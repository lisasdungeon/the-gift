'use strict';
// WORD-CORRELATION (concordance) engine for II Chronicles / VulgHetzenauer. Standalone.
// Builds a co-occurrence map lazily on first correlate()/occurrences() call.
const fs = require('fs');
const path = require('path');

const PY_PATH = path.join(__dirname, "../../python/VulgHetzenauer/II Chronicles.py");
