'use strict';
// WORD-CORRELATION (concordance) engine for I Thessalonians / FreOltramare1874. Standalone.
// Builds a co-occurrence map lazily on first correlate()/occurrences() call.
const fs = require('fs');
const path = require('path');

const PY_PATH = path.join(__dirname, "../../python/FreOltramare1874/I Thessalonians.py");
