'use strict';
// WORD-CORRELATION (concordance) engine for Song of Solomon / CopSahBible2. Standalone.
// Builds a co-occurrence map lazily on first correlate()/occurrences() call.
const fs = require('fs');
const path = require('path');

const PY_PATH = path.join(__dirname, "../../python/CopSahBible2/Song of Solomon.py");
