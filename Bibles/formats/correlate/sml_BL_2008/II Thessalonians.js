'use strict';
// WORD-CORRELATION (concordance) engine for II Thessalonians / sml_BL_2008. Standalone.
// Builds a co-occurrence map lazily on first correlate()/occurrences() call.
const fs = require('fs');
const path = require('path');

const PY_PATH = path.join(__dirname, "../../python/sml_BL_2008/II Thessalonians.py");
