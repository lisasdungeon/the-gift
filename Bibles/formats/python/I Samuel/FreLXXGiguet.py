...
CHAPTERS = {
    1: {
        ...
        11: 'Et elle fit un vœu au Seigneur, disant: Adonaï, Seigneur, Eloé sabaoth<ref>Dieu des armées.',
    ...
    2: {
        ...
        13: 'Or, tel était le droit du prêtre: quand quelqu’un',
    ...
    4: {
        ...
        21: 'Et l’on appela l’enfant Ibarchaboth, à cause de l’arche de Dieu, à cause du beau-père de la femme, et à cause de son mari.',
    ...
    6: {
        ...
        19: 'Parmi les hommes de Bethsamys, les fils de Jéchonie n’eurent point à se féliciter parce qu’ils regardèrent l’arche du Seigneur, qui frappa à mort soixantedix de leurs chefs, outre cinquante mille hommes. Le peuple fut plongé dans le deuil parce que le Seigneur l’avait frappé d’une très-grande plaie.',
    ...
    7: {
        ...
        2: 'A partir du jour où l’arche entra à Cariath-larim, bien des jours s’écoulèrent, elle y était déjà depuis vingt ans, quand tout Israël se tourna vers le Seigneur.',
    ...
    8: {
        ...
        9: 'Obéis donc à leur voix; seulement prends-les à témoin, et prends-les à témoin pour leur faire connaître les droits du roi qui régnera sur eux.',
    ...
    13: {
        ...
        2: 'Jonathas battit le Nasib, étranger qui demeurait sur la colline; les Philistins l’apprirent, et Saül fit retentir la trompette en toute la terre promise, disant: Les esclaves secouent le joug.',
    ...
    14: {
        1: 'Or, un jour vint où Jonathas, fils de Saül, dit au serviteur qui portait ses armes: Viens, allons à la station des Philistins du côté opposé au lieu où nous sommes; et il n’en dit rien à son père.',
    ...
    17: {
        ...
        21: '(42) Goliath vit David, et il le méprisa, parce que c’était un jeune garçon, qu’il était roux et qu’il avait de beaux yeux.',
        ...
        26: '(47) Toute cette Église connaîtra que le Seigneur ne sauve point avec le glaive et la javeline; car cette guerre est du Seigneur, et il vous livrera à nos mains.',
    ...
    18: {
        ...
        8: '(16) Or, tout Israël et tout Juda aimaient David, parce qu’il marchait à la tête du peuple.',
    ...
    19: {
        ...
        13: 'Et Michol prit une image qu’elle posa sur le lit; à la tête elle mit du poil de chèvre, et elle couvrit le corps d’un manteau. être un mannequin.',
        ...
        20: 'Et Saül envoya des messagers pour prendre David; or, ils virent l’assemblée des prophètes, Samuel à leur tête, et l’Esprit de Dieu vint sur les messagers de Saül, et ils prophétisèrent.',
        ...
        24: 'Là, il se dépouilla de ses vêtements; il prophétisa devant l’assemblée, et il resta nu</ref>C’est-à-dire qu’il quitta ses vêtements royaux, et ne garda que les habits de dessous.</ref>, tout ce jour-là et toute la nuit, se tenant prosterné; à cause de cela on dit: Saül aussi est-il au nombre des prophètes?',
    },
    20: {
        ...
        15: 'Ni toi ni les tiens ne priverez ma famille de votre miséricorde à jamais. Oui, si je ne t’avertis; lorsque le Seigneur fera disparaître un à un de la face de la terre les ennemis de David, que le nom de Jonathas se trouve du nombre, et que le Seigneur punisse les ennemis de David.',
    ...
    23: {
        ...
        6: 'Or, Abiathar, fils d’Abimélech, après s’être réfugié auprès de David, le suivit à Ceïla, tenant en sa main l’éphod.',
