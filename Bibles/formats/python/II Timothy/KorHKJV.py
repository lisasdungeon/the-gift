...
CHAPTERS = {
    1: {
        1: '하나님의 뜻으로 말미암아 그리스도 예수님 안에 있는 생명의 약속에 따라 예수 그리스도의 사도가 된 바울은',
        2: '나의 극진히 사랑하는 아들 디모데에게 편지하노니 하나님 아버지와 그리스도 예수 우리 주로부터 은혜와 긍휼과 평강이 있기를 원하노라.',
        3: '내가 밤낮으로 기도하는 가운데 끊임없이 너를 기억하므로 내 선조들 때부터 내가 순수한 양심으로 섬기는 하나님께 감사를 드리고',
        ...
        6: '그러므로 내가 안수함으로 네 속에 있게 된 하나님의 선물을 네가 불붙이게 하려고 너로 하여금 기억하게 하노니',
        7: '하나님께서는 우리에게 두려움의 영을 주지 아니하시고 권능과 사랑과 건전한 생각의 영을 주셨느니라.',
        8: '그러므로 너는 우리 주의 증언과 그분의 갇힌 자 된 나를 부끄러워하지 말고 오직 하나님의 권능에 따라 복음의 고난에 참여하는 자가 되라.',
        ...
        14: '우리 안에 거하시는 성령님을 의지하여 네게 맡겨진 그 선한 것을 지키라.',
    ...
    2: {
        ...
        5: '또한 사람이 우승하려고 애써도 적법하게 애쓰지 아니하면 관을 얻지 못하며',
        6: '수고하는 농부가 열매에 맨 먼저 참여하는 자가 되어야 마땅하니라.',
        7: '내가 말하는 것을 깊이 생각하라. 주께서 모든 일에서 네게 깨달음을 주시기 원하노라.',
        8: '다윗의 씨에서 나신 예수 그리스도께서 나의 복음대로 죽은 자들로부터 일으켜지신 것을 기억하라.',
        ...
        26: '이것은 마귀의 뜻대로 마귀에게 사로잡힌 자들이 마귀의 올무에서 벗어나 자신을 되찾게 하려 함이라.',
    },
    3: {
    ...
    4: {
        ...
        9: '너는 곧 내게 오도록 힘쓰라.',
        10: '데마는 현재의 이 세상을 사랑하여 나를 버리고 데살로니가로 떠났고 그레스겐은 갈라디아로, 디도는 달마디아로 갔으며',
        11: '오직 누가만 나와 함께 있느니라. 마가를 취해 데리고 오라. 그가 사역을 위해 내게 유익하니라.',
        12: '두기고는 내가 에베소로 보내었노라.',
        13: '네가 올 때에 내가 드로아에서 가보에게 맡겨 놓은 겉옷을 가져오고 또 책들을 가져오되 특별히 양피지들을 가져오라.',
        14: '구리 세공업자 알렉산더가 내게 많은 악을 행하였으니 주께서 그의 행위대로 그에게 갚으시기를 원하노라.',
        15: '너도 그를 조심하라. 그가 우리의 말들을 크게 대적하였느니라.',
        16: '내가 처음 답변할 때에 아무도 나와 함께 서지 아니하고 모든 사람이 나를 버렸으나 그것을 그들의 책임으로 돌리지 아니하시기를 내가 하나님께 기도하노라.',
        17: '그럼에도 불구하고 주께서 나와 함께 서서 나를 강건하게 하셨으니 이것은 나로 말미암아 그 선포한 말씀이 온전히 알려져서 모든 이방인들이 듣게 하려 하심이라. 내가 사자의 입에서 구출되었느니라.',
        18: '주께서 나를 모든 악한 일에서 건져 내시고 또 자신의 하늘 왕국에 이르기까지 보존하시리니 그분께 영광이 영원무궁토록 있기를 원하노라. 아멘.',
        ...
        22: '주 예수 그리스도께서 네 영과 함께 하시기를 원하노라. 은혜가 너희와 함께 있기를 원하노라. 아멘. ¶에베소 사람들의 교회의 첫째 감독으로 임명받은 디모데에게 보내는 둘째 서신을 바울이 네로 앞에 두 번째 불려나갈 때에 로마에서 써서 보내다.',
    },
}
