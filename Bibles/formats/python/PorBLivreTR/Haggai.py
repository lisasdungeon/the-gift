...
CHAPTERS = {
    ...
    2: {
        ...
        16: 'Antes que fossem estas coisas, vinham ao amontoado de grão de vinte medidas,e obtinham somente dez; vinham ao lagar para tirar cinquenta vasos do lagar, mas obtinham somente vinte.',
