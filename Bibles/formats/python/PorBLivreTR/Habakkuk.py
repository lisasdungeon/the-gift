...
CHAPTERS = {
    ...
    2: {
        1: 'Sobre minha guarda estarei, e sobre a fortaleza ficarei, e vigiarei para ver o que ele me falará, e o que eu responderei à minha queixa.',
        ...
        3: 'Pois a visão ainda é para um tempo determinado, mas ao fim ela dará testemunho, e não será mentirosa; ainda que se tardar, espera-o, porque virá; não se atrasará.',
        4: 'Eis que o soberbo não tem a alma correta em si; mas o justo viverá por sua fé.',
        5: 'Pois também o vinho é enganador, é como um homem arrogante, que não fica quieto em casa; seu apetite se alarga como o mundo dos mortos, e é semelhante à morte, que não se farta; e ajunta a si todas as nações, e reúne a si todos os povos.',
        6: 'Por acaso todos estes não levantarão um insulto e provérbios de ridicularizações contra ele? E dirão: Ai daquele que acumula o que não era seu, e daquele de se enriquece por meio de extorsão! Até quando?',
