...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'Os quais vieram com Zorobabel, Jesuá, Neemias, Seraías, Reelaías, Mardoqueu, Bilsã, Mispar, Bigvai, Reum e Baaná. O registro dos homens do povo de Israel:',
    ...
    3: {
        ...
        2: 'E levantaram-se Jesuá filho de Jozadaque, e seus irmãos os sacerdotes, e Zorobabel filho de Sealtiel, e seus irmãos, e edificaram o altar do Deus de Israel, para oferecerem sobre ele ofertas de queima, como está escrito na Lei de Moisés, homem de Deus.',
        ...
        5: 'E depois disto, fizeram a oferta de queima contínua, e as das luas novas, e todas as festas santificadas ao SENHOR, como também de qualquer um que dava oferta voluntária ao SENHOR.',
        6: 'Desde o primeiro dia do mês sétimo começaram a apresentar ofertas de queima ao SENHOR; porém ainda não estavam postos os fundamentos do templo do SENHOR.',
        ...
        8: 'E no ano segundo de sua vinda à casa de Deus em Jerusalém, no mês segundo, começaram Zorobabel filho de Sealtiel, Jesuá filho de Jozadaque, com os outros irmãos seus, os sacerdotes e os levitas, e todos os que haviam vindo do cativeiro a Jerusalém. E ordenaram aos levitas da idade de vinte anos acima, que cuidassem da casa do SENHOR.',
        9: 'Então Jesuá, seus filhos e seus irmãos, Cadmiel e seus filhos, filhos de Judá, se levantaram como um só homem para supervisionarem os que faziam a obra na casa de Deus; com os filhos de Henadade, seus filhos e seus irmãos, levitas.',
    ...
    4: {
        ...
        3: 'Porém Zorobabel, e Jesuá, e os demais chefes das famílias de Israel lhes disseram:Não nos convém edificar convosco casa a nosso Deus; mas somente nós a edificaremos ao SENHOR, Deus de Israel, como nos mandou o rei Ciro, rei da Pérsia.',
    ...
    5: {
        ...
        2: 'Então se levantaram Zorobabel filho de Sealtiel, e Jesuá filho de Jozadaque; e começaram a reconstruir a casa de Deus que está em Jerusalém; e com eles os profetas de Deus, que os ajudavam.',
    ...
    6: {
        ...
        9: 'E o que for necessário, como bezerros, carneiros e cordeiros, para ofertas de queima ao Deus do céu, trigo, sal, vinho e azeite, conforme o que os sacerdotes que estão em Jerusalém disserem, seja lhes dado a cada sem falta.',
    ...
    8: {
        ...
        33: 'Ao quarto dia foram pesados a prata, o ouro, e os utensílios, na casa de nosso Deus, por meio de Meremote, filho do sacerdote Urias, e com ele Eleazar filho de Fineias; e com eles os levitas Jozabade filho de Jesuá, e Noadias filho de Binui.',
    ...
    10: {
        ...
        18: 'E dos filhos dos sacerdotes que haviam se casado com mulheres estrangeiras, foram achados estes: dos filhos de Jesuá, filho de Jozadaque, e de seus irmãos: Maaseias, Eliézer, Jaribe, e Gedalias;',
