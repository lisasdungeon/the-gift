...
CHAPTERS = {
    ...
    9: {
        1: 'O hätte ich doch eine Wanderer-Herberge fern in der Wüste, so wollte ich mein Volk verlassen und von ihnen weggehen! Denn sie sind allesamt Ehebrecher, eine Gesellschaft von Treulosen.',
    ...
    14: {
        ...
        17: '»Du aber richte dieses Wort an sie: ›Bei Tag und bei Nacht zerfließen meine Augen in Tränen und kommen nicht zur Ruhe! Denn einen furchtbaren Schlag hat die Jungfrau, die Tochter meines Volkes, erlitten, eine qualvolle Wunde.',
    ...
    19: {
        1: 'So hat der HERR zu mir gesprochen: »Gehe hin und kaufe dir beim Töpfer einen Krug, nimm dann einige von den Ältesten des Volkes und von den vornehmsten Priestern mit dir',
        ...
        6: 'darum wisset wohl: die Zeit kommt‹ – so lautet der Ausspruch des HERRN –, ›da wird dieser Ort nicht mehr Thopheth und dieses Tal nicht mehr Tal Ben-Hinnom, sondern Würgetal genannt werden.',
    ...
    23: {
        ...
        6: 'In seinen Tagen wird Juda gerettet werden und Israel in Sicherheit wohnen, und der Name, den man ihm beilegt, wird lauten: ›Der HERR unsere Gerechtigkeit‹.',
        ...
        8: 'sondern: ›So wahr der HERR lebt, der die zum Hause Israel Gehörigen aus dem Nordland und aus all den Ländern, wohin ich sie versprengt hatte, hergeführt und heimgebracht hat, damit sie wieder auf ihrem Grund und Boden wohnten!‹«',
        9: '[Über die Propheten:] Gebrochen ist mir das Herz in der Brust, es zittern mir alle Glieder; mir ist zu Sinn wie einem Trunkenen, wie einem Manne, den der Wein übermannt hat, vor dem HERRN und vor seinen heiligen Worten!',
        ...
        13: '»Schon an den Propheten Samarias habe ich Ärgerliches erlebt: sie weissagten im Namen des Baal und führten mein Volk Israel irre;',
        ...
        15: 'Darum hat der HERR der Heerscharen über die Propheten so gesprochen: »Fürwahr, ich will sie mit Wermut speisen und ihnen Giftwasser zu trinken geben; denn von den Propheten Jerusalems hat sich Verworfenheit über das ganze Land verbreitet!« –',
        ...
        20: 'Nicht nachlassen wird der lodernde Zorn des HERRN, bis er’s vollbracht und die Gedanken seines Herzens vollführt hat: am Ende der Tage werdet ihr das schon klar erkennen!',
        ...
        30: 'Darum wisset wohl: ich will an die Propheten« – so lautet der Ausspruch des HERRN –, »die meine Worte einer dem andern stehlen!',
        ...
        33: '»Wenn aber dieses Volk oder ein Prophet oder ein Priester dich fragen sollte: ›Was ist die Last des HERRN?‹, so antworte ihnen: ›Ihr seid die Last, und ich will euch abwerfen! – so lautet der Ausspruch des HERRN.',
        ...
        36: 'Aber den Ausdruck ›Last des HERRN‹ sollt ihr nicht mehr gebrauchen, sonst soll einem jeden diese seine Redeweise zur Last werden! Denn ihr würdet damit die Worte des lebendigen Gottes, des HERRN der Heerscharen, unsers Gottes, verkehren.',
    ...
    30: {
        ...
        11: 'denn ich bin mit dir« – so lautet der Ausspruch des HERRN –, »um dir zu helfen. Denn über alle Völker, unter die ich dich zerstreut habe, will ich völlige Vernichtung bringen; dich allein will ich nicht völlig vernichten, sondern dich nur nach Gebühr züchtigen; denn ganz ungestraft will ich dich nicht lassen.«',
        ...
        16: '»Darum sollen alle, die dich gefressen haben, wieder gefressen werden und alle deine Bedränger insgesamt in die Gefangenschaft wandern; die dich ausgeplündert haben, sollen der Plünderung anheimfallen, und alle, die dich ausgeraubt haben, will ich der Beraubung preisgeben!',
        ...
        18: 'So hat der HERR gesprochen: »Nunmehr will ich das Geschick der Zelte Jakobs wenden und mich seiner Wohnungen erbarmen: die Stadt soll auf ihrem Hügel wieder aufgebaut und die Königsburg in der alten Weise bewohnt werden!',
        ...
        21: 'Sein Machthaber soll aus ihm selbst stammen und sein Herrscher aus seiner Mitte hervorgehen, und ich will ihm Zutritt zu mir gewähren, daß er mir nahen darf; denn wer würde sonst wohl sein Leben daransetzen, um mir zu nahen?« – so lautet der Ausspruch des HERRN.',
    ...
    37: {
        1: 'Zur Zeit, als Zedekia, der Sohn Josias, regierte, den Nebukadnezar, der König von Babylon, zum König über das Land Juda an Stelle Konjas, des Sohnes Jojakims, eingesetzt hatte,',
        2: 'hörte weder er noch seine Diener, noch die Bevölkerung des Landes auf die Worte, die der HERR durch den Propheten Jeremia an sie richtete.',
        ...
        14: 'Jeremia entgegnete: »Das ist eine Lüge! Ich will nicht zu den Chaldäern übergehen!« und hörte nicht weiter nach ihm hin; aber Jirja ließ Jeremia festnehmen und vor die Fürsten führen.',
        ...
        17: 'sandte der König Zedekia (eines Tages) hin, ließ ihn holen und richtete in seinem Palast insgeheim die Frage an ihn: »Ist ein Wort vom HERRN ergangen?« Jeremia antwortete: »Jawohl! Nämlich der Gewalt des Königs von Babylon wirst du preisgegeben werden.«',
    ...
    44: {
        ...
        2: '»So hat der HERR der Heerscharen, der Gott Israels, gesprochen: ›Ihr selbst habt all das Unglück gesehen, das ich über Jerusalem und alle Städte Judas verhängt habe; ihr wißt, sie liegen heutigestags in Trümmern und sind unbewohnt',
        ...
        8: 'Ihr reizt mich ja zum Zorn durch das Tun eurer Hände, indem ihr anderen Göttern in Ägypten opfert, wohin ihr euch begeben habt, um dort als Fremdlinge zu wohnen – (allerdings mit dem Ergebnis), daß ihr der Vernichtung verfallt und zu einem Fluchwort und zur Beschimpfung bei allen Völkern der Erde werdet.',
        ...
        14: 'und unter dem Überrest der Judäer, die hergekommen sind, um hier in Ägypten als Fremdlinge zu wohnen, soll es keinen geben, der seinem Geschick entgeht und am Leben bleibt, um ins Land Juda zurückzukehren, wohin sie sich zurücksehnen und wo sie gern wieder wohnen möchten; denn sie sollen nicht dorthin zurückkehren außer einigen Entronnenen!‹«',
        15: 'Da antworteten dem Jeremia alle Männer, welche wußten, daß ihre Frauen anderen Göttern räucherten, und alle Frauen, die in großer Schar dabei standen, und das gesamte Volk, das in Ägypten (und) Pathros wohnte, folgendermaßen:',
        16: '»Was die Forderung betrifft, die du im Namen des HERRN an uns gerichtet hast, so wisse, daß wir auf dich nicht hören!',
        17: 'Wir wollen vielmehr das Gelübde, das wir geleistet haben, nämlich der Himmelskönigin zu räuchern und ihr Trankopfer zu spenden, getreulich ausführen, ganz so wie wir und unsere Väter, unsere Könige und Fürsten es in den Ortschaften Judas und auf den Straßen Jerusalems getan haben! Damals hatten wir Brot in Fülle, befanden uns wohl und wußten nichts von Unglück.',
        18: 'Aber seitdem wir aufgehört haben, der Himmelskönigin zu räuchern und ihr Trankopfer zu spenden, haben wir Mangel an allem gelitten und sind durch das Schwert und durch den Hunger aufgerieben worden.',
        19: 'Und wenn wir der Himmelskönigin jetzt (wieder) Opfer verbrennen und ihr Trankopfer spenden – geschieht es etwa ohne die Zustimmung unserer Ehemänner, daß wir ihr zu Ehren Kuchen backen, indem wir ihre Gestalt darauf abbilden, und ihr Trankopfer spenden?«',
        20: 'Da gab Jeremia dem gesamten Volk, den Männern und Frauen und allen denen, die ihm mit solchen Reden entgegengetreten waren, folgende Antwort:',
        21: '»Jawohl, die Räucherei, die ihr in den Ortschaften Judas und in den Straßen Jerusalems getrieben habt, ihr und eure Väter, eure Könige und Fürsten und die Bevölkerung des Landes – hat der HERR ihrer etwa nicht gedacht und sie nicht in Erinnerung behalten?',
        ...
        29: 'Und dies soll für euch das Zeichen sein‹ – so lautet der Ausspruch des HERRN –, ›daß ich euch an diesem Orte heimsuchen werde – damit ihr erkennt, daß meine Unheilsdrohungen gegen euch unfehlbar in Erfüllung gehen werden‹:',
    ...
    46: {
        ...
        3: 'Rüstet Schild und Tartsche und tretet an zum Kampf!',
        ...
        8: 'Ägypten stieg wie der Nil empor, daß seine Fluten wie Ströme wogten, und es drohte: »Ich will emporsteigen, das Land überschwemmen, will Städte vertilgen samt ihren Bewohnern!«',
        9: 'Stürmt heran, ihr Rosse, und rast daher, ihr Wagen! Und die Mannen mögen ausrücken, die Äthiopier und die schildbewehrten Putäer und die Luditer, die den Bogen führen und spannen!',
        10: 'Ja, dieser Tag ist für Gott, den HERRN der Heerscharen, ein Tag der Rache, um seinen Widersachern zu vergelten: da frißt das Schwert, bis es satt ist, und berauscht sich an ihrem Blut, denn ein Schlachtfest hält Gott, der HERR der Heerscharen, im Nordland am Euphratstrom.',
        ...
        12: 'Die Völker vernehmen deine Schande, und die Erde hallt von deinem Wehgeschrei wider; denn ein Krieger ist über den andern gefallen: miteinander sind beide niedergestürzt!',
        ...
        14: 'Verkündet es in Ägypten und ruft es in Migdol aus, ruft es auch in Memphis und Daphne aus! Gebietet: Stelle dich auf (zur Wehr) und mache dich bereit, denn schon frißt das Schwert rings um dich her!',
        15: 'Warum sind deine Helden niedergeworfen? Sie haben nicht standgehalten, denn der HERR hat sie niedergestoßen.',
        16: 'Er hat viele straucheln lassen; ja, einer stürzt über den andern, so daß sie ausrufen: »Auf! Laßt uns heimkehren zu unserm Volk und in unser Heimatland vor dem gewalttätigen Schwert!«',
        17: 'Nennt den Namen des Pharaos, des Königs von Ägypten: ›Toben, das den richtigen Zeitpunkt versäumt hat‹.',
        18: '»So wahr ich lebe« – so lautet der Ausspruch des Königs, dessen Name ›HERR der Heerscharen‹ ist –: »Wie der Thabor unter den Bergen und wie der Karmel am Meer, so wird er heranziehen!',
        ...
        21: 'Auch seine Söldner, die es in seiner Mitte wie Mastkälber hat, ja, auch sie haben kehrt gemacht, haben sich insgesamt zur Flucht gewandt und nicht standgehalten, denn ihr Unglückstag ist über sie hereingebrochen, die Zeit ihrer Heimsuchung!',
        22: 'Man hört etwas daherkommen wie das Rascheln einer Schlange, die davoneilt; denn sie rücken mit Heeresmacht heran und fallen mit Äxten über das Land her wie Holzhauer.',
        23: '»Sie hauen seinen Wald um« – so lautet der Ausspruch des HERRN –, »der unübersehbar ist; denn ihrer sind mehr als der Heuschrecken, und unzählbar ist ihre Menge!«',
        24: 'Zuschanden wird die Tochter Ägypten, der Gewalt des nordischen Volkes wird sie preisgegeben!',
        25: 'Gesprochen hat der HERR der Heerscharen, der Gott Israels: »Wisset wohl: ich halte (jetzt) Abrechnung mit dem Amon von No sowie mit dem Pharao und ganz Ägypten samt seinen Göttern und Königen, ja mit dem Pharao samt denen, die sich auf ihn verlassen.',
        26: 'Und ich gebe sie in die Gewalt ihrer Todfeinde, und zwar in die Gewalt Nebukadnezars, des Königs von Babylon, und in die Gewalt seiner Knechte. Nachmals aber wird das Land wieder bewohnt sein wie in den Tagen der Vorzeit« – so lautet der Ausspruch des HERRN.',
        27: '»Du aber, fürchte dich nicht, mein Knecht Jakob, und laß dir nicht bange sein, Israel! Denn wisse wohl: ich will dich erretten aus fernen Landen und deine Kinder aus dem Lande ihrer Gefangenschaft, dann wird Jakob heimkehren und in Ruhe und Sicherheit leben, ohne daß jemand ihn aufschreckt.',
    ...
    49: {
        ...
        3: 'Erhebe Wehgeschrei, Hesbon, denn Ai ist zerstört! Jammert, ihr Tochterstädte Rabbas, umgürtet euch mit Sackleinen, wehklagt und lauft in den Hürden hin und her! Denn Milkom muß in die Gefangenschaft wandern, seine Priester und Oberen allzumal!',
