...
CHAPTERS = {
    1: {
        ...
        6: 'daß er ferner die Engel, die ihren Herrschaftsbereich nicht bewahrt, sondern ihre eigene Wohnstätte verlassen hatten, für den großen Gerichtstag mit ewigen Fesseln in der Finsternis drunten verwahrt hat.',
        7: 'Wie Sodom und Gomorrha nebst den umliegenden Städten, die in gleicher Weise wie diese in Unzucht gelebt und (Wesen von) andersartigem Fleisch nachgestellt haben, stehen sie als warnendes Beispiel da, indem sie die Strafe ewigen Feuers zu erleiden haben.',
        ...
        13: 'wilde Meereswogen, die ihre eigenen Schändlichkeiten ausschäumen, Irrsterne, denen die dunkelste Finsternis in (alle) Ewigkeit aufbewahrt ist.',
        ...
        25: 'ihm, dem alleinigen Gott, der durch unsern Herrn Jesus Christus unser Retter ist – ihm gebührt Herrlichkeit und Erhabenheit, Macht und Gewalt (wie) vor aller Weltzeit, (so) auch jetzt und in alle Ewigkeit! Amen.',
    },
}
