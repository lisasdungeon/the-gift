...
CHAPTERS = {
    ...
    9: {
        ...
        9: 'Als Jesus dann von dort weiterging, sah er einen Mann namens Matthäus an der Zollstätte sitzen und sagte zu ihm: »Folge mir nach!« Da stand er auf und folgte ihm.',
        ...
        13: 'Geht aber hin und lernt das Wort verstehen: ›An Barmherzigkeit habe ich Wohlgefallen, nicht an Schlachtopfern‹; denn ich bin nicht gekommen, um Gerechte zu berufen, sondern Sünder.«',
        ...
        16: 'Niemand setzt aber ein Stück ungewalkten Tuches auf ein altes Kleid; denn der eingesetzte Fleck reißt doch von dem Kleide wieder ab, und es entsteht ein noch schlimmerer Riß.',
        17: 'Auch füllt man neuen Wein nicht in alte Schläuche; sonst werden die Schläuche gesprengt, und der Wein läuft aus, und auch die Schläuche gehen verloren; nein, man füllt neuen Wein in neue Schläuche: dann bleiben beide erhalten.«',
    ...
    12: {
        ...
        33: 'Entweder macht den Baum gut, dann ist auch seine Frucht gut; oder macht den Baum faul, dann ist auch seine Frucht faul; denn an der Frucht erkennt man den Baum.',
    ...
    18: {
        ...
        4: 'Wer sich demnach so erniedrigt wie dieses Kind hier, der ist der Größte im Himmelreich;',
        5: 'und wer ein einziges solches Kind auf meinen Namen hin aufnimmt, der nimmt mich auf.«',
        ...
        8: 'Wenn nun deine Hand oder dein Fuß dich ärgert, so haue sie ab und wirf sie von dir! Es ist besser für dich, verstümmelt oder lahm ins Leben einzugehen, als daß du beide Hände oder beide Füße hast und in das ewige Feuer geworfen wirst.',
        9: 'Und wenn dein Auge dich ärgert, so reiße es aus und wirf es von dir! Es ist besser für dich, einäugig ins Leben einzugehen, als daß du beide Augen hast und ins Feuer der Hölle geworfen wirst.',
        10: 'Sehet zu, daß ihr keinen von diesen Kleinen geringschätzt! Denn ich sage euch: Ihre Engel im Himmel schauen allezeit das Angesicht meines himmlischen Vaters.',
        ...
        16: 'hört er aber nicht, so nimm noch einen oder zwei (Brüder) mit dir, damit jede Sache auf Grund der Aussagen von zwei oder drei Zeugen festgestellt wird.',
        17: 'Will er auf diese (Brüder) nicht hören, so teile es der Gemeinde mit; will er auch auf die Gemeinde nicht hören, so gelte er dir wie ein Heide und ein Zöllner. –',
        18: 'Wahrlich ich sage euch: Alles, was ihr auf der Erde bindet, wird auch im Himmel gebunden sein; und was ihr auf der Erde löst, wird auch im Himmel gelöst sein. –',
        ...
        20: 'denn wo zwei oder drei auf meinen Namen hin versammelt sind, da bin ich mitten unter ihnen.«',
        ...
        22: 'Da antwortete ihm Jesus: »Ich sage dir: Nicht bis zu siebenmal, sondern bis siebenzigmal siebenmal.',
        ...
        25: 'Weil er nun diese Schuld nicht bezahlen konnte, befahl der Herr, man solle ihn samt Weib und Kindern und seinem gesamten Besitz verkaufen und so Ersatz schaffen.',
        ...
        32: 'Da ließ sein Herr ihn vor sich rufen und sagte zu ihm: ›Du böser Knecht! Jene ganze Schuld habe ich dir erlassen, weil du mich darum batest;',
    ...
    24: {
        ...
        3: 'Als er sich dann auf dem Ölberg niedergesetzt hatte, traten die Jünger, als sie für sich allein waren, an ihn mit der Bitte heran: »Sage uns doch: wann wird dies geschehen? Und welches ist das Zeichen deiner Ankunft und der Vollendung der Weltzeit?«',
