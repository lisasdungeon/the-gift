...
CHAPTERS = {
    ...
    6: {
        ...
        5: 'Das Feuer aber auf dem Altar soll dadurch in Brand erhalten werden und darf nicht erlöschen: jeden Morgen soll der Priester Holzscheite auf dem Altar anzünden und das (Morgen-) Brandopfer auf ihm zurechtlegen und über ihm die Fettstücke der Heilsopfer in Rauch aufgehen lassen.',
        ...
        8: 'Dann nehme er eine Handvoll davon, nämlich von dem Feinmehl des Speisopfers und von dessen Öl, dazu den gesamten Weihrauch, der auf dem Speisopfer liegt, und lasse es auf dem Altar in Rauch aufgehen als ein Feueropfer lieblichen Geruchs, als den Duftteil davon für den HERRN.',
        ...
        13: '»Dies soll die Opfergabe Aarons und seiner Söhne sein, die sie dem HERRN darzubringen haben an dem Tage, an welchem er gesalbt wird: ein Zehntel Epha Feinmehl als regelmäßiges Speisopfer, die eine Hälfte davon am Morgen, die andere Hälfte am Abend.',
        14: 'Auf einer Platte soll es mit Öl zubereitet werden; zusammengerührt sollst du es darbringen; zerbröckelt zu einem Brockenspeisopfer sollst du es darbringen als einen lieblichen Geruch für den HERRN.',
        15: 'Auch der Priester, der an Aarons Statt aus der Zahl seiner Söhne gesalbt ist, soll es als eine auf ewige Zeiten festgesetzte Gebühr für den HERRN herrichten: als Ganzopfer soll es verbrannt werden;',
    ...
    8: {
        ...
        8: 'Dann befestigte er auf demselben das Brustschild und tat die heiligen Lose Urim und Thummim in das Brustschild hinein.',
        9: 'Hierauf setzte er ihm den Kopfbund auf das Haupt und befestigte an der Vorderseite des Kopfbundes das goldene Stirnblatt, das heilige Diadem, wie der HERR dem Mose geboten hatte.',
        ...
        21: 'Nachdem man dann die Eingeweide und die Beine mit Wasser abgewaschen hatte, ließ Mose den ganzen Widder auf dem Altar in Rauch aufgehen: so war es ein Brandopfer zu lieblichem Geruch, ein Feueropfer für den HERRN, wie der HERR dem Mose geboten hatte.',
        ...
        29: 'Dann nahm Mose die Brust und webte sie als Webeopfer vor dem HERRN; von dem Einweihungswidder fiel sie dem Mose als Anteil zu, wie der HERR dem Mose geboten hatte.',
    ...
    11: {
        ...
        4: 'Nur folgende Tiere dürft ihr von den Wiederkäuern und von denen, die gespaltene Klauen haben, nicht essen: das Kamel, denn es ist zwar ein Wiederkäuer, hat aber keine durchgespaltenen Klauen: als unrein soll es euch gelten; –',
        ...
        30: 'der Mauergecko, der Dornschwanz, der Schleuderschwanz, der Salamander und das Chamäleon.',
    ...
    15: {
        ...
        8: 'Wenn ferner der mit einem Ausfluß Behaftete einen Reinen anspeit, so muß dieser seine Kleider waschen und ein Wasserbad nehmen und ist bis zum Abend unrein.',
        ...
        13: 'Wenn aber der mit einem Ausfluß Behaftete von seinem Leiden befreit wird, so soll er von dem Zeitpunkte, wo er rein geworden ist, sieben Tage zählen; dann wasche er seine Kleider und bade seinen Leib in Quell- oder Flußwasser: so ist er rein.',
    ...
    16: {
        ...
        6: '»Hierauf soll Aaron den jungen Stier, der zum Sündopfer für ihn selbst bestimmt ist, herzubringen und sich und seinem Hause Sühne erwirken.',
        ...
        19: 'dann sprenge er etwas von dem Blut siebenmal mit seinem Finger an den Altar und heilige ihn so und reinige ihn von den Versündigungen der Israeliten.«',
        ...
        29: '»Und folgendes soll für euch eine ewiggültige Verordnung sein: Im siebten Monat, am zehnten Tage des Monats, sollt ihr eure Seelen beugen und dürft keinerlei Arbeit verrichten, weder der Einheimische noch der Fremdling, der sich bei euch aufhält;',
        ...
        31: 'Ein Tag völliger Ruhe soll es für euch sein, und ihr sollt fasten; das ist eine ewiggültige Verordnung.',
    ...
    18: {
        ...
        4: 'nein, meine Gebote sollt ihr befolgen und meine Satzungen beobachten, um in ihnen zu wandeln: ich bin der HERR, euer Gott!',
        ...
        9: 'Mit deiner Schwester, der Tochter deines Vaters oder der Tochter deiner Mutter, mag sie im Hause geboren oder auswärts geboren sein, darfst du keinen geschlechtlichen Umgang haben.',
        10: 'Mit der Tochter deines Sohnes oder mit der Tochter deiner Tochter darfst du keinen geschlechtlichen Umgang haben; denn sie sind (wie) deine eigenen Töchter.',
        ...
        14: 'Mit der Frau des Bruders deines Vaters darfst du keinen geschlechtlichen Umgang haben; seinem Weibe darfst du nicht nahen, sie ist deine Muhme.',
        ...
        17: 'Mit einer Frau und zugleich ihrer Tochter darfst du keinen geschlechtlichen Umgang haben; die Tochter ihres Sohnes und die Tochter ihrer Tochter darfst du nicht nehmen, um ihnen beizuwohnen; sie sind nächste Blutsverwandte: es wäre eine Schandtat.',
        ...
        19: '»Du darfst ferner einer Frau während der Zeit ihrer Unreinheit nicht nahen, um ihr beizuwohnen. –',
        20: 'Mit der Ehefrau deines Nächsten darfst du nicht den Beischlaf vollziehen, weil du dich dadurch verunreinigen würdest. –',
    ...
    20: {
        ...
        6: 'Wenn sich ferner jemand an die Totenbeschwörer und die Wahrsager wendet, um Götzendienst mit ihnen zu treiben, so will ich mein Angesicht gegen einen solchen Menschen kehren und ihn aus der Mitte seines Volkes ausrotten.«',
        ...
        9: 'Ein jeder, der seinem Vater oder seiner Mutter flucht, soll unfehlbar mit dem Tode bestraft werden! Er hat seinem Vater oder seiner Mutter geflucht: Blutschuld lastet auf ihm.',
        10: 'Wenn ferner ein Mann Ehebruch mit einer verheirateten Frau treibt, wenn er mit der Ehefrau seines Nächsten Ehebruch treibt, so sollen beide, der Ehebrecher und die Ehebrecherin, unfehlbar mit dem Tode bestraft werden. –',
        11: 'Wenn ein Mann der Frau seines Vaters beiwohnt, so hat er seinen Vater geschändet; beide Schuldige sollen unfehlbar mit dem Tode bestraft werden: Blutschuld lastet auf ihnen.',
        12: 'Wenn ein Mann seiner Schwiegertochter beiwohnt, so sollen beide unfehlbar mit dem Tode bestraft werden; sie haben eine schändliche Befleckung verübt: Blutschuld lastet auf ihnen. –',
        ...
        16: 'Und wenn ein Weib sich irgendeinem Tiere naht, um sich mit ihm zu paaren, so sollst du das Weib samt dem Tiere töten; sie sollen unfehlbar mit dem Tode bestraft werden: Blutschuld lastet auf ihnen. –',
        ...
        18: 'Wenn ferner ein Mann mit einer weiblichen Person zur Zeit ihres monatlichen Unwohlseins geschlechtlichen Umgang gehabt hat, wenn er also den Quell ihres Blutes enthüllt und sie (selbst) den Quell ihres Blutes aufgedeckt hat, so sollen beide aus der Mitte ihres Volkes ausgerottet werden! –',
        ...
        20: 'Wenn ferner ein Mann der Frau seines Oheims beiwohnt, so hat er seinen Oheim geschändet; sie sollen für ihre Sünde büßen: kinderlos werden sie sterben.',
        ...
        23: 'Ihr dürft also nicht nach den Satzungen der Völkerschaften wandeln, die ich vor euch vertreiben werde; denn alle diese Sünden haben sie verübt, so daß sie mir zum Ekel geworden sind.',
    ...
    26: {
        1: '»Ihr sollt euch keine Götzen verfertigen und dürft euch keine Schnitzbilder und Malsteine aufrichten, auch keine Steine mit Bildwerk in eurem Lande aufstellen, um euch davor niederzuwerfen; denn ich, der HERR, bin euer Gott!',
        2: 'Meine Sabbate sollt ihr beobachten und mein Heiligtum fürchten: ich bin der Herr!«',
        3: '»Wenn ihr in meinen Satzungen wandelt und meine Gebote beobachtet und nach ihnen tut,',
        ...
        13: 'Ich bin der HERR, euer Gott, der euch aus dem Lande Ägypten herausgeführt hat, damit ihr ihnen nicht länger als Knechte dienen solltet; ich habe die Stäbe eures Joches zerbrochen und euch aufrecht einhergehen lassen.«',
        ...
        16: 'so will auch ich dementsprechend mit euch verfahren und schreckliche Heimsuchungen über euch verhängen: Schwindsucht und Fieber, daß euch das Augenlicht erlöschen soll und das Leben qualvoll dahinschwindet. Vergebens sollt ihr dann euren Samen aussäen, denn eure Feinde werden ihn verzehren;',
        ...
        34: 'Da wird dann das Land seine Ruhezeiten ersetzt bekommen die ganze Zeit hindurch, in der es verwüstet daliegt, während ihr im Lande eurer Feinde weilt; ja, da wird dann das Land Ruhe haben und seine Ruhezeiten nachholen;',
        ...
        39: 'Und diejenigen von euch, die dann noch übrig sind, sollen in den Ländern eurer Feinde infolge ihrer Sündenschuld verschmachten und auch infolge der Sünden ihrer Väter hinschwinden mit ihnen.«',
        ...
        41: 'auch ich ihnen widerstrebt und sie in das Land ihrer Feinde gebracht habe. Wenn alsdann ihr unbeschnittenes Herz sich demütigt und sie dann die Strafe für ihre Verschuldung büßen,',
