...
CHAPTERS = {
    ...
    2: {
        ...
        3: 'und nichts aus Rechthaberei oder eitlem Ehrgeiz tut, sondern in Demut einer den andern höher als sich selbst erachtet;',
        4: 'jeder habe nicht (nur) seinen eigenen Vorteil im Auge, sondern jeder auch den des andern.',
        5: 'Solche Gesinnung wohne in euch allen, wie sie auch in Christus Jesus vorhanden war;',
        ...
        15: 'damit ihr euch tadellos und lauter erweist, als unsträfliche Gotteskinder inmitten einer verkehrten und verdrehten Menschheit, unter der ihr wie helle Sterne in der Welt leuchtet.',
        ...
        17: 'Aber auch wenn ich als Trankopfer ausgegossen werden sollte über dem Opfer und dem priesterlichen Dienst an eurem Glauben, so freue ich mich doch und freue mich im Verein mit euch allen.',
        18: 'Ebenso freuet aber auch ihr euch, und zwar im Verein mit mir!',
        19: 'Ich hoffe aber im Herrn Jesus, Timotheus bald zu euch senden zu können, damit auch ich mich beruhigt fühle, wenn ich erfahre, wie es um euch steht.',
        ...
        23: 'Ihn also hoffe ich euch unverzüglich senden zu können, sobald ich meine Lage zu übersehen vermag;',
    ...
    4: {
        1: 'Daher, meine geliebten Brüder, nach denen ich mich sehne, ihr meine Freude und meine Krone: stehet in dieser Weise fest im Herrn, Geliebte!',
        2: 'Die Evodia ermahne ich und ebenso die Syntyche, eines Sinnes zu sein im Herrn.',
        3: 'Ja, ich bitte auch dich, mein Syzygus: nimm dich als echter Genosse ihrer an! Sie haben mir ja im Kampf für die Heilsbotschaft Beistand geleistet im Verein mit Klemens und meinen übrigen Mitarbeitern, deren Namen im Buche des Lebens verzeichnet stehen.',
        ...
        7: 'Dann wird der Friede Gottes, der höher ist als aller Verstand, eure Herzen und euer ganzes Denken in Christus Jesus bewahren.',
        8: 'Endlich, liebe Brüder: alles, was wahr ist, was ehrbar, was gerecht, was rein, was liebenswert, was unanstößig ist, sei es irgendeine Tugend oder etwas Lobenswertes, darauf seid bedacht!',
        9: 'Was ihr auch (von mir) gelernt und überkommen, gehört und an mir gesehen habt, das tut: dann wird der Gott des Friedens mit euch sein.',
        ...
        11: 'Ich sage das nicht, weil ich mich in Not befinde; denn ich habe gelernt, in welcher Lage ich mich auch befinde, mir genügen zu lassen;',
        ...
        17: 'Nicht daß es mir um die Gabe zu tun wäre; nein, für mich handelt es sich um die Frucht, die als Guthaben auf eure Rechnung kommt.',
        ...
        19: 'Mein Gott aber wird euch nach seinem Reichtum alles, was ihr bedürft, in Herrlichkeit zukommen lassen in Christus Jesus.',
        20: 'Unserm Gott und Vater aber sei die Ehre in alle Ewigkeit!',
        21: 'Grüßt jeden Heiligen in Christus Jesus! Es grüßen euch die Brüder, die hier bei mir sind.',
        22: 'Alle Heiligen lassen euch grüßen, besonders die vom kaiserlichen Hofe.',
