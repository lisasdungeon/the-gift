...
CHAPTERS = {
    ...
    4: {
        ...
        3: 'Deine Lippen gleichen einer Purpurschnur, und dein Mund ist voll Anmut; wie der Spalt eines Granatapfels schimmern die Schläfen dir hinter dem Schleier hervor.',
        4: 'Wie Davids Turm ragt dein Hals, zur Fernsicht gebaut: tausend Schilde hangen an ihm, lauter Wehren von Helden.',
        5: 'Deine Brüste sind gleich einem Zwillingspaar junger Gazellen, die unter den Lilien weiden.',
        ...
        10: 'Wie schön ist deine Liebe, meine bräutliche Schwester, viel süßer ist deine Liebe als Wein, und deiner Salben Duft geht über alle Wohlgerüche!',
        ...
        13: 'Alles, was an dir sproßt, ist ein Lusthain von Granaten mit den köstlichsten Früchten, Zyperblumen samt Narden,',
    ...
    5: {
        ...
        2: 'Ich schlief, doch mein Herz war wach. Horch! Da klopft mein Geliebter! »Mach mir auf, meine Schwester, meine Freundin, mein Täubchen, meine Reine! Ach, mein Haupthaar ist voll von Tau, meine Locken voll von den Tropfen der Nacht!«',
        ...
        7: 'Es trafen mich die Wächter, die in der Stadt umhergehn; sie schlugen mich, verwundeten mich, rissen den Schleier mir ab, die Wächter der Stadtmauer!',
        ...
        14: 'seine Arme goldene Walzen, mit Edelsteinen dicht besetzt; sein Leib ein Kunstwerk von Elfenbein, mit Saphiren übersät;',
        ...
        16: 'sein Gaumen lauter Süße und alles an ihm entzückend! Das ist mein Geliebter und das mein Freund, ihr Töchter Jerusalems!',
    },
    6: {
    ...
    7: {
        1: 'Wende dich, wende dich, Sulammith! Wende dich, wende dich, daß wir dich beschauen! »Was wollt ihr schauen an Sulammith beim kriegerischen Tanz?«',
        2: 'Wie schön sind deine Füße in den Schuhen, du Fürstenkind! Die Wölbungen deiner Hüften sind wie Halsgeschmeide, ein Werk von Künstlerhand;',
        3: 'dein Schoß eine runde Schale, der nie der Mischtrank fehlen darf; dein Leib ein Weizenhaufen, umsäumt von Lilien.',
        ...
        6: 'dein Haupt droben wie der Karmel und das herabwallende Haar deines Hauptes wie dunkler Purpur: ein König liegt gefangen in den Locken!',
    ...
    8: {
        ...
        4: 'Ich beschwöre euch, ihr Töchter Jerusalems: was wollt ihr die Liebe aufstören und wecken, eh’ es ihr selber gefällt!',
        ...
        6: '»O lege mich an dein Herz wie einen Siegelring, wie einen Siegelring an deinen Arm! Denn stark wie der Tod ist die Liebe und ihre Leidenschaft hart wie die Unterwelt; ihre Gluten sind Feuergluten, ihre Flammen wie Flammen Gottes.',
        7: 'Die mächtigsten Fluten vermögen die Liebe nicht auszulöschen und Ströme sie nicht fortzuschwemmen; böt’ einer auch alles Gut seines Hauses (als Kaufpreis) für die Liebe: man würde sein nur spotten.«',
        ...
        9: 'Ist sie eine Mauer, so bauen wir eine Krönung von Silber auf ihr; ist sie aber ein Tor, so verrammeln wir es mit Zederbohlen.« –',
        10: 'Ich bin eine Mauer, und meine Brüste sind wie Türme; doch ich habe mich ihm gezeigt als friedlich übergebene Burg.',
        ...
        14: '»Enteile, mein Geliebter, und mache es wie die Gazelle oder wie der junge Hirsch auf den balsamduftenden Bergen!«',
    },
}
