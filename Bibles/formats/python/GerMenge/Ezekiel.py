...
CHAPTERS = {
    1: {
        1: 'Und es begab sich im dreißigsten Jahre im vierten Monat, am fünften Tage des Monats, als ich mich unter den in die Verbannung Weggeführten am Flusse Kebar befand: da tat sich der Himmel auf, und ich sah göttliche Gesichte.',
    ...
    4: {
        ...
        2: 'Dann eröffne die Belagerung gegen sie: errichte Belagerungswerke gegen sie, schütte gegen sie einen Wall auf, schlage Heerlager gegen sie auf und stelle Sturmböcke ringsum gegen sie auf.',
        3: 'Darauf hole dir eine eiserne Platte und stelle sie als eiserne Mauer zwischen dich und die Stadt hin; dann richte deine Blicke unverwandt gegen sie: so soll sie sich im Belagerungszustand befinden, und du sollst sie belagern: ein Wahrzeichen soll dies für das Haus Israel sein!«',
        ...
        8: 'Und wisse wohl: ich will dir Fesseln anlegen, daß du dich nicht von einer Seite auf die andere umwenden kannst, bis du mit den Tagen deiner Belagerung zu Ende bist.«',
        9: '»Du aber nimm dir Weizen und Gerste, Bohnen und Linsen, Hirse und Spelt, tu sie zusammen in ein einziges Gefäß und bereite dir Brot daraus nach der Zahl der Tage, während derer du auf deiner Seite liegen mußt: 390 Tage lang sollst du das essen;',
        ...
        14: 'Da entgegnete ich: »Ach, HERR, mein Gott! Siehe, mein Inneres ist noch niemals durch Unreines befleckt worden, und von verendeten oder zerrissenen Tieren habe ich seit meiner Jugend bis jetzt niemals etwas genossen, und abscheuliches Fleisch ist noch nie in meinen Mund gekommen.«',
        ...
        16: 'Dann fuhr er fort: »Menschensohn, wisse wohl: ich will den Stab des Brotes in Jerusalem zerbrechen, so daß sie das Brot abgewogen und mit Angst essen müssen und das Wasser abgemessen und mit Entsetzen trinken,',
    ...
    8: {
        ...
        4: 'Und siehe, dort stand die Herrlichkeit des Gottes Israels in derselben Erscheinung, wie ich sie in der Tal-Ebene gesehen hatte.',
    ...
    11: {
        1: 'Darauf hob die Gotteskraft mich empor und brachte mich an das östliche Tor am Tempel des HERRN, das nach Osten zu liegt; dort sah ich am Eingang des Tores fünfundzwanzig Männer stehen und erblickte in ihrer Mitte die Häupter des Volkes, Jaasanja, den Sohn Assurs, und Pelatja, den Sohn Benajas.',
    ...
    21: {
        ...
        28: 'Freilich scheint das ihnen eine trügerische Wahrsagung zu sein, da sie ja die feierlichsten Eide geschworen haben; doch er bringt ihre Verschuldung (bei sich) in Erinnerung, damit sie gefangen werden.«',
    ...
    24: {
        ...
        25: '»Du aber, Menschensohn, wisse wohl: An dem Tage, wo ich ihnen ihr Bollwerk nehmen werde, ihren Stolz und ihre innige Freude, die Lust ihrer Augen und die Sehnsucht ihres Herzens, dazu auch ihre Söhne und Töchter:',
    ...
    32: {
        1: 'Im zwölften Jahre, am ersten Tage des zwölften Monats, erging das Wort des HERRN an mich folgendermaßen:',
        ...
        3: 'So hat Gott der HERR gesprochen: ›So will ich denn mein Netz über dich ausbreiten durch eine Schar vieler Völker, die sollen dich in meinem Fanggarn emporziehen.',
        ...
        6: 'und das Land mit deinem Ausfluß tränken von deinem Blut bis an die Berge, und die Rinnsale sollen voll von dir werden.',
        ...
        12: 'Durch die Schwerter tapferer Krieger will ich dein Gepränge zu Fall bringen – die wildesten unter den Völkern sind sie allesamt –: die sollen die Herrlichkeit Ägyptens zerstören, daß all sein Gepränge vernichtet wird;',
        ...
        16: 'Ein Klagelied ist dies, das man klagend singen soll; die Töchter der Völker sollen es klagend singen; über Ägypten und all sein Gepränge sollen sie es klagend singen!« – so lautet der Ausspruch Gottes des HERRN.',
        ...
        23: 'Seine Gräber sind im tiefsten Grunde der Grube untergebracht, und sein Kriegsvolk liegt rings um sein Grab herum; sie sind alle erschlagen, durch das Schwert gefallen, sie, die einstmals Schrecken verbreitet haben im Lande der Lebenden.',
    ...
    35: {
        ...
        3: '›So hat Gott der HERR gesprochen: Nunmehr will ich an dich, Gebirge Seir, ich will meine Hand gegen dich ausstrecken und dich zur Wüste und Einöde machen!',
    ...
    36: {
        ...
        22: 'Darum sage zum Hause Israel: ›So hat Gott der HERR gesprochen: Nicht um euretwillen, Haus Israel, greife ich ein, sondern um meines heiligen Namens willen, den ihr unter den Heidenvölkern überall entehrt habt, wohin ihr gekommen seid.',
        ...
        32: 'Nicht um euretwillen greife ich ein‹ – so lautet der Ausspruch Gottes des HERRN –: ›das sei euch kundgetan! Schämt euch vielmehr und errötet über euren Wandel, ihr vom Hause Israel!‹«',
    ...
    37: {
        1: 'Die Hand des HERRN kam über mich: er führte mich im Zustande der Verzückung hinaus und ließ mich mitten in der Tal-Ebene nieder, die voll von Totengebeinen war.',
        2: 'Er führte mich ringsherum an diesen vorüber; und siehe, es lagen ihrer sehr viele über die ganze Tal-Ebene hin, aber alle waren ganz verdorrt.',
        ...
        5: 'So hat Gott der HERR zu diesen Gebeinen gesagt: Fürwahr, ich will Odem in euch kommen lassen, damit ihr wieder lebendig werdet,',
        6: 'und will Sehnen an euch schaffen und Fleisch über euch wachsen lassen, ich will euch mit Haut überziehen und euch Odem einflößen, damit ihr wieder lebendig werdet und erkennt, daß ich der HERR bin.‹«',
        ...
        8: 'Als ich nun hinschaute, nahm ich wohl Sehnen an ihnen wahr, und Fleisch war über sie gewachsen, und mit Haut waren sie oben überzogen, aber Odem war noch nicht in ihnen.',
        9: 'Da sagte er zu mir: »Richte eine Weissagung an den Odem, ja weissage, Menschensohn, und sprich zu dem Lebensgeist: ›So hat Gott der HERR gesprochen: O Geist, komm von den vier Winden herbei und hauche diese Erschlagenen an, daß sie wieder lebendig werden!‹«',
        ...
        17: 'Dann füge dir beide Holzstäbe zu einem einzigen Stabe zusammen, so daß sie ein Ganzes in deiner Hand bilden!«',
    ...
    38: {
        ...
        2: '»Menschensohn, richte deine Blicke auf Gog im Lande Magog, den Fürsten von Ros, Mesech und Thubal, und sprich folgende Weissagungen über ihn aus:',
        3: '›So hat Gott der HERR gesprochen: Nunmehr will ich an dich, Gog, Fürst von Ros, Mesech und Thubal!',
        4: 'Ich will dich herbeilocken und dir Haken in die Kinnbacken legen und dich ins Feld ziehen lassen mit deiner ganzen Kriegsmacht, Rosse und Reiter, allesamt in voller Ausrüstung, ein gewaltiges Heer mit Schilden und Tartschen, durchweg mit Schwertern bewaffnet:',
        5: 'Perser, Äthiopier und Libyer befinden sich unter ihnen, allesamt mit Schild und Helm;',
        6: 'Kimmerier mit all ihren Scharen, das Haus Thogarma aus dem äußersten Norden mit all seinen Scharen: ja viele Völker sind mit dir.',
        7: 'Rüste dich und halte dich bereit, du mit all deinen Scharen, die sich bei dir gesammelt haben, und sei du ihr Anführer!',
        8: 'Nach geraumer Zeit sollst du Befehl erhalten: am Ende der Jahre sollst du über ein Land kommen, das sich vom Kriege erholt hat, (zu einem Volk) das aus vielen Völkern auf den Bergen Israels, die dauernd verödet lagen, gesammelt worden ist; jetzt aber ist es aus den Völkern zurückgeführt, und sie wohnen nun in Sicherheit allesamt.',
        ...
        11: 'du wirst nämlich denken: ›Ich will zu Felde ziehen gegen ein Land von Bauernhöfen, will über friedliche Leute herfallen, die ruhig und sorglos leben; sie wohnen ja allesamt (in Ortschaften) ohne Mauern und haben keine Riegel und Tore.‹',
        12: '(Gegen diese gedenkst du zu ziehen,) um schonungslos zu rauben und Beute zu machen, um deine Hand an wiederbewohnte Trümmerstätten zu legen und an ein Volk, das aus den Heidenländern gesammelt worden ist, das sich Hab und Gut erworben hat und auf dem Nabel der Erde wohnt.',
        13: 'Seba und Dedan und ihre Kaufleute, Tharsis und all seine raubgierigen Löwen werden zu dir sagen: ›Bist du gekommen, um Beute zu machen? Hast du deine Scharen aufgeboten, um zu plündern, um Silber und Gold zu rauben, um Hab und Gut wegzunehmen, um reiche Beute zu machen?‹',
        ...
        17: 'So hat Gott der HERR (zu Gog) gesprochen: »Bist du es nicht, auf den ich in früheren Tagen durch den Mund meiner Knechte, der Propheten Israels, hingewiesen habe, die zu jener Zeit jahrelang geweissagt haben, daß ich dich gegen sie heranführen würde?',
        ...
        22: 'Und ich will das Strafgericht an ihm vollziehen durch Pest und Blutvergießen, durch Wolkenbrüche und Hagelsteine; Feuer und Schwefel will ich regnen lassen auf ihn und auf seine Kriegsscharen und auf die vielen Völker, die bei ihm sind.',
    ...
    40: {
        1: 'Im fünfundzwanzigsten Jahre unserer Verbannung, im Anfang des Jahres, am zehnten Tage des Monats, im vierzehnten Jahre nach der Eroberung der Stadt (Jerusalem) – an eben diesem Tage kam die Hand des HERRN über mich und brachte mich dorthin;',
        2: 'im Zustand der Verzückung führte er mich ins Land Israel und ließ mich auf einem sehr hohen Berge nieder, auf dessen Südseite sich ein Bauwerk nach Art einer Stadt befand.',
        ...
        5: 'Da sah ich eine Mauer, die außen den Tempel(-bezirk) rings umgab; der Meßstab aber, den der Mann in der Hand hielt, war sechs Ellen lang, jede Elle zu einer gewöhnlichen Elle und einer Handbreite gerechnet; mit diesem maß er die Breite des Mauerbaues: sie betrug eine Rute und die Höhe auch eine Rute.',
        ...
        7: 'sodann die (erste) Wachtstube: eine Rute lang und eine Rute breit, und den Raum zwischen den Wachtstuben: fünf Ellen; und die Schwelle des Tores neben der Vorhalle des Tores auf der Innenseite: eine Rute.',
        ...
        12: 'An der Vorderseite der Wachtstuben befand sich eine Einfriedigung von je einer Elle Breite auf dieser wie auf jener Seite, während die Wachtstube selbst sechs Ellen im Geviert maß.',
        ...
        14: 'Hierauf bestimmte er die Wandpfeiler zu sechzig Ellen, und an die Wandpfeiler stieß der Vorhof rings um das Torgebäude,',
        ...
        19: 'Dann maß er die Breite des Vorhofs von der inneren Vorderseite des unteren Tores bis zur Vorderseite des inneren Vorhofs nach außen zu: hundert Ellen [an der Ostseite und an der Nordseite].',
        ...
        21: 'Von seinen Wachtstuben lagen drei auf der einen und drei auf der andern Seite; und seine Wandpfeiler und seine Vorhalle hatten dieselben Maße wie das erste Tor: fünfzig Ellen betrug seine Länge und fünfundzwanzig Ellen seine Breite.',
        ...
        38: 'Auch eine Zelle war da, deren Eingang sich an den Pfeilern des Tores befand; dort hatte man das Brandopfer abzuspülen.',
        ...
        41: 'also vier Tische auf der einen Seite und vier Tische auf der andern Seite an der Seitenwand des Tores, zusammen acht Tische, auf denen man die Schlachtopfer schlachten sollte.',
