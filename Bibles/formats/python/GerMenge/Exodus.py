...
CHAPTERS = {
    ...
    6: {
        ...
        3: 'Ich bin dem Abraham, Isaak und Jakob als ›der allmächtige Gott‹ erschienen, aber mit meinem Namen ›Gott der HERR‹ habe ich mich ihnen nicht geoffenbart.',
        4: 'Auch habe ich meinen Bund mit ihnen geschlossen, ihnen das Land Kanaan zu geben, das Land ihrer Fremdlingschaft, in dem sie als Gäste sich aufgehalten haben.',
        5: 'Ich habe auch die Klagen der Israeliten gehört, die von den Ägyptern geknechtet werden, und habe meines Bundes gedacht.',
        ...
        20: 'Amram aber heiratete seine Muhme Jochebed; die gebar ihm Aaron und Mose; Amram wurde dann 137 Jahre alt.',
    ...
    7: {
        1: 'Da erwiderte der HERR dem Mose: »Siehe, ich mache dich für den Pharao zu einem Gott, und dein Bruder Aaron soll dein Prophet sein.',
        ...
        4: 'Wenn der Pharao nun auf euch nicht hört, so will ich meine Hand an die Ägypter legen und meine Heerscharen, mein Volk, die Israeliten, aus Ägypten unter gewaltigen Strafgerichten wegführen.',
    ...
    8: {
        ...
        11: 'Als aber der Pharao merkte, daß er Luft bekommen hatte, verstockte er sein Herz weiter und hörte nicht auf sie, wie der HERR es vorausgesagt hatte.',
    ...
    9: {
        ...
        9: 'Dann wird er sich als feiner Staub über das ganze Land Ägypten verbreiten und an Menschen und am Vieh zu Beulen werden, die als Geschwüre aufbrechen, im ganzen Lande Ägypten!«',
        10: 'Da nahmen sie Ofenruß und traten vor den Pharao, und Mose streute ihn himmelwärts; da wurde er zu Beulen, die als Geschwüre an den Menschen und am Vieh aufbrachen.',
        ...
        27: 'Da ließ der Pharao Mose und Aaron rufen und sagte zu ihnen: »Diesmal habe ich mich versündigt: der HERR ist im Recht, ich aber und mein Volk sind im Unrecht!',
    ...
    14: {
        ...
        8: 'Denn der HERR hatte das Herz des Pharaos, des Königs von Ägypten, verhärtet, so daß er die Israeliten verfolgte, obgleich diese mit hocherhobener Hand ausgezogen waren.',
    ...
    18: {
        ...
        3: 'samt ihren beiden Söhnen, von denen der eine Gersom hieß, weil Mose gesagt hatte: »Ein Gast bin ich in einem fremden Lande geworden«,',
        4: 'während der andere Elieser hieß, denn »der Gott meines Vaters ist meine Hilfe gewesen und hat mich vor dem Schwert des Pharaos errettet« –',
    ...
    20: {
        ...
        10: 'Aber der siebte Tag ist ein Feiertag zu Ehren des HERRN, deines Gottes: da darfst du keinerlei Geschäft verrichten, weder du selbst noch dein Sohn oder deine Tochter, weder dein Knecht, noch deine Magd, noch dein Vieh, noch der Fremdling, der bei dir in deinen Ortschaften weilt!',
    ...
    22: {
        ...
        2: 'wenn aber die Sonne zur Zeit der Tat über ihm schon aufgegangen war, so soll ein Mord für ihn als vorliegend angenommen werden.',
        ...
        27: 'Gott sollst du nicht lästern und einem Fürsten in deinem Volk nicht fluchen. –',
    ...
    26: {
        ...
        32: 'Du sollst ihn dann an vier mit Gold überzogenen Ständern von Akazienholz aufhängen, deren Haken von Gold sind und die auf vier silbernen Füßen stehen;',
    ...
    29: {
        ...
        2: 'ungesäuertes Brot und ungesäuerte, mit Öl gemengte Kuchen sowie ungesäuerte, mit Öl bestrichene Fladen; aus feinem Weizenmehl sollst du sie bereiten.',
        ...
        9: 'umgürte sie mit dem Gürtel [Aaron und seine Söhne] und laß sie die hohen Mützen aufsetzen, damit ihnen das Priestertum kraft einer ewig gültigen Einsetzung zusteht. Wenn du so Aaron und seine Söhne in ihr Amt eingesetzt hast,',
        ...
        21: 'Sodann nimm etwas von dem Blut, das sich auf dem Altar befindet, sowie von dem Salböl und besprenge mit ihm Aaron und seine Kleider, ebenso seine Söhne und deren Kleider, damit er und seine Kleider und ebenso seine Söhne und deren Kleider geheiligt sind.',
        ...
        24: 'lege dies alles dem Aaron und seinen Söhnen in die Hände und laß es als Webeopfer vor dem HERRN weben.',
        ...
        29: 'Die heiligen Kleider Aarons aber sollen nach ihm an seine Söhne kommen, damit man sie darin salbe und sie darin in ihr Amt einsetze.',
        ...
        33: 'sie sollen die Stücke verzehren, durch welche die Sühne für sie bewirkt wurde, als man sie in ihr Amt einsetzte und sie weihte; aber ein Fremder darf nicht davon essen, denn sie sind heilig.',
        ...
        39: 'Das eine Lamm sollst du am Morgen opfern, das andere gegen Abend,',
        40: 'und außerdem ein Zehntel Epha Feinmehl, das mit einem Viertel Hin Öl von zerstoßenen Oliven gemengt ist; und als Trankopfer soll ein Viertel Hin Wein zu dem einen Lamm kommen.',
        ...
        43: '»Ich will dort nämlich mit den Israeliten in Verkehr treten, und es (das Zelt) wird durch meine Herrlichkeit geheiligt werden.',
    ...
    31: {
        ...
        2: '»Wisse wohl: ich habe Bezaleel, den Sohn Uris, den Enkel Hurs, aus dem Stamme Juda, namentlich berufen',
        ...
        13: '»Du aber präge den Israeliten folgendes Gebot ein: ›Beobachtet ja meine Sabbate! Denn sie sind ein Zeichen (des Bundes) zwischen mir und euch für eure künftigen Geschlechter, damit ihr erkennt, daß ich, der HERR, es bin, der euch heiligt.',
    ...
    32: {
        ...
        4: 'Der nahm sie von ihnen in Empfang, bearbeitete das Gold mit dem Meißel und machte ein gegossenes Kalb daraus. Da riefen sie: »Dies ist dein Gott, Israel, der dich aus dem Land Ägypten hergeführt hat!«',
        ...
        12: 'Warum sollen die Ägypter sagen: ›In böser Absicht hat er sie hinausgeführt, um sie in den Bergen umkommen zu lassen und sie vom Erdboden zu vertilgen‹? Laß ab von deiner Zornesglut und laß dir das Unheil leid sein, das du deinem Volk zugedacht hast!',
    ...
    33: {
        ...
        21: 'Doch der HERR fuhr fort: »Siehe, es ist ein Platz neben mir: da magst du dich auf den Felsen stellen!',
    ...
    37: {
        ...
        3: 'Dann goß er für sie vier goldene Ringe und befestigte diese an ihren vier Ecken, und zwar zwei Ringe an ihrer einen Seite und zwei Ringe an ihrer andern Seite.',
        ...
        12: 'Außerdem brachte er an ihm ringsum noch eine Einfassung an, die eine Handbreite hoch war, und an dieser Einfassung wieder einen goldenen Kranz ringsherum.',
        ...
        18: 'Sechs Arme gingen von seinen beiden Seiten aus, drei Arme auf jeder Seite des Leuchters.',
        ...
        25: 'Weiter fertigte er den Räucheraltar aus Akazienholz an, eine Elle lang und eine Elle breit, viereckig, und zwei Ellen hoch; seine Hörner waren aus einem Stück mit ihm.',
    ...
    38: {
        1: 'Hierauf fertigte er den Brandopferaltar aus Akazienholz an, fünf Ellen lang und fünf Ellen breit, viereckig und drei Ellen hoch.',
        ...
        8: 'Hierauf verfertigte er das Becken aus Kupfer und sein Gestell gleichfalls aus Kupfer [aus den Spiegeln der diensttuenden Frauen, die am Eingang des Offenbarungszeltes den Dienst versahen].',
        ...
        10: 'dazu zwanzig Säulen nebst den zugehörigen zwanzig kupfernen Füßen; die Nägel der Säulen aber und die zugehörigen Ringbänder waren von Silber.',
