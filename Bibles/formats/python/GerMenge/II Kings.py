...
CHAPTERS = {
    1: {
        ...
        2: 'Als Ahasja aber in Samaria durch das Gitterfenster in seinem Obergemach gefallen war und krank darniederlag, sandte er Boten ab mit dem Auftrag: »Geht hin und befragt Baal-Sebub, den Gott von Ekron, ob ich von dieser Krankheit genesen werde.«',
    ...
    9: {
        ...
        2: 'Wenn du dort angekommen bist, so sieh dich daselbst nach Jehu um, dem Sohne Josaphats, des Sohnes Nimsis. Gehe dann zu ihm ins Haus, fordere ihn auf, aus dem Kreise seiner Genossen herauszutreten, und führe ihn in das innerste Gemach.',
        ...
        36: 'Als sie nun zurückkamen und es dem Jehu meldeten, rief er aus: »So lautet das Wort des HERRN, das er durch den Mund seines Knechtes Elia, des Thisbiters, hat verkünden lassen: ›Auf der Feldmark von Jesreel sollen die Hunde das Fleisch Isebels fressen,',
    ...
    12: {
        ...
        2: 'im siebten Jahre Jehus war er König geworden, vierzig Jahre regierte er in Jerusalem; seine Mutter hieß Zibja und stammte aus Beerseba.',
        3: 'Joas tat, was dem HERRN wohlgefiel, sein ganzes Leben lang, weil der Priester Jojada ihn beriet;',
        4: 'nur der Höhendienst wurde nicht beseitigt, sondern das Volk brachte immer noch Schlacht- und Rauchopfer auf den Höhen dar.',
        5: 'Joas ließ aber den Priestern die Weisung zugehen: »Alles Geld, das als Weihegabe in den Tempel des HERRN gebracht wird: das Geld, das jemand durch Schätzung auferlegt wird, ferner alles Geld, das jemand aus freien Stücken in den Tempel des HERRN bringt,',
        ...
        8: 'ließ der König Joas den Priester Jojada und die übrigen Priester zu sich kommen und sagte zu ihnen: »Warum habt ihr die Schäden am Tempel nicht ausgebessert? Fortan sollt ihr kein Geld mehr von euren Bekannten in Empfang nehmen, sondern sollt es für die Ausbesserung der Schäden am Tempel abliefern.«',
        ...
        10: 'Darauf nahm der Priester Jojada einen Kasten, ließ ein Loch in seinen Deckel bohren und ihn neben dem Malstein rechts vom Eingang in den Tempel des HERRN aufstellen; dahinein mußten die Priester, die an der Schwelle Wache hielten, alles Geld tun, das im Tempel des HERRN abgeliefert wurde.',
        11: 'Sooft sie nun wahrnahmen, daß viel Geld in dem Kasten war, kamen der Schreiber des Königs und der Hohepriester hinauf, banden das Geld, das sich im Tempel des HERRN vorfand, in einen Beutel zusammen und zählten es.',
        12: 'Dann händigten sie das abgezählte Geld den Werkführern ein, denen die Ausführung der Arbeiten am Tempel des HERRN übertragen war, und diese zahlten es an die Zimmerleute und an die übrigen Handwerker aus, die am Tempel des HERRN arbeiteten,',
        13: 'sowie an die Maurer und Steinmetzen und für den Ankauf von Hölzern und behauenen Steinen, um die Schäden am Tempel des HERRN auszubessern und überhaupt alle Kosten zu bestreiten, welche die Instandhaltung des Tempels verursachte.',
        14: 'Doch ließ man für den Tempel des HERRN keine silbernen Becken, Messer, Sprengschalen, Trompeten, kurz keinerlei goldene und silberne Geräte von dem Gelde anfertigen, das im Tempel des HERRN einging,',
        ...
        20: 'Die übrige Geschichte des Joas aber und alles, was er unternommen hat, das findet sich bekanntlich aufgezeichnet im Buch der Denkwürdigkeiten der Könige von Juda.',
        ...
        22: 'und zwar waren es seine Diener Josachar, der Sohn Simeaths, und Josabad, der Sohn Somers, die ihn ermordeten. Man begrub ihn dann bei seinen Vätern in der Davidsstadt, und sein Sohn Amazja folgte ihm in der Regierung nach.',
    },
    13: {
        1: 'Im dreiundzwanzigsten Regierungsjahre des Joas, des Sohnes des Königs Ahasja von Juda, wurde Joahas, der Sohn Jehus, König über Israel und regierte siebzehn Jahre in Samaria.',
        2: 'Er tat, was dem HERRN mißfiel, und wandelte in den Sünden Jerobeams, des Sohnes Nebats, der Israel zur Sünde verführt hatte; er ließ nicht davon ab.',
        3: 'Da entbrannte der Zorn des HERRN gegen Israel, so daß er sie in die Gewalt Hasaels, des Königs von Syrien, und in die Gewalt Benhadads, des Sohnes Hasaels, die ganze Zeit hindurch fallen ließ.',
        ...
        6: 'Dennoch gaben sie die Sünde des Hauses Jerobeams nicht auf, wozu dieser die Israeliten verführt hatte: sie hielten daran fest; sogar die Bildsäule der Aschera blieb in Samaria stehen.',
        ...
        8: 'Die übrige Geschichte des Joahas aber sowie alles, was er unternommen hat, und seine tapferen Taten, das findet sich bekanntlich aufgezeichnet im Buch der Denkwürdigkeiten der Könige von Israel.',
        9: 'Als Joahas sich dann zu seinen Vätern gelegt und man ihn in Samaria begraben hatte, folgte ihm sein Sohn Joas in der Regierung nach.',
        10: 'Im siebenunddreißigsten Jahre der Regierung des Joas, des Königs von Juda, wurde Joas, der Sohn des Joahas, König über Israel und regierte sechzehn Jahre in Samaria.',
        11: 'Er tat, was dem HERRN mißfiel; er ließ in keinem Stück von den Sünden Jerobeams, des Sohnes Nebats, ab, der Israel zur Sünde verführt hatte; nein, er hielt daran fest. –',
        12: 'Die übrige Geschichte des Joas aber sowie alles, was er unternommen hat, seine tapferen Taten (und) wie er mit Amazja, dem Könige von Juda, Krieg geführt hat, das findet sich bekanntlich aufgezeichnet im Buch der Denkwürdigkeiten der Könige von Israel. –',
        13: 'Als Joas sich dann zu seinen Vätern gelegt und Jerobeam als sein Nachfolger den Thron bestiegen hatte, wurde Joas in Samaria bei den Königen von Israel begraben.',
        14: 'Als Elisa aber an der Krankheit darniederlag, an der er sterben sollte, kam Joas, der König von Israel, zu ihm hinab, weinte über ihm und rief aus: »Mein Vater, mein Vater! Du Wagen Israels und seine Reiter!«',
        15: 'Da sagte Elisa zu ihm: »Hole einen Bogen und Pfeile!«, und als er ihm einen Bogen und Pfeile geholt hatte,',
        16: 'sagte er zum König von Israel: »Lege deine Hand auf den Bogen!« Als er es getan hatte, legte Elisa seine Hände auf die Hände des Königs',
        ...
        19: 'Da wurde der Gottesmann unwillig über ihn und sagte: »Du hättest fünf- oder sechsmal schlagen sollen, dann hättest du die Syrer bis zur Vernichtung geschlagen; nun aber wirst du die Syrer nur dreimal schlagen!«',
        ...
        24: 'Als daher Hasael, der König von Syrien, gestorben und sein Sohn Benhadad ihm in der Regierung nachgefolgt war,',
        25: 'entriß Joas, der Sohn des Joahas, dem Benhadad, dem Sohne Hasaels, die Städte wieder, die dieser seinem Vater Joahas im Kriege entrissen hatte. Dreimal schlug ihn Joas und gewann so die israelitischen Städte zurück.',
    },
    14: {
    ...
    18: {
        ...
        11: 'Der König von Assyrien führte dann die Israeliten in die Gefangenschaft nach Assyrien und verpflanzte sie nach Halah und an den Habor, den Fluß Gosans, und in die Ortschaften der Meder,',
    ...
    19: {
        ...
        20: 'Da sandte Jesaja, der Sohn des Amoz, zu Hiskia und ließ ihm sagen: »So hat der HERR, der Gott Israels, gesprochen: ›Was das Gebet betrifft, das du wegen Sanheribs, des Königs von Assyrien, an mich gerichtet hast, so habe ich es gehört.‹',
        21: 'Folgenden Ausspruch hat der HERR über ihn getan: ›Es verachtet dich, es spottet deiner die jungfräuliche Tochter Zion; hinter dir her schüttelt das Haupt die Tochter Jerusalem!',
        22: 'Wen hast du geschmäht und gelästert und gegen wen deine Stimme erhoben und deine Augen hochmütig emporgerichtet? Gegen den Heiligen Israels!',
        ...
        24: 'Ich grabe den Erdboden auf und trinke Wasser und mache andrerseits mit der Sohle meiner Füße versiegen alle Nilarme Ägyptens! –',
        25: 'Hast du es nicht gehört? Von lange her habe ich es festgesetzt und seit den Tagen der Vorzeit es vorbereitet, nunmehr aber es eintreten lassen, daß du feste Städte zu wüsten Steinhaufen verheeren solltest,',
        26: 'und ihre Bewohner, deren Arm zu kurz war, sollten erschreckt dastehen und zuschanden werden, sollten wie Kraut des Feldes und grünender Rasen sein, wie Gras auf den Dächern und wie Getreide, das versengt ist, ehe es aufschießt.',
        27: 'Mir ist dein Aufstehen und dein Sitzen offenbar, dein Gehen und Kommen kenne ich wohl, auch dein Toben wider mich.',
        28: 'Weil du nun wider mich tobst und dein Großtun zu meinen Ohren aufgestiegen ist, will ich dir meinen Ring in die Nase legen und meinen Zaum an deine Lippen und will dich auf dem Wege zurückkehren lassen, auf dem du hergekommen bist.‹',
        29: 'Folgendes aber möge dir, Hiskia, als Wahrzeichen dienen: In diesem Jahr wird man den Brachwuchs essen und im nächsten Jahre den Wurzelwuchs; im dritten Jahre aber sollt ihr säen und ernten, sollt ihr Weinberge anlegen und ihren Ertrag genießen.',
        30: 'Was dann vom Hause Juda entronnen und als Rest übriggeblieben ist, wird aufs neue unten Wurzel treiben und oben Früchte tragen;',
        31: 'denn von Jerusalem wird ein Überrest ausgehen und eine Schar Entronnener vom Berge Zion; der Eifer des HERRN der Heerscharen wird dies vollführen!',
        32: 'Darum hat der HERR in bezug auf den König von Assyrien so gesprochen: ›Er soll nicht in diese Stadt hineinkommen und keinen Pfeil hineinschießen; er soll mit keinem Schild gegen sie anrücken und keinen Wall gegen sie aufführen!',
        33: 'Nein, auf dem Wege, auf dem er gekommen ist, soll er zurückkehren und in diese Stadt nicht eindringen!‹ – so lautet der Ausspruch des HERRN.',
        34: '›Ja, ich will diese Stadt beschirmen, um sie zu erretten, um meiner selbst willen und um meines Knechtes David willen!‹«',
        35: 'In derselben Nacht aber ging der Engel des HERRN aus und ließ im Lager der Assyrer 185000 Mann sterben; und als man am Morgen früh aufstand, fand man sie alle tot als Leichen vor.',
        36: 'Da brach Sanherib, der König von Assyrien, auf und zog ab; er kehrte nach Hause zurück und nahm seinen Wohnsitz in Ninive.',
        37: 'Als er aber dort (einmal) im Tempel seines Gottes Nisroch anbetete, erschlugen ihn seine Söhne Adrammelech und Sarezer mit dem Schwert; sie entflohen dann ins Land Ararat, und sein Sohn Esarhaddon folgte ihm als König in der Regierung nach.',
    },
    20: {
        1: 'Als Hiskia in jenen Tagen auf den Tod erkrankte, begab sich der Prophet Jesaja, der Sohn des Amoz, zu ihm und sagte zu ihm: »So hat der HERR gesprochen: ›Bestelle dein Haus, denn du mußt sterben und wirst nicht wieder gesund werden!‹«',
        2: 'Da kehrte er sein Gesicht gegen die Wand hin und betete zum HERRN:',
        3: '»Ach, HERR! Denke doch daran, wie ich in Treue und mit ungeteiltem Herzen vor deinem Angesicht gewandelt bin und getan habe, was dir wohlgefällt!« Hierauf brach Hiskia in heftiges Weinen aus.',
        4: 'Als nun Jesaja den inneren Vorhof des Palastes noch nicht verlassen hatte, da erging das Wort des HERRN an ihn folgendermaßen:',
        ...
        6: 'Ich will dann zu deinen Lebenstagen noch fünfzehn Jahre hinzufügen; dazu will ich dich und diese Stadt aus der Gewalt des Königs von Assyrien erretten und diese Stadt beschirmen um meinetwillen und um meines Knechtes David willen.‹«',
        7: 'Darauf sagte Jesaja: »Bringt ein Feigenpflaster her!« Da holten sie ein solches und legten es auf das Geschwür: da wurde er gesund.',
        8: 'Als Hiskia aber Jesaja fragte: »Welches ist das Wahrzeichen dafür, daß der HERR mich heilen wird und daß ich übermorgen zum Tempel des HERRN hinaufgehen kann?«',
        ...
        11: 'Da rief der Prophet Jesaja den HERRN an, und dieser ließ den Schatten an den Stufen, welche (die Sonne) auf den Stufen des Sonnenzeigers des Ahas bereits hinabgestiegen war, um zehn Stufen rückwärts gehen.',
        12: 'Zu jener Zeit sandte Merodach-Baladan, der Sohn Baladans, der König von Babylon, ein Schreiben und ein Geschenk an Hiskia; er hatte nämlich gehört, daß Hiskia krank gewesen war.',
        13: 'Hiskia hörte sie (die Gesandten) gern an und zeigte ihnen sein ganzes Schatzhaus: das Silber und das Gold, die Spezereien und das kostbare Öl, sein ganzes Zeughaus und überhaupt alles, was sich in seinen Schatzhäusern vorfand; es gab nichts in seinem Palast und im ganzen Bereich seiner Herrschaft, was Hiskia ihnen nicht gezeigt hätte.',
        14: 'Da begab sich der Prophet Jesaja zum König Hiskia und fragte ihn: »Was haben diese Männer gewollt, und woher sind sie gekommen?« Hiskia antwortete: »Aus einem fernen Lande sind sie gekommen, aus Babylon.«',
        15: 'Darauf fragte jener: »Was haben sie in deinem Palast zu sehen bekommen?« Hiskia antwortete: »Alles, was in meinem Palast ist, haben sie zu sehen bekommen; es gibt in meinen Schatzhäusern nichts, was ich ihnen nicht gezeigt hätte.«',
        16: 'Da sagte Jesaja zu Hiskia: »Vernimm das Wort des HERRN:',
        ...
        18: '›und von deinen leiblichen Söhnen, die dir geboren werden, wird man einige nehmen, damit sie im Palast des Königs von Babylon als Kämmerlinge dienen.‹«',
        ...
        20: 'Die übrige Geschichte Hiskias aber und alle seine Herrschermacht und wie er den Teich und die Wasserleitung angelegt und das Wasser in die Stadt geleitet hat, das findet sich bekanntlich aufgezeichnet im Buch der Denkwürdigkeiten der Könige von Juda.',
        21: 'Als Hiskia sich dann zu seinen Vätern gelegt hatte, folgte ihm sein Sohn Manasse als König in der Regierung nach.',
    },
    21: {
    ...
    23: {
        1: 'Als sie nun dem König Bericht erstattet hatten, sandte der König Boten aus, daß sie alle Ältesten von Juda und Jerusalem bei ihm versammelten.',
        2: 'Hierauf ging der König zum Tempel des HERRN hinauf und mit ihm alle Männer von Juda und alle Bewohner Jerusalems, auch die Priester und die Propheten, überhaupt das ganze Volk, klein und groß; und er las ihnen den ganzen Inhalt des Bundesbuches vor, das man im Tempel des HERRN gefunden hatte.',
        3: 'Hierauf trat der König an die Säule und schloß den Bund vor dem HERRN, daß sie dem HERRN nachwandeln und seine Gebote, seine Verordnungen und seine Satzungen mit ganzem Herzen und mit ganzer Seele beobachten wollten, um so den Bestimmungen dieses Bundes, die in diesem Buche geschrieben standen, Geltung zu verschaffen. Und das gesamte Volk trat dem Bunde bei.',
        ...
        6: 'Ferner ließ er das Standbild der Aschera aus dem Tempel des HERRN hinaus vor die Tore Jerusalems in das Kidrontal schaffen und es dort verbrennen und zu Staub zerstampfen und den Staub davon auf die Gräber der gemeinen Leute werfen.',
        7: 'Sodann ließ er die Stuben der Heiligtumsbuhler niederreißen, die sich im Tempel des HERRN befanden und in denen die Weiber Hüllen für Astarte zu weben pflegten.',
        8: 'Weiter ließ er alle Priester aus den Ortschaften Judas kommen und die Höhen entweihen, auf denen die Priester geopfert hatten, von Geba bis Beerseba; auch ließ er die Höhen der Bocksgestalten niederreißen, die am Eingang des Tores des Stadthauptmannes Josua auf der linken Seite standen, wenn man zum Stadttor hineinging.',
        ...
        11: 'Ferner ließ er die Rosse beseitigen, welche die Könige von Juda zu Ehren des Sonnengottes am Eingang zum Tempel des HERRN in der Richtung nach der Zelle des Kämmerers Nethan-Melech, im Parwarim aufgestellt hatten, und ließ den Sonnenwagen im Feuer verbrennen.',
        ...
        13: 'Auch die Höhen, die östlich von Jerusalem, südlich vom Unheilsberge lagen, die der König Salomo von Israel zu Ehren der Astarte, des greulichen Götzen der Sidonier, und für Kamos, das Scheusal der Moabiter, und für Milkom, den greulichen Götzen der Ammoniter, errichtet hatte, ließ der König entweihen;',
        14: 'ebenso zertrümmerte er die Malsteine und ließ die Götzenbäume umhauen und ihren Platz mit Menschengebeinen anfüllen.',
        15: 'Aber auch den Altar zu Bethel, die Höhe, welche Jerobeam, der Sohn Nebats, der Israel zur Sünde verführte, hergestellt hatte, auch diesen Altar samt der Höhe ließ er niederreißen; er verwüstete die Höhe mit Feuer, zermalmte sie zu Staub und verbrannte das Standbild der Aschera.',
        16: 'Als Josia dabei umherblickte und die Gräber dort am Bergabhang wahrnahm, sandte er Leute hin, ließ die Gebeine aus den Gräbern herausnehmen und auf dem Altar verbrennen und entweihte ihn auf diese Weise gemäß der Drohung des HERRN, die der Gottesmann einst ausgesprochen hatte, der diese Dinge voraussagte.',
        17: 'Als er dann fragte: »Was ist das für ein Grabmal, das ich dort sehe?«, antworteten ihm die Leute der Stadt: »Das ist das Grab des Gottesmannes, der aus Juda gekommen war und das angesagt hat, was du jetzt am Altar von Bethel getan hast.«',
        ...
        19: 'Außerdem beseitigte Josia auch alle Höhenheiligtümer, die sich in den Ortschaften Samarias befanden und die von den israelitischen Königen angelegt waren, um (den HERRN) zum Zorn zu reizen; er verfuhr mit ihnen gerade so, wie er zu Bethel verfahren war.',
        ...
        21: 'Hierauf ließ der König folgenden Befehl an das ganze Volk ergehen: »Feiert das Passahfest zu Ehren des HERRN, eures Gottes, so wie es in diesem Bundesbuche geschrieben steht!«',
        22: 'Denn ein solches Passah wie dieses war nicht gefeiert worden seit der Zeit der Richter, die in Israel gewaltet hatten, und während der ganzen Zeit der Könige von Israel und der Könige von Juda;',
        23: 'vielmehr erst im achtzehnten Regierungsjahre des Königs Josia wurde dieses Passah zu Ehren des HERRN in Jerusalem begangen.',
        24: 'Außerdem rottete Josia auch die Totenbeschwörer und Zeichendeuter, die Hausgötter und die Götzen, überhaupt alle Abgötter aus, die im Lande Juda und in Jerusalem zu sehen waren, um den Bestimmungen des Gesetzes nachzukommen, die in dem Buch, das der Priester Hilkia im Tempel des HERRN gefunden hatte, geschrieben standen.',
        ...
        27: 'Daher sprach der HERR: »Auch Juda will ich mir aus den Augen schaffen, wie ich Israel verstoßen habe, und will diese Stadt verwerfen, die ich einst erwählt hatte, Jerusalem, und das Haus, von dem ich einst gesagt hatte, mein Name solle daselbst wohnen.«',
        28: 'Die übrige Geschichte Josias aber und alles, was er unternommen hat, das findet sich bekanntlich aufgezeichnet im Buch der Denkwürdigkeiten der Könige von Juda.',
        ...
        31: 'Im Alter von dreiundzwanzig Jahren wurde Joahas König und regierte drei Monate in Jerusalem; seine Mutter hieß Hamutal und war die Tochter Jeremias von Libna.',
        32: 'Er tat, was dem HERRN mißfiel, ganz so wie seine Väter getan hatten.',
        33: 'Der Pharao Necho aber ließ ihn zu Ribla in der Landschaft Hamath ins Gefängnis werfen, damit er nicht länger König in Jerusalem wäre, und legte dem Lande eine Geldbuße von hundert Talenten Silber und einem Talent Gold auf.',
        ...
        37: 'Er tat, was dem HERRN mißfiel, ganz so wie seine Väter getan hatten.',
    },
    24: {
