...
CHAPTERS = {
    1: {
        ...
        33: 'und er wird als König über das Haus Jakobs in alle Ewigkeit herrschen, und sein Königtum wird kein Ende haben.«',
        ...
        55: 'wie er es unsern Vätern verheißen hat, dem Abraham und seinen Nachkommen in Ewigkeit.«',
    ...
    13: {
        ...
        30: 'Und wisset wohl: Es gibt Letzte, die werden Erste sein, und es gibt Erste, die werden Letzte sein.«',
