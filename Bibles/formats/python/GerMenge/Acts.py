...
CHAPTERS = {
    ...
    4: {
        ...
        11: 'Dieser (Jesus) ist der von euch Bauleuten verworfene Stein, der zum Eckstein geworden ist;',
        ...
        25: 'du hast durch den heiligen Geist zu unsern Vätern durch den Mund Davids, deines Knechtes, gesagt: ›Was soll das Toben der Heiden und das eitle Sinnen der Völker?',
    ...
    15: {
        ...
        15: 'Und damit stimmen die Worte der Propheten überein; denn es steht geschrieben:',
    ...
    19: {
        ...
        40: 'Droht uns doch wegen der heutigen Vorkommnisse sogar eine Anklage wegen Aufruhrs, weil kein Grund vorliegt, mit dem wir diesen Aufruhr rechtfertigen könnten.« Durch diese Worte brachte er die Versammlung zum Auseinandergehen.',
    },
    20: {
    ...
    21: {
        ...
        8: 'Am nächsten Morgen zogen wir weiter und kamen nach Cäsarea, wo wir bei dem Evangelisten Philippus, einem der sieben, einkehrten und bei ihm blieben.',
    ...
    22: {
        ...
        20: 'und als das Blut deines Zeugen Stephanus vergossen wurde, da habe auch ich dabeigestanden und Freude daran gehabt und Wache bei den Mänteln derer gehalten, die ihn ums Leben brachten.‹',
