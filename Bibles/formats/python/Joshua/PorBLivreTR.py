...
CHAPTERS = {
    ...
    2: {
        ...
        9: 'Sê que o SENHOR vos deu esta terra; porque o temor de vós caiu sobre nós, e todos os moradores do país estão desmaiados por causa de vós;',
        ...
        24: 'E disseram a Josué: O SENHOR entregou toda a terra em nossas mãos; e também todos os moradores do país estão desmaiados diante de nós.',
    },
    3: {
    ...
    6: {
        ...
        13: 'E os sete sacerdotes, levando as sete trombetas de chifres de carneiros, foram diante da arca do SENHOR, andando sempre e tocando as trombetas; e os armados iam diante deles, e a gente reunida ia detrás da arca do SENHOR, andando e tocando l',
    ...
    13: {
        ...
        6: 'Todos os que habitam nas montanhas desde o Líbano até as águas quentes, todos os sidônios; eu os desarraigarei diante dos filhos de Israel: somente repartirás tu por sorte o país aos israelitas por herança, como te mandei.',
    ...
    18: {
        ...
        8: 'Levantando-se, pois, aqueles homens, foram: e mandou Josué aos que iam para demarcar a terra, dizendo-lhes: Ide, percorrei a terra, e demarcai-a, e voltai a mim, para que eu vos lance as sortes aqui diante do SENHOR em Siló.',
    ...
    22: {
        ...
        22: 'O Deus dos deuses, o SENHOR, o Deus dos deuses, o SENHOR, ele sabe, e saberá Israel: se por rebelião ou por transgressão contra o SENHOR (não nos salves hoje,)',
        23: 'Edificamos para nós altar para deixarmos de seguir o SENHOR, ou para sacrificar holocausto ou presente, ou para fazer sobre ele sacrifícios pacíficos, o mesmo o SENHOR nos demande isso.',
        24: 'E se não o fizemos por temor disto, dizendo: Amanhã vossos filhos dirão a nossos filhos: Que tendes vós com o SENHOR o Deus de Israel?',
        25: 'O SENHOR pôs por termo o Jordão entre nós e vós, ó filhos de Rúben e filhos de Gade; não tendes vós parte no SENHOR: e assim vossos filhos farão que nossos filhos não temam ao SENHOR.',
        26: 'Por isto dissemos: Façamos agora para edificar-nos um altar, não para holocausto nem para sacrifício,',
        27: 'Mas sim para que seja um testemunho entre nós e vós, e entre os que virão depois de nós, de que podemos fazer o serviço do SENHOR diante dele com nossos holocaustos, com nossos sacrifícios, e com nossos pacíficos; e não digam amanhã vossos filhos aos nossos: Vós não tendes parte com o SENHOR.',
        28: 'Nós, pois, dissemos: Se acontecer que tal digam a nós, ou a nossas gerações no porvir, então responderemos: Olhai a réplica do altar do SENHOR, o qual fizeram nossos pais, não para holocaustos ou sacrifícios, mas sim para que fosse testemunho entre nós e vós.',
        29: 'Nunca tal aconteça que nos rebelemos contra o SENHOR, ou que nos apartemos hoje de seguir ao SENHOR, edificando altar para holocaustos, para presente, ou para sacrifício, a mais do altar do SENHOR nosso Deus que está diante de seu tabernáculo.',
        ...
        31: 'E disse Fineias filho do sacerdote Eleazar, aos filhos de Rúben, aos filhos de Gade, e aos filhos de Manassés: Hoje temos entendido que o SENHOR está entre nós, pois que não intentastes esta traição contra o SENHOR. Agora livrastes aos filhos d',
        32: 'E Fineias filho do sacerdote Eleazar, e os príncipes, voltaram da presença dos filhos de Rúben, e da presença dos filhos de Gade, da terra de Gileade à terra de Canaã, aos filhos de Israel: aos quais deram a resposta.',
        33: 'E o negócio pareceu bem aos filhos de Israel, e bendisseram a Deus os filhos de Israel; e não falaram mais de subir contra eles em guerra, para destruir a terra em que habitavam os filhos de Rúben e os filhos de Gade.',
