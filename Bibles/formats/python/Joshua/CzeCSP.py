...
CHAPTERS = {
    1: {
        ...
        15: 'dokud Hospodin ne dá odpočinek vašim bratrům tak jako vám a dokud ne obsadí také oni zemi, kterou jim dává Hospodin, váš Bůh. Potom se navrátíte do země, kterou jste obsadili vy, a obsadíte, co vám Mojžíš, otrok Hospodinův, dal na druhé straně Jordánu na východu slunce.',
    ...
    2: {
        1: 'I poslal Jozue, syn Núnův, ze Šitímu tajně dva zvědy se slovy: Jděte, prohlédněte si tu zemi i Jericho. Šli tedy, přišli do domu prostitutky jménem Rachab a ulehli tam.',
        ...
        5: 'Za tmy, když nastal čas zavřít bránu, ti muži odešli. Nevím, kam šli. Rychle je pronásledujte; však je dostihnete.',
        6: 'Ona je pak vyvedla na střechu a ukryla je mezi snopky lnu, které měla na střeše rozprostřené.',
        ...
        9: 'A řekla těm mužům: Poznala jsem, že vám Hospodin dal zemi, že na nás padla hrůza ⌈ z vás⌉ a že kvůli vám všichni obyvatelé země ⌈propadli malomyslnosti.⌉',
        10: 'Vždyť jsme slyšeli, jak před vámi Hospodin nechal vyschnout vody Rákosového moře, když jste vycházeli z Egypta, a co jste udělali dvěma emorejským králům, kteří sídlili na druhé straně Jordánu, Síchonovi a Ógovi; jak jste je zasvětili zkáze.',
        ...
        20: 'Jestliže však vyzradíš tuto naši úmluvu, budeme zproštěni tvé přísahy, jíž jsi nás zapřisáhla.',
        21: 'Nato řekla: Tak to bude, podle vašich slov. Propustila je a oni šli. Potom přivázala do okna karmínový provázek.',
        22: 'Tak šli, až došli na to pohoří a zůstali tam tři dny, dokud se pronásledovatelé ne vrátili. Ačkoliv pronásledovatelé ⌈prohledali celou cestu,⌉ nikoho nenašli.',
        ...
        24: 'A řekli Jozuovi: Hospodin vydal do naší ruky celou zemi a také všichni obyvatelé té země z nás ⌈propadli malomyslnosti.⌉',
    },
    3: {
    ...
    6: {
        ...
        2: 'Ale Hospodin Jozuovi řekl: Pohleď, vydal jsem ti do ruky Jericho i jeho krále s udatnými hrdiny.',
        3: 'Obejdete tedy město. Všichni bojovníci ať to město jednou obkrouží. Takto to budeš dělat šest dnů.',
        ...
        6: 'Jozue, syn Núnův, tedy svolal kněze a řekl jim: Pozdvihněte truhlu smlouvy. Sedm kněží pak pozdvihne sedm beraních rohů před Hospodinovou truhlou.',
        7: 'Potom řekl lidu: Jděte a obejděte město a vojsko ať projde před Hospodinovou truhlou.',
        8: 'I stalo se, jak to Jozue lidu řekl. Sedm kněží nesoucích sedm beraních rohů prošlo před Hospodinem, troubili na rohy a truhla Hospodinovy smlouvy šla za nimi.',
        9: 'Vojsko šlo před kněžími troubícími na rohy a shromáždění se ubíralo za truhlou, tak šli a troubili na rohy.',
        10: 'Lidu pak Jozue přikázal: Nebudete křičet, ani ne necháte zaznít svůj hlas a z vašich úst nevyjde slovo až do dne, kdy vám řeknu: Křičte. Pak budete křičet.',
        11: 'Nechal tehdy obejít Hospodinovu truhlu kolem města jednou dokola. Potom přišli do tábora a přenocovali v táboře.',
        12: 'Jozue časně zrána vstal a kněží pozdvihli Hospodinovu truhlu.',
        13: 'A sedm kněží nesoucích sedm beraních rohů před Hospodinovou truhlou stále šlo, troubili na rohy a vojsko šlo před nimi. Shromáždění šlo stále za Hospodinovou truhlou, troubíc na rohy.',
        ...
        16: 'I stalo se, když kněží po sedmé zatroubili na rohy, že Jozue řekl lidu: Spusťte křik, protože Hospodin vám město vydal.',
        17: 'A to město bude zasvěceno zkáze pro Hospodina, ono i každý, kdo je v něm. Pouze Rachab, ta prostitutka, zůstane naživu, ona a každý, kdo je s ní v domě, neboť ukryla posly, které jsme poslali.',
        18: 'Hlavně ⌈se ale chraňte před klatbou, ať nevykonáte klatbu, ne vezmete z klatby, ne vystavíte klatbě⌉ izraelský tábor a ne uvalíte na něj zkázu.',
        19: 'A veškeré stříbro, zlato a bronzové a železné nádoby jsou svaté pro Hospodina. Půjde to na Hospodinův poklad.',
        ...
        24: 'Potom spálili ohněm to město i všechno, co v něm bylo. Pouze stříbro, zlato a bronzové a železné nádoby zanechali na poklad Hospodinova domu.',
        ...
        26: 'I zapřisáhl se Jozue v onen čas: ⌈Prokletý je před Hospodinem⌉ ten muž, který povstane a vystaví toto město Jericho. Na svém prvorozeném položí jeho základy a na svém nejmenším postaví jeho vrata.',
        27: 'A Hospodin byl s Jozuem a pověst o něm se rozšířila do celé té země.',
    },
    7: {
        1: 'Synové Izraele se však zpronevěřili věrolomností při klatbě. Akán, syn Karmího, syna Zabdího, syna Zeracha z pokolení Judova, vzal z toho, co bylo zasvěceno zkáze, a Hospodinův hněv vzplanul proti synům Izraele.',
        ...
        3: 'Když se vrátili k Jozuovi, řekli mu: Ať netáhne všechen lid. Asi dva tisíce nebo tři tisíce mužů ať vytáhnou a pobijí Aj. ⌈Nevyčerpávej všechen lid, vždyť je jich tam málo.⌉',
        ...
        6: 'Tu Jozue roztrhl své roucho a padl tváří k zemi před Hospodinovou truhlou až do večera, on a izraelští starší, a házeli si prach na hlavu.',
        7: 'A Jozue řekl: ⌈Ach, Panovníku Hospodine,⌉ proč jsi vlastně převedl tento lid přes Jordán? Abys nás vydal do ruky Emorejců k naší záhubě? Kéž bychom se byli odhodlali a zůstali na druhé straně Jordánu.',
        8: 'Dovol Panovníku, co mám říci potom, co se Izrael ⌈dal na útěk⌉ před svými nepřáteli?',
        9: 'Až to uslyší Kenaanci a všichni obyvatelé té země, obklíčí nás a vyhladí naše jméno ze země. Co pak učiníš pro své veliké jméno?',
        10: 'Nato Hospodin Jozuovi řekl: Vstaň, proč takhle ležíš na tváři?',
        ...
        13: 'Vstaň, posvěť lid a řekneš: Posvěťte se na zítra, protože toto řekl Hospodin, Bůh Izraele: Uprostřed tebe, Izraeli, je to, co je zasvěceno zkáze. Nemůžeš obstát před svými nepřáteli, dokud neodstraníte věc zasvěcenou zkáze ze svého středu.',
        14: 'Budete tedy ráno přistupovat podle svých kmenů a zůstane ten kmen, který Hospodin označí. Bude přistupovat po čeledích a ta čeleď, kterou Hospodin označí, bude přistupovat po rodinách a ta rodina, kterou Hospodin označí, bude přistupovat po mužích.',
        15: 'A kdo bude označen kvůli klatbě, bude spálen ohněm, on i všechno, co mu patří, protože přestoupil Hospodinovu smlouvu a protože se dopustil v Izraeli bláznovství.',
        ...
        19: 'Jozue Akánovi řekl: Můj synu, přiznej přece slávu Hospodinu, Bohu Izraele, vzdej mu chválu a oznam mi konečně, co jsi spáchal. Nezatajuj to přede mnou.',
        20: 'Akán Jozuovi odpověděl. Řekl: Proti Hospodinu, Bohu Izraele, jsem opravdu zhřešil já a udělal jsem to a to.',
        ...
        23: 'Tak ty věci zprostřed stanu vzali, přinesli je k Jozuovi a ke všem synům Izraele a vysypali je před Hospodinem.',
        ...
        25: 'Jozue řekl: Jakou zkázu jsi uvalil na nás, takovou zkázu uvalí Hospodin v tento den na tebe. Všechen Izrael na něho házel kamení. Spálili je ohněm a ukamenovali je.',
        26: 'Potom na něj postavili velkou haldu kamení až do tohoto dne. Hospodin se odvrátil od svého planoucího hněvu; kvůli tomu nazval ono místo jménem údolí Akór až do tohoto dne.',
    },
    8: {
    ...
    10: {
        ...
        13: 'Tu slunce zůstalo stát a měsíc se zastavil, dokud se národ ne pomstil svým nepřátelům. Což není zapsáno v knize Jašarově: I zastavilo se slunce v polovině nebes a nespěchalo k západu po celý den?',
    ...
    22: {
        ...
        20: 'Cožpak se Akán, syn Zerachův, nezpronevěřil věrolomností při klatbě a na celou izraelskou obec ne dopadlo ⌈rozhořčení a ten muž sám nevydechl ⌈kvůli své zvrácenosti⌉ naposled?⌉',
    ...
    24: {
        ...
        2: 'Jozue řekl všemu lidu: Toto praví Hospodin, Bůh Izraele: Vaši otcové pobývali odedávna na druhé straně řeky Eufratu -- Terach, otec Abrahamův a otec Náchorův -- a sloužili jiným bohům.',
        3: 'Vzal jsem vašeho otce Abrahama z druhé strany řeky a provedl jsem jej celou kenaanskou zemí, rozmnožil jsem jeho potomstvo a dal jsem mu Izáka.',
        ...
        6: 'Když jsem vyvedl vaše otce z Egypta, přišli jste k moři a Egypťané vaše otce pronásledovali s vozbou a na koních k Rákosovému moři.',
        ...
        9: 'Potom povstal ⌈moábský král Balák, syn Sipórův,⌉ bojoval proti Izraeli, poslal pro Bileáma, syna Beórova, a povolal ho, aby vás proklel.',
        10: 'Nechtěl jsem však Bileáma slyšet, a tak vám stále žehnal a já jsem vás vysvobodil z jeho ruky.',
        ...
        12: 'Poslal jsem před vámi děs a vyhnal je před vámi, dva emorejské krále, nikoli vaším mečem ani vaším lukem.',
        13: 'Dal jsem vám zemi, ve které ses nenamáhal a města, která jste nestavěli, a usadili jste se v nich. Jíte z vinic a olivových hájů, které jste nesázeli.',
        ...
        15: 'Jestliže je však ve vašich očích nežádoucí, abyste sloužili Hospodinu, vyberte si dnes, komu budete sloužit: Zda bohům, kterým sloužili vaši otcové, když byli za řekou, nebo zda bohům Emorejců, když sídlíte v jejich zemi. Já a můj dům budeme sloužit Hospodinu.',
        ...
        29: 'I stalo se po těchto událostech, že Jozue, syn Núnův, otrok Hospodinův, zemřel ve věku sto deseti let.',
        30: 'A pohřbili ho na území jeho dědictví v Timnat–serachu, který je v efrajimském pohoří severně od hory Gaaše.',
        31: 'Izrael sloužil Hospodinu po všechny Jozuovy dny a po všechny dny starších, kteří ⌈Jozua přežili⌉ a kteří znali celé Hospodinovo dílo, jež vykonal pro Izrael.',
        32: 'Josefovy kosti, které vynesli synové Izraele z Egypta, pohřbili v Šekemu na dílu pole, který koupil Jákob od synů Chamóra, otce Šekemova, za sto kesít, a dostaly se synům Josefovým do dědictví.',
        33: 'Zemřel i Eleazar, syn Áronův, a pohřbili jej na návrší jeho syna Pinchasa, které mu bylo dáno v efrajimském pohoří.',
    },
}
