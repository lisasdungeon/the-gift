...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'og sa: Jeg kalte på Herren i min nød, og han svarte mig; fra dødsrikets skjød ropte jeg, du hørte min røst.',
    ...
    4: {
        1: 'Men det syntes Jonas meget ille om, og hans vrede optendtes.',
