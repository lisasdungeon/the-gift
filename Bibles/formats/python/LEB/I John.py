...
CHAPTERS = {
    ...
    5: {
        ...
        7: 'For there are three that testify,Later Latin manuscripts add the following words to v. 7 and v. 8: “in heaven, the Father, the Word, and the Holy Spirit, and these three are one.',
        8: 'And there are three that testify on earth” the Spirit and the water and the blood, and the three are ⌞in agreement⌟.',
