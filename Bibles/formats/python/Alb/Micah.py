...
CHAPTERS = {
    ...
    3: {
        1: 'Unë thashë: "Ah, dëgjoni, o krerë të Jakobit, dhe ju qeveritarë të shtëpisë së Izraelit: a nuk ju takon vallë juve të njihni drejtësinë?',
        2: 'Ju që urreni të mirën dhe doni të keqen, që ju hiqni lëkurën nga trupi dhe mishin nga kockat e tyre.',
        3: 'Ata hanë mishin e popullit tim, i heqin lëkurën nga trupi, i thyejnë kockat dhe e presin në copa sikur do të shkonte në tenxhere, si mishi që vihet në kazan.',
        4: "Atëherë do t'i këlthasin Zotit, por ai nuk do t'u përgjigjet; në atë kohë ai do t'ua fshehë fytyrën e tij, sepse kanë qenë të këqij në veprimet e tyre.",
        5: 'Kështu thotë Zoti për profetët që e bëjnë popullin tim të largohet nga rruga e tij, që bërtasin: "Paqe", po të kenë diçka për të kafshuar nëpër dhëmbë, por i shpallin luftë atij që nuk u vë gjë në gojë.',
        6: 'Prandaj do të keni net pa vegime, dhe do të keni terr pa shortari; dielli do të perëndojë mbi këta profetë dhe dita do të erret mbi ta.',
        7: 'Shikuesit do të mbulohen me turp dhe shortarët do të skuqen; do të mbulojnë të gjithë mjekrën e tyre, sepse nuk do të ketë asnjë përgjigje nga Perëndia".',
        8: "Unë përkundrazi jam plot me forca të Frymës së Zotit, me drejtësi dhe forcë, për t'i bërë të njohur Jakobit shkeljen e tij dhe Izraelit mëkatin e tij.",
