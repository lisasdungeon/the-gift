...
CHAPTERS = {
    ...
    2: {
        ...
        6: 'Dhe ne flasim dituri në mes njerëzish të pjekur, por jo diturinë e kësaj kohe dhe as të pushtetarëve të kësaj kohe, që nuk arrin asgjë,',
        7: 'por flasim diturinë e Perëndisë të fshehur në mister, që Perëndia e kishte paracaktuar përpara kohërash për lavdinë tonë,',
        8: 'të cilën asnjë nga pushtetarët e kësaj kohe nuk e ka njohur; sepse, po ta kishin njohur, nuk do të kishin kryqëzuar Zotin e lavdisë.',
    ...
    8: {
        ...
        13: 'Prandaj, në qoftë se një ushqim skandalizon vëllanë tim, unë nuk do të ha më kurrë mish, që të mos e skandalizoj vëllanë tim.',
    },
    9: {
