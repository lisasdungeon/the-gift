...
CHAPTERS = {
    ...
    9: {
        1: 'Dhe i pesti engjëll i ra borisë, dhe unë pashë një yll që ra nga qielli përmbi tokë; dhe atij iu dha çelësi i pusit të humnerës.',
    ...
    20: {
        1: 'Dhe pashë një engjëll që zbriste nga qielli, duke pasur çelësin e humnerës, dhe një zinxhir të madh në dorë.',
