...
CHAPTERS = {
    ...
    2: {
        ...
        6: "Ou konnen sa ou gen pou fè. Pa kite se vyeyès ki touye l'.",
        ...
        9: "Men ou menm, pa padonnen l' sa. Ou gen bon konprann, ou konn sa pou ou fè avè l'. Jwenn yon jan pou fè yo touye l' atout li fin vye granmoun lan.",
    ...
    5: {
        1: "Iram, wa peyi Tir, te toujou yon bon zanmi wa David. Lè li vin konnen se Salomon ki te vin moute wa nan plas David, papa l', li voye kèk chèf bò kote l'.",
    ...
    15: {
        1: 'Jewoboram te gen dizwitan depi li te wa peyi Izrayèl la, lè Abijam moute wa nan peyi Jida.',
        2: "Li gouvènen lavil Jerizalèm pandan twazan. Manman l' te rele Maka, se te pitit fi Absalon.",
        3: "Abijam te lage kò l' nan fè menm bagay ak papa l'. Li pa t' sèvi Seyè a, Bondye li a, ak tout kè li jan David, zansèt li a, te fè.",
        4: 'Men poutèt David, Seyè a, Bondye li a, te bay Abijam yon pitit gason pou te toujou gen yon moun nan ras li ap gouvènen lavil Jerizalèm apre li. Konsa lavil Jerizalèm va toujou rete kanpe.',
        5: "Seyè a te fè sa paske David te toujou fè sa ki dwat devan Seyè a. Pandan tout lavi li, li pa t' janm dezobeyi ankenn lòd Seyè a, si ou wete zafè Ouri, moun peyi Et la.",
        6: 'Pandan tout rèy Woboram lan, se te yon lagè san rete ant Woboram ak Jewoboram.',
        7: "Toutan te gen lagè tou ant Abijam ak Jewoboram. Tout lòt bagay Abijam te fè yo, n'a jwenn yo ekri nan liv Istwa wa peyi Jida yo.",
        8: "Lè Abijam mouri, yo antere l' nan lavil David la, Se Asa, pitit gason l' lan, ki moute sou fotèy la nan plas li.",
        9: "Wa Jewoboram t'ap mache sou ventan depi li t'ap gouvènen peyi Izrayèl, lè Asa moute wa nan peyi Jida.",
    ...
    16: {
        1: "Seyè a pale ak Jeou, pitit gason Anani. Li ba li mesaj sa a pou Bacha. Li di l' konsa:",
    ...
    17: {
        1: "Yon pwofèt yo te rele Eli, moun lavil Tichbe nan zòn Galarad, di wa Akab konsa: -Nan non Seyè m'ap sèvi a, Bondye vivan pèp Izrayèl la, men sa m'ap di ou: Pandan lanne k'ap vini yo, p'ap gen lawouze, p'ap gen lapli si se pa mwen ki mande sa.",
    ...
    18: {
        1: "Apre sa, kèk tan pase. Chechrès la t'ap mache sou twazan depi li t'ap bat peyi a. Lè sa a, Seyè a pale ak Eli, li di l' konsa: -Al parèt devan wa Akab. Mwen pral fè lapli tonbe.",
