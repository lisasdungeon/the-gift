...
CHAPTERS = {
    ...
    2: {
        1: 'Jou ki make venteyenyèm jou nan setyèm mwa nan menm lanne a, Seyè a bay pwofèt Aje yon lòt mesaj ankò.',
        2: "Li di li konsa: -Pale ak Zowobabèl, pitit gason Chealtyèl la, gouvènè peyi Jida a, ak Jozye, granprèt la, pitit gason Jozadak la, ansanm ak pèp ki te tounen soti nan peyi kote yo te depòte yo a. W'a di yo:",
        3: "Eske gen yonn nan nou ki chonje jan tanp lan te bèl nan tan lontan? Ki jan nou wè l' koulye a? Nou pa wè li pa vo anyen?",
        ...
        5: "Lè nou t'ap soti kite peyi Lejip la, mwen te pwomèt mwen t'ap toujou la avèk nou. Enben! M' la nan mitan nou. Nou pa bezwen pè.",
        6: 'Paske men sa Seyè ki gen tout pouvwa a di: Anvan lontan, mwen pral souke syèl la ak latè a, lanmè a ak tè yo.',
        7: 'Mwen pral souke tout nasyon yo. Yo pral pote tout richès yo isit la, yo pral plen kay sa a ak bèl bagay. Se Seyè ki gen tout pouvwa a menm ki di sa.',
        8: 'Se pou mwen tout lò ak tout ajan sou latè ye. Se Seyè ki gen tout pouvwa a menm ki di sa.',
        9: "Kay sa a ap pi bèl lontan pase premye a. Se isit la menm m'ap bay tout moun kè poze. Se mwen menm, Seyè ki gen tout pouvwa a, ki di sa!",
