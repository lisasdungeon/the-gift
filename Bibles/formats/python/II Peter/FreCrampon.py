...
CHAPTERS = {
    ...
    2: {
        ...
        7: "et s'il a délivré le juste Lot, affligé de la conduite de ces scélérats",
        8: "(car, à cause de ce qu'il voyait et de ce qu'il entendait, ce juste, continuant à habiter au milieu d'eux, avait chaque jour son âme vertueuse tourmentée de leurs œuvres iniques): —",
        ...
        14: "Ils ont les yeux pleins d'adultère, insatiables de péché; ils prennent à leurs amorces les âmes inconstantes; ils ont le cœur exercé à la cupidité: ce sont des enfants de malédiction.",
        ...
        18: "Avec leurs théories pompeuses et vides, ils attirent dans les convoitises de la chair, dans le libertinage, ceux qui s'étaient à peine retirés des hommes nourris dans l'erreur.",
    ...
    3: {
        ...
        17: "Vous donc, bien-aimés, qui êtes prévenus, tenez-vous sur vos gardes, de peur qu'entraînés par l'égarement de ces impies, vous ne veniez à déchoir de votre propre fermeté.",
        18: "Mais croissez dans la grâce et dans la connaissance de notre Seigneur et Sauveur Jésus-Christ. A lui soit la gloire, maintenant et jusqu'au jour de l'éternité! Amen!",
    },
}
