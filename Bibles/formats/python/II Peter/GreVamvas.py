...
CHAPTERS = {
    ...
    3: {
        1: "Δευτέραν ήδη ταύτην την επιστολήν σας γράφω, αγαπητοί, με τας οποίας διεγείρω δι' υπενθυμίσεως την ειλικρινή σας διάνοιαν,",
        2: 'διά να ενθυμηθήτε τους λόγους τους προλαληθέντας υπό των αγίων προφητών και την παραγγελίαν ημών των αποστόλων του Κυρίου και Σωτήρος·',
        ...
        5: "Διότι εκουσίως αγνοούσι τούτο, ότι με τον λόγον του Θεού οι ουρανοί έγειναν έκπαλαι και η γη συνεστώσα εξ ύδατος και δι' ύδατος,",
        6: 'διά των οποίων ο τότε κόσμος απωλέσθη κατακλυσθείς υπό του ύδατος·',
        7: 'οι δε σημερινοί ουρανοί και η γη διά του αυτού λόγου είναι αποτεταμιευμένοι, φυλαττόμενοι διά το πυρ εις την ημέραν της κρίσεως και της απωλείας των ασεβών ανθρώπων.',
