...
CHAPTERS = {
    1: {
        ...
        18: 'Et nous, nous avons entendu cette voix venue du ciel, étant avec lui sur la sainte montagne.',
    ...
    2: {
        ...
        10: 'mais spécialement ceux qui suivent la chair dans la convoitise de l’impureté et qui méprisent la domination. Gens audacieux, adonnés à leur sens, ils ne tremblent pas en injuriant les dignités,',
        ...
        21: 'car il leur aurait mieux valu n’avoir pas connu la voie de la justice, que de se détourner, après l’avoir connue, du saint commandement qui leur avait été donné;',
