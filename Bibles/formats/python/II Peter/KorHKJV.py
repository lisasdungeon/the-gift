...
CHAPTERS = {
    1: {
        ...
        9: '이것들이 없는 자는 눈먼 자요 멀리 볼 수 없는 자며 자기의 옛 죄들에서 자기가 깨끗하게 된 것을 잊은 자니라.',
        ...
        19: '또한 우리에게는 더 확실한 대언의 말씀이 있으니 날이 새어 샛별이 너희 마음속에 떠오를 때까지 너희가 어두운 곳에서 비치는 빛을 대하듯 이 말씀에 주의를 기울이는 것이 잘하는 것이니라.',
        20: '먼저 이것을 알라. 성경 기록의 대언은 결코 어떤 사적인 해석에서 나지 아니하였나니',
        21: '대언은 옛적에 사람의 뜻으로 말미암아 나오지 아니하였고 오직 하나님의 거룩한 사람들은 성령님께서 자기들을 움직이시는 대로 말하였느니라.',
    },
    2: {
        1: '그러나 백성 가운데 거짓 대언자들이 있었던 것 같이 너희 가운데도 거짓 교사들이 있으리니 그들은 정죄 받을 이단 교리들을 몰래 들여와 심지어 자기들을 사신 주를 부인하기까지 하고 자기들 위에 신속한 파멸을 가져오리라.',
        ...
        4: '하나님께서 죄를 지은 천사들을 아끼지 아니하사 지옥에 던지시고 어둠의 사슬에 넘겨주어 심판 때까지 예비해 두셨으며',
        ...
        12: '그러나 이들은 잡혀서 죽게 만들어진 짐승들 곧 본래 이성이 없는 짐승들 같아서 자기들이 깨닫지 못하는 것들을 비방하므로 자기들의 부패 속에서 철저히 멸망을 당하며',
        13: '대낮에 방탕하는 것을 낙으로 여기므로 불의의 대가를 받으리라. 그들이 너희와 함께 잔치를 할 때에 자기들의 속임수로 즐기니 그들은 점과 흠이요,',
        14: '또 간음으로 가득한 눈을 가지고 죄를 그칠 줄 모르며 불안정한 혼들을 속이니 그들은 곧 탐내는 습관으로 마음을 단련시킨 자들이요 저주받은 자식들이라.',
        15: '그들이 바른 길을 저버리고 보솔의 아들 발람의 길을 따르며 길을 잃었도다. 그는 불의의 삯을 사랑하였으나',
        16: '자기의 불법으로 인해 책망을 받았으니 곧 말 못하는 나귀가 사람의 음성으로 말하여 그 대언자의 미친 것을 막았느니라.',
        17: '이들은 물 없는 샘이요 폭풍에 밀려다니는 구름이라. 그들을 위해 어둠의 안개가 영원토록 예비되어 있나니',
        18: '그들은 헛된 것을 크게 부풀려 말하면서 잘못하며 사는 자들로부터 빠져나와 깨끗하게 된 자들을 육체의 정욕과 심한 방종을 통해 꾀어내느니라.',
        19: '그들이 저들에게 자유를 약속하나 자신들은 부패의 종이 되었으니 사람이 누구에게 정복되면 바로 그 사람에게 속박되느니라.',
    ...
    3: {
        1: '사랑하는 자들아, 내가 이제 둘째 서신을 너희에게 쓰노니 내가 이 두 서신 안에서 기억을 통해 너희의 순수한 생각을 일깨우고자 함은',
        2: '너희가 전에 거룩한 대언자들이 전한 말씀들과 주 곧 구원자의 사도인 우리에게서 받은 명령을 명심하게 하려 함이라.',
        ...
        15: '또 우리 주의 오래 참으심이 구원인 줄로 여기라. 심지어 우리가 사랑하는 형제 바울도 자기가 받은 지혜대로 너희에게 이같이 썼고',
