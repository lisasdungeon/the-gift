...
CHAPTERS = {
    ...
    6: {
        ...
        2: '내가 주를 위하여 거할실 전을 건축하였사오니 주께서 영원히 거하실 처소로소이다 하고',
        3: '얼굴을 돌이켜 이스라엘의 온 회중을 위하여 축복하니 때에 이스라엘의 온 회중이 서 있더라',
        4: '왕이 가로되 이스라엘 하나님 여호와를 송축할지로다 여호와께서 그 입으로 나의 부친 다윗에게 말씀하신 것을 이제 그 손으로 이루셨도다 이르시기를',
    ...
    23: {
        1: '제칠년에 여호야다가 세력을 내어 백부장 곧 여로함의 아들 아사랴와 여호하난의 아들 이스마엘과 오벳의 아들 아사랴와 아다야의 아들 마아세야와 시그리의 아들 엘리사밧 등으로 더불어 언약을 세우매',
