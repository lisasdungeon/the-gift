...
CHAPTERS = {
    ...
    4: {
        ...
        27: '그 관장들은 각각 자기 달에 솔로몬 왕과 왕의 상에 참여하는 모든 자를 위하여 먹을 것을 예비하여 부족함이 없게 하였으며',
    ...
    6: {
        1: '이스라엘 자손이 애굽 땅에서 나온지 사백팔십 년이요 솔로몬이 이스라엘 왕이 된지 사년 시브월 곧 이월에 솔로몬이 여호와를 위하여 전 건축하기를 시작하였더라',
        ...
        6: '하층 다락의 광은 다섯 규빗이요 중층 다락의 광은 여섯 규빗이요 제삼층 다락의 광은 일곱 규빗이라 전의 벽 바깥으로 돌아가며 턱을 내어 골방 들보들로 전의 벽에 박히지 않게 하였으며',
        7: '이 전은 건축할 때에 돌을 뜨는 곳에서 치석하고 가져다가 건축하였으므로 건축하는 동안에 전 속에서는 방망이나 도끼나 모든 철 연장 소리가 들리지 아니하였으며',
        8: '중층 골방의 문은 전 오른편에 있는데 나사모양 사닥다리로 말미암아 하층에서 중층에 오르고 중층에서 제삼층에 오르게 하였더라',
