NAME = 'Esperanto: Esperanto Londona Biblio'
BOOK = 'Jude'
...
CHAPTERS = {
    1: {
        ...
        6: 'Kaj anĝelojn, kiuj ne konservis sian regadon, sed forlasis sian propran loĝejon, Li rezervis sub mallumo en katenoj ĉiamaj ĝis la juĝo en la granda tago.',
        7: 'Kiel ankaŭ Sodom kaj Gomora kaj la ĉirkaŭaj urboj tiel same, kiel ĉi tiuj, malĉastiĝinte kaj foririnte post fremdan karnon, estas elmontritaj kiel ekzemplo, suferante la punon de eterna fajro.',
        ...
        13: 'sovaĝaj marondoj, elŝaŭmantaj siajn hontindaĵojn; steloj vagantaj, por kiuj la nigreco de mallumo por eterne estas rezervata.',
        ...
        25: 'al la sola Dio, nia Savanto, per Jesuo Kristo, nia Sinjoro, estu gloro, majesto, potenco, kaj aŭtoritato, antaŭ ĉiu mondaĝo, kaj nun, kaj ĝis la eterneco. Amen.',
    },
}
