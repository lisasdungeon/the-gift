...
CHAPTERS = {
    ...
    3: {
        ...
        7: 'Gij mannen, insgelijks, woont bij haar met verstand, aan het vrouwelijke vat, als het zwakste, eer gevende, als die ook medeerfgenamen der genade des levens met haar zijt; opdat uw gebeden niet verhinderd worden.',
