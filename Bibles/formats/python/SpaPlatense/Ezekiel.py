...
CHAPTERS = {
    ...
    2: {
        ...
        9: 'Yo miré, y vi una mano que se tendía hacia mí, y he aquí en ella el rollo de un libro. Lo desenvolvió delante de mí, y estaba escrito por dentro y por fuera; y lo escrito en él eran cantos lúgubres, lamentaciones y ayes.',
    },
    3: {
    ...
    33: {
        ...
        5: 'Pues oyó la voz de la trompeta, mas no se dejó prevenir, por eso recae su sangre sobre él. Si hubiese tomado nota del aviso habría salvado su vida,',
    ...
    34: {
        ...
        10: 'Así dice Yahvé, el Señor: Heme aquí contra los pastores; demandaré mis ovejas de su mano y no permitiré que apacienten mi grey; ni tampoco se apacentarán en adelante los pastores a sí mismos; puesto que Yo libraré mis ovejas de su boca, y no les servirán ya de pasto.',
    ...
    37: {
        ...
        25: 'Y habitarán en la tierra que Yo di a mi siervo Jacob, donde moraron vuestros padres; allí habitarán para siempre, ellos y sus hijos y los hijos de sus hijos; y mi siervo David será para siempre su príncipe.',
