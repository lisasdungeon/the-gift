...
CHAPTERS = {
    ...
    14: {
        ...
        24: 'Después de esto, Simón envió a Roma a Numenio con un grande escudo de oro, que pesaba mil minas, con el fin de renovar con ellos la alianza. Y luego que lo supo el pueblo romano,',
