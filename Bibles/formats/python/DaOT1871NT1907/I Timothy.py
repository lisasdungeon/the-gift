...
CHAPTERS = {
    1: {
        ...
        16: 'Men derfor blev der vist mig Barmhjertighed, for at Jesus Kristus kunde paa mig som den første vise hele sin Langmodighed, til et Forbillede paa dem, som skulle tro paa ham til evigt Liv.',
        17: 'Men Evighedens Konge, den uforkrænkelige, usynlige, eneste Gud være Pris og Ære i Evighedernes Evigheder! Amen.',
    ...
    6: {
        ...
        16: 'han, som alene har Udødelighed, som bor i et utilgængeligt Lys, hvem intet Menneske har set, ikke heller kan se; ham være Ære og evig Magt! Amen!',
        17: 'Byd dem, som ere rige i den nærværende Verden, at de ikke hovmode sig, ej heller sætte Haab til den usikre Rigdom, men til Gud, som giver os rigeligt alle Ting at nyde;',
