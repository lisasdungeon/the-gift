...
CHAPTERS = {
    ...
    4: {
        ...
        9: 'Og naar Væsenerne give Ære og Pris og Tak til ham, som sidder paa Tronen, ham, som lever i Evighedernes Evigheder,',
        10: 'da falde de fire og tyve Ældste ned for ham, som sidder paa Tronen, og tilbede ham, som lever i Evighedernes Evigheder, og lægge deres Kranse ned for Tronen og sige:',
    ...
    5: {
        ...
        13: 'Og hver Skabning, som er i Himmelen og paa Jorden og under Jorden og paa Havet, ja, alt, hvad der er i dem, hørte jeg sige: Ham, som sidder paa Tronen, og Lammet tilhører Velsignelsen og Æren og Prisen og Magten i Evighedernes Evigheder!',
    ...
    6: {
        ...
        8: 'Og jeg saa, og se en grøngul Hest, og han, som sad paa den, hans Navn var Døden, og Dødsriget fulgte med ham; og der blev givet dem Magt over Fjerdedelen af. Jorden til at ihjelslaa med Sværd og med Hunger og med Pest og ved Jordens vilde Dyr.',
    ...
    9: {
        1: 'Og den femte Engel basunede, og jeg saa en Stjerne, som var falden ned fra Himmelen paa Jorden, og Nøglen til Afgrundens Brønd blev given den.',
        2: 'Og den aabnede Afgrundens Brønd, og en Røg steg op af Brønden, lig Røgen af en stor Ovn; og Solen og Luften blev formørket af Røgen fra Brønden.',
    ...
    10: {
        ...
        6: 'og svor ved ham, som lever i Evighedernes Evigheder, som har skabt Himmelen, og hvad deri er, og Jorden, og hvad derpaa er, og Havet, og hvad deri er, at der ikke mere skal gives Tid;',
    ...
    11: {
        ...
        7: 'Og naar de faa fuldendt deres Vidnesbyrd, skal Dyret, som stiger op af Afgrunden, føre Krig imod dem og overvinde dem og ihjelslaa dem.',
        ...
        15: 'Og den syvende Engel basunede, og der hørtes høje Røster i Himmelen, som sagde: Herredømmet over Verden er blevet vor Herres og hans Salvedes, og han skal være Konge i Evighedernes Evigheder.',
    ...
    12: {
        ...
        18: 'Og jeg stod paa Sandet ved Havet.',
    },
    13: {
        1: 'Og jeg saa et Dyr stige op af Havet, som havde ti Horn og syv Hoveder, og paa sine Horn ti Kroner, og paa sine Hoveder Bespottelsens Navne.',
    ...
    14: {
        ...
        6: 'Og jeg saa en anden Engel flyve midt oppe under Himmelen, som havde et evigt Evangelium, at forkynde for dem, der bo paa Jorden, og for alle Folkeslag og Stammer og Tungemaal og Folk,',
    ...
    15: {
        ...
        7: 'Og et af de fire levende Væsener gav de syv Engle syv Guldskaaler fyldte med Guds Harme, han, som lever i Evighedernes Evigheder.',
    ...
    17: {
        ...
        8: 'Dyret, som du saa, har været og er ikke, og det skal stige op af Afgrunden og gaa bort til Fortabelse; og de, som bo paa Jorden, skulle undre sig, de, hvis Navne ikke ere skrevne i Livets Bog fra Verdens Grundlæggelse, naar de se, at Dyret var og er ikke og skal komme.',
    ...
    19: {
        ...
        3: 'Og de sagde anden Gang: Halleluja! og Røgen fra hende opstiger i Evighedernes Evigheder.',
        ...
        20: 'Og Dyret blev grebet og med det den falske Profet, som havde gjort Tegnene for dets Aasyn, hvormed han havde forført dem, som toge Dyrets Mærke, og dem, som tilbade dets Billede; de bleve begge kastede levende i Ildsøen, som brænder med Svovl.',
    ...
    20: {
        1: 'Og jeg saa en Engel stige ned fra Himmelen, han havde Afgrundens Nøgle og en stor Lænke i sin Haand.',
        2: 'Og han greb Dragen, den gamle Slange, som er Djævelen og Satan, og bandt ham for tusinde Aar',
        3: 'og kastede ham i Afgrunden og lukkede og forseglede over ham, for at han ikke mere skulde forføre Folkeslagene, førend de tusinde Aar vare til Ende; derefter skal han løses en lille Tid.',
        ...
        10: 'Og Djævelen, som forførte dem, blev kastet i Ild- og Svovlsøen, hvor ogsaa Dyret og den falske Profet var; og de skulle pines Dag og Nat i Evighedernes Evigheder.',
    ...
    21: {
        ...
        8: 'Men de fejge og utro og vederstyggelige og Morderne og de utugtige og Troldkarlene og Afgudsdyrkerne og alle Løgnerne, deres Lod skal være i Søen, som brænder med Ild og Svovl; dette er den anden Død.',
