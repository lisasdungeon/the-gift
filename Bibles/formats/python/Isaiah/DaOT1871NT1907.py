...
CHAPTERS = {
    ...
    5: {
        ...
        14: 'Derfor skal Dødsriget udvide sit Svælg og oplade sin Mund umaadeligt, at baade dets ypperlige og dets menige Folk, baade den, som buldrer, og den, som er glad udi den, skal fare der ned.',
    ...
    39: {
        ...
        2: 'Og Ezekias blev glad ved dem og lod dem se Huset med sine dyrebare Sager, Sølvet og Guldet og de vellugtende Urter og den bedste Olie og hele sit Vaabenhus og alt det, som fandtes i hans Skatkammer; der var ingen Ting i hans Hus og i hans hele Rige, som Ezekias jo lod dem se.',
        ...
        4: 'Og han sagde: Hvad have de set i dit Hus? Og Ezekias sagde: De have set alt det, som er i mit Hus; der var ingen Ting, som jeg jo lod dem se i mine Skatkamre.',
        5: 'Da sagde Esajas til Ezekias: Hør den Herre Zebaoths Ord:',
        6: 'Se, de Dage komme, at alt det, som er i dit Hus, og hvad dine Fædre have samlet til Liggendefæ indtil denne Dag, skal føres til Babel; der skal intet blive tilovers, siger Herren.',
        7: 'Og af dine Sønner, som nedstamme fra dig, som du skal avle, skulle de tage nogle ud, og de skulle være Kammertjenere i Kongen af Babels Palads.',
    ...
    49: {
        1: 'Hører mig, I Øer, og giver Agt, I Folk fra det fjerne! Herren kaldte mig fra Moders Liv af, han nævnede mit Navn fra Moders Skød.',
        ...
        9: 'for at sige til de bundne: Gaar ud! til dem, som ere i Mørke: Kommer frem for Lyset! de skulle finde Græsgang ved Vejene, og Græsgang skal være for dem paa alle nøgne Høje.',
        ...
        13: 'Synger med Fryd, I Himle! og fryd dig, du Jord! og I Bjerge, raaber med Frydesang! thi Herren trøster sit Folk og forbarmer sig over sine elendige.',
        ...
        18: 'Kast dine Øjne omkring og se, alle disse ere samlede, de komme til dig; saa sandt jeg lever, siger Herren, med alle disse skal du klæde dig som med en Prydelse, og du skal binde dem om dig, som Bruden sit Bælte.',
        ...
        21: 'Og du skal sige i dit Hjerte: Hvo har avlet mig disse, eftersom jeg var barnløs og ufrugtbar? jeg var landflygtig og forskudt, og hvo har opdraget disse? se, jeg var enlig tilbage, hvor vare da disse?',
        22: 'Saa siger den Herre, Herre: Se, jeg vil udstrække min Haand efter Hedningerne og opløfte mit Banner for Folkene, og de skulle føre mine Sønner frem paa Armene, og dine Døtre skulle bæres paa Skuldrene.',
        23: 'Og Konger skulle være dine Fosterfædre, og deres Fyrstinder skulle være dine Ammer, paa deres Ansigt skulle de nedbøje sig til Jorden for dig og slikke dine Fødders Støv: da skal du fornemme, at jeg er Herren, og at de, som forvente mig, ikke skulle beskæmmes.',
        24: 'Mon man kan tage fra den vældige, hvad han har taget? og mon den retfærdiges Fanger skulle undkomme?',
        25: 'Ja, saaledes siger Herren: Baade skulle Fangerne tages fra den vældige, og det, en Voldsmand har taget, skal rives fra ham; og jeg vil trætte med dem, som trætte med dig, og vil frelse dine Børn.',
        26: 'Og jeg vil bringe dine Undertrykkere til at æde deres eget Kød, de skulle blive drukne af deres eget Blod som af Most; og alt Kød skal kende, at jeg, Herren, er din Frelser, og den Mægtige i Jakob er din Genløser.',
    },
    50: {
    ...
    64: {
        ...
        3: 'Og fra gammel Tid har man ikke hørt, har man ikke fornummet, intet Øje set, at nogen Gud uden du gjorde saadanne Ting for den, som bier efter ham.',
        4: 'Du møder den, som er glad ved at gøre Retfærdighed, de skulle komme dig i Hu paa dine Veje; se, du var vred, og vi bleve ved at synde; vare vi evindelig blevne paa dem, da vare vi nu frelste.',
