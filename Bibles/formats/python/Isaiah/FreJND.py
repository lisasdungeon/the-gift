...
CHAPTERS = {
    ...
    8: {
        ...
        23: 'Toutefois l’obscurité ne sera pas selon que la détresse fut sur la terre, quand au commencement il pesa légèrement sur le pays de Zabulon et le pays de Nephthali, et plus tard s’appesantit [sur elle],… chemin de la mer, au-delà du Jourdain, Galilée des nations:',
    },
    9: {
        1: 'le peuple qui marchait dans les ténèbres a vu une grande lumière; ceux qui habitaient dans le pays de l’ombre de la mort,… la lumière a resplendi sur eux!',
        2: 'Tu as multiplié la nation, tu lui as accru la joie; ils se réjouissent devant toi, comme la joie à la moisson, comme on est transporté de joie quand on partage le butin.',
        3: 'Car tu as cassé le joug qui pesait sur elle, et la verge de son épaule, le bâton de son oppresseur, comme au jour de Madian.',
        4: 'Car toute chaussure de guerre qu’on chausse pour le tumulte, et le manteau roulé dans le sang, seront un embrasement, la pâture du feu.',
        5: 'Car un enfant nous est né, un fils nous a été donné, et le gouvernement sera sur son épaule; et on appellera son nom: Merveilleux, Conseiller, ✶Dieu fort, Père du siècle, Prince de paix.',
        6: 'À l’accroissement de [son] empire, et à la paix, il n’y aura pas de fin, sur le trône de David et dans son royaume, pour l’établir et le soutenir en jugement et en justice, dès maintenant et à toujours. La jalousie de l’ Éternel des armées fera cela.',
        7: '*Le Seigneur a envoyé une parole à Jacob, et elle tombe sur Israël;',
        8: 'et le peuple tout entier le saura, Éphraïm et celui qui habite la Samarie, qui disent avec orgueil et avec hauteur de cœur:',
        ...
        11: 'les Syriens, à l’est, et les Philistins, à l’ouest; et ils dévoreront Israël à gueule ouverte. Pour tout cela, sa colère ne s’est pas détournée, et sa main est encore étendue.',
        12: 'Mais le peuple ne retourne pas à celui qui le frappe, et ne recherche pas l’ Éternel des armées.',
        13: 'Et l’ Éternel retranchera d’Israël la tête et la queue, la branche de palmier et le jonc, en un seul jour:',
        14: 'l’ancien et l’homme considéré, lui, est la tête; et le prophète qui enseigne le mensonge, lui, est la queue.',
        15: 'Car les conducteurs de ce peuple le fourvoient, et ceux qui sont conduits par eux périssent.',
        ...
        17: 'Car la méchanceté brûle comme un feu, elle dévore les ronces et les épines, et embrase les épaisseurs de la forêt, et roule et s’élève en colonne de fumée.',
        18: 'Par la fureur de l’ Éternel des armées le pays est consumé, et le peuple est comme ce qui alimente le feu: l’un n’épargne pas l’autre.',
        19: 'Et on arrache à droite, et on a faim; et on dévore à gauche, et on n’est pas rassasié. Ils mangent chacun la chair de son bras:',
        20: 'Manassé, Éphraïm, et Éphraïm, Manassé; [et] ceux-ci ensemble sont contre Juda. Pour tout cela, sa colère ne s’est pas détournée, et sa main est encore étendue.',
    },
    10: {
        ...
        22: 'car ton peuple Israël serait-il comme le sable de la mer, un résidu [seulement] reviendra; la consomption décrétée débordera en justice.',
    ...
    14: {
        ...
        23: 'et j’en ferai une possession du butor, et des mares d’eau; et je la balaierai avec le balai de la destruction, dit l’ Éternel des armées.',
    ...
    28: {
        ...
        17: 'Et j’ai mis le jugement pour cordeau, et la justice pour plomb, et la grêle balaiera l’abri de mensonge, et les eaux inonderont la retraite cachée;',
    ...
    29: {
        ...
        19: 'et les débonnaires augmenteront leur joie en l’ Éternel, et les pauvres d’entre les hommes s’égaieront dans le Saint d’Israël.',
    ...
    30: {
        ...
        26: 'Et la lumière de la lune sera comme la lumière du soleil, et la lumière du soleil sera septuple, comme la lumière de sept jours, au jour où l’ Éternel bandera la brisure de son peuple et guérira la blessure de ses plaies.',
    ...
    36: {
        ...
        8: 'Et maintenant, fais un accord, je te prie, avec le roi d’Assyrie, mon seigneur, et je te donnerai 2 000 chevaux si tu peux donner des cavaliers pour les monter.',
    ...
    48: {
        ...
        5: 'je te les ai déclarées dès longtemps; avant qu’elles arrivent je te les ai fait entendre, de peur que tu ne dises: Mon idole les a faites; et mon image taillée ou mon image de fonte les a ordonnées.',
        ...
        7: 'Elles sont créées maintenant, et non dès longtemps; et avant ce jour tu ne les as pas entendues, de peur que tu ne dises: Voici, je les savais!',
    ...
    49: {
        ...
        13: 'Exultez, cieux, et égaie-toi, terre! Montagnes, éclatez en chants de triomphe! Car l’ Éternel console son peuple et fera miséricorde à ses affligés.',
    ...
    51: {
        ...
        6: 'Élevez vos yeux vers les cieux, et regardez vers la terre, en bas; car les cieux s’évanouiront comme la fumée, et la terre vieillira comme un vêtement, et ceux qui y habitent mourront également; mais mon salut sera à toujours, et ma justice ne défaillira pas.',
    ...
    57: {
        ...
        16: 'Car je ne contesterai pas à toujours, et je ne me courroucerai pas à jamais; car l’esprit défaillirait devant moi et les âmes que j’ai faites.',
    ...
    59: {
        ...
        15: 'Et la vérité fait défaut, et celui qui se retire du mal devient une proie. Et l’ Éternel l’a vu: et ce fut mauvais à ses yeux qu’il n’y ait pas de juste jugement.',
        16: 'Et il vit qu’il n’y avait personne, et il s’étonna de ce qu’il n’y ait pas d’intercesseur; et son bras le sauva, et sa justice le soutint.',
    ...
    61: {
        ...
        10: 'Je me réjouirai avec joie en l’ Éternel, mon âme s’égaiera en mon Dieu; car il m’a revêtu des vêtements du salut, il m’a couvert de la robe de la justice, comme un fiancé se pare de son turban et comme une fiancée s’orne de ses joyaux.',
    ...
    63: {
        ...
        5: 'Et je regardai, et il n’y avait point de secours; et je m’étonnai de ce qu’il n’y avait personne qui [me] soutienne; et mon bras m’a sauvé, et ma fureur m’a soutenu.',
        ...
        19: 'Nous sommes [comme ceux] sur lesquels tu n’as jamais dominé, qui ne sont pas appelés de ton nom. Oh! si tu fendais les cieux! Si tu voulais descendre, [et] que devant toi les montagnes se fondent, –',
    },
    64: {
        1: '[descendre] comme le feu brûle les broussailles, comme le feu fait bouillonner l’eau, pour faire connaître ton nom à tes ennemis, en sorte que les nations tremblent devant toi!',
        2: 'Quand tu fis des choses terribles que nous n’attendions pas, tu descendis: devant toi les montagnes se fondirent.',
        3: 'Et jamais on n’a entendu, [jamais] on n’a entendu de l’oreille, [jamais] l’œil n’a vu, hors toi, ô Dieu, ce que [Dieu] a préparé pour celui qui s’attend à lui.',
        4: 'Tu viens à la rencontre de celui qui se réjouit à pratiquer la justice, [de ceux] qui se souviennent de toi dans tes voies! Voici, tu as été courroucé, et nous avons péché;… en tes voies est la perpétuité, et nous serons sauvés.',
        5: 'Et tous, nous sommes devenus comme une chose impure, et toutes nos justices, comme un vêtement souillé; et nous sommes tous fanés comme une feuille, et nos iniquités, comme le vent, nous emportent;',
        6: 'et il n’y a personne qui invoque ton nom, qui se réveille pour te saisir! Car tu as caché ta face de nous, et tu nous as fait fondre par nos iniquités.',
        7: 'Or maintenant, Éternel, tu es notre père: nous sommes l’argile, tu es celui qui nous as formés, et nous sommes tous l’ouvrage de tes mains.',
        8: 'Ne sois pas extrêmement courroucé, ô Éternel, et ne te souviens pas à toujours de l’iniquité. Voici, regarde: nous sommes tous ton peuple.',
        9: 'Tes villes saintes sont devenues un désert; Sion est un désert, Jérusalem, une désolation;',
        10: 'notre maison sainte et magnifique, où nos pères te louaient, est brûlée par le feu, et toutes nos choses désirables sont dévastées.',
    ...
    65: {
        ...
        6: 'Voici, cela est écrit devant moi; je ne me tairai point, mais je rendrai, oui, je rendrai dans leur sein',
        7: 'à la fois, dit l’ Éternel, vos iniquités et les iniquités de vos pères, qui ont brûlé de l’encens sur les montagnes, et m’ont outragé sur les collines, – et je mesurerai dans leur sein leur œuvre passée.',
        ...
        19: 'et je m’égaierai sur Jérusalem, et je me réjouirai en mon peuple. Et on n’y entendra plus la voix des pleurs et la voix des cris.',
        20: 'Il n’y aura plus, dès lors, ni petit enfant de peu de jours, ni vieillard qui n’ait pas accompli ses jours. Car le jeune homme mourra âgé de 100 ans, et le pécheur âgé de 100 ans sera maudit.',
    ...
    66: {
        ...
        4: 'moi aussi, je choisirai leurs calamités, et je ferai venir sur eux ce qu’ils craignent, parce que j’ai crié, et il n’y a eu personne qui réponde; j’ai parlé, et ils n’ont pas écouté, et ont fait ce qui est mauvais à mes yeux, et ont choisi ce en quoi je ne prends pas plaisir.',
        ...
        12: 'Car ainsi dit l’ Éternel: Voici, j’étends sur elle la paix comme une rivière, et la gloire des nations comme un torrent qui déborde; et vous téterez, vous serez portés sur les bras et caressés sur les genoux.',
