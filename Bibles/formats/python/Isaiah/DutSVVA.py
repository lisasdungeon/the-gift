...
CHAPTERS = {
    1: {
        ...
        19: 'Indiën gijlieden willig zijt en hoort, zo zult gij het goede dezes lands eten;',
    ...
    5: {
        ...
        19: 'Die daar zeggen: Dat Hij haaste, dat Hij Zijn werk bespoedige, opdat wij het zien; en laat naderen en komen den raadslag des Heiligen van Israël, dat wij het vernemen!',
        ...
        24: 'Daarom, gelijk de tong des vuurs den stoppel verteert, en het kaf door de vlam verdaan wordt, alzo zal hun wortel als een uittering wezen; en hun bloem zal als stof opvaren; omdat zij verwerpen de wet des Heeren der heirscharen, en de rede des Heiligen van Israël versmaden.',
    ...
    7: {
        ...
        9: 'Ondertussen zal Samaria Efraïms hoofd zijn, en de zoon van Remalia het hoofd van Samaria. Indiën gijlieden niet gelooft, zekerlijk, gij zult niet bevestigd worden.',
    ...
    8: {
        ...
        8: 'En hij zal doortrekken in Juda, hij zal het overstromen, en er doorgaan, hij zal tot aan den hals reiken; en de uitstrekkingen zijner vleugelen zullen vervullen de breedte uws lands, o Immanuël!',
    ...
    10: {
        ...
        12: 'Want het zal geschieden, als de Heere een einde zal gemaakt hebben van al Zijn werk op den berg Sion en te Jeruzalem, dan zal Ik te huis zoeken de vrucht van de grootsheid des harten van den koning van Assyrië, en de pracht van de hoogheid zijner ogen.',
        ...
        20: 'En het zal geschieden te dien dage, dat het overblijfsel van Israël, en de ontkomenen van het huis Jakobs niet meer steunen zullen op dien, die ze geslagen heeft; maar zij zullen steunen op den Heere, den Heilige Israëls, oprechtelijk.',
    ...
    13: {
        ...
        20: 'Daar zal geen woonplaats zijn in der eeuwigheid, en zij zal niet bewoond worden van geslacht tot geslacht; en de Arabiër zal daar geen tent spannen, en de herders zullen er niet legeren.',
    ...
    14: {
        ...
        24: 'De Heere der heirscharen heeft gezworen, zeggende: Indiën niet, gelijk Ik gedacht heb, het alzo geschiede, en gelijk Ik beraadslaagd heb, het bestaan zal!',
    ...
    19: {
        ...
        18: 'Te dien dage zullen er vijf steden in Egypteland zijn, sprekende de spraak van Kanaän, en zwerende den Heere der heirscharen; een zal genoemd zijn een stad der verstoring.',
    ...
    22: {
        ...
        14: 'Maar de Heere der heirscharen heeft Zich voor mijn oren geopenbaard, zeggende: Indiën ulieden deze ongerechtigheid verzoend wordt, totdat gij sterft! zegt de Heere, de Heere der heirscharen.',
    ...
    24: {
        ...
        3: 'Dat land zal ganselijk ledig gemaakt worden, en het zal ganselijk beroofd worden; want de Heere heeft dit woord gesproken.',
    ...
    28: {
        ...
        28: 'Het brood koren moet verbrijzeld worden, maar hij dorst het niet geduriglijk dorsende; noch hij breekt het met het wiel zijns wagens, noch hij verbrijzelt het met zijn paarden.',
    ...
    29: {
        ...
        23: 'Want als hij zijn kinderen, het werk Mijner handen, zien zal in het midden van hen, zullen zij Mijn Naam heiligen; en zij zullen den Heilige Jakobs heiligen, en den God van Israël vrezen.',
    ...
    30: {
        ...
        17: 'Een duizend van het schelden van enige, van het schelden van vijf zult gij allen vlieden; totdat gij overgelaten wordt, gelijk een mast op den top van een berg, en als een banier op een heuvel.',
        ...
        22: 'En gijlieden zult voor onrein houden het deksel uwer zilveren gesneden beelden, en het overtreksel uwer gouden gegoten beelden; gij zult ze wegwerpen gelijk een maanstondig kleed, en tot elk van die zeggen: Henen uit!',
        ...
        29: 'Er zal een lofzang bij ulieden zijn, gelijk in den nacht, wanneer het feest geheiligd wordt; en blijdschap des harten, gelijk van een, die met pijpen wandelt, om te komen tot den berg des Heeren, tot den Rotssteen van Israël.',
    ...
    36: {
        1: 'En het geschiedde in het veertiende jaar van den koning Hizkia, dat Sanherib, de koning van Assyrië, optoog tegen alle vaste steden van Juda, en nam ze in.',
        2: 'En de koning van Assyrië zond Rabsake van Lachis naar Jeruzalem tot den koning Hizkia, met een zwaar heir; en hij stond aan den watergang des oppersten vijvers, aan den hogen weg van het veld des vollers.',
        ...
        4: 'En Rabsake zeide tot hen: Zegt nu tot Hizkia: Zo zegt de grote koning, de koning van Assyrië: Wat vertrouwen is dit, waarmede gij vertrouwt;',
        ...
        8: 'Nu dan, wed toch met mijn heer, den koning van Assyrië; en ik zal u twee duizend paarden geven, zo gij voor u de ruiters daarop zult kunnen geven.',
        ...
        13: 'Alzo stond Rabsake, en riep met luider stem in het Joods, en zeide: Hoort de woorden des groten konings, des konings van Assyrië!',
        14: 'Alzo zegt de koning: Dat Hizkia u niet bedriege, want hij zal u niet kunnen redden.',
        15: 'Daartoe, dat Hizkia u niet doe vertrouwen op den Heere, zeggende: De Heere zal ons zekerlijk redden; deze stad zal niet in de hand des konings van Assyrië gegeven worden.',
        16: 'Hoort naar Hizkia niet; want alzo zegt de koning van Assyrië: Handelt met mij door een geschenk, en komt tot mij uit, en eet, een ieder van zijn wijnstok, en een ieder van zijn vijgeboom, en drinkt een ieder het water zijns bornputs;',
        ...
        18: 'Dat Hizkia ulieden niet verleide, zeggende: De Heere zal ons redden; hebben de goden der volken, een ieder zijn land, gered uit de hand des konings van Assyrië?',
    ...
    43: {
        ...
        14: 'Alzo zegt de Heere, uw Verlosser, de Heilige Israëls: Om ulieder wil heb Ik naar Babel gezonden, en heb hen allen vluchtig doen nederdalen, te weten de Chaldeen, in de schepen, op welke zij juichten.',
    ...
    44: {
        ...
        6: 'Zo zegt de Heere, de Koning van Israël, en zijn Verlosser, de Heere der heirscharen: Ik ben de Eerste, en Ik ben de Laatste, en behalve Mij is er geen God.',
    ...
    49: {
        ...
        8: 'Alzo zegt de Heere: In dien tijd des welbehagens heb Ik U verhoord, en ten dage des heils heb Ik U geholpen; en Ik zal U bewaren, en Ik zal U geven tot een verbond des volks, om het aardrijk op te richten, om de verwoeste erfenissen te doen beërven;',
    ...
    58: {
        ...
        13: 'Indiën gij uw voet van den sabbat afkeert, van te doen uw lust op Mijn heiligen dag; en indien gij den sabbat noemt een verlustiging, opdat de Heere geheiligd worde, Die te eren is; en indien gij dien eert, dat gij uw wegen niet doet, en uw eigen lust niet vindt, noch een woord daarvan spreekt;',
