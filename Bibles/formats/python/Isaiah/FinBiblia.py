...
CHAPTERS = {
    ...
    3: {
        ...
        5: 'Ja kansan pitää ryöstämän toinen toistansa, ja jokaisen lähimmäistänsä; ja nuoremman pitää ylpiä oleman vanhaa vastaan, ja ylönkatsotun kunniallista vastaan.',
    ...
    8: {
        ...
        19: 'Kuin siis he teille sanovat: kysykäät noidilta ja tietäjiltä, jotka kuiskuttelevat ja tutkivat, (niin sanokaat:) eikö kansan pidä Jumalaltansa kysymän? (eikö ole parempi kysyä) eläviltä kuin kuolleilta?',
    ...
    9: {
        ...
        9: 'Että kaikki Ephraimin kansa ja Samarian asuvaiset pitää sen tietää saaman, jotka ylpeydessä ja korialla mielellä sanovat:',
        ...
        17: 'Sentähden ei Herra taida iloita heidän nuorista miehistänsä, eikä armahda heidän orpolapsiansa ja leskiänsä; sillä he ovat kaikki ulkokullatut ja pahat, ja jokaisen suu puhuu hulluutta; näissä kaikissa ei lakkaa vielä hänen vihansa, vaan hänen kätensä on vielä ojennettu.',
    ...
    12: {
        ...
        3: 'Teidän pitää ammentaman vettä ilolla autuuden lähteistä.',
    ...
    18: {
        1: 'Voi sitä maata, joka vaeltaa siipein varjon alla, tällä puolella Etiopian virtoja!',
        ...
        7: 'Silloin se revitty ja ryöstetty kansa, joka julmempi on kuin joku muu, joka siellä ja täällä mitattu on ja tallattu on, jonka maa virtain hallussa on, tuo Herralle Zebaotille lahjoja siihen paikkaan, jossa Herran Zebaotin nimi on, Zionin vuorelle.',
    },
    19: {
    ...
    20: {
        ...
        5: 'Ja heidän pitää peljästymän ja häpeemän Etiopiaa, johon he luottivat, ja Egyptiläisiä, joista he kerskasivat.',
    ...
    27: {
        ...
        10: 'Sillä vahvan kaupungin pitää yksinänsä oleman, kauniit huoneet hyljättämän ja jätettämän niinkuin korpi; niin että vasikat käyvät siellä laitumella, oleskelevat siellä ja pureskelevat oksia.',
    ...
    28: {
        ...
        7: 'Siihen myös ovat nämät hulluksi tulleet viinasta, ja hoipertelevat väkevistä juomista; sillä papit ja prophetat ovat hullut väkevästä juomasta, he ovat uponneet viinaan, ja hoipertelevat väkevästä juomasta, he ovat erhettyneet ennustuksessa, ja ei osanneet oikeutta tuomiossa.',
    ...
    33: {
        1: 'Voi sinuas hävittäjä! luuletkos, ettei sinun pidä hävitetyksi tuleman? ja sinuas ylönkatsoja! luuletkos, ettei sinua ylönkatsota? Koska sinä olet täyttänyt hävitykses, niin sinun myös pitää tuleman hävitetyksi; koska sinä olet täyttänyt ylönkatsees, niin sinua pitää jälleen katsottaman ylön.',
        ...
        13: 'Niin kuulkaat nyt te, jotka kaukana olette, mitä minä olen tehnyt; ja te, jotka olette läsnä, havaitkaat minun väkevyyteni.',
    ...
    39: {
        ...
        3: 'Niin tuli propheta Jesaia kuningas Hiskian tykö, ja sanoi hänelle: mitä nämät miehet ovat sanoneet, ja kusta he sinun tykös ovat tulleet? Hiskia sanoi: he ovat tulleet kaukaiselta maalta minun tyköni, aina Babelista.',
    ...
    63: {
        ...
        15: 'Niin katso nyt taivasta, ja katso tänne alas pyhästä ja kunniallisesta asuinsiastas. Kussa nyt on kiivautes ja voimas? sinun suuri sydämellinen laupiutes kovennetaan minua vastaan.',
