...
CHAPTERS = {
    1: {
        ...
        29: 'Ja, de skola komma på skam med de terebinter som voro eder fröjd; och I skolen få blygas över de lustgårdar[1] som I haden så kära.',
        30: 'Ty I skolen bliva såsom en terebint med vissnade löv och varda lika en lustgård utan något vatten.',
        31: 'Och de väldige skola varda såsom blår, och deras verk såsom en gnista, och de skola tillsammans brinna, och ingen skall kunna släcka. [1] Se Lustgård i Ordförkl.',
    },
    2: {
    ...
    7: {
        ...
        25: 'Och alla de berg där man nu arbetar med hackan, dem skall man ej mer beträda, av fruktan för tistel och törne; de skola bliva platser dit oxar drivas, och marker som trampas ned av får.» [1] D. ä. Gud med oss.',
    },
    8: {
        1: 'Och HERREN sade till mig: »Tag dig en stor tavla och skriv på den med tydlig stil Maher-salal Has-bas[1].',
        ...
        22: 'men se, där är nöd och mörker och natt av ångest. Ja, tjockt mörker är de fördrivnas liv. [1] D. ä. rovet hastar, bytet skyndar.',
    },
    9: {
    ...
    10: {
        ...
        21: 'En kvarleva skall omvända sig[1], en kvarleva av Jakob, till Gud, den väldige.',
        ...
        34: 'Den tjocka skogen nedhugges med järnet; Libanons skogar falla för den väldige. [1] En anspelning på namnet Sear-Jasub (Jes 7,3) som betyder en kvarleva skall omvända sig.',
    },
    11: {
    ...
    17: {
        ...
        10: 'Ty du har förgätit din frälsnings Gud, och du tänker icke på din fasta klippa. Därför planterar du ljuvliga planteringar[1] och sätter i dem främmande vinträd.',
        ...
        14: 'När aftonen är inne, se, då kommer förskräckelsen, och förrän morgonen gryr, äro de sin kos. Detta bliver våra skövlares del, våra plundrares lott. [1] Se Plantering i Ordförkl.',
    },
    18: {
    ...
    29: {
        ...
        2: 'så skall jag bringa Ariel i trångmål; jämmer skall följa på jämmer, och då bliver det för mig ett verkligt Ariel[1].',
    ...
    30: {
        ...
        7: 'Ty Egyptens bistånd är fåfänglighet och tomhet; därför kallar jag det landet »Rahab, som ingenting uträttar»[1].',
        ...
        33: 'Ty en Tofetplats är längesedan tillredd, ja ock för konungen är den gjord redo, och djup och vid är den; dess rund är fylld av eld och av ved i myckenhet, och lik en svavelström skall HERRENS Ande sätta den i brand. [1] Rahab uttydes såsom stortalighet; jfr Ps 87,4; Jes 51,9.',
    },
    31: {
    ...
    34: {
        ...
        11: 'Pelikaner och rördrommar skola taga det i besittning, uvar och korpar skola bo däri; ty förödelsens mätsnöre[1] och förstörelsens murlod skall han låta komma däröver.',
        ...
        17: 'Det är han, som kastar lott för dem, hans hand tillskiftar dem deras mark efter mätsnöre; till evig tid skola de hava den till besittning, från släkte till släkte bo därpå. [1] Se Mätsnöre i Ordförkl.',
    },
    35: {
    ...
    38: {
        ...
        10: 'Jag tänkte: Jag går hädan i mina bästa dagar, in genom dödsrikets portar; jag varder berövad återstoden av mina år.',
        ...
        18: 'Ty dödsriket tackar dig icke, döden prisar dig icke, och de som hava farit ned i graven hoppas ej mer på din trofasthet.',
    ...
    44: {
        ...
        2: 'Så säger HERREN, han som har skapat dig, han som danade dig redan i moderlivet och som hjälper dig: Frukta icke, du min tjänare Jakob, du Jesurun[1], som jag har utvalt.',
        ...
        28: "Jag är den som säger om Kores: »Han är min herde, han skall fullborda all min vilja, och han skall säga om Jerusalem: 'Det skall bliva uppbyggt' och till templet: 'Din grund skall åter varda lagd.'» [1] Se Jesurun i Ordförkl.",
    },
    45: {
        1: 'Så säger HERREN till sin smorde, till Kores som jag har fattat vid hans högra hand, då jag nu vill slå ned folken inför honom och lösa svärdet från konungarnas länd, då jag vill öppna dörrarna för honom så att inga portar mer äro stängda:',
        2: 'Själv skall jag gå framför dig, backarna skall jag jämna ut; kopparportarna skall jag krossa, och järnbommarna skall jag bryta sönder.',
        3: 'Och jag skall giva dig dolda skatter och bortgömda rikedomar, för att du må förnimma, att jag, HERREN, är den som har kallat dig vid ditt namn, jag, Israels Gud.',
        4: 'För min tjänare Jakobs skull, för Israels, min utkorades, skull kallade jag dig vid ditt namn och gav dig ärenamn, innan du kände mig.',
        5: 'Jag är HERREN och eljest ingen, utom mig finnes ingen Gud; innan du kände mig, omgjordade jag dig,',
        6: 'för att man skulle förnimma både i öster och i väster, att alls ingen finnes förutom mig, att jag är HERREN och eljest ingen,',
        7: 'jag som danar ljuset och skapar mörkret, jag som giver lyckan och skapar olyckan. Jag, HERREN, är den som gör allt detta.',
        8: 'Drypen, I himlar därovan, och må skyarna låta rättfärdighet strömma ned. Må jorden öppna sig, och må dess frukt bliva frälsning; rättfärdighet låte den ock växa upp. Jag, HERREN, skapar detta.',
        9: 'Ve dig som vill gå till rätta med din Skapare, ja, ve dig, du skärva bland andra skärvor av jord! Skall väl leret säga till krukmakaren: »Vad kan du göra?» Och skall ditt verk säga om dig: »Han har inga händer»?',
    ...
    53: {
        ...
        3: 'Föraktad var han och övergiven av människor, en smärtornas man och förtrogen med krankhet; han var såsom en, för vilken man skyler sitt ansikte, så föraktad, att vi höllo honom för intet.',
        ...
        7: 'Han blev plågad, fastän han ödmjukade sig och icke öppnade sin mun, lik ett lamm, som föres bort att slaktas, och lik ett får, som är tyst inför dem som klippa det ja, han öppnade icke sin mun.',
    ...
    54: {
        1: 'Jubla, du ofruktsamma, du som icke har fött barn; brist ut i jubel och ropa av fröjd, du som icke har blivit moder. Ty den ensamma skall hava många barn, flera än den som har man, säger HERREN.',
    ...
    65: {
        ...
        25: 'Då skola vargar gå i bet tillsammans med lamm, och lejon skola äta halm likasom oxar, och stoft skall vara ormens föda. Ingenstädes på mitt heliga berg skall man då göra, vad ont och fördärvligt är, säger HERREN. [1] Se Lustgård i Ordförkl.',
    },
    66: {
        ...
        17: 'De som låta inviga sig och rena sig till gudstjänst i lustgårdar[1], anförda av en som står där i mitten, de som äta svinkött och annan styggelse, ja, också möss, de skola allasammans förgås, säger HERREN.',
        ...
        24: 'Och man skall gå ut och se med lust, huru de människor, som avföllo från mig, nu ligga där döda; ty deras mask skall icke dö, och deras eld skall icke utsläckas, och de skola vara till vämjelse för allt kött. [1] Se Lustgård i Ordförkl.',
    },
}
