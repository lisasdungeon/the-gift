...
CHAPTERS = {
    ...
    2: {
        1: 'Nadciąga niszczyciel przeciwko tobie! Strzeż miejsc obronnych, obserwuj drogę, wzmocnij biodra i zbierz wszystkie swe siły.',
        2: 'Pan bowiem odwrócił pychę Jakuba jak pychę Izraela, gdyż złupili ich grabieżcy i zniszczyli ich latorośle.',
        3: 'Tarcza jego mocarzy czerwona, jego wojownicy ubrani w szkarłat, rydwany będą jak płonące pochodnie w dniu jego przygotowania, a jodły będą strasznie się trząść.',
        4: 'Rydwany po ulicach będą szaleć i na rynku skrzypieć. Z wyglądu będą podobne do pochodni, jak błyskawice będą pędzić.',
        ...
        12: 'Lew już dosyć rozszarpał ofiar dla swych lwiąt i zadusił je dla swoich lwic, napełniał łupem swoje jaskinie, a zdobyczą swoje legowiska.',
        13: 'Oto jestem przeciwko tobie, mówi Pan zastępów, spalę na proch twoje rydwany i twoje lwięta pożre miecz. Wykorzenię z ziemi twój łup i nie będzie już słychać głosu twoich posłów.',
    },
    3: {
