...
CHAPTERS = {
    ...
    2: {
        ...
        3: 'Eis que eu repreenderei a vossa semente, e espalharei lixo sobre os vossos rostos, o lixo de vossas festas, e com ele sereis removidos.',
    ...
    4: {
        ...
        6: 'Ele converterá o coração dos pais aos filhos, e o coração dos filhos aos pais; para que não seja que eu venha e fira a terra com maldição.',
    },
}
