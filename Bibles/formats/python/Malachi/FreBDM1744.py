...
CHAPTERS = {
    1: {
        ...
        14: 'C’est pourquoi, maudit soit l’homme trompeur, qui ayant un mâle en son troupeau, et faisant un voeu, sacrifie à l’Eternel ce qui est défectueux; car je suis un grand Roi, a dit l’Eternel des armées, et mon Nom est redouté parmi les nations. Retournez au Début',
    },
    2: {
        ...
        17: 'Vous avez travaillé l’Eternel par vos paroles; vous avez dit: En quoi l’avons-nous travaillé? C’est quand vous dites: Quiconque fait du mal plaît à l’Eternel, et il prend plaisir à de telles gens. Autrement où est le Dieu du jugement? Retournez au Début',
    },
    3: {
        ...
        2: 'Mais qui pourra soutenir le jour de sa venue? et qui pourra subsister quand il paraîtra? Car il sera comme le feu de celui qui raffine, et comme le savon des foulons.',
        ...
        8: 'L’homme pillera-t-il Dieu, que vous me pilliez? Et vous dites: En quoi t’avons-nous pillé? Vous l’avez fait dans les dîmes et dans les offrandes.',
        ...
        16: 'Alors ceux qui craignent l’Eternel ont parlé l’un à l’autre, et l’Eternel y a été attentif, et l’a ouï, et on a écrit un livre de mémoires, devant lui; pour ceux qui craignent l’Eternel, et qui pensent à son Nom.',
        ...
        18: 'Convertissez-vous donc, et vous verrez la différence qu’il y a entre le juste et le méchant; entre celui qui sert Dieu et celui qui ne l’a point servi. Retournez au Début',
    },
    4: {
        ...
        2: 'Mais pour vous qui craignez mon Nom, se lèvera le Soleil de justice, et la santé sera dans ses rayons; vous sortirez, et vous acquerrez de l’embonpoint comme de jeunes boeufs que l’on engraisse.',
        3: 'Et vous foulerez les méchants; car ils seront comme de la cendre sous les plantes de vos pieds, au jour que je ferai mon oeuvre, a dit l’Eternel des armées.',
        ...
        6: 'Il convertira le coeur des pères envers les enfants, et le coeur des enfants, envers leurs pères, de peur que je ne vienne, et que je ne frappe la terre à la façon de l’interdit. Retournez au Début ===============================================================================',
    },
}
