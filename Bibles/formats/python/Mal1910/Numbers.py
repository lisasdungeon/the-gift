...
CHAPTERS = {
    ...
    2: {
        ...
        3: 'യെഹൂദാപാളയത്തിന്റെ കൊടിക്കീഴുള്ളവർ ഗണംഗണമായി കിഴക്കു സൂൎയ്യോദയത്തിന്നു നേരെ പാളയമിറങ്ങേണം; യെഹൂദയുടെ മക്കൾക്കു അമ്മീനാദാബിന്റെ മകൻ നഹശോൻ പ്രഭു ആയിരിക്കേണം.',
    ...
    4: {
        ...
        41: 'യഹോവ കല്പിച്ചതുപോലെ മോശെയും അഹരോനും ഗേൎശോന്യകുടുംബങ്ങളിൽ എണ്ണിയവരായി സമാഗമനകൂടാരത്തിൽ വേല ചെയ്\u200cവാനുള്ളവർ എല്ലാം ഇവർ തന്നേ.',
    ...
    7: {
        1: 'മോശെ തിരുനിവാസം നിവിൎത്തുകഴിഞ്ഞിട്ടു അതും അതിന്റെ ഉപകരണങ്ങളൊക്കെയും അഭിഷേകം ചെയ്തു ശുദ്ധീകരിക്കയും യാഗപീഠത്തെയും അതിന്റെ സകലപാത്രങ്ങളെയും അഭിഷേകം കഴിച്ചു ശുദ്ധീകരിക്കയും ചെയ്ത ദിവസം',
        ...
        6: 'മോശെ വണ്ടികളെയും കാളകളെയും വാങ്ങി ലേവ്യൎക്കു കൊടുത്തു.',
        7: 'രണ്ടു വണ്ടിയും നാലു കാളയെയും അവൻ ഗേൎശോന്യൎക്കു അവരുടെ വേലെക്കു തക്കവണ്ണം കൊടുത്തു.',
        ...
        9: 'കെഹാത്യൎക്കു അവൻ ഒന്നും കൊടുത്തില്ല; അവരുടെ വേല വിശുദ്ധമന്ദിരം സംബന്ധിച്ചുള്ളതും തോളിൽ ചുമക്കുന്നതും ആയിരുന്നു.',
        ...
        13: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - അവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        14: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കം ഉള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        19: 'അവൻ വഴിപാടു കഴിച്ചതു: വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        20: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        25: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയമാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        26: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കം ഉള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        31: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റി മുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        32: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        37: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        38: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        43: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        44: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        49: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയമാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        50: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കം ഉള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        55: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവരണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണ ചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        56: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        61: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണ ചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        62: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        67: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണ ചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        68: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കം ഉള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        73: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവ രണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        74: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        79: 'അവന്റെ വഴിപാടു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം നൂറ്റിമുപ്പതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിത്തളിക, എഴുപതു ശേക്കെൽ തൂക്കമുള്ള ഒരു വെള്ളിക്കിണ്ണം - ഇവരണ്ടും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത നേരിയ മാവുകൊണ്ടു നിറഞ്ഞിരുന്നു -',
        80: 'ധൂപവൎഗ്ഗം നിറഞ്ഞതും പത്തു ശേക്കെൽ തൂക്കമുള്ളതുമായ ഒരു പൊൻകലശം,',
        ...
        86: 'ധൂപവൎഗ്ഗം നിറഞ്ഞ പൊൻകലശം പന്ത്രണ്ടു; ഓരോന്നു വിശുദ്ധമന്ദിരത്തിലെ തൂക്കപ്രകാരം പത്തു ശേക്കെൽ വീതം കലശങ്ങളുടെ പൊന്നു ആകെ നൂറ്റിരുപതു ശേക്കെൽ.',
    ...
    8: {
        ...
        19: 'യിസ്രായേൽമക്കൾ വിശുദ്ധമന്ദിരത്തിന്നു അടുത്തുവരുമ്പോൾ അവരുടെ ഇടയിൽ ബാധയുണ്ടാകാതിരിക്കേണ്ടതിന്നു സമാഗമനകൂടാരത്തിൽ യിസ്രായേൽമക്കളുടെ വേല ചെയ്\u200cവാനും യിസ്രായേൽമക്കൾക്കുവേണ്ടി പ്രായശ്ചിത്തം കഴിപ്പാനും ലേവ്യരെ ഞാൻ യിസ്രായേൽമക്കളുടെ ഇടയിൽനിന്നു അഹരോന്നും പുത്രന്മാൎക്കും ദാനം ചെയ്തുമിരിക്കുന്നു.',
        ...
        22: 'അതിന്റെ ശേഷം ലേവ്യർ അഹരോന്റെയും പുത്രന്മാരുടെയും മുമ്പാകെ സമാഗമനകൂടാരത്തിൽ തങ്ങളുടെ വേലചെയ്\u200cവാൻ അടുത്തുചെന്നു; യഹോവ ലേവ്യരെക്കുറിച്ചു മോശെയോടു കല്പിച്ചതുപോലെ തന്നേ അവർ അവൎക്കു ചെയ്തു.',
    ...
    10: {
        ...
        9: 'നിങ്ങളുടെ ദേശത്തു നിങ്ങളെ ഞെരുക്കുന്ന ശത്രുവിന്റെ നേരെ നിങ്ങൾ യുദ്ധത്തിന്നു പോകുമ്പോൾ ഗംഭീരധ്വനിയായി കാഹളം ഊതേണം; എന്നാൽ നിങ്ങളുടെ ദൈവമായ യഹോവ നിങ്ങളെ ഓൎത്തു ശത്രുക്കളുടെ കയ്യിൽനിന്നു രക്ഷിക്കും.',
        ...
        17: 'അപ്പോൾ തിരുനിവാസം അഴിച്ചു താഴ്ത്തി; ഗേൎശോന്യരും മെരാൎയ്യരും തിരുനിവാസം ചുമന്നുകൊണ്ടു പുറപ്പെട്ടു.',
        ...
        21: 'അപ്പോൾ കെഹാത്യർ വിശുദ്ധസാധനങ്ങൾ ചുമന്നുകൊണ്ടു പുറപ്പെട്ടു; ഇവർ എത്തുമ്പോഴേക്കു തിരുനിവാസം നിവിൎത്തുകഴിയും.',
        ...
        30: 'അവൻ അവനോടു: ഞാൻ വരുന്നില്ല; എന്റെ സ്വദേശത്തേക്കും ചാൎച്ചക്കാരുടെ അടുക്കലേക്കും ഞാൻ പോകുന്നു എന്നു പറഞ്ഞു.',
        ...
        33: 'അനന്തരം അവർ യഹോവയുടെ പൎവ്വതം വിട്ടു മൂന്നു ദിവസത്തെ വഴി പോയി; യഹോവയുടെ നിയമപെട്ടകം അവൎക്കു വിശ്രാമസ്ഥലം അന്വേഷിക്കേണ്ടതിന്നു മൂന്നു ദിവസത്തെ വഴി മുമ്പോട്ടു പോയി.',
        34: 'പാളയം പുറപ്പെട്ടപ്പോൾ യഹോവയുടെ മേഘം പകൽസമയം അവൎക്കു മീതെ ഉണ്ടായിരുന്നു.',
    ...
    13: {
        ...
        19: 'അവർ പാൎക്കുന്ന ദേശം നല്ലതോ ആകാത്തതോ, അവർ വസിക്കുന്ന പട്ടണങ്ങൾ പാളയങ്ങളോ കോട്ടകളോ,',
        20: 'ദേശം പുഷ്ടിയുള്ളതോ പുഷ്ടിയില്ലാത്തതോ, അതിൽ വൃക്ഷം ഉണ്ടോ ഇല്ലയോ എന്നിങ്ങനെ നോക്കിയറിവിൻ; നിങ്ങൾ ധൈൎയ്യപ്പെട്ടു ദേശത്തിലെ ഫലങ്ങളും കൊണ്ടുവരുവിൻ എന്നു പറഞ്ഞു. അതു മുന്തിരിങ്ങ പഴുത്തു തുടങ്ങുന്ന കാലം ആയിരുന്നു.',
        ...
        26: 'അവർ യാത്രചെയ്തു പാറാൻമരുഭൂമിയിലെ കാദേശിൽ മോശെയുടെയും അഹരോന്റെയും യിസ്രായേൽമക്കളുടെ സൎവ്വസഭയുടെയും അടുക്കൽ വന്നു അവരോടും സൎവ്വസഭയോടും വൎത്തമാനം അറിയിച്ചു; ദേശത്തിലെ ഫലങ്ങളും അവരെ കാണിച്ചു.',
        ...
        28: 'എങ്കിലും ദേശത്തു പാൎക്കുന്ന ജനങ്ങൾ ബലവാന്മാരും പട്ടണങ്ങൾ ഏറ്റവും ഉറപ്പും വലിപ്പവും ഉള്ളവയും ആകുന്നു. ഞങ്ങൾ അനാക്കിന്റെ പുത്രന്മാരെയും അവിടെ കണ്ടു.',
        29: 'അമാലേക്യർ തെക്കെ ദേശത്തു പാൎക്കുന്നു; ഹിത്യരും യെബൂസ്യരും അമോൎയ്യരും പൎവ്വതങ്ങളിൽ പാൎക്കുന്നു; കനാന്യർ കടൽക്കരയിലും യോൎദ്ദാൻനദീതീരത്തും പാൎക്കുന്നു.',
        30: 'എന്നാൽ കാലേബ് മോശെയുടെ മുമ്പാകെ ജനത്തെ അമൎത്തി: നാം ചെന്നു അതു കൈവശമാക്കുക; അതു ജയിപ്പാൻ നമുക്കു കഴിയും എന്നു പറഞ്ഞു.',
        ...
        32: 'തങ്ങൾ ഒറ്റുനോക്കിയ ദേശത്തെക്കുറിച്ചു അവർ യിസ്രായേൽമക്കളോടു ദുൎവ്വൎത്തമാനമായി പറഞ്ഞതെന്തെന്നാൽ: ഞങ്ങൾ സഞ്ചരിച്ചു ഒറ്റുനോക്കിയ ദേശം നിവാസികളെ തിന്നുകളയുന്ന ദേശം ആകുന്നു; ഞങ്ങൾ അവിടെ കണ്ട ജനം ഒക്കെയും അതികായന്മാർ;',
    ...
    16: {
        ...
        3: 'അവൻ മോശെക്കും അഹരോന്നും വിരോധമായി കൂട്ടംകൂടി അവരോടു: മതി, മതി; സഭ ഒട്ടൊഴിയാതെ എല്ലാവരും വിശുദ്ധരാകുന്നു; യഹോവ അവരുടെ മദ്ധ്യേ ഉണ്ടു; പിന്നെ നിങ്ങൾ യഹോവയുടെ സഭെക്കു മീതെ നിങ്ങളെത്തന്നേ ഉയൎത്തുന്നതു എന്തു? എന്നു പറഞ്ഞു.',
        ...
        6: 'കോരഹും അവന്റെ എല്ലാകൂട്ടവുമായുള്ളോരേ, നിങ്ങൾ ഇതു ചെയ്\u200cവിൻ:',
        7: 'ധൂപകലശം എടുത്തു നാളെ യഹോവയുടെ സന്നിധിയിൽ അതിൽ തീയിട്ടു ധൂപവൎഗ്ഗം ഇടുവിൻ; യഹോവ തിരഞ്ഞെടുക്കുന്നവൻ തന്നേ വിശുദ്ധൻ; ലേവിപുത്രന്മാരേ, മതി, മതി!',
        ...
        10: 'അവൻ നിന്നെയും ലേവിപുത്രന്മാരായ നിന്റെ സകലസഹോദരന്മാരെയും തന്നോടു അടുക്കുമാറാക്കിയല്ലോ; നിങ്ങൾ പൌരോഹിത്യംകൂടെ കാംക്ഷിക്കുന്നുവോ?',
        ...
        17: 'നിങ്ങൾ ഓരോരുത്തൻ താന്താന്റെ ധൂപകലശം എടുത്തു അവയിൽ ധൂപവൎഗ്ഗം ഇട്ടു ഒരോരുത്തൻ ഓരോ ധൂപകലശമായി ഇരുനൂറ്റമ്പതു കലശവും യഹോവയുടെ സന്നിധിയിൽ കൊണ്ടുവരുവിൻ; നീയും അഹരോനും കൂടെ താന്താന്റെ ധൂപകലശവുമായി വരേണം എന്നു പറഞ്ഞു.',
        18: 'അങ്ങനെ അവർ ഓരോരുത്തൻ താന്താന്റെ ധൂപകലശം എടുത്തു തീയിട്ടു അതിൽ ധൂപവൎഗ്ഗവും ഇട്ടു മോശെയും അഹരോനുമായി സമാഗമനകൂടാരത്തിന്റെ വാതിൽക്കൽ നിന്നു.',
        19: 'കോരഹ് അവൎക്കു വിരോധമായി സൎവ്വസഭയെയും സമാഗമനകൂടാരത്തിന്റെ വാതിൽക്കൽ കൂട്ടിവരുത്തി; അപ്പോൾ യഹോവയുടെ തേജസ്സു സൎവ്വസഭെക്കും പ്രത്യക്ഷമായി.',
        20: 'യഹോവ മോശെയോടും അഹരോനോടും:',
        21: 'ഈ സഭയുടെ മദ്ധ്യേനിന്നു മാറിപ്പോകുവിൻ; ഞാൻ അവരെ ക്ഷണത്തിൽ സംഹരിക്കും എന്നു കല്പിച്ചു.',
        22: 'അപ്പോൾ അവർ കവിണ്ണുവീണു: സകലജനത്തിന്റെയും ആത്മാക്കൾക്കു ഉടയവനാകുന്ന ദൈവമേ, ഒരു മനുഷ്യൻ പാപം ചെയ്തതിന്നു നീ സൎവ്വസഭയോടും കോപിക്കുമൊ എന്നു പറഞ്ഞു.',
        ...
        26: 'അവൻ സഭയോടു: ഈ ദുഷ്ടമനുഷ്യരുടെ സകലപാപങ്ങളാലും നിങ്ങൾ സംഹരിക്കപ്പെടാതിരിക്കേണ്ടതിന്നു അവരുടെ കൂടാരങ്ങളുടെ അടുക്കൽനിന്നു മാറിപ്പോകുവിൻ; അവൎക്കുള്ള യാതൊന്നിനെയും തൊടരുതു എന്നു പറഞ്ഞു.',
        27: 'അങ്ങനെ അവർ കോരഹ്, ദാഥാൻ, അബീരാം എന്നവരുടെ വാസസ്ഥലത്തിന്റെ ചുറ്റിലുംനിന്നു മാറിപ്പോയി. എന്നാൽ ദാഥാനും അബീരാമും പുറത്തു വന്നു: അവരും അവരുടെ ഭാൎയ്യമാരും പുത്രന്മാരും കുഞ്ഞുങ്ങളും താന്താങ്ങളുടെ കൂടാരവാതിൽക്കൽനിന്നു.',
        ...
        29: 'സകലമനുഷ്യരും മരിക്കുന്നതുപോലെ ഇവർ മരിക്കയോ സകലമനുഷ്യൎക്കും ഭവിക്കുന്നതുപോലെ ഇവൎക്കു ഭവിക്കയോ ചെയ്താൽ യഹോവ എന്നെ അയച്ചിട്ടില്ല.',
        30: 'എന്നാൽ യഹോവ ഒരു അപൂൎവ്വകാൎയ്യം പ്രവൎത്തിക്കയും ഭൂമി വായ് പിളൎന്നു അവരെയും അവൎക്കുള്ള സകലത്തെയും വിഴുങ്ങിക്കളകയും അവർ ജീവനോടു പാതാളത്തിലേക്കു ഇറങ്ങുകയും ചെയ്താൽ അവർ യഹോവയെ നിരസിച്ചു എന്നു നിങ്ങൾ അറിയും.',
        31: 'അവൻ ഈ വാക്കുകളെല്ലാം പറഞ്ഞു തീൎന്നപ്പോൾ അവരുടെ കീഴെ ഭൂമി പിളൎന്നു.',
        ...
        33: 'അവരും അവരോടു ചേൎന്നിട്ടുള്ള എല്ലാവരും ജീവനോടെ പാതാളത്തിലേക്കു ഇറങ്ങി; ഭൂമി അവരുടെമേൽ അടകയും അവർ സഭയുടെ ഇടയിൽനിന്നു നശിക്കയും ചെയ്തു.',
        ...
        46: 'മോശെ അഹരോനോടു: നീ ധൂപകലശം എടുത്തു അതിൽ യാഗപീഠത്തിലെ തീ ഇട്ടു ധൂപവൎഗ്ഗവും ഇട്ടു വേഗത്തിൽ സഭയുടെ മദ്ധ്യേ ചെന്നു അവൎക്കുവേണ്ടി പ്രായശ്ചിത്തം കഴിക്ക; യഹോവയുടെ സന്നിധിയിൽനിന്നു ക്രോധം പുറപ്പെട്ടു ബാധ തുടങ്ങിയിരിക്കുന്നു എന്നു പറഞ്ഞു.',
        ...
        48: 'മരിച്ചവൎക്കും ജീവനുള്ളവൎക്കും നടുവിൽ നിന്നപ്പോൾ ബാധ അടങ്ങി.',
    ...
    22: {
        1: 'യിസ്രായേൽമക്കൾ യാത്ര പുറപ്പെട്ടു യെരീഹോവിന്റെ സമീപത്തു യോൎദ്ദാന്നക്കരെ മോവാബ് സമഭൂമിയിൽ പാളയമിറങ്ങി.',
        2: 'യിസ്രായേൽ അമോൎയ്യരോടു ചെയ്തതൊക്കെയും സിപ്പോരിന്റെ മകനായ ബാലാക്ക് അറിഞ്ഞു.',
        ...
        5: 'അവൻ ബെയോരിന്റെ മകനായ ബിലെയാമിനെ വിളിപ്പാൻ അവന്റെ സ്വജാതിക്കാരുടെ ദേശത്തു നദീതീരത്തുള്ള പെഥോരിലേക്കു ദൂതന്മാരെ അയച്ചു: ഒരു ജനം മിസ്രയീമിൽനിന്നു പുറപ്പെട്ടുവന്നു ഭൂതലത്തെ മൂടിയിരിക്കുന്നു; അവർ എനിക്കെതിരെ പാൎക്കുന്നു.',
        ...
        19: 'ആകയാൽ യഹോവ ഇനിയും എന്നോടു എന്തു അരുളിച്ചെയ്യും എന്നു ഞാൻ അറിയട്ടെ; നിങ്ങളും ഈ രാത്രി ഇവിടെ പാൎപ്പിൻ എന്നു ഉത്തരം പറഞ്ഞു.',
        20: 'രാത്രിയിൽ ദൈവം ബിലെയാമിന്റെ അടുക്കൽ വന്നു: ഇവർ നിന്നെ വിളിപ്പാൻ വന്നിരിക്കുന്നു എങ്കിൽ പുറപ്പെട്ടു അവരോടുകൂടെ പോക; എന്നാൽ ഞാൻ നിന്നോടു കല്പിക്കുന്ന കാൎയ്യം മാത്രമേ ചെയ്യാവു എന്നു കല്പിച്ചു.',
        ...
        25: 'കഴുത യഹോവയുടെ ദൂതനെ കണ്ടപ്പോൾ മതിലരികെ ഒതുങ്ങി ബിലെയാമിന്റെ കാൽ മതിലോടു ചേൎത്തു ഞെക്കി; അവൻ അതിനെ വീണ്ടും അടിച്ചു.',
        ...
        36: 'ബിലെയാം വരുന്നു എന്നു ബാലാക്ക് കേട്ടപ്പോൾ അൎന്നോൻതീരത്തു ദേശത്തിന്റെ അതിരിലുള്ള ഈർമോവാബ് വരെ അവനെ എതിരേറ്റുചെന്നു.',
        ...
        39: 'അങ്ങനെ ബിലെയാം ബാലാക്കിനോടുകൂടെ പോയി; അവർ കിൎയ്യത്ത് - ഹൂസോത്തിൽ എത്തി.',
        40: 'ബാലാക്ക് കാളകളെയും ആടുകളെയും അറുത്തു ബിലെയാമിന്നും അവനോടുകൂടെയുള്ള പ്രഭുക്കന്മാൎക്കും കൊടുത്തയച്ചു.',
        41: 'പിറ്റെന്നാൾ ബാലാക്ക് ബിലെയാമിനെ ബാമോത്ത്-ബാലിലേക്കു കൂട്ടിക്കൊണ്ടുപോയി; അവിടെനിന്നു അവൻ ജനത്തിന്റെ ഒരു അറ്റം കണ്ടു.',
    },
    23: {
        1: 'അനന്തരം ബിലെയാം ബാലാക്കിനോടു: ഇവിടെ എനിക്കു ഏഴു യാഗപീഠം പണിതു ഏഴു കാളയെയും ഏഴു ആട്ടുകൊറ്റനെയും ഒരുക്കിനിൎത്തുക എന്നു പറഞ്ഞു.',
        ...
        3: 'പിന്നെ ബിലെയാം ബാലാക്കിനോടു: നിന്റെ ഹോമയാഗത്തിന്റെ അടുക്കൽ നിൽക്ക; ഞാൻ അങ്ങോട്ടു ചെല്ലട്ടെ; പക്ഷേ യഹോവ എനിക്കു പ്രത്യക്ഷനാകും; അവൻ എന്നെ ദൎശിപ്പിക്കുന്നതു ഞാൻ നിന്നോടു അറിയിക്കും എന്നു പറഞ്ഞു കുന്നിന്മേൽ കയറി.',
        ...
        7: 'അപ്പോൾ അവൻ സുഭാഷിതം ചൊല്ലിത്തുടങ്ങിയതു: ബാലാക്ക് എന്നെ അരാമിൽനിന്നും മോവാബ്\u200cരാജാവു പൂൎവ്വപൎവ്വതങ്ങളിൽനിന്നും വരുത്തി: ചെന്നു യാക്കോബിനെ ശപിക്ക; ചെന്നു യിസ്രായേലിനെ പ്രാകുക എന്നു പറഞ്ഞു.',
        8: 'ദൈവം ശപിക്കാത്തവനെ ഞാൻ എങ്ങനെ ശപിക്കും? യഹോവ പ്രാകാത്തവനെ ഞാൻ എങ്ങനെ പ്രാകും?',
        9: 'ശിലാഗ്രങ്ങളിൽനിന്നു ഞാൻ അവനെ കാണുന്നു; ഗിരികളിൽനിന്നു ഞാൻ അവനെ ദൎശിക്കുന്നു; ഇതാ തനിച്ചു പാൎക്കുന്നോരു ജനം; ജാതികളുടെ കൂട്ടത്തിൽ എണ്ണപ്പെടുന്നതുമില്ല.',
        ...
        21: 'യാക്കോബിൽ തിന്മ കാണ്മാനില്ല; യിസ്രായേലിൽ കഷ്ടത ദൎശിപ്പാനുമില്ല; അവന്റെ ദൈവമായ യഹോവ അവനോടുകൂടെ ഇരിക്കുന്നു; രാജകോലാഹലം അവരുടെ മദ്ധ്യേ ഉണ്ടു.',
        22: 'ദൈവം അവരെ മിസ്രയീമിൽനിന്നു കൊണ്ടുവരുന്നു; കാട്ടുപോത്തിന്നു തുല്യമായ ബലം അവന്നു ഉണ്ടു.',
        23: 'ആഭിചാരം യാക്കോബിന്നു പറ്റുകയില്ല; ലക്ഷണവിദ്യ യിസ്രായേലിനോടു ഫലിക്കയുമില്ല; ഇപ്പോൾ യാക്കോബിനെക്കുറിച്ചും യിസ്രായേലിനെക്കുറിച്ചും: ദൈവം എന്തെല്ലാം പ്രവൎത്തിച്ചിരിക്കുന്നു എന്നേ പറയാവു.',
        ...
        29: 'ബിലെയാം ബാലാക്കിനോടു: ഇവിടെ എനിക്കു ഏഴു യാഗപീഠം പണിതു ഏഴു കാളയെയും ഏഴു ആട്ടുകൊറ്റനെയും ഒരുക്കിനിൎത്തുക എന്നു പറഞ്ഞു.',
    ...
    25: {
        1: 'യിസ്രായേൽ ശിത്തീമിൽ പാൎക്കുമ്പോൾ ജനം മോവാബ്യസ്ത്രീകളുമായി പരസംഗം തുടങ്ങി.',
        2: 'അവർ ജനത്തെ തങ്ങളുടെ ദേവന്മാരുടെ ബലികൾക്കു വിളിക്കയും ജനം ഭക്ഷിച്ചു അവരുടെ ദേവന്മാരെ നമസ്കരിക്കയും ചെയ്തു.',
        3: 'യിസ്രായേൽ ബാൽപെയോരിനോടു ചേൎന്നു, യഹോവയുടെ കോപം യിസ്രായേലിന്റെ നേരെ ജ്വലിച്ചു.',
        ...
        5: 'മോശെ യിസ്രായേൽ ന്യായാധിപന്മാരോടു: നിങ്ങൾ ഓരോരുത്തൻ താന്താന്റെ ആളുകളിൽ ബാൽപെയോരിനോടു ചേൎന്നവരെ കൊല്ലുവിൻ എന്നു പറഞ്ഞു.',
        6: 'എന്നാൽ മോശെയും സമാഗമനകൂടാരത്തിന്റെ വാതിൽക്കൽ കരഞ്ഞുകൊണ്ടിരിക്കുന്ന യിസ്രായേൽമക്കളുടെ സൎവ്വസഭയും കാൺകെ, ഒരു യിസ്രായേല്യൻ തന്റെ സഹോദരന്മാരുടെ മദ്ധ്യത്തിലേക്കു ഒരു മിദ്യാന്യസ്ത്രീയെ കൊണ്ടുവന്നു.',
        ...
        13: 'അവൻ തന്റെ ദൈവത്തിന്നുവേണ്ടി തീക്ഷ്ണതയുള്ളവനായി യിസ്രായേൽമക്കൾക്കുവേണ്ടി പ്രായശ്ചിത്തം കഴിച്ചതുകൊണ്ടു അതു അവന്നും അവന്റെ സന്തതിക്കും നിത്യപൌരോഹിത്യത്തിന്റെ നിയമമാകും എന്നു നീ പറയേണം.',
        ...
        15: 'കൊല്ലപ്പെട്ട മിദ്യാന്യസ്ത്രീക്കു കൊസ്ബി എന്നു പേർ; അവൾ ഒരു മിദ്യാന്യഗോത്രത്തിൽ ജനാധിപനായിരുന്ന സൂരിന്റെ മകളായിരുന്നു.',
    ...
    26: {
        ...
        2: 'യിസ്രായേൽമക്കളുടെ സൎവ്വസഭയെയും ഇരുപതു വയസ്സുമുതൽ മേലോട്ടു യുദ്ധത്തിന്നുപ്രാപ്തിയുള്ള എല്ലാവരെയും ഗോത്രം ഗോത്രമായി എണ്ണി തുക എടുപ്പിൻ എന്നു കല്പിച്ചു.',
        3: 'അങ്ങനെ മോശെയും പുരോഹിതനായ എലെയാസാരും യെരീഹോവിന്റെ സമീപത്തു യോൎദ്ദാന്നരികെയുള്ള മോവാബ് സമഭൂമിയിൽവെച്ചു അവരോടു:',
        ...
        6: 'ഹെസ്രോനിൽനിന്നു ഹെസ്രോന്യകുടുംബം; കൎമ്മിയിൽനിന്നു കൎമ്മ്യകുടുംബം.',
        ...
        10: 'ഭൂമി വായി തുറന്നു അവരെയും കേരഹിനെയും വിഴുങ്ങിക്കളകയും തീ ഇരുനൂറ്റമ്പതുപേരെ ദഹിപ്പിക്കയും ചെയ്ത സമയം ആ കൂട്ടം മരിച്ചു; അവർ ഒരു അടയാളമായ്തീൎന്നു.',
        ...
        16: 'ഒസ്നിയിൽനിന്നു ഒസ്നീയകുടുംബം; ഏരിയിൽനിന്നു ഏൎയ്യകുടുംബം;',
        ...
        29: 'മനശ്ശെയുടെ പുത്രന്മാർ: മാഖീരിൽനിന്നു മാഖീൎയ്യകുടുംബം; മാഖീർ ഗിലെയാദിനെ ജനിപ്പിച്ചു; ഗിലെയാദിൽനിന്നു ഗിലെയാദ്യകുടുംബം.',
        30: 'ഗിലെയാദിന്റെ പുത്രന്മാർ ആരെന്നാൽ: ഈയേസെരിൽ നിന്നു ഈയേസെൎയ്യകുടുംബം; ഹേലെക്കിൽനിന്നു ഹേലെക്ക്യകുടുംബം.',
        31: 'അസ്രീയേലിൽനിന്നു അസ്രീയേല്യകുടുംബം; ശേഖെമിൽനിന്നു ശേഖെമ്യകുടുംബം;',
        32: 'ശെമീദാവിൽനിന്നു ശെമീദാവ്യകുടുംബം; ഹേഫെരിൽനിന്നു ഹേഫെൎയ്യകുടുംബം.',
        ...
        35: 'എഫ്രയീമിന്റെ പുത്രന്മാർ കുടുംബംകുടുംബമായി ആരെന്നാൽ: ശൂഥേലഹിൽനിന്നു ശൂഥേലഹ്യകുടുംബം; ബേഖെരിൽനിന്നു ബേഖെൎയ്യകുടുംബം; തഹനിൽനിന്നു തഹന്യകുടുംബം,',
        ...
        40: 'ബേലിയുടെ പുത്രന്മാർ അൎദ്ദും നാമാനും ആയിരുന്നു; അൎദ്ദിൽനിന്നു അൎദ്ദ്യകുടുംബം; നാമാനിൽനിന്നു നാമാന്യകുടുംബം.',
        ...
        45: 'ബെരീയാവിന്റെ പുത്രന്മാരുടെ കുടുംബംങ്ങൾ ആരെന്നാൽ: ഹേബെരിൽനിന്നു ഹേബെൎയ്യകുടുംബം; മൽക്കീയേലിൽനിന്നു മൽക്കീയേല്യകുടുംബം.',
        ...
        49: 'യേസെരിൽനിന്നു യേസെൎയ്യകുടുംബം. ശില്ലോമിൽനിന്നു ശില്ലോമ്യകുടുംബം.',
        ...
        53: 'ഇവൎക്കു ആളെണ്ണത്തിന്നു ഒത്തവണ്ണം ദേശത്തെ അവകാശമായി വിഭാഗിച്ചു കൊടുക്കേണം.',
        54: 'ആളേറെയുള്ളവൎക്കു അവകാശം ഏറെയും ആൾ കുറവുള്ളവൎക്കു അവകാശം കുറെച്ചും കൊടുക്കേണം; ഓരോരുത്തന്നു അവനവന്റെ ആളെണ്ണത്തിന്നു ഒത്തവണ്ണം അവകാശം കൊടുക്കേണം.',
        55: 'ദേശത്തെ ചീട്ടിട്ടു വിഭാഗിക്കേണം; അതതു പിതൃഗോത്രത്തിന്റെ പേരിന്നൊത്തവണ്ണം അവൎക്കു അവകാശം ലഭിക്കേണം.',
        56: 'ആൾ ഏറെയുള്ളവൎക്കും കുറെയുള്ളവൎക്കും അവകാശം ചീട്ടിട്ടു വിഭാഗിക്കേണം.',
        57: 'ലേവ്യരിൽ എണ്ണപ്പെട്ടവർ കുടുംബംകുടുംബമായി ആരെന്നാൽ: ഗേൎശോനിൽനിന്നു ഗേൎശോന്യകുടുംബം; കെഹാത്തിൽനിന്നു കെഹാത്യകുടുംബം; മെരാരിയിൽനിന്നു മെരാൎയ്യകുടുംബം.',
        ...
        63: 'യെരീഹോവിന്റെ സമീപത്തു യോൎദ്ദാന്നരികെ മോവാബ്സമഭൂമിയിൽവെച്ചു യിസ്രായേൽമക്കളെ എണ്ണിയപ്പോൾ മോശെയും പുരോഹിതനായ എലെയാസാരും എണ്ണിയവർ ഇവർ തന്നേ.',
    ...
    28: {
        1: 'യഹോവ പിന്നെയും മോശെയോടു അരുളിച്ചെയ്തതു:',
        2: 'എനിക്കു സൌരഭ്യവാസനയായ ദഹനയാഗങ്ങൾക്കുള്ള എന്റെ ഭോജനമായ വഴിപാടു തക്കസമയത്തു എനിക്കു അൎപ്പിക്കേണ്ടതിന്നു ജാഗ്രതയായിരിപ്പാൻ യിസ്രായേൽമക്കളോടു കല്പിക്കേണം.',
        3: 'നീ അവരോടു പറയേണ്ടതു: നിങ്ങൾ യഹോവെക്കു അൎപ്പിക്കേണ്ടുന്ന ദഹനയാഗം എന്തെന്നാൽ: നാൾതോറും നിരന്തരഹോമയാഗത്തിന്നായി ഒരു വയസ്സു പ്രായമുള്ള ഊനമില്ലാത്ത രണ്ടു കുഞ്ഞാടു.',
        4: 'ഒരു കുഞ്ഞാടിനെ രാവിലേയും മറ്റെ കുഞ്ഞാടിനെ വൈകുന്നേരത്തും യാഗം കഴിക്കേണം.',
        5: 'ഇടിച്ചെടുത്ത എണ്ണ കാൽ ഹീൻ ചേൎത്ത ഒരിടങ്ങഴി മാവു ഭോജനയാഗമായും അൎപ്പിക്കേണം.',
        6: 'ഇതു യഹോവെക്കു സൌരഭ്യവാസനയായ ദഹനയാഗമായി സീനായിപൎവ്വതത്തിൽവെച്ചു നിയമിക്കപ്പെട്ട നിരന്തരഹോമയാഗം.',
        7: 'അതിന്റെ പാനീയയാഗം കുഞ്ഞാടൊന്നിന്നു കാൽ ഹീൻ മദ്യം ആയിരിക്കേണം; അതു യഹോവെക്കു പാനീയയാഗമായി വിശുദ്ധമന്ദിരത്തിൽ ഒഴിക്കേണം.',
        8: 'മറ്റെ കുഞ്ഞാടിനെ വൈകുന്നേരത്തു യാഗം കഴിക്കേണം; അതിനെ രാവിലത്തെ ഭോജനയാഗവും അതിന്റെ പാനീയയാഗവുംപോലെ യഹോവെക്കു സൌരഭ്യവാസനയായ ദഹനയാഗമായി അൎപ്പിക്കേണം.',
        9: 'ശബ്ബത്ത്നാളിലോ ഒരു വയസ്സു പ്രായമുള്ള ഊനമില്ലാത്ത രണ്ടു കുഞ്ഞാടിനെയും ഭോജനയാഗത്തിന്നായി എണ്ണചേൎത്ത രണ്ടിടങ്ങഴി മാവും അതിന്റെ പാനീയയാഗവും അൎപ്പിക്കേണം.',
        ...
        12: 'കാള ഒന്നിന്നു ഭോജനയാഗമായി എണ്ണചേൎത്ത മൂന്നിടങ്ങഴി മാവും ആട്ടുകൊറ്റന്നു ഭോജനയാഗമായി എണ്ണചേൎത്ത രണ്ടിടങ്ങഴി മാവും',
        13: 'കുഞ്ഞാടൊന്നിന്നു ഭോജനയാഗമായി എണ്ണചേൎത്ത ഒരിടങ്ങഴി മാവും അൎപ്പിക്കേണം. അതു ഹോമയാഗം; യഹോവെക്കു സൌരഭ്യവാസനയായ ദഹനയാഗം തന്നേ.',
        ...
        15: 'നിരന്തരഹോമയാഗത്തിന്നും അതിന്റെ പാനീയയാഗത്തിന്നും പുറമെ പാപയാഗമായി യഹോവെക്കു ഒരു കോലാട്ടുകൊറ്റനെയും അൎപ്പിക്കേണം.',
        ...
        19: 'എന്നാൽ നിങ്ങൾ യഹോവെക്കു ഹോമയാഗത്തിന്നായി രണ്ടു കാളക്കിടാവിനെയും ഒരു ആട്ടുകൊറ്റനെയും ഒരു വയസ്സു പ്രായമുള്ള ഏഴു കുഞ്ഞാടിനെയും ദഹനയാഗമായി അൎപ്പിക്കേണം; അവ ഊനമില്ലാത്തവ ആയിരിക്കേണം.',
        20: 'അവയുടെ ഭോജനയാഗം എണ്ണ ചേൎത്ത മാവു ആയിരിക്കേണം; കാള ഒന്നിന്നു മൂന്നിടങ്ങഴിയും ആട്ടുകൊറ്റന്നു രണ്ടിടങ്ങഴിയും',
        21: 'ഏഴു കുഞ്ഞാട്ടിൽ ഓരോന്നിന്നു ഓരോ ഇടങ്ങഴിയും അൎപ്പിക്കേണം.',
        22: 'നിങ്ങൾക്കുവേണ്ടി പ്രായശ്ചിത്തം കഴിപ്പാൻ പാപയാഗത്തിന്നായി ഒരു കോലാട്ടിനെയും അൎപ്പിക്കേണം.',
        23: 'നിരന്തരഹോമയാഗമായ രാവിലത്തെ ഹോമയാഗത്തിന്നു പുറമെ ഇവ അൎപ്പിക്കേണം.',
        24: 'ഇങ്ങനെ ഏഴു നാളും യഹോവെക്കു സൌരഭ്യവാസനയായി ദഹനയാഗത്തിന്റെ ഭോജനം ദിവസംപ്രതി അൎപ്പിക്കേണം. നിരന്തരഹോമയാഗത്തിന്നും അതിന്റെ പാനീയയാഗത്തിന്നും പുറമെ ഇതു അൎപ്പിക്കേണം.',
        ...
        27: 'എന്നാൽ നിങ്ങൾ യഹോവെക്കു സൌരഭ്യവാസനയായ ഹോമയാഗത്തിന്നായി രണ്ടു കാളക്കിടാവിനെയും ഒരു ആട്ടുകൊറ്റനെയും ഒരു വയസ്സു പ്രായമുള്ള ഏഴു കുഞ്ഞാടിനെയും അൎപ്പിക്കേണം.',
        28: 'അവയുടെ ഭോജനയാഗമായി എണ്ണചേൎത്ത മാവു, കാള ഒന്നിന്നു ഇടങ്ങഴി മൂന്നും ആട്ടുകൊറ്റന്നു ഇടങ്ങഴി രണ്ടും',
        29: 'ഏഴു കുഞ്ഞാട്ടിൽ ഓരോന്നിന്നു ഇടങ്ങഴി ഓരോന്നും',
        30: 'നിങ്ങൾക്കുവേണ്ടി പ്രായശ്ചിത്തം കഴിപ്പാൻ ഒരു കോലാട്ടുകൊറ്റനും വേണം.',
        31: 'നിരന്തരഹോമയാഗത്തിന്നും അതിന്റെ ഭോജനയാഗത്തിന്നും അവയുടെ പാനീയയാഗത്തിന്നും പുറമെ നിങ്ങൾ ഇവ അൎപ്പിക്കേണം; അവ ഊനമില്ലാത്തവ ആയിരിക്കേണം.',
    },
    29: {
    ...
    32: {
        1: 'എന്നാൽ രൂബേന്യൎക്കും ഗാദ്യൎക്കും എത്രയും വളരെ ആടുമാടുകൾ ഉണ്ടായിരുന്നു; അവർ യസേർദേശവും ഗിലെയാദ്\u200cദേശവും ആടുമാടുകൾക്കു കൊള്ളാകുന്ന സ്ഥലം എന്നു കണ്ടിട്ടു വന്നു',
        ...
        29: 'ഗാദ്യരും രൂബേന്യരും ഓരോരുത്തൻ യുദ്ധസന്നദ്ധനായി യഹോവയുടെ മുമ്പാകെ നിങ്ങളോടുകൂടെ യോൎദ്ദാന്നക്കരെ കടന്നുപോരികയും ദേശം നിങ്ങളുടെ മുമ്പാകെ കീഴടങ്ങുകയും ചെയ്താൽ നിങ്ങൾ അവൎക്കു ഗിലെയാദ്\u200cദേശം അവകാശമായി കൊടുക്കേണം.',
        ...
        40: 'മോശെ ഗിലെയാദ്\u200cദേശം മനശ്ശെയുടെ മകനായ മാഖീരിന്നു കൊടുത്തു; അവൻ അവിടെ പാൎത്തു.',
