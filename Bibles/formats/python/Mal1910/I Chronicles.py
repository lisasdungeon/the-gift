...
CHAPTERS = {
    1: {
        1: 'ആദാം, ശേത്ത്, ഏനോശ്,',
        2: 'കേനാൻ, മഹലലേൽ, യാരേദ്,',
        3: 'ഹനോക്ക്, മെഥൂശേലഹ്, ലാമെക്ക്, നോഹ,',
        4: 'ശേം, ഹാം, യാഫെത്ത്. യാഫെത്തിന്റെ പുത്രന്മാർ:',
        5: 'ഗോമെർ, മാഗോഗ്, മാദായി, യാവാൻ, തൂബാൽ',
        6: 'മേശെക്ക്, തീരാസ്. ഗോമെരിന്റെ പുത്രന്മാർ: അശ്കേനസ്, രീഫത്ത്, തോഗൎമ്മാ.',
        7: 'യാവാന്റെ പുത്രന്മാർ: എലീശാ, തൎശീശ്, കിത്ഥിം, ദോദാനീം.',
        ...
        15: 'ഗിൎഗ്ഗശി, ഹിവ്വി, അൎക്കി, സീനി, അൎവ്വാദി,',
        16: 'സെമാരി, ഹമാത്തി എന്നിവരെ ജനിപ്പിച്ചു.',
        17: 'ശേമിന്റെ പുത്രന്മാർ: ഏലാം, അശ്ശൂർ, അൎപ്പക്ഷദ്, ലൂദ്, അരാം, ഊസ്, ഹൂൾ, ഗേഥെർ, മേശെക്.',
        18: 'അൎപ്പക്ഷദ് ശേലഹിനെ ജനിപ്പിച്ചു; ശേലഹ് ഏബെരിനെ ജനിപ്പിച്ചു.',
        ...
        48: 'സമ്ലാ മരിച്ചശേഷം നദീതീരത്തുള്ള രെഹോബോത്ത് പട്ടണക്കാരനായ ശൌൽ അവന്നു പകരം രാജാവായി.',
        49: 'ശൌൽ മരിച്ചശേഷം അക്ബോരിന്റെ മകൻ ബാൽഹാനാൻ അവന്നു പകരം രാജാവായി.',
        50: 'ബാൽഹാനാൻ മരിച്ചശേഷം ഹദദ് അവന്നു പകരം രാജാവായി. അവന്റെ പട്ടണത്തിന്നു പായീ എന്നും ഭാൎയ്യക്കു മെഹേതബേൽ എന്നും പേർ. അവൾ മേസാഹാബിന്റെ മകളായ മത്രേദിന്റെ മകളായിരുന്നു.',
        ...
        54: 'മിബ്സാൎപ്രഭു, മഗ്ദീയേൽപ്രഭു, ഈരാംപ്രഭു; ഇവരത്രേ ഏദോമ്യപ്രഭുക്കന്മാർ.',
    },
    2: {
    ...
    3: {
        1: 'ഹെബ്രോനിൽവെച്ചു ദാവീദിന്നു ജനിച്ച പുത്രന്മാരാവിതു: യിസ്രെയേല്ക്കാരത്തിയായ അഹീനോവാം പ്രസവിച്ച അമ്നോൻ ആദ്യജാതൻ; കൎമ്മേല്ക്കാരത്തിയായ അബിഗയിൽ പ്രസവിച്ച ദാനീയേൽ രണ്ടാമൻ;',
        2: 'ഗെശൂർരാജാവായ തൽമായിയുടെ മകളായ മയഖയുടെ മകൻ അബ്ശാലോം മൂന്നാമൻ; ഹഗ്ഗീത്തിന്റെ മകൻ അദോനീയാവു നാലാമൻ;',
        3: 'അബീതാൽ പ്രസവിച്ച ശെഫത്യാവു അഞ്ചാമൻ; അവന്റെ ഭാൎയ്യ എഗ്ലാ പ്രസവിച്ച യിഥ്\u200cരെയാം ആറാമൻ.',
        ...
        12: 'അവന്റെ മകൻ യോവാശ്; അവന്റെ മകൻ അമസ്യാവു; അവന്റെ മകൻ അസൎയ്യാവു. അവന്റെ മകൻ യോഥാം; അവന്റെ മകൻ ആഹാസ്;',
        ...
        21: 'ഹനന്യാവിന്റെ മക്കൾ: പെലത്യാവു, യെശയ്യാവു, രെഫായാവിന്റെ മക്കൾ, അൎന്നാന്റെ മക്കൾ, ഓബദ്യാവിന്റെ മക്കൾ, ശെഖന്യാവിന്റെ മക്കൾ.',
        22: 'ശെഖന്യാവിന്റെ മക്കൾ: ശെമയ്യാവു; ശെമയ്യാവിന്റെ മക്കൾ: ഹത്തൂശ്, യിഗാൽ, ബാരീഹ്, നെയൎയ്യാവ്, ശാഫാത്ത് ഇങ്ങനെ ആറു പേർ.',
        23: 'നെയൎയ്യാവിന്റെ മക്കൾ: എല്യോവേനായി, ഹിസ്കീയാവു, അസ്രീക്കാം ഇങ്ങനെ മൂന്നുപേർ.',
    ...
    14: {
        ...
        3: 'ദാവീദ് യെരൂശലേമിൽവെച്ചു വേറെയും ഭാൎയ്യമാരെ പരിഗ്രഹിച്ചു, വളരെ പുത്രന്മാരെയും പുത്രിമാരെയും ജനിപ്പിച്ചു.',
        ...
        11: 'അങ്ങനെ അവർ ബാൽ-പെരാസീമിൽ ചെന്നു; അവിടെവെച്ചു ദാവീദ് അവരെ തോല്പിച്ചു: വെള്ളച്ചാട്ടംപോലെ ദൈവം എന്റെ ശത്രുക്കളെ എന്റെ കയ്യാൽ തകൎത്തുകളഞ്ഞു എന്നു ദാവീദ് പറഞ്ഞു; അതുകൊണ്ടു ആ സ്ഥലത്തിന്നു ബാൽ-പെരാസീം എന്നു പേർ പറഞ്ഞു വരുന്നു.',
        ...
        17: 'ദാവീദിന്റെ കീൎത്തി സകലദേശങ്ങളിലും പരക്കയും യഹോവ അവനെയുള്ള ഭയം സൎവ്വജാതികൾക്കും വരുത്തുകയും ചെയ്തു.',
    },
    15: {
        ...
        6: 'മെരാൎയ്യരിൽ പ്രധാനിയായ അസായാവെയും അവന്റെ സഹോദരന്മാരായ ഇരുനൂറ്റിരുപതുപേരെയും',
        7: 'ഗേൎശോമ്യരിൽ പ്രധാനിയായ യോവേലിനെയും അവന്റെ സഹോദരന്മാരായ നൂറ്റിമുപ്പതുപേരെയും',
        ...
        17: 'അങ്ങനെ ലേവ്യർ യോവേലിന്റെ മകനായ ഹേമാനെയും അവന്റെ സഹോദരന്മാരിൽ ബേരെഖ്യാവിന്റെ മകനായ ആസാഫിനെയും അവരുടെ സഹോദരന്മാരായ മെരാൎയ്യരിൽ കൂശായാവിന്റെ മകനായ ഏഥാനെയും',
        18: 'അവരോടുകൂടെ രണ്ടാം തരത്തിലെ തങ്ങളുടെ സഹോദരന്മാരായ സെഖൎയ്യാവു, ബേൻ, യാസീയേൽ, ശെമീരാമോത്ത്, യെഹീയേൽ, ഉന്നി, എലീയാബ്, ബെനായാവു, മയസേയാവു, മത്ഥിഥ്യാവു, എലീഫെലേഹൂ, മിക്നേയാവു, ഓബേദ്-എദോം, യെയീയേൽ എന്നിവരെ വാതിൽകാവല്ക്കാരായും നിയമിച്ചു.',
        19: 'സംഗീതക്കാരായ ഹേമാനും ആസാഫും ഏഥാനും താമ്രംകൊണ്ടുള്ള കൈത്താളങ്ങളെയും',
        20: 'സെഖൎയ്യാവു, അസീയേൽ, ശെമീരാമോത്ത്, യെഹീയേൽ, ഉന്നി, എലീയാബ്, മയസേയാവു, ബെനായാവു എന്നിവർ അലാമോത്ത് രാഗത്തിൽ വീണകളെയും ധ്വനിപ്പിപ്പാനും',
        ...
        22: 'വാഹകന്മാരായ ലേവ്യരിൽ പ്രധാനിയായ കെനന്യാവു പെട്ടകം വഹിക്കുന്നതിന്നു മേൽവിചാരകനായിരുന്നു; അവൻ അതിൽ സമൎത്ഥനായിരുന്നു.',
        23: 'ബേരെഖ്യാവും എല്ക്കാനയും പെട്ടകത്തിന്നു വാതിൽകാവല്ക്കാർ ആയിരുന്നു.',
        24: 'ശെബന്യാവു, യോശാഫാത്ത്, നെഥനയേൽ, അമാസായി, സെഖൎയ്യാവു, ബെനായാവു, എലെയാസാർ എന്നീ പുരോഹിതന്മാർ ദൈവത്തിന്റെ പെട്ടകത്തിന്മുമ്പിൽ കാഹളം ഊതി; ഓബേദ്-എദോമും യെഹീയാവും പെട്ടകത്തിന്നു വാതിൽകാവല്ക്കാർ ആയിരുന്നു.',
        ...
        26: 'യഹോവയുടെ നിയമപെട്ടകത്തിന്റെ വാഹകന്മാരായ ലേവ്യൎക്കു ദൈവം സഹായിച്ചതുകൊണ്ടു അവർ ഏഴു കാളയെയും ഏഴു ആട്ടുകൊറ്റനെയും യാഗംകഴിച്ചു.',
        ...
        28: 'അങ്ങനെ യിസ്രായേലൊക്കയും ആൎപ്പോടും കാഹളനാദത്തോടും തൂൎയ്യങ്ങളുടെയും കൈത്താളങ്ങളുടെയും ധ്വനിയോടുംകൂടി കിന്നരവും വീണയും വായിച്ചുകൊണ്ടു യഹോവയുടെ നിയമപെട്ടകം കൊണ്ടുവന്നു.',
        29: 'എന്നാൽ യഹോവയുടെ നിയമപെട്ടകം ദാവീദിന്റെ നഗരത്തിൽ എത്തിയപ്പോൾ ശൌലിന്റെ മകളായ മീഖൾ കിളിവാതിലിൽകൂടി നോക്കി, ദാവീദ് രാജാവു നൃത്തം ചെയ്യുന്നതും പാടുന്നതും കണ്ടു ഹൃദയത്തിൽ അവനെ നിന്ദിച്ചു',
    },
    16: {
    ...
    19: {
        ...
        5: 'ചിലർ ചെന്നു ആ പുരുഷന്മാരുടെ വസ്തുത ദാവീദിനെ അറിയിച്ചു; അവർ ഏറ്റവും ലജ്ജിച്ചിരിക്കയാൽ അവൻ അവരെ എതിരേല്പാൻ ആളയച്ചു; നിങ്ങളുടെ താടി വളരുന്നതുവരെ യെരീഹോവിൽ പാൎത്തിട്ടു മടങ്ങിവരുവിൻ എന്നു രാജാവു പറയിച്ചു.',
        6: 'തങ്ങൾ ദാവീദിന്നു വെറുപ്പായി എന്നു അമ്മോന്യർ കണ്ടപ്പോൾ ഹാനൂനും അമ്മോന്യരും മെസൊപൊതാമ്യയിൽനിന്നും മയഖയോടു ചേൎന്ന അരാമിൽനിന്നും സോബയിൽനിന്നും രഥങ്ങളെയും കുതിരപ്പടയാളികളെയും ആയിരം താലന്ത് വെള്ളി കൊടുത്തു കൂലിക്കു വാങ്ങി.',
        ...
        10: 'തന്റെ മുമ്പിലും പിമ്പിലും പട നിരന്നിരിക്കുന്നു എന്നു കണ്ടപ്പോൾ യോവാബ് എല്ലായിസ്രായേൽവീരന്മാരിൽനിന്നും ആളുകളെ തിരഞ്ഞെടുത്തു അരാമ്യൎക്കെതിരെ അണിനിരത്തി.',
        11: 'ശേഷം പടജ്ജനത്തെ അവൻ തന്റെ സഹോദരനായ അബീശായിയെ ഏല്പിച്ചു; അവർ അമ്മോന്യൎക്കെതിരെ അണിനിരന്നു.',
        ...
        13: 'ധൈൎയ്യമായിരിക്ക; നാം നമ്മുടെ ജനത്തിന്നും നമ്മുടെ ദൈവത്തിന്റെ പട്ടണങ്ങൾക്കും വേണ്ടി പുരുഷത്വം കാണിക്കുക; യഹോവയോ തനിക്കു ഇഷ്ടമായതു ചെയ്യുമാറാകട്ടെ എന്നു പറഞ്ഞു.',
        ...
        17: 'അതു ദാവീദിന്നു അറിവു കിട്ടിയപ്പോൾ അവൻ എല്ലായിസ്രായേലിനെയും കൂട്ടി യോൎദ്ദാൻ കടന്നു അവൎക്കെതിരെ ചെന്നു അവരുടെ നേരെ അണിനിരത്തി. ദാവീദ് അരാമ്യൎക്കു നേരെ പടെക്കു അണിനിരത്തിയ ശേഷം അവർ അവനോടു പടയേറ്റു യുദ്ധം ചെയ്തു.',
    ...
    26: {
        ...
        2: 'മെശേലെമ്യാവിന്റെ പുത്രന്മാർ: സെഖൎയ്യാവു ആദ്യജാതൻ; യെദീയയേൽ രണ്ടാമൻ; സെബദ്യാവു മൂന്നാമൻ, യത്നീയേൽ നാലാമൻ, ഏലാം അഞ്ചാമൻ;',
        ...
        11: 'ഹില്ക്കീയാവു രണ്ടാമൻ, തെബല്യാവു മൂന്നാമൻ, സെഖൎയ്യാവു നാലാമൻ; ഹോസയുടെ പുത്രന്മാരും സഹോദരന്മാരും എല്ലാം കൂടി പതിമ്മൂന്നുപേർ.',
        ...
        14: 'കിഴക്കെ വാതിലിന്റെ ചീട്ടു ശേലെമ്യാവിന്നു വന്നു; പിന്നെ അവർ അവന്റെ മകനായി വിവേകമുള്ള ആലോചനക്കാരനായ സെഖൎയ്യാവിന്നു വേണ്ടി ചീട്ടിട്ടു; അവന്റെ ചീട്ടു വടക്കെ വാതിലിന്നു വന്നു.',
        15: 'തെക്കെ വാതിലിന്റെതു ഓബേദ്-എദോമിന്നും പാണ്ടിശാലയുടേതു അവന്റെ പുത്രന്മാൎക്കും',
        ...
        18: 'പൎബാരിന്നു പടിഞ്ഞാറു പെരുവഴിയിൽ നാലുപേരും പൎബാരിൽ തന്നേ രണ്ടുപേരും ഉണ്ടായിരുന്നു.',
        19: 'കോരഹ്യരിലും മെരാൎയ്യരിലും ഉള്ള വാതിൽകാവല്ക്കാരുടെ കൂറുകൾ ഇവ തന്നേ.',
        20: 'അവരുടെ സഹോദരന്മാരായ ലേവ്യർ ദൈവലായത്തിലെ ഭണ്ഡാരത്തിന്നും വിശുദ്ധവസ്തുക്കളുടെ ഭണ്ഡാരത്തിന്നും മേൽവിചാരകരായിരുന്നു.',
        21: 'ലയെദാന്റെ പുത്രന്മാർ: ലയെദാന്റെ കുടുംബത്തിലുള്ള ഗേൎശോന്യരുടെ പുത്രന്മാർ: ഗേൎശോന്യനായ ലയെദാന്റെ പിതൃഭവനത്തലവന്മാർ യെഹീയേല്യർ ആയിരുന്നു.',
        ...
        24: 'മോശെയുടെ മകനായ ഗേൎശോമിന്റെ മകൻ ശെബൂവേൽ ഭണ്ഡാരത്തിന്നു മേൽവിചാരകനായിരുന്നു.',
        ...
        28: 'ദൎശകനായ ശമൂവേലും കീശിന്റെ മകൻ ശൌലും നേരിന്റെ മകൻ അബ്നേരും സെരൂയയുടെ മകൻ യോവാബും നിവേദിച്ച സകലനിവേദിതവസ്തുക്കളും ശെലോമീത്തിന്റെയും അവന്റെ സഹോദരന്മാരുടെയും വിചാരണയിൽ വന്നു.',
        29: 'യിസ്ഹാൎയ്യരിൽ കെനന്യാവും അവന്റെ പുത്രന്മാരും പുറമെയുള്ള പ്രവൃത്തിക്കു യിസ്രായേലിൽ പ്രമാണികളും ന്യായാധിപന്മാരും ആയിരുന്നു.',
        30: 'ഹെബ്രോന്യരിൽ ഹശബ്യാവും അവന്റെ സഹോദരന്മാരുമായി ആയിരത്തെഴുനൂറു പ്രാപ്തന്മാർ യോൎദ്ദാന്നിക്കരെ പടിഞ്ഞാറു യഹോവയുടെ സകലകാൎയ്യത്തിന്നും രാജാവിന്റെ ശുശ്രൂഷെക്കും യിസ്രായേലിൽ മേൽവിചാരകരായിരുന്നു.',
        31: 'ഹെബ്രോന്യരിൽ കുലംകുലമായും കുടുംബംകുടുംബമായുമുള്ള ഹെബ്രോന്യൎക്കു യെരീയാവു തലവനായിരുന്നു; ദാവീദിന്റെ വാഴ്ചയുടെ നാല്പതാം ആണ്ടിൽ അവരുടെ വസ്തുത അനേഷിച്ചപ്പോൾ അവരുടെ ഇടയിൽ ഗിലെയാദിലെ യാസേരിൽ പ്രാപ്തന്മാരെ കണ്ടു.',
    ...
    28: {
        ...
        2: 'ദാവീദ്\u200cരാജാവു എഴുന്നേറ്റുനിന്നു പറഞ്ഞതു എന്തെന്നാൽ: എന്റെ സഹോദരന്മാരും എന്റെ ജനവുമായുള്ളോരേ, എന്റെ വാക്കു കേൾപ്പിൻ; യഹോവയുടെ നിയമപെട്ടകത്തിനും നമ്മുടെ ദൈവത്തിന്റെ പാദപീഠത്തിന്നുമായി ഒരു വിശ്രമാലയം പണിവാൻ എനിക്കു താല്പൎയ്യം ഉണ്ടായിരുന്നു; പണിക്കുവേണ്ടി ഞാൻ വട്ടംകൂട്ടിയിരുന്നു.',
