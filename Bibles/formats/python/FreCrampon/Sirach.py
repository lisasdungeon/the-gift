...
CHAPTERS = {
    1: {
        ...
        9: "C'est lui qui l'a créée; il l'a vue et il l'a fait connaître.",
    ...
    6: {
        1: "et d'ami ne deviens pas ennemi; car le méchant aura en partage le mauvais renom, la honte et l'opprobre: tel est le pécheur à la langue double.",
    ...
    14: {
        ...
        5: 'Celui qui est mauvais à lui-même, pour qui sera-t-il bon? Il ne jouira pas de ses propres trésors.',
        6: "Il n'y a pas pire que celui qui se refuse tout, et c'est là le juste salaire de sa malice.",
    ...
    24: {
        ...
        15: "J'ai donné du parfum comme la canelle et comme le baume odorant, et comme une myrrhe choisie j'ai répandu une odeur suave, comme le galbanum, l'onyx et le stacte, et comme la vapeur de l'encens dans le tabernacle.",
    ...
    37: {
        ...
        11: "Ne consulte pas une femme sur sa rivale, un lâche sur la guerre, un marchand sur un échange, un acheteur sur une vente, un envieux sur la reconnaissance, un homme sans compassion sur un acte charitable, un paresseux sur un travail quelconque, un mercenaire de la maison sur l'achèvement d'un travail, un esclave paresseux sur une grosse besogne: ne fais fonds sur ces gens pour aucun conseil.",
    ...
    39: {
        ...
        28: 'Il y a des vents qui ont été créés pour la vengeance, et, dans leur fureur, ils déchaînent leurs fléaux. Au jour de la destruction, ils déploieront leur puissance, et apaiseront le courroux de Celui qui les a faits.',
    ...
    41: {
        1: "O mort, que ton souvenir est amer à l'homme qui vit en paix au sein de ses richesses, à l'homme exempt de soucis et qui prospère en tout, et qui est encore en état de goûter le plaisir de la table!",
        2: "O mort, ton arrêt est agréable, à l'indigent, à celui dont les forces sont épuisées, au vieillard accablé d'années et travaillé de mille soins, à celui qui ne se soumet pas à son sort et qui a perdu l'espérance.",
        ...
        11: "Les hommes s'attristent pour leur corps, mais le nom odieux des pécheurs sera anéanti.",
    ...
    45: {
        ...
        10: "Il l'entoura du vêtement sacré, tissé d'or, d'hyacinthe et de pourpre, ouvrage du brodeur; du rational du jugement, avec l'Urim et le Thummim, fait de fils d'écarlate, œuvre d'un artiste;",
    ...
    49: {
        ...
        4: "A l'exception de David, d'Ezéchias et de Josias, tous les autres ont commis l'iniquité; car, ayant abandonné la loi du Très-Haut, les rois de Juda sont allés à leur perte.",
    ...
    50: {
        ...
        8: "comme la fleur des roses aux jours du printemps, comme les lys sur le bord des eaux, comme le rameau de l'arbre odoriférant aux jours de l'été,",
        ...
        18: 'Et les chantres, en déployant leur voix, le louaient; le vaste temple retentissait de doux accords.',
        ...
        29: "car s'il les met en pratique, il triomphera de tout, parce que la lumière du Seigneur est son sentier. <DEUX APPENDICES >",
    },
    51: {
        ...
        12: "car vous m'avez sauvé de la ruine, et vous m'avez délivré au temps du malheur. C'est pourquoi je vous célébrerai et je vous louerai, et je bénirai le nom du Seigneur. — Zèle pour l'acquisition de la sagesse —",
