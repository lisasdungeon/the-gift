...
CHAPTERS = {
    ...
    4: {
        ...
        11: "si quelqu'un exerce un ministère, qu'il le fasse comme par la vertu que Dieu donne, afin qu'en toutes choses Dieu soit glorifié par Jésus-Christ, à qui appartiennent la gloire et la puissance aux siècles des siècles. Amen!",
        ...
        15: "Que nul d'entre vous ne souffre comme meurtrier, comme voleur ou malfaiteur, ou comme avide du bien d'autrui.",
