...
CHAPTERS = {
    ...
    2: {
        ...
        23: 'Et il arrivera en ce jour, je répondrai, — oracle de Yahweh, je répondrai aux cieux, et eux répondront à la terre;',
        24: "la terre répondra au froment, au vin nouveau et à l'huile, et eux répondront à Jezrahel.",
    ...
    7: {
        ...
        16: "Ils se tournent, mais non pas en haut; ils sont comme un arc trompeur; leurs chefs tomberont par l'épée à cause de la fureur de leurs langues; et cela fera rire d'eux au pays d'Egypte.",
    },
    8: {
    ...
    9: {
        ...
        6: "Car voici qu'ils sont partis devant la dévastation, l'Egypte les recueillera. Memphis les ensevelira; leurs objets précieux d'argent, le chardon s'en emparera; l'épine envahira leurs tentes.",
    ...
    11: {
        ...
        8: "Comment te délaisserais-je, Ephraïm, te livrerais-je, Israël? Comment te laisserais-je devenir comme Adama, te rendrais-je comme Séboïm? Mon cœur se retourne en moi, et toutes ensemble, mes compassions s'émeuvent.",
    ...
    12: {
        ...
        3: 'Yahweh a aussi procès avec Juda; il va châtier Jacob selon ses voies, il lui rendra selon ses œuvres.',
    ...
    14: {
        ...
        3: 'Prenez avec vous des paroles, et revenez à Yahweh; dites-lui: " Otez toute iniquité et prenez ce qui est bon! Que nous vous offrions, au lieu de taureaux, les paroles de nos lèvres.',
