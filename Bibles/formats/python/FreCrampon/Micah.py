...
CHAPTERS = {
    1: {
        ...
        2: 'Ecoutez, vous tous, peuples! Sois attentive, terre, avec ce qui te remplit! Le Seigneur Yahweh va témoigner contre vous, le Seigneur, du palais de sa sainteté!',
    ...
    5: {
        ...
        7: "Et le reste de Jacob sera aussi parmi les nations, au milieu de peuples nombreux, comme un lion parmi les bêtes de la forêt, comme un jeune lion parmi les troupeaux de brebis; lorsqu'il passe, foule et déchire, personne ne délivre.",
    ...
    7: {
        ...
        12: "Ce jour-là, on viendra jusqu'à toi, de l'Assyrie et des villes d'Egypte, de l'Egypte jusqu'au fleuve, d'une mer à l'autre et d'une montagne à l'autre.",
