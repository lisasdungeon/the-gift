...
CHAPTERS = {
    1: {
        ...
        3: 'Baruch lut les paroles de ce livre aux oreilles de Jéchonias, fils de Joakim, roi de Juda, et aux oreilles de tout le peuple qui était venu pour entendre ce livre,',
        ...
        10: 'Ils dirent: " Voici que nous vous envoyons de l\'argent; achetez avec cet argent des victimes pour les holocaustes et les sacrifices d\'expiation, et de l\'encens; faites aussi des oblations, et offrez-les sur l\'autel du Seigneur, notre Dieu.',
        ...
        15: "Et vous direz: Au Seigneur notre Dieu appartient la justice, à nous la confusion du visage, comme on le voit aujourd'hui, pour les hommes de Juda, et les habitants de Jérusalem,",
        ...
        20: "Aussi, comme on le voit en ce jour, de grands malheurs se sont attaches à nous, ainsi que la malédiction que le Seigneur a prononcée, par l'intermédiaire de Moïse, son serviteur, qui a fait sortir nos pères du pays d'Egypte, pour nous donner un pays où coulent le lait et le miel.",
    ...
    2: {
        ...
        11: "Et maintenant, Seigneur, Dieu d’Israël, qui avez fait sortir votre peuple du pays d'Egypte par une main forte, par des miracles et des prodiges, avec une grande puissance et un bras élevé, et qui vous êtes fait un nom, comme on le voit en ce jour,",
        ...
        20: "Car vous avez envoyé sur nous votre colère et votre indignation, comme vous l'aviez proclamé par vos serviteurs les prophètes,",
        21: 'en disant: Ainsi parle le Seigneur: " Inclinez vos épaules et votre cou et servez le roi de Babylone, et vous demeurerez dans le pays que j\'ai donné à vos pères.',
        ...
        24: "Nous n'avons pas écouté votre voix, en servant le roi de Babylone, et vous avez accompli vos paroles, prononcées par l'organe de vos serviteurs les prophètes, annonçant que les ossements de nos rois et les ossements de nos pères seraient ôtés de leurs sépulcres.",
        25: "Et voici qu'ils ont été, en effet, jetés sur le sol, exposés aux ardeurs du soleil et au froid de la nuit; et nos pères sont morts dans de cruelles souffrances, par la faim, par le glaive et par la peste.",
    ...
    4: {
        ...
        9: "Car elle a vu fondre sur vous la colère de Dieu, et elle a dit: Écoutez, voisines de Sion, car Dieu m'a envoyé un grand deuil.",
        ...
        12: "Que nul ne se réjouisse en me voyant veuve, et délaissée d'un grand nombre! Je suis déserte à cause des péchés de mes fils, parce qu'ils se sont détournés de la loi de Dieu,",
        ...
        34: 'Je lui ôterai la joie que lui causaient ses nombreux habitants, et sa jactance sera changée en deuil.',
    ...
    5: {
        ...
        2: "enveloppe-toi du manteau de la justice qui te vient de Dieu; mets sur ta tête la mitre de la gloire de l'Éternel.",
