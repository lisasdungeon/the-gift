...
CHAPTERS = {
    1: {
        ...
        10: "Ecoutez la parole de Yahweh, juges de Sodome; prêtez l'oreille à la loi de notre Dieu, peuple de Gomorrhe.",
    ...
    5: {
        ...
        12: "La harpe et le luth, le tambourin, la flûte et le vin, voilà leurs festins; mais ils ne prennent point garde à l'œuvre de Yahweh, et ils ne voient point l'ouvrage de ses mains.",
        ...
        19: 'Qui disent: " Qu\'il se dépêche, qu\'il hâte son œuvre, afin que nous la voyions! Qu\'il s\'approche et s\'exécute, le décret du Saint d\'Israël, et que nous sachions!... "',
    ...
    7: {
        ...
        11: '" Demande un signe à Yahweh, ton Dieu, demande-le dans les profondeurs du schéol ou dans les hauteurs du ciel. "',
    ...
    9: {
        ...
        19: "On coupe à droite, et l'on a faim; on dévore à gauche, et l'on n'est point rassasié; chacun dévore la chair de son bras; Manassé contre Ephraïm, Ephraïm contre Manassé, tous deux ensemble contre Juda.",
    ...
    10: {
        ...
        7: "Mais lui, ce n'est pas ainsi qu'il l'entend, et telle n'est pas la pensée de son cœur; car il ne songe qu'à détruire, et à exterminer des nations, non en petit nombre.",
    ...
    18: {
        1: 'Oh! Terre ou résonne le bruissement des ailes, au delà des fleuves de Cusch!',
    ...
    20: {
        ...
        3: 'Et Yahweh dit: " De même que mon serviteur Isaïe a marché nu et déchaussé; étant pendant trois ans un signe et un présage, pour l\'Egypte et pour l\'Ethiopie;',
        4: "ainsi le roi d'Assyrie emmènera les captifs de l'Egypte, et les déportés de l'Ethiopie, jeunes gens et vieillards, nus et déchaussés, et les reins découverts, à la honte de l'Egypte.",
        5: "Alors ils seront consternés et confus, à cause de l'Ethiopie, qui était leur espoir, et de l'Egypte qui était leur sujet de gloire.",
    ...
    25: {
        ...
        3: "C'est pourquoi un peuple puissant vous glorifiera; la cité des nations terribles vous révèrera.",
    ...
    29: {
        ...
        5: "Et la multitude de tes ennemis sera comme une fine poussière, et la multitude des guerriers comme la paille qui s'envole.",
        6: 'Et il arrivera que soudain, en un instant, tu seras visitée, par Yahweh des armées avec fracas, tonnerre et grand bruit, tourbillon, tempête et flamme de feu dévorant.',
        ...
        13: "Le Seigneur dit: Puisque ce peuple s'approche en paroles et m'honore des lèvres, tandis qu'il tient son cœur éloigné de moi, et que le culte qu'il me rend est un précepte appris des hommes,",
        ...
        15: 'Malheur à ceux qui cachent profondément à Yahweh le secret de leurs desseins, dont l\'œuvre s\'accomplit dans les ténèbres, et qui disent: " Qui nous voit, qui nous connaît? "',
        16: 'Quelle folie! Le potier sera-t-il donc estimé pour de l\'argile, que l\'œuvre dise de l\'ouvrier: " Il ne m\'a point faite; " et que le vase dise du potier: " Il n\'y entend rien? "',
        ...
        19: "Les humbles se réjouiront de plus en plus en Yahweh, et les plus pauvres tressailliront dans le Saint d'Israël.",
        20: "Car l'oppresseur aura disparu, et le moqueur aura péri, et tous ceux qui méditent l'iniquité seront exterminés,",
        21: 'ceux qui condamnent un homme pour un mot, qui tendent des pièges à celui qui les confond à la porte, et qui perdent le juste par leurs mensonges.',
        ...
        23: "Car, lorsqu'il verra, lui et ses enfants, l'œuvre de mes mains au milieu d'eux, ils sanctifieront mon nom, ils sanctifieront le Saint de Jacob, et ils révéreront le Dieu d'Israël.",
    ...
    30: {
        ...
        3: "La protection de Pharaon sera pour vous une honte; et le refuge à l'ombre de l'Egypte, une confusion.",
        ...
        7: 'Le secours de l\'Egypte sera vanité et néant, c\'est pourquoi je la nomme: " La superbe qui reste assise. "',
        ...
        11: 'Ecartez-vous de la voie, détournez-vous du chemin; ôtez de devant nos yeux le Saint d\'Israël! " —',
        ...
        16: 'et vous avez dit: " Non! Mais nous fuirons sur des chevaux! " — eh bien, vous fuirez — " Nous volerons sur des coursiers! " — eh bien, ceux qui vous poursuivront seront plus rapides!',
    ...
    37: {
        ...
        12: "Est-ce que leurs dieux les ont délivrées, ces nations que mes pères ont détruites: Gozan, Haram, Réseph et les fils d'Eden, qui étaient à Thélasar?",
        ...
        21: 'Et Isaïe, fils d\'Amos, envoya dire à Ezéchias: " Ainsi dit Yahweh, Dieu d\'Israël: La prière que tu m\'as adressée au sujet de Sennachérib, roi d\'Assyrie, je l\'ai entendue.',
        ...
        25: "J'ai creusé, et j'ai eu de l'eau à boire; avec la plante de mes pieds je dessécherai tous les fleuves de l'Egypte.",
    ...
    40: {
        ...
        13: "Qui a dirigé l'esprit de Yahweh, et quel a été son conseiller pour l'instruire?",
        14: "Avec qui a-t-il tenu conseil, pour qu'il l'éclaire, pour qu'il lui enseigne le sentier de la justice, pour qu'il lui enseigne la sagesse, et lui montre le chemin de l'intelligence?",
        ...
        19: "Quand l'ouvrier a coulé une idole, l'orfèvre la recouvre d'or, et il lui fond des chaînettes d'argent.",
        20: 'Le pauvre, qui ne peut offrir beaucoup, choisit un bois qui ne pourrisse point; et il va chercher un ouvrier habile, pour faire une idole qui ne branle point.',
    ...
    44: {
        ...
        12: "L'ouvrier en fer travaille avec le ciseau, il passe son œuvre dans les charbons embrasés, il la façonne avec le marteau; il la travaille d'un bras vigoureux. Cependant, il a faim, et le voilà sans force; il ne boit pas d'eau, et le voilà épuisé!",
        ...
        16: 'Il en a brûlé au feu la moitié; avec l\'autre moitié, il apprête sa viande; il cuit son rôti et se rassasie. Il se chauffe aussi et il dit: " Ah! Ah! Je me réchauffe; je sens la flamme! "',
        ...
        23: 'Cieux, poussez des cris de joie, car Yahweh a fait cela! Retentissez, profondeurs de la terre! Eclatez de joie, montagnes, forêts, avec tous vos arbres; car Yahweh a racheté Jacob, et manifesté sa gloire en Israël!',
    ...
    47: {
        ...
        6: "J'étais irrité contre mon peuple; j'ai laissé profaner mon héritage et je les ai livrés entre tes mains... Tu ne leur fis point de miséricorde; sur le vieillard tu as fait peser lourdement ton joug.",
    ...
    51: {
        ...
        20: 'Tes fils, épuisés de force, sont gisants au coin de toutes les rues, comme une antilope dans le filet du chasseur, ivres de la fureur de Yahweh, de la menace de ton Dieu.',
    ...
    57: {
        1: 'Cependant, le juste disparaît, et personne ne le prend à cœur; les hommes pieux sont enlevés, et nul ne prend garde que le juste a été retiré du malheur,',
    ...
    58: {
        ...
        6: 'Le jeûne que je choisis ne consiste-t-il pas en ceci: détacher les chaînes injustes, délier les nœuds du joug, renvoyer libres les opprimés, briser toute espèce de joug?',
    ...
    59: {
        ...
        13: 'Etre infidèles et renier Yahweh, nous retirer loin de notre Dieu, proférer la violence et la révolte, concevoir et tirer de notre cœur des paroles de mensonge!...',
    ...
    61: {
        1: "L'esprit du Seigneur Yahweh est sur moi, parce que Yahweh m'a oint; il m'a envoyé porter la bonne nouvelle aux malheureux; panser ceux qui ont le cœur brisé; Annoncer aux captifs la liberté et aux prisonniers l'élargissement;",
