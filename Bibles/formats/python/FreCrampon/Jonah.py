...
CHAPTERS = {
    ...
    4: {
        ...
        5: "Et Jonas sortit de la ville et s'assit à l'orient de la ville; là il se fit une hutte et s'assit dessous à l'ombre, jusqu'à ce qu'il vît ce qui arriverait dans la ville.",
