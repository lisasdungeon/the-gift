...
CHAPTERS = {
    ...
    2: {
        ...
        30: 'Ty för Kristi verks skull var han nära döden, i det han satte sitt liv på spel, för att giva mig ersättning för den tjänst som jag måste sakna från eder personligen. [1] Eller: Haven i edert förhållande till varandra samma sinne som I haven i Kristus Jesus, vilken var till osv.',
    },
    3: {
    ...
    4: {
        ...
        3: 'Ja, också till dig, min Synsygus -- du som med rätta bär det namnet[1] -- har jag en bön: Var dessa kvinnor till hjälp, ty jämte mig hava de kämpat i evangelii tjänst, de såväl som Klemens och mina andra medarbetare, vilkas namn äro skrivna i livets bok.',
        ...
        23: 'Herrens, Jesu Kristi, nåd vare med eder ande. [1] Synsygus betyder medhjälpare.',
    },
}
