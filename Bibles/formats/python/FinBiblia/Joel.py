...
CHAPTERS = {
    ...
    3: {
        ...
        13: 'Sivaltakaat viikahteella, sillä elo on kypsä; tulkaat ja astukaat alas; sillä kuurnat ovat täydet, ja kuurnaastiat kuohuvat; sillä heidän pahuutensa on suuri.',
