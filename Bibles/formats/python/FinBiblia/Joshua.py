...
CHAPTERS = {
    ...
    2: {
        ...
        10: 'Sillä me olemme kuulleet, kuinka Herra kuivasi Punaisen meren vedet teidän edestänne lähteissänne Egyptistä, ja mitä te olette tehneet niille kahdelle Amorilaisten kuninkaalle, jotka olivat tuolla puolella Jordania, Sihonille ja Ogille, jotka te tapoitte.',
    ...
    4: {
        1: 'Ja kun kaikki kansa oli tullut Jordanin yli, puhui Herra Josualle, sanoen:',
    ...
    5: {
        ...
        2: 'Siihen aikaan sanoi Herra Josualle: tee sinulles kiviveitset ja ympärileikkaa taas Israelin lapset toisen kerran.',
        3: 'Niin teki Josua itsellensä kiviveitset ja ympärileikkasi Israelin lapset Aralotin kukkulalla.',
        4: 'Ja tämä on syy, jonkatähden Josua heidät siinä ympärileikkasi: kaikki se kansa joka läksi ulos Egyptistä, miehenpuoli, kaikki sotamiehet kuolivat tiellä korvessa, sitte kuin he läksivät Egyptistä.',
        ...
        6: 'Sillä Israelin lapset vaelsivat neljäkymmentä ajastaikaa korvessa, siihenasti että kaikki kansa sotamiehiä, jotka Egyptistä lähteneet olivat, loppuivat, jotka ei kuulleet Herran ääntä; niinkuin Herra heille vannonut oli, ettei heidän pitänyt näkemän sitä maata, jonka Herra heidän isillensä vannonut oli, antaaksensa meille maan, rieskaa ja hunajaa vuotavan.',
        7: 'Heidän lapsensa, jotka heidän siaansa tulivat, ympärileikkasi Josua; sillä heillä oli esinahka, ja ei olleet ympärileikatut matkalla.',
        8: 'Ja kuin kaikki kansa ympärileikattu oli, pysyivät he siallansa leirissä siihenasti että he paranivat.',
        9: 'Ja Herra sanoi Josualle: tänäpänä olen minä teiltä kääntänyt pois Egyptin häväistyksen; ja se paikka kutsutaan Gilgal, tähän päivään asti.',
        10: 'Ja kuin Israelin lapset niin sioittivat itsensä Gilgalissa, pitivät he pääsiäistä neljäntenätoistakymmenentenä päivänä sinä kuukautena, ehtoona, Jerihon kedolla,',
        11: 'Ja söivät sen maan jyvistä toisena pääsiäispäivänä, happamattomia leipiä ja paistetuita tähkäpäitä, juuri sinä päivänä.',
        12: 'Ja manna lakkasi toisena päivänä, sittekuin he syöneet olivat maan jyvistä, niin ettei Israelin lapsilla enää ollut mannaa, vaan he söivät Kanaanin maan hedelmää sinä vuonna.',
        13: 'Ja tapahtui kuin Josua oli lähellä Jerihoa, nosti hän silmänsä ja näki: ja katso, mies seisoi siellä hänen edessänsä, ja oli avoin miekka hänen kädessänsä; ja Josua meni hänen tykönsä ja sanoi hänelle: oletko sinä meidän vai vihamiestemme puolella?',
        14: 'Hän sanoi: en, vaan minä olen Herran sotajoukon päämies, ja olen nyt tullut; niin Josua lankesi maahan kasvoillensa ja kumarsi häntä, ja sanoi hänelle: mitä Herrani sanoo palveliallensa?',
        15: 'Ja Herran sotajoukon päämies sanoi Josualle: riisu kengät jaloistas, sillä paikka, jossa seisot, on pyhä; ja Josua teki niin.',
    },
    6: {
        ...
        15: 'Ja tapahtui seitsemäntenä päivänä, kuin huomenrusko kävi ylös, nousivat he varhain ja kävivät entisellä tavalla seitsemän kertaa kaupungin ympäri; ja sinä päivänä ainoastaan kävivät he seitsemän kertaa kaupungin ympäri.',
    ...
    7: {
        ...
        25: 'Ja Josua sanoi: miksis meitä murheelliseksi saatit? saattakoon Herra sinun murheelliseksi tänäpäivänä. Ja koko Israel kivitti heitä kuoliaaksi, ja polttivat heidät tulella sitte kuin he olivat heidän kivittäneet.',
    ...
    8: {
        1: 'Ja Herra sanoi Josualle: älä pelkää, älä myös vapise: ota kanssas kaikki sotaväki, ja nouse ja mene ylös Aihin; katso, minä annan Ain kuninkaan kansoinensa, kaupunkinensa ja mainensa sinun kätees.',
        ...
        5: 'Ja minä ja kaikki kansa, joka minun kanssani on, lähestymme kaupunkia. Ja kuin he tulevat ulos meitä vastaan niinkuin ennenkin, niin me pakenemme heidän edellänsä,',
        6: 'Että he tulisivat meidän jälkeemme niinkauvan, että me saisimme heidät eroitetuksi kaupungista; sillä he sanovat: he pakenevat meidän edellämme niinkuin ennenkin; ja me pakenemme heidän edellänsä.',
        ...
        15: 'Mutta Josua ja kaikki Israel teeskelivät heidän edessänsä niinkuin he olisivat lyödyt ja pakenivat tietä myöten korpeen päin.',
        ...
        20: 'Ja Ain miehet kääntyivät ja katsoivat taaksensa, ja näkivät savun nousevan kaupungista taivaaseen. Ja ei ollut heillä siaa paeta ei sinne eikä tänne; ja se kansa, joka pakeni korpeen päin, palasi niitä vastaan, jotka heitä takaa ajoivat.',
        ...
        22: 'Ja jotka kaupungissa olivat, menivät ulos heitä vastaan, niin he tulivat keskelle Israelia molemmilta puolilta; ja he löivät heitä siihenasti ettei yhtään heistä elämään jäänyt, eikä myös päässyt pois.',
        23: 'Ja Ain kuninkaan ottivat he elävänä kiinni ja veivät hänen Josuan tykö.',
        24: 'Ja kuin Israel oli lyönyt kuoliaaksi kaikki Ain asujat kedolla ja korvessa, johonka he heitä ajoivat takaa, ja he lankesivat kaikki miekan terällä, siihenasti että he loppuivat; niin koko Israel palasi Aihin ja löi kaiken sen miekan terällä.',
        ...
        26: 'Ja ei Josua kättänsä vetänyt puoleensa, jolla hän oli ojentanut keihään, siihenasti kuin hän oli tappanut kaikki Ain asuvaiset.',
        27: 'Mutta kaupungin karjan ja saaliin jakoi Israel keskenänsä, Herran sanan jälkeen, niinkuin hän oli käskenyt Josualle.',
        28: 'Ja Josua poltti Ain ja teki siitä kiviraunion ijankaikkiseksi, joka vielä autiona on tähän päivään asti.',
        29: 'Ja antoi hirttää Ain kuninkaan puuhun ehtooseen asti; ja kuin päivä oli laskenut, käski hän ottaa hänen ruumiinsa puusta pois, ja he heittivät sen kaupungin portin eteen ja kokosivat suuren kiviraunion hänen päällensä, joka siellä on vielä nyt tähän päivään asti.',
        30: 'Silloin rakensi Josua Herralle Israelin Jumalalle alttarin Ebalin vuorella,',
        31: 'Niinkuin Moses Herran palvelia Israelin lapsille käskenyt oli, niinkuin Moseksen lakikirjassa kirjoitettu on: alttarin kokonaisista kivistä, joihinka ei ole rauta sattunut. Ja he uhrasivat Herralle sen päällä polttouhria ja kiitosuhria.',
    ...
    18: {
        ...
        5: 'Ja he jakakaan maan seitsemään osaan: Juudan pitää oleman rajallansa etelän puolella, ja Josephin huoneen pitää oleman rajallansa pohjan puolella.',
    ...
    20: {
        1: 'Ja Herra puhui Josualle ja sanoi:',
        2: 'Puhu Israelin lapsille, sanoen: asettakaat teille muutamia vapaakaupungeita, joista minä teille puhuin Moseksen kautta,',
        3: 'Että sinne sais paeta miehentappaja, joka jonkun lyö tapaturmaisesti ja tietämätä, että he teidän seassanne olisivat vapaat verenkostajalta.',
        4: 'Ja joka pakenee johonkuhun niistä kaupungeista, hänen pitää seisoman ulkona kaupungin portin edessä ja jutteleman vanhinten edessä syynsä, niin pitää heidän ottaman hänen kaupunkiin tykönsä ja antaman hänelle siaa, asuaksensa heidän tykönänsä.',
        5: 'Ja kuin verenkostaja ajaa häntä takaa, ei heidän pidä antaman miehentappajaa hänen käsiinsä, että hän tietämätä löi lähimmäisensä ja ei ollut ennen vainoa hänen välillänsä.',
        6: 'Niin asukaan hän siinä kaupungissa, siihenasti kuin hän seisoo seurakunnan oikeuden edessä, ylimmäisen papin kuolemaan asti, joka siihen aikaan on; sitte pitää miehentappajan palaaman ja tuleman kaupunkiinsa ja huoneeseensa, kaupunkiin, josta hän pakeni.',
        7: 'Niin he pyhittivät Kedeksen Galileassa Naphtalin vuorella, ja Sikemin Ephraimin vuorella, ja KirjatArban, se on Hebroni, Juudan vuorella;',
        8: 'Ja tuolla puolella Jordania, Jerihon kohdalla itään päin, antoivat he Betserin, korvessa lakialla kedolla, Rubenin sukukunnasta, ja Ramotin Gileadissa Gadin sukukunnasta ja Golanin Basanissa Manassen sukukunnasta.',
        9: 'Nämät olivat ne kaupungit, jotka asetettiin kaikille Israelin lapsille ja muukalaisille, jotka heidän seassansa asuivat, että sinne piti pakeneman jokainen joka jonkun tapaturmaisesti löi, ettei hän kuolisi verenkostajan käden kautta, siihenasti että hän seisois seurakunnan edessä.',
    },
    21: {
    ...
    24: {
        1: 'Ja Josua kokosi kaikki Israelin sukukunnat Sikemiin, ja kutsui edes vanhimmat Israelissa, päämiehet, tuomarit ja esimiehet; ja kuin he olivat seisatetut Jumalan eteen,',
