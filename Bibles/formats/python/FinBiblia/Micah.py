...
CHAPTERS = {
    ...
    2: {
        ...
        13: 'Yksi särkiä pitää astuman ylös heidän edellänsä; heidän pitää särkemän lävitse, ja käymän portista ulos ja sisälle; ja heidän kuninkaansa pitää käymän heidän edellänsä, ja Herra kaikkein ensin heitä.',
    },
    3: {
    ...
    4: {
        1: 'Mutta viimeisinä päivinä pitää sen vuoren, jolla Herran huone on, vahvistuman, ja oleman korkeimman kaikkia muita vuoria, ja korotettaman kukkulain ylitse; ja kansat pitää sinne juokseman.',
        ...
        8: 'Ja sinä Ederin torni, Zionin tyttären linna, sinun tykös pitää tuleman, ja pitää tuleman sen entinen esivalta, Jerusalemin tyttären valtakunta.',
        9: 'Miksi sinä nyt niin lakkaamatta huudat? Eikö kuningas ole sinun kanssas? Ovatko sinun neuvonantajas hukkuneet, että kipu tarttui sinuun niinkuin synnyttäväiseen?',
