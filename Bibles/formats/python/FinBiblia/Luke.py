...
CHAPTERS = {
    1: {
        ...
        29: 'Mutta kuin hän näki hänen, hämmästyi hän hänen puheestansa ja ajatteli, millainen se tervehdys oli.',
    ...
    2: {
        1: 'Mutta niinä päivinä tapahtui, että käsky kävi ulos keisarilta Augustukselta, että kaikki maailma piti verolliseksi laskettaman.',
    ...
    4: {
        ...
        18: 'Herran Henki on minun päälläni, sentähden on hän minut voidellut ja lähettänyt minun saarnaamaan köyhille hyvää sanomaa, parantamaan särjetyitä sydämiä, saarnaamaan vangeille lunastusta ja sokeille näkönsä jälleen saamista, särjetyitä vapauteen saattamaan,',
    ...
    7: {
        ...
        39: 'Mutta kuin Pharisealainen sen näki, joka hänen kutsunut oli, sanoi hän itsellensä: jos tämä olis propheta, niin hän tietäis, mikä ja millainen tämä vaimo on, joka häneen rupee, että hän on syntinen.',
    ...
    9: {
        ...
        12: 'Mutta päivä rupesi jo laskemaan ja ne kaksitoistakymmentä tulivat ja sanoivat hänelle: päästä kansa menemään lähikyliin ja majoihin poikkeamaan, ruokaa saamaan; sillä me olemme täällä erämaassa.',
    ...
    10: {
        ...
        19: 'Katso, minä annan teille vallan tallata käärmeitä ja skorpioneja ja kaikkea vihollisen voimaa, ja ei teitä mikään ole vahingoitseva,',
    ...
    11: {
        ...
        42: 'Mutta voi teitä, te Pharisealaiset! että te kymmenykset teette mintuista ja ruuasta, ja kaikkinaisista kaaleista, ja jätätte pois tuomion ja Jumalan rakkauden: näitä piti tehtämän, ja toisia ei jätettämän.',
    ...
    12: {
        ...
        33: 'Myykäät, mitä teillä on, ja antakaat almua. Tehkäät teillenne säkit, jotka ei vanhene, puuttumatoin tavara taivaissa, kuhunka ei varas ulotu, ja kussa ei koi raiskaa.',
    ...
    18: {
        ...
        22: 'Kuin Jesus sen kuuli, sanoi hän hänelle: yksi sinulta vielä puuttuu: myy kaikki, mitä sinulla on ja vaivaisille, niin sinulla pitää oleman tavara taivaassa: ja tule, seuraa minua.',
    ...
    21: {
        1: 'Mutta kuin hän katsoi, näki hän rikkaat panevan lahjojansa uhri-arkkuun.',
    ...
    23: {
        ...
        50: 'Ja katso, raatimies, nimeltä Joseph, joka oli jalo ja hurskas mies,',
