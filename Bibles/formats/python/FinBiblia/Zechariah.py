...
CHAPTERS = {
    ...
    7: {
        1: 'Ja neljäntenä kuningas Dariuksen vuotena tapahtui Herran sana Sakarjalle, neljäntenä päivänä yhdeksännessä kuukaudessa, joka kutsutaan Kislev.',
        ...
        4: 'Ja Herran Zebaotin sana tapahtui minulle ja sanoi:',
    ...
    9: {
        1: 'Tämä on Herran sanan kuorma Hadrakin maasta, ja Damaskusta, jossa se on pysyvä; sillä Herralla on silmä, joka näkee ihmiset ja kaikki Israelin sukukunnat.',
        ...
        8: 'Ja minä tahdon itse minun huoneeni piirittää sotaväellä, jotka vaeltavat ulos ja sisälle, ettei heitä enään pidä vaatian vaivaaman; sillä minä katsoin nyt sitä minun silmilläni.',
    ...
    14: {
        ...
        4: 'Silloin hänen jalkansa pitää Öljymäellä seisoman, joka on läsnä Jerusalemia itään päin; ja Öljymäen pitää halkeeman keskeltä itään ja länteen, sangen leviältä toinen toisestansa; toinen osa mäkeä pitää erkaneman pohjoiseen päin ja toinen etelään päin.',
