...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'Ja sanoi: minä huusin Herraa minun ahdistuksessani, ja hän vastasi minua; minä paruin helvetin vatsasta, ja sinä kuulit minun ääneni.',
        ...
        8: 'Mutta jotka luottavat turhaan valheeseen, ne hylkäävät laupiuden itse kohtaansa.',
