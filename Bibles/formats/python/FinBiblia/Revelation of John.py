...
CHAPTERS = {
    ...
    7: {
        1: 'Ja sitte näin minä neljä enkeliä seisovan neljän maan kulman päällä, ja neljää maan tuulta pitävän, ettei tuuli oisi puhaltanut maan päälle, eikä meren päälle, eikä yhdenkään puun päälle.',
        ...
        5: 'Juudan sukukunnasta kaksitoistakymmentä tuhatta merkityt Rubenin sukukunnasta kaksitoistakymmentätuhatta merkityt, Gadin sukukunnasta kaksitoistakymmentätuhatta merkityt:',
        ...
        9: 'Sen jälkeen näin minä, ja katso, suuri joukko, jota ei yksikään lukea taitanut, kaikista pakanoista, ja sukukunnista, ja kansoista ja kielistä, seisovan istuimen edessä ja Karitsan edessä, valkeilla vaatteilla puetetut, ja palmut heidän käsissänsä.',
    ...
    9: {
        ...
        7: 'Ja metsäsirkat ovat orhitten kaltaiset, jotka sotaan valmistetut ovat, ja heidän päässänsä niinkuin kruunut, kullan muotoiset, ja heidän kasvonsa niin-ihmisten kasvot.',
    ...
    11: {
        ...
        15: 'Ja seitsemäs enkeli soitti basunalla, ja suuret äänet kuuluivat taivaassa, sanoen: maailman valtakunnat ovat meidän Herrallemme ja hänen Kristuksellensa tulleet, ja hän on hallitseva ijankaikkisesta ijankaikkiseen.',
    ...
    17: {
        ...
        7: 'Ja enkeli sanoi minulle, miksis ihmettelet? Minä sanon sinulle vaimon salaisuuden ja pedon salaisuuden, joka häntä kantaa, ja jolla on seitsemän päätä ja kymmenen sarvea.',
