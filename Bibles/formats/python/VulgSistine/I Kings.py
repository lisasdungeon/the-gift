...
CHAPTERS = {
    1: {
        ...
        8: 'Sadoc vero sacerdos, et Banaias filius Ioiadae, et Nathan propheta, et Semei, et Cerethi et Phelethi, et robur exercitus David non erat cum Adonia.',
        ...
        35: 'Et ascendetis post eum, et venietis, et sedebit super solium meum, et ipse regnabit pro me: illique praecipiam ut sit dux super Israel, et super Iudam.',
        ...
        50: 'Adonias autem timens Salomonem, surrexit, et abiit in tabernaculum Domini, tenuitque cornu altaris.',
    ...
    2: {
        ...
        3: 'Et observa ut custodias mandata Domini Dei tui, ut ambules in viis eius, ut custodias ceremonias eius, et praecepta eius, et iudicia, et testimonia, sicut scriptum est in lege Moysi: ut intelligas universa quae facis, et quocumque te verteris:',
        4: 'ut confirmet Dominus sermones suos, quos locutus est de me, dicens: Si custodierint filii tui vias meas, et ambulaverint coram me in veritate, in omni corde suo, et in omni anima sua, non auferetur tibi vir de solio Israel.',
        ...
        28: 'Venit autem nuncius ad Salomonem, quod Ioab declinasset post Adoniam, et post Salomonem non declinasset: fugit ergo Ioab in tabernaculum Domini, et apprehendit cornu altaris.',
        ...
        42: 'Et mittens vocavit eum, dixitque illi: Nonne testificatus sum tibi per Dominum, et praedixi tibi: Quacumque die egressus, fueris huc et illuc, scito te esse moriturum? Et respondisti mihi: Bonus sermo, quem audivi.',
        ...
        46: 'Iussit itaque rex Banaiae filio Ioiadae: qui aggressus, percussit eum, et mortuus est.',
    },
    3: {
    ...
    6: {
        ...
        8: 'Ostium lateris medii in pariete erat domus dextrae: et per cochleam ascendebant in medium coenaculum, et a medio in tertium.',
    ...
    8: {
        ...
        2: 'Convenitque ad regem Salomonem universus Israel in mense Bethanim, in sollemni die, ipse est mensis septimus.',
    ...
    15: {
        1: 'Igitur in octavo decimo anno regni Ieroboam filii Nabat, regnavit Abias super Iudam.',
        ...
        7: 'Reliqua autem sermonum Abiae, et omnia quae fecit, nonne haec scripta sunt in Libro verborum dierum regum Iuda? Fuitque praelium inter Abiam et inter Ieroboam.',
        8: 'Et dormivit Abias cum patribus suis, et sepelierunt eum in civitate David: regnavitque Asa filius eius pro eo.',
        ...
        34: 'Et fecit malum coram Domino, ambulavitque in viis Ieroboam, et in peccatis eius, quibus peccare fecit Israel.',
    },
    16: {
    ...
    17: {
        1: 'Et dixit Elias Thesbites de habitatoribus Galaad ad Achab: Vivit Dominus Deus Israel, in cuius conspectu sto, si erit annis his ros et pluvia, nisi iuxta oris mei verba.',
    ...
    18: {
        ...
        7: 'Cumque esset Abdias in via, Elias occurrit ei: qui cum cognovisset eum, cecidit super faciem suam, et ait: Non tu es, domine mi, Elias?',
        ...
        45: 'Cumque se verteret huc atque illuc, ecce caeli contenebrati sunt, et nubes, et ventus, et facta est pluvia grandis. Ascendens itaque Achab abiit in Iezrahel:',
