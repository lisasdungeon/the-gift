...
CHAPTERS = {
    1: {
        ...
        4: '神に愛せらるる兄弟よ、また汝らの選ばれたることを知るに因りてなり。',
        5: 'それ我らの福音の汝らに至りしは、言にのみ由らず、能力と聖 靈と大なる確信とに由れり。且われらが汝らの中にありて汝らの爲に如何なる行爲をなししかは、汝らの知る所なり。',
        6: 'かくて汝らは大なる患難のうちにも、聖 靈による喜悦をもて御言をうけ、我ら及び主に效ふ者となり、',
        7: '而してマケドニヤ及びアカヤに在る凡ての信者の模範となれり。',
        8: 'それは主のことば汝 等より出でて、啻にマケドニヤ及びアカヤに響きしのみならず、神に對する汝らの信仰のことは諸方に弘りたるなり。されば之に就きては何をも語るに及ばず。',
        9: '人々 親しく我らが汝らの中に入りし状を告げ、また汝らが偶像を棄てて神に歸し、活ける眞の神に事へ、',
