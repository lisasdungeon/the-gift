...
CHAPTERS = {
    ...
    2: {
        ...
        6: "ούτε εζητήσαμεν δόξαν εξ ανθρώπων, ούτε αφ' υμών ούτε απ' άλλων",
        7: "καίτοι δυνάμενοι να δίδωμεν βάρος ως απόστολοι του Χριστού, αλλ' εστάθημεν γλυκείς εν τω μέσω υμών, καθώς η τροφός περιθάλπει τα εαυτής τέκνα·",
        ...
        12: 'σας προετρέπομεν και παρηγορούμεν και διεμαρτυρόμεθα, διά να περιπατήσητε αξίως του Θεού του προσκαλούντος υμάς εις την εαυτού βασιλείαν και δόξαν.',
        ...
        18: 'Διά τούτο ηθελήσαμεν να έλθωμεν προς εσάς, εγώ μάλιστα ο Παύλος, και άπαξ και δις, και ημπόδισεν ημάς ο Σατανάς.',
