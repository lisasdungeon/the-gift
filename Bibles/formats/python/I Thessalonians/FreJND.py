...
CHAPTERS = {
    ...
    2: {
        ...
        4: 'mais comme nous avons été approuvés de Dieu pour que l’évangile nous soit confié, nous parlons ainsi, non comme plaisant aux hommes, mais à Dieu qui éprouve nos cœurs.',
        ...
        11: 'ainsi que vous savez comment [nous avons exhorté] chacun de vous, comme un père ses propres enfants,',
        12: 'vous exhortant, et vous consolant, et rendant témoignage, pour que vous marchiez d’une manière digne de Dieu qui vous appelle à son propre royaume et à sa propre gloire.',
