...
CHAPTERS = {
    ...
    4: {
        ...
        3: 'Da riefen die Israeliten den HERRN laut um Hilfe an; denn Jabin besaß neunhundert eiserne Kriegswagen und bedrückte die Israeliten gewaltsam zwanzig Jahre lang.',
        4: 'Nun wirkte damals Debora, eine Prophetin, die Frau Lappidoths, als Richterin in Israel.',
        ...
        6: 'Diese nun schickte hin und ließ Barak, den Sohn Abinoams, aus Kedes im Stamme Naphthali rufen und sagte zu ihm: »Wisse wohl: der HERR, der Gott Israels, gebietet dir: ›Mache dich auf, ziehe auf den Berg Thabor und nimm zehntausend Mann mit dir aus den beiden Stämmen Naphthali und Sebulon.',
        ...
        11: 'Der Keniter Heber aber hatte sich von den übrigen Kenitern, von der Familie Hobabs, des Schwagers Moses, getrennt und schlug seine Zelte bis zur Eiche bei Zaanannim in der Nähe von Kedes auf.',
        ...
        18: 'Da trat Jael aus dem Zelte hinaus Sisera entgegen und sagte zu ihm: »Kehre ein, Herr, kehre ein bei mir: fürchte dich nicht!« Da trat er zu ihr ins Zelt, und sie deckte ihn mit einer Schlafdecke zu.',
    ...
    6: {
        ...
        2: 'und die Hand der Midianiter lag schwer auf Israel. Um sich der Midianiter zu erwehren, richteten die Israeliten sich die Schlupfwinkel ein, die sich in den Bergen befinden, und legten die Höhlen und die Bergfesten an.',
        ...
        32: 'Daher gab man ihm an jenem Tage den Namen »Jerubbaal«, indem man sagte: »Baal möge gegen ihn streiten, weil er seinen Altar niedergerissen hat.«',
        ...
        37: 'gut, so will ich ein Schaffel auf der Tenne ausbreiten; wenn dann der Tau bloß auf dem Fell liegen wird, der ganze übrige Boden aber trocken bleibt, so will ich daran erkennen, daß du Israel durch meine Hand erretten willst, wie du verheißen hast.«',
        38: 'Und so geschah es: als er am andern Morgen früh das Fell ausdrückte, preßte er Tau aus dem Fell, eine ganze Schale voll Wasser.',
        39: 'Darauf sagte Gideon zu Gott: »Gerate nicht in Zorn gegen mich, wenn ich nur diesmal noch rede! Laß mich nur noch diesmal einen Versuch mit dem Fell machen: das Fell allein möge trocken bleiben, auf dem ganzen übrigen Boden aber Tau liegen!«',
    ...
    8: {
        ...
        5: 'bat er die Einwohner von Sukkoth: »Gebt doch den Leuten, die mir folgen, einige Laibe Brot, denn sie sind erschöpft; und ich bin auf der Verfolgung der Midianiterkönige Sebah und Zalmunna.«',
        ...
        18: 'Darauf fragte er Sebah und Zalmunna: »Wie sahen die Männer aus, die ihr am Thabor erschlagen habt?« Sie antworteten: »Ganz wie du, so sahen sie aus, ein jeder wie ein Königssohn an Wuchs.«',
        ...
        25: 'Da antworteten sie: »Gewiß, die wollen wir dir gern geben.« Da breiteten sie einen Mantel aus, und ein jeder warf die von ihm erbeuteten Ringe darauf.',
        ...
        29: 'Hierauf ging Jerubbaal, der Sohn des Joas, hin und lebte ruhig in seinem Hause.',
        30: 'Gideon hatte aber siebzig vollbürtige Söhne, denn er hatte viele Frauen;',
        31: 'auch von seinem Nebenweibe, die in Sichem wohnte, hatte er einen Sohn, dem er den Namen Abimelech gab.',
        ...
        33: 'Nach Gideons Tode aber trieben die Israeliten wiederum Götzendienst mit den Baalen und machten den Bundesbaal zu ihrem Gott;',
    ...
    12: {
        ...
        5: 'Die Gileaditer aber hatten die Jordanfurten nach Ephraim zu besetzt. Sooft nun flüchtige Ephraimiten baten: »Laßt mich hinüber!«, fragten die Männer von Gilead den Betreffenden, ob er ein Ephratiter sei; antwortete er dann mit nein,',
        6: 'so forderte man ihn auf, das Wort »Schibboleth« auszusprechen. Sagte er dann »Sibboleth«, weil ihm die richtige Aussprache unmöglich war, so ergriffen sie ihn und machten ihn an den Jordanfurten nieder. So kamen damals 42000 Ephraimiten ums Leben.',
        ...
        9: 'Er hatte dreißig Söhne, und dreißig Töchter verheiratete er nach auswärts, und dreißig Töchter führte er seinen Söhnen von auswärts als Gattinnen zu. Nachdem er sieben Jahre lang als Richter in Israel gewaltet hatte,',
    ...
    15: {
        ...
        4: 'Er ging also hin und fing dreihundert Füchse, nahm dann Feuerbrände, kehrte Schwanz gegen Schwanz und brachte einen Feuerbrand mitten zwischen je zwei Schwänzen an.',
        ...
        6: 'Als nun die Philister fragten: »Wer hat das getan?«, hieß es: »Simson, der Schwiegersohn des Thimniters, weil der ihm seine Frau genommen und sie einem von seinen Hochzeitsgenossen gegeben hat.« Da kamen die Philister herangezogen und verbrannten sie samt ihres Vaters Hause.',
        ...
        19: 'Da spaltete Gott die Vertiefung in dem Kinnbacken, so daß Wasser daraus hervorfloß; und als er getrunken hatte, kehrten seine Lebensgeister zurück, und er erholte sich wieder; daher nannte man (jenen Ort) »Quelle des Rufers«; sie befindet sich bei Lehi noch heutigen Tages. –',
    ...
    17: {
        ...
        10: 'Da sagte Micha zu ihm: »Bleibe bei mir und sei mir ein Vater und Priester, so will ich dir jährlich zehn Silberstücke geben und für Kleidung und deinen Lebensunterhalt aufkommen.« Als er dann dem Leviten weiter zuredete,',
