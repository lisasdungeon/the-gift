...
CHAPTERS = {
    ...
    2: {
        ...
        8: 'Men då Josua, Nuns son, Herrans tjenare, död var, hundrade och tio är gammal,',
        ...
        20: 'Derföre förgrymmade sig så Herrans vrede öfver Israel, att han sade: Efter detta folket hafver gått ifrå mitt förbund, som jag deras fader budit hafver, och icke velat höra min röst;',
    ...
    3: {
        ...
        26: 'Och Ehud undflydde, medan de fördröjde, och gick fram om af gudarna, och undkom allt intill Seirath.',
        ...
        29: 'Och slogo de Moabiter af på den tiden vid tiotusend män, alltsammans adla och stridsamma män, så att icke en undslapp.',
        30: 'Alltså vordo de Moabiter på den tiden nederlagde, under Israels barnas hand; och landet var stilla i åttatio år.',
        31: 'Efter honom var Samlar, Anaths son; han slog sexhundrade Philisteer med en herdastaf, och frälste ock han Israel.',
    },
    4: {
        ...
        3: 'Och Israels barn ropade till Herran; ty han hade niohundrade järnvägnar, och tvingade Israels barn med våld i tjugu år.',
    ...
    6: {
        ...
        27: 'Då tog Gideon tio män ut af sina tjenare, och gjorde såsom Herren honom sagt hade; men han fruktade sig göra det om dagen, för sins faders hus skull, och för folkens skull i stadenom; utan om nattena gjorde han det.',
    ...
    7: {
        ...
        7: 'Och Herren sade till Gideon: Med de trehundrade män, som läppjat hafva, vill jag frälsa eder, och gifva de Midianiter i dina händer; men det andra folket lät alltsammans gå hem till sitt.',
        ...
        18: 'Såsom jag blås i basunen, och alle de som med mig äro, så skolen ock I blåsa i basunen omkring hela haren, och säga: Herren och Gideon.',
    ...
    8: {
        ...
        15: 'Och han kom till det folket i Succoth, och sade: Si, här äro Sebah och Zalmunna, om hvilka I bespottaden mig, och säden: Är då allaredo Sebahs och Zalmunna hand uti dina händer, att vi ju skole gifva dino folke, som trött är, bröd?',
    ...
    10: {
        ...
        3: 'Efter honom kom upp Jair, en Gileadit, och han dömde Israel itu och tjugu år.',
        ...
        10: 'Då ropade Israels barn till Herran, och sade: Vi hafve syndat emot dig; ty vi hafve öfvergifvit var Gud, och tjent Baalim.',
    ...
    11: {
        ...
        38: 'Han sade: Gack; och låt henne gå i två månader. Så gick hon bort med sina leksystrar, och begret sin jungfrudom på bergen.',
    ...
    12: {
        ...
        14: 'Han hade fyratio söner, och tretio sonasöner, som på sjutio åsnafålar redo. Han dömde Israel i åtta är;',
    ...
    15: {
        ...
        15: 'Och han råkade en rutten åsnakindbåga; han räckte ut sina hand och tog honom, och slog dermed tusende man.',
        ...
        19: 'Då öppnade Gud ena oxlatand i kindbåganom, och der gick ut vatten; och som han drack, kom hans ande igen, och vederkvicktes; derföre heter ock det rummet åkallarens kindbågabrunn, allt intill denna dag.',
    ...
    17: {
        ...
        11: 'Och Leviten tog till att blifva när mannen om; och han höll den unga mannen såsom en son.',
    ...
    18: {
        ...
        14: 'Då svarade de fem män, som hade varit utgångne till att bespeja Lais land, och sade till sina bröder: Veten I ock, att i dessom husom är en lifkjortel, af gudar och gjutet beläte? I mågen tillse, hvad eder till görandes är.',
    ...
    21: {
        ...
        22: 'När nu deras fäder eller bröder komma till att beklaga sig för oss, vilje vi säga till dem: Varer dem barmhertige för våra skull; förty vi hafve icke tagit dem hustrur med strid, utan I vill en icke gifva dem dem; det är nu edor skull.',
