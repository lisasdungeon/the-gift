...
CHAPTERS = {
    ...
    12: {
        ...
        9: 'Hänellä oli kolmekymmentä poikaa, ja hän naitti kolmekymmentä tytärtänsä muualle ja toi muualta kolmekymmentä tyttöä pojilleen vaimoiksi. Ja hän oli tuomarina Israelissa seitsemän vuotta. 12:',
    ...
    13: {
        1: 'Kun israelilaiset taas tekivät sitä, mikä oli pahaa Herran silmissä, niin Herra antoi heidät filistealaisten käsiin neljäksikymmeneksi vuodeksi.',
        ...
        6: 'Niin vaimo meni ja sanoi miehelleen näin: "Jumalan mies tuli minun luokseni; hän oli näöltään niinkuin Jumalan enkeli, hyvin peljättävä. En kysynyt häneltä, mistä hän oli, eikä hän ilmaissut minulle nimeänsä.',
        7: 'Ja hän sanoi minulle: \'Katso, sinä tulet raskaaksi ja synnytät pojan; älä siis juo viiniä ja väkijuomaa äläkä syö mitään saastaista, sillä poika on oleva Jumalan nasiiri äitinsä kohdusta aina kuolinpäiväänsä asti\'."',
        ...
        10: 'Niin vaimo juoksi nopeasti ilmoittamaan miehellensä ja sanoi hänelle: "Katso, sama mies, joka äsken kävi luonani, ilmestyi minulle".',
        11: 'Niin Maanoah nousi ja seurasi vaimoaan. Ja kun hän tuli miehen luo, sanoi hän tälle: "Sinäkö olet se mies, joka puhuttelit tätä vaimoa?" Hän vastasi: "Minä".',
        ...
        14: 'Älköön syökö mitään, mikä viiniköynnöksestä tulee, viiniä ja väkijuomaa hän älköön juoko älköönkä syökö mitään saastaista. Noudattakoon hän kaikkea, mitä minä olen käskenyt hänen noudattaa."',
        15: 'Ja Maanoah sanoi Herran enkelille: "Salli meidän pidättää sinua valmistaaksemme sinulle vohlan".',
        16: 'Mutta Herran enkeli vastasi Maanoahille: "Vaikka sinä pidättäisitkin minut, en minä kuitenkaan söisi sinun ruokaasi; mutta jos tahdot valmistaa polttouhrin, niin uhraa se Herralle". Sillä Maanoah ei tiennyt häntä Herran enkeliksi.',
        ...
        23: 'Mutta hänen vaimonsa vastasi hänelle: "Jos Herra tahtoisi surmata meidät, ei hän olisi ottanut meiltä vastaan polttouhria ja ruokauhria eikä antanut meidän nähdä tätä kaikkea eikä antanut meidän juuri nyt tätä kuulla".',
        24: 'Ja vaimo synnytti pojan ja antoi hänelle nimen Simson; ja poika kasvoi, ja Herra siunasi häntä.',
        25: 'Ja Herran henki alkoi hänessä vaikuttaa Daanin leirissä, Soran ja Estaolin välillä.',
    },
    14: {
    ...
    15: {
        ...
        11: 'Niin kolmetuhatta miestä Juudasta meni Eetamin kallioluolalle, ja he sanoivat Simsonille: "Etkö tiedä, että filistealaiset hallitsevat meitä; mitä oletkaan meille tehnyt!" Hän vastasi heille: "Niinkuin he tekivät minulle, niin minäkin tein heille".',
    ...
    16: {
        ...
        24: 'Kun kansa näki hänet, niin he ylistivät jumalaansa, sillä he sanoivat: "Meidän jumalamme on antanut käsiimme vihollisemme, maamme hävittäjän, sen, joka surmasi meistä niin monta". 16:',
