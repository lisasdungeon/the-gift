...
CHAPTERS = {
    1: {
        ...
        17: 'Men Juda tågade åstad med sin broder Simeon, och de slogo de kananéer som bodde i Sefat; och de gåvo staden till spillo; så fick den namnet Horma[1].',
        ...
        36: 'Och amoréernas område sträckte sig från Skorpionhöjden, från Sela vidare uppåt. [1] Se noten till 4 Mos 21,3.',
    },
    2: {
        ...
        5: 'Och de gåvo den platsen namnet Bokim[2]; och de offrade där åt HERREN.',
        ...
        16: 'Då lät HERREN domare[2] uppstå, som frälste dem ur deras plundrares hand.',
        ...
        23: 'Alltså lät HERREN dessa folk bliva kvar och fördrev dem icke med hast; han gav dem icke i Josuas hand. [1] D. ä. de gråtande. [2] Se Domare i Ordförkl.',
    },
    3: {
    ...
    6: {
        ...
        32: 'Härav kallade man honom då Jerubbaal, i det man sade: »Baal utföre sin sak[1] mot honom, eftersom han har brutit ned hans altare.»',
        ...
        40: 'Och Gud gjorde så den natten; allenast ullen var torr, men eljest hade dagg kommit överallt på marken. [1] Hebr jareb.',
    },
    7: {
    ...
    11: {
        1: 'Gileaditen Jefta var en tapper stridsman, men han var son till en sköka; och Jeftas fader var Gilead.',
        2: 'Nu födde ock Gileads hustru honom söner; och när dessa hans hustrus söner hade växt upp, drevo de ut Jefta och sade till honom: »Du skall icke taga arv i vår faders hus, ty du är son till en kvinna som icke är hans hustru.»',
        3: 'Då flydde Jefta bort ifrån sina bröder och bosatte sig i landet Tob; där sällade sig löst folk till Jefta och gjorde strövtåg med honom.',
        4: 'Någon tid därefter gåvo Ammons barn sig i strid med Israel.',
        5: 'Men när Ammons barn gåvo sig i strid med Israel, gingo de äldste i Gilead åstad för att hämta Jefta från landet Tob',
        6: 'Och de sade till Jefta: »Kom och bliv vår anförare, så vilja vi strida mot Ammons barn.»',
        7: 'Men Jefta svarade de äldste i Gilead: »I haven ju hatat mig och drivit mig ut ur min faders hus. Huru kunnen I då nu, när I ären i nöd, komma till mig?»',
        8: 'De äldste i Gilead sade till Jefta: »Just därför hava vi nu kommit tillbaka till dig, och du måste gå med oss och strida mot Ammons barn; ty du skall bliva hövding över oss, alla Gileads inbyggare.»',
        9: 'Jefta svarade de äldste i Gilead: »Om I nu fören mig tillbaka för att strida mot Ammons barn och HERREN giver dem i mitt våld, så vill jag ock sedan vara eder hövding.»',
    ...
    12: {
        ...
        3: 'Och när jag såg att I icke villen frälsa mig, tog jag min själ[1] i min hand och drog åstad mot Ammons barn, och HERREN gav dem i min hand. Varför haven I då nu dragit upp emot mig till att strida emot mig?»',
        ...
        6: "så sade de till honom: »Säg 'schibbolet'[2].» Sade han då »sibbolet», därför att han icke nog lade sig vinn om att uttala ordet rätt, så grepo de honom och höggo ned honom där vid vadställena över Jordan. På detta sätt föllo vid det tillfället fyrtiotvå tusen efraimiter.",
        ...
        15: 'Sedan dog pirgatoniten Abdon, Hillels son, och blev begraven i Pirgaton i Efraims land, i amalekiternas bergsbygd. [1] Se Själ i Ordförkl. [2] Se Schibbolet i Ordförkl.',
    },
    13: {
    ...
    15: {
        ...
        17: 'När han hade sagt detta, kastade han käken ifrån sig. Och man kallade den platsen Ramat-Lehi[1].',
        ...
        20: 'Och han var domare i Israel under filistéernas tid, i tjugu år. [1] D. ä. käkkastet eller käkhöjden.',
    },
    16: {
    ...
    17: {
        ...
        10: 'Mika sade till honom: »Stanna kvar hos mig, och bliv fader[1] och präst åt mig, så skall jag årligen giva dig tio siklar silver och vad kläder du behöver, och därtill din föda.» Då följde leviten med honom.',
        ...
        13: 'Och Mika sade: »Nu vet jag att HERREN skall göra mig gott, eftersom jag har fått leviten till präst.» [1] Se Fader i Ordförkl.',
    },
    18: {
        ...
        19: 'De svarade honom: »Tig, lägg handen på din mun, och gå med oss och bliv fader[1] och präst åt oss. Vilket är bäst för dig: att vara präst för en enskild mans hus eller att vara präst för en hel stam och släkt i Israel?»',
        ...
        31: 'De ställde upp åt sig den skurna gudabild som Mika hade gjort, och de hade denna kvar under hela den tid Guds hus var i Silo. [1] Se Fader i Ordförkl.',
    },
    19: {
