...
CHAPTERS = {
    ...
    7: {
        1: "Og Jerubba'al, det er Gideon, og alt folket som var med ham, tok tidlig ut og leiret sig ved Harodkilden; men midianittenes leir lå nordenfor, fra More-høiden og ned i dalen.",
    ...
    9: {
        1: "Og Abimelek, Jerubba'als sønn, drog til Sikem, til sin mors brødre; og han talte til dem og til hele sin morfars slekt og sa:",
        ...
        6: 'Da samlet alle Sikems menn sig og alle de som bodde i Millo, og de gikk avsted og gjorde Abimelek til konge ved minnesmerkets ek i Sikem',
        ...
        28: "Og Ga'al, Ebeds sønn, sa: Hvem er Abimelek, og hvad er Sikem, at vi skulde tjene ham? Er han ikke Jerubba'als sønn, og Sebul hans foged? Tjen de menn som stammer fra Hemor, Sikems far! Men hvorfor skulde vi tjene denne?",
    ...
    16: {
        1: 'Engang drog Samson til Gasa; der fikk han se en skjøge og gikk inn til henne.',
    ...
    19: {
        1: "På denne tid da det ingen konge fantes i Israel, var det en mann av Levi stamme som opholdt sig som fremmed langt inne på Efra'imfjellet. Han tok sig en medhustru fra Betlehem i Juda.",
