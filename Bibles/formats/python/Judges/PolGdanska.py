...
CHAPTERS = {
    ...
    2: {
        1: 'I przyszedł Anioł Pański z Galgal do Bochym, mówiąc: Wywiodłem was z Egiptu, i wywiodłem was do ziemi, o którąm przysiągł ojcom waszym, i mówiłem: Nie wzruszę przymierza mego z wami na wieki;',
        2: 'Jedno wy nie wchodźcie w przymierze z mieszkającymi w tej ziemi, owszem ołtarze ich porozwalajcie; aleście nie słuchali głosu mojego. Przeczżeście to uczynili?',
        ...
        4: 'I stało się, gdy mówił Anioł Pański te słowa do wszystkich synów Izraelskich, że lud podniósł głos swój, i płakali.',
        ...
        7: 'Tedy służył lud Panu po wszystkie dni Jozuego, i po wszystkie dni starszych, którzy długo żyli po śmierci Jozuego, a którzy widzieli wszystkie sprawy Pańskie wielkie, które uczynił Izraelowi.',
        ...
        10: 'Także gdy wszystek on rodzaj przyłączony jest do ojców swoich, i powstał po nich inszy naród, który nie znał Pana, ani też spraw, który uczynił Izraelowi;',
        ...
        16: 'Potem Pan wzbudził sędzie, którzy je wyzwalali z rąk łupieżców ich;',
        17: 'Ale i sędziów swych nie słuchali, owszem się scudzołożyli z bogami obcymi, kłaniając się im, i ustępowali prędko z drogi, którą chodzili ojcowie ich, a słuchając przykazań Pańskich, nie czynili tak.',
        ...
        20: 'Przetoż wzruszyła się popędliwość Pańska przeciw Izraelowi, i rzekł: Dla tego, że przestąpił ten naród przymierze moje, którem przykazał ojcom ich, a nie byli posłuszni głosowi mojemu,',
    ...
    10: {
        ...
        4: 'A ten miał trzydzieści synów, którzy jeździli na trzydziestu ośląt, a mieli trzydzieści miast, które zwano Awot Jair aż po dzisiejszy dzień w ziemi Galaadskiej.',
        5: 'I umarł Jair, a pogrzebion jest w Kamon.',
        6: 'Lecz znowu synowie Izraelscy czynili złe przed oczyma Pańskiemi, a służąc Baalowi, i Astaratowi, i bogom Syryjskim, i bogom Sydońskim, i bogom Moabskim, i bogom synów Ammon, i nawet bogom Filistyńskim, a opuściwszy Pana, nie służyli mu.',
        ...
        12: 'I od Sydończyków, i Amalekitów, i Mahanitów, którzy was trapili, gdyście wołali do mnie, nie wybawił z ręki ich?',
    ...
    12: {
        ...
        5: 'I odjęli Galaadczycy brody Jordańskie Efraimowi; a gdy mówili uciekający z Efraimczyków: Niech przejdę, tedy pytali mężowie Galaadscy: A Efratejczykieś ty: A jeźli rzekł: Nie.',
        ...
        12: 'Potem umarł Elon Zabulończyk, i pogrzebiony jest w Ajalon w ziemi Zabulon.',
        13: 'A po nim sądził Izraela Abdon, syn Hellelów, Faratończyk.',
        ...
        15: 'Umarł potem Abdon, syn Hellelów, Faratończyk, i pogrzebiony jest w Faratonie w ziemi Efraimskiej, na górze Amalekitów.',
    },
    13: {
