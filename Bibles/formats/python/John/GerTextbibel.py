...
CHAPTERS = {
    ...
    3: {
        ...
        36: 'Der an den Sohn glaubt, hat ewiges Leben; der dem Sohn nicht folgt, wird kein Leben sehen, sondern der Zorn Gottes bleibt auf ihm.',
    },
    4: {
        ...
        14: 'Wer aber trinkt von dem Wasser das ich ihm geben werde, den wird nimmermehr dürsten in Ewigkeit, sondern das Wasser, das ich ihm geben werde, wird in ihm ein Quell werden von Wasser, das sprudelt zu ewigem Leben.',
    ...
    5: {
        ...
        39: 'Ihr forschet in den Schriften, da ihr glaubet in denselben ewiges Leben zu haben, und sie sind es, die von mir zeugen;',
    ...
    6: {
        ...
        27: 'Schaffet nicht die Speise die vergehet, sondern die Speise die zu ewigem Leben bleibt, welche der Sohn des Menschen euch geben wird; denn diesen hat der Vater, Gott, versiegelt.',
    ...
    10: {
        ...
        41: 'Und Viele suchten ihn auf und sagten: Johannes hat kein Zeichen gethan, aber was uns Johannes von diesem sagte, das war alles wahr. Und Viele wurden daselbst an ihn gläubig.',
    },
    11: {
        ...
        26: 'Und wer da lebt und glaubt an mich, wird nimmermehr sterben in Ewigkeit. Glaubst du das?',
    ...
    12: {
        ...
        25: 'Wer sein Leben liebt, der verliert es; wer sein Leben haßt in dieser Welt, der wird es für ewiges Leben bewahren.',
        ...
        34: 'Da antwortete ihm die Menge: wir haben aus dem Gesetze gehört, daß der Christus bleibt in Ewigkeit: wie kannst du nun sagen, daß der Sohn des Menschen erhöht werden müsse? Wer ist dieser Sohn des Menschen?',
        ...
        50: 'Und ich weiß, daß sein Auftrag ewiges Leben ist. Was ich also rede: so wie mir der Vater gesagt hat, so rede ich.',
    },
    13: {
        1: 'Vor dem Passafest aber, da Jesus wußte, daß seine Stunde gekommen war, daß er hingienge aus dieser Welt zum Vater, bewies er den Seinigen die Liebe, die er zu ihnen gehabt in der Welt, bis ans Ende.',
        ...
        6: 'So kommt er an Simon Petrus, der sagt zu ihm: Herr, du netzest mir die Füße?',
        7: 'Antwortete Jesus und sprach zu ihm: was ich thue, verstehst du jetzt nicht; du wirst es aber hernach erkennen.',
        8: 'Sagt zu ihm Petrus: du sollst mir nimmermehr die Füße netzen in Ewigkeit. Antwortete Jesus ihm: wenn ich dich nicht netze, hast du keinen Teil an mir.',
        9: 'Sagt zu ihm Simon Petrus: Herr, nicht blos meine Füße, sondern auch die Hände und das Haupt.',
        10: 'Jesus sagt zu ihm: der abgewaschen ist, hat nicht nötig, sich weiter netzen zu lassen, sondern er ist ganz rein: ihr seid auch rein, doch nicht alle.',
        11: 'Denn er kannte seinen Verräter; darum sagte er: ihr seid nicht alle rein.',
        12: 'Als er ihnen die Füße genetzt und seine Kleider wieder genommen und sich niedergesetzt hatte, sprach er zu ihnen: Versteht ihr, was ich euch gethan habe?',
        13: 'Ihr nennet mich Meister und Herr, und ihr habt recht, denn ich bin es.',
        14: 'Wenn nun ich, der Herr und Meister, euch die Füße genetzt habe, so seid auch ihr schuldig, einander die Füße zu netzen.',
        15: 'Denn ich habe euch ein Vorbild gegeben, daß auch ihr thuet, wie ich euch gethan habe.',
        16: 'Wahrlich, wahrlich, ich sage euch: der Knecht ist nicht mehr als sein Herr, noch der Abgesandte mehr als der ihn gesandt hat.',
        17: 'So ihr das wisset, selig seid ihr, wenn ihr darnach thut.',
        18: 'Nicht von euch allen rede ich, denn ich weiß, welche ich auserwählt habe; aber es soll die Schrift erfüllt werden: der mit mir das Brot isset, hat seine Ferse wider mich erhoben.',
        19: 'Nunmehr sage ich es euch, bevor es geschieht, daß ihr glaubet, wenn es geschieht, daß das auf mich geht.',
        ...
        31: 'Als er nun hinausgegangen, spricht Jesus: jetzt ist der Sohn des Menschen verherrlicht, und Gott ist verherrlicht durch ihn.',
        32: 'Wenn Gott verherrlicht ist durch ihn, so wird auch Gott ihn verherrlichen durch sich, ja er wird ihn alsbald verherrlichen.',
        33: 'Kinder, nur noch eine kleine Weile bin ich bei euch: dann werdet ihr mich suchen, und wie ich den Juden sagte: wo ich hingehe, könnet ihr nicht hinkommen, so sage ich jetzt auch zu euch.',
        34: 'Ein neues Gebot gebe ich euch, daß ihr einander liebet, so wie ich euch geliebt habe, daß so auch ihr einander liebet.',
        35: 'Daran wird jedermann erkennen, daß ihr meine Jünger seid, wenn ihr Liebe unter euch habt.',
        36: 'Sagt zu ihm Simon Petrus: Herr, wo gehst du hin? Antwortete ihm Jesus: wo ich hingehe, kannst du mir jetzt nicht folgen; du wirst aber später folgen.',
        37: 'Sagt zu ihm Petrus: Herr, warum kann ich dir jetzt nicht folgen? mein Leben will ich für dich lassen.',
        38: 'Antwortet Jesus: dein Leben willst du für mich lassen? Wahrlich, wahrlich, ich sage dir: der Hahn wird nicht krähen, ehe du mich dreimal verleugnet hast.',
    },
    14: {
        1: 'Euer Herz lasse sich nicht ängstigen, trauet auf Gott, trauet auf mich.',
        2: 'In meines Vaters Hause sind viele Wohnungen; hätte ich euch, wenn dem nicht so wäre, gesagt, daß ich hingehe euch eine Stätte zu bereiten?',
        3: 'Und wenn ich hingegangen bin, und euch die Stätte bereitet habe, komme ich wieder und werde euch mitnehmen zu mir, damit wo ich bin, auch ihr seid.',
        4: 'Und wohin ich gehe, ihr wisset den Weg.',
        5: 'Sagt Thomas zu ihm: Herr, wir wissen nicht, wo du hingehst, wie sollen wir den Weg wissen?',
        6: 'Sagt zu ihm Jesus: Ich bin der Weg und die Wahrheit und das Leben; niemand kommt zum Vater außer durch mich.',
        7: 'Wenn ihr mich erkannt hättet, würdet ihr auch meinen Vater kennen; so erkennet ihn von nun an, ihr habt ihn ja gesehen.',
        ...
        17: 'den Geist der Wahrheit, welchen die Welt nicht empfangen kann, weil sie ihn nicht schaut und erkennt. Ihr erkennt ihn, denn bei euch wohnt er und in euch wird er sein.',
        18: 'Ich will euch nicht Waisen lassen, ich komme zu euch.',
        19: 'Noch um ein kleines und die Welt schaut mich nicht mehr: ihr aber schauet mich, denn ich lebe und ihr werdet leben.',
        20: 'An jenem Tage werdet ihr erkennen, daß ich im Vater und ihr in mir und ich in euch.',
        21: 'Wer meine Gebote hat und hält sie, der ist es, der mich liebt. Wer aber mich liebt, der wird von meinem Vater geliebt werden, und ich werde ihn lieben, und werde ihm erscheinen.',
        22: 'Sagt zu ihm Judas, nicht der Iskariote: Herr, was ist der Grund, daß du uns erscheinen willst, und der Welt nicht?',
        23: 'Antwortete Jesus und sagte zu ihm: wenn einer mich liebt, wird er mein Wort halten, und mein Vater wird ihn lieben, und wir werden zu ihm kommen, und Wohnung bei ihm machen.',
        24: 'Der mich nicht liebt, hält meine Worte nicht, und doch ist das Wort, das ihr hört, nicht mein, sondern des Vaters, der mich gesandt hat.',
        25: 'Das habe ich zu euch geredet, in der Zeit meines Weilens bei euch.',
        26: 'Der Fürsprecher aber, der heilige Geist, den der Vater auf meinen Namen senden wird, der wird euch über alles unterrichten und euch an alles erinnern, was ich euch gesagt habe.',
        ...
        28: 'Ihr habt gehört, daß ich euch gesagt habe: ich gehe hin, und: ich komme zu euch. Wenn ihr mich liebtet, so würdet ihr euch freuen, daß ich zum Vater gehe, weil der Vater größer ist als ich.',
        29: 'Und nun habe ich es euch gesagt, ehe es geschieht, damit ihr glaubet, wenn es geschieht.',
        30: 'Ich werde nicht mehr viel mit euch reden, denn es kommt der Herrscher der Welt. Zwar hat er kein Recht an mich,',
    ...
    15: {
        1: 'Ich bin der wahrhafte Weinstock, und mein Vater ist der Weingärtner.',
        2: 'Jede Ranke an mir, die nicht Frucht bringt, nimmt er weg, und jede, die Frucht bringt, putzt er aus, damit sie mehr Frucht bringe.',
        3: 'Ihr seid bereits rein, um des Wortes willen, das ich zu euch geredet habe; bleibet in mir, so ich in euch.',
        ...
        6: 'Wenn einer nicht in mir bleibt, so wird er hinausgeworfen wie die Ranke, die verdorrt, und man sammelt sie und wirft sie ins Feuer, da brennt sie.',
        7: 'Wenn ihr in mir bleibt und meine Worte in euch bleiben, so möget ihr bitten was ihr wollt, es soll euch werden.',
        8: 'Damit ist mein Vater verherrlicht, daß ihr viele Frucht bringt und meine Jünger seid.',
        9: 'Wie mich der Vater geliebt, habe auch ich euch geliebt; bleibet in meiner Liebe.',
        10: 'Wenn ihr meine Gebote haltet, dann werdet ihr in meiner Liebe bleiben, so wie ich die Gebote meines Vaters gehalten habe, und bleibe in seiner Liebe.',
        11: 'Dieses habe ich zu euch geredet, damit meine Freude über euch komme, und eure Freude völlig werde.',
        12: 'Das ist mein Gebot, daß ihr einander liebet, wie ich euch geliebt habe.',
        13: 'Niemand hat eine größere Liebe als die, daß er sein Leben für seine Freunde einsetzt.',
        14: 'Ihr seid meine Freunde, wenn ihr thut, was ich euch auftrage.',
        15: 'Ich nenne euch nicht mehr Knechte, weil der Knecht nicht weiß, was sein Herr thut; vielmehr habe ich euch Freunde genannt, weil ich euch alles, was ich von meinem Vater gehört, kundgethan habe.',
        ...
        17: 'Das gebe ich euch auf, daß ihr einander liebet.',
        18: 'Wenn euch die Welt haßt, so bedenket, daß sie mich zuerst gehaßt hat.',
        19: 'Wenn ihr von der Welt wäret, so würde die Welt das Ihrige lieben. Weil ihr aber nicht von der Welt seid, sondern ich euch von der Welt ausgelesen habe, deswegen haßt euch die Welt.',
        20: 'Gedenket des Wortes, das ich zu euch gesagt habe: ein Knecht ist nicht mehr, als sein Herr. Wenn sie mich verfolgt haben, werden sie auch euch verfolgen; wenn sie mein Wort gehalten haben, werden sie auch das eure halten.',
        21: 'Aber dieses alles werden sie an euch thun, um meines Namens willen, weil sie den nicht kennen, der mich gesandt hat.',
        22: 'Wenn ich nicht gekommen wäre und hätte zu ihnen geredet, so hätten sie nicht Sünde; nun aber haben sie keinen Vorwand für ihre Sünde.',
        23: 'Wer mich hasset, der hasset auch meinen Vater.',
        24: 'Wenn ich die Werke nicht unter ihnen gethan hätte, die kein anderer gethan, so hätten sie nicht Sünde; nun aber haben sie es gesehen und haben mich gehaßt und meinen Vater.',
        25: 'Aber es soll das Wort erfüllt werden, das in ihrem Gesetze geschrieben steht: Sie haben mich umsonst gehaßt. Wenn der Fürsprecher kommt, welchen ich euch senden werde vom Vater, der Geist der Wahrheit, der vom Vater ausgeht, der wird von mir zeugen. Aber auch ihr zeuget, weil ihr von Anfang bei mir waret.',
    },
    16: {
    ...
    17: {
        ...
        2: 'Wie du ihm Vollmacht gegeben hast über alles Fleisch, damit er, was alles du ihm gegeben hast, denselben ewiges Leben gebe.',
        3: 'Dies aber ist das ewige Leben, daß sie dich erkennen, den allein wahrhaften Gott, und den du gesandt hast, Jesus Christus.',
    ...
    21: {
        1: 'Nach diesem offenbarte sich Jesus abermals den Jüngern am See von Tiberias; er offenbarte sich aber also.',
        2: "Es waren zusammen Simon Petrus, und Thomas, der Zwilling genannt, und Nathanael der von Kana in Galiläa, und die Söhne Zebedäus', und zwei andere von seinen Jüngern.",
        3: 'Sagt Simon Petrus zu ihnen: ich gehe hin zu fischen. Sie sagen zu ihm: wir gehen auch mit dir. Sie giengen hinaus und stiegen in das Schiff, und in dieser Nacht fiengen sie nichts.',
        4: 'Als es aber schon Morgen wurde, stand Jesus am Ufer; die Jünger erkannten ihn jedoch nicht.',
        5: 'Da sagt Jesus zu ihnen: Kinder, habt ihr nicht etwas zu essen? Antworteten sie ihm: nein.',
        6: 'Er aber sagt zu ihnen: werfet das Netz aus rechts vom Schiffe, so wird es euch gelingen. Da warfen sie aus, und vermochten es nicht mehr zu heben vor der Menge der Fische.',
        ...
        8: 'Die anderen Jünger aber kamen mit dem Schiffe (denn sie waren nicht weit vom Lande, nur etwa zweihundert Ellen) und schleppten das Netz mit den Fischen nach.',
        9: 'Wie sie nun ans Land stiegen, sehen sie ein Kohlenfeuer am Boden und Fische daran und Brot.',
        10: 'Sagt Jesus zu ihnen: bringt mir von den Fischen, die ihr eben gefangen habt.',
        11: 'Da stieg Simon Petrus herauf und zog das volle Netz ans Land mit hundert und drei und fünfzig großen Fischen, so viel es waren, so zerriß doch das Netz nicht.',
        12: 'Sagt Jesus zu ihnen: kommt und frühstückt. Keiner von den Jüngern wagte ihn auszufragen: wer bist du? da sie wußten, daß er der Herr sei.',
        ...
        15: "Als sie dann frühstückten, sagt Jesus zu Simon Petrus: Simon Johannes', hast du mich lieber als diese? Sagt er zu ihm: ja, Herr, du weißt, daß ich dich liebe. Sagte er zu ihm: weide meine Lämmer.",
        16: "Sagt er wiederum zum zweitenmale zu ihm: Simon Johannes', hast du mich lieb? Er sagt zu ihm: ja, Herr, du weißt, daß ich dich liebe. Sagt er zu ihm: leite meine Schäfchen.",
        17: "Sagt er zum drittenmale zu ihm: Simon Johannes', liebst du mich? Petrus ward bekümmert, weil er zum drittenmal zu ihm sagte: liebst du mich? und sagte zu ihm: Herr, du weißt alles; du erkennst, daß ich dich liebe. Sagt Jesus zu ihm: weide meine Schäfchen.",
        18: 'Wahrlich, wahrlich, ich sage dir: als du jung warest, gürtetest du dich selbst, und wandeltest wo du hin wolltest. Wenn du aber alt wirst, so wirst du deine Hände ausstrecken, und ein anderer wird dich gürten und führen, wo du nicht hin willst.',
        19: 'Das sagte er aber, zu bezeichnen, mit welchem Tode er Gott verherrlichen werde. Und als er dies gesagt hatte, sagt er zu ihm: folge mir.',
        20: 'Petrus wendet sich um und sieht den Jünger, welchen Jesus lieb hatte, folgen, denselben, der auch beim Mahl sich an seine Brust lehnte und sagte: Herr, wer ists, der dich verrät?',
        21: 'Als nun Petrus diesen sah, sagt er zu Jesus: Herr, was ist es aber mit diesem?',
        22: 'Sagt Jesus zu ihm: wenn ich will, daß er bleibe, bis ich komme, was geht es dich an? Du folge mir.',
        23: 'So gieng denn dieses Wort aus zu den Brüdern, daß jener Jünger nicht sterbe. Und Jesus hat nicht zu ihm gesagt: er sterbe nicht, sondern: wenn ich will, daß er bleibe, bis ich komme, was geht es dich an?',
        24: 'Dies ist der Jünger, der für dieses zeugt und dieses geschrieben hat, und wir wissen, daß sein Zeugnis wahr ist.',
        25: 'Es gibt aber noch viele andere Thaten die Jesus gethan; und wenn man sie alle einzeln beschreiben wollte, so würde die Welt selbst, meine ich, die Bücher nicht fassen, die da geschrieben würden.',
    },
}
