...
CHAPTERS = {
    ...
    8: {
        ...
        51: '誠にまことに汝らに告ぐ、人もし我が言を守らば、永遠に死を見ざるべし』',
    ...
    17: {
        1: 'イエスこれらの事を語りはて、目を擧げ天を仰ぎて言ひ給ふ『父よ、時 來れり、子が汝の榮光を顯さんために、汝の子の榮光を顯したまへ。',
        2: '汝より賜はりし凡ての者に、永遠の生命を與へしめんとて、萬民を治むる權威を子に賜ひたればなり。',
        3: '永遠の生命は、唯一の眞の神にいます汝と、なんぢの遣し給ひしイエス・キリストとを知るにあり。',
        4: '我に成さしめんとて汝の賜ひし業を成し遂げて、我は地上に汝の榮光をあらはせり。',
        5: '父よ、まだ世のあらぬ前に、わが汝と偕にもちたりし榮光をもて、今 御前にて我に榮光あらしめ給へ。',
        ...
        13: '今は我なんぢに往く、而して此 等のことを世に在りて語るは、我が喜悦を彼らに全からしめん爲なり。',
        ...
        18: '汝われを世に遣し給ひし如く、我も彼らを世に遣せり。',
        19: 'また彼 等のために我は己を潔めわかつ、これ眞理にて彼らも潔め別たれん爲なり。',
        20: '我かれらの爲のみならず、その言によりて我を信ずる者のためにも願ふ。',
        21: 'これ皆 一つとならん爲なり。父よ、なんぢ我に在し、我なんぢに居るごとく、彼らも我らに居らん爲なり、是なんぢの我を遣し給ひしことを世の信ぜん爲なり。',
    ...
    21: {
        ...
        3: 'シモン・ペテロ『われ漁獵にゆく』と言へば、彼ら『われらも共に往かん』と言ひ、皆いでて舟に乘りしが、その夜は何をも得ざりき。',
        4: '夜明の頃イエス岸に立ち給ふに、弟子たち其のイエスなるを知らず。',
        5: 'イエス言ひ給ふ『子どもよ、獲 物ありしか』彼ら『なし』と答ふ。',
        6: 'イエス言ひたまふ『舟の右のかたに網をおろせ、然らば獲 物あらん』乃ち網を下したるに、魚おびただしくして、網を曳き上ぐること能はざりしかば、',
        7: 'イエスの愛し給ひし弟子、ペテロに言ふ『主なり』シモン・ペテロ『主なり』と聞きて、裸なりしを上衣をまとひて海に飛びいれり。',
        8: '他の弟子たちは陸を離るること遠からず、僅に五十間ばかりなりしかば、魚の入りたる網を小舟にて曳き來り、',
        9: '陸に上りて見れば、炭火ありてその上に肴あり、又パンあり。',
        10: 'イエス言ひ給ふ『なんぢらの今とりたる肴を少し持ちきたれ』',
        11: 'シモン・ペテロ舟に往きて網を陸に曳き上げしに、百 五 十 三 尾の大なる魚 滿ちたり、斯く多かりしが網は裂けざりき。',
        12: 'イエス言ひ給ふ『きたりて食せよ』弟子たちその主なるを知れば『なんぢは誰ぞ』と敢へて問ふ者もなし。',
        ...
        19: 'これペテロが如何なる死にて神の榮光を顯すかを示して言ひ給ひしなり。斯く言ひて後かれに言ひ給ふ『われに從へ』',
        ...
        23: 'ここに兄弟たちの中に、この弟子 死なずと云ふ話つたはりたり。されどイエスは死なずと言ひ給ひしにあらず『よしや我、かれが我の來るまで留るを欲すとも、汝になにの關係あらんや』と言ひ給ひしなり。',
        24: 'これらの事につきて、證をなし、又これを録しし者は、この弟子なり、我等はその證の眞なるを知る。',
        25: 'イエスの行ひ給ひし事は、この外なほ多し、もし一つ一つ録さば、我おもふに世界もその録すところの書を載するに耐へざらん。',
    },
}
