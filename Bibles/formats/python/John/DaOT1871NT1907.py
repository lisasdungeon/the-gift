...
CHAPTERS = {
    ...
    3: {
        ...
        16: 'Thi saaledes elskede Gud Verden, at han gav sin Søn den enbaarne, for at hver den, som tror paa ham, ikke skal fortabes, men have et evigt Liv.',
    ...
    4: {
        ...
        36: 'Den, som høster, faar Løn og samler Frugt til et evigt Liv, saa at de kunne glæde sig tilsammen, baade den, som saar, og den, som høster.',
    ...
    5: {
        ...
        24: 'Sandelig, sandelig, siger jeg eder, den, som hører mit Ord og tror den, som sendte mig, har et evigt Liv og kommer ikke til Dom, men er gaaet over fra Døden til Livet.',
    ...
    8: {
        ...
        52: 'Jøderne sagde til ham: „Nu vide vi, at du er besat; Abraham døde og Profeterne, og du siger: Dersom nogen holder mit Ord, han skal i al Evighed ikke smage Døden.',
    ...
    9: {
        ...
        32: 'Aldrig er det hørt, at nogen har aabnet Øjnene paa en blindfødt.',
    ...
    12: {
        ...
        50: 'Og jeg ved, at hans Befaling er evigt Liv. Altsaa, hvad jeg taler, taler jeg saaledes, som Faderen har sagt mig.‟',
    },
    13: {
