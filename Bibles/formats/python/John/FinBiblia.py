...
CHAPTERS = {
    1: {
        ...
        39: 'Mitä te etsitte? Niin he sanoivat hänelle: Rabbi (se on niin paljo sanottu: opettaja) kussas asut?',
        40: 'Hän sanoi heille: tulkaat ja katsokaat; ja he tulivat ja näkivät, kussa hän asui, ja olivat sen päivän hänen tykönänsä, ja se oli lähes kymmenes hetki.',
        ...
        51: 'Jesus vastasi ja sanoi hänelle: sinä uskot, että minä sanoin sinulle: minä näin sinut fikunapuun alla. Sinä saat vielä suurempia nähdä. Ja sanoi hänelle: totisesti, totisesti sanon minä teille: tästedes pitää teidän näkemän taivaan avoinna, ja Jumalan enkelit astuvan ylös ja tulevan alas Ihmisen Pojan päälle.',
    },
    2: {
    ...
    5: {
        ...
        45: 'Älkäät luulko, että minä minä kannan Isän edessä teidän päällenne: se on, joka teidän päällenne kantaa, Moses, johonka te turvaatte.',
    ...
    6: {
        ...
        10: 'Mutta Jesus sanoi: asettakaat kansa atrioitsemaan. ja siinä paikassa oli paljo ruohoa. Niin atrioitsi lähes viisituhatta miestä.',
        ...
        60: 'Niin monta hänen opetuslapsistansa, kuin he tämän kuulivat, sanoivat: tämä on kova puhe: kuka voi sitä kuulla?',
    ...
    7: {
        ...
        35: 'Niin Juudalaiset sanoivat keskenänsä: kuhunkas hän menee, ettemme häntä löydä? meneekö hän Grekiläisten sekaan, jotka sinne ja tänne hajoitetut ovat, Grekiläisiä opettamaan?',
    ...
    8: {
        ...
        51: 'Totisesti, totisesti sanon minä teille: joka kätkee minun sanani, ei hänen pidä näkemän kuolemaa ijankaikkisesti.',
    ...
    10: {
        ...
        26: 'Mutta ette usko: sillä ette ole minun lampaistani, niinkuin minä teille sanoin.',
        ...
        34: 'Jesus vastasi heitä: eikö teidän laissanne ole kirjoitettu: minä sanon, te olette jumalat?',
    ...
    11: {
        ...
        4: 'Kuin Jesus sen kuuli, sanoi hän: ei tämä tauti ole kuolemaksi, vaan Jumalan kunniaksi, että Jumalan Poika sen kautta kunnioitettaisiin.',
    ...
    12: {
        ...
        3: 'Niin Maria otti naulan turmelematointa ja kallista nardusvoidetta, ja voiteli Jesuksen jalat, ja kuivasi hänen jalkansa hiuksillansa. Ja huone täytettiin voiteen hajusta.',
        ...
        16: 'Mutta ei hänen opetuslapsensa näitä ensisti ymmärtäneet; vaan sittekuin Jesus oli kirkastettu, silloin he muistivat, että nämät ovat hänestä kirjoitetut, ja että he näitä hänelle tehneet olivat.',
    ...
    13: {
        ...
        2: 'Ja ehtoolisen jälkeen, (kuin perkele oli jo Juudaan Simonin Iskariotin sydämeen lykännyt, että hänen piti hänen pettämän,)',
    ...
    15: {
        ...
        9: 'Niinkuin Isä rakasti minua, niin minä myös rakastin teitä: pysykäät minun rakkaudessani.',
    ...
    18: {
        ...
        18: 'Mutta palveliat, jotka hiilistä olivat tulen tehneet, sillä kylmä oli, seisoivat ja lämmittelivät. Ja Pietari seisoi myös heidän kanssansa ja lämmitteli.',
    ...
    19: {
        ...
        26: 'Kuin siis Jesus näki äidin ja opetuslapsen siinä seisovan, jota hän rakasti, sanoi hän äidillensä: vaimo, katso sinun poikaas.',
    ...
    20: {
        ...
        11: 'Mutta Maria seisoi ulkona haudan edessä ja itki. Ja kuin hän niin itki, kumarsi hän itsensä hautaan.',
