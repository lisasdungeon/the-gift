...
CHAPTERS = {
    ...
    3: {
        ...
        16: "En effet Dieu a tant aimé le monde qu'il a donné Son Fils unique, afin que quiconque croit en lui ne périsse point, mais ait la vie éternelle;",
    ...
    4: {
        1: 'Lors donc que le Seigneur sut que les pharisiens avaient appris que Jésus faisait et baptisait plus de disciples que Jean,',
        2: "(toutefois ce n'était pas Jésus lui-même qui baptisait, mais ses disciples),",
        3: 'il quitta la Judée, et se rendit en Galilée.',
        4: "Or il fallait qu'il traversât la Samarie.",
        5: 'Il arriva donc dans une ville de Samarie nommée Sichar, près du champ que Jacob avait donné à Joseph son fils;',
        6: "or là se trouvait la source de Jacob. Jésus donc fatigué du voyage s'était tout simplement assis près de la source; c'était environ la sixième heure;",
        7: "survient une femme samaritaine pour puiser de l'eau; Jésus lui dit: « Donne-moi à boire. »",
        8: "Car ses disciples étaient allés à la ville afin d'acheter des vivres.",
        9: 'La femme samaritaine lui dit donc: « Comment toi, qui es Juif, me demandes-tu à boire, à moi qui suis une femme samaritaine? » — Les Juifs en effet ne frayent pas avec les Samaritains. Jésus lui répliqua:',
        10: "« Si tu connaissais le don de Dieu, et quel est celui qui te dit: Donne-moi à boire, c'est toi qui l'aurais sollicité, et il t'aurait donné de l'eau vive. »",
        11: "Elle lui dit: « Seigneur, tu n'as rien pour puiser, et le puits est profond; d'où as-tu donc cette eau vive?",
        12: 'Es-tu plus grand que notre père Jacob qui nous a donné ce puits, et qui lui-même en a bu, ainsi que ses fils et ses troupeaux? »',
        13: 'Jésus lui répliqua: « Quiconque boit de cette eau-là aura de nouveau soif;',
        14: "tandis que celui qui aura bu de l'eau que je lui donnerai n'aura certainement plus jamais soif, mais l'eau que je lui donnerai deviendra en lui une source d'eau jaillissante jusque dans la vie éternelle. »",
        15: "La femme lui dit: « Seigneur, donne-moi cette eau-là, afin que je n'aie plus soif, et que je ne vienne plus puiser ici. »",
        16: 'Il lui dit: « Va, appelle ton mari, et reviens ici. »',
        17: "La femme lui répliqua: « Je n'ai pas de mari. » Jésus lui dit: « Tu as eu raison de dire: je n'ai pas de mari;",
        ...
        22: 'Pour vous, vous adorez ce que vous ne connaissez pas; nous, nous adorons ce que nous connaissons, car le salut vient des Juifs;',
        ...
        25: 'La femme lui dit: « Je sais que le Messie doit venir, celui qui est appelé Christ; lorsque celui-là sera venu, il nous apprendra toutes choses. »',
        26: "« Jésus lui dit: « C'est moi qui le suis, moi qui te parle. »",
        27: "Et là-dessus survinrent ses disciples, et ils s'étonnaient de ce qu'il parlait avec une femme. Nul cependant ne dit: « Que demandes-tu? » ou, « Pourquoi parles-tu avec elle? »",
        28: "La femme laissa donc sa cruche et s'en fut à la ville, et elle dit aux gens:",
        29: "« Venez voir un homme qui m'a dit tout ce que j'ai fait; n'est-ce point lui qui est le Christ? »",
        30: 'Ils sortirent de la ville, et ils venaient vers lui.',
        31: "Dans l'intervalle les disciples le sollicitaient en disant: « Rabbi, mange. »",
        32: "Mais il leur dit: « J'ai à manger un aliment que vous ne connaissez pas. »",
        33: "Les disciples se disaient donc les uns aux autres: « Est-ce que quelqu'un lui a apporté à manger? »",
        34: "Jésus leur dit: « Ma nourriture est de faire la volonté de Celui qui m'a envoyé et d'achever Son œuvre.",
        35: 'Ne dites-vous pas vous-mêmes: Encore quatre mois et la moisson arrive? Voici, je vous dis: Levez vos yeux, et voyez comme les campagnes blanchissent déjà pour la moisson.',
        36: 'Le moissonneur reçoit un salaire, et il serre sa récolte pour la vie éternelle, afin que le semeur se réjouisse aussi bien que le moissonneur;',
        37: "car c'est ici que s'applique avec vérité la parole qui dit: « Autre est le semeur, et autre le moissonneur. »",
        38: "C'est moi qui vous ai envoyés moissonner ce que vous n'avez pas travaillé; d'autres ont travaillé, et vous, vous êtes entrés dans leur travail. »",
        39: "Or de cette ville-là il y eut plusieurs Samaritains qui crurent en lui, à cause de cette déclaration de la femme: « Il m'a dit tout ce que j'ai fait. »",
        40: "Lors donc que les Samaritains furent venus vers lui, ils le sollicitaient de demeurer auprès d'eux; et il demeura là deux jours.",
        41: 'Et un beaucoup plus grand nombre crurent à cause de sa prédication,',
        42: "et ils disaient à la femme: « Ce n'est plus à cause de tes discours, que nous croyons, car nous avons ouï nous-mêmes, et nous savons que celui-ci est vraiment le sauveur du monde, le Christ. »",
        43: 'Au bout de ces deux jours il sortit de là pour se rendre en Galilée.',
        44: "En effet Jésus lui-même avait déclaré qu'un prophète n'est point honoré dans sa propre patrie;",
        45: "lors donc qu'il arriva en Galilée, les Galiléens l'accueillirent parce qu'ils avaient vu tout ce qu'il avait fait à Jérusalem pendant la fête; car eux-mêmes aussi étaient venus à la fête.",
    ...
    5: {
        ...
        24: "En vérité, en vérité je vous déclare que celui qui écoute ma parole, et qui croit en Celui qui m'a envoyé possède la vie éternelle, et il ne subit pas de jugement, mais il est passé de la mort à la vie.",
        ...
        39: 'Vous scrutez les Écritures, parce que vous pensez posséder en elles la vie éternelle, et ce sont elles qui témoignent pour moi,',
    ...
    6: {
        ...
        27: "travaillez à vous procurer, non la nourriture qui périt, mais la nourriture qui subsiste pour la vie éternelle, laquelle le fils de l'homme vous donnera; car c'est lui que le Père, je veux dire Dieu, a marqué de Son sceau. »",
        ...
        40: "car c'est ici la volonté de mon Père, que quiconque contemple le Fils et croit en lui possède la vie éternelle, et c'est moi qui le ressusciterai au dernier jour. »",
        ...
        47: 'En vérité, en vérité je vous le déclare, celui qui croit possède la vie éternelle.',
        ...
        51: "c'est moi qui suis le pain vivant qui est descendu du ciel; si quelqu'un mange de ce pain, il vivra pour l'éternité; mais le pain aussi que je donnerai, c'est ma chair pour la vie du monde. »",
        ...
        58: "Tel est le pain qui est descendu du ciel; ce n'est pas comme les pères qui ont mangé et qui sont morts, celui qui mange ce pain-là vivra pour l'éternité. »",
        ...
        68: 'Simon Pierre lui répliqua: « Seigneur, vers qui irions-nous? Tu possèdes les paroles de la vie éternelle,',
    ...
    8: {
        ...
        35: "or l'esclave ne demeure pas éternellement dans la famille; le fils y demeure éternellement;",
        ...
        51: "En vérité, en vérité je vous déclare que si quelqu'un a observé ma parole, il ne verra certainement jamais la mort. »",
        52: "Les Juifs lui dirent: « Maintenant nous reconnaissons que tu as un démon; Abraham est mort ainsi que les prophètes, et toi tu dis: Si quelqu'un a observé ma parole, il ne verra certainement jamais la mort.",
    ...
    9: {
        ...
        32: "jamais on n'a ouï dire que personne eût ouvert les yeux d'un aveugle-né.",
    ...
    10: {
        ...
        28: 'et je leur donne la vie éternelle, et elles ne périront certainement jamais, et personne ne les arrachera de ma main;',
    ...
    11: {
        ...
        15: "et je me réjouis à cause de vous, afin que vous croyiez, de ce que je n'étais pas là; mais allons vers lui. »",
        16: 'Thomas, qui est appelé Didymos, dit donc aux autres disciples: « Allons-y, nous aussi, afin que nous mourrions avec lui. »',
        17: "Jésus étant donc arrivé trouva qu'il était depuis déjà quatre jours dans le sépulcre.",
        18: "Or Béthanie était rapprochée de Jérusalem d'environ quinze stades,",
        19: "et plusieurs d'entre les Juifs étaient venus auprès de Marthe et de Marie, afin de les consoler au sujet de leur frère.",
        20: "Marthe donc, lorsqu'elle apprit que Jésus arrivait, vint à sa rencontre, tandis que Marie demeurait assise dans la maison.",
        21: 'Marthe dit donc à Jésus: « Si tu avais été ici, mon frère ne serait point mort;',
        22: 'et maintenant je sais que tout ce que tu demanderas à Dieu, Dieu te le donnera. »',
        23: 'Jésus lui dit: « Ton frère ressuscitera. »',
        24: "Marthe lui dit: « Je sais qu'il ressuscitera lors de la résurrection au dernier jour. »",
        25: "Jésus lui dit: « C'est moi qui suis la résurrection et la vie; celui qui croit en moi vivra, quand même il serait mort",
        26: 'et tout vivant qui croit en moi ne mourra certainement jamais. Crois-tu cela? »',
        27: "Elle lui dit: « Oui, Seigneur, pour moi je crois que c'est toi qui es le Christ, le fils de Dieu, celui qui doit venir dans le monde. »",
        28: "Et après avoir dit cela elle s'en alla, et elle appela Marie sa sœur en lui disant en secret: « Le maître est ici et il t'appelle. »",
        29: "Celle-ci, dès qu'elle eut entendu, se leva en toute hâte et vint vers lui.",
        30: "Or Jésus n'était pas encore entré dans le village, mais il était encore à l'endroit où l'avait rencontré Marthe.",
        31: "Les Juifs donc qui étaient avec elle dans la maison et qui la consolaient, voyant que Marie s'était levée en toute hâte et était sortie, la suivirent en pensant qu'elle allait au sépulcre afin d'y pleurer.",
        32: "Marie donc, lorsqu'elle fut arrivée là où était Jésus, l'ayant vu tomba à ses pieds, en lui disant: « Seigneur, si tu avais été ici, mon frère ne serait pas mort. »",
        33: "Jésus donc, lorsqu'il la vit pleurer, et les Juifs venus avec elle pleurer aussi, fut irrité en son esprit, et il tressaillit",
        34: "et dit: « Où l'avez-vous mis? » On lui dit: « Seigneur, viens et vois. »",
        35: 'Jésus pleura.',
        36: "Les Juifs donc disaient: « Voyez comme il l'aimait. »",
        37: "Mais quelques-uns d'entre eux dirent: « Est-ce que celui-ci qui a ouvert les yeux de l'aveugle ne pouvait pas faire que celui-ci aussi ne mourût point? »",
        38: "Jésus donc, derechef irrité en lui-même, se rend au sépulcre; or c'était une grotte, et une pierre était placée dessus.",
        39: "Jésus dit: « Enlevez la pierre. » La sœur du mort, Marthe, lui dit: « Seigneur, il donne déjà de l'odeur; car voici quatre jours qu'il y est. »",
        40: "Jésus lui dit: « Ne t'ai-je pas dit que, si tu crois, tu verras la gloire de Dieu? »",
        41: "Ils enlevèrent donc la pierre. Et Jésus leva les yeux en haut et dit: « Père, je Te rends grâce de ce que Tu m'as écouté;",
        42: "pour moi je savais bien que Tu m'écoutes toujours, mais c'est à cause de la foule qui m'entoure que j'ai parlé, afin qu'ils croient que c'est Toi qui m'as envoyé. »",
        43: "Et après avoir dit cela il s'écria à haute voix: « Lazare, viens dehors! »",
        44: "Le mort sortit, avec les pieds et les mains attachés par des bandelettes, et son visage était enveloppé d'un suaire. Jésus leur dit: « Déliez-le, et laissez-le aller. »",
        45: "Plusieurs donc d'entre les Juifs, qui étaient venus auprès de Marie, et qui avaient vu ce qu'il avait fait, crurent en lui;",
        46: "mais quelques-uns d'entre eux s'en allèrent vers les pharisiens et leur dirent ce qu'avait fait Jésus.",
        47: "Les grands prêtres et les pharisiens rassemblèrent donc le Sanhédrin et ils disaient: « Qu'y a-t-il à faire, car cet homme opère beaucoup de miracles?",
        48: "Si nous le laissons libre d'agir ainsi, tous croiront en lui, et les Romains viendront, et ils nous enlèveront et le lieu et la nation. »",
        49: "Or l'un d'entre eux, Caïaphas, qui était grand prêtre cette année-là, leur dit: « Vous n'y entendez rien,",
        50: "et vous ne réfléchissez pas qu'il vous convient mieux qu'un seul homme meure pour le peuple, et que la nation entière ne périsse pas. » —",
        51: 'Or il ne dit point cela de lui-même, mais étant grand prêtre cette année-là il prophétisa que Jésus devait mourir pour la nation,',
        52: 'et non pas seulement pour la nation, mais aussi afin de réunir en un seul corps les enfants de Dieu dispersés. —',
        53: 'A partir donc de ce jour-là ils délibérèrent afin de le faire mourir.',
        54: "Jésus donc ne se montrait plus ouvertement parmi les Juifs, mais de là il s'en alla dans la contrée voisine du désert, dans la ville appelée Ephraïm. Et il y demeura avec les disciples.",
        ...
        56: 'Ils cherchaient donc Jésus et se disaient entre eux en se tenant dans le temple: « Que vous en semble? Ne viendra-t-il point du tout à la fête? »',
        57: "Cependant les grands prêtres et les pharisiens avaient donné des ordres, afin que si quelqu'un savait où il était, il en avertît, pour qu'ils le fissent saisir.",
    },
    12: {
    ...
    13: {
        ...
        8: "Pierre lui dit: « Tu ne me laveras certainement jamais les pieds! » Jésus lui répondit: « Si je ne te lave, tu n'as rien de commun avec moi. »",
    ...
    14: {
        ...
        2: 'Dans la maison de mon Père il y a plusieurs demeures; sinon, vous dirais-je que je vais vous préparer une place?',
        3: 'Et si je vais et que je vous prépare une place, je reviendrai, et je vous prendrai auprès de moi, afin que là où je suis vous y soyez aussi;',
        4: 'et là où je vais, vous en savez le chemin. »',
        5: 'Thomas lui dit: « Seigneur, nous ne savons où tu vas, comment en savons-nous le chemin? »',
        6: 'Jésus lui dit: « Je suis le chemin, et la vérité, et la vie; personne ne vient au Père que par moi;',
        7: "si vous m'aviez connu, vous auriez aussi connu mon Père; dès maintenant vous Le connaissez et vous L'avez vu. »",
        8: 'Philippe lui dit: « Seigneur, montre-nous le Père, et cela nous suffit. »',
        9: "Jésus lui dit: « Depuis si longtemps je suis avec vous, et tu ne m'as pas connu, Philippe! Celui qui m'a vu a vu le Père; comment dis-tu: Montre-nous le Père?",
        10: 'Ne croiras-tu point que je suis dans le Père, et que le Père est en moi? Les paroles que je vous adresse, je ne les profère pas de mon chef; mais le Père qui demeure en moi fait Ses propres œuvres;',
        11: 'croyez-moi, quand je dis que je suis dans le Père et que le Père est en moi; sinon, croyez-moi à cause de Ses œuvres.',
        12: "En vérité, en vérité je vous le déclare, celui qui croit en moi, les œuvres que je fais, lui aussi les fera, et il en fera de plus grandes, parce que je m'en vais vers le Père;",
        13: "et, quoi que ce soit qu'on demande en mon nom, je le ferai, afin que le Père soit glorifié dans le Fils;",
        14: 'si vous me demandez quelque chose en mon nom, je le ferai.',
        15: "Si vous m'aimez, vous garderez mes commandements,",
        16: 'et moi je prierai le Père, et Il vous donnera un autre défenseur, pour être éternellement avec vous,',
        17: "l'Esprit de vérité, que le monde ne peut recevoir, car il ne le voit point, ni ne le connaît point; pour vous, vous le connaissez, car il demeure près de vous, et il est en vous.",
        18: 'Je ne vous laisserai point orphelins, je viens à vous;',
        19: 'encore un peu de temps, et le monde ne me voit plus, mais vous, vous me verrez, parce que je vis, et que vous aussi vous vivrez;',
        20: 'en ce jour-là vous connaîtrez que je suis en mon Père, et que vous êtes en moi, et que je suis en vous.',
        21: "Celui qui possède mes commandements et qui les garde, c'est celui-là qui m'aime; celui qui m'aime sera aimé par mon Père, et moi aussi je l'aimerai et je me manifesterai moi-même à lui. »",
        22: "Judas, non pas l'Iscariote, lui dit: « Seigneur, que s'est-il passé pour que tu doives te manifester à nous, et non pas au monde? »",
        23: "Jésus lui répliqua: « Si quelqu'un m'aime il gardera ma parole, et mon Père l'aimera, et nous viendrons vers lui et nous ferons un séjour chez lui;",
        24: "celui qui ne m'aime pas ne garde point mes paroles; et la parole que vous entendez n'est pas de moi, mais du Père qui m'a envoyé.",
        25: 'Je vous ai dit ces choses pendant que je demeurais près de vous,',
        26: "mais le défenseur, l'Esprit Saint qu'enverra le Père en mon nom, celui-là vous instruira de tout, et vous remettra en mémoire tout ce que je vous ai dit.",
        27: "Pour moi, je vous laisse la paix, je vous donne ma paix; ce n'est pas comme donne le monde, que je vous donne. Que votre cœur ne se trouble point et qu'il ne s'effarouche point.",
        28: "Vous avez entendu que je vous ai dit: Je m'en vais, et, je viens à vous; si vous m'aimiez, vous vous réjouiriez de ce que je vais vers le Père, parce que le Père est plus grand que moi.",
        29: "Et maintenant, je vous l'ai dit avant que cela ait eu lieu, afin que, lorsque cela aura eu lieu, vous croyiez.",
        30: 'Je ne parlerai plus de beaucoup de choses avec vous, car le chef du monde vient, et il ne me peut rien,',
        31: "mais, afin que le monde sache que j'aime le Père, et que j'agis conformément à l'ordre que le Père m'a donné, levez-vous, sortons d'ici. »",
    },
    15: {
    ...
    17: {
        ...
        3: "Or voici ce qu'est la vie éternelle, c'est qu'ils Te connaissent comme le seul véritable Dieu, et, comme Christ, Jésus que Tu as envoyé.",
    ...
    18: {
        1: 'Après avoir dit ces choses Jésus sortit avec ses disciples pour se rendre, au delà du torrent des cèdres, en un lieu où se trouvait un jardin dans lequel il entra, lui et ses disciples.',
        2: "Or Judas, qui le livrait, connaissait aussi l'endroit, parce que souvent Jésus s'y était réuni à ses disciples.",
        3: 'Judas donc, ayant pris la cohorte et des satellites que lui avaient donnés les grands prêtres et les pharisiens, arrive en ce lieu avec des torches, des lanternes et des armes.',
        4: 'Jésus donc, qui savait tout ce qui allait lui arriver, sortit et leur dit: « Qui cherchez-vous? »',
        5: "Ils lui répondirent: « Jésus le Nazoréen. » Il leur dit: « C'est moi qui suis Jésus. » Or Judas qui le livrait était aussi avec eux.",
        6: "Lors donc qu'il leur eut dit: « C'est moi qui le suis, » ils reculèrent en arrière et tombèrent par terre.",
        7: 'Il leur demanda donc derechef: « Qui cherchez-vous? » Et ils dirent: « Jésus le Nazoréen. »',
        8: "Jésus répondit: « Je vous ai dit que c'est moi qui le suis, si donc vous me cherchez, laissez aller ceux-ci. » —",
        9: "Afin que fût accomplie la parole qu'il avait dite: ceux que tu m'as donnés, je n'en ai perdu aucun. —",
        10: "Simon Pierre qui avait une épée la tira donc et frappa l'esclave du grand prêtre et lui coupa l'oreille droite; or le nom de l'esclave était Malchus.",
        11: "Jésus dit donc à Pierre: « Remets l'épée dans le fourreau; la coupe que le Père m'a donnée, ne la boirai-je pas? »",
        12: 'La cohorte, et le commandant, et les satellites des Juifs se saisirent donc de Jésus et le garrottèrent,',
        13: "et ils le conduisirent d'abord chez Annas; il était en effet beau-père de Caïaphas, qui était grand prêtre cette année-là. —",
        14: "Or Caïaphas était celui qui avait donné aux Juifs le conseil: il convient qu'un seul homme meure pour le peuple. —",
        15: 'Cependant Simon Pierre suivait Jésus, avec un autre disciple; or ce disciple-ci était connu du grand prêtre, et il entra avec Jésus dans la cour du grand prêtre,',
        16: "mais Pierre se tenait dehors près de la porte. L'autre disciple, celui qui était connu du grand prêtre, sortit donc, et parla à la portière, et il fit entrer Pierre.",
        17: "La servante qui faisait office de portière dit donc à Pierre: « N'es-tu pas, toi aussi, des disciples de cet homme-là? » Il lui dit: « Je n'en suis point. »",
        18: "Cependant les esclaves et les satellites se tenaient auprès d'un brasier qu'ils avaient allumé, car il faisait froid, et ils se chauffaient; or Pierre se tenait aussi avec eux et se chauffait.",
        19: 'Le grand prêtre interrogea donc Jésus sur ses disciples et sur sa doctrine.',
        20: "Jésus lui répondit: « Pour moi, c'est publiquement que j'ai parlé au monde; j'ai constamment enseigné dans une synagogue et dans le temple où tous les Juifs se rassemblent, et je n'ai rien dit en cachette.",
        21: "Pourquoi m'interroges-tu? Interroge ceux qui ont entendu ce dont je leur ai parlé; voici, ce sont eux qui savent ce que j'ai dit. »",
        22: "Or quand il eut dit cela, un des satellites qui se trouvait là donna un soufflet à Jésus, en disant: « C'est ainsi que tu réponds au grand prêtre! »",
        23: "Jésus lui répondit: « Si j'ai mal parlé, porte témoignage du mal que j'ai dit, mais si c'est bien, pourquoi me frappes-tu? »",
        24: "Annas l'envoya donc garrotté à Caïaphas le grand prêtre.",
        25: "Cependant Simon Pierre était à se chauffer; ils lui dirent donc: « N'es-tu pas, toi aussi, de ses disciples? » Il le nia et dit: « Je n'en suis point. »",
        26: "Un des esclaves du grand prêtre, qui était parent de celui dont Pierre avait coupé l'oreille, dit: « Est-ce que je ne t'ai pas vu dans le jardin avec lui? »",
        27: 'Pierre donc nia derechef, et aussitôt un coq chanta.',
        28: "Ils conduisent donc Jésus de chez Caïaphas au prétoire; or c'était le matin, et eux-mêmes n'entrèrent pas dans le prétoire, afin de ne pas se souiller, et de pouvoir manger la pâque.",
        29: "Pilate donc sortit pour se rendre auprès d'eux et dit: « Quelle accusation portez-vous contre cet homme? »",
        30: "Ils lui répliquèrent: « Si celui-ci n'était pas un malfaiteur, nous ne te l'aurions pas livré. »",
        31: 'Pilate leur dit donc: « Prenez-le vous-mêmes, et jugez-le selon votre loi. » Les Juifs lui dirent: « Il ne nous est pas permis de mettre personne à mort. » —',
        32: 'Afin que fût accomplie la parole par laquelle Jésus avait indiqué de quelle mort il devait mourir. —',
        33: 'Pilate entra donc derechef dans le prétoire, et il appela Jésus, et lui dit: « Es-tu le roi des Juifs? »',
        34: "Jésus répondit: « Est-ce de toi-même que tu dis cela, ou bien d'autres te l'ont-ils dit de moi? »",
        35: "Pilate répondit: « Est-ce que je suis Juif? C'est ta nation et les grands prêtres qui t'ont livré à moi; qu'as-tu fait? »",
        36: "Jésus répondit: « Mon royaume n'est pas de ce monde; si mon royaume était de ce monde, mes satellites auraient combattu afin que je ne fusse pas livré aux Juifs; mais maintenant mon royaume n'est pas d'ici. »",
        37: "Pilate lui dit donc: « Tu es donc roi? » Jésus répondit: « Tu le dis; en effet je suis roi. C'est pour rendre témoignage à la vérité que je suis né et que je suis venu dans le monde; quiconque est de la vérité écoute ma voix. »",
        38: "Pilate lui dit: « Qu'est-ce que la vérité? » Et en disant cela il sortit derechef pour se rendre auprès des Juifs, et il leur dit: « Pour moi, je ne trouve en lui aucun crime;",
        39: "mais c'est votre coutume que je vous relâche quelqu'un à Pâque, voulez-vous donc que je vous relâche le roi des Juifs? »",
        40: "Ils s'écrièrent donc derechef: « Non pas celui-ci, mais Barabbas! » Or Barabbas était un brigand.",
    },
    19: {
        1: 'Alors donc Pilate fit prendre et fustiger Jésus.',
        2: "Et les soldats, ayant tressé une couronne avec des épines, la posèrent sur sa tête, et ils le revêtirent d'un manteau de pourpre,",
        3: 'et ils venaient vers lui et disaient: « Salut, roi des Juifs! » Et ils lui donnèrent des soufflets.',
        4: "Et Pilate sortit derechef et leur dit: « Voici, je vous l'amène, afin que vous sachiez que je ne trouve en lui aucun crime. »",
        5: "Jésus sortit donc, portant la couronne d'épines et le manteau de pourpre. Et il leur dit: « Voici l'homme. »",
        6: "Lors donc que les grands prêtres et leurs satellites le virent, ils s'écrièrent: « Crucifie, crucifie! » Pilate leur dit: « Prenez-le vous-mêmes, et crucifiez-le; car pour moi je ne trouve pas de crime en lui. »",
        7: "Les Juifs lui répondirent: « Nous avons une loi, et selon la loi il doit mourir, parce qu'il s'est fait fils de Dieu. »",
        8: 'Lors donc que Pilate eut ouï cette parole, il craignit davantage,',
        9: "et il rentra dans le prétoire et dit à Jésus: « D'où es-tu? » Mais Jésus-ne lui fit pas de réponse.",
        10: "Pilate donc lui dit: « Tu ne me parles pas! Ne sais-tu pas que j'ai l'autorité de te relâcher, et que j'ai l'autorité de te crucifier? »",
        11: "Jésus lui répondit: « Tu n'aurais nulle autorité sur moi, si elle ne t'avait été donnée d'en haut; c'est pourquoi celui qui m'a livré à toi commet un plus grand péché. »",
        12: "Dès lors Pilate cherchait à le relâcher; mais les Juifs s'écrièrent: « Si tu relâches celui-ci, tu n'es pas ami de l'empereur; quiconque se fait roi se déclare contre l'empereur! »",
        13: "Pilate donc, quand il eut ouï ces paroles, fit sortir Jésus, et s'assit sur un tribunal dans un endroit appelé Pavé, mais en hébreu Gabbatha.",
        14: "Or c'était la préparation de la pâque; c'était environ la sixième heure, et il dit aux Juifs: « Voilà votre roi! »",
        15: "Ceux-ci s'écrièrent donc: « Fais-le mourir! Fais-le mourir! Crucifie-le! » Pilate leur dit: « Crucifierai-je votre roi? »",
        16: "Les grands prêtres lui répondirent: « Nous n'avons d'autre roi que l'empereur. » Alors donc il le leur livra pour être crucifié.",
        17: "et, portant lui-même sa croix, il sortit pour se rendre à l'endroit appelé du crâne, qui en hébreu est appelé Golgoth,",
        18: 'où ils le crucifièrent, et avec lui deux autres, de droite et de gauche, et Jésus au milieu.',
        19: 'Cependant Pilate composa aussi une inscription et la fit placer sur la croix; or elle était ainsi conçue: Jésus le nazoréen, le roi des juifs.',
        20: "Plusieurs des Juifs lurent donc cette inscription, parce que l'endroit où fut crucifié Jésus était près de la ville, et qu'elle était écrite en hébreu, en latin et en grec.",
        21: "Les grands prêtres des Juifs disaient donc à Pilate: « N'écris pas: Le roi des Juifs, mais qu'il a dit: Je suis roi des Juifs. »",
        22: "Pilate répondit: « Ce que j'ai écris, je l'ai écrit. »",
        23: "Les soldats donc, lorsqu'ils eurent crucifié Jésus, prirent ses vêtements, et ils en firent quatre parts, une part pour chaque soldat; ils prirent aussi la tunique. Or la tunique était sans couture, entièrement tissée du haut en bas;",
        24: "ils se dirent donc entre eux: « Ne la déchirons pas, mais tirons-la au sort, à qui l'aura. » — Afin que fût accompli le passage de l'Écriture: « Ils se sont partagé mes vêtements, et ils ont tiré mon habit au sort. » — Les soldats firent donc ces choses,",
        25: 'tandis que, près de la croix de Jésus, se tenaient sa mère et la sœur de sa mère, Marie femme de Clopas et Marie la Magdalène.',
        26: "Jésus donc, voyant sa mère, et près d'elle le disciple qu'il aimait, dit à sa mère: « Femme, voici ton fils. »",
        27: 'Ensuite il dit au disciple: « Voici ta mère. » Et dès ce moment le disciple la prit chez lui.',
        28: "Après cela Jésus, qui savait que tout était déjà accompli, — afin que l'Écriture fût accomplie, — dit: « J'ai soif. »",
        29: "Il y avait là un vase plein de vinaigre; on attacha donc une éponge pleine de ce vinaigre à une branche d'hysope et on l'approcha de sa bouche.",
        30: "Lors donc que Jésus eut pris le vinaigre, il dit: « C'est accompli, » et ayant penché la tête, il rendit l'esprit.",
        31: "Les Juifs donc (parce que c'était la préparation), afin que les corps ne demeurassent pas sur la croix pendant le sabbat (car le jour de ce sabbat était grand), les Juifs demandèrent à Pilate qu'on leur rompît les jambes et qu'on les enlevât.",
        32: "Les soldats vinrent donc, et rompirent les jambes du premier, et celles de l'autre crucifié avec lui,",
        33: "mais en venant à Jésus, comme ils virent qu'il était déjà mort, ils ne lui rompirent pas les jambes;",
        34: "mais l'un des soldats lui perça le flanc avec une lance, et il en sortit aussitôt du sang et de l'eau. —",
        35: "Et c'est celui qui l'a vu qui en a porté témoignage, et son témoignage est véritable, et il sait qu'il dit vrai, afin que vous croyiez;",
        36: "car cela est advenu afin que ce passage de l'Écriture fût accompli: « Aucun de ses os ne sera brisé. »",
        37: "Et un autre passage de l'Écriture dit encore: « Ils verront celui qu'ils ont transpercé. »",
        38: "Or, après cela, Joseph d'Arimathée, qui était disciple de Jésus, mais en cachette par crainte des Juifs, demanda à Pilate de pouvoir enlever le corps de Jésus. Et Pilate le permit. Il vint donc et enleva son corps.",
        39: "Or Nicodème, qui était venu vers lui de nuit la première fois, vint aussi portant un rouleau de myrrhe et d'aloès, pesant environ cent livres.",
        40: "Ils prirent donc le corps de Jésus, et l'enveloppèrent de bandelettes avec les parfums, selon la coutume suivie par les Juifs pour la sépulture.",
        41: "Or il y avait dans l'endroit où il avait été crucifié un jardin, et dans le jardin un sépulcre neuf, dans lequel personne n'avait encore été déposé;",
        42: "ce fut donc là, à cause de la préparation des Juifs, parce que le sépulcre était proche, qu'ils déposèrent Jésus.",
    },
    20: {
        1: "Or le premier jour de la semaine, Marie la Magdalène vient de bon matin, pendant qu'il faisait encore obscur, vers le sépulcre, et elle voit la pierre enlevée du sépulcre.",
        2: "Elle court donc et vient vers Simon Pierre et vers l'autre disciple que Jésus aimait, et elle leur dit: « Ils ont enlevé le Seigneur du sépulcre, et nous ne savons où ils l'ont mis. »",
        3: "Pierre sortit donc, ainsi que l'autre disciple; et ils se rendaient vers le sépulcre;",
        4: "or ils couraient tous deux ensemble, et l'autre disciple courut plus vite que Pierre et arriva le premier au sépulcre;",
        5: "et s'étant baissé il voit les bandelettes par terre; cependant il n'entra pas.",
        6: 'Arrive donc aussi Simon Pierre qui le suivait, et il entra dans le sépulcre. Et il voit les bandelettes par terre,',
        7: 'et le linge qui avait été sur sa tête, non point par terre avec les bandelettes, mais roulé à part dans un coin.',
        8: "Alors donc entra aussi l'autre disciple qui, le premier, était arrivé au sépulcre, et il vit et il crut;",
        9: "car ils n'avaient pas encore compris que, d'après l'Écriture, il fallait qu'il ressuscitât des morts.",
        10: "Les disciples s'en retournèrent donc chez eux.",
        11: 'Mais Marie se tenait dehors près du sépulcre en pleurant; comme donc elle pleurait, elle se baissa pour regarder dans le sépulcre,',
        12: "et elle voit deux anges vêtus de blanc, assis, l'un à la tête, et l'autre aux pieds, là où avait été couché le corps de Jésus;",
        13: "et ils lui disent: « Femme, pourquoi pleures-tu? » Et elle leur dit: « Parce qu'ils ont enlevé mon Seigneur, et que je ne sais où ils l'ont mis. »",
        14: 'Après avoir dit cela elle se retourna en arrière, et elle voit Jésus debout, et elle ne savait pas que ce fût Jésus.',
        15: "Jésus lui dit: « Femme, pourquoi pleures-tu? Qui cherches-tu? » Elle, s'imaginant que c'est le jardinier, lui dit: « Seigneur, si c'est toi qui l'as emporté, dis-moi où tu l'as mis, et moi je l'irai prendre. »",
        16: "Jésus lui dit: « Marie! » S'étant retournée, elle lui dit en hébreu: « Rabbouni », ce qui signifie, Maître.",
        ...
        18: "Marie la Magdalène vient annoncer aux disciples qu'elle a vu le Seigneur, et qu'il lui a dit ces choses.",
        19: "Le soir donc de ce premier jour de la semaine, et les portes de l'endroit où étaient les disciples étant closes par crainte des Juifs, Jésus vint et se tint au milieu d'eux, et il leur dit: « Paix pour vous! »",
        20: 'Et après avoir dit cela, il leur montra et ses mains et son flanc. Les disciples furent donc dans la joie en voyant le Seigneur.',
        21: "Jésus leur dit donc derechef: « Paix pour vous! Comme le Père m'a envoyé, moi aussi je vous envoie. »",
        22: "Et après avoir dit cela il souffla et leur dit: « Recevez l'esprit saint;",
        23: 'à tous ceux dont vous aurez pardonné les péchés, ils leur sont pardonnés; à tous ceux dont vous les retenez, ils sont retenus. »',
        24: "Cependant Thomas, l'un des Douze, celui qui est appelé Didymos, n'était pas avec eux quand Jésus vint;",
        25: 'les autres disciples lui disaient donc: « Nous avons vu le Seigneur. » Mais il leur dit: « Si je ne vois dans ses mains la marque des clous, et si je ne mets mon doigt dans la marque des clous, et si je ne mets ma main dans son flanc, je ne croirai point. »',
        26: "Et huit jours après, ses disciples étaient de nouveau renfermés, et Thomas avec eux. Jésus vient, les portes étant closes, et il se tint au milieu d'eux, et dit: « Paix pour vous! »",
        27: 'Ensuite il dit à Thomas: « Avance ton doigt ici, et regarde mes mains, et avance ta main, et mets-la dans mon flanc, et ne deviens pas incrédule, mais croyant. »',
        28: 'Thomas lui répliqua: « Mon Seigneur, et mon Dieu! »',
        29: "Jésus lui dit: « Parce que tu m'as vu, tu as cru; heureux ceux qui n'ont pas vu, et qui ont cru! »",
        30: "Jésus fit donc, en présence des disciples, encore beaucoup d'autres miracles, qui n'ont pas été écrits dans ce livre;",
        31: "mais ceux-ci ont été écrits afin que vous croyiez que Jésus est le Christ, le fils de Dieu, et afin qu'en croyant vous ayez la vie en son nom.",
    },
    21: {
        ...
        12: "Jésus leur dit: « Venez, faites collation. » Aucun des disciples n'osait lui demander: « Qui es-tu? » sachant bien que c'était le Seigneur.",
        13: 'Jésus vient et prend le pain et le leur donne, et il fait de même des poissons.',
        14: "Ce fut là la troisième fois que Jésus apparut aux disciples, depuis qu'il fut ressuscité des morts.",
        15: "Lors donc qu'ils eurent fait collation, Jésus dit à Simon Pierre: « Simon, fils de Jean, m'aimes-tu plus que ceux-ci? Il lui dit: « Oui, Seigneur; tu sais que je t'aime. » Il lui dit: « Pais mes agneaux. »",
        16: "Il lui redit une seconde fois: « Simon, fils de Jean, m'aimes-tu? » Il lui dit: « Oui, Seigneur, tu sais que je t'aime. » Il lui dit: « Fais paître mes brebis. »",
        17: "Il lui dit pour la troisième fois: « Simon, fils de Jean, m'aimes-tu? » Pierre fut attristé de ce qu'il lui avait dit pour la troisième fois: « M'aimes-tu? » et il dit: « Seigneur, tu sais toutes choses, tu connais que je t'aime. » Jésus lui dit: « Pais mes brebis.",
        18: 'En vérité, en vérité je te le déclare, lorsque tu étais plus jeune, tu te ceignais toi-même, et tu allais où tu voulais; mais quand tu seras devenu vieux, tu étendras les mains, et un autre te ceindra et te portera là où tu ne veux pas. »',
        19: 'Or il dit cela pour indiquer par quel genre de mort il glorifierait Dieu, et après avoir dit cela, il dit: « Suis-moi. »',
        20: "Pierre, s'étant retourné, se voit suivi par le disciple que Jésus aimait, et qui, pendant le repas, s'était appuyé contre sa poitrine, et qui avait dit: « Seigneur, quel est celui qui doit te livrer? »",
        21: "Pierre donc l'ayant vu dit à Jésus: « Seigneur, mais celui-ci, qu'en sera-t-il? »",
        22: "Jésus lui dit: « Si je veux qu'il demeure jusques à ce que je vienne, que t'importe? Quant à toi, suis-moi. »",
        23: "Le bruit se répandit donc parmi les frères, que ce disciple ne devait pas mourir; mais Jésus ne lui dit pas: « Il ne doit point mourir, » mais: « Si je veux qu'il demeure jusques à ce que je vienne, que t'importe? »",
        24: "C'est lui qui est le disciple qui atteste ces choses, et qui a aussi écrit ces choses, et nous savons que son témoignage est véridique;",
        25: "mais il y a encore beaucoup d'autres choses qu'a faites Jésus, lesquelles, si on les écrivait en détail, je ne pense pas que le monde même pût contenir les livres où elles seraient écrites.",
    },
}
