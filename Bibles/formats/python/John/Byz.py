...
CHAPTERS = {
    1: {
        ...
        29: 'τη επαυριον βλεπει βλεπει ο ιωαννης τον ιησουν ερχομενον προς αυτον και λεγει ιδε ο αμνος του θεου ο αιρων την αμαρτιαν του κοσμου',
        ...
        32: 'και εμαρτυρησεν ιωαννης λεγων οτι τεθεαμαι το πνευμα καταβαινον ωσει ως περιστεραν εξ ουρανου και εμεινεν επ αυτον',
        ...
        42: 'και ηγαγεν αυτον προς τον ιησουν εμβλεψας εμβλεψας δε αυτω ο ιησους ειπεν συ ει σιμων ο υιος ιωνα συ κληθηση κηφας ο ερμηνευεται πετρος',
        43: 'τη επαυριον ηθελησεν εξελθειν εις την γαλιλαιαν και ευρισκει φιλιππον και λεγει αυτω ο ιησους ο ιησους> OMIT ο ιησους ακολουθει μοι',
    ...
    3: {
        ...
        2: 'ουτος ηλθεν προς αυτον τον ιησουν νυκτος και ειπεν αυτω ραββι οιδαμεν οτι απο θεου εληλυθας διδασκαλος ουδεις γαρ ταυτα τα σημεια δυναται ποιειν α συ ποιεις εαν μη η ο θεος μετ αυτου',
        ...
        23: 'ην δε και ιωαννης βαπτιζων εν αινων εγγυς του σαλημ σαλειμ οτι υδατα πολλα ην εκει και παρεγινοντο και εβαπτιζοντο',
        ...
        36: 'ο πιστευων εις τον υιον εχει ζωην αιωνιον ο δε απειθων τω υιω ουκ οψεται ζωην την ζωην αλλ η οργη του θεου μενει επ αυτον',
    },
    4: {
        ...
        47: 'ουτος ακουσας οτι ιησους ηκει εκ της ιουδαιας εις την γαλιλαιαν απηλθεν προς αυτον και ηρωτα αυτον ινα καταβη και ιασηται αυτου τον υιον εμελλεν ημελλεν γαρ αποθνησκειν',
    ...
    5: {
        1: 'μετα ταυτα ην η OMIT η εορτη των ιουδαιων και ανεβη ο ιησους εις ιεροσολυμα',
        ...
        5: 'ην δε τις ανθρωπος εκει τριακοντα οκτω και οκτω ετη εχων εν τη ασθενεια',
        ...
        14: 'μετα ταυτα ευρισκει αυτον ο ιησους εν τω ιερω και ειπεν αυτω ιδε υγιης γεγονας μηκετι αμαρτανε ινα μη χειρον τι σοι σοι τι γενηται',
        ...
        46: 'ει γαρ επιστευετε μωση μωσει επιστευετε αν εμοι περι γαρ εμου εκεινος εγραψεν',
    ...
    6: {
        ...
        10: 'ειπεν δε ο ιησους ποιησατε τους ανθρωπους αναπεσειν ην δε χορτος πολυς εν τω τοπω ανεπεσον ανεπεσαν ουν οι ανδρες τον αριθμον ωσει πεντακισχιλιοι',
        ...
        15: 'ιησους ουν γνους οτι μελλουσιν ερχεσθαι και αρπαζειν αυτον ινα ποιησωσιν αυτον βασιλεα ανεχωρησεν εις το ορος αυτος μονος',
        ...
        24: 'οτε ουν ειδεν ο οχλος οτι ιησους ουκ εστιν εκει ουδε οι μαθηται αυτου ενεβησαν αυτοι εις τα πλοια και ηλθον εις καπερναουμ ζητουντες τον ιησουν',
        ...
        39: 'τουτο δε εστιν το θελημα του πεμψαντος με πατρος ινα παν ο δεδωκεν μοι μη απολεσω εξ αυτου αλλα αναστησω αυτο αυτον τη εν τη εσχατη ημερα',
        ...
        44: 'ουδεις δυναται ελθειν προς με εαν μη ο πατηρ ο πεμψας με ελκυση αυτον και εγω αναστησω αυτον εν τη εσχατη ημερα',
        45: 'εστιν γεγραμμενον εν τοις προφηταις και εσονται παντες διδακτοι θεου πας ουν ο ακουων παρα του πατρος και μαθων ερχεται προς με',
        ...
        54: 'ο τρωγων μου την σαρκα και πινων μου το αιμα εχει ζωην αιωνιον και εγω αναστησω αυτον τη εν τη εσχατη ημερα',
        ...
        58: 'ουτος εστιν ο αρτος ο εκ του ουρανου καταβας ου καθως εφαγον οι πατερες υμων το μαννα και απεθανον ο τρωγων τουτον τον αρτον ζησεται ζησει εις τον αιωνα',
        ...
        70: 'απεκριθη αυτοις ο ιησους OMIT ο ιησους ουκ εγω υμας τους δωδεκα εξελεξαμην και εξ υμων εις διαβολος εστιν',
    ...
    7: {
        ...
        12: 'και γογγυσμος πολυς περι αυτου ην εν τοις οχλοις οι μεν ελεγον οτι αγαθος εστιν αλλοι ελεγον ου αλλα πλανα τον οχλον',
        ...
        32: 'ηκουσαν οι φαρισαιοι του οχλου γογγυζοντος περι αυτου ταυτα και απεστειλαν υπηρετας οι φαρισαιοι και οι αρχιερεις ινα πιασωσιν αυτον',
        ...
        39: 'τουτο δε ειπεν περι του πνευματος ου ο εμελλον λαμβανειν οι πιστευοντες εις αυτον ουπω γαρ ην πνευμα αγιον οτι ιησους ουδεπω εδοξασθη',
        ...
        53: 'και επορευθη απηλθεν εκαστος εις τον οικον αυτου',
    },
    8: {
        1: 'ιησους δε και ο ιησους επορευθη εις το ορος των ελαιων',
        2: 'ορθρου δε παλιν παλιν βαθεος παρεγενετο ηλθεν ο ιησους εις το ιερον και πας ο λαος ηρχετο ηρχετο προς αυτον και καθισας εδιδασκεν αυτους',
        3: 'αγουσιν δε οι γραμματεις και οι φαρισαιοι προς αυτον OMIT προς αυτον:END γυναικα εν επι μοιχεια καταληφθεισαν κατειλημμενην και στησαντες αυτην εν εν τω μεσω',
        4: 'λεγουσιν ειπον αυτω πειραζοντες OMIT πειραζοντες διδασκαλε αυτη η γυνη κατεληφθη ταυτην ευρομεν επ αυτοφορω αυτοφωρω μοιχευομενη μοιχευομενην',
        5: 'εν δε τω νομω μωσης ημιν ενετειλατο τας τοιαυτας λιθοβολεισθαι συ ουν τι λεγεις OMIT: περι αυτης OMIT εν δε τω νομω ημων μωυσης OMIT: ημιν:OMIT ενετειλατο τας τοιαυτας λιθαζειν συ ουν τι λεγεις περι αυτης',
        6: 'τουτο δε ελεγον πειραζοντες αυτον ινα εχωσιν κατηγορειν κατηγοριαν κατ αυτου ο δε ιησους κατω κυψας τω δακτυλω εγραφεν OMIT μη προσποιουμενος',
        7: 'ως δε επεμενον ερωτωντες επερωτωντες αυτον ανακυψας αναβλεψας ειπεν προς αυτους αυτοις ο αναμαρτητος υμων πρωτον πρωτος επ αυτην τον λιθον βαλετω λιθον βαλετω επ αυτην',
        8: 'και παλιν κατω κυψας εγραφεν εις την γην',
        9: 'οι δε ακουσαντες και υπο της συνειδησεως ελεγχομενοι εξηρχοντο εις καθ εις αρξαμενοι απο των πρεσβυτερων και κατελειφθη μονος ο ιησους και η γυνη εν μεσω ουσα οι δε ακουσαντες OMIT: και υπο της συνειδησεως ελεγχομενοι:OMIT εξηρχοντο εις καθ εις αρξαμενοι απο των πρεσβυτερων εως των εσχατων και κατελειφθη ο ιησους μονος και η γυνη εν μεσω ουσα και η γυνη εν μεσω ουσα v 10 ανακυψας δε ο ιησους και μηδενα θεασαμενος πλην της γυναικος ειπεν αυτη που εισιν εκεινοι οι κατηγοροι σου ουδεις σε κατεκρινεν ανακυψας δε ο ιησους OMIT και μηδενα θεασαμενος πλην της γυναικος OMIT ειδεν αυτην και ειπεν γυναι που εισιν OMIT: εκεινοι οι κατηγοροι σου:OMIT ουδεις σε κατεκρινεν',
        11: 'η δε ειπεν ουδεις κυριε ειπεν δε δε αυτη ο ιησους ουδε εγω σε κρινω κατακρινω πορευου και και απο του νυν μηκετι αμαρτανε',
        ...
        39: 'απεκριθησαν και ειπον αυτω ο πατηρ ημων αβρααμ εστιν λεγει αυτοις ο ιησους ει τεκνα του αβρααμ ητε τα εργα του αβρααμ εποιειτε εποιειτε αν',
        ...
        44: 'υμεις εκ του πατρος του διαβολου εστε και τας επιθυμιας του πατρος υμων θελετε ποιειν εκεινος ανθρωποκτονος ην απ αρχης και εν τη αληθεια ουχ εστηκεν οτι ουκ εστιν αληθεια εν αυτω οταν λαλη το ψευδος εκ των ιδιων λαλει οτι ψευστης εστιν και ο πατηρ αυτου',
        ...
        54: 'απεκριθη ιησους εαν εγω δοξαζω εμαυτον η δοξα μου ουδεν εστιν εστιν ο πατηρ μου ο δοξαζων με ον υμεις λεγετε οτι θεος ημων εστιν',
    ...
    9: {
        ...
        10: 'ελεγον ουν αυτω πως ανεωχθησαν ηνεωχθησαν σου οι οφθαλμοι',
    ...
    10: {
        ...
        23: 'και περιεπατει ο ιησους εν τω ιερω εν τη στοα σολομωνος',
        ...
        39: 'εζητουν ουν OMIT ουν παλιν αυτον πιασαι και εξηλθεν εκ της χειρος αυτων',
    ...
    11: {
        ...
        9: 'απεκριθη ιησους ουχι δωδεκα εισιν ωραι της ημερας εαν τις περιπατη εν τη ημερα ου προσκοπτει οτι το φως του κοσμου τουτου βλεπει',
        ...
        21: 'ειπεν ουν μαρθα προς τον ιησουν κυριε ει ης ωδε ο αδελφος μου ουκ αν ετεθνηκει',
        ...
        32: 'η ουν μαρια ως ηλθεν οπου ην ο ιησους ιδουσα αυτον επεσεν αυτου εις τους ποδας λεγουσα αυτω κυριε ει ης ωδε ουκ αν απεθανεν μου ο αδελφος',
        ...
        51: 'τουτο δε αφ εαυτου ουκ ειπεν αλλα αρχιερευς ων του ενιαυτου εκεινου προεφητευσεν οτι εμελλεν ιησους αποθνησκειν υπερ του εθνους',
        ...
        54: 'ιησους ουν ουκετι παρρησια περιεπατει εν τοις ιουδαιοις αλλα απηλθεν εκειθεν εις την χωραν εγγυς της ερημου εις εφραιμ λεγομενην πολιν κακει διετριβεν μετα των μαθητων αυτου',
    ...
    12: {
        ...
        2: 'εποιησαν ουν αυτω δειπνον εκει και η μαρθα διηκονει ο δε λαζαρος εις ην των ανακειμενων συν αυτω',
        ...
        12: 'τη επαυριον οχλος πολυς ο ελθων εις την εορτην ακουσαντες οτι ερχεται ιησους εις ιεροσολυμα',
        13: 'ελαβον τα βαια των φοινικων και εξηλθον εις υπαντησιν αυτω και εκραζον ωσαννα ευλογημενος ο ερχομενος εν ονοματι κυριου βασιλευς του ισραηλ',
        ...
        16: 'ταυτα δε ουκ εγνωσαν οι μαθηται αυτου το πρωτον αλλ οτε εδοξασθη ιησους ο ιησους τοτε εμνησθησαν οτι ταυτα ην επ αυτω γεγραμμενα και ταυτα εποιησαν αυτω',
        ...
        30: 'απεκριθη ιησους ο ιησους και ειπεν ου δι εμε αυτη η φωνη γεγονεν αλλα δι υμας',
        ...
        34: 'απεκριθη αυτω ο οχλος ημεις ηκουσαμεν εκ του νομου οτι ο χριστος μενει εις τον αιωνα και πως συ λεγεις δει υψωθηναι τον υιον του ανθρωπου τις εστιν ουτος ο υιος του ανθρωπου',
        ...
        40: 'τετυφλωκεν αυτων τους οφθαλμους και πεπωρωκεν αυτων την καρδιαν ινα μη ιδωσιν τοις οφθαλμοις και νοησωσιν τη καρδια και επιστραφωσιν και ιασωμαι ιασομαι αυτους',
    ...
    14: {
        ...
        3: 'και εαν πορευθω ετοιμασω πορευθω και ετοιμασω OR πορευθω ετοιμασαι υμιν τοπον παλιν ερχομαι 2064 και παραληψομαι υμας προς εμαυτον ινα οπου ειμι εγω και υμεις ητε',
        ...
        14: 'εαν τι αιτησητε με OMIT με εν τω ονοματι μου εγω ποιησω',
        ...
        19: 'ετι μικρον και ο κοσμος με ουκετι θεωρει υμεις δε θεωρειτε με οτι εγω ζω και υμεις ζησεσθε',
        ...
        22: 'λεγει αυτω ιουδας ουχ ο ισκαριωτης κυριε και τι γεγονεν οτι ημιν μελλεις εμφανιζειν σεαυτον και ουχι τω κοσμω',
        23: 'απεκριθη ιησους και ειπεν αυτω εαν τις αγαπα με τον λογον μου τηρησει και ο πατηρ μου αγαπησει αυτον και προς αυτον ελευσομεθα και μονην παρ αυτω ποιησομεν',
    ...
    15: {
        ...
        16: 'ουχ υμεις με εξελεξασθε αλλ εγω εξελεξαμην υμας και εθηκα υμας ινα υμεις υπαγητε και καρπον φερητε και ο καρπος υμων μενη ινα ο τι αν αιτησητε τον πατερα εν τω ονοματι μου δω δωη υμιν',
    ...
    17: {
        ...
        2: 'καθως εδωκας αυτω εξουσιαν πασης σαρκος ινα παν ο δεδωκας αυτω δωσει αυτοις ζωην αιωνιον',
        ...
        11: 'και ουκετι ειμι εν τω κοσμω και ουτοι εν τω κοσμω εισιν και εγω προς σε ερχομαι πατερ αγιε τηρησον αυτους εν τω ονοματι σου ω δεδωκας μοι ινα ωσιν εν καθως ημεις',
        ...
        24: 'πατερ ους δεδωκας μοι θελω ινα οπου ειμι εγω κακεινοι ωσιν μετ εμου ινα θεωρωσιν την δοξαν την εμην ην εδωκας δεδωκας μοι οτι ηγαπησας με προ καταβολης κοσμου',
    ...
    18: {
        ...
        2: 'ηδει δε και ιουδας ο παραδιδους αυτον τον τοπον οτι πολλακις συνηχθη ο ιησους και ο ιησους εκει μετα των μαθητων αυτου',
        ...
        28: 'αγουσιν ουν τον ιησουν απο του καιαφα εις το πραιτωριον ην δε πρωι πρωια και αυτοι ουκ εισηλθον εις το πραιτωριον ινα μη μιανθωσιν αλλ ινα φαγωσιν το πασχα',
        ...
        37: 'ειπεν ουν αυτω ο πιλατος ουκουν βασιλευς ει συ απεκριθη ιησους ο ιησους συ λεγεις οτι βασιλευς ειμι εγω εγω εις τουτο γεγεννημαι και εις τουτο εληλυθα εις τον κοσμον ινα μαρτυρησω τη αληθεια πας ο ων εκ της αληθειας ακουει μου της φωνης',
    ...
    19: {
        ...
        14: 'ην δε παρασκευη του πασχα ωρα δε ωσει ως εκτη και λεγει τοις ιουδαιοις ιδε ο βασιλευς υμων',
        ...
        26: 'ιησους ουν ιδων την μητερα και τον μαθητην παρεστωτα ον ηγαπα λεγει τη μητρι αυτου γυναι ιδου ιδε ο υιος σου',
        ...
        35: 'και ο εωρακως μεμαρτυρηκεν και αληθινη εστιν αυτου αυτου εστιν η μαρτυρια κακεινος οιδεν οτι αληθη λεγει ινα υμεις πιστευσητε',
        ...
        38: 'μετα ταυτα ηρωτησεν τον πιλατον ιωσηφ ο ιωσηφ ο απο αριμαθαιας ων μαθητης του ιησου κεκρυμμενος δε δια τον φοβον των ιουδαιων ινα αρη το σωμα του ιησου και επετρεψεν ο πιλατος ηλθεν ουν και ηρεν το σωμα του ιησου',
        39: 'ηλθεν δε και νικοδημος ο ελθων προς τον ιησουν νυκτος το πρωτον φερων μιγμα σμυρνης και αλοης ως ωσει λιτρας εκατον',
    ...
    20: {
        ...
        11: 'μαρια δε ειστηκει προς το μνημειον τω μνημειω κλαιουσα εξω ως ουν εκλαιεν παρεκυψεν εις το μνημειον',
        ...
        14: 'και ταυτα ειπουσα εστραφη εις τα οπισω και θεωρει τον ιησουν εστωτα και ουκ ηδει οτι ιησους εστιν',
        15: 'λεγει αυτη ο ιησους γυναι τι κλαιεις τινα ζητεις εκεινη δοκουσα οτι ο κηπουρος εστιν λεγει αυτω κυριε ει συ εβαστασας αυτον ειπε μοι που εθηκας αυτον καγω αυτον αρω',
        ...
        31: 'ταυτα δε γεγραπται ινα πιστευσητε οτι ιησους εστιν ο χριστος ο υιος του θεου και ινα πιστευοντες ζωην εχητε εν τω ονοματι αυτου',
    },
    21: {
        1: 'μετα ταυτα εφανερωσεν εαυτον παλιν ο ιησους τοις μαθηταις μαθηταις αυτου επι της θαλασσης της τιβεριαδος εφανερωσεν δε ουτως',
        ...
        3: 'λεγει αυτοις σιμων πετρος υπαγω αλιευειν λεγουσιν αυτω ερχομεθα και ημεις συν σοι εξηλθον και ενεβησαν εις το πλοιον ευθυς και εν εκεινη τη νυκτι επιασαν ουδεν',
        ...
        11: 'ανεβη σιμων πετρος και ειλκυσεν το δικτυον επι της γης μεστον ιχθυων μεγαλων εκατον πεντηκοντα τριων και τοσουτων οντων ουκ εσχισθη το δικτυον',
