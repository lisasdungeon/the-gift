NAME = 'Haweis: Thomas Haweis 1795 New Testament'
BOOK = 'Jude'
...
CHAPTERS = {
    1: {
        ...
        6: 'And the angels who preserved not their own primitive state, but deserted their proper abode, hath he reserved in everlasting chains under darkness, unto the judgment of the great day.',
        7: 'As Sodom and Gomorrha and the surrounding cities, in like manner with them abandoned to whoredom, and going after other flesh, are set forth an example, suffering the judicial punishment of eternal fire.',
        ...
        21: 'preserve yourselves in the love of God, waiting for the mercy of our Lord Jesus Christ unto eternal life.',
        ...
        25: 'to the only wise God our Saviour, be glory and majesty, might and dominion, both now and unto all eternity. Amen. \\p',
    },
}
