...
CHAPTERS = {
    1: {
        ...
        6: 'Także aniołów, którzy nie zachowali swego pierwotnego stanu, lecz opuścili własne mieszkanie, zatrzymał w wiecznych pętach w ciemnościach na sąd wielkiego dnia.',
        7: 'Tak samo Sodoma i Gomora oraz okoliczne miasta, które w podobny sposób jak i one oddały się nierządowi i podążały za cudzym ciałem, służą za przykład, ponosząc karę wiecznego ognia.',
        ...
        25: 'Jedynemu mądremu Bogu, naszemu Zbawicielowi, niech będzie chwała i majestat, moc i władza, teraz i po wszystkie wieki. Amen.',
    },
}
