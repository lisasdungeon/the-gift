...
CHAPTERS = {
    1: {
        ...
        3: 'Αγαπητοί, επειδή καταβάλλω πάσαν σπουδήν να σας γράψω περί της κοινής σωτηρίας, έλαβον ανάγκην να σας γράψω, προτρέπων εις το να αγωνίζησθε δια την πίστιν, ήτις άπαξ παρεδόθη εις τους αγίους.',
        ...
        6: 'και αγγέλους οίτινες δεν εφύλαξαν την εαυτών αξίαν, αλλά κατέλιπον το ίδιον αυτών κατοικητήριον, εφύλαξε με παντοτεινά δεσμά υποκάτω του σκότους, δια την κρίσιν της μεγάλης ημέρας',
        ...
        13: 'κύματα άγρια θαλάσσης επαφρίζοντα τας ιδίας αυτών αισχύνας, αστέρες πλανήται, δια τους οποίους το ζοφερόν σκότος είναι τετηρημένον εις τον αιώνα.',
        14: 'Προεφήτευσε δε περί τούτων και ο Ενώχ, έβδομος από Αδάμ, λέγων, "Ιδού, ήλθεν ο Κύριος με μυριάδας αγίων αυτού,',
        15: 'δια να κάμη κρίσιν κατά πάντων, και να ελέγξη πάντας τους ασεβείς εξ αυτών, δια πάντα τα έργα της ασεβείας αυτών, τα οποία έπραξαν και δια πάντα τα σκληρά τα οποία ελάλησαν κατ\' αυτού αμαρτωλοί ασεβείς."',
