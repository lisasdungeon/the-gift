...
CHAPTERS = {
    ...
    2: {
        ...
        8: 'Sen till, att ingen får bortföra eder såsom ett segerbyte genom sin tomma och bedrägliga »vishetslära», i det att han åberopar fäderneärvda människomeningar och håller sig till världens »makter»[1] och icke till Kristus.',
        ...
        23: 'Visserligen har allt detta fått namn om sig att vara »vishet», eftersom däri ligger ett självvalt gudstjänstväsende och ett slags »ödmjukhet» och en kroppens späkning; men ingalunda ligger däri »en viss heder», det tjänar allenast till att nära det köttsliga sinnet. [1] Se Makter i Ordförkl.',
    },
    3: {
    ...
    4: {
        ...
        2: 'Varen uthålliga i bönen och vaken i den under tacksägelse. 3; Och bedjen jämväl för oss, att Gud må åt oss öppna en dörr för ordet, så att vi få förkunna Kristi hemlighet, den hemlighet, för vars skull jag också är en fånge;',
