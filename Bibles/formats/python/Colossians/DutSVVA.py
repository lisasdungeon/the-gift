...
CHAPTERS = {
    1: {
        ...
        23: 'Indiën gij maar blijft in het geloof, gefondeerd en vast, en niet bewogen wordt van de hope des Evangelies, dat gij gehoord hebt, hetwelk gepredikt is onder al de kreature, die onder den hemel is; van hetwelk ik Paulus een dienaar geworden ben;',
    ...
    2: {
        ...
        20: 'Indiën gij dan met Christus de eerste beginselen der wereld zijt afgestorven, wat wordt gij, gelijk of gij in de wereld leefdet, met inzettingen belast?',
    ...
    3: {
        1: 'Indiën gij dan met Christus opgewekt zijt, zo zoekt de dingen, die boven zijn, waar Christus is, zittende aan de rechter hand Gods.',
    ...
    4: {
        ...
        18: 'De groetenis met mijn hand, van Paulus. Gedenkt mijner banden. De genade zij met u. Amen. Geschreven vanuit Rome aan de Kolossenzen door bemiddeling van Tychicus en Onesimus.',
    },
}
