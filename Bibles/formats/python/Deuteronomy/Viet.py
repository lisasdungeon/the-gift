...
CHAPTERS = {
    1: {
        1: 'Nầy là lời Môi-se nói cho cả Y-sơ-ra-ên, bên kia sông Giô-đanh, tại đồng vắng, trong đồng bằng, đối ngang Su-phơ, giữa khoảng Pha-ran và Tô-phên, La-ban, Hát-sê-rốt, và Ði-xa-háp.',
        2: 'Từ Hô-rếp tới Ca-đe-Ba-nê-a, bởi đường núi Sê -i-rơ, đi mười một ngày đường.',
        3: 'Nhằm năm bốn mươi, ngày mồng một tháng mười một. Môi-se nói cùng dân Y-sơ-ra-ên mọi điều mà Ðức Giê-hô-va đã biểu người phải nói cùng họ.',
        4: 'Ấy là sau khi người đã đánh giết Si-hôn, vua dân A-mô-rít ở tại Hết-bôn, và Oùc, vua Ba-san, ở tại Ách-ta-rốt và Ết-rê -i.',
        ...
        7: 'hãy vòng lại và đi đến núi dân A-mô-rít, cùng đến các miền ở gần bên, tức là đến nơi đồng bằng, lên núi, vào xứ thấp, đến miền nam, lên mé biển, vào xứ dân Ca-na-an và Li-ban, cho đến sông lớn, là sông Ơ-phơ-rát.',
        8: 'Kìa, ta phó xứ nầy cho các ngươi! Hãy vào và chiếm lấy xứ mà Ðức Giê-hô-va đã thề ban cho tổ phụ các ngươi, là Áp-ra-ham, Y-sác, Gia-cốp, cùng cho con cháu của họ.',
        9: 'Trong lúc đó ta có nói cùng các ngươi rằng: Một mình ta không đủ sức cai trị các ngươi.',
        10: 'Giê-hô-va Ðức Chúa Trời các ngươi đã gia thêm các ngươi, kìa ngày nay, các ngươi đông như sao trên trời.',
        ...
        15: 'Bấy giờ, ta chọn lấy những người quan trưởng của các chi phái, là những người khôn ngoan, có tiếng, lập lên làm quan tướng các ngươi, hoặc cai ngàn người, hoặc cai trăm người, hoặc cai năm mươi người, hoặc cai mười người, và làm quản lý trong những chi phái của các ngươi.',
        16: 'Trong lúc đó, ta ra lịnh cho những quan xét các ngươi rằng: Hãy nghe anh em các ngươi, và lấy công bình mà xét đoán sự tranh tụng của mỗi người với anh em mình, hay là với khách ngoại bang ở cùng người.',
        ...
        18: 'Vậy, trong lúc đó, ta có truyền cho các ngươi mọi điều mình phải làm.',
        19: 'Ðoạn, bỏ Hô-rếp, chúng ta trải ngang qua đồng vắng minh-mông và gớm ghê mà chúng ta thấy kia, hướng về núi dân A-mô-rít, y như Giê-hô-va Ðức Chúa Trời chúng ta đã phán dặn; rồi chúng ta đến Ca-đe-Ba-nê-a.',
        20: 'Bấy giờ, ta nói cùng các ngươi rằng: Các ngươi đã đến núi của dân A-mô-rít mà Giê-hô-va Ðức Chúa Trời chúng ta ban cho chúng ta.',
        21: 'Kìa, Giê-hô-va Ðức Chúa Trời ngươi phó xứ nầy cho ngươi; hãy đi lên, chiếm làm sản nghiệp, y như Giê-hô-va Ðức Chúa Trời của tổ phụ ngươi đã phán cùng ngươi; chớ ái ngại, chớ kinh khủng.',
        ...
        23: 'Lời nầy đẹp lòng ta; ta chọn mười hai người trong các ngươi, tức mỗi chi phái một người.',
        24: 'Mười hai người đó ra đi. lên núi, đi đến khe Ếch-côn và do thám xứ.',
        25: 'Họ hái cầm trong tay mình những trái cây xứ đó, đem về cho chúng ta; thuật lại cùng chúng ta rằng: Xứ mà Giê-hô-va Ðức Chúa Trời chúng ta ban cho thật là tốt.',
        26: 'Nhưng các ngươi không muốn lên đó, và đã bội nghịch mạng của Giê-hô-va Ðức Chúa Trời các ngươi,',
        ...
        33: 'là Ðấng đi trước dẫn các ngươi trên đường, để tìm cho các ngươi một nơi đóng trại; ban đêm trong đám lửa, ban ngày trong đám mây, đặng chỉ con đường các ngươi phải đi.',
        ...
        36: 'ngoại trừ Ca-lép, con trai của Giê-phu-nê. Người sẽ thấy xứ đó; và ta sẽ ban cho người cùng con cháu người xứ mà người đã trải qua, bởi vì người có theo Ðức Giê-hô-va cách trung tín trọn vẹn.',
        37: 'Lại, Ðức Giê-hô-va vì cớ các ngươi cũng nổi giận cùng ta, mà rằng: Ngươi cũng vậy, sẽ không vào đó đâu.',
        ...
        39: 'Những con trẻ của các ngươi và các ngươi đã nói rằng sẽ thành một miếng mồi, và những con trai các ngươi hiện bây giờ chưa biết điều thiện hay là điều ác, sẽ vào xứ đó. Ta sẽ ban cho chúng nó xứ nầy làm sản nghiệp;',
        40: 'nhưng các ngươi hãy trở về, đi đến đồng vắng về hướng Biển đỏ.',
        41: 'Lúc đó, các ngươi bèn đáp cùng ta mà rằng: Chúng tôi đã phạm tội cùng Ðức Giê-hô-va; chúng tôi sẽ đi lên chiến trận và làm mọi điều Giê-hô-va Ðức Chúa Trời chúng tôi đã phán dặn. Mỗi người trong các ngươi nịt binh khí và toan dại dột đi lên núi.',
        42: 'Ðức Giê-hô-va bèn phán cùng ta rằng: Hãy nói cùng dân sự: Chớ đi lên và chớ chiến trận, vì ta không ngự giữa các ngươi; e các ngươi bị quân thù nghịch đánh bại.',
        43: 'Ta có thuật lại những lời nầy, nhưng các ngươi không nghe ta, nghịch mạng của Ðức Giê-hô-va, đầy sự kiêu ngạo, kéo đi lên núi.',
        ...
        46: 'Ấy vì thế nên các ngươi ở tại Ca-đe lâu ngày, nhiều ngày biết dường bao!',
    },
    2: {
        1: 'Ðoạn, chúng ta trở lại đi vào đồng vắng về hướng Biển đỏ, y như Ðức Giê-hô-va đã phán dặn ta, và chúng ta đi vòng lâu ngày quanh núi Sê -i-rơ.',
        ...
        6: 'Các ngươi sẽ dùng tiền bạc mà mua lương thức của chúng nó mà ăn, nước mà uống.',
        ...
        21: 'ấy là một dân lớn, đông, hình giềng giàng như dân A-na-kim. Nhưng Ðức Giê-hô-va diệt dân Rê-pha-im trước mặt dân Am-môn; dân Am-môn đoạt lấy xứ của họ và ở thế cho.',
    ...
    3: {
        ...
        12: 'Vậy, trong lúc đó, chúng ta chiếm lấy xứ nầy. Ta cho người Ru-bên và người Gát từ xứ A-rô -e, ở trên khe Aït-nôn và phân nửa núi Ga-la-át, cùng các thành của nó.',
        13: 'Ta cho phân nửa chi phái Ma-na-se phần còn lại của núi Ga-la-át, và toàn Ba-san, nước của Oùc, tức là cả miền Aït-gốp cùng toàn Ba-san vậy. Miền ấy gọi là xứ Rê-pha-im.',
        ...
        16: 'Về người Ru-bên và người Gát, ta cho phần Ga-la-át có ranh ở giữa khe Aït-nôn cho đến khe Gia-bốt, là giới hạn của con cháu Am-môn,',
    ...
    5: {
        1: 'Vậy, Môi-se gọi cả Y-sơ-ra-ên mà nói rằng: Hõi Y-sơ-ra-ên, hãy nghe những luật lệ và mạng lịnh mà ngày nay ta rao truyền nơi lỗ tai các ngươi; các ngươi phải học tập và cẩn thận làm theo những điều đó.',
        2: 'Giê-hô-va Ðức Chúa Trời chúng ta có lập giao ước cùng chúng ta tại Hô-rếp.',
        3: 'Chẳng phải cùng tổ phụ chúng ta mà Ðức Giê-hô-va đã lập giao ước nầy đâu, nhưng cùng hết thảy chúng ta hiện ngày nay còn sống đây.',
        4: 'Ðức Giê-hô-va tại trên núi từ giữa lửa, đã đối diện phán cùng các ngươi.',
        5: 'Ðang lúc đó, ta đứng giữa Ðức Giê-hô-va và các ngươi, đặng truyền lại lời của Ngài cho các ngươi; vì các ngươi sợ lửa, không lên trên núi. Ngài phán rằng:',
        6: 'Ta là Giê-hô-va Ðức Chúa Trời ngươi, đã rút ngươi ra khỏi xứ Ê-díp-tô, tức là khỏi nhà nô lệ.',
        ...
        11: 'Ngươi chớ lấy danh của Giê-hô-va Ðức Chúa Trời ngươi mà làm chơi; vì Ðức Giê-hô-va không cầm bằng vô tội kẻ nào lấy danh Ngài mà làm chơi.',
        12: 'Hãy giữ ngày nghỉ đặng làm nên thánh, y như Giê-hô-va Ðức Chúa Trời ngươi đã phán dặn ngươi.',
        13: 'Ngươi hãy làm hết công việc mình trong sáu ngày;',
        14: 'nhưng ngày thứ bảy là ngày nghỉ của Giê-hô-va Ðức Chúa Trời ngươi: chớ làm một công việc nào hết, hoặc ngươi, con trai con gái, tôi trai tớ gái của ngươi, hoặc bò, lừa, hoặc một trong các súc vật của ngươi, hay là khách ở trong nhà ngươi, hầu cho tôi trai và tớ gái ngươi cũng được nghỉ như ngươi.',
        15: 'Khá nhớ rằng ngươi đã làm tôi mọi nơi xứ Ê-díp-tô, và Giê-hô-va Ðức Chúa Trời ngươi dùng tay quyền năng giơ thẳng ra đem ngươi ra khỏi đó; bởi cớ ấy cho nên Giê-hô-va Ðức Chúa Trời ngươi có dặn biểu ngươi phải giữ ngày nghỉ.',
        16: 'Hãy hiếu kính cha mẹ ngươi, như Giê-hô-va Ðức Chúa Trời ngươi có phán dặn, hầu cho ngươi được sống lâu và có phước trên đất mà Giê-hô-va Ðức Chúa Trời ngươi ban cho.',
        ...
        22: 'Tại trên núi, giữa lửa, mây và sự tối tăm, Ðức Giê-hô-va có dùng tiếng lớn phán những lời nầy cho cả hội các ngươi, Ngài không thêm chi hết; đoạn Ngài ghi các lời đó trên hai bảng đá, và trao cho ta.',
        ...
        24: 'Kìa, Giê-hô-va Ðức Chúa Trời chúng tôi đã tỏ ra sự vinh hiển và sự oai nghiêm Ngài cho chúng tôi, và chúng tôi có nghe tiếng Ngài từ giữa lửa phán ra; ngày nay chúng tôi thấy rằng Ðức Chúa Trời có phán cùng loài người và loài người vẫn còn sống.',
        25: 'Nhưng bây giờ, cớ sao chúng tôi phải chết? vì đám lửa lớn nầy sẽ tiêu diệt chúng tôi hết. Ví bằng chúng tôi còn có nghe tiếng của Giê-hô-va Ðức Chúa Trời chúng tôi, thì chúng tôi phải chết.',
        26: 'Vì trong loài người, có ai đã nghe tiếng Ðức Chúa Trời sanh hoạt từ giữa lửa phán ra, như chúng tôi mà vẫn còn sống?',
        27: 'Vậy, ông hãy đi đến gần, nghe mọi điều Giê-hô-va Ðức Chúa Trời chúng tôi sẽ phán, rồi hãy truyền lại cho chúng tôi mọi điều Giê-hô-va Ðức Chúa Trời chúng tôi sẽ nghe và làm theo.',
        28: 'Ðang khi các ngươi bàn cùng ta, Ðức Giê-hô-va nghe những lời của các ngươi, nên phán cùng ta rằng: Ta có nghe những lời dân nầy bàn cùng ngươi; chúng nó nói như vậy lấy làm thậm phải.',
        ...
        32: 'Vậy, các ngươi khá cẩn thận làm theo, y như Giê-hô-va Ðức Chúa Trời các ngươi đã phán dặn các ngươi; chớ xây qua bên hữu, hoặc qua bên tả.',
        33: 'Các ngươi khá đi theo trọn đường mà Giê-hô-va Ðức Chúa Trời các ngươi đã chỉ cho, để các ngươi được sống, hưởng phước, và ở lâu dài trong xứ mà mình sẽ nhận được.',
    },
    6: {
    ...
    7: {
        1: 'Khi Giê-hô-va Ðức Chúa Trời ngươi đã dẫn ngươi vào xứ mình sẽ nhận được, đuổi khỏi trước mặt ngươi nhiều dân tộc, là dân Hê-tít, dân Ghi-rê-ga-sít, dân A-mô-rít, dân Ca-na-an, dân Phê-rê-sít, dân Hê-vít, và dân Giê-bu-sít, tức bảy dân tộc lớn và mạnh hơn ngươi,',
    ...
    9: {
        1: 'Hỡi Y-sơ-ra-ên, hãy nghe! ngày nay ngươi sẽ đi ngang qua sông Giô-đanh, đặng chiếm lấy các dân tộc lớn và mạnh hơn ngươi, những thành lớn và tường cao đến trời,',
        2: 'một dân to lớn và tác cao, là con cháu A-na-kim, mà ngươi đã biết, và có nghe mói rằng: "Ai sẽ đương địch nổi trước mặt con cháu A-nác?"',
        3: 'Vậy, ngày nay phải biết rằng Giê-hô-va Ðức Chúa Trời ngươi đi trước ngươi, như một đám lửa hừng, sẽ tiêu diệt và hạ xuống các dân nầy trước mặt ngươi; ngươi sẽ đuổi ra và diệt chúng nó cách mau, y như Ðức Giê-hô-va đã phán cùng ngươi.',
        4: 'Khi Giê-hô-va Ðức Chúa Trời ngươi đã đuổi chúng nó khỏi trước mặt ngươi, chớ nói trong lòng rằng: Ấy vì cớ sự công bình tôi mà Ðức Giê-hô-va khiến tôi vào nhận lấy xứ nầy; thật là bởi sự gian ác của các dân tộc đó, nên Ðức Giê-hô-va mới đuổi chúng nó ra khỏi trước mặt ngươi.',
        5: 'Ngươi vào nhận lấy xứ của các dân tộc ấy, chẳng phải vì cớ sự công bình ngươi, hay là lòng chánh trực của ngươi đâu, nhưng vì cớ sự gian ác của chúng nó, nên Giê-hô-va Ðức Chúa Trời ngươi sẽ đuổi chúng nó ra khỏi trước mặt ngươi, để làm cho ứng nghiệm lời hứa Ngài đã thề cùng các tổ phụ người, là Áp-ra-ham, Y-sác và Gia-cốp.',
        6: 'Vậy, khá biết rằng chẳng phải vì cớ sự công bình ngươi mà Giê-hô-va Ðức Chúa Trời ngươi cho ngươi nhận lấy xứ tốt tươi nầy đâu; bởi ngươi vẫn là một dân cứng cổ.',
        7: 'Hãy nhớ lại, chớ quên rằng, trong đồng vắng ngươi đã chọc giận Giê-hô-va Ðức Chúa Trời ngươi. Từ ngày ra khỏi xứ Ê-díp-tô cho đến chốn nầy, ngươi thường phản nghịch cùng Ðức Giê-hô-va.',
        8: 'Tại Hô-rếp, các ngươi cũng đã chọc giận Ðức Giê-hô-va; nên Ngài nổi thạnh nộ toan diệt các ngươi.',
        9: 'Khi ta đi lên núi đặng lãnh hai bảng đá, tức là hai bảng về sự giao ước mà Ðức Giê-hô-va đã lập cùng các ngươi, ta ở trên núi bốn mươi ngày và bốn mươi đêm, không ăn bánh, chẳng uống nước;',
        10: 'và Ðức Giê-hô-va trao cho ta hai bảng đá, bởi ngón tay Ðức Chúa Trời viết ra, có đủ những lời mà Ðức Giê-hô-va từ giữa lửa, tại trên núi, có phán ra cùng các ngươi, trong ngày nhóm hiệp.',
        11: 'Xảy khi bốn mươi ngày và bốn mươi đêm mãn rồi, Ðức Giê-hô-va ban cho ta hai bảng đá, tức là hai bảng về sự giao ước.',
        12: 'Ðoạn, Ðức Giê-hô-va phán cùng ta rằng: Hãy đứng dậy, mau mau xuống khỏi đây, vì dân mà ngươi đem ra khỏi xứ Ê-díp-tô đã tự bại hoại, vội bỏ đạo của ta đã truyền cho, mà chế cho mình một tượng đúc.',
        13: 'Ðức Giê-hô-va lại phán cùng ta rằng: Ta nhìn xem dân nầy, kìa là một dân cứng cổ.',
        14: 'Hãy để mặc ta diệt chúng nó, và xóa tên chúng nó khỏi dưới trời, rồi ta sẽ làm cho ngươi thành một dân tộc mạnh và lớn hơn dân ấy.',
        15: 'Vậy, ta bèn xây lại đi xuống núi, cả núi vẫn có lửa cháy: hai tay ta cầm hai bảng đá về sự giao ước.',
        16: 'Bấy giờ, ta nhìn xem, kìa các ngươi đã phạm tội cùng Giê-hô-va. Ðức Chúa Trời các ngươi, rất vội bỏ đạo Ngài đã truyền cho, mà làm cho mình một con bò con đúc.',
        17: 'Ta bèn nắm hai bảng đá, liệng ra khỏi tay, đập bể trước mặt các ngươi.',
        18: 'Ðoạn, vì cớ các ngươi làm dữ, phạm tội trọng trước mắt Ðức Giê-hô-va, chọc cho Ngài giận, nên ta lại sấp mình xuống trước mặt Ðức Giê-hô-va, trong bốn mươi ngày và bốn mươi đêm như lần trước, không ăn bánh và chẳng uống nước.',
        19: 'Vì ta sợ cơn thạnh nộ và tức giận của Ðức Giê-hô-va đã nổi phừng lên, đặng diệt các ngươi; nhưng Ðức Giê-hô-va còn nhậm lời ta lần nầy nữa.',
        20: 'Ðức Giê-hô-va cũng nổi nóng phừng cùng A-rôn, đến đỗi muốn giết người; song ta cũng cầu nguyện cho A-rôn trong lúc đó.',
        21: 'Ðoạn, ta lấy vật tội lỗi của các ngươi, tức là con bò con mà các ngươi đã làm, đem đốt trong lửa, đập bể ra từng miếng, nghiền cho đến đỗi nó tan ra bụi, rồi đổ bụi ấy nơi khe ở trên núi chảy xuống.',
        22: 'Các ngươi cũng có chọc giận Ðức Giê-hô-va tại Tha-bê-ra, tại Ma-sa, và tại Kíp-rốt-Ha-tha-va.',
        23: 'Khi Ðức Giê-hô-va sai các ngươi đi từ Ca-đe-Ba-nê-a, có dặn rằng: Hãy đi lên nhận lấy xứ ta ban cho các ngươi, thì các ngươi đã bội nghịch mạng của Giê-hô-va Ðức Chúa Trời các ngươi, không tin Ngài và không nghe theo tiếng Ngài.',
        24: 'Từ ngày ta biết các ngươi cho đến bây giờ, các ngươi thường phản nghịch cùng Ðức Giê-hô-va.',
        25: 'Vậy, vì cớ Ðức Giê-hô-va có phán rằng Ngài toan diệt các ngươi, nên ta cứ sấp mình xuống trước mặt Ðức Giê-hô-va trong bốn mươi ngày và bốn mươi đêm,',
        26: 'cầu khẩn Ngài mà rằng: Chúa Giê-hô-va ôi! xin chớ diệt dân sự của Chúa, là cơ nghiệp của Chúa, mà Chúa đã lấy sự oai nghiêm Ngài chuộc lại, và nhờ tay quyền năng rút ra khỏi xứ Ê-díp-tô.',
        27: 'Xin hãy nhớ đến những tôi tớ của Chúa là Áp-ra-ham, Y-sác, và Gia-cốp, chớ chấp sự cứng lòng, hung dữ, và tội ác của dân nầy,',
        28: 'e dân của xứ mà Chúa đã đem chúng tôi ra khỏi đó, nói rằng: Bởi vì Ðức Giê-hô-va không thế đem dân ấy vào xứ Ngài đã hứa, và vì Ngài ghét chúng nó, nên dẫn chúng nó ra khỏi xứ đặng giết đi trong đồng vắng.',
        29: 'Song chúng vốn là dân sự và cơ nghiệp của Chúa, mà Chúa đã dùng quyền năng lớn và cánh tay giơ thẳng ra, rút ra khỏi xứ Ê-díp-tô.',
    },
    10: {
        ...
        10: 'Vậy, ta ở trên núi trong bốn mươi ngày và bốn mươi đêm như lần đầu, và lần nầy Ðức Giê-hô-va lại nhậm lời ta, bằng lòng không diệt ngươi.',
    ...
    11: {
        ...
        6: 'và cũng hãy nhận biết điều Ngài làm cho Ða-than, A-bi-ram, con trai Ê-li-áp, cháu Ru-bên, khi đất tại giữa cả Y-sơ-ra-ên hả miệng nuốt hai người, gia quyến, luôn với trại và mọi vật chi theo họ.',
    ...
    12: {
        1: 'Nầy là những luật lệ và mạng lịnh mà trọn đời mình sống trên đất các ngươi phải gìn giữ làm theo trong xứ mà Giê-hô-va Ðức Chúa Trời của tổ phụ ngươi đã ban cho ngươi nhận lấy.',
        ...
        4: 'Chớ tùy tục chúng nó mà phục sự Giê-hô-va Ðức Chúa Trời các ngươi;',
        5: 'song nơi nào trong những chi phái các ngươi, mà Giê-hô-va Ðức Chúa Trời các ngươi sẽ chọn, đặng đặt danh Ngài, tức là nơi ngự của Ngài, thì các ngươi phải tìm đi đến đó,',
        ...
        7: 'rồi các ngươi sẽ ăn tại đó, trước mặt Giê-hô-va Ðức Chúa Trời các ngươi, vui vẻ cùng gia quyến mình, vì mọi việc tay mình làm đã được Giê-hô-va Ðức Chúa Trời ngươi ban phước cho.',
        8: 'Chớ làm như chúng ta làm ngày nay đây, là mỗi người làm tùy ý mình tưởng là phải;',
        9: 'vì các ngươi chưa vào nơi an nghỉ, và chưa hưởng lấy cơ nghiệp mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi.',
        10: 'Vậy, các ngươi sẽ đi ngang qua sông Giô-đanh, ở trong xứ mà Giê-hô-va Ðức Chúa Trời các ngươi ban cho làm sản nghiệp. Ngài sẽ ban sự bình an cho các ngươi, không để kẻ thù nghịch xung quanh hãm áp, và khiến cho các ngươi được ở yên ổn.',
        11: 'Bấy giờ, sẽ có một chỗ mà Giê-hô-va Ðức Chúa Trời các ngươi chọn, đặng cho danh Ngài ở; ấy là nơi các ngươi sẽ đem dâng mọi điều ta dặn các ngươi, tức là những của lễ thiêu, các hi sinh, thuế một phần mười, lễ vật dâng giơ lên, và mọi của lễ tốt nhất, mà các ngươi hứa nguyện dâng cho Ðức Giê-hô-va.',
        12: 'Các ngươi, con trai, con gái, tôi trai và tớ gái của các ngươi sẽ vui vẻ trước mặt Giê-hô-va Ðức Chúa Trời các ngươi, luôn với người Lê-vi ở trong thành các ngươi.',
        13: 'Khá coi chừng, chớ dâng của lễ thiêu mình trong những nơi nào ngươi thấy;',
        14: 'nhưng phải dâng tại nơi Ðức Giê-hô-va sẽ chọn trong một của các chi phái ngươi, và tại đó ngươi phải làm mọi điều ta truyền dặn.',
        15: 'Song trong các thành mình, ngươi được mặc ý giết những thú vật và ăn thịt nó, tùy theo sự phước lành mà Giê-hô-va Ðức Chúa Trời ngươi sẽ ban cho ngươi; vô luận người bị ô uế hay là người được tinh sạch sẽ đều ăn thịt nó như ăn con hoàng dương và con nai đực.',
        ...
        18: 'Nhưng ngươi, các con trai, con gái, tôi trai, và tớ gái ngươi, cùng người Lê-vi ở trong thành ngươi, phải ăn những vật ấy trước mặt Giê-hô-va Ðức Chúa Trời ngươi, tại chỗ Ngài sẽ chọn; ngươi sẽ vui vẻ trước mặt Giê-hô-va Ðức Chúa Trời ngươi, về mọi việc tay ngươi đã làm.',
        19: 'Trọn đời ngươi ở trong xứ, khá giữ mình, chớ bỏ bê người Lê-vi.',
        20: 'Khi Giê-hô-va Ðức Chúa Trời ngươi đã mở rộng bờ cõi ngươi, y như Ngài đã phán, và vì ngươi ước ao ăn thịt, nên nói: Tôi muốn ăn thịt! thì khá tùy ý ăn lấy.',
        21: 'Nếu chỗ mà Giê-hô-va Ðức Chúa Trời ngươi đã chọn đặng đặt danh, Ngài cách xa ngươi, ngươi được giết bò hay chiên mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi, y như ta dặn; rồi tùy ý ngươi muốn, ăn lấy nó trong thành mình.',
        ...
        25: 'Ðừng ăn huyết, hầu ngươi và con cháu ngươi được phước, bởi vì có làm điều ngay thẳng trước mặt Ðức Giê-hô-va.',
        26: 'Còn về thú vật ngươi biệt riêng ra thánh, hay là hứa nguyện dâng lên, thì phải đem nó theo mình đến nơi Ðức Giê-hô-va đã chọn,',
        27: 'dâng thịt và huyết nó làm của lễ thiêu trên bàn thờ của Giê-hô-va Ðức Chúa Trời ngươi; còn huyết các con sinh khác, thì phải đổ trên bàn thờ của Giê-hô-va Ðức Chúa Trời ngươi, đoạn mới ăn thịt nó.',
        28: 'Hãy giữ và nghe các điều nầy mà ta dặn biểu ngươi, để ngươi và con cháu ngươi được phước đời đời, bởi vì làm điều tốt lành và ngay thẳng trước mặt Giê-hô-va Ðức Chúa Trời ngươi.',
    ...
    15: {
        ...
        20: 'Mỗi năm, ngươi và gia quyến ngươi sẽ ăn nó trước mặt Giê-hô-va Ðức Chúa Trời ngươi, tại nơi mà Ngài sẽ chọn.',
    ...
    16: {
        1: 'Hãy giữ tháng lúa trỗ làm lễ Vượt-qua cho Giê-hô-va Ðức Chúa Trời ngươi, vì ấy trong tháng lúa trỗ, mà Giê-hô-va Ðức Chúa Trời ngươi, đang ban đêm đem ngươi ra khỏi xứ Ê-díp-tô.',
        ...
        4: 'Trong bảy ngày, không nên thấy men nơi nhà ngươi, hay trong khắp địa phận ngươi, thịt con sinh mà ngươi đã giết lúc chiều của ngày thứ nhất, thì chớ để đến sáng mai.',
        5: 'Ngươi không được giết con sinh về lễ Vượt-qua trong một thành nào mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi;',
        6: 'nhưng chỉ trong nơi mà Giê-hô-va Ðức Chúa Trời ngươi sẽ chọn để danh Ngài ở; ấy là nơi mà ngươi phải giết con sinh về lễ Vượt-qua, vào lối chiều, vừa khi mặt trời lặn, nhằm giờ mà ngươi đã ra khỏi xứ Ê-díp-tô.',
        7: 'Phải nấu thịt con sinh, và ăn tại trong nơi mà Giê-hô-va Ðức Chúa Trời ngươi sẽ chọn, rồi sáng mai trở về trại mình.',
        8: 'Trong sáu ngày, ngươi phải ăn bánh không men, và qua ngày thứ bảy, sẽ có một lễ trọng thể cho Giê-hô-va Ðức Chúa Trời ngươi: ngươi chớ làm một công việc nào.',
        ...
        11: 'Ngươi, con trai, con gái ngươi, tôi trai và tớ gái ngươi, người Lê-vi ở trong thành ngươi, người khách lạ, kẻ mồ côi và người góa bụa ở giữa vòng ngươi, đều sẽ vui vẻ tại trong chỗ mà Giê-hô-va Ðức Chúa Trời sẽ chọn để danh Ngài ở.',
        12: 'Phải nhớ lại rằng mình đã làm tôi mọi tại xứ Ê-díp-tô, và khá cẩn thận làm theo các luật lệ nầy.',
        13: 'Khi ngươi đã thâu huê lợi của sân đạp lúa và hầm rượu mình rồi, thì phải giữ lễ lều tạm trong bảy ngày.',
        ...
        15: 'Trong bảy ngày ngươi phải giữ lễ nầy cho Giê-hô-va Ðức Chúa Trời ngươi, tại nơi mà Ðức Giê-hô-va sẽ chọn; vì Giê-hô-va Ðức Chúa Trời ngươi sẽ ban phước cho các mùa màng và mọi công việc của tay ngươi; rồi ngươi sẽ vui mừng trọn vẹn.',
        16: 'Mọi người nam trong các ngươi, mỗi năm ba lần, phải ra mắt Giê-hô-va Ðức Chúa Trời ngươi, tại nơi mà Ngài sẽ chọn: tức là nhằm lễ bánh không men, lễ bảy tuần và lễ lều tạm; người ta chẳng nên đi tay không ra mắt Ðức Giê-hô-va.',
        17: 'Mỗi người sẽ dâng tùy theo của mình có, tùy theo phước mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi.',
        18: 'Ngươi phải tùy từng chi phái mình lập những quan án trong các thành mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi; những quan án ấy sẽ xử đoán dân sự cách công bình.',
        ...
        20: 'Ngươi phải theo sự công bình cách trọn vẹn, để ngươi được sống và nhận lấy xứ mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi.',
        21: 'Gần bên bàn thờ mà ngươi sẽ lập cho Giê-hô-va Ðức Chúa Trời ngươi, chớ dựng lên hình tượng của thần A-sê-ra bằng thứ cây nào.',
        22: 'Cũng chẳng nên dựng lên một trụ thờ nào: Giê-hô-va Ðức Chúa Trời ngươi lấy làm ghét các vật ấy.',
    },
    17: {
    ...
    19: {
        1: 'Khi Giê-hô-va Ðức Chúa Trời ngươi đã diệt các dân tộc của xứ mà Ngài ban cho ngươi, khi ngươi đã đuổi chúng nó đi, được ở trong các thành và các nhà chúng nó rồi,',
        2: 'thì phải để riêng ba cái thành giữa xứ mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi nhận lấy.',
        3: 'Ngươi phải dọn đường, chia ra làm ba phần địa phận của xứ mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi làm sản nghiệp: ấy hầu cho kẻ sát nhân ẩn núp tại đó.',
        ...
        8: 'Nếu ngươi cẩn thận làm theo các điều răn nầy mà ta truyền cho ngươi ngày nay, tức là thương mến Giê-hô-va Ðức Chúa Trời ngươi, hằng đi theo đường lối Ngài,',
        9: 'thì Giê-hô-va Ðức Chúa Trời ngươi sẽ mở rộng bờ cõi ngươi, y như Ngài đã thề cùng tổ phụ ngươi, và ban cho ngươi cả xứ mà Ngài đã hứa ban cho tổ phụ ngươi, rồi bấy giờ, ngươi phải thêm ba thành nữa vào ba thành trước;',
        10: 'hầu cho huyết vô tội không đổ ra giữa xứ mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi làm sản nghiệp, và không có huyết trên mình ngươi.',
        ...
        14: 'Ngươi chớ dời mộc giới của kẻ lân cận mình mà các tiên nhân ngươi đã cắm nơi sản nghiệp ngươi sẽ nhận được, tại xứ Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi nhận lấy.',
        ...
        17: 'thì hai đàng có tranh tụng nhau phải ứng hầu trước mặt Ðức Giê-hô-va, trước mặt những thầy tế lễ và quan án làm chức đang thì đó.',
    ...
    22: {
        ...
        5: 'Người nữ không phép mặc quần áo của người nam, và người nam cũng chẳng được mặc quần áo của người nữ; vì ai làm điều đó lấy làm gớm ghiếc cho Giê-hô-va Ðức Chúa Trời ngươi.',
        6: 'Khi ngươi gặp ngoài đường, hoặc ở trên cây, hoặc ở dưới đất, một ổ chim với con hay là trứng, thì chớ bắt chim mẹ luôn với chim con.',
        ...
        16: 'Ngươi cha của người gái sẽ nói cùng các trưởng lão rằng: Tôi có gả con gái tôi cho người nầy làm vợ, mà người lại ghét nó:',
        ...
        21: 'thì các trưởng lão phải dẫn nàng ra đến cửa nhà cha nàng, bá tánh của thành ấy sẽ lấy đá ném cho nàng chết, vì nàng có phạm tội gian ác tại Y-sơ-ra-ên, mà hành dâm trong nhà cha mình. Ấy, ngươi sẽ cất sự ác khỏi giữa mình là như vậy.',
        ...
        24: 'thì các ngươi phải dẫn cả hai người ra cửa thành đó, lấy đá ném cho cả hai đều chết: con gái trẻ, bởi vì không có la lên trong thành, người con trai, bởi vì làm mất danh giá vợ người lân cận mình. Ấy, ngươi sẽ cất sự ác khỏi giữa mình là như vậy.',
        ...
        26: 'chớ làm điều chi cho con gái trẻ dó, vì nàng không có phạm tội đáng chết. Việc nầy giống như sự một người dấy lên cùng kẻ lân cận mình và giết người đi;',
        ...
        29: 'thì người nam đã nằm cùng con gái trẻ đó phải nạp cho cha màng năm mươi siếc-lơ bạc, rồi nàng sẽ làm vợ người, bởi vì người có làm nhục nàng. Người còn sống ngày nào, thì chẳng được phép đuổi nàng đi.',
        30: 'Chẳng ai nên lấy vợ kế của cha mình, cũng đừng dở vạt áo của cha mình.',
    },
    23: {
        1: 'Người hoạn, hoặc vì ngoại thận bị dập, hay là bị cắt, sẽ không được phép vào hội của Ðức Giê-hô-va.',
        2: 'Con ngoại tình không được phép vào hội của Ðức Giê-hô-va, dầu đến đời thứ mười cũng chẳng vào được.',
        3: 'Dân Am-môn và dân Mô-áp sẽ không được phép vào hội Ðức Giê-hô-va, dầu đến đời thứ mười cũng chẳng hề bao giờ vào được;',
        ...
        5: 'Nhưng Giê-hô-va Ðức Chúa Trời ngươi không chịu nghe Ba-la-am, bèn đổi sự rủa sả ra sự chúc phước cho ngươi, vì Giê-hô-va Ðức Chúa Trời ngươi thương mến ngươi.',
        ...
        8: 'con cháu họ sanh về đời thứ ba sẽ được phép vào hội Ðức Giê-hô-va.',
        ...
        14: 'Bởi vì Giê-hô-va Ðức Chúa Trời ngươi đi giữa trại quân ngươi, đặng giải cứu người và phó kẻ thù nghịch cho. Vậy, trại quân ngươi phải thánh, kẻo Giê-hô-va Ðức Chúa Trời ngươi thấy sự ô uế ơ nơi ngươi, và xây mặt khỏi ngươi chăng.',
        ...
        18: 'Mặc dầu sự hứa nguyện ngươi thể nào, chớ đem vào nhà của Giê-hô-va Ðức Chúa Trời ngươi, hoặc tiền công của một con đĩ, hay là giá trả cho một con chó; vì cả hai đều lấy làm gớm ghiếc cho Giê-hô-va Ðức Chúa Trời ngươi.',
        19: 'Ngươi chớ đòi lời-lãi gì nơi anh em mình về tiền bạc, về đồ ăn hay là về món nào mặc dầu người ta cho vay, để ăn lời.',
        20: 'Ngươi được phép lấy lợi người ngoại bang, nhưng chớ lấy lợi anh em mình, để Giê-hô-va Ðức Chúa Trời ngươi ban phước cho ngươi về mọi việc ngươi sẽ làm trong xứ mà ngươi sẽ vào để nhận lấy.',
        21: 'Khi ngươi hứa nguyện cùng Giê-hô-va Ðức Chúa Trời ngươi, thì chớ trì hoãn làm cho xong; vì Giê-hô-va Ðức Chúa Trời ngươi hẳn sẽ đòi sự hoàn nguyện ấy; bằng chẳng làm cho xong, ngươi sẽ mang lấy tội.',
        22: 'Nhưng nếu ngươi không hứa nguyện, thì không phạm tội.',
        23: 'Khi môi ngươi đã hứa cùng Giê-hô-va Ðức Chúa Trời ngươi một sự hứa nguyện lạc ý, thì khá cẩn thận làm trọn lời ra khỏi miệng mình đó.',
        24: 'Khi ngươi vào vườn nho của kẻ lân cận mình, thì có phép ăn nho, tùy theo miệng ăn ngon no nê, song không được bỏ trong giỏ mình.',
    ...
    24: {
        1: 'Khi một người nam cưới vợ, nếu nàng chẳng được ơn trước mặt người, bởi người thấy nơi nàng một sự xấu hổ nào, thì người được viết một tờ để, trao vào tay nàng, đuổi nàng khỏi nhà mình.',
        2: 'Khi nàng đã ra khỏi nhà mình, đi làm vợ một người khác,',
        3: 'nếu người chồng thứ nhì lại ghét nàng, viết cho một tờ để, trao vào tay nàng và đuổi khỏi nhà mình, hay là người chồng thứ nhì nầy chết đi,',
        4: 'thì người chồng thứ nhất là người đã đuổi nàng đi, không được phép lấy nàng lại làm vợ, sau khi nàng bị ô uế. Vì ấy là một việc gớm ghiếc trước mặt Ðức Giê-hô-va; ngươi chớ đổ tội cho xứ mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi làm sản nghiệp.',
        ...
        11: 'phải đứng ở ngoài, người mà mình cho mướn đó, sẽ đem của cầm ra ngoài đưa cho.',
        12: 'Nhược bằng một người nghèo, chớ lấy của cầm người mà đi ngủ.',
        13: 'Khá trả cho người trước khi mặt trời lặn, hầu cho người ngủ có áo xống đáp, và chúc phước cho ngươi; ấy sẽ kể cho ngươi là công bình trước mặt Giê-hô-va Ðức Chúa Trời ngươi.',
        14: 'Ngươi chớ hà hiếp kẻ làm mướn nghèo khổ và túng cùng, bất luận anh em mình hay là khách lạ kiều ngụ trong xứ và trong thành ngươi.',
        ...
        19: 'Khi ngươi gặt trong đồng ruộng, quên một nắm gié lúa ở đó, thì chớ trở lại lấy. Nắm gié ấy sẽ về phần khách lạ, kẻ mồ côi, và người góa bụa, hầu cho Giê-hô-va Ðức Chúa Trời ngươi ban phước cho ngươi trong mọi công việc của tay ngươi làm.',
        20: 'Khi ngươi rung cây ô-li-ve mình, chớ mót những trái sót trên nhánh; ấy sẽ về phần khách lạ, kẻ mồ côi, và người góa bụa.',
        21: 'Khi người hái nho mình, chớ mót chi còn sót lại; ấy sẽ về phần khách lạ, kẻ mồ côi, và người góa bụa.',
    ...
    27: {
        ...
        13: 'còn Ru-bên, Gát, A-se, Sa-bu-lôn, Ðan, và Nép-ta-li phải đứng trên núi Ê-banh, đặng rủa sả.',
    ...
    28: {
        ...
        15: 'Nhưng nếu ngươi không nghe theo tiếng phán của Giê-hô-va Ðức Chúa Trời ngươi, không cẩn thận làm theo các điều răn và luật pháp của Ngài mà ta truyền cho ngươi ngày nay, thì nầy là mọi sự rủa sả sẽ giáng xuống trên mình ngươi và theo kịp ngươi.',
        ...
        35: 'Ðức Giê-hô-va sẽ giáng cho ngươi một thứ ung độc tại trên đầu gối và chân, không thể chữa lành được, từ bàn chân chí chót đầu.',
        ...
        53: 'Trong lúc bị vậy, và khi quân nghịch làm cho túng thế cùng đường, ngươi sẽ ăn hoa quả của thân thể mình, tức là ăn thịt của con trai và con gái mình, mà Giê-hô-va Ðức Chúa Trời ngươi ban cho ngươi.',
    ...
    29: {
        1: 'Nầy là các lời của sự giao ước mà Ðức Giê-hô-va dặn biểu Môi-se lập cùng dân Y-sơ-ra-ên, trong xứ Mô-áp, ngoài sự giao ước Ngài đã lập cùng chúng tại Hô-rếp.',
        2: 'Vậy, Môi-se gọi cả Y-sơ-ra-ên mà nói rằng: Các ngươi đã thấy mọi điều Ðức Giê-hô-va làm trong xứ Ê-díp-tô dưới mắt các ngươi cho Pha-ra-ôn, quần thần và cả xứ người,',
        3: 'tức là những sự thử thách lớn lao, dấu kỳ, phép lạ mà mắt ngươi đã thấy;',
        4: 'nhưng cho đến ngày nay Ðức Giê-hô-va không ban cho các ngươi một tấm lòng để biết, mắt để thấy hay là tai để nghe.',
        5: 'Ta đã dẫn dắt các ngươi bốn mươi năm trong đồng vắng, áo xống không cũ trên mình ngươi, giày không mòn dưới chân ngươi,',
        6: 'các ngươi không có ăn bánh, uống rượu hay là vật chi say, để cho biết rằng ta, Giê-hô-va, là Ðức Chúa Trời của các ngươi.',
        7: 'Khi các ngươi đến chốn nầy, Si-hôn, vua Hết-bôn, và Oùc, vua Ba-san, đi ra đón đặng giao chiến cùng chúng ta; chúng ta có đánh bại họ,',
        8: 'chiếm xứ họ và ban cho chi phái Ru-bên, Gát, và nửa chi phái Ma-na-se, làm sản nghiệp.',
        9: 'Vậy, các ngươi khá gìn giữ làm theo những lời của sự giao ước nầy, hầu cho các ngươi được may mắn trong mọi việc mình làm.',
        10: 'Hết thảy các ngươi, nào trưởng tộc, các chi phái, nào các trưởng lão, nào các quan cai, nào mọi người nam của Y-sơ-ra-ên,',
        11: 'những con trẻ và vợ các ngươi, nào kẻ khách lạ ở trong trại quân ngươi, từ người chặt củi cho đến người xách nước, ngày nay hãy đến chầu trước mặt Giê-hô-va Ðức Chúa Trời ngươi,',
        12: 'đặng vào trong sự giao ước của Giê-hô-va Ðức Chúa Trời ngươi, và vào trong lời thề mà Giê-hô-va Ðức Chúa Trời ngươi lập cùng ngươi ngày nay,',
        13: 'hầu cho ngày nay Ngài lập ngươi lên làm dân của Ngài, và Ngài làm Ðức Chúa Trời ngươi, y như Ngài đã phán cùng ngươi, và thề cùng tổ phụ ngươi, là Áp-ra-ham, Y-sác, và Gia-cốp.',
        14: 'Chẳng phải chỉ với các ngươi mà ta lập giao ước và lời thề nầy thôi;',
        15: 'nhưng lập với người nào ngày nay đứng tại đây cùng chúng ta, trước mặt Giê-hô-va Ðức Chúa Trời chúng ta, luôn với những người nào không có cùng chúng ta trong ngày nay.',
        16: 'Các ngươi biết sự kiều ngụ của chúng ta trong xứ Ê-díp-tô, và chúng ta đi ngang qua các nước là làm sao. Ðang khi đi ngang địa phận chúng nó,',
        17: 'các ngươi đã thấy sự gớm ghiếc của chúng nó, và những tà thần quái gở bằng cây, bằng đá, bằng bạc, và bằng vàng ở nơi chúng nó.',
        18: 'Trong các ngươi, chớ có người nam, người nữ, họ hàng hay là chi phái nào ngày nay trở lòng bỏ Giê-hô-va Ðức Chúa Trời chúng ta, đặng đi hầu việc các thần của những dân tộc ấy; trong các ngươi cũng chớ có rễ sanh ra vật độc và ngải cứu.',
        19: 'Ai nghe các lời của sự thề nầy, chớ có tự khoe nơi lòng rằng: Ta sẽ được bình an, dầu khi ta đi theo sự cứng lòng ta, đến nỗi vật được tưới với vật bị khô, đều cùng hư nát.',
        20: 'Ðức Giê-hô-va không khứng tha tội cho người, nhưng bấy giờ, cơn giận và sự kỵ tà của Ðức Giê-hô-va nổi lên cùng người, và hết thảy sự rủa sả ghi trong sách nầy sẽ chất nặng trên mình người; Ðức Giê-hô-va sẽ xóa tên người khỏi dưới trời,',
        21: 'và biệt ngươi ra khỏi các chi phái Y-sơ-ra-ên, để bị tai họa, chiếu theo hết các lời trù ẻo của giao ước đã ghi trong sách luật pháp nầy.',
        22: 'Ðời sau, con cháu sanh ra sau các ngươi, và người khách ở phương xa đến, khi thấy những tai vạ và chứng bịnh mà Ðức Giê-hô-va đã hành hại xứ nầy,',
        ...
        24: 'thì chúng nó và các nước sẽ hỏi rằng: Sao Ðức Giê-hô-va đãi xứ nầy như thế? Căn cớ của sự thạnh nộ lớn lao nầy là làm sao?',
        25: 'Người ta sẽ đáp rằng: Ấy vì họ bội giao ước mà Giê-hô-va, Ðức Chúa Trời của tổ phụ họ, đã lập cùng họ, khi dẫn họ ra khỏi xứ Ê-díp-tô;',
        26: 'Ấy vì họ đi hầu việc và thờ lạy các thần mà mình chưa hề biết, và Ngài không phân phát cho.',
        27: 'Cơn thạnh nộ của Ðức Giê-hô-va đã nổi phừng lên cùng xứ nầy, đặng giáng trên nó các sự rủa sả ghi trong sách nầy,',
        28: 'và trong cơn thạnh nộ, hờn giận, và nổi nóng, Ðức Giê-hô-va đã rút dân nầy khỏi đất họ, và ném vào một xứ khác, như điều đó hiện có ngày nay.',
        29: 'Những sự bí mật thuộc về Giê-hô-va Ðức Chúa Trời chúng ta; song những sự bày tỏ thuộc về chúng ta, và con cháu chúng ta đời đời, để chúng ta làm theo mọi lời của luật pháp nầy.',
    },
    30: {
        ...
        20: 'thương mến Giê-hô-va Ðức Chúa Trời ngươi, vâng theo tiếng phán Ngài, và tríu mến Ngài; vì Ngài là sự sống ngươi và làm cho ngươi được sống lâu, đặng ngươi ở trên đất mà Ðức Giê-hô-va đã thề ban cho các tổ phụ ngươi, là Áp-ra-ham, Y-sác, và Gia-cốp.',
    },
    31: {
    ...
    33: {
        ...
        20: 'Người chúc về Gát rằng: Ðáng ngợi khen thay Ðấng để Gát nơi quảng-khoát, Người nằm nghỉ như một sư tử cái, Và xé cánh tay cùng đầu.',
        ...
        27: 'Ðức Chúa Trời hằng sống là nơi ở của ngươi, Ở dưới có cánh tay đời đời của Ngài, Ngài đuổi kẻ thù nghịch khỏi trước mặt ngươi, Và phán cùng ngươi rằng: Hãy diệt đi!',
    ...
    34: {
        1: 'Kế ấy, Môi-se từ đồng bằng Mô-áp lên trên núi Nê-bô, nơi đỉnh Phích-ga, đối ngang Giê-ri-cô, rồi Ðức Giê-hô-va cho người xem toàn xứ, từ Ga-la-át chí Ðan;',
        ...
        4: 'Ðức Giê-hô-va phán cùng người rằng: Ðó là xứ mà ta đã thề ban cho Áp-ra-ham, Y-sác và Gia-cốp, mà rằng: Ta sẽ ban xứ ấy cho dòng giống ngươi. Ta cho tự mắt ngươi xem xứ ấy, nhưng ngươi không vào đó được.',
        5: 'Môi-se, tôi tớ của Ðức Giê-hô-va, qua đời tại đó, trong đồng bằng Mô-áp, theo như lịnh của Ðức Giê-hô-va.',
        6: 'Ðức Chúa Trời bèn chôn người trong trũng tại xứ Mô-áp, đối ngang Bết-Phê -o; cho đến ngày nay không có ai biết được mộ của người.',
        7: 'Vả, khi Môi-se qua đời, tuổi được một trăm hai mươi; mắt người không làng, sức người không giảm.',
        8: 'Dân Y-sơ-ra-ên khóc Môi-se trong ba mươi ngày tại đồng bằng Mô-áp. Những ngày khóc và ngày chịu tang cho Môi-se đã xong rồi là như vậy.',
        9: 'Giô-suê, con trai của Nun, được đầy dẫy thần khôn ngoan, vì Môi-se đã đặt tay mình trên người; dân Y-sơ-ra-ên bèn vâng lời người và làm theo điều Ðức Giê-hô-va đã phán dặn Môi-se.',
        10: 'Về sau, trong Y-sơ-ra-ên không còn dấy lên tiên tri nào giống như Môi-se, mà Ðức Giê-hô-va biết giáp mặt.',
        11: 'Không có ai bằng người, hoặc về các dấu kỳ, phép lạ mà Ðức Giê-hô-va sai người làm tại trong xứ Ê-díp-tô, trước mặt Pha-ra-ôn, các quần thần, và cả xứ của người;',
        12: 'hoặc hết thảy công việc lớn lao và đáng sợ mà Môi-se cậy tay quyền năng mình làm tại trước mặt cả Y-sơ-ra-ên.',
    },
}
