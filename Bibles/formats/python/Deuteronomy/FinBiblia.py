...
CHAPTERS = {
    ...
    3: {
        ...
        13: 'Mutta mitä Gileadista jäi ja koko Basanin Ogin valtakunnan annoin minä puolelle Manassen sukukunnalle, kaiken Argobin maakunnan, koko Basanin kanssa, joka kutsutaan Refalaisten maaksi.',
        ...
        20: 'Siihenasti että Herra teidän veljennekin saattaa lepoon, niinkuin teidätkin, että hekin omistaisivat sen maan, jonka Herra teidän Jumalanne heille antava on tuolla puolella Jordania: sitte te palajatte kukin omaisuuteenne, jonka minä teille antanut olen.',
    ...
    4: {
        ...
        2: 'Ei teidän pidä mitään lisäämän siihen sanaan minkä minä teille käsken, eikä pidä myös teidän mitään siitä ottaman pois, kätkeäksenne Herran teidän Jumalanne käskyjä, jotka minä teille käsken.',
        ...
        6: 'Niin pitäkäät siis ja tehkäät ne; sillä tämä on teidän ymmärryksenne ja toimellisuutenne kaikkein kansain edessä, koska he kuulevat nämät käskyt, niin he sanovat: tämä suuri kansa ainoastaan on toimellinen ja kuuluisa kansa.',
    ...
    6: {
        ...
        22: 'Ja Herra teki suuria ja pahoja tunnustähtejä, ja ilmeitä Egyptille, Pharaolle, ja kaikelle hänen huoneellensa, meidän silmäimme edessä.',
    ...
    7: {
        1: 'Kuin Herra sinun Jumalas vie sinun siihen maahan, johon sinä tulet omistamaan sitä, ja ajaa paljon kansaa ulos sinun edestäs: Hetiläiset, Girgasilaiset, Amorilaiset, Kanaanilaiset, Pheresiläiset, Heviläisetja Jebusilaiset, seitsemän kansaa, jotka sinua suuremmat ja väkevämmät ovat;',
        ...
        3: 'Ja ei sinun pidä heimolaisuuteen antaman sinuas heidän kanssansa: sinun tyttäriäs ei sinun pidä antaman heidän pojillensa, ja heidän tyttäriänsä ei pidä sinun ottaman pojilles.',
        4: 'Sillä he viettelevät sinun poikas minun tyköäni, palvelemaan muukalaisia jumalia; niin julmistuu Herran viha teidän päällenne ja nopiasti hukuttaa teidät.',
        5: 'Mutta näin pitää teidän tekemän heille: heidän alttarinsa pitää teidän kukistaman ja heidän patsaansa rikkoman, niin myös heidän metsistönsä hakkaaman, ja heidän epäjumalansa kuvat tulella polttaman.',
        6: 'Sillä sinä olet pyhä kansa Herralle sinun Jumalalles: sinun on Herra sinun Jumalas valinnut omaksi kansaksensa kaikista kansoista, jotka asuvat maan päällä.',
        7: 'Ei ole Herra mielistynyt teihin ja valinnut teitä sentähden, että teidän lukunne on suurempi kuin kaikkein muiden kansain; sillä sinä olet vähin kaikista kansoista.',
        8: 'Mutta että Herra rakasti teitä ja pitää valansa, jonka hän vannoi teidän isillenne, johdatti hän teidät ulos väkevällä kädellä ja vapahti teidät orjuuden huoneesta, Pharaon Egyptin kuninkaan kädestä.',
        9: 'Niin sinun pitää tietämän, että Herra sinun Jumalas on Jumala, uskollinen Jumala, pitäväinen liiton ja laupiuden niiden kanssa, jotka häntä rakastavat ja pitävät hänen käskynsä, tuhanteen polveen,',
        10: 'Ja kostaa niille, jotka häntä vihaavat, kasvoinsa edessä, niin että hän hukuttaa heitä, ja ei viivy kostamasta niille kasvoinsa edessä, jotka häntä vihaavat.',
        11: 'Niin pidä ne käskyt, säädyt ja oikeudet, jotka minä sinulle käsken tänäpänä tehdäkses niitä.',
        12: 'Ja kuin te nämät oikeudet kuulette, ja pidätte, ja teette ne, niin myös Herra sinun Jumalas pitää sinulle sen liiton ja laupiuden, jonka hän vannoi sinun isilles,',
        13: 'Ja rakastaa sinua, ja siunaa sinun, ja enentää sinun, ja siunaa sinun ruumiis hedelmän, ja sinun maas hedelmän, sinun jyväs, viinas ja öljys, sikiät karjastas, ja laumat lampaistas, siinä maassa, jonka hän sinun isilles vannoi sinulle antaaksensa.',
        14: 'Sinun pitää oleman siunatun kaikista kansoista. Ei yksikään hedelmätöin pidä sinun seassas oleman, eikä karjas seassa.',
        15: 'Ja Herra ottaa sinulta pois kaikki sairaudet: ei hän yhtäkään Egyptin pahaa tautia, jotka sinä tiedät, pane sinun päälles; mutta heittää ne kaikkein niiden päälle, jotka sinua vihaavat.',
        16: 'Sinun pitää nielemän kaikki ne kansat, jotka Herra sinun Jumalas sinulle antava on: ei sinun silmäs pidä säästämän heitä, eikä sinun pidä palveleman heidän jumaliansa; sillä se tulis sinulle paulaksi.',
        17: 'Jos sinä sanot sydämessäs: nämät kansat ovat usiammat kuin minä; kuinka taidan minä heidät ajaa ulos?',
        18: 'Niin älä pelkää heitä: muista visusti, mitä Herra sinun Jumalas teki Pharaolle ja kaikille Egyptiläisille,',
        19: 'Ja ne suuret kiusaukset, jotka silmät nähneet ovat, ja tunnustähdet ja ihmeet, ja väkevä käsi, ja ojettu käsivarsi, jolla Herra sinun Jumalas johdatti sinun. Niin Herra sinun Jumalas tekee kaikille niille kansoille, joita sinä pelkäät.',
        20: 'Niin myös Herra sinun Jumalas lähettää heidän sekaansa hörhöläiset siihen asti että kaikki hukutetaan, jotka jääneet ja heitänsä lymyttäneet ovat sinun edestäs.',
        21: 'Älä hämmästy heidän edessänsä; sillä Herra sinun Jumalas on sinun keskelläs, suuri ja peljättävä Jumala.',
        22: 'Ja Herra sinun Jumalas karkottaa nämät kansat sinun edestäs, vähitellen toisen toisensa jälkeen: et sinä saa äkisti hukuttaa heitä, ettei metsän pedot lisääntyisi sinua vastaan maan päällä.',
        23: 'Ja Herra sinun Jumalas antaa heitä sinun etees, ja häiritsee heitä suurella sekaseuraisuudella, siihenasti että hän hukuttaa heidät.',
        24: 'Ja antaa heidän kuninkaansa sinun käsiis, ja sinun pitää hukuttaman heidän nimensä taivaan alta: ei pidä yhdenkään seisoman sinua vastaan siihenasti ettäs heidät hukutat.',
        25: 'Heidän epäjumalainsa kuvat pitää sinun tulella polttaman: ei sinun pidä himoitseman sitä hopiaa ja kultaa, joka niiden päällä on ollut, taikka ottaman siitä jotain sinulles, ettei se olisi sinulle paulaksi; sillä se on Herralle sinun Jumalalles kauhistus.',
        26: 'Sentähden ei sinun pidä sitä kauhistusta huoneeses viemän, ettei tulisi kirotuksi niinkuin se, mutta sinun pitää ilvoituksella ilvoittaman ja kauhistuksella kauhistuman sitä; sillä se on kirottu.',
    },
    8: {
    ...
    11: {
        ...
        24: 'Kaikki paikat, mihin teidän jalkanne astuu, pitää teidän oleman: korvesta ja Libanonista ja Phrathin virrasta, äärimäiseen mereen asti, pitää teidän rajanne oleman.',
    ...
    12: {
        ...
        10: 'Vaan teidän pitää menemän Jordanin yli, ja asuman siinä maassa, jonka Herra teidän Jumalanne antaa teidän periä: ja hän antaa teille levon kaikilta vihamiehiltänne ympäriltänne, teidän pitää myös turvallisesti asuman.',
        ...
        27: 'Ja tee siellä lihasta ja verestä polttouhris, Herran sinun Jumalas alttarilla; mutta uhris veri kaada Herran sinun Jumalas alttarille, ja syö liha.',
    ...
    13: {
        1: 'Jos propheta eli unennäkiä nousee teidän seassanne, ja antaa teille merkin eli ihmeen,',
        ...
        6: 'Jos veljes, äitis poika, eli sinun poikas, eli tyttäres, eli emäntäs, joka sinun sylissäs on, eli ystäväs, joka on kuin oma sydämes, viettelis sinua salaa, ja sanois: käykäämme ja palvelkaamme muita jumalia, joita et sinä tunne eikä sinun isäskään,',
        7: 'Kansain jumalia teidän ympäristöllänne, joko he läsnä eli kaukana ovat, yhdestä maan äärestä niin toiseen;',
        8: 'Niin älä siihen mielisty, älä myös ole hänelle kuuliainen, ja ei sinun silmäs pidä säästämän häntä: ei ensinkään pidä sinun armaitseman eli salaaman häntä.',
        9: 'Mutta sinun pitää kaiketikin surmaaman hänen, sinun kätes pitää ensin hänen päällensä oleman, että hän surmattaisiin, ja sen perästä kaiken kansan käsi.',
        10: 'Hän pitää kivillä surmattaman, ja hänen pitää kuoleman, sillä hän ahkeroitsi luovuttaa sinua Herrasta sinun Jumalastas, joka sinun Egyptin maalta, orjuuden huoneesta on johdattanut ulos,',
        11: 'Että koko Israel sen kuulis ja pelkäis, eikä silleen sen muotoista pahuutta teidän seassanne tekisi.',
        12: 'Jos saat kuulla jossakussa kaupungissas, jonka Herra sinun Jumalas sinulle antaa asuakses, sanottavan:',
        13: 'Muutamat Belialin lapset ovat lähteneet sinun seastas, ja kääntäneet kaupunkinsa asujat pois, ja sanoneet: käykäämme ja palvelkaamme muita jumalia, joita ette tunne,',
        14: 'Niin pitää sinun etsimän, tutkiman, ja kyselemän visusti, ja jos todeksi löydetään, että se niin on tosi, että se kauhistus teidän seassanne tapahtunut on;',
        15: 'Niin pitää sinun lyömän sen kaupungin asujat miekan terällä, ja hukuttaman heitä, ja kaikki mitä ikänä siinä on, ja heidän karjansa miekan terällä.',
        16: 'Ja kaikki hänen saaliinsa pitää sinun kokooman keskelle sen katua, ja polttaman tulessa, sekä kaupungin että kaikki hänen saaliinsa, Herralle sinun Jumalalles, että se autiona pysyy ijankaikkisesti, ja ei ikänä enään pidä rakettaman.',
        17: 'Ja älä mitään sinun käsiis jätä siitä kirotusta, että Herra kääntyis vihansa julmuudesta, ja antais sinulle laupiuden, ja armahtais sinun päälles, ja enentäis sinun, niinkuin hän vannoi sinun isilles,',
        18: 'Että sinä Herran sinun Jumalas äänelle kuuliainen ollut olet, ja pitänyt kaikki hänen käskynsä, jotka minä sinulle tänäpänä käsken, oikein tehdäkses Herran sinun Jumalas silmäin edessä.',
    },
    14: {
    ...
    18: {
        ...
        8: 'Ja heidän pitää yhden verran osaa saaman syödäksensä, paitsi sitä mitä hänellä on vanhempainsa myydystä hyvyydestä.',
        ...
        20: 'Mutta jos joku propheta ylpeydestä puhuu minun nimeeni sitä mitä en minä hänen käskenyt puhua, ja se joka puhuu muiden jumalain nimeen, sen prophetan pitää kuoleman.',
    ...
    19: {
        ...
        10: 'Ettei viatointa verta vuodatettaisi sinun maassas, jonka Herra sinun Jumalas sinulle antaa perinnöksi, ja veren vika tulisi sinun päälles.',
    ...
    21: {
        ...
        3: 'Joka kaupunki tapettua lähin on, sen vanhimmat ottakaan nuoren lehmän karjasta, jolla ei ole työtä tehty ja joka ei ikeen alla ole ollut,',
    ...
    22: {
        ...
        14: 'Ja soimaa häntä johonkuhun häpiään vikapääksi, ja saattaa hänestä pahan sanoman, sanoen: minä otin tämän emännäkseni, ja menin hänen tykönsä, ja löysin, ettei hän ollut neitsyt;',
    ...
    30: {
        ...
        6: 'Ja Herra sinun Jumalas ympärileikkaa sinun sydämes ja siemenes sydämen, rakastamaan Herraa sinun Jumalaas kaikesta sydämestäs ja kaikesta sielustas, ettäs eläisit.',
    ...
    31: {
        ...
        17: 'Niin minun vihani silloin julmistuu heidän päällensä, ja minä hylkään heitä ja peitän kasvoni heidän edestänsä, että he hukutetaan, ja paljo pahuutta ja ahdistusta käy heidän päällensä; ja he sanovat sinä päivänä: eikö nämät pahuudet ole tapahtuneet minulle, ettei minun Jumalani ole minun kanssani?',
