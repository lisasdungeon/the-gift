...
CHAPTERS = {
    1: {
        ...
        11: 'Que l’ Éternel, le Dieu de vos pères, ajoute à votre nombre 1 000 fois ce que vous êtes, et vous bénisse, comme il vous l’a dit!',
        ...
        14: 'Et vous m’avez répondu et avez dit: La chose que tu as dit de faire est bonne.',
        ...
        19: 'Et nous sommes partis d’Horeb, et nous avons traversé tout ce grand et terrible désert que vous avez vu, le chemin de la montagne des Amoréens, comme l’ Éternel, notre Dieu, nous l’avait commandé, et nous sommes venus jusqu’à Kadès-Barnéa.',
        20: 'Et je vous dis: Vous êtes arrivés jusqu’à la montagne des Amoréens, laquelle l’ Éternel, notre Dieu, nous donne.',
        21: 'Regarde, l’ Éternel, ton Dieu, a mis devant toi le pays: monte, prends possession, comme l’ Éternel, le Dieu de tes pères, te l’a dit; ne crains point et ne t’effraie point.',
        22: 'Et vous vous êtes tous approchés de moi, et vous avez dit: Envoyons des hommes devant nous, et ils examineront le pays pour nous, et ils nous rapporteront des nouvelles du chemin par lequel nous pourrons monter et des villes auxquelles nous viendrons.',
        ...
        26: 'Mais vous n’avez pas voulu monter, et vous avez été rebelles au commandement de l’ Éternel, votre Dieu.',
        27: 'Et vous avez murmuré dans vos tentes et vous avez dit: C’est parce que l’ Éternel nous hait, qu’il nous a fait sortir du pays d’Égypte, afin de nous livrer aux mains des Amoréens, pour nous détruire.',
        ...
        32: 'Mais, dans cette circonstance, vous n’avez point cru l’ Éternel, votre Dieu,',
        ...
        41: '– Et vous avez répondu et m’avez dit: Nous avons péché contre l’ Éternel; nous monterons, et nous combattrons, selon tout ce que l’ Éternel, notre Dieu, nous a commandé. Et vous avez ceint chacun ses armes de guerre, et légèrement vous avez entrepris de monter dans la montagne.',
        ...
        43: 'Et je vous parlai; mais vous n’avez point écouté, et vous avez été rebelles au commandement de l’ Éternel, et vous avez été présomptueux, et êtes montés dans la montagne.',
        ...
        45: 'Et à votre retour vous avez pleuré devant l’ Éternel; et l’ Éternel n’écouta point votre voix et ne vous prêta point l’oreille.',
        46: 'Et vous avez demeuré à Kadès plusieurs jours, selon les jours que vous y avez habité.',
    },
    2: {
        1: 'Et nous nous sommes tournés, et nous sommes partis pour le désert, par le chemin de la mer Rouge, comme l’ Éternel m’avait dit, et nous avons tourné autour de la montagne de Séhir, plusieurs jours.',
        ...
        7: 'Car l’ Éternel, ton Dieu, t’a béni dans toute l’œuvre de ta main; il a connu ta marche par ce grand désert; pendant ces 40 ans, l’ Éternel, ton Dieu, a été avec toi; tu n’as manqué de rien.',
        8: 'Et nous avons laissé nos frères, les fils d’Ésaü, qui habitent en Séhir, passant devant la plaine, devant Élath et Étsion-Guéber, et nous nous sommes tournés, et nous avons passé par le chemin du désert de Moab.',
        ...
        14: 'Et les jours que nous avons marché depuis Kadès-Barnéa jusqu’à ce que nous ayons passé le torrent de Zéred, ont été 38 ans, jusqu’à ce que toute la génération des hommes de guerre ait péri du milieu du camp, comme l’ Éternel le leur avait juré.',
        ...
        33: 'Et l’ Éternel, notre Dieu, le livra devant nous; et nous l’avons battu, lui, et ses fils, et tout son peuple;',
        34: 'et nous avons pris toutes ses villes, en ce temps-là, et nous avons détruit entièrement toutes les villes, hommes, et femmes, et enfants; nous n’avons pas laissé un réchappé;',
        35: 'seulement, nous avons pillé pour nous les bêtes et le butin des villes que nous avions prises.',
        36: 'Depuis Aroër, qui est sur le bord du torrent de l’Arnon, et la ville qui est dans le torrent, jusqu’à Galaad, il n’y eut pas de ville qui soit trop haute pour nous; l’ Éternel, notre Dieu, livra tout devant nous.',
    ...
    3: {
        1: 'Et nous nous sommes tournés, et nous sommes montés par le chemin de Basan; et Og, le roi de Basan, sortit à notre rencontre, lui et tout son peuple, à Édréhi, pour livrer bataille.',
        ...
        3: '– Et l’ Éternel, notre Dieu, livra aussi en notre main Og, le roi de Basan, et tout son peuple; et nous l’avons battu jusqu’à ne pas lui laisser un réchappé.',
        4: 'Et nous avons pris toutes ses villes, en ce temps-là; il n’y eut point de ville que nous ne leur ayons prise: 60 villes, toute la région d’Argob, le royaume d’Og, en Basan;',
        ...
        6: 'et nous les avons entièrement détruites, comme nous avions fait à Sihon, roi de Hesbon, détruisant toutes les villes, hommes, femmes, et enfants.',
        7: 'Et nous avons pillé pour nous toutes les bêtes, et le butin des villes.',
        8: 'Et nous avons pris en ce temps-là, de la main des deux rois des Amoréens, le pays qui était en deçà du Jourdain, depuis le torrent de l’Arnon jusqu’à la montagne de l’Hermon;',
        ...
        12: 'Et nous avons pris possession de ce pays-là, en ce même temps. Depuis Aroër, qui est sur le torrent de l’Arnon, la moitié de la montagne de Galaad, et ses villes, je les donnai aux Rubénites et aux Gadites;',
        ...
        29: 'Et nous avons habité dans la vallée, vis-à-vis de Beth-Péor.',
    },
    4: {
        ...
        11: 'alors vous vous êtes approchés et vous vous êtes tenus au bas de la montagne (et la montagne était brûlante de feu jusqu’au cœur des cieux,… ténèbres, nuées, et profonde obscurité),',
        12: 'et l’ Éternel vous parla du milieu du feu; vous entendiez la voix de [ses] paroles, mais vous n’avez vu aucune forme, seulement [vous entendiez] une voix.',
        ...
        35: 'Cela t’a été montré, afin que tu connaisses que l’ Éternel est Dieu, et qu’il n’y en a point d’autre que lui.',
        ...
        42: 'afin que l’homicide qui aurait tué son prochain sans le savoir, et qui ne l’aurait pas haï auparavant, s’y enfuie, et que, s’enfuyant dans l’une de ces villes-là, il vive:',
    ...
    7: {
        ...
        9: 'Connais donc que c’est l’ Éternel, ton Dieu, qui est Dieu, le ✶Dieu fidèle, qui garde l’alliance et la bonté jusqu’à 1 000 générations à ceux qui l’aiment et qui gardent ses commandements,',
    ...
    8: {
        ...
        2: 'Et tu te souviendras de tout le chemin par lequel l’ Éternel, ton Dieu, t’a fait marcher ces 40 ans, dans le désert, afin de t’humilier, [et] de t’éprouver, pour connaître ce qui était dans ton cœur, si tu garderais ses commandements, ou non.',
        ...
        4: 'Ton vêtement ne s’est point usé sur toi, et ton pied ne s’est point enflé, pendant ces 40 ans.',
    ...
    9: {
        ...
        9: 'quand je montai sur la montagne pour recevoir les tables de pierre, les tables de l’alliance que l’ Éternel avait faite avec vous, je demeurai sur la montagne 40 jours et 40 nuits; je ne mangeai point de pain, et je ne bus point d’eau;',
        ...
        11: 'et il arriva, au bout de 40 jours et de 40 nuits, que l’ Éternel me donna les deux tables de pierre, les tables de l’alliance;',
        ...
        18: 'Et je me prosternai devant l’ Éternel, comme au commencement, 40 jours et 40 nuits; je ne mangeai point de pain et je ne bus point d’eau, à cause de tout votre péché que vous aviez commis, en faisant ce qui est mauvais aux yeux de l’ Éternel, afin de le provoquer à colère;',
        ...
        21: 'et je pris votre péché, le veau que vous aviez fait, et je le brûlai au feu, et je le pilai, je le moulus bien, jusqu’à ce qu’il soit réduit en poudre, et j’en jetai la poudre dans le torrent qui descendait de la montagne.',
        22: 'Et à Tabhéra, et à Massa, et à Kibroth-Hattaava, vous avez excité à colère l’ Éternel.',
        23: 'Et lorsque l’ Éternel vous envoya de Kadès-Barnéa, en disant: Montez, et possédez le pays que je vous ai donné, vous avez été rebelles au commandement de l’ Éternel, votre Dieu, et vous ne l’avez point cru, et vous n’avez pas écouté sa voix.',
        24: 'Vous avez été rebelles à l’ Éternel depuis le jour où je vous ai connus.',
        25: 'Et je me prosternai devant l’ Éternel, les 40 jours et les 40 nuits pendant lesquels je me prosternai [devant lui]; car l’ Éternel avait dit qu’il vous détruirait.',
    ...
    10: {
        ...
        10: 'Et moi, je me tins sur la montagne comme les jours précédents, 40 jours et 40 nuits; et l’ Éternel m’écouta aussi cette fois-là: l’ Éternel ne voulut pas te détruire.',
        ...
        22: 'Tes pères sont descendus en Égypte au nombre de 70 âmes; et maintenant l’ Éternel, ton Dieu, t’a fait devenir comme les étoiles des cieux, en multitude.',
    },
    11: {
    ...
    13: {
        ...
        2: 'S’il s’élève au milieu de toi un prophète, ou un songeur de songes, et qu’il te donne un signe ou un miracle,',
        3: 'et que le signe arrive, ou le miracle dont il t’avait parlé lorsqu’il disait: Allons après d’autres dieux, [des dieux] que tu n’as point connus, et servons-les;',
        4: 'tu n’écouteras pas les paroles de ce prophète, ni ce songeur de songes, car l’ Éternel, votre Dieu, vous éprouve, pour savoir si vous aimez l’ Éternel, votre Dieu, de tout votre cœur et de toute votre âme.',
        ...
        7: 'Si ton frère, fils de ta mère, ou ton fils, ou ta fille, ou la femme de ton cœur, ou ton ami, qui t’est comme ton âme, t’incite en secret, disant: Allons, et servons d’autres dieux, [des dieux] que tu n’as point connus, toi, ni tes pères,',
        8: 'd’entre les dieux des peuples qui sont autour de vous, près de toi ou loin de toi, d’un bout de la terre à l’autre bout de la terre,',
        9: 'tu ne t’accorderas pas avec lui et tu ne l’écouteras pas; et ton œil ne l’épargnera pas, et tu n’auras pas pitié de lui, et tu ne le cacheras pas;',
        ...
        11: 'et tu l’assommeras de pierres, et il mourra, car il a cherché à t’entraîner loin de l’ Éternel, ton Dieu, qui t’a fait sortir du pays d’Égypte, de la maison de servitude;',
        12: 'et tout Israël l’entendra et craindra, et ne fera plus une pareille méchante action au milieu de toi.',
        13: 'Si, dans l’une de tes villes que l’ Éternel, ton Dieu, te donne pour y habiter, tu entends dire:',
        14: 'Des hommes, fils de Bélial, sont sortis du milieu de toi, et ont incité les habitants de leur ville, disant: Allons, et servons d’autres dieux, [des dieux] que vous n’avez pas connus;',
        15: 'alors tu rechercheras, et tu t’informeras, et tu t’enquerras bien; et si c’est la vérité, si la chose est établie, si cette abomination a été commise au milieu de toi,',
        ...
        17: 'Et tout son butin, tu le rassembleras au milieu de sa place, et tu brûleras tout entiers au feu la ville et tout son butin, à l’ Éternel, ton Dieu; et elle sera un monceau perpétuel, elle ne sera plus rebâtie.',
        18: 'Et il ne s’attachera rien de cet anathème à ta main, afin que l’ Éternel revienne de l’ardeur de sa colère, et qu’il te fasse miséricorde, et ait compassion de toi, et qu’il te multiplie, comme il a juré à tes pères,',
    ...
    17: {
        ...
        14: 'Quand tu seras entré dans le pays que l’ Éternel, ton Dieu, te donne, et que tu le posséderas et y habiteras, et que tu diras: J’établirai un roi sur moi, comme toutes les nations qui sont autour de moi:',
    ...
    22: {
        ...
        19: 'Et parce qu’il aura fait courir un mauvais bruit sur une vierge d’Israël, ils lui feront payer une amende de 100 pièces d’argent, et ils les donneront au père de la jeune femme; et elle restera sa femme, et il ne pourra pas la renvoyer, tous ses jours.',
    ...
    23: {
        1: 'Un homme ne prendra pas la femme de son père, et ne relèvera pas le pan du vêtement de son père.',
        2: 'Celui qui est eunuque, soit pour avoir été froissé, soit pour avoir été taillé, n’entrera point dans la congrégation de l’ Éternel.',
        3: 'L’enfant illégitime n’entrera pas dans la congrégation de l’ Éternel; même sa dixième génération n’entrera pas dans la congrégation de l’ Éternel.',
        4: 'L’Ammonite et le Moabite n’entreront pas dans la congrégation de l’ Éternel; même leur dixième génération n’entrera pas dans la congrégation de l’ Éternel, à jamais;',
        5: 'parce qu’ils ne sont pas venus à votre rencontre avec du pain et de l’eau dans le chemin, lorsque vous sortiez d’Égypte, et parce qu’ils ont loué [à prix d’argent] contre toi, Balaam, fils de Béor, de Pethor, en Mésopotamie, pour te maudire.',
        ...
        8: '– Tu n’auras pas en abomination l’Édomite, car il est ton frère; tu n’auras pas en abomination l’Égyptien, car tu as séjourné comme étranger dans son pays.',
        9: 'Les fils qui leur naîtront, à la troisième génération, entreront dans la congrégation de l’ Éternel.',
        10: 'Lorsque le camp sortira contre tes ennemis, garde-toi de toute chose mauvaise.',
        11: 'S’il y a parmi toi un homme qui ne soit pas pur, pour quelque accident de nuit, il sortira hors du camp; il n’entrera pas dans l’intérieur du camp;',
        12: 'et sur le soir il se lavera dans l’eau; et au coucher du soleil il entrera dans l’intérieur du camp.',
        13: 'Et tu auras un endroit hors du camp, et tu sortiras là dehors;',
        14: 'et tu auras, outre tes armes, un pieu; et il arrivera, quand tu t’assiéras dehors, que tu creuseras avec ce [pieu], et tu te retourneras, et tu couvriras ce qui est sorti de toi.',
        15: 'Car l’ Éternel, ton Dieu, marche au milieu de ton camp pour te délivrer et pour livrer tes ennemis devant toi; et ton camp sera saint, afin qu’il ne voie parmi toi rien de malséant, et qu’il ne se détourne d’avec toi.',
        16: 'Tu ne livreras point à son maître le serviteur qui se sera sauvé chez toi d’auprès de son maître;',
        17: 'il habitera avec toi, au milieu de toi, dans le lieu qu’il choisira en l’une de tes portes, là où bon lui semble: tu ne l’opprimeras pas.',
        18: 'Il n’y aura, d’entre les filles d’Israël, aucune femme vouée à la prostitution, et il n’y aura, d’entre les fils d’Israël, aucun homme voué à la prostitution.',
        19: 'Tu n’apporteras point dans la maison de l’ Éternel, ton Dieu, pour aucun vœu, le salaire d’une prostituée, ni le prix d’un chien; car ils sont tous les deux en abomination à l’ Éternel, ton Dieu.',
        20: 'Tu ne prendras pas d’intérêt de ton frère, intérêt d’argent, intérêt de vivres, intérêt de quelque chose que ce soit qu’on prête à intérêt.',
        21: 'Tu prendras un intérêt de l’étranger, mais de ton frère tu ne prendras pas d’intérêt; afin que l’ Éternel, ton Dieu, te bénisse en tout ce à quoi tu mets la main, dans le pays où tu entres pour le posséder.',
        22: 'Quand tu voueras un vœu à l’ Éternel, ton Dieu, tu ne tarderas pas à l’acquitter; car l’ Éternel, ton Dieu, le redemandera certainement de ta part, et il y aura du péché sur toi;',
        23: 'mais si tu t’abstiens de faire un vœu, il n’y aura pas du péché sur toi.',
        24: 'Ce qui sera sorti de tes lèvres, l’offrande volontaire que tu auras promise de ta bouche, tu prendras garde à le faire, comme tu auras voué à l’ Éternel, ton Dieu.',
        25: 'Si tu entres dans la vigne de ton prochain, tu pourras manger des raisins selon ton appétit et te rassasier; mais tu n’en mettras pas dans ta corbeille.',
        26: 'Si tu entres dans les blés de ton prochain, tu pourras arracher des épis avec ta main; mais tu ne lèveras pas la faucille sur les blés de ton prochain.',
    },
    24: {
    ...
    25: {
        ...
        3: 'Il le fera battre de 40 [coups], sans les dépasser, de peur que s’il continuait à le battre de beaucoup de coups outre ceux-là, ton frère ne soit méprisable à tes yeux.',
    ...
    26: {
        ...
        7: 'et nous avons crié à l’ Éternel, le Dieu de nos pères, et l’ Éternel entendit notre cri, et vit notre humiliation, et notre labeur, et notre oppression;',
    ...
    28: {
        ...
        26: 'et tes cadavres seront en pâture à tous les oiseaux des cieux et aux bêtes de la terre, et il n’y aura personne qui les effraie.',
    ...
    29: {
        1: '*Et Moïse appela tout Israël, et leur dit: Vous avez vu tout ce que l’ Éternel a fait devant vos yeux dans le pays d’Égypte, au Pharaon, et à tous ses serviteurs, et à tout son pays:',
        2: 'les grandes épreuves que tes yeux ont vues, ces signes et ces grands prodiges.',
        3: 'Mais l’ Éternel ne vous a pas donné un cœur pour connaître, ni des yeux pour voir, ni des oreilles pour entendre, jusqu’à ce jour.',
        4: 'Et je vous ai conduits 40 ans par le désert: vos vêtements ne se sont pas usés sur vous, et ta sandale ne s’est pas usée à ton pied.',
        5: 'Vous n’avez pas mangé de pain, et vous n’avez bu ni vin ni boisson forte, afin que vous connaissiez que moi, l’ Éternel, je suis votre Dieu.',
        6: 'Et vous êtes parvenus en ce lieu-ci; et Sihon, roi de Hesbon, et Og, le roi de Basan, sortirent à notre rencontre pour nous livrer bataille, et nous les avons battus;',
        ...
        9: 'Vous vous tenez tous aujourd’hui devant l’ Éternel, votre Dieu, vos chefs, vos tribus, vos anciens, et vos magistrats, tout homme d’Israël,',
        ...
        11: 'afin que tu entres dans l’alliance de l’ Éternel, ton Dieu, et dans son serment, que l’ Éternel, ton Dieu, fait aujourd’hui avec toi;',
        ...
        15: '(car vous savez comment nous avons habité dans le pays d’Égypte, et comment nous avons passé à travers les nations que vous avez traversées;',
        16: 'et vous avez vu leurs abominations, et leurs idoles, du bois et de la pierre, de l’argent et de l’or, qui sont parmi eux);',
        17: 'de peur qu’il n’y ait parmi vous homme, ou femme, ou famille, ou tribu, dont le cœur se détourne aujourd’hui d’avec l’ Éternel, notre Dieu, pour aller servir les dieux de ces nations; de peur qu’il n’y ait parmi vous une racine qui produise du poison et de l’absinthe,',
        18: 'et qu’il n’arrive que quelqu’un, en entendant les paroles de ce serment, ne se bénisse dans son cœur, disant: J’aurai la paix, lors même que je marcherai dans l’obstination de mon cœur, afin de détruire ce qui est arrosé, et ce qui est altéré.',
        19: 'L’ Éternel ne voudra pas lui pardonner, mais la colère de l’ Éternel et sa jalousie fumeront alors contre cet homme; et toute la malédiction qui est écrite dans ce livre reposera sur lui; et l’ Éternel effacera son nom de dessous les cieux;',
        20: 'et l’ Éternel le séparera de toutes les tribus d’Israël pour le malheur, selon toutes les malédictions de l’alliance qui est écrite dans ce livre de la loi.',
        21: 'Et la génération à venir, vos fils qui se lèveront après vous, et l’étranger qui viendra d’un pays éloigné, diront, lorsqu’ils verront les plaies de ce pays, et ses maladies, dont l’ Éternel l’aura affligé;',
        22: '[et] que tout son sol n’est que soufre et sel, – un embrasement (qu’il n’est pas semé, et qu’il ne fait rien germer, et qu’aucune herbe n’y pousse), comme la subversion de Sodome et de Gomorrhe, d’Adma et de Tseboïm, que l’ Éternel détruisit dans sa colère et dans sa fureur, –',
        23: 'toutes les nations diront: Pourquoi l’ Éternel a-t-il fait ainsi à ce pays? d’où vient l’ardeur de cette grande colère?',
        ...
        25: 'et ils sont allés, et ont servi d’autres dieux, et se sont prosternés devant eux, des dieux qu’ils n’avaient pas connus et qu’il ne leur avait pas donnés en partage.',
        26: 'Et la colère de l’ Éternel s’est embrasée contre ce pays, pour faire venir sur lui toute la malédiction écrite dans ce livre.',
        27: 'Et l’ Éternel les a arrachés de dessus leur terre dans [sa] colère, et dans [sa] fureur, et dans [sa] grande indignation, et les a chassés dans un autre pays, comme [il paraît] aujourd’hui.',
        28: 'Les choses cachées sont à l’ Éternel, notre Dieu; et les choses révélées sont à nous et à nos fils, à toujours, afin que nous pratiquions toutes les paroles de cette loi.',
    },
    30: {
    ...
    31: {
        1: 'Et Moïse alla, et dit ces paroles à tout Israël;',
        2: 'et il leur dit: Je suis aujourd’hui âgé de 120 ans, je ne puis plus sortir et entrer; et l’ Éternel m’a dit: Tu ne passeras pas ce Jourdain.',
        3: 'L’ Éternel, ton Dieu, lui-même, va passer devant toi; c’est lui qui détruira ces nations devant toi, et tu les déposséderas: Josué, lui, va passer devant toi, comme l’ Éternel l’a dit.',
        ...
        8: 'Et l’ Éternel est celui qui marche devant toi; lui, sera avec toi; il ne te laissera pas et il ne t’abandonnera pas: ne crains point, et ne t’effraie point.',
        ...
        30: '*Et Moïse prononça aux oreilles de toute la congrégation d’Israël les paroles de ce cantique-ci, jusqu’à ce qu’elles soient complètes:',
    },
    32: {
    ...
    34: {
        ...
        7: 'Et Moïse était âgé de 120 ans quand il mourut; son œil n’était pas affaibli, et sa vigueur ne s’en était pas allée.',
        8: '– Et les fils d’Israël pleurèrent Moïse dans les plaines de Moab, 30 jours; et les jours des pleurs du deuil de Moïse furent terminés.',
