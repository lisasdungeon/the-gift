...
CHAPTERS = {
    ...
    3: {
        ...
        24: 'Seigneur Eternel, tu as commencé de montrer à ton serviteur ta grandeur et ta main forte; car qui est le Dieu Fort au ciel et sur la terre qui puisse faire des oeuvres comme les tiennes, et dont la force soit comme tes forces?',
    ...
    5: {
        ...
        14: 'Mais le septième jour est le repos de l’Eternel ton Dieu; tu ne feras aucune oeuvre en ce jour-là, ni toi, ni ton fils, ni ta fille, ni ton serviteur, ni ta servante, ni ton boeuf, ni ton âne, ni aucune de tes bêtes, ni ton étranger qui est dans tes portes, afin que ton serviteur et ta servante se reposent comme toi.',
        ...
        21: 'Tu ne convoiteras point la femme de ton prochain, tu ne souhaiteras point la maison de ton prochain, ni son champ, ni son serviteur, ni sa servante, ni son boeuf, ni son âne, ni aucune chose qui soit à ton prochain.',
        ...
        29: 'Ô! s’ils avaient toujours ce même coeur pour me craindre, et pour garder tous mes commandements, afin qu’ils prospérassent, eux et leurs enfants à jamais.',
    ...
    7: {
        ...
        17: 'Si tu dis en ton coeur: Ces nations-là sont en plus grand nombre que moi, comment les pourrai-je déposséder?',
    ...
    8: {
        ...
        2: 'Et qu’il te souvienne de tout le chemin par lequel l’Eternel ton Dieu t’a fait marcher durant ces quarante ans dans ce désert, afin de t’humilier et de t’éprouver; pour connaître ce qui était en ton coeur, si tu garderais ses commandements, ou non.',
        ...
        5: 'Connais donc en ton coeur que l’Eternel ton Dieu te châtie, comme un homme châtie son enfant.',
        ...
        14: 'Alors ton coeur ne s’élève, et que tu n’oublies l’Eternel ton Dieu, qui ta retiré du pays d’Egypte, de la maison de servitude.',
    ...
    12: {
        ...
        6: 'Et vous apporterez là vos holocaustes, vos sacrifices, vos dîmes, et l’oblation élevée de vos mains, vos voeux, vos offrandes volontaires, et les premiers-nés de votre gros et de votre menu bétail.',
    ...
    28: {
        ...
        54: 'L’homme le plus tendre et le plus délicat d’entre vous regardera d’un oeil malin son frère et sa femme bien-aimée, et le reste de ses enfants qu’il aura réservés;',
