...
CHAPTERS = {
    ...
    7: {
        ...
        3: 'Du darfst dich auch nicht mit ihnen verschwägern, weder deine Töchter an ihre Söhne verheiraten noch ihre Töchter für deine Söhne zu Frauen nehmen;',
        ...
        6: 'Denn du bist ein dem HERRN, deinem Gott, geheiligtes Volk: dich hat der HERR, dein Gott, aus allen Völkern, die auf dem Erdboden sind, zu seinem Eigentumsvolk erwählt.',
        ...
        13: 'und wird dich lieben und segnen und dich zahlreich werden lassen, dir Kindersegen bescheren und deine Feldfrüchte, dein Getreide, deinen Wein und dein Öl, die Jungen deiner Rinder und den Nachwuchs deines Kleinviehs in dem Lande segnen, das du, wie er deinen Vätern zugeschworen hat, besitzen sollst.',
        ...
        15: 'Der HERR wird auch alle Krankheiten von dir fernhalten und keine von den bösen Seuchen Ägyptens, die du kennst, über dich kommen lassen, sondern alle deine Feinde damit heimsuchen.',
        16: 'Du sollst aber alle Völker vernichten, die der HERR, dein Gott, in deine Gewalt gibt: dein Auge soll sie nicht mitleidig ansehen, und du sollst ihren Göttern nicht dienen, denn das würde ein Fallstrick für dich sein.',
        ...
        19: 'an die großen Machterweise, die du mit eigenen Augen gesehen hast, an die Zeichen und Wunder, an die starke Hand und den hocherhobenen Arm, mit dem der HERR, dein Gott, dich herausgeführt hat: ebenso wird der HERR, dein Gott, mit allen Völkern verfahren, vor denen du dich jetzt fürchtest.',
        20: 'Auch die Hornissen wird der HERR, dein Gott, gegen sie loslassen, bis die Übriggebliebenen und die sich vor dir Versteckenden umgekommen sind.',
        21: 'Habe also keine Angst vor ihnen! Denn der HERR, dein Gott, ist in deiner Mitte, ein großer und furchtbarer Gott.',
        22: 'Doch der HERR, dein Gott, wird diese Völker nur nach und nach vor dir vertreiben: du darfst sie nicht schnell vernichten, sonst würden die wilden Tiere zu deinem Schaden überhandnehmen.',
        23: 'Jedoch wird der HERR, dein Gott, sie dir preisgeben und sie in große Bestürzung versetzen, bis sie ausgerottet sind;',
        ...
        25: 'Ihre geschnitzten Götzenbilder sollt ihr im Feuer verbrennen: du sollst nach dem Silber und Gold, das sich an ihnen befindet, kein Verlangen tragen und es nicht für dich hinnehmen, damit du dadurch nicht ins Verderben gerätst, denn es ist ein Greuel für den HERRN, deinen Gott,',
        26: 'und du sollst einen solchen Greuel nicht in dein Haus kommen lassen, um nicht gleich ihm dem Bann zu verfallen; du sollst es vielmehr mit Ekel verabscheuen und es durchaus für etwas Greuelhaftes halten, denn es ist dem Banne geweiht.«',
    },
    8: {
    ...
    10: {
        ...
        6: 'Die Israeliten aber brachen von Beeroth-Bene-Jaakan nach Mosera auf; dort starb Aaron und wurde dort begraben, und sein Sohn Eleasar trat als Priester an seine Stelle.',
        7: 'Von da zogen sie nach Gudgoda weiter und von Gudgoda nach Jotba, einem reichbewässerten Landstrich.',
        8: 'Damals sonderte der HERR den Stamm Levi dazu aus, die Lade mit dem Bundesgesetz des HERRN zu tragen und als seine Diener vor ihm zu stehen und in seinem Namen zu segnen, wie es bis auf den heutigen Tag geschieht.',
        ...
        14: 'Bedenke wohl: dem HERRN, deinem Gott, gehört der Himmel, und zwar der innerste Himmel, die Erde und alles, was auf ihr ist;',
        ...
        21: 'Er ist dein Ruhm und er dein Gott, der an dir jene großen und wunderbaren Taten vollführt hat, die du mit eigenen Augen gesehen hast.',
    ...
    11: {
        1: '»So liebe denn den HERRN, deinen Gott, und beobachte allezeit, was er beobachtet wissen will, seine Satzungen, seine Verordnungen und seine Gebote,',
        2: 'und erkennet heute – denn nicht zu euren Kindern rede ich, welche die Zucht des HERRN, eures Gottes, nicht miterlebt und seine große Macht nicht gesehen haben, seine starke Hand und seinen hocherhobenen Arm,',
        ...
        5: 'und was er sodann an euch in der Wüste bis zu eurer Ankunft an diesem Ort vollbracht hat,',
        ...
        8: 'So beobachtet denn das ganze Gesetz, das ich euch heute gebiete, damit ihr stark seid und dazu kommt, das Land in Besitz zu nehmen, in das ihr hinüberzieht, um es zu erobern,',
        9: 'und damit ihr lange in dem Lande wohnen bleibt, dessen Verleihung der HERR euren Vätern und ihren Nachkommen zugeschworen hat, ein Land, das von Milch und Honig überfließt.«',
        10: '»Denn das Land, in das du einziehst, um es in Besitz zu nehmen, ist nicht so wie das Land Ägypten, aus dem ihr ausgezogen seid, wo du die Saat, die du gesät hattest, wie einen Gemüsegarten (durch Schöpfräder) mit den Füßen bewässern mußtest;',
        ...
        12: 'ein Land, für das der HERR, dein Gott, Sorge trägt und auf das die Augen des HERRN, deines Gottes, beständig gerichtet sind vom Anfang des Jahres bis zum Ende des Jahres.',
        13: 'Wenn ihr nun den Geboten, die ich euch heute zur Pflicht mache, getreulich nachkommt, indem ihr den HERRN, euren Gott, liebt und ihm von ganzem Herzen und mit ganzer Seele dient,',
        14: '›so wird er eurem Lande zu rechter Zeit Regen geben, Frühregen und Spätregen, damit du dein Getreide, deinen Wein und dein Öl einbringen kannst;',
        ...
        17: 'Sonst wird der Zorn des HERRN gegen euch entbrennen, und er wird den Himmel verschließen, so daß kein Regen mehr fällt und der Erdboden keinen Ertrag mehr gibt und ihr schnell aus dem schönen Lande verschwindet, das der HERR euch geben will.«',
        18: '»Laßt also diese meine Worte Eingang in euer Herz finden und euch ganz durchdringen, bindet sie euch als ein Gedenkzeichen an eure Hand und tragt sie als Binde auf eurer Stirn,',
        19: 'lehrt sie auch eure Kinder, indem ihr davon redet, wenn ihr zu Hause sitzt oder auf der Wanderung begriffen seid, wenn ihr euch niederlegt und wenn ihr aufsteht;',
        20: 'und schreibt sie auf die Türpfosten eurer Häuser und an eure Tore,',
        ...
        24: 'Das ganze Gebiet, das eure Fußsohle betreten wird, soll euer Eigentum werden: von der Wüste bis an den Libanon, von dem Strome, dem Euphratstrom, bis an das Meer im Westen soll euer Gebiet reichen;',
        25: 'niemand soll euch gegenüber standhalten können; Furcht und Schrecken vor euch wird der HERR, euer Gott, über das ganze Land verbreiten, das ihr betreten werdet, wie er es euch zugesagt hat.',
        26: 'Seht, ich lege euch heute Segen und Fluch zur Wahl vor:',
        27: 'den Segen, wenn ihr den Geboten des HERRN, eures Gottes, gehorcht, die ich euch heute gebiete;',
        28: 'aber den Fluch, wenn ihr den Geboten des HERRN, eures Gottes, nicht gehorcht und von dem Wege, den ich euch heute gebiete, abweicht, um anderen Göttern anzuhangen, von denen ihr vorher nichts gewußt habt.«',
        29: '»Wenn nun der HERR, dein Gott, dich in das Land gebracht hat, in das du jetzt ziehst, um es in Besitz zu nehmen, so sollst du den Segen auf dem Berge Garizim und den Fluch auf dem Berge Ebal erteilen.',
        30: 'Diese liegen bekanntlich jenseits des Jordans, westlich von der nach Sonnenuntergang führenden Straße, im Lande der Kanaanäer, die in der Jordanebene wohnen, Gilgal gegenüber, neben dem Terebinthenhain von More.',
        ...
        32: 'so seid auf die Erfüllung aller Satzungen und Verordnungen bedacht, die ich euch heute vorlege.«',
    },
    12: {
    ...
    23: {
        1: 'Niemand darf die Frau seines Vaters zum Weibe nehmen und überhaupt nicht die Bettdecke seines Vaters aufdecken.«',
    ...
    25: {
        ...
        18: 'daß sie dich, während du müde und matt warst, auf der Wanderung ohne Furcht vor Gott überfallen und alle die niedergehauen haben, welche bei dir vor Ermattung zurückgeblieben waren.',
    ...
    27: {
        1: 'Weiter geboten Mose und die Ältesten der Israeliten dem Volke folgendes: »Beobachtet alle Gebote, die ich euch heute zur Pflicht mache!',
        2: 'Sobald ihr also über den Jordan in das Land gezogen seid, das der HERR, dein Gott, dir geben wird, so richte dir große Steine auf, überstreiche sie mit Tünchkalk',
        3: 'und schreibe, sobald du hinübergezogen bist, alle Worte dieses Gesetzes auf sie, damit du in das Land hineinkommst, das der HERR, dein Gott, dir geben will, ein Land, das von Milch und Honig überfließt, wie der HERR, der Gott deiner Väter, dir verheißen hat.',
        ...
        6: 'aus unbehauenen Steinen sollst du den Altar des HERRN, deines Gottes, erbauen und dem HERRN, deinem Gott, Brandopfer auf ihm darbringen;',
        7: 'und du sollst Dankopfer schlachten und ein Opfermahl dort halten und vor dem HERRN, deinem Gott, fröhlich sein.',
        8: 'Auf die Steine aber sollst du alle Worte dieses Gesetzes schreiben, indem du sie sorgfältig eingräbst.«',
        9: 'Hierauf richteten Mose und die levitischen Priester folgende Worte an ganz Israel: »Beobachte Schweigen, Israel, und höre zu! Am heutigen Tage bist du zum Volk des HERRN, deines Gottes, geworden.',
        ...
        11: 'An demselben Tage erteilte Mose dem Volke folgenden Befehl:',
        12: '»Wenn ihr über den Jordan gezogen seid, so sollen die einen sich auf dem Berge Garizim aufstellen, um das Volk zu segnen, nämlich Simeon, Levi, Juda, Issaschar, Joseph und Benjamin;',
        ...
        15: '›Verflucht sei, wer ein geschnitztes oder gegossenes Bild, einen Greuel für den HERRN, ein Machwerk von Künstlerhand, anfertigt und es heimlich aufstellt!‹, und das ganze Volk soll antworten: ›So sei es!‹',
        ...
        20: '›Verflucht sei, wer sich mit dem Weibe seines Vaters vergeht; denn er hat die Bettdecke seines Vaters aufgedeckt!‹, und das ganze Volk soll sagen: ›So sei es!‹',
        ...
        23: '›Verflucht sei, wer sich mit seiner Schwägerin vergeht!‹, und das ganze Volk soll sagen: ›So sei es!‹',
        ...
        26: '›Verflucht sei, wer nicht die Bestimmungen dieses Gesetzes durch ihre Erfüllung aufrechthält!‹, und das ganze Volk soll sagen: ›So sei es!‹«',
    },
    28: {
    ...
    29: {
        1: 'Mose berief also alle Israeliten und sagte zu ihnen: »Ihr habt selbst alles gesehen, was der HERR vor euren Augen im Lande Ägypten dem Pharao und allen seinen Knechten und seinem ganzen Lande hat widerfahren lassen:',
    ...
    32: {
        ...
        11: 'Wie ein Adler, der seine Brut aus dem Nest hinausführt und über seinen Jungen flatternd schwebt, seine Fittiche über sie breitet, sie aufnimmt, sie trägt auf seinen Schwingen:',
        ...
        14: 'Sahne von Kühen und Milch vom Kleinvieh, dazu das Fett von Lämmern und Widdern, Sprößlinge von Basan und Böcke samt dem Nierenfett des Weizens; und Traubenblut trankst du, feurigen Wein.',
        ...
        18: 'Des Felsens, der dir das Dasein gegeben, gedachtest du nicht mehr und vergaßest den Gott, dem du das Entstehn verdanktest.',
        ...
        22: 'Denn ein Feuer ist durch meinen Zorn entbrannt und hat bis in die Tiefen der Unterwelt gelodert; es hat die Erde samt ihrem Ertrag verzehrt und die Grundfesten der Berge in Flammen gesetzt.',
        ...
        25: 'Draußen soll das Schwert sie (der Angehörigen) berauben und drinnen daheim der Schrecken (sie wegraffen), den Jüngling wie die Jungfrau, den Säugling mitsamt dem Graukopf.«',
        ...
        30: 'Wie könnte ein einziger Tausend vor sich hertreiben und zwei Zehntausend in die Flucht schlagen, hätte nicht ihr Fels sie verkauft und der HERR sie preisgegeben?',
        ...
        41: 'Hab’ ich mein blitzendes Schwert geschärft und hat meine Hand zum Gericht gegriffen, so werde ich Rache an meinen Feinden nehmen und denen vergelten, die mich hassen!',
    ...
    33: {
        ...
        13: 'Und von Joseph sagte er: »Gesegnet vom HERRN ist sein Land mit der köstlichsten Himmelsgabe, mit Tau, und mit der Wasserflut, die drunten lagert;',
        ...
        19: 'Sie laden Völker ein auf den Berg, dort opfern sie rechte Opfer; denn den Reichtum der Meere saugen sie ein und die verborgensten Schätze des Sandes.«',
