...
CHAPTERS = {
    1: {
        ...
        16: 'Οἱ δὲ ἐξ ἐριθείας τὸν ˚Χριστὸν καταγγέλλουσιν, οὐχ ἁγνῶς οἰόμενοι θλῖψιν ἐγείρειν τοῖς δεσμοῖς μου.',
        17: 'Οἱ μὲν ἐξ ἀγάπης εἰδότες ὅτι εἰς ἀπολογίαν τοῦ εὐαγγελίου κεῖμαι,',
        ...
        20: 'κατὰ τὴν ἀποκαραδοκίαν καὶ ἐλπίδα μου, ὅτι ἐν οὐδενὶ αἰσχυνθήσομαι, ἀλλʼ ἐν πάσῃ παρρησίᾳ, ὡς πάντοτε καὶ νῦν, μεγαλυνθήσεται ˚Χριστὸς ἐν τῷ σώματί μου, εἴτε διὰ ζωῆς εἴτε διὰ θανάτου.',
        ...
        24: 'τὸ δὲ ἐπιμένειν ἐν τῇ σαρκὶ, ἀναγκαιότερον διʼ ὑμᾶς.',
    ...
    2: {
        ...
        17: 'ἀλλʼ εἰ καὶ σπένδομαι ἐπὶ τῇ θυσίᾳ καὶ λειτουργίᾳ τῆς πίστεως ὑμῶν, χαίρω καὶ συγχαίρω πᾶσιν ὑμῖν.',
    ...
    4: {
        ...
        6: 'Μηδὲν μεριμνᾶτε, ἀλλʼ ἐν παντὶ, τῇ προσευχῇ καὶ τῇ δεήσει μετὰ εὐχαριστίας, τὰ αἰτήματα ὑμῶν γνωριζέσθω πρὸς τὸν ˚Θεόν.',
        ...
        23: 'Ἡ χάρις τοῦ ˚Κυρίου ˚Ἰησοῦ ˚Χριστοῦ μετὰ τοῦ πνεύματος ὑμῶν. Ἀμήν!',
    },
}
