...
CHAPTERS = {
    ...
    2: {
        ...
        14: '¶Ταῦτα ὑπομίμνῃσκε, διαμαρτυρόμενος ἐνώπιον τοῦ ˚Θεοῦ, μὴ λογομαχεῖν ἐπʼ οὐδὲν χρήσιμον, ἐπὶ καταστροφῇ τῶν ἀκουόντων.',
    ...
    3: {
        ...
        9: 'Ἀλλʼ οὐ προκόψουσιν ἐπὶ πλεῖον, ἡ γὰρ ἄνοια αὐτῶν ἔκδηλος ἔσται πᾶσιν, ὡς καὶ ἡ ἐκείνων ἐγένετο.',
    ...
    4: {
        ...
        10: 'Δημᾶς γάρ με ἐγκατέλειπεν, ἀγαπήσας τὸν νῦν αἰῶνα, καὶ ἐπορεύθη εἰς Θεσσαλονίκην, Κρήσκης εἰς Γαλατίαν, Τίτος εἰς Δαλματίαν.',
        ...
        22: '¶Ὁ ˚Κύριος ˚Ἰησοῦς μετὰ τοῦ πνεύματός σου. Ἡ χάρις μεθʼ ὑμῶν.',
    },
}
