...
CHAPTERS = {
    ...
    7: {
        ...
        69: '{7:68} Kameleja heillä oli neljäsataa kolmekymmentä viisi, aaseja kuusituhatta seitsemänsataa kaksikymmentä.',
        70: '{7:69} Osa perhekunta-päämiehistä antoi lahjoja rakennustyötä varten. Maaherra antoi rahastoon tuhat dareikkia kultaa, viisikymmentä maljaa ja viisisataa kolmekymmentä papin-ihokasta.',
        71: '{7:70} Ja muutamat perhekunta-päämiehistä antoivat rakennusrahastoon kaksikymmentä tuhatta dareikkia kultaa ja kaksituhatta kaksisataa miinaa hopeata.',
        72: '{7:71} Ja muu kansa antoi yhteensä kaksikymmentä tuhatta dareikkia kultaa ja kaksituhatta miinaa hopeata sekä kuusikymmentä seitsemän papin-ihokasta.',
        73: '{7:72} Ja papit, leeviläiset, ovenvartijat, veisaajat ja osa kansasta sekä temppelipalvelijat, koko Israel, asettuivat kaupunkeihinsa. Ja niin tuli seitsemäs kuukausi, ja israelilaiset olivat jo kaupungeissansa.',
    },
    8: {
    ...
    9: {
        ...
        38: '{10:1} "Kaiken tämän johdosta me teemme sitoumuksen ja kirjoitamme siihen nimemme; sinetöidyssä asiakirjassa ovat meidän päämiestemme, leeviläistemme ja pappiemme nimet.',
    },
    10: {
