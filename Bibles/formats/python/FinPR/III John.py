...
CHAPTERS = {
    1: {
        ...
        14: 'sillä minä toivon pian näkeväni sinut, ja silloin saamme suullisesti puhella. {1:15} Rauha sinulle! Ystävät tervehtivät sinua. Tervehdys ystäville, kullekin erikseen.',
    },
}
