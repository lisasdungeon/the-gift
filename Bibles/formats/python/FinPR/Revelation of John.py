...
CHAPTERS = {
    ...
    13: {
        1: '{12:18} Ja se asettui seisomaan meren hiekalle. {13:1} Ja minä näin pedon nousevan merestä; sillä oli kymmenen sarvea ja seitsemän päätä, ja sarvissansa kymmenen kruunua, ja sen päihin oli kirjoitettu pilkkaavia nimiä.',
