...
CHAPTERS = {
    ...
    2: {
        ...
        3: '{2:5} etten minä riisuisi häntä alasti ja asettaisi häntä, niinkuin hän oli syntymänsä päivänä, etten tekisi häntä erämaan kaltaiseksi, saattaisi häntä kuivan maan kaltaiseksi ja kuolettaisi häntä janoon.',
