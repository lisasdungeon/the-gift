...
CHAPTERS = {
    ...
    3: {
        ...
        19: 'Minä ajattelin: Kuinka asetankaan sinut lasten joukkoon ja annan sinulle suloisen maan, ihanan perintöosan, ihanimman kansojen maista! Ja ajattelin: Sinä olet kutsuva minua isäksi etkä ole koskaan kääntyvä minusta pois.',
        20: 'Mutta niinkuin vaimo on uskoton puolisollensa, niin olette te, Israelin heimo, olleet uskottomat minulle, sanoo Herra.',
        ...
        24: 'Häpeäjumala on syönyt isiemme vaivannäön nuoruudestamme asti, heidän lampaansa ja raavaansa, poikansa ja tyttärensä.',
        25: 'Maatkaamme häpeässämme, ja häväistyksemme peittäköön meidät, sillä Herraa, meidän Jumalaamme, vastaan me olemme syntiä tehneet, me ja meidän isämme, hamasta nuoruudestamme tähän päivään asti, emmekä ole kuulleet Herran, meidän Jumalamme, ääntä."',
    },
    4: {
        ...
        7: 'Leijona on noussut tiheiköstänsä, kansaintuhooja on lähtenyt liikkeelle, lähtenyt asuinpaikastansa, tekemään sinun maasi autioksi: sinun kaupunkisi hävitetään asujattomiksi.',
    ...
    9: {
        ...
        2: '{9:1} Oi, jospa minulla olisi erämaassa matkamiehen yömaja, niin minä jättäisin kansani ja vaeltaisin pois heidän luotaan! Sillä he ovat kaikki avionrikkojia, ovat uskottomain joukkio.',
    ...
    11: {
        ...
        5: 'ja pidän valan, jonka olen vannonut teidän isillenne luvaten antaa heille maan, joka vuotaa maitoa ja mettä, niinkuin se teillä tänäkin päivänä on." Ja minä vastasin ja sanoin: "Amen, Herra!"',
        6: 'Ja Herra sanoi minulle: "Julista kaikki nämä sanat Juudan kaupungeissa ja Jerusalemin kaduilla ja sano: Kuulkaa tämän liiton sanat ja noudattakaa niitä.',
        ...
        8: 'Mutta he eivät kuulleet eivätkä korvaansa kallistaneet, vaan vaelsivat kukin pahan sydämensä paatumuksessa. Niin minä tuotin heidän päällensä kaikki tämän liiton sanat, joita minä olin käskenyt heidän noudattaa, mutta joita he eivät noudattaneet."',
        9: 'Ja Herra sanoi minulle: "Juudan miesten ja Jerusalemin asukasten keskuudessa on salaliitto.',
        ...
        21: 'Sentähden, näin sanoo Herra Anatotin miehistä, jotka väijyvät sinun henkeäsi sanoen: "Älä ennusta Herran nimeen, ettet kuolisi meidän kättemme kautta" -',
        22: 'sentähden, näin sanoo Herra Sebaot: "Katso, minä kostan heille; heidän nuoret miehensä kuolevat miekkaan, heidän poikansa ja tyttärensä kuolevat nälkään.',
        23: 'Heistä ei jäännöstä jää, sillä minä tuotan onnettomuuden Anatotin miehille heidän rangaistusvuotenansa."',
    },
    12: {
        ...
        5: '"Jos sinä jalkamiesten kanssa juokset ja ne sinut väsyttävät, kuinka sinä kävisit kilpaan hevosten kanssa? Ja jos sinä vaarattomalla maalla oletkin turvassa, kuinka käy sinun Jordanin rantatiheikössä?',
        ...
        13: 'He ovat kylväneet nisuja ja niittäneet ohdakkeita; ovat nähneet vaivaa näännyksiin asti, saamatta hyötyä. Niinpä saakaa häpeä sadostanne Herran vihan hehkun tähden."',
        ...
        17: 'Mutta jos he eivät kuule, niin minä tempaan pois ja hukutan sen kansan, sanoo Herra."',
    },
    13: {
    ...
    22: {
        ...
        30: 'Näin sanoo Herra: Merkitkää tämä mies lapsettomaksi, mieheksi, jolla ei elinpäivinänsä onnea ole. Sillä ei kenellekään hänen jälkeläisistänsä sitä onnea tule, että istuisi Daavidin valtaistuimella ja hallitsi vielä Juudaa."',
    },
    23: {
    ...
    29: {
        ...
        25: '"Näin sanoo Herra Sebaot, Israelin Jumala: Sentähden että sinä olet lähettänyt omassa nimessäsi tämän kirjeen kaikelle kansalle, joka on Jerusalemissa, ja pappi Sefanjalle, Maasejan pojalle, ja kaikille papeille:',
        ...
        28: 'Niinpä hän on saattanut lähettää meille Baabeliin tämän sanan: \'Se kestää vielä kauan. Rakentakaa taloja ja asukaa niissä, istuttakaa puutarhoja ja syökää niiden hedelmiä.\'"',
        ...
        32: 'sentähden, näin sanoo Herra: Katso, minä kostan nehelamilaiselle Semajalle ja hänen jälkeläisillensä. Hänellä ei ole oleva ketään, joka saa asua tämän kansan keskuudessa, eikä hän ole näkevä sitä hyvää, jonka minä teen kansalleni, sanoo Herra; sillä hän on julistanut luopumusta Herrasta."',
    },
    30: {
        1: 'Sana, joka tuli Herralta Jeremialle ja kuului näin:',
    ...
    34: {
        ...
        15: 'Vaan nyt te olette kääntyneet ja tehneet teon, joka on oikea minun silmissäni, julistaessanne vapautuksen kukin lähimmäisellensä, ja olette tehneet liiton minun kasvojeni edessä temppelissä, joka on otettu minun nimiini.',
    ...
    35: {
        ...
        17: 'Sentähden, näin sanoo Herra, Jumala Sebaot, Israelin Jumala: Katso, minä annan tulla Juudalle ja kaikille Jerusalemin asukkaille kaiken sen onnettomuuden, jolla minä olen heitä uhannut, koska he eivät kuulleet, kun minä heille puhuin, eivät vastanneet, kun minä heitä kutsuin."',
