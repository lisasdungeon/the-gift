...
CHAPTERS = {
    ...
    2: {
        ...
        17: 'Os sacerdotes, trabalhadores do SENHOR, chorem entre o alpendre e o altar, e digam: Poupa a teu povo, SENHOR, e não entregues tua herança à humilhação, para que as nações a dominem. Por que entre os povos diriam: Onde está o Deus deles?',
