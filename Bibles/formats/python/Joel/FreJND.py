...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'un jour de ténèbres et d’obscurité, un jour de nuées et d’épaisses ténèbres: c’est comme l’aube qui s’étend sur les montagnes, – un peuple nombreux et fort, tel qu’il n’y en eut jamais, et qu’après lui, il n’y en aura point jusqu’aux années des générations et des générations.',
    ...
    3: {
        1: '*Et il arrivera, après cela, que je répandrai mon Esprit sur toute chair, et vos fils et vos filles prophétiseront, vos vieillards songeront des songes, vos jeunes hommes verront des visions;',
        2: 'et aussi sur les serviteurs et sur les servantes, en ces jours-là, je répandrai mon Esprit. –',
        3: 'Et je montrerai des signes dans les cieux et sur la terre, du sang, et du feu, et des colonnes de fumée;',
        4: 'le soleil sera changé en ténèbres, et la lune en sang, avant que vienne le grand et terrible jour de l’ Éternel.',
        5: 'Et il arrivera que, quiconque invoquera le nom de l’ Éternel sera sauvé. Car sur la montagne de Sion il y aura délivrance, et à Jérusalem, comme l’ Éternel l’a dit, et pour les réchappés que l’ Éternel appellera.',
    },
    4: {
