...
CHAPTERS = {
    ...
    3: {
        ...
        2: 'Zgromadzę też wszystkie narody i sprowadzę je do Doliny Jehoszafata, i będę tam z nimi rozprawiał o swoim ludzie i o swoim dziedzictwie Izraela, które rozproszyły wśród narodów i podzieliły moją ziemię.',
        ...
        6: 'A synów Judy i synów Jerozolimy sprzedaliście Grekom, by ich oddalić od ich granic.',
        ...
        17: 'I poznacie, że ja jestem Panem, waszym Bogiem, który mieszka na Syjonie, mojej świętej górze. I Jerozolima stanie się święta, a obcy już nie będą przez nią przechodzić.',
