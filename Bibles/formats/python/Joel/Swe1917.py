...
CHAPTERS = {
    1: {
        1: 'Bot Detta är HERRENS ord som kom till Joel, Petuels son.',
    ...
    3: {
        ...
        2: 'då skall jag samla tillhopa alla hednafolk och föra dem ned till Josafats[1] dal, och där skall jag hålla dom över dem, för mitt folks och min arvedels, Israels, skull, därför att de hava förskingrat dem bland hedningarna och utskiftat mitt land.',
        ...
        21: 'Och jag skall utplåna deras blodskulder, dem som jag icke allaredan har utplånat. Och HERREN skall förbliva boende på Sion. [1] Namnet kan översättas: Herren håller dom.',
    },
}
