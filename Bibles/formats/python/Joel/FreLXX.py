...
CHAPTERS = {
    ...
    3: {
        1: 'Et ensuite, voici ce qui arrivera: Je répandrai Mon Esprit sur toute chair; et vos fils prophétiseront, et vos anciens auront des songes, et vos jeunes hommes des visions.',
        2: 'Et en ce jour-là Je répandrai Mon Esprit sur Mes serviteurs et sur Mes servantes.',
        3: 'Et Je mettrai des signes au ciel; et sur la terre, du sang, du feu et de la fumée.',
        4: "Le soleil sera changé en ténèbres, et la lune en sang, avant qu'arrive le grand jour, le jour éclatant du Seigneur.",
        5: "Et il arrivera que quiconque invoquera le Nom du Seigneur sera sauvé; car alors sera sauvé tout ce qui sera sur la montagne de Sion et de Jérusalem, et avec eux tous les évangélisés que le Seigneur a élus, comme l'a dit le Seigneur.",
    },
    4: {
