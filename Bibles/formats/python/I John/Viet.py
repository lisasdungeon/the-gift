...
CHAPTERS = {
    1: {
        1: 'Ðiều có từ trước hết, là điều chúng tôi đã nghe, điều mắt chúng tôi đã thấy, điều chúng tôi đã ngắm và tay chúng tôi đã rờ, về lời sự sống;',
        2: 'vì sự sống đã bày tỏ ra, chúng tôi có thấy, và đang làm chứng cho, chúng tôi rao truyền cho anh em sự sống đời đời vốn ở cùng Ðức Chúa Cha và đã bày tỏ ra cho chúng tôi rồi;',
        3: 'chúng tôi lấy điều đã thấy đã nghe mà truyền cho anh em, hầu cho anh em cũng được giao thông với chúng tôi. Vả, chúng tôi vẫn được giao thông với Ðức Chúa Cha, và với Con Ngài là Ðức Chúa Jêsus Christ.',
        4: 'Chúng tôi viết những điều đó cho anh em, hầu cho sự vui mừng của chúng tôi được đầy dẫy.',
        5: 'Nầy là lời truyền giảng mà chúng tôi đã nghe nơi Ngài và truyền lại cho anh em rằng Ðức Chúa Trời là sự sáng, trong Ngài chẳng có sự tối tăm đâu.',
        ...
        7: 'Nhưng, nếu chúng ta đi trong sự sáng cũng như chính mình Ngài ở trong sự sáng, thì chúng ta giao thông cùng nhau; và huyết của Ðức Chúa Jêsus, Con Ngài, làm sạch mọi tội chúng ta.',
    ...
    2: {
        1: 'Hỡi con cái bé mọn ta, ta viết cho các con những điều nầy, hầu cho các con khỏi phạm tội. Nếu có ai phạm tội, thì chúng ta có Ðấng cầu thay ở nơi Ðức Chúa Cha, là Ðức Chúa Jêsus Christ, tức là Ðấng công bình.',
        ...
        13: 'Hỡi các phụ lão, tôi viết cho các ông, vì các ông đã biết Ðấng có từ lúc ban đầu. Hỡi kẻ trẻ tuổi, ta viết cho các ngươi, vì các ngươi đã thắng được ma quỉ.',
        14: 'Hỡi con trẻ, ta đã viết cho các con, vì các con đã biết Ðức Chúa Cha. Hỡi phụ lão, tôi đã viết cho các ông, vì các ông đã biết Ðấng có từ lúc ban đầu. Hỡi kẻ trẻ tuổi, ta đã viết cho các ngươi, vì các ngươi là mạnh mẽ, lời Ðức Chúa Trời ở trong các ngươi, và các ngươi đã thắng được ma quỉ.',
        ...
        17: 'Vả thế gian với sự tham dục nó đều qua đi, song ai làm theo ý muốn Ðức Chúa Trời thì còn lại đời đời.',
        18: 'Hỡi các con cái ta, giờ cuối cùng là đây rồi, các con đã nghe nói rằng Kẻ địch lại Ðấng Christ phải đến. Vừa lúc bây giờ, có nhiều kẻ địch lại Ðấng Christ; bởi đó, chúng ta biết rằng ấy là giờ cuối cùng.',
        ...
        20: 'Về phần các con, đã chịu xức dầu từ nơi Ðấng thánh, thì đã biết mọi sự rồi.',
        ...
        22: 'Ai là kẻ nói dối, há chẳng phải kẻ chối Ðức Chúa Jêsus là Ðấng Christ sao? Ấy đó là Kẻ địch lại Ðấng Christ, tức là kẻ chối Ðức Chúa Cha và Ðức Chúa Con!',
    ...
    3: {
        ...
        10: 'Bởi đó, người ta nhận biết con cái Ðức Chúa Trời và con cái ma quỉ: ai chẳng làm điều công bình là không thuộc về Ðức Chúa Trời, kẻ chẳng yêu anh em mình cũng vậy.',
        ...
        17: 'Nếu ai có của cải đời nầy, thấy anh em mình đương cùng túng mà chặt dạ, thì lòng yêu mến Ðức Chúa Trời thể nào ở trong người ấy được!',
        ...
        20: 'Vì nếu lòng mình cáo trách mình, thì Ðức Chúa Trời lại lớn hơn lòng mình nữa, và biết cả mọi sự.',
        21: 'Hỡi kẻ rất yêu dấu, ví bằng lòng mình không cáo trách, thì chúng ta có lòng rất dạn dĩ, đặng đến gần Ðức Chúa Trời:',
        ...
        23: 'Vả, nầy là điều răn của Ngài: là chúng ta phải tin đến danh Con Ngài, tức là Ðức Chúa Jêsus Christ, và chúng ta phải yêu mến lẫn nhau như Ngài đã truyền dạy ta.',
        24: 'Ai vâng giữ các điều răn Ngài thì ở trong Ðức Chúa Trời, và Ðức Chúa Trời ở trong người ấy; chúng ta biết Ngài ở trong lòng chúng ta, là nhờ Ðức Thánh Linh mà Ngài đã ban cho chúng ta.',
    },
    4: {
        1: 'Hỡi kẻ rất yêu dấu, chớ tin cậy mọi thần, nhưng hãy thử cho biết các thần có phải đến bởi Ðức Chúa Trời chăng; vì có nhiều tiên tri giả đã hiện ra trong thiên hạ.',
        ...
        7: 'Hỡi kẻ rất yêu dấu, chúng ta hãy yêu mến lẫn nhau; vì sự yêu thương đến từ Ðức Chúa Trời, kẻ nào yêu, thì sanh từ Ðức Chúa Trời và nhìn biết Ðức Chúa Trời.',
        8: 'Ai chẳng yêu, thì không biết Ðức Chúa Trời; vì Ðức Chúa Trời là sự yêu thương.',
        9: 'Lòng Ðức Chúa Trời yêu chúng ta đã bày tỏ ra trong điều nầy: Ðức Chúa Trời đã sai Con một Ngài đến thế gian, đặng chúng ta nhờ Con được sống.',
        10: 'Nầy sự yêu thương ở tại đây: ấy chẳng phải chúng ta đã yêu Ðức Chúa Trời, nhưng Ngài đã yêu chúng ta, và sai Con Ngài làm của lễ chuộc tội chúng ta.',
        11: 'Hỡi kẻ rất yêu dấu, nếu Ðức Chúa Trời đã yêu chúng ta dường ấy, thì chúng ta cũng phải yêu nhau.',
        12: 'Chưa hề có ai thấy Ðức Chúa Trời; nếu chúng ta yêu nhau, thì Ðức Chúa Trời ở trong chúng ta, và sự yêu mến Ngài được trọn vẹn trong chúng ta.',
        13: 'Bởi điều nầy chúng ta biết mình ở trong Ngài và Ngài ở trong chúng ta, là Ngài đã ban Thánh Linh Ngài cho chúng ta.',
        14: 'Chúng ta lại đã thấy và làm chứng rằng Ðức Chúa Cha đã sai Ðức Chúa Con đặng làm Cứu Chúa thế gian.',
        15: 'Ví bằng có ai xưng Ðức Chúa Jêsus là Con Ðức Chúa Trời, thì Ðức Chúa Trời ở trong người, và người ở trong Ðức Chúa Trời.',
        ...
        20: 'Vì có ai nói rằng: Ta yêu Ðức Chúa Trời, mà lại ghét anh em mình, thì là kẻ nói dối; vì kẻ nào chẳng yêu anh em mình thấy, thì không thể yêu Ðức Chúa Trời mình chẳng thấy được.',
        21: 'Chúng ta đã nhận nơi Ngài điều răn nầy: Ai yêu Ðức Chúa Trời, thì cũng phải yêu anh em mình.',
    },
    5: {
        ...
        11: 'Chừng ấy tức là Ðức Chúa Trời đã ban sự sống đời đời cho chúng ta, và sự sống ấy ở trong Con Ngài.',
        ...
        20: 'Nhưng chúng ta biết Con Ðức Chúa Trời đã đến, Ngài đã ban trí khôn cho chúng ta đặng chúng ta biết Ðấng chân thật, và chúng ta ở trong Ðấng chân thật, là ở trong Ðức Chúa Jêsus Christ, Con của Ngài. Ấy chính Ngài là Ðức Chúa Trời chân thật và là sự sống đời đời.',
