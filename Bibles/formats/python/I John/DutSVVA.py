...
CHAPTERS = {
    1: {
        ...
        6: 'Indiën wij zeggen, dat wij gemeenschap met Hem hebben, en wij in de duisternis wandelen, zo liegen wij, en doen de waarheid niet.',
        ...
        8: 'Indiën wij zeggen, dat wij geen zonde hebben, zo verleiden wij ons zelven, en de waarheid is in ons niet.',
        9: 'Indiën wij onze zonden belijden, Hij is getrouw en rechtvaardig, dat Hij ons de zonden vergeve, en ons reinige van alle ongerechtigheid.',
        10: 'Indiën wij zeggen, dat wij niet gezondigd hebben, zo maken wij Hem tot een leugenaar, en Zijn woord is niet in ons.',
    },
    2: {
        ...
        24: 'Hetgeen gijlieden dan van den beginne gehoord hebt, dat blijve in u. Indiën in u blijft, wat gij van den beginne gehoord hebt, zo zult gij ook in den Zoon en in den Vader blijven.',
        ...
        29: 'Indiën gij weet, dat Hij rechtvaardig is, zo weet gij, dat een iegelijk, die de rechtvaardigheid doet, uit Hem geboren is.',
    },
    3: {
        ...
        21: 'Geliefden! Indiën ons hart ons niet veroordeelt, zo hebben wij vrijmoedigheid tot God;',
    ...
    4: {
        ...
        20: 'Indiën iemand zegt: Ik heb God lief; en haat zijn broeder, die is een leugenaar; want die zijn broeder niet liefheeft, dien hij gezien heeft, hoe kan hij God liefhebben, Dien hij niet gezien heeft?',
    ...
    5: {
        ...
        9: 'Indiën wij de getuigenis der mensen aannemen, de getuigenis van God is meerder; want dit is de getuigenis van God, welke Hij van Zijn Zoon getuigd heeft.',
        ...
        16: 'Indiën iemand zijn broeder ziet zondigen een zonde niet tot den dood, die zal God bidden en Hij zal hem het leven geven, dengenen, zeg ik, die zondigen niet tot den dood. Er is een zonde tot den dood; voor dezelve zonde zeg ik niet, dat hij zal bidden.',
