...
CHAPTERS = {
    ...
    20: {
        ...
        2: 'Sultihan mo ang mga anak sa Israel, sa pag-ingon: Magpili kamo sa mga ciudad nga dalangpanan, sumala sa akong gipamulong kaninyo pinaagi kang Moises,',
        3: 'Nga ang mamumuno nga makabuno kang bisan kinsang tawo, tungod sa kasayup ug dili tinuyo, makahimo sa pagdangup didto: ug kini mao ang inyong dalangpanan gikan sa magpapanimalus sa dugo.',
        4: 'Ug mokalagiw siya ngadto sa usa nianang mga ciudara, ug motindog sa ganghaan sa ciudad, ug sa mga igdulungog sa mga anciano nianang ciudara siya magapahayag sa iyang katarungan; ug ilang pagadad-on siya ngadto sa ciudad diha kanila, ug hatagan siya ug dapit nga iyang kapuy-an ipon kanila.',
        5: 'Ug kong ang magpapanimalus sa dugo magapangita kaniya, nan dili gayud nila ihatag ang nakabuno ngadto sa iyang kamot; tungod kay iyang gipatay ang iyang igsoon sa dili tinuyo ug wala man magdumot kaniya sa unang panahon.',
        6: 'Ug siya magapuyo nianang ciudara hangtud nga motindog siya sa atubangan sa katilingban aron pagahukman hangtud sa kamatayon sa labawng sacerdote niadtong mga adlawa; unya ang mamumuno mopauli ug moadto sa iyang kaugalingong ciudad ug sa iyang kaugalingong balay, ug ngadto sa ciudad diin siya makakalagiw.',
        7: 'Ug ilang gipili ang Cades, sa Galilea, sa kabungtoran sa Nephtali, ug ang Sechem, sa kabungtoran sa Ephraim, ug ang Chiriath-arba (nga mao ang Hebron), sa kabungtoran sa Juda.',
        8: 'Ug sa unahan sa Jordan sa Jerico paingon ngadto sa silangan, ilang gipili ang Beser nga anaa sa kamingawan sa patag sa banay ni Ruben, ug ang Ramoth sakup sa Galaad sa banay ni Gad, ug ang Golan sa Basan sa banay ni Manases.',
        9: 'Kini mao ang mga piniling ciudad alang sa tanang mga anak sa Israel ug alang sa mga dumuloong nga mopuyo ipon kanila, nga bisan kinsa ang makapatay sa bisan kinsang tawo sa dili-tinuyo, makadangup didto, ug dili mamatay sa kamot sa magpapanimalus sa dugo hangtud nga makatindog siya sa atubangan sa katilingban.',
    },
    21: {
