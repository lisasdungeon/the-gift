...
CHAPTERS = {
    ...
    15: {
        1: 'Ug ang pulong ni Jehova midangat kanako, nga nagaingon:',
        2: 'Anak sa tawo, sa unsa ba nga paagi nga ang parras labaw man kay sa uban nga kahoy, ang sanga sa parras nga anaa sa taliwala sa mga kahoy sa lasang?',
        3: 'Pagakuhaan ba kana ug kahoy aron buhaton sa bisan unsa nga buhat? kun ang mga tawo magakuha ba gikan niana ug usa ka tarogo aron sa pagbitay ug bisan unsa nga sudlanan?',
        4: 'Ania karon, ginasalibay kana ngadto sa kalayo aron isugnod; ang kalayo nagaut-ut sa duruha ka tumoy niana, ug ang taliwala niana nasunog: magapulos ba kana sa bisan unsang buhat?',
        5: 'Ania karon, sa diha nga kana tibook pa, dili na magapulos sa bisan unsang bulohaton: daw unsa pa kakulang hinoon ug kapuslanan kong ang kalayo nagaut-ut na niana, ug kana nasunog: angay ba kana nga magapulos sa bisan unsang bulohaton!',
        6: 'Busa mao kini ang giingon sa Ginoong Jehova: Ingon nga ang parras sa taliwala sa mga kahoy sa lasang, nga akong gihatag sa kalayo aron isugnod, sa mao nga pagkaagi ihatag ko ang mga pumoluyo sa Jerusalem.',
        7: 'Ug akong ipahamutang ang akong nawong batok kanila, sila mogula gikan sa kalayo, apan ang kalayo magaut-ut kanila; ug kamo makaila nga ako mao si Jehova, sa diha nga ipahamutang ko na ang akong nawong batok kanila.',
        8: 'Ug ang yuta himoon ko nga biniyaan, tungod kay sila nanagpakalapas, nagaingon ang Ginoong Jehova.',
    },
    16: {
