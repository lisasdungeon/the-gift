...
CHAPTERS = {
    1: {
        1: 'Davids klagosång Efter Sauls död, när David hade kommit tillbaka från segern över Amalek, och när David sedan i två dagar hade uppehållit sig i Siklag,',
    ...
    2: {
        ...
        16: 'Och de fattade varandra i huvudet och stötte svärdet i sidan på varandra och föllo så allasammans därför blev detta ställe kallat Helkat-Hassurim[1] vid Gibeon.',
        ...
        32: 'Och de togo upp Asael och begrovo honom i hans faders grav i Bet-Lehem. Därefter tågade Joab och hans män hela natten och kommo i dagningen till Hebron. [1] Betydelsen oviss; möjligen svärdsåkern.',
    },
    3: {
        1: 'Kriget mellan Sauls hus och Davids hus blev långvarigt. Därunder blev David allt starkare och starkare, men Sauls hus allt svagare och svagare.',
    ...
    5: {
        ...
        20: 'Och David kom till Baal-Perasim, och där slog David dem. Då sade han: »HERREN har brutit ned[1] mina fiender inför mig, likasom en vattenflod bryter ned.» Därav fick det stället namnet Baal-Perasim.',
    ...
    6: {
        ...
        8: 'Men det gick David hårt till sinne att HERREN så hade brutit ned Ussa[1]; och han kallade det ställe Peres-Ussa, såsom det heter ännu i dag.',
        ...
        23: 'Och Mikal, Sauls dotter, fick inga barn, så länge hon levde. [1] Hebr parás péres be-Ussá.',
    },
    7: {
    ...
    12: {
        ...
        25: 'och sände ett budskap med profeten Natan, och denne gav honom namnet Jedidja[1], för HERRENS skull.',
        ...
        31: 'Och folket därinne förde han ut och lade dem under sågar och tröskvagnar av järn och bilor av järn och överlämnade dem åt Molok. Så gjorde han mot Ammons barns alla städer. Sedan vände David med allt folket tillbaka till Jerusalem. [1] D. ä. Herrens älskling.',
    },
    13: {
    ...
    15: {
        ...
        37: 'Så gick då Husai, Davids vän[1], in i staden. Och jämväl Absalom drog in i Jerusalem. [1] Se Vän i Ordförkl.',
    },
    16: {
