...
CHAPTERS = {
    ...
    2: {
        ...
        10: 'Ish-Bosheth, fils de Saül, était âgé de 40 ans lorsqu’il régna sur Israël, et il régna deux ans. Toutefois la maison de Juda suivit David.',
        ...
        30: 'Et Joab s’en retourna de la poursuite d’Abner et rassembla tout le peuple; et, des serviteurs de David, il manquait 19 hommes et Asçaël.',
        31: 'Et les serviteurs de David avaient frappé à mort 360 hommes de Benjamin et des hommes d’Abner.',
    ...
    6: {
        1: '*Et David assembla encore toute l’élite d’Israël, 30 000 [hommes].',
    ...
    9: {
        ...
        10: 'et tu cultiveras pour lui la terre, toi et tes fils et tes serviteurs, et tu en apporteras [les fruits], et le fils de ton seigneur aura du pain à manger; et Mephibosheth, fils de ton seigneur, mangera continuellement le pain à ma table. Or Tsiba avait 15 fils et 20 serviteurs.',
    ...
    10: {
        ...
        6: 'Et les fils d’Ammon virent qu’ils s’étaient mis en mauvaise odeur auprès de David; et les fils d’Ammon envoyèrent, et prirent à leur solde des Syriens de Beth-Rehob et des Syriens de Tsoba, 20 000 hommes de pied, et le roi de Maaca [avec] 1 000 hommes, et ceux de Tob, 12 000 hommes.',
        ...
        19: 'Et tous les rois qui étaient serviteurs d’Hadarézer virent qu’ils étaient battus devant Israël, et ils firent la paix avec Israël, et le servirent. Et les Syriens craignirent d’aider encore les fils d’Ammon.',
    },
    11: {
    ...
    13: {
        ...
        2: 'Et Amnon fut tourmenté jusqu’à en tomber malade, à cause de Tamar, sa sœur; car elle était vierge, et il était trop difficile aux yeux d’Amnon de lui faire quoi que ce soit.',
        ...
        32: 'Et Jonadab, fils de Shimha, frère de David, prit la parole et dit: Que mon seigneur ne pense pas qu’on ait tué tous les jeunes hommes, fils du roi, car Amnon seul est mort; car cela a eu lieu par l’ordre d’Absalom, qu’il avait arrêté dès le jour où [Amnon] humilia Tamar, sa sœur.',
    ...
    15: {
        1: '*Et il arriva, après cela, qu’Absalom se procura des chars et des chevaux, et 50 hommes qui couraient devant lui.',
        2: 'Et Absalom se levait de bonne heure, et se tenait à côté du chemin de la porte; et tout homme qui avait une cause qui l’oblige d’aller vers le roi pour un jugement, Absalom l’appelait, et disait: De quelle ville es-tu? Et il disait: Ton serviteur est de l’une des tribus d’Israël.',
        ...
        11: 'Et 200 hommes qui avaient été invités, s’en allèrent de Jérusalem avec Absalom, et ils allaient dans leur simplicité, et ne savaient rien de l’affaire.',
        ...
        18: 'Et tous ses serviteurs marchaient à ses côtés; et tous les Keréthiens, et tous les Peléthiens, et tous les Guitthiens, 600 hommes qui étaient venus de Gath à sa suite, marchaient devant le roi.',
    ...
    17: {
        1: 'Et Akhitophel dit à Absalom: Laisse-moi choisir 12 000 hommes, et je me lèverai, et je poursuivrai David cette nuit;',
        ...
        14: 'Et Absalom et tous les hommes d’Israël dirent: Le conseil de Hushaï, l’Arkite, est meilleur que le conseil d’Akhitophel. Et l’ Éternel avait décrété d’annuler le bon conseil d’Akhitophel, pour que l’ Éternel fasse venir le mal sur Absalom.',
        ...
        22: 'Et David se leva, et tout le peuple qui était avec lui, et ils passèrent le Jourdain; à la lumière du matin il n’en manqua pas un qui n’ait passé le Jourdain.',
    ...
    18: {
        ...
        3: 'Mais le peuple dit: Tu ne sortiras point; car quand nous viendrions à fuir, ils ne prendraient pas garde à nous, et quand la moitié d’entre nous mourrait, ils ne prendraient pas garde à nous; car toi, tu es comme 10 000 d’entre nous; et maintenant il est bon que, de la ville, tu nous sois en secours.',
        ...
        7: 'Et le peuple d’Israël fut battu là par les serviteurs de David; et le carnage fut grand ce jour-là,… 20 000 hommes.',
        ...
        12: 'Et l’homme dit à Joab: Et quand je pèserais dans ma main 1 000 [pièces] d’argent, je n’étendrais pas ma main sur le fils du roi; car à nos oreilles le roi t’a commandé, à toi, et à Abishaï, et à Itthaï, disant: Prenez garde, qui [de vous] que ce soit, au jeune homme Absalom;…',
    ...
    19: {
        1: 'Et le roi fut très ému, et il monta à la chambre au-dessus de la porte et pleura; et en allant, il disait ainsi: Mon fils Absalom! mon fils! mon fils Absalom! Fussé-je mort à ta place! Absalom, mon fils, mon fils!',
        ...
        4: 'Et le peuple entra, ce jour-là, dans la ville à la dérobée, comme s’en irait à la dérobée un peuple honteux d’avoir pris la fuite dans la bataille.',
        5: 'Et le roi avait couvert son visage, et le roi criait à haute voix: Mon fils Absalom! Absalom, mon fils, mon fils!',
        6: 'Et Joab vint vers le roi dans la maison, et dit: Tu as aujourd’hui rendu honteuse la face de tous tes serviteurs, qui ont aujourd’hui sauvé ta vie, et la vie de tes fils et de tes filles, et la vie de tes femmes, et la vie de tes concubines,',
        ...
        11: 'et Absalom, que nous avions oint sur nous, est mort dans la bataille; et maintenant, pourquoi gardez-vous le silence pour ce qui est de ramener le roi?',
        12: 'Et le roi David envoya à Tsadok et à Abiathar, les sacrificateurs, disant: Parlez aux anciens de Juda, en disant: Pourquoi êtes-vous les derniers pour ramener le roi dans sa maison, alors que la parole de tout Israël est venue au roi dans sa maison?',
        13: 'Vous êtes mes frères, vous êtes mon os et ma chair; et pourquoi êtes-vous les derniers pour ramener le roi?',
        14: 'Et dites à Amasa: N’es-tu pas mon os et ma chair? Que Dieu me fasse ainsi, et ainsi y ajoute, si tu n’es chef de l’armée devant moi, pour toujours, à la place de Joab!',
        ...
        16: 'Et le roi s’en retourna, et vint jusqu’au Jourdain; et Juda vint à Guilgal pour aller à la rencontre du roi, pour faire passer au roi le Jourdain.',
        ...
        18: 'et, avec lui, 1 000 hommes de Benjamin, et Tsiba, serviteur de la maison de Saül, et ses 15 fils et ses 20 serviteurs avec lui; et ils traversèrent le Jourdain devant le roi.',
        ...
        20: 'et il dit au roi: Ne m’impute pas d’iniquité, mon seigneur, et ne te souviens pas de l’iniquité commise par ton serviteur au jour où le roi, mon seigneur, sortit de Jérusalem, en sorte que le roi le prenne à cœur.',
        ...
        23: 'Et David dit: Qu’ai-je à faire avec vous, fils de Tseruïa? car vous êtes aujourd’hui des adversaires pour moi. Ferait-on mourir aujourd’hui un homme en Israël? car ne sais-je pas que je suis aujourd’hui roi sur Israël?',
        24: 'Et le roi dit à Shimhi: Tu ne mourras point. Et le roi le lui jura.',
        ...
        26: 'Et lorsque Jérusalem vint à la rencontre du roi, le roi lui dit: Pourquoi n’es-tu pas allé avec moi, Mephibosheth?',
        ...
        29: 'Car toute la maison de mon père n’était que des hommes morts devant le roi, mon seigneur; et tu as mis ton serviteur parmi ceux qui mangent à ta table; et quel droit ai-je encore? et pour quel sujet crierai-je encore au roi?',
        ...
        32: 'Et Barzillaï, le Galaadite, descendit de Roguelim, et passa le Jourdain avec le roi, pour l’accompagner au-delà du Jourdain.',
        ...
        36: 'Je suis aujourd’hui âgé de 80 ans; puis-je distinguer ce qui est bon de ce qui est mauvais? Ton serviteur peut-il savourer ce que je mange et ce que je bois? Puis-je encore entendre la voix des chanteurs et des chanteuses? Et pourquoi ton serviteur serait-il encore à charge au roi, mon seigneur?',
        37: 'Ton serviteur passera pour peu [de temps] le Jourdain avec le roi; et pourquoi le roi me donnerait-il cette récompense?',
        38: 'Que ton serviteur, je te prie, s’en retourne, afin que je meure dans ma ville, auprès du sépulcre de mon père et de ma mère; et voici ton serviteur Kimham, il passera avec le roi, mon seigneur: fais-lui ce qui sera bon à tes yeux.',
        ...
        40: 'Et tout le peuple passa le Jourdain, et le roi passa. Et le roi embrassa Barzillaï, et le bénit; et [Barzillaï] s’en retourna en son lieu.',
        ...
        43: 'Et tous les hommes de Juda répondirent aux hommes d’Israël: Parce que le roi m’est proche; et pourquoi y a-t-il chez toi cette colère à cause de cela? Avons-nous mangé quelque chose qui vienne du roi, ou nous a-t-il fait des présents?',
        44: 'Et les hommes d’Israël répondirent aux hommes de Juda, et dirent: J’ai dix parts au roi, et aussi en David j’ai plus que toi; et pourquoi m’as-tu méprisé? Et ma parole n’a-t-elle pas été la première pour ramener mon roi? Et la parole des hommes de Juda fut plus dure que la parole des hommes d’Israël.',
    },
    20: {
    ...
    21: {
        ...
        10: 'Et Ritspa, fille d’Aïa, prit un sac et l’étendit sur le rocher, depuis le commencement de la moisson jusqu’à ce qu’il tombe de l’eau des cieux sur eux; et elle ne permit pas aux oiseaux des cieux de se poser sur eux le jour, ni aux bêtes des champs la nuit.',
        ...
        20: 'Et il y eut encore un combat, à Gath: et il y avait [là] un homme de haute stature qui avait six doigts aux mains et six orteils aux pieds, en tout 24; et lui aussi était né au géant.',
    ...
    24: {
        ...
        3: 'Et Joab dit au roi: Que l’ Éternel, ton Dieu, ajoute au peuple 100 fois autant qu’il y en a, et que les yeux du roi, mon seigneur, le voient! Mais pourquoi le roi, mon seigneur, prend-il plaisir à cela?',
        ...
        8: 'Et ils parcoururent tout le pays, et revinrent à Jérusalem au bout de neuf mois et 20 jours.',
        9: 'Et Joab donna au roi le chiffre du recensement du peuple; et il y avait d’Israël 800 000 hommes de guerre tirant l’épée, et des hommes de Juda, 500 000 hommes.',
        ...
        15: 'Et l’ Éternel envoya la peste en Israël depuis le matin jusqu’au temps assigné; et il mourut du peuple, depuis Dan jusqu’à Beër-Shéba, 70 000 hommes.',
        ...
        24: 'Et le roi dit à Arauna: Non, car certainement j’ achèterai de toi pour un prix, et je n’offrirai pas à l’ Éternel, mon Dieu, des holocaustes qui ne coûtent rien. Et David acheta l’aire et les bœufs pour 50 sicles d’argent.',
