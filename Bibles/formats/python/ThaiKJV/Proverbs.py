...
CHAPTERS = {
    1: {
        ...
        27: 'เมื่อความหวาดกลัวของเจ้ามาถึงอย่างการรกร้างว่างเปล่า และความพินาศของเจ้ามาถึงอย่างลมหมุน เมื่อความซึมเศร้าและความปวดร้าวมาถึงเจ้า',
    ...
    2: {
        ...
        4: 'ถ้าเจ้าแสวงหาปัญญาดุจหาเงิน และเสาะหาปัญญาอย่างหาขุมทรัพย์ที่ซ่อนไว้',
        ...
        22: 'แต่คนชั่วร้ายจะถูกตัดขาดเสียจากแผ่นดินโลก และคนละเมิดจะถูกถอนรากออกไปจากแผ่นดินโลกเสีย',
    },
    3: {
    ...
    5: {
        ...
        6: 'เกรงว่าเจ้าจะสนใจในวิถีแห่งชีวิต ทางของนางวนเวียนไป เพื่อเจ้าจะหารู้ทางนั้นไม่',
        ...
        16: 'จงให้น้ำพุของเจ้าไหลกระจายออกไปนอกบ้าน และให้ธารน้ำนั้นไหลไปตามถนน',
        ...
        19: 'จงให้นางเหมือนนางกวางที่น่ารัก เลียงผาที่งามสง่า จงให้ถันของภรรยาเจ้าเป็นที่หนำใจเจ้าอยู่ทุกเวลา จงดื่มด่ำอยู่กับความรักของนางเสมอ',
        20: 'บุตรชายของเราเอ๋ย เจ้าจะเคลิบเคลิ้มอยู่กับหญิงชั่วทำไมเล่า และโอบกอดอกของนางสัญจรอยู่ทำไม',
        21: 'เพราะว่าทางของคนก็อยู่เบื้องหน้าพระเนตรของพระเยโฮวาห์ และพระองค์ทรงใคร่ครวญวิถีทั้งสิ้นของเขา',
    ...
    6: {
        ...
        3: 'บุตรชายของเราเอ๋ย จงทำอย่างนี้และช่วยตัวเจ้าให้รอดเถิด เพราะเมื่อเจ้าตกอยู่ในกำมือเพื่อนของเจ้าแล้ว ไป รีบไปวิงวอนเพื่อนของเจ้า',
        ...
        17: 'สายตาที่หยิ่งยโส ลิ้นมุสา และมือที่ทำโลหิตไร้ผิดให้ตก',
        ...
        23: 'เพราะพระบัญญัติเป็นประทีป และพระราชบัญญัติเป็นความสว่าง และคำตักเตือนแห่งการสั่งสอนเป็นทางแห่งชีวิต',
        ...
        26: 'เพราะโดยวิธีการของหญิงแพศยา ชายคนนั้นอาจเหลือแค่ขนมปังก้อนเดียวได้ และหญิงเล่นชู้ล่าชีวิตประเสริฐของชายทีเดียว',
        ...
        31: 'แต่ถ้าจับขโมยได้ เขาต้องชำระคืนเจ็ดเท่า เขาจะต้องให้สิ่งของทั้งสิ้นในบ้านของเขา',
        ...
        34: 'เพราะความอิจฉาริษยากระทำให้คนเกรี้ยวกราด ในวันที่เขาแก้แค้น เขาจะไม่เพลามือ',
    ...
    7: {
        ...
        12: 'ประเดี๋ยวอยู่ข้างนอก ประเดี๋ยวอยู่ตามถนน และนางหมอบคอยอยู่ทุกมุม)',
        ...
        20: 'เขาเอาเงินไปถุงหนึ่ง พอถึงวันกำหนดไว้เขาจึงจะกลับมา”',
    ...
    8: {
        ...
        17: 'เรารักบรรดาผู้ที่รักเรา และบรรดาผู้ที่แสวงหาเราอย่างขยันขันแข็งก็พบเรา',
        ...
        23: 'เราได้รับการสถาปนาไว้ตั้งแต่ดึกดำบรรพ์มาแล้ว ตั้งแต่แรก ก่อนปฐมกาลของแผ่นดินโลก',
    ...
    10: {
        1: 'สุภาษิตของซาโลมอน บุตรชายที่ฉลาดกระทำให้บิดายินดี แต่บุตรชายที่โง่เขลาเป็นความโศกเศร้าของมารดาเขา',
        2: 'คลังทรัพย์ชั่วร้ายไม่เป็นกำไร แต่ความชอบธรรมช่วยให้พ้นจากความตาย',
        3: 'พระเยโฮวาห์จะไม่ทรงปล่อยให้จิตใจคนชอบธรรมหิว แต่พระองค์ทรงทอดทิ้งทรัพย์สมบัติของคนชั่วร้าย',
        4: 'มือที่หย่อนเป็นเหตุให้เกิดความยากจน แต่มือที่ขยันขันแข็งกระทำให้มั่งคั่ง',
        5: 'ผู้ที่ส่ำสมไว้ในฤดูแล้งก็เป็นบุตรชายที่ฉลาด แต่ผู้หลับในฤดูเกี่ยวก็เป็นบุตรชายที่นำความอับอายมา',
        ...
        9: 'ผู้ใดที่ดำเนินในความเที่ยงธรรมก็ดำเนินอย่างมั่นคงดี แต่ผู้ที่ทำทางของตนให้ชั่วก็จะปรากฏแจ้งแก่คนอื่น',
        10: 'ผู้ที่ขยิบตาก็ก่อความเศร้าโศก แต่คนที่พูดโง่ๆจะล้มลง',
        11: 'ปากของคนชอบธรรมเป็นบ่อน้ำแห่งชีวิต แต่ความทารุณปกคลุมปากคนชั่วร้าย',
        12: 'ความเกลียดชังเร้าให้เกิดความวิวาท แต่ความรักปกปิดบรรดาความผิดบาปเสีย',
        ...
        15: 'ทรัพย์ศฤงคารของคนมั่งคั่งคือเมืองเข้มแข็งของเขา แต่ความยากจนของคนจนคือความพินาศของเขา',
        16: 'ผลงานของคนชอบธรรมนำไปถึงชีวิต แต่ผลของคนชั่วร้ายนำไปถึงบาป',
        17: 'เขาผู้รักษาคำสั่งสอนก็อยู่ในวิถีแห่งชีวิต แต่เขาผู้ปฏิเสธคำเตือนสติก็หลงเจิ่นไป',
        ...
        24: 'สิ่งใดที่คนชั่วร้ายคิดกลัว มันจะมาถึงเขา แต่สิ่งใดที่คนชอบธรรมปรารถนาจะทรงประสาทให้',
        25: 'ลมหมุนผ่านไปฉันใด คนชั่วก็ไม่มีอีกฉันนั้น แต่คนชอบธรรมเป็นรากฐานที่อยู่เป็นนิตย์',
        26: 'อย่างน้ำส้มกับฟัน และควันกับตาเป็นฉันใด คนเกียจคร้านกับผู้ที่ใช้เขาก็เป็นฉันนั้น',
        27: 'ความยำเกรงพระเยโฮวาห์นั้นยืดชีวิตให้ยาวไป แต่ปีเดือนของคนชั่วร้ายนั้นจะสั้นเข้า',
        28: 'ความหวังของคนชอบธรรมจะจบลงในความยินดี แต่ความมุ่งหวังของความชั่วร้ายก็จะสูญเปล่า',
        29: 'มรรคาของพระเยโฮวาห์ทรงเป็นกำลังแก่ผู้เที่ยงธรรม แต่ผู้กระทำความชั่วช้าจะถูกทำลาย',
    ...
    11: {
        ...
        17: 'ชายผู้มีความเอ็นดูย่อมให้ประโยชน์แก่จิตใจตน แต่ชายที่ดุร้ายย่อมทำให้ตัวเองเจ็บปวด',
        ...
        23: 'ความปรารถนาของคนชอบธรรมอยู่ในความดีเท่านั้น ความมุ่งหวังของคนชั่วร้ายอยู่ในความพิโรธ',
        24: 'บางคนที่ยิ่งแจกจ่ายก็ยิ่งทวีขึ้น บางคนที่ยิ่งหวงสิ่งที่ควรแจกจ่ายไว้ก็ยิ่งขัดสน',
        ...
        27: 'บุคคลผู้แสวงหาความดี ก็แสวงหาความพอใจ แต่ความชั่วร้ายมาถึงผู้ที่เสาะหามัน',
        ...
        30: 'ผลของคนชอบธรรมเป็นต้นไม้แห่งชีวิต และผู้ชนะวิญญาณก็มีสติปัญญา',
    ...
    14: {
        1: 'ผู้หญิงทั้งหลายที่มีสติปัญญาสร้างเรือนของเธอขึ้น แต่ผู้หญิงที่โง่รื้อมันลงด้วยมือตนเอง',
        2: 'บุคคลผู้ดำเนินในความเที่ยงธรรมเกรงกลัวพระเยโฮวาห์ แต่บุคคลที่คดเคี้ยวในทางของเขาก็ดูหมิ่นพระองค์',
        ...
        6: 'คนมักเยาะเย้ยแสวงหาปัญญาเสียเปล่า แต่ความรู้นั้นก็ง่ายแก่คนที่มีความเข้าใจ',
        ...
        14: 'คนที่มีใจหันกลับจะได้ผลจากทางของเขาจนเต็ม และคนดีก็จะได้ผลดีแห่งการกระทำของเขา',
        ...
        27: 'ความยำเกรงพระเยโฮวาห์เป็นน้ำพุแห่งชีวิต เพื่อผู้หนึ่งผู้ใดจะหลีกจากบ่วงของความมรณาได้',
        ...
        30: 'ใจที่สงบให้ชีวิตแก่เนื้อหนัง แต่ความอิจฉาริษยากระทำให้กระดูกผุ',
        31: 'บุคคลผู้บีบบังคับคนยากจน ดูถูกพระผู้สร้างของเขา แต่บุคคลที่ถวายเกียรติแด่พระองค์ก็เอ็นดูต่อคนขัดสน',
        32: 'คนชั่วร้ายก็ถูกไล่ออกตามการกระทำชั่วร้ายของเขา แต่คนชอบธรรมมีความหวังในความมรณาของเขา',
        33: 'ปัญญาอาศัยอยู่ในใจของคนที่มีความเข้าใจ แต่สิ่งซึ่งอยู่ท่ามกลางบรรดาคนโง่ก็ปรากฏตัว',
        34: 'ความชอบธรรมเชิดชูประชาชาติหนึ่งๆ แต่บาปเป็นเหตุให้ชนชาติหนึ่งๆถูกตำหนิ',
        35: 'ข้าราชการที่เฉลียวฉลาดก็ได้รับความโปรดปรานจากกษัตริย์ แต่พระพิโรธของพระองค์ก็ตกลงบนผู้ที่ประพฤติน่าละอาย',
    },
    15: {
        ...
        8: 'เครื่องสักการบูชาของคนชั่วร้ายเป็นที่น่าสะอิดสะเอียนต่อพระเยโฮวาห์ แต่คำอธิษฐานของคนเที่ยงธรรมเป็นความปีติยินดีของพระองค์',
        ...
        14: 'ใจของบุคคลผู้มีความเข้าใจก็แสวงหาความรู้ แต่ปากของคนโง่กินความโง่เป็นอาหาร',
    ...
    16: {
        ...
        5: 'ทุกคนที่มีความเย่อหยิ่งในใจก็เป็นที่น่าสะอิดสะเอียนต่อพระเยโฮวาห์ ถึงแม้มือประสานมือช่วยกัน เขาจะพ้นโทษก็หามิได้',
        ...
        18: 'ความเย่อหยิ่งเดินหน้าการถูกทำลาย และจิตใจที่ยโสนำหน้าการล้มลง',
        19: 'ที่จะเป็นคนมีใจถ่อมอยู่กับคนยากจนก็ดีกว่าแบ่งของที่ริบมาได้กับคนเย่อหยิ่ง',
        ...
        33: 'ฉลากนั้นเขาทอดลงที่ตัก แต่การตัดสินมาจากพระเยโฮวาห์ทั้งสิ้น',
    },
    17: {
        ...
        5: 'บุคคลที่เย้ยหยันคนยากจนก็ดูถูกพระผู้สร้างของเขา บุคคลที่ยินดีเมื่อมีความลำบากยากเย็นจะไม่มีโทษหามิได้',
        ...
        8: 'ของกำนัลก็เป็นเหมือนเพชรพลอยในสายตาของเจ้าของ ไม่ว่ามันจะหันไปทางไหนก็เจริญรุ่งเรืองทางนั้น',
        9: 'บุคคลผู้ปิดบังการละเมิดก็เสาะหาความรัก แต่คนกล่าวเรื่องนั้นซ้ำซากก็ทำให้เพื่อนสนิทแยกจากกัน',
        ...
        21: 'ผู้ที่ให้กำเนิดแก่คนโฉดก็มีความโศก และบิดาของคนโง่ไม่มีความชื่นบาน',
    ...
    18: {
        ...
        19: 'การคืนดีกันกับพี่น้องที่สะดุดกันแล้วก็ยากกว่าการชนะเมืองที่เข้มแข็ง และการทะเลาะวิวาทของเขาเหมือนดาลที่ป้อมปราการ',
    ...
    19: {
        ...
        2: 'เช่นเดียวกัน การที่จิตใจคนไม่มีความรู้ก็ไม่ดี และบุคคลที่เร่งเท้าหนักก็มักพลาดผิด',
        3: 'ความโง่ของคนก็นำความพินาศมาสู่ทางของเขา และใจของเขาเกรี้ยวกราดต่อพระเยโฮวาห์',
        ...
        15: 'ความเกียจคร้านทำให้หลับสนิท และคนขี้เกียจจะต้องหิวโหย',
        ...
        23: 'ความยำเกรงพระเยโฮวาห์นำไปสู่ชีวิต และบุคคลผู้ได้รับแล้วก็หยุดด้วยความพอใจ เขาจะไม่มีความชั่วร้ายใดๆมาเยี่ยมกรายเขา',
    ...
    20: {
        ...
        2: 'ความเกรงกลัวกษัตริย์ก็เหมือนเสียงสิงโตคำราม ผู้ใดยั่วเย้าพระองค์ให้กริ้วก็ทำผิดต่อชีวิตของตนเอง',
        ...
        8: 'กษัตริย์ผู้ประทับบนบัลลังก์พิพากษาย่อมฝัดความชั่วทั้งหลายออกด้วยพระเนตรของพระองค์',
        9: 'ผู้ใดจะกล่าวได้ว่า “ข้าพเจ้าได้กระทำใจของข้าพเจ้าให้สะอาด ข้าพเจ้าบริสุทธิ์พ้นบาปของข้าพเจ้าแล้ว”',
        10: 'ลูกตุ้มหลายชนิดและเครื่องตวงหลายขนาด ทั้งสองสิ่งเป็นที่น่าสะอิดสะเอียนต่อพระเยโฮวาห์พอๆกัน',
        ...
        15: 'มีทองคำและมีทับทิมเป็นอันมาก แต่ริมฝีปากที่มีความรู้ก็เป็นเพชรนิลจินดาประเสริฐ',
        ...
        21: 'เริ่มแรกอาจได้รับมรดกแบบชิงสุกก่อนห่าม แต่ที่สุดปลายจะไม่เป็นพร',
        22: 'อย่าพูดว่า “ข้าจะแก้แค้นความชั่ว” แต่จงรอคอยพระเยโฮวาห์ พระองค์จะทรงช่วยเจ้าให้รอด',
        23: 'ลูกตุ้มหลายชนิดเป็นที่น่าสะอิดสะเอียนต่อพระเยโฮวาห์ และตราชูเทียมเท็จก็ไม่ดี',
        ...
        30: 'ความฟกช้ำดำเขียวของบาดแผลก็ชำระความชั่วเสีย การโบยตีกระทำให้ส่วนลึกที่สุดสะอาดสะอ้าน',
    },
    21: {
        ...
        4: 'สายตาที่หยิ่งยโส ใจเย่อหยิ่งและการไถนาของคนชั่วร้ายเป็นบาป',
        5: 'แผนงานของคนขยันขันแข็งนำสู่ความอุดมแน่นอน แต่ทุกคนที่เร่งร้อนก็มาสู่ความขัดสนเท่านั้น',
        6: 'การได้คลังทรัพย์มาด้วยลิ้นมุสาก็เป็นความอนิจจังที่เคลื่อนไปๆมาๆของคนที่เสาะหาความตาย',
        ...
        28: 'พยานเท็จจะต้องพินาศ แต่คนที่พูดอย่างซื่อสัตย์นั้นฟังได้',
    ...
    22: {
        ...
        6: 'จงฝึกเด็กในทางที่เขาควรจะเดินไป และเมื่อเขาเติบโตแล้ว เขาจะไม่พรากจากทางนั้น',
        7: 'คนมั่งคั่งปกครองเหนือคนยากจน และคนขอยืมก็เป็นทาสของคนให้ยืม',
        8: 'บุคคลผู้หว่านความชั่วช้าจะเกี่ยวความหายนะ และไม้เรียวแห่งความโกรธของเขาจะล้มเหลว',
        ...
        21: 'เพื่อเราจะให้เจ้าทราบถึงความแน่นอนของถ้อยคำแห่งความจริง เพื่อเจ้าจะได้ตอบถ้อยคำแห่งความจริงแก่ผู้ที่ใช้เจ้าไป',
    ...
    23: {
        ...
        5: 'เจ้าจะเพ่งตาของเจ้าอยู่ที่ของอนิจจังหรือ เพราะแน่นอนทีเดียวทรัพย์สมบัติมีปีก มันจะบินไปในท้องฟ้าเหมือนนกอินทรี',
        6: 'อย่ากินอาหารของคนที่มีแววตาอันชั่วร้าย อย่าปรารถนาของโอชะของเขา',
        ...
        35: 'เจ้าจะว่า “เขาตีข้า แต่ข้าไม่เจ็บ เขาทุบข้า แต่ข้าไม่รู้สึก ข้าจะตื่นเมื่อไรหนอ ข้าจะแสวงหาการดื่มอีก”',
    },
    24: {
        ...
        12: 'ถ้าเจ้าจะว่า “ดูเถิด เราไม่รู้เรื่องนี้เลย” พระองค์ผู้ทรงชั่งใจจะไม่ทรงเพ่งเล็งเห็นหรือ พระองค์ผู้ทรงเฝ้าวิญญาณอยู่เหนือเจ้าจะไม่ทราบหรือ และพระองค์จะไม่ทรงเรียกเอาจากทุกคนตามการกระทำของเขาหรือ',
        ...
        29: 'อย่ากล่าวว่า “ข้าจะทำแก่เขาอย่างที่เขาได้กระทำแก่ข้า ข้าจะทำตอบแก่เขาอย่างที่เขาได้กระทำ”',
        ...
        34: 'แล้วความยากจนจะมาหาเจ้าอย่างนักท่องเที่ยว ความขัดสนอย่างคนถืออาวุธ”',
    },
    25: {
        ...
        12: 'คนตักเตือนที่ฉลาดกับหูที่เชื่อฟังก็เหมือนตุ้มหูทองคำหรืออาภรณ์ทองคำเนื้อดี',
        ...
        23: 'ลมเหนือไล่ฝนไปเสียฉันใด สีหน้าที่โกรธแค้นก็ไล่ลิ้นที่ส่อเสียดไปเสียฉันนั้น',
    ...
    27: {
        ...
        2: 'จงให้คนอื่นยกย่องเจ้า และไม่ใช่ปากของเจ้าเอง ให้คนต่างถิ่นยกย่อง ไม่ใช่ริมฝีปากของเจ้าเอง',
        3: 'หินก็หนัก และทรายก็มีน้ำหนัก แต่ความกริ้วโกรธของคนโง่ก็หนักยิ่งกว่าทั้งสองอย่างนั้น',
        ...
        10: 'อย่าทอดทิ้งมิตรของเจ้าเอง และมิตรของบิดาเจ้า และอย่าเข้าไปในเรือนพี่น้องของเจ้าในวันที่เจ้าประสบหายนะ เพราะเพื่อนบ้านสักคนที่อยู่ใกล้ดีกว่าพี่น้องคนหนึ่งที่อยู่ห่างไกล',
        11: 'บุตรชายของเราเอ๋ย จงฉลาดและกระทำให้ใจของเรายินดี เพื่อเราจะตอบบุคคลที่ตำหนิเราได้',
    ...
    28: {
        ...
        4: 'บรรดาผู้ที่ทอดทิ้งพระราชบัญญัติย่อมยกย่องคนชั่วร้าย แต่บรรดาผู้ที่รักษาพระราชบัญญัติย่อมคอยต่อสู้เขา',
        ...
        17: 'คนใดที่ทำรุนแรงต่อโลหิตของคนอื่น คนนั้นก็เป็นคนหลบหนีอยู่จนลงไปสู่ปากแดน อย่าให้ใครช่วยเขาเลย',
        18: 'บุคคลที่ดำเนินในความเที่ยงธรรมจะได้รับการช่วยให้รอด แต่คนที่มีเล่ห์กะเท่ห์ในทางทั้งหลายของเขาเองจะล้มลงทันที',
    ...
    29: {
        1: 'บุคคลที่ถูกตักเตือนบ่อยๆ แต่ยังทำคอแข็ง ประเดี๋ยวจะถูกทำลาย จึงรักษาไม่ได้',
        ...
        10: 'คนที่กระหายเลือดย่อมเกลียดคนเที่ยงธรรม แต่คนชอบธรรมแสวงหาชีวิตของเขา',
        ...
        15: 'ไม้เรียวและคำตักเตือนทำให้เกิดปัญญา แต่ถ้าปล่อยเด็กไว้แต่ลำพังจะนำความอับอายมาสู่มารดาของตน',
        ...
        19: 'สักแต่ใช้คำพูดเท่านั้นจะฝึกสอนคนใช้ไม่ได้ เพราะถึงแม้เขาเข้าใจ แต่เขาก็จะไม่ตอบสนอง',
        20: 'เจ้าเห็นคนที่ปากไวหรือ ยังมีหวังในคนโง่มากกว่าเขา',
        21: 'บุคคลที่ทะนุถนอมคนใช้ของตนตั้งแต่เด็กๆ ที่สุดจะเห็นว่าเขากลายเป็นบุตรชายของตน',
        ...
        25: 'การกลัวมนุษย์ก็เป็นบ่วงดักไว้ แต่บุคคลที่วางใจในพระเยโฮวาห์ก็จะปลอดภัย',
        26: 'คนเป็นอันมากแสวงหาความพอใจจากผู้ครอบครอง แต่ทุกคนจะได้ความยุติธรรมจากพระเยโฮวาห์',
        27: 'คนไม่ชอบธรรมเป็นที่สะอิดสะเอียนแก่คนชอบธรรม แต่คนเที่ยงธรรมในทางของเขากลับเป็นที่สะอิดสะเอียนแก่คนชั่วร้าย',
    },
    30: {
        1: 'ถ้อยคำของอากูร์ บุตรชายของยาเคห์ คือคำพยากรณ์นั้น ชายคนนั้นพูดกับอิธีเอล คือกับอิธีเอลและอูคาล ว่า',
        2: 'แท้จริงข้าก็เขลากว่าคนใด ข้าไม่มีความเข้าใจอย่างมนุษย์',
        3: 'ข้าไม่เคยเรียนรู้ปัญญา ทั้งไม่มีความรู้ขององค์ผู้บริสุทธิ์',
        4: 'ใครเล่าได้ขึ้นไปยังสวรรค์หรือลงมา ใครเล่าได้รวบรวมลมไว้ในกำมือของท่าน ใครเล่าได้เอาเครื่องแต่งกายห่อห้วงน้ำไว้ ใครเล่าได้สถาปนาที่สุดปลายแห่งแผ่นดินโลกไว้ นามของผู้นั้นว่ากระไร และนามบุตรชายของผู้นั้นว่ากระไร ถ้าท่านบอกได้',
        ...
        9: 'เกรงว่าข้าพระองค์จะอิ่ม และปฏิเสธพระองค์ แล้วพูดว่า “พระเยโฮวาห์เป็นผู้ใดเล่า” หรือเกรงว่าข้าพระองค์จะยากจนและขโมย และออกพระนามพระเจ้าของข้าพระองค์อย่างไร้ค่า',
        ...
        14: 'มีคนชั่วอายุหนึ่งที่ฟันของเขาเป็นเหมือนดาบ เขี้ยวของเขาเป็นเหมือนมีด เพื่อจะกลืนกินคนยากจนเสียจากแผ่นดินโลก และคนขัดสนเสียจากท่ามกลางมนุษย์',
        ...
        17: 'นัยน์ตาที่เยาะเย้ยบิดาและดูถูกไม่ฟังมารดาจะถูกนกกาแห่งหุบเขาจิกออกและนกอินทรีหนุ่มจะกินเสีย',
        ...
        31: 'สุนัขล่าเนื้อ แพะผู้ด้วย และกษัตริย์ผู้ซึ่งไม่มีใครก่อการกบฏ',
        32: 'ถ้าเจ้าเป็นคนโง่ยกย่องตนเอง หรือคิดแผนการชั่วร้าย จงเอามือปิดปากของเจ้าเสียเถิด',
        33: 'เพราะเมื่อกวนน้ำนมก็ได้เนยข้น เมื่อบีบจมูกก็ได้โลหิต และเมื่อกวนโทโสก็ได้การวิวาท',
    },
    31: {
        1: 'ถ้อยคำของกษัตริย์เลมูเอล คือคำพยากรณ์ที่พระราชมารดาได้สอนไว้แก่พระองค์',
        ...
        6: 'จงให้สุราแก่ผู้ที่กำลังจะพินาศ และเหล้าองุ่นแก่ผู้ที่ทุกข์ใจอย่างขมขื่น',
        ...
        16: 'เธอพิเคราะห์ดูไร่นาแล้วก็ซื้อไว้ ด้วยผลแห่งน้ำมือของเธอ เธอปลูกสวนองุ่น',
        ...
        25: 'กำลังและเกียรติยศเป็นเครื่องนุ่งห่มของเธอ เธอจะปลื้มปีติในอนาคต',
        ...
        28: 'ลูกๆของเธอตื่นขึ้นมาก็ชมเชยเธอ สามีของเธอก็ยกย่องเธอ',
        29: 'ว่า “สตรีเป็นอันมากทำอย่างดีเลิศ แต่เธอเลิศยิ่งกว่าเขาทั้งหมด”',
        30: 'เสน่ห์เป็นของหลอกลวง และความงามก็เปล่าประโยชน์ แต่สตรียำเกรงพระเยโฮวาห์จะได้รับการยกย่อง',
        31: 'จงให้เธอรับผลแห่งน้ำมือของเธอ และให้การงานของเธอยกย่องเธอที่ประตูเมือง',
    },
}
