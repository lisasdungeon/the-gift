...
CHAPTERS = {
    1: {
        1: 'Tại trong xứ Uùt-xơ có một người tên là Gióp; người ấy vốn trọn vẹn và ngay thẳng; kính sợ Ðức Chúa Trời, và lánh khỏi điều ác.',
        ...
        6: 'Vả, một ngày kia các con trai của Ðức Chúa Trời đến ra mắt Ðức Giê-hô-va, và Sa-tan cũng đến trong vòng chúng.',
    ...
    2: {
        1: 'Xảy ra một ngày kia, các con trai của Ðức Chúa Trời đến ra mắt Ðức Giê-hô-va, Sa-tan cũng có đến trong vòng chúng đặng ra mắt Ðức Giê-hô-va.',
        2: 'Ðức Giê-hô-va bèn phán hỏi Sa-tan rằng: Ngươi ở đâu đến? Sa-tan thưa cùng Ðức Giê-hô-va rằng: Tôi trải qua đây đó trên đất và dạo chơi tại nơi nó.',
        3: 'Ðức Giê-hô-va lại phán hỏi Sa-tan rằng: Ngươi có nhìn thấy Gióp, tôi tớ ta chăng? Trên đất chẳng có ai giống như người, vốn trọn vẹn và ngay thẳng, kính sợ Ðức Chúa Trời, và lánh khỏi đều ác; lại người bền đỗ trong sự hoàn toàn mình, mặc dầu ngươi có giục ta phá hủy người vô cớ.',
        4: 'Sa-tan thưa lại với Ðức Giê-hô-va rằng: Lấy da đền da, phàm vật chi một người có, tất sẽ trao thế cho mạng sống mình.',
        5: 'Nhưng bây giờ xin Chúa hãy giơ tay ra, đụng đến hại xương thịt người, ắt là người sẽ phỉ báng Chúa trước mặt.',
        6: 'Ðức Giê-hô-va phán với Sa-tan rằng: Kìa, người ở trong tay ngươi; nhưng chỉ hãy giữ mạng sống người.',
        7: 'Sa-tan bèn lui ra trước mặt Ðức Giê-hô-va, hành hại Gióp một bịnh ung độc, từ bàn chơn cho đến chót đầu.',
        8: 'Gióp lấy một miếng sành đặng gãi mình, và ngồi trong đống tro.',
        9: 'Vợ Gióp nói với người rằng: Uûa? Ông hãy còn bền đỗ trong sự hoàn toàn mình sao? Hãy phỉ báng Ðức Chúa Trời, và chết đi!',
        10: 'Người đáp lại rằng: Ngươi nói như một người đờn bà ngu muội. Uûa sao! Sự phước mà tay Ðức Chúa Trời ban cho chúng ta, chúng ta lãnh lấy, còn sự tai họa mà tay Ngài giáng trên chúng ta, lại chẳng lãnh lấy sao? Trong mọi việc đó, Gióp không phạm tội bởi môi miệng mình.',
        11: 'Vả, khi ba bạn hữu của Gióp, là Ê-li-pha người Thê-man, Binh-đát người Su-a, và Sô-pha người Na-a-ma, hay được các tai nạn đã xảy đến cho người, mỗi người bèn hẹn nhau từ xứ mình đi đến đặng chia buồn và an ủy người.',
        12: 'Ba bạn hữu ở xa ngước mắt lên thì chẳng nhận biết người, bèn cất tiếng khóc, mỗi người xé áo mình, hất bụi lên trời mà vãi trên đầu mình.',
        13: 'Ðoạn, ba bạn ngồi xuống đất với người trong bảy ngày đêm, chẳng ai nói một lời với người, vì thấy sự đau đớn người lớn lắm.',
    },
    3: {
    ...
    13: {
        ...
        2: 'Ðiều gì các ngươi biết, ta cũng biết với. Ta chẳng kém hơn các người đâu.',
        3: 'Song ta muốn thưa với Ðấng Toàn năng, Ước ao biện luận cùng Ðức Chúa Trời:',
        4: 'Còn các ngươi là kẻ đúc rèn lời dối trá; Thảy đều là thầy thuốc không ra gì hết.',
        5: 'Chớ chi các ngươi nín lặng! Ðó sẽ là sự khôn ngoan của các ngươi.',
        6: 'Vậy, hãy nghe lời biện luận của ta, Khá chăm chỉ về lẽ đối nại của miệng ta.',
        7: 'Có phải các ngươi dám nói lời bất công với Ðức Chúa Trời chăng? Các ngươi há sẽ nói điều dối trá vì Ngài sao?',
        8: 'Các ngươi há muốn tây vị Ðức Chúa Trời, Và cãi lẽ cho Ngài sao?',
        ...
        22: 'Ðoạn, hãy gọi tôi, tôi sẽ thưa lại, Hoặc tôi nói thì Chúa sẽ trả lời cho tôi.',
        ...
        27: 'Ðặt chơn tôi trong xiềng tỏa, Xét các đường lối tôi, Và ghi ranh hạng chung quanh bước chơn tôi,',
    ...
    42: {
        1: 'Gióp thưa với Ðức Chúa Trời rằng:',
        ...
        7: 'Xảy sau khi Ðức Giê-hô-va đã phán các lời ấy với Gióp, thì Ngài phán cùng Ê-li-pha, người Thê-man, mà rằng: Cơn thạnh nộ ta nổi lên cùng ngươi và hai bạn hữu ngươi; bởi vì các ngươi không có nói về ta cách xứng đáng, y như Gióp, kẻ tôi tớ ta, đã nói.',
