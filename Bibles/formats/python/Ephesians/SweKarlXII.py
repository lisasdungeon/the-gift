...
CHAPTERS = {
    1: {
        ...
        10: 'Att det skulle predikadt varda, då tiden fullkomnad var; på det allting skulle sammanfattad varda i Christo, både det i himmelen och på jordene är, genom den sammas;',
        ...
        19: 'Och huru öfversvinneliga stor hans kraft är till oss, som tron, efter hans mägtiga starkhets verkan;',
    ...
    2: {
        ...
        19: 'Så ären I icke nu mera gäster och främmande; utan helga manna medborgare, och Guds husfolk;',
    ...
    3: {
        ...
        8: 'Mig, som är den aldra ringaste ibland all helgon, är denna nåd gifven, att jag skall ibland Hedningarna förkunna de obegrundeliga Christi rikedomar;',
        ...
        10: 'På det nu skulle kunnigt varda Förstadömen och Herradömen i himmelen, på församlingene, Guds mångfaldeliga vishet;',
    ...
    4: {
        ...
        13: 'Till dess att vi alle kommom till ena tro, och Guds Sons kunskap, och vardom en fullkommen man, den der är uti Christi fullbordiga ålders mått;',
        ...
        26: 'Vredgens och synder icke; läter icke solena gå ned öfver edra vrede.',
    ...
    5: {
        ...
        3: 'Boleri och all slemhet, eller girighet läter ibland eder icke ens nämnda varda, såsom helgon tillhörer;',
        ...
        6: 'Läter eder ingen förföra med fåfäng ord; ty för sådana plägar Guds vrede komma öfver otrones barn.',
        ...
        26: 'På det han henne helga skulle, och hafver gjort henne rena i vattnens bad, genom ordet;',
        ...
        31: 'Fördenskull skall menniskan öfvergifva sin fader och moder, och blifva vid sin hustru, och af tväm varder ett kött.',
    ...
    6: {
        ...
        7: 'Med välviljoghet läter eder tycka, att I tjenen Herranom, och icke menniskom;',
