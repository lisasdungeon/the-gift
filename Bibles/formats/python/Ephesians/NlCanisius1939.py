...
CHAPTERS = {
    1: {
        ...
        21: 'hoog boven alle heerschappij en macht en kracht en hoogheid, en boven elke naam, die genoemd wordt in deze wereld niet alleen, maar ook in de toekomstige wereld;',
    ...
    2: {
        ...
        2: 'waarin gij eertijds geleefd hebt in navolging van deze aardse wereld, in navolging ook van den vorst der macht in de lucht, van den vorst van de geest, die nog altijd werkt in de zonen der ongehoorzaamheid.',
    ...
    3: {
        ...
        21: 'aan Hem zij de glorie in de Kerk en in Christus Jesus ten allen tijde, van eeuwigheid tot eeuwigheid. Amen!',
    },
    4: {
    ...
    6: {
        ...
        12: 'Want niet tegen vlees en bloed geldt onze strijd, maar tegen heerschappijen en machten, tegen wereldbeheersers dezer duisternis, tegen de boze geesten in de lucht.',
