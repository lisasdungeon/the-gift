...
CHAPTERS = {
    1: {
        ...
        21: 'langt over al Magt og Myndighed og Kraft og Herredom og hvert Navn, som nævnes, ikke alene i denne Verden, men ogsaa i den kommende,',
    ...
    2: {
        ...
        2: 'hvori I fordum vandrede efter denne Verdens Tidsaand, efter hans Vis, som hersker over Luftens Magt, over den Aand, der nu er virksom i Genstridighedens Børn,',
        ...
        7: 'for at han i de tilkommende Tider kunde vise sin Naades overvættes Rigdom ved Godhed imod os i Kristus Jesus.',
