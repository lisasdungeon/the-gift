...
CHAPTERS = {
    ...
    4: {
        ...
        14: 'ινα μηκετι ωμεν νηπιοι κλυδωνιζομενοι και περιφερομενοι παντι ανεμω της διδασκαλιας εν τη κυβεια των ανθρωπων εν πανουργια προς την μεθοδειαν μεθοδιαν της πλανης',
    ...
    5: {
        ...
        21: 'υποτασσομενοι αλληλοις εν φοβω χριστου θεου',
    ...
    6: {
        ...
        17: 'και την περικεφαλαιαν του σωτηριου δεξασθαι και την μαχαιραν του πνευματος ο εστιν ρημα θεου',
