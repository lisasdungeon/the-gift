...
CHAPTERS = {
    ...
    3: {
        ...
        17: 'κατοικησαι τον χριστον δια της πιστεως εν ταις καρδιαις υμων (3:18) εν αγαπη ερριζωμενοι και τεθεμελιωμενοι',
        18: 'ινα εξισχυσητε καταλαβεσθαι συν πασιν τοις αγιοις τι το πλατος και μηκος και βαθος και υψος',
    ...
    6: {
        ...
        24: 'η χαρις μετα παντων των αγαπωντων τον κυριον ημων ιησουν χριστον εν αφθαρσια αμην [προς εφεσιους εγραφη απο ρωμης δια τυχικου]',
    },
}
