...
CHAPTERS = {
    ...
    2: {
        1: 'Voici sur les montagnes les pieds de celui qui apporte de bonnes nouvelles, de celui qui annonce la paix! Juda, célèbre tes fêtes, acquitte tes vœux; car le méchant ne passera plus par toi, il est entièrement retranché.',
        ...
        3: 'Car l’ Éternel a ramené la gloire de Jacob comme la gloire d’Israël; car ceux qui dépouillent les ont dépouillés et ont gâté leurs sarments.',
        4: 'Le bouclier de ses hommes forts est teint en rouge, les hommes vaillants sont vêtus d’écarlate, l’acier fait étinceler les chars, au jour où il se prépare, et les [lances de] cyprès sont brandies.',
