...
CHAPTERS = {
    ...
    8: {
        ...
        9: 'Or ceux qui avaient mangé étaient environ 4 000. Et il les renvoya.',
        10: 'Et aussitôt, montant dans un bateau avec ses disciples, il vint aux quartiers de Dalmanutha.',
    ...
    10: {
        ...
        30: 'qui n’en reçoive maintenant, en ce temps-ci, 100 fois autant, maisons, et frères, et sœurs, et mères, et enfants, et champs, avec des persécutions, et dans le siècle qui vient, la vie éternelle.',
    ...
    12: {
        ...
        11: 'celle-ci est de par le ✶Seigneur, et est merveilleuse devant nos yeux »?',
        ...
        14: 'Et étant venus, ils lui disent: Maître, nous savons que tu es vrai, et que tu ne t’embarrasses de personne; car tu ne regardes pas à l’apparence des hommes, mais tu enseignes la voie de Dieu avec vérité. Est-il permis de payer le tribut à César, ou non? Paierons-nous, ou ne paierons-nous pas?',
        ...
        28: 'Et l’un des scribes, qui les avait entendus disputer, voyant qu’il leur avait bien répondu, s’approcha et lui demanda: Quel est le premier de tous les commandements?',
