...
CHAPTERS = {
    ...
    3: {
        ...
        20: 'Et pour vous qui craignez mon nom, se lèvera le soleil de justice; et la guérison sera dans ses ailes; et vous sortirez, et vous prospérerez comme des veaux à l’engrais.',
        21: 'Et vous foulerez les méchants, car ils seront de la cendre sous la plante de vos pieds, au jour que je ferai, dit l’ Éternel des armées.',
        22: 'Souvenez-vous de la loi de Moïse, mon serviteur, que je lui commandai en Horeb pour tout Israël, – des statuts et des ordonnances.',
        23: 'Voici, je vous envoie Élie, le prophète, avant que vienne le grand et terrible jour de l’ Éternel.',
        24: 'Et il fera retourner le cœur des pères vers les fils, et le cœur des fils vers leurs pères, de peur que je ne vienne et ne frappe le pays de malédiction.',
    },
}
