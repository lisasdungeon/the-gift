...
CHAPTERS = {
    1: {
        1: 'Et aux jours d’Assuérus (cet Assuérus régnait depuis l’Inde jusqu’à l’Éthiopie sur 127 provinces),',
    ...
    2: {
        ...
        14: 'Le soir elle allait, et le matin elle s’en revenait à la seconde maison des femmes, sous la surveillance de Shaashgaz, eunuque du roi, gardien des concubines. Elle n’entrait plus auprès du roi, à moins que le roi ne trouve plaisir en elle, et qu’elle ne soit appelée par [son] nom.',
    ...
    3: {
        ...
        9: 'Si le roi le trouve bon, qu’on écrive [l’ordre] de les détruire, et je pèserai 10 000 talents d’argent entre les mains de ceux qui font les affaires, pour qu’on les porte dans le trésor du roi.',
    ...
    4: {
        ...
        7: 'Et Mardochée l’informa de tout ce qui lui était arrivé, et de la somme d’argent qu’Haman avait dit qu’il paierait au trésor du roi en vue des Juifs, pour les détruire;',
    ...
    8: {
        ...
        13: 'Pour que l’édit soit rendu [public] dans chaque province, une copie de l’écrit fut portée à la connaissance de tous les peuples, afin que les Juifs soient prêts pour ce jour-là, pour se venger de leurs ennemis.',
    ...
    9: {
        ...
        6: 'Et à Suse, la capitale, les Juifs tuèrent et firent périr 500 hommes,',
        ...
        12: 'Et le roi dit à la reine Esther: Les Juifs ont tué et fait périr dans Suse, la capitale, 500 hommes et les dix fils d’Haman; qu’auront-ils fait dans les autres provinces du roi? Et quelle est ta demande? elle te sera accordée. Et quelle est encore ta requête? et ce sera fait.',
        ...
        15: 'Et les Juifs qui étaient à Suse s’assemblèrent aussi le quatorzième jour du mois d’Adar, et ils tuèrent dans Suse 300 hommes; mais ils ne mirent pas la main sur le butin.',
        16: 'Et le reste des Juifs qui étaient dans les provinces du roi s’assemblèrent et se mirent en défense pour leur vie, et eurent du repos de leurs ennemis; et ils tuèrent 75 000 de ceux qui les haïssaient; mais ils ne mirent pas la main sur le butin:',
        ...
        25: 'Et quand [Esther] vint devant le roi, il ordonna, par lettres, que le méchant dessein qu’[Haman] avait tramé contre les Juifs retombe sur sa propre tête, et on le pendit au bois, lui et ses fils.',
        ...
        30: 'et à tous les Juifs dans les 127 provinces du royaume d’Assuérus, il envoya des lettres [avec] des paroles de paix et de vérité,',
