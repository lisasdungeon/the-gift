...
CHAPTERS = {
    ...
    7: {
        ...
        11: 'Si donc la perfection était par la sacrificature lévitique, (car c’est en relation avec elle que le peuple a reçu sa loi,) quel besoin était-il encore qu’un autre sacrificateur se lève selon l’ordre de Melchisédec et qui ne soit pas nommé selon l’ordre d’Aaron?',
    ...
    9: {
        ...
        26: '(puisque [dans ce cas] il aurait fallu qu’il souffre plusieurs fois depuis la fondation du monde); mais maintenant, en la consommation des siècles, il a été manifesté une fois pour l’abolition du péché par son sacrifice.',
    ...
    11: {
        ...
        5: 'Par la foi, Énoch fut enlevé pour qu’il ne voie pas la mort; et il ne fut pas trouvé, parce que Dieu l’avait enlevé; car, avant son enlèvement, il a reçu le témoignage d’avoir plu à Dieu.',
        ...
        37: 'ils furent lapidés, sciés, tentés; ils moururent égorgés par l’épée; ils errèrent çà et là, vêtus de peaux de brebis, de peaux de chèvres, dans le besoin, affligés, maltraités,',
    ...
    13: {
        ...
        21: 'vous rende accomplis en toute bonne œuvre pour faire sa volonté, faisant en vous ce qui est agréable devant lui, par Jésus Christ, auquel soit la gloire aux siècles des siècles! Amen.',
