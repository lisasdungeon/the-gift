...
CHAPTERS = {
    ...
    8: {
        ...
        6: 'Or ils disaient cela pour l’éprouver, afin qu’ils aient de quoi l’accuser. Mais Jésus, s’étant baissé, écrivait avec le doigt sur la terre.',
        ...
        26: 'J’ai beaucoup de choses à dire de vous et à juger; mais celui qui m’a envoyé est vrai, et les choses que j’ai entendues de lui, moi, je les dis au monde.',
        ...
        33: 'Ils lui répondirent: Nous sommes la postérité d’Abraham, et jamais nous n’avons été dans la servitude de personne; comment dis-tu, toi: Vous serez rendus libres?',
        ...
        40: 'mais maintenant vous cherchez à me faire mourir, moi, un homme qui vous ai dit la vérité que j’ai entendue de Dieu: Abraham n’a pas fait cela.',
        ...
        43: 'Pourquoi n’entendez-vous pas mon langage? Parce que vous ne pouvez pas entendre ma parole.',
        ...
        57: 'Les Juifs donc lui dirent: Tu n’as pas encore 50 ans, et tu as vu Abraham!',
    ...
    9: {
        ...
        32: 'Jamais on n’entendit dire que quelqu’un ait ouvert les yeux d’un aveugle-né.',
