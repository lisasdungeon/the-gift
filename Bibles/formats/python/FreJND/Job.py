...
CHAPTERS = {
    1: {
        ...
        3: 'et il possédait 7 000 brebis, et 3 000 chameaux, et 500 paires de bœufs, et 500 ânesses; et [il avait] un très grand nombre de serviteurs; et cet homme était plus grand que tous les fils de l’orient.',
        ...
        19: 'et voici, un grand vent est venu d’au-delà du désert et a donné contre les quatre coins de la maison, et elle est tombée sur les jeunes gens et ils sont morts; et j’ai échappé, moi seul, pour te l’annoncer.',
        ...
        22: 'En tout cela Job ne pécha pas, et n’attribua rien à Dieu qui soit inconvenable.',
    },
    2: {
    ...
    41: {
        1: 'Voici, on est déçu dans son attente; même à sa vue, n’est-on pas terrassé?',
        2: 'Nul n’est assez hardi pour le réveiller; et qui est celui qui se présentera devant moi?',
        3: 'Qui m’a prévenu, et je lui rendrai? Tout ce qui est sous les cieux est à moi.',
        ...
        7: 'Il est magnifique par la force de ses boucliers étroitement unis comme par un sceau;',
        ...
        16: 'Son cœur est dur comme une pierre, dur comme la meule inférieure.',
        17: 'Quand il se lève, les forts ont peur, ils s’enfuient saisis d’épouvante.',
        18: 'Quand on l’atteint de l’épée, elle n’a aucun effet, ni la lance, ni le dard, ni la cuirasse.',
        19: 'Il estime le fer comme de la paille, l’airain comme du bois vermoulu.',
        20: 'La flèche ne le met pas en fuite; les pierres de fronde se changent pour lui en du chaume.',
        21: 'Il estime la massue comme du chaume, et il se rit du bruit du javelot.',
        ...
        26: 'Il regarde tout ce qui est élevé; il est roi sur tous les fiers animaux.',
    },
    42: {
