...
CHAPTERS = {
    1: {
        ...
        23: 'Et Elkana, son mari, lui dit: Fais ce qui est bon à tes yeux, demeure jusqu’à ce que tu l’aies sevré; seulement, que l’ Éternel accomplisse sa parole! Et la femme demeura, et elle allaita son fils jusqu’à ce qu’elle l’ait sevré.',
    ...
    2: {
        ...
        15: 'Même, avant qu’on ait fait fumer la graisse, le serviteur du sacrificateur venait, et disait à l’homme qui sacrifiait: Donne de la chair à rôtir pour le sacrificateur; et il ne prendra pas de toi de la chair bouillie, mais [de la chair] crue.',
    ...
    12: {
        ...
        3: 'Me voici, témoignez contre moi, devant l’ Éternel et devant son oint. De qui ai-je pris le bœuf? ou de qui ai-je pris l’âne? ou à qui ai-je fait tort? à qui ai-je fait violence? ou de la main de qui ai-je pris un présent pour que par lui j’aie fermé mes yeux? et je vous le rendrai.',
    ...
    13: {
        ...
        4: 'Et tout Israël entendit dire: Saül a frappé le poste des Philistins, et aussi Israël est détesté par les Philistins. Et le peuple se rassembla auprès de Saül à Guilgal.',
        5: 'Et les Philistins s’assemblèrent pour faire la guerre à Israël: 30 000 chars, et 6 000 cavaliers, et un peuple nombreux comme le sable qui est sur le bord de la mer; et ils montèrent et campèrent à Micmash, à l’orient de Beth-Aven.',
        ...
        15: 'Et Samuel se leva et monta de Guilgal à Guibha de Benjamin. Et Saül dénombra le peuple qui se trouvait avec lui, environ 600 hommes.',
    ...
    14: {
        ...
        2: 'Et Saül se tenait à l’extrémité de Guibha, sous un grenadier qui était à Migron; et le peuple qui était avec lui était d’environ 600 hommes.',
    ...
    21: {
        ...
        2: '*Et David vint à Nob, auprès d’Akhimélec, le sacrificateur; et Akhimélec trembla en rencontrant David, et lui dit: Pourquoi es-tu seul et n’y a-t-il personne avec toi?',
        3: 'Et David dit à Akhimélec, le sacrificateur: Le roi m’a commandé quelque chose, et m’a dit: Que personne ne sache rien de l’affaire pour laquelle je t’envoie, ni de ce que je t’ai commandé. Et j’ai indiqué à mes jeunes hommes un certain lieu.',
        4: 'Et maintenant, qu’as-tu sous la main? Donne-moi dans la main cinq pains, ou ce qui se trouvera.',
        5: 'Et le sacrificateur répondit à David, et dit: Je n’ai point sous la main de pain commun, il n’y a que du pain sacré; si seulement les jeunes hommes se sont gardés des femmes!',
        6: 'Et David répondit au sacrificateur, et lui dit: Oui, nous avons été privés des femmes depuis deux ou trois jours que je suis sorti, et les vases de mes jeunes hommes sont saints; et le [pain] est en quelque sorte commun, vu qu’on en consacre [de nouveau] dans les vases aujourd’hui.',
        7: 'Et le sacrificateur lui donna du [pain] sacré, car il n’y avait point là d’autre pain que le pain de proposition qui avait été ôté de devant l’ Éternel pour remettre du pain chaud le jour où on levait l’autre.',
        8: 'Et il y avait là un homme d’entre les serviteurs de Saül, retenu ce jour-là devant l’ Éternel, et son nom était Doëg, l’Édomite; il était le chef des bergers de Saül.',
        9: 'Et David dit à Akhimélec: N’as-tu pas ici sous la main une lance ou une épée? car je n’ai pris dans ma main ni mon épée ni mes armes, parce que l’affaire du roi était pressante.',
        10: 'Et le sacrificateur dit: L’épée de Goliath, le Philistin, que tu as frappé dans la vallée d’Éla, la voilà, enveloppée dans un manteau derrière l’éphod: si tu veux la prendre, prends-la; car il n’y en a point d’autre ici que celle-là. Et David dit: Il n’y en a point de pareille; donne-la-moi.',
        ...
        16: 'Manqué-je de fous, moi, que vous m’ayez amené celui-ci pour faire le fou devant moi? Celui-ci entrerait-il dans ma maison?',
    },
    22: {
    ...
    23: {
        ...
        13: 'Et David se leva, et ses hommes, environ 600 hommes, et ils sortirent de Kehila et s’en allèrent où ils purent. Et on rapporta à Saül que David s’était échappé de Kehila, et il s’abstint d’entrer en campagne.',
    ...
    29: {
        ...
        3: 'Et les chefs des Philistins dirent: Que sont ces Hébreux? Et Akish dit aux chefs des Philistins: N’est-ce pas David, serviteur de Saül, roi d’Israël, qui a été avec moi tant de jours [déjà], ou tant d’années? et je n’ai rien trouvé en lui, depuis le jour où il est tombé chez moi jusqu’à ce jour.',
        ...
        8: 'Et David dit à Akish: Mais qu’ai-je fait? et qu’as-tu trouvé en ton serviteur, depuis le jour où j’ai été devant toi jusqu’à ce jour, pour que je ne puisse pas aller et combattre contre les ennemis du roi, mon seigneur?',
    ...
    31: {
        ...
        13: 'Et ils prirent leurs os, et les enterrèrent sous le tamaris de Jabès, et jeûnèrent sept jours.',
    },
}
