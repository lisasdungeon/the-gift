...
CHAPTERS = {
    ...
    3: {
        ...
        7: 'Et à l’ange de l’assemblée qui est à Philadelphie, écris: Voici ce que dit le saint, le véritable, celui qui a la clé de David, celui qui ouvre et nul ne fermera, qui ferme et nul n’ouvrira:',
    ...
    8: {
        ...
        12: 'Et le quatrième ange sonna de la trompette: et le tiers du soleil fut frappé, et le tiers de la lune, et le tiers des étoiles, afin que le tiers de ces [astres] soit obscurci, et que le jour ne paraisse pas pour le tiers de sa [durée], et de même pour la nuit.',
    ...
    9: {
        1: 'Et le cinquième ange sonna de la trompette: et je vis une étoile tombée du ciel sur la terre; et la clé du puits de l’abîme lui fut donnée,',
        ...
        4: 'Et il leur fut dit qu’elles ne nuisent ni à l’herbe de la terre, ni à aucune verdure, ni à aucun arbre, mais aux hommes qui n’ont pas le sceau de Dieu sur leurs fronts.',
        5: 'Et il leur fut donné de ne pas les tuer, mais qu’ils soient tourmentés cinq mois; et leur tourment est comme le tourment du scorpion, quand il frappe l’homme.',
        ...
        13: 'Et le sixième ange sonna de la trompette: et j’entendis une voix sortant des [quatre] cornes de l’autel d’or qui était devant Dieu,',
    ...
    11: {
        ...
        2: 'et le parvis, qui est en dehors du temple, rejette-le et ne le mesure point, car il a été donné aux nations, et elles fouleront aux pieds la cité sainte 42 mois.',
        3: 'Et je donnerai [puissance] à mes deux témoins, et ils prophétiseront 1 260 jours, vêtus de sacs.',
        ...
        12: 'Et j’entendis une grande voix venant du ciel, leur disant: Montez ici. Et ils montèrent au ciel dans la nuée, et leurs ennemis les contemplèrent.',
        13: 'Et à cette heure-là, il y eut un grand tremblement de terre; et la dixième partie de la ville tomba, et 7 000 noms d’hommes furent tués dans le tremblement de terre; et les autres furent épouvantés et donnèrent gloire au Dieu du ciel.',
        ...
        16: 'Et les 24 anciens qui sont assis devant Dieu sur leurs trônes, tombèrent sur leurs faces et rendirent hommage à Dieu,',
    ...
    12: {
        ...
        6: 'Et la femme s’enfuit dans le désert, où elle a un lieu préparé par Dieu, afin qu’on la nourrisse là 1 260 jours.',
        ...
        10: 'Et j’entendis une grande voix dans le ciel, disant: Maintenant est venu le salut et la puissance et le royaume de notre Dieu et le pouvoir de son Christ, car l’accusateur de nos frères, qui les accusait devant notre Dieu jour et nuit, a été précipité;',
    ...
    13: {
        ...
        5: 'Et il lui fut donné une bouche qui proférait de grandes choses et des blasphèmes; – et le pouvoir d’agir 42 mois lui fut donné.',
        ...
        15: 'Et il lui fut donné de donner la respiration à l’image de la bête, afin que l’image de la bête parle même, et qu’elle fasse que tous ceux qui ne rendraient pas hommage à l’image de la bête soient mis à mort.',
        ...
        18: 'Ici est la sagesse. Que celui qui a de l’intelligence compte le nombre de la bête, car c’est un nombre d’homme; et son nombre est 666.',
    },
    14: {
    ...
    16: {
        1: 'Et j’entendis une grande voix venant du temple, disant aux sept anges: Allez, et versez sur la terre les sept coupes du courroux de Dieu.',
        ...
        12: 'Et le sixième versa sa coupe sur le grand fleuve Euphrate; et son eau tarit, afin que la voie des rois qui viennent de l’orient soit préparée.',
    ...
    20: {
        ...
        2: 'Et il saisit le dragon, le serpent ancien qui est le diable et Satan, et le lia pour 1 000 ans;',
        3: 'et il le jeta dans l’abîme, et l’enferma; et il mit un sceau sur lui, afin qu’il ne séduise plus les nations, jusqu’à ce que les 1 000 ans soient accomplis; après cela, il faut qu’il soit délié pour un peu de temps.',
        ...
        5: 'le reste des morts ne vécut pas jusqu’à ce que les 1 000 ans soient accomplis. C’est ici la première résurrection.',
        6: 'Bienheureux et saint celui qui a part à la première résurrection: sur eux la seconde mort n’a point de pouvoir; mais ils seront sacrificateurs de Dieu et du Christ, et ils régneront avec lui 1 000 ans.',
    ...
    21: {
        ...
        3: 'Et j’entendis une grande voix venant du ciel, disant: Voici, l’habitation de Dieu est avec les hommes, et il habitera avec eux; et ils seront son peuple, et Dieu lui-même sera avec eux, leur Dieu.',
        ...
        17: 'Et il mesura sa muraille, 144 coudées, mesure d’homme, c’est-à-dire d’ange.',
