...
CHAPTERS = {
    1: {
        ...
        10: '30 coupes d’or, 410 coupes d’argent de second ordre, [et] 1 000 autres ustensiles;',
        11: 'tous les ustensiles d’or et d’argent étaient [au nombre de] 5 400. Sheshbatsar apporta le tout lorsqu’on fit monter de Babylone à Jérusalem ceux de la transportation.',
    },
    2: {
    ...
    4: {
        ...
        4: 'Alors le peuple du pays rendit lâches les mains du peuple de Juda; et ils leur firent peur de bâtir,',
        ...
        13: 'Que le roi sache donc que si cette ville est bâtie et que ses murailles s’achèvent, ils ne paieront ni tribut, ni impôt, ni péage, et, plus tard, cela portera préjudice aux rois.',
    ...
    5: {
        ...
        4: 'Alors nous leur avons dit quels étaient les noms des hommes qui bâtissaient cet édifice.',
        5: 'Et l’œil de leur Dieu était sur les anciens des Juifs; et ils ne les firent pas cesser jusqu’à ce que l’affaire parvienne à Darius; et alors ils répondirent par lettre à ce sujet.',
    ...
    6: {
        ...
        3: 'La première année du roi Cyrus, le roi Cyrus donna l’ordre, touchant la maison de Dieu à Jérusalem: Que la maison soit bâtie pour être un lieu où l’on offre des sacrifices, et que ses fondements soient solides. Sa hauteur sera de 60 coudées, sa largeur de 60 coudées,',
        ...
        17: 'et ils offrirent pour la dédicace de cette maison de Dieu, 100 taureaux, 200 béliers, 400 agneaux, et, comme sacrifice pour le péché, pour tout Israël, douze boucs, selon le nombre des tribus d’Israël.',
    ...
    7: {
        ...
        22: 'jusqu’à 100 talents d’argent, et jusqu’à 100 cors de froment, et jusqu’à 100 baths de vin, et jusqu’à 100 baths d’huile, et du sel, sans prescription [de quantité]:',
    ...
    9: {
        ...
        6: 'et je dis: Mon Dieu, je suis confus, et j’ai honte de lever ma face vers toi, ô mon Dieu; car nos iniquités se sont multipliées par-dessus nos têtes, et notre culpabilité a grandi jusqu’aux cieux.',
        ...
        8: 'et maintenant, pour un moment, nous est arrivée une faveur de la part de l’ Éternel, notre Dieu, pour nous laisser des réchappés et pour nous donner un clou dans son saint lieu, afin que notre Dieu éclaire nos yeux et nous redonne un peu de vie dans notre servitude,',
        9: 'car nous sommes serviteurs; mais, dans notre servitude, notre Dieu ne nous a pas abandonnés, et il a étendu sa bonté sur nous devant les rois de Perse, afin de nous redonner de la vie pour élever la maison de notre Dieu et pour restaurer ses ruines, et pour nous donner des murs en Juda et à Jérusalem.',
    ...
    10: {
        ...
        8: 'et pour que quiconque ne viendrait pas dans les trois jours selon le conseil des chefs et des anciens, tous ses biens soient confisqués, et que lui-même soit séparé de la congrégation de ceux qui avaient été transportés.',
        ...
        10: 'Et Esdras, le sacrificateur, se leva et leur dit: Vous avez été infidèles, et vous avez pris des femmes étrangères, pour ajouter à la culpabilité d’Israël.',
