...
CHAPTERS = {
    1: {
        1: '바울과 실루아노와 디모데는 하나님 우리 아버지와 주 예수 그리스도 안에 있는 데살로니가 사람들의 교회에 편지하노니',
        2: '하나님 우리 아버지와 주 예수 그리스도로부터 은혜와 평강이 너희에게 있기를 원하노라.',
        3: '형제들아, 우리가 너희로 인하여 항상 하나님께 감사드려야 하나니 그것이 마땅함은 너희의 믿음이 심히 많이 자라고 너희 모두가 각각 서로에게 베푸는 사랑이 넘치기 때문이라.',
        4: '그러므로 너희가 당하는 너희의 모든 핍박과 환난 속에서 드러난 너희의 인내와 믿음으로 인해 우리는 하나님의 교회들에서 직접 너희를 자랑하노라.',
        5: '그것은 하나님의 의로운 심판의 명백한 증표인데 이것은 너희가 하나님의 왕국에 합당한 자로 여겨지게 하려 함이라. 그 왕국을 위하여 너희도 고난을 당하느니라.',
        6: '너희를 괴롭게 하는 자들에게는 환난으로 갚으시고',
        7: '괴로움을 당하는 너희에게는 우리와 함께 안식으로 갚으시는 것이 하나님께는 의로운 일인즉 주 예수님께서 자신의 강력한 천사들과 함께 하늘로부터 나타나사',
        8: '하나님을 알지 못하는 자들과 우리 주 예수 그리스도의 복음에 순종하지 아니하는 자들에게 타오르는 불로 징벌하실 때에 그리하시리라.',
        9: '그들은 주의 앞과 그분의 권능의 영광에서 떠나 영존하는 파멸로 형벌을 받으리로다.',
        10: '그 날에 그분께서 오셔서 자신의 성도들 가운데서 영광을 받으시고 믿는 모든 자들 가운데서 칭송을 받으시리니 (이는 너희가 우리의 증언을 너희 가운데서 믿었기 때문이라.)',
        11: '그러므로 우리도 항상 너희를 위하여 기도함은 우리 하나님께서 너희를 이 부르심에 합당한 자로 여기시고 자신의 선하심의 모든 선한 기쁨과 또 믿음의 일을 권능으로 성취하시게 하려 함이며',
        12: '또 우리 하나님과 주 예수 그리스도의 은혜에 따라 우리 주 예수 그리스도의 이름이 너희 안에서 영광을 받고 너희가 그분 안에서 영광을 받게 하려 함이라.',
    },
    2: {
        ...
        4: '그는 대적하는 자요, 또 하나님이라 불리거나 혹은 경배 받는 모든 것 위로 자기를 높이는 자로서 하나님처럼 하나님의 성전에 앉아 자기가 하나님인 것을 스스로 보이느니라.',
        ...
        8: '그 뒤에 저 사악한 자가 드러날 터인데 주께서 자신의 입의 영으로 그를 소멸시키시고 친히 오실 때의 광채로 그를 멸하시리라.',
        ...
        13: '그러나 주께 사랑받는 형제들아, 우리가 너희로 인하여 항상 하나님께 감사드려야 하나니 이는 하나님께서 처음부터 너희를 택하사 성령의 거룩히 구별하심과 진리를 믿는 것을 통해 구원에 이르게 하셨기 때문이라.',
        14: '이것을 위하여 그분께서 우리의 복음을 통해 너희를 부르사 우리 주 예수 그리스도의 영광을 얻게 하셨느니라.',
        15: '그러므로 형제들아, 굳게 서서 말로나 우리의 서신으로 너희가 가르침을 받은 전통들을 붙들라.',
        16: '이제 우리 주 예수 그리스도 그분과 또 우리를 사랑하시고 은혜를 통하여 영존하는 안위와 좋은 소망을 주신 하나님 곧 우리 아버지께서',
        17: '너희 마음을 위로하시고 모든 선한 말과 일에서 너희를 굳게 세우시기를 원하노라.',
    },
    3: {
        1: '끝으로 형제들아, 우리를 위해 기도하되 주의 말씀이 너희에게서와 같이 자유로운 행로를 가져 영광스럽게 되고',
        ...
        5: '주께서 너희 마음을 인도하사 하나님을 사랑하게 하고 또 인내하며 그리스도를 기다리게 하기를 원하노라.',
        ...
        14: '만일 어떤 사람이 이 서신으로 전하는 우리의 말에 순종하지 아니하거든 그 사람을 주목하여 그와 사귀지 말고 이로써 그가 부끄러움을 당하게 하라.',
        15: '그러나 그를 원수로 여기지 말고 형제로서 권고하라.',
        16: '이제 평강의 주께서 친히 모든 방법으로 항상 너희에게 평강을 주시기를 원하노라. 주께서 너희 모두와 함께하시기를 원하노라.',
        17: '바울은 내 손으로 써서 문안하노니 이것은 모든 서신에 있는 증표이므로 내가 이렇게 쓰노라.',
        18: '우리 주 예수 그리스도의 은혜가 너희 모두와 함께 있기를 원하노라. 아멘. ¶데살로니가 사람들에게 보내는 둘째 서신을 아테네에서 써서 보내다.',
    },
}
