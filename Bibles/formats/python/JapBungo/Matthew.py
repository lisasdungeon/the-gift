...
CHAPTERS = {
    ...
    5: {
        ...
        22: 'されど我は汝らに告ぐ、すべて兄弟を怒る者は、審判にあふべし。また兄弟に對ひて、愚 者よといふ者は、衆議にあふべし。また痴者よといふ者は、ゲヘナの火にあふべし。',
        ...
        29: 'もし右の目なんぢを躓かせば、抉り出して棄てよ、五體の一つ亡びて、全身ゲヘナに投げ入れられぬは益なり。',
        30: 'もし右の手なんぢを躓かせば、切りて棄てよ、五體の一つ亡びて、全身ゲヘナに往かぬは益なり。',
    ...
    12: {
        ...
        32: '誰にても言をもて人の子に逆ふ者は赦されん、されど言をもて聖 靈に逆ふ者は、この世にても後の世にても赦されじ。',
    ...
    13: {
        ...
        40: 'されば毒 麥の集められて火に焚かるる如く、世の終にも斯くあるべし。',
    ...
    18: {
        ...
        8: 'もし汝の手または足なんぢを躓かせば、切りて棄てよ。不具または蹇跛にて生命に入るは、兩手 兩足ありて永遠の火に投げ入れらるるよりも勝るなり。',
        9: 'もし汝の眼なんぢを躓かせば、拔きて棄てよ。片眼にて生命に入るは、兩眼ありて火のゲヘナに投げ入れらるるよりも勝るなり。',
    ...
    19: {
        ...
        16: '視よ、或 人みもとに來りて言ふ『師よ、われ永遠の生命をうる爲には、如何なる善き事を爲すべきか』',
    ...
    23: {
        ...
        14: '[なし]',
        15: '禍害なるかな、僞善なる學者、パリサイ人よ、汝らは一人の改宗者を得んために海 陸を經めぐり、既に得れば、之を己に倍したるゲヘナの子となすなり。',
