...
CHAPTERS = {
    ...
    4: {
        ...
        4: 'この世の神は此 等の不 信者の心を暗まして、神の像なるキリストの榮光の福音の光を照さざらしめたり。',
    ...
    9: {
        ...
        9: '録して『彼は散して貧しき者に與へたり。その正義は永遠に存らん』とある如し。',
    ...
    10: {
        ...
        3: '我らは肉にありて歩めども、肉に從ひて戰はず。',
        4: 'それ我らの戰爭の武器は肉に屬するにあらず、神の前には城砦を破るほどの能力あり、我等はもろもろの論説を破り、',
        5: '神の示教に逆ひて建てたる凡ての櫓を毀ち、凡ての念を虜にしてキリストに服はしむ。',
        6: '且なんぢらの從順の全くならん時、すべての不 從順を罰せんと覺悟せり。',
        7: '汝らは外貌のみを見る、若し人みづからキリストに屬する者と信ぜば、己がキリストに屬する如く、我らも亦キリストに屬する者なることを更に考ふべし。',
        8: '假令われ汝らを破る爲ならずして建つる爲に、主が我らに賜ひたる權威につきて誇ること稍 過ぐとも恥とはならじ。',
        9: 'われ書をもて汝らを嚇すと思はざれ。',
        10: '彼らは言ふ『その書は重くかつ強し、その逢ふときの容貌は弱く、言は鄙し』と。',
        11: '斯くのごとき人は思ふべし。我らが離れをる時おくる書の言のごとく、逢ふときの行爲も亦 然るを。',
        12: '我らは己を譽むる人と敢へて竝び、また較ぶる事をせず、彼らは己によりて己を度り、己をもて己に較ぶれば智なき者なり。',
        13: '我らは範圍を踰えて誇らず、神の我らに分ち賜ひたる範圍にしたがひて誇らん。その範圍は汝らに及べり。',
        14: '汝らに及ばぬ者のごとく範圍を踰えて身を延すに非ず、キリストの福音を傳へて汝らにまで到れるなり。',
        15: '我らは己が範圍を踰えて他の人の勞を誇らず、唯なんぢらの信仰の彌増すにより、我らの範圍に循ひて汝らのうちに更に大ならんことを望む。',
        16: 'これ他の人の範圍に既に備りたるものを誇らず、汝らを踰えて外の處に福音を宣傳へん爲なり。',
        17: '誇る者は主によりて誇るべし。',
