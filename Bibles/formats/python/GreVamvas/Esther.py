...
CHAPTERS = {
    1: {
        1: 'Και εν ταις ημέραις του Ασσουήρου, ούτος είναι ο Ασσουήρης, ο βασιλεύων από της Ινδίας έως της Αιθιοπίας, επί εκατόν εικοσιεπτά επαρχιών·',
        2: 'εν εκείναις ταις ημέραις, ότε ο βασιλεύς Ασσουήρης εκάθησεν επί τον θρόνον της βασιλείας αυτού, εν Σούσοις τη βασιλευούση,',
        3: 'εν τω τρίτω έτει της βασιλείας αυτού, έκαμε συμπόσιον εις πάντας τους άρχοντας αυτού και τους δούλους αυτού· και ήτο ενώπιον αυτού η δύναμις της Περσίας και της Μηδίας, οι ευγενείς και οι άρχοντες των επαρχιών,',
        4: 'ότε εδείκνυε τα πλούτη της ενδόξου βασιλείας αυτού, και την λαμπρότητα της εξόχου μεγαλειότητος αυτού, ημέρας πολλάς, εκατόν ογδοήκοντα ημέρας.',
        5: 'Και αφού επληρώθησαν αι ημέραι αύται, έκαμεν ο βασιλεύς συμπόσιον εις πάντα τον λαόν τον ευρεθέντα εν Σούσοις τη βασιλευούση, από μεγάλου έως μικρού, επτά ημέρας, εν τη αυλή του κήπου του βασιλικού παλατίου·',
        6: 'όπου ήσαν παραπετάσματα λευκά, πράσινα και κυανά, κρεμάμενα διά σχοινίων βυσσίνων και πορφυρών διά κρίκων αργυρών εις στύλους εκ μαρμάρου· κλίναι χρυσαί και αργυραί ήσαν επί λιθόστρωτον εκ πορφυρίτου και κυανού και λευκού και μέλανος μαρμάρου.',
        7: 'Εκέρνων δε εις σκεύη χρυσά, ηλλάσσοντο δε τα σκεύη διαδοχικώς, και ήτο οίνος βασιλικός εν αφθονία, κατά την μεγαλοπρέπειαν του βασιλέως.',
        8: 'Η δε πόσις ήτο κεκανονισμένη· ουδείς εβίαζε· διότι ο βασιλεύς προσέταξεν ούτως εις πάντας τους οικονόμους του παλατίου αυτού, να κάμνωσι κατά την ευχαρίστησιν εκάστου.',
        9: 'Και Αστίν έτι η βασίλισσα έκαμεν εις τας γυναίκας συμπόσιον εν τω οίκω τω βασιλικώ του βασιλέως Ασσουήρου.',
        10: 'Εν τη εβδόμη δε ημέρα, ότε η καρδία του βασιλέως ήτο εύθυμος εκ του οίνου, προσέταξε τον Μεουμάν, τον Βηζαθά, τον Αρβωνά, τον Βηγθά και Αβαγθά, τον Ζεθάρ και τον Χαρκάς, τους επτά ευνούχους τους υπηρετούντας ενώπιον του βασιλέως Ασσουήρου,',
        11: 'να φέρωσι την Αστίν την βασίλισσαν ενώπιον του βασιλέως, μετά του βασιλικού διαδήματος, διά να δείξη το κάλλος αυτής εις τους λαούς και εις τους άρχοντας· διότι ήτο ώραία την όψιν.',
        12: 'Η βασίλισσα όμως Αστίν ηρνήθη να έλθη κατά την προσταγήν του βασιλέως, την διά των ευνούχων. Όθεν ο βασιλεύς εθυμώθη σφόδρα, και η οργή αυτού εξήφθη εν εαυτώ.',
        13: 'Τότε είπεν ο βασιλεύς προς τους σοφούς, τους γνωρίζοντας τους καιρούς· διότι τοιαύτη ήτο η συνήθεια του βασιλέως προς πάντας τους γνωρίζοντας τον νόμον και την κρίσιν·',
        14: 'πλησίον δε αυτού ήτο ο Καρσένα, ο Σεθάρ, ο Αδμαθά, ο Θαρσείς, ο Μερές, ο Μαρσενά και ο Μεμουκάν, οι επτά άρχοντες της Περσίας και της Μηδίας, οίτινες έβλεπον το πρόσωπον του βασιλέως και είχον την προεδρίαν εν τω βασιλείω·',
        15: 'Τι αρμόζει να κάμωμεν προς την βασίλισσαν Αστίν κατά τον νόμον, διότι δεν εξετέλεσε την διά των ευνούχων προσταγήν του βασιλέως Ασσουήρου;',
        16: 'Και απεκρίθη ο Μεμουκάν ενώπιον του βασιλέως και των αρχόντων, Η βασίλισσα Αστίν δεν ημάρτησε μόνον εις τον βασιλέα, αλλά και εις πάντας τους άρχοντας και εις πάντας τους λαούς τους εν πάσαις ταις επαρχίαις του βασιλέως Ασσουήρου·',
        17: 'διότι η πράξις της βασιλίσσης θέλει διαδοθή εις πάσας τας γυναίκας, ώστε θέλουσι καταφρονεί τους άνδρας αυτών έμπροσθεν των οφθαλμών αυτών, όταν διαφημισθή ότι ο βασιλεύς Ασσουήρης προσέταξε την βασίλισσαν Αστίν να φερθή ενώπιον αυτού, και δεν ήλθε·',
        18: 'και την σήμερον αι δέσποιναι της Περσίας και της Μηδίας, όσαι ήκουσαν περί της πράξεως της βασιλίσσης, θέλουσι λαλήσει ούτω προς πάντας τους άρχοντας του βασιλέως· εντεύθεν μεγάλη περιφρόνησις και οργή·',
        19: "εάν λοιπόν ήναι αρεστόν εις τον βασιλέα, ας εξέλθη παρ' αυτού βασιλική διαταγή, και ας γραφή μεταξύ των νόμων των Περσών και των Μήδων, διά να ήναι αμετάθετος, να μη έλθη πλέον η Αστίν ενώπιον του βασιλέως Ασσουήρου· και ας δώση ο βασιλεύς την βασιλικήν αυτής αξίαν εις άλλην καλητέραν αυτής·",
        20: 'και όταν το πρόσταγμα του βασιλέως, το οποίον θέλει κάμει, δημοσιευθή διά παντός του βασιλείου αυτού, διότι είναι μέγα, πάσαι αι γυναίκες θέλουσιν αποδίδει τιμήν εις τους άνδρας αυτών, από μεγάλου έως μικρού.',
        21: 'Και ο λόγος ήρεσεν εις τον βασιλέα και εις τους άρχοντας· και έκαμεν ο βασιλεύς κατά τον λόγον του Μεμουκάν·',
        22: 'και έστειλε γράμματα εις πάσας τας επαρχίας του βασιλέως, εις εκάστην επαρχίαν κατά το γράφειν αυτής, και προς έκαστον λαόν κατά την γλώσσαν αυτού, να ήναι πας ανήρ κύριος εν τη οικία αυτού, και να λαλή κατά την γλώσσαν του λαού αυτού.',
    },
    2: {
    ...
    5: {
        1: 'Την τρίτην δε ημέραν ενδυθείσα η Εσθήρ την βασιλικήν στολήν εστάθη εν τη εσωτέρα αυλή του βασιλικού οίκου, απέναντι του οίκου του βασιλέως· και ο βασιλεύς εκάθητο επί του βασιλικού θρόνου αυτού εν τω βασιλικώ οίκω, απέναντι της πύλης του οίκου.',
        2: 'Και ως είδεν ο βασιλεύς την Εσθήρ την βασίλισσαν ισταμένην εν τη αυλή, εύρηκε χάριν ενώπιον αυτού· και εξέτεινεν ο βασιλεύς προς την Εσθήρ το χρυσούν σκήπτρον το εν τη χειρί αυτού· και επλησίασεν η Εσθήρ και ήγγισε το άκρον του σκήπτρου.',
        3: 'Και είπε προς αυτήν ο βασιλεύς, Τι θέλεις, βασίλισσα Εσθήρ; και τις η αίτησίς σου; και έως του ημίσεος της βασιλείας θέλει δοθή εις σε.',
        4: "Και απεκρίθη η Εσθήρ, Εάν ήναι αρεστόν εις τον βασιλέα, ας έλθη ο βασιλεύς και ο Αμάν την ημέραν ταύτην εις το συμπόσιον, το οποίον ητοίμασα δι' αυτόν.",
        5: 'Και είπεν ο βασιλεύς, Επισπεύσατε τον Αμάν, διά να κάμη τον λόγον της Εσθήρ. Και ήλθον ο βασιλεύς και ο Αμάν εις το συμπόσιον, το οποίον έκαμεν η Εσθήρ.',
        6: 'Και είπεν ο βασιλεύς προς την Εσθήρ επί του συμποσίου του οίνου, Τι το ζήτημά σου; και θέλει δοθή εις σέ· και τις η αίτησίς σου; και έως του ημίσεος της βασιλείας εάν ζητήσης, θέλει γείνει.',
        7: 'Τότε αποκριθείσα η Εσθήρ είπε, το ζήτημά μου και η αίτησίς μου είναι·',
        8: "Εάν εύρηκα χάριν ενώπιον του βασιλέως, και εάν ήναι αρεστόν εις τον βασιλέα να εκτελέση το ζήτημά μου και να κάμη την αίτησίν μου, ας έλθη ο βασιλεύς και ο Αμάν εις το συμπόσιον το οποίον θέλω ετοιμάσει δι' αυτούς· και αύριον θέλω κάμει κατά τον λόγον του βασιλέως.",
        9: "Τότε εξήλθεν ο Αμάν την ημέραν εκείνην περιχαρής και εύθυμος την καρδίαν· αλλ' ότε ο Αμάν είδε τον Μαροδοχαίον εν τη πύλη του βασιλέως, ότι δεν εσηκώθη ουδέ εκινήθη δι' αυτόν, ενεπλήσθη ο Αμάν θυμού κατά του Μαροδοχαίου.",
        10: "Αλλ' ο Αμάν εκράτησεν εαυτόν· και εισελθών εις τον οίκον αυτού έστειλε και εκάλεσε τους φίλους αυτού και Ζερές την γυναίκα αυτού,",
        11: 'και διηγήθη προς αυτούς ο Αμάν περί της δόξης του πλούτου αυτού και του πλήθους των τέκνων αυτού, και πόσον ο βασιλεύς εμεγάλυνεν αυτόν, και τίνι τρόπω ύψωσεν αυτόν υπεράνω των αρχόντων και των δούλων του βασιλέως.',
        12: 'Και είπεν ο Αμάν, Μάλιστα η βασίλισσα Εσθήρ δεν προσεκάλεσεν εις το συμπόσιον το οποίον έκαμεν, ειμή εμέ, μετά του βασιλέως· και αύριον έτι είμαι προσκεκλημένος προς αυτήν μετά του βασιλέως·',
        13: 'πλην πάντα ταύτα δεν με ωφελούσιν, ενόσω βλέπω τον Μαροδοχαίον τον Ιουδαίον καθήμενον εν τη πύλη του βασιλέως.',
        14: "Και είπε προς αυτόν Ζερές η γυνή αυτού και πάντες οι φίλοι αυτού, Ας κατασκευασθή ξύλον πεντήκοντα πηχών το ύψος, και το πρωΐ ειπέ προς τον βασιλέα να κρεμασθή ο Μαροδοχαίος επ' αυτό· τότε ύπαγε περιχαρής μετά του βασιλέως εις το συμπόσιον. Και το πράγμα ήρεσεν εις τον Αμάν, και προσέταξε να ετοιμασθή το ξύλον.",
    },
    6: {
        1: 'Εν εκείνη τη νυκτί ο ύπνος έφυγεν από του βασιλέως· και προσέταξε να φέρωσι το βιβλίον των υπομνημάτων των χρονικών· και ανεγινώσκοντο ενώπιον του βασιλέως.',
        2: 'Και ευρέθη γεγραμμένον ότι ο Μαροδοχαίος απήγγειλε περί του Βιχθάν και Θερές, δύο εκ των ευνούχων του βασιλέως, θυρωρών, οίτινες εζήτησαν να επιβάλωσι χείρα επί τον βασιλέα Ασσουήρην.',
        3: 'Και είπεν ο βασιλεύς, Ποία τιμή και αξιοπρέπεια έγεινεν εις τον Μαροδοχαίον διά τούτο; Και είπον οι δούλοι του βασιλέως οι υπηρετούντες αυτόν, Δεν έγεινεν ουδέν εις αυτόν.',
        4: "Και είπεν ο βασιλεύς, Τις είναι εν τη αυλή; είχε δε ελθεί ο Αμάν εις την εξωτέραν αυλήν του βασιλικού οίκου, διά να είπη προς τον βασιλέα να κρεμάση τον Μαροδοχαίον εις το ξύλον το οποίον ητοίμασε δι' αυτόν.",
        5: 'Και είπον προς αυτόν οι δούλοι του βασιλέως, Ιδού, ο Αμάν ίσταται εν τη αυλή. Και είπεν ο βασιλεύς, Ας εισέλθη.',
        6: 'Και ότε εισήλθεν ο Αμάν, είπε προς αυτόν ο βασιλεύς, Τι πρέπει να γείνη εις τον άνθρωπον, τον οποίον ευαρεστείται ο βασιλεύς να τιμήση; Ο δε Αμάν εστοχάσθη εν τη καρδία αυτού, εις ποίον άλλον ο βασιλεύς ήθελεν ευαρεστηθή να κάμη τιμήν, παρά εις εμέ;',
        7: 'Απεκρίθη λοιπόν ο Αμάν προς τον βασιλέα, Περί του ανθρώπου, τον οποίον ο βασιλεύς ευαρεστείται να τιμήση,',
        8: 'ας φέρωσι την βασιλικήν στολήν, την οποίαν ο βασιλεύς ενδύεται, και τον ίππον επί του οποίου ο βασιλεύς ιππεύει, και να τεθή το βασιλικόν διάδημα επί της κεφαλής αυτού·',
        9: 'και η στολή αύτη και ο ίππος ας δοθώσιν εις την χείρα τινός εκ των μεγαλητέρων αρχόντων του βασιλέως, διά να στολίση τον άνθρωπον τον οποίον ο βασιλεύς ευαρεστείται να τιμήση· και φέρων αυτόν έφιππον διά των οδών της πόλεως ας κηρύττη έμπροσθεν αυτού, ούτω θέλει γίνεσθαι εις τον άνθρωπον, τον οποίον ο βασιλεύς ευαρεστείται να τιμήση.',
        10: 'Και είπεν ο βασιλεύς προς τον Αμάν, Σπεύσον, λάβε την στολήν και τον ίππον, ως είπας, και κάμε ούτως εις τον Μαροδοχαίον τον Ιουδαίον τον καθήμενον εν τη βασιλική πύλη· ας μη λείψη μηδέν εκ πάντων όσα είπας.',
        11: 'Και έλαβεν ο Αμάν την στολήν και τον ίππον, και εστόλισε τον Μαροδοχαίον και έφερεν αυτόν έφιππον διά των οδών της πόλεως, κηρύττων έμπροσθεν αυτού, ούτω θέλει γίνεσθαι εις τον άνθρωπον, τον οποίον ο βασιλεύς ευαρεστείται να τιμήση.',
        12: 'Και επανήλθεν ο Μαροδοχαίος εις την πύλην του βασιλέως· ο δε Αμάν έσπευσε προς τον οίκον αυτού περίλυπος και έχων την κεφαλήν αυτού κεκαλυμμένην.',
        13: "Και διηγήθη ο Αμάν προς Ζερές την γυναίκα αυτού και προς πάντας τους φίλους αυτού παν ό,τι συνέβη εις αυτόν. Και είπον προς αυτόν οι σοφοί αυτού και Ζερές η γυνή αυτού, Εάν ο Μαροδοχαίος, έμπροσθεν του οποίου ήρχισας να εκπίπτης, ήναι εκ του σπέρματος των Ιουδαίων, δεν θέλεις κατισχύσει εναντίον αυτού, αλλ' εξάπαντος θέλεις πέσει έμπροσθεν αυτού.",
        14: "Ενώ ελάλουν έτι μετ' αυτού, έφθασαν οι ευνούχοι του βασιλέως και έσπευσαν να φέρωσι τον Αμάν εις το συμπόσιον, το οποίον ητοίμασεν η Εσθήρ.",
    },
    7: {
        1: 'Ήλθον λοιπόν ο βασιλεύς και ο Αμάν να συμποσιάσωσι μετά της Εσθήρ της βασιλίσσης.',
        2: 'Και είπε πάλιν ο βασιλεύς προς την Εσθήρ την δευτέραν ημέραν επί του συμποσίου του οίνου, Τι το ζήτημά σου, βασίλισσα Εσθήρ; και θέλει δοθή εις σέ· και τις η αίτησίς σου; και έως του ημίσεος της βασιλείας εάν ζητήσης, θέλει γείνει.',
        3: 'Τότε απεκρίθη η Εσθήρ η βασίλισσα και είπεν, Εάν εύρηκα χάριν ενώπιόν σου, βασιλεύ, και εάν ήναι αρεστόν εις τον βασιλέα, η ζωή μου ας μοι δοθή εις το ζήτημά μου και ο λαός μου εις την αίτησίν μου·',
        4: 'διότι επωλήθημεν, εγώ και ο λαός μου, εις απώλειαν, εις σφαγήν και εις όλεθρον· και εάν ηθέλομεν πωληθή ως δούλοι και δούλαι ήθελον σιωπήσει, αν και ο εχθρός δεν ηδύνατο να αναπληρώση την ζημίαν του βασιλέως.',
        5: 'Τότε απεκρίθη ο βασιλεύς Ασσουήρης και είπε προς την Εσθήρ την βασίλισσαν, Τις είναι αυτός και που είναι εκείνος, όστις ετόλμησε να κάμη ούτω;',
        6: 'Και είπεν η Εσθήρ, Ο εναντίος και εχθρός είναι ούτος ο αχρείος Αμάν. Τότε εταράχθη ο Αμάν ενώπιον του βασιλέως και της βασιλίσσης.',
        7: 'Και σηκωθείς ο βασιλεύς από του συμποσίου του οίνου ωργισμένος υπήγεν εις τον κήπον του παλατίου· ο δε Αμάν εστάθη, διά να ζητήση την ζωήν αυτού παρά της Εσθήρ της βασιλίσσης· διότι είδεν ότι κακόν ήτο αποφασισμένον εναντίον αυτού παρά του βασιλέως.',
        ...
        9: "Και είπεν ο Αρβονά, εις εκ των ευνούχων, ενώπιον του βασιλέως, Ιδού, και το ξύλον πεντήκοντα πηχών το ύψος, το οποίον ο Αμάν έκαμε διά τον Μαροδοχαίον, τον λαλήσαντα αγαθά υπέρ του βασιλέως, ίσταται εν τη οικία του Αμάν. Και είπεν ο βασιλεύς, Κρεμάσατε αυτόν επ' αυτού.",
        10: 'Και εκρέμασαν τον Αμάν επί του ξύλου, το οποίον ητοίμασε διά τον Μαροδοχαίον. Και κατέπαυσεν ο θυμός του βασιλέως.',
    },
    8: {
    ...
    9: {
        1: "Εν δε τω δωδεκάτω μηνί, ούτος είναι ο μην Αδάρ, τη δεκάτη τρίτη ημέρα του αυτού, ότε το πρόσταγμα του βασιλέως και η διαταγή αυτού ήτο πλησίον να εκτελεσθή, εν τη ημέρα καθ' ην οι εχθροί των Ιουδαίων ήλπιζον να κατακρατήσωσιν αυτών, αν και ετράπη εις το εναντίον, διότι οι Ιουδαίοι κατεκράτησαν των μισούντων αυτούς,",
        2: 'συνήχθησαν οι Ιουδαίοι εν ταις πόλεσιν αυτών κατά πάσας τας επαρχίας του βασιλέως Ασσουήρου, διά να επιβάλωσι χείρα επί τους ζητούντας το κακόν αυτών· και ουδείς ηδυνήθη να αντισταθή εις αυτούς, διότι ο φόβος αυτών επέπεσεν επί πάντας τους λαούς.',
        3: "Και πάντες οι άρχοντες των επαρχιών και οι σατράπαι και οι διοικηταί και οι οικονόμοι του βασιλέως εβοήθουν τους Ιουδαίους· διότι ο φόβος του Μαροδοχαίου επέπεσεν επ' αυτούς·",
        4: 'επειδή ο Μαροδοχαίος ήτο μέγας εν τω οίκω του βασιλέως και η φήμη αυτού διεδόθη εις πάσας τας επαρχίας· διότι ο άνθρωπος ο Μαροδοχαίος προέβαινε μεγαλυνόμενος.',
        5: 'Και επάταξαν οι Ιουδαίοι πάντας τους εχθρούς αυτών με πάταγμα ρομφαίας και σφαγήν και όλεθρον, και έκαμον εις τους μισούντας αυτούς όπως ήθελον.',
        6: 'Και εν Σούσοις τη βασιλευούση εφόνευσαν οι Ιουδαίοι και απώλεσαν πεντακοσίους άνδρας.',
        7: 'Και τον Φαρσανδαθά και τον Δαλφών και τον Ασπαθά',
        8: 'και τον Ποραθά και τον Αδαλία και τον Αριδαθά',
        9: 'και τον Φαρμαστά και τον Αρισαΐ και τον Αριδαΐ και τον Βαϊεζαθά,',
        10: 'τους δέκα υιούς του Αμάν υιού του Αμμεδαθά, του εχθρού των Ιουδαίων, εφόνευσαν· επί λάφυρα όμως δεν έβαλον την χείρα αυτών.',
        11: 'Εν τη ημέρα εκείνη ο αριθμός των φονευθέντων εν Σούσοις τη βασιλευούση εφέρθη ενώπιον του βασιλέως.',
        ...
        14: 'Και προσέταξεν ο βασιλεύς να γείνη ούτω· και εξεδόθη διαταγή εν Σούσοις· και εκρέμασαν τους δέκα υιούς του Αμάν.',
        15: 'Και συνήχθησαν οι Ιουδαίοι οι εν Σούσοις και την δεκάτην τετάρτην του μηνός Αδάρ και εφόνευσαν τριακοσίους άνδρας εν Σούσοις· επί λάφυρα όμως δεν έβαλον την χείρα αυτών.',
        16: 'Οι δε άλλοι Ιουδαίοι, οι εν ταις επαρχίαις του βασιλέως, συνήχθησαν και εστάθησαν υπέρ της ζωής αυτών, και έλαβον ανάπαυσιν από των εχθρών αυτών και εφόνευσαν εκ των μισούντων αυτούς εβδομήκοντα πέντε χιλιάδας· επί τα λάφυρα όμως δεν έβαλον την χείρα αυτών·',
        17: 'την δεκάτην τρίτην ημέραν του μηνός Αδάρ· και την δεκάτην τετάρτην ημέραν του αυτού ανεπαύθησαν και έκαμον ταύτην ημέραν συμποσίου και ευφροσύνης.',
        18: 'Οι δε Ιουδαίοι οι εν Σούσοις συνήχθησαν την δεκάτην τρίτην αυτού και την δεκάτην τετάρτην αυτού· την δε δεκάτην πέμπτην του αυτού ανεπαύθησαν και έκαμον ταύτην ημέραν συμποσίου και ευφροσύνης.',
        19: 'Διά τούτο οι Ιουδαίοι οι χωρικοί οι κατοικούντες εν ταις ατειχίστοις πόλεσιν έκαμνον την δεκάτην τετάρτην ημέραν του μηνός Αδάρ ημέραν ευφροσύνης και συμποσίου και ημέραν αγαθήν, και απέστελλον μερίδας προς αλλήλους.',
        20: 'Και έγραψεν ο Μαροδοχαίος τα πράγματα ταύτα και απέστειλεν επιστολάς προς πάντας τους Ιουδαίους τους εν πάσαις ταις επαρχίαις τον βασιλέως Ασσουήρου, τους πλησίον και τους μακράν,',
        21: "προσδιορίζων εις αυτούς να φυλάττωσι την δεκάτην τετάρτην ημέραν του μηνός Αδάρ και την δεκάτην πέμπτην του αυτού καθ' έκαστον έτος,",
        22: "ως τας ημέρας καθ' ας οι Ιουδαίοι ανεπαύθησαν από των εχθρών αυτών, και τον μήνα καθ' ον η λύπη αυτών ετράπη εις αυτούς εις χαράν και το πένθος εις ημέραν αγαθήν· ώστε να κάμνωσιν αυτάς ημέρας συμποσίου και ευφροσύνης και να αποστέλλωσι μερίδας προς αλλήλους και δώρα προς τους πτωχούς.",
        23: 'Και εδέχθησαν οι Ιουδαίοι εκείνο το οποίον ήρχισαν να κάμνωσι και εκείνο το οποίον έγραψεν ο Μαροδοχαίος προς αυτούς·',
        24: 'διότι ο Αμάν ο υιός του Αμμεδαθά, ο Αγαγίτης, ο εχθρός πάντων των Ιουδαίων, εσκευώρησε κατά των Ιουδαίων να απολέση αυτούς, και έρριψε Φούρ, ήγουν κλήρον, διά να αναλώση αυτούς και να αφανίση αυτούς·',
        25: "Ότε όμως ήλθεν αυτή η Εσθήρ ενώπιον του βασιλέως, προσέταξε δι' επιστολών να τραπή κατά της κεφαλής αυτού η κακή αυτού σκευωρία, την οποίαν εσκευώρησε κατά των Ιουδαίων, και εκρέμασαν επί του ξύλου αυτόν και τους υιούς αυτού.",
        26: "Διά τούτο ωνόμασαν τας ημέρας ταύτας Φουρείμ εκ του ονόματος Φούρ. Όθεν διά πάντας τους λόγους της επιστολής ταύτης, και δι' εκείνο το οποίον είδον περί του πράγματος τούτου και το οποίον συνέβη εις αυτούς,",
        27: "διέταξαν οι Ιουδαίοι, και εδέχθησαν εφ' εαυτούς και επί το σπέρμα αυτών και επί πάντας τους προστιθεμένους εις αυτούς, να μη λείψωσι ποτέ από του να φυλάττωσι τας δύο ταύτας ημέρας, κατά το γεγραμμένον περί αυτών και κατά τον καιρόν αυτών εκάστου έτους·",
        28: 'και αι ημέραι αύται να μνημονεύωνται και να φυλάττωνται εν πάση γενεά, εκάστη συγγενεία, εκάστη επαρχία, και εκάστη πόλει και αι ημέραι αύται Φουρείμ να μη εκλείψωσιν εκ μέσου των Ιουδαίων, και να μη παύση το μνημόσυνον αυτών από του σπέρματος αυτών.',
        29: "Τότε η Εσθήρ η βασίλισσα, η θυγάτηρ του Αβιχαίλ, και ο Μαροδοχαίος ο Ιουδαίος, έγραψαν εκ δευτέρου μεθ' όλου του κύρους, διά να στερεώσωσι ταύτα τα περί Φουρείμ γεγραμμένα.",
        30: 'Και έπεμψεν επιστολάς προς πάντας τους Ιουδαίους, εις τας εκατόν εικοσιεπτά επαρχίας του βασιλείου του Ασσουήρου, με λόγους ειρήνης και αληθείας,',
        31: "διά να στερεώση τας ημέρας ταύτας Φουρείμ εν τοις καιροίς αυτών, καθώς προσδιώρισαν εις αυτούς ο Μαροδοχαίος ο Ιουδαίος και Εσθήρ η βασίλισσα, και καθώς διώρισαν, εφ' εαυτούς και επί το σπέρμα αυτών, την υπόθεσιν των νηστειών και της κραυγής αυτών.",
