...
CHAPTERS = {
    ...
    2: {
        ...
        10: 'Διά τούτο πάντα υπομένω διά τους εκλεκτούς, διά να απολαύσωσι και αυτοί την σωτηρίαν την εν Χριστώ Ιησού μετά δόξης αιωνίου.',
    ...
    3: {
        ...
        9: 'Αλλά δεν θέλουσι προκόψει πλειότερον· διότι η ανοησία αυτών θέλει γείνει κατάδηλος εις πάντας, καθώς και η εκείνων έγεινε.',
