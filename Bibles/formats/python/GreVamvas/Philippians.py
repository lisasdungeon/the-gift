...
CHAPTERS = {
    ...
    2: {
        ...
        19: 'Ελπίζω δε επί τον Κύριον Ιησούν να πέμψω προς εσάς ταχέως τον Τιμόθεον, διά να ευφραίνωμαι και εγώ μαθών την κατάστασίν σας·',
        ...
        23: 'Τούτον λοιπόν ελπίζω να πέμψω ευθύς, καθώς ίδω το τέλος των υποθέσεών μου·',
        24: 'πέποιθα δε επί τον Κύριον ότι και εγώ θέλω ελθεί ταχέως.',
        ...
        27: "Και τωόντι ησθένησε μέχρι θανάτου· αλλ' ο Θεός ηλέησεν αυτόν, ουχί δε αυτόν μόνον, αλλά και εμέ, διά να μη λάβω λύπην επί λύπην.",
        28: 'Όθεν έπεμψα αυτόν μετά περισσοτέρας σπουδής, διά να χαρήτε ιδόντες αυτόν πάλιν, και εγώ να έχω ολιγωτέραν λύπην.',
