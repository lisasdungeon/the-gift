...
CHAPTERS = {
    1: {
        ...
        2: 'Καθώς είναι γεγραμμένον εν τοις προφήταις· Ιδού, εγώ αποστέλλω τον άγγελόν μου προ προσώπου σου, όστις θέλει κατασκευάσει την οδόν σου έμπροσθέν σου·',
        3: 'Φωνή βοώντος εν τη ερήμω, ετοιμάσατε την οδόν του Κυρίου, ευθείας κάμετε τας τρίβους αυτού.',
        4: 'Ήτο ο Ιωάννης βαπτίζων εν τη ερήμω και κηρύττων βάπτισμα μετανοίας εις άφεσιν αμαρτιών.',
        5: "Και εξήρχοντο προς αυτόν όλος ο τόπος της Ιουδαίας και οι Ιεροσολυμίται, και εβαπτίζοντο πάντες εν τω Ιορδάνη ποταμώ υπ' αυτού, εξομολογούμενοι τας αμαρτίας αυτών.",
        ...
        7: 'Και εκήρυττε, λέγων· Έρχεται ο ισχυρότερός μου οπίσω μου, του οποίου δεν είμαι άξιος σκύψας να λύσω το λωρίον των υποδημάτων αυτού.',
        ...
        24: 'λέγων· Φευ, τι είναι μεταξύ ημών και σου, Ιησού Ναζαρηνέ; ήλθες να μας απολέσης; σε γνωρίζω τις είσαι, ο Άγιος του Θεού.',
        25: 'Και επετίμησεν αυτό ο Ιησούς, λέγων· Σιώπα και έξελθε εξ αυτού.',
        26: 'Και το πνεύμα το ακάθαρτον, αφού εσπάραξεν αυτόν και έκραξε μετά φωνής μεγάλης, εξήλθεν εξ αυτού.',
        ...
        35: 'Και το πρωΐ ενώ ήτο όρθρος βαθύς, σηκωθείς εξήλθε· και υπήγεν εις έρημον τόπον και εκεί προσηύχετο.',
        36: "Και έδραμον κατόπιν αυτού ο Σίμων και οι μετ' αυτού,",
        ...
        39: 'Και εκήρυττεν εν ταις συναγωγαίς αυτών εις όλην την Γαλιλαίαν και εξέβαλλε τα δαιμόνια.',
        40: 'Και έρχεται προς αυτόν λεπρός παρακαλών αυτόν και γονυπετών έμπροσθεν αυτού και λέγων προς αυτόν ότι, εάν θέλης, δύνασαι να με καθαρίσης.',
        41: 'Ο δε Ιησούς σπλαγχνισθείς, εξέτεινε την χείρα και ήγγισεν αυτόν και λέγει προς αυτόν· Θέλω, καθαρίσθητι.',
        42: "Και ως είπε τούτο, ευθύς έφυγεν απ' αυτού η λέπρα, και εκαθαρίσθη.",
        43: 'Και προστάξας αυτόν εντόνως, ευθύς απέπεμψεν αυτόν',
        44: "και λέγει προς αυτόν· Πρόσεχε μη είπης προς μηδένα μηδέν, αλλ' ύπαγε, δείξον σεαυτόν εις τον ιερέα και πρόσφερε περί του καθαρισμού σου όσα προσέταξεν ο Μωϋσής διά μαρτυρίαν εις αυτούς.",
        45: "Αλλ' εκείνος εξελθών ήρχισε να κηρύττη πολλά και να διαφημίζη τον λόγον, ώστε πλέον δεν ηδύνατο αυτός να εισέλθη φανερά εις πόλιν, αλλ' ήτο έξω εν ερήμοις τόποις· και ήρχοντο προς αυτόν πανταχόθεν.",
    },
    2: {
    ...
    8: {
        1: 'Εν εκείναις ταις ημέραις, επειδή ήτο πάμπολυς όχλος και δεν είχον τι να φάγωσι, προσκαλέσας ο Ιησούς τους μαθητάς αυτού λέγει προς αυτούς·',
        2: 'Σπλαγχνίζομαι διά τον όχλον, ότι τρεις ήδη ημέρας μένουσι πλησίον μου και δεν έχουσι τι να φάγωσι·',
        3: "και εάν απολύσω αυτούς νήστεις εις τους οίκους αυτών, θέλουσιν αποκάμει καθ' οδόν· διότι τινές εξ αυτών ήλθον μακρόθεν.",
        4: 'Και απεκρίθησαν προς αυτόν οι μαθηταί αυτού· Πόθεν θέλει τις δυνηθή να χορτάση τούτους από άρτων εδώ επί της ερημίας;',
        5: 'Και ηρώτησεν αυτούς· Πόσους άρτους έχετε; Οι δε είπον· Επτά.',
        6: 'Και προσέταξε τον όχλον να καθήσωσιν επί της γής· και λαβών τους επτά άρτους, αφού ευχαρίστησεν, έκοψε και έδιδεν εις τους μαθητάς αυτού διά να βάλωσιν έμπροσθεν του όχλου· και έβαλον.',
        7: 'Είχον και ολίγα οψαράκια· και ευλογήσας είπε να βάλωσι και αυτά.',
        8: 'Έφαγον δε και εχορτάσθησαν, και εσήκωσαν περισσεύματα κλασμάτων επτά σπυρίδας.',
        9: 'Ήσαν δε οι φαγόντες ως τετρακισχίλιοι· και απέλυσεν αυτούς.',
        ...
        12: 'Τότε αναστενάξας εκ καρδίας αυτού, λέγει· Διά τι η γενεά αύτη σημείον ζητεί; αληθώς σας λέγω, δεν θέλει δοθή εις την γενεάν ταύτην σημείον.',
        ...
        26: 'Και απέστειλεν αυτόν εις τον οίκον αυτού, λέγων· Μηδέ εις την κώμην εισέλθης μηδέ είπης τούτο εις τινά εν τη κώμη.',
        27: "Και εξήλθεν ο Ιησούς και οι μαθηταί αυτού εις τας κώμας της Καισαρείας Φιλίππου· και καθ' οδόν ηρώτα τους μαθητάς αυτού, λέγων προς αυτούς· Τίνα με λέγουσιν οι άνθρωποι ότι είμαι;",
        ...
        31: 'Και ήρχισε να διδάσκη αυτούς ότι πρέπει ο Υιός του ανθρώπου να πάθη πολλά, και να καταφρονηθή από των πρεσβυτέρων και αρχιερέων και γραμματέων, και να θανατωθή, και μετά τρεις ημέρας να αναστηθή·',
        ...
        38: "Διότι όστις αισχυνθή δι' εμέ και διά τους λόγους μου εν τη γενεά ταύτη τη μοιχαλίδι και αμαρτωλώ, και ο Υιός του ανθρώπου θέλει αισχυνθή δι' αυτόν, όταν έλθη εν τη δόξη του Πατρός αυτού μετά των αγγέλων.",
    },
    9: {
        ...
        43: 'Και εάν σε σκανδαλίζη η χειρ σου, απόκοψον αυτήν· καλήτερόν σοι είναι να εισέλθης εις την ζωήν κουλλός, παρά έχων τας δύο χείρας να απέλθης εις την γέενναν, εις το πυρ το άσβεστον,',
        44: 'όπου ο σκώληξ αυτών δεν τελευτά και το πυρ δεν σβύνεται.',
        45: 'Και εάν ο πους σου σε σκανδαλίζη, απόκοψον αυτόν· καλήτερόν σοι είναι να εισέλθης εις την ζωήν χωλός, παρά έχων τους δύο πόδας να ριφθής εις την γέενναν, εις το πυρ το άσβεστον,',
    ...
    10: {
        1: 'Και σηκωθείς εκείθεν έρχεται εις τα όρια της Ιουδαίας διά του πέραν του Ιορδάνου, και συνέρχονται πάλιν όχλοι προς αυτόν, και ως εσυνείθιζε, πάλιν εδίδασκεν αυτούς.',
        ...
        5: 'Και αποκριθείς ο Ιησούς είπε προς αυτούς· Διά την σκληροκαρδίαν σας έγραψεν εις εσάς την εντολήν ταύτην·',
        ...
        13: 'Και έφεραν προς αυτόν παιδία, διά να εγγίση αυτά· οι δε μαθηταί επέπληττον τους φέροντας.',
        ...
        17: 'Ενώ δε εξήρχετο εις την οδόν, έδραμέ τις και γονυπετήσας έμπροσθεν αυτού, ηρώτα αυτόν· Διδάσκαλε αγαθέ, τι να κάμω διά να κληρονομήσω ζωήν αιώνιον;',
        ...
        22: 'Εκείνος όμως σκυθρωπάσας διά τον λόγον, ανεχώρησε λυπούμενος· διότι είχε κτήματα πολλά.',
        ...
        24: 'Οι δε μαθηταί εξεπλήττοντο διά τους λόγους αυτού. Και ο Ιησούς πάλιν αποκριθείς λέγει προς αυτούς· Τέκνα, πόσον δύσκολον είναι να εισέλθωσιν εις την βασιλείαν του Θεού οι έχοντες το θάρρος αυτών εις τα χρήματα.',
        25: 'Ευκολώτερον είναι κάμηλος να περάση διά της τρύπης της βελόνης παρά πλούσιος να εισέλθη εις την βασιλείαν του Θεού.',
        ...
        34: 'και θέλουσιν εμπαίξει αυτόν και μαστιγώσει αυτόν και θέλουσιν εμπτύσει εις αυτόν και θανατώσει αυτόν, και την τρίτην ημέραν θέλει αναστηθή.',
        35: 'Τότε έρχονται προς αυτόν ο Ιάκωβος και Ιωάννης, οι υιοί του Ζεβεδαίου, λέγοντες· Διδάσκαλε, θέλομεν να κάμης εις ημάς ό,τι ζητήσωμεν.',
        36: 'Ο δε είπε προς αυτούς· Τι θέλετε να κάμω εις εσάς;',
        37: 'Οι δε είπον προς αυτόν· Δος εις ημάς να καθήσωμεν εις εκ δεξιών σου και εις εξ αριστερών σου εν τη δόξη σου.',
        ...
        39: 'Οι δε είπον προς αυτόν· Δυνάμεθα. Ο δε Ιησούς είπε προς αυτούς· το μεν ποτήριον, το οποίον εγώ πίνω, θέλετε πίει, και το βάπτισμα το οποίον εγώ βαπτίζομαι, θέλετε βαπτισθή·',
        40: "το να καθήσητε όμως εκ δεξιών μου και εξ αριστερών μου δεν είναι εμού να δώσω, αλλ' εις όσους είναι ητοιμασμένον.",
        ...
        45: 'διότι ο Υιός του ανθρώπου δεν ήλθε διά να υπηρετηθή, αλλά διά να υπηρετήση και να δώση την ζωήν αυτού λύτρον αντί πολλών.',
    ...
    11: {
        1: 'Και ότε πλησιάζουσιν εις Ιερουσαλήμ εις Βηθφαγή και Βηθανίαν προς το όρος των Ελαιών, αποστέλλει δύο των μαθητών αυτού',
        2: 'και λέγει προς αυτούς· Υπάγετε εις την κώμην την κατέναντι υμών, και ευθύς εισερχόμενοι εις αυτήν θέλετε ευρεί πωλάριον δεδεμένον, επί του οποίου ουδείς άνθρωπος εκάθησε· λύσατε αυτό και φέρετε.',
        3: 'Και εάν τις είπη προς εσάς· Διά τι κάμνετε τούτο; είπατε ότι ο Κύριος έχει χρείαν αυτού, και ευθύς θέλει αποστείλει αυτό εδώ.',
        4: 'Και υπήγον και εύρον το πωλάριον δεδεμένον προς την θύραν έξω επί της διόδου, και λύουσιν αυτό.',
        5: 'Και τινές των εκεί ισταμένων έλεγον προς αυτούς· Τι κάμνετε λύοντες το πωλάριον;',
        6: 'Οι δε είπον προς αυτούς καθώς παρήγγειλεν ο Ιησούς, και αφήκαν αυτούς.',
        7: "Και έφεραν το πωλάριον προς τον Ιησούν και έβαλον επ' αυτού τα ιμάτια αυτών, και εκάθησεν επ' αυτού.",
        ...
        27: 'Και έρχονται πάλιν εις Ιεροσόλυμα· και ενώ περιεπάτει εν τω ιερώ, έρχονται προς αυτόν οι αρχιερείς και οι γραμματείς και οι πρεσβύτεροι',
        28: 'και λέγουσι προς αυτόν· Εν ποία εξουσία πράττεις ταύτα; και τις σοι έδωκε την εξουσίαν ταύτην, διά να πράττης ταύτα;',
        ...
        31: "Και διελογίζοντο καθ' εαυτούς, λέγοντες· Εάν είπωμεν, Εξ ουρανού, θέλει ειπεί· Διά τι λοιπόν δεν επιστεύσατε εις αυτόν;",
    ...
    12: {
        ...
        12: 'Και εζήτουν να πιάσωσιν αυτόν και εφοβήθησαν τον όχλον· επειδή ενόησαν ότι προς αυτούς είπε την παραβολήν· και αφήσαντες αυτόν ανεχώρησαν.',
        13: 'Και αποστέλλουσι προς αυτόν τινάς των Φαρισαίων και των Ηρωδιανών, διά να παγιδεύσωσιν αυτόν εις λόγον.',
        14: "Και εκείνοι ελθόντες, λέγουσι προς αυτόν· Διδάσκαλε, εξεύρομεν ότι είσαι αληθής και δεν σε μέλει περί ουδενός· διότι δεν βλέπεις εις πρόσωπον ανθρώπων, αλλ' επ' αληθείας την οδόν του Θεού διδάσκεις. Είναι συγκεχωρημένον να δώσωμεν δασμόν εις τον Καίσαρα, ή ουχί; να δώσωμεν ή να μη δώσωμεν;",
        15: 'Ο δε γνωρίσας την υπόκρισιν αυτών, είπε προς αυτούς· τι με πειράζετε; φέρετέ μοι δηνάριον διά να ίδω.',
    ...
    16: {
        ...
        7: "Αλλ' υπάγετε, είπατε προς τους μαθητάς αυτού και προς τον Πέτρον ότι υπάγει πρότερον υμών εις την Γαλιλαίαν· εκεί θέλετε ιδεί αυτόν, καθώς είπε προς εσάς.",
        ...
        9: 'Αφού δε ανέστη το πρωΐ της πρώτης της εβδομάδος, εφάνη πρώτον εις την Μαρίαν την Μαγδαληνήν, εξ ης είχεν εκβάλει επτά δαιμόνια.',
        10: "Εκείνη υπήγε και απήγγειλε προς εκείνους, οίτινες είχον σταθή μετ' αυτού, ενώ επένθουν και έκλαιον.",
        11: "Και εκείνοι, ακούσαντες ότι ζη και εθεάθη υπ' αυτής, δεν επίστευσαν.",
        12: 'Μετά δε ταύτα εφανερώθη εν άλλη μορφή εις δύο εξ αυτών, ενώ περιεπάτουν και επορεύοντο εις τον αγρόν.',
        13: "Και εκείνοι υπήγαν και απήγγειλαν προς τους λοιπούς· αλλ' ουδέ εις εκείνους επίστευσαν.",
