...
CHAPTERS = {
    ...
    3: {
        1: 'Ήτο δε άνθρωπός τις εκ των Φαρισαίων, Νικόδημος ονομαζόμενος, άρχων των Ιουδαίων.',
        2: "Ούτος ήλθε προς τον Ιησούν διά νυκτός και είπε προς αυτόν· Ραββί, εξεύρομεν ότι από Θεού ήλθες διδάσκαλος· διότι ουδείς δύναται να κάμνη τα σημεία ταύτα, τα οποία συ κάμνεις, εάν δεν ήναι ο Θεός μετ' αυτού.",
        ...
        6: 'Το γεγεννημένον εκ της σαρκός είναι σαρξ και το γεγεννημένον εκ του Πνεύματος είναι πνεύμα.',
        7: 'Μη θαυμάσης ότι σοι είπον, Πρέπει να γεννηθήτε άνωθεν.',
        ...
        9: 'Απεκρίθη ο Νικόδημος και είπε προς αυτόν· Πως δύνανται να γείνωσι ταύτα;',
        ...
        23: 'Ήτο δε και ο Ιωάννης βαπτίζων εν Αινών πλησίον του Σαλείμ, διότι ήσαν εκεί ύδατα πολλά, και ήρχοντο και εβαπτίζοντο·',
        24: 'Επειδή ο Ιωάννης δεν ήτο έτι βεβλημένος εις την φυλακήν.',
        25: 'Έγεινε λοιπόν συζήτησις περί καθαρισμού παρά των μαθητών του Ιωάννου με Ιουδαίους τινάς.',
        26: 'Και ήλθον προς τον Ιωάννην και είπον προς αυτόν· Ραββί, εκείνος όστις ήτο μετά σου πέραν του Ιορδάνου, εις τον οποίον συ εμαρτύρησας, ιδού, ούτος βαπτίζει και πάντες έρχονται προς αυτόν.',
        ...
        33: 'Όστις δεχθή την μαρτυρίαν αυτού επεσφράγισεν ότι ο Θεός είναι αληθής.',
    ...
    4: {
        ...
        40: "Καθώς λοιπόν ήλθον προς αυτόν οι Σαμαρείται, παρεκάλουν αυτόν να μείνη παρ' αυτοίς· και έμεινεν εκεί δύο ημέρας.",
        41: 'Και πολύ πλειότεροι επίστευσαν διά τον λόγον αυτού,',
        42: 'και προς την γυναίκα έλεγον, ότι δεν πιστεύομεν πλέον διά τον λόγον σου· επειδή ημείς ηκούσαμεν, και γνωρίζομεν ότι ούτος είναι αληθώς ο Σωτήρ του κόσμου, ο Χριστός.',
        ...
        53: "Ενόησε λοιπόν ο πατήρ ότι έγεινε τούτο κατ' εκείνην την ώραν, καθ' ην ο Ιησούς είπε προς αυτόν ότι Ο υιός σου ζή· και επίστευσεν αυτός και όλη η οικία αυτού.",
    ...
    8: {
        ...
        52: 'Είπον λοιπόν προς αυτόν οι Ιουδαίοι· Τώρα κατελάβομεν ότι δαιμόνιον έχεις. Ο Αβραάμ απέθανε και οι προφήται, και συ λέγεις· Εάν τις φυλάξη τον λόγον μου, δεν θέλει γευθή θάνατον εις τον αιώνα.',
    ...
    9: {
        ...
        32: 'Εκ του αιώνος δεν ηκούσθη ότι ήνοιξέ τις οφθαλμούς γεγεννημένου τυφλού.',
    ...
    11: {
        ...
        53: "Απ' εκείνης λοιπόν της ημέρας συνεβουλεύθησαν, διά να θανατώσωσιν αυτόν.",
        54: "Όθεν ο Ιησούς δεν περιεπάτει πλέον παρρησία μεταξύ των Ιουδαίων, αλλ' ανεχώρησεν εκείθεν εις τον τόπον πλησίον της ερήμου, εις πόλιν λεγομένην Εφραΐμ, και εκεί διέτριβε μετά των μαθητών αυτού.",
        55: 'Επλησίαζε δε το πάσχα των Ιουδαίων, και πολλοί ανέβησαν εκ του τόπου εκείνου εις Ιεροσόλυμα προ του πάσχα, διά να καθαρίσωσιν εαυτούς.',
        ...
        57: 'Είχον δε δώσει προσταγήν και οι αρχιερείς και οι Φαρισαίοι, εάν τις μάθη που είναι, να μηνύση, διά να πιάσωσιν αυτόν.',
    },
    12: {
    ...
    20: {
        ...
        2: 'Τρέχει λοιπόν και έρχεται προς τον Σίμωνα Πέτρον και προς τον άλλον μαθητήν, τον οποίον ηγάπα ο Ιησούς, και λέγει προς αυτούς· Εσήκωσαν τον Κύριον εκ του μνημείου, και δεν εξεύρομεν που έθεσαν αυτόν.',
        3: 'Εξήλθε λοιπόν ο Πέτρος και ο άλλος μαθητής και ήρχοντο εις το μνημείον.',
        4: 'Έτρεχον δε οι δύο ομού· και ο άλλος μαθητής προέτρεξε ταχύτερον του Πέτρου και ήλθε πρώτος εις το μνημείον,',
        ...
        8: 'Τότε λοιπόν εισήλθε και ο άλλος μαθητής ο ελθών πρώτος εις το μνημείον, και είδε και επίστευσε·',
        ...
        31: 'ταύτα δε εγράφησαν διά να πιστεύσητε ότι ο Ιησούς είναι ο Χριστός ο Υιός του Θεού, και πιστεύοντες να έχητε ζωήν εν τω ονόματι αυτού.',
    },
    21: {
        ...
        14: "Αύτη ήτο ήδη τρίτη φορά, καθ' ην ο Ιησούς εφανερώθη εις τους μαθητάς αυτού, αφού ηγέρθη εκ νεκρών.",
