...
CHAPTERS = {
    ...
    4: {
        ...
        9: 'Και όταν προσφέρωσι τα ζώα δόξαν και τιμήν και ευχαριστίαν εις τον καθήμενον επί του θρόνου, εις τον ζώντα εις τους αιώνας των αιώνων,',
        10: 'οι εικοσιτέσσαρες πρεσβύτεροι θέλουσι πέσει ενώπιον του καθημένου επί του θρόνου, και θέλουσι προσκυνήσει τον ζώντα εις τους αιώνας των αιώνων, και θέλουσι βάλει τους στεφάνους αυτών ενώπιον του θρόνου, λέγοντες·',
    ...
    5: {
        1: 'Και είδον εν τη δεξιά του καθημένου επί του θρόνου βιβλίον γεγραμμένον έσωθεν και όπισθεν, κατεσφραγισμένον με σφραγίδας επτά.',
        2: 'Και είδον άγγελον ισχυρόν κηρύττοντα μετά φωνής μεγάλης· Τις είναι άξιος να ανοίξη το βιβλίον και να λύση τας σφραγίδας αυτού;',
        3: 'Και ουδείς ηδύνατο εν τω ουρανώ, ουδέ επί της γης ουδέ υποκάτω της γης να ανοίξη το βιβλίον ουδέ να βλέπη αυτό.',
        4: 'Και εγώ έκλαιον πολλά, ότι ουδείς ευρέθη άξιος να ανοίξη και να αναγνώση το βιβλίον ούτε να βλέπη αυτό.',
        5: 'Και εις εκ των πρεσβυτέρων μοι λέγει· Μη κλαίε· ιδού, υπερίσχυσεν ο λέων, όστις είναι εκ της φυλής Ιούδα, η ρίζα του Δαβίδ, να ανοίξη το βιβλίον και να λύση τας επτά σφραγίδας αυτού.',
        6: 'Και είδον και ιδού εν μέσω του θρόνου και των τεσσάρων ζώων και εν μέσω των πρεσβυτέρων Αρνίον ιστάμενον ως εσφαγμένον, έχον κέρατα επτά και οφθαλμούς επτά, οίτινες είναι τα επτά πνεύματα του Θεού τα απεσταλμένα εις πάσαν την γην.',
        7: 'Και ήλθε και έλαβε το βιβλίον εκ της δεξιάς του καθημένου επί του θρόνου.',
        8: 'Και ότε έλαβε το βιβλίον, τα τέσσαρα ζώα και οι εικοσιτέσσαρες πρεσβύτεροι έπεσον ενώπιον του Αρνίου, έχοντες έκαστος κιθάρας και φιάλας χρυσάς πλήρεις θυμιαμάτων, αίτινες είναι αι προσευχαί των αγίων·',
        9: 'και ψάλλουσι νέαν ωδήν, λέγοντες· Άξιος είσαι να λάβης το βιβλίον και να ανοίξης τας σφραγίδας αυτού, διότι εσφάγης και ηγόρασας ημάς εις τον Θεόν διά του αίματός σου εκ πάσης φυλής και γλώσσης και λαού και έθνους,',
        10: 'και έκαμες ημάς εις τον Θεόν ημών βασιλείς και ιερείς, και θέλομεν βασιλεύσει επί της γης.',
        11: 'Και είδον και ήκουσα φωνήν αγγέλων πολλών κυκλόθεν του θρόνου και των ζώων και των πρεσβυτέρων, και ήτο ο αριθμός αυτών μυριάδες μυριάδων και χιλιάδες χιλιάδων,',
        12: 'λέγοντες μετά φωνής μεγάλης· Άξιον είναι το Αρνίον το εσφαγμένον να λάβη την δύναμιν και πλούτον και σοφίαν και ισχύν και τιμήν και δόξαν και ευλογίαν.',
        13: 'Και παν κτίσμα, το οποίον είναι εν τω ουρανώ και επί της γης και υποκάτω της γης και όσα είναι εν τη θαλάσση και πάντα τα εν αυτοίς, ήκουσα ότι έλεγον· Εις τον καθήμενον επί του θρόνου και εις το Αρνίον έστω η ευλογία και η τιμή και η δόξα και το κράτος εις τους αιώνας των αιώνων.',
        14: 'Και τα τέσσαρα ζώα έλεγον· Αμήν· και οι εικοσιτέσσαρες πρεσβύτεροι έπεσαν και προσεκύνησαν τον ζώντα εις τους αιώνας των αιώνων.',
    },
    6: {
        ...
        8: "Και είδον, και ιδού, ίππος ωχρός, και ο καθήμενος επάνω αυτού ωνομάζετο θάνατος, και ο Άδης ηκολούθει μετ' αυτού· και εδόθη εις αυτούς εξουσία επί το τέταρτον της γης, να θανατώσωσι με ρομφαίαν και με πείναν και με θάνατον και με τα θηρία της γης.",
    ...
    7: {
        1: 'Και μετά ταύτα είδον τέσσαρας αγγέλους ισταμένους επί τας τέσσαρας γωνίας της γης, κρατούντας τους τέσσαρας ανέμους της γης, διά να μη πνέη άνεμος επί της γης μήτε επί της θαλάσσης μήτε επί παν δένδρον.',
        2: 'Και είδον άλλον άγγελον ότι ανέβη από ανατολής ηλίου, έχων σφραγίδα του Θεού του ζώντος, και έκραξε μετά φωνής μεγάλης προς τους τέσσαρας αγγέλους, εις τους οποίους εδόθη να βλάψωσι την γην και την θάλασσαν,',
        3: 'λέγων· Μη βλάψητε την γην μήτε την θάλασσαν μήτε τα δένδρα, εωσού σφραγίσωμεν τους δούλους του Θεού ημών επί των μετώπων αυτών.',
        4: 'Και ήκουσα τον αριθμόν των εσφραγισμένων· εκατόν τεσσαράκοντα τέσσαρες χιλιάδες ήσαν εσφραγισμένοι εκ πάσης φυλής των υιών Ισραήλ·',
        5: 'εκ φυλής Ιούδα δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Ρουβήν δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Γαδ δώδεκα χιλιάδες εσφραγισμένοι·',
        6: 'εκ φυλής Ασήρ δώδεκα χιλιάδες εσφραγισμένοι·εκ φυλής Νεφθαλείμ δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Μανασσή δώδεκα χιλιάδες εσφραγισμένοι.',
        7: 'εκ φυλής Συμεών δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Λευΐ δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Ισσάχαρ δώδεκα χιλιάδες εσφραγισμένοι·',
        8: 'εκ φυλής Ζαβουλών δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Ιωσήφ δώδεκα χιλιάδες εσφραγισμένοι· εκ φυλής Βενιαμίν δώδεκα χιλιάδες εσφραγισμένοι·',
        9: 'Μετά ταύτα είδον, και ιδού, όχλος πολύς, τον οποίον ουδείς ηδύνατο να αριθμήση, εκ παντός έθνους και φυλών και λαών και γλωσσών, οίτινες ίσταντο ενώπιον του θρόνου και ενώπιον του Αρνίου, ενδεδυμένοι στολάς λευκάς, έχοντες φοίνικας εν ταις χερσίν αυτών.',
        10: 'και κράζοντες μετά φωνής μεγάλης έλεγον· Η σωτηρία είναι του Θεού ημών, του καθημένου επί του θρόνου, και του Αρνίου.',
        11: 'Και πάντες οι άγγελοι ίσταντο κύκλω του θρόνου και των πρεσβυτέρων και των τεσσάρων ζώων, και έπεσαν κατά πρόσωπον ενώπιον του θρόνου και προσεκύνησαν τον Θεόν',
        12: 'λέγοντες· Αμήν· η ευλογία και δόξα και η σοφία και η ευχαριστία και η τιμή και η δύναμις και η ισχύς ανήκει εις τον Θεόν ημών εις τους αιώνας των αιώνων· αμήν.',
        13: 'Και απεκρίθη εις εκ των πρεσβυτέρων, λέγων προς εμέ· Ούτοι οι ενδεδυμένοι τας στολάς τας λευκάς τίνες είναι και πόθεν ήλθον;',
        14: 'Και είπα προς αυτόν· Κύριε, συ εξεύρεις. Και είπε προς εμέ· Ούτοι είναι οι ερχόμενοι εκ της θλίψεως της μεγάλης, και έπλυναν τας στολάς αυτών και ελεύκαναν αυτάς εν τω αίματι του Αρνίου.',
        15: "Διά τούτο είναι ενώπιον του θρόνου του Θεού και λατρεύουσιν αυτόν ημέραν και νύκτα εν τω ναώ αυτού, και ο καθήμενος επί του θρόνου θέλει κατασκηνώσει επ' αυτούς.",
        16: "Δεν θέλουσι πεινάσει πλέον ουδέ θέλουσι διψήσει πλέον, ουδέ θέλει πέσει επ' αυτούς ο ήλιος ουδέ κανέν καύμα,",
        17: 'διότι το Αρνίον το αναμέσον του θρόνου θέλει ποιμάνει αυτούς και οδηγήσει αυτούς εις ζώσας πηγάς υδάτων, και θέλει εξαλείψει ο Θεός παν δάκρυον από των οφθαλμών αυτών.',
    },
    8: {
    ...
    9: {
        ...
        4: 'και ερρέθη προς αυτάς να μη βλάψωσι τον χόρτον της γης μηδέ κανέν χλωρόν μηδέ κανέν δένδρον, ειμή τους ανθρώπους μόνους, οίτινες δεν έχουσι την σφραγίδα του Θεού επί των μετώπων αυτών.',
        5: 'Και εδόθη εις αυτάς να μη θανατώσωσιν αυτούς, αλλά να βασανισθώσι πέντε μήνας· και ο βασανισμός αυτών ήτο ως βασανισμός σκορπίου, όταν κτυπήση άνθρωπον.',
        6: "Και εν ταις ημέραις εκείναις θέλουσι ζητήσει οι άνθρωποι τον θάνατον και δεν θέλουσιν ευρεί αυτόν, και θέλουσιν επιθυμήσει να αποθάνωσι, και ο θάνατος θέλει φύγει απ' αυτών.",
        7: 'Και αι μορφαί των ακρίδων ήσαν όμοιαι με ίππους ητοιμασμένους εις πόλεμον, και επί τας κεφαλάς αυτών ήσαν ως στέφανοι όμοιοι με χρυσόν, και τα πρόσωπα αυτών ως πρόσωπα ανθρώπων.',
        8: 'Και είχον τρίχας ως τρίχας γυναικών, και οι οδόντες αυτών ήσαν ως λεόντων,',
        9: 'και είχον θώρακας ως θώρακας σιδηρούς, και η φωνή των πτερύγων αυτών ήτο ως φωνή αμαξών ίππων πολλών τρεχόντων εις πόλεμον.',
        ...
        13: 'Και ο έκτος άγγελος εσάλπισε· και ήκουσα μίαν φωνήν εκ των τεσσάρων κεράτων του θυσιαστηρίου του χρυσού του ενώπιον του Θεού,',
        ...
        15: 'Και ελύθησαν οι τέσσαρες άγγελοι, οι ητοιμασμένοι εις την ώραν και ημέραν και μήνα και ενιαυτόν, διά να θανατώσωσι το τρίτον των ανθρώπων.',
        16: 'Και ο αριθμός των στρατευμάτων του ιππικού ήτο δύο μυριάδες μυριάδων· και ήκουσα τον αριθμόν αυτών.',
        17: "Και ούτως είδον τους ίππους εν τη οράσει και τους καθημένους επ' αυτών, ότι είχον θώρακας πυρίνους και υακινθίνους και θειώδεις· και αι κεφαλαί των ίππων ήσαν ως κεφαλαί λεόντων, και εκ των στομάτων αυτών εξήρχετο πυρ και καπνός και θείον.",
        ...
        20: 'Και οι λοιποί των ανθρώπων, οίτινες δεν εθανατώθησαν με τας πληγάς ταύτας, ούτε μετενόησαν από των έργων των χειρών αυτών, ώστε να μη προσκυνήσωσι τα δαιμόνια και τα είδωλα τα χρυσά και τα αργυρά και τα χάλκινα και τα λίθινα και τα ξύλινα, τα οποία ούτε να βλέπωσι δύνανται ούτε να ακούωσιν ούτε να περιπατώσι,',
    ...
    10: {
        ...
        6: 'και ώμοσεν εις τον ζώντα εις τους αιώνας των αιώνων, όστις έκτισε τον ουρανόν και τα εν αυτώ, και την γην και τα εν αυτή και την θάλασσαν και τα εν αυτή, ότι καιρός δεν θέλει είσθαι έτι,',
    ...
    14: {
        1: "Και είδον, και ιδού Αρνίον ιστάμενον επί το όρος Σιών, και μετ' αυτού εκατόν τεσσαράκοντα τέσσαρες χιλιάδες, έχουσαι το όνομα του Πατρός αυτού γεγραμμένον επί των μετώπων αυτών.",
        2: 'Και ήκουσα φωνήν εκ του ουρανού ως φωνήν υδάτων πολλών και ως φωνήν βροντής μεγάλης· και ήκουσα φωνήν κιθαρωδών οίτινες εκιθάριζον με τας κιθάρας αυτών.',
        3: 'Και έψαλλον ως ωδήν νέαν ενώπιον του θρόνου και ενώπιον των τεσσάρων ζώων και των πρεσβυτέρων· και ουδείς ηδύνατο να μάθη την ωδήν, ειμή αι εκατόν τεσσαράκοντα τέσσαρες χιλιάδες, οι ηγορασμένοι από της γης.',
        4: 'Ούτοι είναι οι μη μολυνθέντες με γυναίκας· διότι παρθένοι είναι. Ούτοι είναι οι ακολουθούντες το Αρνίον όπου αν υπάγη. Ούτοι ηγοράσθησαν από των ανθρώπων απαρχή εις τον Θεόν και εις το Αρνίον·',
        5: 'και εν τω στόματι αυτών δεν ευρέθη δόλος, διότι είναι άμωμοι ενώπιον του θρόνου Θεού,',
        6: 'Και είδον άλλον άγγελον πετώμενον εις το μεσουράνημα, όστις είχεν ευαγγέλιον αιώνιον, διά να κηρύξη εις τους κατοικούντας επί της γης και εις παν έθνος και φυλήν και γλώσσαν και λαόν,',
        7: 'και έλεγε μετά φωνής μεγάλης· Φοβήθητε τον Θεόν και δότε δόξαν εις αυτόν, διότι ήλθεν η ώρα της κρίσεως αυτού, και προσκυνήσατε τον ποιήσαντα τον ουρανόν και την γην και την θάλασσαν και τας πηγάς των υδάτων.',
        8: 'Και άλλος άγγελος ηκολούθησε, λέγων· Έπεσεν, έπεσε Βαβυλών η πόλις η μεγάλη, διότι εκ του οίνου του θυμού της πορνείας αυτής επότισε πάντα τα έθνη.',
        ...
        13: 'Και ήκουσα φωνήν εκ του ουρανού λέγουσαν προς εμέ· Γράψον, Μακάριοι οι νεκροί, οίτινες αποθνήσκουσιν εν Κυρίω από του νυν. Ναι, λέγει το Πνεύμα, διά να αναπαυθώσιν από των κόπων αυτών, και τα έργα αυτών ακολουθούσι με αυτούς.',
        14: 'Και είδον, και ιδού, νεφέλη λευκή, και επί της νεφέλης εκάθητό τις όμοιος με υιόν ανθρώπου, έχων επί της κεφαλής αυτού στέφανον χρυσούν και εν τη χειρί αυτού δρέπανον κοπτερόν.',
        15: 'Και άλλος άγγελος εξήλθεν εκ του ναού, κράζων μετά μεγάλης φωνής προς τον καθήμενον επί της νεφέλης. Πέμψον το δρέπανόν σου και θέρισον, διότι ήλθεν εις σε η ώρα του να θερίσης, επειδή εξηράνθη ο θερισμός της γης.',
        16: 'Και ο καθήμενος επί της νεφέλης έβαλε το δρέπανον αυτού επί την γην, και εθερίσθη η γη.',
        17: 'Και άλλος άγγελος εξήλθεν εκ του ναού του εν τω ουρανώ, έχων και αυτός δρέπανον κοπτερόν.',
        18: 'Και άλλος άγγελος εξήλθεν εκ του θυσιαστηρίου, έχων εξουσίαν επί του πυρός, και εφώναξε μετά κραυγής μεγάλης προς τον έχοντα το δρέπανον το κοπτερόν, λέγων· Πέμψον το δρέπανόν σου το κοπτερόν και τρύγησον τους βότρυας της αμπέλου της γης, διότι ωρίμασαν τα σταφύλια αυτής.',
        ...
        20: 'Και επατήθη ο ληνός έξω της πόλεως, και εξήλθεν αίμα εκ του ληνού έως των χαλινών των ίππων εις διάστημα χιλίων εξακοσίων σταδίων.',
    },
    15: {
        ...
        2: 'Και είδον ως θάλασσαν υαλίνην μεμιγμένην με πυρ, και εκείνους οίτινες ενίκησαν κατά του θηρίου και κατά της εικόνος αυτού και κατά του χαράγματος αυτού και κατά του αριθμού του ονόματος αυτού ισταμένους επί την θάλασσαν την υαλίνην, έχοντας κιθάρας του Θεού.',
        3: 'Και έψαλλον την ωδήν Μωϋσέως του δούλου του Θεού και την ωδήν του Αρνίου, λέγοντες· Μεγάλα και θαυμαστά τα έργα σου, Κύριε Θεέ παντοκράτωρ· δίκαιαι και αληθιναί αι οδοί σου, βασιλεύ των αγίων.',
        4: 'Τις δεν θέλει σε φοβηθή, Κύριε, και δοξάσει το όνομά σου; διότι είσαι μόνος όσιος, διότι πάντα τα έθνη θέλουσιν ελθεί και προσκυνήσει ενώπιόν σου, διότι αι κρίσεις σου εφανερώθησαν.',
        5: 'Και μετά ταύτα είδον και ιδού, ηνοίχθη ο ναός της σκηνής του μαρτυρίου εν τω ουρανώ,',
        6: 'και εξήλθον εκ του ναού οι επτά άγγελοι, έχοντες τας επτά πληγάς, ενδεδυμένοι λινά καθαρά και λαμπρά και περιεζωσμένοι περί τα στήθη ζώνας χρυσάς.',
        7: 'Και εν εκ των τεσσάρων ζώων έδωκεν εις τους επτά αγγέλους επτά φιάλας χρυσάς, πλήρεις του θυμού του Θεού του ζώντος εις τους αιώνας των αιώνων.',
        8: 'Και εγεμίσθη ο ναός από καπνού εκ της δόξης του Θεού και εκ της δυνάμεως αυτού· και ουδείς ηδύνατο να εισέλθη εις τον ναόν, εωσού τελειώσωσιν αι επτά πληγαί των επτά αγγέλων.',
    },
    16: {
        ...
        13: 'Και είδον τρία ακάθαρτα πνεύματα όμοια με βατράχους εξερχόμενα εκ του στόματος του δράκοντος και εκ του στόματος του θηρίου και εκ του στόματος του ψευδοπροφήτου·',
        14: 'διότι είναι πνεύματα δαιμόνων εκτελούντα σημεία, τα οποία εκπορεύονται προς τους βασιλείς της γης και της οικουμένης όλης, διά να συνάξωσιν αυτούς εις τον πόλεμον της ημέρας εκείνης της μεγάλης του Θεού του παντοκράτορος.',
        15: 'Ιδού, έρχομαι ως κλέπτης· μακάριος όστις αγρυπνεί και φυλάττει τα ιμάτια αυτού, διά να μη περιπατή γυμνός και βλέπωσι την ασχημοσύνην αυτού.',
        16: 'Και συνήθροισεν αυτούς εις τον τόπον τον καλούμενον Εβραϊστί Αρμαγεδδών.',
        17: 'Και ο έβδομος άγγελος εξέχεε την φιάλην αυτού εις τον αέρα· και εξήλθε φωνή μεγάλη από του ναού του ουρανού από του θρόνου, λέγουσα· Ετελέσθη.',
        18: 'Και έγειναν φωναί και βρονταί και αστραπαί, και έγεινε σεισμός μέγας, οποίος δεν έγεινεν αφού οι άνθρωποι υπήρξαν επί της γης, τόσον πολλά μεγάλος σεισμός.',
        19: 'Και διηρέθη η πόλις η μεγάλη εις τρία μέρη, και αι πόλεις των εθνών έπεσον. Και Βαβυλών η μεγάλη ήλθεν εις ενθύμησιν ενώπιον του Θεού διά να δώση εις αυτήν το ποτήριον του οίνου του θυμού της οργής αυτού.',
        20: 'Και πάσα νήσος έφυγε και τα όρη δεν ευρέθησαν.',
        21: 'Και χάλαζα μεγάλη έως ενός ταλάντου κατέβαινεν εκ του ουρανού επί τους ανθρώπους· και εβλασφήμησαν οι άνθρωποι τον Θεόν διά την πληγήν της χαλάζης, διότι η πληγή αυτής ήτο μεγάλη σφόδρα.',
    },
    17: {
    ...
    19: {
        ...
        3: 'Και εκ δευτέρου είπον· Αλληλούϊα· και ο καπνός αυτής αναβαίνει εις τους αιώνας των αιώνων.',
        ...
        20: 'Και επιάσθη το θηρίον και μετά τούτου ο ψευδοπροφήτης, όστις έκαμε τα σημεία ενώπιον αυτού, με τα οποία επλάνησε τους λαβόντας το χάραγμα του θηρίου και τους προσκυνούντας την εικόνα αυτού· ζώντες ερρίφθησαν οι δύο εις την λίμνην του πυρός, την καιομένην με το θείον.',
