...
CHAPTERS = {
    ...
    3: {
        ...
        11: 'Εγώ μεν σας βαπτίζω εν ύδατι εις μετάνοιαν· ο δε οπίσω μου ερχόμενος είναι ισχυρότερός μου, του οποίου δεν είμαι άξιος να βαστάσω τα υποδήματα· αυτός θέλει σας βαπτίσει εν Πνεύματι Αγίω και πυρί.',
        12: 'Όστις κρατεί το πτυάριον εν τη χειρί αυτού και θέλει διακαθαρίσει το αλώνιον αυτού και θέλει συνάξει τον σίτον αυτού εις την αποθήκην, το δε άχυρον θέλει κατακαύσει εν πυρί ασβέστω.',
    ...
    5: {
        ...
        22: 'Εγώ όμως σας λέγω ότι πας ο οργιζόμενος αναιτίως κατά του αδελφού αυτού θέλει είσθαι ένοχος εις την κρίσιν· και όστις είπη προς τον αδελφόν αυτού Ρακά, θέλει είσθαι ένοχος εις το συνέδριον· όστις δε είπη Μωρέ, θέλει είσθαι ένοχος εις την γέενναν του πυρός.',
        ...
        29: 'Εάν ο οφθαλμός σου ο δεξιός σε σκανδαλίζη, έκβαλε αυτόν και ρίψον από σού· διότι σε συμφέρει να χαθή εν των μελών σου και να μη ριφθή όλον το σώμα σου εις την γέενναν.',
        30: 'Και εάν η δεξιά σου χειρ σε σκανδαλίζη, έκκοψον αυτήν και ρίψον από σού· διότι σε συμφέρει να χαθή εν των μελών σου, και να μη ριφθή όλον το σώμα σου εις την γέενναν.',
    ...
    7: {
        ...
        6: 'Μη δώσητε το άγιον εις τους κύνας μηδέ ρίψητε τους μαργαρίτας σας έμπροσθεν των χοίρων, μήποτε καταπατήσωσιν αυτούς με τους πόδας αυτών και στραφέντες σας διασχίσωσιν.',
        ...
        22: 'Πολλοί θέλουσιν ειπεί προς εμέ εν εκείνη τη ημέρα, Κύριε, Κύριε, δεν προεφητεύσαμεν εν τω ονόματί σου, και εν τω ονόματί σου εξεβάλομεν δαιμόνια, και εν τω ονόματί σου εκάμομεν θαύματα πολλά;',
    ...
    10: {
        ...
        4: 'Σίμων ο Κανανίτης και ο Ιούδας ο Ισκαριώτης, όστις και παρέδωκεν αυτόν.',
        ...
        14: 'Και όστις δεν σας δεχθή μηδέ ακούση τους λόγους σας, εξερχόμενοι της οικίας ή της πόλεως εκείνης εκτινάξατε τον κονιορτόν των ποδών σας.',
        ...
        18: 'και έτι ενώπιον ηγεμόνων και βασιλέων θέλετε φερθή ένεκεν εμού προς μαρτυρίαν εις αυτούς και εις τα έθνη.',
        19: 'Όταν δε σας παραδίδωσι, μη μεριμνήσητε πως ή τι θέλετε λαλήσει· διότι θέλει σας δοθή εν εκείνη τη ώρα τι πρέπει να λαλήσητε.',
        ...
        22: 'και θέλετε είσθαι μισούμενοι υπό πάντων διά το όνομά μου· ο δε υπομείνας έως τέλους, ούτος θέλει σωθή.',
        23: 'Όταν δε σας διώκωσιν εν τη πόλει ταύτη, φεύγετε εις την άλλην· διότι αληθώς σας λέγω, δεν θέλετε τελειώσει τας πόλεις του Ισραήλ, εωσού έλθη ο Υιός του ανθρώπου.',
        24: 'Δεν είναι μαθητής ανώτερος του διδασκάλου ουδέ δούλος ανώτερος του κυρίου αυτού.',
        25: 'Αρκετόν είναι εις τον μαθητήν να γείνη ως ο διδάσκαλος αυτού, και ο δούλος ως ο κύριος αυτού. Εάν τον οικοδεσπότην ωνόμασαν Βεελζεβούλ, πόσω μάλλον τους οικιακούς αυτού;',
        ...
        27: 'ό,τι σας λέγω εν τω σκότει, είπατε εν τω φωτί, και ό,τι ακούετε εις το ωτίον, κηρύξατε επί των δωμάτων.',
        28: 'Και μη φοβηθήτε από των αποκτεινόντων το σώμα, την δε ψυχήν μη δυναμένων να αποκτείνωσι· φοβήθητε δε μάλλον τον δυνάμενον και ψυχήν και σώμα να απολέση εν τη γεέννη.',
        ...
        37: 'Όστις αγαπά πατέρα ή μητέρα υπέρ εμέ, δεν είναι άξιος εμού· και όστις αγαπά υιόν ή θυγατέρα υπέρ εμέ, δεν είναι άξιος εμού·',
        ...
        41: 'Ο δεχόμενος προφήτην εις όνομα προφήτου μισθόν προφήτου θέλει λάβει, και ο δεχόμενος δίκαιον εις όνομα δικαίου, μισθόν δικαίου θέλει λάβει.',
    ...
    11: {
        ...
        23: 'Και συ, Καπερναούμ, η υψωθείσα έως του ουρανού, θέλεις καταβιβασθή έως άδου· διότι εάν τα θαύματα τα γενόμενα εν σοι εγίνοντο εν Σοδόμοις, ήθελον μείνει μέχρι της σήμερον.',
    ...
    13: {
        1: 'Εν εκείνη δε τη ημέρα εξελθών ο Ιησούς από της οικίας εκάθητο πλησίον της θαλάσσης·',
        2: 'και συνήχθησαν προς αυτόν όχλοι πολλοί, ώστε εμβάς εις το πλοίον εκάθητο, και πας ο όχλος ίστατο επί τον αιγιαλόν.',
        ...
        51: 'Λέγει προς αυτούς ο Ιησούς· Ενοήσατε ταύτα πάντα; Λέγουσι προς αυτόν· Ναι, Κύριε.',
        ...
        53: 'Και αφού ετελείωσεν ο Ιησούς τας παραβολάς ταύτας, ανεχώρησεν εκείθεν,',
        54: 'και ελθών εις την πατρίδα αυτού, εδίδασκεν αυτούς εν τη συναγωγή αυτών, ώστε εξεπλήττοντο και έλεγον· Πόθεν εις τούτον η σοφία αύτη και αι δυνάμεις;',
        55: 'δεν είναι ούτος ο υιός του τέκτονος; η μήτηρ αυτού δεν λέγεται Μαριάμ, και οι αδελφοί αυτού Ιάκωβος και Ιωσής και Σίμων και Ιούδας;',
        56: "και αι αδελφαί αυτού δεν είναι πάσαι παρ' ημίν; πόθεν λοιπόν εις τούτον ταύτα πάντα;",
        57: 'Και εσκανδαλίζοντο εν αυτώ. Ο δε Ιησούς είπε προς αυτούς· Δεν είναι προφήτης άνευ τιμής ειμή εν τη πατρίδι αυτού και εν τη οικία αυτού.',
        58: 'Και δεν έκαμεν εκεί πολλά θαύματα διά την απιστίαν αυτών.',
    },
    14: {
    ...
    16: {
        ...
        2: 'Ο δε αποκριθείς είπε προς αυτούς· Όταν γείνη εσπέρα, λέγετε· Καλωσύνη· διότι κοκκινίζει ο ουρανός·',
        3: 'και το πρωΐ· Σήμερον χειμών· διότι κοκκινίζει σκυθρωπάζων ο ουρανός. Υποκριταί, το μεν πρόσωπον του ουρανού εξεύρετε να διακρίνητε, τα δε σημεία των καιρών δεν δύνασθε;',
        4: 'Γενεά πονηρά και μοιχαλίς σημείον ζητεί, και σημείον δεν θέλει δοθή εις αυτήν ειμή το σημείον Ιωνά του προφήτου. Και αφήσας αυτούς ανεχώρησε.',
        5: 'Και ελθόντες οι μαθηταί αυτού εις το πέραν, ελησμόνησαν να λάβωσιν άρτους.',
        6: 'Ο δε Ιησούς είπε προς αυτούς· Βλέπετε και προσέχετε από της ζύμης των Φαρισαίων και Σαδδουκαίων.',
        7: 'Και εκείνοι διελογίζοντο εν εαυτοίς, λέγοντες ότι άρτους δεν ελάβομεν.',
        8: 'Νοήσας δε ο Ιησούς, είπε προς αυτούς· Τι διαλογίζεσθε εν εαυτοίς, ολιγόπιστοι, ότι άρτους δεν ελάβετε;',
        9: 'έτι δεν καταλαμβάνετε, ουδέ ενθυμείσθε τους πέντε άρτους των πεντακισχιλίων και πόσους κοφίνους ελάβετε;',
        ...
        17: "Και αποκριθείς ο Ιησούς είπε προς αυτόν· Μακάριος είσαι, Σίμων, υιέ του Ιωνά, διότι σαρξ και αίμα δεν σοι απεκάλυψε τούτο, αλλ' ο Πατήρ μου ο εν τοις ουρανοίς.",
        ...
        19: 'Και θέλω σοι δώσει τα κλειδία της βασιλείας των ουρανών, και ό,τι εάν δέσης επί της γης, θέλει είσθαι δεδεμένον εν τοις ουρανοίς, και ό,τι εάν λύσης επί της γης, θέλει είσθαι λελυμένον εν τοις ουρανοίς.',
    ...
    28: {
        1: 'Αφού δε επέρασε το σάββατον, περί τα χαράγματα της πρώτης ημέρας της εβδομάδος ήλθε Μαρία η Μαγδαληνή και η άλλη Μαρία, διά να θεωρήσωσι τον τάφον.',
        ...
        5: 'Αποκριθείς δε ο άγγελος είπε προς τας γυναίκας· μη φοβείσθε σείς· διότι εξεύρω ότι Ιησούν τον εσταυρωμένον ζητείτε·',
        6: 'δεν είναι εδώ· διότι ανέστη, καθώς είπεν. Έλθετε, ίδετε τον τόπον όπου έκειτο ο Κύριος.',
        7: 'Και υπάγετε ταχέως και είπατε προς τους μαθητάς αυτού ότι ανέστη εκ των νεκρών, και ιδού, υπάγει πρότερον υμών εις την Γαλιλαίαν· εκεί θέλετε ιδεί αυτόν· ιδού, σας είπον.',
        8: 'Και εξελθούσαι ταχέως από του μνημείου μετά φόβου και χαράς μεγάλης έδραμον να απαγγείλωσι προς τους μαθητάς αυτού.',
        9: 'Ενώ δε ήρχοντο να απαγγείλωσι προς τους μαθητάς αυτού, ιδού, ο Ιησούς απήντησεν αυτάς, λέγων· Χαίρετε. Και εκείναι προσελθούσαι επίασαν τους πόδας αυτού και προσεκύνησαν αυτόν.',
