...
CHAPTERS = {
    1: {
        ...
        25: '彼らは神の眞を易へて虚僞となし、造物主を措きて造られたる物を拜し、且これに事ふ、造物主は永遠に讃むべき者なり、アァメン。',
    ...
    9: {
        ...
        5: '先祖たちも彼 等のものなり、肉によれば、キリストも彼 等より出で給ひたり。キリストは萬物の上にあり、永遠に讃むべき神なり、アァメン。',
    ...
    10: {
        ...
        7: 'これキリストを引下さんとするなり『また「たれか底なき所に下らん」と言ふなかれ』と。是キリストを死人の中より引上げんとするなり。',
    ...
    11: {
        ...
        32: '神は凡ての人を憐まんために、凡ての人を不順の中に取籠め給ひたり。',
    ...
    16: {
        ...
        27: '唯一の智き神に、榮光 世々 限りなくイエス・キリストに由りて在らんことを、アァメン。',
    },
}
