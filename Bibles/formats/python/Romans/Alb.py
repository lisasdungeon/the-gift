...
CHAPTERS = {
    ...
    2: {
        ...
        7: 'jetë të përjetshme atyre që kërkojnë lavdi, nder e pavdekësi, duke ngulmuar në veprat e mira;',
    ...
    10: {
        ...
        7: "Ose: ''Kush do të zbresë në humnerë?''. Kjo do të thotë që të sjellë lart Krishtin prej së vdekurish.",
