...
CHAPTERS = {
    ...
    5: {
        ...
        11: 'And not only [that], but [we are] making our boast inGod, through our Lord Jesus Christ, through whom now we have received the reconciliation.',
        ...
        15: 'But [shall] not the act of favour [be] as the offence? For if by the offence of one the many have died, much rather has the grace ofGod, and the free gift in grace, which [is] by the one man Jesus Christ, abounded unto the many.',
    ...
    6: {
        ...
        11: 'So also ye, reckon yourselves dead to sin and alive toGod in Christ Jesus.',
        12: 'Let not sin therefore reign in your mortal body to obey its lusts.',
        13: 'Neither yield your members instruments of unrighteousness to sin, but yield yourselves toGod as alive from among [the] dead, and your members instruments of righteousness toGod.',
        ...
        17: 'But thanks [be] toGod, that ye were bondmen of sin, but have obeyed from the heart the form of teaching into which ye were instructed.',
        ...
        22: 'But now, having got your freedom from sin, and having become bondmen toGod, ye have your fruit unto holiness, and the end eternal life.',
        23: 'For the wages of sin [is] death; but the act of favour ofGod, eternal life in Christ Jesus our Lord.',
    },
    7: {
        ...
        4: 'So that, my brethren, ye also have been made dead to the law by the body of the Christ, to be to another, who has been raised up from among [the] dead, in order that we might bear fruit toGod.',
        ...
        22: 'For I delight in the law ofGod according to the inward man:',
        ...
        25: "I thankGod, through Jesus Christ our Lord. So then I myself with the mind serveGod's law; but with the flesh sin's law.",
    },
    8: {
        ...
        7: 'Because the mind of the flesh is enmity againstGod: for it is not subject to the law ofGod; for neither indeed can it be:',
        8: 'and they that are in flesh cannot pleaseGod.',
        9: "But ye are not in flesh but in Spirit, if indeedGod's Spirit dwell in you; but if any one has not [the] Spirit of Christ he is not of him:",
        ...
        14: 'for as many as are led by [the] Spirit ofGod, these are sons ofGod.',
        ...
        16: 'The Spirit itself bears witness with our spirit, that we are children ofGod.',
        17: "And if children, heirs also: heirs ofGod, and Christ's joint heirs; if indeed we suffer with [him], that we may also be glorified with [him].",
        ...
        19: 'For the anxious looking out of the creature expects the revelation of the sons ofGod:',
        ...
        21: 'that the creature itself also shall be set free from the bondage of corruption into the liberty of the glory of the children ofGod.',
        ...
        27: 'But he who searches the hearts knows what [is] the mind of the Spirit, because he intercedes for saints according toGod.',
        28: 'But we do know that all things work together for good to those who loveGod, to those who are called according to purpose.',
        ...
        31: 'What shall we then say to these things? IfGod [be] for us, who against us?',
        ...
        33: "Who shall bring an accusation againstGod's elect? [It is]God who justifies:",
        34: 'who is he that condemns? [It is] Christ who has died, but rather has been [also] raised up; who is also at the right hand ofGod; who also intercedes for us.',
        ...
        39: 'nor height, nor depth, nor any other creature, shall be able to separate us from the love ofGod, which [is] in Christ Jesus our Lord.',
    },
    9: {
    ...
    11: {
        1: 'I say then, HasGod cast away his people? Far be the thought. For I also am an Israelite, of [the] seed of Abraham, of [the] tribe of Benjamin.',
        2: 'God has not cast away his people whom he foreknew. Know ye not what the scripture says in [the history of] Elias, how he pleads withGod against Israel?',
        ...
        21: 'ifGod indeed has not spared the natural branches; lest it might be he spare not thee either.',
        22: 'Behold then [the] goodness and severity ofGod: upon them who have fallen, severity; upon thee goodness ofGod, if thou shalt abide in goodness, since [otherwise] thou also wilt be cut away.',
        23: 'And they too, if they abide not in unbelief, shall be grafted in; forGod is able again to graft them in.',
        ...
        29: 'For the gifts and the calling ofGod [are] not subject to repentance.',
        30: 'For as indeed ye [also] once have not believed inGod, but now have been objects of mercy through the unbelief of these;',
        31: 'so these also have now not believed in your mercy, in order that they also may be objects of mercy.',
        32: 'ForGod hath shut up together all in unbelief, in order that he might shew mercy to all.',
        33: 'O depth of riches both of [the] wisdom and knowledge ofGod! how unsearchable his judgments, and untraceable his ways!',
    ...
    14: {
        ...
        3: 'Let not him that eats make little of him that eats not; and let not him that eats not judge him that eats: forGod has received him.',
        ...
        6: 'He that regards the day, regards it to [the] Lord. And he that eats, eats to [the] Lord, for he givesGod thanks; and he that does not eat, [it is] to [the] Lord he does not eat, and givesGod thanks.',
        ...
        10: 'But thou, why judgest thou thy brother? or again, thou, why dost thou make little of thy brother? for we shall all be placed before the judgment-seat ofGod.',
        11: 'For it is written, I live, saith [the] Lord, that to me shall bow every knee, and every tongue shall confess toGod.',
        12: 'So then each of us shall give an account concerning himself toGod.',
        ...
        17: 'for the kingdom ofGod is not eating and drinking, but righteousness, and peace, and joy in [the] Holy Spirit.',
        18: 'For he that in this serves the Christ [is] acceptable toGod and approved of men.',
        19: 'So then let us pursue the things which tend to peace, and things whereby one shall build up another.',
        20: 'For the sake of meat do not destroy the work ofGod. All things indeed [are] pure; but [it is] evil to that man who eats while stumbling [in doing so].',
        21: '[It is] right not to eat meat, nor drink wine, nor [do anything] in which thy brother stumbles, or is offended, or is weak.',
        22: 'Hast thou faith? have [it] to thyself beforeGod. Blessed [is] he who does not judge himself in what he allows.',
    ...
    16: {
        ...
        20: 'But theGod of peace shall bruise Satan under your feet shortly. The grace of our Lord Jesus Christ [be] with you.',
        ...
        26: 'but [which] has now been made manifest, and by prophetic scriptures, according to commandment of the eternalGod, made known for obedience of faith to all the nations —',
