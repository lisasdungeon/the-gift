...
CHAPTERS = {
    1: {
        ...
        13: 'Ich will aber nicht, daß euch unbekannt sei, Brüder, daß ich mir oft vorgesetzt habe, zu euch zu kommen, auf daß ich auch unter euch einige Frucht haben möchte, gleichwie auch unter den übrigen Nationen.',
    ...
    2: {
        ...
        18: 'und den Willen kennst und das Vorzüglichere unterscheidest, indem du aus dem Gesetz unterrichtet bist,',
        ...
        24: 'Denn der Name Gottes wird eurethalben gelästert unter den Nationen, wie geschrieben steht.',
        ...
        28: 'Denn nicht der ist ein Jude, der es äußerlich ist, noch die äußerliche Beschneidung im Fleische Beschneidung;',
    ...
    3: {
        ...
        3: 'Was denn? wenn etliche nicht geglaubt haben, wird etwa ihr Unglaube Gottes Treue aufheben?',
        ...
        5: 'Wenn aber unsere Ungerechtigkeit Gottes Gerechtigkeit erweist, was wollen wir sagen? Ist Gott etwa ungerecht, der Zorn auferlegt?',
    ...
    4: {
        ...
        16: 'Darum ist es aus Glauben, auf daß es nach Gnade sei, damit die Verheißung dem ganzen Samen fest sei, nicht allein dem vom Gesetz, sondern auch dem vom Glauben Abrahams, welcher unser aller Vater ist,',
        17: ', vor dem Gott, welchem er glaubte, der die Toten lebendig macht und das Nichtseiende ruft, wie wenn es da wäre;',
        18: 'der wider Hoffnung auf Hoffnung geglaubt hat, auf daß er ein Vater vieler Nationen würde, nach dem, was gesagt ist: "Also soll dein Same sein".',
    ...
    5: {
        1: 'Da wir nun gerechtfertigt worden sind aus Glauben, so haben wir Frieden mit Gott durch unseren Herrn Jesum Christum,',
        ...
        11: 'Nicht allein aber das, sondern wir rühmen uns auch Gottes durch unseren Herrn Jesum Christum, durch welchen wir jetzt die Versöhnung empfangen haben.',
    ...
    7: {
        1: 'Oder wisset ihr nicht, Brüder, daß das Gesetz über den Menschen herrscht, solange er lebt?',
    ...
    8: {
        ...
        20: 'Denn die Schöpfung ist der Eitelkeit unterworfen worden, auf Hoffnung,',
        ...
        26: 'Desgleichen aber nimmt auch der Geist sich unserer Schwachheit an; denn wir wissen nicht, was wir bitten sollen, wie sichs gebührt, aber der Geist selbst verwendet sich für uns in unaussprechlichen Seufzern.',
    ...
    9: {
        ...
        9: 'Denn dieses Wort ist ein Verheißungswort: "Um diese Zeit will ich kommen, und Sarah wird einen Sohn haben".',
        10: 'Nicht allein aber das, sondern auch Rebekka, als sie schwanger war von Einem, von Isaak, unserem Vater,',
        11: 'selbst als die Kinder noch nicht geboren waren und weder Gutes noch Böses getan hatten,',
    ...
    12: {
        ...
        16: 'Seid gleichgesinnt gegeneinander; sinnet nicht auf hohe Dinge, sondern haltet euch zu den niedrigen; seid nicht weise bei euch selbst.',
    ...
    15: {
        ...
        16: 'um ein Diener Christi Jesu zu sein für die Nationen, priesterlich dienend an dem Evangelium Gottes, auf daß das Opfer der Nationen angenehm werde, geheiligt durch den Heiligen Geist.',
        17: 'Ich habe also etwas zum Rühmen in Christo Jesu in den Dingen, die Gott angehen.',
        ...
        24: 'falls ich nach Spanien reise; denn ich hoffe, auf der Durchreise euch zu sehen und von euch dorthin geleitet zu werden, wenn ich euch zuvor etwas genossen habe.',
        ...
        30: 'Ich bitte euch aber, Brüder, durch unseren Herrn Jesum Christum und durch die Liebe des Geistes, mit mir zu kämpfen in den Gebeten für mich zu Gott,',
