...
CHAPTERS = {
    1: {
        ...
        4: 'John to the seven Assemblies which are in Asia: Grace be unto you, and peace, from him which is, and which was, and which is to come; and from the seven Spirits which are before his throne;',
        5: 'And from Jesus Christ, who is the faithful witness, and the first begotten of the dead, and the ruler of the kings of the earth. Unto him that loved us, and washed us from our sins in his own blood,',
        ...
        20: 'The mystery of the seven stars which thou sawest in my right hand, and the seven golden lampstands. The seven stars are the angels of the seven Assemblies: and the seven lampstands which thou sawest are the seven Assemblies.',
    },
    2: {
    ...
    3: {
        1: 'And unto the angel of the Assembly in Sardis write; These things saith he that hath the seven Spirits of God, and the seven stars; I know thy works, that thou hast a name that thou livest, and art dead.',
        ...
        14: 'And unto the angel of the Assembly of the Laodiceans write; These things saith the Amen, the faithful and true witness, the head of the creation of God;',
    ...
    17: {
        ...
        8: 'The beast that thou sawest was, and is not; and shall ascend out of the abyss, and go into perdition: and they that dwell on the earth shall wonder, whose names were not written in the book of life from the foundation of the world, when they behold the beast that was, and is not, and yet is.',
    ...
    18: {
        1: 'And after these things I saw another angel come down from heaven, having great authority; and the earth was lightened with his glory.',
    ...
    19: {
        1: 'And after these things I heard a great voice of much people in heaven, saying, Hallelujah; Salvation, and glory, and honour, and power, unto the Lord our God:',
    ...
    22: {
        ...
        16: 'I Jesus have sent mine angel to testify unto you these things in the Assemblies. I am the root and the offspring of David, and the bright and morning star.',
