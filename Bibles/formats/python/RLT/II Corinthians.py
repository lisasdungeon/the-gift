...
CHAPTERS = {
    1: {
        1: 'Paul, an apostle of Jesus Christ by the will of God, and Timothy our brother, unto the Assembly of God which is at Corinth, with all the saints which are in all Achaia:',
    ...
    13: {
        ...
        10: 'Therefore I write these things being absent, lest being present I should use sharpness, according to the authority which the Lord hath given me to edification, and not to destruction.',
