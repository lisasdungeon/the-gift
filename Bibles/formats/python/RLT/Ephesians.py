...
CHAPTERS = {
    1: {
        ...
        21: 'Far above all principality, and authority, and might, and dominion, and every name that is named, not only in this world, but also in that which is to come:',
    ...
    3: {
        ...
        21: 'Unto him be glory in the Assembly by Christ Jesus throughout all ages, world without end. Amen.',
    },
    4: {
