...
CHAPTERS = {
    1: {
        ...
        2: 'Unto the Assembly of God which is at Corinth, to them that are sanctified in Christ Jesus, called to be saints, with all that in every place call upon the name of Jesus Christ our Lord, both theirs and ours:',
    ...
    4: {
        ...
        17: 'For this cause have I sent unto you Timothy, who is my beloved son, and faithful in the Lord, who shall bring you into remembrance of my ways which be in Christ, as I teach every where in every Assembly.',
    ...
    7: {
        ...
        17: 'But as God hath distributed to every man, as the Lord hath called every one, so let him walk. And so ordain I in all Assemblies.',
    ...
    15: {
        ...
        9: 'For I am the least of the apostles, that am not meet to be called an apostle, because I persecuted the Assembly of God.',
