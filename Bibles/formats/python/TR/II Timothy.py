...
CHAPTERS = {
    1: {
        ...
        5: 'υπομνησιν λαμβανων της εν σοι ανυποκριτου πιστεως ητις ενωκησεν πρωτον εν τη μαμμη σου λωιδι και τη μητρι σου ευνεικη ευνικη πεπεισμαι δε οτι και εν σοι',
    ...
    4: {
        ...
        13: 'τον φαιλονην φελονην ον απελιπον εν τρωαδι παρα καρπω ερχομενος φερε και τα βιβλια μαλιστα τας μεμβρανας',
