...
CHAPTERS = {
    ...
    2: {
        ...
        11: 'και ελθοντες εις την οικιαν ευρον ειδον το παιδιον μετα μαριας της μητρος αυτου και πεσοντες προσεκυνησαν αυτω και ανοιξαντες τους θησαυρους αυτων προσηνεγκαν αυτω δωρα χρυσον και λιβανον και σμυρναν',
        ...
        23: 'και ελθων κατωκησεν εις πολιν λεγομενην ναζαρετ ναζαρεθ οπως πληρωθη το ρηθεν δια των προφητων οτι ναζωραιος κληθησεται',
    },
    3: {
    ...
    4: {
        ...
        13: 'και καταλιπων την ναζαρετ ναζαρεθ ελθων κατωκησεν εις καπερναουμ την παραθαλασσιαν εν οριοις ζαβουλων και νεφθαλειμ',
    ...
    6: {
        ...
        24: 'ουδεις δυναται δυσιν κυριοις δουλευειν η γαρ τον ενα μισησει και τον ετερον αγαπησει η ενος ανθεξεται και του ετερου καταφρονησει ου δυνασθε θεω δουλευειν και μαμμωνα',
    ...
    10: {
        ...
        10: 'μη πηραν εις οδον μηδε δυο χιτωνας μηδε υποδηματα μηδε ραβδον ραβδους αξιος γαρ ο εργατης της τροφης αυτου εστιν',
        ...
        25: 'αρκετον τω μαθητη ινα γενηται ως ο διδασκαλος αυτου και ο δουλος ως ο κυριος αυτου ει τον οικοδεσποτην βεελζεβουλ βεελζεβουβ εκαλεσαν ποσω μαλλον τους οικιακους αυτου',
    ...
    11: {
        ...
        21: 'ουαι σοι χοραζιν ουαι σοι βηθσαιδαν βηθσαιδα οτι ει εν τυρω και σιδωνι εγενοντο αι δυναμεις αι γενομεναι εν υμιν παλαι αν εν σακκω και σποδω μετενοησαν',
    ...
    13: {
        ...
        24: 'αλλην παραβολην παρεθηκεν αυτοις λεγων ωμοιωθη η βασιλεια των ουρανων ανθρωπω σπειροντι σπειραντι καλον σπερμα εν τω αγρω αυτου',
    ...
    15: {
        ...
        6: 'και ου μη τιμηση τον πατερα αυτου η την μητερα αυτου (15:6) και ηκυρωσατε την εντολην του θεου δια την παραδοσιν υμων',
    ...
    17: {
        ...
        14: 'και ελθοντων αυτων προς τον οχλον προσηλθεν αυτω ανθρωπος γονυπετων αυτω (17:15) και λεγων',
    ...
    18: {
        ...
        30: 'ο δε ουκ ηθελεν αλλα αλλ απελθων εβαλεν αυτον εις φυλακην εως ου αποδω το οφειλομενον',
    ...
    20: {
        ...
        4: 'κακεινοις ειπεν υπαγετε και υμεις εις τον αμπελωνα και ο εαν η δικαιον δωσω υμιν (20:5) οι δε απηλθον',
        5: 'παλιν εξελθων περι εκτην και εννατην ωραν εποιησεν ωσαυτως',
    ...
    21: {
        ...
        7: 'ηγαγον την ονον και τον πωλον και επεθηκαν επανω αυτων τα ιματια αυτων και επεκαθισεν επεκαθισαν επανω αυτων',
        ...
        11: 'οι δε οχλοι ελεγον ουτος εστιν ιησους ο προφητης ο απο ναζαρετ ναζαρεθ της γαλιλαιας',
    ...
    23: {
        ...
        13: '(23:14) ουαι ουαι δε υμιν γραμματεις και φαρισαιοι υποκριται οτι κλειετε την βασιλειαν των ουρανων εμπροσθεν των ανθρωπων υμεις γαρ ουκ εισερχεσθε ουδε τους εισερχομενους αφιετε εισελθειν',
        14: '(23:13) ουαι δε ουαι υμιν γραμματεις και φαρισαιοι υποκριται οτι κατεσθιετε τας οικιας των χηρων και προφασει μακρα προσευχομενοι δια τουτο ληψεσθε περισσοτερον κριμα',
    ...
    24: {
        ...
        15: 'οταν ουν ιδητε το βδελυγμα της ερημωσεως το ρηθεν δια δανιηλ του προφητου εστος εστως εν τοπω αγιω ο αναγινωσκων νοειτω',
    ...
    26: {
        ...
        60: 'και ουχ ευρον και πολλων ψευδομαρτυρων προσελθοντων ουχ ευρον (26:61) υστερον δε προσελθοντες δυο ψευδομαρτυρες',
        61: 'ειπον ουτος εφη δυναμαι καταλυσαι τον ναον του θεου και δια τριων ημερων οικοδομησαι αυτον',
