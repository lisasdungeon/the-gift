...
CHAPTERS = {
    ...
    5: {
        ...
        7: 'εκκαθαρατε ουν την παλαιαν ζυμην ινα ητε 1510 νεον φυραμα καθως εστε αζυμοι και γαρ το πασχα ημων υπερ ημων ετυθη εθυθη χριστος',
        ...
        11: 'νυνι δε εγραψα υμιν μη συναναμιγνυσθαι εαν τις αδελφος ονομαζομενος η η πορνος η πλεονεκτης η ειδωλολατρης η λοιδορος η μεθυσος η αρπαξ τω τοιουτω μηδε συνεσθιειν',
    ...
    10: {
        ...
        8: 'μηδε πορνευωμεν καθως τινες αυτων επορνευσαν 4203 και επεσον εν μια ημερα εικοσιτρεις χιλιαδες',
    ...
    13: {
        ...
        2: 'και εαν εχω προφητειαν και ειδω τα μυστηρια παντα και πασαν την γνωσιν και εαν εχω πασαν την πιστιν ωστε ορη μεθιστανειν αγαπην δε μη εχω ουθεν ουδεν ειμι',
    ...
    14: {
        ...
        5: 'θελω δε παντας υμας λαλειν γλωσσαις μαλλον δε ινα προφητευητε μειζων γαρ ο προφητευων η ο λαλων γλωσσαις εκτος ει μη διερμηνευη ινα η εκκλησια οικοδομην λαβη',
    ...
    15: {
        ...
        31: 'καθ ημεραν αποθνησκω νη την ημετεραν υμετεραν καυχησιν ην εχω εν χριστω ιησου τω κυριω ημων',
