...
CHAPTERS = {
    1: {
        ...
        2: 'τοις εν κολασσαις κολοσσαις αγιοις και πιστοις αδελφοις εν χριστω χαρις υμιν και ειρηνη απο θεου πατρος ημων και κυριου ιησου χριστου',
    ...
    2: {
        ...
        13: 'και υμας νεκρους οντας εν τοις παραπτωμασιν και τη ακροβυστια της σαρκος υμων συνεζωποιησεν συνεζωοποιησεν συν αυτω χαρισαμενος ημιν υμιν παντα τα παραπτωματα',
    ...
    4: {
        ...
        10: 'ασπαζεται υμας αρισταρχος ο συναιχμαλωτος μου και μαρκος ο ανεψιος βαρναβα 921 {N-GSM} {N-DSM} περι ου ελαβετε εντολας εαν ελθη προς υμας δεξασθε αυτον',
