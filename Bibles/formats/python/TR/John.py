...
CHAPTERS = {
    1: {
        ...
        45: 'ευρισκει φιλιππος τον ναθαναηλ και λεγει αυτω ον εγραψεν μωσης εν τω νομω και οι προφηται ευρηκαμεν ιησουν τον υιον του ιωσηφ τον απο ναζαρετ ναζαρεθ',
        46: 'και ειπεν αυτω ναθαναηλ εκ ναζαρετ ναζαρεθ δυναται τι αγαθον ειναι λεγει αυτω φιλιππος ερχου και ιδε',
    ...
    5: {
        ...
        5: 'ην δε τις ανθρωπος εκει τριακονταοκτω τριακοντα και οκτω ετη εχων εν τη ασθενεια',
    ...
    6: {
        ...
        28: 'ειπον ουν προς αυτον τι ποιουμεν ποιωμεν ινα εργαζωμεθα τα εργα του θεου',
    ...
    9: {
        ...
        21: 'πως δε νυν βλεπει ουκ οιδαμεν η τις ηνοιξεν αυτου τους οφθαλμους ημεις ουκ οιδαμεν αυτος ηλικιαν εχει αυτον ερωτησατε αυτος περι αυτου 848 αυτου 846 {P-GSM} λαλησει',
    ...
    12: {
        ...
        6: 'ειπεν δε τουτο ουχ οτι περι των πτωχων εμελεν αυτω αλλ αλλα οτι κλεπτης ην και το γλωσσοκομον ειχεν και τα βαλλομενα εβασταζεν',
    ...
    16: {
        ...
        3: 'και ταυτα ποιησουσιν υμιν οτι ουκ εγνωσαν τον πατερα ουδε εμε',
        ...
        7: 'αλλ εγω την αληθειαν λεγω υμιν συμφερει υμιν ινα εγω απελθω εαν γαρ μη απελθω ο παρακλητος ουκ ελευσεται προς υμας εαν δε πορευθω πεμψω αυτον προς υμας',
        ...
        33: 'ταυτα λελαληκα υμιν ινα εν εμοι ειρηνην εχητε εν τω κοσμω θλιψιν εχετε εξετε αλλα θαρσειτε εγω νενικηκα τον κοσμον',
    },
    17: {
    ...
    18: {
        ...
        8: 'απεκριθη ο ιησους ειπον υμιν οτι εγω ειμι ει ουν εμε ζητειτε αφετε τουτους υπαγειν',
    ...
    19: {
        ...
        31: 'οι ουν ιουδαιοι επει παρασκευη ην ινα μη μεινη επι του σταυρου τα σωματα εν τω σαββατω επει παρασκευη ην ην γαρ μεγαλη η ημερα εκεινου του σαββατου ηρωτησαν τον πιλατον ινα κατεαγωσιν αυτων τα σκελη και αρθωσιν',
