...
CHAPTERS = {
    ...
    3: {
        ...
        6: 'χριστος δε ως υιος επι τον οικον αυτου ου οικος εσμεν ημεις εανπερ 0 την παρρησιαν και το καυχημα της ελπιδος μεχρι τελους βεβαιαν κατασχωμεν',
        ...
        14: 'μετοχοι γαρ γεγοναμεν του χριστου εανπερ 0 την αρχην της υποστασεως μεχρι τελους βεβαιαν κατασχωμεν',
    ...
    4: {
        ...
        15: 'ου γαρ εχομεν αρχιερεα μη δυναμενον συμπαθησαι ταις ασθενειαις ημων πεπειραμενον πεπειρασμενον δε κατα παντα καθ ομοιοτητα χωρις αμαρτιας',
    ...
    6: {
        ...
        10: 'ου γαρ αδικος ο θεος επιλαθεσθαι του εργου υμων και του κοπου της αγαπης ης ενεδειξασθε ενδειξασθε εις το ονομα αυτου διακονησαντες τοις αγιοις και διακονουντες',
    ...
    7: {
        ...
        21: 'οι μεν γαρ χωρις ορκωμοσιας εισιν ιερεις γεγονοτες (7:21) ο δε μετα ορκωμοσιας δια του λεγοντος προς αυτον ωμοσεν κυριος και ου μεταμεληθησεται συ ιερευς εις τον αιωνα κατα την ταξιν μελχισεδεκ',
    ...
    9: {
        ...
        6: 'τουτων δε ουτως κατεσκευασμενων εις μεν την πρωτην σκηνην διαπαντος δια παντος εισιασιν οι ιερεις τας λατρειας επιτελουντες',
        ...
        11: 'χριστος δε παραγενομενος αρχιερευς των μελλοντων αγαθων δια της μειζονος και τελειοτερας σκηνης ου χειροποιητου τουτ εστιν ου ταυτης της κτισεως',
    ...
    11: {
        ...
        4: 'πιστει πλειονα θυσιαν αβελ παρα καιν προσηνεγκεν τω θεω δι ης εμαρτυρηθη ειναι δικαιος μαρτυρουντος επι τοις δωροις αυτου του θεου και δι αυτης αποθανων ετι λαλειται λαλει',
    ...
    12: {
        ...
        24: 'και διαθηκης νεας μεσιτη ιησου και αιματι ραντισμου κρειττονα λαλουντι παρα τον το αβελ',
    ...
    13: {
        ...
        15: 'δι αυτου ουν αναφερωμεν θυσιαν αινεσεως διαπαντος δια παντος τω θεω τουτ εστιν καρπον χειλεων ομολογουντων τω ονοματι αυτου',
