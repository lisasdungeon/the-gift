...
CHAPTERS = {
    1: {
        ...
        9: 'και εγενετο εν εκειναις ταις ημεραις ηλθεν ιησους απο ναζαρετ ναζαρεθ της γαλιλαιας και εβαπτισθη υπο ιωαννου εις τον ιορδανην',
    ...
    5: {
        ...
        5: 'και διαπαντος δια παντος νυκτος και ημερας εν τοις ορεσιν και εν τοις μνημασιν ην κραζων και κατακοπτων εαυτον λιθοις',
    ...
    6: {
        ...
        9: 'αλλ υποδεδεμενους σανδαλια και μη ενδυσησθε ενδυσασθαι δυο χιτωνας',
        ...
        25: 'και εισελθουσα ευθεως μετα σπουδης προς τον βασιλεα ητησατο λεγουσα θελω ινα μοι δως εξ αυτης εξαυτης επι πινακι την κεφαλην ιωαννου του βαπτιστου',
        26: 'και περιλυπος γενομενος ο βασιλευς δια τους ορκους και τους συνανακειμενους ουκ ηθελησεν αυτην αθετησαι',
        27: 'και ευθεως αποστειλας ο βασιλευς σπεκουλατωρα επεταξεν ενεχθηναι την κεφαλην αυτου (6:28) ο δε απελθων απεκεφαλισεν αυτον εν τη φυλακη',
        ...
        45: 'και ευθεως ηναγκασεν τους μαθητας αυτου εμβηναι 1684 εις το πλοιον και προαγειν εις το περαν προς βηθσαιδαν βηθσαιδα εως αυτος απολυση τον οχλον',
        ...
        53: 'και διαπερασαντες ηλθον 2064 επι την γην γενησαρετ γεννησαρετ και προσωρμισθησαν',
    ...
    8: {
        ...
        14: 'και επελαθοντο οι μαθηται λαβειν αρτους και ει μη ενα αρτον ουκ ειχον μεθ εαυτων εν τω πλοιω',
        ...
        22: 'και ερχεται εις βηθσαιδαν βηθσαιδα και φερουσιν αυτω τυφλον και παρακαλουσιν αυτον ινα αυτου αψηται',
    ...
    9: {
        ...
        40: 'ος γαρ ουκ εστιν καθ υμων υπερ υμων ημων υπερ ημων εστιν',
    ...
    10: {
        ...
        25: 'ευκοπωτερον εστιν καμηλον δια της τρυμαλιας της ραφιδος εισελθειν διελθειν η πλουσιον εις την βασιλειαν του θεου εισελθειν',
    ...
    13: {
        ...
        9: 'βλεπετε δε υμεις εαυτους παραδωσουσιν γαρ υμας εις συνεδρια και εις συναγωγας δαρησεσθε και επι ηγεμονων και βασιλεων σταθησεσθε αχθησεσθε ενεκεν εμου εις μαρτυριον αυτοις',
        ...
        14: 'οταν δε ιδητε το βδελυγμα της ερημωσεως το ρηθεν υπο δανιηλ του προφητου εστος εστως οπου ου δει ο αναγινωσκων νοειτω τοτε οι εν τη ιουδαια φευγετωσαν εις τα ορη',
