...
CHAPTERS = {
    ...
    3: {
        ...
        3: 'Gott kommt von Teman her und der Heilige vom Berge Paran (Pause). Seine Pracht bedeckt den Himmel, und seines Lobes ist die Erde voll.',
        ...
        13: 'Du ziehst aus zum Heil deines Volkes, zum Heil deines Gesalbten; du zerschmetterst das Haupt von dem Hause des Gottlosen, entblößest den Grund bis an den Hals (Pause).',
