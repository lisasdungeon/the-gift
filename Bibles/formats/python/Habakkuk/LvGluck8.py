...
CHAPTERS = {
    ...
    2: {
        ...
        5: 'Un turklāt kā viltīgs vīns ir lepns vīrs; tas nepastāv; tas atpleš savu dvēseli platu kā elli, un kā nāve tas nav pieēdināms; tas rauj pie sevis visas tautas un sakrāj pie sevis visus ļaudis.',
