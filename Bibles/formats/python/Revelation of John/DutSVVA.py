...
CHAPTERS = {
    ...
    3: {
        ...
        3: 'Gedenk dan, hoe gij het ontvangen en gehoord hebt, en bewaar het, en bekeer u. Indiën gij dan niet waakt, zo zal Ik over u komen als een dief, en gij zult niet weten, op wat ure Ik over u komen zal.',
    ...
    13: {
        ...
        9: 'Indiën iemand oren heeft, die hore.',
        10: 'Indiën iemand in de gevangenis leidt, die gaat zelf in de gevangenis; indien iemand met het zwaard zal doden, die moet zelf met het zwaard gedood worden. Hier is de lijdzaamheid en het geloof der heiligen.',
    ...
    14: {
        ...
        9: 'En een derde engel is hen gevolgd, zeggende met een grote stem: Indiën iemand het beest aanbidt en zijn beeld, en ontvangt het merkteken aan zijn voorhoofd, of aan zijn hand,',
    ...
    22: {
        ...
        18: 'Want ik betuig aan een iegelijk, die de woorden der profetie dezes boeks hoort: Indiën iemand tot deze dingen toedoet, God zal hem toedoen de plagen, die in dit boek geschreven zijn.',
