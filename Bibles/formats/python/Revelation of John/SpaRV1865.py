...
CHAPTERS = {
    ...
    4: {
        ...
        2: 'Y al punto yo fui en el Espíritu; y, he aquí, un trono estaba puesto en el cielo, y sobre el trono estaba uno asentado.',
    ...
    6: {
        ...
        8: 'Y miré, y he aquí un caballo pálido; y el que estaba sentado sobre él, tenía por nombre Muerte, y el Infierno le seguía; y le fue dada potestad sobre la cuarta parte de la tierra, para matar con espada, y con hambre, y con mortandad, y con fieras de la tierra.',
    ...
    7: {
        ...
        12: 'Diciendo: Amén: la bendición, y la gloria, y la sabiduría, y el hacimiento de gracias, y la honra, y la potencia, y la fortaleza a nuestro Dios para siempre jamás. Amén.',
    ...
    9: {
        1: 'Y el quinto ángel tocó la trompeta, y ví una estrella caída del cielo en la tierra; y a aquel fue dada la llave del pozo del abismo.',
        2: 'Y abrió el pozo del abismo, y subió un humo del pozo como el humo de una grande hornaza; y el sol, y el aire fue oscurecido por razón del humo del pozo.',
        ...
        11: 'Y tenían sobre sí un rey, que es el ángel del abismo, el cual tenía por nombre en Hebraico Abaddón, y en Griego Apolión.',
    ...
    11: {
        ...
        15: 'Y el séptimo ángel tocó la trompeta; y fueron hechas grandes voces en el cielo que decían: Los reinos de este mundo han venido a ser los reinos de nuestro Señor, y de su Cristo, y reinará por los siglos de los siglos.',
    ...
    14: {
        1: 'Y miré, y, he aquí, el Cordero estaba en pie sobre el monte de Sión, y con él ciento y cuarenta y cuatro mil, que tenían el nombre de su Padre escrito en sus frentes.',
        ...
        3: 'Y cantaban como una canción nueva delante del trono, y delante de los cuatro animales, y de los ancianos; y ninguno podía aprender la canción, sino aquellos ciento y cuarenta y cuatro mil, los cuales fueron comprados de entre los de la tierra.',
        4: 'Estos son los que con mujeres no fueron contaminados; porque son vírgenes. Estos siguen al Cordero por donde quiera que fuere. Estos fueron comprados de entre los hombres por primicias para Dios, y para el Cordero.',
        5: 'Y en su boca no ha sido hallado engaño; porque ellos son sin mácula delante del trono de Dios.',
        6: 'Y ví otro ángel volar por en medio del cielo, que tenía el evangelio eterno, para que evangelizase a los que moran en la tierra, y a toda nación, y tribu, y lengua, y pueblo,',
        7: 'Diciendo a alta voz: Teméd a Dios, y dádle gloria; porque la hora de su juicio es venida; y adorád al que ha hecho el cielo, y la tierra, y la mar, y las fuentes de las aguas.',
        8: 'Y otro ángel le siguió, diciendo: Ya es caída: ya es caída Babilonia, aquella gran ciudad, porque ella ha dado a beber a todas las naciones del vino de la ira de su fornicación.',
        9: 'Y el tercer ángel los siguió, diciendo en alta voz: Si alguno adora a la bestia, y a su imagen, y toma la señal en su frente, o en su mano,',
        10: 'Este tal beberá del vino de la ira de Dios, el cual está echado puro en el cáliz de su ira; y será atormentado con fuego y azufre delante de los santos ángeles, y delante del Cordero.',
        11: 'Y el humo del tormento de ellossube para siempre jamás. Y los que adoran a la bestia, y a su imagen, no tienen reposo día y noche, y ni quienquiera que tomare la señal de su nombre.',
        12: 'Aquí está la paciencia de los santos: aquí están los que guardan los mandamientos de Dios, y la fe de Jesús.',
        13: 'Y oí una voz del cielo, que me decía: Escribe: Bienaventurados son los muertos, que de aquí adelante mueren en el Señor: Sí, dice el Espíritu, que descansan de sus trabajos, y sus obras los siguen.',
        14: 'Y miré, y he aquí una nube blanca, y sobre la nube uno asentado semejante al Hijo del hombre, que tenía en su cabeza una corona de oro, y en su mano una hoz aguzada.',
        15: 'Y otro ángel salió del templo, clamando con alta voz al que estaba sentado sobre la nube: Mete tu hoz, y siega; porque la hora de segar te es venida, porque la mies de la tierra está madura.',
        16: 'Y el que estaba sentado sobre la nube echó su hoz sobre la tierra, y la tierra fue segada.',
        17: 'Y salió otro ángel del templo que está en el cielo, teniendo también una hoz aguzada.',
        18: 'Y otro ángel salió del altar, el cual tenía poder sobre el fuego, y clamó con gran voz al que tenía la hoz aguzada, diciendo: Mete tu hoz aguzada, y vendimia los racimos de la vid de la tierra; porque sus uvas están cumplidamente maduras.',
        19: 'Y el ángel metió su hoz aguzada en la tierra, y vendimió la vid de la tierra, y echó la vendimia en el grande lagar de la ira de Dios.',
        20: 'Y el lagar fue pisado fuera de la ciudad, y del lagar salió sangre hasta los frenos de los caballos por mil y seiscientos estadios.',
    },
    15: {
        ...
        7: 'Y uno de los cuatro animales dio a los siete ángeles siete redomas de oro, llenas de la ira de Dios, que vive para siempre jamás.',
    ...
    17: {
        ...
        8: 'La bestia que has visto, fue, y ya no es; y ha de subir del abismo, y ha de ir a perdición; y los moradores de la tierra (cuyos nombres no están escritos en el libro de la vida desde la fundación del mundo,) se maravillarán cuando vean la bestia la cual era, y ya no es, aun que sin embargo es.',
    ...
    19: {
        ...
        20: 'Y la bestia fue presa, y con ella el falso profeta, que había hecho las señales en su presencia, con las cuales había engañado a los que recibieron la marca de la bestia, y a los que adoraron su imagen. Estos dos fueron lanzados vivos dentro de un lago de fuego ardiendo con azufre.',
    ...
    20: {
        ...
        2: 'Y agarró al dragón, antigua serpiente, que es el Diablo, y Satanás, y le ató por mil años.',
        3: 'Y le arrojó al abismo, y le encerró, y selló sobre él; porque no engañase más a las naciones hasta que los mil años fuesen cumplidos, y después de esto, es necesario que sea desatado por un poco de tiempo.',
        4: 'Y ví tronos, y se sentaron sobre ellos, y les fue dado el juicio: y ví las almas de los que habían sido degollados por el testimonio de Jesús, y por la palabra de Dios, y que no habían adorado la bestia, ni a su imagen, y que no habían recibido su marca en sus frentes, ni en sus manos; y vivieron, y reinaron con Cristo mil años.',
        5: 'Empero los demás muertos no tornaron a vivir, hasta que fueron cumplidos los mil años: esta es la primera resurrección.',
        6: 'Bienaventurado y santo el que tiene parte en la primera resurrección: la segunda muerte no tiene potestad sobre los tales: antes serán sacerdotes de Dios, y de Cristo, y reinarán con él mil años.',
        7: 'Y cuando los mil años fueren cumplidos, Satanás será suelto de su prisión;',
        8: 'Y saldrá para engañar las naciones que están en las cuatro esquinas de la tierra, Gog y Magog, a fin de congregarlas para la batalla, el número de las cuales es como la arena de la mar.',
        9: 'Y subieron sobre la anchura de la tierra, y anduvieron al derredor de los ejércitos de los santos, y de la ciudad amada. Y de Dios descendió fuego del cielo, y los tragó.',
        ...
        11: 'Y ví un gran trono blanco, y al que estaba sentado sobre él, de delante del cual huyó la tierra y el cielo; y no se halló lugar para ellos.',
        12: 'Y ví los muertos, grandes y pequeños, que estaban en pie delante de Dios; y los libros fueron abiertos; y otro libro fue abierto, el cual es el libro de la vida; y fueron juzgados los muertos por las cosas que estaban escritas en los libros, según sus obras.',
        13: 'Y la mar dio los muertos que estaban en ella; y la muerte, y el infierno dieron los muertos que estaban en ellos; y fue hecho juicio de cada uno de ellos según sus obras.',
