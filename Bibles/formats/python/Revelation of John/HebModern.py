NAME = 'HebModern: Modern Hebrew Bible'
...
CHAPTERS = {
    ...
    22: {
        ...
        6: 'ויאמר אלי הדברים האלה אמתים ונאמנים הם ויהוה אלהי הנביאים הקדשים שלח את מלאכו להראות את עבדיו את אשר היה יהיה במהרה׃',
        7: 'הנני בא מהר אשרי השמר את דברי נבואת הספר הזה׃',
        8: 'ואני יוחנן הוא הראה אלה ושמעם ויהי כשמעי וכראותי ואפל לפני רגלי המלאך אשר הראני את אלה להשתחות לו׃',
        9: 'ויאמר אלי ראה אל תעשה זאת כי עבד כמוך אנכי וחבר לך ולאחיך הנביאים ולשמרים את דברי הספר הזה לאלהים השתחוה׃',
        ...
        12: 'והנני בא מהר ושכרי אתי לשלם לכל איש כמעשהו׃',
        13: 'אני האלף והתו הראש והסוף הראשון והאחרון׃',
        14: 'אשרי העשים את מצותיו למען תהיה ממשלתם בעץ החיים ובאו העירה דרך השערים׃',
        15: 'ומחוץ לה הכלבים והמכשפים והזנים והמרצחים ועבדי האלילים וכל אהב שקר ועשהו׃',
