...
CHAPTERS = {
    1: {
        ...
        8: 'Eu sou o Alfa e o Ômega, o princípio e o fim,Diz o Senhor, que é, e que era, e que virá, o Todo-Poderoso.',
        ...
        11: 'Dizendo: Eu sou o Alfa e o Ômega, o primeiro e o último; e o que tu estás vendo, escreve em um livro, e envia às sete igrejas que estão na Ásia: a Éfeso, e a Esmirna, e a Pérgamo, e a Tiatira, e a Sardes, e a Filadélfia, e a Laodiceia.',
        ...
        18: 'Eu sou o que vivo, e fui morto; e eis que eu vivo para todo o sempre; Amém. E eu tenho as chaves do mundo dos mortos, e da morte.',
    ...
    2: {
        ...
        5: 'Então lembra-te de onde tu caíste, e arrepende-te, e faze as primeiras obras; senão em breve eu virei a ti, e tirarei teu castiçal de seu lugar, se tu não te arrependeres.',
        ...
        14: 'Mas eu tenho algumas poucas coisas contra ti: que tu tens lá aos que retêm a doutrina de Balaão, o qual ensinava a Balaque a lançar tropeço diante dos filhos de Israel, para que comessem dos sacrifícios aos ídolos, e façam pecados sexuais.',
        15: 'Assim tu tens também aos que retém a doutrina dos nicolaítas, que eu odeio.',
        ...
        18: 'E escreve ao anjo da igreja que está em Tiatira: Isto diz o Filho de Deus, que tem seus olhos como chama de fogo, e seus pés semelhantes a um metal valioso reluzente:',
    ...
    5: {
        ...
        14: 'E os quatro animais diziam: Amém!E os vinte e quatro anciãos se prostraram e adoraram ao que vive para todo o sempre.',
    },
    6: {
        ...
        5: 'E quando ele abriu o terceiro celo, eu ouvi o terceiro animal dizer: Vem, e vê.E olhei, e eis um cavalo preto, e o que estava sentado sobre ele tinha uma balança na mão dele.',
        6: 'E ouvi uma voz no meio dos quatro animais, dizendo: Uma medida de trigo por um dinheiro, e três medidas de cevada por um dinheiro; e não danifiques ao azeite e ao vinho.',
        7: 'E quando ele abriu o quarto selo, eu ouvi a voz do quarto animal dizendo: Vem, e vê.',
        8: 'E eu olhei, e eis um cavalo amarelo-esverdeado, e o que estava sentado sobre ele, seu nome era Morte; e o mundo dos mortos o seguia. E foi-lhes dada autoridade para matar a quarta parte da terra, com espada, com fome, com morte por doença,e com os animais ferozes da terra.',
        ...
        11: 'E foram dados a cada um deles compridas roupas brancas; e foi-lhes dito que repousassem ainda um pouco de tempo, até que se completassem os seus companheiros servos e seus irmãos, que ainda viriam a ser mortos.',
        ...
        16: 'E diziam aso montes, e às rochas: Caí sobre nós, e escondei-nos do rosto daquele que está sentado sobre o trono, e da ira do Cordeiro;',
        17: 'Porque chegou o dia da grande ira dele; e quem pode rá ficar a salvo?',
    },
    7: {
        ...
        3: 'Dizendo: Não danifiques a terra, nem o mar, nem as árvores, até que tenhamos selado aos servos do nosso Deus nas testas deles.',
        ...
        5: 'Da tribo de Judá, doze mil foram selados; da tribo de Rúben, doze mil foram selados; da tribo de Gade, doze mil foram selados;',
        6: 'Da tribo de Aser, doze mil foram selados; da tribo de Naftali, doze mil foram selados; da tribo de Manassés, doze mil foram selados;',
        7: 'Da tribo de Simeão, doze mil foram selados; da tribo de Levi, doze mil foram selados; da tribo de Issacar, doze mil foram selados;',
        8: 'Da tribo de Zebulom, doze mil foram selados; da tribo de José, doze mil foram selados; da tribo de Benjamim, doze mil foram selados.',
        9: 'Depois destas coisas eu olhei, e eis uma grande multidão, a qual ninguém podia contar, de todas as nações, e tribos, e povos, e línguas, que estavam diante do trono e diante do Cordeiro, vestidos de roupas brancas, e com ramos de palmas nas mãos deles.',
        10: 'E clamavam com grande voz, dizendo: A salvação pertence a nosso Deus, que está sentado sobre o trono, e ao Cordeiro!',
    ...
    8: {
        ...
        2: 'E eu vi os sete anjos, que estavam diante diante de Deus; e foram lhes dadas sete trombetas.',
        ...
        7: 'E o primeiro anjo tocou sua trombeta; e houve saraiva e fogo misturado com sangue; e foram lançados sobre a terra; e a terça parte das árvores se queimou, e toda a erva verde foi queimada.',
        ...
        13: 'E olhei, e ouvi um anjo que estava voando pelo meio do céu, dizendo em alta voz: Ai ai ai dos que habitam sobre a terra por causa das demais vozes das trombetas dos três anjos que ainda vão tocar!',
    },
    9: {
        ...
        15: 'E foram soltos os quatro anjos, que tinham sido preparados para a hora, dia, mês e ano, para matarem a terça parte dos homens.',
        ...
        20: 'E o resto dos homens, que não foram mortos por estas pragas, não se arrependeram das obras de suas mãos, para não adorarem aos demônios, e ídolos de ouro, de prata, de bronze, de pedra e de madeira, que não podem ver, nem ouvir, nem andar;',
        21: 'E não se arrependeram de seus homicídios, nem de suas feitiçarias, nem de seu pecado sexual, nem de seus roubos.',
    },
    10: {
        ...
        7: 'Mas que nos dias da voz do sétimo anjo, quando sua trombeta estiver a ponto de tocar, o mistério de Deus se cumprirá, assim como ele bem anunciou a seus servos e profetas.',
        ...
        11: 'E ele me disse: É necessário tu profetizares outra vez a muitos povos, nações, línguas e reis.',
    },
    11: {
        ...
        11: 'E depois d aqueles três dias e meio, entrou nelas o espírito de vida de Deus, e se puseram sobre seus pés, e caiu grande temor sobre os que as viram.',
        ...
        17: 'Dizendo: Graças te damos, Senhor Deus, o Todo-Poderoso, o que é, e que era, e que virá; porque tu tomaste teu grande poder, e tens reinado;',
        18: 'E as nações se irarão, porém veio a tua ira, e o tempo dos mortos, para serem julgados, e para tu dares a recompensa a teus servos, os profetas, e aos santos, e aos que temem o teu nome, a pequenos e a grandes; e para destruir aos que destroem a terra.',
        19: 'E o templo de Deus se abriu no céu, e a arca de seu pacto foi vista no templo dele; e houve relâmpagos, e vozes, e trovões, e terremotos, e grande saraiva.',
    },
    12: {
        ...
        4: 'E sua cauda levava após si a terça parte das estrelas do céu, e as lançou sobre a terra; e o dragão ficou parado diante da mulher, que estava a ponto de gerar filho; para que, quando ela gerasse, o dragão devorasse o filho dela.',
        5: 'E ela gerou um filho macho, que com vara de ferro ia dominar todas as nações; e o filho dela foi arrebatado para Deus e para o trono dele.',
        6: 'E a mulher fugiu para o deserto, onde ela tinha lugar preparado por Deus, para que lá a alimentassem por mil duzentos e sessenta dias.',
        ...
        14: 'E foram dadas à mulher duas asas de grande água, para que voasse ao deserto, ao lugar dela, onde ali ela é alimentada por um tempo, e tempos, e a metade de um tempo, longe da face da serpente.',
        ...
        16: 'E a terra ajudou a mulher, e a terra abriu a sua boca, e engoliu ao rio que o dragão tinha lançado de sua boca.',
        17: 'E o dragão se irou contra a mulher, e saiu para fazer guerra contra os demais da semente dela, os que guardam os mandamentos de Deus e têm o testemunho de Jesus Cristo.',
        18: 'E eu fiquei parado sobre a areia do mar.',
    },
    13: {
        1: 'E eu vi subir do mar uma besta, que tinha sete cabeças e dez chifres, e sobre seus chifres dez diademas; e sobre suas cabeças um nome de blasfêmia.',
        ...
        3: 'E eu vi uma de suas cabeças como ferida de morte, e sua ferida mortal foi curada; e toda a terra se maravilhou, indo atrás da besta.',
        ...
        5: 'E foi-lhe dada um boca que falava grandes coisas e blasfêmias; e foi-lhe dada autoridade para fazer assim por quarenta e dois meses.',
        ...
        8: 'E todos os que habitam sobre a terra a adorarão, o nomes dos quais não estão escritos no livro da vida do Cordeiro, que tem sido morto desde a fundação do mundo.',
        9: 'Se alguém tem ouvido s, ouça.',
        ...
        13: 'E ela faz grandes sinais, de maneira que faz até fogo descer do céu até a terra, diante dos homens.',
        14: 'E engana aos que habitam na terra por meio de sinais, que lhe foram concedidos fazer na presença da besta; dizendo aos que habitam na terra para fazerem uma imagem para a besta que tinha recebido a ferida da espada, e ainda assim viveu.',
        15: 'E foi-lhe concedido dar espírito à imagem da besta, para que a imagem da besta também falasse, e fizesse com que todos os que não adorassem à imagem da besta fossem mortos.',
    ...
    14: {
        1: 'E eu olhei, e eis que o Cordeiro estava de pé sobre o monte Sião, e com ele cento e quarenta e quatro mil, tendo o nome do Pai dele escrito em suas testas.',
        ...
        5: 'E não foi encontrado engano na boca deles, porque eles são irrepreensíveis diante do trono de Deus.',
        ...
        18: 'E outro anjo, que tinha poder sobre o fogo, saiu do altar; e ele clamou em alta voz ao que tinha a foice afiada, dizendo: Envia tua foice afiada, e recolhe os cachos da vinha da terra; porque suas uvas já estão maduras.',
        19: 'E o anjo lançou sua foice à terra, e recolheu as uvas d a vinha da terra, e as lançou no lagar da grande ira de Deus.',
    ...
    15: {
        ...
        3: 'E cantavam o cântico de Moisés, o servo de Deus, e o cântico do Cordeiro, dizendo: Grandes e maravilhosas são tuas obras, ó Senhor Deus Todo-Poderoso! Teus caminhos são justos e verdadeiros, ó Rei dos santos!',
        4: 'Quem não te temeria, ó Senhor, e não glorificaria o teu nome? Porque só tu és santo; porque todas as nações virão, e adorarão diante de ti, porque teus juízos foram manifestos!',
        ...
        7: 'E um dos quatro animais deu aos sete anjos sete taças de ouro, cheias da ira de Deus, aquele que vive para todo o sempre.',
    ...
    16: {
        ...
        5: 'E eu ouvi ao anjo das águas, dizendo: Justo és tu, Senhor, que és, e que eras, e que virás a ser, porque julgaste estas coisas;',
        ...
        15: '(Eis que eu venho como ladrão. Bem-aventurado aquele que vigia e guarda suas roupas, para que não ande nu, e vejam seu impudor).',
        ...
        18: 'E houve vozes, e trovões, e relâmpagos; e houve um grande terremoto, o qual nunca tinha acontecido desde que existiam homens sobre a terra, tão forte e grande assim.',
        19: 'E a grande cidade se fendeu em três partes, e as cidades das nações caíram; e a grande Babilônia veio em memória diante de Deus, para dar a ela o cálice do vinho da indignação da ira dele.',
        20: 'E toda ilha fugiu, e os montes não foram achados.',
        21: 'E uma grande saraiva, como de peso de um talento, caiu do céu sobre os homens; e os homens blasfemaram a Deus por causa da praga da saraiva, porque a sua praga era muito grande.',
    },
    17: {
        1: 'E veio um dos sente anjos que tinham as sete taças, e falou comigo, dizendo-me: Vem, eu te mostrarei a condenação da grande prostituta, que está sentada sobre muitas águas;',
        2: 'Com a qual os reis da terra se prostituíram, e os que habitam na terra se embriagaram com o vinho da prostituição dela.',
        3: 'E ele me levou em espírito a um deserto, e eu vi uma mulher sentada sobre uma besta de cor de escarlate, que estava cheio de nomes de blasfêmia. E ele tinha sete cabeças e dez chifres.',
        ...
        8: 'A besta que tu viste, era, e não é; e está para subir do abismo, e irá para a perdição; e os que habitam sobre a terra (cujos nomes não estão escritos no livro da vida desde a fundação do mundo), ficarão maravilhados ao verem a besta que era, e não é, e ainda é.',
        ...
        12: 'E os dez chifres que tu viste são dez reis, que aina não receberam o reino; mas receberão autoridade como reis por uma hora, juntamente com a besta.',
        13: 'Estes tem uma mesma intenção, e entregarão seu poder e autoridade à besta.',
    ...
    18: {
        ...
        7: 'O quanto ela glorificou a si mesma, e viveu sensualmente, tanto quanto dai a ela de tormento e pranto; porque ela em seu coração diz: Eu estou sentada como rainha e não sou viúva, e nenhum pranto eu verei.',
        ...
        15: 'Os comerciantes destas coisas, que por ela se enriqueceram, estarão de longe por medo do tormento dela, chorando e lamentando,',
        ...
        17: 'E todo capitão de embarcação, e todos d a multidão que estavam em barcos, e marinheiros, e todos os que trabalham no mar, se puseram de longe;',
        ...
        20: 'Alegra-te sobre ela, céu; e também vós santos apóstolos e profetas; porque Deus já tem julgado dela vossa causa.',
    ...
    19: {
        ...
        9: 'E ele me disse: Escreve: Bem-aventurados são aqueles que foram chamados para a ceia da festa de casamento do Cordeiro.E ele me disse: Estas são as verdadeiras palavras de Deus.',
        10: 'E eu me lancei aos pés dele para o adorar; mas ele me disse: Olha, não faça isso! Eu também sou companheiro servo teu, e de teus irmãos, que têm o testemunho de Jesus; adora a Deus; porque o testemunho de Jesus é o espírito da profecia.',
        ...
        15: 'E da boca dele saía uma espada afiada, para com ela ferir às nações; e ele as dominará com vara de ferro; e ele pisa o lagar do vinho da ira e da indignação do Deus Todo-Poderoso.',
        ...
        18: 'Para que comais a carne dos reis, e a carne dos governantes, e a carne dos fortes, e a carne dos que se sentam sobre eles; e a carne de todos os livres e servos; e dos pequenos e dos grandes.',
        ...
        21: 'E os restantes foram mortos com a espada que saía da boca daquele que estava sentado sobre o cavalo; e as aves se saciaram com as carnes deles.',
    },
    20: {
        1: 'E eu vi um anjo descendo do céu, tendo a chave do abismo; e uma grande corrente em sua mão;',
        ...
        6: 'Bem-aventurado e santo é aquele que tem parte na primeira ressurreição; sobre estes a segunda morte não tem poder; mas sim, eles serão sacerdotes de Deus e de Cristo, e reinarão com ele por mil anos.',
        ...
        14: 'E a morte e o mundo dos mortos foram lançados no lago de fogo; esta é a segunda morte.',
    ...
    21: {
        ...
        24: 'E as nações dos salvos andarão na luz dela; e os reis da terra trarão a ela a glória e honra deles.',
    ...
    22: {
        ...
        7: 'Eis que logo venho; bem-aventurado é aquele que guarda as palavras da profecia deste livro.',
        ...
        14: 'Bem-aventurados os que guardam os mandamentos dele, para que tenham direito à árvore da vida, e possam entrar na cidade pelas portas.',
        ...
        19: 'E se alguém tirar das palavras do livro desta profecia, Deus tirará sua parte do livro da vida, e da cidade santa, e das coisas que estão escritas neste livro.',
        20: 'Aquele que dá testemunho destas coisas diz: Certamente logo venho. Amém! Sim, vem, Senhor Jesus!',
        21: 'A graça do nosso Senhor Jesus Cristo seja com todos vós. Amém!',
    },
}
