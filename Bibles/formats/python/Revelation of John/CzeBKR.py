...
CHAPTERS = {
    ...
    4: {
        ...
        9: 'A když ta zvířata vzdávala slávu, a čest, i díků činění sedícímu na trůnu, tomu živému na věky věků,',
        10: 'Padlo těch čtyřmecítma starců před oblíčejem toho sedícího na trůnu, a klanělo se tomu živému na věky věků, a metali koruny své před trůnem, řkouce:',
    ...
    6: {
        ...
        8: 'I pohleděl jsem, a aj, kůň plavý, a toho, kterýž seděl na něm, jméno bylo smrt, a peklo šlo za ním. I dána jest jim moc nad čtvrtým dílem země, aby mordovali mečem, a hladem, a morem, a šelmami zemskými.',
