...
CHAPTERS = {
    1: {
        ...
        6: 'und uns gemacht hat zu einem Königtum, zu Priestern seinem Gott und Vater: Ihm sei die Herrlichkeit und die Macht in die Zeitalter der Zeitalter! Amen.',
        ...
        9: 'Ich, Johannes, euer Bruder und Mitgenosse in der Drangsal und dem Königtum und dem Ausharren in Jesu, war auf der Insel, genannt Patmos, um des Wortes Gottes und des Zeugnisses Jesu willen.',
        10: 'Ich war am Tage des Herrn Tage im Geiste, und ich hörte hinter mir eine laute Stimme wie die einer Posaune,',
        ...
        12: 'Und ich wandte mich um, die Stimme zu sehen, welche mit mir redete, und als ich mich umgewandt hatte, sah ich sieben goldene Leuchter,',
    ...
    6: {
        ...
        2: 'Und ich sah: und siehe, ein weißes Pferd, und der darauf saß hatte einen Bogen; und eine Krone wurde ihm gegeben, und er zog aus, siegend und auf daß er siegte.',
        ...
        8: 'Und ich sah: und siehe, ein fahles Pferd, und der darauf saß, sein Name war Tod; und der Hades folgte ihm. Und ihm wurde Gewalt gegeben über den vierten Teil der Erde, zu töten mit dem Schwerte und mit Hunger und mit Tod und durch die wilden Tiere der Erde.',
    ...
    7: {
        ...
        2: 'Und ich sah einen anderen Engel von Sonnenaufgang heraufsteigen, welcher das Siegel des lebendigen Gottes hatte; und er rief mit lauter Stimme den vier Engeln, welchen gegeben worden war, die Erde und das Meer zu beschädigen,',
        ...
        5: 'Aus dem Stamme Juda 12000 Versiegelte, aus dem Stamme Ruben 12000,aus dem Stamme Gad 12000,',
        6: 'aus dem Stamme Aser 12000,aus dem Stamme Nephthalim 12000,aus dem Stamme Manasse 12000,',
        7: 'aus dem Stamme Simeon 12000,aus dem Stamme Levi 12000,aus dem Stamme Issaschar 12000,',
        8: 'aus dem Stamme Zabulon 12000,aus dem Stamme Joseph 12000,aus dem Stamme Benjamin 12000 Versiegelte.',
    ...
    9: {
        1: 'Und der fünfte Engel posaunte: und ich sah einen Stern, der vom Himmel auf die Erde gefallen war; und es wurde ihm der Schlüssel zum Schlunde des Abgrundes gegeben.',
        2: 'Und er öffnete den Schlund des Abgrundes; und ein Rauch stieg auf aus dem Schlunde wie der Rauch eines großen Ofens, und die Sonne und die Luft wurde verfinstert von dem Rauche des Schlundes.',
        ...
        5: 'Und es wurde ihnen gegeben, daß sie sie nicht töteten, sondern daß sie gequält würden fünf Monate; und ihre Qual war wie die Qual eines Skorpions, wenn er einen Menschen schlägt.',
        ...
        10: 'und sie haben Schwänze gleich Skorpionen, und Stacheln, und ihre Gewalt ist in ihren Schwänzen, die Menschen zu beschädigen fünf Monate.',
    ...
    11: {
        ...
        15: 'Und der siebte Engel posaunte: und es geschahen laute Stimmen in dem Himmel, welche sprachen: Das Reich der Welt unseres Herrn und seines Christus ist gekommen, und er wird herrschen in die Zeitalter der Zeitalter.',
    ...
    12: {
        ...
        6: 'Und das Weib floh in die Wüste, woselbst sie eine von Gott bereitete Stätte hat, auf daß man sie daselbst ernähre 1260 Tage.',
        ...
        17: 'Und der Drache ward zornig über das Weib und ging hin, Krieg zu führen mit den übrigen ihres Samens, welche die Gebote Gottes halten und das Zeugnis Jesu haben. Und ich stand auf dem Sande des Meeres.',
    },
    13: {
        ...
        5: 'Und es wurde ihm ein Mund gegeben, der große Dinge und Lästerungen redete; und es wurde ihm Gewalt gegeben, zu wirken 42 Monate.',
    ...
    14: {
        ...
        11: 'Und der Rauch ihrer Qual steigt auf in die Zeitalter der Zeitalter; und sie haben keine Ruhe Tag und Nacht, die das Tier und sein Bild anbeten, und wenn jemand das Malzeichen seines Namens annimmt.',
    ...
    15: {
        ...
        7: 'Und eines der vier lebendigen Wesen gab den sieben Engeln sieben goldene Schalen, voll des Grimmes Gottes, der da lebt in die Zeitalter der Zeitalter.',
    ...
    16: {
        ...
        17: 'Und der siebte goß seine Schale aus in die Luft; und es ging eine laute Stimme aus von dem Tempel des Himmels,von dem Throne, welche sprach: Es ist geschehen.',
        18: 'Und es geschahen Blitze und Stimmen und Donner; und ein großes Erdbeben geschah, desgleichen nicht geschehen ist, seitdem die Menschen auf der Erde waren, solch ein Erdbeben, so groß.',
    ...
    18: {
        1: 'Nach diesem sah ich einen anderen Engel aus dem Himmel herniederkommen, welcher große Gewalt hatte; und die Erde wurde von seiner Herrlichkeit erleuchtet.',
        2: 'Und er rief mit starker Stimme und sprach: Gefallen, gefallen ist Babylon, die große, und ist eine Behausung von Dämonen geworden und ein Gewahrsam jedes unreinen Geistes und ein Gewahrsam jedes unreinen und gehaßten Vogels.',
        ...
        17: 'Und jeder Steuermann und jeder, der nach irgend einem Orte segelt, und Schiffsleute und so viele auf dem Meere beschäftigt sind, standen von ferne',
    ...
    19: {
        1: 'Nach diesem hörte ich wie eine laute Stimme einer großen Volksmenge in dem Himmel, welche sprach: Halleluja! das Heil und die Herrlichkeit und die Macht unseres Gottes!',
        2: 'denn wahrhaftig und gerecht sind seine Gerichte; denn er hat die große Hure gerichtet, welche die Erde mit ihrer Hurerei verderbte, und hat das Blut seiner Knechte gerächt an ihrer Hand.',
        ...
        10: 'Und ich fiel zu seinen Füßen nieder, ihn anzubeten Und er spricht zu mir: Siehe zu, tue es nicht. Ich bin dein Mitknecht und der deiner Brüder, die das Zeugnis Jesu haben; bete Gott an. Denn der Geist der Weissagung ist das Zeugnis Jesu.',
        ...
        18: 'auf daß ihr Fleisch von Königen fresset und Fleisch von Obersten und Fleisch von Starken und Fleisch von Pferden und von denen, die darauf sitzen, und Fleisch von allen, sowohl von Freien als Sklaven, sowohl von Kleinen als Großen.',
    ...
    22: {
        1: 'Und er zeigte mir einen Strom von Wasser des Lebens, glänzend wie Krystall, der hervorging aus dem Throne Gottes und des Lammes.',
        ...
        5: 'Und Nacht wird nicht mehr sein und kein Bedürfnis nach einer Lampe und des Lichtes der Sonne; denn der Herr, Gott, wird über ihnen leuchten, und sie werden herrschen in die Zeitalter der Zeitalter.',
