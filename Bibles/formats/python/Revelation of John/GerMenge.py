...
CHAPTERS = {
    ...
    4: {
        ...
        10: 'werfen sich die vierundzwanzig Ältesten vor dem auf dem Throne Sitzenden nieder und beten den an, der in alle Ewigkeit lebt, und legen ihre Kronen vor dem Throne nieder mit den Worten:',
    ...
    7: {
        ...
        4: 'Dann vernahm ich die Zahl der Versiegelten, nämlich hundertvierundvierzigtausend Versiegelte aus allen Stämmen der Israeliten:',
        ...
        16: 'Sie werden keinen Hunger und keinen Durst mehr haben, und kein Sonnenbrand wird sie jemals treffen noch irgendeine Hitze;',
        17: 'denn das Lamm dort mitten vor dem Thron wird sie weiden und sie zu Wasserquellen des Lebens führen, und Gott wird alle Tränen aus ihren Augen abwischen.«',
    },
    8: {
        ...
        3: 'Dann kam ein anderer Engel und trat mit einer goldenen Räucherpfanne in der Hand an den Altar heran, und viel Räucherwerk wurde ihm gegeben, damit er es für die Gebete aller Heiligen auf den goldenen Altar bringe, der vor dem Throne (Gottes) steht;',
        4: 'und der Rauch des Räucherwerks stieg für die Gebete der Heiligen aus der Hand des Engels vor Gott empor.',
        5: 'Hierauf nahm der Engel die Räucherpfanne, füllte sie mit glühenden Kohlen vom Altar und schleuderte sie auf die Erde hinab; da erfolgten Donnerschläge und Stimmen, Blitze und ein Erdbeben.',
        ...
        11: 'der Name des Sternes lautet ›Wermut‹. Da wurde der dritte Teil der Gewässer zu Wermut, und viele Menschen starben von dem Genuß des Wassers, weil es bitter geworden war.',
    ...
    9: {
        1: 'Und der fünfte Engel stieß in die Posaune: da sah ich einen Stern, der vom Himmel auf die Erde gefallen war; und der Schlüssel zum Schlund des Abgrundes wurde ihm gegeben.',
        ...
        11: 'Als König haben sie über sich den Engel des Abgrundes, der auf hebräisch ›Abaddon‹, auf griechisch ›Apollyon‹ heißt.',
    ...
    12: {
        1: 'Es erschien dann ein großes Zeichen im Himmel: ein Weib, das mit der Sonne umkleidet war; der Mond war unter ihren Füßen und ein Kranz von zwölf Sternen auf ihrem Haupt;',
        2: 'sie war guter Hoffnung und schrie in ihren Geburtsschmerzen und Kindesnöten.',
        3: 'Dann erschien plötzlich noch ein anderes Zeichen im Himmel: ein großer, feuerroter Drache mit sieben Köpfen und zehn Hörnern und mit sieben Königskronen auf seinen Köpfen;',
        4: 'sein Schweif fegte den dritten Teil der Sterne des Himmels weg und schleuderte sie auf die Erde. Der Drache stellte sich dann vor das Weib, die in Wehen lag, um ihr Kind sofort nach der Geburt zu verschlingen.',
        5: 'Und sie gebar einen Sohn, einen Knaben, der »alle Völker mit eisernem Stabe weiden soll«, und ihr Kind wurde zu Gott und zu seinem Thron entrückt.',
        6: 'Da floh das Weib in die Wüste, wo sie eine von Gott bereitete Stätte hat, um sich dort zwölfhundertsechzig Tage lang ernähren zu lassen.',
        ...
        14: 'Da wurden dem Weibe die beiden Flügel des großen Adlers gegeben, damit sie in die Wüste an ihre Stätte flöge, wo sie fern vom Anblick der Schlange »eine Zeit und (zwei) Zeiten und eine halbe Zeit lang« ernährt wird.',
        15: 'Da spie die Schlange aus ihrem Rachen Wasser hinter dem Weibe her wie einen Strom, um sie durch die Flut wegzuschwemmen;',
        ...
        17: 'Da geriet der Drache in Wut gegen das Weib und ging hin, um Krieg mit den übrigen ihres Samens zu führen, (nämlich mit denen) die Gottes Gebote beobachten und das Zeugnis Jesu haben.',
        18: 'Hierauf trat ich an den Sand des Meeres.',
    },
    13: {
    ...
    14: {
        1: 'Nun hatte ich ein Gesicht: ich sah nämlich das Lamm auf dem Berge Zion stehen und mit ihm hundertvierundvierzigtausend, die seinen Namen und den Namen seines Vaters auf ihrer Stirn geschrieben trugen.',
        2: 'Und ich hörte einen Schall aus dem Himmel wie das Rauschen vieler Wasser und wie das Rollen eines starken Donners; zugleich aber klang der Schall, den ich hörte, wie der von Harfenspielern, die auf ihren Harfen spielen.',
        3: 'Sie sangen ein neues Lied vor dem Throne und vor den vier Lebewesen und den Ältesten, und niemand konnte das Lied (singen) lernen außer den Hundertvierundvierzigtausend, die von der Erde erkauft sind.',
        4: 'Diese sind es, die sich mit Weibern nicht befleckt haben, denn sie sind jungfräulich rein; diese sind es, die dem Lamme nachfolgen, wohin es auch gehen mag. Diese sind aus der Menschheit als Erstlingsgabe für Gott und für das Lamm erkauft worden,',
        ...
        9: 'Noch ein anderer, dritter Engel folgte ihnen nach, der mit lauter Stimme rief: »Wenn jemand das Tier und sein Bild anbetet und das Malzeichen an seiner Stirn oder seiner Hand annimmt,',
        10: 'der wird gleichfalls vom Zornwein Gottes trinken, der ungemischt im Becher seines Zornes hergestellt ist, und wird mit Feuer und Schwefel vor den Augen der heiligen Engel und vor dem Lamm gepeinigt werden;',
        ...
        14: 'Nun sah ich plötzlich eine weiße Wolke, und auf der Wolke saß einer, der wie ein Menschensohn aussah; er hatte auf dem Haupt eine goldene Krone und eine scharfe Sichel in der Hand.',
        15: 'Dann trat ein anderer Engel aus dem Tempel heraus und rief dem auf der Wolke Sitzenden mit lauter Stimme zu: »Lege deine Sichel an und beginne die Ernte! Denn die Zeit zum Ernten ist gekommen, weil die Ernte der Erde dürr geworden ist.«',
        ...
        18: 'und ein anderer Engel kam aus dem Altar heraus; der hatte Macht über das Feuer und rief dem, der die scharfe Sichel hatte, mit lauter Stimme die Worte zu: »Lege deine scharfe Sichel an und schneide den Fruchtertrag am Weinstock der Erde ab! Denn seine Trauben sind reif geworden.«',
        ...
        20: 'Hierauf wurde die Kelter draußen vor der Stadt getreten: da kam Blut aus der Kelter hervor bis hinauf an die Zügel der Pferde (und ergoß sich) sechzehnhundert Stadien weit.',
    },
    15: {
    ...
    17: {
        1: 'Da kam einer von den sieben Engeln, welche die sieben Schalen hatten, redete mit mir und sagte: »Komm, ich will dir das Gericht über die große Buhlerin zeigen, die an vielen Wassern ihren Sitz hat,',
        2: 'mit der die Könige der Erde gebuhlt haben und von deren Unzuchtswein die Bewohner der Erde trunken geworden sind.«',
        3: 'So entführte er mich denn im Geist in eine Wüste; und ich sah dort ein Weib auf einem scharlachroten Tier sitzen, das mit gotteslästerlichen Namen übersät war und sieben Köpfe und zehn Hörner hatte.',
        ...
        10: 'und bedeuten (zugleich) sieben Könige: fünf von ihnen sind (bereits) zu Fall gekommen, der eine (sechste) ist (jetzt) da, der andere (siebte) ist noch nicht gekommen, und wenn er gekommen ist, darf er nur eine kurze Zeit bleiben.',
        ...
        12: 'Und die zehn Hörner, die du gesehen hast, sind zehn Könige, welche die Herrschaft noch nicht empfangen haben, sondern ihre königliche Gewalt zu derselben Stunde zugleich mit dem Tier erhalten.',
        ...
        15: 'Dann fuhr er fort: »Die Wasser, die du gesehen hast, wo die Buhlerin thront, sind Völker und Scharen, Völkerschaften und Sprachen;',
        16: 'und die zehn Hörner, die du gesehen hast, und das Tier: die werden die Buhlerin hassen, werden sie einsam und nackt machen, ihr Fleisch verzehren und sie selbst mit Feuer verbrennen;',
        17: 'denn Gott hat ihnen ins Herz gegeben, seinen Ratschluß auszuführen und in einem Sinn zu handeln und ihre Königsherrschaft solange dem Tier zur Verfügung zu stellen, bis die Worte Gottes erfüllt sein werden.',
    ...
    18: {
        ...
        13: 'auch Zimt und Haarbalsam und Räucherwerk, Salbe und Weihrauch, Wein und Öl, Feinmehl und Weizen, Zugvieh und Schafe, Pferde und Wagen, Menschenleiber und Menschenseelen.',
        ...
        17: 'Und alle Steuermänner und alle Küstenfahrer, die Schiffsleute und alle, die auf dem Meer arbeiten, standen von fern',
        ...
        22: 'Kein Klang von Harfenspielern und Sängern, von Flötenspielern und Posaunenbläsern wird je wieder in dir vernommen werden! Auch kein Künstler in irgendwelcher Kunst wird noch in dir gefunden und kein Schall von einer Mühle in dir gehört werden!',
        23: 'Kein Licht von einer Lampe wird noch in dir scheinen und kein Jubelruf eines Bräutigams und einer Braut sich in dir vernehmen lassen! Denn deine Kaufherren sind die Großen der Erde gewesen, und durch deine Giftmischereien sind alle Völker verführt worden;',
    ...
    19: {
        ...
        20: 'Da wurde das Tier gegriffen und mit ihm der Lügenprophet, der die Wunderzeichen vor seinen Augen getan und dadurch die verführt hatte, welche das Malzeichen des Tieres trugen und sein Bild anbeteten; bei lebendigem Leibe wurden beide in den Feuersee geworfen, der mit Schwefel brennt.',
    ...
    20: {
        ...
        14: 'hierauf wurden der Tod und das Totenreich in den Feuersee geworfen. Dies ist der zweite Tod, nämlich der Feuersee;',
    ...
    22: {
        ...
        5: 'Es wird dort auch keine Nacht mehr geben, und man bedarf keines Lampenlichts und keines Sonnenlichts; denn Gott der Herr wird ihnen leuchten, und sie werden als Könige in alle Ewigkeit herrschen.',
