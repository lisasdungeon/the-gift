...
CHAPTERS = {
    ...
    9: {
        1: 'Og den femte engel blåste i basun, og jeg så en stjerne som var falt fra himmelen ned på jorden, og nøkkelen til avgrunnens brønn blev gitt den.',
    ...
    11: {
        ...
        7: 'Og når de har fullført sitt vidnesbyrd, da skal dyret som stiger op av avgrunnen, føre krig mot dem og seire over dem og drepe dem.',
    ...
    14: {
        ...
        6: 'Og jeg så en annen engel flyve under det høieste av himmelen, som hadde et evig evangelium å forkynne for dem som bor på jorden, og for hver ætt og stamme og tunge og folk,',
