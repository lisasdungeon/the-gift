...
CHAPTERS = {
    ...
    4: {
        ...
        9: 'A gdy one zwierzęta dawały chwałę i cześć, i dziękowanie siedzącemu na stolicy, żyjącemu na wieki wieków;',
    ...
    7: {
        ...
        12: 'Mówiąc: Amen! Błogosławieństwo i chwała, i mądrość, i dziękowanie, i cześć, i moc, i siła Bogu naszemu na wieki wieków. Amen.',
    ...
    11: {
        ...
        7: 'A gdy dokończą świadectwa swojego, bestyja, która występuje z przepaści, stoczy z nimi bitwę, a zwycięży ich i pobije ich.',
        ...
        15: 'I zatrąbił Anioł siódmy i stały się głosy wielkie na niebie mówiące: Królestwa świata stały się królestwami Pana naszego i Chrystusa jego, i królować będzie na wieki wieków.',
    ...
    19: {
        ...
        20: 'Ale pojmana jest bestyja, a z nią fałszywy on prorok, który czynił cuda przed nią, któremi zwodził tych, którzy przyjęli piętno bestyi i którzy się kłaniali obrazowi jej, i obaj wrzuceni są żywo do jeziora ognistego, gorejącego siarką.',
