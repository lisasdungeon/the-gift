...
CHAPTERS = {
    1: {
        ...
        10: 'Ich war an des Herrn Tage im Geiste, und ich hörte hinter mir eine laute Stimme wie die einer Posaune, welche sprach:',
        11: 'Was du siehst, schreibe in ein Buch und sende es den sieben Versammlungen: nach Ephesus und nach Smyrna und nach Pergamus und nach Thyatira und nach Sardes und nach Philadelphia und nach Laodicäa.',
    ...
    9: {
        ...
        2: 'Und er öffnete den Schlund des Abgrundes; und ein Rauch stieg auf aus dem Schlunde wie der Rauch eines großen Ofens, und die Sonne und die Luft wurden von dem Rauche des Schlundes verfinstert.',
    ...
    11: {
        ...
        3: 'Und ich werde meinen zwei Zeugen Kraft geben, und sie werden tausendzweihundertsechzig Tage weissagen, mit Sacktuch bekleidet.',
    ...
    13: {
        1: '(G12:18) Und ich stand auf dem Sande des Meeres. (G13:1) Und ich sah aus dem Meere ein Tier aufsteigen, welches zehn Hörner und sieben Köpfe hatte, und auf seinen Hörnern zehn Diademe, und auf seinen Köpfen Namen der Lästerung.',
    ...
    22: {
        1: 'Und er zeigte mir einen Strom von Wasser des Lebens, glänzend wie Kristall, der hervorging aus dem Throne Gottes und des Lammes.',
