...
CHAPTERS = {
    ...
    2: {
        ...
        15: 'Protož jsem řekl v srdci svém: Má-liť mi se tak díti, jako se děje bláznu, pročež jsem tedy moudrostí předčil? A tak řekl jsem v srdci svém: I to jest marnost.',
        ...
        17: 'Pročež mrzí mne tento život; nebo se mi nelíbí nic, což se děje pod sluncem, poněvadž všecky věci jsou marnost a trápení ducha.',
