...
CHAPTERS = {
    ...
    3: {
        ...
        35: 'Potom přišel všecken lid, a měli k tomu Davida, aby jedl chléb ještě záhý. Ale David přisáhl, řka: Toto ať mi učiní Bůh a toto přidá, jestliže prvé, než slunce zapadne, okusím chleba aneb čehokoli jiného.',
