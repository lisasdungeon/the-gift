...
CHAPTERS = {
    ...
    4: {
        ...
        7: '我在床上腦中所有的異象是這樣：我忽然看見從地中生出一棵樹來，極其高大。',
        8: '這棵樹長的非常粗壯，高可摩天，大地四極都可見到；',
        9: '樹葉美麗，果實繁多，足以供養一切生靈，田野的走獸安息在它的蔭下，空中的飛鳥棲息在它的枝杈上，一切生物都由它獲得供養。',
        10: '我在床上，在我腦海所得的異象中，我看見有一位守衛兼聖者自天降下，',
        11: '他大聲呼喊說：砍倒這棵樹，砍斷它的枝條，搖落它的葉子，打下它的果實，叫走獸離開它下面，叫飛鳥飛離它的枝杈，',
        12: '但在地上只留下它根上的餘幹，用鐵索和銅鏈將它捆住，放在田野的青草，',
        13: '使他的心改變不像人心，給他一個獸心，在他身上要這樣經歷七段時期。',
        ...
        22: '你將由人間被驅逐，與田野的走獸為伍，你吃草如同牛一樣，為露水浸濕，要這樣經歷七段時期，直到你承認至高者統治世人的國度，願意給誰，就給誰。',
        ...
        29: '你要由人間被驅逐，與田野的走獸為伍，你要吃草如同牛一樣，這樣，在你身上經歷七段時期，直到你承認至高者統治世人的國度，他願意給誰，就給誰。」',
        30: '這話立即在拿步高身上應驗了：他被逐離開了人群，吃草如同牛一樣，他的身體為露水浸濕，直報他的頭髮長得有如鷹的羽翼，指甲有如鳥的爪子。',
        ...
        34: '現在，我拿步高要稱頌、讚揚和光榮天上的君王，因為他的一切作為是真理，他的到路是正義；凡行動傲慢的，他都能壓伏。」',
    },
    5: {
        ...
        5: '正在此時，忽然出現了一個人的手指，在燈台後面王宮的粉牆上寫字，君王也看見了那寫字的手掌。',
        6: '當時君王的面色立即改變，心意煩亂，兩腰關節鬆弛，兩膝互相碰擊，',
        7: '君王遂大聲喊叫，命召術士、占星者和占卜者來；君王就向巴比倫的智者說：不論誰，如能閱讀這些字，給我解說其中的意義，就必身被絳袍，帶上金項鏈，位居全國第三。',
        ...
        15: '方纔智者和術士被引至我前，要他們念這些文字，給我說明其中的意義，但是他們卻都不能給我解釋這些文字的意義。',
        16: '我聽說你能解釋疑難，現在你若能念這些文字，給我說明其中的意義，你就要身披絳袍，帶上金項鏈，位居全國第三。」',
        ...
        23: '反而自高自大，抵抗上天的大主，命人將他殿宇的器皿給你拿來，供你和你的大臣並你的妻妾用來飲酒，並且你讚美那些不能看，不能聽，不能知的金、銀、銅、鐵、木、石製的神像，卻不知尊崇那掌握你的氣息，註定你一切命途的天主。',
        24: '為此，他使一隻手掌出現，寫了這些字。',
        25: '寫出來的這些字是：「默乃，默乃，特刻耳，培勒斯。」',
        26: '這些字的含義是：「默乃：」天主數了你的國祚，使它完結；「',
        27: '特刻耳：」你在天秤上被衡量了，不夠分量；「',
        28: '培勒斯：」你的國被瓜分了，給了瑪待人和波斯人。」',
        29: '於是貝耳沙匝下令，給達尼爾披上絳袍，帶上金項鏈，並宣布他位居全國第三。',
        30: '當夜加色丁王貝耳沙匝即為人所殺。',
    },
    6: {
        ...
        4: '這位達尼爾，由於他具有超凡的精神，辦事勝過其他監察史和總督，所以君王有意立他治理全國。',
        ...
        17: '君王於是下令，將達尼爾逮捕投入獅子圈內。君王對達尼爾說：「願你恒心恭敬的天主拯救救你! 」',
        18: '遂即移了一塊大石，封住圈口，君王蓋上自己的御璽，大臣們蓋上自己的印章，免得達尼爾的案件發生意外的變化。',
        19: '然後君王回了王宮，整夜絕食，斷絕娛樂，並徹夜失眠未睡。',
        20: '清晨，天一亮，君王便起來，急速往獅子圈去了，',
        21: '一來到獅子圈旁，就哀聲呼喊，向達尼爾說道：「永生天主的僕人達尼爾! 你恒心恭敬的天主真能由獅子口裏拯救你嗎﹖」',
        22: '達尼爾遂對君王說：「大王萬歲!',
        23: '我的天主曾打發他的天使閉住獅子的口，一點沒有傷害我，因為我在他面前是無罪的；大王! 我即在陛下面前，也從沒有做過什麼傷害人的事。」',
        24: '君王非常高興，遂下令將達尼爾從獅子圈裏提出來。達尼爾便從獅子圈裏被提出來，他身上絲毫沒有受到損傷，因為他信賴了自己的天主。',
        25: '君王遂下令逮捕那些控告達尼爾的人，將他們和他們的兒子、妻子，都投入獅子圈裏，他們還沒有到獅子圈底，獅子就向他們撲來，捉住他們，將他們的骨頭全咬碎了。',
    ...
    13: {
        ...
        4: '約雅金是個很富有的人，靠近他的住宅有一個果園；由於他比眾人更有聲望，猶太人經常到他那裏集會。',
        5: '那一年，有兩個長老由人民選為民長，上主曾論及這類人說：「邪惡充塞巴比倫，是由於只在表面上治理人民的長老和民長。」',
        6: '這兩個人經常到約雅金的家裏來；凡有訴訟的，都到這裏來見他們。',
        7: '中午時，人民離去以後，蘇撒納常走進她丈夫的果園裏散步。',
        ...
        63: '為此，希耳克雅和他的妻子為女兒蘇撒納，同蘇撒納的丈夫約雅金和自己全體親友，一起稱謝了天主，因為在蘇撒納身上沒有找到什麼敗德的事。',
        64: '從那一天以後，達尼爾在人民面前大受尊重。',
    },
    14: {
        1: '阿斯提雅革歸到他祖先那裏以後，波斯人居魯士便繼承了他的王位。',
        2: '達尼爾與王住在一起，且受王尊敬，遠在他所有的同僚之上。',
        3: '巴比倫有一個偶像名叫貝耳，每天這偶像耗費十二袋細麵，四十隻綿羊和六桶酒。',
        ...
        7: '達尼爾笑著說：「大王，不要受欺騙! 它裏面是泥土，外面是黃銅，決不會吃，也不會喝。」',
        8: '君王大怒，命人將貝耳的司祭召來，對他們說：「你們若不告訴我是誰吃了這些供物，你們就該死；如果你能證明是貝耳吃了，達尼爾就該死，因為他褻瀆了貝耳。」',
        ...
        12: '他們自以為得意，因為他們在供桌下面早開了一個暗門，天天從那裏進來，吃光桌上的供物。',
        ...
        21: '於是君王大怒，令人逮捕了司祭和他們的妻子兒女，這時他們纔給君王指出他們是由暗門進來，吃盡供桌上的食物。',
        22: '君王遂將他們殺掉，將貝耳交由達尼爾處理；達尼爾便推翻了貝耳和他的廟宇。',
        23: '在那地方有一條巴比倫人所敬拜的大龍。',
        24: '君王對達尼爾說：「現在你卻不能說這不是生活的神了罷，那麼你就應該崇拜牠。」',
        25: '達尼爾回答說：「我崇拜的是上主，我的天主，因為只有他是永生的天主；這條龍不是永生的神。大王! 請給我全權! 我不用刀，也不用棍，就可殺死這條龍。」',
        26: '君王說：「我給你全權! 」',
        27: '達尼爾取了瀝青、脂油和頭髮，攙和在一起煎熬，作成丸子送到龍口裏；龍吃下以後，就爆裂了。於是達尼爾說：「請看，你們所敬拜的神! 」',
        ...
        31: '他們便將達尼爾拋入獅子圈內，達尼爾在那裏有六天之久。',
        32: '圈裏有七隻獅子，每天給牠們兩個屍體，兩隻綿羊，但那時卻沒有給牠們，好叫牠們吞食達尼爾。',
        33: '當時在猶大有個先知哈巴谷，他做好了肉湯，把餅切好放在罐裏，正要往田間去，送給收割莊稼的人。',
        34: '那時上主的天使便對哈巴谷說：「把你預備下的午飯，帶到巴比倫去，送給在獅子圈裏的達尼爾罷! 」',
        ...
        40: '到了第七天，君王前來哀悼達尼爾。當他走近獅子圈往裏面觀看時，望見達尼爾坐在那裏。',
        41: '君王遂大聲呼喊說：「上主，達尼爾的天主! 你是偉大的，除你以外沒有別的神。」',
        42: '於是君王將達尼爾拉上來，那些想陷害他的人拋進獅子圈裏，頃刻之間他們在君王面前，便被獅子吞噬了。',
        43: '君王遂宣佈說：「全地的君民都應敬畏達尼爾的天主，因為他施救，在地上行了神蹟奇事，從獅子圈裏拯救了達尼爾。」',
    },
}
