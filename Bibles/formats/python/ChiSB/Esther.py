...
CHAPTERS = {
    ...
    2: {
        ...
        3: '大王可指派委員到全國各省，把所有美貌的年輕處女，都召集到穌撒禁城的後宮來，由管理嬪妃的王家太監赫革負責照應，供給她們美容潤身的香料。',
        4: '那中悅君王的處女就得代瓦市提為后。」這建議正合了王的心，王就照樣進行。',
        ...
        11: '此後，摩爾德開天天在後宮的庭院前徘徊，好打聽艾斯德爾的消自，想知道她的情形如何。',
        ...
        16: '艾斯德爾在薛西斯為王第七年十月，即「太貝特」月，被召進王宮。',
        17: '王愛艾斯德爾超過所有的嬪妃。在所有的處女中，她最得君王的歡心和喜愛。王便將后冠戴在她頭上，立她為王后，以代瓦市提。',
        18: '於是王給眾文武官員擺設盛宴，一連七天，號為艾斯德爾宴，又給全國各省頒賜大赦，並按照君王的法度敕贈御品。',
        ...
        23: '那陰謀經過調查證實以後，就將他們二人懸在木架上，處以極刑。此事的原委，當著君王的面記錄在年鑑內。',
    },
    3: {
    ...
    6: {
        1: '那一夜，君王因失眠，便命人取大事錄，即年鑑來，在他面前誦讀。',
        2: '書上這樣記載：摩爾德開如何告發了君王的兩個守門太監彼革堂和特勒士，企圖殺害薛西斯王的事。',
        3: '王問說：「摩爾德開為這事得到什尊榮和地位﹖」服侍他的僕答說：「他什麼也沒有得到。」',
