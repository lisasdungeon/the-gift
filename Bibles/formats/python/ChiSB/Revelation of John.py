...
CHAPTERS = {
    ...
    6: {
        ...
        8: '我就看見，出來了一匹青馬，騎馬的名叫「死亡，」陰間也跟著他；並給了他們統治世界四分之一的權柄，好藉刀劍、饑荒、瘟疫，並藉地上的野獸，去執行殺戮。',
    ...
    9: {
        ...
        2: '他一開了深淵的洞穴，就有煙從洞穴裏冒上來，像大火窯裏的煙，太陽和天空都因那洞穴裏的煙昏暗了，',
        ...
        11: '牠們以深淵的使者為牠們的王子，他的名字，希伯來文叫「阿巴冬，」希臘文叫「阿頗隆。」',
    ...
    13: {
        1: '看見從海裏上來一隻獸，牠有十隻角和七個頭，角上有十個王冠，頭上有褻聖的名號。',
        2: '我所看見的那獸，相似豹子，牠的腳像熊腳，牠的口像獅子口；那龍遂把自己的能力、寶座和大權交給了牠。',
        3: '我看見那獸的頭中，有一個似乎受了致死的傷，但牠那致死的傷卻治好了；故此全地的人都驚奇，而跟隨了那獸。',
        4: '世人遂都朝拜那龍，因為牠把權柄賜給了那獸；世人朝拜那獸說：「誰可與這獸相比？誰能和牠交戰？」',
        5: '又賜給了那獸一張說大話和褻聖的口，並且賜給了牠可妄為四十二個月的權柄；',
        6: '牠便張開自己的口，向天主說褻瀆的話，褻瀆他的聖名、他的帳幕和那些居住在天上的人。',
        7: '又允許牠可與聖徒們交戰，且戰勝他們；又賜給牠制服各支派、各民族、各異語和各邦國的權柄。',
        8: '地上的居民，凡名字從創造之初沒有記錄在被宰殺的羔羊生命冊中的人，都要朝拜牠。',
        9: '誰若有耳朵，就聽罷！',
        10: '誰若該被俘擄，就去受俘擄；誰若該受刀殺，就去受刀殺：聖徒們的堅忍和忠信即在於此。',
        11: '以後我看見另一隻獸由地中上來，牠有兩隻相似羔羊的角，說話卻相似龍。',
        12: '牠在那前一隻獸面前，施行前一隻獸所有的一切權柄，使大地和居住在地上的人，朝拜前一隻獸，就是那隻受過致死的傷而被治好的獸。',
        13: '牠又行大奇蹟，甚至在眾人面前使火從天降到地上。',
        14: '牠因著在那獸面前所行的那些奇蹟，迷惑了地上的居民，便勸告地上的居民，給那那受過刀傷而還活著的獸，立一個像。',
        15: '牠又得了能力，把生氣賦給那獸像，甚至叫那獸像說話，並使那些凡不朝拜獸像的人死亡。',
        16: '牠給所有的人，無論大小貧富，自主的和為奴的，都在他們的右手上，或在他們的額上，打了一個印號；',
        17: '如此，除非有這印號的，就是有那獸的名字或牠名字的數字的，誰也不能買，誰也不能賣。',
        18: '在這裏應有智慧：凡有明悟的，就讓他計算一下那獸的數字，因為是人的數字，牠的數字是六百六十六。',
    },
    14: {
        ...
        11: '他們受刑的煙向上直冒，至於萬世無窮；那些朝拜了獸和獸像的，以及凡接受了牠名字的印號的，日夜得不到安息。」',
    ...
    17: {
        1: '七位拿著七個盂的天使中，有一位前來， 向我說道：「你來，我要指給你看，那在多水之旁為王的大淫婦受的懲罰；',
        ...
        7: '天使便對我說：「你為什麼驚奇？我要告訴你這婦人和馱著她，而有七個頭和十隻角的那獸的奧秘：',
        8: '你所看見的那獸， 先前在而今不在，可是牠又要從深淵中上來，自趨於喪亡；地上的居民，凡他們的名字從創世之初，沒有記錄在生命冊中的，看見那先前在，而今不在，將來又在的獸，都必要驚奇。',
        9: '這裏需要一個有智慧的明悟去理解：七個頭是指那婦人所坐的七座山，也是指七位君王；',
        10: '五位已經倒了，一位仍在，另一位還沒有來到；當他來到時，必要存留片刻。',
        11: '至於那先前在而今不在的獸，是第八位，也屬於那七位中之一，牠要趨於喪亡。',
        12: '你所看見的那十隻角，是指十個君王，他們還沒有領受王位，但必要同那獸一起得到權柄；他們當國王，只一個時辰。',
        13: '他們的意見都一致：就是把自己的能力和權柄都交給那獸。',
        14: '他們要同羔羊交戰，羔羊卻要戰勝他們，因為他是萬主之主，萬王之王，同他在一起的蒙召、被選和忠信的人，也必要獲勝。 」',
        15: '天使又對我說：「你看見那淫婦所統治的水，是指諸民族、群眾、邦國和異語人民。',
        16: '你看見的那十隻角和那獸，必要憎恨那淫婦，使她成為孤獨淒涼，赤身裸體的，並吞食她的肉，且用火焚燒她，',
        17: '因為天主使牠們的心中有這意念，叫牠們實行天主的計劃，就是叫牠們一心，把牠們的王權交給那獸，直到天主的話完全應驗為止。',
    ...
    19: {
        ...
        20: '可是，那獸被捉住了，在牠面前行過奇蹟，並藉著這些奇蹟，欺騙了那些接受那獸的印號，和朝拜獸像的那位假先知，也和牠一起被捉住了；牠們兩個活活的被扔到那用硫磺燃燒的火坑裏去了。',
        21: '其餘的人也被騎馬者口中所射出的劍殺死了；所有的飛鳥都吃飽了他們的肉。',
    },
    20: {
        1: '後，我看見一位天使從天降下，手持深淵的鑰匙和一條大鎖鏈。',
