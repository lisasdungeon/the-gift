...
CHAPTERS = {
    ...
    4: {
        1: "yIlegh, SoH 'oH 'IH, wIj muSHa'. yIlegh, SoH 'oH 'IH. lIj mInDu' 'oH doves behind lIj veil. lIj jIb ghaH as a flock vo' goats, vetlh descend vo' Mount Gilead.",
    ...
    8: {
        ...
        5: "'Iv ghaH vam 'Iv choltaH Dung vo' the ngem, leaning Daq Daj parmaqqay? bIng the apple Sor jIH aroused SoH. pa' lIj SoS conceived SoH. pa' ghaH ghaHta' Daq labor je boghmoH SoH.",
        6: "cher jIH as a seal Daq lIj tIq, as a seal Daq lIj arm; vaD muSHa' ghaH HoS as Hegh. Jealousy ghaH as cruel as Sheol { Note: Sheol ghaH the Daq vo' the Heghpu'. }. Its flashes 'oH flashes vo' qul, a very flame vo' joH'a'.",
        7: "law' bIQmey ta'laHbe' meQbe'moH muSHa', ghobe' laH floods drown 'oH. chugh a loD would nob Hoch the wealth vo' Daj tuq vaD muSHa', ghaH would taH utterly scorned. Friends",
        ...
        9: "chugh ghaH ghaH a reD, maH DichDaq chen Daq Daj a turret vo' baS chIS. chugh ghaH ghaH a lojmIt, maH DichDaq enclose Daj tlhej boards vo' cedar. parmaqqay",
        10: "jIH 'oH a reD, je wIj breasts rur towers, vaj jIH ghaHta' Daq Daj mInDu' rur wa' 'Iv tu'ta' roj.",
