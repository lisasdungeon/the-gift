...
CHAPTERS = {
    ...
    12: {
        ...
        33: 'E que amá-lo com todo o coração, com todo o entendimento, e com todas as forças; e amar ao próximo como a si mesmo, é mais que todas as ofertas de queima e sacrifícios.',
    ...
    14: {
        ...
        27: 'E Jesus lhes disse: “Todos vós vos ofendereis; porque está escrito: Ferirei ao pastor, e as ovelhas serão dispersas.',
