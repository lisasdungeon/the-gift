...
CHAPTERS = {
    ...
    7: {
        ...
        24: 'Portanto todo o que ouve estas minhas palavras e as praticaserá comparado ao homem prudente, que construiu sua casa sobre a rocha.',
    ...
    11: {
        ...
        19: 'Veio o Filho do homem, que come e bebe, e dizem: “Eis aqui um homem comilão e beberrão, amigo de cobradores de impostos e pecadores!” Mas a sabedoria prova-se justa por meio de suas obras.',
        ...
        23: 'E tu, Cafarnaum, estarás tu exaltada até o céu? Ao mundo dos mortos serás derrubada! Pois se em Sodoma tivessem sido feitos os milagres que foram feitos em ti, ela teria permanecido até hoje.',
    ...
    15: {
        ...
        12: 'Então os discípulos se aproximaram dele, e lhe perguntaram: Tu sabes que os fariseus se ofenderam quando ouviram esta palavra?',
    ...
    18: {
        ...
        7: 'Ai do mundo por causa dos escândalos! Pois é necessário que os escândalos venham, mas ai da pessoa por quem o escândalo vem!',
        8: 'Portanto, se a tua mão ou o teu pé te conduz ao escândalo, corta-os, e lança-os de ti; melhor te é entrar aleijado ou manco na vida do que, tendo duas mãos ou dois pés, ser lançado no fogo eterno.',
        ...
        28: 'Todavia, depois daquele servo sair, achou um servo, colega seu, que lhe devia cem denários; então o agarrou e o sufocou, dizendo: “Paga o que me deves!”',
    ...
    19: {
        ...
        29: 'E qualquer um que houver deixado casas, ou irmãos, ou irmãs, ou pai, ou mãe, ou filhos, ou terras por causa do meu nome, receberá muitas vezes mais, e herdará a vida eterna.',
    ...
    21: {
        ...
        31: 'Qual dos dois fez a vontade do pai?Eles lhe responderam: O segundo. Jesus lhes disse: Em verdade vos digo que os cobradores de impostos e as prostitutas estão indo adiante de vós ao Reino de Deus.',
    ...
    26: {
        ...
        59: 'Os chefes dos sacerdotes e todo o conselho buscavam falso testemunho contra Jesus, para poderem matá-lo,',
