...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'Διότι εάν εισέλθη εις την συναγωγήν σας άνθρωπος έχων χρυσούν δακτυλίδιον με λαμπρόν ένδυμα, εισέλθη δε και πτωχός με ρυπαρόν ένδυμα,',
        3: 'και επιβλέψητε εις τον φορούντα το ένδυμα το λαμπρόν και είπητε προς αυτόν, Συ κάθου εδώ καλώς, και προς τον πτωχόν είπητε, Συ στέκε εκεί· κάθου εδώ υπό το υποπόδιόν μου,',
        ...
        8: 'Εάν μεν εκτελήτε τον νόμον τον βασιλικόν κατά την γραφήν, Θέλεις αγαπά τον πλησίον σου ως σεαυτόν, καλώς ποιείτε·',
        9: 'εάν όμως προσωποληπτήτε, κάμνετε αμαρτίαν και ελέγχεσθε υπό του νόμου ως παραβάται.',
        10: 'Διότι όστις φυλάξη όλον τον νόμον και πταίση εις εν, έγεινεν ένοχος πάντων.',
        11: "Επειδή ο ειπών, Μη μοιχεύσης, είπε και, Μη φονεύσης· αλλ' εάν δεν μοιχεύσης, φονεύσης δε, έγεινες παραβάτης του νόμου.",
        ...
        18: 'Αλλά θέλει τις ειπεί· Συ έχεις πίστιν, και εγώ έχω έργα· δείξόν μοι την πίστιν σου εκ των έργων σου, και εγώ θέλω σοι δείξει εκ των έργων μου την πίστιν μου.',
        ...
        23: 'και επληρώθη η γραφή η λέγουσα· Επίστευσε δε Αβραάμ εις τον Θεόν, και ελογίσθη εις αυτόν εις δικαιοσύνην, και φίλος Θεού ωνομάσθη.',
        24: 'Βλέπετε λοιπόν ότι εξ έργων δικαιούται ο άνθρωπος και ουχί εκ πίστεως μόνον.',
        25: "Ομοίως δε και Ραάβ η πόρνη δεν εδικαιώθη εξ έργων, ότε υπεδέχθη τους απεσταλμένους και εξέβαλεν αυτούς δι' άλλης οδού;",
        26: 'Διότι καθώς το σώμα χωρίς πνεύματος είναι νεκρόν, ούτω και η πίστις χωρίς των έργων είναι νεκρά.',
    },
    3: {
        1: 'Μη γίνεσθε πολλοί διδάσκαλοι, αδελφοί μου, εξεύροντες ότι μεγαλητέραν κατάκρισιν θέλομεν λάβει·',
        2: 'διότι εις πολλά πταίομεν άπαντες. Εάν τις δεν πταίη εις λόγον, ούτος είναι τέλειος ανήρ, δυνατός να χαλιναγωγήση και όλον το σώμα.',
        ...
        6: 'και η γλώσσα πυρ είναι, ο κόσμος της αδικίας. Ούτω μεταξύ των μελών ημών η γλώσσα είναι η μολύνουσα όλον το σώμα και φλογίζουσα τον τροχόν του βίου και φλογιζομένη υπό της γεέννης.',
        ...
        12: 'μήπως είναι δυνατόν, αδελφοί μου, η συκή να κάμη ελαίας ή η άμπελος σύκα; ούτως ουδεμία πηγή είναι δυνατόν να κάμη ύδωρ αλμυρόν και γλυκύ.',
    ...
    5: {
        ...
        4: 'Ιδού, ο μισθός των εργατών των θερισάντων τα χωράφια σας, τον οποίον εστερήθησαν από σας, κράζει, και αι κραυγαί των θερισάντων εισήλθον εις τα ώτα Κυρίου Σαβαώθ.',
        ...
        7: "Μακροθυμήσατε λοιπόν, αδελφοί, έως της παρουσίας του Κυρίου. Ιδού, ο γεωργός περιμένει τον πολύτιμον καρπόν της γης και μακροθυμεί δι' αυτόν, εωσού λάβη βροχήν πρώϊμον και όψιμον·",
        ...
        19: 'Αδελφοί, εάν τις μεταξύ σας αποπλανηθή από της αληθείας, και επιστρέψη τις αυτόν,',
