...
CHAPTERS = {
    ...
    2: {
        ...
        7: 'Is not it they who malign that honourable name which has been bestowed on you?',
        8: 'Yet, if you keep the royal law which runs — ‘You must love your neighbour as you love yourself,’ you are doing right;',
    ...
    5: {
        ...
        13: 'If any of you is in trouble, let them pray; if anyone is happy, let them sing hymns.',
        14: 'If anyone of you is ill, let him send for the officers of the church, and let them pray over them, after anointing them with oil in the name of the Lord.',
        ...
        17: 'Elijah was only human like ourselves, but, when he prayed fervently that it might not rain, no rain fell on the land for three years and a half.',
        ...
        20: 'be sure that the person who brings a sinner back from their mistaken ways will save that person’s soul from death, and throw a veil over countless sins.',
    },
}
