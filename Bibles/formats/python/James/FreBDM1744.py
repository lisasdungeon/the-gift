...
CHAPTERS = {
    1: {
        ...
        4: 'Mais il faut que la patience ait une oeuvre parfaite, afin que vous soyez parfaits et accomplis, de sorte que rien ne vous manque.',
    ...
    3: {
        ...
        14: 'Mais si vous avez une envie amère et de l’irritation dans vos coeurs, ne vous glorifiez point, et ne mentez point en déshonorant la vérité de l’Evangile.',
    ...
    5: {
        ...
        5: 'Vous avez vécu dans les délices sur la terre, vous vous êtes livrés aux voluptés, et vous avez rassasié vos coeurs comme en un jour de sacrifices.',
