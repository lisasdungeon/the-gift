...
CHAPTERS = {
    1: {
        ...
        5: '너희 중에 어떤 사람이 지혜가 부족하거든 모든 사람에게 너그러이 주시고 꾸짖지 아니하시는 하나님께 구하라. 그리하면 그것을 그에게 주시리라.',
        6: '그러나 그는 믿음으로 구하고 조금도 흔들리지 말지니라. 흔들리는 자는 마치 바람에 밀려 요동하는 바다 물결 같나니',
        7: '그 사람은 자기가 무엇을 주께 받을 줄로 생각하지 말라.',
        ...
        16: '나의 사랑하는 형제들아, 잘못을 범하지 말라.',
        17: '모든 좋은 선물과 모든 완전한 선물은 위에서 오며 빛들의 아버지로부터 내려오거니와 그분께는 변함도 없고 회전하는 그림자도 없느니라.',
        18: '그분께서 자신의 뜻에 따라 진리의 말씀으로 우리를 낳으셨으니 이것은 우리가 그분의 창조물 중의 첫 열매 종류가 되게 하려 하심이라.',
        19: '그러므로 내 사랑하는 형제들아, 사람마다 듣기는 빨리 하고 말하기는 더디 하며 진노하는 것도 더디 하라.',
        20: '사람의 진노가 하나님의 의를 이루지 못하느니라.',
        21: '그러므로 모든 더러움과 넘치는 악을 내버리고 접붙여진 말씀 곧 능히 너희 혼을 구원할 수 있는 말씀을 온유함으로 받으라.',
        22: '오직 너희는 말씀을 행하는 자가 되고 듣기만 하여 너희 자신을 속이는 자가 되지 말라.',
        23: '누구든지 말씀을 듣고 행하지 아니하는 자는 거울로 자기의 본래 얼굴을 들여다보는 사람과 같으니라.',
        24: '그는 자기를 바라보고 자기 길로 가서 자기가 어떤 사람인지 즉시 잊어버리거니와',
    ...
    2: {
        1: '내 형제들아, 영광의 주 곧 우리 주 예수 그리스도의 믿음을 가지고서 사람들의 외모를 중시하지 말라.',
        2: '만일 너희 집회에 금반지를 끼고 아름다운 옷을 입은 사람이 오고 또 허름한 옷을 입은 가난한 사람이 들어올 때에',
        3: '너희가 화려한 옷을 입은 자에게 관심을 기울이며 그에게 이르되, 여기 좋은 자리에 앉으소서, 하고 또 그 가난한 자에게 이르되, 거기 서 있든지 여기 내 발받침 밑에 앉으라, 하면',
        4: '너희가 너희끼리 차별하며 악한 생각으로 판단하는 자가 되지 아니하느냐?',
        5: '내 사랑하는 형제들아, 귀를 기울이라. 하나님께서 이 세상의 가난한 자들을 택하사 믿음에 부요하게 하시고 또 자신을 사랑하는 자들에게 약속하신 왕국의 상속자들로 삼지 아니하셨느냐?',
        ...
        10: '누구든지 온 율법을 지키다가 한 조목이라도 어기면 모든 것에서 유죄가 되나니',
        11: '간음하지 말라, 하신 분께서 또한, 살인하지 말라, 하셨은즉 이제 네가 비록 간음하지 아니하여도 살인하면 율법을 범한 자가 되느니라.',
        12: '너희는 자유의 법에 의해 심판 받을 자들처럼 말하고 행하라.',
        13: '긍휼을 베풀지 않은 자는 긍휼 없는 심판을 받으리라. 긍휼은 심판을 이기고 기뻐하느니라.',
        14: '내 형제들아, 사람이 자기가 믿음이 있다고 말하면서 행위가 없으면 그것이 무슨 유익을 주느냐? 믿음이 그를 구원할 수 있겠느냐?',
        15: '만일 형제나 자매가 헐벗고 일용할 양식이 없는데',
        16: '너희 중에 누가 그들에게 이르되, 평안히 떠나가라. 너희는 따뜻하게 하고 배부르게 하라, 하고는 몸에 필요한 그것들을 너희가 그들에게 주지 아니하면 그것이 무슨 유익을 주느냐?',
        17: '이와 같이 믿음도 행위가 없으면 그것만으로는 죽은 것이니라.',
        18: '참으로 어떤 사람은 이르되, 너는 믿음이 있고 나는 행위가 있으니 네 행위가 없는 네 믿음을 내게 보이라. 나는 내 행위로 내 믿음을 네게 보이리라, 하느니라.',
        19: '네가 한 하나님이 계시는 줄 믿으니 잘하는도다. 마귀들도 믿고 떠느니라.',
        20: '그러나, 오 허무한 사람아, 행위 없는 믿음이 죽은 것인 줄 네가 알고자 하느냐?',
        21: '우리 조상 아브라함이 자기 아들 이삭을 제단 위에 드릴 때에 행위로 의롭게 되지 아니하였느냐?',
        22: '네가 보거니와 믿음이 그의 행위와 함께 일하고 행위로 믿음이 완전하게 되지 아니하였느냐?',
        23: '이에, 아브라함이 하나님을 믿으니 그것을 그에게 의로 인정하셨느니라, 하시는 성경 기록이 성취되었고 그는 하나님의 친구라 불렸느니라.',
        24: '그런즉 너희가 보거니와 사람이 행위로 의롭게 되고 단지 믿음만으로 되지 아니하느니라.',
        25: '또한 이와 같이 창녀 라합이 사자들을 받아들이고 그들을 다른 길로 보냈을 때에 행위로 의롭게 되지 아니하였느냐?',
        26: '영이 없는 몸이 죽은 것 같이 행위 없는 믿음도 죽었느니라.',
    },
    3: {
        1: '내 형제들아, 너희는 많이 선생이 되지 말라. 우리가 더 큰 정죄를 받을 줄 너희가 아느니라.',
        ...
        6: '혀는 불이요 불법의 세계니라. 혀는 우리의 지체들 가운데서 그와 같아서 온 몸을 더럽히고 본성의 행로에 불을 붙이며 지옥 불 위에 놓여 있느니라.',
        7: '모든 종류의 짐승과 새와 뱀과 바다에 있는 것들은 길들여졌고 또 사람이 길들여 왔으나',
        8: '혀는 아무도 능히 길들이지 못하나니 그것은 다스릴 수 없는 악이요 죽이는 독으로 가득한 것이니라.',
        9: '그것으로 우리가 하나님 곧 아버지를 찬송하며 또 그것으로 우리가 하나님의 모양대로 만들어진 사람들을 저주하느니라.',
        ...
        13: '너희 가운데 지식을 갖추고 지혜로운 자가 누구냐? 그는 지혜의 온유함으로 선한 생활에서 나오는 자신의 행위를 보일지니라.',
    ...
    4: {
        ...
        7: '그러므로 하나님께 복종하라. 마귀를 대적하라. 그리하면 그가 너희에게서 도망하리라.',
        ...
        16: '이제 너희가 스스로 자랑하는 것을 기뻐하나니 그러한 기쁨은 다 악한 것이니라.',
        17: '그러므로 선을 행할 줄 알고도 행하지 아니하는 자에게는 곧 그에게는 그것이 죄가 되느니라.',
    },
    5: {
        1: '자, 이제, 너희 부자들아, 너희에게 임할 너희의 비참한 일들로 인하여 슬피 울며 울부짖으라.',
        2: '너희의 재물은 썩었고 너희의 옷은 좀먹었으며',
        3: '너희의 금과 은은 부식되었으니 그것들의 녹이 너희를 대적하는 증인이 되고 불같이 너희 살을 먹으리라. 너희가 마지막 날들을 위해 재물을 함께 모아 쌓았도다.',
        4: '보라, 너희 밭에서 곡식을 거둔 품꾼들의 품삯 곧 너희가 사기 쳐서 숨겨 둔 품삯이 소리를 지르며 곡식을 거둔 자들의 울부짖음이 만군의 주의 귀에 들어갔느니라.',
        5: '너희가 땅에서 쾌락 가운데 살며 방탕함에 빠져 살육하는 날에서와 같이 너희 마음을 살찌게 하였도다.',
        6: '너희가 의인을 정죄하고 죽였으나 그는 너희에게 대항하지 아니하느니라.',
        7: '그러므로 형제들아, 주께서 오실 때까지 인내하라. 보라, 농부가 땅에서 나는 귀한 열매를 바라고 이른 비와 늦은 비를 받을 때까지 오랫동안 그것을 위해 인내하느니라.',
        8: '너희도 인내하고 너희 마음을 굳건히 하라. 주의 오심이 가까이 다가오고 있느니라.',
        9: '형제들아, 서로 불평하지 말라. 그리하여야 너희가 정죄를 받지 아니하리라. 보라, 심판자께서 문 앞에 서 계시느니라.',
        10: '내 형제들아, 주의 이름으로 말한 대언자들을 고난당하는 것과 인내의 본으로 삼으라.',
        11: '보라, 참는 자들을 우리가 행복한 자로 여기나니 너희가 욥의 인내를 들었고 주께서 주신 결말을 보았거니와 주께서는 지극히 동정심이 많으시며 친절한 긍휼을 베푸는 분이시니라.',
        12: '그러나 내 형제들아, 무엇보다도 먼저 맹세하지 말지니 하늘로나 땅으로나 다른 어떤 맹세로도 맹세하지 말고 오직 너희의 예는 예라 하고 너희의 아니요는 아니요라 하라. 이것은 너희가 정죄에 빠지지 아니하게 하려 함이니라.',
        13: '너희 가운데 고난을 당하는 자가 있느냐? 그는 기도할 것이요, 즐거워하는 자가 있느냐? 그는 시를 노래할지어다.',
        14: '너희 가운데 병든 자가 있느냐? 그는 교회의 장로들을 부를 것이요, 그들은 주의 이름으로 그에게 기름을 바르며 그를 위해 기도할지니라.',
        ...
        20: '그 죄인을 그의 길의 잘못에서 돌아서게 하는 자가 한 혼을 사망에서 구원하며 허다한 죄를 덮을 것임을 그가 알게 할지니라.',
    },
}
