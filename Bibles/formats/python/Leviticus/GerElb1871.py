...
CHAPTERS = {
    ...
    3: {
        1: 'Und wenn seine Opfergabe ein Friedensopfer ist: wenn er sie von den Rindern darbringt, es sei ein Männliches oder ein Weibliches, so soll er sie ohne Fehl vor Jehova darbringen.',
    ...
    5: {
        1: 'Und wenn jemand sündigt, daß er die Stimme des Fluches hört, und er war Zeuge, sei es daß er es gesehen oder gewußt hat, -wenn er es nicht anzeigt, so soll er seine Ungerechtigkeit tragen;',
        2: 'oder wenn jemand irgend etwas Unreines anrührt, sei es das Aas eines unreinen wilden Tieres, oder das Aas eines unreinen Viehes, oder das Aas eines unreinen kriechenden Tieres -ist es ihm auch verborgen, so ist er unrein und schuldig;',
    ...
    6: {
        ...
        3: 'Und der Priester soll sein leinenes Kleid anziehen, und soll seine leinenen Beinkleider anziehen über sein Fleisch; und er soll die Fettasche abheben, wozu das Feuer das Brandopfer auf dem Altar verzehrt hat, und soll sie neben den Altar schütten.',
        ...
        5: 'Und das Feuer auf dem Altar soll auf demselben in Brand erhalten werden, es soll nicht erlöschen; und der Priester soll Holz auf ihm anzünden, Morgen für Morgen, und das Brandopfer auf ihm zurichten, und die Fettstücke der Friedensopfer auf ihm räuchern.',
        ...
        8: 'Und er soll davon seine Hand voll nehmen, vom Feinmehl des Speisopfers und von dessen Öl, und allen Weihrauch, der auf dem Speisopfer ist, und es auf dem Altar räuchern: es ist ein lieblicher Geruch, sein Gedächtnisteil für Jehova.',
        ...
        16: 'Und jedes Speisopfer des Priesters soll ein Ganzopfer sein; es soll nicht gegessen werden.',
        17: 'Und Jehova redete zu Mose und sprach:',
        18: 'Rede zu Aaron und zu seinen Söhnen und sprich: Dies ist das Gesetz des Sündopfers. An dem Orte, wo das Brandopfer geschlachtet wird, soll das Sündopfer geschlachtet werden vor Jehova: hochheilig ist es.',
    ...
    7: {
        ...
        15: 'Und das Fleisch seines Dank-Friedensopfers soll am Tage seiner Darbringung gegessen werden; er soll nichts davon liegen lassen bis an den Morgen.',
        ...
        34: 'Denn die Brust des Webopfers und den Schenkel des Hebopfers habe ich von den Kindern Israel genommen, von ihren Friedensopfern, und habe sie Aaron, dem Priester, und seinen Söhnen gegeben als eine ewige Gebühr von seiten der Kinder Israel. -',
    ...
    9: {
        ...
        17: 'Und er brachte das Speisopfer herzu und füllte seine Hand davon und räucherte es auf dem Altar, außer dem Morgen-Brandopfer.',
    ...
    10: {
        1: 'Und die Söhne Aarons, Nadab und Abihu, nahmen ein jeder seine Rauchpfanne und taten Feuer hinein und legten Rauchwerk darauf und brachten fremdes Feuer vor Jehova dar, das er ihnen nicht geboten hatte.',
    ...
    11: {
        ...
        36: 'Doch Quelle und Cisterne, Wasserbehälter, werden rein sein; wer aber das Aas darin anrührt, wird unrein sein.',
    ...
    15: {
        ...
        24: 'Und wenn etwa ein Mann neben ihr liegt, und ihre Unreinigkeit kommt an ihn, so wird er sieben Tage unrein sein; und jedes Lager, worauf er liegt, wird unrein sein.',
        25: 'Und wenn ein Weib ihren Blutfluß viele Tage hat außer der Zeit ihrer Unreinheit, oder wenn sie den Fluß hat über ihre Unreinheit hinaus, so soll sie alle die Tage des Flusses ihrer Unreinigkeit sein wie in den Tagen ihrer Unreinheit: sie ist unrein.',
        26: 'Jedes Lager, worauf sie alle Tage ihres Flusses liegt, soll ihr sein wie das Lager ihrer Unreinheit, und jedes Gerät, worauf sie sitzt, wird unrein sein nach der Unreinigkeit ihrer Unreinheit.',
        27: 'Und jeder, der es anrührt, wird unrein sein; und er soll seine Kleider waschen und sich im Wasser baden, und er wird unrein sein bis an den Abend.',
        28: 'Und wenn sie rein geworden ist von ihrem Flusse, so soll sie sich sieben Tage zählen, und danach wird sie rein sein.',
        29: 'Und am achten Tage soll sie sich zwei Turteltauben oder zwei junge Tauben nehmen und sie zu dem Priester bringen an den Eingang des Zeltes der Zusammenkunft;',
        30: 'und der Priester soll die eine als Sündopfer und die andere als Brandopfer opfern. Und so tue der Priester Sühnung für sie vor Jehova wegen des Flusses ihrer Unreinigkeit.',
        31: 'Und ihr sollt die Kinder Israel absondern von ihrer Unreinigkeit, daß sie nicht in ihrer Unreinigkeit sterben, indem sie meine Wohnung verunreinigen, die in ihrer Mitte ist.',
        32: 'Das ist das Gesetz für den Flüssigen und für den, dem der Samenerguß entgeht, so daß er durch ihn unrein wird;',
        33: 'und für die, welche krank ist in ihrer Unreinheit, und für den, der seinen Fluß hat, es sei Mann oder Weib, und für den Mann, der neben einer Unreinen liegt.',
    },
    16: {
    ...
    17: {
        1: 'Und Jehova redete zu Mose und sprach:',
        2: 'Rede zu Aaron und zu seinen Söhnen und zu allen Kindern Israel und sprich zu ihnen: Dies ist es, was Jehova geboten und gesagt hat:',
        3: 'Jedermann aus dem Hause Israel, der ein Rind oder ein Schaf oder eine Ziege im Lager schlachtet, oder der außerhalb des Lagers schlachtet,',
        4: 'und es nicht an den Eingang des Zeltes der Zusammenkunft gebracht hat, um es Jehova als Opfergabe darzubringen vor der Wohnung Jehovas, selbigem Manne soll Blut zugerechnet werden: Blut hat er vergossen, und selbiger Mann soll ausgerottet werden aus der Mitte seines Volkes;',
        5: 'auf daß die Kinder Israel ihre Schlachtopfer bringen, die sie auf freiem Felde schlachten, daß sie sie Jehova bringen an den Eingang des Zeltes der Zusammenkunft zu dem Priester und sie als Friedensopfer dem Jehova schlachten.',
        6: 'Und der Priester soll das Blut an den Altar Jehovas sprengen vor dem Eingang des Zeltes der Zusammenkunft und das Fett räuchern zum lieblichen Geruch dem Jehova.',
        7: 'Und sie sollen nicht mehr ihre Schlachtopfer den Dämonen schlachten, denen sie nachhuren. Das soll ihnen eine ewige Satzung sein bei ihren Geschlechtern.',
    ...
    20: {
        1: 'Und Jehova redete zu Mose und sprach:',
        2: 'Und zu den Kindern Israel sollst du sprechen: Jedermann von den Kindern Israel und von den Fremdlingen, die in Israel weilen, der von seinen Kindern dem Molech gibt, soll gewißlich getötet werden; das Volk des Landes soll ihn steinigen.',
        3: 'Und ich werde mein Angesicht wider selbigen Mann richten und ihn ausrotten aus der Mitte seines Volkes, weil er von seinen Kindern dem Molech gegeben hat, mein Heiligtum zu verunreinigen und meinen heiligen Namen zu entweihen.',
        4: 'Und wenn das Volk des Landes seine Augen irgend verhüllt vor selbigem Manne, wenn er von seinen Kindern dem Molech gibt, so daß es ihn nicht tötet,',
        5: 'so werde ich mein Angesicht wider selbigen Mann richten und wider sein Geschlecht und werde ihn und alle, die ihm nachhuren, um dem Molech nachzuhuren, ausrotten aus der Mitte ihres Volkes.',
        ...
        8: 'und beobachtet meine Satzungen und tut sie. Ich bin Jehova, der euch heiligt.',
        ...
        19: 'Und die Blöße der Schwester deiner Mutter und der Schwester deines Vaters sollst du nicht aufdecken; denn wer das tut, hat seine Blutsverwandte entblößt: sie sollen ihre Ungerechtigkeit tragen.',
        20: 'Und wenn ein Mann bei dem Weibe seines Oheims liegt, so hat er die Blöße seines Oheims aufgedeckt; sie sollen ihre Sünde tragen, kinderlos sollen sie sterben.',
        21: 'Und wenn ein Mann das Weib seines Bruders nimmt: das ist eine Unreinigkeit; er hat die Blöße seines Bruders aufgedeckt, sie sollen kinderlos sein.',
    ...
    21: {
        1: 'Und Jehova sprach zu Mose: Rede zu den Priestern, den Söhnen Aarons, und spricht zu ihnen: Keiner von ihnen soll sich wegen einer Leiche verunreinigen unter seinen Völkern:',
        2: 'außer wegen seines Blutsverwandten, der ihm nahe steht: wegen seiner Mutter und wegen seines Vaters und wegen seines Sohnes und wegen seiner Tochter und wegen seines Bruders;',
        3: 'und wegen seiner Schwester, der Jungfrau, die ihm nahe steht, die noch keines Mannes geworden ist: wegen dieser darf er sich verunreinigen.',
        4: 'Er soll sich nicht verunreinigen als Herr unter seinen Völkern, sich zu entweihen.',
        5: 'Sie sollen keine Glatze auf ihrem Haupte machen, und den Rand ihres Bartes sollen sie nicht abscheren, und an ihrem Fleische sollen sie keine Einschnitte machen.',
        6: 'Sie sollen ihrem Gott heilig sein, und den Namen ihres Gottes sollen sie nicht entweihen, denn die Feueropfer Jehovas, das Brot ihres Gottes, bringen sie dar; und sie sollen heilig sein.',
        7: 'Eine Hure und eine Entehrte sollen sie nicht zum Weibe nehmen, und ein von ihrem Manne verstoßenes Weib sollen sie nicht nehmen; denn heilig ist er seinem Gott.',
        8: 'Und du sollst ihn für heilig achten, denn das Brot deines Gottes bringt er dar; er soll dir heilig sein; denn heilig bin ich Jehova, der euch heiligt.',
        ...
        10: 'Und der Hohepriester unter seinen Brüdern, auf dessen Haupt das Salböl gegossen worden, und der geweiht ist, um die heiligen Kleider anzulegen, soll sein Haupt nicht entblößen und soll seine Kleider nicht zerreißen.',
        11: 'Und er soll zu keiner Leiche kommen; wegen seines Vaters und wegen seiner Mutter soll er sich nicht verunreinigen.',
        12: 'Und aus dem Heiligtum soll er nicht hinausgehen und nicht entweihen das Heiligtum seines Gottes; denn die Weihe des Salböls seines Gottes ist auf ihm. Ich bin Jehova.',
        13: 'Und derselbe soll ein Weib in ihrer Jungfrauschaft nehmen.',
        14: 'Eine Witwe und eine Verstoßene und eine Entehrte, eine Hure, diese soll er nicht nehmen; sondern eine Jungfrau aus seinen Völkern soll er zum Weibe nehmen.',
        15: 'Und er soll seinen Samen nicht entweihen unter seinen Völkern; denn ich bin Jehova, der ihn heiligt.',
        16: 'Und Jehova redete zu Mose und sprach:',
        17: 'Rede zu Aaron und sprich: Jemand von deinem Samen bei ihren Geschlechtern, an dem ein Gebrechen ist, soll nicht herzunahen, um das Brot seines Gottes darzubringen;',
        18: 'denn jedermann, an dem ein Gebrechen ist, soll nicht herzunahen, es sei ein blinder Mann oder ein lahmer oder ein stumpfnasiger, oder der ein Glied zu lang hat,',
        19: 'oder ein Mann, der einen Bruch am Fuße oder einen Bruch an der Hand hat,',
        20: 'oder ein Höckeriger oder ein Zwerg, oder der einen Flecken an seinem Auge hat, oder der die Krätze oder Flechte, oder der zerdrückte Hoden hat.',
        21: 'Jedermann vom Samen Aarons, des Priesters, der ein Gebrechen hat, soll nicht herzutreten, die Feueropfer Jehovas darzubringen; ein Gebrechen ist an ihm, er soll nicht herzutreten, das Brot seines Gottes darzubringen.',
        22: 'Das Brot seines Gottes von dem Hochheiligen und von dem Heiligen mag er essen;',
        23: 'allein zum Vorhang soll er nicht kommen, und zum Altar soll er nicht nahen, denn ein Gebrechen ist an ihm, daß er nicht meine Heiligtümer entweihe; denn ich bin Jehova, der sie heiligt.',
    ...
    22: {
        ...
        15: 'Und man soll die heiligen Dinge der Kinder Israel nicht entweihen, die sie dem Jehova heben,',
    ...
    23: {
        ...
        18: 'Und ihr sollt zu dem Brote darbringen sieben einjährige Lämmer ohne Fehl, und einen jungen Farren und zwei Widder und ihr Speisopfer und ihre Trankopfer: ein Feueropfer lieblichen Geruchs dem Jehova.',
    ...
    26: {
        ...
        23: 'Und wenn ihr euch durch dieses nicht von mir zurechtweisen lasset und mir entgegen wandelt,',
        ...
        40: 'Und sie werden ihre Ungerechtigkeit bekennen und die Ungerechtigkeit ihrer Väter durch ihre Treulosigkeit, die sie gegen mich begangen haben, und auch daß, weil sie mir entgegen gewandelt sind,',
    ...
    27: {
        ...
        34: 'Das sind die Gebote, welche Jehova dem Mose auf dem Berge Sinai an die Kinder Israel aufgetragen hat.',
    },
}
