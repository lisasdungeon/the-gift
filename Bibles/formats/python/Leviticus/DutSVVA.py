...
CHAPTERS = {
    1: {
        ...
        3: 'Indiën zijn offerande een brandoffer van runderen is, zo zal hij een volkomen mannetje offeren; aan de deur van de tent der samenkomst zal hij dat offeren, naar zijn welgevallen, voor het aangezicht des Heeren.',
    ...
    2: {
        ...
        2: 'En hij zal het brengen tot de zonen van Aäron, de priesters, een van welke daarvan zijn hand vol grijpen zal uit deszelfs meelbloem, en uit deszelfs olie, met al deszelfs wierook; en de priester zal deszelfs gedenkoffer aansteken op het altaar; het is een vuuroffer, tot een liefelijken reuk den Heere.',
    ...
    3: {
        ...
        7: 'Indiën hij een lam tot zijn offerande offert, zo zal hij het offeren voor het aangezicht des Heeren.',
        ...
        12: 'Indiën nu zijn offerande een geit is, zo zal hij die offeren voor het aangezicht des Heeren.',
    ...
    4: {
        ...
        3: 'Indiën de priester, die gezalfd is, zal gezondigd hebben, tot schuld des volks, zo zal hij voor zijn zonde, die hij gezondigd heeft, offeren een var, een volkomen jong rund, den Heere ten zondoffer.',
        ...
        13: 'Indiën nu de gehele vergadering van Israël afgedwaald zal zijn, en de zaak voor de ogen der gemeente verborgen is, en zij iets gedaan zullen hebben tegen enige van alle geboden des Heeren, dat niet zoude gedaan worden, en zijn schuldig geworden;',
    ...
    6: {
        ...
        9: 'Gebied Aäron en zijn zonen, zeggende: Dit is de wet des brandoffers; het is hetgeen, wat door de branding op het altaar den gansen nacht tot aan den morgen opvaart; alwaar het vuur des altaars zal brandende gehouden worden.',
        ...
        16: 'En het overblijvende daarvan zullen Aäron en zijn zonen eten; ongezuurd zal het gegeten worden in de heilige plaats; in den voorhof van de tent der samenkomst zullen zij dat eten.',
    ...
    7: {
        ...
        12: 'Indiën hij dat tot een lof offer offert, zo zal hij, nevens het lofoffer, ongezuurde koeken met olie gemengd, en ongezuurde vladen met olie bestreken, offeren; en zullen die koeken met olie gemengd van geroost meelbloem zijn.',
    ...
    8: {
        ...
        7: 'Daar deed hij hem den rok aan, en gordde hem met den gordel, en trok hem den mantel aan; en deed hij hem den efod aan, en gordde dien met den kunstelijken riem des efods, en ombond hem daarmede.',
        ...
        14: 'Toen deed hij den var des zondoffers bijeenkomen; en Aäron en zijn zonen leiden hun handen op het hoofd van den var des zondoffers;',
        ...
        18: 'Daarna deed hij den ram des brandoffers bijbrengen; en Aäron en zijn zonen leiden hun handen op het hoofd van den ram.',
        ...
        22: 'Daarna deed hij den anderen ram, den ram des vuloffers, bijbrengen; en Aäron met zijn zonen leiden hun handen op het hoofd van den ram.',
        ...
        26: 'Ook nam hij uit den korf van de ongezuurde broden, die voor het aangezicht des Heeren was, een ongezuurde koek, en een geolieden broodkoek, en een vlade; en hij leide ze op dat vet, en op den rechterschouder.',
        ...
        31: 'En Mozes zeide tot Aäron en tot zijn zonen: Ziedt dat vlees voor de deur van de tent der samenkomst, en eet hetzelve daar, mitsgaders het brood, dat in den korf des vuloffers is; gelijk als ik geboden heb, zeggende: Aäron en zijn zonen zullen dat eten.',
    ...
    9: {
        1: 'En het geschiedde op den achtsten dag, dat Mozes riep Aäron en zijn zonen, en de oudsten van Israël;',
    ...
    10: {
        ...
        4: 'En Mozes riep Misael en Elzafan, de zonen van Uzziël, den oom van Aäron, en zeide tot hen: Treedt toe, draagt uw broederen weg, van voor het heiligdom tot buiten het leger.',
        ...
        14: 'Ook de beweegborst en den hefschouder zult gij in een reine plaats eten, gij, en uw zonen, en uw dochteren met u; want tot uw bescheiden deel, en uwer zonen bescheiden deel, zijn zij uit de dankofferen der kinderen Israëls gegeven.',
        ...
        16: 'En Mozes zocht zeer naarstiglijk den bok des zondoffers; en ziet, hij was verbrand. Dies was hij op Eleazar en op Ithamar, de overgebleven zonen van Aäron, zeer toornig, zeggende:',
    ...
    13: {
        ...
        8: 'Indiën de priester merken zal, dat, ziet, de verzwering in het vel uitgespreid is, zo zal de priester hem onrein verklaren; het is melaatsheid.',
        9: 'Wanneer de plaag der melaatsheid in een mens zal zijn, zo zal hij tot den priester gebracht worden.',
        10: 'Indiën de priester merken zal, dat, ziet, een wit gezwel in het vel is, hetwelk het haar in wit veranderd heeft, en gezondheid van levend vlees in dat gezwel is;',
        ...
        20: 'Indiën de priester merken zal, dat, ziet, haar aanzien lager is dan het vel, en derzelver haar in wit veranderd is, zo zal de priester hem onrein verklaren; het is de plaag der melaatsheid, zij is door de zweer uitgebot.',
        ...
        56: 'Indiën nu de priester merken zal, dat, ziet, die plaag, nadat zij zal gewassen zijn, ingetrokken is; dan zal hij ze van het kleed, of van het vel, of van den scheerdraad, of van den inslag afscheuren.',
    ...
    14: {
        ...
        34: 'Als gij zult gekomen zijn in het land van Kanaän, hetwelk Ik u tot bezitting geven zal, en Ik de plaag der melaatsheid aan een huis van dat land uwer bezitting zal gegeven hebben;',
    ...
    17: {
        ...
        5: 'Opdat, wanneer de kinderen Israëls hun slachtofferen brengen, welke zij op het veld slachten, dat zij die den Heere toebrengen, aan de deur van de tent der samenkomst tot den priester, en dezelve tot dankofferen den Heere slachten.',
    ...
    21: {
        ...
        21: 'Geen man, uit het zaad van Aäron, den priester, in wien een gebrek is, zal toetreden om de vuurofferen des Heeren te offeren; een gebrek is in hem, hij zal niet toetreden, om de spijs zijns Gods te offeren.',
    ...
    22: {
        ...
        3: 'Zeg tot hen: Alle man onder uw geslachten, die uit uw ganse zaad tot de heilige dingen, die de kinderen Israëls den Heere heiligen, naderen zal, als zijn onreinigheid op hem is; diezelve mens zal van voor Mijn aangezicht uitgeroeid worden; Ik ben de Heere!',
        ...
        15: 'Zo zullen zij niet ontheiligen de heilige dingen der kinderen Israëls, die zij den Heere zullen gegeven hebben;',
    ...
    25: {
        ...
        51: 'Indiën nog vele van die jaren zijn, naar die zal hij tot zijn lossing van het geld, waarover hij gekocht is, wedergeven.',
    ...
    26: {
        ...
        3: 'Indiën gij in Mijn inzettingen wandelen, en Mijn geboden houden, en die doen zult;',
        ...
        23: 'Indiën gij nog door deze dingen Mij niet getuchtigd zult zijn, maar met Mij in tegenheid wandelen;',
    ...
    27: {
        ...
        16: 'Indiën ook iemand van den akker zijner bezitting den Heere wat geheiligd zal hebben, zo zal uw schatting zijn naar zijn zaad; een homer gerstezaad zal zijn op vijftig sikkelen zilvers.',
        17: 'Indiën hij zijn akker van het jubeljaar af geheiligd zal hebben, zo zal het naar uw schatting stand hebben.',
        ...
        34: 'Dit zijn de geboden, die de Heere Mozes geboden heeft, aan de kinderen Israëls, op den berg Sinaï.',
    },
}
