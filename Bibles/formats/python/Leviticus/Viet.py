...
CHAPTERS = {
    ...
    4: {
        ...
        24: 'nhận tay mình trên đầu dê đực đó, rồi giết nó trước mặt Ðức Giê-hô-va tại nơi giết các con sinh dùng làm của lễ thiêu: ấy là của lễ chuộc tội.',
    ...
    5: {
        ...
        6: 'rồi vì tội mình đã phạm, dẫn đến Ðức Giê-hô-va một con cái trong bầy súc vật nhỏ, hoặc chiên cái hay là dê cái, đặng làm của lễ chuộc tội; thì thầy tế lễ sẽ làm lễ chuộc tội cho người.',
    ...
    9: {
        ...
        2: 'rồi dạy A-rôn rằng: Hãy bắt một con bò con đực đặng làm của lễ chuộc tội, một con chiên đực làm của lễ thiêu, đều không tì vít chi, và dâng lên trước mặt Ðức Giê-hô-va.',
        3: 'Ngươi hãy nói cùng dân Y-sơ-ra-ên rằng: Các ngươi hãy bắt một con dê đực làm của lễ chuộc tội, một con bò con và một con chiên con không tì vít chi, một tuổi, đặng dùng làm của lễ thiêu,',
        ...
        8: 'A-rôn bèn lại gần bàn thờ, giết bò con đực dùng làm của lễ chuộc tội.',
        ...
        11: 'Còn thịt và da, người đem ra thiêu ngoài trại quân.',
    ...
    16: {
        ...
        16: 'Người vì cớ sự ô uế, sự vi phạm và tội lỗi của dân Y-sơ-ra-ên phải làm lễ chuộc tội cho nơi thánh và cho hội mạc ở giữa sự ô uế của họ.',
        ...
        19: 'Rồi dùng ngón tay rảy huyết bảy lần trên bàn thờ, làm cho bàn thờ nên sạch và thánh, vì cớ những sự ô uế của dân Y-sơ-ra-ên.',
        ...
        24: 'Rồi lấy nước tắm mình trong một nơi thánh, mặc áo lại, đi ra, dâng của lễ thiêu về phần mình, và của lễ thiêu về phần dân chúng, đặng làm lễ chuộc tội cho mình và cho dân chúng.',
    ...
    20: {
        ...
        3: 'Còn ta sẽ nổi giận cùng người đó, truất nó khỏi dân sự mình, vì nó đã nộp con cái mình cho thần Mo-lóc, làm cho nơi thánh ta ô uế, và làm ô danh thánh ta.',
        4: 'Nếu dân bổn xứ nhắm mắt khi người đó dâng một trong các con cái nó cho thần Mo-lóc mà chẳng giết nó đi,',
        5: 'thì ta đây sẽ nổi giận cùng người đó và nhà nó, rồi truất nó cùng những kẻ nào theo nó mà thông dâm cùng thần Mo-lóc, ra khỏi dân sự mình.',
        ...
        7: 'Các ngươi hãy làm sạch mình, và hãy nên thánh, vì ta là Giê-hô-va, Ðức Chúa Trời của các ngươi.',
        8: 'Các ngươi hãy giữ làm theo những luật pháp ta: Ta là Ðức Giê-hô-va, Ðấng làm cho các ngươi nên thánh.',
        ...
        11: 'Nếu người nào nằm cùng vợ cha mình, ấy là gây nhục cho cha mình, thì hai người đều hẳn phải bị xử tử; huyết họ sẽ đổ lại trên mình họ.',
        ...
        15: 'Nếu một người nam cấu hiệp cùng thú vật, thì hẳn phải bị xử tử, và các ngươi hãy giết thú đó đi.',
        ...
        17: 'Nếu một người nam lấy chị em gái mình, hoặc một cha khác mẹ, hoặc một mẹ khác cha, và họ cấu hiệp nhau; ấy là sự điếm nhục; họ sẽ bị truất khỏi trước mặt dân sự mình; người đã gây nhục cho chị em mình; người sẽ mang tội ác mình.',
        18: 'Nếu một người nam nằm cùng một người nữ trong lúc có kinh nguyệt, và người nam lộ ra nguyên huyết của người nữ, và chánh người nữ cũng lộ ra nguyên huyết mình, thì cả hai đều sẽ bị truất khỏi dân sự mình.',
        ...
        22: 'Các ngươi hãy gìn giữ làm theo những luật pháp và mạng lịnh ta, hầu cho xứ mà ta dẫn các ngươi đến ở không mửa các ngươi ra.',
        23: 'Chớ nên noi theo thói tục của dân mà ta sẽ đuổi ra khỏi trước mặt các ngươi, vì họ đã làm những điều đó, và ta lấy làm gớm ghiếc lắm.',
        24: 'Ta đã phán cùng các ngươi rằng: Ấy là các ngươi sẽ được xứ của dân đó; ta cho các ngươi xứ ấy đặng làm sản nghiệp; ấy là một xứ đượm sữa và mật: Ta là Giê-hô-va, Ðức Chúa Trời của các ngươi, đã phân rẽ các ngươi cùng các dân.',
        25: 'Vậy, hãy phân biệt thú tinh sạch với thú ô uế, chim ô uế với chim tinh sạch; chớ gây cho mình ra gớm ghiếc vì loài vật, vì chim chóc, vì các loài côn trùng trên mặt đất, mà ta đã dạy các ngươi phân biệt như loài ô uế.',
        26: 'Ðối cùng ta các ngươi hãy nên thánh, vì ta, Ðức Giê-hô-va, là thánh; ta đã phân rẽ các ngươi với các dân, để các ngươi thuộc về ta.',
    ...
    22: {
        ...
        8: 'Người chẳng nên ăn một con thú nào chết tự nhiên hay là bị xé, hầu khỏi bị ô uế: Ta là Ðức Giê-hô-va.',
    ...
    23: {
        ...
        17: 'Các ngươi hãy từ nhà mình đem đến hai ổ bánh đặng làm của lễ dâng đưa qua đưa lại; bánh đó làm bằng hai phần mười bột lọc hấp có pha men: ấy là của đầu mùa dâng cho Ðức Giê-hô-va.',
    ...
    26: {
        ...
        2: 'Hãy giữ lễ sa-bát ta, và tôn kính nơi thánh ta. Ta là Ðức Giê-hô-va.',
        ...
        13: 'Ta là Giê-hô-va, Ðức Chúa Trời của các ngươi, Ðấng đã đem các ngươi ra khỏi xứ Ê-díp-tô, hầu cho khỏi làm tôi mọi. Ta đã bẻ gãy cái ách của các ngươi, làm cho các ngươi đi ngước đầu lên.',
        ...
        27: 'Dầu đến nỗi vậy, mà các ngươi cứ không khứng nghe ta, còn phản đối cùng ta,',
        ...
        44: 'Dẫu vậy, đương khi họ bị ở trong xứ kẻ thù nghịch mình, ta cũng chẳng bỏ họ đâu, chẳng ghê gớm họ đến phải hao mòn hết, và chẳng bội sự giao ước ta lập cùng họ đâu, vì ta là Giê-hô-va, Ðức Chúa Trời của họ.',
        45: 'Ta vì họ sẽ nhớ lại sự giao ước đã lập cùng tổ phụ họ mà ta đã đem ra khỏi xứ Ê-díp-tô trước mặt các dân, đặng làm Ðức Chúa Trời của họ. Ta là Ðức Giê-hô-va.',
        46: 'Ðó là các điều lệ, mạng lịnh, và luật pháp mà Ðức Giê-hô-va nhờ Môi-se,',
    },
    27: {
        1: 'Ðức Giê-hô-va phán cùng Môi-se rằng:',
