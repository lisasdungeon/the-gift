...
CHAPTERS = {
    ...
    7: {
        ...
        35: 'C’est là [le droit de] l’onction d’Aaron et [de] l’onction de ses fils, dans les sacrifices de l’ Éternel faits par feu, du jour où on les aura fait approcher pour exercer la sacrificature devant l’ Éternel,',
        36: 'ce que l’ Éternel a commandé de leur donner, de la part des fils d’Israël, du jour où il les aura oints; [c’est] un statut perpétuel en leurs générations.',
    ...
    11: {
        ...
        30: 'et le lézard gémissant, et le coakh, et le letaa, et le khometh, et le caméléon.',
    ...
    12: {
        ...
        4: 'Et elle demeurera 33 jours dans le sang de sa purification; elle ne touchera aucune chose sainte, et ne viendra pas au sanctuaire, jusqu’à ce que les jours de sa purification soient accomplis.',
        5: 'Et si c’est une fille qu’elle enfante, elle sera impure deux semaines, comme dans sa séparation, et elle demeurera 66 jours dans le sang de sa purification.',
    ...
    26: {
        ...
        8: 'Et cinq d’entre vous en poursuivront 100, et 100 d’entre vous en poursuivront 10 000, et vos ennemis tomberont devant vous par l’épée.',
        ...
        13: 'Moi, je suis l’ Éternel, votre Dieu, qui vous ai fait sortir du pays d’Égypte, afin que vous ne soyez pas leurs esclaves: j’ai brisé les liens de votre joug, et je vous ai fait marcher la tête levée.',
    ...
    27: {
        ...
        3: 'Et ton estimation d’un mâle depuis l’âge de 20 ans jusqu’à l’âge de 60 ans, ton estimation sera de 50 sicles d’argent, selon le sicle du sanctuaire;',
        4: 'et si c’est une femme, ton estimation sera de 30 sicles.',
        5: 'Et si c’est un mâle depuis l’âge de cinq ans jusqu’à l’âge de 20 ans, ton estimation sera de 20 sicles, et pour une femme, de dix sicles;',
        ...
        7: 'Et si c’est un mâle de l’âge de 60 ans et au-dessus, ton estimation sera de 15 sicles, et pour une femme, de dix sicles.',
        ...
        16: 'Et si quelqu’un sanctifie à l’ Éternel une partie du champ de sa possession, ton estimation sera à raison de ce qu’on peut y semer: le khomer de semence d’orge à 50 sicles d’argent.',
