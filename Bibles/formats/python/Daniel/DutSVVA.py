...
CHAPTERS = {
    ...
    2: {
        ...
        9: 'Indiën gijlieden mij dien droom niet te kennen geeft, ulieder vonnis is enerlei; daarom hebt gij een leugenachtig en verdicht woord voor mij te zeggen bereid, totdat de tijd verandere; daarom zegt mij den droom, dan zal ik weten, dat gij mij deszelfs uitlegging zult te kennen geven.',
        ...
        17: 'Toen ging Daniël naar zijn huis, en hij gaf de zaak zijn metgezellen, Hananja, Misael, en Azarja te kennen;',
        ...
        24: 'Daarom ging Daniël in tot Arioch, dien de koning gesteld had om de wijzen van Babel om te brengen; hij ging henen en zeide aldus tot hem: Breng de wijzen van Babel niet om, maar breng mij in voor den koning, en ik zal den koning de uitlegging te kennen geven.',
        25: 'Toen bracht Arioch met haast Daniël voor den koning, en hij sprak alzo tot hem: Ik heb een man van de gevankelijk weggevoerden van Juda gevonden, die den koning de uitlegging zal bekend maken.',
        26: 'De koning antwoordde en zeide tot Daniël, wiens naam Beltsazar was: Zijt gij machtig mij bekend te maken den droom, dien ik gezien heb, en zijn uitlegging?',
        27: 'Daniël antwoordde voor den koning, en zeide: De verborgenheid, die de koning eist, kunnen de wijzen, de sterrekijkers, de tovenaars, en de waarzeggers den koning niet te kennen geven;',
        ...
        46: 'Toen viel de koning Nebukadnezar op zijn aangezicht, en aanbad Daniël; en hij zeide, dat men hem met spijsoffer en liefelijk reukwerk een drankoffer doen zou.',
    ...
    3: {
        ...
        7: 'Daarom te dier tijd, als al die volken hoorden het geluid des hoorns, der pijp, der citer, der vedel, der psalteren, en allerlei soorten der muziek, alle volken, natiën, en tongen nedervallende, aanbaden het gouden beeld, hetwelk de koning Nebukadnezar had opgericht.',
    ...
    5: {
        ...
        12: 'Omdat een voortreffelijke geest, en wetenschap, en verstand van een, die dromen uitlegt, en der aanwijzing van raadselen, en van een, die knopen ontbindt, gevonden werd in hem, in Daniël, dien de koning den naam van Beltsazar gaf; laat nu Daniël geroepen worden, die zal de uitlegging te kennen geven.',
        ...
        17: 'Toen antwoordde Daniël, en zeide voor den koning: Heb uw gaven voor uzelven, en geef uw vereringen aan een ander; ik zal nochtans het schrift voor den koning lezen, en de uitlegging zal ik hem bekend maken.',
        ...
        29: 'Toen beval Belsazar, en zij bekleedden Daniël met purper, met een gouden keten om zijn hals, en zij riepen overluid van hem, dat hij de derde heerser in dat koninkrijk was.',
