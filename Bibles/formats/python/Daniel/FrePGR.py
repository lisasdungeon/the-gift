...
CHAPTERS = {
    1: {
        1: "La troisième année du règne de Jéhojakim, roi de Juda, Nébucadnézar, roi de Babel, arriva devant Jérusalem, et l'assiégea.",
        2: 'Et le Seigneur mit entre ses mains Jéhojakim, roi de Juda, et une partie des meubles de la maison de Dieu; et il les amena au pays de Sinear, à la maison de son dieu; et il fit entrer les meubles dans le Trésor de son dieu.',
        3: "Et le roi ordonna à Aspenas, chef de ses eunuques, d'amener des enfants d'Israël et de race royale et de noble extraction,",
        4: "des jeunes garçons sans défaut et sans tache, beaux de figure, et versés dans toute la sagesse, et connaissant la science, et doués d'instruction, qui fussent propres à faire le service dans le palais du roi, et à apprendre la langue et les lettres des Chaldéens.",
        5: "Et le roi leur assigna un ordinaire quotidien sur les mets délicats du roi et sur le vin qu'il buvait, et fixa pour leur éducation trois années au bout desquelles ils entreraient au service de la personne du roi.",
        6: 'Et de ce nombre il y avait de la race de Juda Daniel, Hananias, Misaël et Azarias.',
        7: 'Et le chef des eunuques leur donna des noms, et donna à Daniel le nom de Beltsazar, et à Hananias celui de Sadrach, et à Misaël celui de Mésach, et à Azarias celui de Abednégo.',
        8: "Or, Daniel prit la résolution de ne pas contracter la souillure des mets délicats du roi ni du vin qu'il buvait, et il sollicita du chef des eunuques la permission de ne pas se souiller.",
        9: 'Et Dieu mit Daniel en faveur et en grâce auprès du chef des eunuques;',
        10: "et le chef des eunuques dit à Daniel: Je crains le roi, mon maître, qui lui-même a fixé ce que vous mangerez et boirez; car pourquoi vous verrait-il un visage plus défait qu'aux enfants de votre âge? Ainsi, vous exposeriez ma tête auprès du roi.",
        11: "Alors Daniel s'adressa au maître d'hôtel auquel le chef des eunuques avait commis Daniel, Hananias, Misaël et Azarias:",
        12: "Fais donc un essai de dix jours sur tes serviteurs, et qu'on nous donne des légumes pour nourriture, et de l'eau pour boisson.",
        13: "Puis tu examineras notre visage et le visage des enfants nourris des mets délicats du roi; et traite alors tes serviteurs d'après ce que tu auras vu.",
        14: 'Et il leur déféra en cela, et fit sur eux un essai de dix jours.',
        15: "Et au bout de dix jours on leur vit meilleur visage et plus d'embonpoint qu'à tous les enfants nourris des mets délicats du roi.",
        16: "Alors le maître d'hôtel supprima leurs mets délicats, et le vin qu'ils avaient pour boisson, et leur servit des légumes.",
        17: "Et à ces jeunes gens, aux quatre, Dieu accorda la connaissance et l'intelligence de toutes les lettres, et de toute la sagesse; et Daniel avait l'entente de toutes les visions et des songes.",
        18: "Et après l'expiration du temps fixé par le roi pour leur admission, le chef des eunuques les amena et les présenta à Nébucadnézar.",
        19: "Et le roi s'entretint avec eux, et entre eux tous aucun ne fut trouvé égal à Daniel, à Hananias, à Misaël et à Azarias; ils furent donc placés auprès de la personne du roi.",
        20: "Et sur tous les points de sagesse et d'intelligence sur lesquels le roi les interrogeait, il les trouvait dix fois supérieurs à tous les devins et enchanteurs qui étaient dans tout son empire.",
        21: "Ainsi fut Daniel jusqu'à la première année du roi Coresch.",
    },
    2: {
    ...
    3: {
        1: "Le roi Nébucadnézar fit une statue d'or, qui avait soixante coudées de hauteur, et six coudées d'épaisseur; il l'éleva dans la plaine de Doura, dans la province de Babel.",
        2: "Et le roi Nébucadnézar envoya l'ordre de convoquer les satrapes, les préfets et les gouverneurs, les grands-juges, les trésoriers, les légistes, les jurisconsultes, et tous les magistrats des provinces, afin qu'ils vinssent à l'inauguration de la statue qu'avait élevée le roi Nébucadnézar.",
        3: "Alors se rassemblèrent les satrapes, les préfets et les gouverneurs, les grands-juges, les trésoriers, les légistes, les jurisconsultes, et tous les magistrats des provinces, pour l'inauguration de la statue qu'avait élevée le roi Nébucadnézar, et ils se placèrent debout devant la statue qu'avait élevée Nébucadnézar.",
        4: 'Et le héraut cria avec force: Avis vous est donné, peuples, nations et hommes de toutes langues!',
        5: "Au moment où vous entendrez le son de la trompette, du chalumeau, de la lyre, de la sambuque, du psaltérion, de la cornemuse et de toutes les sortes d'instruments, vous aurez à vous prosterner et à adorer la statue d'or qu'a élevée le roi Nébucadnézar:",
        6: "et quiconque ne se prosternera pas et n'adorera pas, sera au même instant jeté dans la fournaise ardente qui est allumée.",
        7: "En conséquence, à l'instant où tous les peuples entendirent le son de la trompette, du chalumeau, de la lyre, de la sambuque, du psaltérion et de toutes les sortes d'instruments, tous les peuples, les nations et les hommes de toutes langues se prosternèrent devant la statue d'or qu'avait élevée le roi Nébucadnézar.",
        8: "Ensuite de cela, au moment même des hommes Chaldéens s'approchèrent, et accusèrent les Juifs,",
        9: 'en prenant la parole, et en disant au roi Nébucadnézar: O roi, puisses-tu vivre éternellement!',
        10: "O roi, tu as émis un décret portant que chacun, à l'ouïe du son de la trompette, du chalumeau, de la lyre, de la sambuque, du psaltérion et de la cornemuse, et de toutes les sortes d'instruments, eût à se prosterner et à adorer la statue d'or;",
        11: "et que quiconque ne se prosternerait pas et n'adorerait pas, serait jeté dans la fournaise ardente qui est allumée.",
        12: "Or, il y a des hommes Juifs que tu as préposés à l'administration de la province de Babel, Sadrach, Mésach et Abednégo, ces hommes ne tiennent aucun compte de toi, ô roi; ils ne rendent aucun culte à tes dieux, et ils n'adorent point la statue d'or que tu as élevée.",
        13: "Alors Nébucadnézar irrité et courroucé dit qu'on amenât Sadrach, Mésach et Abednégo. En conséquence, ces hommes furent amenés devant le roi.",
        14: "Nébucadnézar prit la parole et leur dit: Était-ce dessein prémédité, Sadrach, Mésach et Abednégo? Vous ne rendez pas un culte à mon dieu, et vous n'adorez pas la statue d'or que j'ai élevée?",
        15: "Maintenant donc, si au moment où vous entendrez le son de la trompette, du chalumeau, de la lyre, de la sambuque, du psaltérion, et de la cornemuse et de toutes les sortes d'instruments, vous vous prosternez et adorez la statue que j'ai faite, [c'est bien]; mais si vous n'adorez pas, vous serez au moment même jetés dans la fournaise ardente qui est allumée; et quel est le Dieu qui vous délivrera de ma main?",
        16: "Sadrach, Mésach et Abednégo répondirent et dirent au roi Nébucadnézar: Il n'est pas besoin que nous te répondions rien là-dessus.",
        17: 'Si notre Dieu que nous servons a le pouvoir de nous délivrer de la fournaise ardente qui est allumée, Il nous délivrera aussi de ta main, ô roi.',
        18: "Sinon, sache néanmoins, ô roi, que nous ne servons point tes dieux et que nous n'adorons point la statue d'or que tu as élevée.",
        19: "Alors Nébucadnézar fut rempli de colère, et tourna vers Sadrach, Mésach et Abednégo un visage altéré. Puis prenant la parole il commanda de chauffer la fournaise sept fois plus qu'on n'avait trouvé bon de la chauffer.",
        20: 'Et il ordonna à des hommes, aux hommes les plus vigoureux de son armée, de lier Sadrach, Mésach et Abednégo, et de les jeter dans la fournaise ardente qui était allumée.',
        21: 'Alors ces hommes furent attachés dans leurs caleçons, leurs tuniques et leurs manteaux et leurs vêtements, puis jetés dans la fournaise ardente qui était allumée.',
        22: "Ensuite de ce que l'ordre du roi avait été sévère, et que la fournaise était extraordinairement chauffée, les hommes qui avaient hissé Sadrach, Mésach et Abednégo, périrent par l'effet du feu.",
        23: 'Cependant ces trois hommes, Sadrach, Mésach et Abednégo, tombèrent tout liés dans la fournaise ardente qui brûlait.',
        24: "Alors le roi Nébucadnézar fut stupéfait, et se leva précipitamment. Il prit la parole et dit à ses conseillers: N'avons-nous pas jeté trois hommes liés dans les flammes? Ils répondirent et dirent au roi: Certainement, ô roi!",
        25: 'Il répliqua et dit: Voici, je vois quatre hommes marcher sans liens au milieu du feu, et on ne voit sur eux aucune lésion, et le quatrième par son air ressemble à un fils des dieux.',
        26: "Alors Nébucadnézar s'approcha de la porte de la fournaise ardente qui était allumée. Il prit la parole et dit: Sadrach, Mésach et Abednégo, serviteurs du Dieu suprême, sortez et venez! Alors Sadrach, Mésach et Abednégo sortirent du milieu des flammes.",
        ...
        28: "Nébucadnézar prit la parole et dit: Béni soit le Dieu de Sadrach, Mésach et Abednégo, lequel a envoyé son ange, et sauvé ses serviteurs qui se confiaient en lui, et qui ont transgressé l'ordre du roi et livré leurs corps, pour ne point servir et ne point adorer un autre Dieu que leur Dieu!",
        29: "Et de par moi ordre est donné que tout peuple, toute nation et homme de toute langue qui blasphémera le Dieu de Sadrach, Mésach et Abednégo, soit coupé par morceaux, et que sa maison soit changée en un tas de fumier, parce qu'il n'y a pas d'autre Dieu qui puisse délivrer de la sorte.",
        30: 'Dès lors le roi rendit Sadrach, Mésach et Abednégo puissants dans la province de Babel.',
    },
    4: {
        1: 'Le roi Nébucadnézar à tous les peuples, aux nations et aux hommes de toute langue qui habitent sur toute la terre. A vous grande prospérité!',
    ...
    5: {
        1: 'Le roi Belschazar donna un grand festin à ses mille grands, et il but du vin en présence de ces mille personnes.',
        2: "Belschazar, animé par le vin, dit qu'on apportât les vases d'or et d'argent que Nébucadnézar, son père, avait enlevés du temple de Jérusalem, pour que le roi et ses grands, ses femmes et ses concubines bussent dans ces vases.",
        3: "Alors on apporta les vases d'or qui avaient été enlevés du temple de la maison de Dieu à Jérusalem, et le roi et ses grands, ses femmes et ses concubines burent dans ces vases.",
        4: "Ils burent du vin et chantèrent des louanges à leurs dieux d'or et d'argent, d'airain, de fer, de bois et de pierre.",
        5: "Dans ce moment même les doigts d'une main d'homme s'avancèrent, et écrivirent, vis-à-vis du lustre, sur la chaux de la muraille du palais du roi, et le roi vit la main qui écrivait.",
        6: "Aussitôt le roi changea de couleur, et ses pensées le troublèrent, et les nerfs de ses reins se détendirent, et ses genoux s'entre-heurtèrent.",
        7: "Le roi s'écria avec force qu'on mandât les devins, les Chaldéens et les mages. Le roi prit la parole et dit aux sages de Babel: Tout homme qui lira ces caractères, et m'en expliquera la signification, sera revêtu de la pourpre, et d'une chaîne d'or à son cou, et occupera la troisième place dans le gouvernement de mon empire.",
        8: 'Puis tous les sages du roi furent introduits; mais ils ne purent ni lire les caractères, ni en indiquer au roi la signification.',
        9: 'Alors le roi Belschazar fut extrêmement troublé, et il changea de couleur, et ses grands furent interdits.',
        10: 'Dans cette situation du roi et des grands, la reine parut dans la salle du festin. La reine prit la parole et dit: O roi! puisses-tu vivre éternellement! que tes pensées ne te troublent pas, et ne change pas de couleur!',
        11: "Il est dans ton royaume un homme en qui est l'esprit des dieux saints, et du temps de ton père en lui s'est trouvée une lumière, une intelligence, une sagesse pareille à la sagesse des dieux; et le roi Nébucadnézar, ton père, ton père, ô roi, l'a établi chef des devins, des enchanteurs, des Chaldéens, des mages,",
        12: "parce qu'un esprit éminent, et la connaissance et l'entente de l'interprétation des songes, et de l'explication des énigmes et de la solution des questions difficiles s'étaient rencontrées en lui, savoir, en Daniel, dont le roi avait changé le nom en celui de Beltsazar; que Daniel soit donc mandé, et il te donnera l'explication.",
        13: "Alors Daniel fut introduit devant le roi. Le roi prit la parole et dit à Daniel: Es-tu ce Daniel, l'un des captifs Juifs que le roi, mon père, a amenés de Juda?",
        14: "J'ai ouï dire de toi que l'esprit des dieux est en toi, et qu'on trouve en toi et lumière, et intelligence, et sagesse éminente.",
        15: "Or les sages et les devins ont été amenés devant moi pour lire ces caractères et m'en découvrir le sens, mais ils ne peuvent m'expliquer le sens de la chose.",
        16: "Mais j'ai ouï dire de toi que tu sais donner les explications, et résoudre les questions difficiles; si donc tu peux lire ces caractères, et m'en faire connaître le sens, tu seras revêtu de la pourpre, et tu auras une chaîne d'or à ton cou, et tu occuperas la troisième place dans mon empire.",
        17: 'Alors Daniel répondit et dit en présence du roi: Garde tes dons, et fais tes largesses à un autre! Cependant je lirai les caractères au roi, et je lui en indiquerai le sens.',
        18: 'O roi, le Dieu très haut accorda à Nébucadnézar, ton père, royauté et grandeur, et gloire et magnificence;',
        19: "et à cause de la grandeur qu'il lui avait donnée, les peuples, les nations et les hommes de toute langue étaient tous craintifs et tremblants devant lui; il faisait mourir qui il voulait, et donnait la vie à qui il voulait, et il élevait qui il voulait, et il abaissait qui il voulait.",
        20: "Mais comme son cœur s'éleva, et que son esprit s'enorgueillit jusqu'à l'insolence, il fut précipité de son trône royal, et sa gloire lui fut ôtée;",
        21: "et il fut chassé du milieu des enfants des hommes, et son cœur devint semblable à la brute, et il demeura avec les onagres, comme le bœuf il mangea de l'herbe, et son corps fut trempé de la rosée du ciel, jusqu'à ce qu'il eût reconnu que le Dieu très haut a la domination sur la royauté de l'homme, et qu'il y élève qui Il veut.",
        22: "Mais toi, son fils Belschazar, tu n'as pas humilié ton cœur, quoique tu saches toutes ces choses;",
        23: "et tu t'es élevé contre le Maître du ciel, et les vases de sa maison ont été apportés devant toi, et toi et tes grands, tes femmes et tes concubines, vous avez bu du vin dans ces vases, et tu as chanté des louanges aux dieux d'argent et d'or, d'airain, de fer, de bois et de pierre, qui ne voient, ni n'entendent, ni ne savent rien, et le Dieu qui tient ton souffle dans sa main et qui préside à toutes tes destinées, tu ne l'as pas honoré.",
        24: "En conséquence, c'est de par lui qu'a été envoyée cette main qui a tracé ces caractères.",
        25: 'Et voici les caractères qui ont été tracés: Compté! Compté! Pesé! et Partage!',
        26: 'Voici le sens du mot Compté: Dieu a fait le compte de ton règne et y met fin.',
        27: 'Pesé: Tu as été pesé à la balance et trouvé trop léger.',
        28: 'Partage: Ton empire sera partagé et donné aux Mèdes et aux Perses.',
        29: "Alors, sur l'ordre de Belschazar on revêtit Daniel de la pourpre, et on lui mit au cou une chaîne d'or, et l'on publia devant lui qu'il occuperait la troisième place dans l'empire.",
        30: 'Cette nuit même, Belschazar, roi des Chaldéens, fut tué.',
        31: "Et Darius le Mède reçut l'empire, étant âgé de soixante-deux ans.",
    },
    6: {
    ...
    9: {
        1: "La première année de Darius, fils d'Assuérus, de la race Mède, qui devint roi du royaume des Chaldéens,",
        2: "la première année de son règne, moi Daniel, je fixai mon attention dans les livres [saints] sur le nombre des années que l'Éternel avait dit à Jérémie, le prophète, devoir s'accomplir pour les ruines de Jérusalem, [savoir] soixante-dix années.",
        3: "Et je tournai mes regards vers le Seigneur, mon Dieu, afin de chercher la prière et l'oraison dans le jeûne, dans le cilice et la cendre.",
        4: "Et je fis à l'Éternel, mon Dieu, ma prière et ma confession, et je dis: O Seigneur, qui es le Dieu grand et redoutable, qui garde l'alliance et la miséricorde pour ceux qui l'aiment et gardent ses commandements!",
        5: 'Nous avons été pécheurs et pervers, et nous avons été transgresseurs et rebelles, et nous nous sommes écartés de tes commandements et de tes lois.',
        6: "Et nous n'avons point écouté tes serviteurs, les prophètes, qui parlèrent en ton nom à nos rois, à nos princes et à nos pères et à tout le peuple du pays.",
        7: 'Seigneur, à toi la justice, et à nous la confusion du visage en ce jour, aux hommes de Juda, et aux habitants de Jérusalem et à tout Israël, et à ceux qui sont près, et à ceux qui sont au loin dans toutes les contrées où tu les as chassés à cause du crime par lequel ils se sont rendus criminels envers toi.',
        8: 'Seigneur, à nous la confusion du visage, à nos rois, à nos princes et à nos pères, pour avoir péché contre toi.',
        9: 'Mais par devers le Seigneur, notre Dieu, il y a miséricorde et pardon.',
        10: "Car nous nous sommes rebellés contre lui, et nous n'avons point été dociles à la voix de l'Éternel, notre Dieu, pour suivre ses lois qu'il avait mises devant nos yeux par le ministère de ses serviteurs, les prophètes.",
        11: "Et tout Israël a transgressé ta loi, et s'est détourné pour ne point écouter ta voix; et sur nous a été versée la malédiction et l'exécration consignée dans la loi de Moïse, serviteur de Dieu, parce que nous avons péché contre Lui.",
        12: "Et Il a réalisé sa menace prononcée par Lui contre nous et contre nos juges qui nous jugeaient, amenant sur nous une grande calamité, tellement que ce qui est arrivé à Jérusalem, n'était jamais arrivé sous le ciel entier.",
        13: "Conformément à ce qui est écrit dans la Loi de Moïse, toute cette calamité nous est survenue. Mais nous n'avons point imploré la grâce de l'Éternel, notre Dieu, pour renoncer à nos iniquités, et nous rendre attentifs à ta vérité.",
        14: "C'est pourquoi l'Éternel ne perdit pas de vue la calamité et la fit fondre sur nous; car l'Éternel, notre Dieu, est juste dans tous les actes qu'il opère; mais nous ne fûmes point dociles à sa voix.",
        15: "Et maintenant, Seigneur, notre Dieu, qui as tiré ton peuple du pays d'Egypte d'une main forte, et qui t'es fait un nom aujourd'hui: nous avons péché, nous avons été des impies.",
        16: "Seigneur! conformément à tous tes actes d'équité, ah! que ta colère et ta fureur se détournent de ta ville de Jérusalem, ta sainte montagne! Car nos péchés et les crimes de nos pères ont rendu Jérusalem et ton peuple l'opprobre de tous nos alentours.",
        17: "Écoute donc, ô notre Dieu, la prière de ton serviteur et sa requête, et fais luire ta face sur ton sanctuaire qui est dévasté, pour l'amour du Seigneur!",
        18: 'Incline, ô mon Dieu, ton oreille et écoute! ouvre les yeux et regarde nos ruines et la ville appelée de ton nom! et quand nous déposons nos requêtes devant toi, nous comptons non sur notre justice, mais sur tes compassions immenses.',
        19: "Seigneur, écoute! Seigneur, pardonne! Seigneur, aie égard et agis! ne tarde pas, au nom de toi-même, O mon Dieu! Car c'est de ton nom que cette ville et ce peuple sont appelés.",
        20: "Et je parlais et priais encore, et confessais mon péché et le péché de mon peuple d'Israël, et je laissais tomber mes prières devant l'Éternel, mon Dieu, en faveur de la sainte montagne de mon Dieu;",
        21: "je parlais encore en oraison, quand l'homme, Gabriel, que j'avais vu dans la précédente vision, vint en hâte auprès de moi, vers le temps de l'oblation du soir.",
        22: "Et il m'éclaira et s'entretint avec moi, et me dit: Daniel, je parais maintenant pour te faire pénétrer dans l'intelligence.",
        23: "Comme tu commençais à prier, la parole est émanée, et je viens te l'exposer; car tu es le désiré. Fais donc attention à la parole, et comprends la vision!",
        24: "Soixante-dix semaines sont dispensées sur ton peuple et sur ta ville sainte, pour que le crime soit consommé, et la mesure du péché comblée, et l'iniquité expiée, et pour amener une justice éternelle, et sceller la vision et le prophète, et oindre le Saint des saints.",
        25: "Sache-le donc, et sois attentif: Depuis l'émission de la parole annonçant que Jérusalem sera restaurée et rebâtie jusqu'à un Oint, un prince, il y a sept semaines; et dans l'espace de soixante-deux semaines elle sera restaurée et rebâtie, avec places et fossés, mais au milieu des perplexités des temps.",
        26: "Et après les soixante-deux semaines un Oint sera retranché, et il n'aura personne, et là ville et le sanctuaire seront ravagés par le peuple d'un prince arrivant, et sa fin sera, amenée par une inondation, et jusqu'à la fin il y aura guerre, arrêt de dévastations,",
        27: "et il donnera une alliance forte à plusieurs pendant une semaine, et à la moitié de la semaine il fera cesser le sacrifice et l'oblation, et sur le faîte des abominations sera le dévastateur, et cela jusqu'à ce que l'extermination et le décret fondent sur le dévastateur.",
    },
    10: {
        1: "La troisième année de Coresch, roi de Perse, une parole fut révélée à Daniel qui portait le nom de Beltsazar; et cette parole est une vérité, et a une grande calamité pour objet. Et il fut attentif à cette révélation, et il eut l'intelligence de la vision.",
        2: 'En ce même temps, moi Daniel, je fus dans le deuil pendant trois semaines.',
        3: "Je ne mangeai point de pain délicat, et ni viande ni vin n'entra dans ma bouche, et je ne m'oignis point jusqu'à l'expiration des trois semaines.",
        4: "Et le vingt-quatrième jour du premier mois, j'étais sur le rivage du grand fleuve Hiddékel.",
        5: "Et je levai les yeux, et je regardai, et voici, il y avait là un homme vêtu de lin, et ayant aux reins une ceinture d'or d'Uphaz.",
        6: "Et son corps était comme le chrysolithe, et son visage avait l'aspect de l'éclair, et ses yeux étaient comme des flambeaux allumés, et ses bras et la région de ses pieds avaient l'aspect de l'airain poli, et le son de ses paroles était comme la voix d'une foule en rumeur.",
        7: "Et moi Daniel, j'étais seul à voir la vision, et les hommes qui m'accompagnaient, n'apercevaient point la vision; mais un grand effroi les saisit, et ils fuirent en se dérobant.",
        8: 'Et je restai seul, et je vis cette grande vision; mais il ne me resta point de force, et je changeai de couleur à être défiguré, et je ne conservai aucune force.',
        9: "Et j'entendis le son de ses paroles, et à l'ouïe du son de ses paroles je tombai tout étourdi sur mon visage, et mon visage toucha la terre.",
        10: 'Mais voici, une main me toucha, et soutint mes genoux vacillants et mes mains.',
        11: "Et il me dit: Daniel, homme chéri, sois attentif aux paroles que je vais te dire, et demeure debout à ta place; car je suis maintenant envoyé vers toi. Et pendant qu'il me parlait ainsi, j'étais là debout tremblant.",
        12: "Et il me dit: Ne crains point, Daniel! Car dès le premier jour où tu as pris a cœur de comprendre, et de t'humilier en la présence de ton Dieu, tes paroles ont été écoutées, et je viens ensuite de tes paroles.",
        13: "Et celui qui préside au royaume de Perse, m'a tenu tête pendant vingt-un jours, et voici, Michel, l'un de ceux qui président au premier rang, est venu à mon aide, et ainsi je l'ai emporté auprès des rois de Perse.",
        14: "Et je suis venu pour t'instruire de ce qui arrivera à ton peuple dans la suite des temps; car la vision a trait encore à l'avenir.",
        15: "Et comme il m'adressait de tels discours, je baissai mon visage contre terre, et demeurai muet.",
        16: "Et voici, un personnage qui ressemblait à un fils des hommes, toucha mes lèvres; puis j'ouvris la bouche, et je parlai, et je dis à celui qui se tenait devant moi: « Mon Seigneur, par l'effet de la vision les terreurs m'ont saisi, et je n'ai point conservé de force.",
        17: 'Et comment un serviteur de mon Seigneur que voilà pourrait-il parler avec mon Seigneur que voilà? » Et dès lors il ne me resta plus de force, et je ne respirais plus.',
        18: "Alors je fus de nouveau touché par un personnage qui avait l'air d'un homme, et il me fortifia.",
        19: "Et il dit: Ne crains point, homme chéri! Salut pour toi! courage! courage! Et pendant qu'il me parlait, je me sentais fortifié, et je dis: Que mon Seigneur parle, car tu m'as fortifié.",
        20: "Et il dit: Sais-tu pourquoi je suis venu vers toi? Et maintenant je vais m'en retourner pour combattre celui qui préside à la Perse, et je pars; mais voici, celui qui préside à la Grèce arrive.",
        21: 'Toutefois je veux te découvrir ce qui est consigné dans le livre de la vérité. Et aucun ne me soutient contre ceux-là, sinon Michel qui préside sur vous.',
    },
    11: {
    ...
    12: {
        1: "Et dans ce temps-là Michel, le grand prince, qui tient le parti des fils de ton peuple, se lèvera, et il y aura un temps d'angoisse, tel qu'il n'y en a pas eu depuis l'existence d'un peuple jusqu'à cette époque-là; mais dans le même temps ton peuple sera délivré, tous ceux qui sont inscrits dans le livre [de la vie].",
        2: "Et plusieurs de ceux qui dorment dans la poussière de la terre, se réveilleront, les uns pour une vie éternelle, et les autres pour l'opprobre et une ignominie éternelle.",
        3: "Mais les intelligents brilleront de l'éclat du firmament, et ceux qui auront conduit à la justice cette multitude, [brilleront] comme les étoiles éternellement, à jamais.",
        4: "Mais toi, Daniel, serre les paroles et scelle le livre jusqu'à l'époque de la fin. Plusieurs le parcourront, et la connaissance augmentera.",
        5: "Et moi Daniel, je regardai, et voici, deux autres personnages étaient là, l'un en deçà de la rive du fleuve, et l'autre au delà de la rive du fleuve.",
        6: "Et l'un dit à l'homme vêtu de lin qui se tenait en dessus des ondes du fleuve: A quand la fin de ces faits singuliers?",
        ...
        8: "Et j'entendais, mais je ne comprenais pas, et je dis: Mon Seigneur, quelle issue auront ces choses?",
        9: "Et il me dit: Va, Daniel; car les paroles resteront serrées et scellées jusqu'à l'époque de la fin.",
        10: "Plusieurs seront triés, blanchis et épurés, et les impies pratiqueront l'impiété, et aucun des impies n'y prendra garde, mais les intelligents y prendront garde.",
        11: "Cependant, depuis le temps de l'abolition du sacrifice perpétuel et du placement de l'abomination du dévastateur, il y a mille deux cent quatre-vingt-dix jours.",
        12: 'Heureux celui qui attend, et atteint mille trois cent trente-cinq jours!',
        13: 'Mais toi, marche vers la fin, et tu te reposeras, et tu seras debout pour ton lot à la fin des jours.',
    },
}
