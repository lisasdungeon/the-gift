...
CHAPTERS = {
    ...
    3: {
        ...
        5: 'Sobald ihr den Klang des Hornes, der Pfeife, der Zither, der Sambuke der Laute, der Sackpfeife, und allerlei Art von Musik höret, sollt ihr niederfallen und das goldene Bild anbeten, welches der König Nebukadnezar aufgerichtet hat.',
    ...
    6: {
        ...
        3: 'und über diese drei Vorsteher, von welchen Daniel einer war: damit jene Satrapen ihnen Rechenschaft gäben und der König keinen Schaden erlitte.',
        ...
        5: 'Da suchten die Vorsteher und die Satrapen einen Anklagegrund gegen Daniel von seiten der Verwaltung zu finden; aber sie konnten keinen Anklagegrund und keine schlechte Handlung finden, weil er treu war und kein Vergehen und keine schlechte Handlung an ihm gefunden wurden.',
        ...
        15: 'Da wurde der König, als er die Sache hörte, sehr betrübt und er sann darauf, Daniel zu retten und bis zum Untergang der Sonne bemühte er sich, ihn zu befreien.',
        ...
        23: 'Mein Gott hat seinen Engel gesandt und hat den Rachen der Löwen verschlossen, daß sie mich nicht verletzt haben, weil vor ihm Unschuld an mir gefunden wurde; und auch vor dir, o König, habe ich kein Verbrechen begangen.',
        ...
        27: 'Von mir wird Befehl gegeben, daß man in der ganzen Herrschaft meines Königreichs bebe und sich fürchte vor dem Gott Daniels; denn er ist der lebendige Gott und besteht in Ewigkeit, und sein Reich wird nie zerstört werden, und seine Herrschaft währt bis ans Ende;',
        28: 'der da rettet und befreit, und Zeichen und Wunder tut im Himmel und auf der Erde: denn er hat Daniel aus der Gewalt der Löwen errettet. Und dieser Daniel hatte Gedeihen unter der Regierung des Darius und unter der Regierung Kores, des Persers.',
    },
    7: {
    ...
    8: {
        ...
        13: 'Und ich hörte einen Heiligen reden; und ein Heiliger sprach zu jenem, welcher redete: Bis wann geht das Gesicht von dem beständigen Opfer und von dem verwüstenden Frevel daß sowohl das Heiligtum als auch das Heer zur Zertretung hingegeben ist?',
        14: 'Und er sprach zu mir: Bis zu 2300 Abenden und Morgen dann wird das Heiligtum gerechtfertigt werden.',
    ...
    10: {
        ...
        4: 'Und am 24. Tage des ersten Monats, da war ich am Ufer des großen Stromes, das ist der Hiddekel',
    ...
    11: {
        ...
        2: 'Und nun will ich dir die Wahrheit kundtun: Siehe, es werden noch drei Könige in Persien aufstehen, und der vierte wird größeren Reichtum erlangen als alle; und wenn er durch seinen Reichtum stark geworden ist, wird er alles gegen das Königreich Griechenland aufregen.',
        ...
        7: 'Doch einer von den Schößlingen ihrer Wurzeln wird an seiner Statt aufstehen; und er wird gegen die Heeresmacht kommen, und wird in die Festungen des Königs des Nordens eindringen und mit ihnen nach Gutdünken verfahren, und wird siegen.',
        8: 'Und auch wird er ihre Götter samt ihren gegossenen Bildern, samt ihren kostbaren Geräten, Silber und Gold, nach Ägypten in die Gefangenschaft führen; und er wird Jahre lang standhalten vor dem König des Nordens.',
        ...
        21: 'Und an seiner Statt wird ein Verachteter aufstehen, auf den man nicht die Würde des Königtums legen wird; und er wird unversehens kommen und durch Schmeicheleien sich des Königtums bemächtigen.',
        ...
        24: 'Unversehens wird er in die fettesten Gegenden der Landschaft eindringen und tun, was weder seine Väter noch die Väter seiner Väter getan haben: Raub und Beute und Gut wird er ihnen zerstreuen und wider die Festungen seine Anschläge ersinnen, und zwar eine Zeitlang.',
        ...
        28: 'Und er wird mit großem Reichtum in sein Land zurückkehren, und sein Herz wird wider den heiligen Bund gerichtet sein; und er wird handeln und in sein Land zurückkehren.',
        29: 'Zur bestimmten Zeit wird er wiederkehren und gegen den Süden ziehen, aber es wird zuletzt nicht sein wie im Anfang.',
        30: 'Denn Schiffe von Kittim werden wider ihn kommen; und er wird verzagen und umkehren, und er wird gegen den heiligen Bund ergrimmen und handeln: er wird umkehren und sein Augenmerk auf diejenigen richten, welche den heiligen Bund verlassen.',
        ...
        33: 'Und die Verständigen des Volkes werden die Vielen unterweisen, aber sie werden fallen durch Schwert und Flamme, durch Gefangenschaft und Raub, eine Zeitlang.',
