...
CHAPTERS = {
    ...
    3: {
        1: 'Kuningas Nebukadnessar teetti kultaisen kuvapatsaan, jonka korkeus oli kuusikymmentä kyynärää ja leveys kuusi kyynärää, ja pystytti sen Duuran lakeudelle Baabelin maakuntaan.',
    ...
    4: {
        1: '{3:31} "Kuningas Nebukadnessar kaikille kansoille, kansakunnille ja kielille, jotka asuvat kaiken maan päällä: suuri olkoon teidän rauhanne!',
        2: '{3:32} Minä olen nähnyt hyväksi ilmoittaa ne tunnusteot ja ihmeet, jotka korkein Jumala on minulle tehnyt.',
        3: '{3:33} Kuinka suuret ovat hänen tunnustekonsa ja kuinka voimalliset hänen ihmeensä! Hänen valtakuntansa on iankaikkinen valtakunta ja hänen valtansa pysyy suvusta sukuun."',
        4: '{4:1} "Minä Nebukadnessar elin rauhassa huoneessani ja onnellisena palatsissani.',
        ...
        7: '{4:4} Silloin tulivat tietäjät, noidat, kaldealaiset ja tähtienselittäjät, ja minä kerroin heille unen, mutta he eivät voineet ilmoittaa minulle sen selitystä.',
        8: '{4:5} Mutta viimein tuli minun eteeni Daniel, jonka nimi on minun jumalani nimen mukaan Beltsassar ja jossa on pyhien jumalien henki; ja minä kerroin hänelle unen:',
        9: "{4:6} 'Beltsassar, sinä tietäjäin päämies, jossa minä tiedän olevan pyhien jumalien hengen ja jolle mikään salaisuus ei ole liian vaikea! Sano, mitä olivat ne näyt, jotka minä unessani näin, ja mikä on sen selitys.",
        10: '{4:7} Nämä olivat minun pääni näyt, jotka minulla oli vuoteessani. Minä näin: Katso, oli puu keskellä maata, ja sen korkeus oli suuri.',
        11: '{4:8} Puu kasvoi ja vahvistui, niin että sen latva ulottui taivaaseen ja se näkyi kaiken maan ääriin.',
        12: '{4:9} Sen lehvät olivat kauniit ja sen hedelmät suuret, ja siinä oli ravintoa kaikille. Sen alla etsivät varjoa kedon eläimet, ja sen oksilla asuivat taivaan linnut, ja kaikki liha sai siitä ravintonsa.',
        13: '{4:10} Minä näin pääni näyissä, joita minulla oli vuoteessani: katso, pyhä enkeli astui alas taivaasta.',
        14: '{4:11} Hän huusi voimallisesti ja sanoi näin: hakatkaa puu poikki ja karsikaa sen oksat, riipikää sen lehvät ja hajottakaa sen hedelmät. Paetkoot eläimet sen alta ja linnut sen oksilta.',
        15: '{4:12} Mutta sen kanto juurineen jättäkää maahan, rauta-ja vaskikahleissa kedon ruohikkoon. Taivaan kasteesta hän kastukoon, ja niinkuin eläinten olkoon hänen osansa maan ruoho.',
        16: '{4:13} Hänen sydämensä muutetaan, niin ettei se ole ihmisen sydän, ja hänelle annetaan eläimen sydän. Ja niin kulukoon häneltä seitsemän aikaa.',
        17: "{4:14} Tämä on säädetty enkelien päätöksellä, ja niin ovat tästä asiasta pyhät sanoneet, että elävät tietäisivät Korkeimman hallitsevan ihmisten valtakuntaa ja antavan sen, kenelle hän tahtoo, ja asettavan sen päämieheksi ihmisistä halvimman.'",
        18: '{4:15} Tämän unen näin minä, kuningas Nebukadnessar. Ja sinä, Beltsassar, sano sen selitys, koska ei yksikään minun valtakuntani viisaista voi minulle ilmoittaa sen selitystä. Mutta sinä sen voit, sillä sinussa on pyhien jumalien henki."',
        19: '{4:16} Silloin Daniel, jonka nimenä oli Beltsassar, hämmästyi hetkeksi, ja hänen ajatuksensa peljästyttivät häntä. Kuningas lausui ja sanoi: "Beltsassar, älköön uni ja sen selitys sinua peljästyttäkö". Beltsassar vastasi ja sanoi: "Herrani, koskekoon uni sinun vihollisiasi ja sen selitys sinun vastustajiasi.',
        20: '{4:17} Puu, jonka sinä näit ja joka kasvoi ja vahvistui, niin että sen latva ulottui taivaaseen ja se näkyi kaikkeen maahan,',
        21: '{4:18} jonka lehvät olivat kauniit ja hedelmät suuret ja jossa oli ravintoa kaikille, jonka alla kedon eläimet asuivat ja jonka oksilla taivaan linnut oleskelivat,',
        ...
        26: '{4:23} Mutta että käskettiin jättää maahan puun kanto juurineen, se tietää, että sinun valtakuntasi pysytetään sinulla, ja sinä saat sen, niin pian kuin tulet tuntemaan, että valta on taivaan.',
        27: '{4:24} Sentähden, kuningas, kelvatkoon sinulle minun neuvoni: kirvoita synnit itsestäsi almuilla ja pahat tekosi vaivaisia armahtamalla; ehkäpä silloin onnesi kestäisi."',
        28: '{4:25} Tämä kaikki kohtasi kuningas Nebukadnessaria.',
        29: '{4:26} Kaksitoista kuukautta tämän jälkeen, kun kuningas oli kävelemässä kuninkaallisen palatsinsa katolla Baabelissa,',
        30: '{4:27} hän puhkesi puhumaan sanoen: "Eikö tämä ole se suuri Baabel, jonka minä väkevällä voimallani olen rakentanut kuninkaalliseksi linnaksi, valtasuuruuteni kunniaksi!"',
        31: '{4:28} Vielä oli sana kuninkaan suussa, kun taivaasta tuli ääni: "Sinulle, kuningas Nebukadnessar, julistetaan: Sinun valtakuntasi on otettu sinulta pois.',
