...
CHAPTERS = {
    ...
    3: {
        ...
        26: 'Ðoạn, vua Nê-bu-cát-nết-sa đến gần cửa lò lửa hực, cất tiếng nói rằng: Hỡi Sa-đơ-rắc, Mê-sác và A-bết-Nê-gô, là tôi tớ của Ðức Chúa Trời Rất Cao, hãy ra và lại đây! Sa-đơ-rắc, Mê-sác và A-bết-Nê-gô bèn từ giữa đám lửa mà ra.',
    ...
    5: {
        1: 'Vua Bên-xát-sa dọn tiệc lớn đãi một ngàn đại thần mình, và vua uống rượu trước mặt họ.',
        2: 'Vua Bên-xát-sa đương nhấm rượu, truyền đem những khí mạnh bằng vàng và bạc mà vua Nê-bu-cát-nết-sa, cha mình, đã lấy trong đền thờ tại Giê-ru-sa-lem, hầu cho vua và các đại thần, cùng các hoàng hậu và cung phi vua dùng mà uống.',
        3: 'Người ta bèn đem đến những khí mạnh bằng vàng đã lấy từ trong đền thờ của nhà Ðức Chúa Trời, tại Giê-ru-sa-lem; và vua cùng các đại thần, các hoàng hậu và cung phi mình dùng mà uống.',
        4: 'Vậy họ uống rượu và ngợi khen các thần bằng vàng, bằng bạc, bằng đồng, bằng sắt, bằng gỗ và bằng đá.',
        5: 'Chính giờ đó, co những ngón tay của bàn tay người hiện ra, viết trên vôi tường cung vua, đối ngay chỗ để chơn đèn; và vua trông thấy phần bàn tay đó đương viết.',
        6: 'Bấy giờ vua biến sắc mặt, các ý tưởng làm cho vua bối rối; các xương lưng rời khớp ra, và hai đầu gối chạm vào nhau.',
        7: 'Vua kêu lớn tiếng truyền vời các thuật sĩ, người Canh-đê, và thầy bói đến. Ðoạn, vua cất tiếng và nói cùng những bác sĩ của Ba-by-lôn rằng: Ai đọc được chữ nầy và giải nghĩa ra cho ta, thì sẽ được mặc màu tía, được đeo vòng vàng vào cổ, và được dự bật thứ ba trong việc chánh trị nhà nước.',
        8: 'Bấy giờ hết thảy bác sĩ của vua đều vào; nhưng họ không đọc được chữ, cũng không thể cắt nghĩa cho vua được.',
        9: 'Vua Bên-xát-sa lấy làm bối rối lắm; sắc mặt người đổi đi; các quan đại thần đều bỡ ngỡ.',
        10: 'Bà thái hậu, vì cớ lời của vua và các quan đại thần đã nói, bèn vào trong phòng tiệc, cất tiếng nói rằng: Hỡi vua, chúc vua sống đời đời! Xin vua chớ để tư tưởng bối rối, chớ đổi sắc mặt đi!',
        11: 'Trong nước vua có một người, linh của các thần thánh ở trong nó. Về đời vua cha, người ta thấy trong nó có ánh sáng, sự thông minh, khôn ngoan, như sự khôn ngoan của các vì thần. Vậy nên vua Nê-bu-cát-nết-sa, cha vua, chính cha vua, đã lập người lên làm đầu các đồng bóng, thuật sĩ, người Canh-đê và thầy bói,',
        12: 'bởi vì Ða-ni-ên mà vua đã đặt tên Bên-tơ-xát-sa, trong người có linh tánh tốt lành, có sự thông biết và khôn sáng để giải nghĩa được những câu kín nhiệm, và làm co những sự hồ nghi tan chảy. Vậy bây giờ hãy sai gọi Ða-ni-ên, và người sẽ giải nghĩa cho.',
        13: 'Bấy giờ Ða-ni-ên được đem đến trước mặt vua. Ðoạn, vua cất tiếng nói cùng Ða-ni-ên rằng: Ngươi có phải là Ða-ni-ên, một trong các con cái phu tù Giu-đa, mà vua cha ta đã điệu từ Giu-đa về chăng?',
        14: 'Ta đã nghe nói về ngươi rằng linh của các thần ở trong ngươi, và người ta đã thấy trong ngươi có ánh sáng, sự thông minh, và khôn ngoan lạ thường.',
        15: 'Bây giờ những bác sĩ và thuật sĩ đã được đem đến trước mặt ta để đọc những chữ nầy và giải nghĩa cho ta; nhưng họ không giải nghĩa được.',
        16: 'Ta nghe nói rằng ngươi có thể giải nghĩa và làm cho những sự hồ nghi tan chảy. Vậy nếu ngươi đọc được chữ nầy và giải nghĩa cho ta, thì sẽ được mặc màu tía, sẽ mang vòng vàng nơi cổ, và dự chức thứ ba trong việc chánh trị nhà nước.',
        17: 'Bấy giờ Ða-ni-ên cất tiếng và nói trước mặt vua rằng: Vua hãy giữ lại của ban thưởng, và lễ vật vua hãy ban cho kẻ khác! Dầu vậy, tôi sẽ đọc chữ viết đó và giải nghĩa cho vua.',
        18: 'Hỡi vua, Ðức Chúa Trời Rất Cao đã ban ngôi vua và quyền thế lớn, sự tôn vinh và uy nghiêm cho cha vua là Nê-bu-cát-nết-sa.',
        19: 'Vì cớ Ngài đã ban cho người quyền to, thì hết thảy các dân, các nước, các thứ tiếng đều run rẩy trước mặt người, và sợ hãi người. Người muốn giết ai thì giết, và muốn để ai sống thì để. Người nâng ai cao lên hay hạ ai thấp xuống thì tùy ý người.',
        20: 'Nhưng vì lòng người tự cao, và tánh người cứng cỏi, làm một cách kiêu ngạo, nên người bị truất mất ngôi vua và lột hết sự vinh hiển.',
        21: 'Người bị đuổi khỏi giữa các con trai loài người; lòng người trở nên giống như lòng súc vật, và chỗ ở người thì cùng với những lừa rừng. Người bị nuôi bằng cỏ như bò, và thân người bị nhuần thấm sương móc trên trời, cho đến khi người nhận biết rằng Ðức Chúa Trời Rất Cao cai trị trong nước loài người, và Ngài muốn lập ai lên đó tùy ý.',
        22: 'Hỡi vua Bên-xát-sa, con của người, vua cũng vậy, dầu vua đã biết hết các việc ấy, mà lòng vua cũng không chịu nhún nhường chút nào;',
        ...
        24: 'Vậy nên từ nơi Ngài đã sai phần bàn tay nầy đến, và chữ đó đã vạch ra.',
        25: 'Những chữ đã vạch ra như sau nầy: Mê-nê, Mê-nê, Tê-ken, U-phác-sin.',
        26: 'Nầy là nghĩa những chữ đó: Mê-nê là: Ðức Chúa Trời đã đếm nước vua và khiến nó đến cuối cùng.',
        27: 'Tê-ken là: Vua đã bị cân trên cái cân, và thấy kém thiếu.',
        28: 'Phê-rết là: Nước vua bị chia ra, được ban cho người Mê-đi và người Phe-rơ-sơ.',
        29: 'Tức thì, theo lịnh truyền của vua Bên-xát-sa, người ta mặc màu tía cho Ða-ni-ên; đeo vào cổ người một vòng vàng, và rao ra rằng người được dự chức thứ ba trong việc chánh trị nhà nước.',
        30: 'Ngay đêm đó, vua người Canh-đê là Bên-xát-sa bị giết.',
        31: 'Rồi Ða-ri-út là người Mê-đi được nước, bấy giờ tuổi người độ sáu mươi hai.',
    },
    6: {
        1: 'Vua Ða-ri-út ưng đặt trong nước một trăm hai mươi quan trấn thủ, để chia nhau trị cả nước,',
    ...
    7: {
        ...
        18: 'Nhưng các thánh của Ðấng Rất Cao sẽ nhận lấy nước, và được nước làm của mình đời đời, cho đến đời đời vô cùng.',
        ...
        22: 'cho tới khi Ðấng Thượng Cổ đã đến, sự xét đoán và ban cho các thánh của Ðấng Rất Cao và thì giờ đã đến, là khi các thánh được nước làm của mình.',
        ...
        25: 'Vua đó sẽ nói những lời phạm đến Ðấng Rất Cao, làm hao mòn các thánh của Ðấng Rất Cao, và định ý đổi những thời kỳ và luật pháp; các thánh sẽ bị phó trong tay người cho đến một kỳ, những kỳ, và nửa kỳ.',
        26: 'Nhưng sẽ xét đoán sẽ đến, và người ta sẽ cất quyền thế khỏi nó, để diệt đi và làm cho hủy phá đến cuối cùng.',
        27: 'Bấy giờ nước, quyền thế, và sự tôn đại của muôn nước ở dưới cả trời, sẽ được ban cho dân các thánh của Ðấng Rất Cao. Nước Ngài là nước đời đời, và hết thảy các quyền thế đều hầu việc và vâng lời Ngài.',
    ...
    8: {
        ...
        3: 'Ta ngước mắt lên và thấy, nầy, có một con chiên đực đứng gần sông, có hai cái sừng; hai sừng nó cao, nhưng một cái thì cao hơn cái kia, và cái cao hơn thì mọc lên sau.',
        ...
        6: 'Nó đến tận chỗ con chiên đực có hai sừng, mà ta đã thấy đứng gần sông; nó hết sức giận chạy đến nghịch cùng chiên đực ấy.',
    ...
    9: {
        1: 'Năm đầu Ða-ri-út con trai A-suê-ru, về dòng người Mê-đi, đã được lập làm vua trị nước người Canh-đê;',
        ...
        24: 'Có bảy mươi tuần lễ định trên dân ngươi và thành thánh ngươi, đặng ngăn sự phạm phép, trừ tội lỗi, làm sạch sự gian ác, và đem sự công bình đời đời vào, đặng đặt ấn tín nơi sự hiện thấy và lời tiên tri, và xức dầu cho Ðấng rất thánh.',
    ...
    10: {
        ...
        3: 'Ta chẳng ăn bánh ngon, thịt và rượu chẳng vào miệng ta, và ta không xức dầu chi hết cho đến chừng ba tuần đã mãn.',
