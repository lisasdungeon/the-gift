...
CHAPTERS = {
    ...
    8: {
        1: 'Në vitin e tretë të mbretërimit të mbretit Belshatsar, unë, Danieli, pata një vegim, pas atij që pata në fillim të mbretërimit.',
        2: 'Pashë në vegim dhe, ndërsa po shikoja, më ndodhi të gjëndesha në qytezën e Suzas, që është në krahinën e Elamit; nga vegimi e kuptova që isha pranë lumit Ulai.',
        3: 'Ngrita sytë dhe shikova, dhe ja, pranë lumit pashë më këmbë një dash me dy brirë; të dy brirët ishin të lartë, por njëri ishte më i lartë se tjetri, megjithëse më i larti kishte dalë i fundit.',
        4: "Pashë dashin që godiste kundrejt perëndimit, drejt veriut dhe drejt jugut; asnjë kafshë nuk mund t'i rezistonte, askush nuk mund të çlirohej nga pushteti i tij; kështu ai bëri atë që desh dhe u bë i madh.",
        5: 'Ndërsa kisha parasysh këtë, ja, ku po vinte nga perëndimi një cjap, që përshkonte tërë sipërfaqen e dheut pa e prekur tokën; cjapi kishte një bri të madh midis syve të vet.',
        6: 'Arriti deri te dashi me dy brirë që kisha parë më këmbë përpara lumit, dhe iu hodh kundër me furinë e forcës së tij.',
        7: "E pashë të afrohet dhe të zemërohet kundër tij; pastaj i ra me bri dashit dhe copëtoi dy brirët e tij, ndërsa dashi nuk kishte fuqi për t'i rezistuar; kështu e hodhi për tokë dhe askush nuk mundi ta çlirojë dashin nga pushteti i këtij.",
        8: 'Cjapi u bë shumë i madh; por, kur u bë i fuqishëm, briri i tij i madh u thye; në vend të tij dolën katër brirë të mëdhenj, që drejtoheshin drejt katër erërave të qiellit.',
