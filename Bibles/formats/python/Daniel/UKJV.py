...
CHAPTERS = {
    1: {
        ...
        10: 'And the prince of the eunuchs said unto Daniel, I fear my lord the king, who has appointed your food and your drink: for why should he see your faces worse looking than the children which are of your sort? then shall all of you make me endanger my head to the king.',
        11: 'Then said Daniel to Melzar, whom the prince of the eunuchs had set over Daniel, Hananiah, Mishael, and Azariah,',
        12: 'Prove your servants, I plead to you, ten days; and let them give us vegetables to eat, and water to drink.',
        13: "Then let our countenances be looked upon before you, and the countenance of the children that eat of the portion of the king's food: and as you see, deal with your servants.",
        14: 'So he consented to them in this matter, and proved them ten days.',
        15: "And at the end of ten days their countenances appeared fairer and fatter in flesh than all the children which did eat the portion of the king's food.",
    ...
    2: {
        ...
        2: 'Then the king commanded to call the magicians, and the astrologers, and the sorcerers, and the Chaldeans, in order to show the king his dreams. So they came and stood before the king.',
        ...
        5: 'The king answered and said to the Chaldeans, The thing is gone from me: if all of you will not make known unto me the dream, with the interpretation thereof, all of you shall be cut in pieces, and your houses shall be made a dunghill.',
        6: 'But if all of you show the dream, and the interpretation thereof, all of you shall receive of me gifts and rewards and great honour: therefore show me the dream, and the interpretation thereof.',
        7: 'They answered again and said, Let the king tell his servants the dream, and we will show the interpretation of it.',
        8: 'The king answered and said, I know of certainty that all of you would gain the time, because all of you see the thing is gone from me.',
        9: 'But if all of you will not make known unto me the dream, there is but one decree for you: for all of you have prepared lying and corrupt words to speak before me, till the time be changed: therefore tell me the dream, and I shall know that all of you can show me the interpretation thereof.',
        ...
        26: 'The king answered and said to Daniel, whose name was Belteshazzar, Are you able to make known unto me the dream which I have seen, and the interpretation thereof?',
        ...
        34: 'You saw till that a stone was cut out without hands, which stroke the image upon his feet that were of iron and clay, and brake them to pieces.',
        35: 'Then was the iron, the clay, the brass, the silver, and the gold, broken to pieces together, and became like the chaff of the summer threshing floors; and the wind carried them away, that no place was found for them: and the stone that stroke the image became a great mountain, and filled the whole earth.',
        ...
        38: 'And where ever the children of men dwell, the beasts of the field and the fowls of the heaven has he given into your hand, and has made you ruler over them all. You are this head of gold.',
        ...
        47: 'The king answered unto Daniel, and said, Truthfully it is, that your God is a God of gods, and a Lord of kings, and a revealer of secrets, seeing you could reveal this secret.',
    ...
    3: {
        ...
        5: 'That at what time all of you hear the sound of the cornet, flute, harp, sackbut, psaltery, dulcimer, and all kinds of music, all of you fall down and worship the golden image that Nebuchadnezzar the king has set up:',
        ...
        19: 'Then was Nebuchadnezzar full of fury, and the form of his visage was changed against Shadrach, Meshach, and Abednego: therefore he spoke, and commanded that they should heat the furnace one seven times more than it was known to be heated.',
        20: 'And he commanded the most mighty men that were in his army to bind Shadrach, Meshach, and Abednego, and to cast them into the burning fiery furnace.',
        21: 'Then these men were bound in their coats, their upper garments, and their hats, and their other garments, and were cast into the midst of the burning fiery furnace.',
    ...
    4: {
        ...
        12: 'The leaves thereof were fair, and the fruit thereof much, and in it was food for all: the beasts of the field had shadow under it, and the fowls of the heaven dwelt in the boughs thereof, and all flesh was fed of it.',
        ...
        17: 'This matter is by the decree of the watchers, and the demand by the word of the holy ones: to the intent that the living may know that the most High rules in the kingdom of men, and gives it to whomsoever he will, and sets up over it the base of men.',
        ...
        22: 'It is you, O king, that are grown and become strong: for your greatness is grown, and reachs unto heaven, and your dominion to the end of the earth.',
        ...
        34: 'And at the end of the days I Nebuchadnezzar lifted up mine eyes unto heaven, and mine understanding returned unto me, and I blessed the most High, and I praised and honoured him that lives for ever, whose dominion is an everlasting dominion, and his kingdom is from generation to generation:',
        ...
        37: 'Now I Nebuchadnezzar praise and extol and honour the King of heaven, all whose works are truth, and his ways judgment: and those that walk in pride he is able to bring low.',
    },
    5: {
        ...
        5: "In the same hour came forth fingers of a man's hand, and wrote opposite to the candlestick upon the plaister of the wall of the king's palace: and the king saw the part of the hand that wrote.",
        6: "Then the king's countenance was changed, and his thoughts troubled him, so that the joints of his loins were loosed, and his knees stroke one against another.",
        ...
        27: 'TEKEL; You are weighed in the balances, and are found lacking.',
    ...
    6: {
        ...
        10: 'Now when Daniel knew that the writing was signed, he went into his house; and his windows being open in his chamber toward Jerusalem, he kneeled upon his knees three times a day, and prayed, and gave thanks before his God, as he did in old times.',
        ...
        22: "My God has sent his angel, and has shut the lions' mouths, that they have not hurt me: forasmuch as before him innocence was found in me; and also before you, O king, have I done no hurt.",
        23: 'Then was the king exceedingly glad for him, and commanded that they should take Daniel up out of the den. So Daniel was taken up out of the den, and no manner of hurt was found upon him, because he believed in his God.',
        24: 'And the king commanded, and they brought those men which had accused Daniel, and they cast them into the den of lions, them, their children, and their wives; and the lions had the mastery of them, and brake all their bones in pieces before even they came at the bottom of the den.',
    ...
    8: {
        ...
        7: 'And I saw him come close unto the ram, and he was moved with choler against him, and stroke the ram, and brake his two horns: and there was no power in the ram to stand before him, but he cast him down to the ground, and stamped upon him: and there was none that could deliver the ram out of his hand.',
    ...
    9: {
        ...
        7: 'O LORD, righteousness belongs unto you, but unto us confusion of faces, as at this day; to the men of Judah, and to the inhabitants of Jerusalem, and unto all Israel, that are near, and that are far off, through all the countries where you have driven them, because of their trespass that they have trespassed against you.',
        ...
        15: 'And now, O Lord our God, that have brought your people forth out of the land of Egypt with a mighty hand, and have got you renown, as at this day; we have sinned, we have done wickedly.',
        16: 'O LORD, according to all your righteousness, I plead to you, let your anger and your fury be turned away from your city Jerusalem, your holy mountain: because for our sins, and for the iniquities of our fathers, Jerusalem and your people are become a reproach to all that are about us.',
        ...
        25: 'Know therefore and understand, that from the going out of the commandment to restore and to build Jerusalem unto the Messiah the Prince shall be seven weeks, and threescore and two weeks: the street shall be built again, and the wall, even in troublous times.',
    ...
    10: {
        ...
        8: 'Therefore I was left alone, and saw this great vision, and there remained no strength in me: for my loveliness was turned in me into corruption, and I retained no strength.',
        ...
        16: 'And, behold, one like the embodiment of the sons of men touched my lips: then I opened my mouth, and spoke, and said unto him that stood before me, O my lord, by the vision my sorrows are turned upon me, and I have retained no strength.',
