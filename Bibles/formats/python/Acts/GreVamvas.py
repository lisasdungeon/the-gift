...
CHAPTERS = {
    ...
    3: {
        ...
        11: 'Και ενώ ο ιατρευθείς χωλός εκράτει τον Πέτρον και Ιωάννην, συνέδραμε προς αυτούς πας ο λαός εις την στοάν την λεγομένην Σολομώντος έκθαμβοι.',
        ...
        19: 'Μετανοήσατε λοιπόν και επιστρέψατε, διά να εξαλειφθώσιν αι αμαρτίαι σας, διά να έλθωσι καιροί αναψυχής από της παρουσίας του Κυρίου,',
        20: 'και αποστείλη τον προκεκηρυγμένον εις εσάς Ιησούν Χριστόν,',
        21: "τον οποίον πρέπει να δεχθή ο ουρανός μέχρι των καιρών της αποκαταστάσεως πάντων, όσα ελάλησεν ο Θεός απ' αιώνος διά στόματος πάντων των αγίων αυτού προφητών.",
        22: 'Διότι ο Μωϋσής είπε προς τους πατέρας Ότι Κύριος ο Θεός σας θέλει αναστήσει εις εσάς προφήτην εκ των αδελφών σας ως εμέ· αυτού θέλετε ακούει κατά πάντα όσα αν λαλήση προς εσάς.',
        23: 'Και πάσα ψυχή, ήτις δεν ακούση του προφήτου εκείνου, θέλει εξολοθρευθή εκ του λαού.',
        24: 'Και πάντες δε οι προφήται από Σαμουήλ και των καθεξής, όσοι ελάλησαν, προανήγγειλαν και τας ημέρας ταύτας.',
        25: 'Σεις είσθε υιοί των προφητών και της διαθήκης, την οποίαν έκαμεν ο Θεός προς τους πατέρας ημών, λέγων προς τον Αβραάμ· Και εν τω σπέρματί σου θέλουσιν ευλογηθή πάσαι αι φυλαί της γης.',
        26: 'Προς εσάς πρώτον ο Θεός αναστήσας τον Υιόν αυτού Ιησούν απέστειλεν αυτόν διά να σας ευλογή όταν επιστρέφητε έκαστος από των πονηριών υμών.',
    },
    4: {
    ...
    6: {
        ...
        2: 'Τότε οι δώδεκα, προσκαλέσαντες το πλήθος των μαθητών, είπον· Δεν είναι πρέπον να αφήσωμεν ημείς τον λόγον του Θεού και να διακονώμεν εις τραπέζας.',
        ...
        4: 'ημείς δε θέλομεν εμμένει εν τη προσευχή και τη διακονία του λόγου.',
        5: 'Και ήρεσεν ο λόγος ενώπιον παντός του πλήθους· και εξέλεξαν τον Στέφανον, άνδρα πλήρη πίστεως και Πνεύματος Αγίου, και Φίλιππον και Πρόχορον και Νικάνορα και Τίμωνα και Παρμενάν και Νικόλαον, προσήλυτον Αντιοχέα,',
        6: "τους οποίους έστησαν ενώπιον των αποστόλων και προσευχηθέντες επέθεσαν επ' αυτούς τας χείρας.",
    ...
    9: {
        ...
        7: 'Οι δε άνδρες οι συνοδεύοντες αυτόν ίσταντο άφωνοι, ακούοντες μεν την φωνήν, μηδένα όμως βλέποντες.',
        8: 'Εσηκώθη δε ο Σαύλος από της γης, και έχων ανεωγμένους τους οφθαλμούς αυτού δεν έβλεπεν ουδένα· και χειραγωγούντες αυτόν εισήγαγον εις Δαμασκόν.',
        9: 'Και ήτο τρεις ημέρας χωρίς να βλέπη, και δεν έφαγεν ουδέ έπιεν.',
        10: "Ήτο δε τις μαθητής εν Δαμασκώ Ανανίας ονομαζόμενος, και είπε προς αυτόν ο Κύριος δι' οράματος· Ανανία· Ο δε είπεν· Ιδού εγώ, Κύριε.",
        11: 'Και ο Κύριος είπε προς αυτόν· Σηκωθείς ύπαγε εις την οδόν την ονομαζομένην Ευθείαν και ζήτησον εν τη οικία του Ιούδα τινά Σαύλον ονομαζόμενον Ταρσέα· διότι ιδού, προσεύχεται,',
        12: "και είδε δι' οράματος άνθρωπον Ανανίαν ονομαζόμενον ότι εισήλθε και έθεσεν επ' αυτόν την χείρα, διά να αναβλέψη.",
        13: 'Απεκρίθη δε ο Ανανίας· Κύριε, ήκουσα από πολλών περί του ανδρός τούτου, όσα κακά έπραξεν εις τους αγίους σου εν Ιερουσαλήμ·',
        14: 'και εδώ έχει εξουσίαν παρά των αρχιερέων να δέση πάντας τους επικαλουμένους το όνομά σου.',
        15: 'Είπε δε προς αυτόν ο Κύριος· Ύπαγε, διότι ούτος είναι σκεύος εκλογής εις εμέ, διά να βαστάση το όνομά μου ενώπιον εθνών και βασιλέων και των υιών Ισραήλ·',
        16: 'επειδή εγώ θέλω δείξει εις αυτόν όσα πρέπει να πάθη υπέρ του ονόματός μου.',
        17: "Υπήγε δε ο Ανανίας και εισήλθεν εις την οικίαν, και επιθέσας επ' αυτόν τας χείρας είπε· Σαούλ αδελφέ, ο Κύριος με απέστειλεν, ο Ιησούς όστις εφάνη εις σε εν τη οδώ καθ' ην ήρχου, διά να αναβλέψης και να πλησθής Πνεύματος Αγίου.",
        18: 'Και ευθύς έπεσον από των οφθαλμών αυτού ως λέπη, και ανέβλεψεν ευθύς, και σηκωθείς εβαπτίσθη.',
        ...
        21: 'Εξεπλήττοντο δε πάντες οι ακούοντες και έλεγον· Δεν είναι ούτος, όστις εξωλόθρευσεν εν Ιερουσαλήμ τους επικαλουμένους το όνομα τούτο και εδώ διά τούτο είχεν ελθεί διά να φέρη αυτούς δεδεμένους προς τους αρχιερείς;',
        22: 'Ο δε Σαύλος μάλλον ενεδυναμούτο και συνέχεε τους Ιουδαίους τους κατοικούντας εν Δαμασκώ, αποδεικνύων ότι ούτος είναι ο Χριστός.',
        23: 'Και αφού παρήλθον ημέραι ικαναί, συνεβουλεύθησαν οι Ιουδαίοι να θανατώσωσιν αυτόν·',
        24: 'εγνωστοποιήθη δε εις τον Σαύλον η επιβουλή αυτών. Και παρεφύλαττον τας πύλας ημέραν και νύκτα, διά να θανατώσωσιν αυτόν·',
        25: 'λαβόντες δε αυτόν οι μαθηταί, διά νυκτός κατεβίβασαν διά του τείχους κρεμάσαντες εντός σπυρίδος.',
        26: 'Και ελθών ο Σαύλος εις Ιερουσαλήμ επροσπάθει να προσκολληθή εις τους μαθητάς· πλην πάντες εφοβούντο αυτόν, μη πιστεύοντες ότι είναι μαθητής.',
        27: 'Ο Βαρνάβας δε παραλαβών αυτόν έφερε προς τους αποστόλους, και διηγήθη προς αυτούς πως είδε τον Κύριον εν τη οδώ και ότι ελάλησε προς αυτόν, και πως εν Δαμασκώ, εκήρυξε μετά παρρησίας εν τω ονόματι του Ιησού.',
        28: "Και ήτο μετ' αυτών εν Ιερουσαλήμ εισερχόμενος και εξερχόμενος και μετά παρρησίας κηρύττων εν τω ονόματι του Κυρίου Ιησού,",
        29: 'και ελάλει και εφιλονείκει μετά των Ελληνιστών· εκείνοι δε κατεγίνοντο εις το να θανατώσωσιν αυτόν.',
        30: 'Μαθόντες δε οι αδελφοί, κατεβίβασαν αυτόν εις Καισάρειαν και εξαπέστειλαν αυτόν εις Ταρσόν.',
        31: "Αι μεν λοιπόν εκκλησίαι καθ' όλην την Ιουδαίαν και Γαλιλαίαν και Σαμάρειαν είχον ειρήνην, οικοδομούμεναι και περιπατούσαι εν τω φόβω του Κυρίου, και διά της παρηγορίας του Αγίου Πνεύματος επληθύνοντο.",
        32: 'Ο δε Πέτρος, διερχόμενος διά πάντων, κατέβη και προς τους αγίους τους κατοικούντας την Λύδδαν.',
        33: 'Και εύρεν άνθρωπον τινά Αινέαν το όνομα, όστις ήτο παραλυτικός, από ετών οκτώ κατακείμενος επί κραββάτου.',
        34: 'Και είπε προς αυτόν ο Πέτρος· Αινέα, σε ιατρεύει Ιησούς ο Χριστός· σηκώθητι και στρώσον την κλίνην σου. Και ευθύς εσηκώθη.',
        35: 'Και είδον αυτόν πάντες οι κατοικούντες την Λύδδαν και τον Σάρωνα, οίτινες επέστρεψαν εις τον Κύριον.',
        36: 'Και εν Ιόππη ήτο τις μαθήτρια ονόματι Ταβιθά, ήτις διερμηνευομένη λέγεται Δορκάς· αύτη ήτο πλήρης αγαθών έργων και ελεημοσυνών, τας οποίας έκαμνε·',
        37: "κατ' εκείνας δε τας ημέρας συνέβη ασθενήσασα να αποθάνη· και λούσαντες αυτήν έθεσαν εις ανώγεον.",
        38: 'Και επειδή η Λύδδα ήτο πλησίον της Ιόππης, ακούσαντες οι μαθηταί ότι ο Πέτρος είναι εν αυτή, απέστειλαν προς αυτόν δύο άνδρας, παρακαλούντες να μη βραδύνη να περάση έως εις αυτούς.',
        39: "Και σηκωθείς ο Πέτρος, υπήγε μετ' αυτών· τον οποίον ελθόντα ανεβίβασαν εις το ανώγεον, και παρεστάθησαν ενώπιον αυτού πάσαι αι χήραι, κλαίουσαι και δεικνύουσαι χιτώνας και ιμάτια, όσα η Δορκάς ειργάζετο ότε ήτο μετ' αυτών.",
        40: 'Ο δε Πέτρος, εκβαλών έξω πάντας, εγονάτισε και προσηυχήθη και στραφείς προς το σώμα, είπε· Ταβιθά, ανάστηθι. Η δε ήνοιξε τους οφθαλμούς αυτής και ιδούσα τον Πέτρον ανεκάθησεν.',
        ...
        43: 'Και ο Πέτρος έμεινεν ικανάς ημέρας εν Ιόππη παρά τινί Σίμωνι βυρσοδέψη.',
    },
    10: {
    ...
    12: {
        ...
        19: 'Ο δε Ηρώδης, αφού εζήτησεν αυτόν και δεν εύρεν, ανακρίνας τους φύλακας προσέταξε να θανατωθώσι, και καταβάς από της Ιουδαίας εις την Καισάρειαν, διέτριβεν εκεί.',
        20: 'Ήτο δε ο Ηρώδης σφόδρα ωργισμένος κατά των Τυρίων και Σιδωνίων· ήλθον δε προς αυτόν ομοθυμαδόν, και πείσαντες τον Βλάστον τον επί του κοιτώνος του βασιλέως, εζήτουν ειρήνην, διότι ο τόπος αυτών ετρέφετο από του βασιλικού.',
        21: 'Και εν ημέρα ωρισμένη ενδυθείς ο Ηρώδης βασιλικήν στολήν και καθήσας επί του θρόνου, εδημηγόρει προς αυτούς.',
        22: 'Ο δε λαός επεφώνει· Θεού φωνή και ουχί ανθρώπου.',
        23: 'Και παρευθύς επάταξεν αυτόν άγγελος Κυρίου, διότι δεν έδωκε την δόξαν εις τον Θεόν, και γενόμενος σκωληκόβρωτος εξεψύχησεν.',
        24: 'Ο δε λόγος του Θεού ηύξανε και επληθύνετο.',
        25: "Ο δε Βαρνάβας και ο Σαύλος υπέστρεψαν εξ Ιερουσαλήμ αφού εξεπλήρωσαν την διακονίαν αυτών, παραλαβόντες μεθ' εαυτών και τον Ιωάννην τον επονομασθέντα Μάρκον.",
    },
    13: {
        1: 'Ήσαν δε εν Αντιοχεία εν τη υπαρχούση εκκλησία προφήταί τινές και διδάσκαλοι, ο Βαρνάβας και Συμεών ο καλούμενος Νίγερ, και Λούκιος ο Κυρηναίος, και Μαναήν ο συνανατραφείς μετά του Ηρώδου του τετράρχου, και ο Σαύλος.',
        2: 'Και ενώ υπηρέτουν εις τον Κύριον και ενήστευον, είπε το Πνεύμα το Αγιον· Χωρίσατε εις εμέ τον Βαρνάβαν και τον Σαύλον διά το έργον, εις το οποίον προσεκάλεσα αυτούς.',
        3: "Τότε αφού ενήστευσαν και προσευχήθησαν και επέθεσαν τας χείρας επ' αυτούς, απέστειλαν.",
        4: 'Ούτοι λοιπόν πεμφθέντες υπό του Πνεύματος του Αγίου, κατέβησαν εις την Σελεύκειαν και εκείθεν απέπλευσαν εις την Κύπρον,',
        5: 'και ότε ήλθον εις την Σαλαμίνα, εκήρυττον τον λόγον του Θεού εν ταις συναγωγαίς των Ιουδαίων· είχον δε και τον Ιωάννην υπηρέτην.',
        6: 'Και αφού διήλθον την νήσον μέχρι της Πάφου, εύρον τινά μάγον ψευδοπροφήτην Ιουδαίον ονομαζόμενον Βαριησούν,',
        7: 'όστις ήτο μετά του ανθυπάτου Σεργίου Παύλου, ανδρός συνετού. Ούτος προσκαλέσας τον Βαρνάβαν και Σαύλον, εζήτησε να ακούση τον λόγον του Θεού·',
        8: 'ανθίστατο δε εις αυτούς Ελύμας ο μάγος, διότι ούτω μεθερμηνεύεται το όνομα αυτού, ζητών να αποτρέψη τον ανθύπατον από της πίστεως.',
        9: 'Πλην ο Σαύλος, ο και Παύλος, πλησθείς Πνεύματος Αγίου και ατενίσας εις αυτόν,',
        10: 'είπεν· Ω πλήρης παντός δόλου και πάσης ραδιουργίας, υιέ του διαβόλου, εχθρέ πάσης δικαιοσύνης, δεν θέλεις παύσει διαστρέφων τας ευθείας οδούς του Κυρίου;',
        11: "Και τώρα ιδού, χειρ του Κυρίου είναι κατά σου, και θέλεις είσθαι τυφλός, μη βλέπων τον ήλιον μέχρι καιρού. Και παρευθύς επέπεσεν επ' αυτόν αμαύρωσις και σκότος, και περιστρεφόμενος εζήτει χειραγωγούς.",
        12: 'Τότε ιδών ο ανθύπατος το γεγονός επίστευσεν, εκπληττόμενος εις την διδαχήν του Κυρίου.',
        13: "Αποπλεύσαντες δε από της Πάφου ο Παύλος και οι περί αυτόν ήλθον εις την Πέργην της Παμφυλίας· ο δε Ιωάννης, χωρισθείς απ' αυτών, υπέστρεψεν εις τα Ιεροσόλυμα.",
        14: 'Αυτοί δε περάσαντες από της Πέργης, έφθασαν εις Αντιόχειαν της Πισιδίας, και εισελθόντες εις την συναγωγήν τη ημέρα του σαββάτου εκάθησαν.',
        15: 'Και μετά την ανάγνωσιν του νόμου και των προφητών απέστειλαν εις αυτούς οι αρχισυνάγωγοι, λέγοντες· Άνδρες αδελφοί, εάν έχητε λόγον τινά προτροπής εις τον λαόν, λέγετε.',
        16: 'Σηκωθείς δε ο Παύλος και σείσας την χείρα, είπεν· Άνδρες Ισραηλίται και οι φοβούμενοι τον Θεόν, ακούσατε.',
        17: 'Ο Θεός του λαού τούτου Ισραήλ εξέλεξε τους πατέρας ημών και ύψωσε τον λαόν παροικούντα εν γη Αιγύπτου, και μετά βραχίονος υψηλού εξήγαγεν αυτούς εξ αυτής,',
        18: 'και έως τεσσαράκοντα έτη υπέφερε τους τρόπους αυτών εν τη ερήμω,',
        19: 'και αφού κατέστρεψεν επτά έθνη εν γη Χαναάν, διεμέρισεν εις αυτούς κατά κλήρον την γην αυτών.',
        20: 'Και μετά ταύτα ως τετρακόσια και πεντήκοντα περίπου έτη έδωκεν εις αυτούς κριτάς έως Σαμουήλ του προφήτου.',
        21: 'Και έπειτα εζήτησαν βασιλέα, και έδωκεν εις αυτούς ο Θεός τον Σαούλ, υιόν του Κις, άνδρα εκ της φυλής Βενιαμίν, τεσσαράκοντα έτη·',
        22: 'και μεταστήσας αυτόν, ανέστησεν εις αυτούς βασιλέα τον Δαβίδ, περί του οποίου και είπε μαρτυρήσας· Εύρον Δαβίδ τον του Ιεσσαί, άνδρα κατά την καρδίαν μου, όστις θέλει κάμει πάντα τα θελήματά μου.',
        23: 'Από του σπέρματος τούτου ο Θεός κατά την επαγγελίαν αυτού ανέστησεν εις τον Ισραήλ σωτήρα τον Ιησούν,',
        24: 'αφού ο Ιωάννης προ της ελεύσεως αυτού προεκήρυξε βάπτισμα μετανοίας εις πάντα τον λαόν του Ισραήλ.',
        25: "Και ενώ ο Ιωάννης ετελείονε τον δρόμον αυτού, έλεγε· Τίνα με στοχάζεσθε ότι είμαι; δεν είμαι εγώ, αλλ' ιδού, έρχεται μετ' εμέ εκείνος, του οποίου δεν είμαι άξιος να λύσω το υπόδημα των ποδών.",
        26: 'Άνδρες αδελφοί, υιοί του γένους του Αβραάμ και οι εν υμίν φοβούμενοι τον Θεόν, προς εσάς απεστάλη ο λόγος της σωτηρίας ταύτης.',
        27: 'Διότι οι κατοικούντες εν Ιερουσαλήμ και οι άρχοντες αυτών, μη γνωρίσαντες τούτον μηδέ τας ρήσεις των προφητών, τας αναγινωσκομένας κατά παν σάββατον, επλήρωσαν αυτάς κρίναντες τούτον,',
        28: 'και μη ευρόντες μηδεμίαν αιτίαν θανάτου, εζήτησαν παρά του Πιλάτου να θανατωθή.',
        29: 'Αφού δε ετελείωσαν πάντα τα περί αυτού γεγραμμένα, καταβιβάσαντες αυτόν από του ξύλου έθεσαν εις μνημείον.',
        30: 'Ο Θεός όμως ανέστησεν αυτόν εκ νεκρών·',
        31: "όστις εφάνη επί πολλάς ημέρας εις τους μετ' αυτού αναβάντας από της Γαλιλαίας εις Ιερουσαλήμ, οίτινες είναι μάρτυρες αυτού προς τον λαόν.",
        32: 'Και ημείς ευαγγελιζόμεθα προς εσάς την γενομένην εις τους πατέρας επαγγελίαν,',
        33: 'ότι ταύτην ο Θεός εξεπλήρωσεν εις ημάς τα τέκνα αυτών, αναστήσας τον Ιησούν, ως είναι γεγραμμένον και εν τω ψαλμώ τω δευτέρω· Υιός μου είσαι συ, εγώ σήμερον σε εγέννησα.',
        34: 'Ότι δε ανέστησεν αυτόν εκ νεκρών, μη μέλλοντα πλέον να υποστρέψη εις την διαφθοράν, λέγει ούτως, ότι θέλω σας δώσει τα ελέη του Δαβίδ τα πιστά.',
        35: 'Διά τούτο και εν άλλω ψαλμώ λέγει· Δεν θέλεις αφήσει τον όσιόν σου να ίδη διαφθοράν.',
        36: 'Διότι ο μεν Δαβίδ, αφού υπηρέτησε την βουλήν του Θεού εν τη γενεά αυτού, εκοιμήθη και προσετέθη εις τους πατέρας αυτού και είδε διαφθοράν·',
        37: 'εκείνος όμως, τον οποίον ο Θεός ανέστησε, δεν είδε διαφθοράν.',
        38: 'Έστω λοιπόν γνωστόν εις εσάς, άνδρες αδελφοί, ότι διά τούτου κηρύττεται προς εσάς άφεσις αμαρτιών.',
        39: "Και από πάντων, αφ' όσων δεν ηδυνήθητε διά του νόμου του Μωϋσέως να δικαιωθήτε, διά τούτου πας ο πιστεύων δικαιούται.",
        40: "Βλέπετε λοιπόν μη επέλθη εφ' υμάς το λαληθέν υπό των προφητών·",
        41: 'Ίδετε, οι καταφρονηταί, και θαυμάσατε και αφανίσθητε, διότι έργον εγώ εργάζομαι εν ταις ημέραις υμών, έργον, εις το οποίον δεν θέλετε πιστεύσει, εάν τις διηγηθή εις εσάς.',
        42: 'Ενώ δε εξήρχοντο εκ της συναγωγής των Ιουδαίων, παρεκάλουν τα έθνη να κηρυχθώσιν εις αυτούς οι λόγοι ούτοι το ακόλουθον σάββατον.',
        43: 'Και αφού ελύθη η συναγωγή, πολλοί εκ των Ιουδαίων και των ευσεβών προσηλύτων ηκολούθησαν τον Παύλον και τον Βαρνάβαν, οίτινες λαλούντες προς αυτούς, έπειθον αυτούς να εμμένωσιν εις την χάριν του Θεού.',
        44: 'το δε ερχόμενον σάββατον σχεδόν όλη η πόλις συνήχθη διά να ακούσωσι τον λόγον του Θεού.',
        45: 'Ιδόντες δε οι Ιουδαίοι τα πλήθη, επλήσθησαν φθόνου και ηναντιούντο εις τα υπό του Παύλου λεγόμενα, αντιλέγοντες και βλασφημούντες.',
        46: "Ο Παύλος δε και ο Βαρνάβας, λαλούντες μετά παρρησίας, είπον· Εις εσάς πρώτον ήτο αναγκαίον να λαληθή ο λόγος του Θεού· αλλ' επειδή απορρίπτετε αυτόν και δεν κρίνετε εαυτούς αξίους της αιωνίου ζωής, ιδού, στρεφόμεθα εις τα έθνη·",
        47: 'διότι ούτω προσέταξεν ημάς ο Κύριος, λέγων· Σε έθεσα φως των εθνών, διά να ήσαι προς σωτηρίαν έως εσχάτου της γης.',
        48: 'Και οι εθνικοί ακούσαντες έχαιρον και εδόξαζον τον λόγον του Κυρίου, και επίστευσαν όσοι ήσαν ωρισμένοι διά την αιώνιον ζωήν·',
        49: "και ο λόγος του Κυρίου διεδίδετο δι' όλου του τόπου.",
        50: 'Οι δε Ιουδαίοι παρεκίνησαν τας ευλαβείς και επισήμους γυναίκας και τους πρώτους της πόλεως και διήγειραν διωγμόν κατά του Παύλου και του Βαρνάβα, και εξέβαλον αυτούς από των ορίων αυτών.',
        51: "Εκείνοι δε εκτινάξαντες τον κονιορτόν των ποδών αυτών επ' αυτούς, ήλθον εις το Ικόνιον.",
        52: 'Και οι μαθηταί επληρούντο χαράς και Πνεύματος Αγίου.',
    },
    14: {
    ...
    15: {
        ...
        18: "Απ' αιώνος είναι γνωστά εις τον Θεόν πάντα τα έργα αυτού.",
    ...
    16: {
        ...
        2: 'όστις είχε καλήν μαρτυρίαν υπό των εν Λύστροις και Ικονίω αδελφών.',
        3: "Τούτον ηθέλησεν ο Παύλος να εξέλθη μεθ' εαυτού, και λαβών αυτόν περιέτεμε διά τους Ιουδαίους τους όντας εν τοις τόποις εκείνοις· επειδή εγνώριζον πάντες τον πατέρα αυτού ότι ήτο Έλλην.",
        4: 'Ως δε διήρχοντο τας πόλεις, παρέδιδον εις αυτούς διαταγάς να φυλάττωσι τα δόγματα τα εγκεκριμένα υπό των αποστόλων και των πρεσβυτέρων των εν Ιερουσαλήμ.',
        ...
        8: 'Περάσαντες δε την Μυσίαν κατέβησαν εις Τρωάδα.',
        ...
        15: 'Αφού δε εβαπτίσθη αυτή και ο οίκος αυτής, παρεκάλεσε λέγουσα· Εάν με εκρίνατε ότι είμαι πιστή εις τον Κύριον, εισέλθετε εις τον οίκόν μου και μείνατε· και μας εβίασεν.',
        16: 'Ενώ δε επορευόμεθα εις την προσευχήν, απήντησεν ημάς δούλη τις έχουσα πνεύμα πύθωνος, ήτις έδιδε πολύ κέρδος εις τους κυρίους αυτής μαντευομένη.',
        ...
        18: "Τούτο δε έκαμνεν επί πολλάς ημέρας. Βαρυνθείς δε ο Παύλος και στραφείς, είπε προς το πνεύμα, Προστάζω σε εν τω ονόματι του Ιησού Χριστού να εξέλθης απ' αυτής. Και εξήλθε την αυτήν ώραν.",
        19: 'Ιδόντες δε οι κύριοι αυτής ότι εξήλθεν η ελπίς του κέρδους αυτών, πιάσαντες τον Παύλον και τον Σίλαν, έσυραν εις την αγοράν προς τους άρχοντας,',
        20: 'και φέροντες αυτούς προς τους στρατηγούς, είπον· Ούτοι οι άνθρωποι εκταράττουσι την πόλιν ημών, Ιουδαίοι όντες,',
        21: 'και διδάσκουσιν έθιμα, τα οποία δεν είναι εις ημάς συγκεχωρημένον να παραδεχώμεθα μηδέ να πράττωμεν, Ρωμαίοι όντες.',
        22: "Και συνεφώρμησεν ο όχλος κατ' αυτών. Και οι στρατηγοί διασχίσαντες αυτών τα ιμάτια, προσέταττον να ραβδίζωσιν αυτούς,",
        ...
        25: 'Κατά δε το μεσονύκτιον ο Παύλος και ο Σίλας προσευχόμενοι ύμνουν τον Θεόν· και ηκροάζοντο αυτούς οι δέσμιοι.',
        26: 'Και εξαίφνης έγεινε σεισμός μέγας, ώστε εσαλεύθησαν τα θεμέλια του δεσμωτηρίου, και παρευθύς ηνοίχθησαν πάσαι αι θύραι και ελύθησαν πάντων τα δεσμά.',
        ...
        30: 'και εκβαλών αυτούς έξω, είπε· Κύριοι, τι πρέπει να κάμω διά να σωθώ;',
        31: 'Οι δε είπον· Πίστευσον εις τον Κύριον Ιησούν Χριστόν, και θέλεις σωθή, συ και ο οίκός σου.',
        ...
        34: 'και αναβιβάσας αυτούς εις τον οίκον αυτού παρέθηκε τράπεζαν, και ευφράνθη πανοικί πιστεύσας εις το Θεόν.',
        ...
        39: 'και ελθόντες παρεκάλεσαν αυτούς, και αφού εξέβαλον, παρεκάλουν αυτούς να εξέλθωσιν εκ της πόλεως.',
    ...
    22: {
        1: 'Άνδρες αδελφοί και πατέρες, ακούσατέ με απολογούμενον τώρα προς εσάς.',
        2: 'Ακούσαντες δε ότι ελάλει προς αυτούς εις την Εβραϊκήν διάλεκτον, έδειξαν περισσοτέραν ησυχίαν. Και είπεν·',
        ...
        5: 'καθώς και ο αρχιερεύς μαρτυρεί εις εμέ και όλον το πρεσβυτέριον· παρά των οποίων και επιστολάς λαβών προς τους αδελφούς, επορευόμην εις Δαμασκόν διά να φέρω δεδεμένους εις Ιερουσαλήμ και τους εκεί όντας, διά να τιμωρηθώσιν.',
        6: 'Ενώ δε οδοιπορών επλησίαζον εις την Δαμασκόν, περί την μεσημβρίαν εξαίφνης έστραψε περί εμέ φως πολύ εκ του ουρανού,',
        7: 'και έπεσον εις το έδαφος και ήκουσα φωνήν λέγουσαν προς εμέ· Σαούλ, Σαούλ, τι με διώκεις;',
        8: 'Εγώ δε απεκρίθην· Τις είσαι, Κύριε; Και είπε προς εμέ· Εγώ είμαι Ιησούς ο Ναζωραίος, τον οποίον συ διώκεις.',
        9: "Οι όντες δε μετ' εμού το μεν φως είδον και κατεφοβήθησαν, την φωνήν όμως του λαλούντος προς εμέ δεν ήκουσαν.",
        10: 'Και είπον· Τι να κάμω, Κύριε; Και ο Κύριος είπε προς εμέ· Σηκωθείς ύπαγε εις Δαμασκόν, και εκεί θέλει σοι λαληθή περί πάντων όσα είναι διωρισμένα να κάμης.',
        11: "Και επειδή εκ της λαμπρότητος του φωτός εκείνου δεν έβλεπον, χειραγωγούμενος υπό των όντων μετ' εμού ήλθον εις Δαμασκόν.",
        12: 'Ανανίας δε τις, άνθρωπος ευσεβής κατά τον νόμον, μαρτυρούμενος υπό πάντων των εκεί κατοικούντων Ιουδαίων,',
        13: 'ήλθε προς εμέ και σταθείς επάνω μου μοι, είπε· Σαούλ αδελφέ, ανάβλεψον. Και εγώ τη αυτή ώρα ανέβλεψα εις αυτόν.',
        14: 'Ο δε είπεν· Ο Θεός των πατέρων ημών σε διώρισε να γνωρίσης το θέλημα αυτού και να ίδης τον δίκαιον και να ακούσης φωνήν εκ του στόματος αυτού,',
        15: 'διότι θέλεις είσθαι μάρτυς περί αυτού προς πάντας τους ανθρώπους των όσα είδες και ήκουσας.',
        16: 'Και τώρα τι βραδύνεις; σηκωθείς βαπτίσθητι και απολούσθητι από των αμαρτιών σου, επικαλεσθείς το όνομα του Κυρίου.',
        17: 'Αφού δε υπέστρεψα εις Ιερουσαλήμ, ενώ προσηυχόμην εν τω ιερώ, ήλθον εις έκστασιν',
        18: 'και είδον αυτόν λέγοντα προς εμέ· Σπεύσον και έξελθε ταχέως εξ Ιερουσαλήμ, διότι δεν θέλουσι παραδεχθή την περί εμού μαρτυρίαν σου.',
        19: 'Και εγώ είπον· Κύριε, αυτοί εξεύρουσιν ότι εγώ εφυλάκιζον και έδερον εν ταις συναγωγαίς τους πιστεύοντας εις σέ·',
        20: 'και ότε εχύνετο το αίμα Στεφάνου του μάρτυρός σου, και εγώ ήμην παρών και συνεφώνουν εις τον φόνον αυτού και εφύλαττον τα ιμάτια των φονευόντων αυτόν.',
        21: 'Και είπε προς εμέ· Ύπαγε, διότι εγώ θέλω σε εξαποστείλει εις έθνη μακράν.',
        22: 'Και μέχρι τούτου του λόγου ήκουον αυτόν· τότε δε ύψωσαν την φωνήν αυτών, λέγοντες· Σήκωσον από της γης τον τοιούτον· διότι δεν πρέπει να ζη.',
        23: 'Και επειδή αυτοί εκραύγαζον και ετίναζον τα ιμάτια και έρριπτον κονιορτόν εις τον αέρα,',
        24: "ο χιλίαρχος προσέταξε να φερθή εις το φρούριον, παραγγείλας να εξετασθή διά μαστίγων, διά να γνωρίση διά ποίαν αιτίαν εφώναζον ούτω κατ' αυτού.",
        25: 'Και καθώς εξήπλωσεν αυτόν δεδεμένον με τα λωρία, ο Παύλος είπε προς τον παρεστώτα εκατόνταρχον· Είναι τάχα νόμιμον εις εσάς άνθρωπον Ρωμαίον και ακατάκριτον να μαστιγόνητε;',
        26: 'Ακούσας δε ο εκατόνταρχος, υπήγε και απήγγειλε προς τον χιλίαρχον, λέγων· Βλέπε τι μέλλεις να κάμης· διότι ο άνθρωπος ούτος είναι Ρωμαίος.',
        27: 'Προσελθών δε ο χιλίαρχος, είπε προς αυτόν· Λέγε μοι, συ Ρωμαίος είσαι; Ο δε είπε· Ναι.',
        28: "Και απεκρίθη ο χιλίαρχος· Εγώ διά πολλών χρημάτων απέκτησα ταύτην την πολιτογράφησιν. Ο δε Παύλος είπεν· Αλλ' εγώ και εγεννήθην Ρωμαίος.",
        29: "Ευθύς λοιπόν απεσύρθησαν απ' αυτού οι μέλλοντες να βασανίσωσιν αυτόν. Και ο χιλίαρχος έτι εφοβήθη γνωρίσας ότι είναι Ρωμαίος, και διότι είχε δέσει αυτόν.",
        30: 'Τη δε επαύριον θέλων να μάθη το βέβαιον, περί τίνος κατηγορείται παρά των Ιουδαίων, έλυσεν αυτόν από των δεσμών, και προσέταξε να έλθωσιν οι αρχιερείς και όλον το συνέδριον αυτών και καταβιβάσας τον Παύλον, έστησεν έμπροσθεν αυτών.',
    },
    23: {
    ...
    26: {
        ...
        18: 'διά να ανοίξης τους οφθαλμούς αυτών, ώστε να επιστρέψωσιν από του σκότους εις το φως και από της εξουσίας του Σατανά προς τον Θεόν, διά να λάβωσιν άφεσιν αμαρτιών και κληρονομίαν μεταξύ των ηγιασμένων διά της εις εμέ πίστεως.',
        ...
        28: "Και ο Αγρίππας είπε προς τον Παύλον· Παρ' ολίγον με πείθεις να γείνω Χριστιανός.",
        ...
        32: 'Ο δε Αγρίππας είπε προς τον Φήστον· Ο άνθρωπος ούτος ηδύνατο να απολυθή, εάν δεν είχεν επικαλεσθή τον Καίσαρα.',
    },
    27: {
