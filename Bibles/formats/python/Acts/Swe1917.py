...
CHAPTERS = {
    ...
    8: {
        ...
        40: 'Men Filippus blev efteråt sedd i Asdod. Därefter vandrade han omkring och förkunnade evangelium i alla städer, till dess han kom till Cesarea. [1] V. 37 se Nya testamentets text i Ordförkl.',
    },
    9: {
        1: 'Men Saulus, som alltjämt andades hot och mordlust mot Herrens lärjungar, gick till översteprästen',
        2: 'och utbad sig av honom brev till synagogorna i Damaskus, för att, om han funne några som voro på »den vägen»[1], vare sig män eller kvinnor, han skulle kunna föra dem bundna till Jerusalem.',
        ...
        36: 'I Joppe bodde då en lärjunginna vid namn Tabita (det betyder detsamma som Dorkas).[2] Hon överflödade i goda gärningar och gav allmosor rikligen.',
        ...
        43: 'Därefter stannade han en längre tid i Joppe hos en garvare vid namn Simon. [1] Se Väg i Ordförkl. [2] Båda namnen betyda hind; det förra är ett arameiskt ord, det senare ett grekiskt.',
    },
    10: {
        1: 'I Cesarea bodde en man vid namn Kornelius, en hövitsman vid den så kallade italiska krigsskaran.',
        2: 'Han var en from man, som »fruktade Gud»[1] tillika med hela sitt hus; han utdelade rikligen allmosor åt folket och bad alltid till Gud.',
        ...
        48: 'Och så bjöd han att man skulle döpa dem i Jesu Kristi namn. Därefter bådo de honom att han skulle stanna hos dem några dagar. [1] Se Frukta Gud i Ordförkl.',
    },
    11: {
    ...
    13: {
        1: "I den församling som fanns i Antiokia verkade nu såsom profeter och lärare Barnabas och Simeon, som kallades Niger, och Lucius från Cyrene, så ock Manaen, landsfursten Herodes' fosterbroder[1], och Saulus.",
        ...
        16: "Då stod Paulus upp och gav tecken med handen och sade: »I män av Israels hus och I som 'frukten Gud'[2], hören mig.",
        ...
        52: 'Och lärjungarna uppfylldes alltmer av glädje och helig ande. [1] Se Fosterbroder i Ordförkl. [2] Se Frukta Gud i Ordförkl.',
    },
    14: {
    ...
    15: {
        ...
        41: 'och färdades genom Syrien och Cilicien och styrkte församlingarna. [1] V. 34 se Nya testamentets text i Ordförkl.',
    },
    16: {
        ...
        14: 'Och en kvinna som »fruktade Gud»[1], en purpurkrämerska från staden Tyatira, vid namn Lydia, lyssnade till samtalet; och Herren öppnade hennes hjärta, så att hon aktade på det som Paulus talade.',
        ...
        40: 'När de så hade kommit ut ur fängelset, begåvo de sig hem till Lydia. Och sedan de där hade träffat bröderna och talat förmaningens ord till dem, drogo de vidare. [1] Se Frukta Gud i Ordförkl.',
    },
    17: {
        ...
        4: 'Och några av dem läto övertyga sig och slöto sig till Paulus och Silas; så gjorde ock en stor hop greker som »fruktade Gud»[1], likaså ganska många av de förnämsta kvinnorna.',
        ...
        34: 'Dock slöto sig några män till honom och kommo till tro. Bland dessa var Dionysius, han som tillhörde Areopagens domstol, så ock en kvinna vid namn Damaris och några andra jämte dem. [1] Se Frukta Gud i Ordförkl.',
    },
    18: {
        ...
        7: 'Och han gick därifrån och tog in hos en man vid namn Titius Justus, som »fruktade Gud»[1]; denne hade sitt hus invid synagogan.',
        ...
        25: "Denne sade blivit undervisad om »Herrens väg»[2] och talade, brinnande i anden, och undervisade grundligt om Jesus, fastän han allenast hade kunskap om Johannes' döpelse.",
        ...
        28: 'Ty med stor kraft vederlade han judarna offentligen och bevisade genom skrifterna att Jesus var Messias. [1] Se Frukta Gud i Ordförkl. [2] Se Väg i Ordförkl.',
    },
    19: {
        ...
        9: "Men när några av dem förhärdade sig och voro ohörsamma och inför menigheten talade illa om »den vägen»[1], vände han sig ifrån dem och avskilde lärjungarna och samtalade sedan dagligen med dessa i Tyrannus' lärosal.",
        ...
        19: 'Och ganska många av dem som hade övat vidskepliga konster samlade ihop sina böcker och brände upp dem i allas åsyn. Och när man räknade tillsammans vad böckerna voro värda, fann man att värdet uppgick till femtio tusen silverpenningar[2].',
    ...
    21: {
        ...
        38: "Är du då icke den egyptier som för en tid sedan ställde till 'dolkmännens'[1] uppror, de fyra tusens, och förde dem ut i öknen?»",
        ...
        40: 'Och han tillstadde honom det. Då gav Paulus från trappan, där han stod, med handen ett tecken åt folket. Och sedan där hade blivit helt tyst, talade han till dem på hebreiska[2] och sade: [1] Se Dolkmän i Ordförkl.',
    },
    22: {
        ...
        4: "Jag förföljde 'den vägen'[1] ända till döds, och både män och kvinnor lät jag binda och sätta i fängelse;",
        ...
        30: 'Då han emellertid ville få säkert besked om varför Paulus anklagades av judarna, låt han dagen därefter taga av honom bojorna och bjöd översteprästerna och hela Stora rådet att komma tillsammans. Sedan lät han föra Paulus ditned och ställde honom inför dem. [1] Se Väg i Ordförkl.',
    },
    23: {
    ...
    24: {
        ...
        14: "Men det bekänner jag för dig att jag, i enlighet med 'den vägen'[2], vilken de kalla en partimening, så tjänar mina fäders Gud, att jag tror allt vad som är skrivet i lagen och i profeterna,",
        ...
        22: 'Men Felix, som mycket väl kände till »den vägen»[3], uppsköt målet och sade: »När översten Lysias kommer hit ned, vill jag undersöka eder sak.»',
        ...
        27: 'När två år voro förlidna, fick Felix till efterträdare Porcius Festus. Och eftersom Felix ville göra judarna sig bevågna, lämnade han Paulus kvar i fängelset. [1] V. 7 se Nya testamentets text i Ordförkl. [2] Se Väg i Ordförkl. [3] Se Väg i Ordförkl.',
    },
    25: {
    ...
    27: {
        ...
        9: 'Härunder hade ganska lång tid hunnit förflyta, och sjöfarten begynte redan vara osäker; fastedagen[1] var nämligen redan förbi. Paulus varnade dem då',
        ...
        44: 'och att därefter de övriga skulle giva sig ut, somliga på plankor, andra på spillror av skeppet. Så lyckades det för alla att komma välbehållna i land. [1] Se Fastedagen i Ordförkl.',
    },
    28: {
        ...
        28: 'Det mån I därför veta: till hedningarna bar denna Guds frälsning blivit sänd; de skola ock akta därpå.»[1]',
        30: 'I två hela år bodde han sedan kvar i en bostad som han själv hade hyrt. Och alla som kommo till honom tog han emot;',
        31: 'och han predikade om Guds rike och undervisade om Herren Jesus Kristus med all frimodighet, utan att någon hindrade honom däri. [1] 29; Och då han hade sagt detta, gingo judarna bort. Och de tvistade häftigt sinsemellan.',
    },
}
