...
CHAPTERS = {
    ...
    27: {
        1: 'A gdy postanowiono, że mamy płynąć do Italii, oddano Pawła i innych więźniów setnikowi, imieniem Juliusz, z oddziału Augusta.',
        ...
        14: 'Lecz niedługo potem uderzył na nią gwałtowny wiatr, zwany Eurokludon.',
        ...
        34: 'Dlatego proszę was, abyście się posilili, bo to przyczyni się do waszego ocalenia, gdyż żadnemu z was włos z głowy nie spadnie.',
        35: 'A to powiedziawszy, wziął chleb i podziękował Bogu wobec wszystkich, a gdy złamał, zaczął jeść.',
