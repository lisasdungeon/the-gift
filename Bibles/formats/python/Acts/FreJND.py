...
CHAPTERS = {
    ...
    4: {
        ...
        4: 'Mais plusieurs de ceux qui avaient entendu la parole crurent; et le nombre des hommes se monta à environ 5 000.',
        ...
        22: 'Car l’homme en qui avait été faite cette miraculeuse guérison, avait plus de 40 ans.',
        ...
        26: 'Les rois de la terre se sont trouvés là, et les chefs se sont réunis ensemble, contre le ✶Seigneur et contre son Christ ».',
        ...
        32: 'Et la multitude de ceux qui avaient cru était un cœur et une âme; et nul ne disait d’aucune des choses qu’il possédait, qu’elle soit à lui; mais toutes choses étaient communes entre eux.',
    ...
    6: {
        ...
        11: 'Alors ils subornèrent des hommes qui disaient: Nous l’avons entendu proférant des paroles blasphématoires contre Moïse et contre Dieu.',
    ...
    14: {
        ...
        3: 'Ils séjournèrent donc là assez longtemps, parlant hardiment, [appuyés] sur le Seigneur, qui rendait témoignage à la parole de sa grâce, accordant que des miracles et des prodiges se fassent par leurs mains.',
    ...
    15: {
        ...
        7: 'Et une grande discussion ayant eu lieu, Pierre se leva et leur dit: Hommes frères, vous savez vous-mêmes que, dès les jours anciens, Dieu m’a choisi entre vous, afin que par ma bouche les nations entendent la parole de l’évangile, et qu’elles croient.',
        ...
        17: 'en sorte que le résidu des hommes recherche le ✶Seigneur, et toutes les nations sur lesquelles mon nom est réclamé, dit le ✶Seigneur, qui fait ces choses »',
        ...
        24: 'Comme nous avons entendu dire que quelques-uns qui sont sortis d’entre nous, vous ont troublés par des discours, bouleversant vos âmes, [disant qu’il faut être circoncis et garder la loi], (auxquels nous n’avons donné aucun ordre,)',
    ...
    17: {
        ...
        3: 'expliquant et exposant qu’il fallait que le Christ souffre et qu’il ressuscite d’entre les morts; – et [disant], que celui-ci, Jésus, que moi je vous annonce, est le Christ.',
        ...
        21: 'Or tous les Athéniens et les étrangers séjournant [à Athènes], ne passaient leur temps à autre chose qu’à dire ou à écouter quelque nouvelle.',
        22: 'Mais Paul, se tenant au milieu de l’Aréopage, dit: Hommes athéniens, je vois qu’en toutes choses vous êtes voués au culte des divinités;',
        ...
        32: 'Mais quand ils entendirent parler de la résurrection des morts, les uns s’en moquaient, et les autres disaient: Nous t’entendrons encore sur ce sujet.',
    ...
    19: {
        ...
        40: 'car nous sommes en danger d’être accusés de sédition pour ce qui s’est passé aujourd’hui, puisqu’il n’y a pas de motif que nous puissions alléguer pour rendre raison de cet attroupement. Et quand il eut dit ces choses, il congédia l’assemblée.',
    },
    20: {
        ...
        6: 'Et pour nous, nous sommes partis à force de voiles, de Philippes, après les jours des pains sans levain, et nous sommes arrivés au bout de cinq jours auprès d’eux dans la Troade, et nous y avons séjourné sept jours.',
        ...
        13: 'Or pour nous, ayant pris les devants sur un navire, nous avons fait voile vers Assos où nous devions prendre Paul à bord; car il l’avait ainsi ordonné, étant dans l’intention d’aller lui-même à pied.',
        14: 'Et lorsqu’il nous eut rejoints à Assos, nous l’avons pris à bord, et nous sommes allés à Mitylène.',
        15: 'Et ayant fait voile de là, nous sommes arrivés le lendemain à la hauteur de Chios; et le jour suivant nous avons touché à Samos; et, nous étant arrêtés à Trogylle, nous sommes venus le jour d’après à Milet;',
        ...
        18: 'et quand ils furent venus vers lui, il leur dit: Vous savez de quelle manière je me suis conduit envers vous tout le temps, depuis le premier jour où je suis entré en Asie,',
        ...
        20: 'comment je n’ai rien caché des choses qui étaient profitables, en sorte que je ne vous aie pas prêché et enseigné publiquement et dans les maisons,',
        ...
        22: 'Et maintenant, voici, étant lié dans mon esprit, je m’en vais à Jérusalem, ignorant les choses qui doivent m’y arriver,',
    ...
    23: {
        ...
        5: 'Et Paul dit: Je ne savais pas, frères, que c’était le souverain sacrificateur; car il est écrit: « Tu ne diras pas du mal du chef de ton peuple ».',
        ...
        10: 'Et un grand tumulte s’étant élevé, le chiliarque, craignant que Paul ne soit mis en pièces par eux, commanda à la troupe de descendre et de l’enlever du milieu d’eux et de le conduire à la forteresse.',
        ...
        12: 'Et quand le jour fut venu, les Juifs s’unirent et s’obligèrent par un serment d’exécration, disant qu’ils ne mangeraient ni ne boiraient jusqu’à ce qu’ils aient tué Paul.',
        13: 'Et ils étaient plus de 40 qui avaient fait cette conjuration.',
        ...
        21: 'Toi donc n’y consens pas, car plus de 40 hommes d’entre eux lui dressent un guet-apens, lesquels se sont obligés par un serment d’exécration de ne manger ni ne boire jusqu’à ce qu’ils l’aient tué; et ils sont maintenant prêts, attendant de toi la promesse.',
        22: 'Le chiliarque donc renvoya le jeune homme, lui ayant enjoint de ne divulguer à personne qu’il lui avait déclaré ces choses.',
        23: 'Et ayant appelé deux des centurions, il dit: Préparez 200 soldats pour aller à Césarée, et 70 cavaliers, et 200 porte-lances, dès la troisième heure de la nuit;',
        ...
        29: 'et j’ai trouvé qu’il était accusé touchant des questions de leur loi, mais qu’il n’était sous le coup d’aucune accusation qui mérite la mort ou les liens.',
        ...
        35: 'Je t’entendrai à fond, dit-il, quand tes accusateurs aussi seront arrivés. Et il donna ordre qu’il soit gardé au prétoire d’Hérode.',
    },
    24: {
