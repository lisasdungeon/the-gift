...
CHAPTERS = {
    1: {
        ...
        7: 'Er sprach aber zu ihnen: Es ist nicht eure Sache, Zeit oder Zeiten zu wissen, die der Vater in seine eigene Gewalt gesetzt hat.',
        ...
        15: 'Und in diesen Tagen stand Petrus in der Mitte der Brüder auf und sprach:',
    ...
    3: {
        ...
        8: 'Und aufspringend stand er und wandelte; und er ging mit ihnen in den Tempel, wandelnd und springend und Gott lobend.',
    ...
    4: {
        ...
        36: 'Joseph aber, der von den Aposteln Barnabas zubenamt wurde, ein Levit, ein Cyprier von Geburt,',
    ...
    5: {
        ...
        17: 'Der Hohepriester aber stand auf und alle, die mit ihm waren, das ist die Sekte der Sadducäer, und wurden von Eifersucht erfüllt;',
        ...
        28: 'und sprach: Wir haben euch strenge geboten, in diesem Namen nicht zu lehren, und siehe, ihr habt Jerusalem erfüllt mit eurer Lehre und wollt das Blut dieses Menschen auf uns bringen.',
    ...
    7: {
        ...
        2: 'Er aber sprach: Brüder und Väter, höret! Der Gott der Herrlichkeit erschien unserem Vater Abraham, als er in Mesopotamien war, ehe er in Haran wohnte,',
        ...
        9: 'Und die Patriarchen, neidisch auf Joseph, verkauften ihn nach Ägypten. Und Gott war mit ihm',
    ...
    12: {
        ...
        3: 'Und als er sah, daß es den Juden gefiel, fuhr er fort, auch Petrus festzunehmen,',
        ...
        19: 'Als aber Herodes nach ihm verlangte und ihn nicht fand, zog er die Wächter zur Untersuchung und befahl sie abzuführen; und er ging von Judäa nach Cäsarea hinab und verweilte daselbst.',
    ...
    13: {
        ...
        8: 'Elymas aber, der Zauberer, widerstand ihnen und suchte den Prokonsul von dem Glauben abwendig zu machen.',
        ...
        22: 'Und nachdem er ihn weggetan hatte, erweckte er ihnen David zum König, welchem er auch Zeugnis gab und sprach: "Ich habe David gefunden, den Sohn Jesses, einen Mann nach meinem Herzen, der meinen ganzen Willen tun wird".',
    ...
    14: {
        ...
        13: 'Der Priester des Zeus aber, welcher vor der Stadt war, brachte Stiere und Kränze an die Tore und wollte mit der Volksmenge opfern.',
        ...
        15: 'und sprachen: Männer, warum tut ihr dieses? Auch wir sind Menschen von gleichen Empfindungen wie ihr und verkündigen euch, daß ihr euchb von diesen nichtigen Götzen bekehren sollt zu dem lebendigen Gott, welcher den Himmel und die Erde und das Meer gemacht hat und alles, was in ihnen ist;',
    ...
    15: {
        ...
        3: 'Sie nun, nachdem sie von der Versammlung das Geleit erhalten hatten, durchzogen Phönizien und Samaria und erzählten die Bekehrung derer aus den Nationen; und sie machten allen Brüdern große Freude.',
        ...
        20: 'sondern ihnen schreibe, daß sie sich enthalten von den Verunreinigungen der Götzen und von der Hurerei und vom Erstickten und vom Blute.',
    ...
    16: {
        ...
        13: 'Und am Tage des Sabbaths gingen wir hinaus vor das Tor an einen Fluß, wo es gebräuchlich war, das Gebet zu verrichten; und wir setzten uns nieder und redeten zu den Weibern, die zusammengekommen waren.',
        ...
        15: 'Als sie aber getauft worden war und ihr Haus, bat sie und sagte: Wenn ihr urteilet, daß ich dem Herrn treu sei, so kehret in mein Haus ein und bleibet. Und sie nötigte uns.',
        ...
        19: 'Als aber ihre Herren sahen, daß die Hoffnung ihres Gewinnes dahin war, griffen sie Paulus und Silas und schleppten sie auf den Markt zu den Vorstehern.',
        ...
        21: 'und verkündigen Gebräuche, die uns nicht erlaubt sind anzunehmen noch zu tun, da wir Römer sind.',
        ...
        40: 'Als sie aber aus dem Gefängnis herausgegangen waren, gingen sie zu der Lydia; und als sie die Brüder gesehen hatten, ermahnten sie sie und gingen weg.',
    },
    17: {
        ...
        22: 'Paulus aber stand mitten auf dem Areopag und sprach: Männer von Athen, ich sehe, daß ihr in jeder Beziehung den Götzen sehr ergeben seid.',
    ...
    18: {
        ...
        2: 'Und als er einen gewissen Juden fand, mit Namen Aquila, aus Pontus gebürtig, der kürzlich aus Italien gekommen war, und Priscilla, sein Weib,, ging er zu ihnen,',
    ...
    19: {
        ...
        21: 'Als dies aber erfüllt war, setzte sich Paulus in seinem Geiste vor, nachdem er Macedonien und Achaja durchzogen habe, nach Jerusalem zu reisen, und sprach: Nachdem ich dort gewesen bin, muß ich auch Rom sehen.',
    ...
    20: {
        ...
        3: 'Und nachdem er sich drei Monate aufgehalten hatte und von den Juden ein Anschlag gegen ihn geschehen war, als er nach Syrien abfahren wollte, ward er des Sinnes, durch Macedonien zurückzukehren.',
        ...
        11: 'Und als er hinaufgestiegen war und das Brot gebrochen und gegessen und lange bis zum Anbruch des Tages geredet hatte, reiste er also ab.',
    ...
    21: {
        ...
        13: 'Paulus aber antwortete: Was machet ihr, daß ihr weinet und mir das Herz brechet? Denn ich bin bereit, nicht allein gebunden zu werden, sondern auch in Jerusalem für den Namen des Herrn Jesu zu sterben.',
        ...
        21: 'Sie sind aber über dich berichtet worden, daß du alle Juden, die unter den Nationen sind, Abfall von Moses lehrest und sagest, sie sollen die Kinder nicht beschneiden, noch nach den Gebräuchen wandeln.',
        ...
        24: 'Diese nimm zu dir und reinige dich mit ihnen und trage die Kosten für sie, damit sie das Haupt scheren lassen; und alle werden erkennen, daß nichts an dem ist, wessen sie über dich berichtet sind, sondern daß du selbst auch in der Beobachtung des Gesetzes wandelst.',
        ...
        36: 'denn die Menge des Volkes folgte und schrie: Hinweg mit ihm!',
    ...
    22: {
        ...
        3: 'Ich bin ein jüdischer Mann, geboren zu Tarsus in Cilicien; aber auferzogen in dieser Stadt zu den Füßen Gamaliels, unterwiesen nach der Strenge des väterlichen Gesetzes, war ich, wie ihr alle heute seid, ein Eiferer für Gott;',
        ...
        17: 'Es geschah mir aber, als ich nach Jerusalem zurückgekehrt war und in dem Tempel betete, daß ich in Entzückung geriet',
    ...
    23: {
        ...
        6: 'Da aber Paulus wußte, daß der eine Teil von den Sadducäern, der andere aber von den Pharisäern war, rief er in dem Synedrium: Brüder, ich bin ein Pharisäer, ein Sohn von Pharisäern; wegen der Hoffnung und Auferstehung der Toten werde ich gerichtet.',
        ...
        17: 'Paulus aber rief einen von den Hauptleuten zu sich und sagte: Führe diesen Jüngling zu dem Obersten, denn er hat ihm etwas zu melden.',
        18: 'Der nun nahm ihn zu sich und führte ihn zu dem Obersten und sagt: Der Gefangene Paulus rief mich herzu und bat mich, diesen Jüngling zu dir zu führen, der dir etwas zu sagen habe.',
        19: 'Der Oberste aber nahm ihn bei der Hand und zog sich mit ihm besonders zurück und fragte: Was ist es, das du mir zu melden hast?',
        20: 'Er aber sprach: Die Juden sind übereingekommen, dich zu bitten, daß du morgen den Paulus in das Synedrium hinabbringest, als wollest du etwas Genaueres über ihn erkunden.',
        21: 'Du nun, laß dich nicht von ihnen überreden, denn mehr als vierzig Männer von ihnen stellen ihm nach, welche sich verflucht haben, weder zu essen noch zu trinken, bis sie ihn umgebracht haben; und jetzt sind sie bereit und erwarten die Zusage von dir.',
        22: 'Der Oberste nun entließ den Jüngling und befahl ihm: Sage niemandem, daß du mir dies angezeigt hast.',
        23: 'Und als er zwei von den Hauptleuten herzugerufen hatte, sprach er: Machet zweihundert Kriegsknechte bereit, damit sie bis Cäsarea ziehen, und siebzig Reiter und zweihundert Lanzenträger, von der dritten Stunde der Nacht an.',
        24: 'Und sie sollten Tiere bereit halten, auf daß sie den Paulus darauf setzten und sicher zu Felix, dem Landpfleger, hinbrächten.',
        ...
        33: 'Und als diese nach Cäsarea gekommen waren, übergaben sie dem Landpfleger den Brief und stellten ihm auch den Paulus dar.',
        34: 'Als er es aber gelesen und gefragt hatte, aus welcher Provinz er sei, und erfahren, daß er aus Cilicien sei,',
    ...
    25: {
        ...
        23: 'Als nun des folgenden Tages Agrippa und Bernice mit großem Gepränge gekommen und in den Verhörsaal eingetreten waren, mit den Obersten und den vornehmsten Männern der Stadt, und Festus Befehl gegeben hatte, wurde Paulus vorgeführt.',
    ...
    26: {
        ...
        5: 'die mich von der ersten Zeit her kennen, daß ich nach der strengsten Sekte unserer Religion, als Pharisäer, lebte.',
        ...
        9: 'Ich meinte freilich bei mir selbst, gegen den Namen Jesu, des Nazaräers, viel Widriges tun zu müssen,',
        10: 'was ich auch in Jerusalem getan habe; und viele der Heiligen habe ich in Gefängnisse eingeschlossen, nachdem ich von den Hohenpriestern die Gewalt empfangen hatte; und wenn sie umgebracht wurden, so gab ich meine Stimme dazu.',
        ...
        13: 'sah ich mitten am Tage auf dem Wege, o König, vom Himmel her ein Licht, das den Glanz der Sonne übertraf, welches mich und die mit mir reisten umstrahlte.',
        ...
        29: 'Paulus aber sprach: Ich wollte zu Gott, daß über kurz oder lang nicht allein du, sondern auch alle, die mich heute hören, solche würden, wie auch ich bin, ausgenommen diese Bande.',
    ...
    27: {
        ...
        9: 'Da aber viel Zeit verflossen und die Fahrt schon unsicher war, weil auch die Fasten schon vorüber waren, ermahnte Paulus',
        10: 'und sprach zu ihnen: Männer, ich sehe, daß die Fahrt mit Ungemach und großem Schaden, nicht nur der Ladung und des Schiffes, sondern auch unseres Lebens geschehen wird.',
        ...
        15: 'Als aber das Schiff mit fortgerissen wurde und dem Winde nicht zu widerstehen vermochte, gaben wir uns preis und trieben dahin.',
    ...
    28: {
        ...
        7: 'In der Umgebung jenes Ortes aber besaß der Erste der Insel, mit Namen Publius, Ländereien; der nahm uns auf und beherbergte uns drei Tage freundlich.',
        ...
        10: 'diese ehrten uns auch mit vielen Ehren, und als wir abfuhren, luden sie uns auf, was uns nötig war.',
        ...
        16: 'Als wir aber nach Rom kamen, überlieferte der Hauptmann die Gefangenen dem Oberbefehlshaber; aber dem Paulus wurde erlaubt, mit dem Kriegsknechte, der ihn bewachte, für sich zu bleiben.',
        ...
        25: 'Als sie aber unter sich uneins waren, gingen sie weg, als Paulus ein Wort sprach: Trefflich hat der Heilige Geist durch Jesaias, den Propheten, zu unseren Vätern geredet',
