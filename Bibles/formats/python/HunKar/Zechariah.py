...
CHAPTERS = {
    ...
    11: {
        ...
        5: 'A melyeket leölnek az ő tulajdonosaik, a nélkül, hogy bűnnek tartanák, eladóik pedig ezt mondják: Áldott az Úr, mert meggazdagodtam! és pásztoraik sem kimélik őket.',
        ...
        16: 'Mert ímé, én pásztort állítok e földre, a ki az elveszetteket meg nem keresi, a gyöngével nem törődik, a megtépettet meg nem gyógyítja, a jó karban levőt nem táplálja, a kövérinek húsát megeszi, és körmeiket széttördeli.',
    ...
    12: {
        ...
        5: 'És azt mondják szívökben Júda fejedelmei: Az én erősségem Jeruzsálemnek lakói, az ő Istenökkel, a Seregek Urával.',
