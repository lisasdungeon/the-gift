...
CHAPTERS = {
    ...
    3: {
        ...
        30: 'Akkor a király nagy tisztességre emelé Sidrákot, Misákot és Abednégót Babilon tartományában. Nabukodonozor király minden népnek, nemzetnek és nyelveknek, a kik az egész földön lakoznak, mondá: Békességetek bőséges legyen! A jeleket és csudákat, a melyeket cselekedett velem a felséges Isten, illendő dolognak tartom megjelenteni. Mely nagyok az ő jelei és mely hatalmasak az ő csudái! az ő országa örökkévaló ország és az ő uralkodása nemzedékről nemzedékre száll.',
    },
    4: {
        ...
        4: 'Akkor bejövének az írástudók, varázslók, Káldeusok és jövendőmondók; és én elbeszélém nékik az álmot, de az értelmét nem jelentették meg nékem.',
        ...
        6: 'Baltazár, az írástudók elseje, tudom, hogy a szent isteneknek lelke van benned, és semmi titok sem homályos előtted, az én álmom látásait, a miket láttam, és azoknak jelentését beszéld el.',
        ...
        16: 'Ekkor Dániel, a kinek neve Baltazár, közel egy óráig rémüldözék, és az ő gondolatai háboríták őt. Szóla a király, és monda: Baltazár, az álom és annak jelentése meg ne rettentsenek téged! Felele Baltazár, és monda: Uram, az álom szálljon a te gyűlölőidre, a magyarázata pedig a te ellenségeidre!',
        ...
        27: 'Szóla a király és mondá: Nem ez-é ama nagy Babilon, a melyet én építettem királyság házának, az én hatalmasságom ereje által és dicsőségem tisztességére?',
        28: 'Még a szó a király szájában volt, a mikor szózat szálla le az égből: Néked szól, oh Nabukodonozor király, a birodalom elvétetett tőled.',
        29: 'És kivetnek téged az emberek közül, és a mezei barmokkal lesz a lakozásod, és füvet adnak enned, mint az ökröknek, és hét idő múlik el feletted, a míg megesméred, hogy a felséges Isten uralkodik az emberek birodalmán, és annak adja azt, a kinek akarja.',
        ...
        31: 'És az idő elteltével én, Nabukodonozor, szemeimet az égre emelém, és az én értelmem visszajöve, és áldám a felséges Istent, és dícsérém és dicsőítém az örökké élőt, kinek hatalma örökkévaló hatalom és országa nemzedékről-nemzedékre áll.',
        32: 'És a föld minden lakosa olyan mint a semmi; és az ő akaratja szerint cselekszik az ég seregében és a föld lakosai között, és nincs, a ki az ő kezét megfoghatná és ezt mondaná néki: Mit cselekedtél?',
        33: 'Abban az időben visszatére hozzám az én értelmem, és országom dicsőségére az én ékességem, és méltóságom is visszatére hozzám, és az én tanácsosaim és főembereim fölkeresének engem, és visszahelyeztettem az én országomba, és rendkívüli nagyság adatott nékem.',
        34: 'Most azért én, Nabukodonozor, dicsérem, magasztalom és dicsőítem a mennyei királyt: mert minden cselekedete igazság, és az ő utai ítélet, és azokat, a kik kevélységben járnak, megalázhatja.',
    },
    5: {
    ...
    7: {
        ...
        10: 'Tűzfolyam foly és jő vala ki az ő színe felől; ezerszer ezeren szolgálának néki, és tízezerszer tízezeren állának előtte; ítélők ülének le, és könyvek nyittatának meg.',
        ...
        22: 'Mígnem eljöve az öreg korú, és az ítélet adaték a magasságos egek szenteinek; és az idő eljöve, és elvevék az országot a szentek.',
    ...
    8: {
        1: 'Belsazár király uralkodásának harmadik esztendejében látomás jelenék meg nékem, Dánielnek, annak utánna, a mely először jelent meg nékem.',
        ...
        6: 'És méne a kétszarvú koshoz, a melyet láték állani a folyam előtt; és feléje futa erejének indulatában.',
        7: 'És látám a koshoz érni; és néki dühödött és leüté a kost, és letöré két szarvát, és nem vala erő a kosban megállani előtte, és leüté a földre és megtapodá, és nem vala a kosnak senkije, a ki őt megmentse annak kezéből.',
        ...
        13: 'És hallék egy szentet szólni; és monda egyik szent annak, a ki szól vala: Meddig tart e látomás a mindennapi áldozat és a pusztító vétek felől? s a szent hely és a sereg meddig tapostatik?',
