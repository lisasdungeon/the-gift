...
CHAPTERS = {
    ...
    5: {
        ...
        12: 'Et l’ange dit: Je suis Azarias, fils du grand Ananias, l’un de tes frères.',
    ...
    6: {
        ...
        17: 'Et le démon en sentira l’odeur, et il s’enfuira, et il ne reviendra plus dans les siècles des siècles; lorsque tu viendras ensuite auprès de ta femme, restez levés tous les deux, et criez au Dieu de miséricorde, et il vous sauvera, et il aura compassion de vous. N’aie point crainte, elle t’est de tout temps destinée, et tu la sauveras, et elle te suivra, et j’espère que tu auras d’elle des enfants. Et, en entendant ces paroles, Tobie aima Sara, et son cœur s’attacha vivement à elle, et il entra dans Ecbatane.',
    },
    7: {
    ...
    13: {
        ...
        11: 'Nombre de nations lointaines viendront vers le nom du Seigneur Dieu, portant en leurs mains des présents, des présents pour le Roi du ciel; les générations des générations te causeront des transports d’allégresse.',
        ...
        18: 'Et toutes ses rues diront: Alleluia, louange à Dieu, et elles répéteront: Béni soit le Dieu qui a exalté tous les siècles!',
    },
    14: {
        ...
        6: 'Et tous les Gentils se convertiront sincèrement à la crainte du Seigneur Dieu, et ils enfouiront leurs idoles.',
