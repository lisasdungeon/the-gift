...
CHAPTERS = {
    1: {
        ...
        12: 'bien que tous les autres mangeassent des mets des païens, il garda son âme pure, et jamais il ne se souilla par leurs viandes.',
    ...
    4: {
        ...
        3: 'Lorsque Dieu aura reçu mon âme, mets mon corps en terre. Tu honoreras ta mère tous les jours de sa vie;',
    ...
    6: {
        ...
        19: 'La première nuit, livre au feu le foie du poisson, et le démon s\'enfuira. La seconde nuit, tu seras admis dans la société des saints patriarches. La troisième nuit, tu recevras la bénédiction promise à leur postérité, afin qu\'il naisse de vous des enfants pleins de vigueur. La troisième nuit passée, tu prendras la jeune fille dans la crainte du Seigneur, guidé bien plus par le désir d\'avoir des enfants que par la passion, afin que tu obtiennes dans tes enfants la bénédiction promise à la race d\'Abraham. "',
    },
    7: {
    ...
    11: {
        ...
        4: 'Tobie ayant approuvé ce dessein, Raphaël lui dit: " Prends avec toi du fiel du poisson, car tu en auras besoin. " Tobie prit de ce fiel, et ils partirent.',
    ...
    13: {
        1: 'Le vieux Tobie, ouvrant la bouche, bénit le Seigneur en disant: " Vous êtes grand, Seigneur, dans l\'éternité, et votre règne s\'étend à tous les siècles.',
    ...
    14: {
        ...
        15: "Il les trouva bien portants dans une heureuse vieillesse; il eut soin d'eux et il leur ferma les yeux; il recueillit tout l'héritage de la maison de Raguel, et il vit les enfants de ses enfants jusqu'à la cinquième génération. Après qu'il eut vécu quatre-vingt-dix-neuf ans dans la crainte du Seigneur, ses enfants l'inhumèrent avec joie. Tous ceux de sa parenté et tous ses descendants persévérèrent dans une bonne vie et une sainte conduite, en sorte qu'ils furent aimés de Dieu et des hommes, et de tous ceux qui habitaient le pays.",
    },
}
