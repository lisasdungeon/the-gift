NAME = 'RNKJV: Restored Name King James Version'
BOOK = 'III John'
...
CHAPTERS = {
    1: {
        ...
        6: 'Which have borne witness of thy charity before the assembly: whom if thou bring forward on their journey worthily of Elohim, thou shalt do well:',
        ...
        11: 'Beloved, follow not that which is evil, but that which is good. He that doeth good is of יהוה: but he that doeth evil hath not seen יהוה.',
