...
CHAPTERS = {
    ...
    4: {
        ...
        3: 'Sammalunda höllos ock vi, när vi voro barn, i träldom under världens »makter»[1].',
        ...
        31: 'Alltså, mina bröder, vi äro icke barn av en tjänstekvinna, utan av den fria hustrun. [1] Se Makter i Ordförkl.',
    },
    5: {
