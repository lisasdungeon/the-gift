...
CHAPTERS = {
    ...
    2: {
        ...
        19: 'For I, through law, have died to law, that I may live toGod.',
        20: 'I am crucified with Christ, and no longer live, I, but Christ lives in me; but [in] that I now live in flesh, I live by faith, the [faith] of the Son ofGod, who has loved me and given himself for me.',
        21: 'I do not set aside the grace ofGod; for if righteousness [is] by law, then Christ has died for nothing.',
    },
    3: {
        ...
        6: 'Even as Abraham believedGod, and it was reckoned to him as righteousness.',
        7: "Know then that they that are on the principle of faith, these are Abraham's sons;",
        8: 'and the scripture, foreseeing thatGod would justify the nations on the principle of faith, announced beforehand the glad tidings to Abraham: In thee all the nations shall be blessed.',
        ...
        11: 'but that by law no one is justified withGod [is] evident, because The just shall live on the principle of faith;',
        ...
        17: 'Now I say this, A covenant confirmed beforehand byGod, the law, which took place four hundred and thirty years after, does not annul, so as to make the promise of no effect.',
        18: 'For if the inheritance [be] on the principle of law, [it is] no longer on the principle of promise; butGod gave it in grace to Abraham by promise.',
        ...
        20: 'But a mediator is not of one, butGod is one.',
        ...
        26: "for ye are allGod's sons by faith in Christ Jesus.",
    ...
    4: {
        ...
        7: 'So thou art no longer bondman, but son; but if son, heir also throughGod.',
        8: 'But then indeed, not knowingGod, ye were in bondage to those who by nature are notgods;',
        9: 'but now, knowingGod, but rather being known byGod, how do ye turn again to the weak and beggarly principles to which ye desire to be again anew in bondage?',
        ...
        14: 'and my temptation, which [was] in my flesh, ye did not slight nor reject with contempt; but ye received me as an angel ofGod, as Christ Jesus.',
    ...
    6: {
        ...
        16: 'And as many as shall walk by this rule, peace upon them and mercy, and upon the Israel ofGod.',
