...
CHAPTERS = {
    1: {
        ...
        4: 'Kas pats ir nodevies par mūsu grēkiem, ka mūs izrautu no šās tagadējas niknās pasaules pēc mūsu Dieva un Tēva prāta.',
        5: 'Viņam lai ir gods mūžīgi mūžam! Āmen.',
    ...
    6: {
        ...
        8: 'Ja kas sēj uz savu miesu, tas no tās miesas pļaus samaitāšanu; bet kas sēj uz To Garu, tas pļaus no Tā Gara mūžīgu dzīvošanu.',
