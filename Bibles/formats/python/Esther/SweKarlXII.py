...
CHAPTERS = {
    ...
    3: {
        ...
        12: 'Då kallade man Konungens skrifvare, på trettonde dagen i första månadenom; och vardt skrifvet, såsom Haman befallde, till Konungens Förstar och till landshövdingarna, både här och der i landen, och till höfvitsmännerna för hvart folket i landen här och der, efter hvars och ens folks skrift, och efter deras mål, under Konung Ahasveros namn, och med Konungens insegel försegladt.',
        13: 'Och brefven vordo försänd med båd, uti all Konungens land, till att förgöra, dräpa och förlägga alla Judar, både unga och samla, barn och qvinnor, allt på en dag, nämliga på trettonde dagen i tolfte månadenom, det är den månaden Adar; och till att sköfla deras gods.',
    ...
    5: {
        ...
        7: 'Esther svarade, och sade: Min bön och begärar:',
        ...
        11: 'Och förtäljde för dem sina rikedomars härlighet, och sina barnas myckenhet, och huru Konungen hade gjort honom väldigan, och att han upphöja var öfver Konungens Förstar och tjenare.',
    ...
    6: {
        ...
        6: 'Då Haman kom in, sade Konungen till honom: Hvad skall man göra dem månne, som Konungen gerna ära vill? Men Haman tänkte i sitt hjerta: Hvem skulle Konungen gerna vilja göra äro, utan mig?',
        ...
        11: 'Så tog Haman klädningen och hästen, och kläddepå Mardechai, och förde honom på stadsgatone, och ropade framför honom: Så skall man göra dem månne, som Konungen gerna ära vill.',
    ...
    9: {
        ...
        23: 'Och Judarna togo der vid, och gjorde som de begynt hade, och det Mardechai till dem skref;',
