...
CHAPTERS = {
    1: {
        1: 'Het geschiedde nu in de dagen van Ahasveros, (hij is die Ahasveros, dewelke regeerde van Indië af tot aan Morenland toe, honderd zeven en twintig landschappen).',
        ...
        19: 'Indiën het den koning goeddunkt, dat een koninklijk gebod van hem uitga, hetwelk geschreven worde in de wetten der Perzen en Meden, en dat men het niet overtrede: dat Vasthi niet inga voor het aangezicht van den koning Ahasveros, en de koning geve haar koninkrijk aan haar naaste, die beter is dan zij.',
    ...
    2: {
        ...
        5: 'Er was een Joods man op den burg Susan, wiens naam was Mordechai, een zoon van Jaïr, den zoon van Simeï, den zoon van Kis, een man van Jemini;',
        ...
        14: 'Des avonds ging zij daarin, en des morgens ging zij weder naar het tweede huis der vrouwen, onder de hand van Saasgaz, den kamerling des konings, bewaarder der bijwijven, zij kwam niet weder tot den koning, ten ware de koning lust tot haar had, en zij bij name geroepen werd.',
        15: 'Als de beurt van Esther, de dochter van Abichaïl, den oom van Mordechai, (die hij zich ter dochter genomen had) naakte, dat zij tot den koning komen zou, begeerde zij niet met al, dan wat Hegai, des konings kamerling, de bewaarder der vrouwen, zeide; en Esther verkreeg genade in de ogen van allen, die haar zagen.',
    ...
    3: {
        ...
        9: 'Indiën het den koning goeddunkt, laat er geschreven worden, dat men hen verdoe; zo zal ik tien duizend talenten zilvers opwegen in de handen dergenen, die het werk doen, om in des konings schatten te brengen.',
    ...
    5: {
        ...
        4: 'Esther nu zeide: Indiën het den koning goeddunkt, zo kome de koning met Haman heden tot den maaltijd, dien ik hem bereid heb.',
        ...
        8: 'Indiën ik genade gevonden heb in de ogen des konings, en indien het den koning goeddunkt, mij te geven mijn bede, en mijn verzoek te doen, zo kome de koning met Haman tot den maaltijd, dien ik hem bereiden zal; zo zal ik morgen doen naar het bevel des konings.',
    ...
    6: {
        ...
        13: 'En Haman vertelde aan zijn huisvrouw Zeres en al zijn vrienden al wat hem wedervaren was. Toen zeiden hem zijn wijzen, en Zeres, zijn huisvrouw: Indiën Mordechai, voor wiens aangezicht gij hebt begonnen te vallen, van het zaad der Joden is, zo zult gij tegen hem niet vermogen; maar gij zult gewisselijk voor zijn aangezicht vallen.',
    ...
    7: {
        ...
        2: 'Zo zeide de koning tot Esther, ook op den tweeden dag, op den maaltijd des wijns: Wat is uw bede, koningin Esther! en zij zal u gegeven worden; en wat is uw verzoek? Het zal geschieden, ook tot de helft des koninkrijks.',
        3: 'Toen antwoordde de koningin Esther, en zeide: Indiën ik, o koning, genade in uw ogen gevonden heb, en indien het den koning goeddunkt, men geve mij mijn leven, om mijner bede wil, en mijn volk, om mijns verzoeks wil.',
        4: 'Want wij zijn verkocht, ik en mijn volk, dat men ons verdelge, dode en ombrenge. Indiën wij nog tot knechten en tot dienstmaagden waren verkocht geweest, ik zou gezwegen hebben, ofschoon de onderdrukker de schade des konings geenszins zou kunnen vergoeden.',
    ...
    8: {
        ...
        5: 'En zij zeide: Indiën het den koning goeddunkt, en indien ik genade voor zijn aangezicht gevonden heb, en deze zaak voor den koning recht is, en ik in zijn ogen aangenaam ben, dat er geschreven worde, dat de brieven en de gedachte van Haman, den zoon van Hammedatha, den Agagiet, wederroepen worden, welke hij geschreven heeft, om de Joden om te brengen, die in al de landschappen des konings zijn.',
    ...
    9: {
        ...
        29: 'Daarna schreef de koningin Esther, de dochter van Abichaïl, en Mordechai, de Jood, met alle macht, om dezen brief van Purim ten tweeden male te bevestigen.',
    ...
    10: {
        ...
        2: 'Al de werken nu zijner macht en zijns gewelds, en de verklaring der grootheid van Mordechai, denwelken de koning groot gemaakt heeft, zijn die niet geschreven in het boek der kronieken der koningen van Medië en Perzië?',
