...
CHAPTERS = {
    1: {
        ...
        15: 'What shall we do unto the queen Vashti according to law, because she has not performed the commandment of the king Ahasuerus by the chamberlains?',
    ...
    2: {
        ...
        14: "In the evening she went, and on the next day she returned into the second house of the women, to the custody of Shaashgaz, the king's chamberlain, which kept the concubines: she came in unto the king no more, except the king delighted in her, and that she were called by name.",
        ...
        20: 'Esther had not yet showed her kindred nor her people; as Mordecai had charged her: for Esther did the commandment of Mordecai, like when she was brought up with him.',
        21: "In those days, while Mordecai sat in the king's gate, two of the king's chamberlains, Bigthan and Teresh, of those which kept the door, were angry, and sought to lay hands on the king Ahasuerus.",
    ...
    3: {
        ...
        8: "And Haman said unto king Ahasuerus, There is a certain people scattered abroad and dispersed among the people in all the provinces of your kingdom; and their laws are diverse from all people; neither keep they the king's laws: therefore it is not for the king's profit to suffer them.",
    ...
    5: {
        1: "Now it came to pass on the third day, that Esther put on her royal apparel, and stood in the inner court of the king's house, opposite to the king's house: and the king sat upon his royal throne in the royal house, opposite to the gate of the house.",
    ...
    6: {
        ...
        3: "And the king said, What honour and dignity has been done to Mordecai for this? Then said the king's servants that ministered unto him, There is nothing done for him.",
        ...
        11: 'Then took Haman the apparel and the horse, and arrayed Mordecai, and brought him on horseback through the street of the city, and proclaimed before him, Thus shall it be done unto the man whom the king delights to honour.',
    ...
    8: {
        ...
        8: "Write all of you also for the Jews, as it likes you, in the king's name, and seal it with the king's ring: for the writing which is written in the king's name, and sealed with the king's ring, may no man reverse.",
        ...
        17: "And in every province, and in every city, anywhere the king's commandment and his decree came, the Jews had joy and gladness, a feast and a good day. And many of the people of the land became Jews; for the fear of the Jews fell upon them.",
    },
    9: {
        ...
        5: 'Thus the Jews stroke all their enemies with the stroke of the sword, and slaughter, and destruction, and did what they would unto those that hated them.',
        ...
        19: 'Therefore the Jews of the villages, that dwelt in the towns without protective walls, made the fourteenth day of the month Adar a day of gladness and feasting, and a good day, and of sending portions one to another.',
        ...
        31: 'To confirm these days of Purim in their times appointed, according as Mordecai the Jew and Esther the queen had commanded with authority them, and as they had decreed for themselves and for their seed, the matters of the fastings and their cry.',
