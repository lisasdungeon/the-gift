...
CHAPTERS = {
    ...
    14: {
        1: 'Ispaštat će Samarija jer se protiv Boga svoga pobunila. Od mača past će oni, djecu će njihovu smrskati, žene trudne rasporiti.',
        2: 'Vrati se, Izraele, Jahvi Bogu svome, jer zbog svojeg si bezakonja posrnuo.',
        3: 'Uzmite sa sobom riječi i Jahvi se vratite. Recite mu: "Skini sa nas bezakonje i dobrohotno primi da ti prinesemo plod svojih usana.',
        ...
        5: 'Iscijelit ću ih od njihova otpada, od svega ću ih srca ljubiti; jer gnjev se moj odvratio od njih.',
        6: 'Bit ću kao rosa Izraelu; kao ljiljan on će cvasti, pustit će korijen poput jablana,',
        7: 'nadaleko pružat će izdanke. Ljepota će mu biti kao u masline, miris poput libanonskog.',
        8: "Opet će u mojoj sjeni boraviti, uzgajat će svoju pšenicu, vinograde gajit' što će steći ime vina helbonskog.",
        9: 'Efrajime, što ti imaš još s kumirima? Ja sam ga uslišao i pogledao. Ja sam poput zelena čempresa: po meni si rodan plodovima.',
