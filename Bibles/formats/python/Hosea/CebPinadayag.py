...
CHAPTERS = {
    ...
    3: {
        1: 'Ug si Jehova miingon kanako: Lumakaw ka pag-usab, higugmaa ang usa ka babaye nga hinigugma sa iyang higala, ug ang usa ka babayeng mananapaw, bisan maingon sa paghigugma ni Jehova sa mga anak sa Israel, bisan sila molingi ngadto sa laing mga dios, ug mahagugma sa mga sopas nga may pasas.',
        2: 'Busa siya gipalit ko alang kanako sa napulo ug lima ka book nga salapi, ug usa ka omer sa cebada, ug tunga sa omer sa cebada;',
        3: 'Ug ako miingon kaniya: Ikaw magapabilin alang kanako sa daghang mga adlaw; ikaw dili na magapakighilawas, ug ikaw dili na mahimong asawa sa bisan kinsang tawo: busa ingon niana ako alang kanimo.',
        4: 'Kay ang mga anak sa Israel magapabilin sa daghang mga adlaw nga walay hari, ug walay principe, ug walay halad, ug walay haliging-halaran, ug walay ephod kun mga theraphin:',
        5: 'Sa human niana ang mga anak sa Israel mamalik, ug mangita kang Jehova nga ilang Dios, ug kang David nga ilang hari, ug mangadto kang Jehova uban ang kahadlok ug sa iyang pagkaayo sa ulahing mga adlaw.',
    },
    4: {
