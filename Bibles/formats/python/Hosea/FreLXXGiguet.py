...
CHAPTERS = {
    ...
    8: {
        ...
        2: 'Et ils crieront vers moi, en disant: 0 Dieu, nous vous reconnaissons!',
        ...
        12: 'J’avais écrit pour lui une multitude de préceptes; mais ces lois ont été réputées par lui comme étrangères, même les autels qu’il aime.',
        13: 'Aussi quand ils immoleront une victime et en mangeront les chairs, le Seigneur ne les agréera pas. Alors il se souviendra de leur iniquité, et tirera vengeance de leurs crimes. Ils sont retournés en Égypte, et ils mangeront des viandes impures chez les Assyriens.',
    ...
    9: {
        ...
        8: 'La sentinelle d’Ephraïm était avec Dieu; mais un faux prophète a été comme un lacs tortueux sur toutes ses voies, et ils ont transplanté leur folie dans la maison du Seigneur.',
        ...
        15: 'Toutes leurs méchancetés se font en Galgala; c’est là que je les ai pris en haine pour leurs inventions abominables. Je les chasserai de ma maison, et je ne les aimerai plus, car tous leurs princes sont indociles.',
    ...
    10: {
        ...
        9: 'Depuis qu’il y a des collines, Israël a péché, et c’est là qu’ils se sont arrêtés; mais la guerre que l’on fera aux fils de l’iniquité ne se bornera pas à les surprendre sur une colline',
        10: 'Pour les châtier. Les peuples se réuniront contre eux, pour qu’ils soient punis de leur double péché.',
        ...
        14: 'Mais la perdition s’élèvera parmi ton peuple, et tous tes remparts disparaîtront. Comme le prince Salaman partit de la maison de Jéroboam durant les jours de la guerre, et jeta à terre avec violence les mères sur les enfants,',
        15: 'De même je te traiterai, ô maison d’Israël, à la vue de tes injustices et de tes méchancetés.',
    },
    11: {
        1: 'Ils sont tombés dès l’aurore: le roi d’Israël est tombé; Israël est un enfant, et moi je l’aimais, et j’ai rappelé ses fils de l’Égypte.',
        ...
        4: 'Au milieu de la perdition des hommes, je les ai enveloppés dans les langes de mon amour, et maintenant je serai pour eux comme un homme qui en frappe un autre à la joue, et je me retournerai sur Éphraim, et je prévaudrai contre lui.',
        ...
        8: 'Que ferai-je avec toi, Éphraïm? serai-je ton protecteur? O Israël, que ferai-je avec toi? Je te traiterai comme Adama et Seboïm. Mon cœur a changé pour toi, et tu as excité tous mes regrets.',
    ...
    13: {
        1: 'À la parole de Jéroboam, Éphraïm a pris lui-même des commandements en Israël et les a mis devant Baal, et Éphraim est mort.',
        ...
        14: 'Je les tirerai de l’enfer, dira-t-il; je les affranchirai tous de la mort. O mort, où est ta sentence? Enfer, où est ton aiguillon? Mais cette consolation est cachée à mes yeux.',
    ...
    14: {
        ...
        3: 'Prenez avec vous de bonnes paroles, et convertissez-vous au Seigneur votre Dieu: dites-lui que vous renoncez aux récompenses de l’iniquité pour choisir le bien; dites-lui: Nous vous offrons les fruits de nos lèvres!',
