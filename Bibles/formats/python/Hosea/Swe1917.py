...
CHAPTERS = {
    1: {
        ...
        6: 'Och hon blev åter havande och födde en dotter. Då sade han till honom: »Giv denna namnet Lo-Ruhama[1]; ty jag vill icke vidare förbarma mig över Israels hus, så att jag förlåter dem.',
        ...
        9: 'Då sade han: »Giv denne namnet Lo-Ammi[2]; ty I ären icke mitt folk, ej heller vill jag höra eder till.»',
    ...
    2: {
        1: '[3] Kallen då edra bröder Ammi[1] och edra systrar Ruhama[2].',
        ...
        23: 'Och jag skall plantera[3] henne åt mig i landet och förbarma mig över Lo-Ruhama och säga till Lo-Ammi: »Du är mitt folk.» Och det skall svara: »Du är min Gud.» [1] D. ä. mitt folk. [2] D. ä. hon som finner förbarmande. [3] Namnet Jisreel kan översättas med Guds plantering.',
    },
    3: {
