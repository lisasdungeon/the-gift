...
CHAPTERS = {
    ...
    13: {
        1: 'Gdy mawiał Efraim, strach bywał, bo był wywyższony w Izraelu; ale gdy zgrzeszył przy Baalu, tedy umarł.',
        2: 'A teraz jeszcze przyczyniają grzechu; bo sobie czynią i leją z srebra swego według przemysłu swego straszne bałwany, co wszystko tylko jest robotą rzemieślnika, o których jednak sami mówią: Ludzie, którzy chcą ofiarować, niech całują cielce,',
        ...
        4: 'Gdyżem Ja jest Pan, Bóg twój, od wyjścia z ziemi Egipskiej; a Boga oprócz mnie nie poznałeś, i niemasz zbawiciela oprócz mnie.',
        ...
        12: 'Związana jest nieprawość Efraimowa, schowany jest grzech jego.',
        13: 'Boleści rodzącej ogarną go; on synem niemądrym, bo inaczej nie zostawałby tak długo w żywocie matki.',
        14: 'Z ręki grobu wybawię ich, od śmierci wykupię ich. O śmierci! będę śmiercią twoją; o grobie! będę skażeniem twojem; żałość skryta będzie od oczów moich.',
        15: 'Bo on między braćmi owoc przyniesie; pierwej jednak przyjdzie wiatr ze wschodu, wiatr Pański od puszczy występujący, i wysuszy źródło jego, wysuszy i zdrój jego; onci rozchwyci skarby wszelkiego naczynia pożądanego.',
        16: 'Samaryja będzie spustoszona, przeto, że się sprzeciwiła Bogu swemu; od miecza upadną, maluczcy jej roztrąceni będą, a brzemienne jej rozcięte będą.',
    },
    14: {
