...
CHAPTERS = {
    1: {
        ...
        6: 'Nàng lại chịu thai và sanh một gái, thì Ðức Giê-hô-va phán cùng Ô-sê rằng: Hãy đặt tên nó là Lô-Ru-ha-ma; vì ta sẽ không thương xót nhà Y-sơ-ra-ên nữa.',
    ...
    5: {
        1: 'Hỡi các thầy tế lễ, hãy nghe điều nầy; hỡi nhà Y-sơ-ra-ên, khá để ý; hỡi nhà vua, hãy lắng tai! Sự phán xét có quan hệ với các ngươi, vì các ngươi là bẫy ở Mích-ba, và giăng lưới trên Tha-bô.',
        2: 'Chúng nó là kẻ bạn nghịch đã vào sâu trong sự giết lát, nhưng ta sẽ quở trách chúng nó hết thảy.',
        3: 'Ta biết Ép-ra-im, và Y-sơ-ra-ên không giấu với ta. Vả, hỡi Ép-ra-im, ngươi đã phạm tội tà dâm! Y-sơ-ra-ên bị ô uế!',
        4: 'Công việc chúng nó làm ngăn trở chúng nó về cùng Ðức Chúa Trời mình; vì lòng dâm trong chúng nó, và chúng nó không nhận biết Ðức Giê-hô-va.',
        5: 'Sự kiêu ngạo của Y-sơ-ra-ên làm chứng tận mặt nó, nên Y-sơ-ra-ên và Ép-ra-im sẽ ngã xuống vì cớ tội lỗi mình; Giu-đa cũng sẽ ngã xuống với chúng nó.',
        6: 'Chúng nó sẽ đi với các bầy chiên bầy bò mình, đặng tìm kiếm Ðức Giê-hô-va; song không thấy Ngài! Ngài đã lìa khỏi chúng nó.',
        7: 'Chúng nó đã phỉnh dối Ðức Giê-hô-va, vì đã sanh những con cái ngoại tình. Ðến ngày trăng mới, chúng nó sẽ cùng sản nghiệp mình đều bị nuốt đi!',
        8: 'Hãy thổi kèn ở Ghi-bê-a, hãy thổi loa ở Ra-ma! Hãy la lối ở Bết-a-ven! Hỡi Bên-gia-min, nó ở đằng sau ngươi!',
        9: 'Ép-ra-im sẽ nên hoang vu trong ngày quở trách; ta rao ra cho các chi phái Y-sơ-ra-ên một sự chắc sẽ xảy đến.',
        10: 'Các quan trưởng Giu-đa giống như kẻ lấn địa giới; ta sẽ đổ cơn giận ta trên chúng nó như trút nước.',
        11: 'Ép-ra-im bị hà hiếp, bị nghiền nát trong sự đoán xét, vì nó đã bằng lòng theo điều răn của loài người.',
        12: 'Vậy nên, ta giống như con mọt cho Ép-ra-im, và như sự mục nát cho nhà Giu-đa.',
        13: 'Khi Ép-ra-im đã biết bịnh mình, thì Ép-ra-im đi đến cùng người A-si-ri, và sai đến cùng vua Gia-rép. Nhưng nó không thể chữa lành các ngươi, và không buộc vết thương cho các ngươi.',
        14: 'Vì ta sẽ như một con sư tử cho Ép-ra-im, như một sư tử con cho nhà Giu-đa. Thật, chính ta, chính ta sẽ cắn xé rồi đi luôn; ta sẽ bắt đem đi và chẳng ai có thể giải cứu.',
        15: 'Ta sẽ đi, sẽ vào nơi ta, cho đến chừng nào chúng nó nhận biết mình phạm tội và tìm kiếm mặt ta. Trong cơn khốn nạn, chúng nó sẽ cố tìm ta.',
    },
    6: {
    ...
    7: {
        1: 'Khi ta muốn chữa lành cho Y-sơ-ra-ên, thì tội lỗi của Ép-ra-im và sự gian ác của Sa-ma-ri bày tỏ; vì chúng nó đã làm sự giả dối; kẻ trộm vào trong và bọn cướp đánh giựt ở ngoài.',
        ...
        5: 'Ðến ngày vua chúng ta, các quan trưởng vì sự nóng của rượu mà đau ốm: vua cũng bắt tay những kẻ hay nhạo báng.',
        ...
        16: 'Chúng nó xây lại, song không hướng về Ðấng Rất Cao. Chúng nó giống như cung giở trái. Quan trưởng chúng nó sẽ ngã bởi gươm, vì lưỡi chúng nó nổi giận. Kìa, chúng nó sẽ làm trò cười trong đất Ê-díp-tô.',
    },
    8: {
    ...
    11: {
        1: 'Khi Y-sơ-ra-ên còn thơ ấy, ta yêu dấu nó; ta gọi con trai ta ra khỏi Ê-díp-tô.',
        ...
        4: 'Ta đã dùng dây nhơn tình, dùng xích yêu thương kéo chúng nó đến. Ta đã như những kẻ cởi ách khỏi hàm chúng nó, và để đồ ăn trước mặt chúng nó.',
        5: 'Chúng nó sẽ không trở về trong đất Ê-díp-tô nữa, nhưng người A-si-ri sẽ làm vua chúng nó, vì chúng nó chẳng khứng trở lại với ta.',
        6: 'Gươm sẽ rơi trên các thành chúng nó, hủy phá then cửa chúng nó, nuốt hết chúng nó, vì cớ mưu chước chúng nó.',
        7: 'Thật, dân ta quyết ý trái bỏ ta. Người ta khuyên chúng nó đến cùng Ðấng cao; song trong chúng nó chẳng một người nào dấy lên.',
        8: 'Hỡi Ép-ra-im, thể nào ta bỏ được ngươi? Hỡi Y-sơ-ra-ên, thể nào ta lìa được ngươi? Thể nào ta sẽ đãi ngươi được như Át-ma, hay là làm cho ngươi như Sê-bô-im? Lòng ta rung động trong ta; lòng thương xót của ta cả đều nóng nảy.',
        9: 'Ta cầm sự nóng giận lại, và sẽ chẳng lại hủy diệt Ép-ra-im. Vì ta là Ðức Chúa Trời, không phải là người; ta là Ðấng Thánh ở giữa ngươi, chẳng lấy cơn giận đến cùng ngươi.',
        10: 'Chúng nó sẽ theo sau Ðức Giê-hô-va, Ngài gầm thét như sư tử; Ngài sẽ gầm thét, các con cái sẽ từ phương tây run rẩy mà đến.',
        11: 'Chúng nó sẽ run rẩy mà đến từ Ê-díp-tô như chim bay, và từ đất A-si-ri như bò câu; và ta sẽ khiến chúng nó ở trong các nhà chúng nó, Ðức Giê-hô-va phán vậy.',
        12: '(12:1) Ép-ra-im lấy sự nói dối bao bọc ta, còn nhà Y-sơ-ra-ên thì lấy sự lừa phỉnh; Giu-đa cai trị với Ðức Chúa Trời, và có lòng trung tín với Ðấng Thánh.',
    },
    12: {
    ...
    14: {
        1: 'Hỡi Y-sơ-ra-ên, hãy trở lại cùng Giê-hô-va Ðức Chúa Trời ngươi, vì ấy là tại tội lỗi ngươi làm cho ngươi sa ngã.',
        ...
        9: 'Ai là khôn ngoan mà hiểu những sự nầy? Ai là giỏi giang mà biết những sự đó? Vì các đường lối của Ðức Giê-hô-va là ngay thẳng; những kẻ công bình sẽ bước đi trong đó, còn những kẻ phạm phép thì vấp ngã trong đó.',
    },
}
