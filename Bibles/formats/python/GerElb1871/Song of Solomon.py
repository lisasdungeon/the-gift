...
CHAPTERS = {
    1: {
        ...
        14: 'Eine Cypertraube ist mir mein Geliebter, in den Weinbergen von Engedi. -',
    ...
    8: {
        ...
        9: 'Wenn sie eine Mauer ist, so wollen wir eine Zinne von Silber darauf bauen; und wenn sie eine Tür ist, so wollen wir sie mit einem Cedernbrett verschließen',
