...
CHAPTERS = {
    1: {
        ...
        12: 'Und zu den Rubenitern und zu den Gaditern und zu dem halben Stamme Manasse sprach Josua und sagte:',
        13: 'Gedenket des Wortes, das Mose, der Knecht Jehovas, euch geboten hat, indem er sprach: Jehova, euer Gott, schafft euch Ruhe und gibt euch dieses Land.',
        ...
        15: 'bis Jehova euren Brüdern Ruhe schafft wie euch, und auch sie das Land besitzen, welches Jehova, euer Gott, ihnen gibt. Dann sollt ihr in das Land eures Besitztums zurückkehren und es besitzen, welches Mose, der Knecht Jehovas, euch gegeben hat, diesseit des Jordan, gegen Sonnenaufgang.',
    ...
    2: {
        1: 'Und Josua, der Sohn Nuns, sandte von Sittim heimlich zwei Männer als Kundschafter aus und sprach: Gehet, besehet das Land und Jericho. Und sie gingen hin und kamen in das Haus einer Hure, namens Rahab; und sie legten sich daselbst nieder.',
        2: 'Und es wurde dem König von Jericho berichtet und gesagt: Siehe, es sind in dieser Nacht Männer von den Kindern Israel hierhergekommen, um das Land zu erforschen.',
        3: 'Da sandte der König von Jericho zu Rahab und ließ ihr sagen: Führe die Männer heraus, die zu dir gekommen, die in dein Haus eingekehrt sind; denn sie sind gekommen, um das ganze Land zu erforschen.',
        4: 'Das Weib aber nahm die zwei Männer und verbarg sie. Und sie sprach: Allerdings sind die Männer zu mir gekommen, aber ich wußte nicht, woher sie waren;',
        5: 'und als das Tor beim Dunkelwerden geschlossen werden sollte, da gingen die Männer hinaus; ich weiß nicht, wohin die Männer gegangen sind. Jaget ihnen eilends nach, denn ihr werdet sie erreichen.',
        6: 'Sie hatte sie aber auf das Dach hinaufgeführt und unter Flachsstengel versteckt, die sie sich auf dem Dache aufgeschichtet hatte.',
        7: 'Und die Männer jagten ihnen nach, des Weges zum Jordan, nach den Furten hin; und man schloß das Tor, sobald die, welche ihnen nachjagten, hinaus waren.',
        8: 'Und ehe sie sich niederlegten, stieg sie zu ihnen auf das Dach hinauf',
        9: 'und sprach zu den Männern: Ich weiß, daß Jehova euch das Land gegeben hat, und daß euer Schrecken auf uns gefallen ist, und daß alle Bewohner des Landes vor euch verzagt sind.',
        10: 'Denn wir haben gehört, daß Jehova die Wasser des Schilfmeeres vor euch ausgetrocknet hat, als ihr aus Ägypten zoget, und was ihr den beiden Königen der Amoriter getan, die jenseit des Jordan waren, dem Sihon und dem Og, die ihr verbannt habt.',
        11: 'Und wir hörten es, und unser Herz zerschmolz, und es blieb kein Mut mehr vor euch in irgend einem Menschen; denn Jehova, euer Gott, ist Gott im Himmel oben und auf der Erde unten.',
        ...
        18: 'Siehe, wenn wir in das Land kommen, so sollst du diese Schnur von Karmesinfaden in das Fenster binden, durch welches du uns heruntergelassen hast, und sollst deinen Vater und deine Mutter und deine Brüder und das ganze Haus deines Vaters zu dir ins Haus versammeln;',
        19: 'und es soll geschehen, wer irgend aus der Tür deines Hauses auf die Straße gehen wird, dessen Blut sei auf seinem Haupte, und wir werden unseres Eides ledig sein. Jeder aber, der bei dir im Hause sein wird, dessen Blut sei auf unserem Haupte, wenn Hand an ihn gelegt wird.',
    ...
    4: {
        ...
        13: 'Bei 40000 zum Heere Gerüstete zogen sie vor Jehova her zum Streit in die Ebenen von Jericho.',
    ...
    5: {
        ...
        9: 'Und Jehova sprach zu Josua: Heute habe ich die Schande Ägyptens von euch abgewälzt. Und man gab selbigem Orte den Namen Gilgal bis auf diesen Tag.',
    ...
    6: {
        ...
        9: 'Und die Gerüsteten zogen vor den Priestern her, welche in die Posaunen stießen, und der Nachzug ging hinter der Lade her, indem sie fort und fort in die Posaunen stießen.',
        ...
        13: 'Und die sieben Priester, welche die sieben Hallposaunen vor der Lade Jehovas hertrugen, gingen fort und fort und stießen in die Posaunen; und die Gerüsteten zogen vor ihnen her, und der Nachzug ging hinter der Lade Jehovas her, indem sie fort und fort in die Posaunen stießen.',
        ...
        21: 'Und sie verbannten alles, was in der Stadt war, vom Manne bis zum Weibe, vom Knaben bis zum Greise, und bis zu den Rindern und Schafen und Eseln, mit der Schärfe des Schwertes. -',
        ...
        26: 'Und Josua schwur in selbiger Zeit und sprach: Verflucht vor Jehova sei der Mann, der sich aufmachen und diese Stadt Jericho bauen wird! Mit seinem Erstgeborenen wird er ihren Grund legen und mit seinem Jüngsten ihre Tore aufstellen. -',
        27: 'Und Jehova war mit Josua, und sein Ruf verbreitete sich durch das ganze Land.',
    },
    7: {
        1: 'Und die Kinder Israel begingen Untreue an dem Verbannten; und Achan, der Sohn Karmis, des Sohnes Sabdis, des Sohnes Serachs, vom Stamme Juda, nahm von dem Verbannten; und der Zorn Jehovas entbrannte wider die Kinder Israel. -',
        2: 'Und Josua sandte Männer von Jericho nach Ai, das bei Beth-Awen, östlich von Bethel, liegt, und sprach zu ihnen und sagte: Gehet hinauf und kundschaftet das Land aus. Und die Männer gingen hinauf und kundschafteten Ai aus.',
        3: 'Und sie kehrten zu Josua zurück und sprachen zu ihm: Es ziehe nicht das ganze Volk hinauf; bei zweitausend Mann oder bei dreitausend Mann mögen hinaufziehen und Ai schlagen; bemühe nicht das ganze Volk dahin, denn ihrer sind wenige.',
        4: 'Da zogen von dem Volke bei dreitausend Mann dort hinauf; aber sie flohen vor den Männern von Ai;',
        5: 'und die Männer von Ai erschlugen von ihnen bei 36 Mann, und sie jagten ihnen nach vor dem Tore bis Schebarim und schlugen sie am Abhange. Da zerschmolz das Herz des Volkes und wurde wie Wasser.',
        ...
        12: 'Und die Kinder Israel werden vor ihren Feinden nicht zu bestehen vermögen; sie werden vor ihren Feinden den Rücken kehren, denn sie sind zum Banne geworden. Ich werde nicht mehr mit euch sein, wenn ihr nicht den Bann aus eurer Mitte vertilget.',
        13: 'Stehe auf, heilige das Volk und sprich: Heiliget euch auf morgen; denn so spricht Jehova, der Gott Israels: Ein Bann ist in deiner Mitte, Israel; du wirst vor deinen Feinden nicht zu bestehen vermögen, bis ihr den Bann aus eurer Mitte hinwegtut.',
        ...
        15: 'Und es soll geschehen: wer mit dem Banne getroffen wird, der soll mit Feuer verbrannt werden, er und alles, was er hat; denn er hat den Bund Jehovas übertreten und eine Schandtat in Israel begangen.',
        16: 'Und Josua machte sich des Morgens früh auf und ließ Israel herzutreten nach seinen Stämmen; und es ward getroffen der Stamm Juda.',
        17: 'Und er ließ die Geschlechter Judas herzutreten; und er traf das Geschlecht der Sarchiter. Und er ließ das Geschlecht der Sarchiter herzutreten nach den Männern; und es ward getroffen Sabdi.',
        18: 'Und er ließ sein Haus herzutreten nach den Männern; und es ward getroffen Achan, der Sohn Karmis, des Sohnes Sabdis, des Sohnes Serachs, vom Stamme Juda.',
        19: 'Und Josua sprach zu Achan: Mein Sohn, gib doch Jehova, dem Gott Israels, Ehre und tue ihm Bekenntnis; und tue mir doch kund, was du getan hast, verhehle es mir nicht!',
        20: 'Und Achan antwortete Josua und sprach: Fürwahr, ich habe gegen Jehova, den Gott Israels, gesündigt, und so, und so habe ich getan:',
        21: 'Ich sah unter der Beute einen schönen Mantel aus Sinear und zweihundert Sekel Silber und eine goldene Stange, fünfzig Sekel ihr Gewicht, und mich gelüstete danach, und ich nahm sie; und siehe, sie sind im Innern meines Zeltes in der Erde vergraben und das Silber darunter.',
        22: 'Und Josua sandte Boten hin, und sie liefen zum Zelte; und siehe, er war in seinem Zelte vergraben und das Silber darunter.',
        23: 'Und sie nahmen es aus dem Innern des Zeltes und brachten es zu Josua und zu allen Kindern Israel, und sie legten es vor Jehova hin.',
        24: 'Da nahm Josua, und ganz Israel mit ihm, Achan, den Sohn Serachs, und das Silber und den Mantel und die goldene Stange, und seine Söhne und seine Töchter, und seine Rinder und seine Esel und sein Kleinvieh, und sein Zelt und alles, was er hatte, und sie brachten sie hinauf in das Tal Achor.',
        25: 'Und Josua sprach: Wie hast du uns in Trübsal gebracht! Jehova wird dich in Trübsal bringen an diesem Tage! Und ganz Israel steinigte ihn, und sie verbrannten sie mit Feuer und bewarfen sie mit Steinen;',
        26: 'und sie errichteten einen großen Steinhaufen über ihm, der bis auf diesen Tag da ist. Und Jehova wandte sich von der Glut seines Zornes. Darum gab man jenem Orte den Namen Tal Achor bis auf diesen Tag.',
    },
    8: {
        1: 'Und Jehova sprach zu Josua: Fürchte dich nicht und erschrick nicht! Nimm alles Kriegsvolk mit dir und mache dich auf, ziehe hinauf nach Ai. Siehe, ich habe den König von Ai und sein Volk und seine Stadt und sein Land in deine Hand gegeben.',
        2: 'Und du sollst an Ai und an seinem König tun, so wie du an Jericho und an seinem König getan hast; jedoch seine Beute und sein Vieh dürft ihr für euch plündern. Lege dir einen Hinterhalt gegen die Stadt, in ihren Rücken.',
        3: 'Da machte sich Josua mit allem Kriegsvolk auf, um nach Ai hinaufzuziehen. Und Josua wählte 30000 Mann aus, streitbare Männer, und sandte sie ab bei der Nacht.',
        4: 'Und er gebot ihnen und sprach: Sehet, ihr sollt den Hinterhalt bilden gegen die Stadt, im Rücken der Stadt; entfernet euch nicht allzuweit von der Stadt, sondern seid alle bereit.',
        5: 'Und ich und alles Volk, das bei mir ist, wir wollen uns der Stadt nähern; und es soll geschehen, wenn sie herauskommen, uns entgegen, wie das erste Mal, so wollen wir vor ihnen fliehen.',
        6: 'Und sie werden herausziehen hinter uns her, bis wir sie von der Stadt abgerissen haben; denn sie werden sagen: Sie fliehen vor uns wie das erste Mal! und wir wollen vor ihnen fliehen.',
        7: 'Dann sollt ihr euch aus dem Hinterhalt aufmachen und die Stadt in Besitz nehmen; und Jehova, euer Gott, wird sie in eure Hand geben.',
        8: 'Und es soll geschehen, wenn ihr die Stadt eingenommen habt, so sollt ihr die Stadt mit Feuer anzünden; nach dem Worte Jehovas sollt ihr tun. Sehet, ich habe es euch geboten. -',
        9: 'Und Josua sandte sie ab, und sie zogen in den Hinterhalt und hielten zwischen Bethel und Ai, westlich von Ai. Und Josua brachte jene Nacht in der Mitte des Volkes zu.',
        10: 'Und Josua machte sich des Morgens früh auf und musterte das Volk; und er zog hinauf, er und die Ältesten von Israel, vor dem Volke her nach Ai.',
        11: 'Und alles Kriegsvolk, das bei ihm war, zog hinauf und rückte heran, und sie kamen der Stadt gegenüber; und sie lagerten sich nördlich von Ai, und das Tal war zwischen ihm und Ai.',
        12: 'Er hatte aber bei fünftausend Mann genommen und sie als Hinterhalt zwischen Bethel und Ai gelegt, westlich von der Stadt.',
        13: 'Und so stellten sie das Volk auf, das ganze Lager, das nördlich von der Stadt war, und dessen Hinterhalt westlich von der Stadt; und Josua zog in selbiger Nacht mitten in das Tal.',
        ...
        29: 'Und den König von Ai ließ er an einen Baum hängen bis zur Abendzeit; und beim Untergang der Sonne gebot Josua, und sie nahmen seinen Leichnam von dem Baume herab und warfen ihn an den Eingang des Stadttores und errichteten einen großen Steinhaufen über ihm, der bis auf diesen Tag da ist.',
        30: 'Damals baute Josua dem Jehova, dem Gott Israels, einen Altar auf dem Berge Ebal,',
        31: 'so wie Mose, der Knecht Jehovas, den Kindern Israel geboten hatte, wie im Buche des Gesetzes Moses geschrieben ist, einen Altar von ganzen Steinen, über die man kein Eisen geschwungen hatte. Und sie opferten darauf dem Jehova Brandopfer und schlachteten Friedensopfer.',
        32: 'Und er schrieb daselbst auf die Steine eine Abschrift des Gesetzes Moses, welches er vor den Kindern Israel geschrieben hatte.',
        ...
        34: 'Und danach las er alle Worte des Gesetzes, den Segen und den Fluch, nach allem, was im Buche des Gesetzes geschrieben ist.',
        35: 'Es war kein Wort von allem, was Mose geboten hatte, das Josua nicht der ganzen Versammlung Israels vorlas, samt den Weibern und den Kindern und dem Fremdling, der in ihrer Mitte wandelte.',
    },
    9: {
        ...
        4: 'handelten auch ihrerseits mit List und gingen und stellten sich als Boten: sie nahmen abgenutzte Säcke für ihre Esel, und abgenutzte und geborstene und zusammengebundene Weinschläuche,',
    ...
    10: {
        ...
        4: 'Kommet zu mir herauf und helft mir, daß wir Gibeon schlagen; denn es hat mit Josua und mit den Kindern Israel Frieden gemacht!',
        ...
        6: 'Und die Männer von Gibeon sandten zu Josua in das Lager nach Gilgal und sprachen: Ziehe deine Hände nicht ab von deinen Knechten; komm eilends zu uns herauf und rette uns und hilf uns; denn alle Könige der Amoriter, die das Gebirge bewohnen, haben sich wider uns versammelt.',
        ...
        13: 'Und die Sonne stand still, und der Mond blieb stehen, bis die Nation sich an ihren Feinden gerächt hatte. Und die Sonne blieb mitten am Himmel stehen und eilte nicht zum Untergang, ungefähr einen ganzen Tag.',
        ...
        20: 'Und es geschah, als Josua und die Kinder Israel geendigt hatten, eine sehr große Niederlage unter ihnen anzurichten, bis sie aufgerieben waren,',
    ...
    11: {
        ...
        10: 'Und Josua kehrte in selbiger Zeit zurück und nahm Hazor ein, und seinen König erschlug er mit dem Schwerte; denn Hazor war vordem die Hauptstadt aller dieser Königreiche.',
        ...
        12: 'Und alle Städte dieser Könige, samt allen ihren Königen, nahm Josua ein und schlug sie mit der Schärfe des Schwertes und verbannte sie, so wie Mose, der Knecht Jehovas, geboten hatte.',
        13: 'Nur alle die Städte, die auf ihren Hügeln standen, verbrannte Israel nicht; ausgenommen Hazor allein, das verbrannte Josua.',
        14: 'Und alle Beute dieser Städte und das Vieh plünderten die Kinder Israel für sich; doch alle Menschen schlugen sie mit der Schärfe des Schwertes, bis sie sie vertilgt hatten: sie ließen nichts übrig, was Odem hatte.',
        ...
        16: 'Und Josua nahm dieses ganze Land, das Gebirge und den ganzen Süden und das ganze Land Gosen und die Niederung und die Ebene, und das Gebirge Israel und seine Niederung,',
        17: 'von dem kahlen Gebirge, das gegen Seir aufsteigt, bis Baal-Gad in der Talebene des Libanon, am Fuße des Berges Hermon; und alle ihre Könige ergriff er und erschlug sie und tötete sie.',
        ...
        22: 'Es blieben keine Enakim in dem Lande der Kinder Israel übrig; nur zu Gasa, zu Gath und zu Asdod blieben sie übrig.',
        23: 'Und so nahm Josua das ganze Land, nach allem, was Jehova zu Mose geredet hatte; und Josua gab es Israel zum Erbteil, nach ihren Abteilungen, nach ihren Stämmen. Und das Land hatte Ruhe vom Kriege.',
    },
    12: {
    ...
    13: {
        ...
        3: 'von dem Sihor, der vor Ägypten fließt, bis an die Grenze von Ekron gegen Norden, wird es zu den Kanaanitern gerechnet; die fünf Fürsten der Philister: der Gasiter, der Asdoditer, der Askeloniter, der Gathiter und der Ekroniter, und die Awim.',
        ...
        12: 'das ganze Reich Ogs in Basan, der zu Astaroth und zu Edrei regierte; und Mose schlug sie und trieb sie aus.',
    ...
    14: {
        1: 'Und dies ist es, was die Kinder Israel als Erbe im Lande Kanaan erhielten, was ihnen Eleasar, der Priester, und Josua, der Sohn Nuns, und die Häupter der Väter der Stämme der Kinder Israel ihnen als Erbe austeilten,',
    ...
    16: {
        ...
        6: 'und die Grenze lief gegen Westen nach Mikmethath hin, nördlich; und die Grenze wandte sich gegen Osten nach Taanath-Silo und ging daran vorbei gegen Osten nach Janocha;',
        7: 'und sie stieg von Janocha hinab nach Ataroth und Naarath, und stieß an Jericho und lief aus am Jordan;',
        8: 'von Tappuach ging die Grenze gegen Westen nach dem Bache Kana, und ihr Ausgang war nach dem Meere hin. Das war das Erbteil des Stammes der Kinder Ephraim nach ihren Geschlechtern,',
        9: 'nebst den Städten, welche für die Kinder Ephraim abgesondert wurden inmitten des Erbteils der Kinder Manasse: alle Städte und ihre Dörfer. -',
        10: 'Aber sie trieben die Kanaaniter nicht aus, die zu Geser wohnten; und die Kanaaniter haben inmitten von Ephraim gewohnt bis auf diesen Tag, und sie wurden fronpflichtig.',
    },
    17: {
    ...
    18: {
        ...
        13: 'und von dort ging die Grenze hinüber nach Lus, nach der Südseite von Lus, das ist Bethel; und die Grenze stieg hinab nach Ateroth-Addar, bei dem Berge, der südlich von Unter-Beth-Horon ist. -',
        ...
        15: 'Und die Südseite fing an am Ende von Kirjath-Jearim; und die Grenze lief aus nach Westen hin, und sie lief nach der Quelle des Wassers Nephtoach hin;',
        ...
        18: 'und ging hinüber nach der Seite, die der Araba nordwärts gegenüber liegt, und stieg hinab nach der Araba;',
        ...
        24: 'und Kephar-Ammoni und Ophni und Geba: Zwölf Städte und ihre Dörfer;',
    ...
    21: {
        ...
        10: 'und sie wurden den Söhnen Aarons, von den Familien der Kehathiter, aus den Kindern Levi, zuteil.',
        ...
        41: 'Alle Städte der Leviten inmitten des Eigentums der Kinder Israel: 48 Städte und ihre Bezirke.',
    ...
    22: {
        ...
        3: 'Ihr habt eure Brüder nicht verlassen diese lange Zeit bis auf diesen Tag, und habt das Gebot Jehovas, eures Gottes, beobachtet.',
        ...
        17: 'Ist es uns zu wenig an der Ungerechtigkeit Peors, von welcher wir uns noch nicht gereinigt haben bis auf diesen Tag, und doch kam die Plage über die Gemeinde Jehovas?',
    ...
    23: {
        ...
        4: 'Sehet, ich habe euch diese übrigen Nationen durchs Los als Erbteil zufallen lassen, nach euren Stämmen, vom Jordan an bis an das große Meer gegen Sonnenuntergang.',
