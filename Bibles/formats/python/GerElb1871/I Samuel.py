...
CHAPTERS = {
    ...
    4: {
        1: 'Und das Wort Samuels erging an ganz Israel. Und Israel zog aus, den Philistern entgegen zum Streit; und sie lagerten sich bei Eben-Eser, und die Philister lagerten zu Aphek.',
        ...
        6: 'Und die Philister hörten den Schall des Jauchzens und sprachen: Was bedeutet der Schall dieses großen Jauchzens im Lager der Hebräer? Und sie erkannten, daß die Lade Jehovas ins Lager gekommen war.',
        ...
        10: 'Und die Philister stritten, und Israel wurde geschlagen, und sie flohen ein jeder nach seinem Zelte; und die Niederlage war sehr groß, und es fielen von Israel 30000 Mann zu Fuß.',
    ...
    7: {
        ...
        12: 'Und Samuel nahm einen Stein und stellte ihn auf zwischen Mizpa und Schen, und er gab ihm den Namen Eben-Eser und sprach: Bis hierher hat uns Jehova geholfen.',
    ...
    9: {
        ...
        11: 'Sie gingen eben die Anhöhe zu der Stadt hinauf, da trafen sie Dirnen, die herauskamen, um Wasser zu schöpfen; und sie sprachen zu ihnen: Ist der Seher hier?',
        ...
        27: 'Während sie an das Ende der Stadt hinuntergingen, sprach Samuel zu Saul: Sage dem Knaben, daß er uns vorausgehe; du aber stehe jetzt still, daß ich dich das Wort Gottes hören lasse.',
    },
    10: {
    ...
    11: {
        ...
        8: 'Und er musterte sie zu Besek; und es waren der Kinder Israel 300000,und der Männer von Juda 30000.',
    ...
    13: {
        ...
        3: 'Und Jonathan schlug die Aufstellung der Philister, die zu Geba war, und die Philister hörten es. Und Saul ließ im ganzen Lande in die Posaune stoßen und sprach: Die Hebräer sollen es hören!',
    ...
    14: {
        ...
        3: 'Und das Volk wußte nicht, daß Jonathan weggegangen war.',
    ...
    16: {
        ...
        19: 'Da sandte Saul Boten zu Isai und sprach: Sende deinen Sohn David zu mir, der bei dem Kleinvieh ist.',
        ...
        22: 'Und Saul sandte zu Isai und sprach: Laß doch David vor mir stehen, denn er hat Gnade gefunden in meinen Augen.',
    ...
    18: {
        ...
        21: 'Und Saul sprach: Ich will sie ihm geben, daß sie ihm zum Fallstrick werde und die Hand der Philister wider ihn sei. Und Saul sprach zu David: Zum zweiten Male sollst du heute mein Eidam werden.',
    ...
    19: {
        ...
        9: 'Und ein böser Geist von Jehova kam über Saul; und er saß in seinem Hause, sein Speer in seiner Hand, und David spielte mit der Hand.',
        ...
        18: 'David aber war geflohen und entronnen; und er kam zu Samuel nach Rama und berichtete ihm alles, was Saul ihm getan hatte. Und er und Samuel gingen hin und wohnten zu Najoth.',
        19: 'Und es wurde Saul berichtet und gesagt: Siehe, David ist in Najoth zu Rama.',
        20: 'Da sandte Saul Boten, um David zu holen. Als sie aber die Versammlung der Propheten sahen, welche weissagten, und Samuel als Vorsteher über sie dabeistehen, da kam der Geist Gottes über die Boten Sauls, und auch sie weissagten.',
        21: 'Und man berichtete es Saul, und er sandte andere Boten, und auch sie weissagten; und Saul sandte wiederum dritte Boten, und auch sie weissagten.',
        22: 'Da ging auch er nach Rama und kam an die große Cisterne, die zu Seku ist; und er fragte und sprach: Wo sind Samuel und David? Und man sprach: Siehe, in Najoth zu Rama.',
        23: 'Und er ging dorthin, nach Najoth zu Rama; und auch über ihn kam der Geist Gottes, und er ging, immerfort weissagend, bis er in Najoth zu Rama ankam.',
        24: 'Und auch er zog seine Oberkleider aus, und auch er weissagte vor Samuel, und er lag nackt da jenen ganzen Tag und die ganze Nacht. Daher sagt man: Ist auch Saul unter den Propheten?',
    },
    20: {
        ...
        6: 'Wenn dein Vater mich etwa vermissen sollte, so sage: David hat sichs dringend von mir erbeten, nach Bethlehem, seiner Stadt, zu laufen; denn daselbst ist das Jahresopfer für die ganze Familie.',
        ...
        28: 'Und Jonathan antwortete Saul: David hat sichs dringend von mir erbeten, nach Bethlehem zu gehen, und er sprach:',
    ...
    22: {
        ...
        14: 'Und Ahimelech antwortete dem König und sprach: Und wer unter all deinen Knechten ist wie David, treu, und des Königs Eidam, und der Zutritt hat zu deinem geheimen Rat und geehrt ist in deinem Hause?',
        ...
        18: 'Da sprach der König zu Doeg: Wende du dich und falle über die Priester her! Und Doeg, der Edomiter, wandte sich und fiel über die Priester her, und er tötete an selbigem Tage 85 Mann, die das leinene Ephod trugen.',
    ...
    23: {
        ...
        7: 'Und es wurde Saul berichtet, daß David nach Kehila gekommen wäre. Da sprach Saul: Gott hat ihn verworfen und in meine Hand überliefert; denn er hat sich eingeschlossen, indem er in eine Stadt mit Toren und Riegeln gekommen ist.',
        ...
        10: 'Und David sprach: Jehova, Gott Israels! dein Knecht hat für gewiß gehört, daß Saul danach trachtet, nach Kehila zu kommen, um die Stadt zu verderben um meinetwillen.',
    ...
    24: {
        1: 'Und David zog von dannen hinauf und blieb auf den Bergfesten von Engedi.',
        2: 'Und es geschah, als Saul von der Verfolgung der Philister zurückgekehrt war, da berichtete man ihm und sprach: Siehe, David ist in der Wüste Engedi.',
        ...
        5: 'Da sprachen die Männer Davids zu ihm: Siehe, das ist der Tag, von welchem Jehova zu dir gesagt hat: Siehe, ich werde deinen Feind in deine Hand geben, und tue ihm, wie es gut ist in deinen Augen. Und David stand auf und schnitt heimlich einen Zipfel von dem Oberkleide Sauls ab.',
        6: 'Aber es geschah hernach, da schlug dem David sein Herz, darum daß er den Zipfel von dem Oberkleide Sauls abgeschnitten hatte;',
        7: 'und er sprach zu seinen Männern: Jehova lasse es fern von mir sein, daß ich so etwas an meinem Herrn, dem Gesalbten Jehovas, tun sollte, meine Hand gegen ihn auszustrecken! Denn er ist der Gesalbte Jehovas.',
        ...
        11: 'Siehe, an diesem Tage haben deine Augen gesehen, daß Jehova dich heute in meine Hand gegeben hat in der Höhle. Und man sagte mir, ich solle dich töten; aber mein Auge schonte deiner, und ich sprach: Ich will meine Hand nicht wider meinen Herrn ausstrecken, denn er ist der Gesalbte Jehovas!',
    ...
    25: {
        ...
        2: 'Und es war ein Mann in Maon, der seine Geschäfte zu Karmel hatte; und der Mann war sehr vermögend und hatte dreitausend Schafe und tausend Ziegen; und er war während der Schur seiner Schafe in Karmel.',
        3: 'Und der Name des Mannes war Nabal, und der Name seines Weibes Abigail. Und das Weib war von guter Einsicht und schön von Gestalt; der Mann aber war hart und boshaft in seinen Handlungen, und er war ein Kalebiter.',
        4: 'Und David hörte in der Wüste, daß Nabal seine Schafe schor.',
        5: 'Da sandte David zehn Knaben, und David sprach zu den Knaben: Ziehet nach Karmel hinauf, und gehet zu Nabal und fraget ihn in meinem Namen nach seinem Wohlergehen,',
        6: 'und sprechet also: Lebe lange! Und Friede dir, und Friede deinem Hause, und Friede allem, was dein ist!',
        7: 'Und jetzt habe ich gehört, daß du die Schafscherer hast; nun, deine Hirten sind bei uns gewesen, wir haben ihnen nichts zuleide getan, und nicht das Geringste ist von ihnen vermißt worden alle die Tage, die sie zu Karmel gewesen sind.',
        8: 'Frage deine Knaben, und sie werden es dir kundtun. Mögen denn die Knaben Gnade finden in deinen Augen, denn an einem guten Tage sind wir gekommen; gib doch deinen Knechten und deinem Sohne David, was deine Hand findet!',
        ...
        13: 'Da sprach David zu seinen Männern: Gürtet ein jeder sein Schwert um! Und sie gürteten ein jeder sein Schwert um, und auch David gürtete sein Schwert um; und sie zogen hinauf, hinter David her, bei vierhundert Mann, und zweihundert blieben bei dem Geräte.',
        ...
        26: 'Und nun, mein Herr, so wahr Jehova lebt und deine Seele lebt, Jehova hat dich verhindert in Blutschuld zu kommen, und daß deine Hand dir Hülfe schaffe! Und nun, mögen wie Nabal sein deine Feinde und die Böses suchen wider meinen Herrn!',
        ...
        31: 'so wird dir dieses nicht zum Anstoß sein, noch zum Herzensvorwurf für meinen Herrn, daß du Blut vergossen habest ohne Ursache, und daß mein Herr sich selbst Hülfe geschafft habe. Und wenn Jehova meinem Herrn wohltun wird, so gedenke deiner Magd.',
        32: 'Und David sprach zu Abigail: Gepriesen sei Jehova, der Gott Israels, der dich an diesem Tage mir entgegengesandt hat!',
        33: 'Und gesegnet sei dein Verstand, und gesegnet seiest du, daß du mich heute davon zurückgehalten hast, in Blutschuld zu kommen und mir mit meiner Hand Hülfe zu schaffen!',
        ...
        42: 'Und Abigail machte sich eilends auf und bestieg einen Esel, sie und ihre fünf Mägde, die ihrem Fuße folgten; und sie zog den Boten Davids nach, und sie wurde sein Weib.',
    ...
    27: {
        ...
        10: 'Und sprach Achis: Habt ihr heute keinen Einfall gemacht? so sprach David: In den Süden von Juda, oder: In den Süden der Jerachmeeliter, oder: In den Süden der Keniter.',
    ...
    29: {
        ...
        4: 'Aber die Fürsten der Philister wurden zornig über ihn, und die Fürsten der Philister sprachen zu ihm: Schicke den Mann zurück, daß er an seinen Ort zurückkehre, wohin du ihn bestellt hast, und daß er nicht mit uns in den Streit hinabziehe und uns nicht zum Widersacher werde im Streite; denn womit könnte der sich angenehm machen bei seinem Herrn? nicht mit den Köpfen dieser Männer?',
    ...
    31: {
        1: 'Die Philister aber stritten wider Israel und die Männer von Israel flohen vor den Philistern, und Erschlagene fielen auf dem Gebirge Gilboa.',
        ...
        12: 'da machten sich alle tapferen Männer auf und gingen die ganze Nacht; und sie nahmen den Leichnam Sauls und die Leichname seiner Söhne von der Mauer von Beth-Schan weg; und sie kamen nach Jabes zurück und verbrannten sie daselbst.',
