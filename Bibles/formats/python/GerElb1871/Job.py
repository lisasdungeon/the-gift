...
CHAPTERS = {
    1: {
        1: 'Es war Mann im Lande Uz, sein Name war Hiob; und selbiger Mann war vollkommen und rechtschaffen und gottesfürchtig und das Böse meidend.',
        ...
        5: 'Und es geschah, wenn die Tage des Gastmahls umgegangen waren, so sandte Hiob hin und heiligte sie; und er stand des Morgens früh auf und opferte Brandopfer nach ihrer aller Zahl; denn Hiob sprach: Vielleicht haben meine Kinder gesündigt und sich in ihrem Herzen von Gott losgesagt. Also tat Hiob allezeit.',
        6: 'Und es geschah eines Tages, da kamen die Söhne Gottes, um sich vor Jehova zu stellen; und auch Satan kam in ihrer Mitte.',
        ...
        15: 'da fielen Sabäer ein und nahmen sie weg, und die Knechte erschlugen sie mit der Schärfe des Schwertes; und ich bin entronnen, nur ich allein, um es dir zu berichten.',
        ...
        17: 'Dieser redete noch, da kam ein anderer und sprach: Die Chaldäer haben drei Haufen gebildet und sind über die Kamele hergefallen und haben sie weggenommen, und die Knechte haben sie mit der Schärfe des Schwertes erschlagen; und ich bin entronnen, nur ich allein, um es dir zu berichten.',
    ...
    2: {
        1: 'Und es geschah eines Tages, da kamen die Söhne Gottes, um sich vor Jehova zu stellen; und auch Satan kam in ihrer Mitte, um sich vor Jehova zu stellen.',
        2: 'Und Jehova sprach zum Satan: Von woher kommst du? Und Satan antwortete Jehova und sprach: Vom Durchstreifen der Erde und vom Umherwandeln auf ihr.',
    ...
    4: {
        ...
        20: 'Von Morgen bis Abend werden sie zerschmettert; ohne daß mans beachtet, kommen sie um auf ewig.',
    ...
    6: {
        ...
        13: 'Ist es nicht also, daß keine Hülfe in mir, und jede Kraft aus mir vertrieben ist?',
    ...
    7: {
        ...
        16: 'Ich bins überdrüssig- nicht ewiglich werde ich ja leben: Laß ab von mir! denn ein Hauch sind meine Tage.',
    ...
    10: {
        ...
        21: 'ehe ich hingehe in das Land der Finsternis und des Todesschattens,',
    ...
    14: {
        ...
        14: 'Alle Tage meiner Dienstzeit wollte ich harren, bis meine Ablösung käme!',
    ...
    40: {
        1: 'Und Jehova antwortete Hiob aus dem Sturme und sprach:',
        2: 'Gürte doch wie ein Mann deine Lenden; ich will dich fragen, und du belehre mich!',
        3: 'Willst du gar mein Recht zunichte machen, mich verdammen, damit du gerecht seiest?',
        4: 'Oder hast du einen Arm wie Gott, und kannst du donnern mit einer Stimme wie er?',
        5: 'Schmücke dich doch mit Erhabenheit und Hoheit, und kleide dich in Pracht und Majestät!',
        6: 'Gieße aus die Ausbrüche deines Zornes, und sieh an alles Hoffärtige und erniedrige es!',
        7: 'Sieh an alles Hoffärtige, beuge es, und reiße nieder die Gesetzlosen auf ihrer Stelle!',
        8: 'Verbirg sie allesamt in den Staub, schließe ihre Angesichter in Verborgenheit ein!',
        9: 'Dann werde auch ich dich preisen, daß deine Rechte dir Hülfe schafft.',
        10: 'Sieh doch den Behemoth, den ich mit dir gemacht habe; er frißt Gras wie das Rind.',
        11: 'Sieh doch, seine Kraft ist in seinen Lenden, und seine Stärke in den Muskeln seines Bauches.',
        12: 'Er biegt seinen Schwanz gleich einer Ceder, die Sehnen seiner Schenkel sind verflochten.',
        13: 'Seine Knochen sind Röhren von Erz, seine Gebeine gleich Barren von Eisen.',
        14: 'Er ist der Erstling der Wege Gottes; der ihn gemacht, hat ihm sein Schwert beschafft.',
        15: 'Denn die Berge tragen ihm Futter, und daselbst spielt alles Getier des Feldes.',
        16: 'Unter Lotosbüschen legt er sich nieder, im Versteck von Rohr und Sumpf;',
        17: 'Lotosbüsche bedecken ihn mit ihrem Schatten, es umgeben ihn die Weiden des Baches.',
        18: 'Siehe, der Strom schwillt mächtig an, er flieht nicht ängstlich davon; er bleibt wohlgemut, wenn ein Jordan gegen sein Maul hervorbricht.',
        19: 'Fängt man ihn wohl vor seinen Augen, durchbohrt man ihm die Nase mit einem Fangseile?',
        20: 'Ziehst du den Leviathan herbei mit der Angel, und senkst du seine Zunge in die Angelschnur?',
        21: 'Kannst du einen Binsenstrick durch seine Nase ziehen, und seinen Kinnbacken mit einem Ringe durchbohren?',
        22: 'Wird er viel Flehens an dich richten, oder dir sanfte Worte geben?',
        23: 'Wird er einen Bund mit dir machen, daß du ihn zum ewigen Knechte nehmest?',
        24: 'Wirst du mit ihm spielen wie mit einem Vogel, und ihn anbinden für deine Mädchen? Werden die Fischergenossen ihn verhandeln, ihn verteilen unter Kaufleute? Kannst du seine Haut mit Spießen füllen, und seinen Kopf mit Fischharpunen? Lege deine Hand an ihn, -gedenke des Kampfes, tue es nicht wieder!',
    },
    41: {
