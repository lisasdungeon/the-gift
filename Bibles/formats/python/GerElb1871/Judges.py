...
CHAPTERS = {
    1: {
        ...
        5: 'Und sie fanden den Adoni-Besek in Besek und stritten wider ihn; und sie schlugen die Kanaaniter und die Perisiter.',
        ...
        18: 'Und Juda nahm Gasa ein und sein Gebiet, und Askelon und sein Gebiet, und Ekron und sein Gebiet.',
    ...
    2: {
        ...
        18: 'Und wenn Jehova ihnen Richter erweckte, so war Jehova mit dem Richter, und er rettete sie aus der Hand ihrer Feinde alle Tage des Richters; denn Jehova ließ sichs gereuen wegen ihrer Wehklage vor ihren Bedrückern und ihren Drängern.',
    ...
    3: {
        ...
        29: 'Und sie schlugen die Moabiter zu selbiger Zeit, bei zehntausend Mann, alle kräftige und streitbare Männer, und keiner entrann.',
    ...
    5: {
        ...
        3: 'Höret, ihr Könige; horchet auf, ihr Fürsten! Ich will, ja, ich will Jehova singen, will singen und spielen Jehova, dem Gott Israels!',
        ...
        8: 'Es erwählte neue Götter; da war Streit an den Toren! Ward wohl Schild und Lanze gesehen unter 40000 in Israel?',
        ...
        23: 'Fluchet Meros! spricht der Engel Jehovas, verfluchet seine Bewohner! Denn sie sind nicht Jehova zu Hülfe gekommen, Jehova zu Hülfe unter den Helden.',
    ...
    7: {
        1: 'Und Jerub-Baal, das ist Gideon, und alles Volk, das mit ihm war, machten sich früh auf, und sie lagerten sich an der Quelle Harod; das Lager Midians aber war ihm nordwärts, nach dem Hügel More hin, im Tale.',
        ...
        3: 'Und nun rufe doch vor den Ohren des Volkes aus und sprich: Wer furchtsam und verzagt ist, kehre um und wende sich zurück vom Gebirge Gilead! Da kehrten von dem Volke 22000 um, und 10000 blieben übrig.',
    ...
    8: {
        1: 'Und die Männer von Ephraim sprachen zu ihm: Was ist das für eine Sache, die du uns getan, daß du uns nicht gerufen hast, als du hinzogest, um wider Midian zu streiten! Und sie zankten heftig mit ihm.',
        ...
        24: 'Und Gideon sprach zu ihnen: Eine Bitte will ich von euch erbitten: Gebet mir ein jeder sie Ohrringe seiner Beute!.',
        ...
        26: 'Und das Gewicht der goldenen Ohrringe, die er erbeten hatte, war 1700 Sekel Gold, außer den Halbmonden und den Ohrgehängen und den Purpurkleidern, welche die Könige von Midian trugen, und außer den Halsketten, die an den Hälsen ihrer Kamele waren.',
        ...
        28: 'So wurde Midian vor den Kindern Israels gebeugt, und es hob sein Haupt nicht mehr empor. Und das Land hatte in den Tagen Gideons Ruhe vierzig Jahre.',
    ...
    9: {
        1: 'Und Abimelech, der Sohn Jerub-Baals, ging nach Sichem zu den Brüdern seiner Mutter; und er redete zu ihnen und zu dem ganzen Geschlecht des Hauses des Vaters seiner Mutter und sprach:',
        ...
        15: 'Und der Dornstrauch sprach zu den Bäumen: Wenn ihr mich in Wahrheit zum König über euch salben wollt, so kommet, vertrauet euch meinem Schatten an; wenn aber nicht, so soll Feuer von dem Dornstrauch ausgehen und die Cedern des Libanon verzehren. -',
        ...
        21: 'Und Jotham floh und entwich und ging nach Beer; und er blieb daselbst wegen seines Bruders Abimelech.',
        ...
        31: 'und er sandte Boten an Abimelech mit List und sprach: Siehe, Gaal, der Sohn Ebeds, und seine Brüder sind nach Sichem gekommen, und siehe, sie wiegeln die Stadt wider dich auf.',
        32: 'Und nun, mache dich in der Nacht auf, du und das Volk, das bei dir ist, und lege dich in Hinterhalt auf dem Felde.',
        33: 'Und es geschehe am Morgen, wenn die Sonne aufgeht, so mache dich früh auf und überfalle die Stadt; und siehe, wenn er und das Volk, das bei ihm ist, gegen dich hinausziehen, so tue ihm, wie deine Hand es finden wird.',
        34: 'Und Abimelech und alles Volk, das mit ihm war, machten sich in der Nacht auf, und sie legten sich in vier Haufen gegen Sichem in Hinterhalt.',
        35: 'Und Gaal, der Sohn Ebeds, ging hinaus und trat an den Eingang des Stadttores. Da machten sich Abimelech und das Volk, das bei ihm war, aus dem Hinterhalt auf.',
        36: 'Und Gaal sah das Volk und sprach zu Sebul: Siehe, Volk kommt von den Gipfeln der Berge herab. Und Sebul sprach zu ihm: Den Schatten der Berge siehst du für Männer an.',
        37: 'Und Gaal redete wiederum und sprach: Siehe, Volk kommt von der Höhe des Landes herab, und ein Haufe kommt des Weges nach Elon-Meonenim.',
        ...
        43: 'Und er nahm das Volk und teilte es in drei Haufen und legte sich in Hinterhalt auf dem Felde. Und er sah, und siehe, das Volk kam aus der Stadt heraus; und er erhob sich wider sie und schlug sie.',
        44: 'Und Abimelech und die Haufen, die mit ihm waren, brachen hervor und stellten sich an den Eingang des Stadttores; und zwei der Haufen fielen über alle her, die auf dem Felde waren, und erschlugen sie.',
        45: 'Und Abimelech stritt wider die Stadt jenen ganzen Tag; und er nahm die Stadt ein, und das Volk, das darin war, tötete er; und er riß die Stadt nieder und bestreute sie mit Salz.',
        46: 'Und alle Bewohner des Turmes von Sichem hörten es, und sie gingen in die Burg des Hauses des Gottes Berith.',
        ...
        56: 'Und so brachte Gott die Bosheit Abimelechs, die er an seinem Vater verübt hatte, indem er seine siebzig Brüder ermordete, auf ihn zurück.',
        57: 'Und die ganze Bosheit der Männer von Sichem brachte Gott auf ihren Kopf zurück, und es kam über sie der Fluch Jothams, des Sohnes Jerub-Baals.',
    },
    10: {
        1: 'Und nach Abimelech stand auf, um Israel zu retten, Tola der Sohn Puas, des Sohnes Dodos, ein Mann von Issaschar; und er wohnte zu Schamir im Gebirge Ephraim.',
    ...
    11: {
        ...
        39: 'Und es geschah am Ende von zwei Monaten, da kehrte sie zu ihrem Vater zurück. Und er tat an ihr das Gelübde, das er gelobt hatte. Sie hatte aber keinen Mann erkannt. Und es wurde zum Gebrauch in Israel:',
    ...
    12: {
        ...
        6: 'Und sagte er: Nein! so sprachen sie zu ihm: Sage doch: Schibboleth! Und sagte er: Sibboleth, und brachte es nicht fertig, richtig zu sprechen, dann ergriffen sie ihn und schlachteten ihn an den Furten des Jordan. Und es fielen in jener Zeit von Ephraim 42000.',
    ...
    13: {
        ...
        11: 'Und Manoah machte sich auf und ging seinem Weibe nach; und er kam zu dem Manne und sprach zu ihm: Bist du der Mann, der zu dem Weibe geredet hat? Und er sprach: Ich bins.',
    ...
    15: {
        1: 'Und es geschah nach einiger Zeit, in den Tagen der Weizenernte, da besuchte Simson sein Weib mit einem Ziegenböcklein. Und er sprach: Ich will zu meinem Weibe ins Gemach gehen; aber ihr Vater gestattete ihm nicht hineinzugehen.',
        ...
        16: 'Und Simson sprach: Mit dem Eselskinnbacken einen Haufen, zwei Haufen Mit dem Eselskinnbacken habe ich tausend Mann erschlagen!',
        17: 'Und es geschah, als er ausgeredet hatte, da warf er den Kinnbacken aus seiner Hand; und er nannte selbigen Ort Ramath-Lechi.',
        18: 'Und es dürstete ihn sehr, und er rief zu Jehova und sprach: Du hast durch die Hand deines Knechtes diese große Rettung gegeben, und nun soll ich vor Durst sterben und in die Hand der Unbeschnittenen fallen!',
        19: 'Da spaltete Gott die Höhlung, die zu Lechi ist, und es kam Wasser aus ihr hervor; und er trank, und sein Geist kehrte zurück, und er lebte wieder auf. Daher gab man ihr den Namen: Quelle des Rufenden, die zu Lechi ist, bis auf diesen Tag.',
    ...
    16: {
        ...
        5: 'Und die Fürsten der Philister gingen zu ihr hinauf und sprachen zu ihr: Berede ihn und sieh, worin seine große Stärke besteht, und wodurch wir ihn überwältigen können, daß wir ihn binden, um ihn zu bezwingen; und wir wollen dir ein jeder 1100 Sekel Silber geben.',
        ...
        7: 'Und Simson sprach zu ihr: Wenn man mich bände mit sieben frischen Stricken, die nicht ausgetrocknet sind, so würde ich schwach werden und würde sein wie ein anderer Mensch.',
        ...
        25: 'Und es geschah, als ihr Herz fröhlich war, da sprachen sie: Rufet Simson, daß er vor uns spiele. Und sie riefen Simson aus dem Gefängnis, und er spielte vor ihnen; und sie stellten ihn zwischen die Säulen.',
        ...
        27: 'Das Haus war aber voll Männern und Weibern, und alle Fürsten der Philister waren daselbst; und auf dem Dache waren bei dreitausend Männer und Weiber, welche zusahen, wie Simson spielte.',
        28: 'Und Simson rief zu Jehova und sprach: Herr, Jehova! gedenke doch meiner, und stärke mich doch nur diesmal, o Gott, daß ich an den Philistern eine einmalige Rache nehme für meine beiden Augen!',
        29: 'Und Simson umfaßte die beiden Mittelsäulen, auf welchen das Haus ruhte, die eine mit seiner Rechten und die andere mit seiner Linken;',
    ...
    18: {
        ...
        10: 'denn Gott hat es in eure Hand gegeben: es ist ein Ort, wo es an nichts mangelt von allem, was auf Erden ist.',
        ...
        28: 'Und kein Erretter war da; denn die Stadt war fern von Zidon, und sie hatten nichts mit Menschen zu schaffen; und sie lag in dem Tale, das nach Beth-Rechob hin sich erstreckt. Und sie bauten die Stadt wieder auf und wohnten darin;',
    ...
    20: {
        1: 'Und alle Kinder Israel zogen aus, und die Gemeinde, von Dan bis Beerseba, und das Land Gilead versammelte sich wie ein Mann vor Jehova nach Mizpa.',
        2: 'Und die Häupter des ganzen Volkes, aller Stämme Israels, stellten sich in der Versammlung des Volkes Gottes: 400000 Mann Fußvolk, die das Schwert zogen. -',
        ...
        5: 'Da machten sich die Bürger von Gibea wider mich auf und umringten meinetwegen des Nachts das Haus. Mich gedachten sie umzubringen, und mein Kebsweib haben sie geschwächt, daß sie starb.',
        ...
        10: 'und nehmen wir zehn Männer von hundert, von allen Stämmen Israels, und hundert von tausend und tausend von zehntausend, um Zehrung für das Volk zu holen, damit, wenn sie nach Gibea-Benjamin kommen, man an ihm tue nach all der Schandtat, die es in Israel begangen hat.',
        11: 'Und alle Männer von Israel versammelten sich gegen die Stadt, wie ein Mann verbündet.',
        12: 'Und die Stämme Israels sandten Männer in alle Geschlechter Benjamins und sprachen: Was ist das für eine Übeltat, die unter euch geschehen ist!',
        ...
        15: 'Und die Kinder Benjamin wurden an selbigem Tage aus den Städten gemustert: 26000 Mann, die das Schwert zogen; außer den Bewohnern von Gibea, die gemustert wurden: 700 auserlesene Männer.',
        16: 'Unter all diesem Volke waren 700 auserlesene Männer, die links waren; diese alle schleuderten mit dem Steine aufs Haar und fehlten nicht.',
        17: 'Und die Männer von Israel wurden gemustert, außer Benjamin: 400000 Mann, die das Schwert zogen; diese alle waren Kriegsmänner.',
        18: 'Und die Kinder Israel machten sich auf und zogen hinauf nach Bethel und befragten Gott, und sie sprachen: Wer von uns soll zuerst hinaufziehen zum Streit mit den Kindern Benjamin? Und Jehova sprach: Juda zuerst.',
        ...
        21: 'Und die Kinder Benjamin zogen aus Gibea heraus, und sie streckten unter Israel an selbigem Tage 22000 Mann zu Boden.',
        ...
        25: 'Und Benjamin zog am zweiten Tage aus Gibea heraus, ihnen entgegen, und sie streckten nochmals unter den Kindern Israel 18000 Mann zu Boden; diese alle zogen das Schwert.',
        ...
        33: 'Und alle Männer von Israel machten sich auf von ihrem Orte und stellten sich zu Baal-Tamar auf, während der Hinterhalt Israels von seinem Orte hervorbrach aus dem Blachfelde von Gibea.',
        ...
        35: 'Und Jehova schlug Benjamin vor Israel, und die Kinder Israel streckten unter Benjamin an selbigem Tage 25100 Mann nieder; diese alle zogen das Schwert. -',
        ...
        44: 'Und es fielen von Benjamin 18000 Mann; diese alle waren tapfere Männer.',
        45: 'Da wandten sie sich und flohen der Wüste zu, nach dem Felsen Rimmon; aber die Israeliten hielten unter ihnen auf den Landstraßen eine Nachlese von fünftausend Mann, und setzten ihnen nach bis Gideom und erschlugen von ihnen zweitausend Mann.',
        46: 'So waren all der von Benjamin an selbigem Tage Gefallenen 25000 Mann, die das Schwert zogen; diese alle waren tapfere Männer.',
    ...
    21: {
        1: 'Die Männer von Israel hatten aber zu Mizpa geschworen und gesagt: Niemand von uns soll seine Tochter den Benjaminitern zum Weibe geben!',
        2: 'Und das Volk kam nach Bethel, und sie blieben daselbst bis an den Abend vor Gott; und sie erhoben ihre Stimme und weinten sehr',
        3: 'und sprachen: Warum, Jehova, Gott Israels, ist dieses in Israel geschehen, daß heute ein Stamm aus Israel vermißt wird?',
        ...
        6: 'Und die Kinder Israel ließen sichs gereuen über Benjamin, ihren Bruder, und sie sprachen: Heute ist ein Stamm von Israel abgehauen!',
        ...
        12: 'Und sie fanden unter den Bewohnern von Jabes-Gilead vierhundert Mädchen, Jungfrauen, die keinen Mann im Beischlaf erkannt hatten; und sie brachten sie ins Lager nach Silo, das im Lande Kanaan ist.',
        13: 'Und die ganze Gemeinde sandte hin und redete zu den Kindern Benjamin, die am Felsen Rimmon waren, und entbot ihnen Frieden.',
        14: 'Und Benjamin kehrte in selbiger Zeit zurück; und sie gaben ihnen die Weiber, welche sie hatten leben lassen von den Weibern von Jabes-Gilead; aber sie fanden so nicht genug für sie.',
        15: 'Und das Volk ließ sichs gereuen wegen Benjamins, weil Jehova einen Riß gemacht hatte in den Stämmen Israels.',
        16: 'Und die Ältesten der Gemeinde sprachen: Was sollen wir den Übriggebliebenen tun betreffs der Weiber? Denn die Weiber sind aus Benjamin vertilgt.',
        17: 'Und sie sprachen: Ein Besitztum soll sein für die Entronnenen von Benjamin, damit nicht ein Stamm aus Israel ausgetilgt werde.',
        ...
        24: 'Und die Kinder Israel zogen in selbiger Zeit von dannen, ein jeder zu seinem Stamme und zu seinem Geschlecht; und sie zogen von dannen hinweg, ein jeder in sein Erbteil.',
