...
CHAPTERS = {
    ...
    3: {
        ...
        4: 'Und Nadab und Abihu starben vor Jehova, als sie in der Wüste Sinai fremdes Feuer vor Jehova darbrachten; und sie hatten keine Söhne. Und Eleasar und Ithamar übten den Priesterdienst vor ihrem Vater Aaron aus.',
    ...
    4: {
        ...
        49: 'Nach dem Befehl Jehovas musterte man sie durch Mose, jeden einzelnen zu seinem Dienst und zu seiner Traglast; und sie wurden von ihm gemustert, wie Jehova dem Mose geboten hatte.',
    },
    5: {
    ...
    11: {
        ...
        21: 'Und Mose sprach: 600000 Mann zu Fuß ist das Volk, in dessen Mitte ich bin, und du sprichst: Fleisch will ich ihnen geben, daß sie einen ganzen Monat essen!',
        ...
        26: 'Und zwei Männer blieben im Lager zurück, der Name des einen war Eldad, und der Name des anderen Medad; und auch auf sie kam der Geist, und sie weissagten im Lager.',
    ...
    13: {
        ...
        21: 'Und sie zogen hinauf und kundschafteten das Land aus, von der Wüste Zin bis Rechob, wenn man nach Hamath geht.',
        ...
        23: 'Und sie kamen bis in das Tal Eskol und schnitten daselbst eine Rebe mit einer Weintraube ab und trugen sie zu zweien an einer Stange, auch Granatäpfel und Feigen.',
    ...
    14: {
        ...
        9: 'Nur empöret euch nicht wider Jehova; und fürchtet ja nicht das Volk des Landes, denn unser Brot werden sie sein. Ihr Schirm ist von ihnen gewichen, und Jehova ist mit uns; fürchtet sie nicht!',
        ...
        14: 'und man wird es den Bewohnern dieses Landes sagen, welche gehört haben, daß du, Jehova, in der Mitte dieses Volkes bist, daß du, Jehova, Auge in Auge dich sehen läßt, und daß deine Wolke über ihnen steht, und du in einer Wolkensäule vor ihnen hergehst bei Tage und in einer Feuersäule bei Nacht.',
    ...
    16: {
        ...
        9: 'Ist es euch zu wenig, daß der Gott Israels euch aus der Gemeinde Israel ausgesondert hat, um euch zu sich nahen zu lassen, damit ihr den Dienst der Wohnung Jehovas verrichtet, und vor der Gemeinde stehet, um sie zu bedienen,',
        ...
        17: 'Und nehmet ein jeder seine Räucherpfanne und leget Räucherwerk darauf, und bringet ein jeder seine Räucherpfanne dar vor Jehova, 250 Räucherpfannen; und du und Aaron, ein jeder seine Räucherpfanne.',
        ...
        22: 'Und sie fielen auf ihr Angesicht und sprachen: Gott, du Gott der Geister alles Fleisches! der eine Mann sündigt, und du solltest über die ganze Gemeinde zürnen?',
        23: 'Und Jehova redete zu Mose und sprach:',
        ...
        29: 'Wenn diese sterben, wie alle Menschen sterben, und mit der Heimsuchung aller Menschen heimgesucht werden, so hat Jehova mich nicht gesandt;',
        30: 'wenn aber Jehova ein Neues schafft, und der Erdboden seinen Mund auftut und sie verschlingt mit allem, was ihnen angehört, und sie lebendig in den Scheol hinabfahren, so werdet ihr erkennen, daß diese Männer Jehova verachtet haben. -',
        ...
        35: 'Und Feuer ging aus von Jehova und fraß die 250 Männer, die das Räucherwerk dargebracht hatten.',
        ...
        48: 'Und er stand zwischen den Toten und den Lebendigen, und der Plage ward gewehrt.',
        49: 'Und es waren derer, die an der Plage starben, 14700, außer denen, die Korahs wegen gestorben waren.',
        50: 'Und Aaron kam wieder zu Mose an den Eingang des Zeltes der Zusammenkunft, als der Plage gewehrt war.',
    },
    17: {
        1: 'Und Jehova redete zu Mose und sprach:',
    ...
    18: {
        ...
        2: 'Und auch deine Brüder, den Stamm Levi, den Stamm deines Vaters, laß mit dir herzunahen, daß sie sich dir anschließen und dir dienen; du aber und deine Söhne mit dir, ihr sollt vor dem Zelte des Zeugnisses dienen.',
        ...
        6: 'Und ich, siehe, ich habe eure Brüder, die Leviten, aus der Mitte der Kinder Israel genommen; euch als Geschenk sind sie dem Jehova gegeben, um den Dienst des Zeltes der Zusammenkunft zu verrichten.',
        ...
        22: 'Und die Kinder Israel sollen nicht mehr dem Zelte der Zusammenkunft nahen, um Sünde auf sich zu laden, daß sie sterben;',
        23: 'die Leviten vielmehr sollen den Dienst des Zeltes der Zusammenkunft verrichten, und sie sollen ihre Ungerechtigkeit tragen: eine ewige Satzung bei euren Geschlechtern. Aber inmitten der Kinder Israel sollen sie kein Erbteil besitzen;',
    ...
    22: {
        1: 'Und die Kinder Israel brachen auf und lagerten sich in den Ebenen Moabs, jenseit des Jordan von Jericho.',
        ...
        5: 'Und er sandte Boten zu Bileam, dem Sohne Beors, nach Pethor, das am Strome ist, in das Land der Kinder seines Volkes, um ihn zu rufen, und er ließ ihm sagen: Siehe, ein Volk ist aus Ägypten gezogen; siehe, es bedeckt die Fläche des Landes, und es liegt mir gegenüber.',
        ...
        30: 'Und die Eselin sprach zu Bileam: Bin ich nicht deine Eselin, auf der du geritten hast von jeher bis auf diesen Tag? War ich je gewohnt, dir also zu tun? Und er sprach: Nein.',
    ...
    23: {
        ...
        21: 'Er erblickt keine Ungerechtigkeit in Jakob und sieht kein Unrecht in Israel; Jehova, sein Gott, ist mit ihm, und Jubelgeschrei wie um einen König ist unter ihm.',
        22: 'Gott hat ihn aus Ägypten herausgeführt; sein ist die Stärke des Büffels.',
    ...
    24: {
        ...
        8: 'Gott hat ihn aus Ägypten herausgeführt; sein ist die Stärke des Büffels. Er wird die Nationen, seine Feinde, fressen und ihre Gebeine zermalmen und mit seinen Pfeilen sie zerschmettern.',
        ...
        17: 'Ich sehe ihn, aber nicht jetzt, ich schaue ihn, aber nicht nahe; es tritt hervor ein Stern aus Jakob, und ein Scepter erhebt sich aus Israel und zerschlägt die Seiten Moabs und zerschmettert alle Söhne des Getümmels.',
    ...
    25: {
        ...
        8: 'und er ging dem israelitischen Manne nach in das Innere des Zeltes und durchstach sie beide, den israelitischen Mann und das Weib, durch ihren Bauch. Da ward die Plage von den Kindern Israel abgewehrt.',
    ...
    26: {
        ...
        29: 'Die Söhne Manasses: von Makir das Geschlecht der Makiriter; von Gilead das Geschlecht der Gileaditer.',
        ...
        59: 'Und der Name des Weibes Amrams war Jokebed, eine Tochter Levis, die sie dem Levi gebar in Ägypten; und sie gebar dem Amram Aaron und Mose und Mirjam, ihre Schwester.',
    ...
    27: {
        ...
        14: 'weil ihr in der Wüste Zin, beim Hadern der Gemeinde, widerspenstig gewesen seid gegen meinen Befehl, mich durch das Wasser vor ihren Augen zu heiligen.',
    ...
    28: {
        ...
        31: 'Außer dem beständigen Brandopfer und seinem Speisopfer sollt ihr sie opfern nebst ihren Trankopfern.',
    },
    29: {
    ...
    31: {
        ...
        38: 'und die Zahl der Rinder 36000,und die Abgabe davon für Jehova 72;',
    ...
    32: {
        ...
        7: 'Und warum wollt ihr das Herz der Kinder Israel davon abwendig machen, in das Land hinüber zu ziehen, welches Jehova ihnen gegeben hat?',
        8: 'So haben eure Väter getan, als ich sie von Kades-Barnea aussandte, das Land zu besehen:',
        9: 'sie zogen hinauf bis zum Tale Eskol und besahen das Land; und sie machten das Herz der Kinder Israel abwendig, daß sie nicht in das Land gingen, welches Jehova ihnen gegeben hatte.',
        10: 'Und der Zorn Jehovas entbrannte an jenem Tage, und er schwur und sprach:',
        11: 'Wenn die Männer, die aus Ägypten hinaufgezogen sind, von zwanzig Jahren und darüber, das Land sehen werden, das ich Abraham und Isaak und Jakob zugeschworen habe! denn sie sind mir nicht völlig nachgefolgt;',
        12: 'ausgenommen Kaleb, der Sohn Jephunnes, der Kenisiter, und Josua, der Sohn Nuns; denn sie sind Jehova völlig nachgefolgt.',
        ...
        18: 'Wir wollen nicht zu unseren Häusern zurückkehren, bis die Kinder Israel ein jeder sein Erbteil empfangen haben.',
        19: 'Denn wir wollen nicht mit ihnen erben jenseit des Jordan und weiterhin, denn unser Erbteil ist uns diesseit des Jordan gegen Sonnenaufgang zugekommen.',
        20: 'Da sprach Mose zu ihnen: Wenn ihr dieses tut, wenn ihr euch vor Jehova zum Streite rüstet,',
        21: 'und alle unter euch, die gerüstet sind, vor Jehova über den Jordan ziehen, bis er seine Feinde vor sich ausgetrieben hat,',
        22: 'und das Land vor Jehova unterjocht ist, und ihr danach zurückkehret, so sollt ihr schuldlos sein gegen Jehova und gegen Israel; und dieses Land soll euch zum Eigentum sein vor Jehova.',
        23: 'Wenn ihr aber nicht also tut, siehe, so habt ihr wider Jehova gesündigt; und wisset, daß eure Sünde euch finden wird.',
        ...
        29: 'und Mose sprach zu ihnen: Wenn die Kinder Gad und die Kinder Ruben, alle zum Streit Gerüsteten, mit euch vor Jehova über den Jordan ziehen, und das Land vor euch unterjocht sein wird, so sollt ihr ihnen das Land Gilead zum Eigentum geben;',
        30: 'wenn sie aber nicht gerüstet mit euch hinüberziehen, so sollen sie sich unter euch ansässig machen im Lande Kanaan.',
        31: 'Und die Kinder Gad und die Kinder Ruben antworteten und sprachen: Wie Jehova zu deinen Knechten geredet hat, so wollen wir tun.',
        32: 'Wir wollen gerüstet vor Jehova in das Land Kanaan hinüberziehen, und unser Erbbesitztum verbleibe uns diesseit des Jordan.',
        33: 'Und Mose gab ihnen, den Kindern Gad und den Kindern Ruben und der Hälfte des Stammes Manasse, des Sohnes Josephs, das Königreich Sihons, des Königs der Amoriter, und das Königreich Ogs, des Königs von Basan, das Land nach seinen Städten in ihren Grenzen, die Städte des Landes ringsum.',
        ...
        39: 'Und die Söhne Makirs, des Sohnes Manasses, zogen nach Gilead und nahmen es ein; und sie trieben die Amoriter, die darin wohnten, aus.',
        40: 'Und Mose gab Gilead dem Makir, dem Sohne Manasses; und er wohnte darin.',
        41: 'Und Jair, der Sohn Manasses, zog hin und nahm ihre Dörfer ein und nannte sie Dörfer Jairs.',
        42: 'Und Nobach zog hin und nahm Kenath und seine Tochterstädte ein und nannte es Nobach nach seinem Namen.',
    },
    33: {
    ...
    36: {
        1: 'Und es traten herzu die Häupter der Väter vom Geschlecht der Söhne Gileads, des Sohnes Makirs, des Sohnes Manasses, aus den Geschlechtern der Söhne Josephs; und sie redeten vor Mose und vor den Fürsten, den Häuptern der Väter der Kinder Israel,',
        2: 'und sprachen: Jehova hat meinem Herrn geboten, den Kindern Israel das Land durchs Los als Erbteil zu geben; und meinem Herrn ist von Jehova geboten worden, das Erbteil Zelophchads, unseres Bruders, seinen Töchtern zu geben.',
