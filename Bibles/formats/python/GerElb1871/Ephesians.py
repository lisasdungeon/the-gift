...
CHAPTERS = {
    ...
    3: {
        ...
        11: 'nach dem Vorsatz der Zeitalter, den er gefaßt hat in Christo Jesu, unserem Herrn;',
    ...
    4: {
        ...
        29: 'Kein faules Rede gehe aus eurem Munde, sondern das irgend gut ist zur notwendigen Erbauung, auf daß es den Hörenden Gnade darreiche.',
    ...
    5: {
        ...
        5: 'Denn dieses wisset und erkennet ihr, daß kein Hurer oder Unreiner oder Habsüchtiger, ein Erbteil hat in dem Reiche Christi und Gottes.',
    ...
    6: {
        ...
        20: ', damit ich in demselben freimütig rede, wie ich reden soll.',
