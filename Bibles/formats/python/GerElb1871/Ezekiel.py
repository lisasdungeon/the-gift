...
CHAPTERS = {
    1: {
        ...
        22: 'Und über den Häuptern des lebendigen Wesens war das Gebilde einer Ausdehnung wie der Anblick eines wundervollen Krystalls, ausgebreitet oben über ihren Häuptern.',
        ...
        27: 'Und ich sah wie den Anblick von glänzendem Metall, wie das Aussehen von Feuer innerhalb desselben ringsum; von seinen Lenden aufwärts und von seinen Lenden abwärts sah ich wie das Aussehen von Feuer; und ein Glanz war rings um denselben.',
    ...
    2: {
        ...
        5: 'Und sie, mögen sie hören oder es lassen sie sollen doch wissen daß ein Prophet in ihrer Mitte war.',
    ...
    3: {
        1: 'Und er sprach zu mir: Menschensohn, iß, was du findest; iß diese Rolle, und gehe hin, rede zu dem Hause Israel.',
        ...
        22: 'Und die Hand Jehovas kam daselbst über mich, und er sprach zu mir: Mache dich auf, gehe hinaus in das Tal und dort will ich mit dir reden.',
        ...
        27: 'Wenn ich aber mit dir reden werde, will ich deinen Mund auftun, und du sollst zu ihnen sprechen: "So spricht der Herr, Jehova!" Wer hören will, der höre, und wer es läßt, der lasse es; denn ein widerspenstiges Haus sind sie.',
    },
    4: {
    ...
    7: {
        ...
        9: 'Und mein Auge soll nicht schonen, und ich werde mich nicht erbarmen; nach deinen Wegen will ichs über dich bringen, und deine Greuel sollen in deiner Mitte sein. Und ihr werdet wissen, daß ich, Jehova, es bin, der schlägt. -',
    ...
    8: {
        ...
        16: 'Und er brachte mich in den inneren Vorhof des Hauses Jehovas; und siehe, am Eingang des Tempels Jehovas, zwischen der Halle und dem Altar, waren 25 Männer, ihre Rücken gegen den Tempel Jehovas und ihre Angesichter gegen Osten gerichtet; und sie bückten sich gegen Osten hin vor der Sonne.',
    ...
    9: {
        ...
        4: 'und Jehova sprach zu ihm: Gehe mitten durch die Stadt, mitten durch Jerusalem, und mache ein Zeichen an die Stirnen der Leute, welche seufzen und jammern über all die Greuel, die in ihrer Mitte geschehen.',
        ...
        6: 'Mordet bis zur Vertilgung Greise, Jünglinge und Jungfrauen und Kinder und Weiber! aber nahet euch niemandem, an welchem das Zeichen ist; und bei meinem Heiligtum sollt ihr anfangen. Und sie fingen an bei den alten Männern, welche vor dem Hause waren. -',
    ...
    10: {
        ...
        2: 'Und er sprach zu dem in Linnen gekleideten Manne und sagte: Gehe hinein zwischen den Räderwirbel unterhalb des Cherubs und fülle deine Hände mit Feuerkohlen von dem Raume zwischen den Cherubim, und streue sie über die Stadt hin. Und er ging vor meinen Augen hinein.',
    ...
    11: {
        1: 'Und der Geist hob mich empor und brachte mich zum östlichen Tore des Hauses Jehovas, welches gegen Osten sieht. Und siehe, an dem Eingang des Tores waren 25 Männer; und ich sah in ihrer Mitte Jaasanja, den Sohn Assurs, und Pelatja, den Sohn Benajas, die Fürsten des Volkes.',
        2: 'Und er sprach zu mir: Menschensohn, das sind die Männer, welche Unheil sinnen und bösen Rat erteilen in dieser Stadt,',
        3: 'die da sprechen: Es ist nicht an der Zeit Häuser zu bauen sie ist der Topf, und wir sind das Fleisch',
    ...
    12: {
        ...
        14: 'Und alle, die um ihn her sind, seine Hülfe und alle seine Scharen, will ich in alle Winde zerstreuen und das Schwert ziehen hinter ihnen her.',
    ...
    13: {
        ...
        18: 'und sprich: So spricht der Herr, Jehova: Wehe denen, welche Binden zusammennähen über alle Gelenke der Hände und Kopfhüllen machen nach dem Haupte jedes Wuchses, um Seelen zu fangen! Die Seelen meines Volkes fanget ihr, und eure Seelen erhaltet ihr am Leben?',
    ...
    16: {
        ...
        3: 'und sprich: So spricht der Herr, Jehova, zu Jerusalem: Dein Ursprung und deine Abstammung ist aus dem Lande der Kanaaniter; dein Vater war ein Amoriter, und deine Mutter eine Hethiterin.',
        ...
        23: 'Und es geschah, nach aller deiner Bosheit',
    ...
    17: {
        ...
        23: 'Auf den hohen Berg Israels werde ich ihn pflanzen; und er wird Zweige treiben und Frucht tragen und zu einer herrlichen Ceder werden; und unter ihr werden alle Vögel wohnen, alles Geflügelte: Im Schatten ihrer Zweige werden sie wohnen.',
    ...
    19: {
        ...
        2: 'und sprich: Welch eine Löwin war deine Mutter! Zwischen Löwen lagerte sie, unter jungen Löwen zog sie ihre Jungen groß.',
    ...
    20: {
        ...
        5: 'und sprich zu ihnen: So spricht der Herr, Jehova: An dem Tage, da ich Israel erwählte, und ich meine Hand dem Samen des Hauses Jakob erhob und ihnen im Lande Ägypten mich kundgab, und meine Hand ihnen erhob und sprach: Ich bin Jehova, euer Gott-',
    ...
    21: {
        1: 'Und das Wort Jehovas geschah zu mir also:',
        2: 'Menschensohn, richte dein Angesicht gegen Süden und rede gegen Mittag, und weissage über den Wald des Gefildes im Süden',
        ...
        5: 'Und ich sprach: Ach, Herr, Jehova! sie sagen von mir: Redet er nicht in Gleichnissen?',
        6: 'Und das Wort Jehovas geschah zu mir also:',
        7: 'Menschensohn, richte dein Angesicht gegen Jerusalem und rede über die Heiligtümer, und weissage über das Land Israel;',
        ...
        11: 'Und du, Menschensohn, seufze, daß die Hüften brechen und mit bitterem Schmerze seufze vor ihren Augen!',
        ...
        18: 'Denn die Probe ist gemacht; und was? wenn sogar das verachtende Scepter nicht mehr sein wird spricht der Herr, Jehova. -',
        19: 'Und du, Menschensohn, weissage und schlage die Hände zusammen; denn das Schwert, das Schwert der Erschlagenen, wird sich ins Dreifache vervielfältigen; es ist das Schwert des erschlagenen Großen welches sie umkreist.',
        20: 'Damit das Herz zerfließe und viele hinstürzen habe ich das schlachtende Schwert wider alle ihre Tore gerichtet. Wehe! Zum Blitzen ist es gemacht, zum Schlachten geschärft',
        ...
        24: 'Und du, Menschensohn, machte dir zwei Wege, auf welchen das Schwert des Königs von Babel kommen soll:von einem Lande sollen sie beide ausgehen; und zeichne einen Wegweiser, am Anfang des Weges nach der Stadt zeichne ihn.',
        25: 'Du sollst einen Weg machen, damit das Schwert nach Rabbath der Kinder Ammon komme, und nach Juda in das befestigte Jerusalem.',
        26: 'Denn der König von Babel bleibt am Kreuzwege stehen, am Anfang der beiden Wege, um sich wahrsagen zu lassen er schüttelt die Pfeile, befragt die Teraphim, beschaut die Leber.',
        27: 'In seine Rechte fällt die Wahrsagung "Jerusalem" daß er Sturmböcke aufstelle, den Mund auftue mit Geschrei, die Stimme erhebe mit Feldgeschrei, Sturmböcke gegen die Tore aufstelle, Wälle aufschütte und Belagerungstürme baue. -',
        28: 'Und es wird ihnen wie eine falsche Wahrsagung in ihren Augen sein; Eide um Eide haben sie; er aber wird die Ungerechtigkeit in Erinnerung bringen, auf daß sie ergriffen werden.',
        29: 'Darum, so spricht der Herr, Jehova: Weil ihr eure Ungerechtigkeit in Erinnerung bringet, indem eure Übertretungen offenbar werden, so daß eure Sünden in allen euren Handlungen zum Vorschein kommen-weil ihr in Erinnerung kommet, werdet ihr von der Hand ergriffen werden.',
        30: 'Und du, Unheiliger, Gesetzloser, Fürst Israels, dessen Tag gekommen ist zur Zeit der Ungerechtigkeit des Endes!',
        31: 'so spricht der Herr, Jehova: Hinweg mit dem Kopfbund und fort mit der Krone! Dies wird nicht mehr sein Das Niedrige werde erhöht und das Hohe erniedrigt!',
        32: 'Umgestürzt, umgestürzt, umgestürzt will ich sie machen; auch dies wird nicht mehr sein-bis der kommt, welchem das Recht gehört: dem werde ichs geben. Und du, Menschensohn, weissage und sprich: So spricht der Herr, Jehova, über die Kinder Ammon und über ihren Hohn; und sprich: Ein Schwert, ein Schwert, zur Schlachtung gezückt, geschliffen, damit es fresse, damit es blitze, um dich zu den Hälsen der erschlagenen Gesetzlosen zu legen, deren Tag gekommen ist zur Zeit der Ungerechtigkeit des Endes! Stecke es wieder in seine Scheide! An dem Orte, wo du geschaffen bist, in dem Lande deines Ursprungs, werde ich dich richten. Und ich werde meinen Zorn über dich ausgießen, das Feuer meines Grimmes wider dich anfachen; und ich werde dich in die Hand roher Menschen geben, welche Verderben schmieden. Du wirst dem Feuer zum Fraße werden, dein Blut wird inmitten des Landes sein; deiner wird nicht mehr gedacht werden. Denn ich, Jehova, habe geredet.',
    },
    22: {
        1: 'Und das Wort Jehovas geschah zu mir also:',
        2: 'Und du, Menschensohn, willst du richten, willst du richten die Stadt der Blutschuld? So tue ihr kund alle ihre Greuel',
        3: 'und sprich: so spricht der Herr, Jehova: Stadt, die Blut vergießt in ihrer Mitte, damit ihre Zeit komme, und welche sich Götzen macht, um sich zu verunreinigen!',
    ...
    23: {
        ...
        5: 'Und Ohola hurte, als sie unter mir war. Und sie entbrannte gegen ihre Buhlen, gegen die Assyrer, die nahe waren,',
        ...
        18: 'Und als sie ihre Hurereien aufdeckte und ihre Blöße aufdeckte, da riß meine Seele sich von ihr los, so wie meine Seele sich von ihrer Schwester losgerissen hatte.',
    ...
    27: {
        ...
        3: 'und sprich zu Tyrus: Die du wohnst an den Zugängen des Meeres und Handel treibst mit den Völkern nach vielen Inseln hin, so spricht der Herr, Jehova: Tyrus, du sprichst: Ich bin vollkommen an Schönheit',
        4: 'Deine Grenzen sind im Herzen der Meere; deine Bauleute haben deine Schönheit vollkommen gemacht.',
        5: 'Aus Cypressen von Senir bauten sie dir alles Doppelplankenwerk; sie nahmen Cedern vom Libanon, um dir einen Mast zu machen;',
        6: 'aus Eichen von Basan machten sie deine Ruder; dein Verdeck machten sie aus Elfenbein, eingefaßt in Scherbinceder von den Inseln der Kittäer',
    ...
    28: {
        1: 'Und das Wort Jehovas geschah zu mir also:',
        2: 'Menschensohn, sprich zu dem Fürsten von Tyrus: So spricht der Herr, Jehova: Weil dein Herz sich erhebt, und du sprichst: "Ich bin ein Gott, ich sitze auf einem Gottessitze im Herzen der Meere!" und hegst einen Sinn wie eines Gottes Sinn; -',
        ...
        22: 'und sprich: So spricht der Herr, Jehova: Siehe, ich will an dich, Zidon, und will mich verherrlichen in deiner Mitte; und sie werden wissen, daß ich Jehova bin, wenn ich Gerichte an ihm übe und mich an ihm heilige',
    ...
    29: {
        ...
        17: 'Und es geschah im 27. Jahre, im ersten Monat, am Ersten des Monats, da geschah das Wort Jehovas zu mir also:',
    ...
    38: {
        1: 'Und das Wort Jehovas geschah zu mir also:',
        2: 'Menschensohn, richte dein Angesicht gegen Gog vom Lande Magog den Fürsten von Rosch, Mesech und Tubal und weissage wider ihn',
        3: 'und sprich: So spricht der Herr, Jehova: Siehe, ich will an dich, Gog, Fürst von Rosch, Mesech und Tubal.',
        ...
        11: 'und sprechen: Ich will hinaufziehen in das Land der offenen Städte, will über die kommen, welche in Ruhe sind, in Sicherheit wohnen, die allesamt ohne Mauern wohnen und Riegel und Tore nicht haben:',
    ...
    39: {
        ...
        6: 'Und ich werde Feuer senden unter Magog und unter die, welche auf den Inseln sicher wohnen. Und sie werden wissen, daß ich Jehova bin.',
        7: 'Und ich werde meinen heiligen Namen kundtun inmitten meines Volkes Israel, und werde meinen heiligen Namen nicht mehr entweihen lassen. Und die Nationen werden wissen, daß ich Jehova bin, der Heilige in Israel.',
        ...
        11: 'Und es wird geschehen an jenem Tage, da werde ich Gog eine Grabstätte geben in Israel, das Tal der Wanderer auf der Ostseite des Meeres; und es wird den Wanderern den Weg versperren. Und daselbst werden sie Gog und seine ganze Menge begraben, und sie werden es nennen: Tal der Menge Gogs',
        12: 'Und das Haus Israel wird sie begraben, um das Land zu reinigen, sieben Monate lang;',
        13: 'und das ganze Volk des Landes wird sie begraben, und es wird ihnen zum Ruhme sein an dem Tage, da ich mich verherrlichen werde, spricht der Herr, Jehova.',
        14: 'Und sie werden Männer aussondern, die beständig im Lande umherziehen, und solche, welche mit den Umherziehenden die auf der Fläche des Landes Übriggebliebenen begraben, um es zu reinigen; nach Verlauf von sieben Monaten werden sie es durchsuchen.',
        ...
        16: 'Und auch der Name der Stadt soll Hamona sein. Und so werden sie das Land reinigen. -',
        ...
        21: 'Und ich werde meine Herrlichkeit unter den Nationen erweisen und alle Nationen sollen mein Gericht sehen, welches ich gehalten, und meine Hand, die ich an sie gelegt habe.',
    ...
    40: {
        ...
        13: 'Und er maß das Tor vom Dache eines Wachtzimmers bis zum Dache des anderen: 25 Ellen Breite, Tür gegen Tür',
        ...
        21: 'und seine Wachtzimmer, drei auf dieser und drei auf jener Seite; und seine Pfeiler und seine Wandvorsprünge. Es war nach dem Maße des ersten Tores, fünfzig Ellen seine Länge und 25 Ellen die Breite',
    ...
    41: {
        ...
        16: 'Die Schwellen und die vergitterten Fenster und die Galerien rings um diese drei Gebäude-den Schwellen gegenüber war getäfeltes Holz ringsherum und vom Boden bis an die Fenster -',
    ...
    45: {
        1: 'Und wenn ihr das Land als Erbteil verlosen werdet, sollt ihr für Jehova ein Hebopfer heben, als Heiliges vom Lande: die Länge 25000 Ruten lang, und die Breite 20000 dasselbe soll heilig sein in seiner ganzen Grenze ringsum.',
        ...
        5: 'Und 25000 Ruten in die Länge und 10000 in die Breite soll den Leviten, den Dienern, des Hauses, gehören, ihnen zum Eigentum, als Städte zum Wohnen',
    ...
    48: {
        ...
        18: 'Und das Übrige in der Länge, gleichlaufend dem heiligen Hebopfer, 10000 Ruten, gegen Osten und 10000 gegen Westen, dessen Ertrag soll den Arbeitern der Stadt zur Nahrung dienen.',
        ...
        30: 'Und dies sollen die Ausgänge der Stadt sein: Von der Nordseite an 4500 Ruten Maß;',
        ...
        35: 'Ringsum 18000 Ruten. Und der Name der Stadt soll von nun an heißen: Jehova daselbst',
    },
}
