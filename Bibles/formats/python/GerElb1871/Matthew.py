...
CHAPTERS = {
    ...
    6: {
        ...
        6: 'Du aber, wenn du betest, so gehe in deine Kammer und, nachdem du deine Tür geschlossen hast, bete zu deinem Vater, der im Verborgenen ist, und dein Vater, der im Verborgenen sieht, wird dir vergelten.',
    ...
    7: {
        ...
        28: 'Und es geschah, als Jesus diese Worte vollendet hatte, da erstaunte die Volksmenge sehr über seine Lehre;',
    ...
    8: {
        ...
        9: 'Denn auch ich bin ein Mensch unter Gewalt und habe Kriegsknechte unter mir; und ich sage zu diesem: Gehe hin, und er geht; und zu einem anderen: Komm, und er kommt; und zu meinem Knechte: Tue dieses, und er tuts.',
    ...
    12: {
        ...
        2: 'Als aber die Pharisäer es sahen, sprachen sie zu ihm: Siehe, deine Jünger tun, was nicht erlaubt ist am Sabbath zu tun.',
        ...
        9: 'Und von dannen weitergehend, kam er in ihre Synagoge.',
    ...
    13: {
        ...
        47: 'Wiederum ist das Reich der Himmel gleich einem Netze, das ins Meer geworfen wurde und von jeder Gattung zusammenbrachte,',
    ...
    16: {
        ...
        26: 'Denn was wird es einem Menschen nützen, wenn er die ganze Welt gewänne, aber seine Seele einbüßte? Oder was wird ein Mensch als Lösegeld geben für seine Seele?',
    ...
    19: {
        ...
        5: 'und sprach: "Um deswillen wird ein Mensch Vater und Mutter verlassen und seinem Weibe anhangen, und es werden die zwei ein Fleisch sein";',
    ...
    21: {
        ...
        9: 'Die Volksmenge aber, welche vor ihm herging und nachfolgte, rief und sprach: Hosanna dem Sohne Davids! Gepriesen sei, der da kommt im Namen des Herrn! Hosanna in der Höhe!',
        ...
        15: 'Als aber die Hohenpriester und die Schriftgelehrten die Wunder sahen, welche er tat, und die Kinder, die im Tempel schrieen und sagten: Hosanna dem Sohne Davids! -wurden sie unwillig',
        16: 'und sprachen zu ihm: Hörst du, was diese sagen? Jesus aber spricht zu ihnen: Ja, habt ihr nie gelesen: "Aus dem Munde der Unmündigen und Säuglinge hast du dir Lob bereitet"?',
        ...
        28: 'Was dünkt euch aber? Ein Mensch hatte zwei Kinder; und er trat hin zu dem ersten und sprach: Kind, gehe heute hin, arbeite in meinem Weinberge.',
        ...
        42: 'Jesus spricht zu ihnen: Habt ihr nie in den Schriften gelesen: "Der Stein, den die Bauleute verworfen haben, dieser ist zum Eckstein geworden; von dem Herrn ist dies geschehen, und ist wunderbar in unseren Augen"?',
        ...
        46: 'Und als sie ihn zu greifen suchten, fürchteten sie die Volksmenge, denn sie hielt ihn für einen Propheten.',
    },
    22: {
        ...
        16: 'Und sie senden ihre Jünger mit den Herodianern zu ihm und sagen: Lehrer, wir wissen, daß du wahrhaftig bist und den Weg Gottes in Wahrheit lehrst und dich um niemanden kümmerst, denn du siehst nicht auf die Person der Menschen;',
        ...
        24: 'und sprachen: Lehrer, Moses hat gesagt: Wenn jemand stirbt und keine Kinder hat, so soll sein Bruder sein Weib heiraten und soll seinem Bruder Samen erwecken.',
    ...
    23: {
        ...
        3: 'Alles nun, was irgend sie euch sagen, tut und haltet; aber tut nicht nach ihren Werken, denn sie sagen es und tuns nicht.',
        ...
        13: 'Wehe aber euch, Schriftgelehrte und Pharisäer, Heuchler! denn ihr verschließet das Reich der Himmel vor den Menschen; denn ihr gehet nicht hinein, noch laßt ihr die Hineingehenden eingehen.',
        14: '-',
        ...
        27: 'Wehe euch, Schriftgelehrte und Pharisäer, Heuchler! denn ihr gleichet übertünchten Gräbern, die von außen zwar schön scheinen, inwendig aber voll Totengebeine und aller Unreinigkeit sind.',
    ...
    24: {
        ...
        15: 'Wenn ihr nun den Greuel der Verwüstung, von welchem durch Daniel, den Propheten, geredet ist, stehen sehet an heiligem Orte,',
    ...
    25: {
        ...
        15: 'und einem gab er fünf Talente, einem anderen zwei, einem anderen eins, einem jeden nach seiner eigenen Fähigkeit; und alsbald reiste er außer Landes.',
