...
CHAPTERS = {
    1: {
        ...
        32: 'Aber in dieser Sache glaubtet ihr nicht Jehova, eurem Gott,',
    ...
    2: {
        ...
        14: 'Die Tage aber, die wir von Kades-Barnea gegangen sind, bis wir über den Bach Sered zogen, waren 38 Jahre, bis das ganze Geschlecht der Kriegsleute aus dem Lager aufgerieben war, so wie Jehova ihnen geschworen hatte.',
    ...
    4: {
        1: 'Und nun, Israel, höre auf die Satzungen und auf die Rechte, die ich euch lehre zu tun, auf daß ihr lebet und hineinkommet und das Land in Besitz nehmet, welches Jehova, der Gott eurer Väter, euch gibt.',
    ...
    5: {
        ...
        11: 'Du sollst den Namen Jehovas, deines Gottes, nicht zu Eitlem aussprechen; denn Jehova wird den nicht für schuldlos halten, der seinen Namen zu Eitlem ausspricht. -',
        ...
        14: 'aber der siebte Tag ist Sabbath dem Jehova, deinem Gott: Du sollst keinerlei Werk tun, du und dein Sohn und deine Tochter und dein Knecht und deine Magd, und dein Rind und dein Esel und all dein Vieh, und dein Fremdling, der in deinen Toren ist; auf daß dein Knecht und deine Magd ruhen gleichwie du.',
    ...
    6: {
        ...
        2: 'auf daß du Jehova, deinen Gott, fürchtest alle Tage deines Lebens, um zu beobachten alle seine Satzungen und seine Gebote, die ich dir gebiete, du und dein Sohn und deines Sohnes Sohn, und auf daß sich deine Tage sich verlängern.',
        ...
        11: 'und Häuser, voll von allem Gut, die du nicht gefüllt, und gehauene Cisternen, die du nicht gehauen, Weinberge und Olivengärten, die du nicht gepflanzt hast, und du essen und satt werden wirst:',
    ...
    9: {
        ...
        9: 'Als ich auf den Berg stieg, um die steinernen Tafeln zu empfangen, die Tafeln des Bundes, den Jehova mit euch gemacht hatte, da blieb ich auf dem Berge vierzig Tage und vierzig Nächte, -Brot aß ich nicht, und Wasser trank ich nicht-',
        ...
        15: 'Und ich wandte mich und stieg von dem Berge herab, und die zwei Tafeln des Bundes waren auf meinen beiden Händen.',
        ...
        19: 'Denn mir war bange vor dem Zorne und dem Grimme, womit Jehova über euch ergrimmt war, so daß er euch vertilgen wollte. Und Jehova erhörte mich auch dieses Mal.',
    ...
    11: {
        ...
        29: 'Und es soll geschehen, wenn Jehova, dein Gott, dich in das Land bringt, wohin du kommst, um es in Besitz zu nehmen, so sollst du den Segen erteilen auf dem Berge Gerisim und den Fluch auf dem Berge Ebal.',
    ...
    13: {
        ...
        2: 'und das Zeichen oder das Wunder trifft ein, von welchem er zu dir geredet hat, indem er sprach: Laß uns anderen Göttern nachgehen und ihnen dienen! -',
        ...
        13: 'Es sind Männer, Söhne Belials, aus deiner Mitte ausgegangen und haben die Bewohner ihrer Stadt verleitet und gesprochen: Laßt uns gehen und anderen Göttern dienen,',
    ...
    19: {
        ...
        9: ', so sollst du dir zu diesen dreien noch drei Städte hinzufügen;',
    ...
    20: {
        ...
        19: 'Wenn du eine Stadt viele Tage belagern wirst, indem du Krieg wider sie führst, um sie einzunehmen, so sollst du ihre Bäume nicht verderben, indem du die Axt gegen sie schwingst, und sollst sie nicht abhauen; denn ist der Baum des Feldes ein Mensch, daß er vor dir in Belagerung kommen sollte?',
    ...
    28: {
        ...
        57: 'wegen ihrer Nachgeburt, die zwischen ihren Beinen hervorgeht, und wegen ihrer Kinder, die sie gebiert; denn sie wird sie im Geheimen aufessen im Mangel an allem, in der Belagerung und in der Bedrängnis, womit dein Feind dich bedrängen wird in deinen Toren. -',
    ...
    29: {
        1: 'Und Mose berief ganz Israel und sprach zu ihnen:',
        2: 'Ihr habt alles gesehen, was Jehova vor euren Augen im Lande Ägypten getan hat, an dem Pharao und an allen seinen Knechten und an seinem ganzen Lande:',
        ...
        6: 'Brot habt ihr nicht gegessen, und Wein und starkes Getränk habt ihr nicht getrunken; auf daß ihr erkänntet, daß ich Jehova, euer Gott, bin.',
        ...
        19: 'und es geschehe, wenn er die Worte dieses Eidschwures hört, daß er sich in seinem Herzen segne und spreche: Ich werde Frieden haben, wenn ich auch in der Verstocktheit meines Herzens wandle! damit zu Grunde gehe der Trunkene mit dem Durstigen.',
    ...
    31: {
        ...
        2: 'Und er sprach zu ihnen: 120 Jahre bin ich heute alt, ich vermag nicht mehr aus- und einzugehen; und Jehova hat zu mir gesagt: Du sollst nicht über diesen Jordan gehen.',
        ...
        10: 'Und Mose gebot ihnen und sprach: Am Ende von sieben Jahren, zur Zeit des Erlaßjahres, am Feste der Laubhütten,',
        11: 'wenn ganz Israel kommt, um vor Jehova, deinem Gott, zu erscheinen an dem Orte, den er erwählen wird, sollst du dieses Gesetz vor dem ganzen Israel lesen, vor ihren Ohren.',
    ...
    32: {
        ...
        4: 'Der Fels: Vollkommen ist sein Tun; denn alle seine Wege sind recht. Ein Gott der Treue und sonder Trug, gerecht und gerade ist er!',
        ...
        36: 'Denn Jehova wird sein Volk richten, und er wird sichs gereuen lassen über seine Knechte, wenn er sehen wird, daß geschwunden die Kraft, und der Gebundene und der Freie dahin ist.',
    ...
    33: {
        ...
        26: 'Keiner ist wie der Gott Jeschuruns, der auf den Himmeln einherfährt zu deiner Hülfe, und in seiner Hoheit auf den Wolken.',
        ...
        29: 'Glückselig bist du, Israel! wer ist wie du, ein Volk, gerettet durch Jehova, den Schild deiner Hülfe, und der das Schwert deiner Hoheit ist? Und es werden dir schmeicheln deine Feinde, und du, du wirst einherschreiten auf ihren Höhen.',
    },
    34: {
