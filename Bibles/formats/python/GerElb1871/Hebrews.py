...
CHAPTERS = {
    ...
    2: {
        ...
        3: 'wie werden wir entfliehen, wenn wir eine so große Errettung vernachlässigen? welche den Anfang ihrer Verkündigung durch den Herrn empfangen hat und uns von denen bestätigt worden ist, die es gehört haben,',
        ...
        12: 'indem er spricht: "Ich will deinen Namen kundtun meinen Brüdern; inmitten der Versammlung will ich dir lobsingen".',
        13: 'Und wiederum: "Ich will mein Vertrauen auf ihn setzen". Und wiederum: "Siehe, ich und die Kinder, die Gott mir gegeben hat".',
        14: 'Weil nun die Kinder Blutes und Fleisches teilhaftig sind, hat auch er gleicherweise an denselben teilgenommen, auf daß er durch den Tod den zunichte machte, der die Macht des Todes hat, das ist den Teufel,',
    ...
    5: {
        ...
        7: 'Der in den Tagen seines Fleisches, da er sowohl Bitten als Flehen dem, der ihn aus dem Tode zu erretten vermochte, mit starkem Geschrei und Tränen dargebracht hat,',
    ...
    7: {
        ...
        11: 'Wenn nun die Vollkommenheit durch das levitische Priestertum wäre, welches Bedürfnis war noch vorhanden, daß ein anderer Priester nach der Ordnung Melchisedeks aufstehe, und nicht nach der Ordnung Aarons genannt werde?',
        ...
        19: 'und die Einführung einer besseren Hoffnung, durch welche wir Gott nahen.',
    ...
    9: {
        ...
        11: 'Christus aber, gekommen als Hoherpriester der zukünftigen Güter, in Verbindung mit der größeren und vollkommneren Hütte, die nicht mit Händen gemacht,',
        ...
        28: 'also wird auch der Christus, nachdem er einmal geopfert worden ist, um vieler Sünden zu tragen, zum zweiten Male denen, die ihn erwarten, ohne Sünde erscheinen zur Seligkeit.',
    },
    10: {
        ...
        7: 'Da sprach ich: Siehe, ich komme, um deinen Willen, o Gott zu tun."',
        8: 'Indem er vorher sagt: "Schlachtopfer und Speisopfer und Brandopfer und Opfer für die Sünde hast du nicht gewollt, noch Wohlgefallen daran gefunden", sprach er dann:',
        9: '"Siehe, ich komme, um deinen Willen zu tun".',
        ...
        16: '"Dies ist der Bund, den ich ihnen errichten werde nach jenen Tagen, spricht der Herr: Indem ich meine Gesetze in ihre Herzen gebe, werde ich sie auch auf ihre Sinne schreiben";',
        17: 'und: "Ihrer Sünden und ihrer Gesetzlosigkeiten werde ich nie mehr gedenken".',
        ...
        23: 'Laßt uns das Bekenntnis der Hoffnung unbeweglich festhalten,;',
    ...
    11: {
        ...
        11: 'Durch Glauben empfing auch selbst Sarah Kraft, einen Samen zu gründen, und zwar über die geeignete Zeit des Alters hinaus, weil sie den für treu achtete, der die Verheißung gegeben hatte.',
        ...
        38: 'irrten umher in Wüsten und Gebirgen und Klüften und den Höhlen der Erde.',
    ...
    12: {
        ...
        17: 'denn ihr wisset, daß er auch nachher, als er den Segen ererben wollte, verworfen wurde, obgleich er ihn sehr mit Tränen suchte.',
    ...
    13: {
        ...
        7: 'Gedenket eurer Führer, die euch das Wort Gottes verkündigt haben, und, den Ausgang ihres Wandels anschauend, ahmet ihren Glauben nach.',
        ...
        17: 'Gehorchet euren Führern und seid unterwürfig; denn sie wachen über eure Seelen, auf daß sie dies mit Freuden tun und nicht mit Seufzen; denn dies wäre euch nicht nützlich.',
        ...
        20: 'Der Gott des Friedens aber, der aus den Toten wiederbrachte unseren Herrn Jesum, den großen Hirten der Schafe, in dem Blute des ewigen Bundes,',
        21: 'vollende euch in jedem guten Werke, um seinen Willen zu tun, in euch schaffend, was vor ihm wohlgefällig ist, durch Jesum Christum, welchem die Herrlichkeit sei von Ewigkeit zu Ewigkeit! Amen.',
