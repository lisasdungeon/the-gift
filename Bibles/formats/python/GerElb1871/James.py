...
CHAPTERS = {
    ...
    2: {
        1: 'Meine Brüder, habet den Glauben unseres Herrn Jesu Christi, des Herrn der Herrlichkeit, nicht mit Ansehen der Person.',
        2: 'Denn wenn in eure Synagoge ein Mann kommt mit goldenem Ringe, in prächtigem Kleide, es kommt aber auch ein Armer in unsauberem Kleide herein,',
    ...
    4: {
        ...
        2: 'Ihr gelüstet und habt nichts; ihr tötet und neidet und könnet nichts erlangen; ihr streitet und krieget; ihr habt nichts, weil ihr nicht bittet;',
        3: 'ihr bittet und empfanget nichts, weil ihr übel bittet, auf daß ihr es in euren Lüsten vergeudet.',
        ...
        9: 'Seid niedergebeugt, und trauert und weinet; euer Lachen verwandle sich in Traurigkeit und eure Freude in Niedergeschlagenheit.',
    ...
    5: {
        ...
        2: 'Euer Reichtum ist verfault, und eure Kleider sind mottenfressig geworden.',
