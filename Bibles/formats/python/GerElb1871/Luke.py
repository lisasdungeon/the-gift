...
CHAPTERS = {
    1: {
        1: 'Sintemal es viele unternommen haben, eine Erzählung von den Dingen, die unter uns völlig geglaubt werden, zu verfassen,',
        ...
        33: 'und er wird über das Haus Jakobs herrschen in die Zeitalter, und seines Reiches wird kein Ende sein.',
        ...
        55: 'gegen Abraham und seinen Samen in Ewigkeit. -',
    ...
    2: {
        ...
        11: 'denn euch ist heute, ein Erretter geboren, in Davids Stadt, welcher ist Christus, der Herr.',
        ...
        35: ', damit die Überlegungen vieler Herzen offenbar werden.',
    ...
    4: {
        ...
        2: 'indem er von dem Teufel versucht wurde. Und er aß in jenen Tagen nichts; und als sie vollendet waren, hungerte ihn.',
        3: 'Und der Teufel sprach zu ihm: Wenn du Gottes Sohn bist, so sprich zu diesem Steine, daß er Brot werde.',
        4: 'Und Jesus antwortete ihm und sprach: Es steht geschrieben: "Nicht von Brot allein soll der Mensch leben, sondern von jedem Worte Gottes".',
        ...
        10: 'denn es steht geschrieben: "Er wird seinen Engeln über dir befehlen, daß sie dich bewahren;',
        ...
        24: 'Er sprach aber: Wahrlich, ich sage euch, daß kein Prophet in seiner Vaterstadt angenehm ist.',
        ...
        26: 'und zu keiner von ihnen wurde Elias gesandt, als nur nach Sarepta in Sidonia, zu einem Weibe, einer Witwe.',
        ...
        36: 'Und Entsetzen kam über alle, und sie redeten untereinander und sprachen: Was ist dies für ein Wort? denn mit Gewalt und Kraft gebietet er den unreinen Geistern, und sie fahren aus.',
        ...
        42: 'Als es aber Tag geworden war, ging er aus und begab sich an einen öden Ort; und die Volksmenge suchte ihn auf und kam bis zu ihm, und sie hielten ihn auf, daß er nicht von ihnen ginge.',
        43: 'Er aber sprach zu ihnen: Ich muß auch den anderen Städten das Evangelium vom Reiche Gottes verkündigen, denn dazu bin ich gesandt worden.',
    ...
    6: {
        ...
        2: 'Einige der Pharisäer aber sprachen zu ihnen: Warum tut ihr, was nicht erlaubt ist, am Sabbath zu tun?',
        ...
        4: 'wie er in das Haus Gottes ging und die Schaubrote nahm und aß, und auch denen gab, die bei ihm waren, welche niemand essen darf, als nur die Priester allein?',
        ...
        12: 'Und es geschah in selbigen Tagen, daß er auf den Berg hinausging, um zu beten; und er verharrte die Nacht im Gebet zu Gott.',
        ...
        15: 'und Matthäus und Thomas, und Jakobus, Alphäus Sohn, und Simon, genannt Zelotes,',
        ...
        48: 'Er ist einem Menschen gleich, der ein Haus baute, welcher grub und vertiefte und den Grund auf den Felsen legte; als aber eine Flut kam, schlug der Strom an jenes Haus und vermochte es nicht zu erschüttern, denn es war auf den Felsen gegründet.',
    ...
    7: {
        ...
        6: 'Jesus aber ging mit ihnen. Als er aber schon nicht mehr weit von dem Hause entfernt war, sandte der Hauptmann Freunde zu ihm und ließ ihm sagen: Herr, bemühe dich nicht, denn ich bin nicht würdig, daß du unter mein Dach tretest.',
        ...
        19: 'Und Johannes rief zwei seiner Jünger herzu und sandte sie zu Jesu und ließ ihm sagen:Bist du der Kommende, oder sollen wir auf eines anderen warten?',
        20: 'Als aber die Männer zu ihm gekommen waren, sprachen sie: Johannes der Täufer hat uns zu dir gesandt und läßt dir sagen: Bist du der Kommende, oder sollen wir auf eines anderen warten?',
    ...
    8: {
        ...
        2: 'und gewisse Weiber, die von bösen Geistern und Krankheiten geheilt worden waren: Maria, genannt Magdalene, von welcher sieben Dämonen ausgefahren waren,',
        ...
        26: 'Und sie fuhren nach dem Lande der Gadarener, welches Galiläa gegenüber ist.',
        ...
        41: 'Und siehe, es kam ein Mann, mit Namen Jairus, und fiel Jesu zu Füßen und bat ihn, in sein Haus zu kommen;',
    ...
    9: {
        ...
        11: 'Als aber die Volksmenge es erfuhr, folgte sie ihm; und er nahm sie auf und redete zu ihnen vom Reiche Gottes, und die der Heilung bedurften, machte er gesund.',
        ...
        21: 'Er aber bedrohte sie und gebot ihnen, dies niemandem zu sagen,',
        ...
        29: 'Und indem er betete, wurde die Gestalt seines Angesichts anders und sein Gewand weiß, strahlend.',
        ...
        36: 'Und indem die Stimme geschah, wurde Jesus allein gefunden. Und sie schwiegen und verkündeten in jenen Tagen niemandem etwas von dem, was sie gesehen hatten.',
        ...
        43: 'Sie erstaunten aber alle sehr über die herrliche Größe Gottes. Als sich aber alle verwunderten über alles, was Jesus tat, sprach er zu seinen Jüngern:',
        44: 'Fasset ihr diese Worte in eure Ohren; denn der Sohn des Menschen wird überliefert werden in der Menschen Hände.',
    ...
    10: {
        ...
        4: 'Traget weder Börse noch Tasche, noch Sandalen, und grüßet niemanden auf dem Wege.',
        ...
        8: 'Und in welche Stadt irgend ihr eintretet, und sie nehmen euch auf, da esset, was euch vorgesetzt wird,',
        ...
        38: 'Es geschah aber, als sie ihres Weges zogen, daß er in ein gewisses Dorf kam; und ein gewisses Weib, mit Namen Martha, nahm ihn in ihr Haus auf.',
    ...
    12: {
        ...
        11: 'Wenn sie euch aber vor die Synagogen und die Obrigkeiten und die Gewalten führen, so sorget nicht, wie oder womit ihr euch verantworten oder was ihr sagen sollt;',
    ...
    13: {
        ...
        30: 'Und siehe, es sind Letzte, welche Erste sein werden, und es sind Erste, welche Letzte sein werden.',
    ...
    14: {
        ...
        25: 'Es ging aber eine große Volksmengen mit ihm; und er wandte sich um und sprach zu ihnen:',
    ...
    15: {
        ...
        25: 'Es war aber sein älterer Sohn auf dem Felde; und als er kam und sich dem Hause näherte, hörte er Musik und Reigen.',
    ...
    16: {
        ...
        9: 'Und ich sage euch: Machet euch Freunde mit dem ungerechten Mammon, auf daß, wenn er zu Ende geht, ihr aufgenommen werdet in die ewigen Hütten.',
    ...
    21: {
        1: 'Aufblickend aber sah er die Reichen ihre Gaben in den Schatzkasten legen.',
        ...
        8: 'Er aber sprach: Sehet zu, daß ihr nicht verführt werdet! denn viele werden unter meinem Namen kommen und sagen: Ich bins und die Zeit ist nahe gekommen! Gehet ihnen nun nicht nach.',
    ...
    22: {
        ...
        58: 'Und kurz danach sah ihn ein anderer und sprach: Auch du bist einer von ihnen. Petrus aber sprach: Mensch, ich bins nicht.',
        ...
        66: 'Und als es Tag wurde, versammelte sich die Ältestenschaft des Volkes, sowohl Hohepriester als Schriftgelehrte, und führten ihn hin in ihr Synedrium',
    ...
    23: {
        ...
        33: 'Und als sie an den Ort kamen, der Schädelstätte genannt wird, kreuzigten sie daselbst ihn und die Übeltäter, den einen zur Rechten, den anderen zur Linken.',
        ...
        36: 'Aber auch die Kriegsknechte verspotteten ihn, indem sie herzutraten, ihm Essig brachten',
        ...
        48: 'Und alle die Volksmenge, die zu diesem Schauspiel zusammengekommen waren, schlugen sich, als sie sahen, was geschehen war, an die Brust und kehrten zurück.',
