...
CHAPTERS = {
    1: {
        1: 'Und es geschah in den Tagen des Ahasveros,',
        ...
        10: 'Am siebten Tage, als das Herz des Königs vom Weine fröhlich war, befahl er Mehuman, Bistha, Harbona, Bigtha und Abagtha, Sethar und Karkas, den sieben Kämmerern, welche vor dem König Ahasveros dienten,',
    ...
    2: {
        1: 'Nach diesen Begebenheiten, als der Zorn des Königs Ahasveros sich gelegt hatte, gedachte er an Vasti und an das, was sie getan, und was über sie beschlossen worden war.',
        2: 'Da sprachen die Diener des Königs, die ihn bedienten: Man suche dem König jungfräuliche Dirnen schön von Ansehen;',
        3: 'und der König bestellte Beamte in allen Landschaften seines Königreiches, damit sie alle jungfräuliche Dirnen, die schön von Ansehen sind, nach der Burg Susan in das Frauenhaus zusammenbringen unter die Aufsicht Heges, des königlichen Kämmerers, des Hüters der Frauen; und man gebe ihnen Reinigungssalben.',
        4: 'Und die Dirne, welche dem König gefallen wird, werde Königin an Vastis Statt. Und das Wort gefiel dem König; und er tat also.',
        5: 'Es war ein jüdischer Mann in der Burg Susan, sein Name war Mordokai, der Sohn Jairs, des Sohnes Simeis, des Sohnes Kis,',
        6: 'ein Benjaminiter, der aus Jerusalem weggeführt worden war mit den Weggeführten, die mit Jekonja, dem König von Juda, weggeführt wurden, welche Nebukadnezar, der König von Babel, weggeführt hatte.',
        7: 'Und er erzog Hadassa, das ist Esther, die Tochter seines Oheims; denn sie hatte weder Vater noch Mutter. Und die Dirne war schön von Gestalt und schön von Angesicht. Und als ihr Vater und ihre Mutter gestorben waren, hatte Mordokai sie als seine Tochter angenommen.',
        8: 'Und es geschah, als das Wort des Königs und sein Befehl gehört, und als viele Dirnen in die Burg Susan unter die Aufsicht Hegais zusammengebracht wurden, da wurde auch Esther in das Haus des Königs aufgenommen, unter die Aufsicht Hegais, des Hüters der Frauen.',
        9: 'Und die Dirne gefiel ihm und erlangte Gunst vor ihm. Und er beeilte sich, ihre Reinigungssalben und ihre Teile ihr zu geben, und ihr die sieben Dirnen zu geben, welche aus dem Hause des Königs ausersehen waren; und er versetzte sie mit ihren Dirnen in die besten Gemächer des Frauenhauses.',
        ...
        12: 'Und wenn die Reihe an eine jede Dirne kam, zum König Ahasveros zu kommen, nachdem ihr zwölf Monate lang nach der Vorschrift für die Weiber geschehen war,',
        13: 'und wenn alsdann die Dirne zu dem König kam, so wurde ihr alles gegeben, was sie verlangte, um es aus dem Frauenhause in das Haus des Königs mitzunehmen.',
        14: 'Am Abend kam sie, und am Morgen kehrte sie in das zweite Frauenhaus zurück, unter die Aufsicht Schaaschgas, des königlichen Kämmerers, des Hüters der Kebsweiber. Sie kam nicht wieder zu dem König, es sei denn, daß der König Gefallen an ihr hatte, und sie mit Namen gerufen wurde.',
    ...
    3: {
        ...
        7: 'Im ersten Monat, das ist der Monat Nisan, im zwölften Jahre des Königs Ahasveros, warf man das Pur, das ist das Los, vor Haman, von Tag zu Tag und von Monat zu Monat, bis zum zwölften Monat, das ist der Monat Adar.',
        8: 'Und Haman sprach zu dem König Ahasveros: Da ist ein Volk, zerstreut und abgesondert unter den Völkern in allen Landschaften deines Königreiches; und ihre Gesetze sind von denen jedes anderen Volkes verschieden, und die Gesetze des Königs tun sie nicht; und es ist für den König nicht geziemend, sie gewähren zu lassen.',
        9: 'Wenn es den König gut dünkt, so werde geschrieben, daß man sie umbringe; und ich will zehntausend Talente Silber in die Hände derer darwägen, welche die Geschäfte besorgen, daß sie es in die Schatzkammern des Königs bringen.',
        ...
        11: 'Und der König sprach zu Haman: Das Silber sei dir gegeben, und das Volk, um mit ihm zu tun, wie es gut ist in deinen Augen.',
        ...
        13: 'Und die Briefe wurden durch die Eilboten in alle Landschaften des Königs gesandt, um alle Juden zu vertilgen, zu ermorden und umzubringen, vom Knaben bis zum Greise, Kinder und Weiber, an einem Tage, am Dreizehnten des zwölften Monats, das ist der Monat Adar, und um ihre Beute zu plündern.',
        14: 'Und auf daß der Befehl in jeder einzelnen Landschaft erlassen würde, ward eine Abschrift des Schreibens allen Völkern bekannt gemacht, damit sie auf diesen Tag bereit wären.',
        15: 'Die Eilboten zogen auf das Wort des Königs eilends aus. Und der Befehl wurde in der Burg Susan erlassen. Und der König und Haman saßen und tranken; aber die Stadt Susan war in Bestürzung.',
    },
    4: {
        ...
        4: 'Und die Dirnen Esthers und ihre Kämmerer kamen und taten es ihr kund. Da geriet die Königin sehr in Angst. Und sie sandte Kleider, daß man sie Mordokai anziehe und sein Sacktuch von ihm wegnehme; aber er nahm sie nicht an.',
        ...
        13: 'Und Mordokai ließ der Esther antworten: Denke nicht in deinem Herzen, daß du im Hause des Königs allein vor allen Juden entkommen werdest.',
        ...
        17: 'Und Mordokai ging hin und tat nach allem, was Esther ihm geboten hatte.',
    },
    5: {
    ...
    6: {
        1: 'In jener Nacht floh dem König der Schlaf; und er befahl, das Gedächtnisbuch der Chroniken zu bringen; und sie wurden vor dem König gelesen.',
        ...
        3: 'Und der König sprach: Welche Ehre und Auszeichnung ist dem Mordokai dafür erwiesen worden? Und die Diener des Königs, die ihn bedienten, sprachen: Es ist ihm nichts erwiesen worden.',
    ...
    8: {
        ...
        10: 'Und er schrieb im Namen des Königs Ahasveros und untersiegelte mit dem Siegelringe des Königs; und er sandte durch die berittenen Eilboten, welche auf den Rennern der königlichen Gestüte ritten, Briefe, worin geschrieben stand,',
    ...
    9: {
        1: 'Und im zwölften Monat, das ist der Monat Adar, am dreizehnten Tage desselben, als das Wort des Königs und sein Befehl zur Ausführung kommen sollte, an dem Tage, da die Feinde der Juden gehofft hatten, sie zu überwältigen,',
        ...
        30: 'Und er sandte Briefe an alle Juden, in die 127 Landschaften, das Königreich Ahasveros, Worte des Friedens und der Wahrheit,',
    ...
    10: {
        ...
        2: 'Und alle Taten seiner Gewalt und seiner Macht und die Beschreibung der Größe Mordokais, zu welcher der König ihn erhob, sind sie nicht geschrieben in dem Buche der Chroniken der Könige der Meder und Perser?',
        3: 'Denn Mordokai, der Jude, war der Zweite nach dem König Ahasveros, und groß bei den Juden, und wohlgefällig der Menge seiner Brüder; er suchte das Wohl seines Volkes und redete zur Wohlfahrt seines ganzen Geschlechts.',
    },
}
