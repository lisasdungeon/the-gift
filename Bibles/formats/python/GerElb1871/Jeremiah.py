...
CHAPTERS = {
    1: {
        1: 'Worte Jeremias, des Sohnes Hilkijas, von den Priestern, die zu Anathoth waren im Lande Benjamin,',
        2: 'zu welchem das Wort Jehovas geschah in den Tagen Josias, des Sohnes Amons, des Königs von Juda, im dreizehnten Jahre seiner Regierung;',
        ...
        5: 'Ehe ich dich im Mutterleibe bildete, habe ich dich erkannt, und ehe du aus dem Mutterschoße hervorkamst, habe ich dich geheiligt: zum Propheten an die Nationen habe ich dich bestellt',
        6: 'Und ich sprach: Ach, Herr, Jehova! Siehe, ich weiß nicht zu reden, denn ich bin jung',
        ...
        18: 'Und ich, siehe, ich mache dich heute zu einer festen Stadt und zu einer eisernen Säule und zu einer ehernen Mauer wider das ganze Land, sowohl wider die Könige von Juda als auch dessen Fürsten, dessen Priester und das Volk des Landes.',
        19: 'Und sie werden gegen dich streiten, aber dich nicht überwältigen; denn ich bin mit dir, spricht Jehova, um dich zu erretten.',
    },
    2: {
        1: 'Und das Wort Jehovas geschah zu mir also:',
        2: 'Geh und rufe vor den Ohren Jerusalems und sprich: So spricht Jehova: Ich habe dir gedacht die Zuneigung deiner Jugend, die Liebe deines Brautstandes, dein Wandeln hinter mir her in der Wüste, im unbesäten Lande.',
        3: 'Israel war heilig dem Jehova, der Erstling seines Ertrags; alle, die es verzehren wollten, verschuldeten sich: Unglück kam über sie, spricht Jehova.',
        ...
        13: 'Denn zweifach Böses hat mein Volk begangen: Mich, den Born lebendigen Wassers, haben sie verlassen, um sich Cisternen auszuhauen, geborstene Cisternen, die kein Wasser halten.',
        ...
        17: 'Ist es nicht dein Verlassen Jehovas, deines Gottes, zur Zeit, da er dich auf dem Wege führte, welches dir dieses bewirkt?',
        ...
        19: 'Deine Bosheit züchtigt dich und deine Abtrünnigkeiten strafen dich; so erkenne und sieh, daß es schlimm und bitter ist, daß du Jehova, deinen Gott, verlässest, und daß meine Furcht nicht bei dir ist, spricht der Herr, Jehova der Heerscharen.',
        ...
        22: 'Ja, wenn du dich mit Natron wüschest und viel Laugensalz nähmest: schmutzig bleibt deine Ungerechtigkeit vor mir, spricht der Herr, Jehova.',
    ...
    3: {
        1: 'Er spricht:Wenn ein Mann sein Weib entläßt, und sie von ihm weggeht und eines anderen Mannes wird, darf er wieder zu ihr zurückkehren? Würde nicht selbiges Land entweiht werden? Du aber hast mit vielen Buhlen gehurt, und doch solltest du zu mir zurückkehren! spricht Jehova.',
        ...
        16: 'Und es wird geschehen, wenn ihr euch im Lande mehret und fruchtbar seid in jenen Tagen, spricht Jehova, so wird man nicht mehr sagen: "Die Bundeslade Jehovas"; und sie wird nicht mehr in den Sinn kommen, und man wird ihrer nicht mehr gedenken noch sie suchen und sie wird nicht wieder gemacht werden.',
        ...
        19: 'Und ich sprach: Wie will ich dich unter den Söhnen stellen und dir ein köstliches Land geben, ein Erbteil, das die herrlichste Zierde der Nationen ist! Und ich sprach: Ihr werdet mir zurufen: Mein Vater! und werdet euch nicht von mir abwenden.',
    ...
    4: {
        ...
        24: 'Ich schaue die Berge an, und siehe, sie beben; und alle Hügel schwanken.',
    ...
    5: {
        ...
        8: 'Wie wohlgenährte Pferde schweifen sie umher; sie wiehern ein jeder nach seines Nächsten Weibe.',
        9: 'Sollte ich solches nicht heimsuchen? spricht Jehova; oder sollte an einer Nation, wie diese, meine Seele sich nicht rächen?',
        10: 'Ersteiget seine Mauern und zerstöret, doch richtet ihn nicht völlig zu Grunde; nehmet seine Ranken weg, denn nicht Jehovas sind sie.',
        11: 'Denn das Haus Israel und das Haus Juda haben gar treulos gegen mich gehandelt, spricht Jehova.',
        12: 'Sie haben Jehova verleugnet und gesagt: Er ist nicht; und kein Unglück wird über uns kommen, und Schwert und Hunger werden wir nicht sehen;',
        13: 'und die Propheten werden zu Wind werden, und der da redet, ist nicht in ihnen:also wird ihnen geschehen.',
        ...
        19: 'Und es soll geschehen, wenn ihr sagen werdet: Weshalb hat Jehova, unser Gott, uns dies alles getan? so sprich zu ihnen: Gleichwie ihr mich verlassen und fremden Göttern gedient habt in eurem Lande, also sollt ihr Fremden dienen in einem Lande, das nicht euer ist.',
    ...
    7: {
        ...
        23: 'sondern dieses Wort habe ich ihnen geboten, und gesagt: Höret auf meine Stimme, so werde ich euer Gott sein, und ihr werdet mein Volk sein und wandelt auf dem ganzen Wege, den ich euch gebiete, auf daß es euch wohlgehe.',
    ...
    8: {
        1: 'In jener Zeit, spricht Jehova, wird man die Gebeine der Könige von Juda und die Gebeine seiner Fürsten und die Gebeine der Priester und die Gebeine der Propheten und die Gebeine der Bewohner von Jerusalem aus ihren Gräbern herausnehmen.',
        2: 'Und man wird sie ausbreiten vor der Sonne und vor dem Monde und vor dem ganzen Heere des Himmels, welche sie geliebt und welchen sie gedient haben, und denen sie nachgewandelt sind, und welche sie gesucht und vor denen sie sich niedergebeugt haben; sie werden nicht gesammelt noch begraben werden, zu Dünger auf der Fläche des Erdbodens sollen sie werden.',
        ...
        4: 'Und sprich zu ihnen: So spricht Jehova: Fällt man denn und steht nicht wieder auf? Oder wendet man sich ab und kehrt nicht wieder zurück?',
    ...
    9: {
        ...
        3: 'Und sie spannen ihre Zunge, ihren Bogen, mit Lüge, und nicht nach Treue schalten sie im Lande; denn sie schreiten fort von Bosheit zu Bosheit, und mich kennen sie nicht, spricht Jehova.',
        4: 'Hütet euch ein jeder vor seinem Freunde, und auf keinen Bruder vertrauet; denn jeder Bruder treibt Hinterlist, und jeder Freund geht als Verleumder einher.',
        5: 'Und sie betrügen einer den anderen, und Wahrheit reden sie nicht; sie lehren ihre Zunge Lügen reden, sie mühen sich ab, verkehrt zu handeln.',
        6: 'Deine Wohnung ist mitten unter Trug. Vor Trug weigern sie sich, mich zu erkennen, spricht Jehova.',
        7: 'Darum, so spricht Jehova der Heerscharen: Siehe, ich will sie schmelzen und läutern; denn wie sollte ich anders handeln wegen der Tochter meines Volkes?',
        ...
        9: 'Sollte ich solches nicht an ihnen heimsuchen? spricht Jehova; oder sollte an einer Nation wie diese meine Seele sich nicht rächen?',
        ...
        15: 'Darum, so spricht Jehova der Heerscharen, der Gott Israels: Siehe, ich will sie, dieses Volk, mit Wermut speisen und sie mit bitterem Wasser tränken,',
        16: 'und sie unter die Nationen zerstreuen, die sie nicht gekannt haben, weder sie noch ihre Väter; und ich will das Schwert hinter ihnen her senden, bis ich sie vernichtet habe.',
        17: 'So spricht Jehova der Heerscharen: Gebet acht, und rufet Klageweiber, daß sie kommen, und schicket zu den weisen Frauen, daß sie kommen',
        18: 'und eilends eine Wehklage über uns erheben, damit unsere Augen von Tränen rinnen und unsere Wimpern von Wasser fließen.',
        19: 'Denn eine Stimme der Wehklage wird aus Zion gehört: "Wie sind wir verwüstet! wir sind völlig zu Schanden geworden; denn wir haben das Land verlassen müssen, denn sie haben unsere Wohnungen umgestürzt".',
        20: 'Denn höret, ihr Weiber, das Wort Jehovas, und euer Ohr fasse das Wort seines Mundes; und lehret eure Töchter Wehklage und eine die andere Klaggesang.',
        21: 'Denn der Tod ist durch unsere Fenster gestiegen, er ist in unsere Paläste gekommen, um das Kind auszurotten von der Gasse, die Jünglinge von den Straßen.',
        22: 'Rede: So spricht Jehova: Ja, die Leichen der Menschen werden fallen wie Dünger auf der Fläche des Feldes und wie eine Garbe hinter dem Schnitter, die niemand sammelt.',
        23: 'So spricht Jehova: Der Weise rühme sich nicht seiner Weisheit, und der Starke rühme sich nicht seiner Stärke, der Reiche rühme sich nicht seines Reichtums;',
        24: 'sondern wer sich rühmt, rühme sich dessen: Einsicht zu haben und mich zu erkennen, daß ich Jehova bin, der Güte, Recht und Gerechtigkeit übt auf der Erde; denn daran habe ich Gefallen, spricht Jehova.',
        25: 'Siehe, Tage kommen, spricht Jehova, da ich heimsuchen werde alle Beschnittenen mit den Unbeschnittenen:',
        26: 'Ägypten und Juda und Edom und die Kinder Ammon und Moab, und alle mit geschorenen Haarrändern die in der Wüste wohnen; denn alle Nationen sind unbeschnitten, und das ganze Haus Israel ist unbeschnittenen Herzens.',
    },
    10: {
        ...
        22: 'Horch! ein Gerücht: siehe, es kommt, und ein großes Getöse vom Lande des Nordens, um die Städte Judas zur Wüste zu machen, zur Wohnung der Schakale. -',
    ...
    12: {
        1: 'Du bist gerecht, Jehova, wenn ich mit dir hadere; doch von deinen Urteilen möchte ich mit dir reden: Warum ist der Weg der Gesetzlosen glücklich, sind sicher alle, die Treulosigkeit üben?',
        ...
        5: 'Wenn du mit Fußgängern liefest, und sie dich ermüdeten, wie wolltest du denn mit Rossen wetteifern? Und wenn du auf ein Land des Friedens dein Vertrauen setzest, wie willst du es denn machen in der Pracht des Jordan',
    ...
    13: {
        1: 'So hat Jehova zu mir gesprochen: Gehe und kaufe dir einen leinenen Gürtel und lege ihn um deine Lenden; aber ins Wasser sollst du ihn nicht bringen.',
        ...
        4: 'Nimm den Gürtel, den du gekauft hast, der um deine Lenden ist, und mache dich auf, gehe an den Euphrat und verbirg ihn daselbst in einer Felsenspalte.',
        5: 'Da ging ich hin und verbarg ihn am Euphrat, wie Jehova mir geboten hatte.',
        6: 'Und es geschah am Ende vieler Tage, da sprach Jehova zu mir: Mache dich auf, gehe an den Euphrat und hole von dort den Gürtel, den ich dir geboten habe daselbst zu verbergen.',
        ...
        27: 'Dein Ehebrechen und dein Wiehern, die Schandtat deiner Hurerei auf den Hügeln im Felde: deine Greuel habe ich gesehen. Wehe dir, Jerusalem! Du wirst nicht rein werden-wie lange wirds noch währen?',
    },
    14: {
        1: 'Das Wort Jehovas, welches zu Jeremia geschah betreffs der Dürre',
    ...
    15: {
        ...
        14: 'Und ich werde es deine Feinde bringen lassen in ein Land das du nicht kennst; denn ein Feuer ist entbrannt in meinem Zorn, über euch wird es brennen. -',
        15: 'Jehova, du weißt es ja; gedenke meiner und nimm dich meiner an und räche mich an meinen Verfolgern! Raffe mich nicht hin nach deiner Langmut erkenne, daß ich um deinetwillen Schmach trage.',
    ...
    16: {
        ...
        13: 'So werde ich euch aus diesem Lande wegschleudern in ein Land, welches ihr nicht gekannt habt, weder ihr noch eure Väter; und daselbst werdet ihr anderen Göttern dienen Tag und Nacht, weil ich euch keine Gnade schenken werde.',
        ...
        17: 'Denn meine Augen sind auf alle ihre Wege gerichtet; sie sind vor mir nicht verborgen, und ihre Ungerechtigkeit ist nicht verhüllt vor meinen Augen.',
        18: 'Und zuvor will ich zwiefach vergelten ihre Ungerechtigkeit und ihre Sünde, weil sie mein Land mit den Leichen ihrer Scheusale entweiht und mein Erbteil mit ihren Greueln erfüllt haben.',
        19: 'Jehova, meine Stärke und mein Hort und meine Zuflucht am Tage der Bedrängnis! Zu dir werden Nationen kommen von den Enden der Erde und sprechen: Nur Lüge haben unsere Väter ererbt, nichtige Götter und unter ihnen ist keiner, der etwas nützt.',
    ...
    17: {
        ...
        4: 'Und du wirst, und zwar durch dich selbst dein Erbteil fahren lassen müssen, welches ich dir gegeben habe, und ich werde dich deinen Feinden dienen lassen in einem Lande, das du nicht kennst; denn ihr habt ein Feuer angezündet in meinem Zorn, es wird ewiglich brennen.',
        ...
        9: 'Arglistig ist das Herz, mehr als alles, und verderbt ist es; wer mag es kennen?',
        ...
        19: 'So spricht Jehova zu mir: Geh hin und stelle dich in das Tor der Kinder des Volkes durch welches die Könige von Juda einziehen und durch welches sie ausziehen, und in alle Tore Jerusalems,',
    ...
    18: {
        1: 'Das Wort, welches von seiten Jehovas zu Jeremia geschah, also:',
        2: 'Mache dich auf und gehe in das Haus des Töpfers hinab, und daselbst werde ich dich meine Worte hören lassen.',
        ...
        10: 'tut es aber, was böse ist in meinen Augen, so daß es auf meine Stimme nicht hört, so lasse ich mich des Guten gereuen, welches ich ihm zu erweisen gedachte hatte.',
    ...
    19: {
        ...
        2: 'und gehe hinaus in das Tal des Sohnes Hinnoms, welches vor dem Eingang des Tores Charsuth liegt, und rufe daselbst die Worte aus, die ich zu dir reden werde,',
    ...
    20: {
        1: 'Und als Paschchur, der Sohn Immers, der Priester, Jeremia diese Worte weissagen hörte,',
        ...
        16: 'Und jener Mann werde den Städten gleich, die Jehova umgekehrt hat, ohne sichs gereuen zu lassen; und er höre ein Geschrei am Morgen und Feldgeschrei zur Mittagszeit:',
    ...
    22: {
        ...
        4: 'Denn wenn ihr dieses Wort wirklich tun werdet, so werden durch die Tore dieses Hauses Könige einziehen, welche auf dem Throne Davids sitzen auf Wagen fahrend und auf Rossen reitend, er und seine Knechte und sein Volk.',
        ...
        6: 'Denn also spricht Jehova über das Haus des Königs von Juda: Du bist mir ein Gilead ein Haupt des Libanon; wenn ich dich nicht zur Wüste machen werde, zu unbewohnten Städten!',
        ...
        23: 'Die du auf dem Libanon wohnst und auf den Cedern nistest, wie mitleidswürdig wirst du sein wenn Schmerzen dich ankommen, Wehen, der Gebärenden gleich!',
    ...
    25: {
        ...
        3: 'Vom dreizehnten Jahre Josias, des Sohnes Amons, des Königs von Juda, bis auf diesen Tag, diese 23 Jahre, ist das Wort Jehovas zu mir geschehen; und ich habe zu euch geredet, früh mich aufmachend und redend, aber ihr hörtet nicht.',
        ...
        20: 'und alle gemischten Völker, und alle Könige des Landes Uz und alle Könige des Landes der Philister, und Askelon und Gasa und Ekron und den Überrest von Asdod;',
    ...
    26: {
        ...
        5: 'daß ihr auf die Worte meiner Knechte, der Propheten, höret, welche ich zu euch sende, früh mich aufmachend und sendend:',
        ...
        16: 'Und die Fürsten und alles Volk sprachen zu den Priestern und zu den Propheten: Diesem Manne gebührt nicht die Todesstrafe; denn er hat im Namen Jehovas, unseres Gottes, zu uns geredet.',
    ...
    28: {
        1: 'Und es geschah in demselben Jahre, im Anfang der Regierung Zedekias, des Königs von Juda, im vierten Jahre, im fünften Monat, da sprach zu mir Hananja, der Sohn Assurs, der Prophet, der von Gibeon war, im Hause Jehovas vor den Augen der Priester und alles Volkes, und sagte:',
        ...
        6: 'und der Prophet Jeremia sprach: Amen, Jehova tue also! Jehova bestätige deine Worte, die du geweissagt hast, daß er die Geräte des Hauses Jehovas und alle Weggeführten von Babel an diesen Ort zurückbringe!',
        7: 'Nur höre doch dieses Wort, welches ich vor deinen Ohren und vor den Ohren alles Volkes rede:',
        8: 'Die Propheten, welche von alters her vor mir und vor dir gewesen sind, sie haben auch über viele Länder und über große Königreiche geweissagt von Krieg und von Unglück und von Pest.',
    ...
    29: {
        ...
        16: 'ja, so spricht Jehova von dem König, der auf dem Throne Davids sitzt, und von dem ganzen Volke, das in dieser Stadt wohnt, euren Brüdern, welche nicht mit euch in die Gefangenschaft weggezogen sind,',
    ...
    30: {
        ...
        8: 'Denn es wird geschehen an jenem Tage, spricht Jehova der Heerscharen, daß ich sein Joch von deinem Halse zerbrechen und deine Fesseln zerreißen werde, und Fremde sollen ihn nicht mehr dienstbar machen;',
        9: 'sondern sie werden Jehova, ihrem Gott, dienen und ihrem König David, den ich ihnen erwecken werde.',
        10: 'Und du, fürchte dich nicht, mein Knecht Jakob, spricht Jehova, und erschrick nicht, Israel! denn siehe, ich will dich retten aus der Ferne und deine Nachkommen aus dem Lande ihrer Gefangenschaft; und Jakob wird zurückkehren und ruhig und sicher sein, und niemand wird ihn aufschrecken.',
        11: 'Denn ich bin mit dir, spricht Jehova, um dich zu retten. Denn ich werde den Garaus machen allen Nationen, wohin ich dich zerstreut habe; nur dir werde ich nicht den Garaus machen, sondern dich nach Gebühr züchtigen und dich keineswegs ungestraft lassen.',
        12: 'Denn so spricht Jehova: Deine Wunde ist unheilbar, schmerzlich ist dein Schlag;',
    ...
    31: {
        ...
        3: 'Jehova ist mir von ferne erschienen: Ja, mit ewiger Liebe habe ich dich geliebt; darum habe ich dir fortdauern lassen meine Güte.',
        ...
        15: 'So spricht Jehova: Eine Stimme wird in Rama gehört, Wehklage, bitteres Weinen. Rahel beweint ihre Kinder; sie will sich nicht trösten lassen über ihre Kinder, weil sie nicht mehr sind.',
        16: 'So spricht Jehova: Halte deine Stimme zurück vom Weinen und deine Augen von Tränen; denn es gibt Lohn für deine Arbeit, spricht Jehova, und sie werden aus dem Lande des Feindes zurückkehren;',
        17: 'und Hoffnung ist da für dein Ende spricht Jehova, und deine Kinder werden in ihr Gebiet zurückkehren.',
        18: 'Wohl habe ich Ephraim klagen hören: Du hast mich gezüchtigt, und ich bin gezüchtigt worden wie ein nicht ans Joch gewöhntes Kalb; bekehre mich, daß ich mich bekehre, denn du bist Jehova, mein Gott.',
        ...
        20: 'Ist mir Ephraim ein teurer Sohn oder ein Kind der Wonne? Denn sooft ich auch wider ihn geredet habe, gedenke ich seiner doch immer wieder. Darum ist mein Innerstes um ihn erregt; ich will mich gewißlich seiner erbarmen, spricht Jehova.',
        21: 'Richte dir Wegweiser auf, setze dir Stangen, richte dein Herz auf die Straße, auf den Weg, den du gegangen bist! Kehre um, Jungfrau Israel, kehre um zu diesen deinen Städten!',
        22: 'Wie lange willst du dich hin und her wenden, du abtrünnige Tochter? Denn Jehova hat ein Neues geschaffen auf der Erde: Das Weib wird den Mann umgeben.',
        23: 'So spricht Jehova der Heerscharen, der Gott Israels: Dieses Wort wird man noch sprechen im Lande Juda und in seinen Städten, wenn ich ihre Gefangenschaft wenden werde: Jehova segne dich, du Wohnung der Gerechtigkeit, du heiliger Berg!',
        24: 'Und Juda und alle seine Städte werden allzumal darin wohnen, Ackerleute und die mit der Herde umherziehen.',
        ...
        27: 'Siehe, Tage kommen, spricht Jehova, da ich das Haus Israel und das Haus Juda besäen werde mit Samen von Menschen und Samen von Vieh.',
        28: 'Und es wird geschehen, wie ich über sie gewacht habe, um auszureißen und abzubrechen und niederzureißen und zu zerstören und zu verderben, also werde ich über sie wachen, um zu bauen und zu pflanzen, spricht Jehova.',
        ...
        30: 'sondern ein jeder wird für seine Missetat sterben: Jeder Mensch, der Herlinge ißt, dessen Zähne sollen stumpf werden.',
        ...
        38: 'Siehe, Tage kommen, spricht Jehova, da diese Stadt dem Jehova gebaut werden wird vom Turme Hananel bis zum Ecktore.',
        39: 'Und die Meßschnur wird weiter fortlaufen geradeaus über den Hügel Gareb, und sich nach Goah wenden.',
        40: 'Und das ganze Tal der Leichen und der Asche, und alles Gefilde bis zum Bache Kidron, bis zur Ecke des Roßtores gegen Osten, wird Jehova heilig sein; es soll nicht ausgerottet noch zerstört werden in Ewigkeit.',
    },
    32: {
        ...
        5: 'und er wird Zedekia nach Babel führen, und daselbst wird er sein, bis ich mich seiner annehme spricht Jehova. Wenn ihr mit den Chaldäern streitet, so wird es euch nicht gelingen?"',
        ...
        8: 'Und Hanamel, der Sohn meines Oheims, kam zu mir, nach dem Worte Jehovas, in den Gefängnishof und sprach zu mir: Kaufe doch mein Feld, das zu Anathoth im Lande Benjamin ist, denn du hast das Erbrecht und du hast die Lösung; kaufe es dir. Und ich erkannte, daß es das Wort Jehovas war.',
        ...
        17: 'Ach, Herr, Jehova! Siehe, du hast die Himmel und die Erde gemacht durch deine große Kraft und durch deinen ausgestreckten Arm: kein Ding ist dir unmöglich',
        18: 'der du Güte übst an Tausenden, und die Ungerechtigkeit der Väter vergiltst in den Busen ihrer Kinder nach ihnen; du großer, mächtiger Gott dessen Name Jehova der Heerscharen ist,',
        ...
        35: 'Und sie haben die Höhen des Baal gebaut, welche im Tale des Sohnes Hinnoms sind, um ihre Söhne und ihre Töchter dem Moloch durch das Feuer gehen zu lassen, -was ich nicht geboten habe und mir nicht in den Sinn gekommen ist-um diesen Greuel zu verüben, damit sie Juda sündigen machten.',
        ...
        37: 'Siehe, ich werde sie aus all den Ländern sammeln, wohin ich sie vertrieben haben werde in meinem Zorn und in meinem Grimm, und in großer Entrüstung und ich werde sie an diesen Ort zurückbringen und sie in Sicherheit wohnen lassen.',
        ...
        40: 'Und ich werde einen ewigen Bund mit ihnen machen, daß ich nicht von ihnen lassen werde, ihnen wohlzutun; und ich werde meine Furcht in ihr Herz legen, damit sie nicht von mir abweichen.',
        41: 'Und ich werde mich über sie freuen, ihnen wohlzutun, und werde sie in diesem Lande pflanzen in Wahrheit mit meinem ganzen Herzen und mit meiner ganzen Seele.',
    ...
    33: {
        ...
        10: 'So spricht Jehova: An diesem Orte, von dem ihr saget: "Er ist verödet, ohne Menschen und ohne Vieh", in den Städten Judas und auf den Straßen Jerusalems, die verwüstet sind, ohne Menschen und ohne Bewohner und ohne Vieh, wird wiederum gehört werden',
        11: 'die Stimme der Wonne und die Stimme der Freude, die Stimme des Bräutigams und die Stimme der Braut, die Stimme derer, welche sagen: Lobet Jehova der Heerscharen, denn Jehova ist gütig, denn seine Güte währt ewiglich! die Stimme derer, welche Lob in das Haus Jehovas bringen. Denn ich werde die Gefangenschaft des Landes wenden wie im Anfang, spricht Jehova.',
        12: 'So spricht Jehova der Heerscharen: An diesem Orte, der verödet ist, ohne Menschen und ohne Vieh, und in allen seinen Städten wird wiederum eine Wohnung sein für die Hirten, welche Herden lagern lassen.',
        13: 'In den Städten des Gebirges, in den Städten der Niederung und in den Städten des Südens, und im Lande Benjamin und in den Umgebungen von Jerusalem und in den Städten Judas werden wiederum die Herden unter den Händen des Zählers vorüberziehen, spricht Jehova.',
        14: 'Siehe, Tage kommen, spricht Jehova, da ich das gute Wort erfüllen werde, welches ich über das Haus Israel und über das Haus Juda geredet habe.',
        ...
        24: 'Hast du nicht gesehen, was dieses Volk redet, indem es spricht: "Die zwei Geschlechter welche Jehova erwählt hatte, die hat er verworfen"? Und so verachten sie mein Volk, so daß es vor ihnen keine Nation mehr ist.',
        25: 'So spricht Jehova: Wenn nicht mein Bund betreffs des Tages und der Nacht besteht, wenn ich nicht die Ordnungen des Himmels und der Erde festgesetzt habe,',
    ...
    34: {
        1: 'Das Wort, welches von seiten Jehovas zu Jeremia geschah, als Nebukadnezar, der König von Babel, und sein ganzes Heer und alle Königreiche der Erde, die unter der Herrschaft seiner Hand waren, und alle Völker wider Jerusalem und wider alle seine Städte stritten:',
        2: 'So spricht Jehova, der Gott Israels: Geh und sprich zu Zedekia, dem König von Juda, und sage ihm: So spricht Jehova: Siehe, ich gebe diese Stadt in die Hand des Königs von Babel, daß er sie mit Feuer verbrenne.',
        3: 'Und du, du wirst seiner Hand nicht entrinnen, sondern gewißlich ergriffen und in seine Hand gegeben werden; und deine Augen werden die Augen des Königs von Babel sehen, und sein Mund wird mit deinem Munde reden, und du wirst nach Babel kommen.',
        4: 'Doch höre das Wort Jehovas, Zedekia, König von Juda! So spricht Jehova über dich: Du wirst nicht durch das Schwert sterben;',
        5: 'in Frieden wirst du sterben, und gleich den Bränden deiner Väter, der früheren Könige, die vor dir gewesen sind, also wird man dir einen Brand machen, und man wird über dich klagen: "Wehe, Herr!" denn ich habe das Wort geredet, spricht Jehova. -',
        ...
        13: 'So spricht Jehova, der Gott Israels: Ich habe einen Bund mit euren Vätern gemacht an dem Tage, da ich sie aus dem Lande Ägypten, aus dem Hause der Knechtschaft herausführte, und gesprochen:',
        14: 'Am Ende von sieben Jahren sollt ihr ein jeder seinen Bruder entlassen, den Hebräer, der sich dir verkauft hat; er soll dir sechs Jahre dienen, und dann sollst du ihn frei von dir entlassen. Aber eure Väter hörten nicht auf mich und neigten ihr Ohr nicht.',
        15: 'Und ihr seid heute zwar umgekehrt und habt getan, was recht ist in meinen Augen, daß ein jeder seinem Nächsten Freiheit ausrief; und ihr habt einen Bund vor mir gemacht in dem Hause, welches nach meinem Namen genannt ist;',
        16: 'aber ihr habt euch wieder umgewandt und meinen Namen entweiht, und habt ein jeder seinen Knecht und ein jeder seine Magd wiederkommen lassen, die ihr nach ihrem Belieben frei entlassen hattet; und ihr habt sie unterjocht, daß sie euch zu Knechten und zu Mägden seien.',
        17: 'Darum spricht Jehova also: Ihr habt nicht auf mich gehört, Freiheit auszurufen, ein jeder seinem Bruder und ein jeder seinem Nächsten; siehe, so rufe ich euch Freiheit aus, spricht Jehova, für das Schwert, für die Pest und für den Hunger, und gebe euch zur Mißhandlung hin allen Königreichen der Erde.',
        18: 'Und ich will die Männer, welche meinen Bund übertreten haben, welche die Worte des Bundes nicht gehalten, den sie vor mir gemacht haben, wie das Kalb machen, das sie entzweigeschnitten und zwischen dessen Stücken sie hindurchgegangen sind:',
    ...
    35: {
        ...
        2: 'Gehe zum Hause der Rekabiter und rede mit ihnen, und bringe sie in das Haus Jehovas in eine der Zellen und gib ihnen Wein zu trinken.',
    ...
    36: {
        ...
        6: 'so gehe du hin und lies aus der Rolle, was du aus meinem Munde aufgeschrieben hast, die Worte Jehovas, vor den Ohren des Volkes im Hause Jehovas am Tage des Fastens; und du sollst sie auch vor den Ohren aller Juden lesen, die aus ihren Städten kommen.',
    ...
    37: {
        ...
        7: 'So spricht Jehova, der Gott Israels: Also sollt ihr dem König von Juda sagen, der euch zu mir gesandt hat, um mich zu befragen: Siehe, das Heer des Pharao, welches euch zu Hülfe ausgezogen ist, wird in sein Land Ägypten zurückkehren.',
    ...
    38: {
        ...
        9: 'Mein Herr König, diese Männer haben übel gehandelt in allem, was sie dem Propheten Jeremia getan, den sie in die Grube geworfen haben; er muß ja da, wo er ist, vor Hunger sterben, denn es ist kein Brot mehr in der Stadt.',
        10: 'Und der König gebot Ebedmelech, dem Äthiopier, und sprach: Nimm von hier dreißig Männer unter deine Hand und hole den Propheten Jeremia aus der Grube herauf, bevor er stirbt.',
        11: 'Und Ebedmelech nahm die Männer unter seine Hand und ging in das Haus des Königs, unter die Schatzkammer, und er nahm von dort zerrissene Lappen und abgetragene Lumpen, und er ließ sie an Stricken zu Jeremia in die Grube hinab.',
        12: 'Und Ebedmelech, der Äthiopier, sprach zu Jeremia: Lege doch diese zerrissenen Lappen und abgetragenen Lumpen unter die Achseln deiner Arme, unter die Stricke. Und Jeremia tat also.',
        13: 'Und sie zogen Jeremia an den Stricken empor und holten ihn aus der Grube herauf; und Jeremia blieb im Gefängnishof.',
        ...
        28: 'Und Jeremia blieb im Gefängnishofe bis zu dem Tage, da Jerusalem eingenommen wurde.',
    },
    39: {
        1: 'Und es geschah, als Jerusalem eingenommen wurde im neunten Jahre Zedekias, des Königs von Juda, im zehnten Monat, war Nebukadrezar, der König von Babel, und sein ganzes Heer gegen Jerusalem gekommen, und sie belagerten es;',
    ...
    41: {
        ...
        4: 'Und es geschah am zweiten Tage, nachdem er Gedalja getötet hatte,',
    ...
    42: {
        ...
        2: 'und sprachen zu dem Propheten Jeremia: Laß doch unser Flehen vor dich kommen, und bete für uns zu Jehova, deinem Gott, für diesen ganzen Überrest; denn wenige sind wir übriggeblieben von vielen, wie deine Augen uns sehen:',
        ...
        11: 'Fürchtet euch nicht vor dem König von Babel, vor dem ihr euch fürchtet; fürchtet euch nicht vor ihm, spricht Jehova; denn ich bin mit euch, um euch aus seiner Hand zu retten und zu befreien.',
        12: 'Und ich werde euch Barmherzigkeit zuwenden, daß er sich euer erbarme und euch in euer Land zurückkehren lasse.',
        ...
        14: 'und sprechet: Nein, sondern wir wollen in das Land Ägypten ziehen, wo wir keinen Krieg sehen und den Schall der Posaune nicht hören und nicht nach Brot hungern werden, und daselbst wollen wir wohnen-',
        15: 'nun denn, darum höret das Wort Jehovas, ihr Überrest von Juda! So spricht Jehova der Heerscharen, der Gott Israels: Wenn ihr eure Angesichter wirklich dahin richtet, nach Ägypten zu ziehen, und hinziehet, um euch daselbst aufzuhalten,',
        ...
        17: 'Und es wird geschehen, alle Männer, die ihre Angesichter dahin gerichtet haben, nach Ägypten zu ziehen, um sich daselbst aufzuhalten, werden sterben durch das Schwert, durch den Hunger und durch die Pest; und sie werden keinen Übriggeliebenen noch Entronnenen haben vor dem Unglück, welches ich über sie bringen werde.',
        18: 'Denn so spricht Jehova der Heerscharen, der Gott Israels: Gleichwie mein Zorn und mein Grimm sich ergossen haben über die Bewohner von Jerusalem, also wird mein Grimm sich über euch ergießen, wenn ihr nach Ägypten ziehet; und ihr werdet zum Fluch und zum Entsetzen und zur Verwünschung und zum Hohne sein, und werdet diesen Ort nicht mehr sehen. -',
        19: 'Jehova hat zu euch geredet, ihr Überrest von Juda: Ziehet nicht nach Ägypten! Wisset bestimmt, daß ich es euch heute ernstlich bezeugt habe.',
        20: 'Denn ihr habt um den Preis eurer Seelen geirrt. Denn ihr habt mich an Jehova, euren Gott, gesandt und gesprochen: Bete für uns zu Jehova, unserem Gott; und nach allem, was Jehova, unser Gott, sagen wird, also tue uns kund, und wir werden es tun.',
        21: 'Und ich habe es euch heute kundgetan; aber ihr habt nicht auf die Stimme Jehovas, eures Gottes, gehört, nach allem womit er mich zu euch gesandt hat.',
        22: 'Und nun wisset bestimmt, daß ihr sterben werdet durch das Schwert, durch den Hunger und durch die Pest an dem Orte, wohin es euch zu ziehen gelüstet, um euch daselbst aufzuhalten.',
    },
    43: {
        1: 'Und es geschah, als Jeremia zu dem ganzen Volke alle Worte Jehovas, ihres Gottes, zu Ende geredet, womit ihn Jehova, ihr Gott, zu ihnen gesandt hatte, alle jene Worte,',
        2: 'da sprachen Asarja der Sohn Hoschajas, und Jochanan, der Sohn Kareachs, und alle frechen Männer-sie sprachen zu Jeremia: Du redest Lügen! Jehova, unser Gott, hat dich nicht gesandt und gesagt: Ihr sollt nicht nach Ägypten ziehen, um euch daselbst aufzuhalten;',
        ...
        6: 'die Männer und die Weiber und die Kinder und die Königstöchter, und alle Seelen, welche Nebusaradan, der Oberste der Trabanten, bei Gedalja, dem Sohne Achikams, des Sohnes Schaphans, zurückgelassen hatte, und auch den Propheten Jeremia und Baruk, den Sohn Nerijas;',
        ...
        9: 'Nimm große Steine in deine Hand und verbirg sie in den Mörtel am Ziegelofen, der bei dem Eingang des Hauses des Pharao in Tachpanches ist, vor den Augen der jüdischen Männer;',
        ...
        12: 'Und ich werde ein Feuer anzünden in den Häusern der Götter Ägyptens, und er wird sie verbrennen und sie wegführen. Und er wird das Land Ägypten um sich wickeln, wie der Hirt sein Oberkleid um sich wickelt; und er wird von dannen ziehen in Frieden.',
        13: 'Und er wird die Säulen von Beth-Semes welche im Lande Ägypten sind, zerschlagen, und die Häuser der Götter Ägyptens mit Feuer verbrennen.',
    },
    44: {
    ...
    47: {
        ...
        4: 'wegen des Tages, der da kommt, um alle Philister zu zerstören und für Tyrus und Zidon jeden Hülfebringenden Überrest zu vertilgen. Denn Jehova zerstört die Philister, den Überrest der Insel Kaphtor.',
        5: 'Kahlheit ist über Gasa gekommen, vernichtet ist Askelon, der Überrest ihres Tales Wie lange willst du dich ritzen? -',
    ...
    52: {
        ...
        7: 'Und die Stadt wurde erbrochen, und alle Kriegsmänner flohen und zogen des Nachts aus der Stadt hinaus auf dem Wege durch das Tor, welches zwischen den beiden Mauern bei dem Garten des Königs war; und sie zogen den Weg zur Ebene',
        ...
        23: 'Und der Granatäpfel waren 96 nach den vier Winden hin aller Granatäpfel waren hundert am Netzwerk ringsum.',
        ...
        33: 'und er veränderte die Kleider seines Gefängnisses. Und Jojakin aß beständig vor ihm alle Tage seines Lebens;',
        34: 'und sein Unterhalt: ein beständiger Unterhalt wurde ihm von dem König von Babel gegeben, soviel er täglich bedurfte, bis zum Tage seines Todes, alle Tage seines Lebens.',
    },
}
