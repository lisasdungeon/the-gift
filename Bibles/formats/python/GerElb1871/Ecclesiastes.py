...
CHAPTERS = {
    ...
    4: {
        1: 'Und ich wandte mich und sah alle die Bedrückungen, welche unter der Sonne geschehen: und siehe, da waren Tränen der Bedrückten, und sie hatten keinen Tröster; und von der Hand ihrer Bedrücker ging Gewalttat aus, und sie hatten keinen Tröster.',
    ...
    6: {
        ...
        11: 'Denn es gibt viele Worte welche die Eitelkeit mehren; welchen Nutzen hat der Mensch davon? Denn wer weiß, was dem Menschen gut ist im Leben, die Zahl der Tage seines eitlen Lebens, welche er wie ein Schatten verbringt? Denn wer kann dem Menschen kundtun, was nach ihm sein wird unter der Sonne?',
    },
    7: {
    ...
    8: {
        ...
        16: 'Als ich mein Herz darauf richtete, Weisheit zu erkennen, und das Treiben zu besehen, welches auf Erden geschieht,',
    ...
    9: {
        1: 'Denn dies alles habe ich mir zu Herzen genommen und zwar um dies alles zu prüfen:daß die Gerechten und die Weisen und ihre Werke in der Hand Gottes sind; weder Liebe noch Haß kennt der Mensch im voraus: alles ist vor ihnen',
        ...
        3: 'Das ist ein Übel in allem, was unter der Sonne geschieht, daß einerlei Geschick allen zuteil wird; und auch ist das Herz der Menschenkinder voll Bosheit, und Narrheit ist in ihrem Herzen während ihres Lebens; und danach gehts zu den Toten.',
        ...
        17: 'Worte der Weisen, in Ruhe gehört, sind mehr wert als das Geschrei des Herrschers unter den Toren. -',
    ...
    11: {
        ...
        8: 'Denn wenn der Mensch auch viele Jahre lebt, möge er in ihnen allen sich freuen und der Tage der Finsternis gedenken, daß ihrer viele sein werden: alles, was kommt, ist Eitelkeit.',
        9: 'Freue dich, Jüngling, in deiner Jugend, und dein Herz mache dich fröhlich in den Tagen deiner Jugendzeit, und wandle in den Wegen deines Herzens und im Anschauen deiner Augen; doch wisse, daß um dies alles Gott dich ins Gericht bringen wird.',
        10: 'Und entferne den Unmut aus deinem Herzen, und tue das Übel von deinem Leibe weg; denn die Jugend und das Mannesalter sind Eitelkeit.',
    },
    12: {
        ...
        6: 'ehe zerrissen wird die silberne Schnur, und zerschlagen die goldene Schale, und zerbrochen der Eimer am Quell, und zerschlagen die Schöpfwelle an der Cisterne',
