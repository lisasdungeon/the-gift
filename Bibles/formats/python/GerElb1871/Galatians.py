...
CHAPTERS = {
    1: {
        ...
        4: 'der sich selbst für unsere Sünden hingegeben hat, damit er uns herausnehme aus der gegenwärtigen bösen Welt, nach dem Willen unseres Gottes und Vaters,',
        5: 'welchem die Herrlichkeit sei in die Zeitalter der Zeitalter! Amen.',
    ...
    2: {
        ...
        16: 'aber wissend, daß der Mensch nicht aus Gesetzeswerken gerechtfertigt wird, sondern nur durch den Glauben an Jesum Christum, auch wir haben an Christum Jesum geglaubt, auf daß wir aus Glauben an Christum gerechtfertigt würden, und nicht aus Gesetzeswerken, weil aus Gesetzeswerken kein Fleisch gerechtfertigt werden wird.',
    ...
    3: {
        ...
        19: 'Warum nun das Gesetz? Es wurde der Übertretungen wegen hinzugefügt, angeordnet durch Engel in der Hand eines Mittlers.',
    ...
    6: {
        ...
        14: 'Von mir aber sei es ferne, mich zu rühmen, als nur des Kreuzes unseres Herrn Jesu Christi, durch welchen mir die Welt gekreuzigt ist, und ich der Welt.',
