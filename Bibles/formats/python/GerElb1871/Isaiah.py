...
CHAPTERS = {
    ...
    5: {
        1: 'Wohlan, ich will singen von meinem Geliebten, ein Lied meines Lieben von seinem Weinberge: Mein Geliebter hatte einen Weinberg auf einem fetten Hügel.',
        2: 'Und er grub ihn um und säuberte ihn von Steinen und bepflanzte ihn mit Edelreben; und er baute einen Turm in seine Mitte und hieb auch eine Kelter darin aus; und er erwartete, daß er Trauben brächte, aber er brachte Herlinge.',
        3: 'Nun denn, Bewohner von Jerusalem und Männer von Juda, richtet doch zwischen mir und meinem Weinberge!',
        4: 'Was war noch an meinem Weinberge zu tun, das ich nicht an ihm getan hätte? Warum habe ich erwartet, daß er Trauben brächte, und er brachte Herlinge?',
        5: 'Nun, so will ich euch denn kundmachen, was ich meinem Weinberge tun will: seinen Zaun wegnehmen, daß er abgeweidet werde, seine Mauer niederreißen, daß er zertreten werde.',
        6: 'Und ich werde ihn zu Grunde richten; er soll nicht beschnitten noch behackt werden, und Dornen und Disteln sollen in ihm aufschießen; und ich will den Wolken gebieten, daß sie keinen Regen auf ihn fallen lassen.',
        7: 'Denn der Weinberg Jehovas der Heerscharen ist das Haus Israel, und die Männer von Juda sind die Pflanzung seines Ergötzens; und er wartete auf Recht, und siehe da: Blutvergießen, auf Gerechtigkeit, und siehe da: Wehgeschrei.',
        8: 'Wehe denen, die Haus an Haus reihen, Feld an Feld rücken, bis gar kein Raum mehr ist, und ihr allein seßhaft seid inmitten des Landes!',
        9: 'Vor meinen Ohren hat Jehova der Heerscharen gesprochen: Wenn nicht die vielen Häuser zur Wüste werden, die großen und schönen ohne Bewohner!',
        ...
        20: 'Wehe denen, die das Böse gut heißen, und das Gute böse; welche Finsternis zu Licht machen, und Licht zu Finsternis; welche Bitteres zu Süßem machen, und Süßes zu Bitterem! -',
    ...
    7: {
        ...
        8: 'Denn Damaskus ist das Haupt von Syrien, und Rezin das Haupt von Damaskus; und in noch 65 Jahren wird Ephraim zerschmettert werden, daß es kein Volk mehr sei.',
    ...
    8: {
        1: 'Und Jehova sprach zu mir: Nimm dir eine große Tafel und schreibe darauf mit Menschengriffel: Es eilt der Raub, bald kommt die Beute;',
        2: 'und ich will mir zuverlässige Zeugen nehmen: Urija, den Priester, und Sacharja, den Sohn Jeberekjas. -',
        3: 'Und ich nahte der Prophetin, und sie ward schwanger und gebar einen Sohn. Und Jehova sprach zu mir: Gib ihm den Namen: "Es eilt der Raub, bald kommt die Beute".',
        4: 'Denn ehe der Knabe zu rufen weiß "mein Vater" und "meine Mutter", wird man vor dem König von Assyrien hertragen den Reichtum von Damaskus und die Beute von Samaria.',
        5: 'Und Jehova fuhr fort, weiter zu mir zu reden, und sprach:',
        6: 'Darum, daß dieses Volk die Wasser von Siloah verachtet, die still fließen, und Freude hat an Rezin und an dem Sohne Remaljas:',
        ...
        12: 'Ihr sollt nicht alles Verschwörung nennen, was dieses Volk Verschwörung nennt; und fürchtet nicht ihre Furcht und erschrecket nicht davor.',
        13: 'Jehova der Heerscharen, den sollt ihr heiligen; und er sei eure Furcht, und er sei euer Schrecken.',
        14: 'Und er wird zum Heiligtum sein; aber zum Stein des Anstoßes und zum Fels des Strauchelns den beiden Häusern Israels, zur Schlinge und zum Fallstrick den Bewohnern von Jerusalem.',
    ...
    9: {
        1: 'Doch nicht bleibt Finsternis dem Lande, welches Bedrängnis hat. Um die erste Zeit hat er das Land Sebulon und das Land Naphtali verächtlich gemacht; und in der letzten bringt er zu Ehren den Weg am Meere, das Jenseitige des Jordan, den Kreis der Nationen.',
        ...
        18: 'Denn die Gesetzlosigkeit brennt wie Feuer: sie verzehrt Dornen und Disteln, und zündet in den Dickichten des Waldes, daß sie emporwirbeln in hoch aufsteigendem Rauche.',
        19: 'Durch den Grimm Jehovas der Heerscharen ist das Land verbrannt, und das Volk ist wie eine Speise des Feuers geworden; keiner schont den anderen.',
        20: 'Und man schlingt zur Rechten und hungert, und man frißt zur Linken und wird nicht satt. Sie fressen ein jeder das Fleisch seines eigenen Armes:',
        21: 'Manasse den Ephraim, und Ephraim den Manasse; diese miteinander fallen über Juda her. -Bei dem allen wendet sich sein Zorn nicht ab, und noch ist seine Hand ausgestreckt.',
    },
    10: {
    ...
    13: {
        ...
        21: 'Aber Wüstentiere werden dort lagern, und Uhus ihre Häuser füllen; und Strauße werden dort wohnen und Böcke dort hüpfen;',
    ...
    19: {
        ...
        6: 'die Kanäle Mazors nehmen ab und versiegen, Rohr und Schilf verwelken.',
    ...
    20: {
        ...
        6: 'Und die Bewohner dieses Küstenlandes werden an jenem Tage sprechen: Siehe, also ist es mit unserer Zuversicht, wohin wir um Hülfe flohen, um vor dem Könige von Assyrien errettet zu werden! und wie sollten wir entrinnen?',
    },
    21: {
        1: 'Ausspruch über die Wüste des Meeres. Wie Stürme, wenn sie im Süden daherfahren, so kommts aus der Wüste, aus furchtbarem Lande.',
        ...
        6: 'Denn also hat der Herr zu mir gesprochen: Gehe hin, stelle einen Wächter auf; was er sieht, soll er berichten.',
        ...
        10: 'Du mein Gedroschenes und Sohn meiner Tenne! Was ich von Jehova der Heerscharen, dem Gott Israels, gehört, habe ich euch verkündigt.',
        11: 'Ausspruch über Duma. Aus Seir ruft man mir zu: Wächter, wie weit ists in der Nacht? Wächter, wie weit in der Nacht?',
        12: 'Der Wächter spricht: Der Morgen kommt, und auch die Nacht. Wollt ihr fragen, so fraget! Kehret wieder, kommet her!',
    ...
    22: {
        ...
        15: 'So sprach der Herr, Jehova der Heerscharen: Auf! gehe zu diesem Verwalter da, zu Schebna, der über das Haus ist, und sprich:',
    ...
    23: {
        1: 'Ausspruch über Tyrus. Heulet, ihr Schiffe von Tarsis! denn sie ist verwüstet, ohne Haus, ohne Eingehenden. Vom Lande der Kittäer her ist es ihnen kundgeworden.',
        ...
        13: 'Siehe, das Land der Chaldäer, dieses Volk, das nicht war, richtet seine Belagerungstürme auf, schleift dessen Paläste, macht es zu einem Trümmerhaufen.',
    ...
    24: {
        1: 'Siehe, Jehova leert das Land aus und verödet es; und er kehrt seine Oberfläche um und zerstreut seine Bewohner.',
        ...
        15: 'Darum gebet Jehova Ehre im Osten, auf den Inseln des Meeres dem Namen Jehovas, des Gottes Israels!',
        16: 'Vom Ende der Erde her hören wir Gesänge: "Herrlichkeit dem Gerechten!" -Da sprach ich: Ich vergehe, ich vergehe, wehe mir! Räuber rauben, und räuberisch raubend rauben sie.',
    ...
    28: {
        1: 'Wehe der stolzen Krone der Trunkenen Ephraims, und der welkenden Blume seiner herrlichen Pracht auf dem Haupte des fetten Tales der vom Weine Überwältigten!',
        ...
        4: 'Und der welkenden Blume seiner herrlichen Pracht auf dem Haupte des fetten Tales ergeht es wie dessen Frühfeige vor der Obsternte: kaum ist sie in der Hand dessen, der sie erblickt, so verschlingt er sie.',
        ...
        7: 'Und auch diese wanken vom Wein und taumeln von starkem Getränk: Priester und Prophet wanken von starkem Getränk, sind übermannt vom Wein, taumeln vom starken Getränk; sie wanken beim Gesicht, schwanken beim Rechtsprechen.',
        8: 'Denn alle Tische sind voll unflätigen Gespeies, daß kein Platz mehr ist.',
        9: 'Wen soll er Erkenntnis lehren, und wem die Botschaft verständlich machen? Den von der Milch Entwöhnten, den von den Brüsten Entfernten?',
        ...
        21: 'Denn Jehova wird sich aufmachen wie bei dem Berge Perazim, wie im Tale zu Gibeon wird er zürnen: um sein Werk zu tun-befremdend ist sein Werk! -und um seine Arbeit zu verrichten, -außergewöhnlich ist seine Arbeit!',
    ...
    31: {
        ...
        5: 'Gleich schwebenden Vögeln, also wird Jehova der Heerscharen Jerusalem beschirmen: beschirmen und erretten, schonen und befreien. -',
    ...
    33: {
        1: 'Wehe dir, Verwüster, und du selbst wurdest nicht verwüstet; und dir, Räuber, und man hat dich nicht beraubt! Sobald du das Verwüsten vollendet hast, wirst du verwüstet werden; sobald du mit dem Rauben fertig bist, wirst du beraubt werden. -',
    ...
    34: {
        ...
        15: 'Dorthin nistet die Pfeilschlange und legt Eier und brütet sie aus in ihrem Schatten; ja, daselbst versammeln sich die Geier, einer zum anderen. -',
        16: 'Forschet nach im Buche Jehovas und leset! Es fehlt nicht eines von diesen, keines vermißt das andere. Denn mein Mund, er hat es geboten; und sein Geist, er hat sie zusammengebracht;',
        17: 'und er selbst hat ihnen das Los geworfen, und seine Hand hat es ihnen zugeteilt mit der Meßschnur. Ewiglich werden sie es besitzen, von Geschlecht zu Geschlecht darin wohnen.',
    },
    35: {
    ...
    36: {
        1: 'Und es geschah im vierzehnten Jahre des Königs Hiskia, da zog Sanherib, der König von Assyrien, herauf wider alle festen Städte Judas und nahm sie ein.',
        ...
        5: 'Ich sage: Nur ein Wort der Lippen ist Rat und Macht zum Kriege. Nun, auf wen vertraust du, daß du dich wider mich empört hast?',
        ...
        8: 'Und nun, laß dich doch ein mit meinem Herrn, dem König von Assyrien; und ich will dir zweitausend Rosse geben, wenn du dir Reiter darauf setzen kannst.',
    ...
    37: {
        ...
        4: 'Vielleicht wird Jehova, dein Gott, die Worte des Rabsake hören, welchen sein Herr, der König von Assyrien, gesandt hat, um den lebendigen Gott zu verhöhnen, und wird die Worte bestrafen, die Jehova, dein Gott, gehört hat. Erhebe denn ein Gebet für den Überrest, der sich noch vorfindet.',
        ...
        9: 'Und er hörte von Tirhaka, dem König von Äthiopien, sagen: Er ist ausgezogen, um wider dich zu streiten. Und als er es hörte, sandte er Boten zu Hiskia und sprach:',
        ...
        17: 'Jehova, neige dein Ohr und höre! Jehova, tue deine Augen auf und sieh! Ja, höre alle die Worte Sanheribs, der gesandt hat, um den lebendigen Gott zu verhöhnen!',
        18: 'Wahrlich, Jehova, die Könige von Assyrien haben alle Nationen und ihr Land verwüstet;',
        19: 'und sie haben ihre Götter ins Feuer geworfen, denn sie waren nicht Götter, sondern ein Werk von Menschenhänden, Holz und Stein, und sie haben sie zerstört.',
        20: 'Und nun, Jehova, unser Gott, rette uns von seiner Hand, damit alle Königreiche der Erde wissen, daß du allein Jehova bist!',
        21: 'Da sandte Jesaja, der Sohn Amoz, zu Hiskia und ließ ihm sagen: So spricht Jehova, der Gott Israels: Was du zu mir gebetet hast wegen Sanheribs, des Königs von Assyrien-',
        22: 'dies ist das Wort, welches Jehova über ihn geredet hat: Es verachtet dich, es spottet deiner die Jungfrau, die Tochter Zion; die Tochter Jerusalem schüttelt das Haupt dir nach.',
        ...
        30: 'Und dies soll dir das Zeichen sein: Man wird in diesem Jahre den Nachwuchs der Ernte essen, und im zweiten Jahre was ausgesproßt ist; und im dritten Jahre säet und erntet, und pflanzet Weinberge und esset ihre Frucht.',
        31: 'Und das Entronnene vom Hause Juda, das übriggeblieben ist, wird wieder wurzeln nach unten und Frucht tragen nach oben.',
        32: 'Denn von Jerusalem wird ein Überrest ausgehen, und ein Entronnenes vom Berge Zion. Der Eifer Jehovas der Heerscharen wird solches tun.',
        33: 'Darum, so spricht Jehova von dem König von Assyrien: Er soll nicht in diese Stadt kommen, und er soll keinen Pfeil darein schießen und keinen Schild ihr zukehren, und er soll keinen Wall gegen sie aufschütten.',
        34: 'Auf dem Wege, den er gekommen ist, auf dem soll er zurückkehren und soll in diese Stadt nicht kommen, spricht Jehova.',
        35: 'Und ich will diese Stadt beschirmen, um sie zu retten, um meinet- und um Davids, meines Knechtes, willen.',
        36: 'Und ein Engel Jehovas zog aus und schlug in dem Lager der Assyrer 185000 Mann. Und als man des Morgens früh aufstand, siehe, da waren sie allesamt Leichname.',
        37: 'Und Sanherib, der König von Assyrien, brach auf, und er zog fort und kehrte zurück und blieb in Ninive.',
        38: 'Und es geschah, als er sich niederbeugte im Hause Nisroks, seines Gottes, da erschlugen ihn Adrammelek und Scharezer, seine Söhne, mit dem Schwerte; und sie entrannen in das Land Ararat. Und Esar-Haddon, sein Sohn, ward König an seiner Statt.',
    },
    38: {
        ...
        10: 'Ich sprach: In der Ruhe meiner Tage soll ich hingehen zu den Pforten des Scheol, bin beraubt des Restes meiner Jahre.',
    ...
    40: {
        ...
        2: 'Redet zum Herzen Jerusalems, und rufet ihr zu, daß ihre Mühsal vollendet, daß ihre Schuld abgetragen ist, daß sie von der Hand Jehovas Zwiefältiges empfangen hat für alle ihre Sünden.',
        ...
        5: 'Und die Herrlichkeit Jehovas wird sich offenbaren, und alles Fleisch miteinander wird sie sehen; denn der Mund Jehovas hat geredet.',
        ...
        15: 'Siehe, Nationen sind geachtet wie ein Tropfen am Eimer und wie ein Sandkorn auf der Waagschale. Siehe, Inseln sind wie ein Stäubchen, das emporschwebt.',
    ...
    41: {
        ...
        19: 'Ich werde Cedern in die Wüste setzen, Akazien und Myrten und Olivenbäume, werde in die Steppe pflanzen Cypressen, Platanen und Scherbincedern miteinander;',
    ...
    42: {
        ...
        2: 'Er wird nicht schreien und nicht erheben noch seine Stimme hören lassen auf der Straße.',
        ...
        10: 'Singet Jehova ein neues Lied, seinen Ruhm vom Ende der Erde: die ihr das Meer befahret, und alles, was es erfüllt, ihr Inseln und ihre Bewohner!',
        ...
        13: 'Jehova wird ausziehen wie ein Held, wie ein Kriegsmann den Eifer anfachen; er wird einen Schlachtruf, ja, ein gellendes Kriegsgeschrei erheben, sich als Held beweisen gegen seine Feinde.',
        14: 'Von lange her habe ich geschwiegen, war still, habe an mich gehalten. Gleich einer Gebärenden will ich tief aufatmen, schnauben und schnaufen zumal.',
        15: 'Ich will Berge und Hügel öde machen und all ihr Kraut vertrocknen lassen; und ich will Ströme zu Inseln machen; und Seen trocken legen.',
        16: 'Und ich will die Blinden auf einem Wege führen, den sie nicht kennen; auf Steigen, die sie nicht kennen, will ich sie schreiten lassen; die Finsternis vor ihnen will ich zum Lichte machen, und das Höckerichte zur Ebene. Das sind die Dinge, die ich tun und nicht unterlassen werde.',
        ...
        22: 'Und doch ist es ein beraubtes und ausgeplündertes Volk; sie sind in Löchern gefesselt allesamt und in Kerkern versteckt; sie sind zur Beute geworden, und kein Erretter ist da, zur Plünderung, und niemand spricht: Gib wieder heraus!',
        ...
        25: 'Da hat er die Glut seines Zornes und die Gewalt des Krieges über ihn ausgegossen; und diese hat ihn ringsum angezündet, aber er ist nicht zur Erkenntnis gekommen; und sie hat ihn in Brand gesteckt, aber er nahm es nicht zu Herzen.',
    },
    43: {
    ...
    45: {
        ...
        18: 'Denn so spricht Jehova, der die Himmel geschaffen, der die Erde gebildet und sie gemacht hat; nicht als eine Öde: Ich bin Jehova, und sonst ist keiner!',
    ...
    47: {
        ...
        8: 'Und nun höre dieses, du Üppige, die in Sicherheit wohnt, die in ihrem Herzen spricht: Ich bins und gar keine sonst! ich werde nicht als Witwe sitzen, noch Kinderlosigkeit kennen.',
        ...
        10: 'Und du vertrautest auf deine Bosheit, du sprachst: Niemand sieht mich. Deine Weisheit und dein Wissen, das hat dich irregeführt; und du sprachst in deinem Herzen: Ich bins, und gar keine sonst!',
    ...
    48: {
        ...
        14: 'Versammelt euch, ihr alle, und höret! Wer unter ihnen hat dieses verkündet? Den Jehova liebt, der wird sein Wohlgefallen vollführen an Babel und seinen Arm an den Chaldäern.',
        15: 'Ich, ich habe geredet, ja, ich habe ihn gerufen; ich habe ihn kommen lassen, und sein Weg wird gelingen.',
        16: 'Nahet euch zu mir, höret dieses! Ich habe vom Anfang an nicht im Verborgenen geredet; von der Zeit an, da es ward, bin ich da. -Und nun hat der Herr, Jehova, mich gesandt und sein Geist. -',
        17: 'So spricht Jehova, dein Erlöser, der Heilige Israels: Ich bin Jehova, dein Gott, der dich lehrt, zu tun, was dir frommt, der dich leitet auf dem Wege, den du gehen sollst.',
    ...
    49: {
        ...
        12: 'Siehe, diese werden von fernher kommen, und siehe, diese von Norden und von Westen, und diese aus dem Lande der Sinim.',
        ...
        20: 'Die Kinder deiner Kinderlosigkeit werden noch vor deinen Ohren sagen: Der Raum ist mir zu enge; mache mir Platz, daß ich wohnen möge.',
    ...
    51: {
        ...
        2: 'Blicket hin auf Abraham, euren Vater, und auf Sarah, die euch geboren hat; denn ich rief ihn, den Einen, und ich segnete ihn und mehrte ihn.',
    ...
    55: {
        ...
        13: 'statt der Dornsträucher werden Cypressen aufschießen, und statt der Brennesseln werden Myrten aufschießen. Und es wird Jehova zum Ruhme, zu einem ewigen Denkzeichen sein, das nicht ausgerottet wird.',
    },
    56: {
    ...
    57: {
        1: 'Der Gerechte kommt um, und niemand nimmt es zu Herzen, und die Frommen werden hinweggerafft, ohne daß jemand es beachtet, daß der Gerechte vor dem Unglück hinweggerafft wird.',
        2: 'Er geht ein zum Frieden; sie ruhen auf ihren Lagerstätten, ein jeder, der in Geradheit gewandelt hat.',
        3: 'Und ihr, nahet hierher, Kinder der Zauberin, Same des Ehebrechers und der Hure!',
        4: 'Über wen machet ihr euch lustig, über wen sperret ihr das Maul auf und strecket die Zunge heraus? Seid ihr nicht Kinder des Abfalls, ein Same der Lüge,',
        5: 'die ihr für die Götzen entbranntet unter jedem grünen Baume, die ihr Kinder in den Tälern schlachtetet unter den Klüften der Felsen?',
        6: 'An den glatten Steinen des Talbaches war dein Teil; sie, sie waren dein Los; auch gossest du ihnen Trankopfer aus, opfertest ihnen Speisopfer. Sollte ich mich darüber trösten?',
        7: 'Auf einem hohen und erhabenen Berge schlugest du dein Lager auf; auch stiegest du dort hinauf, um Schlachtopfer zu opfern.',
        ...
        9: 'Und du zogest mit Öl zu dem König und machtest viel deiner wohlriechenden Salben; und du sandtest deine Boten in die Ferne und erniedrigtest dich bis zum Scheol.',
        10: 'Durch die Weite deines Weges bist du müde geworden, doch du sprachst nicht: Es ist umsonst! Du gewannst neue Kraft, darum bist du nicht erschlafft.',
        11: 'Und vor wem hast du dich gescheut und gefürchtet, daß du gelogen hast, und meiner nicht gedachtest, es nicht zu Herzen nahmst? Habe ich nicht geschwiegen, und zwar seit langer Zeit? und mich fürchtest du nicht.',
        12: 'Ich, ich werde deine Gerechtigkeit kundtun; und deine Machwerke, sie werden dir nichts nützen.',
        13: 'Wenn du schreist, mögen dich deine Götzenhaufen erretten! Aber ein Wind wird sie allesamt entführen, ein Hauch sie hinwegnehmen. Wer aber zu mir seine Zuflucht nimmt, wird das Land erben und meinen heiligen Berg besitzen.',
    ...
    58: {
        ...
        9: 'Dann wirst du rufen, und Jehova wird antworten; du wirst um Hülfe schreien, und er wird sagen: Hier bin ich! Wenn du das Joch, das Fingerausstrecken und unheilvolle Reden aus deiner Mitte hinwegtust,',
    ...
    59: {
        1: 'Siehe, die Hand Jehovas ist nicht zu kurz, um zu retten, und sein Ohr nicht zu schwer, um zu hören;',
    ...
    60: {
        ...
        9: 'Denn auf mich hoffen die Inseln, und die Schiffe von Tarsis ziehen voran, um deine Kinder aus der Ferne zu bringen, und ihr Silber und ihr Gold mit ihnen, zu dem Namen Jehovas, deines Gottes, und zu dem Heiligen Israels, weil er dich herrlich gemacht hat. -',
        ...
        13: 'Die Herrlichkeit des Libanon wird zu dir kommen, Cypresse, Platane und Scherbinceder miteinander, um die Stätte meines Heiligtums zu schmücken; und ich werde herrlich machen die Stätte meiner Füße.',
    ...
    61: {
        ...
        5: 'Und Fremdlinge werden dastehen und eure Herden weiden, und Söhne der Fremde werden eure Ackerleute und eure Weingärtner sein.',
    ...
    63: {
        1: 'Wer ist dieser, der von Edom kommt, von Bozra in hochroten Kleidern, dieser, prächtig in seinem Gewande, der einherzieht in der Größe seiner Kraft? Ich bins, der in Gerechtigkeit redet, der mächtig ist zu retten. -',
    ...
    65: {
        ...
        7: 'eure Missetaten und die Missetaten eurer Väter miteinander, spricht Jehova, die auf den Bergen geräuchert und mich auf den Hügeln verhöhnt haben; und ich werde zuvor ihren Lohn in ihren Busen messen.',
        ...
        9: 'Und ich werde aus Jakob einen Samen hervorgehen lassen, und aus Juda einen Besitzer meiner Berge; und meine Auserwählten sollen es besitzen, und meine Knechte sollen daselbst wohnen.',
        10: 'Und Saron wird zu einer Trift der Schafe, und das Tal Achor zu einem Lagerplatz der Rinder werden, für mein Volk, das mich gesucht hat.',
        11: 'Ihr aber, die ihr Jehova verlasset, die ihr meines heiligen Berges vergesset, die ihr dem Gad einen Tisch zurichtet und der Meni Mischtrank einschenket:',
        12: 'Ich habe euch dem Schwerte bestimmt, und ihr alle werdet zur Schlachtung niedersinken; weil ich gerufen, und ihr nicht geantwortet habt, geredet, und ihr nicht gehört habt, sondern getan, was böse ist in meinen Augen, und das erwählet, woran ich kein Gefallen habe.',
    ...
    66: {
        ...
        10: 'Freuet euch mit Jerusalem und frohlocket über sie, alle, die ihr sie liebet; seid hocherfreut mit ihr, alle, die ihr über sie trauert!',
        11: 'auf daß ihr sauget und euch sättiget an der Brust ihrer Tröstungen, auf daß ihr schlürfet und euch ergötzet an der Fülle ihrer Herrlichkeit.',
        12: 'Denn so spricht Jehova: Siehe, ich wende ihr Frieden zu wie einen Strom, und die Herrlichkeit der Nationen wie einen überflutenden Bach, und ihr werdet saugen; auf den Armen werdet ihr getragen und auf den Knieen geliebkost werden.',
        ...
        18: 'Und ich, ihre Werke und ihre Gedanken sind vor mir. Es kommt die Zeit, alle Nationen und Sprachen zu versammeln; und sie werden kommen und meine Herrlichkeit sehen.',
