...
CHAPTERS = {
    ...
    5: {
        ...
        3: 'Und er wird dastehen und seine Herde weiden in der Kraft Jehovas, in der Hoheit des Namens Jehovas, seines Gottes. Und sie werden wohnen denn nun wird er groß sein bis an die Enden der Erde.',
        ...
        6: 'Und der Überrest Jakobs wird inmitten vieler Völker sein wie ein Tau von Jehova, wie Regenschauer auf das Kraut, der nicht auf Menschen wartet und nicht auf Menschenkinder harrt.',
        ...
        9: 'Und es wird geschehen an jenem Tage, spricht Jehova, da werde ich deine Rosse ausrotten aus deiner Mitte und deine Wagen vernichten.',
