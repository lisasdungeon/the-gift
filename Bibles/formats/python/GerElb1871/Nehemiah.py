...
CHAPTERS = {
    1: {
        ...
        5: 'Ach, Jehova, Gott des Himmels, du, der große und furchtbare Gott, der den Bund und die Güte denen bewahrt, die ihn lieben und seine Gebote beobachten:',
    ...
    2: {
        ...
        3: 'Und ich sprach zu dem König: Der König lebe ewiglich! Warum sollte mein Angesicht nicht traurig sein, da die Stadt, die Begräbnisstätte meiner Väter, wüste liegt, und ihre Tore vom Feuer verzehrt sind?',
        ...
        17: 'Und ich sprach zu ihnen: Ihr sehet das Unglück, in welchem wir sind, daß Jerusalem wüste liegt und seine Tore mit Feuer verbrannt sind. Kommt und laßt uns die Mauer Jerusalems wieder aufbauen, daß wir nicht länger zum Hohne seien!',
    ...
    4: {
        1: 'Und es geschah, als Sanballat hörte, daß wir die Mauer bauten, da wurde er zornig und ärgerte sich sehr. Und er spottete über die Juden',
        2: 'und sprach vor seinen Brüdern und dem Heere von Samaria und sagte: Was machen die ohnmächtigen Juden? Wird man es ihnen zulassen? Werden sie opfern? Werden sie es an diesem Tage vollenden? Werden sie die Steine aus den Schutthaufen wieder beleben, da sie doch verbrannt sind?',
        ...
        16: 'Und es geschah von jenem Tage an, daß die Hälfte meiner Diener an dem Werke arbeitete, während die andere Hälfte die Lanzen und die Schilde und die Bogen und die Panzer hielt; und die Obersten waren hinter dem ganzen Hause Juda,',
        17: 'welches an der Mauer baute. Und die Lastträger luden auf, mit der einen Hand am Werke arbeitend, während die andere die Waffe hielt.',
    ...
    5: {
        ...
        7: 'Und mein Herz pflegte Rats in mir, und ich haderte mit den Edlen und mit den Vorstehern und sprach zu ihnen: Auf Wucher leihet ihr, ein jeder seinem Bruder! Und ich veranstaltete eine große Versammlung gegen sie;',
        8: 'und ich sprach zu ihnen: Wir haben unsere Brüder, die Juden, welche den Nationen verkauft waren, soweit es uns möglich war, losgekauft; und ihr wollt gar eure Brüder verkaufen? Und sie sollen sich uns verkaufen? Da schwiegen sie und fanden keine Antwort.',
        ...
        14: 'Auch von dem Tage an, da er mich bestellt hatte, um ihr Landpfleger zu sein im Lande Juda, vom 20 Jahre bis zum 32 Jahre des Königs Artasasta, zwölf Jahre lang, habe ich mit meinen Brüdern die Speise des Landpflegers nicht gegessen.',
        ...
        17: 'Und die Juden, sowohl die Vorsteher, 150 Mann, als auch die, welche aus den Nationen, die ringsumher wohnten, zu uns kamen, waren an meinem Tische.',
    ...
    6: {
        ...
        6: 'Darin stand geschrieben: Unter den Nationen verlautet, und Gaschmu sagt es, daß ihr, du und die Juden, euch zu empören gedenket; darum bauest du die Mauer; und du wollest, nach diesem Gerücht, ihr König werden;',
        7: 'auch habest du Propheten bestellt, damit sie in Jerusalem über dich ausrufen und sagen: Es ist ein König in Juda! Und nun wird der König diese Gerüchte vernehmen. So komm nun, daß wir uns zusammen beraten.',
        ...
        15: 'Und die Mauer wurde vollendet am 25. des Elul, in 52 Tagen.',
        16: 'Und es geschah, als alle unsere Feinde es hörten, da fürchteten sich alle Nationen, die rings um uns her waren, und sie sanken sehr in ihren Augen; und sie erkannten, daß dieses Werk von unserem Gott aus geschehen war.',
        17: 'Auch ließen in jenen Tagen Edle von Juda viele Briefe an Tobija abgehen, und solche von Tobija kamen an sie.',
        18: 'Denn es gab viele in Juda, die ihm geschworen hatten, denn er war ein Schwiegersohn Schekanjas, des Sohnes Arachs; und sein Sohn Jochanan hatte die Tochter Meschullams, des Sohnes Berekjas, genommen.',
        19: 'Auch redeten sie vor mir von seinen guten Taten und hinterbrachten ihm meine Worte; und Tobija sandte Briefe, um mich in Furcht zu setzen.',
    },
    7: {
        ...
        33: 'die Männer von dem anderen Nebo, 52;',
        ...
        43: 'Die Leviten: die Söhne Jeschuas und Kadmiels, von den Söhnen Hodwas, 74. -',
        ...
        70: 'Und ein Teil der Häupter der Väter gab zum Werke. Der Tirsatha gab für den Schatz: an Gold 1000 Dariken, 50 Sprengschalen, 530 Priesterleibröcke.',
    ...
    8: {
        ...
        9: 'Und Nehemia, das ist der Tirsatha, und Esra, der Priester, der Schriftgelehrte, und die Leviten, welche das Volk belehrten, sprachen zu dem ganzen Volke: Dieser Tag ist Jehova, eurem Gott, heilig; seid nicht traurig und weinet nicht!',
        10: 'Und er sprach zu ihnen: Gehet hin, esset Fettes und trinket Süßes, und sendet Teile denen, für welche nichts zubereitet ist; denn der Tag ist unserem Herrn heilig; und betrübet euch nicht, denn die Freude an Jehova ist eure Stärke.',
        ...
        17: 'Und die ganze Versammlung, die aus der Gefangenschaft zurückgekehrt war, machte Hütten und wohnte in den Hütten. Denn die Kinder Israel hatten nicht also getan seit den Tagen Josuas, des Sohnes Nuns, bis auf jenen Tag. Und es war eine sehr große Freude.',
    ...
    9: {
        1: 'Und am 24. Tage dieses Monats versammelten sich die Kinder Israel unter Fasten, und in Sacktuch gekleidet, und mit Erde auf ihren Häuptern.',
        ...
        25: 'Und sie nahmen feste Städte ein und ein fettes Land, und nahmen Häuser in Besitz, die mit allerlei Gut gefüllt waren, ausgehauene Brunnen, Weinberge und Olivengärten und Obstbäume in Menge. Und sie aßen und wurden satt und fett und ließen sichs wohl sein durch deine große Güte.',
    ...
    11: {
        ...
        13: 'und seine Brüder, Häupter von Vaterhäusern: 242; und Amaschsai, der Sohn Asarels, des Sohnes Achsais, des Sohnes Meschillemoths, des Sohnes Immers,',
