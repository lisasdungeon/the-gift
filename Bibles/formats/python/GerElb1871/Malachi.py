...
CHAPTERS = {
    1: {
        ...
        8: 'Und wenn ihr Blindes darbringet, um es zu opfern, so ist es nichts Böses; und wenn ihr Lahmes und Krankes darbringet, so ist es nichts Böses. Bringe es doch deinem Landpfleger dar: wird er dich wohlgefällig annehmen, oder Rücksicht mit dir haben? spricht Jehova der Heerscharen.',
    ...
    3: {
        ...
        16: 'Da unterredeten sich die Jehova fürchten miteinander, und Jehova merkte auf und hörte; und ein Gedenkbuch ward vor ihm geschrieben für die, welche Jehova fürchten und welche seinen Namen achten.',
