...
CHAPTERS = {
    1: {
        ...
        7: 'Und er predigte und sagte: Es kommt der stärker ist als ich, nach mir, dessen ich nicht würdig bin, ihm gebückt den Riemen seiner Sandalen zu lösen.',
    ...
    2: {
        ...
        26: 'wie er in das Haus Gottes ging unter Abjathar, dem Hohenpriester, und die Schaubrote aß, und auch denen gab, die bei ihm waren?',
    ...
    5: {
        ...
        13: 'Und Jesus erlaubte es ihnen alsbald. Und die unreinen Geister fuhren aus und fuhren in die Schweine, und die Herde stürzte sich den Abhang hinab in den See, und sie ertranken in dem See.',
        ...
        20: 'Und er ging hin und fing an, in der Dekapolis auszurufen, wieviel Jesus an ihm getan hatte; und alle verwunderten sich.',
        ...
        23: 'und er bat ihn sehr und sprach: Mein Töchterlein liegt in den letzten Zügen; ich bitte, daß du kommest und ihr die Hände auflegest, auf daß sie gerettet werde und lebe.',
    ...
    6: {
        ...
        14: 'Und der König Herodes hörte von ihm und sagte: Johannes der Täufer ist aus den Toten auferstanden, und darum wirken solche Kräfte in ihm.',
        ...
        50: 'denn alle sahen ihn und wurden bestürzt. Und alsbald redete er mit ihnen und spricht zu ihnen: Seid gutes Mutes, ich bins; fürchtet euch nicht!',
    ...
    7: {
        ...
        11: 'Ihr aber saget: Wenn ein Mensch zu dem Vater oder zu der Mutter spricht: Korban sei das, was irgend dir von mir zunutze kommen könnte; -',
        ...
        22: 'Dieberei, Habsucht, Bosheit, List, Ausschweifung, böses Auge, Lästerung, Hochmut, Torheit;',
    ...
    8: {
        ...
        30: 'Und er bedrohte sie, daß sie niemandem von ihm sagen sollten.',
    ...
    9: {
        ...
        34: 'Sie aber schwiegen; denn sie hatten sich auf dem Wege untereinander besprochen, wer der Größte sei.',
        35: 'Und nachdem er sich niedergesetzt hatte, rief er die Zwölfe; und er spricht zu ihnen: Wenn jemand der Erste sein will, so soll er der Letzte von allen und aller Diener sein.',
        36: 'Und er nahm ein Kindlein und stellte es in ihre Mitte; und als er es in seine Arme genommen hatte, sprach er zu ihnen:',
        37: 'Wer irgend eines solcher Kindlein aufnehmen wird in meinem Namen, nimmt mich auf; und wer irgend mich aufnehmen wird, nimmt nicht mich auf, sondern den, der mich gesandt hat.',
    ...
    11: {
        ...
        25: 'Und wenn ihr im Gebet dastehet, so vergebet, wenn ihr etwas wider jemanden habt, auf daß auch euer Vater, der in den Himmeln ist, euch eure Übertretungen vergebe.',
        ...
        28: 'und sagen zu ihm: In welchem Recht tust du diese Dinge? Und wer hat dir dieses Recht gegeben, daß du diese Dinge tust?',
    ...
    12: {
        ...
        11: 'von dem Herrn ist dies geschehen, und ist wunderbar in unseren Augen"?',
    ...
    13: {
        ...
        6: 'denn viele werden unter meinem Namen kommen und sagen: Ich bins! -und sie werden viele verführen.',
        ...
        14: 'Wenn ihr aber den Greuel der Verwüstung stehen sehet, wo er nicht sollte, daß alsdann, die in Judäa sind, auf die Berge fliehen,',
    ...
    14: {
        1: 'Es war aber nach zwei Tagen das Passah und das Fest der ungesäuerten Brote. Und die Hohenpriester und die Schriftgelehrten suchten, wie sie ihn mit List griffen und töteten;',
        ...
        35: 'Und er ging ein wenig weiter und fiel auf die Erde; und er betete, daß, wenn es möglich wäre, die Stunde an ihm vorübergehe.',
        ...
        44: 'Der ihn aber überlieferte, hatte ihnen ein Zeichen gegeben und gesagt: Welchen irgend ich küssen werde, der ists; ihn greifet und führet ihn sicher fort.',
        ...
        49: 'Täglich war ich bei euch, lehrend im Tempel, und ihr habt mich nicht gegriffen; -aber auf daß die Schriften erfüllt würden.',
        ...
        55: 'Die Hohenpriester aber und das ganze Synedrium suchten Zeugnis wider Jesum, um ihn zum Tode zu bringen; und sie fanden keines.',
        ...
        62: 'Jesus aber sprach: Ich bins! Und ihr werdet den Sohn des Menschen sitzen sehen zur Rechten der Macht und kommen mit den Wolken des Himmels.',
    ...
    15: {
        ...
        42: 'Und als es schon Abend geworden,',
