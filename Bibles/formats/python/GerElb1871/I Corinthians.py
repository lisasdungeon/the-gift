...
CHAPTERS = {
    ...
    2: {
        ...
        8: 'welche keiner von den Fürsten dieses Zeitlaufs erkannt hat,',
        9: 'sondern wie geschrieben steht: "Was kein Auge gesehen und kein Ohr gehört hat und in keines Menschen Herz gekommen ist, was Gott bereitet hat denen, die ihn lieben";',
        ...
        15: 'der geistliche aber beurteilt alles, er selbst aber wird von niemandem beurteilt;',
    ...
    5: {
        ...
        4: 'im Namen unseres Herrn Jesus Christus',
    ...
    6: {
        ...
        5: 'Zur Beschämung sage ichs euch. Also nicht ein Weiser ist unter euch, auch nicht einer, der zwischen seinen Brüdern zu entscheiden vermag?',
    ...
    7: {
        ...
        11: 'und daß ein Mann sein Weib nicht entlasse.',
    ...
    8: {
        ...
        5: 'Denn wenn es anders solche gibt, die Götter genannt werden, sei es im Himmel oder auf Erden,',
        ...
        13: 'Darum, wenn eine Speise meinem Bruder Ärgernis gibt, so will ich für immer kein Fleisch essen, damit ich meinem Bruder kein Ärgernis gebe.',
    },
    9: {
        ...
        21: 'denen, die ohne Gesetz sind, wie ohne Gesetz, auf daß ich die, welche ohne Gesetz sind, gewinne.',
    ...
    10: {
        ...
        4: 'und alle denselben geistlichen Trank tranken; denn sie tranken aus einem geistlichen Felsen, welcher nachfolgte.',
    ...
    14: {
        ...
        20: 'Brüder, seid nicht Kinder am Verstande, sondern an der Bosheit seid Unmündige, am Verstande aber werdet Erwachsene.',
    ...
    15: {
        ...
        2: 'durch welches ihr auch errettet werdet, es sei denn, daß ihr vergeblich geglaubt habt.',
        ...
        34: 'Werdet rechtschaffen nüchtern und sündiget nicht, denn etliche sind in Unwissenheit über Gott; zur Beschämung sage ichs euch.',
