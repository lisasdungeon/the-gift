...
CHAPTERS = {
    ...
    16: {
        ...
        15: 'Ale úfalas v krásu svou, a smilnilas příčinou pověstí své; nebo jsi páchala smilství s každým mimo tebe jdoucím. Každý snadně užil krásy tvé.',
    ...
    18: {
        ...
        21: 'Pakli by se bezbožný odvrátil ode všech hříchu svých, kteréž činil, a ostříhal by všech ustanovení mých, a činil by soud a spravedlnost, jistě živ bude a neumře.',
    ...
    22: {
        ...
        4: 'Ty krví svou, kterouž jsi prolilo, zavinivši, a ukydanými bohy svými, jichž jsi nadělalo, sebe poškvrnivši, to jsi způsobilo, že se přiblížili dnové tvoji, a přišlo jsi k letům svým. Protož vydám tě v pohanění národům, a ku posměchu všechněm zemím.',
