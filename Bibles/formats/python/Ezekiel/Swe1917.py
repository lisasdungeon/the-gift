...
CHAPTERS = {
    ...
    20: {
        ...
        29: 'Då sade jag till dem: »Vad är detta för en offerhöjd[1], denna som I kommen[2] till?» Därav fick en sådan plats namnet »offerhöjd», såsom man säger ännu i dag.',
        ...
        49: "Och jag sade: »Ack, Herre, HERRE! Dessa säga om mig: 'Denne talar ju gåtor.'» [1] Hebr habbamá. [2] Hebr. habbaím.",
    },
    21: {
        1: 'Och HERRENS ord kom till mig; han sade:',
    ...
    36: {
        ...
        2: 'Så säger Herren, HERREN: Eftersom fienden säger om eder: »Rätt så, de urgamla offerhöjderna hava nu blivit vår besittning»,',
    ...
    37: {
        ...
        9: 'Då sade han till mig: »Profetera och tala till anden, ja, profetera, du människobarn, och säg till anden: Så säger Herren, HERREN: Kom, du ande, från de fyra väderstrecken[1] och blås på dessa dräpta, så att de åter bliva levande.»',
        ...
        28: 'Så skola folken förnimma att jag är HERREN, som helgar Israel, då nu min helgedom förbliver ibland dem evinnerligen. [1] Hebreiskans uttryck för ande betyder ock vind.',
    },
    38: {
        1: 'Och HERRENS ord kom till mig; han sade:',
    ...
    39: {
        ...
        15: 'När så någon av dessa män, som genomvandra landet, på sin färd får se människoben, då skall han sätta upp en vård därbredvid, till dess att dödgrävarna hinna begrava dem i »Gogs larmande hops[1] dal».',
        ...
        29: "och jag skall därefter icke mer fördölja mitt ansikte för dem, ty jag skall utgjuta min Ande över Israels hus, säger Herren, HERREN'. [1] Hebr hamón.",
    },
    40: {
    ...
    41: {
        1: 'Därefter förde han mig till tempelsalen. Och han mätte murpelarna de voro sex alnar breda, var på sin sida -- tabernaklets bredd.',
    ...
    42: {
        1: 'Och han lät mig gå ut på den yttre förgården den väg som gick åt norr, och förde mig därefter till den byggnad med tempelkamrar, som låg invid den avsöndrade platsen och tillika invid murbyggnaden norrut,',
        2: 'till långsidan, som mätte hundra alnar, med sin ingång i norr; men bredden var femtio alnar.',
        3: 'Ut emot den tjugu alnar breda platsen på den inre förgården och ut emot stengolvet på den yttre förgården lågo avsatserna på det ena husets framvägg mitt emot avsatserna på det andra husets framvägg, i tre våningar.',
        4: 'Och framför tempelkamrarna gick en tio alnar bred gång till den inre förgården, en alnsbred väg; och ingångarna lågo mot norr.',
        5: 'Men de översta tempelkamrarna voro mindre än de andra, ty avsatserna på framväggen togo bort mer rum från dem än från de nedersta och mellersta kamrarna i byggnaden.',
        6: 'Ty kamrarna lågo i tre våningar och hade inga pelare, såsom förgårdarna hade; därför blevo de översta våningens kamrar mer indragna än den nedersta och den mellersta våningens.',
        7: 'Och en yttre skiljemur gick utmed tempelkamrarna åt den yttre förgården till, framför tempelkamrarna, och den var femtio alnar lång.',
        8: 'Ty längden på tempelkammarbyggnaden utåt den yttre förgården var femtio alnar, men åt templet till hundra alnar.',
    ...
    48: {
        1: "Och dessa äro namnen på stammarna. Vid norra gränsen längs efter Hetlonsvägen, dit fram där vägen går till Hamat, vidare bort mot Hasar-Enan -- med Damaskus' område jämte Hamat i norr -- där skall Dan hava en lott, så att hela sträckan från östra sidan till västra tillhör honom.",
        2: 'Och närmast Dans område skall Aser hava en lott, från östra sidan till västra.',
        3: 'Och närmast Asers område skall Naftali hava en lott, från östra sidan till västra.',
        4: 'Och närmast Naftalis område skall Manasse hava en lott, från östra sidan till västra.',
        5: 'Och närmast Manasses område skall Efraim hava en lott, från östra sidan till västra.',
        6: 'Och närmast Efraims område skall Ruben hava en lott, från östra sidan till västra.',
        7: 'Och närmast Rubens område skall Juda hava en lott, från östra sidan till västra.',
        8: 'Och närmast Juda område skall från östra sidan till västra sträcka sig det offergärdsområde som I skolen giva såsom gärd, tjugufem tusen alnar i bredd, och i längd lika med en stamlotts längd från östra sidan till västra; och helgedomen skall ligga där i mitten.',
        9: 'Det offergärdsområde som I skolen giva såsom gärd åt HERREN skall vara i längd tjugufem tusen alnar och i bredd tio tusen.',
