...
CHAPTERS = {
    1: {
        1: 'Kolmantenakymmenentenä vuotena, viidentenä päivänä neljännessä kuussa, kuin minä olin vankein seassa Kebarin virran tykönä, aukenivat taivaat ja minä näin Jumalan näyt.',
    ...
    3: {
        ...
        7: 'Mutta Israelin huone ei tahdo sinua kuulla, sillä ei he tahdo kuulla itse minuakaan; sillä koko Israelin huoneella on kova otsa ja paatunut sydän.',
    ...
    4: {
        ...
        2: 'Ja lyö leiri sen ympärille, ja rakenna siihen aita, ja tee siihen valli, ja aseta siihen sotaväki, ja pane sotaaseet sitä vastaan joka taholta.',
        ...
        12: 'Ohraisia leipiä pitää sinun syömän, jotka sinun heidän silmäinsä edessä ihmisen jäljellä kypsentämän pitää.',
        ...
        16: 'Ja hän sanoi minulle: sinä ihmisen lapsi, katso, minä tahdon ottaa pois leivän aineen Jerusalemista, niin että heidän pitää leipää syömän painolla ja murheella, ja juoman vettä määrällä ja surulla.',
    ...
    7: {
        ...
        2: 'Sinä ihmisten lapsi, näin sanoo Herra, Herra, Israelin maasta: loppu tulee; koko neljän maan äären loppu tulee.',
        3: 'Nyt tulee sinun loppus; sillä minä tahdon lähettää minun hirmuisuuteni sinun päälles, ja tuomita sinua, niinkuin sinä ansainnut olet, ja antaa sinulle, mitä kaikkiin sinun kauhistuksiis tulee.',
        4: 'Minun silmäni ei pidä säästämän sinua, eikä armahtaman; mutta minä tahdon antaa sinulle, niinkuin sinä ansainnut olet, ja sinun kauhistukses pitää tuleman sinun sekaas, että teidän tietämän pitää, että minä olen Herra.',
        5: 'Näin sanoo Herra, Herra: katso, yksi onnettomuus tulee toisen jälkeen.',
        6: 'Loppu tulee, loppu tulee; se valvoo sinua vastaan; katso, se tulee.',
        ...
        8: 'Nyt tahdon minä pian vuodattaa minun hirmuisuuteni sinun päälles, ja täyttää vihani sinussa ja tuomita sinun, niinkuin sinä ansainnut olet, ja antaa sinulle, mitä kaikkiin sinun kauhistuksiis tulee.',
        9: 'Minun silmäni ei pidä säästämän sinua eikä armahtaman; minä tahdon antaa sinulle, niinkuin sinä ansainnut olet, ja sinun kauhistukses pitää tuleman sinun sekaas, että teidän tietämän pitää, että minä olen Herra, joka teitä lyön.',
        10: 'Katsos päivää, katso, se tulee; aamu tulee edes, vitsa kukoistaa, ja ylpiä viheriöitsee.',
        11: 'Tyranni on itsensä valmistanut jumalattomain vitsaksi, niin ettei kenkään heitä eli heidän kansaansa taikka heidän joukkoansa pidä valittaman.',
        12: 'Aika tulee, päivä lähestyy, ostaja älköön iloitko, ja myyjä älköön murehtiko; sillä viha tulee kaiken heidän joukkonsa päälle.',
        13: 'Sillä myyjän ei pidä enään myydyn kalunsa tykö palajaman, vaikka he vielä hengissäkin olisivat; sillä ennustus kaikesta heidän paljoudestansa ei pidä käymän takaperin, eikä kenkään taida vahvistaa elämäänsä pahuutensa kautta.',
        14: 'Soittakaat vaskitorveen, ja valmistakaat kaikki; ei kuitenkaan yksikään sotaan ole lähtevä; sillä minun vihani tulee kaiken hänen kansansa päälle.',
        15: 'Ulkona liikkuu miekka, sisällä rutto ja nälkä; se joka kedolla on, hänen pitää miekalla lankeeman, mutta se joka kaupungissa on, hänen pitää ruttoon ja nälkään vaipuman.',
        16: 'Ja jotka heiltä pääsevät pakoon, pitää oleman vuorilla niinkuin kyhkyiset laaksoissa, ja kaikkein pitää valittaman, kukin pahuuttansa.',
        17: 'Kaikki kädet pitää nääntymän, ja kaikki polvet horjuman niinkuin vesi.',
        18: 'Ja heidän pitää itsensä säkkiin puettaman, ja pelko pitää heidät peittämän, ja kaikki kasvot surkiasti katsoman, ja kaikki päät paljaaksi tuleman.',
        19: 'Heidän pitää hopiansa heittämän kaduille, ja heidän kultansa kauvas joutuman; sillä heidän hopiansa ja kultansa ei pidä taitaman auttaa heitä Herran vihan päivänä; ja ei taitaman sieluansa ravita, eikä vatsaansa täyttää; sillä se on ollut heille pahennus, heidän pahoihin töihinsä.',
        20: 'Kalliista kaluistansa, joilla he ylpeilivät, ovat he kauhistustensa ja epäjumalainsa kuvat tehneet; sentähden tahdon minä tehdä heille sen saastaisuudeksi,',
        21: 'Ja antaa sen muukalaisten käsiin, että ne sen ryöväämän pitää, ja jumalattomille maan päällä saaliiksi, että ne sen saastuttavat.',
        22: 'Minä tahdon minun kasvoni kääntää sieltä pois, että he juuri minun majani turmelevat; ja ryövärit pitää tuleman sinne, ja sen saastuttaman.',
        23: 'Tee kahleet; sillä maa on täynnä veren vikoja, ja kaupunki täysi väkivaltaa.',
        24: 'Niin tahdon minä antaa tulla kaikkein pahimmat pakanain seasta, että ne pitää heidän huoneensa omistaman, ja tahdon lopettaa voimallisten ylpeyden, ja heidän pyhänsä pitää saastutetuksi tuleman.',
        25: 'Hävittäjä tulee; niin pitää heidän rauhaa etsimän, ja ei se pidä oleman heillä.',
        26: 'Yksi onnettomuus pitää tuleman toisen jälkeen, yksi sanoma toisen päälle, niin pitää heidän prophetailta näkyä etsimän; mutta siellä ei laki enään ole pappien tykönä, eikä neuvo vanhain tykönä.',
        27: 'Kuninkaan pitää murheessa oleman ja päämiehet surullisissa vaatteissa, ja maassa kansan kädet vapiseman. Minä tahdon niin laittaa itseni heidän kanssansa, kuin he eläneet ovat, ja tuomita heitä, niinkuin he ansainneet ovat: ja heidän pitää tietämän, että minä olen Herra.',
    },
    8: {
    ...
    9: {
        1: 'Ja hän huusi korkialla äänellä minun korvissani ja sanoi: se on jo käsissä, että kaupunki pitää rangaistaman, ja jokaisella on murha-ase kädessänsä.',
        2: 'Ja katso, kuusi miestä tuli ylimmäisen portin tietä, joka pohjan puolessa on, ja jokaisella oli vahingollinen ase kädessänsä. Mutta yksi mies heidän seassansa oli liinavaatteilla vaatetettu, ja kirjoitustaulu hänen vyöllänsä; ja he menivät sisälle, ja astuivat vaskialttarin tykö.',
        3: 'Ja Israelin Jumalan kunnia nousi Kerubimin päältä, jonka päällä hän oli, ja lähestyi huoneen kynnykseen asti, ja huusi sitä miestä, jonka yllä oli liinavaate, ja kirjoitustaulu vyöllä.',
        ...
        5: 'Mutta muille sanoi hän, minun kuulteni: menkäät hänen jälissänsä kaupungin lävitse, ja lyökäät; teidän silmänne ei pidä säästämän, eikä armoa tekemän.',
        6: 'Lyökäät sekä vanhat että nuoret, neitseet, lapset ja vaimot kuoliaaksi; mutta joiden päällä kirjoitus on, ei yhteenkään niihin pidä teidän rupeeman. Ruvetkaat ensin minun Pyhästäni. Ja he rupesivat niistä vanhoista miehistä, jotka huoneen edessä olivat.',
        7: 'Ja hän sanoi heille: saastuttakaat huone, ja täyttäkäät kartanot tapetuilla, menkäät sitte ulos. Ja he menivät ulos ja tappoivat kaupungissa.',
        8: 'Ja kuin he olivat tappaneet heidät, jäin minä vielä, ja lankesin kasvoilleni, huusin ja sanoin: ah Herra, Herra, tahdotkos siis hukuttaa kaikki jääneet Israelissa, ettäs niin vuodatat sinun vihas Jerusalemin päälle?',
        ...
        10: 'Sentähden ei minun silmäni pidä säästämän, enkä minä tahdo armahtaa; mutta minä tahdon antaa heidän päänsä päälle, niinkuin he ansainneet ovat.',
    ...
    10: {
        ...
        2: 'Ja hän sanoi sille miehelle, joka oli liinavaatteissa: mene sisälle ratasten välille Kerubimin aalle, ja ota kätes täyteen tulisia hiiliä, jotka Kerubimin välillä ovat, ja hajoita ne kaupungin päälle; ja hän meni sisälle minun silmäini edessä.',
    ...
    11: {
        1: 'Ja henki nosti minun ylös ja vei minun portin eteen Herran huoneen puoleen, joka itään päin on, ja katso: portissa oli viisikolmattakymmentä miestä. Ja minä näin niiden seassa Jasanian Assurin pojan, ja Pelatian Benajan pojan, kansan päämiehet.',
        2: 'Ja hän sanoi minulle: sinä ihmisen poika, näillä miehillä ovat väärät ajatukset ja vahingolliset neuvot tässä kaupungissa,',
        3: 'Jotka sanovat: ei se vielä niin läsnä ole, rakentakaamme huoneita; tämä on pata, me olemme liha.',
        4: 'Sentähden ennusta sinä heitä vastaan, ennusta, sinä ihmisen poika.',
        5: 'Ja Herran henki lankesi minun päälleni, ja sanoi minulle: sano: näin sanoo Herra: te Israelin huoneesta olette niin puhuneet: minä tiedän kyllä teidän henkenne ajatukset.',
        6: 'Te olette monta tappaneet tässä kaupungissa, ja hänen katunsa täyttäneet tapetuilla.',
        7: 'Sentähden sanoo Herra, Herra näin: ne jotka te siellä tappaneet olette, ne ovat liha, ja tämä on pata; mutta minä tahdon teitä viedä tästä ulos.',
        8: 'Miekan, jota te pelkäätte, annan minä tulla teidän päällenne, sanoo Herra, Herra.',
        9: 'Minä tahdon ajaa teitä sieltä ulos, ja antaa teitä muukalaisten käsiin, ja tehdä teille oikeuden.',
        10: 'Teidän pitää miekalla lankeeman; Israelin maan äärissä minä tahdon tuomita teitä, ja teidän pitää ymmärtämän, että minä olen Herra.',
        11: 'Mutta ei tämä pidä oleman teidän patanne, ettekä te lihana siinä; vaan Israelin maan äärissä tahdon minä tuomita teitä.',
        ...
        13: 'Ja kuin minä näin ennustin, niin Pelatia Benjan poika kuoli. Ja minä lankesin kasvoilleni, ja huusin korkialla äänellä ja sanoin: Voi Herra, Herra, sinä lopetat peräti Israelin jääneet.',
        14: 'Niin tuli Herran sana minulle ja sanoi:',
        15: 'Sinä ihmisen poika, ne ovat sinun veljes, sinun veljes ja lähimmäiset lankos, ja koko Israelin huone, joille Jerusalemin asuvaiset sanoneet ovat: menkäät kauvas Herrasta, maa on meille annettu omaisuudeksi.',
        16: 'Sentähden sano sinä: näin sanoo Herra, Herra: totta minä olen antanut ajaa heitä kauvas pakanain sekaan, ja olen tosin hajoittanut heitä maakuntiin, niin tahdon minä kuitenkin äkisti olla heidän pyhityksensä niissä maakunnissa, joihinka he joutuneet ovat.',
        ...
        18: 'Sinne pitää heidän tuleman ja ottaman sieltä ulos kaiken hänen saastaisuutensa ja kaikki hänen kauhistuksensa.',
        19: 'Ja minä tahdon antaa heille yhden sydämen, ja antaa teihin uuden hengen, ja tahdon ottaa pois kivisen sydämen heidän lihastansa, ja antaa heille lihaisen sydämen;',
        20: 'Että heidän pitää vaeltaman minun säädyissäni, ja pitämän minun oikeuteni, ja tekemän sen jälkeen; ja heidän pitää oleman minun kanssani, ja minä tahdon olla heidän Jumalansa.',
        21: 'Mutta niille, jotka vaeltavat sydämensä kauhistuksen ja hirmuisuuden jälkeen, niille minä tahdon panna heidän tekonsa heidän päänsä päälle, sanoo Herra, Herra.',
        ...
        24: 'Ja henki otti minun, ja johdatti minun näyssä ja Jumalan hengessä Kaldean maalle vankien tykö; ja se näky, jonka minä näin, katosi minun edestäni.',
        25: 'Ja minä sanoin vangeille kaikki Herran sanat, jotka hän minulle osoittanut oli.',
    },
    12: {
    ...
    13: {
        ...
        7: 'Eikö teidän näkynne ole turha, ja teidän ennustuksenne kaikki tyynni valhe? Te sanotte: Herra on sen sanonut, ja en minä kuitenkaan ole sitä sanonut.',
        ...
        11: 'Sanos niille, jotka sekoittamattomalla kalkilla sivuvat, että sen pitää putooman; sillä iso sade on tuleva, ja suuret rakeet lankeevat, ja tuulispää sitä syöksemän.',
    ...
    14: {
        ...
        4: 'Sentähden puhuttele heitä ja sano heille: näitä sanoo Herra, Herra: kuka ihminen Israelin huoneesta riippuu sydämellänsä epäjumalissansa, ja pysyy lujana vääryytensä pahennuksessa, ja tulee prophetan tykö, niin tahdon minä Herra vastata häntä, niinkuin hän ansainnut on suurella epäjumalan palveluksellansa,',
    ...
    15: {
        ...
        8: 'Ja teen maakunnan kylmille, että he ovat pilkanneet minua, sanoo Herra, Herra.',
    },
    16: {
        1: 'Ja Herran sana tapahtui minulle ja sanoi:',
    ...
    20: {
        ...
        39: 'Sentähden te, Israelin huone, näin sanoo Herra, Herra: ettette kuitenkaan tahdo kuulla minua, niin tehkäät niinkuin teille kelpaa, ja jokainen teitä palvelkaan epäjumalaansa tästäkin lähin; mutta minun pyhä nimeni antakaat tästedes pilkkaamatta olla teidän uhreissanne ja epäjumalissanne.',
        ...
        43: 'Siellä pitää teidän muistaman teidän menonne ja kaikki teidän tekonne, joilla te itsenne saastuttaneet olette, ja teidän pitää suuttuman itseenne kaiken teidän pahuutenne tähden, jonka te tehneet olette.',
    ...
    21: {
        ...
        22: 'Niin pitää arpa lankeeman hänen oikialle puolellensa Jerusalemia päin, ja hän antaa sinne viedä sotaaseita, ja läven (muuriin) avata, murhaamaan, suurella äänellä huutamaan, panemaan sota-aseita porttien eteen, tekemään saartoa ja rakentamaan multaseiniä.',
    ...
    23: {
        ...
        44: 'Sillä hänen tykönsä mennään niinkuin huoran tykö; juuri niin mennään Oholan ja Oholiban, hävyttömäin vaimoin tykö.',
    ...
    27: {
        ...
        24: 'Kaikki nämät kaupitsivat sinulle kalliita vaatteita, silkkiä ja neulotuita hameita, jotka he kalliissa sederarkuissa hyvin tallella pantuna toivat sinun markkinoilles.',
    ...
    29: {
        ...
        6: 'Ja kaikki, jotka Egyptissä asuvat, pitää ymmärtämän, että minä olen Herra, että he Israelin huoneelle ruokosauvana olivat.',
    ...
    32: {
        ...
        24: 'Siinä myös makaa Elam koko joukkonsa kanssa ympäristölle haudattu, jotka kaikki tapetut ja miekalla kaatuneet ovat, ja menneet alas niinkuin ympärileikkaamattomat maan alle, joita myös koko maailma pelkäsi, ja heidän täytyy häpiänsä kantaa niiden kanssa, jotka kuoppaan alas menevät.',
    ...
    33: {
        ...
        13: 'Kuin minä hurskaalle sanon: hänen pitää totisesti elämän, ja hän luottaa vanhurskauteensa, ja tekee pahaa; niin ei pidä hänen vanhurskauttansa ensinkään muistettaman, mutta hänen pitää kuoleman pahuudessansa, jonka hän tekee.',
        ...
        21: 'Ja tapahtui toisena vuotena toistakymmentä meidän vankiudestamme, viidentenä päivänä kymmenennessä kuukaudessa, että minun tyköni tuli yksi paennut Jerusalemista, ja sanoi: kaupunki lyötiin.',
        ...
        25: 'Sano siis heille: näin sanoo Herra, Herra: te olette verta syöneet, ja nostaneet teidän silmänne epäjumalain tykö, ja olette verta vuodattaneet, ja te luulette, että te omistatte maan?',
    ...
    36: {
        ...
        23: 'Sillä minä tahdon pyhittää minun suuren nimeni, joka teiltä pakanain seassa suuresti häväisty on, ja pakanain pitää ymmärtämän minun olevan Herran, sanoo Herra, Herra, koska minä itseni osoitan teissä heidän edessänsä, että minä olen pyhä.',
    ...
    37: {
        ...
        22: 'Ja teen kaikki yhdeksi kansaksi maalla, Israelin vuorilla; ja heillä kaikilla pitää oleman yksi kuningas, ja ei pidä enään kaksi kansaa eli kahteen valtakuntaan jaetut oleman.',
    ...
    39: {
        ...
        8: 'Katso, jos se on parhaallansa tullut ja tapahtunut, sanoo Herra, Herra: se on se päivä, josta minä olen puhunut.',
        ...
        13: 'Ja kaikella maakunnan kansalla pitää tekemistä oleman heidän hautaamisessansa, ja pitää saaman siitä kuuluisan nimen; että minä sinä päivänä kunnioitetuksi tulen, sanoo Herra, Herra.',
    ...
    40: {
        ...
        48: 'Ja hän vei minun templin esihuoneesen ja mittasi esihuoneen oven päällisen, viisi kyynärää kummallekin puolelle, ja portin leveyden kolme kyynärää molemmin puolin.',
    ...
    41: {
        ...
        2: 'Ja ovi oli kymmenen kyynärää leveä, mutta kukin seinä molemmin puolin ovea viisi kyynärää leveä. Ja hän mittasi sian templissä, se oli neljäkymmentä kyynärää pituudelle ja kaksi kymmentä kyynärää leveydelle.',
    ...
    42: {
        ...
        19: 'Ja kuin hän tuli länteen päin, mittasi hän myös viisisataa riukumittaa sillä mittariuvulla.',
    ...
    43: {
        ...
        18: 'Ja hän sanoi minulle: sinä ihmisen poika, näin sanoo Herra, Herra: nämät pitää oleman alttarin säädyt, kuin se tehdään, että uhrattaisiin siinä polttouhria, ja priiskotettaisiin verta sen päälle.',
    ...
    44: {
        ...
        7: 'Että te annatte muukalaisia, joilla on ympärileikkaamatoin liha, tulla minun pyhääni, jolla te minun huoneeni saastutatte, uhratessanne minun leipääni, lihavuutta ja verta, ja näin rikotte kaikki minun liittoni kaikilla teidän kauhistuksillanne.',
        ...
        10: 'Ja ei myös ne Leviläiset, jotka minusta luopuneet, ja Israelin kanssa epäjumalainsa jälkeen erhetykseen menneet ovat; sentähden pitää heidän kantaman omat syntinsä.',
    ...
    46: {
        ...
        6: 'Mutta uudella kuulla pitää uhrattaman nuori virheetöin härkä, ja kuusi karitsaa, ja virheetöin oinas.',
    ...
    48: {
        ...
        13: 'Mutta Leviläisillä pitää myös osa oleman, viisikolmattakymmentä tuhatta leveä, pappein rajan tykönä; sillä kaikki pituus pitää oleman viisikolmattakymmentä tuhatta riukua ja leveys kymmenentuhatta riukua.',
