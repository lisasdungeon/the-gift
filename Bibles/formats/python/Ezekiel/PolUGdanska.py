...
CHAPTERS = {
    ...
    6: {
        ...
        3: 'I mów: Góry Izraela, słuchajcie słowa Pana Boga. Tak mówi Pan Bóg do gór i pagórków, do strumieni i dolin: Oto ja, właśnie ja sprowadzę na was miecz i zniszczę wasze wyżyny.',
        ...
        11: 'Tak mówi Pan Bóg: Klaśnij swą dłonią, tupnij swą nogą i mów: Biada z powodu wszystkich złych obrzydliwości domu Izraela! Padną bowiem od miecza, od głodu i od zarazy.',
        12: 'Ten, co będzie daleko, umrze od zarazy, ten, co blisko, polegnie od miecza, a ten, co pozostanie i będzie oblężony, umrze od głodu. Tak dopełnię na nich swej zapalczywości.',
        13: 'Wtedy poznacie, że ja jestem Panem, gdy ich pobici będą leżeli wśród ich bożków i dokoła ich ołtarzy, na każdym wysokim pagórku, po wszystkich szczytach górskich, pod każdym drzewem zielonym i pod każdym rozłożystym dębem, gdzie składali miłą woń wszystkim swoim bożkom.',
        14: 'Wyciągnę swoją rękę przeciwko nim i uczynię tę ziemię spustoszoną, bardziej spustoszoną od pustyni Diblat, wszędzie, gdzie mieszkają. I tak poznają, że ja jestem Panem.',
    },
    7: {
    ...
    8: {
        ...
        4: 'A oto była tam chwała Boga Izraela, podobna to tej, którą widziałem na równinie.',
    ...
    12: {
        ...
        13: 'Rozciągnę bowiem nad nim swoją sieć i zostanie schwytany w moje sidła. Zaprowadzę go do Babilonu, do ziemi Chaldejczyków, lecz jej nie zobaczy, a tam umrze.',
        14: 'A wszystkich, którzy go otaczają, by mu pomóc, i wszystkie jego oddziały rozproszę na wszystkie wiatry i miecz na nich dobędę.',
        15: 'I poznają, że ja jestem Panem, gdy ich rozproszę między narody i rozrzucę po krajach.',
        ...
        22: 'Synu człowieczy, cóż to jest za przysłowie u was o ziemi Izraela, które brzmi: Dłużą się dni, a każde widzenie zawodzi?',
        23: 'Dlatego mów do nich: Tak mówi Pan Bóg: Sprawię, że to przysłowie ustanie i nie będą go więcej powtarzać w Izraelu. Powiedz im: Zbliżają się te dni i spełnienie wszelkiego widzenia.',
        24: 'Nie będzie już bowiem żadnego marnego widzenia ani pochlebnej wróżby pośród domu Izraela;',
        25: 'Gdyż ja, Pan, będę mówić, a słowo, które wypowiem, spełni się i nie ulegnie więcej opóźnieniu. Za waszych dni, domu buntowniczy, wypowiem słowo i wypełnię je, mówi Pan Bóg.',
        26: 'I doszło do mnie słowo Pana mówiące:',
        27: 'Synu człowieczy, oto dom Izraela mówi: To widzenie, które on ma, odnosi się do dni odległych, on prorokuje o czasach dalekich.',
    ...
    15: {
        ...
        2: 'Synu człowieczy, w czym jest lepsze drzewo winogronowe od wszelkiego innego drzewa albo od latorośli, która jest wśród drzew leśnych?',
        ...
        7: 'Zwrócę bowiem swoją twarz przeciwko nim; z jednego ognia wyjdą, a drugi ogień ich strawi. I poznacie, że ja jestem Panem, gdy zwrócę swoją twarz przeciwko nim.',
    ...
    19: {
        ...
        3: 'A gdy odchowała jedno ze swoich szczeniąt, stało się młodym lwem, który się nauczył chwytać łup; pożerał też ludzi.',
        4: 'Narody o nim usłyszały, został schwytany w ich dół i zaprowadzony w łańcuchach do ziemi Egiptu.',
        5: 'Gdy lwica zobaczyła, że daremnie czeka i że jej nadzieja przepadła, wzięła inne ze swoich szczeniąt i uczyniła je młodym lwem;',
        ...
        8: 'Wtedy zebrały się przeciwko niemu narody z okolicznych krain i zarzuciły na niego swoją sieć. Został schwytany w ich dół.',
        9: 'I wsadziły go do klatki w łańcuchach, i przyprowadziły do króla Babilonu. Wprowadziły go do ciężkiego więzienia, aby jego głos nie był więcej słyszany na górach Izraela.',
        ...
        14: 'Nadto ogień wyszedł z rózgi jej gałęzi i pochłonął jej owoc tak, że nie ma na niej potężnej rózgi na berła dla panującego. Jest to lament i będzie to lamentem.',
    },
    20: {
        ...
        6: 'Tego dnia podniosłem ku nim swoją rękę, że wyprowadzę ich z ziemi Egiptu do ziemi, którą im wyszukałem, opływającej mlekiem i miodem, która jest ozdobą wszystkich ziem.',
        7: 'I powiedziałem im: Niech każdy z was porzuci obrzydliwości sprzed swych oczu, a nie kalajcie się bożkami Egiptu. Ja jestem Panem, waszym Bogiem.',
        ...
        9: 'Działałem ze względu na moje imię, aby nie było zbezczeszczone na oczach tych narodów, wśród których byli i przed których oczami dałem się im poznać, wyprowadzając ich z ziemi Egiptu.',
        ...
        12: 'Ponadto dałem im moje szabaty, aby były znakiem między mną a nimi, aby wiedzieli, że ja jestem Panem, który ich uświęca.',
        ...
        15: 'Ponadto podniosłem ku nim swą rękę na tej pustyni, że nie wprowadzę ich do ziemi, którą im dałem, opływającej mlekiem i miodem, która jest ozdobą wszystkich ziem;',
        ...
        23: 'Podniosłem ku nim moją rękę na pustyni, że ich rozproszę pomiędzy poganami i rozrzucę po ziemiach;',
        ...
        29: 'I zapytałem ich: Cóż to za wyżyna, do której wy chodzicie? A nazywa się ją Bamah aż do dziś.',
        ...
        37: 'I przeprowadzę was pod rózgą, i wprowadzę was w związek przymierza.',
        ...
        39: 'Wy więc, domu Izraela, tak mówi Pan Bóg: Idźcie i służcie, każdy swoim bożkom, nawet i w przyszłości, ponieważ mnie nie słuchacie; ale już więcej nie kalajcie mego świętego imienia waszymi darami i waszymi bożkami.',
        40: 'Na mojej świętej górze bowiem, na wysokiej górze Izraela, mówi Pan Bóg, tam cały dom Izraela będzie mi służyć, wszyscy, którzy będą w tej ziemi. Tam ich przyjmę i tam będę żądał waszych ofiar, waszych ofiar z pierwocin wraz ze wszystkimi waszymi świętymi rzeczami.',
        ...
        42: 'I poznacie, że ja jestem Panem, gdy was wprowadzę do ziemi Izraela, do tej ziemi, co do której podniosłem swoją rękę, że dam ją waszym ojcom.',
        43: 'Tam wspomnicie o waszych drogach i o wszystkich waszych czynach, którymi się splugawiliście; i obrzydzicie sobie siebie samych za wszystkie wasze złe czyny, które popełniliście.',
    ...
    23: {
        ...
        4: 'A ich imiona: starsza Ohola, a jej siostra – Oholiba. One były moje i urodziły synów i córki. Ich imiona: Samaria to Ohola, a Jerozolima to Oholiba.',
        ...
        9: 'Dlatego wydałem ją w ręce jej kochanków, w ręce Asyryjczyków, do których pałała namiętnością.',
        ...
        16: 'Pałała do nich namiętnością, jak tylko spojrzała na nich swymi oczami, i wyprawiła do nich posłańców, do Chaldei.',
        ...
        18: 'I gdy ujawniła swoje czyny nierządne i odsłoniła swoją nagość, moja dusza odwróciła się od niej, tak jak odwróciła się moja dusza od jej siostry.',
        ...
        22: 'Dlatego, Oholibo, tak mówi Pan Bóg: Oto pobudzę przeciwko tobie twoich kochanków, tych, od których odwróciła się twoja dusza, i sprowadzę ich zewsząd przeciwko tobie;',
        23: 'Babilończyków, wszystkich Chaldejczyków, Pekod, Szoa, Koa, a z nimi wszystkich Asyryjczyków. Oni wszyscy to powabni młodzieńcy, dowódcy i rządcy, dostojnicy i zacni ludzie, wszyscy jeżdżący na koniach.',
        ...
        26: 'I zdejmą z ciebie twoje szaty, i zabiorą ci twoje piękne klejnoty.',
        ...
        28: 'Tak bowiem mówi Pan Bóg: Oto wydam cię w ręce tych, których nienawidzisz, w ręce tych, od których odwróciła się twoja dusza.',
        ...
        31: 'Chodziłaś drogą swojej siostry, dlatego dam jej kielich w twoją rękę.',
        ...
        34: 'Wypijesz go i wychylisz do dna, potem go rozbijesz na kawałki, a swoje piersi poobrywasz. Ja bowiem to powiedziałem, mówi Pan Bóg.',
        35: 'Dlatego tak mówi Pan Bóg: Ponieważ zapomniałaś o mnie i rzuciłaś mnie za swoje plecy, ty także znoś swoją rozwiązłość i swój nierząd.',
        36: 'I Pan powiedział do mnie: Synu człowieczy, czy będziesz sądził Oholę i Oholibę? Uświadom im ich obrzydliwości;',
        37: 'Że cudzołożyły i krew jest na ich rękach; z bożkami cudzołożyły, także swych synów, których mi urodziły, przeprowadziły przez ogień, by byli strawieni.',
        38: 'I jeszcze to mi uczyniły, że moją świątynię splugawiły w tym samym dniu i zbezcześciły moje szabaty.',
        39: 'Gdy bowiem zabiły swoje dzieci dla swoich bożków, wchodziły do mojej świątyni w tym samym dniu, aby ją zbezcześcić; oto tak czyniły wewnątrz mego domu.',
        40: 'Ponadto posyłały po mężczyzn, aby przyszli z daleka; wysłano więc posłańca, a oni przyszli. Dla nich się myłaś, barwiłaś swoje oczy i stroiłaś się w ozdoby;',
        41: 'Siadałaś na wspaniałym łożu, przed którym był przygotowany stół i na którym kładłaś moje kadzidło i mój olejek.',
        ...
        47: 'I ta gromada ukamienuje je, i rozsiecze swymi mieczami, zabije ich synów i córki, a ich domy spali ogniem.',
        48: 'Tak usunę rozwiązłość z tej ziemi, aby wszystkie kobiety otrzymały ostrzeżenie i nie czyniły według waszej rozwiązłości.',
    ...
    30: {
        ...
        3: 'Bliski bowiem jest dzień, bliski jest dzień Pana; będzie to dzień pochmurny i czas pogan.',
        ...
        7: 'I będą spustoszeni wśród spustoszonych ziem, a ich miasta znajdą się wśród zburzonych miast.',
        ...
        12: 'Wysuszę rzeki i sprzedam ziemię w ręce niegodziwych. Ręką cudzoziemców spustoszę ziemię wraz ze wszystkim, co ją napełnia. Ja, Pan, to powiedziałem.',
        13: 'Tak mówi Pan Bóg: Zniszczę bożki i usunę posągi z Nof, i nie będzie już księcia w ziemi Egiptu. Ześlę strach na ziemię Egiptu.',
        14: 'Spustoszę Patros, rozniecę ogień w Soan i wykonam sąd w No.',
        ...
        18: 'W Tachpanches dzień ogarną ciemności, gdy złamię tam jarzma Egiptu, i ustanie w nim pycha jego mocy. Okryje go chmura i jego córki pójdą do niewoli.',
        ...
        23: 'I rozproszę Egipcjan między narodami, i rozrzucę ich po ziemiach.',
        ...
        25: 'Wzmocnię – mówię – ramiona króla Babilonu, a ramiona faraona upadną; i poznają, że ja jestem Panem, gdy włożę swój miecz w ręce króla Babilonu, aby go wyciągnął na ziemię Egiptu.',
    ...
    31: {
        ...
        3: 'Oto Assur był jak cedr na Libanie, o pięknych gałęziach i szeroko rzucającym cieniu, o wysokim wzroście, a jego wierzchołek był wśród gęstych gałęzi.',
        4: 'Wody dodały mu wzrostu i głębiny go wywyższyły, ich rzeki roztoczyły dokoła jego korzeń i puściły swoje strumienie ku wszystkim drzewom polnym.',
        ...
        8: 'Cedry w ogrodzie Bożym nie przewyższały go. Cyprysy nie były podobne do jego gałęzi i drzewa kasztanowe nie były podobne do jego konarów. Żadne drzewo w ogrodzie Bożym nie dorównało mu swoją pięknością.',
        ...
        13: 'Na jego powalonym pniu osiądzie wszelkie ptactwo niebieskie i na jego gałęziach będzie wszelki zwierz polny;',
        ...
        16: 'Na huk jego upadku zadrżały narody, gdy go wrzucałem do piekła z tymi, co do dołu zstępują. Wszystkie drzewa Edenu, najwyborniejsze i najlepsze z Libanu, które piją wodę, doznają pociechy w najgłębszych stronach ziemi.',
        ...
        18: 'Do kogo byłeś podobny chwałą i wielkością między drzewami Edenu? Oto zostaniesz zrzucony wraz z drzewami Edenu do najgłębszych stron ziemi. Będziesz leżał wśród nieobrzezanych wraz z pobitymi mieczem. To jest z faraonem i całą jego rzeszą – mówi Pan Bóg.',
    },
    32: {
        ...
        21: 'Najmocniejsi z mocarzy będą do niego mówić spośród piekła wraz z jego pomocnikami. Zstąpili tam, leżą z nieobrzezanymi pobitymi mieczem.',
    ...
    33: {
        ...
        28: 'I wydam ziemię na wielkie spustoszenie, i ustanie pycha jej mocy; spustoszeją góry Izraela i nikt przez nie będzie przechodził.',
    ...
    42: {
        1: 'I wyprowadził mnie na dziedziniec zewnętrzny w kierunku północy, i wprowadził mnie do tych komórek, które stały naprzeciwko obszaru wyznaczonego i naprzeciwko budowli, od strony północy.',
        ...
        13: 'Wtedy powiedział do mnie: Komórki północne i komórki południowe, które są przed obszarem wyznaczonym, to komórki święte, gdzie kapłani, którzy zbliżają się do Pana, będą jadali najświętsze rzeczy. Tam będą kłaść rzeczy najświętsze, ofiary z pokarmów, ofiary za grzech i ofiary za przewinienie. Jest to bowiem miejsce święte.',
    ...
    44: {
        ...
        3: 'Jest dla księcia. Jedynie książę będzie zasiadać w niej, aby jeść chleb przed Panem. Będzie wchodził przez przedsionek tej bramy i tą samą drogą będzie wychodził.',
        4: 'Następnie zaprowadził mnie przez bramę północną do przedniej strony domu. I spojrzałem, a oto chwała Pana napełniła dom Pana. I upadłem na twarz.',
        ...
        6: 'I powiedz buntownikom, domowi Izraela: Tak mówi Pan Bóg: Dosyć już wszystkich waszych obrzydliwości, domu Izraela!',
        7: 'Wprowadziliście tu cudzoziemców nieobrzezanych na sercu i nieobrzezanych na ciele, aby przebywali w mojej świątyni i zbezcześcili mój dom, gdy ofiarowaliście mój chleb, tłuszcz i krew, a oni łamali moje przymierze przez wszystkie wasze obrzydliwości.',
        ...
        9: 'Tak mówi Pan Bóg: Żaden cudzoziemiec nieobrzezany na sercu i nieobrzezany na ciele nie wejdzie do mojej świątyni, żaden spośród cudzoziemców, którzy są wśród synów Izraela.',
        ...
        12: 'Ponieważ służyli im przed ich bożkami i byli dla domu Izraela przyczyną upadku w nieprawość, podniosłem rękę przeciwko nim, mówi Pan Bóg, i obciążą się swoją nieprawością.',
        13: 'Nie będą się zbliżać do mnie, aby sprawować mi urząd kapłański, i nie będą zbliżać się do moich świętych rzeczy ani do najświętszych, ale poniosą swoją hańbę i obrzydliwości, które popełnili.',
        14: 'Dlatego ustanowię ich stróżami porządku domu do każdej posługi i do wszystkiego, co będzie w nim wykonywane.',
        15: 'Lecz kapłani, Lewici, synowie Sadoka, którzy pełnili straż w mojej świątyni, gdy synowie Izraela odeszli ode mnie, oni zbliżą się do mnie, aby mi służyć, i staną przede mną, aby mi ofiarować tłuszcz i krew, mówi Pan Bóg.',
        16: 'Oni będą wchodzić do mojej świątyni i będą przystępować do mego stołu, aby mi służyć i pełnić moją służbę.',
        17: 'A gdy będą mieli wchodzić przez bramę dziedzińca wewnętrznego, ubiorą się w lniane szaty. Nie włożą na siebie nic wełnianego, gdy będą pełnić służbę w bramach dziedzińca wewnętrznego i wewnątrz.',
        18: 'Lniane mitry będą mieli na swej głowie i lniane spodnie na swych biodrach; nie będą się opasywać niczym, co wywołuje pot.',
        19: 'A gdy będą wychodzić na dziedziniec zewnętrzny, do ludu na dziedzińcu zewnętrznym, zdejmą z siebie swoje szaty, w których pełnili służbę, a złożą je w komorach świątyni i ubiorą się w inne szaty; nie będą uświęcali ludu swoimi szatami.',
        ...
        22: 'Nie będą brali sobie za żonę ani wdowy, ani porzuconej, ale wezmą sobie dziewicę z potomstwa domu Izraela lub wdowę, która została wdową po kapłanie.',
        23: 'Będą uczyć mój lud różnicy pomiędzy tym, co święte, a tym, co nieświęte, a także mają uczyć rozróżniać pomiędzy tym, co nieczyste, a tym, co czyste.',
        24: 'A gdy będzie jakiś spór, oni staną, aby sądzić, i będą sądzić według moich sądów. Będą przestrzegali moich praw i moich ustaw we wszystkie moje uroczyste święta i będą święcili moje szabaty.',
        ...
        28: 'To będzie ich dziedzictwo: Ja jestem ich dziedzictwem. Nie będzie się im dawać posiadłości w Izraelu. Ja jestem ich posiadłością.',
        ...
        30: 'I to, co najlepsze ze wszystkich pierwocin wszystkiego, i każda ofiara podniesiona ze wszystkich rzeczy, wszystkie wasze ofiary będą należeć do kapłana. To, co najlepsze z waszych ciast, również dacie kapłanowi, aby sprawił, że błogosławieństwo spocznie na twoim domu.',
    ...
    45: {
        ...
        7: 'Dla księcia będzie obszar z obu stron działu świętej ofiary i własności miasta, przed działem świętej ofiary i przed własnością miasta, od strony zachodniej ku zachodowi i od strony wschodniej ku wschodowi, a długość będzie naprzeciwko każdego z tych działów od granicy zachodniej aż do granicy wschodniej.',
        ...
        14: 'Ustawa dotycząca oliwy jest taka: bat jest miarą oliwy. Będziecie dawać dziesiątą część bat z kor, czyli chomer z dziesięciu bat, bo dziesięć bat stanowi chomer.',
    ...
    46: {
        ...
        17: 'Ale jeśli przekaże dar ze swego dziedzictwa któremuś ze swoich sług, wtedy będzie to jego aż do roku wyzwolenia, a potem wróci do tego księcia. Ale do synów będzie należeć jego dziedzictwo.',
        18: 'Książę nie będzie brał z dziedzictwa ludu, pozbawiając go siłą jego posiadłości. Lecz ze swojej posiadłości da dziedzictwo swoim synom, aby nikt z mojego ludu nie był wyrzucony ze swojej posiadłości.',
        ...
        20: 'I powiedział do mnie: To jest miejsce, gdzie kapłani będą gotować ofiarę za przewinienie i ofiarę za grzech, gdzie będą piec ofiarę z pokarmów, aby nie musieli wynosić ich na dziedziniec zewnętrzny na uświęcanie ludu.',
        ...
        24: 'I powiedział mi: To są miejsca dla tych, którzy gotują, gdzie słudzy domu będą gotować ofiary ludu.',
    },
    47: {
