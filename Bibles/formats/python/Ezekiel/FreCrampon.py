...
CHAPTERS = {
    1: {
        ...
        28: "Comme l'aspect de l'arc qui est dans la nuée en un jour de pluie, tel était l'aspect de l'éclat tout autour de lui. Tel était l'aspect de la ressemblance de la gloire de Yahweh. A cette vue, je tombai sur ma face, et j'entendis la voix de quelqu'un qui parlait.",
    },
    2: {
    ...
    16: {
        ...
        3: "et dis: Ainsi parle le Seigneur Yahweh, à Jérusalem: Par ton origine et ta naissance, tu es de la terre du Chananéen; ton père était l'Amorrhéen et ta mère une Héthéenne.",
        ...
        5: "Aucun œil n'eut pitié du toi pour te rendre un seul de ces soins, par compassion pour toi; mais on te jeta, par dégoût de toi, sur la face des champs, le jour de ta naissance.",
        ...
        41: 'Ils brûleront tes maisons par le feu et ils exécuteront contre toi des jugements, sous les yeux de beaucoup de femmes; je ferai cesser tes prostitutions, et tu ne feras plus de présents.',
        ...
        48: "Je suis vivant, — oracle du Seigneur Yahweh: Sodome, ta sœur, elle et ses filles, n'ont pas fait ce que tu as fait, toi, et tes filles.",
        49: "Voici quel fut le crime de Sodome, ta sœur: l'orgueil, l'abondance et l'insouciant repos où elle vivait avec ses filles, et elle ne soutenait pas la main du malheureux et de l'indigent.",
        ...
        52: "Porte donc, toi aussi, ton opprobre, que tu rejetais sur tes sœurs, à cause de tes péchés par lesquels tu t'es rendue plus abominable qu'elles; elles sont plus justes que toi. Toi aussi, sois couverte de confusion et porte ton opprobre, puisque tu as justifié tes sœurs.",
    ...
    21: {
        ...
        3: "et dis à la forêt du midi: Ecoute la parole de Yahweh! Ainsi parle le Seigneur Yahweh: Voici que je vais allumer au milieu de toi un feu, et il dévorera en toi tout arbre vert et tout arbre sec; la flamme dévorante ne s'éteindra point, et toute face sera brûlée par elle, du midi au septentrion.",
        ...
        7: '" Fils de l\'homme, tourne ta face vers Jérusalem, et fais découler ta parole vers les lieux saints, et prophétise contre la terre d\'Israël.',
    ...
    23: {
        ...
        3: 'Elles se prostituèrent en Egypte, elles se prostituèrent dans leur jeunesse. Là on a saisi leurs mamelles, là on a pressé leur sein virginal.',
    ...
    33: {
        ...
        31: "Et ils viennent vers toi comme vient la foule; mon peuple s'assied devant toi; ils écoutent tes paroles et ne les mettent point en pratique; ils font ce qui est agréable à leur bouche; leur cœur poursuit leur gain.",
    ...
    40: {
        ...
        2: "Dans des visions divines il m'emmena au pays d'Israël, et il me plaça sur une montagne très élevée; et sur cette montagne, il y avait comme une construction de ville au midi.",
        ...
        4: 'Cet homme me dit: " Fils de l\'homme, regarde de tes yeux et écoute de tes oreilles, et applique ton cœur à tout ce que je vais te faire voir, car c\'est pour qu\'on te le fasse voir que tu as été amené ici. Fais connaître à la maison d\'Israël tout ce que tu vas voir. "',
        ...
        8: "Il mesura le vestibule du portique, du côté de la maison; il était d'un roseau.",
        ...
        10: "Les loges du portique oriental étaient au nombre de trois d'un côté, et de trois de l'autre côté; toutes les trois avaient la même mesure, et les piliers de chaque côté avaient aussi la même mesure.",
        11: "Il mesura la largeur de l'ouverture du portique: elle était de dix coudées; et la longueur du portique de treize coudées.",
        ...
        13: "Et il mesura le portique du toit d'une loge jusqu'au toit de l'autre: vingt-cinq coudées en largeur, d'une porte jusqu'à l'autre porte.",
        ...
        17: "Puis il me conduisit au parvis extérieur: et voici qu'il y avait des chambres et un pavé disposés tout autour du parvis; il y avait trente chambres le long du pavé.",
        18: "Le pavé longeait les portiques, correspondant à la longueur des portiques; c'était le pavé inférieur.",
        19: "Il mesura la largeur du devant du portique inférieur jusqu'au devant du parvis intérieur: cent coudées, à l'orient et au septentrion.",
        ...
        21: "— ses loges, trois d'un côté et trois de l'autre; ses piliers et son vestibule ayant la même mesure que ceux du premier portique, — cinquante coudées en longueur et vingt-cinq coudées en largeur.",
        22: "Ses fenêtres, son vestibule et ses palmiers avaient la même mesure que ceux du portique dont la façade est dans la direction de l'orient; on y montait par sept degrés, et son vestibule était en face des degrés.",
        23: "Il y avait un portique au parvis intérieur, en face du portique du septentrion comme en face de celui de l'orient; il mesura d'un portique à l'autre: cent coudées.",
        ...
        25: '— il avait tout autour, ainsi que son vestibule, des fenêtres pareilles aux autres fenêtres —: cinquante coudées en longueur et vingt-cinq coudées en largeur.',
        ...
        27: "Le parvis intérieur avait aussi un portique dans la direction du midi; il mesura d'un portique à l'autre dans la direction du midi: cent coudées.",
        28: 'Il me conduisit dans le parvis intérieur par le portique du midi, et il mesura le portique qui était au midi, qui avait les mêmes dimensions',
        ...
        33: '— ses loges, ses pilastres et son vestibule avaient les mêmes dimensions; et il avait, ainsi que son vestibule, des fenêtres tout autour — cinquante coudées en longueur et vingt-cinq coudées en largeur.',
        ...
        36: '— Il y avait à ses loges, à ses pilastres et à son vestibule des fenêtres tout autour —: cinquante coudées de longueur et vingt-cinq coudées de largeur.',
        ...
        40: "Au côté extérieur, au septentrion pour celui qui montait à l'entrée du portique, il y avait deux tables, et de l'autre côté, vers le vestibule du portique, deux tables.",
        ...
        42: "Il y avait encore quatre tables servant aux holocaustes, en pierre de taille, longues d'une coudée et demie, larges d'une coudée et demie et hautes d'une coudée, sur lesquelles on posait les instruments avec lesquels on immolait les victimes destinées à l'holocauste et aux autres sacrifices.",
        ...
        44: "En dehors du portique intérieur, il y avait les chambres des chantres, dans le parvis intérieur; celle qui était à côté du portique septentrional, avait sa façade dans la direction du midi; l'autre à côté du portique oriental, avait sa façade dans la direction du nord.",
        ...
        48: "Il me conduisit ensuite vers le vestibule de la maison, et il mesura le pilier du vestibule: cinq coudées d'un côté et cinq coudées de l'autre; et la largeur du portique: trois coudées d'un côté et trois coudées de l'autre.",
        49: "La longueur du vestibule était de vingt coudées, et la largeur de onze coudées, aux degrés par lesquels on y montait; et il y avait des colonnes près des piliers, l'une d'un côté, l'autre de l'autre.",
    },
    41: {
