...
CHAPTERS = {
    ...
    3: {
        1: 'Dersom nogen vil bære frem et takkoffer, og han tar det av storfeet, så skal det offerdyr han fører frem for Herrens åsyn, enten det er han eller hun, være uten lyte.',
    ...
    14: {
        ...
        10: 'Den åttende dag skal han ta to værlam uten lyte og et årsgammelt hunlam uten lyte og til matoffer tre tiendedeler av en efa fint mel, blandet med olje, og så en log olje.',
