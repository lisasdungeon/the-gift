...
CHAPTERS = {
    ...
    18: {
        1: 'David mønstret folket som var med ham, og satte høvedsmenn over dem, nogen over tusen og nogen over hundre.',
        ...
        3: 'Men folket sa: Du skal ikke dra ut; for om vi flykter, bryr ingen sig om oss, og om halvdelen av oss faller, bryr heller ingen sig om oss; men du er så god som ti tusen av oss, og nu er det bedre at du er rede til å komme oss til hjelp fra byen.',
        ...
        9: 'Absalom kom like imot Davids menn; han red på sitt muldyr, og muldyret kom inn under de tette grener på en stor terebinte, så hans hode hang fast i terebinten, og han blev hengende mellem himmel og jord; for muldyret som han satt på, løp sin vei.',
        ...
        32: 'Kongen spurte kusitten: Står det vel til med den unge mann - med Absalom? Kusitten svarte: Gid det må gå min herre kongens fiender og alle som reiser sig imot dig og vil gjøre ondt, som det gikk den unge mann!',
    ...
    19: {
        ...
        6: 'du elsker jo dem som hater dig, og hater dem som elsker dig; for idag har du vist at hverken høvedsmenn eller tjenere er til for dig; og jeg skjønner nu at om Absalom var i live og alle vi andre var død idag, da syntes du det var som det skulde.',
        ...
        10: 'Men Absalom, som vi hadde salvet til konge over oss, er død i krigen; hvorfor sier I da ikke et ord om å føre kongen tilbake?',
        ...
        28: 'For hele min fars hus hadde ikke annet å vente av min herre kongen enn død, og dog gav du din tjener plass blandt dem som eter ved ditt bord; hvad rett har jeg da mere å kreve, og hvad mere har jeg å rope til kongen om?',
        ...
        39: 'Så drog da alt folket over Jordan, og kongen drog over; og kongen kysset Barsillai, og Barsillai velsignet ham og vendte tilbake til sitt hjem.',
