...
CHAPTERS = {
    ...
    11: {
        1: "jeg stod også ved hans side som hjelper og som vern i mederen Darius' første år.",
        2: 'Og nu vil jeg kunngjøre dig hvad som visst og sant vil hende: Ennu skal det opstå tre konger i Persia, og den fjerde skal samle større rikdom enn alle de andre, og når han har vunnet stor makt ved sin rikdom, skal han opbyde alt mot Grekenlands rike.',
        ...
        7: 'Men et av skuddene fra hennes røtter skal trede op på hans plass; og han skal dra mot fiendens hær og trenge inn i Nordens konges festninger og gjøre med dem som han vil, og ha overmakt.',
        ...
        13: 'Og Nordens konge skal komme igjen og stille op en hær som er ennu større enn den første; og når nogen år er gått til ende, skal han komme med en stor hær og store forråd.',
        ...
        15: 'Og Nordens konge skal komme og opkaste en voll og innta en sterk festning, og Sydens makt skal ikke kunne holde stand, og enn ikke hans utvalgte mannskap har kraft til å holde stand.',
        ...
        17: 'Og han skal ta sig fore å komme med hele sitt rikes makt, men er villig til å inngå forlik, og det skal han også få i stand; og en kvinne, sin egen datter, skal han gi ham, forat hun skal volde ødeleggelse; men det skal ikke komme i stand og ikke lykkes for ham.',
        ...
        20: 'Og på hans plass skal det opstå en som skal la en skattekrever dra gjennem rikets pryd; og nogen dager efter skal han omkomme, men ikke ved vrede, heller ikke i krig.',
