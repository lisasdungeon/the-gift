...
CHAPTERS = {
    ...
    33: {
        ...
        11: 'Si til dem: Så sant jeg lever, sier Herren, Israels Gud, jeg har ikke behag i den ugudeliges død, men i at den ugudelige vender om fra sin ferd og lever. Vend om, vend om fra eders onde veier! Hvorfor vil I dø, Israels hus?',
    ...
    41: {
        ...
        2: 'Døren var ti alen bred, og sideveggene ved døren var fem alen på hver side; og han målte dets lengde: den var firti alen, og bredden: den var tyve alen.',
        ...
        21: 'Templet hadde firkantede dørstolper, og fremsiden på helligdommen hadde samme utseende.',
        22: 'Alteret var av tre, tre alen høit og to alen langt, og det hadde sine hjørner, og langsiden og veggene var av tre; og han talte til mig og sa: Dette er bordet som står for Herrens åsyn.',
