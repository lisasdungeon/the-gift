...
CHAPTERS = {
    ...
    2: {
        ...
        26: 'Then Abner called to Joab, and said, Shall the sword devour for ever? know you not that it will be bitterness in the latter end? how long shall it be then, before you bid the people return from following their brothers?',
    ...
    7: {
        ...
        8: 'Now therefore so shall you say to my servant David, Thus says the LORD of hosts, I took you from the sheepcote, from following the sheep, to be ruler over my people, over Israel:',
