...
CHAPTERS = {
    ...
    4: {
        ...
        4: 'en lesquels le dieu de ce siècle a aveuglé les pensées des incrédules, pour que la lumière de l’évangile de la gloire du Christ qui est l’image de Dieu, ne resplendisse pas [pour eux].',
    ...
    7: {
        ...
        5: 'Car aussi, lorsque nous sommes arrivés en Macédoine, notre chair n’a eu aucun repos, mais nous avons été affligés en toute manière: au-dehors, des combats; au-dedans, des craintes.',
        ...
        12: 'Ainsi, si même je vous ai écrit, ce n’a point été à cause de celui qui a fait le tort ni à cause de celui à qui on a fait tort, mais afin que le zèle que nous avons pour vous, vous soit manifesté devant Dieu.',
    ...
    9: {
        ...
        4: 'de peur que si des Macédoniens venaient avec moi et ne vous trouvaient pas prêts, nous (pour ne pas dire vous), nous ne soyons confus de cette assurance.',
        ...
        8: 'Mais Dieu est puissant pour faire abonder toute grâce envers vous, afin qu’ayant toujours en toutes choses tout ce qui suffit, vous abondiez pour toute bonne œuvre,',
    ...
    12: {
        ...
        2: 'Je connais un homme en Christ, qui, il y a 14 ans (si ce fut dans le corps, je ne sais; si ce fut hors du corps, je ne sais; Dieu le sait), [je connais] un tel homme qui a été ravi jusqu’au troisième ciel.',
        ...
        8: 'À ce sujet j’ai supplié trois fois le Seigneur, afin qu’elle se retire de moi;',
