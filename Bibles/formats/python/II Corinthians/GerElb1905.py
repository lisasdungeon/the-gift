...
CHAPTERS = {
    ...
    4: {
        ...
        2: 'sondern wir haben den geheimen Dingen der Scham entsagt, indem wir nicht Arglist wandeln, noch das Wort Gottes verfälschen, sondern durch die Offenbarung der Wahrheit uns selbst jedem Gewissen der Menschen empfehlen vor Gott.',
    ...
    7: {
        ...
        8: 'Denn wenn ich euch auch durch den Brief betrübt habe, so reut es mich nicht, wenn es mich auch gereut hat; denn ich sehe, daß jener Brief, wenn auch nur für eine Zeit, euch betrübt hat.',
    ...
    12: {
        ...
        13: 'Denn was ist es, worin ihr gegen die anderen Versammlungen verkürzt worden seid, es sei denn, daß ich selbst euch nicht zur Last gefallen bin? Verzeihet mir dieses Unrecht.',
