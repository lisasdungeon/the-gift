...
CHAPTERS = {
    1: {
        1: 'Paulus, een apostel van Jezus Christus, door den wil van God, en Timotheüs, de broeder, aan de Gemeente Gods, die te Korinthe is, met al de heiligen, die in geheel Achaje zijn:',
    ...
    6: {
        ...
        7: 'In het woord der waarheid, in de kracht van God, door de wapenen der gerechtigheid aan de rechter zijde en aan de linker zijde;',
    ...
    7: {
        ...
        5: 'Want ook, als wij in Macedonië gekomen zijn, zo heeft ons vlees geen rust gehad; maar wij waren in alles verdrukt; van buiten was strijd, van binnen vrees.',
    ...
    10: {
        ...
        7: 'Ziet gij aan wat voor ogen is? Indiën iemand bij zichzelven betrouwt, dat hij van Christus is, die denke dit wederom uit zichzelven, dat gelijkerwijs hij van Christus is, alzo ook wij van Christus zijn.',
    ...
    11: {
        ...
        9: 'Want mijn gebrek hebben de broeders vervuld, die van Macedonië kwamen; en ik heb mijzelven in alles gehouden zonder u te bezwaren, en zal mij nog alzo houden.',
        ...
        22: 'Zijn zij Hebreën? Ik ook. Zijn zij Israëlieten? Ik ook. Zijn zij het zaad van Abraham? Ik ook.',
        ...
        30: 'Indiën men moet roemen, zo zal ik roemen de dingen mijner zwakheid.',
    ...
    13: {
        ...
        14: 'De genade van den Heere Jezus Christus, en de liefde van God, en de gemeenschap des Heiligen Geestes, zij met u allen. Amen. De tweede brief aan de Korinthiërs werd door Titus en Lukas geschreven vanuit Filippi een stad in Macedonië.',
    },
}
