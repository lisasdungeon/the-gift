...
CHAPTERS = {
    ...
    2: {
        1: "Datapuwa't ito'y ipinasiya ko sa aking sarili, na hindi na ako muling paririyan sa inyo na may kalumbayan.",
    ...
    3: {
        1: 'Pinasisimulan baga naming muli na ipagkapuri ang aming sarili? o kami baga ay nangangailangan gaya ng iba, ng mga sulat na papuri sa inyo, o mula sa inyo?',
        2: 'Kayo ay ang aming sulat, na nasusulat sa aming mga puso, nakikilala at nababasa ng lahat ng mga tao;',
        3: "Yamang nahahayag na kayo'y sulat ni Cristo, na pinangasiwaan namin, hindi isinulat ng tinta, kundi ng Espiritu, ng Dios na buhay, hindi sa mga tapyas ng bato, kundi sa mga tapyas ng pusong laman.",
        4: 'At ang gayong pagkakatiwala sa Dios ay taglay namin sa pamamagitan ni Cristo:',
    ...
    5: {
        1: "Sapagka't nalalaman namin na kung masira ang aming bahay na tabernakulong ukol sa lupa, ay mayroong kaming isang gusaling mula sa Dios, bahay na hindi gawa ng mga kamay, walang hanggan, sa sangkalangitan.",
    ...
    6: {
        1: 'At yamang kalakip niyang gumagawa ay ipinamamanhik din namin sa inyo na huwag ninyong tanggapin ang biyaya ng Dios na walang kabuluhan.',
        ...
        7: 'Sa salita ng katotohanan, sa kapangyarihan ng Dios; sa pamamagitan ng mga sandata ng katuwiran sa kanan at sa kaliwa,',
        ...
        9: "Waring hindi mga kilala, gayon ma'y mga kilalang mabuti; tulad sa nangaghihingalo, at narito, kami ay nangabubuhay; gaya ng mga pinarurusahan, at hindi pinapatay;",
    ...
    7: {
        1: 'Yamang taglay natin ang mga pangakong ito, mga minamahal, ay magsipaglinis tayo sa lahat ng karumihan ng laman at ng espiritu, na pakasakdalin ang kabanalan sa takot sa Dios.',
