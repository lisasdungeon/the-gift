...
CHAPTERS = {
    1: {
        ...
        7: '; es sei wir werden getröstet, so ist es um eures Trostes und Heiles willen, indem wir wissen, daß, gleichwie ihr der Leiden teilhaftig seid, also auch des Trostes.',
    ...
    2: {
        ...
        5: 'Wenn aber jemand traurig gemacht hat, so hat er nicht mich traurig gemacht, sondern in gewissem Maße euch alle.',
    ...
    4: {
        1: 'Darum, da wir diesen Dienst haben, wie wir begnadigt worden sind, ermatten wir nicht;',
        ...
        13: 'Da wir aber denselben Geist des Glaubens haben, so glauben auch wir, darum reden wir auch,',
    ...
    5: {
        ...
        13: 'Denn sei es, daß wir außer uns sind, so sind wir es Gott; sei es daß wir vernünftig sind-euch.',
        14: 'Denn die Liebe des Christus drängt uns, indem wir also geurteilt haben, daß einer für alle gestorben ist und somit alle gestorben sind.',
        15: 'Und er ist für alle gestorben, auf daß die, welche leben, nicht mehr sich selbst leben, sondern dem, der für sie gestorben ist und ist auferweckt worden.',
    ...
    6: {
        ...
        13: 'Zur gleichen Vergeltung aber werdet auch ihr weit.',
    ...
    8: {
        ...
        4: 'mit vielem Zureden uns um die Gnade und die Gemeinschaft des Dienstes für die Heiligen bittend.',
        ...
        9: 'Denn ihr kennet die Gnade unseres Herrn Jesu Christi, daß er, da er reich war, um euretwillen arm wurde, auf daß ihr durch seine Armut reich würdet.',
        10: 'Und ich gebe hierin eine Meinung; denn dies ist euch nützlich, die ihr nicht allein das Tun, sondern auch das Wollen vorher angefangen habt seit vorigem Jahre.',
        11: 'Nun aber vollbringet auch das Tun, damit, gleichwie die Geneigtheit zum Wollen, also auch das Vollbringen da sei nach dem, was ihr habt.',
        12: 'Denn wenn die Geneigtheit vorliegt, so ist einer annehmlich nach dem er hat, und nicht nach dem er nicht hat.',
        13: 'Denn nicht auf daß andere Erleichterung haben, ihr aber Bedrängnis, sondern nach der Gleichheit:',
        ...
        20: 'indem wir dies verhüten, daß uns nicht jemand übel nachrede dieser reichen Gabe halben, die von uns bedient wird;',
        21: 'denn wir sind vorsorglich für das, was ehrbar ist, nicht allein vor dem Herrn, sondern auch vor den Menschen.',
        22: 'Wir haben aber unseren Bruder mit ihnen gesandt, den wir oft in vielen Stücken erprobt haben, daß er eifrig ist, nun aber noch viel eifriger durch große Zuversicht, die er zu euch hat.',
        23: 'Sei es, was Titus betrifft, er ist mein Genosse und in Bezug auf euch mein Mitarbeiter; seien es unsere Brüder, sie sind Gesandte der Versammlungen, Christi Herrlichkeit.',
        24: 'So beweiset nun gegen sie, angesichts der Versammlungen, den Beweis eurer Liebe und unseres Rühmens über euch.',
    },
    9: {
        1: 'Denn was den Dienst für die Heiligen betrifft, so ist es überflüssig für mich, euch zu schreiben.',
        2: 'Denn ich kenne eure Geneigtheit, deren ich mich eurethalben rühme gegen die Macedonier, daß Achaja bereit gewesen ist seit vorigem Jahre; und der von euch ausgegangene Eifer hat viele angereizt.',
    ...
    10: {
        ...
        14: 'Denn wir strecken uns selbst nicht zu weit aus, als gelangten wir nicht bis zu euch,',
    ...
    11: {
        ...
        3: 'Ich fürchte aber, daß etwa, wie die Schlange Eva verführte durch ihre List, also auch euer Sinn verderbt und abgewandt werde von der Einfalt gegen den Christus.',
        ...
        9: 'Und als ich bei euch anwesend war und Mangel litt, fiel ich niemandem zur Last, und ich hielt mich in allem euch unbeschwerlich, und werde mich also halten.',
        10: 'Die Wahrheit Christi ist in mir, daß mir dieses Rühmen nicht verwehrt werden soll in den Gegenden von Achaja!',
        ...
        21: 'Ich rede bezüglich der Unehre, als ob wir schwach gewesen wären. Worin aber irgend jemand dreist ist, bin auch ich dreist.',
        22: 'Sind sie Hebräer? ich auch. Sind sie Israeliten? ich auch. Sind sie Abrahams Same? ich auch.',
        23: 'Sind sie Diener Christi? ich über die Maßen. In Mühen überschwenglicher, in Schlägen übermäßig, in Gefängnissen überschwenglicher, in Todesgefahren oft.',
    ...
    12: {
        ...
        11: 'Ich bin ein Tor geworden; ihr habt mich dazu gezwungen. Denn ich hätte von euch empfohlen werden sollen, denn ich habe in nichts den ausgezeichnetsten Aposteln nachgestanden, wenn ich auch nichts bin.',
        12: 'Die Zeichen des Apostels sind ja unter euch vollbracht worden in allem Ausharren, in Zeichen und Wundern und mächtigen Taten.',
        13: 'Denn was ist es, worin ihr verkürzt worden seid gegen die anderen Versammlungen, es sei denn, daß ich selbst euch nicht zur Last gefallen bin? Verzeihet mir dieses Unrecht.',
        14: 'Siehe, dieses dritte Mal stehe ich bereit, zu euch zu kommen, und werde nicht zur Last fallen, denn ich suche nicht das Eure, sondern euch. Denn die Kinder sollen nicht für die Eltern Schätze sammeln, sondern die Eltern für die Kinder.',
        15: 'Ich will aber sehr gern alles verwenden und völlig verwendet werden für eure Seelen, wenn ich auch, je überschwenglicher ich euch liebe, um so weniger geliebt werde.',
        16: 'Doch es sei so, ich habe euch nicht beschwert; weil ich aber schlau bin, so habe ich euch mit List gefangen.',
