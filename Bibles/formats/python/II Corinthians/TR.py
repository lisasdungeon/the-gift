...
CHAPTERS = {
    ...
    3: {
        1: 'αρχομεθα παλιν εαυτους συνιστανειν ει η μη χρηζομεν ως τινες συστατικων επιστολων προς υμας η εξ υμων συστατικων',
    ...
    5: {
        ...
        4: 'και γαρ οι οντες εν τω σκηνει στεναζομεν βαρουμενοι επειδη εφ ω ου θελομεν εκδυσασθαι αλλ επενδυσασθαι ινα καταποθη το θνητον υπο της ζωης',
    ...
    6: {
        ...
        15: 'τις δε συμφωνησις χριστω προς βελιαρ βελιαλ η τις μερις πιστω μετα απιστου',
    ...
    11: {
        ...
        10: 'εστιν αληθεια χριστου εν εμοι οτι η καυχησις αυτη ου σφραγισεται φραγησεται εις εμε εν τοις κλιμασιν της αχαιας',
        ...
        16: 'παλιν λεγω μη τις με δοξη αφρονα ειναι ει δε μηγε μη γε καν ως αφρονα δεξασθε με ινα μικρον τι καγω καυχησωμαι',
    ...
    13: {
        ...
        13: '(13:12) ασπαζονται υμας οι αγιοι παντες',
        14: '(13:13) η χαρις του κυριου ιησου χριστου και η αγαπη του θεου και η κοινωνια του αγιου πνευματος μετα παντων υμων αμην [προς κορινθιους δευτερα εγραφη απο φιλιππων της μακεδονιας δια τιτου και λουκα]',
    },
}
