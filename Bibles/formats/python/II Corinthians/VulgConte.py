...
CHAPTERS = {
    ...
    7: {
        ...
        12: 'Igitur, etsi scripsi vobis, non propter eum, qui fecit iniuriam, nec propter eum, qui passus est: sed ad manifestandam solicitudinem nostram, quam habemus pro vobis coram Deo:',
        13: 'ideo consolati sumus. In consolatione autem nostra, abundantius magis gavisi sumus super gaudio Titi, quia refectus est spiritus eius ab omnibus vobis.',
