...
CHAPTERS = {
    ...
    2: {
        ...
        12: 'Ότε δε ήλθον εις την Τρωάδα διά να κηρύξω το ευαγγέλιον του Χριστού, και ηνοίχθη εις εμέ θύρα εν Κυρίω,',
        13: "δεν έλαβον άνεσιν εις το πνεύμά μου, διότι δεν εύρον Τίτον τον αδελφόν μου, αλλ' αποχαιρετήσας αυτούς εξήλθον εις Μακεδονίαν.",
    ...
    6: {
        1: 'Όντες δε συνεργοί αυτού, παρακαλούμεν ενταυτώ να μη δεχθήτε την χάριν του Θεού ματαίως·',
        2: 'διότι λέγει· Εν καιρώ δεκτώ επήκουσά σου και εν ημέρα σωτηρίας σε εβοήθησα· ιδού, τώρα καιρός ευπρόσδεκτος, ιδού, τώρα ημέρα σωτηρίας·',
        3: "μη δίδοντες μηδέν πρόσκομμα κατ' ουδέν, διά να μη προσαφθή μώμος εις την διακονίαν,",
        4: 'αλλά εν παντί συνιστώντες εαυτούς ως υπηρέται Θεού, εν υπομονή πολλή, εν θλίψεσιν, εν ανάγκαις, εν στενοχωρίαις,',
        5: 'εν ραβδισμοίς, εν φυλακαίς, εν ακαταστασίαις, εν κόποις, εν αγρυπνίαις, εν νηστείαις,',
        6: 'εν καθαρότητι, εν γνώσει, εν μακροθυμία, εν χρηστότητι, εν Πνεύματι Αγίω, εν αγάπη ανυποκρίτω,',
        7: 'εν λόγω αληθείας, εν δυνάμει Θεού, διά των όπλων της δικαιοσύνης των δεξιών και αριστερών,',
        8: 'διά δόξης και ατιμίας, διά δυσφημίας και ευφημίας, ως πλάνοι όμως αληθείς,',
        9: 'ως αγνοούμενοι αλλά καλώς γνωριζόμενοι, ως αποθνήσκοντες αλλ ιδού, ζώμεν, ως παιδευόμενοι αλλά μη θανατούμενοι,',
        ...
        13: 'την αυτήν λοιπόν αντιμισθίαν αποδίδοντες, ως προς τέκνα λαλώ, πλατύνθητε και σεις.',
    ...
    7: {
        1: 'Έχοντες λοιπόν, αγαπητοί, ταύτας τας επαγγελίας, ας καθαρίσωμεν εαυτούς από παντός μολυσμού σαρκός και πνεύματος, εκπληρούντες αγιωσύνην εν φόβω Θεού.',
        2: 'Δέχθητε ημάς εν υμίν· ουδένα ηδικήσαμεν, ουδένα εφθείραμεν, εις ουδένα εστάθημεν πλεονέκται.',
        3: 'Δεν λέγω τούτο προς κατάκρισίν σας· διότι προείπον ότι είσθε εν ταις καρδίαις ημών, ώστε να συναποθάνωμεν και να συζώμεν.',
        4: 'Πολλήν παρρησίαν έχω προς εσάς, πολλήν καύχησιν έχω διά σάς· είμαι πλήρης παρηγορίας, έχω υπερπερισσεύουσαν την χαράν εις όλην την θλίψιν ημών.',
        5: 'Διότι αφού ήλθομεν εις Μακεδονίαν ουδεμίαν άνεσιν έλαβεν η σαρξ ημών, αλλά κατά πάντα εθλιβόμεθα· έξωθεν μάχαι, έσωθεν φόβοι.',
        6: "Αλλ' ο Θεός ο παρηγορών τους ταπεινούς παρηγόρησεν ημάς διά της παρουσίας του Τίτου·",
        7: 'και ουχί μόνον διά της παρουσίας αυτού, αλλά και διά της παρηγορίας, την οποίαν παρηγορήθη διά σας, αναγγέλλων προς ημάς τον μέγαν πόθον σας, τον οδυρμόν σας, τον ζήλον σας υπέρ εμού, ώστε περισσότερον εχάρην,',
        8: 'διότι εάν και σας ελύπησα διά της επιστολής, δεν μετανοώ, αν και μετενόουν· επειδή βλέπω ότι η επιστολή εκείνη, αν και προς ώραν, σας ελύπησε.',
        9: "Τώρα χαίρω, ουχί ότι ελυπήθητε, αλλ' ότι ελυπήθητε προς μετάνοιαν· διότι ελυπήθητε κατά Θεόν, διά να μη ζημιωθήτε εξ ημών εις ουδέν.",
        10: 'Διότι η κατά Θεόν λύπη γεννά μετάνοιαν προς σωτηρίαν αμεταμέλητον· η λύπη όμως του κόσμου γεννά θάνατον.',
        11: "Διότι ιδού, αυτό τούτο, το ότι ελυπήθητε κατά Θεόν, πόσην σπουδήν εγέννησεν εις εσάς, αλλά απολογίαν, αλλά αγανάκτησιν, αλλά φόβον, αλλά πόθον, αλλά ζήλον, αλλ' εκδίκησιν. Κατά πάντα απεδείξατε εαυτούς ότι είσθε καθαροί εις τούτο το πράγμα.",
        12: 'Λοιπόν, αν και σας έγραψα, δεν έκαμον τούτο διά τον αδικήσαντα, ουδέ διά τον αδικηθέντα, αλλά διά να φανερωθή προς εσάς η σπουδή ημών, την οποίαν έχομεν διά σας ενώπιον του Θεού.',
        13: 'Διά τούτο παρηγορήθημεν διά την παρηγορίαν σας, και έτι περισσότερον εχάρημεν διά την χαράν του Τίτου, ότι ανεπαύθη το πνεύμα αυτού παρά πάντων υμών·',
        14: 'διότι εάν εκαυχήθην τι προς αυτόν διά σας, δεν κατησχύνθην, αλλά καθώς σας ελαλήσαμεν πάντα εν αληθεία, ούτω και η καύχησις ημών η προς τον Τίτον έγεινεν αλήθεια.',
        15: 'Και η αγάπη αυτού αυξάνει περισσότερον προς εσάς, όταν ενθυμήται την υπακοήν πάντων υμών, πως μετά φόβου και τρόμου εδέχθητε αυτόν.',
        16: 'Χαίρω λοιπόν ότι κατά πάντα έχω θάρρος εις εσάς.',
    },
    8: {
    ...
    9: {
        ...
        9: 'καθώς είναι γεγραμμένον· Εσκόρπισεν, έδωκεν εις τους πένητας· η δικαιοσύνη αυτού μένει εις τον αιώνα.',
    ...
    11: {
        1: 'Είθε να υποφέρητε ολίγον τι την αφροσύνην μου· αλλά και υποφέρετέ με.',
        2: 'Διότι είμαι ζηλότυπος προς εσάς κατά ζηλοτυπίαν Θεού· επειδή σας ηρραβώνισα με ένα άνδρα, διά να σας παραστήσω παρθένον αγνήν εις τον Χριστόν.',
        3: 'φοβούμαι όμως μήπως, καθώς ο όφις εξηπάτησε την Εύαν διά της πανουργίας αυτού, διαφθαρή ούτως ο νούς σας, εκπεσών από της απλότητος της εις τον Χριστόν.',
        4: 'Διότι εάν ο ερχόμενος κηρύττη προς εσάς άλλον Ιησούν, τον οποίον ημείς δεν εκηρύξαμεν, ή λαμβάνητε άλλο πνεύμα, το οποίον δεν ελάβετε, ή άλλο ευαγγέλιον, το οποίον δεν εδέχθητε, καλώς ηθέλετε υποφέρει αυτόν.',
        5: 'Αλλά στοχάζομαι ότι δεν είμαι εις ουδέν κατώτερος των πρωτίστων αποστόλων.',
        6: "Εάν δε και ήμαι ιδιώτης κατά τον λόγον, αλλ' ουχί κατά την γνώσιν, αλλ' εν παντί τρόπω εφανερώθημεν κατά πάντα εις εσάς.",
        7: 'Η έπραξα αμαρτίαν ταπεινόνων εμαυτόν διά να υψωθήτε σεις, διότι σας εκήρυξα δωρεάν το ευαγγέλιον του Θεού;',
        8: 'Άλλας εκκλησίας εγύμνωσα λαβών τα αναγκαία διά την υπηρεσίαν σας,',
        9: 'και ότε ήμην παρών εις εσάς και εστερήθην, δεν κατεβάρυνα ουδένα· διότι την στέρησίν μου προσανεπλήρωσαν οι αδελφοί ελθόντες από Μακεδονίας· και κατά πάντα εφύλαξα εμαυτόν και θέλω φυλάξει αβαρή προς εσάς.',
        10: 'Είναι αλήθεια του Χριστού εν εμοί ότι η καύχησις αύτη δεν θέλει αποκλεισθή εις εμέ εν τοις τόποις της Αχαΐας.',
        11: 'Διά τι; διότι δεν σας αγαπώ; ο Θεός γινώσκει.',
        12: 'ό,τι δε κάμνω, τούτο και θέλω κάμνει, διά να εκκόψω την αφορμήν των θελόντων αφορμήν, ίνα ευρεθώσιν εις εκείνο, διά το οποίον καυχώνται, τοιούτοι καθώς και ημείς.',
        13: 'Διότι οι τοιούτοι είναι ψευδαπόστολοι, εργάται δόλιοι, μετασχηματιζόμενοι εις αποστόλους Χριστού.',
        14: 'Και ουδέν θαυμαστόν· διότι αυτός ο Σατανάς μετασχηματίζεται εις άγγελον φωτός.',
        15: 'Δεν είναι λοιπόν μέγα αν και οι διάκονοι αυτού μετασχηματίζωνται εις διακόνους δικαιοσύνης, των οποίων το τέλος θέλει είσθαι κατά τα έργα αυτών.',
        16: 'Πάλιν λέγω, Μηδείς ας μη με στοχασθή ότι είμαι άφρων· ει δε μη, δέχθητέ με καν ως άφρονα, διά να καυχηθώ και εγώ ολίγον τι.',
        17: "ό,τι λαλώ, εις τούτο το θάρρος της καυχήσεως, δεν λαλώ κατά τον Κύριον, αλλ' ως άφρων.",
        ...
        20: 'επειδή υποφέρετε, εάν τις σας καταδουλόνη, εάν τις σας κατατρώγη, εάν τις λαμβάνη τα υμών, εάν τις επαίρηται, εάν τις σας κτυπά εις το πρόσωπον.',
        21: "Κατά ατιμίαν λέγω, ως να ήμεθα ημείς ασθενείς. Αλλ' εις ό,τι τολμά τις, αφρόνως ομιλώ, τολμώ και εγώ.",
        22: 'Εβραίοι είναι; και εγώ· Ισραηλίται είναι; και εγώ· σπέρμα Αβραάμ είναι; και εγώ·',
        ...
        30: 'Εάν πρέπη να καυχώμαι, θέλω καυχηθή εις τα της ασθενείας μου.',
        ...
        33: 'και διά θυρίδος από του τείχους κατεβιβάσθην εν κοφίνω και εξέφυγον τας χείρας αυτού.',
    },
    12: {
        1: 'Να καυχώμαι βέβαια δεν μοι συμφέρει· διότι θέλω ελθεί εις οπτασίας και αποκαλύψεις Κυρίου.',
        2: 'Γνωρίζω άνθρωπον εν Χριστώ προ ετών δεκατεσσάρων, είτε εντός του σώματος δεν εξεύρω, είτε εκτός του σώματος δεν εξεύρω, ο Θεός εξεύρει· ότι ηρπάγη ο τοιούτος έως τρίτου ουρανού.',
        ...
        5: 'Υπέρ του τοιούτου θέλω καυχηθή, υπέρ δε εμαυτού δεν θέλω καυχηθή ειμή εις τας ασθενείας μου.',
        6: "Διότι εάν θελήσω να καυχηθώ, δεν θέλω είσθαι άφρων, επειδή αλήθειαν θέλω ειπεί· συστέλλομαι όμως μη στοχασθή τις εις εμέ ανώτερόν τι αφ' ό,τι με βλέπει ή ακούει τι εξ εμού.",
        7: 'Και διά να μη υπεραίρωμαι διά την υπερβολήν των αποκαλύψεων, μοι εδόθη σκόλοψ εις την σάρκα, άγγελος Σατάν διά να με ραπίζη, διά να μη υπεραίρωμαι.',
        8: "Περί τούτου τρίς παρεκάλεσα τον Κύριον διά να απομακρυνθή απ' εμού·",
        9: 'και μοι είπεν· Αρκεί εις σε η χάρις μου· διότι η δύναμίς μου εν αδυναμία δεικνύεται τελεία. Με άκραν λοιπόν ευχαρίστησιν θέλω καυχηθή μάλλον εις τας αδυναμίας μου, διά να κατοικήση εν εμοί η δύναμις του Χριστού.',
        10: 'Όθεν ευαρεστούμαι εις τας αδυναμίας, εις τας ύβρεις, εις τας ανάγκας, εις τους διωγμούς, εις τας στενοχωρίας, υπέρ του Χριστού· διότι όταν ήμαι αδύνατος, τότε είμαι δυνατός.',
        11: 'Έγεινα άφρων καυχώμενος· σεις με ηναγκάσατε. Διότι έπρεπεν εγώ να συνιστώμαι από σάς· επειδή εις ουδέν υπήρξα κατώτερος των πρωτίστων αποστόλων, αν και ήμαι μηδέν.',
        12: 'Τα μεν σημεία του αποστόλου ενηργήθησαν μεταξύ σας εν πάση υπομονή, διά θαυμάτων και τεραστίων και δυνάμεων.',
        13: 'Διότι κατά τι εμείνατε κατώτεροι των λοιπών εκκλησιών, ειμή ότι αυτός εγώ δεν σας κατεβάρυνα; συγχωρήσατέ μοι την αδικίαν ταύτην.',
        14: "Ιδού, τρίτην φοράν είμαι έτοιμος να έλθω προς εσάς, και δεν θέλω σας καταβαρύνει· διότι δεν ζητώ τα υμών, αλλ' υμάς. Διότι δεν χρεωστούσι τα τέκνα να θησαυρίζωσι διά τους γονείς, αλλ' οι γονείς διά τα τέκνα.",
        15: 'Εγώ δε με άκραν χαράν θέλω δαπανήσει και όλως δαπανηθή υπέρ των ψυχών σας, αν και ενώ σας αγαπώ περισσότερον, αγαπώμαι ολιγώτερον.',
        16: 'Έστω όμως, εγώ δεν σας κατεβάρυνα, αλλά πανούργος ων, σας επίασα με δόλον.',
        17: "Μήπως διά τινός εξ εκείνων, τους οποίους έστειλα προς εσάς, δι' αυτού επλεονέκτησα από σας;",
        18: "Παρεκάλεσα τον Τίτον, και μετ' αυτού απέστειλα τον αδελφόν· μήπως ο Τίτος επλεονέκτησέ τι από σας; ουχί με το αυτό πνεύμα περιεπατήσαμεν; ουχί εις τα αυτά ίχνη;",
        19: 'Πάλιν νομίζετε ότι απολογούμεθα προς εσάς; ενώπιον του Θεού λαλούμεν εν Χριστώ· πράττομεν δε τα πάντα, αγαπητοί, διά την οικοδομήν σας.',
        ...
        21: 'μήπως πάλιν όταν έλθω προς εσάς, με ταπεινώση ο Θεός μου και πενθήσω πολλούς των προαμαρτησάντων και μη μετανοησάντων διά την ακαθαρσίαν και πορνείαν και ασέλγειαν, την οποίαν έπραξαν.',
    },
    13: {
