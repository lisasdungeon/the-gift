...
CHAPTERS = {
    ...
    11: {
        ...
        31: 'Bóg i Ojciec naszego Pana Jezusa Chrystusa, który jest błogosławiony na wieki, wie, że nie kłamię.',
    ...
    13: {
        1: 'Oto teraz po raz trzeci idę do was. Na podstawie zeznania dwóch albo trzech świadków oparte będzie każde słowo.',
        ...
        14: 'Łaska Pana Jezusa Chrystusa, miłość Boga i wspólnota Ducha Świętego niech będzie z wami wszystkimi. Amen. Drugi list do Koryntian został napisany z Filippi, miasta Macedonii, przez Tytusa i Łukasza.',
    },
}
