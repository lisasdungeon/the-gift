...
CHAPTERS = {
    ...
    14: {
        ...
        21: 'Qui méprise son prochain commet un péché, Mais heureux qui a pitié des malheureux!',
    ...
    20: {
        ...
        24: "C'est l'Eternel qui dirige les pas de l'homme. Comment le mortel connaîtrait-il son chemin?",
    ...
    30: {
        ...
        4: "Qui est monté aux cieux et en est descendu? Qui a recueilli le vent dans ses mains? Qui a serré l'eau dans son vêtement? Qui a fixé toutes les extrémités de la terre? Quel est son nom et le nom de son fils, si tu le sais?",
