...
CHAPTERS = {
    1: {
        ...
        10: 'when he comes to be honor ed in his people,’ and to be revered in all who have learned to believe in him (for you also believed our testimony) — as he will be on ‘that day.’',
    ...
    2: {
        ...
        2: 'not lightly to let your minds become unsettled, or disturbed by any revelation, or by any message, or by any letter, purporting to come from us, to the effect that the day of the Lord is come.',
        3: 'Do not let anyone deceive you, whatever he may do. For it will not come until after the Great Apostasy, and the appearing of that Incarnation of Wickedness, that the Lost soul,',
        4: 'who so opposes himself to everyone that is spoken of as a God or as an object of worship, and so exalts himself above them, that he seats himself in the Temple of God, and displays himself as God!',
