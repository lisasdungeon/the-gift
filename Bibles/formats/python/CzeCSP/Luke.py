...
CHAPTERS = {
    ...
    5: {
        ...
        3: 'Vstoupil do jedné z těch lodí, která patřila Šimonovi, a požádal ho, aby odrazil kousek od břehu. Posadil se a z lodi učil zástupy.',
        4: 'Když přestal mluvit, řekl Šimonovi: „Zajeď na hlubinu a spusťte své sítě k lovu.“',
        5: 'Šimon odpověděl: „Mistře, celou noc jsme tvrdě pracovali a nic jsme nechytili.Ale ⌈na tvé slovo⌉ spustím sítě.“',
        ...
        12: 'I stalo se, když byl v jednom z těch měst, hle, byl tam muž plný malomocenství. Jakmile uviděl Ježíše, padl na tvář a poprosil ho: „Pane, chceš–li, jsi mocen mě očistit.“',
        ...
        34: 'Ježíš jim řekl: „Můžete přinutit svatebčany, aby se postili, dokud je ženich s nimi?',
        ...
        39: 'A nikdo, kdo se napil starého, nechce mladé, neboť říká: Staré je dobré. “',
    },
    6: {
    ...
    8: {
        1: 'A stalo se, že potom procházel městy a vesnicemi a hlásal a zvěstoval jako radostnou zvěst Boží království; bylo s ním těch Dvanáct',
        2: 'a některé ženy, které byly uzdraveny od zlých duchů a nemocí: Marie zvaná Magdalská, od níž kdysi vyšlo sedm démonů,',
        3: 'Jana, žena Herodova správce Chuzy, Zuzana a mnohé jiné, které se o ně staraly ze svých prostředků.',
        4: 'Když se scházel veliký zástup a z jednotlivých měst k němu přicházeli lidé, řekl jim v podobenství:',
        ...
        7: 'A jiné padlo mezi trní; a trní vyrostlo spolu s ním a udusilo je.',
        8: 'A jiné padlo do dobré země, vyrostlo a vydalo stonásobnou úrodu.“To řekl a volal: „Kdo má uši k slyšení, ať poslouchá!“',
        9: 'Jeho učedníci se ho tázali, co to podobenství znamená.',
        10: 'On řekl: „Vám je dáno poznat tajemství Božího království, ostatním však v podobenstvích, aby hledíce neviděli a slyšíce nechápali.“',
        ...
        13: 'Ti na skále, když uslyší, s radostí přijímají Slovo. Protože však nemají kořen, věří jen po určitou dobu a v čas zkoušky odpadají.',
        ...
        17: 'Vždyť nic není skrytého, co se nestane zjevným, ani ukrytého, co by zajisté nebylo poznáno a nevyšlo najevo.',
        18: 'Dávejte tedy pozor, jak slyšíte. Neboť tomu, kdo má, bude dáno, a tomu, kdo nemá, bude odňato i to, co myslí, že má.“',
        19: 'Přišla za ním matka a jeho bratři, ale nemohli se s ním pro zástup setkat.',
        ...
        22: 'Stalo se, že jednoho dne vstoupil do lodi se svými učedníky a řekl jim: „Přeplavme se na druhou stranu jezera.“A vypluli.',
        23: 'Zatímco se plavili, usnul. A na jezero se snesla větrná bouře; začali se naplňovat vodou a byli v nebezpečí.',
        24: 'Přistoupili k němu, vzbudili ho a řekli: „Mistře, Mistře, hyneme!“On vstal, pohrozil větru a přívalu vod; i ustaly a nastal klid.',
        25: 'Řekl jim: „Kde je vaše víra?“Ulekli se a užasli a říkali mezi sebou: „Kdo to jen je, že přikazuje dokonce větrům a vodě, a poslouchají ho?“',
        26: 'Přepluli do krajiny Gerasenů, která je naproti Galileji.',
        ...
        28: 'Když uviděl Ježíše, vykřikl, padl před ním na zem a řekl silným hlasem: „Co je ti po mně, Ježíši, Synu Boha Nejvyššího? Prosím tě, abys mne netrýznil.“',
        ...
        31: 'A prosili ho, aby jim nepřikazoval odejít do bezedné propasti.',
        ...
        37: 'A celé to množství lidí z ⌈okolní krajiny Gerasenů⌉ ho požádalo, aby od nich odešel, protože se jich zmocňoval veliký strach. On vstoupil do lodi a vrátil se.',
        ...
        41: 'A hle, přišel muž jménem Jairos; byl to představený synagogy. Padl k Ježíšovým nohám a prosil ho, aby vešel do jeho domu,',
        42: 'protože měl jedinou dceru, asi dvanáctiletou, a ta umírala. Když Ježíš šel, zástupy ho tísnily.',
        43: 'A byla tam žena, která měla dvanáct let krvotok [a vynaložila na lékaře všechno, co měla,] a nikdo ji nemohl uzdravit.',
        ...
        46: 'Ale Ježíš řekl: „Někdo se mne dotkl. Já jsem poznal, že ode mne vyšla moc.“',
        47: 'Když žena uviděla, že se to neutajilo, s třesením přišla, padla mu k nohám a přede vším lidem vypověděla, proč se ho dotkla a jak byla hned uzdravena.',
        48: 'On jí řekl: „Dcero, tvá víra tě zachránila. Jdi v pokoji.“',
        49: 'Zatímco ještě mluvil, přišel kdosi z domu představeného synagogy a řekl: „Tvá dcera zemřela, [již] učitele neobtěžuj.“',
        50: 'Ježíš to uslyšel a odpověděl mu: „Neboj se, jen věř, a bude zachráněna.“',
        51: 'Když přišel do domu, nedovolil nikomu, aby s ním vešel, kromě Petra, Jana a Jakuba a otce a matky té dívky.',
        52: 'Všichni nad ní plakali a bili se v prsa. On řekl: „Neplačte. Nezemřela, ale spí.“',
        53: 'Posmívali se mu, protože věděli, že zemřela.',
        54: 'On však [všechny vyhnal ven,] uchopil její ruku a zvolal: „Dívko, vstaň!“',
    ...
    10: {
        ...
        25: 'A hle, jeden zákoník povstal a zkoušel ho: „Učiteli, co mám učinit, abych získal věčný život?“',
        ...
        38: '[Stalo se,] když šli dále, že vešel do jedné vesnice. Nějaká žena jménem Marta jej přijala [do svého domu].',
    ...
    13: {
        1: 'Právě v tu dobu byli přítomni někteří, kteří mu vyprávěli o Galilejcích, jejichž krev Pilát smísil s jejich oběťmi.',
        2: 'On jim na to řekl: „Myslíte, že tito Galilejci byli větší hříšníci než všichni ostatní Galilejci, když toto vytrpěli?',
        ...
        6: 'Říkal toto podobenství: „Kdosi měl na své vinici zasazený fíkovník. I přišel na něm hledat ovoce, ale nenalezl.',
        7: 'Řekl vinaři: Hle, po tři léta přicházím a hledám ovoce v tomto fíkovníku, a nenalézám. Vytni jej [tedy]! Proč kazí i tu zem?',
        ...
        10: 'V sobotu učil v jedné synagoze.',
        ...
        23: 'Kdosi mu řekl: „Pane, je jen málo těch, kteří ⌈jsou zachraňováni⌉?“On jim řekl:',
        24: '„Usilujte vejít úzkými dveřmi, neboť mnozí, pravím vám, se budou snažit vejít, ale nebudou schopni.',
        25: 'V tu chvíli, když by hospodář vstal a zavřel dveře, a vy byste zůstali stát venku, začali tlouci na dveře a říkat: Pane, otevři nám, on vám odpoví: Neznám vás a nevím, odkud jste.',
        26: 'Tehdy začnete říkat: Jedli jsme ⌈před tebou⌉ i pili a na našich ulicích jsi učil.',
        27: 'A on ⌈vám řekne:⌉ ⌈Neznám vás a nevím, odkud jste⌉. Odstupte ode mne všichni činitelé nepravosti!',
        28: 'Tam bude pláč a skřípění zubů, až spatříte Abrahama, Izáka a Jákoba a všechny proroky v Božím království, ale vás vyženou ven.',
        29: 'A přijdou mnozí od východu i západu, od severu i jihu a budou stolovat v Božím království.',
        30: 'A hle, jsou poslední, kteří budou první, a jsou první, kteří budou poslední.“',
        31: 'Právě v tu hodinu přišli někteří farizeové a řekli mu: „Vyjdi a jdi odtud, protože Herodes tě chce zabít.“',
        ...
        34: 'Jeruzaléme, Jeruzaléme, který zabíjíš proroky a kamenuješ ty, kteří jsou k tobě posláni, kolikrát jsem chtěl shromáždit tvé děti jako slepice svá kuřata pod křídla, ale nechtěli jste.',
        35: 'Hle, váš dům se vám zanechává [pustý]. Pravím vám, že mne zajisté nespatříte, dokud [nepřijde ten den, kdy] řeknete: Požehnaný, který přichází ve jménu Pána. “',
    },
    14: {
        ...
        14: 'a budeš blahoslavený, protože nemají, čím ti odplatit; bude ti odplaceno při zmrtvých vstání spravedlivých.“',
    ...
    16: {
        ...
        16: 'Zákon a Proroci až do Jana; od té chvíle se zvěstuje Boží království a každý ⌈je do něho naléhavě zván⌉.',
        17: 'Je však snadnější, aby pominuly nebe a země, než aby padla jedna čárka Zákona.',
        18: 'Každý, kdo propouští svou ženu a žení se s jinou, cizoloží, a kdo se žení s tou, kterou muž propustil, cizoloží.“',
    ...
    19: {
        ...
        14: 'Avšak jeho spolu občané ho nenáviděli a poslali za ním poselstvo se slovy: Nechceme, aby nad námi tento člověk kraloval.',
    ...
    20: {
        ...
        36: 'Vždyť již nebudou moci ani zemřít, neboť budou jako andělé a budou synové Boží, jsouce syny zmrtvých vstání.',
    ...
    21: {
        ...
        4: 'Neboť ti všichni v hodili k [Božím] darům ze svého přebytku, tato však v hodila ze svého nedostatku celé ⌈svoje živobytí⌉.“',
        ...
        11: 'budou veliká země třesení a na různých místech hlad a mor, budou hrůzy a veliká znamení z nebe.',
