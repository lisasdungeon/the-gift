...
CHAPTERS = {
    1: {
        ...
        10: 'Neoznamujte to v Gatu, vůbec neplačte! V Bét–leafře se válej v prachu.',
        11: '⌈Obyvatelé Šafíru, jděte dál⌉ v ⌈nahotě a hanbě.⌉ Obyvatelé Saanánu ne mohli vyjít. Kvílení Bét–eselu ⌈vás připraví o⌉ místo k přebývání.',
        12: 'Obyvatelé Marótu ⌈zeslábli touhou po dobru,⌉ ale od Hospodina sestoupilo do brány Jeruzaléma zlo.',
        13: 'Zapřáhněte vozy k ořům, obyvatelé Lakíše! Zde je počátek hříchu pro dceru sijónskou, neboť v tobě tkví přestoupení Izraele.',
    ...
    4: {
        1: 'I stane se v ⌈posledních dnech,⌉ že hora Hospodinova domu bude stát pevně jako ⌈přední z hor⌉ a bude vyvýšena nad návrší. Budou k ní proudit lidé',
        2: 'a mnohé národy přijdou a řeknou: Pojďte a vystupme na Hospodinovu horu, do domu ⌈Boha Jákobova.⌉ Bude nás učit svým cestám a my budeme chodit po jeho stezkách. Vždyť ze Sijónu vyjde zákon a Hospodinovo slovo z Jeruzaléma.',
        ...
        4: 'Každý bude pobývat pod svou révou a pod svým fíkovníkem a nikdo ho ne vyděsí. Vždyť ⌈promluvila ústa Hospodina⌉ zástupů.',
        ...
        10: 'Svíjej se bolestí a křič jako rodička, dcero sijónská, neboť nyní vyjdeš z města, budeš přebývat na poli a přijdeš až do Babylona. Tam budeš zachráněna, tam tě Hospodin vykoupí z ruky tvých nepřátel.',
        11: 'Nyní se proti tobě shromáždily mnohé národy, které říkají: Ať je znesvěcen, ať se naše oči vynadívají na Sijón.',
        12: 'Oni však neznají Hospodinovy úmysly, nerozumějí jeho plánu, že je shromáždil jako snopy na humno.',
        13: 'Povstaň a mlať, dcero sijónská, neboť tvé rohy proměním v železo, tvá kopyta proměním v bronz a rozdrtíš mnohé národy. Jejich nekalý zisk pro Hospodina zasvětím zkáze a jejich majetek pro ⌈Pána celé země.⌉',
        14: 'Nyní se houfuj, dcero loupežné hordy. Nachystal na nás obležení. Holí budou bít po tváři soudce Izraele.',
    },
    5: {
    ...
    7: {
        1: 'Běda mi, protože ⌈se mi vede jako po sklizni⌉ letního ovoce, jako po paběrkování vinobraní: Ani hrozen k jídlu, ani raný fík, po kterém toužím.',
        ...
        6: 'Neboť syn jedná opovržlivě vůči otci, dcera povstává proti matce, snacha proti tchyni; nepřáteli člověka jsou ⌈lidé z jeho vlastní rodiny.⌉',
