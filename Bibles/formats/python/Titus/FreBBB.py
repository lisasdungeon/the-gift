...
CHAPTERS = {
    ...
    2: {
        ...
        7: 'te montrant toi-même en toutes choses comme un modèle de bonnes œuvres; mettant dans ton enseignement de la pureté, de la dignité,',
    ...
    3: {
        1: "Rappelle-leur d'être soumis aux principautés, aux autorités, d'obéir, d'être prêts à toute bonne œuvre;",
        ...
        5: "il nous a sauvés, non par des œuvres de justice que nous eussions faites, mais selon sa miséricorde, par le baptême de la régénération et par le renouvellement de l'Esprit-Saint,",
        ...
        8: "Cette parole est certaine, et je veux que tu établisses fortement ces choses, afin que ceux qui ont cru en Dieu aient soin de s'appliquer les premiers aux bonnes œuvres: voilà les choses qui sont bonnes et utiles aux hommes.",
        ...
        14: "Et que les nôtres apprennent aussi à s'appliquer les premiers aux bonnes œuvres, pour les besoins nécessaires, afin qu'ils ne soient pas sans fruit.",
