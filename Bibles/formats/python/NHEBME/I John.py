...
CHAPTERS = {
    1: {
        ...
        3: 'that which we have seen and heard we declare to you also, that you also may have fellowship with us. Yes, and our fellowship is with the Father, and with his Son, Yeshua the Messiah.',
    ...
    2: {
        1: 'My little children, I write these things to you so that you may not sin. If anyone sins, we have an Advocate with the Father, Yeshua the Messiah, the righteous.',
        ...
        18: 'Little children, these are the end times, and as you heard that the Anti-Messiah is coming, even now many anti-Christs have arisen. By this we know that it is the final hour.',
    ...
    4: {
        ...
        3: 'and every spirit who does not confess Yeshua is not of God, and this is the spirit of the Anti-Messiah, of whom you have heard that it comes. Now it is in the world already.',
