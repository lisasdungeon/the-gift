NAME = 'NHEBME: New Heart English Bible: Messianic Edition'
BOOK = 'Jude'

CHAPTERS = {
    1: {
        1: 'Judah, a servant of Yeshua the Messiah, and brother of Jacob, to those who are called, loved by God the Father, and kept for Yeshua the Messiah:',
        2: 'Mercy to you and peace and love be multiplied.',
        3: 'Beloved, while I was very eager to write to you about our common salvation, I was constrained to write to you exhorting you to contend earnestly for the faith which was once for all delivered to the saints.',
        4: 'For there are certain men who crept in secretly, even those who were long ago written about for this condemnation: ungodly men, turning the grace of our God into lasciviousness, and denying our only Master and Lord, Yeshua the Messiah.',
        ...
        25: 'to the only God our Savior, through Yeshua the Messiah our Lord, be glory and majesty, dominion and power, both now and forever. Amen.',
    },
}
