...
CHAPTERS = {
    ...
    13: {
        ...
        5: 'It shall be, when the Lord your God shall bring you into the land of the Canaanite, and the Hittite, and the Amorite, and the Hivite, and the Jebusite, which he swore to your fathers to give you, a land flowing with milk and honey, that you shall keep this service in this month.',
    ...
    16: {
        ...
        4: 'Then said the Lord to Moses, "Behold, I will rain bread from heaven for you, and the people shall go out and gather a day\'s portion every day, that I may test them, whether they will walk in my law, or not.',
    ...
    32: {
        ...
        11: 'Moses begged the Lord his God, and said, "O Lord, why does your wrath burn hot against your people, that you have brought forth out of the land of Egypt with great power and with a mighty hand?',
        ...
        29: 'Moses said, "Consecrate yourselves today to the Lord, yes, every man against his son, and against his brother; that he may bestow on you a blessing this day."',
    ...
    33: {
        1: 'The Lord spoke to Moses, "Depart, go up from here, you and the people that you have brought up out of the land of Egypt, to the land of which I swore to Abraham, to Isaac, and to Jacob, saying, \'I will give it to your seed.\'',
        ...
        5: 'The Lord said to Moses, "Tell the children of Israel, \'You are a stiff-necked people. If I were to go up into your midst for one moment, I would consume you. Therefore now take off your jewelry from you, that I may know what to do to you.\'"',
        6: 'The children of Israel stripped themselves of their jewelry from Mount Horeb onward.',
        7: 'Now Moses used to take the tent and to pitch it outside the camp, far away from the camp, and he called it "The Tent of Meeting." It happened that everyone who sought the Lord went out to the Tent of Meeting, which was outside the camp.',
        ...
        11: 'The Lord spoke to Moses face to face, as a man speaks to his friend. He turned again into the camp, but his servant Joshua, the son of Nun, a young man, did not depart out of the Tent.',
    ...
    34: {
        ...
        4: 'He chiseled two tablets of stone like the first; and Moses rose up early in the morning, and went up to Mount Sinai, as the Lord had commanded him, and took in his hand two stone tablets.',
        ...
        27: 'The Lord said to Moses, "Write you these words: for in accordance with these words I have made a covenant with you and with Israel."',
        ...
        32: 'Afterward all the children of Israel came near, and he gave them all of the commandments that the Lord had spoken with him on Mount Sinai.',
    ...
    35: {
        ...
        24: "Everyone who did offer an offering of silver and brass brought the Lord 's offering; and everyone, with whom was found acacia wood for any work of the service, brought it.",
    ...
    36: {
        1: '"Bezalel and Oholiab shall work with every wise-hearted man, in whom the Lord has put wisdom and understanding to know how to work all the work for the service of the sanctuary, according to all that the Lord has commanded."',
    ...
    39: {
        ...
        43: 'Moses saw all the work, and behold, they had done it as the Lord had commanded, even so had they done it: and Moses blessed them.',
    },
    40: {
        1: 'The Lord spoke to Moses, saying,',
