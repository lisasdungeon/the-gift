...
CHAPTERS = {
    ...
    5: {
        ...
        17: 'Therefore if anyone is in Messiah, he is a new creation. The old things have passed away. Behold, new things have come.',
    ...
    11: {
        ...
        3: 'But I am afraid that somehow, as the serpent deceived Eve in his craftiness, so your minds might be corrupted from a sincere and pure devotion to Messiah.',
    ...
    13: {
        ...
        14: 'The grace of the Lord Yeshua the Messiah, the love of God, and the fellowship of the Holy Spirit, be with you all.',
    },
}
