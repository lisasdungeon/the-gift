...
CHAPTERS = {
    ...
    3: {
        ...
        6: 'that the Gentiles are fellow heirs, and fellow members of the body, and fellow partakers of the promise in Messiah Yeshua through the Good News,',
    ...
    5: {
        ...
        29: 'For no man ever hated his own flesh; but nourishes and cherishes it, even as Messiah also does the congregation;',
