...
CHAPTERS = {
    ...
    2: {
        ...
        16: "Dans sa pensée, nous sommes d'impures scories, il évite notre manière de vivre comme une souillure; il proclame heureux le sort final des justes, et se vante d'avoir Dieu pour père.",
        17: "Voyons donc si ce qu'il dit est vrai, et examinons ce qui lui arrivera au sortir de cette vie.",
        ...
        24: "C'est par l'envie du diable que la mort est venue dans le monde; ils en feront l'expérience, ceux qui lui appartiennent.",
    },
    3: {
    ...
    4: {
        ...
        10: 'Étant agréable à Dieu, il était aimé de lui, et, comme il vivait parmi les pécheurs, il a été transféré.',
    ...
    5: {
        ...
        10: "comme le navire qui fend l'onde agitée, sans qu'on puisse découvrir la trace de son passage, ni la marque de sa quille au milieu des flots;",
        11: "ou comme l'oiseau traversant les airs, sans qu'on relève aucun vestige de sa route; mais il bat à coups de plumes l'air léger, d'un puissant élan il le déchire, s'y fait un chemin en agitant ses ailes; puis, on n'y voit pas aucun indice de son passage;",
    ...
    6: {
        1: "Écoutez donc, ô rois, et comprenez; écoutez l'instruction, vous qui jugez les extrémités de la terre.",
    ...
    7: {
        ...
        22: "car la sagesse, ouvrière de toutes choses, me l'a enseigné. En elle, en effet, il y a un esprit intelligent, saint, unique, multiple, immatériel, actif, pénétrant, sans souillure, infaillible, impassible, aimant le bien, sagace, ne connaissant pas d'obstacle, bienfaisant,",
    ...
    12: {
        ...
        5: "et à des meurtres cruels d'enfants, dévorant des chairs humaines et s'abreuvant de sang. Ces initiés à d'abominables mystères,",
    ...
    15: {
        ...
        12: "Il regarde notre existence comme un amusement, la vie comme un marché où l'on se rassemble pour le gain; car, disent-ils, « il faut acquérir par tous les moyens, même par le crime. »",
    ...
    16: {
        ...
        20: 'Au lieu de cela, vous avez rassasié votre peuple de la nourriture des anges, et vous leur avez donné du ciel, sans travail, un pain tout préparé, procurant toute jouissance et approprié à tous les goûts.',
        21: "Cette substance, envoyée par vous, montrait la douceur que vous avez envers vos enfants, et ce pain, s'accommodant au désir de celui qui le mangeait, se changeait en ce qu'il voulait.",
    ...
    18: {
        1: 'Cependant une grande lumière brillait pour vos saints; les Égyptiens entendaient leur voix sans voir leur visage, et, malgré leurs souffrances passées, les proclamaient heureux.',
    ...
    19: {
        ...
        4: "Une juste nécessité les entraînait à cette fin, et leur faisait oublier ce qui venait de leur arriver, afin qu'ils subissent dans la pleine mesure le châtiment qui manquait encore à leurs précédents supplices,",
