...
CHAPTERS = {
    ...
    8: {
        1: '엘리사가 이전에 아들을 다시 살려준 여인에게 이르되 너는 일어나서 네 권속과 함께 거할만한 곳으로 가서 거하라 여호와께서 기근을 명하셨으니 그대로 이 땅에 칠 년 동안 임하리라',
        2: '여인이 일어나서 하나님의 사람의 말대로 행하여 그 권속과 함께 가서 블레셋 사람의 땅에 칠 년을 우거하다가',
        3: '칠 년이 다하매 여인이 블레셋 사람의 땅에서 돌아와서 자기 집과 전토를 위하여 호소하려 하여 왕에게 나아갔더라',
        ...
        16: '이스라엘 왕 아합의 아들 요람 제오년에 유다 왕 여호사밧이 오히려 위에 있을 때에 그 아들 여호람이 왕이 되니라',
    ...
    9: {
        ...
        20: '파수꾼이 또 고하여 가로되 저도 저희에게까지 갔으나 돌아오지 아니하고 그 병거 모는 것이 님시의 손자 예후의 모는 것 같이 미치게 모나이다',
    ...
    17: {
        ...
        16: '그 하나님 여호와의 모든 명령을 버리고 자기를 위하여 두 송아지 형상을 부어 만들고 또 아세라 목상을 만들고 하늘의 일월성신을 숭배하며 또 바알을 섬기고',
        ...
        20: '여호와께서 이스라엘의 온 족속을 버리사 괴롭게 하시며 노략꾼의 손에 붙이시고 심지어 그 앞에서 쫓아내시니라',
    ...
    18: {
        ...
        17: '앗수르 왕이 다르단과 랍사리스와 랍사게로 대군을 거느리고 라기스에서부터 예루살렘으로 가서 히스기야 왕을 치게 하매 저희가 예루살렘으로 올라가니라 저희가 올라가서 윗못 수도 곁 곧 세탁자의 밭에 있는 큰 길에 이르러 서니라',
        ...
        20: '네가 싸울만한 계교와 용력이 있다고 한다마는 이는 입에 붙은 말뿐이라 네가 이제 누구를 의뢰하고 나를 반역하였느냐',
        ...
        28: '랍사게가 드디어 일어서서 유다 방언으로 크게 소리질러 불러 가로되 너희는 대왕 앗수르 왕의 말씀을 들으라',
    ...
    20: {
        ...
        5: '너는 돌아가서 내 백성의 주권자 히스기야에게 이르기를 왕의 조상 다윗의 하나님 여호와의 말씀이 내가 네 기도를 들었고 네 눈물을 보았노라 내가 너를 낫게 하리니 네가 삼 일만에 여호와의 전에 올라가겠고',
        ...
        14: '선지자 이사야가 히스기야 왕에게 나아와서 이르되 이 사람들이 무슨 말을 하였으며 어디서부터 왕에게 왔나이까 히스기야가 가로되 먼 지방 바벨론에서 왔나이다',
