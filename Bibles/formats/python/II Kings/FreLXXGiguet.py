...
CHAPTERS = {
    1: {
        ...
        10: 'Or, Élie répondit: Si je suis un homme de Dieu, le feu du ciel va tomber et dévorer toi et tes cinquante hommes. Aussitôt, le feu du ciel tomba et dévora le chef avec sa troupe.',
    ...
    2: {
        1: 'Or, dans le temps que le Seigneur ravit Élie, comme au ciel au milieu d’un tourbillon, Élie et Élisée sortirent de Galgala.',
        ...
        3: 'Et les fils des prophètes qui étaient à Béthel, s’approchèrent d’Élisée, et ils lui dirent: Ne sais-tu pas qu’aujourd’hui le Seigneur doit ravir ton maître au-dessus de ta tête? Il répondit: Oui, je le sais, gardez le silence.',
        ...
        9: 'Pendant qu’ils traversaient le Jourdain, Élie dit à Élisée Demande ce que je ferai pour toi avant d’être ravi loin de toi. Élisée répondit: Que j’aie part à ton double esprit.',
        ...
        11: 'Ils parlaient ainsi en marchant, et voilà qu’un char de feu et des chevaux de feu les séparèrent l’un de l’autre; puis, Élie fut ravi dans un tourbillon comme au ciel.',
    ...
    3: {
        ...
        15: 'Maintenant, amenez-moi un joueur de harpe. Or, dans le temps que celui-ci jouait, la main du Seigneur fut sur Élisée.',
    ...
    4: {
        ...
        5: 'Elle s’éloigna d’Élisée; et ferma sa porte sur elle et sur ses fils: ceux-ci lui apportèrent les vases, elle y versa l’huile jusqu’à ce qu’ils en fussent pleins.',
        6: 'Et elle dit à ses fils: Approchez encore un vase. Il n’y en a plus, dirent-ils. Et l’huile cessa de couler.',
        7: 'Alors elle alla trouver l’homme de Dieu, et lui raconta ce qui venait d’arriver. Élisée lui dit: Pars, et donne de l’huile en paiement; tu acquitteras ainsi ta dette; ensuite, toi et tes deux fils vous vivrez du reste de l’huile.',
        ...
        27: 'Puis, elle aborda Élisée sur la montagne, elle lui baisa les pieds, et Giézi s’avança pour la repousser; mais Élisée lui dit: Laisse-la, car son âme est pleine de douleur, et le Seigneur s’est caché de moi; il ne me l’a point dit.',
        28: 'Et la femme ajouta: Est-ce que j’avais demandé à mon maître un fils? N’avais-je point dit: Ne me trompe pas?',
        29: 'Et Élisée dit à Giézi: Ceins-toi les reins, prends en ta main mon bâton, et pars; si tu rencontres un homme, ne le bénis pas; si un homme te bénit, ne lui réponds pas; ensuite, tu poseras mon bâton sur le visage de l’enfant.',
        30: 'Et la mère de l’enfant dit: Vive le Seigneur et vive ton âme! je ne te quitterai point. Élisée se leva donc, et la suivit.',
        31: 'Cependant, Giézi la devança; il posa le bâton sur le visage de l’enfant; mais il n’y avait plus de voix pour lui répondre, plus d’oreilles pour l’ouïr; enfin il revint au-devant d’elle, et lui dit: L’enfant ne s’est point réveillé.',
    ...
    5: {
        ...
        14: 'Et Naaman, ayant mis pied à terre, se baigna sept fois dans le Jourdain selon la parole d’Élisée; et sa chair redevint comme la chair d’un petit enfant; il était guéri.',
    ...
    8: {
        ...
        10: 'Élisée dit: Retourne-t’en, et dis-lui: Tu vivras certainement; mais le Seigneur m’a appris qu’il mourrait.',
    ...
    11: {
        1: 'Et Athalie, mère d’Ochozias, ayant vu que son fils était mort, détruisit toute la race royale.',
    ...
    12: {
        1: 'Joas monta sur le trône la septième année du règne de Jéhu; il régna quarante ans à Jérusalem; le nom de sa mère était Sabía de Bersabée.',
        ...
        11: 'Puis, ils remirent l’argent qu’on avait recueilli entre les mains de ceux qui exécutaient les travaux signalés par les surveillants du temple du Seigneur; ils en donnèrent aussi aux charpentiers et aux constructeurs employés au temple,',
    ...
    14: {
        ...
        25: 'Ce fut lui qui rétablit les limites d’Israël, depuis l’entrée d’Emath jusqu’à la mer d’Araba, selon la parole que le Seigneur Dieu d’Israël avait fait connaître par son serviteur le prophète Jonas, fils d’Amathi, de Gethchopher;',
    ...
    15: {
        1: 'En la vingt-septième année du règne de Jeroboam en Israël, Azarias, fils d’Amasias, monta sur le trône de Juda.',
    ...
    20: {
        ...
        14: 'Mais le prophète, Isaïe alla trouver le roi Ezéchias, et il lui dit: Que t’ont dit ces hommes, et d’où sontils venus? Le roi répondit: Ils sont venus vers moi d’une contrée lointaine, de Babylone.',
    ...
    23: {
        ...
        30: 'Les serviteurs placèrent son corps sur un char, et le ramenèrent de Mageddo à Jérusalem, et ils l’ensevelirent dans son sépulcre; alors, le peuple de la terre prit Joachaz, fils de Josias; il le sacra, et il le proclama rọi à la place de son père.',
        31: 'Joachaz avait vingt-trois ans quand il monta sur le trône, et il régna trois mois à Jérusalem; le nom de sa mère était Amital, fille de Jérémie de Lobna.',
