...
CHAPTERS = {
    1: {
        1: 'Hans budskickning till Efter Ahabs död avföll Moab från Israel.',
    ...
    7: {
        1: 'Men Elisa svarade: »Hören HERRENS ord. Så säger HERREN: I morgon vid denna tid skall man få ett sea-mått fint mjöl för en sikel, så ock två sea-mått korn för en sikel, i Samarias port.»',
        2: 'Den kämpe vid vilkens hand konungen stödde sig svarade då gudsmannen och sade: »Om HERREN också gjorde fönster på himmelen, huru skulle väl detta kunna ske?» Han sade: »Du skall få se det med egna ögon, men du skall icke få äta därav.»',
        3: 'Utanför stadsporten uppehöllo sig då fyra spetälska män. Dessa sade till varandra: »Varför skola vi stanna kvar här, till dess vi dö?»',
        4: 'Om vi besluta oss för att gå in i staden nu då hungersnöd är i staden, så skola vi dö där, och om vi stanna här, skola vi ock dö. Välan då, låt oss gå över till araméernas läger; låta de oss leva, så få vi leva, och döda de oss, så må vi dö.»',
        5: 'Så stodo de då upp i skymningen för att gå in i araméernas läger. Men när de kommo till utkanten av araméernas läger, se, då fanns ingen människa där.',
        6: 'Ty Herren hade låtit ett dån av vagnar och hästar höras i araméernas läger, ett dån såsom av en stor här, så att de hade sagt till varandra: »Förvisso har Israels konung lejt hjälp mot oss av hetiternas och egyptiernas konungar, för att dessa skola komma över oss.»',
        7: 'Därför hade de brutit upp och flytt i skymningen och hade övergivit sina tält, sina hästar och åsnor, lägret sådant det stod; de hade flytt för att rädda sina liv.',
        8: 'När de spetälska nu kommo till utkanten av lägret, gingo de in i ett tält och åto och drucko, och togo därur silver och guld och kläder, och gingo så bort och gömde det. Sedan vände de tillbaka och gingo in i ett annat tält och togo vad där fanns, och gingo så bort och gömde det.',
        9: 'Men därefter sade de till varandra: »Vi bete oss icke rätt. I dag kunna vi frambära ett glädjebudskap. Men om vi nu tiga och vänta till i morgon, när det bliver dager, så skall det tillräknas oss såsom missgärning. Välan då, låt oss gå och berätta detta i konungens hus.',
    ...
    11: {
        1: 'När Atalja, Ahasjas moder, förnam att hennes son var död, stod hon upp och förgjorde hela konungasläkten.',
        ...
        12: 'Därefter förde han ut konungasonen och satte på honom kronan och gav honom vittnesbördet[1]; och de gjorde honom till konung och smorde honom. Och de klappade i händerna och ropade: »Leve konungen!»',
        ...
        20: 'Och hela folkmängden gladde sig, och staden förblev lugn. Men Atalja hade de dödat med svärd i konungshuset.',
        21: 'Joas var sju år gammal, när han blev konung. [1] Se vittnesbördet i Ordförkl.',
    },
    12: {
    ...
    16: {
        1: 'I Pekas, Remaljas sons, sjuttonde regeringsår blev Ahas, Jotams son, konung i Juda.',
    ...
    21: {
        ...
        13: 'Och mot Jerusalem skall jag bruka det mätsnöre[1] som jag brukade mot Samaria, och det sänklod som jag brukade mot Ahabs hus; och jag skall skölja Jerusalem tomt, såsom man sköljer ett fat och, sedan man har sköljt det, vänder det upp och ned.',
        ...
        25: 'Vad nu mer är att säga om Amon, om vad han gjorde, det finnes upptecknat i Juda konungars krönika. Och man begrov honom i hans grav i Ussas trädgård. Och hans son Josia blev konung efter honom. [1] Se Mätsnöre i Ordförkl.',
    },
    22: {
    ...
    23: {
        ...
        15: 'Också altaret i Betel, den offerhöjd som Jerobeam, Nebats son, hade byggt upp, han som kom Israel att synda, också detta altare med offerhöjden bröt han ned; därefter brände han upp offerhöjden[1] och stötte sönder den till stoft och brände tillika upp Aseran.',
        ...
        37: 'Han gjorde vad ont var i HERRENS ögon, alldeles såsom hans fäder hade gjort. [1] Se Höjd i Ordförkl.',
    },
    24: {
    ...
    25: {
        1: 'Och Sidkia avföll från konungen i Babel. Då, i hans nionde regeringsår, i tionde månaden; på tionde dagen i månaden, kom Nebukadnessar, konungen i Babel, med hela sin här till Jerusalem och belägrade det; och de byggde en belägringsmur runt omkring det.',
