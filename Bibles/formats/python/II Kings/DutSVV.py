...
CHAPTERS = {
    ...
    9: {
        ...
        17: 'De wachter nu stond op den toren te Jizreel, en zag den hoop van Jehu, als hij aankwam, en zeide: Ik zie een hoop. Toen zeide Joram: Neem een ruiter, en zend dien hunlieden tegemoet, en dat hij zegge: Is het vrede?',
    ...
    10: {
        ...
        23: 'En Jehu kwam met Jonadab, den zoon van Rechab, in het huis van Baal; en hij zeide tot de dienaren van Baal: Onderzoekt, en ziet toe, dat hier misschien bij u niemand zij van de dienaren van Baal alleen.',
    ...
    17: {
        ...
        9: 'En de kinderen Israels hadden de zaken, die niet recht zijn, tegen den HEERE, hun God, bemanteld; en hadden zich hoogten gebouwd in al hun steden, van den wachttoren af tot de vaste steden toe.',
        ...
        34: 'Tot op dezen dag toe doen die naar de eerste wijzen; zij vrezen den HEERE niet, en zij doen niet naar hun inzettingen, en naar hun rechten, en naar de wet, en naar het gebod, dat de HEERE geboden heeft aan de kinderen van Jakob, dien Hij den naam Israel gaf.',
    ...
    19: {
        ...
        28: 'Om uw woeden tegen Mij, en dat uw woeling voor Mijn oren opgekomen is, zo Mijn gebit in uw lippen, en Ik zal u doen wederkeren door dien weg, door denwelken gij gekomen zijt.',
