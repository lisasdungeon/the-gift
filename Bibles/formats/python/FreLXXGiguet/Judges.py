...
CHAPTERS = {
    1: {
        ...
        10: 'Et Juda marcha contre le Chananéen qui habitait Hébron, et tout Hébron sortit à sa rencontre; le nom d’Hébron était autrefois Cariath-Arboc-Sépher; Juda vainquit Sessi, Achiman et Tholmi, de la race d’Enac.',
        ...
        17: 'Ensuite, Juda marcha avec son frère Siméon; ils vainquirent le Chananéen qui habitait en Sépheth, ils l’exterminèrent, et ils donnèrent à cette ville le nom d’Anatheme.',
        ...
        26: 'L’homme s’en alla dans la terre d’Hettim; il y bâtit une ville, et il lui donna le nom de Luza, qu’elle porte encore de nos jours.',
        ...
        28: 'Mais, lorsque Israël eut pris des forces, il assujettit le Chananéen au tribut, quoiqu’il ne le détruisît pas.',
    ...
    2: {
        1: 'En ce temps-là, un ange du Seigneur vint de Galgala vers le Champ des Pleurs, vers Béthel et vers la maison de Joseph, à qui il dit: Voici ce que dit le Seigneur: Je vous ai fait sortir d’Égypte, je vous ai conduits en la terre que j’ai promise à vos pères, et j’ai dit: Je ne romprai pas l’alliance perpétuelle que j’ai faite avec vous.',
        ...
        12: 'Ils abandonnèrent le Seigneur Dieu de leurs pères qui les avait fait sortir de l’Égypte, et ils suivirent d’autres dieux parmi les dieux des nations qui les entouraient; ils les adorèrent, et ils excitèrent le courroux du Seigneur.',
        ...
        15: 'De quelque côté qu’ils marchassent. Et la main du Seigneur était sur eux pour leur mal, comme l’avait dit le Seigneur Dieu, comme il le leur avait juré, et il les affligea beaucoup.',
        16: 'Ensuite, le Seigneur suscita des juges, et le Seigneur sauva le peuple des mains de ceux qui en faisaient leur proie.',
        17: 'Et le peuple n’obéit pas aux juges, parce qu’il s’était prostitué à la suite des dieux étrangers, et qu’il les avait adorés; il dévia rapidement des voies où avaient marché ses pères; il cessa d’écouter comme eux la parole du Seigneur.',
        ...
        22: 'Pour éprouver par eux Israël, et voir s’il persévérerait ou non dans la voie du Seigneur qu’avaient suivie leurs pères.',
    ...
    3: {
        ...
        3: 'Les cinq principautés des Philistins, tout le Chananéen, et le Sidonien, et l’Évéen, qui habitait le Liban, depuis les montagnes d’Hermon jusqu’à Labo-Emath.',
        4: 'Et cela arriva pour que le Seigneur éprouvât par eux Israël, et pour qu’il connût si le peuple était docile aux commandements que Dieu avait intimés à ses pères par la voix de Moïse.',
        5: 'Les fils d’Israël habitaient donc au milieu du Chananéen, de l’Hettéen, de l’Amorrhéen, du Phérézéen, de l’Évéen et du Jébuséen.',
        ...
        9: 'Et les fils d’Israël crièrent au Seigneur, et le Seigneur suscita pour Israël un sauveur qui les délivra; ce fut Othoniel, fils de Cénez, frère puîné de Caleb.',
        ...
        19: 'Lui-même étant revenu des carrières de Galgal, dit à Eglom: O roi, un mot en secret. Et Eglom lui dit: Garde le silence. Et il éloigna tous ceux qui se tenaient auprès de lui.',
        20: 'Aod s’approcha de lui; or, il était assis tout à fait seul dans son appartement d’été. Et Aod lui dit: Ô roi, un mot de mon Dieu pour toi seul. Et Eglom se leva de son trône pour être plus près d’Aod.',
        ...
        24: 'Il sortit donc, et les serviteurs du roi survinrent; ils virent or, voilà que les portes de l’appartement étaient verrouillées; alors ils dirent: Ne va-t-il pas délivrer ses pieds dans l’appartement d’été?',
        25: 'Et ils attendirent jusqu’à ce que la rougeur leur vînt au visage; enfin, comme personne n’ouvrait la porte de l’appartement d’été, ils prirent la clef; ils ouvrirent, et virent leur maître étendu mort.',
        ...
        30: 'Ce jour-là Moab fut humilié par les mains d’Israël, et la terre resta en repos quatre-vingts ans, et Aod les jugea jusqu’à ce qu’il mourût.',
    ...
    4: {
        ...
        8: 'À quoi Barac répondit: Si tu pars avec moi, je partirai; sinon, je ne partirai pas car je ne sais pas le jour où le Seigneur me favorisera de la compagnie de son ange.',
        ...
        11: 'Or, Haber le Cinéen s’était éloigné de Caïna et des fils de Jobab, allié de Moïse; et il avait dressé sa tente vers le Chêne des Ravisseurs, qui touche à Cadès.',
        ...
        21: 'Et Jaël, femme d’Haber, prit un des clous de la tente; elle mit un marteau dans sa main, elle s’approcha de Sisara furtivement, et elle lui enfonça dans la tempe le clou qui traversa de part en part jusqu’à terre; et l’homme, perdant connaissance, fut enveloppé de ténèbres, et il mourut.',
    ...
    5: {
        ...
        3: 'Écoutez, rois; prêtez l’oreille, princes; je vais chanter un psaume au Seigneur Dieu d’Israël.',
        ...
        7: 'Les hommes forts ont manqué en Israël, ils ont manqué jusqu’à ce que vînt Débora, jusqu’à ce que s’élevât une mère en Israël.',
        ...
        10: 'Vous qui montez sur des ânesses belles et luisantes, vous qui êtes assis sur le siége où l’on rend la justice, vous qui vous avancez sur la route des siéges ou vers cette route; racontez ces hauts faits,',
        ...
        17: 'Galaad est de l’autre côté du Jourdain, où il a dressé ses tentes. Et Dan, pourquoi se tient-il sur ses barques? Aser s’est assis sur la côte maritime, il habite vers les embouchures de ses cours d’eau.',
        18: 'Le peuple de Zabulon a exposé sa vie à la mort; Nephthali est venu sur les hauts lieux de sa terre.',
        19: 'Les rois se sont rangés en bataille, les rois de Chanaan ont combattu en Thanaach, près des eaux de Mageddo; ils n’ont point recueilli de butin.',
        ...
        27: 'Et il roula entre ses pieds, il défaillit, et il mourut entre ses pieds; il s’était étendu devant elle, et il mourut dans son sommeil, et, au lieu même où il s’était endormi, la vie l’abandonna.',
    ...
    6: {
        ...
        6: 'Israël était tout appauvri devant la face de Madian.',
        7: 'Et les fils d’Israël crièrent au Seigneur, à cause de Madian.',
        8: 'Et le Seigneur envoya un prophète aux fils d’Israël, et l’homme leur dit: Voici ce que dit le Seigneur Dieu d’Israël Je suis Celui qui vous ai tirés de la terre d’Égypte, qui vous ai fait sortir de votre maison de servitude.',
        9: 'Je vous ai arrachés des mains de l’Égyptien et de tous ceux qui vous opprimaient; j’ai banni ceux-ci de devant votre face, et je vous ai donné leur territoire.',
        ...
        13: 'Et Gédéon dit: Je vous prie, mon Seigneur; si le Seigneur est avec nous, pourquoi ces maux nous sont-ils venus? Et où sont tous ces miracles que nous ont racontés nos pères, disant: N’est-ce point le Seigneur qui nous a fait sortir de l’Égypte? Maintenant, il nous a renversés, il nous a livrés aux mains de Madian.',
        ...
        20: 'Et l’ange de Dieu lui dit: Prends les chairs et les azymes, dépose-les sur cette pierre, et répands le jus pardessus; ainsi fit Gédéon.',
        ...
        30: 'Les hommes de la ville dirent alors à Joas: Amènenous ton fils; qu’il soit mis à mort, parce qu’il a renversé l’autel de Baal et qu’il a détruit le bois sacré situé auprès.',
        ...
        33: 'En ce temps-là, Madian, Amalec, et les fils de l’Orient, étaient rassemblés tous à la fois; ils campaient dans la vallée de Jezraël;',
        34: 'Et l’esprit du Seigneur vint en Gédéon; il fit sonner du cor, et sur ses pas Abiézer accourut à son secours.',
        35: 'Alors, il dépêcha des messagers à tout Manassé, à Azer, à Zabulon et à Nephthali, et il marcha au-devant des hommes de ces tribus.',
    ...
    7: {
        ...
        4: 'Et le Seigneur dit à Gédéon: Ce peuple est encore nombreux; fais-le descendre auprès de l’eau, et là je le purifierai pour toi. Et celui de qui je te dirai: Il doit marcher avec toi, marchera; celui de qui je te dirai: Il ne doit point marcher avec toi, ne marchera pas.',
        ...
        11: 'Écoute ce qu’ils diront; après cela, tes mains seront fortifiées, et tu descendras pour attaquer le camp. Il descendit, accompagné seulement de Phara, son serviteur, vers la plus avancée des compagnies de cinquante hommes qui étaient dans le camp.',
        ...
        17: 'Et il leur dit: Soyez attentifs à ce que je ferai, et faites de même. J’entrerai par la tête du camp, et comme je ferai vous ferez aussi.',
        ...
        22: 'Et les trois cents cors sonnaient toujours, et le Seigneur tourna l’épée de chaque Madianite contre son voisin dans le camp tout entier.',
        23: 'Le camp s’enfuit jusqu’à Bethséed, Tagaragatha, Abelméula, tirant vers Rabath. En Israël, Nephthali, Aser, tout Manassé apportèrent leur secours, et ils poursuivirent Madian.',
    ...
    8: {
        ...
        2: 'Et il leur dit: Qu’ai-je fait maintenant qui égale ce que vous avez fait? Une petite grappe d’Ephraïm ne vaut-elle pas mieux que la vendange d’Abiézer?',
        ...
        5: 'Et Gédéon dit aux hommes de Socchoth: Donnezmoi des pains pour nourrir le peuple qui me suit, car ils tombent de défaillance; et voilà que je poursuis Zébé et Salmana, rois de Madian.',
        ...
        7: 'Et Gédéon dit: À cause de votre refus, lorsque le Seigneur aura livré à nos mains Zébé et Salmana, je broierai vos chairs à force de coups d’épines du désert et de Barcenim.',
        ...
        9: 'Et Gédéon dit aux hommes de Phanuel: À mon retour, après la paix, je démolirai cette tour.',
        ...
        14: 'Et il surprit un jeune garçon des hommes de Socchoth; il le questionna, et il écrivit, d’après lui, les noms des chefs et des anciens de Socchoth: soixante-dixsept hommes.',
        ...
        33: 'Gédéon mort, les fils d’Israël se pervertirent; ils se prostituèrent aux Baal, et ils firent alliance avec Baal afin qu’il fût leur dieu.',
    ...
    9: {
        1: 'Et Abimélech, fils de Jérobaal, alla trouver à Sichem les frères de sa mère, et il parla à eux et à toute la famille du père de sa mère, disant:',
        ...
        3: 'Et les frères de sa mère parlèrent de lui à tous les hommes de Sichem, de sorte que leur cœur inclina pour Abimélech, parce que, dirent-ils, c’est notre frère.',
        4: 'Ils lui donnèrent donc soixante-dix sicles d’argent du temple du Baal-Bérith. Et Abimélech prit à son service des mercenaires méchants et dénués de tout, qui le suivirent.',
        ...
        6: 'Après cela, tous les hommes de Sichem, les juges, et toute la maison de Bethmaalo se réunirent, et ils marchèrent, et ils proclamèrent roi Abimélech, sous le chêne qui se trouva être le Chene de la sédition, à Sichem.',
        7: 'On l’apprit à Joatham, et il partit; il s’en fut sur la cime du mont Garizin; là, il éleva la voix, il pleura, et il leur dit Écoutez-moi, hommes de Sichem, et Dieu vous écoutera.',
        8: 'Les arbres se mirent en mouvement, et ils se rassemblèrent pour oindre un roi qui régnât sur eux, et ils dirent à l’olivier: Règne sur nous.',
        ...
        10: 'Et les arbres dirent au figuier: Viens, règne sur nous.',
        11: 'Et le figuier leur dit: Puis-je abandonner mon doux suc et mes excellents fruits, et m’en aller pour être élevé à la tête des autres arbres?',
        12: 'Et les arbres dirent à la vigne: Viens, règne sur nous.',
        ...
        14: 'Et tous les arbres dirent au nerprun: Viens, toi, et règne sur nous.',
        15: 'Et le nerprun dit aux arbres: Si, en vérité, vous me donnez l’onction pour que je règne sur vous, venez, demeurez sous mon ombre; sinon, qu’une flamme sorte de moi et qu’elle dévore les cèdres du Liban.',
        16: 'Et vous, maintenant, si c’est en vérité et en toute perfection que vous avez agi, et que vous avez proclamé roi Abimélech, si vous avez traité avec bienveillance Jérobaal et sa maison, et si vous avez dignement récompensé mon père',
        17: 'D’avoir commandé vos armées, jeté sa vie aux hasards des combats, et délivré Israël des mains de Madian;',
        18: 'Vous qui vous êtes soulevés aujourd’hui contre la maison de mon père, et avez tué sur une même pierre ses fils, soixante-dix hommes, et avez proclamé roi Abimélech, fils de sa servante, pour qu’il règne sur Sichem, parce qu’il est votre frère;',
        19: 'Si c’est en vérité et en toute perfection que vous avez agi envers Jérobaal et toute sa famille, faites votre joie d’Abimélech, et que lui aussi mette sa joie en vous.',
        20: 'Sinon, qu’une flamme sorte d’Abimélech, qu’elle dévore les hommes de Sichem et la maison de Bethmaalo, et qu’une flamme sorte des hommes de Sichem et de la maison de Bethmaalo, et qu’elle dévore Abimélech.',
        21: 'Ensuite, Joatham s’enfuit; il courut, et se rendit à Béor, où il demeura loin de son frère Abimélech.',
        22: 'Abimélech régna trois ans sur Israël.',
        23: 'Et Dieu envoya un mauvais esprit entre Abimélech et les hommes de Sichem; les hommes de Sichem méprisèrent la maison d’Abimélec, et rejetèrent sur lui',
        24: 'L’iniquité exercée contre les soixante-dix fils de Jérobaal; ils firent retomber le sang de ses frères, qu’il avait tués, sur lui, et sur les hommes de Sichem qui avaient prêté appui à ses mains pour qu’il tuât ses frères.',
        25: 'Alors, les hommes de Sichem lui dressèrent des embûches sur les cimes des monts; ils pillèrent tout ce qui passait près d’eux sur la route; et on vint l’annoncer au roi Abimélech.',
        26: 'Et Gaal, fils de Jobel, survint avec ses frères; ils passèrent à Sichem, et les hommes de Sichem espérèrent en lui.',
        27: 'Ils sortirent dans les champs, ils vendangèrent et ils pressurèrent le raisin, et ils formèrent des chœurs de danse. Ils firent des offrandes en la maison de leur dieu, ils mangèrent, ils burent, et ils maudirent Abimélech.',
        28: 'Et Gaal, fils de Jobel, dit: Qu’est donc Abimélech? quel est ce fils de Sichem pour que nous lui soyons asservis? N’est-il pas fils de Jérobaal? n’est-ce pas son serviteur Zébul qui vous surveille, vous et les fils d’Emmor, père de Sichem? Pourquoi donc leur serions-nous asservis?',
        29: 'Que l’on remette le peuple entre mes mains, et j’expulserai cet Abimélech, et je lui dirai: Complète ton armée et sors.',
        30: 'Or, Zébul, chef de la ville, apprit les discours de Gaal, fils de Jobel, et il en fut courroucé.',
        31: 'Et il dépêcha secrètement des messagers à Abimélech, disant: Voilà que Gaal, fils de Jobel, et ses frères, sont venus à Sichem, et ils campent autour de la ville contre toi.',
        32: 'Maintenant, pars au milieu de la nuit, avec la partie du peuple qui est pour toi, et dresse-leur une embuscade dans les champs.',
        33: 'Demain, au lever du soleil, tiens-toi prêt, étendstoi vers la ville; il marchera contre toi avec sa suite; alors tu lui feras tout le mal que tu pourras.',
        34: 'Abimélech et tous ses adhérents partirent donc au milieu de la nuit, et, formant quatre troupes, ils dressèrent une embuscade contre Sichem.',
        ...
        44: 'Abimélech et ses chefs poussèrent en avant, et ils s’arrêtèrent près des portes de la ville; en même temps les chefs des deux autres troupes se déployèrent contre tous ceux qui étaient dans les champs, et ils les vainquirent.',
        ...
        51: 'Il y avait au milieu de la ville une forte tour, où tous les hommes et les femmes de la ville se réfugièrent; ils fermèrent les portes sur eux, et ils montèrent sur la plate-forme de la tour.',
        ...
        55: 'Et les hommes d’Israël virent qu’Abimélech était mort, et chacun retourna en sa demeure.',
        56: 'Ainsi, Dieu fit retomber sur Abimélech sa cruauté envers sa famille paternelle, et le meurtre de ses soixantedix frères.',
        57: 'Et Dieu fit retomber sur la tête des hommes de Sichem toute leur méchanceté, et il accomplit contre eux la malédiction de Joatham, fils de Jérobaal.',
    },
    10: {
    ...
    11: {
        1: 'Jephté, fils de Galaad, était un homme très-fort; il était né d’une prostituée qui l’avait eu de Galaad.',
        2: 'Or, la femme de Galaad avait enfanté pour celui-ci des fils; et les fils de cette femme devinrent grands, et ils chassèrent Jephté, et ils lui dirent: Tu n’auras point part à l’héritage de notre père, parce que tu es le fils d’une prostituée.',
        3: 'Jephté s’enfuit donc de devant la face de ses frères, et il demeura en la terre de Tob. Et des hommes dénués de tout se rassemblèrent autour de Jephté, et ils sortirent avec lui.',
        4: 'Lorsque les fils d’Ammon furent en guerre avec Israël,',
        5: 'Les anciens de Galaad allèrent prendre Jephté en la terre de Tob.',
        6: 'Et ils dirent à Jephté: Viens, tu seras notre chef, et nous livrerons bataille aux fils d’Ammon.',
        7: 'Et Jephté dit aux anciens de Galaad: N’est-ce point vous qui m’avez haï, et qui m’avez expulsé de la maison paternelle, et qui m’avez chassé loin de vous? Pourquoi donc êtes-vous venus ici, maintenant que vous avez besoin de moi?',
        8: 'Et les anciens de Galaad dirent à Jephté: Nous sommes venus te trouver, pour que tu viennes avec nous, que tu combattes les fils d’Ammon, et que tu sois le chef de tous ceux qui habitent Galaad.',
        9: 'Et Jephté dit aux fils de Galaad: Si vous m’emmenez pour livrer bataille aux fils d’Ammon, et si le Seigneur me les livre, vous me laisserez dominer sur vous.',
        10: 'Et les anciens de Galaad dirent à Jephté: Que le Seigneur soit témoin entre nous, si nous n’agissons pas selon ta parole.',
        ...
        13: 'Le roi des fils d’Ammon dit aux envoyés de Jephté Parce qu’Israël, en venant d’Égypte, s’est emparé de mon territoire depuis l’Arnon jusqu’au Jaboc, et jusqu’au Jourdain; maintenant rends-nous-le pacifiquement, et je me retirerai.',
        ...
        16: 'En venant de l’Égypte, Israël a traversé le désert jusqu’à la mer de Siph, et est arrivé à Cadès.',
        ...
        19: 'Après cela, Israël a envoyé des messagers à Séhon, roi des Amorrhéens, roi d’Esebon, et Israël lui a dit: Permets que nous traversions ta terre jusqu’au pays qui nous appartient.',
        20: 'Séhon ne s’est pas fié à Israël pour le laisser traverser son territoire, et Séhon a rassemblé tout son peuple, et il a campé en Jasa, et il a combattu Israël.',
        21: 'Le Seigneur Dieu d’Israël a livré Séhon et tout son peuple aux mains d’Israël, qui l’a accablé; et Israël a pris possession de tout le territoire de l’Amorrhéen qui habitait cette terre,',
        22: 'Depuis l’Arnon jusqu’au Jaboc, et du désert au Jourdain.',
        23: 'Et maintenant que le Seigneur Dieu d’Israël a fait disparaître l’Amorrhéen de devant la face de son peuple Israël, ce serait toi qui prendrais son héritage?',
        ...
        25: 'D’ailleurs, l’emportes-tu en vaillance sur Balac, fils de Séphor, roi de Moab? Est-ce qu’il a combattu et combattu Israël? est-ce qu’il a lui fait guerre sur guerre,',
        26: 'Lorsque Israël eut habité trois cents ans Esebon et son territoire, Arœr et son territoire, et toutes les villes auprès du Jourdain? Et pourquoi donc pendant tout ce temps ne les as-tu pas réclamées?',
        27: 'Ce n’est donc point moi aujourd’hui qui ai failli envers toi; tu agis mal à mon égard, en apportant la guerre en ma contrée; que le Seigneur juge entre les fils d’Israël et les fils d’Ammon.',
        28: 'Or, le roi des fils d’Ammon ne fit point attention aux paroles que Jephté lui avait fait dire.',
        29: 'Et l’Esprit du Seigneur vint sur Jephté, qui traverṣa Galaad, Manassé, et passa au delà des hauteurs de Galaad, de l’autre côté des fils d’Ammon.',
        30: 'Et Jephté fit un vœu au Seigneur; il dit: Si vous livrez à ma main les fils d’Ammon,',
        ...
        33: 'Il les écrasa dans vingt villes, depuis Arœr jusqu’à l’Arnon, et jusqu’à Ebel-Charmin; il les frappa d’une très-grande plaie, et les fils d’Ammon furent humbles devant la face des fils d’Israël.',
        ...
        39: 'À la fin des deux mois, elle retourna vers son père, et il accomplit en elle le vœu qu’il avait fait; or, elle ne connut point d’homme, et elle fut l’occasion d’une loi en Israël.',
        40: 'D’âge en âge, les filles d’Israël s’en vont quatre jours par an pleurer la fille de Jephté, fils de Galaad.',
    },
    12: {
    ...
    13: {
        1: 'Et les fils d’Israël recommencèrent à faire le mal devant le Seigneur, et le Seigneur les livra pendant quarante années aux mains des Philistins.',
        ...
        3: 'Et l’ange du Seigneur apparut à la femme, et il lui dit: Femme stérile, toi qui n’avais point enfanté, voilà que tu concevras un fils.',
        4: 'Maintenant, garde-toi de boire du vin ou d’autre boisson enivrante, et ne mange rien d’impur.',
        5: 'Voilà que tu as un fruit en tes entrailles, et tu accoucheras d’un fils, et le fer ne passera point sur sa tête, parce que, dès le sein de sa mère, l’enfant sera Nazir de Dieu, et c’est lui qui commencera à délivrer Israël des Philistins.',
        ...
        14: 'Il ne mangera rien de ce qui sort de la vigne; il ne boira ni vin ni boisson enivrante, il ne mangera rien d’impur, il observera tout ce que j’ai prescrit à la femme.',
        15: 'Et Manué dit à l’ange du Seigneur: Laisse-nous te retenir ici, et nous préparerons devant toi un chevreau.',
        16: 'Mais l’ange du Seigneur dit à Manué: Si vous me retenez je ne mangerai pas de tes pains; si tu prépares un holocauste, offre-le au Seigneur. Or, Manué ne savait pas que c’était un ange du Seigneur.',
        17: 'Et Manué dit à l’ange du Seigneur: Quel est ton nom, afin que nous puissions te glorifier, quand tes paroles seront accomplies?',
        18: 'Et l’ange du Seigneur lui répondit: Pourquoi me demandes-tu mon nom, qui est Admirable?',
        19: 'Alors, Manué prit le chevreau et l’oblation; puis, il les offrit au Seigneur sur une pierre; il le fit en s’écartant des usages, et Manué et sa femme regardèrent.',
        20: 'Et il advint, pendant que la flamme s’élevait de l’autel jusqu’aux cieux, que l’ange du Seigneur monta dans la flamme; Manué et sa femme le virent, et ils tombèrent la face contre terre.',
        21: 'Et l’ange du Seigneur disparut aux yeux de Manué et de sa femme. Alors, Manué reconnut que c’était un ange du Seigneur.',
        22: 'Et il dit à sa femme: Nous mourrons de mort, parce que nous avons vu Dieu.',
        23: 'Mais sa femme lui répondit: Si le Seigneur avait voulu nous faire périr, il n’eût point pris de nos mains l’holocauste et les oblations; il ne nous eût point révélé ces choses; il ne nous eût point en cette occasion fait entendre ces paroles.',
        24: 'Et la femme accoucha d’un fils qu’elle nomma Samson; l’enfant devint grand, et le Seigneur le bénit.',
        25: 'Et au camp de Dan, l’Esprit du Seigneur commença à l’accompagner entre Saraa et Esthaol.',
    },
    14: {
        1: 'Et Samson descendit en Thamnatha, où il vit une femme parmi les filles des Philistins.',
        ...
        6: 'L’Esprit du Seigneur s’élança sur Samson, qui broya le lionceau comme il eût broyé une jeune chèvre; or, il n’avait rien dans les mains, et il ne raconta ce qu’il avait fait ni à son père ni à sa mère.',
        ...
        16: 'Alors, la femme de Samson pleura auprès de lui, et elle lui dit: Sans doute tu me hais; tu ne m’aimes point, puisque tu ne m’as pas expliqué l’énigme que tu as proposée aux enfants de mon peuple. Samson répondit: Si je ne l’ai expliquée ni à mon père ni à ma mère, te l’expliquerai-je à toi?',
        ...
        19: 'Aussitôt, l’Esprit du Seigneur s’élança sur lui; il alla en Ascalon, il y tua trente hommes, il prit leurs vêments, et il donna leurs tuniques changeantes à ceux qui avaient expliqué l’énigme. Et Samson fut courroucé, et il revint à la maison de son père.',
    ...
    16: {
        1: 'Et Samson alla à Gaza, où il vit une femme prostituée, chez laquelle il entra.',
        ...
        24: 'Et le peuple l’a vu, et il a chanté en l’honneur de son dieu, parce qu’il avait livré à ses mains l’ennemi, celui qui faisait de la patrie un désert, et qui multiplia it les morts parmi nous.',
        ...
        27: 'Or, le temple était rempli d’hommes et de femmes; il y avait là tous les chefs des Philistins, et, sur la plateforme, environ trois mille hommes et femmes, qui regardaient Samson et le jeu qu’on faisait de lui.',
        28: 'Et Samson pleura devant le Seigneur, et il dit: Seigneur Adonaï, souvenez-vous de moi, et me rendez encore une fois mes forces, ô mon Dieu! qu’une fois au moins je tire vengeance des Philistins, pour mes deux yeux.',
    ...
    17: {
        ...
        2: 'Et il dit à sa mère: Les onze cents sicles d’argent que tu as pris pour toi, et au sujet desquels tu m’as adjuré avec des imprécations, en me disant: « Vois, l’argent est avec moi; » ces sicles, je les ai pris. Et sa mère répondit: Béni soit mon fils, au nom du Seigneur.',
        ...
        4: "Et il rendit l’argen' à sa mère, qui en prit deux cents sicles pour les donner à un orfévre; celui-ci en âît une sculpture et un ouvrage en fonte; après quoi, ces images restèrent en la maison de Michas.",
        ...
        7: 'Or, il y avait un jeune homme de Bethleem en Juda qui était lévite, et demeurait là.',
    ...
    20: {
        ...
        5: 'Quand les hommes de Gabaa se levèrent contre moi; ils m’entourèrent dans la maison où j’étais logé, voulant me mettre à mort, et ils ont outragé ma femme, et elle en est morte.',
        6: 'Je l’ai saisie, je l’ai coupée en morceaux, et je l’ai envoyée sur toute l’étendue de l’héritage des fils d’Israël, parce qu’une souillure et une abomination ont été commises en Israël.',
        ...
        23: 'Or, les fils d’Israël étaient montés devant le Seigneur, et ils avaient pleuré jusqu’au soir, et ils avaient consulté le Seigneur, disant: Continueronsnous d’approcher pour combattre nos frères les fils de Benjamin? Et le Seigneur leur avait répondu: Marchez contre eux.',
        ...
        30: 'Et les fils d’Israel marchèrent, le troisième jour, contre les fils de Benjamin, et ils en vinrent aux mains, comme les deux autres fois, devant Gabaa.',
        ...
        33: 'Chacun quitta son poste pour reculer jusqu’à BaalThamar; cependant l’embuscade d’Israël survint de Maraagabé, où elle se tenait.',
        ...
        44: 'Là, dix-huit mille hommes de Benjamin périrent, tous dans la force de l’âge.',
