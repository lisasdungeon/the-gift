...
CHAPTERS = {
    ...
    4: {
        ...
        7: 'Mais le juste, s’il est prévenu par la mort, sera en repos.',
    ...
    7: {
        ...
        16: 'Car nous sommes en ses mains, nous et nos paroles, et toute notre sagesse, et la science de nos œuvres.',
    ...
    8: {
        ...
        8: 'Et si quelqu’un désire une grande expérience, la Sagesse sait le passé, elle prévoit l’avenir, elle connaît les subtilités du langage, et les solutions des problèmes; d’avance elle connaît les signes et les prodiges, les vicissitudes des saisons et des temps.',
        ...
        12: 'Quand je me tairai, ils seront dans l’attente; quand je parlerai, ils auront les yeux sur moi; et si je parle plus longuement, ils se mettront une main sur la bouche.',
    ...
    9: {
        1: 'Dieu de mes pères, Seigneur miséricordieux, qui par votre Parole avez créé toutes choses;',
        ...
        8: 'Vous m’avez dit de bâtir un temple sur votre montagne sainte, et un autel dans la cité de votre tabernacle, image du saint tabernacle que, dès le commencement, vous avez préparé.',
        ...
        10: 'Faites-la descendre des cieux, qui sont votre sanctuaire; envoyez-la du trône de votre gloire, afin qu’elle soit avec moi, qu’elle travaille avec moi, et que je sache ce qui vous est agréable.',
        ...
        19: 'Et par la Sagesse ils sont sauvés.',
    },
    10: {
        ...
        4: 'Inondée à cause de lui, la terre fut de nouveau sauvée par la Sagesse, qui fut le pilote du juste, voguant sur un bois de peu de prix.',
        ...
        10: 'C’est elle qui conduisit dans la voie droite le juste fuyant le courroux d’un frère; elle qui lui montra le royaume de Dieu, et lui donna la science des choses saintes; elle qui le récompensa de ses fatigues, et multiplia le fruit de ses travaux.',
    ...
    11: {
        ...
        7: 'Car, au lieu de la source intarissable du fleuve, les uns, tremblants, ont bu un sang immonde,',
        ...
        13: 'Car une double affliction les a saisis, et ils ont gémi en se souvenant du passé.',
        14: 'En effet, ils ont ouï que, par leur propre tourment, d’autres avaient reçu des bienfaits, et alors ils ont senti le Seigneur.',
        15: 'Quand jadis il était entré en explication avec eux, ils l’avaient méconnu et raillé; mais ils ont été bien surpris de l’issue des événements, n’ayant pas eu la même soif que les justes.',
        ...
        17: 'Afin qu’ils sachent que l’on est puni par où l’on a péché.',
        ...
        19: 'Ou de bêtes inconnues d’une nouvelle espèce, et pleines de rage: les unes soufflant un air enflammé ou une fumée infecte; les autres lançant de leurs yeux de terribles étincelles;',
        ...
        24: 'Mais vous avez pitié de tous, parce que vous pouvez tout; et vous feignez de ne point voir les péchés des hommes, en vue du repentir.',
        25: 'Vous aimez tous les êtres; vous n’avez en abomination rien de ce que vous avez créé, et vous n’avez rien préparé que vous dussiez haïr.',
    ...
    12: {
        ...
        3: 'Car vous avez pris en haine les anciens habitants de votre terre sainte,',
        ...
        8: 'Cependant vous avez eu pour eux des ménagements comme hommes; vous leur avez envoyé, comme les avant-coureurs d’une armée, des essaims de guêpes pour les détruire peu à peu.',
        ...
        11: 'Leur race, en effet, dès le commencement était maudite, et nul égard ne vous portait à laisser leurs péchés impunis.',
        ...
        18: 'Maître de votre force, vous jugez avec douceur et vous nous gouvernez avec beaucoup de ménagements; car il vous appartient de pouvoir quand vous voulez.',
        ...
        26: 'Et ceux que n’ont point avertis les dérisions de la réprimande, ont fait l’épreuve d’un jugement digne de Dieu.',
    ...
    14: {
        ...
        2: 'Car c’est là ce que le désir du gain a inventé, et la sagesse de l’artisan l’a ainsi préparé.',
    ...
    15: {
        1: 'Mais vous, ô mon Dieu, vous êtes bon et vrai; vous êtes patient, et vous gouvernez toutes choses avec miséricorde.',
    ...
    16: {
        ...
        12: 'Or il n’y eut ni herbe ni émollient qui les guérît; mais, ô Seigneur, ce fut votre Parole, cette Parole qui guérit tout.',
        ...
        16: 'Les impies, refusant de vous connaître, ont été flagellés par la force de votre bras; ils ont été persécutés par des plaies surnaturelles, par de la grêle, par des orages, et ils ont été dévorés par le feu.',
        ...
        20: 'Au contraire, vous avez distribué à votre peuple le pain des anges; vous avez envoyé pour lui le pain du ciel préparé sans labeur, plein de délices et en harmonie avec tous les goûts.',
        ...
        22: 'Au contraire, c’était pour vos ennemis une neige, une glace qui résistait au feu sans se fondre; et l’on n’ignorait pas que la flamme, en consumant les fruits des Égyptiens, brûlait au milieu de la grêle, et resplendissait au milieu des pluies.',
        ...
        26: 'Afin que les enfants aimés de vous, Seigneur, apprissent que ce n’est point le fruit qui nourrit l’homme, mais que votre Parole conserve ceux qui mettent leur confiance en vous.',
    ...
    17: {
        1: 'Vos jugements sont grands et inénarrables; c’est pourquoi des âmes sans discipline se sont égarées.',
        ...
        15: 'Et si l’un d’eux venait à tomber, n’importe où, il restait là enfermé dans cette prison sans fers.',
    ...
    18: {
        ...
        2: 'Et ils vous rendaient grâces de ce que ceux qui les avaient maltraités ne pouvaient plus leur nuire; et ils demandaient comme une faveur qu’il y eût cette différence entre eux et leurs ennemis.',
        ...
        4: 'Mais les Égyptiens méritaient d’être privés de lumière et d’être emprisonnés dans les ténèbres, pour avoir retenus enfermés vos enfants, par qui la lumière inaltérable de votre loi devait être répandue dans le siècle.',
        ...
        21: 'Car un homme irréprochable se hâta d’intercéder pour eux; revêtu de l’armure de son propre sacerdoce, de la prière et de l’encens de l’expiation, il s’opposa à votre colère, et mit fin à cette calamité en se montrant serviteur de Dieu.',
        ...
        24: 'Car le monde entier était dans sa robe sacerdotale, et la gloire des patriarches sur les quatre rangs de pierres gravées, et votre magnificence, ô Seigneur, sur le diadème de sa tête.',
    ...
    19: {
        ...
        4: 'Une juste nécessité les poussait à cette fin; et l’oubli de ce qui venait d’arriver les abusait, afin que le châtiment achevât ce qui manquait à leurs tortures,',
        5: 'Et que votre peuple fit l’essai d’une voie miraculeuse, tandis qu’eux-mêmes allaient trouver un genre de mort inconnu.',
        6: 'Car alors toute créature reçut d’en haut, sans changer de nature, une forme nouvelle, en obéissant à vos ordres, afin que vos fils échappassent sains et saufs.',
        ...
        12: 'Au gré de leurs désirs, Dieu fit lever pour eux de la mer des râles de cailles, dans le même temps que le châtiment atteignait les pécheurs, non sans en avoir été avertis par de grands coups de tonnerre; mais ils souffraient justement à cause de leurs péchés.',
        ...
        14: 'Et ce n’est pas tout: une autre considération, c’est que c’était un peuple étranger qu’ils avaient traité indignement.',
        ...
        16: 'Mais ils ont été frappés d’aveuglement, comme ceux qui, devant la porte d’un juste, enveloppés de ténèbres impénétrables, cherchaient tous la porte de leur propre demeure.',
        ...
        21: 'car, Seigneur, vous avez grandi votre peuple en toutes choses; vous l’avez glorifié, loin de le mépriser; vous l’avez assisté en tout temps et en tout lieu.',
    },
}
