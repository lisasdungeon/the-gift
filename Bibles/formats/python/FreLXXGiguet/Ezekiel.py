...
CHAPTERS = {
    1: {
        ...
        3: 'La parole du Seigneur vint à Ézéchiel, fils de Buzi, le prêtre, en la terre des Chaldéens, sur le fleuve Chobar. Et la main du Seigneur fut sur moi.',
        ...
        15: 'Et l’aspect des roues était comme l’aspect de Tharsis, et toutes les quatre étaient semblables. Et elles étaient faites comme s’il y avait eu une roue dans une roue.',
        16: 'Et elles allaient sur leurs quatre parties, et elles ne se retournaient pas en marchant,',
        17: 'Ni elles ni leurs moyeux; et elles étaient hautes;',
        18: 'Et quand les animaux marchaient, les quatre roues à côté d’eux marchaient, et quand les animaux s’élevaient au-dessus de terre, les roues s’élevaient.',
        19: 'Et partout où était la nuée, là aussi le vent soufflait; et les roues marchaient et s’élevaient avec les animaux; car un souffle de vie était dans les roues.',
        20: 'Quand les animaux marchaient, elles marchaient; quand ils s’arrêtaient, elles s’arrêtaient, et quand ils s’élevaient au-dessus de la terre, elles s’élevaient avec eux; car un souffle de vie était dans les roues.',
        21: 'Et au-dessus de la tête des animaux il y avait une image comme celle d’un firmament, semblable à du cristal, qui s’étendait au-dessus de leurs ailes.',
        22: 'Et, au-dessus du firmament, leurs ailes étaient étendues, battant l’une contre l’autre, et celles de dessous couvrant leurs corps.',
        23: 'Et j’entendis le bruit de leurs ailes pendant qu’ils marchaient, comme la voix des grandes eaux; et quand ils s’arrêtaient, leurs ailes se reposaient.',
        24: 'Et voilà qu’une voix sortit du firmament qui était au-dessus de leurs têtes,',
        25: 'Et qui ressemblait à un saphir, et qui supportait l’image d’un trône, sur lequel était une image semblable à un homme.',
        26: 'Et je vis comme une vision d’émail, depuis ses reins jusqu’en haut; et depuis ses reins jusqu’en bas je vis une vision de feu, et sa lueur formait un cercle,',
        27: 'Semblable à l’arc qui est dans la nuée les jours de pluie; telle était la forme de cette lueur en cercle.',
    },
    2: {
        ...
        9: 'Et je vis, et voilà qu’une main était étendue vers moi, et elle tenait le rouleau d’un livre, et elle le déroula devant moi, et il y avait des lettres des deux côtés des pages, et il y était écrit: Une lamentation, un chant de deuil, et des hélas!',
    },
    3: {
        ...
        18: 'Quand tu diras de ma part à l’impie: Tu mourras de mort; si tu ne lui enjoins pas de faire effort sur luimême pour se détourner de ses voies afin qu’il vive, cet impie mourra dans son iniquité, et je réclamerai son sang de ta main.',
        ...
        27: 'Mais quand je t’aurai parlé, je t’ouvrirai la bouche et tu leur diras: Voilà ce que dit le Seigneur: Que celui qui veut écouter écoute; que celui qui veut désobéir désobéisse; car c’est une maison qui m’irrite.',
    },
    4: {
        ...
        3: 'Prends ensuite pour toi-même une poêle de fer; puis tu en feras un mur de fer, que tu placeras entre toi et la ville; et tu tourneras ton visage contre la ville, et elle sera assiégée, et tu l’assiègeras; or ceci est un signe pour les enfants d’Israël.',
        ...
        11: 'Et tu boiras de l’eau à la mesure; tu boiras par in tervalle, le sixième du hin.',
    ...
    5: {
        ...
        4: 'Et tu en prendras encore, et tu les jetteras au milieu du feu, et tu les brûleras dans le feu; il en sortira une flamme, et tu diras à toute la maison d’Israël:',
    ...
    10: {
        ...
        3: 'Et quand l’homme y entra, les chérubins étaient à droite dans le temple, et une nuée remplit le parvis intérieur.',
        ...
        5: 'Et le bruit des ailes des chérubins s’entendit jusqu’au parvis extérieur, semblable à la voix du Dieu toutpuissant quand il parle.',
        6: 'Et ceci advint pendant que le Seigneur donnait ses ordres à l’homme revêtu de la robe sainte, disant: Prends du feu au milieu des roues, parmi les chérubins; l’homme entra et s’arrêta près des roues.',
        7: 'Et le Seigneur étendit la main sur le feu qui était parmi les chérubins, et il en prit, et il en remplit les mains de l’homme qui était revêtu de la robe sainte; et celui-ci le prit, et il sortit.',
        8: 'Et je vis les chérubins ayant l’image d’une main d’homme sur leurs ailes.',
        9: 'Et je vis, et voilà que les quatre roues étaient arrêtées près des chérubins; chaque roue touchait un chérubin, et l’aspect des roues était comme l’aspect d’une escarboucle.',
        10: 'Et, quant à leur aspect; elles avaient toutes les quatre le même aspect, c’était comme si une roue était au milieu d’une roue.',
        11: 'Lorsqu’elles allaient, elles allaient de leurs quatre parties, et en allant elles ne se retournaient pas; quel que fut le lieu qu’avait regardé la première tête, elles y allaient, et, en allant, elles ne se retournaient pas.',
        12: 'Et leurs moyeux, leurs mains, leurs ailes et leurs bandes étaient pleins d’yeux, tout alentour aux quatre roues.',
        13: 'Et tandis que j’écoutais, le nom de Gelgel fut donné aux quatre roues.',
        15: 'Et les chérubins étaient ces mêmes créatures vivantes que j’avais vues sur le fleuve Chobar.',
        16: 'Et quand les chérubins allaient, les roues allaient, et elles étaient tout près d’eux; et quand les chérubins étendaient les ailes pour s’élever au-dessus de terre, les roues ne se détournaient point d’eux.',
        17: 'Et quand ils s’arrêtaient, elles s’arrêtaient; et quand ils s’élevaient, elles s’élevaient avec eux, parce qu’il y avait en elles un esprit de vie.',
        18: 'Et la gloire du Seigneur sortit du temple, et alla sur les chérubins.',
        ...
        20: 'Et c’étaient les créatures vivantes que j’avais vues au-dessous du Dieu d’Israël, vers le fleuve de Chobar, et je reconnus que c’étaient des chérubins.',
        21: 'Chacun avait quatre faces et huit ailes, et sous les ailes l’image d’une main d’homme.',
        22: 'Et leurs visages se ressemblaient, et c’étaient les visages que j’avais vus sous la gloire du Dieu d’Israël, vers le fleuve Chobar, et chacun marchait droit devant lui.',
    },
    11: {
    ...
    13: {
        ...
        11: 'Dis à ceux qui le crépissent: Le mur tombera; il y aura de la pluie pour le faire crouler. Je lancerai des pierres sur ses jointures, et elles tomberont; et sur lui, un grand vent, et il se fendra.',
        ...
        15: 'Et j’assouvirai ma colère sur le mur, et sur',
    ...
    16: {
        ...
        10: 'Et je t’ai vêtue de robes brodées, et je t’ai chaussée',
        ...
        27: 'Mais je vais étendre la main contre toi; et je déracinerai tes habitudes, et je te livrerai aux âmes qui te haïssent, aux filles des étrangers, qui rougissent ellesmêmes de la voie où tu as commis tes impiétés.',
        ...
        39: 'Et je te livrerai à leurs mains, et ils démoliront ta maison de débauche, et ils détruiront les lieux où tu te prostituais, et ils te dépouilleront de tes vêtements,',
        ...
        48: 'Par ma vie, dit le Seigneur, Sodome et ses filles',
    ...
    17: {
        ...
        7: 'Et il vint un autre grand aigle, aux grandes ailes, aux serres nombreuses; et voilà que la vigne se plia autour de lui, et ses racines étaient près de lui, et elle lui envoya ses rameaux pour lui donner à boire de la séve de son plant.',
        ...
        9: 'Et à cause de cela, dis-leur: Ainsi parle le Seigneur: Prospérera-t-elle? Ses tendres racines, son fruit ne pourriront-ils pas? Ses bourgeons ne se dessécheront pas? Ne sera-t-elle pas déracinée par un bras puissant et par un peuple nombreux?',
        ...
        18: 'Et le roi de Jérusalem a méprisé son serment, et il a violé l’alliance, quand j’avais engagé sa main, il a fait toutes ces choses pour sa sûreté, mais il ne sera pas sauvé.',
    ...
    18: {
        ...
        8: 'Et il ne placera pas son argent à usure, et il ne prendra pas plus qu’il ne lui est dû, et il détournera sa main de l’iniquité, et il rendra un jugement juste entre un homme et son prochain.',
        ...
        12: 'Il aura opprimé le pauvre et le mendiant; il aura pris avec violence; il n’aura pas rendu le gage; il aura arrêté ses regards sur les idoles; il ́aura fait l’iniquité;',
        ...
        21: 'Et le pécheur, s’il revient de ses dérèglements, s’il garde tous mes commandements, s’il fait justice et miséricorde, vivra de la vie et ne mourra point.',
    ...
    20: {
        ...
        2: 'Et la parole du Seigneur me vint, disant:',
        3: 'Fils de l’homme, réponds aux anciens de la maison d’Israël, et dis-leur: Ainsi parle le Seigneur: Êtes-vous venus m’interroger? Par ma vie, dit le Seigneur, je ne vous répondrai pas.',
        4: 'Les punirai-je sévèrement, fils de l’homme? Faisleur connaître les iniquités de leurs pères.',
        5: 'Et dis-leur: Ainsi parle le Seigneur: Depuis le jour où je choisis la maison d’Israël, où je me manifestai à la race des fils de Jacob, où ils me connurent en Égypte, je les protégeai de ma main, disant: Je suis le Seigneur votre Dieu.',
        6: 'Ce jour-là même je les protégeai de ma main pour les conduire, de la terre d’Égypte, en la terre que je leur avais préparée, terre où coulent le lait et le miel, où les rayons des abeilles abondent plus qu’en aucune terre.',
        7: 'Et je leur dis: Que chacun de vous rejette loin de ses yeux les abominations; gardez-vous de vous souiller par les idoles de l’Égypte: je suis le Seigneur votre Dieu.',
        8: 'Et ils s’éloignèrent de moi, et ils ne voulurent point m’obéir, et ils ne rejetèrent pas loin de leurs yeux les abominations, et ils n’abandonnèrent pas les idoles de l’Égypte. Et je résolus de faire tomber sur eux ma fureur, et, au milieu même de l’Égypte, d’assouvir contre eux ma colère.',
        9: 'Mais je fis en sorte que mon nom ne fût pas entièrement profané à la vue des gentils au milieu desquels ils sont, et parmi lesquels je me suis manifesté à eux, pour les retirer de la terre d’Égypte.',
        10: 'Et je les conduisis dans le désert.',
        11: 'Et je leur donnai mes commandements, et je leur fis connaître mes ordonnances, qui sont telles que l’homme, en les observant, vivra en elles.',
        12: 'Et je leur prescrivis mes sabbats, pour être un signe entre eux et moi; pour qu’ils sussent que je suis le Seigneur qui les sanctifie.',
        ...
        14: 'Mais je fis en sorte que mon nom ne fût pas entièrement profané devant les gentils aux yeux desquels je les avais fait sortir de l’Égypte.',
        15: 'Et je retirai d’eux tout à fait ma main dans le désert, pour que nul d’eux n’entrât dans la terre que je leur avais donnée, terre où coulent le lait et le miel, et où les rayons des abeilles abondent plus qu’en aucune autre terre;',
        16: 'En punition de ce qu’ils avaient répudié mes ordonnances, de ce qu’ils n’avaient pas cheminé en mes commandements, qu’ils avaient profané mes sabbats, et avaient couru après les imaginations de leurs cœurs.',
        17: 'Mais mon œil s’apitoya sur eux quand je les fis périr, et je ne les détruisis pas tous entièrement dans le désert.',
        18: 'Et je dis à leurs enfants dans le désert: Ne marchez point sur les traces de vos pères; gardez mes ordonnances; ne vous mêlez point à ceux qui adorent les idoles, et ne vous souillez point par elles.',
        19: 'Je suis le Seigneur votre Dieu: cheminez en mes commandements; gardez mes ordonnances et mettez-les en pratique.',
        20: 'Sanctifiez mes sabbats; qu’ils soient un signe entre',
        21: 'Et leurs enfants m’irritèrent, et ils ne cheminèrent point en mes commandements, et ils ne regardèrent ni n’observèrent mes ordonnances, qui sont telles que parmi eux l’homme, en les observant, vivra en elles; et ils profanèrent mes sabbats, et je résolus de faire tomber sur eux ma fureur dans le désert et d’assouvir contre eux ma colère.',
        22: 'Mais je fis en sorte que mon nom ne fût pas entièrement profané devant les gentils, et je menai mon peuple hors de la vue de ses ennemis.',
        23: 'Je levai la main, dans le désert, contre les enfants de mon peuple, pour les disperser parmi les nations et les disséminer dans les royaumes,',
        ...
        25: 'Alors je leur donnai des commandements qui n’étaient point bons, et des ordonnances en lesquelles ils ne pourraient vivre.',
        26: 'Et je les souillerai en leurs propres croyances, lorsque je passerai sur leurs nouveau-nés pour les détruire.',
        27: 'À cause de cela, fils de l’homme, réponds à la maison d’Israël, et dis-lui: Ainsi parle le Seigneur: Vos pères ont provoqué ma colère par leurs péchés contre moi.',
        ...
        29: 'Et je leur ai dit: Qu’est-ce donc Abama, pour que vous y alliez? et ce nom d’Abama s’est conservé jusqu’à ce jour.',
        ...
        38: 'Et je choisirai parmi vous les impies et les rebelles; car je les ferai sortir des royaumes où ils sont comme passagers, et ils n’entreront pas en la terre d’Israël. Et vous saurez que je suis le Seigneur Maître.',
        ...
        42: 'Et vous saurez que je suis le Seigneur, lorsque je vous aurai ramenés en la terre d’Israël, dans la terre sur laquelle j’ai levé la main pour en faire don à vos pères.',
        43: 'Et là vous vous rappellerez vos voies, et les habitudes d’idolâtrie dont vous vous êtes souillés, et vous vous frapperez au visage au souvenir de toutes vos iniquités.',
        44: 'Et vous saurez que je suis le Seigneur, parce que je vous aurai ainsi traités, afin que mon nom ne soit pas profané en vos mauvaises voies et selon vos pensées corrompues, dit le Seigneur.',
        45: 'Et la parole du Seigneur me vint,',
        46: 'Fils de l’homme, tourne ton visage contre Théman, et regarde vers Darom, et prophétise contre la grande forêt du Nageb,',
        47: 'Et dis à la forêt du Nageb: Écoute la parole du Seigneur; ainsi parle le Seigneur Maître: Voilà que je vais allumer le feu en toi; et il brûlera en toi tout bois vert et tout bois sec, et la flamme une fois allumée ne s’éteindra pas, et elle brûlera tout visage, de l’orient à l’aquilon.',
        48: 'Et toute chair saura que moi, le Seigneur, j’ai allumé ce feu, et qu’il ne s’éteindra pas.',
    ...
    22: {
        ...
        19: 'À cause de cela, dis-lui: Ainsi parle le Seigneur',
        ...
        28: 'Et ses prophètes qui caressent le peuple tombe',
        ...
        31: 'Et j’ai versé sur elle le feu de ma colère, pour la détruire, et j’ai fait retomber leurs voies sur leurs têtes, dit le Seigneur Maître.',
    },
    23: {
        1: 'Et la parole du Seigneur me vint, disant:',
        ...
        16: 'Et les ayant contemplés de ses yeux, elle les aima',
        ...
        20: 'Et tu as aimé avec fureur les Chaldéens, qui avaient des chairs commes des ânes, et des membres comme des chevaux.',
        ...
        35: 'À cause de cela, voici ce que dit le Seigneur:',
    ...
    25: {
        ...
        15: 'À cause de cela, voici ce que dit le Seigneur: En punition de ce que les Philistins, en châtiant mon peuple, ont fait revivre leur propre vengeance, et se sont',
    ...
    27: {
        ...
        5: 'Le cèdre de Sénir a servi à construire tes vaisseaux; tes planches ont été prises en des poutres de cy',
        6: 'On a fait tes rames de bois de Basan; on a fait en ivoire tes choses saintes, et tes chambres ombragées d’arbres en bois des îles de Cétim.',
        ...
        31: 'Et leurs fils feront sur toi une lamentation, une lamentation sur Tyr, disant:',
        32: 'Quel profit as-tu retiré de la mer? Tu avais rempli de ton abondance toutes les nalions; tu avais enrichi par ton trafic tous les rois de la terre.',
        33: 'Maintenant tu es brisée dans la mer; tes trafiquants sont au fond de l’abîme, avec toute la multitude assemblée en toi.',
        34: 'Tous tes rameurs sont tombés; tous les habitants des îles se sont affligés sur toi; leurs rois ont été saisis de stupeur, et leur visage s’est couvert de larmes.',
        35: 'Les marchands des nations t’ont sifflée; tu es perdue, et tu ne seras plus dans les siècles.',
    },
    28: {
        1: 'Et la parole du Seigneur me vint, disant:',
        ...
        3: 'Es-tu plus sage que Daniel? Les sages ne t’ontils pas instruit de leur science?',
        ...
        11: 'Et la parole du Seigneur me vint, disant: Fils de l’homme, fais une lamentation sur le roi de Tyr;',
        ...
        22: 'Et je dis Ainsi parle le Seigneur: Voilà que je suis contre toi, Sidon, et je serai glorifié en toi, et tu connaîtras que je suis le Seigneur, lorsque j’aurai exercé mes jugements sur toi, et que je serai sanctifié en toi.',
    ...
    29: {
        1: 'En la douzième année, le dixième mois, le premier jour du mois, la parole du Seigneur me vint, disant:',
        2: 'Fils de l’homme, tourne ton visage contre le Pharaon, roi d’Égypte, et prophétise contre lui et contre l’Égypte entière.',
        ...
        4: 'Je mettrai un hameçon dans tes mâchoires; je collerai à tes nageoires les poissons de ton fleuve, et je te tirerai du milieu de ton fleuve.',
        5: 'Et je te jetterai soudain sur le rivage avec tous les poissons de ton fleuve. Tu tomberas sur la face de la terre; tu ne seras pas relevé; tu ne seras pas enseveli; je t’ai donné en pâture aux bêtes de la terre et aux oiseaux du ciel.',
        6: 'Et tous ceux qui habitent l’Égypte sauront que je suis le Seigneur. En punition de ce que tu as été pour la maison d’Israël un appui faible comme un roseau.',
        7: 'Lorsqu’elle te tenait par la main, tu as plié; et lorsque par dérision on l’applaudissait des mains, et qu’elle se reposait sur toi, tu t’es brisé, et tu lui as rompu les reins.',
        8: 'À cause de cela, ainsi dit le Seigneur: Voilà que je tire contre toi le glaive, et j’exterminerai les hommes et le bétail.',
        9: 'Et il y aura ruine et désolation en la terre d’Égypte; et ils sauront que je suis le Seigneur; en punition de ce que tu as dit: Les fleuves sont à moi, c’est moi qui les ai créés.',
        10: 'En punition de cela, voilà que je suis contre toi et',
        11: 'Le pied de l’homme n’y posera plus, les troupeaux n’y passeront plus, et pendant quarante ans elle ne sera plus habitée.',
        12: 'Et je mettrai la terre d’Égypte au rang d’une terre déserte, et ses villes seront au rang des villes désertes pendant quarante ans. Et je disperserai l’Égypte parmi les nations, et je vannerai son peuple en tous lieux.',
        13: 'Et voici ce que dit le Seigneur: Après quarante ans, je rassemblerai les Égyptiens d’entre les nations où ils auront été dispersés.',
        14: 'Et je ferai rentrer les Égyptiens captifs, et je les établirai en la terre de Phathorès, en la terre d’où ils auront été enlevés; et ce sera un royaume humilié',
        15: 'Plus qu’aucun autre royaume. Elle ne s’élèvera plus au-dessus des nations; je les aurai réduits à un petit nombre pour qu’ils ne soient plus les plus grands parmi les peuples.',
        16: 'Et ils ne seront plus pour la maison d’Israël un espoir en qui elle ait confiance, lui rappelant son iniquité, lorsqu’elle se mit à leur suite; et ils sauront que je suis le Seigneur.',
        17: 'Et la vingt-septième année, le premier jour du premier mois, la parole du Seigneur me vint, disant:',
        18: 'Fils de l’homme, Nabuchodonosor, roi de Babylone, a fait servir son armée à frapper Tyr d’une grande servitude; toute tête y est devenue chauve, toute épaule ensanglantée. Et ni lui ni son armée n’ont reçu de salaire pour m’avoir servi contre elle.',
        19: 'Ainsi dit le Seigneur Maître: Voilà que je donne à Nabuchodonosor la terre d’Égypte, et il en fera sa proie, et il en enlèvera des dépouilles; ce sera le salaire de son armée;',
        20: 'En récompense du service qu’il m’a rendu contre Tyr, je lui donne la terre d’Égypte; voici ce que dit le Seigneur Maître.',
        21: 'En ce jour une corne sortira du front de toute la maison d’Israël; et, au milieu d’elle, je t’ouvrirai la houche, et ils sauront que je suis le Seigneur.',
    },
    30: {
        1: 'Et la parole du Seigneur me vint, disant:',
        2: 'Fils de l’homme, prophétise et dis: Voici ce que dit le Seigneur: Malheur, malheur en ce jour!',
        3: 'Car le jour du Seigneur est proche; c’est un jour de nuages; c’est la fin des nations.',
        4: 'Et le glaive viendra sur l’Égypte, et le trouble sera dans l’Éthiopie, et les morts tomberont tous à la fois en la terre d’Égypte, et avec eux tomberont ses fondements.',
        5: 'Perses et Crétois, Lydiens et Libyens, et tous ceux parmi les fils de mon alliance qui se seront mêlés à ces peuples, périront chez elle par le glaive.',
        ...
        7: 'Et elle sera au rang des terres désertes, et ses villes au rang des villes désertes.',
        8: 'Et l’on saura que je suis le Seigneur, lorsque j’aurai',
        9: 'En ce jour, des messagers partiront rapidement pour détruire l’Éthiopie, et le trouble sera en elle au jour fatal de l’Égypte; et voilà que ce jour approche.',
        10: 'Voici ce que dit le Seigneur Maître: Je détruirai la multitude des Égyptiens par la main de Nabuchodonosor, roi de Babylone,',
        11: 'Par sa main et celle de son peuple, comme des fléaux envoyés des nations pour détruire la terre. Et tous s’avanceront l’épée nue sur l’Égypte, et la terre sera pleine de blessés.',
        12: 'Et je dessècherai leurs fleuves, et je détruirai leur terre et leur richesse, par les mains des étrangers; moi, le Seigneur, j’ai parlé.',
        13: 'Car voici ce que dit le Seigneur Maître: Je détruirai les grands de Memphis, et les princes de Memphis de la terre d’Égypte, et ils ne seront plus.',
        14: 'Et je détruirai la terre de Phathorès, et je lancerai le feu contre Taphnis, et je tirerai vengeance de Diospolis.',
        15: 'Et je verserai ma colère sur Saïs, la force de l’Égypte, et je détruirai la multitude de Memphis.',
        16: 'Et je lancerai le feu sur l’Égypte, et Syène sera dans un grand trouble, et il y aura une inondation à Diospolis, et les eaux s’y répandront.',
        17: 'Les jeunes hommes d’Héliopolis et de Bubaste périront par le glaive, et les femmes s’en iront en captivité.',
        18: 'Et le jour sera obscurci à Taphnis lorsque j’y',
        19: 'Et j’exercerai mes jugements contre l’Égypte, et ils sauront que je suis le Seigneur.',
        20: 'Et en l’année onzième, le premier mois, le septième jour du mois, la parole du Seigneur me vint, disant:',
        21: 'Fils de l’homme, j’ai brisé les bras du Pharaon, roi d’Égypte, et voilà qu’il n’a point été entouré de bandes pour que ses plaies guérissent, pour qu’un baume y soit appliqué, pour qu’il recouvre la force de tenir un glaive.',
        22: 'À cause de cela, ainsi dit le Seigneur Maître: Voilà que je suis contre le Pharaon, roi d’Égypte, et je briserai ses bras forts et tendus, et je ferai tomber l’épée de sa main.',
        23: 'Et je disperserai l’Égypte parmi les nations, et je les vannerai sur la terre;',
        24: 'Et je fortifierai les bras du roi de Babylone, et je lui mettrai le glaive à la main, et il le promènera sur l’Égypte, et il fera de l’Égypte sa proie, et il en enlèvera des dépouilles.',
        25: 'Et je fortifierai les bras du roi de Babylone, et les bras du Pharaon tomberont défaillants, et l’on saura que je suis le Seigneur, quand j’aurai mis mon glaive à la main du roi de Babylone, et qu’il l’étendra sur la terre d’Égypte.',
        26: 'Et je disperserai l’Égypte parmi les nations, et je les vannerai sur la terre; et ils sauront tous que je suis le Seigneur.',
    },
    31: {
        ...
        10: 'À cause de cela, voici ce que dit le Seigneur: En',
        ...
        16: 'Au bruit de sa chute, les nations ont tremblé; car je l’ai fait descendre aux enfers avec ceux qui étaient tombés dans l’abîme; et tous les arbres de délices de la',
        17: 'Et ceux-là aussi sont descendus avec lui aux enfers, parmi les morts frappés par le glaive; et sa race, qui demeurait sous son abri, a péri au milieu de sa vie.',
    ...
    32: {
        ...
        16: 'Telle est la lamentation que tu répèteras, et',
        ...
        19: '20. Et ils tomberont avec leur roi dans la foule frappée par le glaive, et toute sa puissance périra.',
        21: 'Et les géants te diront: Reste au fond de l’abîme; qui est moindre que toi? Descends et dors avec les incirconcis, au milieu des morts frappés du glaive.',
        22: 'Là est Assur avec tout son peuple; là sont tous ceux que le glaive a tués.',
        23: 'Et leur sépulture est au fond de l’abîme, et le peuple d’Assur est autour de son monument; ce sont tous les morts qui sont tombés sous le glaive, et qui sur la terre de vie avaient inspiré de l’effroi.',
    ...
    33: {
        ...
        21: 'Et en la douzième année de notre captivité, le douzième mois, le cinquième jour du mois, un homme',
        ...
        25: 'À cause de cela, réponds-leur:',
        26: '27. Voici ce que dit le Seigneur Maître: Par ma vie, ceux qui sont en ces villes désolées périront par le glaive; et ceux qui demeurent aux champs seront donnés en pâture aux bêtes sauvages; et je ferai mourir de mort ceux qui sont dans des forteresses et dans des cavernes.',
    ...
    34: {
        ...
        6: 'Et mes brebis ont été dispersées dans toutes les montagnes et sur toutes les hautes collines; elles ont',
        ...
        14: 'Je les ferai paître en un bon pâturage, sur la haute montagne d’Israël; et c’est là que seront leurs berge',
        ...
        23: 'Et je susciterai pour eux un seul pasteur, et',
    ...
    37: {
        ...
        2: 'Et le Seigneur me conduisit tout autour de ces os,',
        ...
        15: 'Et la parole du Seigneur me vint, disant:',
        16: 'Fils de l’homme, prends une baguette, et sur elle écris Juda et tous les enfants d’Israël de son parti. Prends une autre baguette, et écris sur elle: Pour Joseph; puis une baguette pour Éphraïm; inscris enfin tous les enfants appartenant à Israël.',
        ...
        19: 'Tu leur diras: Ainsi parle le Seigneur: Voilà que je vais prendre la tribu de Joseph, qui est dans la main d’Ephraïm, et les tribus d’Israël qui appartiennent à celle-ci, et je les réunirai à la tribu de Juda, et elles ne formeront qu’une baguette dans la maison de Juda.',
        ...
        24: 'Et mon serviteur David sera prince au milieu d’eux; il y aura pour eux tous un seul pasteur, parce qu’ils marcheront dans la voie de mes ordonnances et qu’ils garderont mes commandements et les pratiqueront.',
        25: 'Et ils habiteront leur terre que j’ai donnée à mon serviteur Jacob, que leurs pères ont habitée; et euxmêmes y habiteront. Et David, mon serviteur, sera leur prince dans tous les siècles.',
    ...
    39: {
        1: 'Et toi, fils de l’homme, prophétise maintenant contre Gog, et dis: Ainsi parle le Seignenr: Voilà que je suis contre toi, Gog, prince de Rhos, de Mésoch et de Thubal.',
        ...
        9: 'Les habitants des villes en sortiront, et ils se chaufferont en brûlant les armes, les boucliers, les épieux, les arcs, les flèches, les bâtons et les javelines; et ils en allumeront leur feu pendant sept ans.',
        ...
        11: 'Et ceci adviendra en ce jour-là je donnerai à Gog une place de renom, un sépulcre en Israël; ce sera le cimetière des voyageurs du côté de la mer, et l’on entourera de murs l’entrée de la vallée.',
        12: 'Là on enterrera Gog et toute sa multitude, et on l’appellera le cimetière de Gog.',
        13: 'Et la maison d’Israël les y enterrera, afin qu’en sept mois la terre soit purifiée; et tout le peuple de la terre les y enterrera; et ce sera pour eux une place de renom, le jour où Israel sera glorifié, dit le Seigneur.',
        ...
        15: 'Et chacun de ceux qui parcourront la terre, à la vue d’un ossement hunain, placera auprès une marque, afin que les fossoyeurs l’enterrent dans la vallée, au cimetière de Gog.',
    ...
    40: {
        1: 'Et en la vingt-cinquième année de notre captivité, le premier mois, le premier jour du mois; quatorze ans après que la ville eut été détruite, en ce jour-là la main du Seigneur fut sur moi.',
        ...
        4: 'Et l’homme me dit: Celui que tu vois, fils de l’homme, regarde-le bien de tes yeux, écoute-le bien de tes oreilles, et dépose en ton cœur tout ce que je vais te montrer; car tu es venu ici pour que je te le montre, et tu montreras ensuite à la maison d’Israël tout ce que tu auras vu.',
        ...
        6: 'Et il monta sept degrés, et il entra par la porte',
        ...
        17: 'Et l’homme me conduisit au parvis le plus intérieur; et voilà qu’il y avait des chambres et un péristyle autour du parvis: trente chambres pour tout le péristyle.',
        ...
        22: 'Et ses fenêtres, son vestibule et ses palmes étaient comme ceux de la porte qui regardait l’orient; et l’on y montait par sept degrés, et le vestibule était intérieur.',
        23: 'Et il y avait une porte au parvis intérieur regardant la porte de l’aquilon, semblable à la porte qui regardait l’orient; et l’homme mesura le parvis d’une porte à l’autre, et il y avait cent coudées.',
        24: 'Et il me conduisit au côté méridional, et voilà',
        25: 'Les fenêtres et les vestibules environnants étaient comme les fenêtres du vestibule; le tout avait cinquante coudées de long et vingt-cinq de large.',
        26: 'Et l’on y montait par sept degrés, et le vestibule était extérieur, et il y avait des palmes des deux côtés du frontispice.',
        27: 'Et il y avait une porte en face de la porte du parvis intérieur du côté méridional; et il mesura le parvis d’une porte à l’autre; et la largeur du côté du midi était de cinquante coudées.',
        28: 'Et il me conduisit au parvis intérieur en entrant par la porte du midi, et il mesura la porte, et elle avait les mêmes dimensions;',
        29: 'Les chambres, les frontispices et les vestibules avaient aussi les mêmes dimensions; et il y avait des fenêtres au parvis et au vestibule environnants; et le parvis était long de cinquante coudées et large de vingt-cinq,',
        30: '31. À partir du vestibule du parvis extérieur; et il y avait des palmes au frontispice, et on y montait par huit degrés.',
        32: 'Et l’homme me conduisit à la porte qui regardait l’orient, et il la mesura, et elle avait les mêmes dimensions;',
        33: 'Les chambres, les frontispices et les vestibules avaient aussi les mêmes dimensions; et il y avait des fenêtres au parvis et au vestibule environnants; et le parvis était long de cinquante coudées et large de vingt-cinq.',
        34: 'Et il y avait des vestibules ouvrant sur le parvis intérieur, et des palmes des deux côtés du frontispice; et on y montait par huit degrés.',
        35: 'Et l’homme me conduisit à la porte de l’aquilon, et il la mesura, et elle avait les mêmes dimensions.',
        36: 'Et les chambres, et les frontispices et les vestibules et le parvis avaient des fenêtres tout alentour avec des vestibules; et il avait cinquante coudées de long et vingt-cinq de large.',
        37: 'Et les vestibules ouvraient sur le parvis extérieur, et il y avait des palmes des deux côtés du frontispice, et on y montait par huit degrés.',
        38: 'Et ses chambres, ses portes,',
        39: 'Et ses vestibules, situés vers la seconde porte, servaient d’écoulement, afin qu’en ce parvis on immolât les victimes pour le péché et pour les fautes d’inadvertance.',
        40: 'Et derrière la rigole des holocaustes il y avait deux tables à l’orient, vers la porte qui regarde l’aquilon; derrière la seconde porte, et derrière le vestibule de la porte, deux tables à l’orient.',
        41: 'C’étaient donc quatre tables d’un côté et quatre de l’autre côté, derrière la porte; et sur ces tables on sacrifiait les victimes. Devant ces huit tables destinées aux victimes',
        42: 'Il y avait de plus, pour les holocaustes, quatre tables en pierre de taille, larges d’une demi-coudée, longues de deux coudées et demie, épaisses d’une coudée. Sur ces tables on posait les instruments avec lesquels on y égorgeait les holocaustes et les autres victimes.',
        43: 'Et ces tables avaient en dedans, tout alentour, une gouttière creusée au ciseau, profonde d’un palme, et au-dessus d’elles un toit pour les préserver de la pluie et de la sécheresse.',
        44: 'Et l’homme me conduisit au parvis intérieur; et voilà qu’il y avait deux chambres dans le parvis intérieur, l’une derrière la porte septentrionale, se prolongeant au midi, l’autre derrière la porte méridionale et se prolongeant à l’aquilon.',
        45: 'Et il me dit: Cette chambre, située au midi, est pour les prêtres qui gardent le temple;',
        ...
        47: 'Et il mesura le parvis qui était long de cent coudées dans tous les sens, et l’autel devant le temple.',
        48: 'Et il me conduisit dans le vestibule du temple, et il mesura les deux poteaux du vestibule, ayant chacun cinq coudées de large, et les portes larges de treize coudées, et les montants et chambranles de la porte du vestibule, qui avaient trois coudées de chaque côté;',
        49: 'Et la longueur du vestibule était de vingt coudées, et sa largeur de douze. Et l’on y montait par douze degrés, et près du vestibule il y avait des colonnes, une d’un côté, une de l’autre.',
    },
    41: {
        1: 'Et l’homme me conduisit dans le temple, et il en mesura les deux poteaux du vestibule, larges chacun de six coudées.',
        2: 'Et la largeur de la grande porte était de six coudées, et ses chambranles montants en avaient cinq de chaque côté; et il mesura le temple, qui avait quarante coudées de long et vingt de large.',
        3: 'Et il entra dans le parvis intérieur, et il mesura les',
        4: 'Puis il en mesura la longueur à partir des portes, et elle était de quarante coudées, et la longueur dans le sens de la façade du temple, et elle était de vingt coudées. Et il dit: C’est ici le saint des saints.',
        ...
        11: 'Et les portes des appartements s’ouvraient sur l’espace laissé par celle des portes qui regardait l’aquilon; il y avait aussi une porte au midi, et la largeur de l’espace éclairé était de cinq coudées tout alentour.',
        12: 'Et le mur de séparation en face de l’espace laissé par la porte occidentale occupait une largeur de soixante-dix coudées; et l’épaisseur du mur de séparation était de cinq coudées autour du temple, et sa longueur de quatre-vingt-dix coudées.',
        13: 'Et l’homme mesura en face du temple une longueur de cent coudées; et les bâtiments séparés avec leurs murs avaient aussi cent coudées de long.',
        14: 'Et la largeur de la place située devant la façade du temple, et les espaces laissés par les portes devant le temple étaient de cent coudées.',
        15: 'Et l’homme mesura la longueur des bâtiments séparés derrière le temple et les galeries ouvertes de l’un et de l’autre côté; et cette longueur était également de cent coudées. Et le temple, les angles et les vestibules extérieurs étaient lambrissés et plafonnés.',
        16: 'Et les fenêtres réticulées laissaient pénétrer le jour dans les trois étages, de sorte qu’on pouvait se pencher et regarder au travers. Et le temple et ses accessoires étaient lambrissés tout alentour, et le sol planchéié; et le lambris montait du sol aux fenêtres, et les volets des fenêtres se repliaient en trois, pour que l’on pût regarder en dehors.',
        17: 'Et le lambris s’élevait presque jusqu’au côté intérieur et au côté extérieur. Et sur tout le mur du temple en dedans et en dehors',
        18: 'Étaient gravés des chérubins, et il y avait des palmes entre deux chérubins, et chaque chérubin avait deux faces,',
        19: 'Une face d’homme du côté d’une palme, et une face de lion du côté d’une autre palme; et tout le contour du temple était ainsi gravé.',
        20: 'Ces chérubins et ces palmes étaient gravés depuis le sol jusqu’au plafond.',
        21: 'Et le saint des saints et le temple étaient ouverts de quatre côtés, et en face des saints apparaissait comme une vision,',
        22: 'L’autel, qui était de bois, avait trois coudées de haut, deux de long et deux de large. Et il avait des cornes, et sa base et ses parois étaient de bois. Et l’homme me dit: Voici la table qui est devant la face du Seigneur.',
        23: 'Et il y avait double porte au temple, et double porte au saint des saints,',
        24: 'Ayant chacune deux battants à charnières: deux battants à la première porte, et deux à la seconde.',
        25: 'Elles étaient sculptées; et il y avait des chérubins aux portes du temple, et des palmes comme à celles du sanctuaire, et de fortes pièces de bois devant le vestibule extérieur,',
        26: 'Et des fenêtres cachées en biais. Et l’homme mesura tous les côtés, et les toitures du vestibule et les côtés du temple qui lui étaient adjacents.',
    },
    42: {
        ...
        12: 'Que les chambres du côté du midi; elle régnait depuis la porte d’entrée jusqu’à la fenêtre de l’espace vide, et l’entrée du côté de l’orient, partout large d’une mesure.',
    ...
    44: {
        ...
        7: 'D’avoir introduit parmi vous des fils d’étrangers incirconcis par le cœur, et incirconcis par la chair, pour qu’ils se tinssent dans mon saint des saints, et qu’ils se souillassent quand vous offriiez des pains, des chairs et du sang; vous avez transgressé mon alliance par toutes vos iniquités;',
        ...
        12: 'Mais en punition de ce qu’ils ont servi pour lui devant ses idoles, et qu’ils ont attiré sur la maison d’Israël',
        ...
        19: 'Et lorsqu’ils sortiront du parvis intérieur pour rejoindre le peuple, ils ôteront les robes avec lesquelles ils font leur service liturgique, et ils les déposeront dans les chambres du sanctuaire; ils mettront d’autres robes et ne sanctifieront pas le peuple avec leurs propres robes.',
        ...
        30: 'Les prémices de toutes choses, les premiers-nés de tous les troupeaux et toutes les parts réservées. Les prêtres auront de toutes vos prémices, et vous donnerez',
        31: 'Et les prêtres ne mangeront, parmi les oiseaux ou le bétail, ni corps mort, ni animal pris par d’autres bêtes.',
    },
    45: {
        1: 'Or, lorsque vous mesurerez la terre de votre héritage, vous en séparerez les prémices pour le Seigneur; c’està-dire un lieu consacré en cette terre, long de vingt-cinq mille mesures, large de vingt mille; et ce lieu sera consacré dans toute son étendue.',
        ...
        6: 'Et à la possession des villes tu ajouteras un espace de vingt-cinq mille mesures de long, sur vingt mille de',
        ...
        15: 'Parmi les menus troupeaux, une tête sur dix sera offerte, en toutes les tribus d’Israël, pour les sacrifices',
    ...
    46: {
        ...
        2: 'Et le prince entrera par le chemin du vestibule de la porte intérieure, et il s’arrêtera au seuil de la porte, et les prêtres prépareront ses holocaustes et ses hosties pacifiques.',
        3: 'Et il adorera au seuil même de la porte, puis il sortira, et la porte ne sera pas fermée jusqu’au soir; et le peuple de la terre adorera près de cette porte, et il se prosternera devant le Seigneur, les jours de sabbat et de nouvelle lune.',
        ...
        19: 'Et l’homme me conduisit derrière la porte à la chambre des saints, consacrée aux prêtres, qui regarde l’aquilon; et là était un lieu réservé.',
    ...
    48: {
        ...
        22: 'Et la part des lévites et le territoire de la ville, au milieu duquel sera la part du prince, seront entre les limites de Juda et les limites de Benjamin; ce sera la résidence des princes.',
        ...
        28: 'À partir des limites de Gad, depuis l’orient, et',
