...
CHAPTERS = {
    1: {
        ...
        20: '(32) Fils de Cettura, concubine d’Abraham: elle lui enfanta Zameran, Jezan, Madian, Madal, Jesboc et Sué. Fils de Jezan: Dedan et Saba.',
        ...
        24: '(36) Fils d’Eliphaz: Thêman, Omar, Sophar, Gatham, Cenez, Thamna et Amalec.',
    ...
    4: {
        ...
        13: 'Et les fils de Cenez furent: Gothoniel et Saraïa; et Gothoniel eut pour fils Athath.',
    ...
    8: {
        ...
        13: 'Et Beria et Sama (ceux-ci furent chefs des familles qui demeurèrent en Aïlam, et qui chassèrent les habitants de Geth),',
    ...
    12: {
        ...
        33: 'Flis de Zabulon, allant au combat avec toutes les armes de guerre cinquante mille, auxiliaires de David, n’ayant pas les mains vides.',
    ...
    15: {
        ...
        13: 'Car, d’abord, parce que vouz n’étiez point là; le Seigneur Dieu nous a châtiés, pour ne l’avoir point cherché, selon la loi.',
        ...
        26: 'David, et les anciens d’Israël et les chefs de mille hommes, partirent ainsi pour transférer l’arche de l’alliance de la maison d’Abdedom, avec allégresse.',
        27: 'Et comme Dieu fortifiait les lévites qui portaient l’arche de l’alliance du Seigneur, on sacrifia devant le cortége sept bœufs et sept béliers.',
        28: 'Or, David était revêtu d’une robe de lin, ainsi que tous les lévites qui portaient l’arche de l’alliance du Seigneur, et les chantres-harpistes, et Honénias, maître du chant; David avait comme eux une robe de lin.',
        29: 'Et tout Israël conduisait l’arche de l’alliance du Seigneur, jetant des cris de joie et chantant les uns au son des trompettes et des cymbales, les autres avec accompagnement de lyres et de harpes. Lorsque l’arche de l’alliance du Seigneur entra dans la ville de David, Michol, fille de Saül, se penchant à sa fenêtre, vit le roi David danser et toucher de la harpe; et, en son âme, elle le méprisa.',
    },
    16: {
    ...
    27: {
        ...
        29: 'Satraï le Saronite, celle des boeufs qui paissaient en Saron; et Sophat, fils d’Abdi, celle des bœufs à l’étable.',
