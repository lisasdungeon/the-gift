...
CHAPTERS = {
    1: {
        ...
        14: 'Et ils crièrent au Seigneur, et ils dirent: Non, Seigneur, que nous ne périssions pas pour la vie de cet homme; ne faites pas retomber sur nous un sang innocent; car, Seigneur, vous avez fait selon votre volonté.',
    ...
    4: {
        ...
        3: 'Maintenant donc, Seigneur mon maître, prenez-moi ma vie; car il vaut mieux pour moi mourir que vivre.',
