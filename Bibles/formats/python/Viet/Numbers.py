...
CHAPTERS = {
    1: {
        1: 'Ngày mồng một tháng hai, năm thứ hai, sau khi dân Y-sơ-ra-ên ra khỏi xứ Ê-díp-tô, Ðức Giê-hô-va phán cùng Môi-se ở trong hội mạc, tại đồng vắng Si-na -i, mà rằng:',
        ...
        5: 'Ðây là tên những người sẽ giúp đỡ các ngươi: Về chi phái Ru-bên, Ê-lít-su, con trai của Sê-đêu;',
        ...
        12: 'về chi phái Ðan, A-hi-ê-xe, con trai của A-mi-sa-đai;',
        ...
        16: 'Ðó là những người được gọi từ trong hội chúng, vốn là quan trưởng của các chi phái tổ phụ mình, và là quan tướng quân đội Y-sơ-ra-ên.',
        ...
        19: 'Vậy, Môi-se kê sổ chúng nó tại đồng vắng Si-na -i, y như Ðức Giê-hô-va đã phán dặn.',
        ...
        32: 'Về hậu tự Giô-sép, là con cháu Ép-ra-im, dòng dõi họ tùy theo họ hàng và tông tộc mình, cứ kể từng tên, từ hai mươi tuổi sắp lên, tức là mọi người trong chi phái Ép-ra-im đi ra trận được,',
        ...
        38: 'Con cháu Ðan, dòng dõi họ tùy theo họ hàng và tông tộc mình, cứ kể từng tên, từ hai mươi tuổi sắp lên, tức là mọi người trong chi phái Ðan đi ra trận được,',
        ...
        44: 'Ðó là những người mà Môi-se, A-rôn, và mười hai quan trưởng Y-sơ-ra-ên kê sổ; mỗi quan trưởng kê sổ cho tông tộc mình.',
        ...
        48: 'Vì Ðức Giê-hô-va có phán cùng Môi-se rằng:',
        49: 'Ngươi chớ kê sổ chi phái Lê-vi, và cũng đừng dựng bộ họ chung với dân Y-sơ-ra-ên;',
        50: 'nhưng hãy cắt phần người Lê-vi coi sóc đền tạm chứng cớ, hết thảy đồ đạc và các món thuộc về đền tạm. Ấy là người Lê-vi sẽ chuyên-vận đền tạm và hết thảy đồ đạc nó, cùng sẽ làm công việc về đền tạm và đóng trại ở chung quanh đền tạm.',
        ...
        54: 'Dân Y-sơ-ra-ên làm y như mọi điều Ðức Giê-hô-va đã phán dặn Môi-se vậy.',
    },
    2: {
        ...
        4: 'và quân đội người, cứ theo kê sổ, cọng bảy mươi bốn ngàn sáu trăm người.',
        ...
        8: 'và quân đội người, cứ theo kê sổ, cộng năm mươi bảy ngàn bốn trăm người.',
        ...
        10: 'Ngọn cờ của trại quân Ru-bên và những đội ngũ mình, phải đóng về hướng nam. Quan trưởng của người Ru-bên là Ê-li-su, con trai của Sê-đêu;',
        ...
        16: 'Vậy, các người đã kê sổ theo trại quân Ru-bên, từng đội ngũ, cộng một trăm năm mươi mốt ngàn bốn trăm năm mươi người. Họ phải đi thứ nhì.',
    ...
    3: {
        1: 'Nầy là dòng dõi của A-rôn và Môi-se, về ngày Ðức Giê-hô-va phán cùng Môi-se tại trên núi Si-na -i.',
        2: 'Nầy là tên các con trai A-rôn: Trưởng nam là Na-đáp, A-bi-hu, Ê-lê-a-sa, và Y-tha-ma.',
        3: 'Ðó là tên các con trai A-rôn, tức những thầy tế lễ đã chịu phép xức dầu, và được lập lên để làm chức tế lễ.',
        4: 'Vả, Na-đáp và A-bi-hu đã thác trước mặt Ðức Giê-hô-va khi hai người dâng một thứ lửa lạ trước mặt Ðức Giê-hô-va tại trong đồng vắng Si-na -i. Hai người nầy không có con. Còn Ê-lê-a-sa và Y-tha-ma làm chức tế lễ trước mặt A-rôn, là cha mình.',
        5: 'Ðức Giê-hô-va bèn phán cùng Môi-se rằng:',
        ...
        13: 'Vì hết thảy con đầu lòng đều thuộc về ta; ngày xưa khi ta hành hại các con đầu lòng trong xứ Ê-díp-tô, ta đã biệt riêng ra thánh cho ta hết thảy con đầu lòng trong Y-sơ-ra-ên, bất luận loài người hay thú vật; chúng nó đều sẽ thuộc về ta. Ta là Ðức Giê-hô-va.',
        14: 'Ðức Giê-hô-va lại phán cùng Môi-se tại trong đồng vắng Si-na -i mà rằng:',
        15: 'Hãy kê sổ con cháu Lê-vi, tùy theo tông tộc và họ hàng chúng nó, kê hết thảy nam đinh từ một tháng sắp lên.',
        16: 'Môi-se bèn kê sổ người Lê-vi theo mạng của Ðức Giê-hô-va, y như Ngài đã phán dặn người vậy.',
        17: 'Ðây là các con trai của Lê-vi kể từng tên: Ghẹt-sôn, Kê-hát, và Mê-ra-ri.',
        18: 'Ðây là tên của các con trai Ghẹt-sôn, tùy theo họ hàng mình: Líp-ni và Si-mê -y.',
        19: 'Ðây là các con trai của Kê-hát tùy theo họ hàng mình: Am-ram, Dít-sa, Hếp-rôn và U-xi-ên;',
        20: 'và các con trai của Mê-ra-ri, tùy theo họ hàng mình, là: Mách-li và Mu-si. Ðó là những họ hàng của người Lê-vi, tùy theo tông tộc của họ.',
        21: 'Họ hàng Líp-ni và họ hàng Si-mê -y thuộc về Ghẹt-sôn. Ðó là hai họ hàng của Ghẹt-sôn vậy.',
        ...
        27: 'Họ hàng Am-ram, họ hàng Dít-sa, họ hàng Hếp-rôn và họ hàng U-xi-ên thuộc về Kê-hát. Ðó là những họ hàng của Kê-hát.',
        ...
        33: 'Họ hàng Mách-li và họ hàng Mu-si thuộc về Mê-ra-ri. Ðó là hai họ hàng của Mê-ra-ri vậy.',
        ...
        39: 'Hết thảy người Lê-vi mà Môi-se và A-rôn vâng mạng Ðức Giê-hô-va tu bộ, tùy theo họ hàng của họ, kể mọi nam đinh từ một tháng sắp lên, số là hai mươi hai ngàn người.',
        40: 'Ðoạn, Ðức Giê-hô-va phán cùng Môi-se rằng: Hãy kê sổ hết thảy con trưởng nam của dân Y-sơ-ra-ên, từ một tháng sắp lên, và hãy dựng sổ tên chúng nó.',
        41: 'Ta là Ðức Giê-hô-va. Ngươi phải chọn lấy cho ta người Lê-vi thế cho các con trưởng nam trong dân Y-sơ-ra-ên; cũng phải bắt súc vật của người Lê-vi thế cho mọi con súc vật đầu lòng của dân Y-sơ-ra-ên.',
        42: 'Vậy, Môi-se kê sổ các con trưởng nam của dân Y-sơ-ra-ên, y như Ðức Giê-hô-va đã phán dặn người.',
        ...
        45: 'Hãy chọn lấy những người Lê-vi thế cho hết thảy con trưởng nam của dân Y-sơ-ra-ên, và súc vật của người Lê-vi thế cho súc vật của dân Y-sơ-ra-ên; vậy, các người Lê-vi sẽ thuộc về ta. Ta là Ðức Giê-hô-va.',
        ...
        51: 'Môi-se vâng mạng Ðức Giê-hô-va, giao bạc chuộc lại cho A-rôn và các con trai người, y như Ðức Giê-hô-va đã phán dặn Môi-se.',
    },
    4: {
        1: 'Ðức Giê-hô-va phán cùng Môi-se và A-rôn rằng:',
        2: 'Trong người Lê-vi hãy dựng sổ các con cháu Kê-hát, tùy theo họ hàng và tông tộc của chúng nó,',
        ...
        5: 'Khi nào dời trại quân đi, A-rôn và các con trai người sẽ đến gỡ bức màn mà bao lấy hòm bảng chứng;',
        6: 'đoạn đắp lên một tấm phủ bằng da cá nược, trải trên một tấm nỉ toàn bằng màu điều xanh và xỏ đòn khiêng vào.',
        7: 'Cũng trải một tấm nỉ màu điều xanh trên cái bàn về bánh trần thiết; ở trên bàn thì sắp dĩa, chén, tộ và chậu về những lễ quán; bánh hằng trần thiết cũng sẽ có ở trên nữa.',
        8: 'Rồi trải trên các vật đó một tấm nỉ màu đỏ sặm, đắp một tấm phủ bằng da cá nược và xỏ đòn khiêng vào.',
        9: 'Cũng phải lấy một tấm nỉ màu điều xanh mà đậy chân đèn thắp, các thếp đèn, kéo hớt tim, đồ đựng tro, và các bình dầu mà người ta dùng về chân đèn.',
        10: 'Rồi để chân đèn và hết thảy đồ phụ tùng trong một tấm phủ bằng da cá nược, để lên trên cái sề.',
        11: 'Họ phải trải trên bàn thờ bằng vàng một tấm nỉ màu điều xanh và đắp một tấm phủ bằng da cá nược, rồi xỏ đòn khiêng vào.',
        ...
        14: 'để lên trên hết thảy đồ đạc dùng về công việc của bàn thờ, tức là những lư hương, nĩa, vá, chén, cùng những đồ phụ tùng của bàn thờ. Rồi đắp trên bàn thờ một tấm phủ bằng da cá nược và xỏ đòn khiêng vào.',
        15: 'Sau khi A-rôn và các con trai người đã đậy-điệm nơi thánh và các đồ đạc thánh xong, khi dời trại quân đi, thì các con cháu Kê-hát phải đến đặng khiêng các đồ đạc đó; họ chẳng nên đụng vào những vật thánh, e phải chết chăng. Trong hội mạc, ấy là đồ mà các con cháu Kê-hát phải khiêng đi.',
        ...
        18: 'Hãy làm thể nào cho tông tộc Kê-hát chớ bị truất khỏi chi phái Lê-vi,',
        19: 'và hãy làm điều nầy cho chúng nó, để khi đến gần nơi chí thánh, chúng nó được sống, chẳng phải chết: A-rôn và các con trai người phải đến cắt công việc cho mỗi người, và đồ chi họ phải khiêng đi.',
        20: 'Dẫu một lát, chúng nó chớ nên vào đặng xem những vật thánh, e phải chết chăng.',
        21: 'Ðức Giê-hô-va lại phán cùng Môi-se rằng:',
        22: 'Cũng hãy dựng sổ các con cháu Ghẹt-sôn, tùy theo tông tộc và họ hàng họ.',
        ...
        33: 'Ðó là hết thảy việc của các họ hàng Mê-ra-ri, về những công việc trong hội mạc mà họ phải làm ở dưới quyền cai trị của Y-tha-ma, con trai thầy tế lễ A-rôn.',
        ...
        36: 'và những người mà người ta kê sổ, tùy theo họ hàng mình, cộng được hai ngàn bảy trăm năm mươi.',
        37: 'Ðó là những người của các họ hàng Kê-hát đã bị kê sổ, tức là hết thảy người hầu việc trong hội mạc mà Môi-se và A-rôn kê sổ, y theo mạng của Ðức Giê-hô-va đã cậy Môi-se truyền dạy.',
        38: 'Còn con cháu của Ghẹt-sôn đã bị kê sổ, tùy theo họ hàng và tông tộc của họ,',
        ...
        41: 'Ðó là những người về các họ hàng con cháu Ghẹt-sôn đã bị kê sổ, tức là mọi người hầu việc trong hội mạc mà Môi-se và A-rôn tu bộ y theo mạng của Ðức Giê-hô-va.',
        42: 'Còn những người về họ hàng con cháu Mê-ra-ri đã bị kê sổ, tùy theo họ hàng và tông tộc của họ,',
        43: 'từ ba mươi tuổi sắp lên cho đến năm mươi, tức là mọi người có thể giúp công trong hội mạc,',
        44: 'cộng được ba ngàn hai trăm.',
        45: 'Ðó là những người về các họ hàng con cháu Mê-ra-ri đã bị kê sổ. Môi-se và A-rôn lấy bộ dân, y theo mạng của Ðức Giê-hô-va đã cậy Môi-se truyền dạy.',
        ...
        49: 'Người ta tu bộ người Lê-vi tùy theo mạng của Ðức Giê-hô-va đã cậy Môi-se truyền dạy, cắt phần cho mỗi người việc mình phải làm, và vật chi mình phải khiêng đi; người ta tu bộ dân tùy theo lời Ðức Giê-hô-va đã phán dặn Môi-se vậy.',
    },
    5: {
        ...
        4: 'Dân Y-sơ-ra-ên bèn làm như vậy, đuổi họ ra khỏi trại quân, y như Ðức Giê-hô-va đã truyền lịnh cho Môi-se vậy.',
        5: 'Ðức Giê-hô-va lại phán cùng Môi-se rằng:',
        6: 'Hãy nói cùng dân Y-sơ-ra-ên như vầy: Khi một người nam hay nữ phạm một trong những tội người ta thường phạm, cho đến can phạm cùng Ðức Giê-hô-va, và vì cớ đó phải mắc tội,',
        ...
        8: 'Nếu người nầy không còn, và không bà con nào để lãnh tang vật đó lại, thì vật ấy sẽ về Ðức Giê-hô-va, tức là về thầy tế lễ, ngoại trừ con chiên đực về lễ chuộc tội mà thầy tế lễ sẽ dùng đặng chuộc tội cho người mắc tội đó.',
        ...
        11: 'Ðức Giê-hô-va lại phán cùng Môi-se rằng:',
        ...
        16: 'Thầy tế lễ sẽ biểu người nữ đến gần, đứng trước mặt Ðức Giê-hô-va.',
        17: 'Kế đó thầy tế lễ lấy nước thánh đổ vào chậu đất, hốt bụi ở trên đất của đền tạm mà bỏ trong nước.',
        18: 'Ðoạn, thầy tế lễ phải biểu người nữ đứng trước mặt Ðức Giê-hô-va, lột trần đầu nàng, để của lễ kỷ niệm trên lòng bàn tay nàng, nghĩa là của lễ chay về sự ghen tương; và thầy tế lễ phải có nước đắng giáng rủa sả trong tay mình.',
        19: 'Thầy tế lễ phải bắt người nữ thề, và nói cùng nàng rằng: Nếu chẳng một người nam nào nằm cùng ngươi, và nếu đương dưới quyền chồng ngươi không có lỗi đạo và không bị ô uế, thì chẳng phải mắc một điều hại nào của nước đắng giáng rủa sả nầy.',
        ...
        21: 'bấy giờ thầy tế lễ phải bắt người nữ lấy một lời thề trù ẻo mà thề, và nói cùng nàng rằng: Cầu Ðức Giê-hô-va khiến cho ngươi trở nên một mầm rủa sả và trù ẻo giữa vòng dân sự ngươi, làm cho ngươi ốm lòi hông và phình bụng lên;',
        ...
        25: 'Ðoạn, thầy tế lễ sẽ lấy khỏi tay người nữ của lễ chay về sự ghen tương, đưa qua đưa lại trước mặt Ðức Giê-hô-va và dâng lên trên bàn thờ.',
        ...
        29: 'Ðó là luật lệ về sự ghen tương khi một người đàn bà, ở dưới quyền chồng mình, lỗi đạo và bị ô uế;',
        30: 'hoặc khi nào tánh ghen phát sanh nơi người chồng mà ghen vợ mình: người phải đem vợ đến trước mặt Ðức Giê-hô-va, và thầy tế lễ sẽ làm cho nàng hết thảy điều chi luật lệ nầy truyền dạy.',
    ...
    9: {
        1: 'Tháng giêng năm thứ hai, sau khi ra khỏi xứ Ê-díp-tô, Ðức Giê-hô-va lại phán cùng Môi-se trong đồng vắng Si-na -i rằng:',
    ...
    11: {
        ...
        12: 'Tôi há có thọ thai dân nầy sao? há có sanh đẻ nó sao? mà Ngài lại phán biểu tôi rằng: Hãy ẵm dân nầy trong lòng người, như người cha nuôi bồng đứa trẻ bú, cho đến xứ mà Ngài có thề hứa ban cho tổ phụ của chúng nó.',
        ...
        16: 'Ðức Giê-hô-va bèn phán cùng Môi-se rằng: Hãy nhóm hiệp cho ta bảy mươi người trong bực trưởng lão Y-sơ-ra-ên, tức là những kẻ ngươi biết là trưởng lão và cai quản dân sự; hãy dẫn các người ấy đến hội mạc, đứng tại đó với ngươi.',
        ...
        26: 'Có hai người ở lại trong trại quân; một người tên là Eân-đát, một người tên là Mê-đát, được Thần cảm động, nói tiên tri tại trại quân. Hai người nầy thuộc về bọn được biên tên, nhưng không có đến hội mạc.',
    ...
    13: {
        ...
        3: 'Tùy theo mạng Ðức Giê-hô-va, Môi-se từ đồng vắng Pha-ran sai các người nầy đi; hết thảy là quan trưởng của dân Y-sơ-ra-ên.',
        4: 'Ðây là tên của các người ấy: Về chi phái Ru-bên, Sam-mua, con trai Xa-cu;',
        ...
        12: 'về chi phái Ðan, A-mi-ên, con trai của Ghê-ma-li;',
        ...
        16: 'Ðó là tên những người mà Môi-se sai đi do thám xứ. Vả, Môi-se đặt tên cho Hô-sê, con trai Nun, là Giô-suê.',
    ...
    14: {
        ...
        40: 'Ðoạn, dân sự dậy sớm đi lên chót núi mà nói rằng: Chúng tôi đây sẽ đi lên tới chỗ Ðức Giê-hô-va đã phán-hứa, vì chúng tôi có phạm tội.',
    ...
    15: {
        ...
        19: 'và ăn bánh của xứ đó, thì các ngươi phải lấy một lễ vật dâng giơ lên cho Ðức Giê-hô-va.',
    ...
    16: {
        1: 'Vả, Cô-rê, con trai của Dít-sê-ha, cháu của Kê-hát, chít của Lê-vi, giục theo mình Ða-than và A-bi-ram, con trai của Ê-li-áp, cùng với Ôn, con trai của Phê-lết, cháu Ru-bên.',
        ...
        35: 'Rồi một ngọn lửa từ Ðức Giê-hô-va lòe ra thiêu hóa hai trăm năm mươi người đã dâng hương.',
        ...
        49: 'Có mười bốn ngàn bảy trăm người chết vì tai vạ nầy, trừ ra những kẻ đã bị chết vì cớ Cô-rê.',
    ...
    18: {
        ...
        17: 'Nhưng ngươi chớ chuộc lại con đầu lòng của bò cái, hoặc con đầu lòng của chiên cái hay là con đầu lòng của dê cái; ấy là những vật thánh. Ngươi phải rưới huyết nó trên bàn thờ, và xông mỡ nó làm của lễ dùng lửa dâng lên có mùi thơm cho Ðức Giê-hô-va.',
    ...
    19: {
        ...
        2: 'Nầy là lệ định của luật pháp mà Ðức Giê-hô-va có truyền rằng: Hãy nói cùng dân Y-sơ-ra-ên và biểu dẫn đến người một con bò cái tơ sắc hoe, không tật không vít, và chưa mang ách.',
        3: 'Ðoạn phải giao nó cho Ê-lê-a-sa, thầy tế lễ, dẫn ra ngoài trại quân, rồi người ta giết nó trước mặt người.',
        4: 'Ê-lê-a-sa, thầy tế lễ, sẽ dùng ngón tay nhúng huyết nó rảy bảy lần phía trước của hội mạc.',
        5: 'Người ta sẽ thiêu con bò cái tơ đó trước mắt người, là thiêu da, thịt, và huyết với phẩn nó.',
        6: 'Kế đó, thầy tế lễ sẽ lấy cây hương nam, chùm kinh giới, và màu đỏ sặm, liệng vào giữa đám lửa thiêu con bò cái tơ.',
        7: 'Ðoạn, thầy tế lễ phải giặt áo xống và tắm mình trong nước, sau rồi vào trại quân, bị ô uế đến chiều tối.',
        8: 'Kẻ nào thiêu con bò cái tơ phải giặt áo xống và tắm mình trong nước, bị ô uế đến chiều tối.',
        9: 'Một người tinh sạch sẽ hốt tro con bò cái tơ đổ ngoài trại quân, trong một nơi tinh sạch; người ta phải giữ tro đó cho hội dân Y-sơ-ra-ên để dùng làm nước tẩy uế: ấy là một của lễ chuộc tội.',
        10: 'Kẻ nào hốt tro con bò cái tơ phải giặt áo xống mình và bị ô uế đến chiều tối. Ðiều nầy sẽ làm một lệ định đời đời cho dân Y-sơ-ra-ên và cho khách ngoại bang kiều ngụ giữa dân đó.',
        11: 'Ai đụng đến một xác chết của người nào sẽ bị ô uế trong bảy ngày.',
        12: 'Ngày thứ ba và ngày thứ bảy, người ấy phải dùng nước nầy làm cho mình được sạch, thì sẽ được sạch; còn nếu ngày thứ ba và ngày thứ bảy không làm cho mình được sạch, thì người vẫn không tinh sạch.',
        13: 'Phàm người nào đụng đến xác chết của người nào và không làm cho mình được sạch, thì sẽ gây cho đền tạm của Ðức Giê-hô-va bị ô uế. Người đó sẽ bị truất khỏi Y-sơ-ra-ên; vì nước tẩy uế không có rảy trên mình người, nên người vẫn ô uế; sự ô uế của người vẫn ở trên mình người vậy.',
        ...
        15: 'Phàm bình đựng nào để trống, không có nắp đậy buộc theo, sẽ bị ô uế.',
        ...
        17: 'Về kẻ bị ô uế, người ta phải lấy tro của con sinh đã bị thiêu đặng chuộc tội, để trong một cái bình và đổ nước chảy lên trên.',
        18: 'Ðoạn, một người tinh sạch sẽ lấy chùm kinh giới nhúng vào nước, rồi rảy trên trại, trên các bình, trên những người có tại đó, và trên người đã đụng, hoặc những hài cốt, hoặc một người bị giết, hoặc một xác chết hay là một cái mả.',
        19: 'Ngày thứ ba và ngày thứ bảy, người tinh sạch phải rảy nước đó trên người bị ô uế, và ngày thứ bảy người tinh sạch sẽ làm cho người được sạch, Người đương được sạch phải giặt áo xống mình, tắm mình trong nước, và đến chiếu tối mới được tinh sạch.',
        20: 'Còn người nào sẽ bị ô uế mà không làm cho mình được sạch, một người như vậy sẽ bị truất khỏi hội chúng; vì người đã làm cho nơi thánh của Ðức Giê-hô-va bị ô uế. Nước tẩy uế không có rưới trên mình người: người vẫn ô uế.',
        21: 'Ấy sẽ là một lệ định đời đời cho dân sự. Người nào rảy nước tẩy uế sẽ giặt áo xống mình: kẻ nào đụng đến nước tẩy uế sẽ bị ô uế đến chiều tối.',
        22: 'Phàm vật chi mà người ô uế đụng đến, đều sẽ bị lây ô uế; còn ai đụng đến người đó sẽ bị lây ô uế đến chiều tối.',
    },
    20: {
        ...
        3: 'Dân sự cãi-lộn cùng Môi-se mà rằng: Anh em chúng tôi đã chết trước mặt Ðức Giê-hô-va, chớ chi chúng tôi cũng đồng chết luôn thể!',
        4: 'Sao người đem hội chúng của Ðức Giê-hô-va vào đồng vắng nầy, làm cho chúng tôi và súc vật của chúng tôi phải chết?',
        ...
        6: 'Môi-se và A-rôn bèn lui khỏi mặt hội chúng, đến tại cửa hội mạc, sấp mặt xuống đất; và sự vinh quang của Ðức Giê-hô-va cùng hai người.',
        7: 'Ðức Giê-hô-va phán cùng Môi-se rằng:',
        8: 'Hãy cầm lấy cây gậy ngươi, rồi với A-rôn anh ngươi, hãy truyền nhóm hội chúng, và hai ngươi phải nói cùng hòn đá trước mặt hội chúng, thì hòn đá sẽ chảy nước ra; ngươi sẽ khiến nước từ hòn đá chảy ra cho hội chúng và súc vật của họ uống.',
        9: 'Vậy, Môi-se cầm lấy cây gậy ở trước mặt Ðức Giê-hô-va, như Ngài đã phán dặn.',
        10: 'Môi-se và A-rôn truyền nhóm hội chúng đến trước hòn đá mà nói rằng: Hỡi dân phản nghịch! hãy nghe, chúng ta há dễ khiến nước chảy từ hòn đá nầy ra cho các ngươi được sao?',
        11: 'Môi-se giơ tay lên, đập hòn đá hai lần bằng cây gậy mình. Nước bèn chảy tràn ra nhiều, hội chúng uống, và súc vật họ uống nữa.',
        12: 'Ðoạn, Ðức Giê-hô-va phán cùng Môi-se và A-rôn rằng: Bởi vì hai ngươi không có tin đến ta, đặng tôn ta nên thánh trước mặt dân Y-sơ-ra-ên, vì cớ đó, hai ngươi sẽ không đem hội chúng nầy vào xứ mà ta đã cho nó đâu.',
        13: 'Ấy đó là nước của Mê-ri-ba, tức là nơi dân Y-sơ-ra-ên cãi-trã cùng Ðức Giê-hô-va; Ngài tự nên thánh trước mặt dân đó.',
        14: 'Ðoạn, từ Ca-đe, Môi-se sai sứ giả đi đến vua Ê-đôm đặng nói rằng: Y-sơ-ra-ên, là em vua, có nói như vầy: Vua biết các sự tai nạn đã xảy đến cho chúng tôi,',
        15: 'và tổ phụ chúng tôi đi xuống xứ Ê-díp-tô là làm sao? Chúng tôi đã ở lâu tại xứ Ê-díp-tô, nhưng dân xứ đó bạc đãi chúng tôi và tổ phụ chúng tôi.',
        16: 'Chúng tôi có kêu la cùng Ðức Giê-hô-va; Ngài có nghe thấu tiếng kêu, bèn sai một thiên sứ dẫn chúng tôi ra khỏi xứ Ê-díp-tô. Nầy, chúng tôi hiện ở tại Ca-đe, là thành ở nơi đầu bờ cõi của vua.',
        ...
        19: 'Dân Y-sơ-ra-ên tâu rằng: Chúng tôi đi theo đường cái; nếu chúng tôi và bầy súc vật chúng tôi uống nước của vua, thì chúng tôi sẽ trả tiền. Xin chỉ để đi bộ ngang qua, không chi khác nữa.',
        20: 'Nhưng Ê-đôm đáp rằng: Ngươi chẳng được qua đâu! Ê-đôm bèn đem quân chúng rất đông, tay cầm binh khí, ra đón Y-sơ-ra-ên.',
        21: 'Ấy vậy, Ê-đôm không cho phép Y-sơ-ra-ên đi ngang bờ cõi mình; Y-sơ-ra-ên trở đi khỏi người.',
        22: 'Cả hội dân Y-sơ-ra-ên đi từ Ca-đe đến núi Hô-rơ.',
        23: 'Ðức Giê-hô-va phán cùng Môi-se và A-rôn trên núi Hô-rơ, tại bờ cõi xứ Ê-đôm, mà rằng:',
        24: 'A-rôn sẽ về nơi tổ phụ mình, vì người không được vào xứ mà ta đã ban cho dân Y-sơ-ra-ên đâu; bởi vì tại nước Mê-ri-ba, các ngươi đã bội nghịch điều răn ta.',
        25: 'Hãy bắt A-rôn và Ê-lê-a-sa, con trai người, biểu đi lên núi Hô-rơ;',
        26: 'đoạn hãy lột áo xống A-rôn mặc cho Ê-lê-a-sa, con trai người. Ấy tại đó A-rôn sẽ được tiếp về và qua đời.',
        27: 'Vậy, Môi-se làm y như Ðức Giê-hô-va đã phán dặn; ba người đi lên núi Hô-rơ, cả hội chúng đều thấy.',
        ...
        29: 'Cả hội chúng thấy A-rôn đã tắt hơi rồi, bèn khóc người trong ba mươi ngày.',
    },
    21: {
        ...
        13: 'Rồi tự đó đi và đóng trại phía bên kia Aït-nôn, ở trong đồng vắng, vừa ra bờ cõi dân A-mô-rít; vì Aït-nôn là giáp-ranh của dân Mô-áp và dân A-mô-rít.',
    ...
    22: {
        1: 'Ðoạn dân Y-sơ-ra-ên đi, đến đóng trại trong đồng bắng Mô-áp, bên kia sông Giô-đanh, đối-diện Giê-ri-cô.',
        ...
        4: 'Vậy, Mô-áp nói cùng các trưởng lão Ma-đi-an rằng: Bây giờ, đoàn dân đông nầy sẽ nuốt hết thảy chung quanh ta, khác nào con bò ăn cỏ trong đồng vậy. Ðương lúc đó, Ba-lác, con trai Xếp-bô, làm vua Mô-áp.',
        ...
        8: 'Người đáp rằng: Hãy ở lại đây đêm nay thì ta sẽ trả lời theo như lời Ðức Giê-hô-va sẽ phán cùng ta. Các trưởng lão Mô-áp ở lại nhà Ba-la-am.',
        9: 'Vả, Ðức Chúa Trời đến cùng Ba-la-am và phán rằng: Những người ngươi có trong nhà là ai?',
        10: 'Ba-la-am thưa cùng Ðức Chúa Trời rằng: Ba-lác, con trai Xếp-bô, vua Mô-áp, đã sai đến tôi đặng nói rằng:',
        ...
        12: 'Ðức Chúa Trời phán cùng Ba-la-am rằng: Ngươi chớ đi với chúng nó, chớ rủa sả dân nầy, vì dân nầy được ban phước.',
        13: 'Sớm mai Ba-la-am dậy, nói cùng các sứ thần của Ba-lác rằng: Hãy trở về xứ các ngươi, vì Ðức Giê-hô-va không cho ta đi cùng các ngươi.',
        ...
        18: 'Ba-la-am đáp cùng các sứ thần của Ba-lác rằng: Dầu Ba-lác sẽ cho ta nhà người đầy vàng và bạc, ta cũng chẳng được vượt qua mạng của Giê-hô-va, Ðức Chúa Trời của ta, đặng làm một việc hoặc nhỏ hay lớn.',
        19: 'Song ta xin các ngươi cũng ở lại đêm nay, đặng ta biết Ðức Giê-hô-va sẽ phán điều chi cùng ta nữa.',
        20: 'Trong lúc ban đêm, Ðức Chúa Trời giáng đến Ba-la-am mà phán rằng: Nếu các người ấy đến đặng gọi ngươi, hãy đứng dậy đi với chúng nó; nhưng chỉ hãy làm theo lời ta sẽ phán.',
        21: 'Vậy, sớm mai, Ba-la-am dậy, thắng lừa cái mình và đi với các sứ thần Mô-áp.',
        22: 'Nhưng cơn thạnh nộ của Ðức Chúa Trời nổi phừng lên, vì người ra đi; thiên sứ của Ðức Giê-hô-va đứng trên đường đặng cản người. Vả, người đã cỡi lừa cái mình, và có hai đứa đầy tớ đi theo.',
        23: 'Lừa cái thấy thiên sứ của Ðức Giê-hô-va đứng trên đường có cây gươm trần nơi tay, bèn tẻ đường đi vào trong ruộng; Ba-la-am đánh nó đặng dẫn nó vào đường lại.',
        24: 'Nhưng thiên sứ của Ðức Giê-hô-va đứng trong đường nhỏ của vườn nho có vách bên nầy và bên kia.',
        25: 'Lừa thấy thiên sứ của Ðức Giê-hô-va thì nép vào vách và ép chân Ba-la-am; người đánh nó.',
        26: 'Thiên sứ của Ðức Giê-hô-va đi tới xa hơn, đứng trong một ngả rất hẹp không chỗ nào trở qua bên hữu hay là bên tả;',
        27: 'lừa thấy thiên sứ của Ðức Giê-hô-va bèn nằm quị dưới Ba-la-am. Nhưng Ba-la-am nổi giận, đánh lừa bằng một cây gậy.',
        28: 'Bấy giờ, Ðức Giê-hô-va mở miệng lừa ra, nó nói cùng Ba-la-am rằng: Tôi có làm chi cho người, mà người đã đánh tôi ba lần?',
        29: 'Ba-la-am đáp cùng lừa cái rằng: Ấy là tại mầy khinh nhạo ta. Chớ chi ta có cây gươm trong tay, ta đã giết mầy rồi!',
        ...
        31: 'Ðức Giê-hô-va bèn mở mắt Ba-la-am ra, thấy thiên sứ của Ðức Giê-hô-va đứng trong đường, tay cầm một cây gươm. Người cúi đầu và sấp mặt xuống đất.',
        32: 'Thiên sứ của Ðức Giê-hô-va nói: Sao ngươi đã đánh lừa cái ngươi ba lần? Nầy, ta đi ra đặng cản ngươi, vì ta thấy ngươi đi theo một con đường dẫn mình đến nơi hư nát.',
        ...
        35: 'Thiên sứ của Ðức Giê-hô-va nói cùng Ba-la-am rằng: Hãy đi cùng các người đó, nhưng chỉ hãy nói điều chi ta sẽ phán dặn ngươi. Ba-la-am bèn đi cùng các sứ thần của Ba-lác.',
        36: 'Khi Ba-lác hay rằng Ba-la-am đến, bèn đi ra tới thành Mô-áp ở gần khe Aït-nôn, tức là ở tận bờ cõi của xứ, mà nghinh tiếp người.',
        ...
        38: 'Ba-la-am đáp cùng Ba-lác rằng: Nầy tôi đã đến cùng vua, bây giờ tôi há có thể nói ra lời gì chăng? Tôi sẽ nói điều chi Ðức Chúa Trời đặt trong miệng tôi vậy.',
    ...
    24: {
        1: 'Ba-la-am thấy rõ Ðức Giê-hô-va ưng ban phước cho Y-sơ-ra-ên, thì không cậy đến phù chú như những lần khác; nhưng người xây mặt về hướng đồng vắng,',
        ...
        13: 'Dầu Ba-lác cho tôi nhà người đầy bạc và vàng, tôi cũng chẳng được vượt qua mạng Ðức Giê-hô-va để làm tự ý điều phải hay là điều quấy; tôi phải nói điều chi Ðức Giê-hô-va sẽ phán!',
    ...
    29: {
        ...
        2: 'Các ngươi phải dùng một con bò đực tơ, một con chiên đực, và bảy chiên con đực giáp năm, không tì vít, dâng làm của lễ thiêu có mùi thơm cho Ðức Giê-hô-va,',
        3: 'luôn với của lễ chay bằng bột lọc nhồi dầu, ba phần mười ê-pha về con bò đực, hai phần mười ê-pha về con chiên đực,',
        ...
        6: 'các ngươi phải dâng những lễ vật nầy ngoài của lễ thiêu đầu tháng, và của lễ chay cặp theo, của lễ thiêu hằng hiến, và của lễ chay với lễ quán cặp theo, tùy theo những lệ đã định về mấy của lễ đó, mà làm của lễ dùng lửa dâng lên có mùi thơm cho Ðức Giê-hô-va.',
        7: 'Ngày mồng mười tháng bảy nầy, các ngươi sẽ có sự nhóm hiệp thánh, phải ép linh hồn mình, chớ nên làm một công việc xác thịt nào.',
        8: 'Các ngươi phải dâng một con bò đực tơ, một con chiên đực, và bảy chiên con đực giáp năm, không tì vít, làm của lễ thiêu có mùi thơm cho Ðức Giê-hô-va:',
        9: 'của lễ chay sẽ bằng bột lọc nhồi dầu, ba phần mười ê-pha về con bò đực, hai phần mười ê-pha về con chiên đực,',
        ...
        12: 'Ngày rằm tháng bảy, các ngươi sẽ có sự nhóm hiệp thánh. Chớ nên làm một công việc xác thịt nào, nhưng các ngươi phải giữ một lễ cho Ðức Giê-hô-va trong bảy ngày.',
        13: 'Các ngươi phải dùng mười ba con bò đực tơ, hai con chiên đực, và mười bốn chiên con đực giáp năm, không tì vít, dâng làm của lễ thiêu, tức là của lễ dùng lửa dâng lên có mùi thơm cho Ðức Giê-hô-va:',
        14: 'của lễ chay cặp theo sẽ bằng bột lọc nhồi dầu, ba phần mười ê-pha về mỗi con bò đực, hai phần mười ê-pha về mỗi con chiên đực,',
        ...
        17: 'Ngày thứ hai, các ngươi phải dâng mười hai con bò đực tơ, hai con chiên đực, mười bốn chiên con đực giáp năm, không tì vít,',
        18: 'với của lễ chay và các lễ quán về những bò đực, chiên đực, và chiên con cứ theo số như lệ đã định.',
        19: 'Các ngươi phải dâng một con dê đực làm của lễ chuộc tội, ngoài của lễ thiêu hằng hiến cùng lễ quán cặp theo.',
        20: 'Ngày thứ ba, các ngươi phải dâng mười một con bò đực, hai con chiên đực, mười bốn chiên con đực giáp năm, không tì vít,',
        21: 'với của lễ chay và các lễ quán về những bò đực, chiên đực và chiên con, cứ theo số như lệ đã định.',
        ...
        23: 'Ngày thứ tư, các ngươi phải dâng mười con bò đực, hai con chiên đực, mười bốn chiên con đực giáp năm, không tì vít,',
        24: 'với của lễ chay và các lễ quán về những bò đực, chiên đực, và chiên con, cứ theo số như lệ đã định.',
        ...
        26: 'Ngày thứ năm, các ngươi phải dâng chín con bò đực, hai con chiên đực, mười bốn chiên con đực giáp năm, không tì vít,',
        27: 'với của lễ chay và các lễ quán về những bò đực, chiên đực, và chiên con, cứ theo số như lệ đã định.',
        ...
        29: 'Ngày thứ sáu, các ngươi phải dâng tám con bò đực, hai con chiên đực, mười bốn chiên con đực giáp năm, không tì vít,',
        30: 'với của lễ chay và các lễ quán về những bò đực; chiên đực, và chiên con, cứ theo số như lệ đã định.',
        ...
        32: 'Ngày thứ bảy, các ngươi phải dâng bảy con bò đực, hai con chiên đực, mười bốn chiên con đực giáp năm, không tì vít,',
        33: 'với của lễ chay và các lễ quán về những bò đực, chiên đực, và chiên con, cứ theo số như lệ đã định.',
        ...
        36: 'phải dùng một con bò đực, một con chiên đực, và bảy chiên con đực giáp năm, không tì vít, dâng làm của lễ thiêu, tức là của lễ dùng lửa dâng lên có mùi thơm cho Ðức Giê-hô-va,',
        37: 'với của lễ chay và các lễ quán về những bò đực, chiên đực, và chiên con, cứ theo số như lệ đã định.',
        ...
        39: 'Ðó là những lễ vật mà các ngươi phải dâng cho Ðức Giê-hô-va trong những ngày lễ trọng thể mình, đặng làm của lễ thiêu, của lễ chay, lễ quán, và làm của lễ thù ân, ngoài những của lễ hứa nguyện, và những của lễ lạc ý của các ngươi.',
    ...
    32: {
        ...
        3: 'A-ta-rốt, Ði-bôn, Gia-ê-xe, Nim-ra, Hết-bôn, Ê-lê-a-sa, Sê-bam, Nê-bô và Bê-ôn,',
        4: 'xứ mà Ðức Giê-hô-va đã đánh bại trước mặt hội chúng Y-sơ-ra-ên, là một xứ tiện hiệp nuôi bầy súc vật, và các tôi tớ ông có bầy súc vật.',
        ...
        7: 'Sao các ngươi xui dân Y-sơ-ra-ên trở lòng, không khứng đi qua xứ mà Ðức Giê-hô-va đã cho?',
        8: 'Ấy, tổ phụ các ngươi cũng làm như vậy khi ở từ Ca-đe-Ba-nê-a, ta sai họ đi do thám xứ.',
        9: 'Vì tổ phụ các ngươi lên đến đèo Ếch-côn, thấy xứ, rồi xui dân Y-sơ-ra-ên trở lòng, không khứng vào xứ mà Ðức Giê-hô-va đã ban cho.',
        10: 'Trong ngày đó, cơn thạnh nộ của Ðức Giê-hô-va phừng lên và Ngài thề rằng:',
        11: 'Những người đi lên khỏi xứ Ê-díp-tô, từ hai mươi tuổi sắp lên, sẽ chẳng hề thấy xứ mà ta đã thề ban cho Áp-ra-ham, Y-sác, và Gia-cốp, vì các người đó không theo ta cách trung thành,',
        12: 'trừ ra Ca-lép, con trai của Giê-phu-nê, là người Kê-nít, và Giô-suê, con trai của Nun: hai người đó đã theo Ðức Giê-hô-va cách trung thành.',
        13: 'Ấy vậy, cơn thạnh nộ của Ðức Giê-hô-va nổi phừng phừng cùng dân Y-sơ-ra-ên, Ngài làm cho dân đó đi lưu lạc trong đồng vắng bốn mươi năm, cho đến chừng nào cả dòng dõi đã làm điều ác trước mặt Ðức Giê-hô-va bị tiêu diệt hết.',
        14: 'Nầy các ngươi dấy lên thế cho tổ phụ mình, là dòng dõi tội nhân, đặng gia thêm sức thạnh nộ của Ðức Giê-hô-va cùng Y-sơ-ra-ên nữa.',
        ...
        20: 'Môi-se đáp cùng các người rằng: Nếu các ngươi làm điều đó, nếu cầm binh khí đặng đi chiến trận trước mặt Ðức Giê-hô-va,',
        21: 'nếu mọi người cầm binh khí đi ngang qua sống Giô-đanh trước mặt Ðức Giê-hô-va, cho đến khi nào đuổi quân-nghịch chạy khỏi trước mặt Ngài,',
        22: 'và nếu chỉ trở về sau khi xứ đã phục trước mặt Ðức Giê-hô-va, thì đối cùng Ðức Giê-hô-va và Y-sơ-ra-ên, các ngươi sẽ không bị trách móc chi, và đất nầy sẽ làm sản nghiệp cho các ngươi trước mặt Ðức Giê-hô-va.',
        23: 'Còn nếu không làm như vậy, nầy các ngươi sẽ phạm tội cùng Ðức Giê-hô-va, và phải biết rằng tội chắc sẽ đổ lại trên các ngươi.',
        ...
        27: 'còn hết thảy tôi tớ ông sẽ cầm binh khí, đi ngang qua, sẵn ngừa mà chiến trận trước mặt Ðức Giê-hô-va, như chúa tôi đã phán dặn.',
        ...
        29: 'mà rằng: Nếu con cháu Gát và con cháu Ru-bên cầm binh khí đi ngang qua sông Giô-đanh với các ngươi đặng chiến trận trước mặt Ðức Giê-hô-va, và nếu xứ phục các ngươi, thì các ngươi phải ban cho họ xứ Ga-la-át làm sản nghiệp.',
        ...
        31: 'Con cháu Gát và con cháu Ru-bên thưa rằng: Chúng tôi sẽ làm điều chi mà Ðức Giê-hô-va đã phán cùng kẻ tôi tớ ông.',
        32: 'Chúng tôi sẽ cầm binh khí đi qua trong xứ Ca-na-an trước mặt Ðức Giê-hô-va; nhưng chúng tôi sẽ lãnh sản nghiệp mình về phía bên nầy sông Giô-đanh.',
        33: 'Ấy vậy, Môi-se ban cho con cháu Gát, con cháu Ru-bên, và phân nữa chi phái Ma-na-se, là con trai của Giô-sép, nước của Si-hôn, vua dân A-mô-rít, và nước của Oùc, vua xứ Ba-san, tức là ban xứ với những thành nó và các thành địa-hạt ở chung quanh.',
        34: 'Con cháu Gát bèn xây cất Ði-bôn, A-ta-rốt, A-rô -e,',
        35: 'Aït-rốt-Sô-phan, Gia-ê-xe, Giô-bê-ha,',
    ...
    35: {
        1: 'Ðức Giê-hô-va phán cùng Môi-se trong đồng Mô-áp, gần sông Giô-đanh, đối ngang Giê-ri-cô, mà rằng:',
        ...
        4: 'Ðất chung quanh thành mà các ngươi nhường cho người Lê-vi sẽ là một ngàn thước chu vi, kể từ vách thành và ở ngoài.',
        5: 'Vậy các ngươi phải đo, phía ngoài thành về hướng đông hai ngàn thước, về hướng nam hai ngàn thước, về hướng tây hai ngàn thước, và về hướng bắc hai ngàn thước; cái thành sẽ ở chính giữa. Ðó sẽ là đất của những thành người Lê-vi.',
        ...
        19: 'Ấy là kẻ báo thù huyết sẽ làm cho kẻ sát nhơn phải chết; khi nào kẻ báo thù huyết gặp kẻ sát nhơn thì phải làm cho nó chết đi.',
        ...
        21: 'hoặc vì sự thù đánh bằng bàn tay, và vì cớ đó nó bị chết, thì người nào đánh đó hẳn phải bị xử tử. Ấy là một kẻ sát nhơn; người báo thù huyết khi nào gặp kẻ sát nhơn phải làm cho nó chết đi.',
        ...
        34: 'Vậy, các ngươi chớ làm ô uế xứ, là nơi các ngươi sẽ ở, và chánh giữa đó là nơi ta sẽ ngự; vì ta là Ðức Giê-hô-va ngự giữa dân Y-sơ-ra-ên.',
    },
    36: {
        ...
        2: 'mà rằng: Ðức Giê-hô-va có phán cùng chúa tôi bắt thăm chia xứ cho dân Y-sơ-ra-ên làm sản nghiệp, và chúa tôi có lãnh mạng Ðức Giê-hô-va giao sản nghiệp của Xê-lô-phát, anh chúng tôi, cho các con gái người.',
        ...
        5: 'Môi-se bèn truyền các lịnh nầy của Ðức Giê-hô-va cho dân Y-sơ-ra-ên mà rằng: Chi phái con cháu Giô-sép nói có lý.',
        6: 'Nầy là điều Ðức Giê-hô-va có phán về phần các con gái Xê-lô-phát: Chúng nó muốn kết thân với ai thì muốn, những chỉ hãy kết thân với một trong những nhà của chi phái tổ phụ mình.',
        ...
        13: 'Ðó là các mạng lịnh và luật lệ mà Ðức Giê-hô-va đã cậy Môi-se truyền cho dân Y-sơ-ra-ên, tại trong đồng bằng Mô-áp, gần sông Giô-đanh, đối ngang Giê-ri-cô.',
    },
}
