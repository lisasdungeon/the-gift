...
CHAPTERS = {
    ...
    3: {
        ...
        2: 'Thiên sứ của Ðức Giê-hô-va hiện ra cùng người trong ngọn lửa, giữa bụi gai kia. Người nhìn thấy cả bụi gai đang cháy, nhưng không hề tàn.',
        3: 'Môi-se bèn nói rằng: Ta hãy tẻ bước lại đặng xem sự lạ lớn nầy, vì cớ sao bụi gai chẳng tàn chút nào.',
        4: 'Ðức Giê-hô-va thấy người tẻ bước lại xem, Ðức Chúa Trời bèn ở giữa bụi gai gọi rằng: Hỡi Môi-se, hỡi Môi-se! Người thưa rằng: Có tôi đây!',
        5: 'Ðức Chúa Trời phán rằng: Chớ lại gần chốn nầy, Hãy cổi giầy ngươi ra, vì chỗ ngươi đang đứng là đất thánh.',
        6: 'Rồi Ngài lại nói: Ta là Ðức Chúa Trời của tổ phụ ngươi, Ðức Chúa Trời của Áp-ra-ham, Ðức Chúa Trời của Y-sác, và Ðức Chúa Trời của Gia-cốp. Môi-se liền che mặt, vì sợ nhìn đến Ðức Chúa Trời.',
        7: 'Ðức Giê-hô-va phán rằng: Ta đã thấy rõ ràng sự cực khổ của dân ta tại xứ Ê-díp-tô, và có nghe thấu tiếng kêu rêu vì cớ người đốc công của nó; phải, ta biết được nỗi đau đớn của nó.',
        ...
        12: 'Ðức Chúa Trời phán rằng: Ta sẽ ở cùng ngươi; nầy là điều làm dấu cho ngươi biết rằng ta đã sai ngươi đi: Khi ngươi dắt dân sự ra khỏi xứ Ê-díp-tô rồi, thì các ngươi sẽ phụng sự Ðức Chúa Trời tại trên núi nầy.',
        13: 'Môi-se thưa cùng Ðức Chúa Trời rằng: Nầy, tôi sẽ đi đến dân Y-sơ-ra-ên, nói cùng họ rằng: Ðức Chúa Trời của tổ phụ các ngươi sai ta đến cùng các ngươi; nhưng nếu họ hỏi: Tên Ngài là chi? thì tôi nói với họ làm sao?',
        14: 'Ðức Chúa Trời phán rằng: Ta là Ðấng Tự Hữu Hằng Hữu; rồi Ngài lại rằng: Hãy nói cho dân Y-sơ-ra-ên như vầy: Ðấng Tự Hữu đã sai ta đến cùng các ngươi.',
        ...
        16: 'Hãy đi, hội hiệp các trưởng lão Y-sơ-ra-ên, mà nói cùng họ rằng: Giê-hô-va, Ðức Chúa Trời của tổ phụ các ngươi, Ðức Chúa Trời của Áp-ra-ham, Ðức Chúa Trời của Y-sác, Ðức Chúa Trời của Gia-cốp, đã hiện ra cùng ta mà phán rằng: Thật vậy, ta đã thăm viếng các ngươi, thấy điều họ đãi các ngươi tại xứ Ê-díp-tô,',
    ...
    4: {
        ...
        10: 'Môi-se thưa cùng Ðức Giê-hô-va rằng: Ôi! lạy Chúa, từ hôm qua, hôm kia, hay là từ lúc Chúa phán dạy kẻ tôi tớ Chúa, tôi vẫn chẳng phải một tay nói giỏi, vì miệng và lưỡi tôi hay ngập ngừng.',
    ...
    6: {
        ...
        14: 'Ðây là các trưởng tộc của những họ hàng dân Y-sơ-ra-ên. Các con trai của Ru-bên, tức là trưởng nam Y-sơ-ra-ên, là: Hê-nóc, Pha-lu, Hết-rôn và Cạt-mi. Ðó là những họ hàng của Ru-bên.',
    ...
    9: {
        ...
        28: 'Hãy cầu nguyện Ðức Giê-hô-va, hầu cho tan sấm sét và mưa đá; rồi trẫm sẽ tha các ngươi đi, không đợi lâu nữa đâu.',
        ...
        33: 'Vậy, Môi-se lui khỏi Pha-ra-ôn, đi ra thành, giơ tay lên Ðức Giê-hô-va, sấm sét và mưa đá tạnh, mưa bèn ngớt hột trên mặt đất.',
        34: 'Khi Pha-ra-ôn thấy mưa, mưa đá và sấm sét đã tạnh rồi, người và quần thần lại rắn lòng, cứ phạm tội nữa.',
    ...
    10: {
        ...
        2: 'hầu cho ngươi thuật cùng con và cháu mình những công việc to tát ta đã làm trên dân Ê-díp-tô, các dấu lạ ta đã làm giữa vòng họ, đặng các ngươi biết rằng ta là Ðức Giê-hô-va.',
        3: 'Môi-se và A-rôn bèn đi đến Pha-ra-ôn mà tâu rằng: Giê-hô-va là Ðức Chúa Trời dân Hê-bơ-rơ, có phán như vầy: Ngươi không chịu hạ mình trước mặt ta cho đến chừng nào? Hãy tha dân ta đi, để chúng nó hầu việc ta.',
        ...
        7: 'Quần thần Pha-ra-ôn tâu rằng: Ðến chừng nào người nầy mới thôi gài bẫy ta? Hãy tha dân ấy đi, để chúng nó hầu việc Giê-hô-va Ðức Chúa Trời chúng nó! Bệ hạ chưa biết rằng nước Ê-díp-tô đã bị nguy vong sao?',
        ...
        9: 'Môi-se tâu rằng: Chúng tôi đi, sẽ đem nam phụ lão ấu và chiên bò theo, vì về phần chúng tôi, ấy là một lễ của Ðức Giê-hô-va.',
        10: 'Pha-ra-ôn nói rằng: Cầu xin Ðức Giê-hô-va ở cùng các ngươi! Hồ dễ ta cho các ngươi cùng con cái đều đi sao! Không! quả thật không cho đâu, vì các ngươi có mưu ác!',
        11: 'Không được vậy đâu, chỉ các ngươi, là đàn ông, phải đi hầu việc Ðức Giê-hô-va, vì là điều các ngươi đã xin. Ðoạn, họ bèn đuổi Môi-se và A-rôn khỏi trước mặt Pha-ra-ôn.',
        12: 'Ðức Giê-hô-va bèn phán cùng Môi-se rằng: Hãy giơ tay ngươi ra trên xứ Ê-díp-tô, đặng khiến cào cào tràn lên xứ đó, cắn xả rau cỏ và mọi vật chi trên đất mưa đá còn chừa lại.',
        13: 'Vậy, Môi-se bèn giơ gậy mình ra trên xứ Ê-díp-tô, thì Ðức Giê-hô-va dẫn ngọn gió đông thổi trên xứ sòng ngày và đêm đó; qua sáng mai gió đông đã dẫn cào cào đến.',
        ...
        16: 'Pha-ra-ôn vội đòi Môi-se và A-rôn đến mà phán rằng: Trẫm đã phạm tội cùng Giê-hô-va Ðức Chúa Trời các ngươi, và cùng các ngươi nữa.',
        17: 'Nhưng bây giờ, xin xá tội cho trẫm lần nầy; và hãy cầu giùm Giê-hô-va Ðức Chúa Trời các ngươi, hầu cho ít nữa Ngài khiến xa trẫm cái vạ chết nầy.',
        18: 'Môi-se bèn lui ra khỏi Pha-ra-ôn, và khẩn nguyện Ðức Giê-hô-va.',
        19: 'Ðức Giê-hô-va dẫn ngọn gió tây đến rất mạnh, đem cào cào đi đuổi xuống Biển đỏ; khắp địa hạt Ê-díp-tô chẳng còn một con cào cào nào.',
        20: 'Nhưng Ðức Giê-hô-va làm cho Pha-ra-ôn cứng lòng: người chẳng tha dân Y-sơ-ra-ên đi.',
        21: 'Ðức Giê-hô-va bèn phán cùng Môi-se rằng: Hãy giơ tay ngươi lên trời, hầu cho trên xứ Ê-díp-tô có sự tối tăm dày đến nỗi người ta rờ đụng đến được.',
        ...
        24: 'Pha-ra-ôn bèn đòi Môi-se mà phán rằng: Hãy đi hầu việc Ðức Giê-hô-va; con trẻ các ngươi đi theo nữa; chỉ bầy chiên và bò ở lại thôi.',
        25: 'Nhưng Môi-se tâu rằng: Chính bệ hạ hãy cấp cho chúng tôi các con sinh và vật chi dùng làm của lễ thiêu để dâng cho Giê-hô-va Ðức Chúa Trời chúng tôi.',
        26: 'Các bầy lục súc sẽ theo chúng tôi nữa, không còn để lại một móng chân nào; vì chúng tôi sẽ dùng mấy con thú đó mà hầu việc Giê-hô-va Ðức Chúa Trời chúng tôi. Chúng tôi biết vật chi dùng để thờ phượng Ðức Giê-hô-va, chỉ khi nào sẽ đến nơi đó.',
        27: 'Nhưng Ðức Giê-hô-va làm cho Pha-ra-ôn cứng lòng, nên người không khứng cho dân Y-sơ-ra-ên đi.',
    ...
    12: {
        ...
        37: 'Dân Y-sơ-ra-ên đi từ Ram-se đến Su-cốt, số không kể con nít, được chừng sáu mươi vạn người đàn ông đi bộ.',
    ...
    17: {
        ...
        16: 'và nói rằng: Bởi vì A-ma-léc có giơ tay lên nghịch cùng ngôi Ðức Giê-hô-va, nên Ðức Giê-hô-va chinh chiến với A-ma-léc từ đời nầy qua đời kia.',
    },
    18: {
        ...
        4: 'và một tên là Ê-li-ê-se, vì người lại có nói: Ðức Chúa Trời của tổ phụ tôi đã vùa giúp và giải cứu tôi khỏi gươm Pha-ra-ôn.',
    ...
    22: {
        ...
        13: 'Nếu con bật bị thú rừng xé chết, người lãnh giữ phải đem nó ra làm chứng, sẽ không phải bồi thường vật bị xé đó.',
    ...
    23: {
        ...
        19: 'Những hoa quả đầu mùa của đất, ngươi phải đem đến đền thờ Giê-hô-va Ðức Chúa Trời ngươi. Ngươi chớ nên nấu dê con trong sữa mẹ nó.',
    ...
    26: {
        ...
        7: 'Ngươi cũng hãy kết mười một bức màn bằng lông dê, để dùng làm bong che trên đền tạm.',
        ...
        17: 'có hai cái mộng liền nhau; hết thảy các tấm ván vách đền tạm ngươi cũng sẽ làm như vậy.',
    ...
    28: {
        ...
        4: 'Ðây là bộ áo mà họ sẽ chế: Bảng đeo ngực, ê-phót, áo dài, áo lá trong thêu, mũ và đai. Thế thì, họ sẽ chế bộ áo thánh cho A-rôn, anh ngươi, cùng các con trai người, để các người đó làm chức tế lễ trước mặt ta.',
        ...
        25: 'và hai đầu sợi chuyền cột vào móc gài, đoạn gắn trên hai đai vai ê-phót về phía đằng trước ngực.',
        ...
        28: 'Rồi một sợi dây màu tím sẽ cột hai cái khoanh của bảng đeo ngực lại cùng hai cái khoanh ê-phót, hầu cho nó dính với đai, đừng rớt khỏi ê-phót.',
    ...
    29: {
        ...
        23: 'lại lấy luôn một ổ bánh, một bánh nhỏ nhồi với dầu, và một cái bánh tráng ở trong giỏ bánh không men để trước mặt Ðức Giê-hô-va;',
    ...
    36: {
        ...
        2: 'Vậy, Môi-se bèn gọi Bết-sa-lê-ên, Ô-hô-li-áp, và các người khôn khéo mà trong lòng họ Ðức Giê-hô-va phú sự thông sáng cùng các người có lòng cảm động xui mình đến gần, đặng làm công việc.',
        ...
        5: 'đến nỗi cùng Môi-se rằng: Dân sự đem đến dư bội phần đặng làm các công việc mà Ðức Giê-hô-va đã phán dặn.',
        ...
        13: 'Ðoạn chế năm chục cái móc bằng vàng, móc bức nầy với bức kia, để cho đền tạm kết lại thành một.',
    ...
    38: {
        ...
        3: 'Rồi làm các đồ phụ tùng của bàn thờ bằng đồng: chảo nhỏ, vá, ảng, nỉa, và bình hương.',
        4: 'Lại làm một tấm rá bằng lưới đồng để dưới thành bàn thờ, từ chân lên đến ngang giữa,',
        5: 'và đúc cái khoen cho bốn góc rá lưới đồng, đặng xỏ đòn khiêng.',
        6: 'Ðoạn, chuốt đòn khiêng bằng cây si-tim, và bọc đồng;',
        7: 'xỏ đòn vào khoen nơi hai bên bàn thờ, đặng khiêng bàn đi. Người đóng bàn thờ bằng ván, trống bộng.',
        8: 'Người dùng các tấm gương của mấy người đàn bà hầu việc nơi cửa hội mạc, chế ra một cái thùng và chân thùng bằng đồng.',
        9: 'Người cũng làm hành lang: về phía nam mấy bức bố vi của hành lang bằng vải gai đậu mịn, dài trăm thước;',
        10: 'hai chục cây trụ và hai chục lỗ trụ bằng đồng, đinh và nuông trụ bằng bạc.',
        11: 'Về phía bắc, cũng một trăm thước bố vi, hai chục cây trụ và hai chục lỗ trụ bằng đồng, đinh và nuông trụ bằng bạc.',
        12: 'Về phía tây, năm chục thước bố vi, mười cây trụ, và mười lỗ trụ bằng đồng, đinh và nuông trụ bằng bạc.',
        ...
        17: 'các lỗ trụ bằng đồng, đinh, nuông bằng bạc, và đầu trụ bọc bạc. Hết thảy trụ của hành lang đều nhờ có nuông bạc chắp với nhau.',
        18: 'Tấm màn nơi cửa hành lang làm thêu thùa bằng chỉ tím, đỏ điều, đỏ sặm, và vải gai đậu mịn; bề dài hai chục thước, bề cao (tùy theo bề khổ của vải) năm thước, đồng cỡ với bề cao của các bố vi chung quanh hành lang.',
        19: 'Bốn cây trụ và bốn lỗ trụ bằng đồng, đinh, đồ bọc đầu trụ, và những nuông đều bằng bạc.',
        20: 'Các nọc của đền tạm và của hành lang chung quanh đều bằng đồng.',
        21: 'Ðây là sổ tổng cộng về đền tạm, là đền tạm chứng cớ theo lịnh truyền của Môi-se biểu người Lê-vi làm ra, nhờ Y-tha-ma, con trai của thầy tế lễ cả A-rôn, cai quản.',
        22: 'Bết-sa-lê-ên, con trai U-ri, cháu Hu-rơ, thuộc về chi phái Giu-đa, làm theo mọi điều Ðức Giê-hô-va đã phán dặn Môi-se,',
        23: 'và kẻ giúp người là Ô-hô-li-áp, con trai A-hi-sa-mạc, thuộc về chi phái Ðan, làm thợ chạm, kẻ bày vẽ, thợ thêu thùa bằng chỉ tím, đỏ điều, đỏ sặm, và bằng chỉ gai mịn.',
        24: 'Hết thảy vàng đã hiệp dùng vào các công việc nơi thánh (ấy là vàng dâng) được hai mươi chín ta lâng, bảy trăm ba chục siếc-lơ, theo siếc-lơ của nơi thánh.',
        ...
        26: 'Hết thảy người nào có kể sổ, từ hai mươi tuổi sắp lên, nghĩa là sáu trăm ba ngàn năm trăm năm chục người, mỗi người nộp nửa siếc-lơ, theo siếc-lơ của nơi thánh.',
        27: 'Vậy, phải một trăm ta lâng bạc đặng đúc các lỗ trụ của nơi thánh, và lỗ trụ màn; một trăm ta lâng cho một trăm lỗ trụ, tức một ta lâng vào mỗi lỗ trụ.',
        28: 'Còn một ngàn bảy trăm bảy mươi lăm siếc-lơ dư lại, thì dùng làm đinh trụ, bọc đầu trụ và lấy nuông chắp các trụ với nhau.',
        29: 'Ðồng đem dâng cộng được bảy chục ta lâng, hai ngàn bốn trăm siếc-lơ.',
        30: 'Họ dùng đồng đó làm lỗ trụ của cửa hội mạc, bàn thờ bằng đồng, rá bằng đồng, các đồ phụ tùng của bàn thờ;',
        31: 'các lỗ trụ của hành lang chung quanh, các lỗ trụ của cửa hành lang, các nọc của đền tạm, và các nọc của hành lang chung quanh.',
    },
    39: {
