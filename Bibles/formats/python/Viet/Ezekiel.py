...
CHAPTERS = {
    ...
    4: {
        ...
        14: 'Ta bèn nói: Ôi! hỡi Chúa Giê-hô-va, nầy, linh hồn tôi chẳng hề bị ô uế. Từ lúc còn nhỏ đến bây giờ, tôi chẳng hề ăn con vậy đã chết tự nhiên, hoặc bị thú vật xé; và chẳng có thịt gớm ghiếc nào đã vào trong miệng tôi.',
        15: 'Ngài đáp rằng: Ta cho phép ngươi lấy phân bò thay phân người; ngươi khá dùng nó mà hấp bánh.',
        16: 'Ðoạn, Ngài lại phán: Hỡi con người, nầy, ta sẽ bẻ gậy bánh trong Giê-ru-sa-lem đi; chúng nó sẽ cân bánh mà ăn, và sợ hãi, lường nước mà uống, và sững sờ.',
        17: 'Thế thì chúng nó thiếu bánh và nước, cùng nhau thất kinh, và hao mòn trong tội lỗi mình.',
    },
    5: {
        1: 'Hỡi con người, còn như ngươi, hãy lấy một cái gươm bén như dao cạo râu, lấy mà đưa qua trên đầu và râu ngươi. Rồi dùng cân cân, và chia tóc.',
    ...
    6: {
        ...
        2: 'Hỡi con người, hãy xây mặt về các núi của Y-sơ-ra-ên, và nói tiên tri nghịch cùng nó,',
        3: 'rằng: Hỡi các núi của Y-sơ-ra-ên, hãy nghe lời của Chúa Giê-hô-va. Chúa Giê-hô-va phán cùng các núi, các đồi, hầm hố, và nơi trũng như vầy: Nầy, ta, chính ta sẽ giá gươm trên các ngươi, hủy hoại các nơi cao của các ngươi.',
        ...
        5: 'Ta sẽ đặt những xác chết con cái Y-sơ-ra-ên ra trước mặt thần tượng chúng nó, và rải hài cốt các ngươi khắp chung quanh bàn thờ các ngươi.',
        6: 'Hễ nơi nào các ngươi ở, thì thành ấp sẽ bị hủy hoại, các nơi cao sẽ bị hoang vu, đến nỗi bàn thờ các ngươi bị hủy hoại hoang vu, thần tượng bị đập bể và không còn nữa, tượng mặt trời nát ra từng mảnh, và mọi công việc của các ngươi thành ra hư không.',
        7: 'Những kẻ bị giết sẽ ngã xuống giữa các ngươi, các ngươi sẽ biết rằng ta là Ðức Giê-hô-va!',
        8: 'Dầu vậy, khi các ngươi bị tan lạc ra các nước, ta sẽ còn để dân sót lại, vì giữa các nước sẽ có một vài người được thoát khỏi mũi gươm.',
        9: 'Những kẻ trong các ngươi được thoát ấy sẽ nhớ đến ta trong các nước mà chúng nó bị bắt đến, thể nào ta đã buồn rầu trong lòng, vì lòng tà dâm của chúng nó đã lìa bỏ ta, và mắt chúng nó hành dâm theo thần tượng mình. Bấy giờ chúng nó tự oán hận mình, vì cớ mọi sự dữ chúng nó đã làm bởi những việc gớm ghiếc của mình.',
        10: 'Chúng nó sẽ biết ta là Ðức Giê-hô-va, và lời ta đã nói giáng tai vạ cho chúng nó chẳng phải là lời hư không vậy.',
        11: 'Chúa Giê-hô-va phán như vầy: Hãy vỗ tay giậm chơn mà rằng: Than ôi! vì mọi sự dữ đáng gớm của nhà Y-sơ-ra-ên; vì nó sẽ chết bởi gươm dao, đói kém, và ôn dịch.',
        12: 'Kẻ nào xa sẽ chết bởi ôn dịch. Kẻ nào gần sẽ ngã dưới lưỡi gươm. Kẻ nào sống sót, là kẻ bị vây, sẽ chết bởi đói kém; đối với chúng nó, ta sẽ làm cho trọn sự giận của ta.',
        13: 'Khi những kẻ bị giết của chúng nó nằm giữa đám thần tượng xung quanh bàn thờ, trên mỗi gò cao, trên mọi đỉnh núi, dưới mọi cây xanh và cây dẽ rậm, khắp những nơi chúng nó dâng hương thơm ngào ngạt cho thần tượng mình, bấy giờ các ngươi sẽ biết ta là Ðức Giê-hô-va.',
        14: 'Vậy ta sẽ giang tay nghịch cùng chúng nó, hễ nơi nào chúng nó ở, thì ta sẽ làm cho đất đó ra hoang vu hủy phá, từ đồng vắng cho đến Ðíp-lát. Thế thì chúng nó sẽ biết ta là Ðức Giê-hô-va.',
    },
    7: {
    ...
    10: {
        1: 'Ta nhìn xem, nầy, trên vòng khung giang ra trên đầu các chê-ru-bin có vật gì như là đá bích ngọc, hình trạng như hình cái ngai.',
        ...
        7: 'Rồi một chê-ru-bin từ giữa các chê-ru-bin giơ tay ra đến lửa giữa các chê-ru-bin, và lấy lửa đem đặt vào tay người mặc vải gai; người nầy tiếp lấy rồi thì ra.',
        ...
        12: 'Cả mình các chê-ru-bin, lưng, tay, cánh, bánh xe, khắp chung quanh đều đầy những mắt, tức các bánh xe mà bốn chê-ru-bin ấy có.',
    ...
    11: {
        1: 'Vả lại, Thần cất ta lên và đem đến cửa đông nhà Ðức Giê-hô-va, là cửa ở về phía đông. Nầy, nơi lối vào cửa có hai mươi lăm người; giữa bọn đó, ta thấy có Gia-a-xa-nia con trai A-xua, và Phê-la-tia con trai Bê-na-gia, đều là quan trưởng của dân.',
        2: 'Ngài phán cùng ta rằng: hãy con người, đó là những người toan tính sự gian ác, bày đặt mưu gian trong thành nầy.',
        3: 'Chúng nó nói rằng: Hiện nay chưa gần kỳ xây nhà! Thành nầy là nồi, chúng ta là thịt.',
    ...
    14: {
        1: 'Một vài trưởng lão kia của Y-sơ-ra-ên đến cùng ta, ngồi trước mặt ta.',
    ...
    17: {
        ...
        15: 'Nhưng vua đã dấy loạn nghịch cùng vua Ba-by-lôn, mà sai sứ thần đến Ê-díp-tô, đặng người ta giúp cho những ngựa và nhiều dân. Người há được thạnh vượng sao? Người đã làm những việc như vầy, há thoát nạn được sao? Ðã dứt bỏ lời giao ước, còn mong thoát nạn!',
    ...
    19: {
        ...
        7: 'Nó biết cung đền chúng nó, và hủy phá các thành; đất nầy cùng mọi vật trong nó đều bị hoang vu, vì tiếng gầm của nó.',
    ...
    20: {
        ...
        6: 'ngày đó ta thề hứa cùng chúng nó rằng ta sẽ đem chúng nó ra khỏi đất Ê-díp-tô đặng vào đất mà ta đã tìm sẵn cho chúng nó, tức là đất đượm sữa và mật ong, vinh hiển nhứt trong các đất.',
        ...
        15: 'Vả, ta cũng đã thề cùng chúng nó trong đồng vắng rằng ta sẽ không đem chúng nó vào đất mà ta đã định cho chúng nó, là đất đượm sữa và mật ong, vinh hiển nhứt trong mọi đất;',
    ...
    21: {
        1: '(21:6) Ðoạn có lời Ðức Giê-hô-va phán cùng ta như vầy:',
        ...
        20: '(21:25) Ngươi khá chỉ định đường lối cho gươm đi qua, một đường thì hướng về Ráp-ba, thành của con cái Am-môn, và một đường hướng về Giu-đa tại Giê-ru-sa-lem, là thành bền vững.',
        ...
        26: '(21:31) Chúa Giê-hô-va phán như vầy: Hãy cất mũ nầy, lột mão triều thiên nầy; sự nầy chẳng giống như trước nữa! Cái gì thấp hãy lại cất lên, cái gì cao hãy hạ xuống.',
    ...
    24: {
        1: 'Năm thứ chín, ngày mồng mười, có lời Ðức Giê-hô-va phán cho ta rằng:',
        2: 'Hỡi con người, nước ghi chép tên ngày nầy, chính ngày nầy; cũng chính ngày nầy vua Ba-by-lôn đến gần thành Giê-ru-sa-lem.',
        3: 'Hãy nói một lời thí dụ cho nhà bạn nghịch ấy, và rằng: Chúa Giê-hô-va phán như vầy: Hãy đặt nồi, hãy đặt, và đổ nước vào.',
        4: 'Hãy để những tấm thịt vào, là hết thảy những tấm thịt tốt, những đùi và vai, và làm cho đầy xương rất tốt.',
        5: 'Hãy chọn con rất tốt trong bầy, và vì xương chất củi dưới nồi. Hãy làm cho sôi sục sục lên, để nấu xương trong nồi.',
        6: 'Vậy nên, Chúa Giê-hô-va phán như vầy: Khốn cho thành hay đổ máu, khốn cho nồi bị ten rét mà ten rét chưa trừ hết! Hãy lấy từ tấm từ tấm ra cho hết, không có bắt thăm.',
        7: 'Vì máu mà nó đã đổ ra còn ở giữa nó; nó đã đổ máu ấy trên vầng đá láng bóng; chớ không đổ trên đất đặng cho bụi che lấp đi.',
        8: 'Ấy là để là cho cơn giận nổi lên và báo thù, mà ta đổ máu nó trên vầng đá láng bóng; đến nỗi nó không có thể che đậy được.',
        9: 'Vậy nên, Chúa Giê-hô-va phán như vầy: Khốn cho thành hay đổ máu! Ta cũng sẽ chất một đống củi lớn.',
        10: 'Hãy chất củi, làm cho lửa hực lên, làm cho rục thịt, cho đặc nước, và cho cháy đi.',
        11: 'Ðoạn, hãy đặt nồi không trên những than lửa đỏ, hầu cho đồng nó cháy lên, cho sự ô uế nó tan ra ở bề trong, và cho ten rét của nó sạch hết.',
        12: 'Nó làm việc mệt nhọc; nhưng ten rét quá lắm của nó còn chưa ra khỏi; dầu bỏ ten rét nó vào lửa cũng không ra!',
        13: 'Sự ô uế mầy là tà dâm: vì ta đã tẩy sạch mầy và mầy không trở nên sạch, thì mầy sẽ không được chùi sự dơ bẩn của mình nữa, cho đến chừng nào ta đã làm cho cơn giận của ta được yên nghỉ đối với mầy.',
        14: 'Ta là Ðức Giê-hô-va, ta đã phán; sự đó sẽ xảy đến, và ta sẽ làm thành. Ta sẽ không lui đi, không tiếc, không ăn năn. Người ta sẽ xét đoán mầy theo đường lối mầy và theo việc làm mầy, Chúa Giê-hô-va phán vậy.',
        15: 'Có lời Ðức Giê-hô-va phán cùng ta rằng:',
        16: 'Hỡi con người, nầy, thình lình ta sẽ cất khỏi ngươi sự con mắt ngươi ưa thích; nhưng ngươi sẽ chẳng than thở, chẳng khóc lóc, và nước mắt ngươi chẳng chảy ra.',
        17: 'Hãy than thầm; chớ phát tang cho những kẻ chết; khá vấn cái khăn trên đầu ngươi. Chớ che môi lại, và đừng ăn bánh của kẻ khác.',
        18: 'Sớm mai ta nói cùng dân sự; đến chiều thì vợ ta chết. Sáng bữa sau ta làm theo như lời đã phán cho ta.',
        19: 'Bấy giờ dân sự nói cùng ta rằng: Ngươi không tỏ cho chúng ta về cách ngươi làm như vậy là nghĩa gì sao?',
        20: 'Ta trả lời rằng: Có lời Ðức Giê-hô-va phán cùng ta rằng:',
        21: 'Hãy nói cùng nhà Y-sơ-ra-ên: Chúa Giê-hô-va phán như vầy: Nầy, ta sẽ làm ô uế nơi thánh ta, là nơi các ngươi lấy làm khoe khoang về quyền năng mình, mắt các ngươi ưa thích, lòng các ngươi thương xót; và những con trai con gái các ngươi mà các ngươi đã để lại, sẽ ngã bởi gươm.',
        22: 'Bấy giờ các ngươi sẽ làm như ta đã làm; các ngươi không che môi, không ăn bánh của kẻ khác.',
        23: 'Khăn các ngươi sẽ để yên trên đầu, giày các ngươi sẽ mang luôn dưới chơn; các ngươi không kêu thương, không khóc lóc; song sẽ bị hao mòn vì cớ tội ác mình, và các ngươi cùng nhau than thở.',
        24: 'Ê-xê-chi-ên sẽ là một dấu hiệu cho các ngươi, phàm sự nó đã làm, thì các ngươi cũng sẽ làm. Khi mọi sự đó xảy đến, các ngươi sẽ biết ta là Chúa Giê-hô-va.',
        25: 'Hỡi các ngươi, về ngươi thì, ngày nào ta sẽ cất khỏi chúng nó sức mạnh, sự vui mừng, sự vinh hiển, sự ưa thích của mắt chúng nó, sự lòng chúng nó yêu mến, con trai và con gái chúng nó,',
        26: 'trong ngày đó sẽ có kẻ trốn đến báo tin cho tai ngươi nghe.',
        27: 'Trong ngày đó, miệng ngươi sẽ mở ra cùng một lúc với miệng của kẻ trốn. Ngươi sẽ nói, và không bị câm nữa: ngươi sẽ là một dấu hiệu cho chúng nó, và chúng nó sẽ biết rằng ta là Ðức Giê-hô-va.',
    },
    25: {
        1: 'Có lời Ðức Giê-hô-va phán cùng ta rằng:',
        2: 'Hỡi con người, hãy xây mặt về con cái Am-môn, và nói tiên tri nghịch cùng chúng nó.',
        3: 'Hãy nói cùng con cái Am-môn rằng: Hãy nghe lời của Chúa Giê-hô-va. Chúa Giê-hô-va phán như vầy: Vì ngươi có nói rằng: Hay! hay! về nơi thánh ta, khi nó bị ô uế, về đất Y-sơ-ra-ên, khi nó bị làm nên hoang vu, cùng về nhà Giu-đa, khi nó bị bắt làm phu tù,',
        4: 'bởi cớ đó, nầy, ta sẽ phó ngươi cho các con cái phương đông làm cơ nghiệp. Chúng nó sẽ đóng trại giữa ngươi, và cất nhà mình ở đó; chúng nó sẽ ăn trái ngươi và uống sữa ngươi.',
        5: 'Ta sẽ khiến Ra-ba làm chuồng lạc đà, và con cái Am-môn làm chỗ bầy vật nằm, thì các ngươi sẽ biết ta là Ðức Giê-hô-va.',
        6: 'Vì Chúa Giê-hô-va phán như vầy: bởi ngươi đã vỗ tay, đập chơn, đầy lòng khinh dể và vui vẻ về đất Y-sơ-ra-ên,',
        7: 'bởi cớ đó, mầy, ta đã giá tay ta trên ngươi. Ta sẽ phó ngươi làm mồi cho các nước; ta sẽ trừ ngươi ra khỏi các dân; ta sẽ diệt ngươi khỏi các nước; ta sẽ hủy hoại ngươi, và ngươi sẽ biết ta là Ðức Giê-hô-va.',
        8: 'Chúa Giê-hô-va phán như vầy: Vì Mô-áp và Sê -i-rơ có nói rằng: Nầy, nhà Giu-đa cũng như các nước khác,',
        9: 'bởi cớ đó, nầy, ta sẽ phá các thành của bờ cõi người Mô-áp, tức là hết thảy các thành trong đất chúng nó làm vinh hiển cho xứ ấy, là thành Bết-Giê-si-mốt, thành Ba-anh-Mê-ôn, và thành Ki-ri-a-ta-im.',
        10: 'Ta sẽ phó xứ nầy và xứ của người Am-môn cho các con trai phương đông. Ta sẽ ban những xứ nầy cho chúng nó làm sản nghiệp, hầu cho con cái Am-môn không được ghi nhớ giữa các nước nữa.',
        11: 'Ta cũng sẽ làm sự phán xét trên Mô-áp; và chúng nó sẽ biết ta là Ðức Giê-hô-va.',
        12: 'Chúa Giê-hô-va phán như vầy: Vì dân Ê-đôm đã làm sự báo thù nghịch cùng nhà Giu-đa, và nhơn báo thù nhà ấy mà phạm tội nặng, nên Chúa Giê-hô-va phán như vầy:',
        13: 'Ta sẽ giá tay nghịch cùng Ê-đôm, sẽ dứt người và vật ở đó; ta sẽ làm thành ấy nên hoang vu; từ Thê-man đến Ðê-đan, chúng nó sẽ ngã bởi gươm.',
        14: 'Ta sẽ làm sự báo thù ta trên Ê-đôm, bởi tay của dân Y-sơ-ra-ên ta; dân ấy sẽ đãi dân Ê-đôm theo như sự thạnh nộ và tức giận của ta. Bấy giờ chúng nó sẽ biết sự báo thù của ta là thế, Chúa Giê-hô-va phán vậy.',
        15: 'Chúa Giê-hô-va phán như vầy: Vì dân Phi-li-tin làm sự báo thù, làm sự báo thù theo lòng ghen ghét vô cùng mà muốn hủy diệt,',
        16: 'bởi đó, Chúa Giê-hô-va phán như vầy: Nầy, ta sẽ giá tay trên các người Phi-li-tin; sẽ dứt những người Cơ-rết; và ta sẽ làm cho chết hết những kẻ còn sót lại ở trên mé biển.',
        17: 'Ta sẽ làm sự báo thù lớn nghịch cùng chúng nó, mà dùng cơn giận quở trách chúng nó; chúng nó sẽ biết ta là Ðức Giê-hô-va, khi ta sẽ làm sự báo thù nghịch cùng chúng nó.',
    },
    26: {
    ...
    28: {
        1: 'Lại có lời Ðức Giê-hô-va phán cùng ta rằng:',
        2: 'Hỡi con người, hãy nói cùng vua Ty-rơ rằng: Chúa Giê-hô-va phán như vầy: Vì lòng ngươi đã tự cao, và ngươi nói rằng: Ta là một vì thần, ta ngồi trên ngai Ðức Chúa Trời, ở giữa các biển; dầu lòng ngươi tự cao lên bằng lòng Ðức Chúa Trời, ngươi còn là loài người, không phán là Ðức Chúa Trời.',
        3: 'Nầy, ngươi khôn hơn Ða-ni-ên; chẳng có sự mầu nhiệm nào giấu kín khỏi ngươi!',
        4: 'Ngươi đã được giàu có bởi sự khôn ngoan và thông sáng của mình; đã thâu chứa vàng bạc trong kho tàng ngươi;',
        ...
        6: 'Vậy nên, Chúa Giê-hô-va phán như vầy: Vì lòng ngươi tự cao lên lười biếng lòng Ðức Chúa Trời,',
        7: 'cho nên, nầy, ta sẽ khiến những người ngoại quốc hung bạo hơn hết trong các dân, nổi dậy nghịch cùng ngươi; chúng nó sẽ rút gươm nghịch cùng sự khôn sáng hoa mĩ ngươi, và làm ô uế sự vinh hiển ngươi.',
        8: 'Chúng nó sẽ xô ngươi xuống hầm hố và ngươi sẽ chết trong lòng biển, như người bị giết.',
        9: 'Trước mặt kẻ giết ngươi, ngươi còn dám nói rằng: Ta là Ðức Chúa Trời chăng? Khi ấy ngươi ở trong tay của kẻ làm ngươi bị thương, thì ngươi là loài người, chẳng phải là Ðức Chúa Trời.',
        ...
        21: 'Hỡi con người, hãy xây mặt về phía Si-đôn, và nói tiên tri nghịch cùng nó.',
        22: 'Ngươi khá nói rằng: Chúa Giê-hô-va phán như vầy: Hỡi Si-đôn, nầy, ta nghịch cùng mầy; ta muốn làm sáng danh ta ở giữa mầy. Chúng nó sẽ biết ta là Ðức Giê-hô-va, khi ta sẽ làm sự phán xét và tỏ mình ra thánh trong nó.',
        23: 'Ta sẽ sai ôn dịch đến giữa nó, và sẽ có máu trong các đường phố nó. Những kẻ bị thương sẽ ngã xuống giữa nó, vì gươm sẽ đổ trên nó tư bề; và chúng nó sẽ biết rằng ta là Ðức Giê-hô-va.',
        24: 'Vừa lúc ấy, sẽ không có chà chuôm hay châm chích, gai gốc hay đau đớn cho nhà Y-sơ-ra-ên, trong những kẻ ở chung quanh dân ấy, và đãi dân ấy cách khinh dể. Bấy giờ chúng nó sẽ biết ta là Chúa Giê-hô-va.',
        25: 'Chúa Giê-hô-va phán như vầy: Khi ta đã nhóm nhà Y-sơ-ra-ên lại từ giữa các dân mà chúng nó đã bị tan tác trong đó, và ta đã tỏ mình ra thánh giữa chúng nó trước mắt các dân, thì chúng nó sẽ ở trong đất mình mà ta đã ban cho tôi tớ ta là Gia-cốp.',
        26: 'Chúng nó sẽ ở đó yên ổn, sẽ cất nhà và trồng vườn nho. Chúng nó sẽ ở đó yên ổn, khi ta đã làm sự phán xét ta nghịch cùng những kẻ ở chung quanh chúng nó, là kẻ đãi chúng nó cách khinh dể; và chúng nó sẽ biết rằng ta là Giê-hô-va Ðức Chúa Trời mình.',
    },
    29: {
    ...
    31: {
        1: 'Năm thứ mười một, ngày mồng một tháng ba, có lời Ðức Giê-hô-va phán cùng ta như vầy:',
        ...
        17: 'Chúng nó cũng đã xuống với nó trong nơi âm phủ, kề những kẻ đã bị gươm giết, những kẻ ngày trước vốn là cánh tay của nó và ở dưới bóng nó giữa các dân.',
    ...
    36: {
        1: 'Hỡi con người, hãy nói tiên tri về các núi của Y-sơ-ra-ên, và rằng: Hỡi các núi của Y-sơ-ra-ên, hãy nghe lời Ðức Giê-hô-va!',
        2: 'Chúa Giê-hô-va phán như vầy: Vì quân thù nghịch có nói về bay rằng: Ê! Những gò cao đời xưa thuộc về chúng ta làm sản nghiệp!',
        3: 'Vì cớ đó, hãy nói tiên tri, và rằng: Chúa Giê-hô-va phán như vầy: Thật, vì chúng nó đã làm cho bay nên hoang vu, và nuốt bay tư bề, đặng bay trở nên sản nghiệp của những kẻ sót lại của các nước, và bay bị miệng kẻ hay nói bàn luận, và bị dân sự chê bai,',
        4: 'vì cớ đó, hỡi các núi của Y-sơ-ra-ên, hãy nghe lời của Chúa Giê-hô-va: Chúa Giê-hô-va phán như vầy cho các núi và các gò, cho khe suối và đồng trũng, cho nơi đổ nát hoang vu và các thành bị bỏ, đã phó cho những kẻ sót lại của các nước chung quanh bay cướp bóc và nhạo báng,',
        5: 'vì cớ đó, Chúa Giê-hô-va phán như vầy: Thật, trong cơn ghen tương nóng nảy, ta rao lời án nghịch cùng kẻ sót lại của các nước ấy và cả Ê-đôm, là những kẻ đầy lòng vui mừng và ý khinh dể, định đất của ta cho mình làm kỷ vật, đặng phó nó cho sự cướp bóc.',
        ...
        7: 'Vậy nên, Chúa Giê-hô-va phán như vầy: Ta đã thề rằng: Các nước chung quanh bay chắc sẽ chịu hổ nhuốc!',
        8: 'Nhưng nay, các núi Y-sơ-ra-ên, sẽ sanh những nhánh và ra trái cho dân Y-sơ-ra-ên ta; vì chúng nó sắp trở về.',
        9: 'Nầy, ta hướng về bay, xây lại cùng bay, và bay sẽ bị cày cấy gieo vãi.',
        10: 'Trên đất bay ta sẽ thêm số dân cư và số con cái cả nhà Y-sơ-ra-ên. Các thành sẽ có người ở, các nơi đổ nát sẽ được dựng lại.',
        11: 'Ta sẽ thêm loài người và loài vật trên đất bay, chúng nó sẽ thêm nhiều và nẩy nở; ta sẽ làm cho bay đông dân như lúc trước, và ban ơn cho bay hơn thuở ban đầu. Bấy giờ bay sẽ biết ta là Ðức Giê-hô-va.',
        12: 'Ta sẽ làm cho những dân cư bước đi trên đất ngươi, tức là dân Y-sơ-ra-ên ta. Thật, chúng nó sẽ được mầy làm kỷ vật; mầy sẽ làm sản nghiệp chúng nó, và không làm mất con cái chúng nó nữa.',
        13: 'Chúa Giê-hô-va phán như vầy: Vì người ta nói cùng bay rằng: Hỡi đất, mầy nuốt người ta, và làm mất con cái của dân mầy đi,',
        14: 'cũng vì cớ đó, mầy chẳng nuốt người ta nữa, và không làm mất con cái của dân mầy đi nữa, Ðức Giê-hô-va phán vậy.',
        15: 'Ta không để cho mầy nghe những lời nhiếc móc của các nước nữa; mầy sẽ không còn chịu sự nhuốc nha của các dân nữa, và mầy không khiến dân mình vấp phạm nữa, Chúa Giê-hô-va phán vậy.',
        16: 'Lại có lời Ðức Giê-hô-va phán cùng ta rằng:',
        17: 'Hỡi con người, khi nhà Y-sơ-ra-ên ở trong đất mình, đã làm ô uế đất ấy bởi đường lối và việc làm của mình: đường lối chúng nó ở trước mặt ta như là sự ô uế của một người đờn bà chẳng sạch.',
        ...
        20: 'Khi chúng nó đã tới trong các nước mà chúng nó đã đi đến, thì chúng nó đã phạm danh thánh ta, đến nỗi người ta nói về chúng nó rằng: Ấy là dân của Ðức Giê-hô-va; chúng nó đã ra đi từ đất Ngài!',
        ...
        23: 'Ta sẽ làm nên thánh danh lớn của ta, là danh đã bị phạm trong các dân, giữa các dân đó các ngươi đã phạm danh ấy. Chúa Giê-hô-va phán: Như vậy các dân tộc sẽ biết ta là Ðức Giê-hô-va, khi trước mắt chúng nó ta sẽ được tỏ ra thánh bởi các ngươi.',
        ...
        28: 'Các ngươi sẽ ở trong đất mà ta đã ban cho tổ phụ các ngươi; các ngươi sẽ làm dân ta, ta sẽ làm Ðức Chúa Trời các ngươi.',
        ...
        30: 'Ta sẽ thêm nhiều trái cây và hoa lợi của đồng ruộng, hầu cho các ngươi không vì đói kém chịu sự xấu hổ ở giữa các nước.',
        31: 'Bấy giờ các ngươi sẽ nhớ lại đường lối xấu xa của mình, và việc làm của mình là không tốt. Chính các ngươi sẽ tự gớm ghét mình, vì cớ tội lỗi và những sự gớm ghiếc của các ngươi.',
        32: 'Chúa Giê-hô-va phán: Chẳng phải vì cớ các ngươi mà ta làm như vậy, các ngươi khá biết rõ. Hỡi nhà Y-sơ-ra-ên, khá biết hổ và mắc cỡ về đường lối mình.',
        33: 'Chúa Giê-hô-va phán như vầy: Ngày mà ta sẽ làm sạch mọi tội lỗi các ngươi, ta sẽ lại làm cho thành các ngươi có dân ở, và những chỗ đổ nát sẽ dựng lại.',
        34: 'Ðất hoang vu sẽ cầy cấy, dầu mà trước đã hoang vu trước mắt mọi kẻ đi qua.',
        35: 'Chúng nó sẽ nói rằng: Ðất hoang vu nầy đã trở nên như vườn Ê-đen; những thành đổ nát, hoang vu, tàn phá kia, kìa đã có tường vách và dân ở!',
        36: 'Bấy giờ các dân tộc còn sót lại xung quanh các ngươi sẽ biết rằng ta, Ðức Giê-hô-va, đã cất lại nơi bị phá, trồng lại nơi bị hủy. Ta, Ðức Giê-hô-va, đã phán lời đó, và sẽ làm thành.',
        37: 'Chúa Giê-hô-va phán như vầy: Ta còn muốn nhà Y-sơ-ra-ên cầu hỏi ta để ta làm sự nầy cho: Ta sẽ thêm nhiều người nam nó như một bầy chiên.',
        38: 'Các thành đổ nát sẽ đầy những bầy người, như bầy chiên để làm của lễ, như bầy của Giê-ru-sa-lem trong ngày lễ trọng thể. Và chúng nó sẽ biết ta là Ðức Giê-hô-va.',
    },
    37: {
        ...
        21: 'và nói cùng chúng nó rằng: Chúa Giê-hô-va phán như vầy: Nầy, ta sẽ kéo con cái Y-sơ-ra-ên ra khỏi giữa các nước mà trong các nước ấy chúng nó đã đi. Ta sẽ nhóm chúng nó lại từ bốn phương, và đem chúng nó về trong đất riêng của chúng nó.',
    ...
    38: {
        ...
        8: 'Sau nhiều ngày, ngươi sẽ lãnh mạng ra đi; trong những năm sau rốt ngươi sẽ đến trong một đất là đất đã được giải cứu khỏi gươm và nhóm lại từ giữa nhiều dân tộc; ngươi sẽ đến trên núi Y-sơ-ra-ên, là nơi đổ nát đã lâu, nhưng nó đã được đem về từ giữa các đến, và chúng nó hết thảy sẽ ở yên.',
        ...
        13: 'Sê-ba và Ðê-đan, những con buôn của Ta-rê-si và hết thảy những sư tử tơ của nó, sẽ nói cùng ngươi rằng: Có phải ngươi đến đặng bóc lột, ngươi nhóm quân đội mình lại đặng cướp của, đặng đem bạc và vàng đi, đặng lấy những súc vật và của cải, đặng làm một sự cướp giựt lớn sao?',
    ...
    39: {
        1: 'Hỡi con người, hãy nói tiên tri nghịch cùng Gót và bảo nó rằng: Chúa Giê-hô-va phán như vầy: Hỡi Gót, vua của Rô-rơ, Mê-siếc, và Tu-banh, nầy, ta nghịch cùng ngươi.',
        ...
        17: 'Hỡi con người, Chúa Giê-hô-va phán như vầy: Hãy nói cùng cả loài chim và hết thảy các loài thú đồng rằng: Hãy nhóm lại, hãy từ bốn phương đến vì một của lễ mà ta dọn cho bay, tức là một của lễ lớn trên các núi Y-sơ-ra-ên, để bay được ăn thịt và uống huyết.',
    ...
    40: {
        ...
        17: 'Rồi đó, người dẫn ta vào nơi hành lang ngoài; nầy, tại đó có những phòng, và có nền lót đá chung quanh hành lang; trên nền lót đá ấy có ba mươi cái phòng.',
        ...
        24: 'Rồi đó, người dắt ta qua phòng nam, nầy, tại đó có hiên cửa hướng nam; người đo các cột và các nhà ngoài, cũng đồng cỡ nhau.',
        ...
        26: 'Có bảy cấp bước lên, ngay trước các cấp ấy có một cái nhà ngoài; mỗi phía có những hình cây kè trên các cột.',
    ...
    41: {
        ...
        5: 'Rồi người đo tường nhà: sáu cu-đê; bề ngang của những phòng bên hông khắp chung quanh nhà: bốn cu-đê.',
        ...
        22: 'Cái bàn thờ thì bằng gỗ, cao ba cu-đê, dài hai cu-đê. Những góc, mặt, và những cạnh của bàn thờ đều bằng gỗ. Người ấy bảo ta rằng: Nầy là cái bàn ở trước mặt Ðức Giê-hô-va.',
    ...
    43: {
        ...
        2: 'Ta thấy vinh quang của Ðức Chúa Trời Y-sơ-ra-ên từ phương đông mà đến. Tiếng Ngài giống như tiếng nước lớn, và đất sáng rực vì vinh quang Ngài.',
        3: 'Sự hiện thấy mà ta thấy bấy giờ, giống như sự hiện thấy đã hiện ra cho ta khi ta đến đặng hủy diệt thành nầy. Ấy là những sự hiện thấy giống như sự hiện thấy mà ta đã thấy trên bờ sông Kê-ba, và ta sấp mặt xuống.',
        4: 'Vinh quang của Ðức Giê-hô-va vào trong nhà do hiên cửa hướng đông.',
        5: 'Thần cất ta lên và đem ta vào nơi hành lang trong; và, nầy, vinh quang của Ðức Giê-hô-va đầy nhà.',
        ...
        8: 'vì chúng nó đã đặt ngạch cửa của nơi thánh mình gần ngạch cửa ta, đặt trụ cửa của mình gần trụ cửa ta, cho đến nỗi giữa ta và chúng nó chỉ có cái tường mà thôi. Ấy vậy chúng nó đã làm ô uế danh thánh ta bởi những sự gớm ghiếc mà chúng nó đã phạm; nên ta giận mà tuyệt diệt chúng nó đi.',
        9: 'Bây giờ chúng nó khá bỏ sự hành dâm mình và những xác chết của vua mình cách xa ta, thì ta sẽ ở giữa chúng nó đời đời.',
        10: 'Hỡi con người, khá cho nhà Y-sơ-ra-ên biết nhà nầy, hầu cho chúng nó xấu hổ về tội lỗi mình. Chúng nó khá đo theo kiểu nó.',
        11: 'Khi chúng nó hổ thẹn về mọi điều mình đã làm, ngươi khá giơ hình nhà nầy ra cho chúng nó, là những hình thế, đường ra, lối vào, hết thảy các hình trạng, hết thảy những mạng lịnh nó, hình nó, và hết thảy luật lệ nó. Hãy viết mà tả ra mọi điều đó trước mặt chúng nó, hầu cho chúng nó giữ lấy cả hình nó và cả lệ luật nó để làm theo.',
        12: 'Nầy là luật của nhà: Cả châu vi nó ở trên chót núi, là nơi rất thánh. Ấy là luật của nhà như vậy.',
        13: 'Nầy là mực thước của bàn thờ, bằng cu-đê mà mỗi cu-đê dài hơn cu-đê thường một gang tay. Cái nền cao một cu-đê, và rộng một cu-đê, cái lợi vòng quanh theo nó cao một gang; đó là cái đế bàn thờ.',
        ...
        23: 'Khi ngươi đã xong sự làm sạch, thì khá dâng một con bò đực tơ không tì vít, và một con chiên đực không tì vít, bắt ra từ trong bầy.',
        24: 'Ngươi sẽ đem hai vật đó gần trước mặt Ðức Giê-hô-va, các thầy tế lễ rưới muối lên, và dâng làm của lễ thiêu cho Ðức Giê-hô-va.',
        25: 'Thẳng bảy ngày, mỗi ngày ngươi khá sắm một con dê đực, để làm lễ chuộc tội; và sắm một con bò đực tơ, một con chiên đực không tì vít, bắt ra từ trong bầy.',
        26: 'Thẳng bảy ngày, phải làm lễ chuộc tội cho bàn thờ, phải làm sạch nó, biệt nó riêng ra thánh.',
    ...
    44: {
        1: 'Ðoạn người đem ta đến hiên cửa ngoài của nơi thánh, ngó về phía đông. Cửa ấy vẫn đóng.',
        2: 'Ðức Giê-hô-va bèn phán cùng ta rằng: Hiên cửa nầy sẽ đóng luôn không mở nữa. Chẳng ai được vào bởi hiên cửa nầy, vì Giê-hô-va Ðức Chúa Trời của Y-sơ-ra-ên đã vào bởi đó; vậy cửa ấy sẽ đóng lại.',
        3: 'Chỉ có vua, vì người là vua, thì có thể đến ngồi tại đó đặng ăn bánh trước mặt Ðức Giê-hô-va. Vua sẽ vào bởi nhà ngoài của hiên cửa, và cũng ra bởi đường ấy.',
        4: 'Rồi người dắt ta bởi hiên cửa phía bắc đến trước nhà. Ta nhìn xem, và nầy, vinh quang của Ðức Giê-hô-va đầy dẫy nhà Ðức Giê-hô-va, thì ta sấp mặt xuống.',
        5: 'Bấy giờ Ðức Giê-hô-va phán cùng ta rằng: Hỡi con người, khá chú ý kĩ càng; lấy mắt ngó và lấy tai nghe mọi điều ta sẽ phán cùng ngươi, về mọi mạng lịnh mọi lệ luật của nhà Ðức Giê-hô-va. Hãy cẩn thận coi sóc lối vào của nhà, và hết thảy các đường ra của nơi thánh.',
        6: 'Ngươi khá nói cùng kẻ bạn nghịch tức là nhà Y-sơ-ra-ên rằng: Chúa Giê-hô-va phán như vầy: Hỡi nhà Y-sơ-ra-ên, mọi sự đáng gớm ghiếc của các ngươi đã đủ rồi.',
        7: 'Các ngươi đã dắt những con cái dân ngoại, là những kẻ không cắt bì bề lòng chúng nó cũng như về thịt chúng nó, vào trong nơi thánh ta đặng làm ô uế nhà ta, khi các ngươi dâng bánh, mỡ và huyết của ta; như vậy các ngươi đã phạm lời giao ước ta bởi mọi sự gớm ghiếc của các ngươi.',
        8: 'Chính các ngươi không giữ vật thánh ta; nhưng các ngươi đã lập người khác thay mình mà giữ vật thánh ta trong nơi thánh ta.',
        9: 'Chúa Giê-hô-va phán như vầy: Chẳng có một người ngoại nào không cắt bì về lòng nó cũng như về thịt nó mà được vào trong nơi thánh ta; không, chẳng có một người ngoài nào ở giữa con cái Y-sơ-ra-ên được vào đó.',
        10: 'Vả lại, khi dân Y-sơ-ra-ên lầm lạc, thì những người Lê-vi đã đi cách xa ta, bỏ ta đặng hầu việc thần tượng nó, sẽ mang tội lỗi mình.',
        11: 'Dầu vậy, chúng nó sẽ hầu việc trong nơi thánh ta, làm kẻ giữ cửa nhà, sẽ hầu việc nơi nhà, sẽ vì dân sự giết những con sinh định làm của lễ thiêu và các của lễ khác, sẽ đứng trước mặt dân sự đặng hầu việc nó.',
        12: 'Vì chúng nó đã hầu việc dân sự trước mặt những thần tượng của nó, và đã nên dịp tội cho nhà Y-sơ-ra-ên; vì cớ đó, ta đã giơ tay lên nghịch cùng chúng nó, vậy chúng nó sẽ mang tội lỗi mình, Chúa Giê-hô-va phán vậy.',
        13: 'Chúng nó sẽ không đến gần ta đặng làm trọn các công việc thầy tế lễ trước mặt ta. Chúng nó sẽ không đến gần vật thánh nào của ta, hãy vật rất thánh; song sẽ mang sự nhuốc nha và những sự gớm ghiếc mình đã phạm.',
        14: 'Nhưng mà ta sẽ lập chúng nó lên đặng coi giữ nhà, đặng làm trọn chức vụ và mọi công việc cần trong đó.',
        15: 'Ðến như các thầy tế lễ họ Lê-vi, con cháu của Xa-đốc, còn coi giữ nơi thánh ta khi con cái Y-sơ-ra-ên lầm lạc cách xa ta, những kẻ đó sẽ gần ta đặng hầu việc, sẽ đứng trước mặt ta đặng dâng mỡ và huyết, Chúa Giê-hô-va phán vậy.',
        16: 'Ấy là những kẻ sẽ vào nơi thánh ta, đến gần nơi bàn ta đặng hầu việc ta, và giữ vật ta.',
        17: 'Khi chúng nó vào bởi các cửa của hành lang trong, thì sẽ mặt áo bằng gai; chúng nó sẽ không mặc đồ bằng lông chiên trong khi hầu việc nơi các hiên cửa của hành lang và nơi nhà.',
        18: 'Chúng nó sẽ đội khăn bằng gai trên đầu và mặc quần đùi bằng gai nơi lưng, thứ vải nào hay đổ mồ hôi thì không mặc lấy.',
        19: 'Nhưng khi chúng nó đi qua nơi hành lang ngoài, là nơi dân sự đứng, thì phải cởi áo xống hầu việc, để trong các phòng thánh, và mặc áo khác, hầu cho không lấy áo mình làm cho dân sự nên thánh.',
        ...
        22: 'Chúng nó không được lấy đờn bà góa hoặc bị để mà làm vợ; nhưng phải lấy gái đồng trinh về dòng nhà Y-sơ-ra-ên, hay là lấy vợ góa của một thầy tế lễ.',
        23: 'Chúng nó sẽ dạy dân ta phân biệt điều chi là thánh với điều chi là tục; làm cho dân ta biết điều ô uế và điều thánh sạch khác nhau là thể nào.',
        24: 'Khi có sự kiện xảy đến, chúng nó phải xử đoán, và phải xử đoán theo mạng lịnh ta; chúng nó sẽ vâng giữ các luật pháp ta và các lệ luật ta trong mọi kỳ lễ của ta, và làm cho các ngày sa-bát ta nên thánh.',
        25: 'Chẳng có một ai trong chúng nó được đến gần thây kẻ chết, e bị ô uế chăng; song le, thầy tế lễ có thể bị ô uế vì cha mình, vì mẹ mình, vì một người anh em, hay là vì một người chị em không chồng.',
        26: 'Sau sự được sạch, sẽ kể là bảy ngày.',
        27: 'Cái ngày mà thầy tế lễ ấy sẽ vào trong nơi thánh, trong hành lang trong, đặng hầu việc tại đó, thì phải dâng của lễ chuộc tội mình, Chúa Giê-hô-va phán vậy.',
        28: 'Còn như gia tài để dành cho chúng nó, thì chính ta là gia tài của chúng nó đây. Các ngươi chớ cho chúng nó sản nghiệp gì trong Y-sơ-ra-ên; chính ta là sản nghiệp chúng nó.',
        29: 'Chúng nó sẽ nuôi mình bằng những của lễ chay, của lễ chuộc sự mắc lỗi, và của lễ chuộc tội; lại hễ vật chi khấn dâng bởi trong dân Y-sơ-ra-ên thì sẽ thuộc về chúng nó.',
        30: 'Các hoa quả đầu mùa của mọi thứ sản vật, cùng hết thảy của lễ chay mà các ngươi dâng, đều sẽ thuộc về thầy tế lễ. Các ngươi cũng sẽ cho các thầy tế lễ bột nhồi đầu mình của mình, hầu làm cho sự chúc phước yên nghỉ nơi nhà các ngươi.',
        31: 'Các thầy tế lễ không nên ăn thịt của một con thú nào chết tự nhiên, hay là bị xé, hoặc thịt chim, hoặc thịt thú.',
    },
    45: {
    ...
    47: {
        ...
        6: 'Bấy giờ người bảo ta rằng: Hỡi con người, có thấy không? Rồi người đem ta trở lại nơi bờ sông.',
        ...
        12: 'Gần bên sông ấy, trên bề nầy và bờ kia, sẽ sanh đủ thứ cây có trái ăn được, lá nó không hề héo rụng, và trái nó không hề dứt. Mỗi tháng nó sẽ sanh ra trái mới, vì những nước tưới nó chảy ra từ nơi thánh. Trái nó dùng để ăn, lá nó dùng để làm thuốc.',
