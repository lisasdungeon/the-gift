...
CHAPTERS = {
    1: {
        1: 'Châm ngôn của Sa-lô-môn, con trai Ða-vít, Vua Y-sơ-ra-ên:',
        2: 'Ðặng khiến cho người ta hiểu biết sự khôn ngoan và điều khuyên dạy, Cùng phân biệt các lời thông sáng;',
        ...
        6: 'Ðể hiểu biết châm ngôn, thí dụ, Và lời của người khôn ngoan, cùng câu đố nhiệm của họ.',
        7: 'Sự kính sợ Ðức Giê-hô-va là khởi đầu sự tri thức; Còn kẻ ngu muội khinh bỉ sự khôn ngoan và lời khuyên dạy.',
    ...
    15: {
        ...
        3: 'Con mắt Ðức Giê-hô-va ở khắp mọi nơi, Xem xét kẻ gian ác và người lương thiện.',
        ...
        9: 'Ðường lối kẻ ác lấy làm gớm ghiếc cho Ðức Giê-hô-va; Nhưng Ngài thương mến người nào theo sự công bình.',
        10: 'Sự hình phạt nặng nề dành cho kẻ bỏ chánh lộ; Và kẻ ghét lời quở trách sẽ chết mất.',
        11: 'Aâm phủ và chốn trầm luân còn ở trước mặt Ðức Giê-hô-va thay, Phương chi lòng của con cái loài người!',
        ...
        16: 'Thà có ít của mà kính sợ Ðức Giê-hô-va, Còn hơn là tài sản nhiều mà bối rối cặp theo.',
        ...
        19: 'Ðường kẻ biếng nhác như một hàng rào gai; Còn nẻo người ngay thẳng được ban bằng.',
        ...
        22: 'Ðâu không có nghị luận, đó mưu đành phải phế; Nhưng nhờ có nhiều mưu sĩ, mưu định bèn được thành.',
        23: 'Miệng hay đáp giỏi khiến người vui vẻ; Và lời nói phải thì lấy làm tốt biết bao!',
        24: 'Con đường sự sống của người khôn ngoan dẫn lên trên, Ðể tránh khỏi âm phủ ở dưới thấp.',
        25: 'Ðức Giê-hô-va sẽ đánh đổ nhà kẻ kiêu ngạo; Nhưng Ngài làm vững chắc các mộc giới của kẻ góa bụa.',
        26: 'Các mưu ác lấy làm gớm ghiếc cho Ðức Giê-hô-va; Song lời thanh sạch đẹp lòng Ngài.',
        ...
        29: 'Ðức Giê-hô-va xa cách kẻ ác; Nhưng Ngài nghe lời cầu nguyện của người công bình.',
        ...
        33: 'Sự kính sợ Ðức Giê-hô-va dạy dỗ điều khôn ngoan; Và sự khiêm nhượng đi trước sự tôn trọng.',
    },
    16: {
        1: 'Việc toan liệu của lòng thuộc về loài người; Còn sự đáp lời của lưỡi do Ðức Giê-hô-va mà đến.',
        2: 'Các đường lối của người đều là trong sạch theo mắt mình; Song Ðức Giê-hô-va cân nhắc cái lòng.',
        3: 'Hãy phó các việc mình cho Ðức Giê-hô-va, Thì những mưu ý mình sẽ được thành công.',
        4: 'Ðức Giê-hô-va đã dựng nên muôn vật để dùng cho Ngài; Ðến đỗi kẻ ác cũng vậy, để dành cho ngày tai họa.',
        5: 'Phàm ai có lòng kiêu ngạo lấy làm gớm ghiếc cho Ðức Giê-hô-va; Quả thật nó sẽ chẳng được khỏi bị phạt.',
        6: 'Nhờ sự nhơn từ và chơn thật tội lỗi được chuộc; Và bởi sự kính sợ Ðức Giê-hô-va người ta xây bỏ điều ác.',
        7: 'Khi tánh hạnh của người nào đẹp lòng Ðức Giê-hô-va, Thì Ngài cũng khiến các thù nghịch người ở hòa thuận với người.',
        ...
        11: 'Trái cân và vá cân công bình thuộc về Ðức Giê-hô-va; Các trái cân trong bao là công việc của Ngài.',
        ...
        16: 'Ðược sự khôn ngoan, thật quí hơn vàng ròng biết mấy! Ðược thông sáng, đáng chuộng hơn bạc biết bao!',
        17: 'Ðạo của người ngay thẳng, ấy là lìa bỏ sự ác; Ai canh giữ tánh nết mình giữ lấy linh hồn mình.',
        ...
        20: 'Ai giữ theo đạo lý tìm được ích; Và ai trông cậy nơi Ðức Giê-hô-va lấy làm có phước thay.',
        ...
        33: 'Người ta bẻ thăm trong vạt áo; Song sự nhứt định do nơi Ðức Giê-hô-va mà đến.',
    },
    17: {
        ...
        3: 'Nồi dót để luyện bạc, lò để luyện vàng; Nhưng Ðức Giê-hô-va thử lòng của loài người.',
        4: 'Kẻ làm ác chăm chỉ về môi gian ác; Kẻ hay nói dối lắng tai nghe lưỡi độc hiểm.',
        5: 'Ai nhạo báng người bần cùng sỉ nhục Ðấng tạo hóa mình; Ai vui mừng về tai họa sẽ chẳng được thoát khỏi bị phạt.',
        ...
        15: 'Ai xưng kẻ ác là công bình, và kẻ nào lên án cho người công bình, Cả hai điều lấy làm gớm ghiếc cho Ðức Giê-hô-va.',
        ...
        23: 'Người gian ác lãnh nhẹm của hối lộ, Ðặng làm sai lệch các lối xét đoán.',
    ...
    19: {
        ...
        3: 'Sự ngu dại của người nào làm cho hư hỏng đường lối mình, Và lòng người oán Ðức Giê-hô-va.',
        ...
        10: 'Aên ở sung sướng chẳng xứng hiệp cho kẻ ngu muội; Phương chi kẻ tôi mọi cai trị các hoàng tử!',
        ...
        14: 'Nhà cửa và tài sản là cơ nghiệp của tổ phụ để lại; Còn một người vợ khôn ngoan do nơi Ðức Giê-hô-va mà đến.',
        ...
        17: 'Ai thương xót kẻ nghèo, tức cho Ðức Giê-hô-va vay mượn; Ngài sẽ báo lại việc ơn lành ấy cho người.',
        ...
        20: 'Hay nghe lời khuyên dạy, và tiếp nhận sự giáo hối, Ðể con được khôn ngoan trong lúc cuối cùng.',
        ...
        23: 'Sự kính sợ Ðức Giê-hô-va dẫn đến sự sống, Làm cho người ta được ở thỏa nguyện, không bị tai họa lâm đến.',
    ...
    28: {
        ...
        5: 'Kẻ buông mình vào sự ác chẳng hiểu sự công bình; Nhưng ai tìm cầu Ðức Giê-hô-va hiểu biết mọi sự.',
        ...
        25: 'Người nào có lòng kiêu ngạo giục sự tranh cạnh; Nhưng kẻ nào tin cậy Ðức Giê-hô-va sẽ được no nê.',
    ...
    30: {
        ...
        16: 'Tức là âm phủ, người đờn bà son sẻ, Ðất không no đủ nước, Và lửa mà chẳng hề nói: Ðủ rồi!',
