...
CHAPTERS = {
    1: {
        ...
        21: 'hãy giữ mình trong sự yêu mến Ðức Chúa Trời, và trông đợi sự thương xót của Ðức Chúa Jêsus Christ chúng ta cho được sự sống đời đời.',
        ...
        25: 'là Ðức Chúa Trời có một, là Cứu Chúa chúng ta, bởi Ðức Chúa Jêsus Christ là Chúa chúng ta, được sự vinh hiển, tôn trọng, thế lực, quyền năng thuộc về Ngài từ trước vô cùng và hiện nay cho đến đời đời! A-men.',
    },
}
