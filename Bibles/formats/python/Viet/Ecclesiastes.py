...
CHAPTERS = {
    ...
    2: {
        ...
        11: 'Ðoạn ta xem xét các công việc tay mình đã làm, và sự lao khổ mình đã chịu để làm nó; kìa, mọi điều đó là sự hư không và theo luồng gió thổi, chẳng có ích lợi gì hết dưới mặt trời.',
        ...
        15: 'Nên ta có nói trong lòng rằng: Sự xảy đến cho kẻ dại, sẽ xảy đến cho ta cũng vậy; vậy, ta có nhiều khôn ngoan như thế mà làm chi? Ta lại nói trong lòng rằng: Ðiều đó là một sự hư không nữa.',
        ...
        19: 'Vả, ai biết rằng người ấy sẽ khôn ngoan hay là ngu dại? Dầu thế nào, hắn sẽ cai quản mọi việc ta đã lấy sự lao khổ và khôn ngoan mà làm ở dưới mặt trời. Ðiều đó cũng là hư không.',
        20: 'Bởi cớ ấy ta trở lòng thất vọng về mọi công việc ta đã lao khổ mà làm ở dưới mặt trời.',
        21: 'Vì có người làm công việc mình cách khôn ngoan, thông sáng, và tài giỏi, rồi phải để lại làm cơ nghiệp cho kẻ chẳng hề lao khổ làm đến. Ðiều đó cũng là một sự hư không và một sự tai nạn lớn.',
        22: 'Vậy, ích chi cho người lao khổ, cực lòng mà làm việc ở dưới mặt trời?',
        23: 'Vì các ngày người chỉ là đau đớn, công lao người thành ra buồn rầu; đến đỗi ban đêm lòng người cũng chẳng được an nghỉ. Ðiều đó cũng là sự hư không.',
        24: 'Chẳng gì tốt cho người hơn là ăn, uống, khiến linh hồn mình hưởng phước của lao khổ mình. Ta xem thấy điều đó cũng bởi tay Ðức Chúa Trời mà đến.',
        25: 'Vì ai là người được ăn và hưởng sự vui sướng hơn ta?',
        26: 'Bởi Ðức Chúa Trời ban sự khôn ngoan, thông sáng, và vui vẻ cho kẻ nào đẹp lòng Ngài; nhưng Ngài khiến cho kẻ có tội phải lao khổ mà thâu góp chất chứa, để rồi ban cho người đẹp lòng Ðức Chúa Trời. Ðiều đó cũng là hư không, theo luồng gió thổi.',
    },
    3: {
        ...
        10: 'Ta đã thấy công việc mà Ðức Chúa Trời ban cho loài người là loài người dùng tập rèn lấy mình.',
        11: 'Phàm vật Ðức Chúa Trời đã làm nên đều là tốt lành trong thì nó. Lại, Ngài khiến cho sự đời đời ở nơi lòng loài người; dầu vậy, công việc Ðức Chúa Trời làm từ ban đầu đến cuối cùng, người không thế hiểu được.',
        12: 'Vậy, ta nhìn biết chẳng có điều gì tốt cho loài người hơn là vui vẻ, và làm lành trọn đời mình.',
        13: 'Lại, ai nấy phải ăn, uống, và hưởng lấy phước của công lao mình, ấy cũng là sự ban cho của Ðức Chúa Trời.',
        14: 'Ta biết rằng mọi việc Ðức Chúa Trời làm nên còn có đời đời: người ta chẳng thêm gì được, cũng không bớt chi đặng; Ðức Chúa Trời làm như thế, để loài người kính sợ trước mặt Ngài.',
        15: 'Ðiều chi hiện có, đã có ngày xưa; điều chi sẽ xảy đến, đã xảy đến từ lâu rồi: Ðức Chúa Trời lại tìm kiếm việc gì đã qua.',
        16: 'Ta lại còn thấy dưới mặt trời, trong nơi công đàng có sự gian ác, và tại chốn công bình có sự bất nghĩa.',
        17: 'Ta bèn nói trong lòng rằng: Ðức Chúa Trời sẽ đoán xét kẻ công bình và người gian ác; vì ở đó có kỳ định cho mọi sự mọi việc.',
    ...
    4: {
        1: 'Ta xây lại, xem xét mọi sự hà hiếp làm ra ở dưới mặt trời; kìa, nước mắt của kẻ bị hà hiếp, song không ai an ủi họ! Kẻ hà hiếp có quyền phép, song không ai an ủi cho kẻ bị hà hiếp!',
        2: 'Vậy, ta khen những kẻ chết đã lâu rồi là sướng hơn kẻ còn sống;',
        3: 'còn kẻ chưa được sanh ra, chưa thấy những gian ác làm ra dưới mặt trời, ta cho là có phước hơn hai đằng kia.',
        4: 'Ta cũng thấy mọi công lao và mọi nghề khéo là điều gây cho người nầy kẻ khác ganh ghét nhau. Ðiều đó cũng là sự hư không, theo luồng gió thổi.',
        ...
        8: 'Nầy một người cô độc, chẳng có ai hoặc con trai hay là anh em; dầu vậy, lao khổ nó không thôi, mắt nó không hề chán của cải; nó không hề nghĩ rằng: Vậy ta lao khổ, ta bắt linh hồn nhịn các phước là vì ai? Ðiều đó cũng là hư không, thật là công việc cực nhọc.',
        ...
        13: 'Một kẻ trẻ tuổi nghèo mà khôn hơn một ông vua già cả mà dại, chẳng còn biết nghe lời khuyên can.',
        14: 'Vì kẻ trẻ ra khỏi ngục khám đặng làm vua, dầu sanh ra nghèo trong nước mình.',
        15: 'Ta thấy mọi người sống đi đi lại lại dưới mặt trời, đều theo kẻ trẻ ấy, là người kế vị cho vua kia.',
        16: 'Dân phục dưới quyền người thật đông vô số; dầu vậy, những kẻ đến sau sẽ chẳng vui thích về người. Ðiều đó cũng là sự hư không, theo luồng gió thổi.',
    },
    5: {
        1: 'Khi người vào nhà Ðức Chúa Trời, hãy giữ chừng chơn mình. Thà lại gần mà nghe, hơn là dâng của tế lễ kẻ ngu muội; vì nó không hiểu biết mình làm ác.',
        2: 'Chớ vội mở miệng ra, và lòng ngươi chớ lật đật nói lời trước mặt Ðức Chúa Trời; vì Ðức Chúa Trời ở trên trời, còn ngươi ở dưới đất. Vậy nên ngươi khá ít lời.',
        3: 'Hễ nhiều sự lo lắng ắt sanh ra chiêm bao; còn nhiều lời thì sanh ra sự ngu dại.',
        4: 'Khi ngươi khấn hứa sự gì với Ðức Chúa Trời, chớ chậm mà hoàn nguyện; vì Ngài chẳng vui thích kẻ dại: vậy, khá trả điều gì ngươi hứa.',
        ...
        7: 'Ðâu có chiêm bao vô số và nhiều lời quá, đó cũng có sự hư không nhiều; song ngươi hãy kính sợ Ðức Chúa Trời.',
        8: 'Khi ngươi thấy trong xứ có kẻ nghèo bị hà hiếp, hoặc thấy sự phạm đến lẽ chánh trực, sự trái phép công bình, thì chớ lấy làm lạ; vì có kẻ cao hơn kẻ cao vẫn coi chừng, lại còn có Ðấng cao hơn nữa.',
        ...
        14: 'hoặc vì cớ tai họa gì, cả của cải nầy phải mất hết; nếu người chủ sanh một con trai, thì để lại cho nó hai tay không.',
        15: 'Mình lọt ra khỏi lòng mẹ trần truồng thể nào, ắt sẽ trở về thể ấy, và về các huê lợi của sự lao khổ mình, chẳng có vậy gì tay mình đem theo được.',
        16: 'Ðiều nầy cũng là một tai nạn lớn: người ra đời thể nào, ắt phải trở về thể ấy. Vậy, chịu lao khổ đặng theo luồng gió thổi, có ích lợi gì chăng?',
        17: 'Lại trọn đời mình ăn trong sự tối tăm, phải nhiều sự buồn rầu đau đớn và phiền não.',
        18: 'Kìa, ta đã nhìn thấy rằng ăn, uống, và hưởng phải của sự lao khổ mình làm ở dưới mặt trời trọn trong những ngày mà Ðức Chúa Trời ban cho, ấy thật là tốt và hay; vì đó là kỷ phần mình.',
        19: 'Hễ Ðức Chúa Trời ban cho người nào giàu có, của cải, làm cho người có thế ăn lấy, nhận lãnh kỷ phần, và vui vẻ trong công lao của mình, ấy là một sự ban cho của Ðức Chúa Trời;',
        20: 'nhân người sẽ ít nhớ những ngày của đời mình; vì Ðức Chúa Trời ứng đáp người bằng sự vui mừng trong lòng người.',
    },
    6: {
        1: 'Có một tai nạn khác mà ta đã thấy dưới mặt trời, thường làm nặng nề cho loài người.',
        2: 'Kìa có một người mà Ðức Chúa Trời đã ban cho sự giàu có, của cải, va sang trọng, đến đỗi mọi sự lòng người ước ao, chẳng thiếu gì hết; nhưng Ðức Chúa Trời không cho người có thể ăn lấy, bèn là một người khác được ăn. Ấy là một sự hư không, một tai nạn cực khổ.',
        3: 'Nếu một người sanh trăm con trai, và sống nhiều năm cho đến cao niên trường thọ, mà lòng chẳng được hưởng phước, và chết chẳng được chôn; ta nói đứa con sảo còn hơn người ấy;',
        4: 'vì đứa con sảo ra hư không, lại trở về sự tối tăm, và tên nó bị sự u ám vùi lấp.',
        5: 'Nó không thấy mặt trời, cũng không biết đến; nó có được phần an nghỉ hơn người kia.',
        6: 'Người dầu sống đến hai ngàn năm, mà không hưởng được chút phước nào, cuối cùng cả thảy há chẳng về chung một chỗ sao?',
        ...
        10: 'Phàm điều gì có trước thì đã được đặt tên từ lâu rồi; loài người sẽ ra thể nào, thì đã biết từ trước rồi; người không thể cãi trả với Ðấng mạnh hơn mình.',
        11: 'Có nhiều điều gia thêm sự hư không; vậy, người ta được ích chi hơn;',
        12: 'vả, trong những ngày của đời hư không mà loài người trải qua như bóng, ai biết điều gì là ích cho mình? Vì ai có thể nói trước cho người nào về điều sẽ xảy ra sau mình dưới mặt trời?',
    },
    7: {
        1: 'Danh tiếng hơn dầu quí giá; ngày chết hơn ngày sanh.',
        2: 'Ði đến nhà tang chế hơn là đến nhà yến tiệc; vì tại đó thấy sự cuối cùng của mọi người; và người sống để vào lòng.',
        ...
        6: 'Vì tiếng cười của kẻ ngu muội giống như tiếng gai nhọn nổ dưới nồi. Ðiều đó cũng là sự hư không.',
        ...
        18: 'Ngươi giữ được điều nầy, ấy là tốt; mà lại cũng đừng nới tay khỏi điều kia; vì ai kính sợ Ðức Chúa Trời ắt tránh khỏi mọi điều đó.',
        ...
        26: 'Ta tìm thấy một điều cay đắng hơn sự chết, ấy là một người đờn bà có lòng giống như lưới bẫy, tay tợ như dây tói: ai ở đẹp lòng Ðức Chúa Trời sẽ thoát khỏi nó; còn kẻ có tội sẽ bị nó vấn lấy.',
        ...
        29: 'Nhưng nầy là điều ta tìm được: Ðức Chúa Trời đã dựng nên người ngay thẳng; song loài người có tìm kiếm ra lắm mưu kế.',
    },
    8: {
        1: 'Ai sánh được với người khôn ngoan? Ai biết giải nghĩa các vật? Sự khôn ngoan làm cho sáng sủa mắt người, và đổi sắc nghiêm trang đi.',
        2: 'Ta khuyên rằng: Vì cớ lời thề cùng Ðức Chúa Trời, khá gìn giữ mạng vua.',
        3: 'Chớ vội lui ra khỏi trước mặt người; đừng ghì mài trong sự ác, vì vua làm điều chi đẹp lòng mình.',
        ...
        6: 'Vì tuy loài người bị sự tai nạn bối rối nhiều, phàm sự gì cũng có thì thế và phép lệ.',
        ...
        10: 'Ta cùng thấy những kẻ gian ác qua đời, và được chôn bình yên; còn những người làm lành lại phải lìa khỏi nơi thánh, bị người đồng thành quên đi. Ấy cũng là sự hư không.',
        11: 'Bởi chẳng thi hành ngay án phạt những việc ác, nên lòng con loài người chuyên làm điều ác.',
        12: 'Vì kẻ có tội làm ác một trăm lần vẫn được trường thọ; dầu vậy, ta biết rằng kẻ kính sợ trước mặt Ðức Chúa Trời, sau rất ắt được phước.',
        13: 'Nhưng kẻ ác chẳng sẽ được phước; cũng sẽ không được sống lâu, vì đời nó giống như bóng qua; ấy tḀ¡i nó không kính sợ trước mặt Ðức Chúa Trời.',
        14: 'Lại còn có một sự hư không khác trên thế gian: lắm người công bình bị đãi theo công việc kẻ ác, và lắm kẻ ác lại được đãi theo công việc người công bình. Ta nói rằng điều đó cũng là sự hư không.',
        15: 'Ta bèn khen sự vui mừng, bởi vì dưới mặt trời chẳng có điều gì tốt cho loài người hơn là ăn, uống, và vui sướng; vì ấy là điều còn lại cho mình về công lao trọn trong các ngày của đời mình, mà Ðức Chúa Trời ban cho mình dưới mặt trời.',
        16: 'Khi ta chuyên lòng để học biết sự khôn ngoan, để hiểu mọi việc làm ra trên đất, thì ta thấy có người ngày và đêm không cho mắt ngủ,',
        17: 'cũng thấy mọi công việc Ðức Chúa Trời, và hiểu biết người ta không thể dò được mọi việc làm ra dưới mặt trời, dầu chịu cực nhọc ngần nào đặng tìm biết, cũng chẳng tìm được; và dầu cho người khôn ngoan tưởng rằng sẽ chắc biết, thì cũng chẳng tìm được.',
    },
    9: {
        1: 'Nầy là các việc khác mà ta đã suy nghĩ và chuyên lòng hiểu rõ ràng: ta thấy người công bình và khôn ngoan, luôn với việc làm của họ, đều ở trong tay Ðức Chúa Trời; hoặc sự yêu hay là sự ghét, loài người chẳng biết rõ: thảy đều thuộc về cuộc tương lai.',
        2: 'Mọi sự xảy đến cho mọi người như nhau: người công bình hay là kẻ hung ác, người hiền lành, thanh sạch, người dâng của tế lễ hay là người không dâng, người thiện hay là kẻ có tội, kẻ phát thề hay là người sợ lời thề, cả thảy đều đồng hưởng một số phận.',
        ...
        4: 'Một người ở trong hội kẻ sống, còn có sự trông mong; vì con chó sống hơn là sư tử chết.',
        5: 'Kẻ sống biết mình sẽ chết; nhưng kẻ chết chẳng biết chi hết, chẳng được phần thưởng gì hết; vì sự kỷ niệm họ đã bị quên đi.',
        6: 'Sự yêu, sự ghét, sự ganh gỗ của họ thảy đều tiêu mất từ lâu; họ chẳng hề còn có phần nào về mọi điều làm ra dưới mặt trời.',
        7: 'Hãy đi ăn bánh cách vui mừng, và uống rượu cách hớn hở; vì Ðức Chúa Trời đã nhận các công việc ngươi.',
        8: 'Khá hằng mặc áo trắng, chớ thiếu dầu thơm trên đầu ngươi.',
        9: 'Trọn các ngày của đời hư không ngươi, mà Ðức Chúa Trời ban cho ngươi dưới mặt trời, hãy ở vui vẻ cùng vợ yêu dấu; vì đó là phần của ngươi trong đời nầy, và là điều ngươi được bởi công lao mình làm ở dưới mặt trời.',
    ...
    11: {
        ...
        2: 'Hãy phân phát nó cho bảy hoặc cho tám người; vì ngươi không biết tai nạn nào sẽ xảy ra trên đất.',
        3: 'Khi mây đầy nước, nó bèn mưa xuống đất; khi một cây ngã về hướng nam hay về hướng bắc, hễ ngã chỗ nào nó phải ở chỗ đó.',
        4: 'Ai xem gió sẽ không gieo; ai xem mây sẽ không gặt.',
        5: 'Người không biết đường của gió đi, cũng không biết xương cốt kết cấu trong bụng đờn bà mang thai thể nào, thì cũng một thể ấy, ngươi chẳng hiểu biết công việc của Ðức Chúa Trời, là Ðấng làm nên muôn vật.',
    ...
    12: {
        1: 'Trong buổi còn thơ ấu hãy tưởng nhớ Ðấng Tạo hóa ngươi, trước khi người ngày gian nan chưa đến, trước khi những năm tới mà ngươi nói rằng: Ta không lấy làm vui lòng;',
        ...
        6: 'lại hãy tưởng nhớ Ðấng Tạo hóa trước khi dây bạc đất, và chén vàng bể, trước khi vò vỡ ra bên suối, và bánh xe gãy ra trên giếng;',
        7: 'và bụi tro trở vào đất y như nguyên cũ, và thần linh trở về nơi Ðức Chúa Trời, là Ðấng đã ban nó.',
        ...
        13: 'Chúng ta hãy nghe lời kết của lý thuyết nầy: Khá kính sợ Ðức Chúa Trời và giữ các điều răn Ngài; ấy là trọn phận sự của ngươi.',
        14: 'Vì Ðức Chúa Trời sẽ đem đoán xét các công việc, đến đỗi việc kín nhiệm hơn hết, hoặc thiện hoặc ác cũng vậy.',
    },
}
