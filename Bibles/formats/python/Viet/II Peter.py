...
CHAPTERS = {
    ...
    2: {
        ...
        4: 'Vả, nếu Ðức Chúa Trời chẳng tiếc các thiên sứ đã phạm tội, nhưng quăng vào trong vực sâu, tại đó họ bị trói buộc bằng xiềng nơi tối tăm để chờ sự phán xét;',
        ...
        17: 'Ấy là những suối nước, những đám mây bị luồng gió mạnh đưa đi và sự tối tăm mờ mịt đã để dành cho chúng nó.',
    ...
    3: {
        ...
        5: 'Chúng nó có ý quên lững đi rằng buổi xưa bởi lời Ðức Chúa Trời có các từng trời và trái đất, đất ra từ Nước và làm nên ở giữa nước,',
        ...
        15: 'Lại phải nhìn biết rằng sự nhịn nhục lâu dài của Chúa chúng ta cốt vì cứu chuộc anh em, cũng như Phao lô, anh rất yêu dấu của chúng ta, đã đem sự khôn ngoan được ban cho mình mà viết thơ cho anh em vậy.',
