...
CHAPTERS = {
    1: {
        ...
        4: 'Jer, rekne li Edom: Bili smo smrvljeni, ali ćemo opet podići ruševine!" ovako kaže Jahve nad Vojskama: Neka grade oni, a ja ću razgraditi! Zvat će ih zemljom bezbožničkom i narodom na koji se Jahve srdi dovijeka!',
        5: 'Vaše će oči vidjeti, i reći ćete: "Velik je Jahve preko granica zemlje izraelske."',
        ...
        7: 'Oskvrnjen kruh na mome prinosite žrtveniku i još pitate: "Čime te oskvrnismo?" Time što kažete "Stol je Jahvin stvar nevažna!"',
        8: 'A kada za žrtvu slijepu stoku prinosite, zar to nije zlo? I kad prinosite hromo i bolesno, zar to nije zlo? Donesi takvo što svome namjesniku, hoće li biti zadovoljan i dobro te primiti? - govori Jahve nad Vojskama.',
        9: 'Sada umilostivite lice Božje da nam se smiluje. To donose ruke vaše, hoće li vas dobro primiti? - govori Jahve nad Vojskama.',
        ...
        11: 'Jer od istoka do zapada veliko je ime moje među narodima, i na svakom mjestu prinosi se kad i žrtva čista Imenu mojemu, jer veliko je Ime moje među narodima - govori Jahve nad Vojskama.',
        ...
        14: 'Proklet bio varalica koji u stadu ima ovna što mi ga je zavjetovao, a žrtvuje mi ovcu jalovicu. Jer ja sam velik kralj - govori Jahve nad Vojskama - i strašno je Ime moje među narodima.',
    },
    2: {
