...
CHAPTERS = {
    ...
    4: {
        ...
        9: 'I kad god bića dadu slavu i čast pohvalnicu Onomu koji sjedi na prijestolju, Živomu u vijeke vjekova,',
        10: 'dvadeset i četiri starješine padnu ničice pred Onim koji sjedi na prijestolju i poklone se njemu - Živomu u vijeke vjekova. I stavljaju svoje vijence pred prijestolje govoreći:',
    ...
    8: {
        1: 'Kad Jaganjac otvori sedmi pečat, nasta muk na nebu oko pola sata.',
        2: 'I vidjeh: sedmorici anđela što stoje pred Bogom dano je sedam trubalja.',
        ...
        5: 'Anđeo uze kadionicu, napuni je vatrom sa žrtvenika i prosu na zemlju. I udariše gromovi, i glasovi, i munje, i potres.',
        6: 'A sedam anđela sa sedam trubalja pripremiše se da zatrube.',
        7: 'Prvi zatrubi. I nastadoše tuča i oganj, pomiješani s krvlju, i budu bačeni na zemlju. I trećina zemlje izgorje, i trećina stabala izgorje, i sva zelena trava izgorje.',
        ...
        10: 'Treći anđeo zatrubi. I pade s neba zvijezda velika - gorjela je kao zublja - pade na trećinu rijeka i na izvore voda.',
        11: 'Zvijezdi je ime Pelin. I trećina se voda pretvori u pelin te mnoštvo ljudi poginu od zagorčenih voda.',
    ...
    9: {
        1: 'Peti anđeo zatrubi. I vidjeh: zvijezda je s neba na zemlju pala i dani su joj ključi zjala Bezdanova.',
        2: 'Ona otvori zjalo Bezdanovo i vinu se iz zjala dim kao dim iz peći goleme te pomrča sunce i zrak od dima iz zjala.',
        3: 'Iz dima pak iziđoše na zemlju skakavci i dana im je moć kakvu imaju štipavci zemaljski.',
        4: 'I zapovjeđeno im je da ne ude travi zemaljskoj nit ikojem zelenilu nit ikojem stablu, nego samo ljudima koji nemaju pečata Božjega na čelu.',
        5: 'I dano im je ne da ih ubijaju, nego samo da ih muče pet mjeseci, a muka njihova da bude kao muka od uboda štipavaca.',
        6: 'U one će dane ljudi iskati smrt, ali je neće naći; poželjet će umrijeti, ali smrt će bježati od njih.',
        ...
        10: 'Repovi im kao u štipavaca, sa žalcima, a u repovima im moć da ude ljudima pet mjeseci.',
        11: 'Nad njima je kralj, anđeo Bezdana, hebrejski mu ime Abadon, grčki Apolion - Upropastitelj.',
        12: 'Prvi Jao prođe. Evo, za njim dolaze još dva druga Jao.',
        ...
        17: 'Ovako u viđenju vidjeh konje i njihove jahače: imahu oklope ognjene, plavetne i sumporne boje; glave im kao u lavova, iz usta im sukljao oganj, dim i sumpor.',
        18: 'Od ovih triju zala poginu trećina ljudi - od ognja, dima i sumpora što sukljahu konjima iz usta.',
        19: 'Doista, snaga je ovim konjima u ustima i repovima: repovi im kao u zmija, s glavama kojima ude.',
        20: 'Ipak, preostali ljudi, što ne poginuše od tih zala, ne obratiše se od djela ruku svojih, da se više ne klanjaju zlodusima i kumirima - ni zlatnima, ni srebrnima, ni mjedenima, ni kamenima ni drvenima koji niti vide niti čuju nit hodaju -',
        21: 'i ne obratiše se od svojih ubojstava ni od svojih čaranja ni od svoga bluda niti od svojih krađa.',
    },
    10: {
    ...
    11: {
        ...
        7: 'A kada dovrše svoje svjedočanstvo, Zvijer koja izlazi iz Bezdana zaratit će s njima, pobijediti ih i ubiti.',
    ...
    14: {
        ...
        6: 'I vidjeh: drugi jedan anđeo leti posred neba s evanđeljem vječnim da ga proglasi svim pozemljarima, svakom narodu i plemenu i jeziku i puku.',
    ...
    15: {
        ...
        7: 'Jedno od četiri bića dade sedmorici anđela sedam zlatnih čaša, punih gnjeva Boga koji živi u vijeke vjekova.',
    ...
    20: {
        1: 'I vidjeh anđela: siđe s neba s ključima Bezdana i s velikim okovima u ruci.',
        2: 'Zgrabi Zmaja, Staru zmiju, to jest Ðavla, Sotonu, i okova ga za tisuću godina.',
        3: 'Baci ga u Bezdan koji nad njim zatvori i zapečati da više ne zavodi narode dok se ne navrši tisuću godina. Nakon toga ima biti odriješen za malo vremena.',
        ...
        10: 'A njihov zavodnik, Ðavao, bačen bi u jezero ognjeno i sumporno, gdje se nalaze i Zvijer i Lažni prorok: ondje će se mučiti danju i noću u vijeke vjekova.',
    ...
    22: {
        ...
        5: 'Noći više biti neće i neće trebati svjetla od svjetiljke ni svjetla sunčeva: obasjavat će ih Gospod Bog i oni će kraljevati u vijeke vjekova.',
        ...
        8: 'Ja, Ivan, čuo sam i vidio sve ovo. I kad sam to vidio i čuo, padoh pred noge anđelu koji mi to pokaza da mu se poklonim.',
        ...
        11: 'Nepravednik neka samo i dalje čini nepravdu! Okaljan neka se i dalje kalja! Pravednik neka i dalje živi pravedno! Svet neka se i dalje posvećuje!"',
        ...
        17: 'I Duh i Zaručnica govore: "Dođi!" I tko ovo čuje, neka rekne: "Dođi!" Tko je žedan, neka dođe; tko hoće, neka zahvati vode života zabadava!',
