...
CHAPTERS = {
    ...
    4: {
        ...
        20: 'For the kingdom ofGod [is] not in word, but in power.',
    ...
    5: {
        ...
        13: 'But those withoutGod judges. Remove the wicked person from amongst yourselves.',
    },
    6: {
        ...
        9: 'Do ye not know that unrighteous [persons] shall not inherit [the] kingdom ofGod? Do not err: neither fornicators, nor idolaters, nor adulterers, nor those who make women of themselves, nor who abuse themselves with men,',
        10: 'nor thieves, nor covetous, nor drunkards, nor abusive persons, nor [the] rapacious, shall inherit [the] kingdom ofGod.',
        11: 'And these things were some of you; but ye have been washed, but ye have been sanctified, but ye have been justified in the name of the Lord Jesus, and by the Spirit of ourGod.',
        ...
        13: 'Meats for the belly, and the belly for meats; butGod will bring to nothing both it and them: but the body [is] not for fornication, but for the Lord, and the Lord for the body.',
        14: 'AndGod has both raised up the Lord, and will raise us up from among [the dead] by his power.',
        ...
        19: 'Do ye not know that your body is [the] temple of the Holy Spirit which [is] in you, which ye have ofGod; and ye are not your own?',
        20: 'for ye have been bought with a price: glorify now thenGod in your body.',
    },
    7: {
        ...
        7: 'Now I wish all men to be even as myself: but every one has his own gift ofGod: one man thus, and another thus.',
        ...
        15: 'But if the unbeliever go away, let them go away; a brother or a sister is not bound in such [cases], butGod has called us in peace.',
        ...
        17: 'However, as the Lord has divided to each, asGod has called each, so let him walk; and thus I ordain in all the assemblies.',
        ...
        19: "Circumcision is nothing, and uncircumcision is nothing; but keepingGod's commandments.",
        ...
        24: 'Let each, wherein he is called, brethren, therein abide withGod.',
        ...
        40: "But she is happier if she so remain, according to my judgment; but I think that I also haveGod's Spirit.",
    },
    8: {
    ...
    10: {
        ...
        5: 'yetGod was not pleased with the most of them, for they were strewed in the desert.',
        ...
        13: "No temptation has taken you but such as is according to man's nature; andGod is faithful, who will not suffer you to be tempted above what ye are able [to bear], but will with the temptation make the issue also, so that [ye] should be able to bear [it].",
        ...
        20: 'But that what [the nations] sacrifice they sacrifice to demons, and not toGod. Now I do not wish you to be in communion with demons.',
        ...
        31: "Whether therefore ye eat, or drink, or whatever ye do, do all things toGod's glory.",
        32: 'Give no occasion to stumbling, whether to Jews, or Greeks, or the assembly ofGod.',
    ...
    12: {
        ...
        3: 'I give you therefore to know, that no one, speaking in [the power of the] Spirit ofGod, says, Curse [on] Jesus; and no one can say, Lord Jesus, unless in [the power of the] Holy Spirit.',
        4: 'But there are distinctions of gifts, but the same Spirit;',
        5: 'and there are distinctions of services, and the same Lord;',
        6: 'and there are distinctions of operations, but the sameGod who operates all things in all.',
        ...
        18: 'But nowGod has set the members, each one of them in the body, according as it has pleased [him].',
        ...
        24: 'but our comely [parts] have not need. ButGod has tempered the body together, having given more abundant honour to [the part] that lacked;',
        ...
        28: 'AndGod has set certain in the assembly: first, apostles; secondly, prophets; thirdly, teachers; then miraculous powers; then gifts of healings; helps; governments; kinds of tongues.',
    ...
    15: {
        ...
        15: 'And we are found also false witnesses ofGod; for we have witnessed concerningGod that he raised the Christ, whom he has not raised if indeed [those that are] dead are not raised.',
        ...
        28: 'But when all things shall have been brought into subjection to him, then the Son also himself shall be placed in subjection to him who put all things in subjection to him, thatGod may be all in all.)',
        ...
        34: 'Awake up righteously, and sin not; for some are ignorant ofGod: I speak to you as a matter of shame.',
        ...
        38: 'andGod gives to it a body as he has pleased, and to each of the seeds its own body.',
        ...
        50: "But this I say, brethren, that flesh and blood cannot inheritGod's kingdom, nor does corruption inherit incorruptibility.",
        ...
        57: 'but thanks toGod, who gives us the victory by our Lord Jesus Christ.',
