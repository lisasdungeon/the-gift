...
CHAPTERS = {
    ...
    3: {
        ...
        15: "but if I delay, in order that thou mayest know how one ought to conduct oneself inGod's house, which is [the] assembly of [the] livingGod, [the] pillar and base of the truth.",
    ...
    5: {
        ...
        4: 'but if any widow have children or descendants, let them learn first to be pious as regards their own house, and to render a return on their side to [their] parents; for this is acceptable in the sight ofGod.',
        5: 'Now she who [is] a widow indeed, and is left alone, has put [her] hope inGod, and continues in supplications and prayers night and day.',
        ...
        21: 'I testify beforeGod and Christ Jesus and the elect angels, that thou keep these things without prejudice, doing nothing by favour.',
    ...
    6: {
        1: 'Let as many bondmen as are under yoke count their own masters worthy of all honour, that the name ofGod and the teaching be not blasphemed.',
        ...
        11: 'But thou, O man ofGod, flee these things, and pursue righteousness, piety, faith, love, endurance, meekness of spirit.',
        ...
        13: 'I enjoin thee beforeGod who preserves all things in life, and Christ Jesus who witnessed before Pontius Pilate the good confession,',
        ...
        17: 'Enjoin on those rich in the present age not to be high-minded, nor to trust on the uncertainty of riches; but in theGod who affords us all things richly for [our] enjoyment;',
