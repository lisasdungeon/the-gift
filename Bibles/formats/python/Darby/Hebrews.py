...
CHAPTERS = {
    ...
    3: {
        ...
        12: 'See, brethren, lest there be in any one of you a wicked heart of unbelief, in turning away from [the] livingGod.',
    ...
    4: {
        ...
        12: 'For the word ofGod [is] living and operative, and sharper than any two-edged sword, and penetrating to [the] division of soul and spirit, both of joints and marrow, and a discerner of the thoughts and intents of [the] heart.',
        ...
        14: 'Having therefore a great high priest who has passed through the heavens, Jesus the Son ofGod, let us hold fast the confession.',
    ...
    5: {
        1: 'For every high priest taken from amongst men is established for men in things relating toGod, that he may offer both gifts and sacrifices for sins;',
        ...
        4: 'And no one takes the honour to himself but [as] called byGod, even as Aaron also.',
        ...
        10: 'addressed byGod [as] high priest according to the order of Melchisedec.',
        11: 'Concerning whom we have much to say, and hard to be interpreted in speaking [of it], since ye are become dull in hearing.',
        12: 'For when for the time ye ought to be teachers, ye have again need that [one] should teach you what [are] the elements of the beginning of the oracles ofGod, and are become such as have need of milk, [and] not of solid food.',
    ...
    7: {
        1: 'For this Melchisedec, King of Salem, priest of the most highGod, who met Abraham returning from smiting the kings, and blessed him;',
        ...
        3: 'without father, without mother, without genealogy; having neither beginning of days nor end of life, but assimilated to the Son ofGod, abides a priest continually.',
        ...
        25: 'Whence also he is able to save completely those who approach by him toGod, always living to intercede for them.',
    ...
    8: {
        ...
        10: 'Because this [is] the covenant that I will covenant to the house of Israel after those days, saith the Lord: Giving my laws into their mind, I will write them also upon their hearts; and I will be to them forGod, and they shall be to me for people.',
    ...
    9: {
        ...
        14: 'how much rather shall the blood of the Christ, who by the eternal Spirit offered himself spotless toGod, purify your conscience from dead works to worship [the] livingGod?',
        ...
        20: 'saying, This [is] the blood of the covenant whichGod has enjoined to you.',
        ...
        24: 'For the Christ is not entered into holy places made with hand, figures of the true, but into heaven itself, now to appear before the face ofGod for us:',
    ...
    12: {
        ...
        2: 'looking stedfastly on Jesus the leader and completer of faith: who, in view of the joy lying before him, endured [the] cross, having despised [the] shame, and is set down at the right hand of the throne ofGod.',
        ...
        15: 'watching lest [there be] any one who lacks the grace ofGod; lest any root of bitterness springing up trouble [you], and many be defiled by it;',
        ...
        22: 'but ye have come to mount Zion; and to [the] city of [the] livingGod, heavenly Jerusalem; and to myriads of angels,',
        23: 'the universal gathering; and to [the] assembly of the firstborn [who are] registered in heaven; and toGod, judge of all; and to [the] spirits of just [men] made perfect;',
        ...
        28: 'Wherefore let us, receiving a kingdom not to be shaken, have grace, by which let us serveGod acceptably with reverence and fear.',
        29: 'For also ourGod [is] a consuming fire.',
    },
    13: {
        ...
        7: 'Remember your leaders who have spoken to you the word ofGod; and considering the issue of their conversation, imitate their faith.',
        ...
        15: 'By him therefore let us offer [the] sacrifice of praise continually toGod, that is, [the] fruit of [the] lips confessing his name.',
        16: 'But of doing good and communicating [of your substance] be not forgetful, for with such sacrificesGod is well pleased.',
        ...
        20: 'But theGod of peace, who brought again from among [the] dead our Lord Jesus, the great shepherd of the sheep, in [the power of the] blood of [the] eternal covenant,',
