...
CHAPTERS = {
    1: {
        ...
        3: 'I thank myGod for my whole remembrance of you,',
        ...
        8: 'ForGod is my witness how I long after you all in [the] bowels of Christ Jesus.',
        ...
        11: "being complete as regards the fruit of righteousness, which [is] by Jesus Christ, toGod's glory and praise.",
        ...
        14: 'and that the most of the brethren, trusting in [the] Lord through my bonds, dare more abundantly to speak the word ofGod fearlessly.',
        ...
        28: 'and not frightened in anything by the opposers, which is to them a demonstration of destruction, but of your salvation, and that fromGod;',
    ...
    2: {
        ...
        11: "and every tongue confess that Jesus Christ [is] Lord toGod [the] Father's glory.",
        ...
        13: 'for it isGod who works in you both the willing and the working according to [his] good pleasure.',
        14: 'Do all things without murmurings and reasonings,',
        15: 'that ye may be harmless and simple, irreproachable children ofGod in the midst of a crooked and perverted generation; among whom ye appear as lights in [the] world,',
        ...
        27: 'for he was also sick close to death, butGod had mercy on him, and not indeed on him alone, but also on me, that I might not have sorrow upon sorrow.',
    ...
    3: {
        ...
        14: 'I pursue, [looking] towards [the] goal, for the prize of the calling on high ofGod in Christ Jesus.',
        15: 'As many therefore as [are] perfect, let us be thus minded; and if ye are any otherwise minded, this alsoGod shall reveal to you.',
        ...
        19: 'whose end [is] destruction, whosegod [is] the belly, and [their] glory in their shame, who mind earthly things:)',
    ...
    4: {
        ...
        18: 'But I have all things in full supply and abound; I am full, having received of Epaphroditus the things [sent] from you, an odour of sweet savour, an acceptable sacrifice, agreeable toGod.',
        19: 'But myGod shall abundantly supply all your need according to his riches in glory in Christ Jesus.',
        20: 'But to ourGod and Father [be] glory to the ages of ages. Amen.',
