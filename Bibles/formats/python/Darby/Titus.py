...
CHAPTERS = {
    1: {
        1: "Paul, bondman ofGod, and apostle of Jesus Christ according to [the] faith ofGod's elect, and knowledge of [the] truth which [is] according to piety;",
        2: 'in [the] hope of eternal life, whichGod, who cannot lie, promised before the ages of time,',
        3: 'but has manifested in its own due season his word, in [the] proclamation with which I have been entrusted, according to [the] commandment of our SaviourGod;',
        4: 'to Titus, my own child according to [the] faith common [to us]: Grace and peace fromGod [the] Father, and Christ Jesus our Saviour.',
        ...
        7: "For the overseer must be free from all charge [against him] asGod's steward; not headstrong, not passionate, not disorderly through wine, not a striker, not seeking gain by base means;",
        ...
        16: 'They profess to knowGod, but in works deny [him], being abominable, and disobedient, and found worthless as to every good work.',
    },
    2: {
        ...
        11: 'For the grace ofGod which carries with it salvation for all men has appeared,',
        ...
        13: 'awaiting the blessed hope and appearing of the glory of our greatGod and Saviour Jesus Christ;',
