...
CHAPTERS = {
    ...
    2: {
        ...
        68: 'And some of the chief fathers, when they came to the house of Jehovah which is at Jerusalem, offered freely for the house ofGod to set it up in its place.',
    ...
    3: {
        ...
        2: 'Then stood up Jeshua the son of Jozadak, and his brethren the priests, and Zerubbabel the son of Shealtiel, and his brethren, and built the altar of theGod of Israel, to offer up burnt-offerings on it, as it is written in the law of Moses the man ofGod.',
        ...
        8: 'And in the second year of their coming to the house ofGod at Jerusalem, in the second month, began Zerubbabel the son of Shealtiel, and Jeshua the son of Jozadak, and the remnant of their brethren the priests and the Levites, and all they that had come out of the captivity to Jerusalem; and they appointed the Levites, from twenty years old and upward, to superintend the work of the house of Jehovah.',
        9: 'And Jeshua stood up, his sons and his brethren, Kadmiel and his sons, the sons of Judah, as one [man], to superintend the workmen in the house ofGod; [also] the sons of Henadad, their sons and their brethren, the Levites.',
    ...
    6: {
        ...
        3: 'In the first year of king Cyrus, king Cyrus made a decree [concerning] the house ofGod at Jerusalem: Let the house be built for a place where they offer sacrifices, and let its foundations be solidly laid; its height sixty cubits, its breadth sixty cubits,',
        4: "[with] three rows of great stones, and a row of new timber; and let the expenses be given out of the king's house:",
        5: 'and also let the golden and silver vessels of the house ofGod, which Nebuchadnezzar took out of the temple that is at Jerusalem and brought to Babylon, be restored and brought again to the temple that is at Jerusalem, in their place; and thou shalt put [them] in the house ofGod.',
        ...
        7: 'let the work of this house ofGod alone; let the governor of the Jews and the elders of the Jews build this house ofGod in its place.',
        8: "Moreover, I give orders what ye shall do to these elders of the Jews, for the building of this house ofGod: that of the king's goods, of the tribute beyond the river, expenses be diligently given to these men, that they be not hindered.",
        9: 'And that which they have need of, both young bullocks and rams and lambs, for the burnt-offerings to theGod of the heavens, wheat, salt, wine, and oil, according to the appointment of the priests that are at Jerusalem, let it be given them day by day without fail;',
        10: 'that they may present sweet odours to theGod of the heavens, and pray for the life of the king and of his sons.',
        ...
        12: 'And theGod that has caused his name to dwell there overthrow every king and people that shall put forth their hand to alter [or] to destroy this house ofGod which is at Jerusalem. I Darius have given [this] order; let it be done diligently.',
        ...
        14: 'And the elders of the Jews built; and they prospered through the prophesying of Haggai the prophet and Zechariah the son of Iddo. And they built and completed [it] according to the commandment of theGod of Israel, and according to the commandment of Cyrus, and Darius, and Artaxerxes king of Persia.',
        ...
        16: 'And the children of Israel, the priests and the Levites, and the rest of the children of the captivity, kept the dedication of this house ofGod with joy;',
        17: 'and they presented at the dedication of this house ofGod a hundred bullocks, two hundred rams, four hundred lambs, and for a sin-offering for all Israel, twelve he-goats, according to the number of the tribes of Israel.',
        18: 'And they set the priests in their classes, and the Levites in their divisions, for the service ofGod, which is at Jerusalem: as it is written in the book of Moses.',
        ...
        21: 'And the children of Israel that were come back out of captivity, and all such as had separated themselves to them from the filthiness of the nations of the land, to seek Jehovah theGod of Israel, did eat;',
        22: 'and they kept the feast of unleavened bread seven days with joy; for Jehovah had made them joyful, and turned the heart of the king of Assyria to them, to strengthen their hands in the work of the house ofGod, theGod of Israel.',
    },
    7: {
        ...
        6: '— this Ezra went up from Babylon; and he was a ready scribe in the law of Moses, which Jehovah theGod of Israel had given. And the king granted him all his request, according to the hand of Jehovah hisGod upon him.',
        ...
        9: 'For upon the first of the first month the project of going up from Babylon was determined on, and on the first of the fifth month he came to Jerusalem, according to the good hand of hisGod upon him.',
        ...
        12: 'Artaxerxes, king of kings, to Ezra the priest, an accomplished scribe of the law of theGod of the heavens, and so forth.',
        ...
        14: 'Because thou art sent by the king, and by his seven counsellors, to inquire concerning Judah and Jerusalem, according to the law of thyGod which is in thy hand;',
        15: 'and to carry the silver and gold which the king and his counsellors have freely offered to theGod of Israel, whose habitation is at Jerusalem,',
        16: 'and all the silver and gold that thou canst find in all the province of Babylon, besides the voluntary offering of the people, and of the priests, who offer willingly for the house of theirGod which is at Jerusalem.',
        17: 'Therefore thou shalt buy diligently with this money bullocks, rams, lambs, with their oblations and their drink-offerings, and offer them upon the altar of the house of yourGod which is at Jerusalem.',
        18: 'And whatever shall seem good to thee and to thy brethren to do with the rest of the silver and the gold, that do according to the will of yourGod.',
        19: 'And the vessels that have been given thee for the service of the house of thyGod, deliver before theGod of Jerusalem.',
        20: "And whatever more shall be needful for the house of thyGod which thou shalt have occasion to bestow, bestow it out of the king's treasure house.",
        21: 'And I, I Artaxerxes the king, do give orders to all the treasurers that are beyond the river, that whatever Ezra the priest and scribe of the law of theGod of the heavens shall require of you, it be done diligently,',
        ...
        23: 'Whatever is commanded by theGod of the heavens, let it be carefully done for the house of theGod of the heavens; for why should there be wrath against the realm of the king and his sons?',
        24: 'Also we inform you, as regards all the priests and Levites, singers, doorkeepers, Nethinim, and ministers of this house ofGod, it shall not be lawful to impose tribute, tax, and toll upon them.',
        25: 'And thou, Ezra, after the wisdom of thyGod, which is in thy hand, set magistrates and judges who may judge all the people that are beyond the river, all such as know the laws of thyGod; and teach ye him that knows [them] not.',
        26: 'And whosoever will not do the law of thyGod and the law of the king, let judgment be executed diligently upon him, whether unto death, or to banishment, or to confiscation of goods, or to imprisonment.',
        27: "Blessed be Jehovah theGod of our fathers, who has put [such a thing] as this in the king's heart, to beautify the house of Jehovah which is at Jerusalem;",
        28: "and has extended mercy to me before the king and his counsellors, and before all the king's mighty princes. And I was strengthened, as the hand of Jehovah myGod was upon me; and I gathered together out of Israel chief men to go up with me.",
    },
    8: {
        ...
        17: 'And I gave them a commission to Iddo the chief, at the place Casiphia, and I put words in their mouths to say to Iddo [and] his brethren the Nethinim, at the place Casiphia, that they should bring to us ministers for the house of ourGod.',
        18: 'And by the good hand of ourGod upon us, they brought us a man of understanding, of the sons of Mahli, the son of Levi, the son of Israel, namely, Sherebiah, with his sons and his brethren, eighteen;',
        ...
        21: 'And I proclaimed a fast there, at the river Ahava, that we might humble ourselves before ourGod, to seek of him a right way for us, and for our little ones, and for all our substance.',
        22: 'For I was ashamed to require of the king a band of soldiers and horsemen to help us against the enemy in the way; for we had spoken to the king saying, The hand of ourGod is upon all them for good that seek him; but his power and his anger is against all them that forsake him.',
        23: 'And we fasted, and besought ourGod for this; and he was entreated of us.',
        24: 'And I separated twelve of the chiefs of the priests, Sherebiah, Hashabiah, and ten of their brethren with them,',
        25: 'and I weighed to them the silver and the gold and the vessels, the heave-offering for the house of ourGod, which the king and his counsellors and his princes, and all Israel present, had offered.',
        ...
        28: 'And I said to them, Ye are holy unto Jehovah; the vessels also are holy; and the silver and the gold is a voluntary offering to Jehovah theGod of your fathers.',
        ...
        30: 'And the priests and the Levites received by weight the silver and the gold and the vessels, to bring them to Jerusalem unto the house of ourGod.',
        31: 'And we departed from the river Ahava on the twelfth of the first month, to go to Jerusalem; and the hand of ourGod was upon us, and he delivered us from the hand of the enemy, and of such as lay in wait by the way.',
        32: 'And we came to Jerusalem, and abode there three days.',
        33: 'And on the fourth day the silver and the gold and the vessels were weighed in the house of ourGod into the hand of Meremoth the son of Urijah the priest; and with him was Eleazar the son of Phinehas; and with them were Jozabad the son of Jeshua, and Noadiah the son of Binnui, Levites:',
        34: 'the whole by number and by weight; and all the weight was written down at that time.',
        35: 'The children of those that had been carried away, who had come out of the captivity, presented burnt-offerings to theGod of Israel, twelve bullocks for all Israel, ninety-six rams, seventy-seven lambs, twelve he-goats for a sin-offering: all for a burnt-offering to Jehovah.',
        36: "And they delivered the king's edicts to the king's satraps, and to the governors on this side the river. And they furthered the people and the house ofGod.",
    },
    9: {
        ...
        4: 'Then were assembled to me every one that trembled at the words of theGod of Israel, because of the unfaithfulness of those that had been carried away; and I sat overwhelmed until the evening oblation.',
        5: 'And at the evening oblation I arose up from my humiliation; and with my mantle and my garment rent, I fell on my knees, and spread out my hands to Jehovah myGod,',
        6: 'and said: O myGod, I am ashamed and blush to lift up my face to thee, myGod; for our iniquities are increased over [our] head, and our trespass is grown up to the heavens.',
        ...
        8: 'And now for a little space there hath been favour from Jehovah ourGod, to leave us a remnant to escape, and to give us a nail in his holy place, that ourGod may lighten our eyes, and give us a little reviving in our bondage.',
        9: 'For we are bondmen; yet ourGod hath not forsaken us in our bondage, but hath extended mercy unto us before the kings of Persia, to give us a reviving, to set up the house of ourGod and to repair the ruins thereof, and to give us a wall in Judah and in Jerusalem.',
        10: 'And now, what shall we say, ourGod, after this? for we have forsaken thy commandments,',
        ...
        13: 'And after all that is come upon us for our evil deeds and for our great trespass, seeing that thou ourGod hast punished us less than our iniquities [deserve], and hast given us such deliverance as this,',
    ...
    10: {
        1: 'And while Ezra prayed, and made confession, weeping and falling down before the house ofGod, there were gathered to him out of Israel a very great congregation of men and women and children; for the people wept very much.',
        2: 'And Shechaniah the son of Jehiel, of the sons of Elam, answered and said to Ezra, We have acted unfaithfully toward ourGod, and have taken foreign wives of the peoples of the land; yet now there is hope for Israel concerning this thing.',
        3: 'And now let us make a covenant with ourGod to put away all the wives, and such as are born of them, according to the counsel of [my] lord, and of those that tremble at the commandments of ourGod; and let it be done according to the law.',
        ...
        6: 'And Ezra arose from before the house ofGod, and went into the chamber of Jehohanan the son of Eliashib; and when he came thither, he ate no bread and drank no water; for he mourned because of the unfaithfulness of them that had been carried away.',
        ...
        9: 'Then were all the men of Judah and Benjamin gathered together at Jerusalem within three days. It was the ninth month, on the twentieth of the month; and all the people sat in the open space of the house ofGod, trembling because of the matter, and because of the pouring rain.',
        ...
        11: 'And now make confession to Jehovah theGod of your fathers, and do his pleasure, and separate yourselves from the peoples of the land, and from the foreign wives.',
        ...
        14: 'Let now our princes, while this matter is going on, stand for all the congregation, and let all those that have taken foreign wives in our cities come at the appointed times, and with them the elders of every city, and the judges thereof, until the fierce anger of ourGod be turned from us.',
