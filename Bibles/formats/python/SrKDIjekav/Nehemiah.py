...
CHAPTERS = {
    1: {
        ...
        3: 'А они ми рекоше: остатак што оста од ропства ондје у земљи, у великој је невољи и срамоти, и зид је Јерусалимски разваљен и врата су му огњем попаљена.',
        ...
        11: 'Ох Господе! нека буде ухо твоје пригнуто и молитви слуге твојега и к молитви слуге твојега и к молитви слуга твојих, који су ради бојати се имена твојега, и дај данас срећу слузи свјему и учини да нађе милост пред овијем човјеком. А ја бијах пехарник царев.',
    },
    2: {
    ...
    3: {
        ...
        11: 'Толико оправља Малхија сина Харимов и Асув син Фат-Моавов и кулу код пећи.',
        ...
        19: 'А до њега оправља Есер син Исусов поглавар од Миспе толико према мјесту куда се иде к ризницама на углу.',
        ...
        23: 'За њим оправља Венијамин и Асув према својим кућама; а за њим оправља Азарија син Масије сина Ананијина уз своју кућу.',
        ...
        27: 'За њим оправљаше Текојани толико према великој кули високој до зида Офилскога.',
        ...
        32: 'А између узбрдице на углу и овчјих врата оправљаше златари и трговци.',
    },
    4: {
        1: 'А кад чу Санавалат да зидамо зид, разгњеви се и расрди се врло, и ругаше се Јеврејима,',
        ...
        7: 'А кад чу Санавалат и Товија и Арапи и Амонци и Азоћани да се оправља зид Јерусалимски и да се почело затворати што је проваљено, разгњевише се врло;',
        ...
        13: 'Тада намјестих народ у низима иза зида и на стрменима, поставих народ по породицама са мачевима и копљима и луковима.',
        ...
        15: 'А кад чуше непријатељи наши да смо дознали, разби Господ њихову намјеру, и ми се вратисмо сви к зиду, сваки на свој посао.',
        ...
        20: 'Гдје чујете трубу да труби, онамо трчите к нама; Бог наш војеваће за нас.',
        21: 'Тако рађасмо посао, и половина их држаше копља од зора па докле звјезде не изиду.',
        22: 'У то вријеме још рекох народу: сваки са момком својим нека ноћује у Јерусалиму да би нам ноћу стражили а дању радили.',
    ...
    6: {
        ...
        9: 'Јер они сви шћаху нас уплашити говорећи: клонуће руке њихове од посла и неће се свршити. За то, Боже, укријепи руке моје.',
        10: 'Јоште отидох у кућу Семаји сину Далаје сина Метавелиова, који се бјеше затворио, и рече ми: да отидемо заједно у дом Божји усред цркве и да закључамо врата цркви, јер ће доћи да те убију, доћи ће ноћу да те убију.',
        ...
        18: 'Јер многи Јудејци бијаху му се заклели; јер бјеше зет Сеханији сину Арахову, и Јоанан син његов бјеше ожењен кћерју Меулама сина Варахијина.',
    ...
    7: {
        ...
        6: 'Ово су људи из овога краја што се вратише из ропства између онијех који бише пресељени, које пресели Навуходоносор цар Вавилонски, па се вратише у Јерусалим и у Јудеју, сваки у свој град,',
        ...
        11: 'Синова Фат-Моавовијех, од синова Исусовијех и Јоавових двије тисуће и осам стотина и осамнаест;',
        ...
        35: 'Синова Харимовијх триста и двадесет;',
        ...
        40: 'Синова Имировијех тисућа и педесет и два;',
        ...
        46: 'Нетинеја: синова Сишинијех, синова Асуфинијех, синова Тавотовијех,',
        47: 'Синова Киросовијех, синова Сијајиних, синова Фадановијех,',
        48: 'Синова Леваниних, синова Агавиних, синова Саламајевих,',
        49: 'Синова Анановијех, синова Гидиловијех, синова Гаровијех,',
        50: 'Синова Реајиних, синова Ресиновијех, синова Некодинијех,',
        51: 'Синова Газамовијех, синова Узинијех, синова Фасејених,',
        ...
        57: 'Синова слуга Соломуновијех: синова Сотајевих, синова Соферетових, синова Феридинијех,',
        ...
        60: 'Свега Нетинеја и синова слуга Соломуновијех, триста и деведесет и два.',
        61: 'И ови дођоше из Тел-Мелаха и Тел-Арисе, Херув, Адон и Имир, али не могаше показати отачкога дома својега и сјемена својега, еда ли су од Израиља,',
        62: 'И синови Делајини, синови Товијини, синови Некодини, њих шест стотина и четрдесет и два,',
        63: 'И од свештеника: синова Авајини, синови Акосови, синови Варзелаја, који се ожени између кћери Варзелаја Галађанина, те се прозва њиховијем именом.',
        64: 'Они тражише по књигама да би показали род свој, али се не нађе, за то бише одлучени од свештенства.',
        65: 'И запријети им Тирсата да не једу од светиње над светињама докле не настане свештеник с Уримом и Тумимом.',
        ...
        68: 'Имаху седам стотина и тридесет и шест коња, двије стотине и четрдесет и пет масака,',
        69: 'Четири стотине и тридесет и пет камила, шест тисућа и седам стотина и двадесет магараца.',
        70: 'Тада неки између главара дома отачких приложише на посао. Тирсата даде у ризницу тисућу драма злата, педесет чаша, шест стотина и тридесет хаљина свештеничких.',
        ...
        73: 'И тако са населише свештеници и Левити вратари и пјевачи и људи из народа и Нетинеји и сав Израиљ у својим градовима; и кад дође седми мјесец, синови Израиљеви бијаху у својим градовима.',
    },
    8: {
    ...
    9: {
        1: 'Потом двадесет четвртога дана тога мјесеца скупише се синови Израиљеви постећи и у костријети и посувши се земљом.',
        2: 'И одвоји се сјеме Израиљево од свијех туђинаца, и стадоше те исповиједаху гријехе своје и безакоња отаца својих.',
        3: 'И стајаху на свом мјесту, те им се читаше закон Господа Бога њихова четврт дана, а други четврт исповиједаху се и поклањаху се Господу Богу својему.',
        ...
        7: 'Ти си Господ Бог, који си избрао Аврама и извео из Ура Халдејскога и надео му име Авраам;',
        8: 'И нашао си срце његово вјерно пред собом, и учинио си с њим завјет да ћеш дати земљу Хананску, Хетејску, Аморејску, Ферезејску и Јевусејску и Гергесејску, да ћеш дати сјемену његову, и испунио си ријечи своје, јер си праведан.',
        9: 'Јер си погледао на муку отаца наших у Мисиру, и вику њихову си на Мору Црвеном;',
        ...
        11: 'И море си раздвојио пред њима, те пријеђоше посред мора сухим, и бацио си у дубине оне који их гнаху као камен у воду.',
        12: 'И у ступу од облака водио си их дању а ноћу у ступу огњеном свијетлећи им путем којим ће ићи.',
        13: 'И сишао си на гору Синајску и говорио с њима с неба, и дао им судове праве и законе истините, уредбе и заповијести добре.',
        14: 'И обзнанио си им суботу своју свету, и дао им заповијести и уредбе и закон преко Мојсија слуге својега.',
        15: 'И хљеб с неба дао си им у глади њиховој, и воду из камена извео си им у жеђи њиховој, и рекао си им да иду и наслиједе земљу за коју си подигао руку своју да ћеш им је дати.',
        16: 'Али они и оци наши узобијестише се и отврднуше вратом својим и не слушаше заповијести твојих.',
        17: 'Не хтјеше слушати, и не опомињаше се чудеса твојих која си им чинио, него отврднуше вратом својим, и у одмету свом постављаше себи вођа да се врате у ропство своје. Али ти, Боже, који опрашташ, који си жалостив и милостив, који дуго трпиш и велике си милости, нијеси их оставио.',
        18: 'И онда кад начинише себи теле ливено и рекоше: ово је твој Бог који те је извео из Мисира, и хулише веома,',
        19: 'Ни онда их ради велике милости своје нијеси оставио у пустињи; ступ од облака није отступао од њих дању водећи их путем, нити ступ огњени ноћу свијетлећи им путем којим ће ићи.',
        ...
        21: 'И четрдесет година хранио си их у пустињи, ништа им није недостајало: одијело им не оветша и ноге им не отекоше.',
        22: 'И дао си им царства и народе, и подијелио си их по крајевима, јер наслиједише земљу Сионову, земљу цара Есевонскога, и земљу цара Васанскога;',
        ...
        25: 'И тако узеше тврде градове и земљу родну, и наслиједише куће пуне свакога добра, студенце ископане, винограде, маслинике и воћке многе, и једоше и наситише се и угојише се, и благоваху по великој твојој доброти.',
        26: 'Али те разгњевише и одметнуше се од тебе: бацише закон твој за леђа и пророке твоје побише, који им свједочаху да би их обратили ка теби, и хулише веома.',
        ...
        29: 'И опомињао си их да би их обратио к закону својему, али они бијаху обијесни и не слушаше заповијести твојих и гријешише о твоје законе које ко врши жив ће бити кроз њих; и измичући рамена своја отврднуше вратом својим и не слушаше.',
        30: 'И трпио си их много година опомињући их духом својим преко пророка својих; али не слушаше; тада си их дао у руке народима земаљским.',
        31: 'Али ради милости своје велике нијеси дао да сасвијем пропадну нити си их оставио, јер си Бог милостив и жалостив.',
    ...
    11: {
        1: 'И населише се кнезови народни у Јерусалиму, а остали народ мета ждријеб да узму једнога од десет да сједи у Јерусалиму светом граду, и осталијех девет дијелова по другим градовима.',
        2: 'И благослови народ све људе који сами од своје воље присташе да сједе у Јерусалиму.',
        3: 'Ово су главари земаљски који се населише у Јерусалиму, а по осталијем градовима Јудејским настанише се сваки на својем нашљедству по градовима својим Израиљци свештеници и Левити, Нетинеји и синови слуга Соломуновијех:',
        ...
        5: 'И Масија син Варуха сина Холозе сина Азаје, сина Адаје, сина Јојарива сина Захрије, сина Силонијева;',
        6: 'Свега синова Фаресовијех што се населише у Јерусалиму, четири стотине и шездесет и осам храбријех људи;',
        7: 'А између синова Венијаминовијех: Салуј син Месулама, сина Јоада, сина Федаје, сина Колаје, сина Масија, сина Итила, сина Исаијина,',
        8: 'И за њим Гавај, Салај девет стотина и двадесет и осам;',
        9: 'А Јоило син Захријев бјеше над њима, а Јуда син Сенујин бјеше други над градом;',
        10: 'Од свештеника: Једаја син Јојавов, Јахин,',
        11: 'Сераја син Хелкије, сина Месулама, сина Садока, сина Мерајота, сина Ахтивова, старјешина у дому Божијем,',
        ...
        13: 'И браће његове главара у домовима отачким двјеста и четрдесет и два; и Амасај син Азреила, сина Азаја; сина Месилемота, сина Имирова,',
        14: 'И браће њихове храбријех људи сто и двадесет и осам, а над њима бјеше Завдило син Гедолимов;',
        15: 'И од Левита: Семаја сина Асува сина Азрикама, сина Асавије, сина Вунијева;',
        16: 'И Саветај, И Јозавад бијаху над послом спољашњим за дом Божји између главара Левитских,',
        17: 'А Матанија син Михе сина Завдије сина Асафова бијаше поглавар који почињаше хвалу у молитви, и Ваквукија други између браће своје, и Авда син Салије сина Галала сина Једутунова;',
        ...
        22: 'А над Левитима у Јерусалиму бјеше Озија син Ванија, сина Асавије, сина Матаније, сина Мишина. Између синова Асафовијех пјевачи бијаху у служби за дом Божји.',
        ...
        25: 'А по селима и пољима њиховијем неки од синова Јудинијех настанише се у Киријат-Арви и засеоцима њезинијем, и у Дивону и засеоцима његовијем, и у Јекавсеилу и селима његовијем,',
        26: 'И у Јесуји и Молади и Вет-Фелету,',
        27: 'И у Асар-Суалу и Вирсавеји и засеоцима њезинијем,',
        28: 'И у Сиклагу и у Мекони и засеоцима њезинијем,',
        29: 'И у Ен-Римону и у Сареји и у Јармуту,',
        30: 'У Заноји, у Одоламу и селима њиховијем, у Лахису с пољем његовијем, у Азици и засеоцима њезинијем. И тако се населише од Вирсавеје до долине Енома.',
        31: 'А синови Венијаминови населише се од Гаваје у Михмасу и Аји и Ветиљу и засеоцима његовијем,',
