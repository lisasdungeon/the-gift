...
CHAPTERS = {
    1: {
        ...
        4: 'И нека метне руку своју на главу жртви паљеници, и примиће му се, и очистиће га од гријеха.',
    ...
    2: {
        ...
        8: 'И донеси дар који начиниш од тога Господу, и подај га свештенику, и он ће га однијети на олтар;',
        ...
        12: 'Само у жртви од првина можете принијети то Господу; али на олтар не мећите за угодни мирис.',
        ...
        14: 'А кад приносиш дар од првина Господу, класове нове осуши на огњу, а што истреш из класова нових принеси на дар од првина својих.',
    ...
    6: {
        ...
        5: 'Или за што се заклео криво, нека плати цијело и још дометне пети дио ономе чије је; нека му да онај дан кад принесе жртву за свој гријех.',
        6: 'А на жртву за гријех свој нека принесе Господу овна здрава, са цијеном којом прецијениш кривицу нека га доведе свештенику.',
        ...
        10: 'Свештеник нека обуче своју хаљину ланену, и гаће ланене нека обуче на тијело своје, и нека згрне пепео кад огањ спали на олтару жртву паљеницу, и нека га изручи код олтара.',
        ...
        16: 'А што претече, нека једе Арон и синови његови; нека се једе без квасца на светом мјесту; у тријему шатора од састанка нека једу.',
        ...
        20: 'Ово је жртва Аронова и синова његовијех, коју ће приносити Господу онај дан кад се који помаже: десетину ефе бијелога брашна за дар свагдашњи, половину ујутру а половину увече.',
        ...
        30: 'Али ни једна жртва за гријех, од које се унесе крв у шатор од састанка да се учини очишћење од гријеха у светињи, нека се не једе, него нека се огњем сажеже.',
    },
    7: {
    ...
    8: {
        ...
        2: 'Узми Арона и синове његове с њим и одијело и уље помазања и теле за жртву ради гријеха и два овна и котарицу пријесних хљебова.',
        ...
        9: 'Још му метну капу на главу, и на капу метну спријед плочу златну, круну свету, као што заповједи Господ Мојсију.',
        ...
        29: 'И узе Мојсије груди, и обрну их тамо и амо за жртву обртану пред Господом; и од овна посветнога допаде Мојсију дио, као што бјеше заповједио Господ Мојсију.',
    ...
    10: {
        ...
        4: 'А Мојсије позва Мисаила и Елисафана синове Озила стрица Аронова, и рече им: ходите и изнесите браћу своју испред светиње напоље из окола.',
    ...
    11: {
        ...
        14: 'Еја и крагуј по својем врстама,',
        ...
        35: 'И на што би пало што од тијела њихова мртва све да је нечисто, и пећ и огњиште да се развали, јер је нечисто и нека вам је нечисто.',
    ...
    12: {
        1: 'И рече Господ Мојсију говорећи:',
        2: 'Кажи синовима Израиљевијем, и реци: кад жена затрудни и роди мушко, нечиста да је седам дана; као у дане кад се одваја ради немоћи своје, биће нечиста.',
        3: 'А у осми дан нека се обреже дијете.',
        4: 'А она још тридесет и три дана нека остане чистећи се од крви; ни једне свете ствари да се не додијева и у светињу да не иде док се не наврше дани чишћења њезина.',
        ...
        8: 'Ако ли не може дати јагњета, онда нека узме двије грлице или два голубића, једно за жртву паљеницу а друго за жртву ради гријеха; и очистиће је свештеник од гријеха њезина и биће чиста.',
    },
    13: {
        1: 'Јоште рече Господ Мојсију и Арону говорећи:',
        2: 'Човјек у кога би на кожи тијела његова био оток или краста или бубуљица, и било би на кожи тијела његова налик на губу, нека се доведе к Арону свештенику или ка којему сину његову свештенику.',
        3: 'И нека свештеник види бољетицу на кожи тијела његова; ако длака на бољетици буде побијељела и бољетица буде на очи нижа од остале коже тијела његова, онда је губа; па кад га види свештеник прогласиће га да је нечист.',
        ...
        6: 'И нека га свештеник опет види седмога дана, па ако опази да се бољетица смањила и није се даље разишла по кожи; краста је; и он нека опере хаљине своје и биће чист.',
        ...
        12: 'Ако ли се губа изаспе по кожи и покрију сву кожу човјеку од главе до пете, гдје би год свештеник очима погледао,',
        ...
        34: 'И седмога дана нека свештеник опет види оспу; ако опази да се оспа није даље разишла по кожи нити је на очи нижа од остале коже, тада ће га прогласити свештеник да је чист, па нека опере хаљине своје, и биће чист.',
    ...
    14: {
        ...
        4: 'Онда ће заповједити свештеник ономе који се чисти да узме двије птице живе чисте, и дрво кедрово и црвца и исопа.',
        ...
        13: 'А послије нека закоље јагње на мјесту гдје се коље жртва за гријех и жртва паљеница на светом мјесту, јер жртва за пријеступ припада свештенику као и жртва за гријех; светиња је над светињама.',
        ...
        18: 'А што још остане од уља на длану свештенику, онијем нека намаже главу ономе који се чисти, и тако ће га очистити свештеник пред Господом.',
        19: 'Потом нека принесе свештеник жртву за гријех, и очистиће онога који се чисти од своје нечистоте; а послије нека закоље жртву паљеницу.',
        ...
        27: 'Па нека замочи прст од десне руке своје у уље што му је на лијевом длану, и нека покропи уљем с прста својега седам пута пред Господом.',
        ...
        29: 'А што још остане од уља на длану свештенику, онијем нека намаже главу ономе који се чисти, и тако ће га очистити пред Господом.',
    ...
    16: {
        ...
        2: 'И каза Господ Мојсију: реци Арону брату својему да не улази у свако доба у светињу за завјес пред заклопац који је на ковчегу, да не погине, јер ћу се у облаку над заклопцем јављати.',
        3: 'С овијем нека улази Арон у светињу: с јунцем за жртву ради гријеха и с овном за жртву паљеницу.',
        4: 'Свету кошуљу ланену нека обуче, и гаће ланене нека су на тијелу његову, и нека се опаше појасом ланенијем и капу ланену нека метне на главу; то су хаљине свете, и нека опере тијело своје водом, па онда нека их обуче.',
        5: 'А од збора синова Израиљевијех нека узме два јарца за жртву ради гријеха, и једнога овна за жртву паљеницу.',
        6: 'И нека принесе Арон јунца својега на жртву за гријех и очисти себе и дом свој.',
        ...
        12: 'И нека узме кадионицу пуну жеравице с олтара, који је пред Господом, и пуне прегршти када мириснога истуцанога, и нека унесе за завјес.',
        ...
        15: 'И нека закоље јарца на жртву за гријех народни, и нека учини с крвљу његовом као што је учинио с крвљу јунчијом, и покропи њом по заклопцу и пред заклопцем.',
        ...
        19: 'И нека га покропи озго истом крвљу с прста својега седам пута; тако ће га очистити и посветити га од нечистота синова Израиљевих.',
        20: 'А кад очисти светињу и шатор од састанка и олтар, тада нека доведе јарца живога.',
        21: 'И метнувши Арон обје руке своје на главу јарцу живому, нека исповједи над њим сва безакоња синова Израиљевих и све пријеступе њихове у свијем гријесима њиховијем, и метнувши их на главу јарцу нека га да човјеку спремном да га истјера у пустињу.',
        22: 'И јарац ће однијети на себи сва безакоња њихова у пустињу; и пустиће онога јарца у пустињу.',
        23: 'Потом нека опет уђе Арон у шатор од састанка и свуче хаљине ланене које је обукао када је ишао у светињу, и ондје нека их остави.',
        24: 'Па нека опере тијело своје на светом мјесту и обуче своје хаљине; и изашав нека принесе своју жртву паљеницу, и очисти себе и народ.',
        ...
        27: 'А јунца за гријех и јарца за гријех, од којих је крв унесена да се учини очишћење у светињи, нека изнесу напоље из окола, и нека спале огњем коже њихове и месо њихово и балегу њихову.',
        28: 'А ко их спали, нека опере хаљине своје и окупа тијело своје у води, па онда нека дође у око.',
        29: 'И ово нека вам буде вјечна уредба: десети дан седмога мјесеца мучите душе своје, и не радите никакога посла, ни домородац ни дошљак који се бави међу вама.',
        30: 'Јер у тај дан бива очишћење за вас, да се очистите; бићете очишћени од свијех гријеха својих пред Господом.',
        31: 'То нека вам је почивање суботно, и мучите душе своје по уредби вјечној.',
        32: 'А свештеник који буде помазан и који буде освећен да врши службу свештеничку на мјесто оца својега, он нека очишћа обукавши се у хаљине ланене, хаљине свете.',
    ...
    17: {
        1: 'Јоште рече Господ Мојсију говорећи:',
        2: 'Кажи Арону и синовима његовијем и свијем синовима Израиљевим, и реци им: ово је заповједио Господ говорећи:',
        3: 'Ко год од дома Израиљева закоље вола или јагње или козу у околу, или ко год закоље изван окола,',
        4: 'А не доведе на врата шатора од састанка, да принесе принос Господу пред шатором Господњим, крив је за крв; зато да се истријеби онај човјек из народа својега.',
        ...
        7: 'И нека више не приносе жртве своје ђаволима, за којима они чине прељубу. Ово нека им буде закон вјечан од кољена на кољено.',
        8: 'Зато им реци: ко би год од дома Израиљева или између странаца који се баве међу њима принио жртву паљеницу или другу жртву,',
        9: 'А не би је довео на врата шатора од састанка да је принесе Господу, тај човјек да се истријеби из народа својега.',
        10: 'А ко би год од дома Израиљева или између странаца који се баве међу њима јео какве год крви, окренућу лице своје на супрот оному човјеку који буде јео крви, и истријебићу га из народа његова.',
        ...
        14: 'Јер је душа свакога тијела крв његова, то му је душа. Зато рекох синовима Израиљевим: крви ниједнога тијела не једите, јер је душа свакога тијела крв његова. Ко би је год јео, да се истријеби.',
    ...
    19: {
        ...
        3: 'Сваки да се боји матере своје и оца својега; и држите суботе моје; ја сам Господ Бог ваш.',
        4: 'Не обраћајте се к идолима, и богова ливенијех не градите себи; ја сам Господ Бог ваш.',
        ...
        8: 'Ко би год јео, носиће своје безакоње, јер оскврни светињу Господу; зато ће се истријебити она душа из народа својега.',
        9: 'А кад жањете род земље своје, немој пожети сасвијем њиве своје, нити пабирчи по жетви.',
        ...
        11: 'Не крадите; не лажите и не варајте ближњега својега.',
        12: 'Не куните се именом мојим криво; јер ћеш оскврнити име Бога својега. Ја сам Господ.',
        13: 'Не закидај ближњега својега и не отимај му; плаћа надничарова да не преноћи код тебе до јутра.',
        14: 'Немој псовати глуха, ни пред слијепца метати што да се спотакне; него се бој Бога својега; ја сам Господ.',
        15: 'Не чините неправде на суду, не гледај што је ко сиромах, нити се поводи за богатијем; право суди ближњему својему.',
        16: 'Не иди као опадач по народу својем, и не устај на крв ближњега својега; ја сам Господ.',
        17: 'Немој мрзити на брата својега у срцу својем; слободно искарај ближњега својега, и немој трпјети гријеха на њему.',
        18: 'Не буди осветљив, и не носи срдње на синове народа својега; него љуби ближњега својега као себе самога; ја сам Господ.',
        19: 'Уредбе моје држите; живинчета својега не пуштај на живинче друге врсте; не засијевај њиве своје двојаким сјеменом, и не облачи на се хаљине од двојаких ствари.',
        ...
        21: 'И нека он принесе Господу жртву за пријеступ свој на врата шатора од састанка, овна за пријеступ.',
        ...
        27: 'Не стризите косе своје уокруг, ни грдите браде своје.',
        28: 'За мртвацем не режите тијела својега, ни ударајте на се каквих биљега. Ја сам Господ.',
    ...
    20: {
        ...
        3: 'И ја ћу окренути лице своје на супрот таком човјеку, и истријебићу га из народа његова, што од сјемена својега даде Молоху, и запрзни светињу моју и оскврни свето име моје.',
        4: 'Ако ли народ како год затвори очи да не види тога човјека кад да од сјемена својега Молоху, и не убију га,',
        ...
        6: 'А ко се обрати к врачарима и гатарима да чини прељубу за њима, окренућу лице своје насупрот њему, и истријебићу га из народа његова.',
        ...
        9: 'Ко опсује оца својега или матер своју, да се погуби; опсовао је оца својега или матер своју; крв његова на њ.',
        ...
        14: 'И ко би узео жену и матер њезину, зло је, огњем да се спали и он и она, да не буде зла међу вама.',
        ...
        24: 'И рекох вам: ви ћете наслиједити земљу њихову и ја ћу вам је дати у државу, земљу у којој тече млијеко и мед. Ја сам Господ Бог ваш, који вас одвојих од других народа.',
        ...
        27: 'А човјек или жена, у којима би био дух врачарски или гатарски, да се погубе, камењем да се заспу, крв њихова на њих.',
    },
    21: {
        ...
        5: 'Да се не начине ћелави чупајући косу с главе своје и да не брију браде своје, нити се режу по тијелу својем.',
        ...
        9: 'А кћи свештеничка која се оскврни курвајући се, скврни оца својега, огњем нека се спали.',
        10: 'А свештеник највиши између браће своје, којему се на главу излило уље помазања и који је посвећен да се облачи у свете хаљине, нека не открива главе своје, и хаљине своје нека не раздире.',
        ...
        15: 'И нека не скврни сјеме народа својега у народу својем, јер сам ја Господ, који га посвећујем.',
        ...
        23: 'Али за завјес нека не улази; к олтару нека се не приближује, јер је мана на њему, па нека не скврни светиње моје, јер сам ја Господ који их посвећујем.',
