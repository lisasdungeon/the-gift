...
CHAPTERS = {
    1: {
        ...
        28: 'Као дуга у облаку кад је киша, така на очи бијаше свјетлост унаоколо. То бијаше виђење славе Божје на очима; и кад видјех, падох на лице своје, и чух глас некога који говораше.',
    },
    2: {
    ...
    3: {
        1: 'И рече ми: сине човјечји, поједи што је пред тобом, поједи ову књигу, па иди, говори дому Израиљеву.',
    ...
    6: {
        ...
        3: 'И реци: горе Израиљеве, чујте ријеч Господ Господа, овако вели Господ Господ горама и хумовима, потоцима и долинама: ево ме, ја ћу пустити на вас мач и оборићу висине ваше.',
        4: 'И ваши ће се олтари раскопати, и сунчани ликови ваши изломиће се, и поваљаћу побијене ваше пред гаднијем боговима вашим.',
    ...
    10: {
        1: 'Потом видјех, и гле, на небу које бијаше над главама херувимима показа се над њима као камен сафир на очи као пријесто.',
    ...
    11: {
        1: 'Тада ме подиже дух, и однесе ме на источна врата дома Господњега која гледају на исток, и гле, на вратима бијаше двадесет и пет људи, и међу њима видјех Језанију сина Азурова и Фелатију сина Венајина, поглаваре народне.',
        ...
        16: 'Зато реци: овако вели Господ Господ: ако их и одагнах далеко међу народе, ако их и расијах по земљама, опет ћу им бити светиња за мало у земљама у које отидоше.',
    ...
    15: {
        ...
        5: 'Гле, док бијаше цијела, не могаше се ништа од ње начинити, а камо ли ће бити за што кад је огањ прождрије и изгорје.',
    ...
    16: {
        ...
        12: 'И гривну око чела метнух ти, и обоце у уши, славан вјенац на главу.',
        ...
        33: 'Свијем курвама даје се плата, а ти си давала плату свијем милосницама својим и даривала си их да долазе к теби са свијех страна да се курвају с тобом.',
        ...
        36: 'Овако вели Господ Господ: што се отров твој просу, и што се у курвању твом откривала голотиња твоја твојим милосницама и свијем гаднијем идолима твојим, и за крв синова твојих, које си им дала,',
        ...
        50: 'Него се понашаху и чињаху гадове преда мном, зато их затрх кад видјех.',
        51: 'Самарије није згријешила ни пола колико ти, јер си починила гадова својих више него оне, те си оправдала сестре своје свијем гадовима својим које си учинила.',
    ...
    20: {
        ...
        36: 'Како сам се судим с оцима вашим у пустињи земље Мисирске, тако ћу се судити с вама, говори Господ Господ.',
    ...
    21: {
        ...
        21: 'Стегни се, удри на десно, на лијево, куда се год обрнеш.',
    ...
    23: {
        ...
        32: 'Овако вели Господ Господ: чашу сестре своје испићеш дубоку и широку, бићеш потсмијех и руг, јер чаша много бере.',
    ...
    24: {
        ...
        2: 'Сине човјечји, запиши име овога дана, овога истога дана; у тај дан дође цар Вавилонски на Јерусалим.',
        ...
        6: 'Јер овако вели Господ Господ: тешко граду крвничком, лонцу, на ком стоји загоријел, с којега неће да сиђе загоријел; повади дио по дио; ждријеб да се не баци за њ.',
        ...
        9: 'Зато овако вели Господ Господ: тешко граду крвничком! и ја ћу наложити велик огањ.',
        ...
        13: 'У нечистоти је твојој грдило твоје; јер сам те чистио, али се ти не очисти; нећеш се више чистити од нечистоте своје, докле не намирим гњев свој над тобом.',
        ...
        26: 'У тај дан ко утече, неће ли доћи к теби да ти донесе глас?',
    ...
    25: {
        1: 'Опет ми дође ријеч Господња говорећи:',
        2: 'Сине човјечји, окрени лице своје према синовима Амоновијем и пророкуј на њих.',
        ...
        12: 'Овако вели Господ Господ: што се Едом освети дому Јудину и тешко скриви осветивши им се,',
        ...
        16: 'Зато овако вели Господ Господ: ево ја ћу дигнути руку своју на Филистеје, и истријебићу Херетеје, и потрћу остатак од приморја.',
    ...
    28: {
        ...
        9: 'Хоћеш ли пред крвником својим казати: ја сам Бог, кад си човјек а не Бог у руци онога који ће те убити?',
        ...
        13: 'Био си у Едему врту Божјем; покривало те је свако драго камење: сарад, топаз, дијаманат, хрисолит, оних, јаспид, сафир, карбункул, смарагд и злато; онај дан кад си се родио начињени ти бише бубњи твоји и свирале.',
        ...
        16: 'Од мноштва трговине своје напунио си се изнутра насиља, и гријешио си; зато ћу те бацити као нечистоту с горе Божје, и затрћу те између камења огњенога, херувиме заклањачу!',
        ...
        21: 'Сине човјечји, окрени лице своје према Сидону, и пророкуј против њега,',
    ...
    31: {
        ...
        3: 'Ето, Асирац бјеше кедар на Ливану, лијепих грана и дебела хлада и висока раста, којему врхови бијаху међу густијем гранама.',
        ...
        9: 'Учиних га лијепа мноштвом грана да му завиђаху сва дрвета Едемска што бијаху у врту Божијем.',
    ...
    32: {
        ...
        2: 'Сине човјечји, наричи за Фараоном царем Мисирским, и реци му: ти си као лавић међу народима и као змај у мору, и пролазиш ријеке своје и мутиш воду ногама својим и газиш по ријекама њезинијем.',
        ...
        7: 'И кад те угасим, застријећу небо, и звијезде на њему помрачити, сунце ћу заклонити облаком, и мјесец неће свијетлити свјетлошћу својом.',
        ...
        10: 'И удивићу тобом многе народе, и цареви ће се њихови згрозити од тебе, кад махнем мачем својим пред њима, и дрктаће сваки час сваки за душу своју у дан кад паднеш.',
        ...
        13: 'И потрћу сву стоку његову покрај великих вода, те их неће више мутити нога човјечија нити ће их папак од каке животиње мутити.',
        ...
        18: 'Сине човјечји, наричи за мноштвом Мисирским, и свали њих и кћери јаких народа у најдоњи крај земље с онима који слазе у јаму.',
        ...
        21: 'Говориће му најхрабрији јунаци исред гроба с помоћницима његовијем, који сидоше и леже необрезани, побијени мачем.',
        22: 'Ондје је Асирац и сав збор његов, гробови су му око њега, сви су побијени, пали од мача.',
        23: 'Гробови су му у дну јаме, а збор му је око његова гроба; сви су побијени, пали од мача, који задаваху страх земљи живијех.',
        ...
        26: 'Ондје је Месех, Тувал и све мноштво његово, гробови су му око њега, сви су необрезани побијени мачем, који задаваху страх земљи живијех.',
        ...
        29: 'Ондје је Едом, цареви његови и сви кнезови његови, који су са силом својом метнути међу побијене мачем; леже међу необрезанима и с онима који сидоше у јаму.',
        30: 'Ондје су сви кнезови сјеверни и сви Сидонци, који сидоше к побијенима са страхом својим, стидећи се силе своје; и леже необрезани с онима који су побијени мачем, и носе срамоту своју с онима који сидоше у јаму.',
    ...
    36: {
        1: 'Ти, сине човјечји, пророкуј горама Израиљевијем, и реци: горе Израиљеве, чујте ријеч Господњу.',
        2: 'Овако вели Господ Господ: што непријатељ говори за вас: ха ха! вјечне висине посташе наше нашљедство;',
        ...
        4: 'Зато, горе Израиљеве, чујте ријеч Господа Господа; овако вели Господ горама Израиљевијем и хумовима, потоцима и долинама, и пустијем развалинама и градовима остављенијем, које посташе грабеж и потсмијех осталијем народима унаоколо,',
        ...
        8: 'А ви, горе Израиљеве, пуштаћете гране своје, и род свој носићете народу мојему Израиљу, јер ће скоро доћи.',
        ...
        17: 'Сине човјечји, дом Израиљев живећи у својој земљи оскврни је својим путем и својим дјелима; пут њихов бијаше преда мном као нечистота жене одвојене.',
        ...
        20: 'И кад дођоше међу народе, гдје год дођоше оскврнише свето име моје, а за њих се говораше да су Господњи народ и да су из земље његове изашли.',
        21: 'Али ми се сажали ради светога имена мојега, које оскврни дом Израиљев у народима у које дође.',
        ...
        25: 'И покропићу вас водом чистом, и бићете чисти; ја ћу вас очистити од свијех нечистота ваших и од свијех гаднијех богова ваших.',
        26: 'И даћу вам ново срце, и нов ћу дух метнути у вас, и извадићу камено срце из тијела вашега, и даћу вам срце месно.',
        ...
        31: 'И опоменућете се злијех путова својих и дјела својих која не бјеху добра, и сами ћете себи бити мрски за безакоња своја и за гадове своје.',
        32: 'Нећу вас ради учинити, говори Господ Господ; знајте; посрамите се и постидите се путова својих, доме Израиљев.',
        ...
        35: 'И рећи ће се: земља ова што бјеше пуста поста као врт Едемски, и градови што бјеху пусти, разваљени и раскопани, утврдише се и населише се.',
        36: 'И народи који остану око вас познаће да ја Господ саграђујем разваљено и засађујем опустјело. Ја Господ рекох, и учинићу.',
    ...
    39: {
        1: 'Ти дакле, сине човјечји, пророкуј против Гога, и реци: овако вели Господ Господ: ево ме на те, Гоже, кнеже и главо Месеху и Тувалу.',
        ...
        4: 'На горама ћеш Израиљевијем пасти ти и све чете твоје и народи који буду с тобом; птицама, свакојаким птицама крилатијем и звијерима пољским даћу те да те изједу.',
        ...
        17: 'Ти, дакле, сине човјечји, овако говори Господ Господ, реци птицама, свакојаким птицама и свијем звијерима пољским: скупите се и ходите, саберите се са свијех страна на жртву моју, коју кољем за вас, на велику жртву на горама Израиљевијем, и јешћете меса и пићете крви;',
    ...
    44: {
        ...
        4: 'И одведе ме к сјевернијем вратима пред дом; и видјех, и гле, дом Господњи бјеше пун славе Господње, и падох на лице своје.',
        ...
        10: 'А Левити који отступише од мене кад зађе Израиљ, који зађоше од мене за гаднијем боговима својим, носиће безакоње своје.',
        ...
        15: 'А свештеници Левити синови Садокови, који извршиваху што треба у мојој светињи, кад синови Израиљеви зађоше од мене, они ће приступати к мени да ми служе, и стајаће преда мном приносећи ми претилину и крв, говори Господ Господ.',
        ...
        19: 'А кад излазе у тријем спољашњи, у спољашњи тријем к народу, нека свуку са себе хаљине у којима служе, и оставе их у клијетима светијем, па нека обуку друге хаљине, да не освећују народа хаљинама својим.',
        20: 'И главе своје да не брију, а ни косе да не остављају, него нека стригу главе своје.',
        21: 'И вина да не пије ни један свештеник кад хоће да уђе у унутрашњи тријем.',
        22: 'И удовицом ни пуштеницом да се не жене, него дјевојком од сјемена дома Израиљева или удовицом свештеничком нека се жене.',
        23: 'И народ мој нека уче што је свето што ли није свето, и нека их уче распознавати нечисто од чистога.',
        ...
        28: 'А нашљедство што ће имати, ја сам њихово нашљедство; и ви им не дајте достојања у Израиљу, ја сам њихово достојање.',
        ...
        31: 'Свештеници да не једу мрцинога ни што звјерка раскине, било птица или што од стоке.',
    },
    45: {
    ...
    47: {
        1: 'Потом одведе ме опет к вратима од дома, и гле, вода излажаше испод прага од дома к истоку, јер лице дому бијаше према истоку; и вода тецијаше доље с десне стране дома, с јужне стране олтара.',
        ...
        3: 'И кад човјек изиде на исток с мјером у руци, измјери тисућу лаката, и преведе ме преко воде, и вода бијаше до глежања.',
        ...
        6: 'Тада ми рече: видје ли, сине човјечји? И одведе ме и поврати ме на бријег ријеци.',
        7: 'А кад се вратих, гле, по бријегу ријеци врло много дрва отуд и одовуд.',
        ...
        12: 'А крај ријеке по бријегу отуд и одовуд рашће дрвета свакојака родна, којима лишће неће опадати нити ће рода на њима нестајати; свакога ће мјесеца рађати нов род, јер јој вода тече из светиње; зато ће род њихов бити за јело и лишће њихово за лијек.',
        13: 'Овако вели Господ Господ: ово су међе у којима ћете наслиједити земљу по дванаест племена Израиљевијех: Јосифу два дијела.',
        ...
        19: 'А јужна страна према југу од Тамара до воде Мериве у Кадису, дуж потока до великога мора. И то је јужна страна према југу.',
