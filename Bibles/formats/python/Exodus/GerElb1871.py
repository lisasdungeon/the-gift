...
CHAPTERS = {
    1: {
        ...
        16: 'und sagte: Wenn ihr den Hebräerinnen bei der Geburt helfet und ihr sie auf dem Geburtsstuhl sehet: wenn es ein Sohn ist, so tötet ihn, und wenn eine Tochter, so mag sie leben.',
    ...
    5: {
        ...
        13: 'Und die Treiber drängten sie und sprachen: Vollendet eure Arbeiten, das Tagewerk an seinem Tage, gleichwie als Stroh da war!',
    ...
    7: {
        ...
        18: 'Und die Fische, die im Strome sind, werden sterben, und der Strom wird stinken, und die Ägypter wirds ekeln, Wasser aus dem Strome zu trinken.',
    ...
    10: {
        ...
        6: 'und sie werden deine Häuser erfüllen und die Häuser aller deiner Knechte und die Häuser aller Ägypter, wie es deine Väter und die Väter deiner Väter nicht gesehen haben, seit dem Tage, da sie auf Erden gewesen sind, bis auf diesen Tag. Und er wandte sich und ging von dem Pharao hinaus.',
        7: 'Und die Knechte des Pharao sprachen zu ihm: Bis wann soll uns dieser zum Fallstrick sein? Laß die Leute ziehen, daß sie Jehova, ihrem Gott, dienen! Erkennst du noch nicht, daß Ägypten zu Grunde geht?',
    ...
    12: {
        ...
        40: 'Und die Wohnzeit der Kinder Israel, die sie in Ägypten zugebracht haben, ist 430 Jahre.',
        41: 'Und es geschah am Ende der 430 Jahre, und es geschah an diesem selbigen Tage, daß alle Heere Jehovas aus dem Lande Ägypten auszogen.',
        42: 'Dies ist eine Nacht, die dem Jehova zu beobachten ist, weil er sie aus dem Lande Ägypten herausführte; diese selbige Nacht ist dem Jehova zu beobachten von allen Kindern Israel bei ihren Geschlechtern.',
    ...
    16: {
        1: 'Und sie brachen auf von Elim, und die ganze Gemeinde der Kinder Israel kam in die Wüste Sin, die zwischen Elim und Sinai ist, am fünfzehnten Tage des zweiten Monats nach ihrem Auszuge aus dem Lande Ägypten.',
        ...
        8: 'Und Mose sprach: Dadurch werdet ihrs erkennen, daß Jehova euch am Abend Fleisch zu essen geben wird und am Morgen Brot bis zur Sättigung, indem Jehova euer Murren gehört hat, womit ihr wider ihn murret. Denn was sind wir? Nicht wider uns ist euer Murren, sondern wider Jehova.',
        ...
        14: 'Und die Tauschicht stieg auf, und siehe, da lags auf der Fläche der Wüste fein, körnig, fein, wie der Reif auf der Erde.',
    ...
    22: {
        ...
        6: 'Wenn Feuer ausbricht und Dornen erreicht, und es wird ein Garbenhaufen verzehrt, oder das stehende Getreide oder das Feld, so soll der gewißlich erstatten, der den Brand angezündet hat.',
    ...
    30: {
        ...
        13: 'Dies sollen sie geben: jeder zu den Gemusterten Übergehende die Hälfte eines Sekels, nach dem Sekel des Heiligtums, die Hälfte eines Sekels als Hebopfer dem Jehova.',
    ...
    34: {
        ...
        3: 'Und niemand soll mit dir heraufsteigen, und niemand soll selbst gesehen werden auf dem ganzen Berge; sogar Kleinvieh und Rinder sollen nicht gegen diesen Berg hin weiden.',
        ...
        9: 'und sprach: Wenn ich doch Gnade gefunden habe in deinen Augen, Herr, so ziehe doch der Herr in unserer Mitte-denn es ist ein hartnäckiges Volk-und vergib unsere Ungerechtigkeit und unsere Sünde, und nimm uns an zum Eigentum.',
    ...
    37: {
        ...
        13: 'Und er goß für denselben vier Ringe von Gold und setzte die Ringe an die vier Ecken, die an seinen vier Füßen waren.',
        ...
        17: 'Und er machte den Leuchter von reinem Golde; in getriebener Arbeit machte er den Leuchter, seinen Fuß und seinen Schaft; seine Kelche, seine Knäufe und seine Blumen waren aus ihm.',
        ...
        25: 'Und er machte den Räucheraltar von Akazienholz: eine Elle seine Länge, und eine Elle seine Breite, quadratförmig, und zwei Ellen seine Höhe; aus ihm waren seine Hörner.',
    ...
    38: {
        ...
        24: 'Alles Gold, das zum Werke verwendet wurde an dem ganzen Werke des Heiligtums, das Gold des Webopfers, betrug 29 Talente und 730 Sekel, nach dem Sekel des Heiligtums.',
