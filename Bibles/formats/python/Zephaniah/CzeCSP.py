...
CHAPTERS = {
    ...
    3: {
        ...
        3: 'Jeho knížata uprostřed něj jsou řvoucí lvi, jeho soudcové jak vlci k večeru, do rána ne nechají nic ne ohryzaného.',
        ...
        13: 'Ostatek Izraele neučiní zvrácenost, nepromluví lživě, v jejich ústech se nenajde podvodný jazyk. Budou se pást a uléhat, a nikdo je ne vyděsí.',
