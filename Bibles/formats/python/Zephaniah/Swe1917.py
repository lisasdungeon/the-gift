...
CHAPTERS = {
    ...
    2: {
        ...
        15: 'Så skall det gå den glada staden, som satt så trygg, och som sade i sitt hjärta: »Jag och ingen annan!» Huru har den icke blivit en ödemark, en lägerstad för vilda djur! Alla som gå där fram skola vissla åt den och slå ihop händerna. [1] Utsagorna om Gasa och Ekron innehålla i den hebreiska grundtexten anspelningar på dessa orters namn.',
    },
    3: {
