...
CHAPTERS = {
    ...
    5: {
        ...
        14: 'Os que apascentavam os porcos fugiram, e avisaram na cidade e nos campos; e as pessoas foram ver o que havia acontecido.',
    ...
    6: {
        ...
        41: 'Ele tomou os cinco pães e os dois peixes, levantou os olhos ao céu, abençoou, e partiu os pães, e os deu aos seus discípulos, para que os pusessem diante deles. E os dois peixes repartiu com todos.',
    ...
    8: {
        1: 'Naqueles dias, quando havia uma multidão muito grande, e não tinham o que comer, Jesus chamou os seus discípulos a si, e disse-lhes:',
        2: 'Tenho compaixão da multidão, porque já há três dias que estão comigo, e não têm o que comer.',
        3: 'E se eu os deixar ir sem comer para suas casas desmaiarão no caminho; porque alguns deles vieram de longe.',
    ...
    9: {
        ...
        23: 'E Jesus lhe disse: Se podes crer, tudo é possível ao que crê.',
        24: 'Logo o pai do menino, clamando, com lágrimas, disse: Creio, Senhor! Ajuda-me na minha incredulidade.',
        ...
        29: 'E lhes respondeu: Este tipo não pode sair por coisa alguma, a não ser com oração e jejum.',
        ...
        45: 'E se teu pé te faz pecar, corta-o; melhor te é entrar na vida manco, do que tendo dois pés ser lançado no inferno, no fogo que nunca se apaga.',
    ...
    10: {
        ...
        10: 'E em casa seus discípulos voltaram a lhe perguntar sobre isto mesmo.',
        11: 'E disse-lhes: Qualquer um que deixar a sua mulher, e se casar com outra, adultera contra ela.',
        12: 'E se a mulher deixar o seu marido, e se casar com outro, adultera.',
        ...
        29: 'Jesus respondeu: Em verdade vos digo, que não há ninguém que tenha deixado casa, ou irmãos, ou irmãs, ou pai, ou mãe, ou esposa, ou filhos, ou campos, por amor de mim e do Evangelho,',
        ...
        40: 'Mas sentar-se à minha direita, e à minha esquerda, não é meu concedê-lo, mas sim, para aqueles a quem está preparado.',
        ...
        46: 'E vieram a Jericó. E saindo ele, e seus discípulos, e uma grande multidão de Jericó, estava Bartimeu, um cego, filho de Timeu, sentado junto ao caminho.',
        ...
        49: 'Jesus parou, e disse que o chamassem. Então chamaram ao cego, dizendo-lhe: Tem bom ânimo, levanta-te, ele está te chamando.',
        50: 'Então ele lançou sua capa, levantou-se, e veio a Jesus.',
    ...
    11: {
        ...
        4: 'Eles foram, e acharam o jumentinho amarrado à porta, do lado de fora em uma esquina, e o soltaram.',
        5: 'E alguns dos que ali estavam lhes perguntaram: Que fazeis, soltando o jumentinho?',
        6: 'Eles lhes disseram como Jesus lhes havia mandado, e os deixaram ir.',
        7: 'Então trouxeram o jumentinho a Jesus. Lançaram sobre ele suas roupas, e Jesus sentou-se sobre ele.',
        8: 'Muitos estendiam suas roupas pelo caminho, e outros cortavam ramos das árvores, e os espalhavam pelo caminho..',
        9: 'E os que iam adiante, e os que seguiam, clamavam: Hosana, bendito o que vem no Nome do Senhor!',
        10: 'Bendito o Reino que vem no Nome do Senhor, o Reino do nosso pai Davi! Hosana nas alturas!',
        ...
        18: 'Os escribas e os chefes dos sacerdotes ouviram isso, e buscavam uma maneira de o matar; pois o temiam, porque toda a multidão estava admirada do ensino dele.',
    ...
    12: {
        1: 'Então Jesus começou a lhes dizer por parábolas: Um homem plantou uma vinha, cercou-a, fundou nela um esmagador de uvas, edificou uma torre, e a arrendou a uns lavradores; e partiu-se d aquela terra.',
        ...
        4: 'E voltou a lhes mandar outro servo; e eles, apedrejando-o, feriram-no na cabeça e voltaram a mandá-lo maltratado.',
        ...
        19: 'Mestre, Moisés nos escreveu que, se o irmão de alguém morresse, e deixasse mulher, mas não filhos, que seu irmão se casasse com a viúva, e gerasse descendência ao seu irmão.',
        ...
        22: 'Os sete casaram-se com ela, mas não deixaram descendente. Finalmente, depois de todos, morreu também a mulher.',
        ...
        33: 'E que amá-lo com todo o coração, com todo o entendimento, com toda a alma, e com todas as forças; e amar ao próximo como a si mesmo, é mais que todas as ofertas de queima e sacrifícios.',
    ...
    13: {
        ...
        2: 'Jesus respondeu, dizendo-lhe: Vês estes grandes edifícios? Não será deixada pedra sobre pedra, que não seja derrubada.',
        ...
        5: 'E Jesus, respondendo-lhes, começou a dizer: Cuidado! ninguém vos engane;',
        6: 'porque muitos virão em meu nome, dizendo: “Sou eu”, e enganarão a muitos.',
        7: 'E quando ouvirdes de guerras e de rumores de guerras, não vos perturbeis; porque assim deve acontecer; mas ainda não será o fim.',
        8: 'Porque nação se levantará contra nação, e reino contra reino, e haverá terremotos em muitos lugares, e haverá fomes e tumultos. Estes serão os princípios das dores.',
        9: 'Mas cuidai de vós mesmos; porque vos entregarão em tribunais e em sinagogas; sereis açoitados, e sereis levados diante de governadores e reis, por causa de mim, para que lhes haja testemunho.',
        10: 'Mas antes o Evangelho deve ser pregado entre todas as nações.',
        11: 'Porém, quando vos levarem para vos entregar, não estejais ansiosos antecipadamente do que deveis dizer, nem o planejeis; mas o que naquela hora for dado, isso falai. Porque não sois vós os que falais, mas o Espírito Santo.',
        ...
        15: 'E quem estiver sobre telhado, não desça para a casa, nem entre para tomar alguma coisa de sua casa.',
        16: 'E quem estiver no campo, não volte atrás, para tomar sua roupa.',
        17: 'Mas ai das grávidas, e das que amamentarem naqueles dias!',
        18: 'Orai, porém, para que a vossa fuga não aconteça no inverno.',
        ...
        22: 'Porque se levantarão falsos cristos, e falsos profetas, que farão sinais e prodígios, para enganar, se possível, até os escolhidos.',
        23: 'Vós, porém, tende cuidado; eis que tenho vos dito tudo com antecedência.',
        24: 'Mas naqueles dias, depois daquela aflição, o sol se escurecerá, e a lua não dará seu brilho;',
        25: 'as estrelas do céu cairão, e as forças que estão nos céus se abalarão.',
        26: 'Então verão o Filho do homem vir nas nuvens, com grande poder e glória.',
        27: 'Ele então enviará os seus anjos, e ajuntará os seus escolhidos dos quatro ventos, desde a extremidade da terra, até a extremidade do céu.',
    ...
    14: {
        ...
        16: 'E seusdiscípulos saíram, e vieram à cidade, e acharam como havia lhes dito, e prepararam a Páscoa.',
        ...
        22: 'E enquanto eles comiam, Jesus tomou o pão; e bendizendo, partiu-o, deu-lhes, e disse: “Tomai, comei, isto é o meu corpo.”',
        23: 'E tomando o copo, e dando graças, deu-lhes; e todos beberam dele.',
        24: 'E disse-lhes: “Isto é o meu sangue, o do novo testamento, que é derramado por muitos.',
        ...
        29: 'E Pedro lhe disse: “Ainda que todos se ofendam, porém eu não.”',
        ...
        43: 'E logo, enquanto ele ainda estava falando, veio Judas, que era um dos doze, e com ele uma grande multidão, com espadas e bastões, da parte dos chefes dos sacerdotes, dos escribas, dos anciãos.',
        ...
        51: 'E certo rapaz o seguia, envolto num lençol sobre o corpo nu. E os rapazes o agarraram.',
        52: 'Mas ele largou o lençol, e fugiu deles nu.',
        53: 'E levaram Jesus ao sumo sacerdote; e ajuntaram-se a ele todos os chefes dos sacerdotes, os anciãos, e os escribas.',
        ...
        65: 'E alguns começaram a cuspir nele, e a cobrir o rosto dele; e a dar-lhe de socos, e dizer-lhe: “Profetiza”. E os oficiais lhe davam bofetadas.',
        ...
        68: 'Mas ele negou, dizendo: “Não o conheço, nem sei o que dizes.”; e saiu para o alpendre. Então o galo cantou.',
        69: 'A serva o viu outra vez, e começou a dizer aos que ali estavam: “Este é um deles”.',
        70: 'Mas ele o negou de novo. E pouco depois, outra vez os que ali estavam disseram a Pedro: “Verdadeiramente tu és um deles; pois também és galileu”, e a tua fala é semelhante”.',
        71: 'Então ele começou a amaldiçoar e a jurar, dizendo: “Não conheço esse homem de quem dizeis.”',
        72: 'O galo cantou a segunda vez. E Pedro se lembrou da palavra que Jesus havia lhe dito: “Antes que o galo cante duas vezes, tu me negarás três vezes.” Então ele retirou-se dali e chorou.',
    },
    15: {
        1: 'E logo ao amanhecer, os chefes dos sacerdotes tiveram uma reunião com os anciãos, com os escribas, e com todo o tribunal; e, amarrando a Jesus, levaram -no e o entregaram a Pilatos.',
        ...
        4: 'E outra vez Pilatos lhe perguntou: Não respondes nada? Olha quantas coisas testemunham contra ti!',
        ...
        8: 'E a multidão, gritando, começou a pedir, como sempre lhes havia feito.',
        ...
        12: 'E Pilatos, respondendo, disse-lhes outra vez: Que, pois, quereis que eu faça com aquele a quem chamais Rei dos Judeus?',
        ...
        23: 'E ofereceram-lhe a beber vinho misturado com mirra; mas ele não o tomou.',
        ...
        39: 'E o centurião que estava ali diante dele, vendo que havia expirado bradando assim, disse: Verdadeiramente este homem era Filho de Deus.',
        ...
        41: 'as quais também, quando ele estava na Galileia, o seguiam, e o serviam; e outras muitas, que haviam subido com ele a Jerusalém.',
