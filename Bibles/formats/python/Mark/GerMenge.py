...
CHAPTERS = {
    ...
    6: {
        ...
        48: 'Als er nun sah, wie sie sich (auf der Fahrt) beim Rudern abmühten – denn der Wind stand ihnen entgegen –, kam er um die vierte Nachtwache auf sie zu, indem er auf dem See dahinging, und wollte an ihnen vorübergehen.',
        ...
        56: 'Und wo er in Dörfern oder Städten oder Gehöften einkehrte, legten sie die Kranken auf den freien Plätzen nieder und baten ihn, daß sie auch nur die Quaste seines Rockes anfassen dürften; und alle, die ihn anfaßten, wurden gesund.',
    },
    7: {
    ...
    8: {
        ...
        4: 'Da erwiderten ihm seine Jünger: »Woher sollte man diese hier in einer so öden Gegend mit Brot sättigen können?«',
        ...
        8: 'So aßen sie denn und wurden satt; dann sammelten sie die übriggebliebenen Stücke, sieben Körbe voll.',
        ...
        14: 'Sie hatten aber vergessen, Brote mitzunehmen, und hatten nur ein einziges Brot bei sich im Boot.',
        ...
        18: 'Ihr habt Augen und seht nicht, habt Ohren und hört nicht? Denkt ihr denn nicht daran:',
        ...
        29: 'Nun fragte er sie weiter: »Ihr aber – für wen haltet ihr mich?« Petrus gab ihm zur Antwort: »Du bist Christus!«',
        ...
        38: 'Denn wer sich meiner und meiner Worte unter diesem ehebrecherischen und sündigen Geschlecht schämt, dessen wird sich auch der Menschensohn schämen, wenn er in der Herrlichkeit seines Vaters mit den heiligen Engeln kommt.«',
    },
    9: {
        ...
        43: 'Und wenn deine Hand dich ärgert, so haue sie ab! Es ist besser für dich, verstümmelt in das Leben einzugehen, als daß du deine beiden Hände hast und in die Hölle kommst, in das unauslöschliche Feuer.',
        45: 'Und wenn dein Fuß dich ärgert, so haue ihn ab! Es ist besser für dich, als Lahmer in das Leben einzugehen, als daß du deine beiden Füße hast und in die Hölle geworfen wirst.',
        47: 'Und wenn dein Auge dich ärgert, so reiße es aus! Es ist besser für dich, einäugig in das Reich Gottes einzugehen, als daß du beide Augen hast und in die Hölle geworfen wirst,',
    ...
    16: {
        ...
        9: 'Nachdem Jesus aber am ersten Tage der Woche frühmorgens auferstanden war, erschien er zuerst der Maria von Magdala, aus der er sieben böse Geister ausgetrieben hatte.',
