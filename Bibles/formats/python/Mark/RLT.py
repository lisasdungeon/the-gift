...
CHAPTERS = {
    ...
    2: {
        ...
        23: 'And it came to pass, that he went through the grainfields on the sabbath day; and his disciples began, as they went, to pluck the heads of grain.',
    ...
    6: {
        ...
        7: 'And he called unto him the twelve, and began to send them forth by two and two; and gave them authority over unclean spirits;',
    ...
    16: {
        ...
        15: 'And he said unto them, Go ye into all the world, and preach the gospel to all creation.',
