...
CHAPTERS = {
    ...
    6: {
        1: 'I wyszedłszy stamtąd, przyszedł w swoje rodzinne strony, a szli za nim jego uczniowie.',
        ...
        20: 'Herod bowiem obawiał się Jana, wiedząc, że jest człowiekiem sprawiedliwym i świętym, i miał wzgląd na niego, a słuchając go, wiele czynił; i chętnie go słuchał.',
    ...
    10: {
        ...
        30: 'A kto by nie otrzymał stokrotnie więcej teraz, w tym czasie, domów, braci, sióstr, matek, dzieci i pól, wśród prześladowań, a w przyszłym świecie życia wiecznego.',
    ...
    16: {
        ...
        8: 'Wyszły więc szybko i uciekły od grobu, bo ogarnął je lęk i zdumienie. Nikomu też nic nie mówiły, ponieważ się bały.',
        9: 'A Jezus, gdy zmartwychwstał wczesnym rankiem pierwszego dnia po szabacie, ukazał się najpierw Marii Magdalenie, z której wypędził siedem demonów.',
