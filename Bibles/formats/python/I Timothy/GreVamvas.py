...
CHAPTERS = {
    ...
    5: {
        ...
        9: 'Ας καταγράφηται χήρα ουχί ολιγώτερον των εξήκοντα ετών, ήτις υπήρξεν ενός ανδρός γυνή,',
        10: 'ήτις μαρτυρείται διά τα καλά αυτής έργα, εάν ανέθρεψε τέκνα, εάν περιέθαλψε ξένους, εάν πόδας αγίων ένιψεν, εάν θλιβομένους εβοήθησεν, εάν επηκολούθησεν εις παν έργον αγαθόν.',
        ...
        16: 'Εάν τις πιστός ή πιστή έχη χήρας, ας προμηθεύη εις αυτάς τα αναγκαία, και ας μη επιβαρύνηται η εκκλησία, διά να δύναται να βοηθή τας αληθώς χήρας.',
