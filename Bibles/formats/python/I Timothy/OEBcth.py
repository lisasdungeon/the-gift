...
CHAPTERS = {
    1: {
        ...
        9: 'by one who recognises that laws were not made for good people, but for the lawless and disorderly, for irreligious and wicked people, for those who are irreverent and profane, for those who ill-treat their fathers or mothers, for murderers,',
        10: 'for the immoral, for perverts, for slave-dealers, for liars, for perjurers, and for whatever else is opposed to sound Christian teaching —',
        ...
        16: 'Yet mercy was shown me for the express purpose that Christ Jesus might exhibit in my case, beyond all others, his exhaustless patience, as an example for those who were afterwards to believe on him and attain eternal life.',
        17: 'To the eternal King, ever-living, invisible, the one God, be ascribed honour and glory for ever and ever. Amen.',
    ...
    3: {
        1: 'How true is this saying: ‘To aspire to be to be a presiding officer in the church is to be ambitious for a noble task.’',
        2: 'The presiding officer should be of blameless character; a faithful partner; living a temperate, discreet, and well-ordered life; hospitable, and a skilful teacher,',
        3: 'not addicted to drink or brawling, but of a forbearing and peaceable disposition, and not a lover of money;',
        4: 'they should provide for own household well, and their children should kept under control and be well-behaved.',
        5: 'If someone does not know how to provide for their own household, how can they take charge of the church of God?',
        6: 'The presiding officer should not be a recent convert, or they might become blinded by pride and fall under the same condemnation as the devil.',
        7: "They should also be well spoken of by outsiders, so that they may not incur censure and so fall into the devil's trap.",
        8: 'So, too, assistant officers should be serious and straightforward, not given to taking much drink or to questionable money-making,',
        ...
        12: 'Assistant officers should be faithful partners who manage their children and their households well.',
    ...
    5: {
        ...
        4: 'but, if a widow has children or grandchildren, let them learn to show proper regard for the members of their own family first, and to make some return to their parents; for that is pleasing in God’s sight.',
        ...
        8: 'Anyone who fails to provide for their own relations, and especially for those under their own roof, has disowned the faith, and is worse than an unbeliever.',
        ...
        22: 'Never ordain anyone hastily, and take no part in the wrong-doing of others. Keep your life pure.',
    ...
    6: {
        ...
        16: 'who alone is possessed of immortality and dwells in unapproachable light, whom no one has ever seen or ever can see — to whom be ascribed honour and power for ever. Amen.',
