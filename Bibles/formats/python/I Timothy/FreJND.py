...
CHAPTERS = {
    1: {
        ...
        3: 'Comme je t’ai prié de rester à Éphèse lorsque j’allais en Macédoine, afin que tu ordonnes à certaines personnes de ne pas enseigner des doctrines étrangères,',
        ...
        16: 'Mais miséricorde m’a été faite, à cause de ceci, [savoir] afin qu’en moi, le premier, Jésus Christ montre toute sa patience, afin que je sois un exemple de ceux qui viendront à croire en lui pour la vie éternelle.',
    ...
    6: {
        ...
        17: 'Ordonne à ceux qui sont riches dans le présent siècle, qu’ils ne soient pas hautains et qu’ils ne mettent pas leur confiance dans l’incertitude des richesses, mais dans le Dieu qui nous donne toutes choses richement pour en jouir;',
