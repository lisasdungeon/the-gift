...
CHAPTERS = {
    1: {
        ...
        13: 'Die te voren een gods lasteraar was, en een vervolger, en een verdrukker; maar mij is barmhartigheid geschied, dewijl ik het onwetende gedaan heb in mijn ongelovigheid.',
        ...
        18: 'Dit gebod beveel ik u, mijn zoon Timotheüs, dat gij naar de profetieën, die van u voorgegaan zijn, in dezelve den goeden strijd strijdt;',
        19: 'Houdende het geloof, en een goed geweten, hetwelk sommigen verstoten hebbende, van het geloof schipbreuk geleden hebben;',
        20: 'Onder welken is Hymeneüs en Alexander, die ik den satan overgegeven heb, opdat zij zouden leren niet meer te lasteren.',
    },
    2: {
    ...
    6: {
        ...
        3: 'Indiën iemand een andere leer leert, en niet overeenkomt met de gezonde woorden van onzen Heere Jezus Christus, en met de leer, die naar de godzaligheid is,',
        ...
        21: 'Dewelke sommigen voorgevende, zijn van het geloof afgeweken. De genade zij met u. Amen. De eerste brief aan Timotheüs werd geschreven uit Laodicea, dat de voornaamste stad in Frygië Pacatania is.',
    },
}
