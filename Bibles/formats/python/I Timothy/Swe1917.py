...
CHAPTERS = {
    ...
    6: {
        ...
        20: 'O Timoteus, bevara vad som har blivit dig betrott; och vänd dig bort ifrån de oandliga, tomma ord och gensägelser som komma från den falskeligen så kallade »kunskapen»[1],',
        21: 'vilken några föregiva sig äga, varför de ock hava farit vilse i fråga om tron. Nåd vare med eder. [1] Se Kunskap i Ordförkl.',
    },
}
