...
CHAPTERS = {
    ...
    2: {
        ...
        18: 'and halewyng, as he bihiyte in the lawe, we hopen that soone he schal haue merci on vs, and schal gadere fro vndur heuene in to the hooli place; for he delyuerede vs fro grete perelis, and purgide the place.',
        19: 'Sotheli of Judas Machabeus, and hise britheren, and of purifiyng of the greet temple, and of halewyng of the auter;',
        20: 'but and of the batels, that perteynen to Antiok noble, and his son Eupator;',
        21: 'and of liytnyngis that weren maad fro heuene, to hem that strongli diden for Jewis, so that, whanne thei weren fewe, thei auengiden al the cuntre, and dryuun an hethene multitude,',
        22: 'and rekyueriden the most famouse temple in al the world; and delyueriden the citee, that and lawis that weren don a wei weren restorid; for the Lord was maad helpful to hem, with al pesiblete.',
        23: 'And also we asaieden for to abregge in o book, thingis comprehendid of Jason of Cirenen in fyue bookis.',
        24: 'Forsothe we bihelden the multitude and hardnesse of bookis, to men willynge for to bigynne the tellyngis of stories, for multitude of thingis;',
        25: 'and sotheli we hadden bisinesse, that it were likyng of soule to men willynge for to rede;',
