...
CHAPTERS = {
    ...
    2: {
        ...
        9: 'Oto podniosę swoją rękę przeciwko nim i staną sią łupem dla swoich sług. I poznacie, że Pan zastępów mnie posłał.',
    ...
    5: {
        ...
        10: 'Wtedym zapytałem tego Anioła, który rozmawiał ze mną: Dokąd niosą tę efę?',
