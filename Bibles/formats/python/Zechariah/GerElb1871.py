...
CHAPTERS = {
    1: {
        ...
        7: 'Am 24. Tage, im elften Monat, das ist der Monat Schebat im zweiten Jahre des Darius, geschah das Wort Jehovas zu Sacharja, dem Sohne Berekjas, des Sohnes Iddos, dem Propheten, also: -',
        8: 'Ich schaute des Nachts, und siehe, ein Mann, reitend auf einem roten Rosse; und er hielt zwischen den Myrten, welche im Talgrunde waren, und hinter ihm waren rote, hellrote und weiße Rosse.',
    ...
    4: {
        ...
        10: 'Denn wer verachtet den Tag kleiner Dinge? Und mit Freuden werden jene Sieben das Senkblei in der Hand Serubbabels sehen: die Augen Jehovas, sie durchlaufen die ganze Erde. -',
        11: 'Und ich hob an und sprach zu ihm: Was sind diese zwei Olivenbäume zur Rechten des Leuchters und zu seiner Linken?',
        12: 'Und ich hob zum zweiten Male an und sprach zu ihm: Was sind die beiden Zweige der Olivenbäume, welche neben den zwei goldenen Röhren sind, die das Gold von sich aus ergießen?',
        13: 'Und er sprach zu mir und sagte: Weißt du nicht, was diese sind? Und ich sprach: Nein, mein Herr.',
        14: 'Da sprach er: Dies sind die beiden Söhne des Öls, welche bei dem Herrn der ganzen Erde stehen.',
    },
    5: {
        1: 'Und ich hob wiederum meine Augen auf und sah: und siehe, eine fliegende Rolle.',
        2: 'Und er sprach zu mir: Was siehst du? Und ich sprach: Ich sehe eine fliegende Rolle, ihre Länge zwanzig Ellen und ihre Breite zehn Ellen.',
        3: 'Und er sprach zu mir: Dies ist der Fluch, welcher über die Fläche des ganzen Landes ausgeht; denn ein jeder, der stiehlt, wird gemäß dem, was auf dieser Seite der Rolle geschrieben ist weggefegt werden; und ein jeder, der falsch schwört, wird gemäß dem, was auf jener Seite der Rolle geschrieben ist, weggefegt werden.',
        4: 'Ich habe ihn ausgehen lassen, spricht Jehova der Heerscharen; und er wird kommen in das Haus des Diebes und in das Haus dessen, der bei meinem Namen falsch schwört; und er wird in seinem Hause herbergen und es vernichten, sowohl sein Gebälk als auch seine Steine. -',
        5: 'Und der Engel, der mit mir redete, trat hervor und sprach zu mir: Hebe doch deine Augen auf und sieh: was ist dieses, das da hervorkommt?',
        6: 'Und ich sprach: Was ist es? Und er sprach: Dies ist ein Epha, das hervorkommt; und er sprach: Solches ist ihr Aussehen im ganzen Lande.',
        7: 'Und siehe, eine Scheibe von Blei wurde aufgehoben; und da war ein Weib, welches inmitten des Ephas saß.',
        8: 'Und er sprach: Dies ist die Gesetzlosigkeit; und er warf sie in das Epha hinein und warf das Bleigewicht auf dessen Mündung.',
        9: 'Und ich hob meine Augen auf und sah: und siehe, da kamen zwei Weiber hervor, und Wind war in ihren Flügeln, und sie hatten Flügel wie die Flügel des Storches; und sie hoben das Epha empor zwischen Erde und Himmel.',
    ...
    6: {
        1: 'Und ich hob wiederum meine Augen auf und sah: und siehe, vier Wagen kamen hervor zwischen zwei Bergen; und die Berge waren Berge von Erz.',
        2: 'An dem ersten Wagen waren rote Rosse, und an dem zweiten Wagen schwarze Rosse;',
        3: 'und an dem dritten Wagen weiße Rosse, und an dem vierten Wagen scheckige, starke Rosse.',
        ...
        10: 'Nimm von den Weggeführten, von Cheldai und von Tobija und von Jedaja, und gehe du an selbigem Tage, gehe in das Haus Josijas, des Sohnes Zephanjas, wohin sie aus Babel gekommen sind-',
        11: 'ja, nimm Silber und Gold und mache eine Krone Und setze sie auf das Haupt Josuas, des Sohnes Jozadaks, des Hohenpriester,',
        12: 'und sprich zu ihm und sage: So spricht Jehova der Heerscharen und sagt: Siehe, ein Mann, sein Name ist Sproß; und er wird von seiner Stelle aufsprossen und den Tempel Jehovas bauen.',
    ...
    9: {
        1: 'Ausspruch des Wortes Jehovas über das Land Chadrak; und auf Damaskus läßt es sich nieder,',
        ...
        5: 'Askelon soll es sehen und sich fürchten; auch Gasa, und soll sehr erzittern, und Ekron, denn seine Zuversicht ist zu Schanden geworden. Und der König wird auf Gasa vertilgt, und Askelon wird nicht mehr bewohnt werden.',
    ...
    10: {
        ...
        11: 'Und er wird durch das Meer der Angst ziehen und die Wellen im Meere schlagen, und alle Tiefen des Stromes werden versiegen; und die Hoffart Assyriens wird niedergeworfen werden, und weichen wird das Scepter Ägyptens.',
        12: 'Und ich werde sie stark machen in Jehova, und in seinem Namen werden sie wandeln, spricht Jehova.',
    },
    11: {
        1: 'Tue auf, Libanon, deine Tore, und Feuer verzehre deine Cedern!',
        2: 'Heule, Cypresse! denn die Ceder ist gefallen, denn die Herrlichen sind verwüstet. Heulet, Eichen Basans! denn der unzugängliche Wald ist niedergestreckt.',
    ...
    13: {
        1: 'An jenem Tage wird ein Quell geöffnet sein dem Hause Davids und den Bewohnern von Jerusalem für Sünde und für Unreinigkeit.',
        ...
        7: 'Schwert, erwache wider meinen Hirten und wider den Mann, der mein Genosse ist! spricht Jehova der Heerscharen; schlage den Hirten, und die Herde wird sich zerstreuen. Und ich werde meine Hand den Kleinen zuwenden.',
    ...
    14: {
        ...
        7: 'Und es wird ein einziger Tag sein, nicht Tag und nicht Nacht; und es wird geschehen zur Zeit des Abends, da wird es Licht sein',
