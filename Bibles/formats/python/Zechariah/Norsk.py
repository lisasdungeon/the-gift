...
CHAPTERS = {
    ...
    5: {
        1: 'Så løftet jeg atter mine øine op og fikk se en flyvende bokrull.',
        ...
        6: 'Jeg spurte: Hvad er det? Han svarte: Det er en efa som kommer frem der. Og han sa: Således skal det se ut med dem i hele landet.',
        7: 'Da blev et blylokk løftet op, og det viste sig en kvinne som satt i efaen.',
    ...
    6: {
        ...
        7: 'Og de sterkeste drog ut, og da de ønsket å få dra omkring på jorden, sa han: Gå, dra omkring på jorden! Og de drog omkring på jorden.',
