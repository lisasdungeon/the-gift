...
CHAPTERS = {
    ...
    4: {
        ...
        10: 'Pois quem despreza o dia das pequenas coisas? Pois esses sete olhos se alegrarão ao verem o prumo na mão de Zorobabel (esses são os olhos do SENHOR, que passam por toda a terra).',
    ...
    6: {
        ...
        12: 'E fala com ele, dizendo: Assim diz o SENHOR dos exércitos: Eis aqui o homem cujo nome é Renovo; ele brotará de seu lugar, e edificará o templo do SENHOR;',
        13: 'Ele mesmo edificará o templo do SENHOR, e levará sobre si majestade; e se sentará e dominará em seu trono, e será sacerdote em seu trono; e haverá conselho de paz entre ambos.',
        14: 'E as coroas serão para Helem, Tobias, e Jedaías, e Hem, filho de Sofonias, como memorial no templo do SENHOR.',
        15: 'E os que estão longe virão e participarão da construção do templo do SENHOR, e vós sabereis que o SENHOR dos exércitos me enviou a vós. Isto acontecerá se verdadeiramente ouvirdes à voz do SENHOR vosso Deus.',
    },
    7: {
