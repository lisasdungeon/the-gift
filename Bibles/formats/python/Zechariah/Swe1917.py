...
CHAPTERS = {
    ...
    3: {
        1: 'Sedan lät han mig se översteprästen Josua stående inför HERRENS ängel; och Åklagaren[1] stod vid hans högra sida för att anklaga honom.',
        ...
        10: 'På den tiden, säger HERREN Sebaot, skall var och en av eder kunna inbjuda den andre till gäst under sitt vinträd och fikonträd.» [1] Se Djävul i Ordförkl.',
    },
    4: {
