...
CHAPTERS = {
    1: {
        ...
        8: 'while of the Son he said — ‘God is your throne for ever and ever; The sceptre of his kingdom is the sceptre of Justice;',
    ...
    8: {
        ...
        2: 'where he ministers in the sanctuary, in that true tent set up by the Lord and not by man.',
    ...
    9: {
        ...
        15: 'And that is why he is the intermediary of a new covenant; in order that, as a death has taken place to effect a deliverance from the offences committed under the first covenant, those who have received the call may obtain the eternal inheritance promised to them.',
