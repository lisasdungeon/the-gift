...
CHAPTERS = {
    ...
    7: {
        ...
        21: 'celui-ci l\'a été avec serment par celui qui lui a dit: " Le Seigneur l\'a juré, et il ne s\'en repentira pas: Tu es prêtre pour toujours selon l\'ordre de Melchisédech ", —',
    ...
    9: {
        ...
        2: 'En effet, on a construit un tabernacle, avec une partie antérieure, appelée le lieu saint, où étaient le chandelier, la table et les pains de proposition.',
        3: 'Derrière le second voile, se trouvait la partie du tabernacle appelée le Saint des Saints,',
        4: "ayant un autel d'or pour les parfums et l'arche de l'alliance toute recouverte d'or. Dans l'arche se trouvait une urne d'or renfermant la manne, la verge d'Aaron qui avait fleuri, et les tables de l'alliance.",
        ...
        19: "Moïse, après avoir proclamé devant tout le peuple tous les commandements selon la teneur de la Loi, prit le sang des taureaux et des boucs, avec de l'eau, de la laine écarlate et de l'hysope, et il fit l'aspersion sur le Livre lui-même et sur tout le peuple,",
    ...
    12: {
        ...
        2: 'les yeux fixés sur Jésus, l\'auteur et le consommateur de la foi, lui qui, au lieu de la joie qu\'il avait devant lui, méprisant l\'ignominie, a souffert la croix, et " s\'est assis à la droite du trône de Dieu ".',
        ...
        6: 'car le Seigneur châtie celui qu\'il aime, et il frappe de la verge tout fils qu\'il reconnaît pour sien. "',
        7: "C'est pour votre instruction que vous êtes éprouvés: Dieu vous traite comme des fils; car quel est le fils que son père ne châtie pas?",
        ...
        21: 'Et ce spectacle était si terrible que Moïse dit: " Je suis terrifié et tout tremblant! " —',
        22: 'Mais vous vous êtes approchés de la montagne de Sion, de la cité du Dieu vivant qui est la Jérusalem céleste, des myriades qui forment le chœur des anges,',
    ...
    13: {
        ...
        24: "Saluez tous ceux qui vous conduisent et tous les saints. Les frères d'Italie vous saluent. Que la grâce soit avec vous tous! Amen!",
    },
}
