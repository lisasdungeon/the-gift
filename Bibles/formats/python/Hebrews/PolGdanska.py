...
CHAPTERS = {
    ...
    5: {
        ...
        6: 'Jako i na inszem miejscu mówi: Tyś jest kapłanem na wieki według porządku Melchisedekowego.',
    ...
    6: {
        ...
        20: 'Gdzie przewodnik dla nas wszedł, Jezus, stawszy się według porządku Melchisedekowego najwyższym kapłanem na wieki.',
    },
    7: {
    ...
    13: {
        ...
        20: 'A Bóg pokoju, który wywiódł od umarłych we krwi przymierza wiecznego, onego wielkiego pasterza owiec, Pana naszego Jezusa,',
        21: 'Niech was doskonałymi uczyni w każdym uczynku dobrym ku czynieniu woli swojej, sprawując w was to, co przyjemnego przed obliczem jego, przez Jezusa Chrystusa, któremu niech będzie chwała na wieki wieków. Amen.',
