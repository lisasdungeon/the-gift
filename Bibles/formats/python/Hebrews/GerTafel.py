...
CHAPTERS = {
    1: {
        ...
        2: 'So hat Er in den letzten Tagen zu uns geredet durch den Sohn, Den Er zum Erben über alles gesetzt, durch Den Er auch die Welten erschaffen hat,',
        ...
        8: 'Vom Sohn aber: Gott, Dein Thron währt in Zeit und Ewigkeit, das Zepter Deines Reiches ist ein Zepter der Geradheit.',
    ...
    5: {
        ...
        9: 'Und da Er ist vollendet, ist Er allen, die Ihm gehorsam sind, Urheber ewiger Seligkeit geworden,',
    ...
    6: {
        1: 'Darum wollen wir die Anfangslehre von Christus beiseite lassen, und uns zum Vollkommeneren wenden, ohne uns noch einmal mit der Grundlage der Bekehrung von toten Werken, dem Glauben an Gott,',
        2: 'Der Taufe, der Lehre, der Auflegung der Hände, der Auferstehung der Toten und dem ewigen Gerichte zu befassen.',
        3: 'Und das wollen wir tun, wenn anders Gott es uns verleiht.',
        4: 'Denn es ist unmöglich, die, so einmal erleuchtet worden und die himmlische Gabe geschmeckt haben, und des Heiligen Geistes teilhaftig geworden sind,',
        5: 'Zudem noch geschmeckt haben das herrliche Gotteswort, die Kräfte der zukünftigen Welt,',
        6: 'Wo sie wiederum abgefallen, zu erneuern zur Buße, als die in ihnen selbst den Sohn Gottes kreuzigen und zum Gespötte haben.',
        7: 'Denn eine Erde, die den oft über sie kommenden Regen trinkt, und denen, für die sie auch bebaut wird, nützliche Gewächse trägt, empfängt Segen von Gott.',
        8: 'Die aber, so Dornen und Disteln trägt, ist unnütz und dem Fluche nahe; ihr Ende ist, daß man sie ausbrennt.',
        9: 'Wir versehen uns aber zu euch, Geliebte, eines Besseren, und das zum Heile führt, obwohl wir also reden.',
        10: 'Denn Gott ist nicht ungerecht, daß Er vergäße eures Werkes und eurer Liebtätigkeit, die ihr an Seinem Namen bewiesen, da ihr den Heiligen Dienst geleistet habt, und noch leistet.',
        11: 'Wir wünschten aber, daß jeder von euch denselben Eifer beweise, die Hoffnung bis ans Ende voll zu bewahren.',
        12: 'Daß ihr nicht müde werdet, sondern nacheifert im Glauben und in der Ausdauer denen, so die Verheißung ererben.',
        13: 'Denn als Gott dem Abraham eine Verheißung machte, schwur Er, da Er bei nichts Höherem schwören konnte, bei Sich Selbst,',
        14: 'Und sprach: Wahrlich, Ich will dich reichlich segnen und vermehren.',
        15: 'Und so harrte er aus, und erlangte, was ihm verheißen war.',
        16: 'Die Menschen schwören bei dem Höheren, und der Eid macht bei ihnen allem Streit ein Ende durch diese Bekräftigung.',
        17: 'Darum, da Gott wollte den Erben der Verheißung die Unwandelbarkeit Seines Ratschlusses dartun, hat Er ihn durch einen Eid vermittelt.',
        18: 'Auf daß zwei unwandelbare Stücke, bei denen nicht möglich ist, daß Gott lügen könnte, einen starken Trost gewähren uns, die wir unsere Zuflucht nehmen zu der uns gewährten Hoffnung, und an ihr halten;',
        19: 'Die wir haben als sicheren und zuverlässigen Anker der Seele, der auch hineinreicht in das Inwendige des Vorhangs;',
        20: 'Dahin auch unser Vorgänger Jesus für uns eingegangen, Der nach der Ordnung Melchisedeks Hoherpriester in Ewigkeit geworden ist.',
    },
    7: {
        ...
        21: 'Er aber mit einem Eidschwur durch Den, Der da zu Ihm spricht: Der Herr hat geschworen, und es wird Ihn nicht gereuen: Du bist Priester in Ewigkeit nach der Ordnung Mel- chisedeks],',
        ...
        24: 'Er aber hat dadurch, daß Er es in Ewigkeit bleibt, ein unvergängliches Priestertum.',
        ...
        28: 'Denn das Gesetz bestellt Menschen zu Hohenpriestern, die Schwachheit an sich haben, das Wort aber der eidlichen Verhei-ßung, die später als das Gesetz gemacht wurde, den Sohn, Der ewiglich vollendet ist.',
    },
    8: {
        1: 'Der Inbegriff dieser Reden aber ist: Wir haben einen solchen Hohenpriester, Der da sitzt zur Rechten auf dem Throne der Majestät in den Himmeln;',
        2: 'Als Priester des Heiligen und des wahren Versammlungszeltes, welches der Herr und nicht ein Mensch aufgerichtet hat.',
        3: 'Denn jeglicher Hohepriester wird eingesetzt, Gaben und Opfer darzubringen. Darum muß auch Er etwas haben darzubringen.',
        4: 'Denn wenn Er auf Erden wäre, so wäre Er nicht einmal Priester, weil Priester da sind, die nach dem Gesetz die Gaben opfern,',
        5: 'Die ihr Amt tun nach dem Vorbild und Schatten der himmlischen Dinge, wie Moses angewiesen worden, da er das Zelt aufrichten sollte: Siehe zu, heißt es, daß du alles nach dem Vorbilde machst, das dir auf dem Berge gezeigt worden ist.',
    ...
    9: {
        ...
        12: 'Ist auch nicht durch das Blut von Böcken und Kälbern, sondern durch Sein eigen Blut ein- für allemal eingetreten in das Heiligtum und hat ewige Erlösung zuwege gebracht.',
        ...
        26: 'Sonst hätte Er seit Anfang der Welt oft Leiden müssen; nun aber ist Er bei Vollendung der Zeitläufe einmal zur Erlassung der Sünde durch Sein Opfer offenbar worden.',
    ...
    10: {
        ...
        5: 'Darum spricht Er, wie Er in die Welt kommt: Opfer und Gabe hast Du nicht gewollt, den Leib aber hast Du Mir zubereitet.',
        6: 'An Brandopfern aber und Sündopfern hast Du kein Gefallen.',
        7: 'Da sprach Ich: Siehe, Ich komme - im Buche steht von Mir geschrieben - Deinen Willen, o Gott, zu tun.',
        8: 'Zuvor hatte Er gesagt: Opfer und Gabe, und Brandopfer und Sündopfer hast Du nicht gewollt, noch hast Du Gefallen daran',
        9: 'Dann sprach Er: Siehe, Ich komme, o Gott, Deinen Willen zu tun. Er hebt das erste auf, um das andere einzusetzen.',
        10: 'Durch diesen Willen sind wir geheiligt, durch das einmalige Opfer des Leibes Jesu Christi.',
        11: 'Und jeglicher Priester steht täglich da, verrichtet seinen Dienst und bringt wiederholt dieselben Opfer dar, die doch nimmermehr Sünden wegnehmen können.',
        12: 'Er aber, der ein Opfer für die Sünden dargebracht, sitzt für immer zur Rechten Gottes.',
        13: 'Und wartet hinfort, bis Seine Feinde zum Schemel Seiner Füße gelegt sind.',
        14: 'Denn mit einem Opfer hat Er für immer zur Vollendung geführt, die da geheiligt werden.',
        15: 'Es zeugt für uns aber auch der Heilige Geist; denn, nachdem Er vorhergesagt hatte:',
        16: 'Das ist der Bund, den Ich nach diesen Tagen mit ihnen schließen werde, spricht der Herr: Ich gebe Meine Gesetze in ihre Herzen, und will sie in ihre Gedanken schreiben.',
        17: 'Und ihrer Sünden und Übertretungen will Ich nicht mehr gedenken.',
        18: 'Wo aber derselben Vergebung ist, da ist kein Opfer für die Sünde mehr.',
        19: 'Weil wir denn, Brüder, die Freiheit des Eintritts in das Heiligtum durch Jesu Blut haben,',
        20: 'Den Er für uns eingeweiht hat, als einen neuen, zum Leben führenden Weg, durch den Vorhang, das heißt durch Sein Fleisch hindurch,',
        21: 'Und haben einen Hohenpriester über das Haus Gottes,',
        22: 'So lasset uns hinzutreten mit wahrhaftigem Herzen und völligem Glauben, da wir am Herzen besprengt',
        ...
        26: 'Denn so wir vorsätzlich sündigen, nachdem wir zur Erkenntnis der Wahrheit gekommen sind, ist kein anderes Opfer mehr für Sünden zu erwarten.',
        27: 'Wohl aber droht ein schreckliches Gericht und ein eiferndes Feuer, das die Widerwärtigen verzehren wird.',
        28: 'Wer Moses Gesetz übertreten, muß ohne Erbarmen auf die Aussage zweier oder dreier Zeugen des Todes sterben.',
        29: 'Wieviel ärgere Strafe meint ihr, wird der zu erleiden haben, der den Sohn Gottes mit Füßen tritt, und das Blut des neuen Bundes, wodurch er geheiligt worden, entheiligt, und den Geist der Gnade lästert?',
        30: 'Wir kennen ja Den, Welcher spricht: Mein ist die Rache, Ich will vergelten, spricht der Herr - und abermals: Der Herr wird richten Sein Volk.',
        31: 'Schrecklich ist es, in die Hände des lebendigen Gottes zu fallen.',
        32: 'Gedenkt aber an die vorigen Tage, in denen ihr nach der Erleuchtung einen großen Leidenskampf bestanden habt;',
        33: 'Indem ihr teils in Zuständen der Schmach und der Drangsale zur Schau gestellt wurdet, teils an anderen, die solches erlitten, Anteil nahmt.',
        34: 'Denn ihr hattet Anteil genommen an den Gefangenen, und den Raub eurer Güter frohen Mutes ertragen, als die da wußten, daß sie in sich selbst ein besseres, bleibendes Gut in den Himmeln haben.',
        35: 'So werfet nun euer Vertrauen nicht weg, das eine große Belohnung hat.',
        36: 'Denn Geduld ist euch Not, auf daß ihr den Willen Gottes tut und die Verheißung empfanget.',
    ...
    11: {
        1: 'Es ist aber der Glaube eine Zuversicht dessen, das man hofft, eine Überzeugung von Dingen, die man nicht sieht.',
        2: 'Durch ihn haben die Alten Zeugnis erhalten.',
        ...
        4: 'Durch den Glauben hat Abel Gott ein größeres Opfer dargebracht denn Kain, durch den bezeugt wurde, daß er gerecht war, da Gott über seine Opfergaben zeugte, und durch ihn redet Er noch jetzt nach seinem Tod.',
        5: 'Durch den Glauben ward Enoch entrückt, auf daß er den Tod nicht sähe, und ward nicht erfunden, darum, daß ihn Gott entrückt hatte; denn vor seiner Entrückung ist bezeugt, daß er Gott wohlgefällig war.',
        ...
        7: 'Durch den Glauben hat Noach, über das noch Unsichtbare belehrt, sich vorgesehen, und die Arche zur Rettung seines Hauses zubereitet, und durch ihn verdammte er die Welt, und er ward nach seinem Glauben der Gerechtigkeit teilhaftig.',
        8: 'Durch den Glauben gehorchte Abraham, da er berufen ward auszuziehen in das Land, das er als Erbe überkommen sollte, und er zog aus und wußte nicht, wohin er käme.',
        9: 'Durch den Glauben lebte er als Fremdling in dem Lande der Verheißung, und wohnte mit Isaak und Jakob, den Miterben derselben Verheißung.',
        10: 'Denn er wartete auf jene festgegründete Stadt, deren Baumeister und Schöpfer Gott ist.',
        11: 'Durch den Glauben erhielt selbst Sarah Kraft zur Empfängnis, und über ihr Alter hinaus gebar sie, weil sie Ihn, Der es verhei-ßen, für wahrhaftig hielt.',
        12: 'Darum sind auch von einem, der schon abgelebt, so viele entsprossen wie die Sterne am Himmel und wie der Sand am Rande des Meeres, der nicht zu zählen ist.',
        13: 'Diese alle sind gestorben im Glauben, ehe sie die Verheißungen empfangen; sie schauten sie aber von ferne, und begnügten sich dabei und bekannten, daß sie Fremdlinge und Beisaßen im Lande wären.',
        14: 'Denn die solches sprachen, gaben zu verstehen, daß sie ein Vaterland suchen;',
        15: 'Und hätten sie das gemeint, von dem sie ausgezogen waren, so hätten sie ja Zeit gehabt, wieder umzukehren.',
        ...
        17: 'Durch Glauben hat Abraham, da er versucht ward, den Isaak dargebracht, und wollte den Eingeborenen hingeben, er, der schon die Verheißungen empfangen hatte;',
        18: 'Von dem gesagt war: Nach Isaak soll dir der Same genannt werden;',
        19: 'Indem er dachte, daß Gott auch von den Toten erwecken könnte, weshalb er ihn, eben weil er ihn hingegeben hatte, wieder erhielt.',
        20: 'Durch den Glauben erteilte Isaak im Hinblick auf die Zukunft seinen Segen an Jakob und Esau.',
        21: 'Durch den Glauben segnete Jakob auf dem Totenbett die beiden Söhne Josephs und betete sodann, auf die Spitze seines Stabes gelehnt.',
        22: 'Durch den Glauben gedachte Joseph, da er starb des Auszugs der Söhne Israels, und gab Befehl über seine Gebeine.',
        23: 'Durch den Glauben ward Moses, da er geboren ward, von seinen Eltern drei Monate lang verborgen gehalten, als sie sahen, daß er ein so anmutiges Kindlein war; und sie fürchteten sich nicht vor dem Befehle des Königs.',
        24: 'Durch den Glauben weigerte sich Moses, ein Sohn der Tochter Pharaos zu heißen.',
        25: 'Und wollte lieber mit dem Volk Gottes Ungemach erdulden, als den zeitlichen Genuß der Sünde haben;',
        26: 'Und achtete höher denn die Schätze Ägyptens Christi Schmach, denn er sah an die Belohnung.',
        27: 'Durch den Glauben verließ er Ägypten, und fürchtete nicht den Zorn des Königs; denn er hielt fest an dem Unsichtbaren, als sähe er Ihn.',
        28: 'Im Glauben hat er das Paschah und die Besprengung des Blutes angeordnet, auf daß nicht der Würger der Erstgeburten sie antastete.',
        29: 'Im Glauben gingen sie durch das Rote Meer, wie über trockenes Land, und die Ägypter versuchten es auch und wurden verschlungen.',
        30: 'Durch den Glauben fielen die Mauern Jerichos, nachdem man sieben Tage um selbige gezogen war.',
        31: 'Durch den Glauben kam die Hure Rahab nicht um mit den Ungläubigen, weil sie die Kundschafter friedlich aufgenommen hatte.',
        32: 'Und was soll ich weiter sagen? Die Zeit würde mir zu kurz, wenn ich von Gideon und Barak und Simson und Jephtha und David und Samuel und den Propheten erzählen sollte;',
        33: 'Welche durch den Glauben Königreiche bezwangen, Gerechtigkeit übten, Verheißungen erlangten, Löwen den Rachen verstopften,',
        34: 'Des Feuers Gewalt auslöschten, der Schärfe des Schwertes entrannen, in Zuständen der Schwäche gekräftigt, zum Streite gestärkt wurden, die Heere der Feinde niederschlugen.',
        35: 'Weiber haben durch Auferstehung ihre Toten wieder erhalten, andere wurden auf die Folter gespannt, indem sie keine Freilassung annahmen, auf daß sie die bessere Auferstehung empfingen.',
        36: 'Andere erduldeten Verhöhnungen und Geißelung, dazu Bande und Gefängnis;',
        37: 'Sie wurden gesteinigt, zersägt, zerstochen, fielen durch das Schwert, gingen in Schafpelzen, in Ziegenfellen umher, hatten mit Mangel, Trübsal und Ungemach zu kämpfen.',
        38: 'Sie, deren die Welt nicht wert war, sind in Wüsten, auf Bergen, in Höhlen und Klüften der Erde umhergeirrt.',
        39: 'Und diese alle haben sich durch Glauben bewährt und trugen die Verheißung nicht davon.',
        40: 'Darum, daß für uns Gott Besseres zuvor vorgesehen hat, auf daß sie nicht ohne uns zur Vollendung gelangten.',
    },
    12: {
        1: 'Darum lasset uns, weil wir eine solche Menge Zeugen vor uns haben, ablegen jegliche Bürde und Sünde, die uns so leicht gefangen hält, und mit Beharrlichkeit den uns verordneten Wettlauf beginnen;',
        ...
        3: 'Gedenkt an Ihn, Der solchen Widerspruch von den Sündern wider Sich erduldet hat, auf daß ihr den Mut nicht sinken lasset und verzagt,',
        4: 'Denn ihr habt im Kampfe wider die Sünde noch nicht bis auf das Blut widerstanden.',
        5: 'Und ihr habt bereits die Ermahnung vergessen, die zu euch als Kindern spricht: Mein Sohn, achte nicht gering die Züchtigung des Herrn, und verzage nicht, wenn du von Ihm gestraft wirst.',
        6: 'Denn welchen der Herr lieb hat, den züchtigt Er, und gibt Streiche jeglichem Sohn, den Er aufnimmt.',
        7: 'So ihr nun in der Züchtigung ausharrt, so verfährt Gott mit euch als mit Söhnen; denn wo ist ein Sohn, den der Vater nicht züchtigt?',
        8: 'So ihr aber ohne Züchtigung bleibt, deren alle teilhaftig werden, so seid ihr Bastarde und keine Söhne.',
        9: 'Wir hatten nun unsere leiblichen Väter zu Züchtigern und scheuten uns vor ihnen; wollten wir da nicht viel mehr dem Vater der Geister untertan sein, auf daß wir das Leben haben?',
        10: 'Jene züchtigen uns nach Gutdünken eine kurze Zeit, Er aber zu unserem Besten, auf daß wir Teil hätten an Seiner Heiligung.',
        ...
        12: 'Darum richtet wieder auf die lässigen Hände und die erschlafften Knie.',
        13: 'Und macht gerade Bahn euren Füßen, auf daß nicht, was lahm ist, ausgereckt werde, sondern zurechtkomme.',
        14: 'Strebt nach Frieden mit allen, und nach der Heiligung, ohne die niemand den Herrn schauen wird.',
        15: 'Und seht darauf, daß nicht einer hinter der Gnade Gottes zurückbleibe, auf daß keine Wurzel der Bitterkeit aufsprosse und Unfrieden anrichte und viele von ihr angesteckt werden.',
        16: 'Daß keiner sei ein Hurer, oder ein Unheiliger wie Esau, der für eine Speise seine Erstgeburt hingab.',
        17: 'Ihr wißt ja, daß er auch hernach, als er den Segen zu erlangen wünschte, verworfen ward; denn er fand keinen Raum zur Buße, wiewohl er mit Tränen nach ihr verlangte.',
        18: 'Denn ihr seid nicht hinzugetreten zu einem Berge, den man antasten kann und der mit Feuer brennt, noch zu dem Dunkel und der Finsternis und dem Ungewitter,',
        19: 'Noch zu dem Hall der Posaune und zur Stimme der Worte, deren Hörer sich verbaten, daß weiter zu ihnen geredet werde.',
        20: 'Denn sie vermochten nicht zu ertragen, was da verordnet wurde. Und wenn ein Tier den Berg anrührte, sollte es gesteinigt oder mit eine Geschoß getötet werden.',
        21: 'Und so furchtbar war die Erscheinung, daß Moses sprach: Ich bin voll Furcht und Zitterns.',
        ...
        25: 'Sehet zu, daß ihr euch nicht weigert, Den zu hören, Der jetzt zu euch redet; denn wenn jene nicht entrannen, die den auf Erden Redenden nicht hören wollten, so werdet ihr noch viel weniger entrinnen, wenn ihr euch von Dem abwendet, Der vom Himmel aus zu euch spricht,',
        26: 'Dessen Stimme damals die Erde bewegte, jetzt aber hat Er verheißen: Noch einmal bewege Ich nicht allein die Erde, sondern auch den Himmel.',
        27: 'Dies noch einmal aber bedeutet die Veränderung dessen, was erschüttert wird, als etwas, das vor sich geht, auf daß Bestand habe das, was nicht bewegt wird.',
        28: 'Darum lasset uns, weil wir ein unerschütterliches Reich empfangen, damit unseren Dank beweisen, daß wir mit Zucht und Ehrfurcht Gott wohlgefällig dienen.',
    ...
    13: {
        ...
        20: 'Der Gott des Friedens aber, Der von den Toten heraufgeführt hat den großen Hirten der Schafe durch das Blut des ewigen Bundes, unseren Herrn Jesus,',
        21: 'Der mache euch fertig in jeglichem guten Werk, zu tun Seinen Willen, und schaffe in euch, was vor Ihm wohlgefällig ist, durch Jesus Christus, Welchem sei Ehre in alle Ewigkeit! Amen.',
