...
CHAPTERS = {
    ...
    6: {
        1: 'C’est pourquoi laissant la parole qui n’enseigne que les premiers principes du Christianisme, tendons à la perfection, et ne nous arrêtons pas à jeter tout de nouveau le fondement de la repentance des oeuvres mortes, et de la foi en Dieu;',
    ...
    10: {
        ...
        7: 'Alors j’ai dit: me voic1, je viens, il est écrit de moi au commencement du Livre: que je fasse, ô Dieu ta volonté.',
    ...
    13: {
        1: 'Que la charité fraternelle demeure dans vos coeurs.',
        ...
        5: 'Que vos moeurs soient sans avarice, étant contents de ce que vous avez présentement; car lui-même a dit: je ne te laisserai point, et je ne t’abandonnerai point.',
        ...
        8: 'Jésus-Christ a été le même hier et aujourd’hu1, et il l’est aussi éternellement.',
        9: 'Ne soyez point emportés çà et là par des doctrines diverses et étrangères; car il est bon que le coeur soit affermi par la grâce, et non point par les viandes, lesquelles n’ont de rien profité à ceux qui s’y sont attachés.',
