...
CHAPTERS = {
    ...
    3: {
        ...
        11: 'Zo heb Ik dan gezworen in Mijn toorn; Indiën zij in Mijn rust zullen ingaan!',
    ...
    4: {
        ...
        3: 'Want wij, die geloofd hebben, gaan in de rust, gelijk Hij gezegd heeft: Zo heb Ik dan gezworen in Mijn toorn: Indiën zij zullen ingaan in Mijn rust! hoewel Zijn werken van de grondlegging der wereld af al volbracht waren.',
        4: 'Want Hij heeft ergens van den zevenden dag aldus gesproken: En God heeft op den zevenden dag van al Zijn werken gerust.',
        5: 'En in deze plaats wederom: Indiën zij in Mijn rust zullen ingaan!',
    ...
    7: {
        ...
        11: 'Indiën dan nu de volkomenheid door het Levietische priesterschap ware (want onder hetzelve heeft het volk de wet ontvangen), wat nood was het nog, dat een ander priester naar de ordening van Melchizedek zou opstaan, en die niet zou gezegd worden te zijn naar de ordening van Aäron?',
    ...
    12: {
        ...
        7: 'Indiën gij de kastijding verdraagt, zo gedraagt Zich God jegens u als zonen; (want wat zoon is er, dien de vader niet kastijdt?)',
    ...
    13: {
        ...
        24: 'Groet al uw voorgangeren, en al de heiligen. U groeten die van Italië zijn.',
        25: 'De genade zij met u allen. Amen. Uit Italië geschreven aan de Hebreeën door Timotheüs.',
    },
}
