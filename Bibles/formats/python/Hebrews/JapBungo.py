...
CHAPTERS = {
    ...
    6: {
        ...
        20: 'イエス我等のために前驅し、永遠にメルキゼデクの位に等しき大 祭司となりて、その處に入り給へり。',
    },
    7: {
        ...
        28: '律法は弱みある人々を立てて大 祭司とすれども、律法の後なる誓の御言は、永遠に全うせられ給へる御子を大 祭司となせり。',
    },
    8: {
    ...
    13: {
        ...
        21: 'その悦びたまふ所を、イエス・キリストに由りて我らの衷に行ひ、御意を行はしめん爲に凡ての善き事につきて、汝らを全うし給はんことを。世々 限りなく榮光、かれに在れ、アァメン。',
