...
CHAPTERS = {
    ...
    3: {
        ...
        14: 'Kääntykäät, te vastahakoiset lapset, sanoo Herra; sillä minä kihlaan teidät minulleni, ja otan teidät yhden kaupungista ja kaksi koko sukukunnasta, ja tahdon teidät viedä Zioniin.',
        15: 'Ja annan teille paimenet minun sydämeni jälkeen, jotka teitä pitää ravitseman opilla ja viisaudella.',
        16: 'Ja se on silloin tapahtuva, kuin te moneksi tulette ja kasvatte maassa, ettei siihen aikaan, sanoo Herra, pidä enään puhuttaman Herran liitonarkista, eikä ajateltaman, ei myös sitä enään muistettaman, eli etsittämän, taikka enään tehtämän.',
        17: 'Mutta Jerusalem pitää siihen aikaan kutsuttaman Herran istuimeksi, ja kaikki pakanat pitää sinne kokoontuman Herran nimeen Jerusalemiin: eikä heidän pidä enää vaeltaman pahan sydämensä ajatusten jälkeen.',
        18: 'Siihen aikaan pitää Juudan huoneen menemän Israelin huoneen tykö, ja pitää ynnä tuleman pohjan puoliselta maalta siihen maahan, jonka minä olen antanut teidän isillenne perinnöksi.',
        19: 'Ja minä sanon: kuinka minä olen monta lasta antava sinulle, ja sen hyvän maan ja ihanaisen perinnön, pakanain joukon. Ja minä sanon: sinä olet kutsuva minun Isäkses, etkä luovu minusta.',
        20: 'Kuitenkin, niinkuin vaimo pettää rakastajansa, niin olette te minusta luopuneet, te Israelin huone, sanoo Herra.',
        ...
        22: 'Niin palatkaat, te vastahakoiset lapset niin minä parannan teitä teidän tottelemattomuudestanne. Katso, me tulemme sinun tykös; sillä sinä olet Herra meidän Jumalamme.',
        23: 'Totisesti on sula petos kukkuloilla ja kaikilla vuorilla: totisesti on Israelin autuus (ainoassa) Herrassa meidän Jumalassamme.',
        24: 'Ja meidän isäimme asetukset, jotka me nuoruudesta olemme pitäneet, pitää häpiällä käymän pois, ynnä heidän lammastensa, karjansa, poikainsa ja tytärtensä kanssa.',
        25: 'Meidän täytyy maata häpiässämme, ja meidän ylönkatseemme peittää meidät; sillä me teimme syntiä Herraa meidän Jumalaamme vastaan, sekä me että meidän isämme, meidän hamasta nuoruudestamme niin tähän päivään asti, ja emme totelleet Herran meidän Jumalamme ääntä.',
    },
    4: {
    ...
    5: {
        ...
        27: 'Ja heidän huoneensa on täynnä petosta, niinkuin häkki lintuja; siitä he tulevat väkeviksi ja rikkaiksi.',
    ...
    16: {
        1: 'Ja Herran sana tapahtui minulle ja sanoi:',
        2: 'Ei sinun pidä ottaman itselles vaimoa, eikä siittämän poikia eli tyttäriä tässä paikassa.',
        3: 'Sillä näin sanoo Herra niistä pojista ja tyttäristä, jotka tässä paikassa syntyvät, ja äideistä, jotka heitä synnyttävät, ja heidän isistänsä, jotka heitä tässä maassa siittävät:',
        4: 'Heidän pitää kuoleman sairaudessansa, ja ei heitä pidä itkettämän eli haudattaman, vaan heidän pitää loaksi kedolle tuleman; ja heidän pitää vielä sitte miekalla ja nälällä hukkuman, ja heidän ruumiinsa pitää linnuille taivaan alla ja eläimille maassa ruaksi tuleman.',
        5: 'Sillä näin sanoo Herra: ei sinun pidä menemän murhehuoneesen, eikä menemän itkemään eli surkuttelemaan heitä; sillä minä olen ottanut pois minun rauhani tältä kansalta, sanoo Herra, ja minun armoni ja laupiuteni;',
        6: 'Että sekä suuret että pienet pitää tässä maassa kuoleman, ja ei haudatuksi tuleman, ja ei yhdenkään pidä itkemän eli repimän itsiänsä, eikä ajeleman hiuksiansa heidän tähtensä.',
        7: 'Ja ei myös pidä (leipää) jaettaman murheessa, että heitä lohdutettaisiin kuolleen tähden, eikä pidä annettaman juoda lohdutusmaljasta isänsä tähden ja äitinsä tähden.',
        8: 'Ja ei pidä sinun menemän pitohuoneesen, istumaan heidän viereensä, syömään ja juomaan.',
        9: 'Sillä näin sanoo Herra Zebaot, Israelin Jumala: katso, minä tahdon ottaa pois tästä siasta, teidän silmäinne edestä ja teidän eläissänne, ilon ja riemun äänen, yljän äänen ja morsiamen äänen.',
        10: 'Ja kuin sinä nämät kaikki tälle kansalle sanonut olet, ja he sanovat sinulle: miksi Herra uhkaa meille kaikkea tätä suurta onnettomuutta? ja mikä on meidän pahatekomme ja syntimme, jolla me olemme rikkoneet Herraa, meidän Jumalaamme, vastaan?',
        11: 'Niin sinun pitää sanoman heille: että teidän isänne, sanoo Herra, ovat hyljänneet minun, ja seuranneet muita jumalia, palvelleet niitä ja kumartaneet niitä; mutta minun ovat he hyljänneet, ja ei pitäneet minun lakiani.',
        12: 'Ja te teette vielä pahemmin kuin teidän isänne; sillä katso, kukin elää oman pahan sydämensä sisun jälkeen, eikä yksikään tottele minua.',
        13: 'Sentähden minä tahdon ajaa teidät pois tästä maasta siihen maahan, josta ette te eikä teidän isänne mitään tiedä, siellä saatte te palvella muita jumalia yli päivää ja yötä, ja en minä tahdo siellä armoa näyttää teille.',
        14: 'Sentähden katso, se aika tulee, sanoo Herra, ettei sitte pidä enään sanottaman: niin totta kuin Herra elää, joka Israelin lapset Egyptin maalta on johdattanut,',
        ...
        16: 'Katso, minä lähetän monta kalamiestä, sanoo Herra, heitä onkimaan; ja sitte lähetän minä monta metsämiestä, heitä käsittämään kaikilla vuorilla, kaikilla kukkuloilla ja kaikissa kiviraunioissa.',
        17: 'Sillä minun silmäni näkee kaikki heidän tiensä, ja ei ne ole peitetyt minun edessäni; ja heidän pahatekonsa on minun silmäini edessä salaamatoin.',
        18: 'Ensisti pitää minun kaksinkertaisesti maksaman heidän pahat tekonsa ja syntinsä, että he ovat saastuttaneet minun maani kauhistustensa raadoilla, ja kauhistuksellansa täyttivät he minun perintöni.',
        19: 'Herra, sinä olet väkevyyteni ja voimani, ja turvani hädässä; pakanat tulevat sinun tykös maailman ääristä ja sanovat: meidän isämme ovat tosin pitäneet vääriä ja turhia jumalia, jotka ei mitään auttaa taida.',
        20: 'Kuinka taitaa ihminen tehdä hänellensä jumalia, jotka ei kuitenkaan jumalia olekaan?',
        21: 'Sentähden katso, minä tahdon opettaa heitä tällä haavalla, ja tehdä heille minun käteni ja valtani tiettäväksi; ja heidän pitää ymmärtämän, että minun nimeni on Herra.',
    },
    17: {
    ...
    22: {
        ...
        26: 'Ja tahdon ajaa sinun ja sinun äitis, joka sinun synnyttänyt on, toiseen maahan, jossa ette syntyneet ole; ja siellä pitää teidän kuoleman.',
    ...
    25: {
        1: 'Tämä on se sana, joka tapahtui Jeremialle koko Juudan kansasta, neljäntenä Jojakimin Josian pojan, Juudan kuninkaan vuotena, joka oli ensimäinen Nebukadnetsarin, Babelin kuninkaan, vuosi;',
        2: 'Jonka propheta Jeremia puhui kaikelle Juudan kansalle ja kaikille Jerusalemin asuvaisille, ja sanoi:',
        ...
        5: 'Koska hän sanoi: kääntäkäät teitänne kukin pahalta tieltänsä ja teidän pahasta menostanne, niin teidän pitää pysymän siinä maassa, jonka Herra teille ja teidän isillenne antanut on, ijankaikkisesta ijankaikkiseen.',
        6: 'Älkäät muita jumalia seuratko, niin että te palvelette ja kumarratte heitä; ettette minua teidän kättenne töillä vihoittaisi, ja minä teille kovan onnen saattaisin.',
        7: 'Mutta ette tahtoneet kuulla minua, sanoo Herra; että te minun kumminkin vihoititte kättenne töillä omaksi onnettomuudeksenne.',
        8: 'Sentähden sanoo Herra Zebaot: ettette kuulleet minun sanojani,',
        9: 'Katso, niin minä tahdon lähettää ja antaa tulla kaikki kansat pohjoisesta, sanoo Herra, ja palveliani Nebukadnetsarin, Babelin kuninkaan, ja tuoda hänen tälle maalle niiden päälle, jotka siinä asuvat, ja kaiken tämän kansan päälle, joka tässä ympäristöllä on; ja tahdon antaa heidät haaskaksi ja hävitykseksi, ja vihellykseksi ja ijankaikkiseksi autioksi;',
        10: 'Ja tahdon heiltä ottaa pois kaiken ilon ja riemun äänen, yljän äänen ja morsiamen äänen, myllyn äänen, ja kynttilän valistuksen.',
        11: 'Että kaikki tämä maa pitää kylmillä ja hävitettynä oleman, ja nämät kansat pitää Babelin kuningasta palveleman seitsemänkymmentä ajastaikaa.',
        12: 'Ja pitää tapahtuman, että kuin ne seitsemänkymmentä vuotta kuluneet ovat, niin minä tahdon kostaa Babelin kuninkaalle ja tälle kansalle, sanoo Herra, heidän pahain tekoinsa tähden, siihen myös Kaldealaisten maalle, ja tehdä sen ijankaikkiseksi autioksi.',
        ...
        14: 'Ja heidän pitää myös palveleman, vaikka he voimallinen kansa ja valtiaat kuninkaat ovat. Näin tahdon minä maksaa heille heidän ansionsa jälkeen ja heidän kättensä tekoin jälkeen.',
        15: 'Sillä näin sanoo Herra, Israelin Jumala, minulle: ota tämä viinamalja minun kädestäni täynnänsä vihaa, ja kaada sitä kaikille kansoille, joiden tykö minä sinun lähetän.',
        16: 'Että se joisivat, horjuisivat ja hokariksi tulisivat miekan edessä, jonka minä heidän sekaansa tahdon lähettää.',
        17: 'Ja minä otin maljan Herran kädestä, ja kaasin kaikille kansoille, joiden tykö Herra minun lähetti:',
        18: 'Jerusalemille, Juudan kaupungeille, hänen kuninkaillensa ja päämiehillensä, että heidän pitää oleman pilkkana ja kirouksena, niinkuin tänäpänä on:',
        19: 'Pharaolle, Egyptin kuninkaalle, palvelioinensa, ruhtinainensa ja kaikelle hänen kansallensa,',
        20: 'Kaikille maille etelään päin, kaikille kuninkaille Utsin maalla, kaikille kuninkaille Philistealaisten maalla, Askalonin, Gatsan, Akaronin ja Asdodin jääneiden kanssa,',
        21: 'Edomilaisille, Moabilaisille ja Ammonin lapsille,',
        22: 'Kaikille Tyron kuninkaille, kaikille Sidonin kuninkaille, luotoin kuninkaille sillä puolen merta,',
        23: 'Dedanille, Temalle, Busille ja kaikille maan äärissä asuvaisille,',
        24: 'kaikille Arabian kuninkaille, kaikille kuninkaille lännen puolessa, jotka korvessa asuvat,',
        25: 'Kaikille Simrin kuninkaille, kaikille kuninkaille Elamissa, kaikille kuninkaille Madaissa,',
        26: 'Kaikille kuninkaille pohjoisessa, sekä läsnä että kaukana toinen toisensa kanssa, ja kaikille valtakunnille maan päällä, jotka maan piirin päällä ovat; ja kuningas Sesakin pitää juoman näiden jälkeen.',
        27: 'Ja sano heille: näin sanoo Herra Zebaot, Israelin Jumala: juokaat ja juopukaat, oksentakaat ja langetkaat, ja ette taida nousta miekan edessä, jonka minä teidän sekaanne lähettää tahdon.',
        28: 'Ja jollei he tahdo ottaa maljaa sinun kädestäs ja juoda, niin sano heille: näin sanoo Herra Zebaot: teidän pitää kaiketi juoman;',
        29: 'Sillä katso, siinä kaupungissa, joka minun nimelläni nimitetty on, rupeen minä vaivaamaan; luuletteko että teidän pitää rankaisematta pääsemän? Ei teidän pidä rankaisematta pääsemän; sillä minä kutsun miekan kaikkein niiden päälle, jotka maalla asuvat, sanoo Herra Zebaot.',
        30: 'Ja sinun pitää ennustaman heille kaikki nämät sanat, ja sanoman heille: Herra on kiljuva korkeudesta, ja antava kuulla äänensä pyhästä asuinsiastansa, hän on kaiketi kiljuva majastansa, hän veisaa virren, niinkuin viinan sotkuja, kaikista maan asuvaisista,',
        31: 'Jonka ääni on kuuluva maan ääriin; sillä Herra toimittaa pakanat oikeuden eteen, ja tahtoo tuomita kaiken lihan; jumalattomat antaa hän miekan alle, sanoo Herra.',
        32: 'Näin sanoo Herra Zebaot: katso, vaiva tulee kansasta kansaan, ja suuri ilma nousee maan sivusta.',
        33: 'Niin pitää Herralta lyötyjä sinä päivänä oleman yhdestä maan äärestä niin toiseen asti; ei pidä heitä itkettämän eikä korjattaman, eli haudattaman, vaan pitää oleman kedolla ja loaksi tuleman.',
        34: 'Parkukaat nyt, te paimenet, huutakaat ja vieristelkäät teitänne tuhassa, te lauman valtiaat; sillä aika on tullut teitä teurastaa ja hajoittaa, ja teidän pitää putooman rikki, niinkuin kallis astia.',
        35: 'Ja ei paimenten pidä taitaman paeta, ja lauman valtiaat ei pidä pääsemän pois.',
        36: 'Niin pitää paimenet surkiasti huutaman, ja lauman valtiaat surkutteleman, että Herra on niin hävittänyt heidän laitumensa.',
        37: 'Ja heidän niittynsä, jotka niin kauniit olivat, ovat hävitetyt Herran julmalta vihalta.',
        38: 'Hän on hyljännyt majansa, niinkuin nuori jalopeura; ja heidän maansa on niin hävitetty hävittäjän vihalta ja hänen julmalta vihaltansa.',
    },
    26: {
        ...
        6: 'Niin tahdon minä tehdä tälle huoneelle niinkuin Silolle, ja tahdon tehdä tämän kaupungin kaikille pakanoille maan päällä kiroukseksi.',
    ...
    31: {
        ...
        10: 'Kuulkaat pakanat, Herran sanaa, ja julistakaat kaukana luodoissa, ja sanokaat: joka Israelin hajoitti, se kokoo hänen jälleen, ja on häntä vartioitseva niinkuin paimen laumaansa.',
        ...
        16: 'Näin Herra sanoo näin: lakkaa parkumasta ja itkemästä, ja pyyhi silmistäs kyyneleet; sillä sinun työlläs pitää palkka oleman, sanoo Herra, ja heidän pitää palajaman vihollisten maasta.',
        ...
        23: 'Näin sanoo Herra Zebaot, Israelin Jumala: Vielä tämä sana sanotaan Juudan maassa ja hänen kaupungeissansa, kun minä heidän vankiutensa kääntävä olen: Herra siunatkoon sinua, sinä vanhurskauden asumus, sinä pyhä vuori.',
        ...
        33: 'Mutta tämän pitää se liitto oleman, jonka minä Israelin huoneen kanssa teen tämän ajan perästä, sanoo Herra: minä tahdon minun lakini antaa heidän sydämeensä ja sen heidän mieliinsä kirjoittaa; ja minä tahdon olla heidän Jumalansa, ja heidän pitää minun kansani oleman.',
        34: 'Ja ei pidä kenenkään lähimmäistänsä opettaman, eikä veli veljeänsä, ja sanoman: tunne Herraa; sillä heidän pitää kaikkein minun tunteman, sekä pienten että suurten, sanoo Herra; sillä minä tahdon heidän pahat tekonsa antaa anteeksi, ja en ikinä enään muista heidän syntejänsä.',
        ...
        38: 'Katso, aika tulee, sanoo Herra, että Herran kaupunki rakennetaan jälleen Hananeelin tornista Kulmaporttiin asti.',
        39: 'Ja mittanuora pitää siellä kohdastansa käymän hamaan Garebin kukkulaan asti, ja käymän ympäri Goaan.',
    ...
    32: {
        1: 'Tämä on se sana, joka tapahtui Herralta Jeremialle, kymmenentenä Zedekian, Juudan kuninkaan, vuonna, joka on Nebukadnetsarin kahdeksastoistakymmenes vuosi.',
        ...
        12: 'Ja annoin kauppakirjan Barukille Neerijan pojalle, Mahsejan pojan, Hanamelin, minun setäni pojan silmäin edessä ja todistajain silmäin edessä, jotka kauppakirjan allekirjoittaneet olivat, ja kaikkien Juudalaisten silmäin edessä, jotka pihassa vankihuoneen edessä asuivat.',
        ...
        25: 'Ja sinä Herra, Herra, sanoit minulle: osta sinulles pelto rahalla, ja ota todistukset, vaikka kaupunki pitää annettaman joutuu kaldealaisten käsiin.',
        ...
        31: 'Siitä ajasta, kuin tämä kaupunki rakennettiin, niin tähän päivään asti, on hän tehnyt minun vihaiseksi ja julmaksi, niin että minun täytyi heittää hänen pois kasvojeni edestä,',
        ...
        34: 'Päälliseksi he ovat panneet kauhistuksensa siihen huoneeseen, jolla minusta on nimi, saastuttaaksensa sitä.',
        35: 'Ja ovat rakentaneet Baalin korkeuksia Ben-Hinnomin laaksossa, polttaakseen poikiansa ja tyttäriänsä Molokille, jota en minä ole heidän käskenyt, eikä myös ole minun mieleeni johtunut, että heidän tämän kauhistuksen piti tekemän, jolla he Juudan saattivat syntiä tekemään.',
        ...
        39: 'Ja tahdon heille yhden sydämen ja yhden tien antaa, että he pelkäisivät minua kaikkena elinaikanansa, että heille ja heidän lapsillensa heidän jälkeensä pitäis hyvästi käymän.',
        ...
        44: 'Kuitenkin pitää vielä nyt peltoja ostettaman rahalla ja kirjoituksella, niin sinetillä vahvistettaman ja todistajilla: Benjaminin maalla, ja ympäri Jerusalemia, ja Juudan kaupungeissa, jotka vuorilla ovat sillä minä tahdon kääntää heidän vankiutensa, sanoo Herra.',
    },
    33: {
        ...
        17: 'Sillä näin sanoo Herra: ei pidä Daavidilta puuttuman mies, joka istuu Israelin huoneen istuimella;',
        18: 'Ei myös pidä koskaan edestäni puuttuman pappeja ja Leviläisiä, jotka polttouhria uhraavat ja ruokauhria sytyttävät, ja uhreja joka aika teurastavat.',
        ...
        22: 'Niinkuin ei taivaan sotaväkeä taideta lukea eikä meren santaa mitata, juuri niin tahdon minä palveliani Daavidin siemenen enentää ja Leviläiset, jotka minua palvelevat.',
    ...
    34: {
        ...
        7: 'Kuin Babelin kuninkaan sotajoukko jo soti Jerusalemia vastaan, ja Juudan jääneitä kaupungeita vastaan, Lakista ja Asekaa vastaan; sillä nämät vahvat kaupungit olivat vielä Juudan kaupungeista jääneet.',
        ...
        18: 'Ja jotka minun liitostani harhailevat, eikä pidä liiton sanoja, jonka he minun edessäni tehneet ovat, niin minä teen niinkuin sille vasikalle, jonka kahdeksi kappaleeksi hakkasivat, ja kävivät molempain kappalten välitse,',
    ...
    35: {
        ...
        4: 'Ja vein heidät Herran huoneeseen, Hananin lasten, Jigdalian pojan, Jumalan miehen kammioon, joka päämiesten kammion tykönä on, ylempänä Maasejan Sallumin pojan, ovenvartian kammiota.',
        ...
        8: 'Ja me olemme kuuliaiset meidän isämme Jonadabin Rekabin pojan äänelle kaikissa, mitä hän on meille käskenyt, niin ettemme viinaa juo kaikkena meidän elinaikanamme, me ja meidän emäntämme, poikamme ja tyttäremme.',
        ...
        11: 'Mutta kun Nebukadnetsar, Babelin kuningas, meni tänne maahan ylös, sanoimme me: tulkaat, käykäämme Jerusalemiin Kaldealaisten ja Syrialaisten sotajoukon edestä; ja niin me olemme sitte olleet tässä Jerusalemissa.',
        ...
        15: 'Niin olen minä myös lähettänyt varhain ja usein tykönne kaikki minun palveliani prophetat, ja antanut sanoa: kääntäkää teistä jokainen itsensä pahasta menostansa, ja parantakaat teidän elämänne, ja älkäät seuratko muita jumalia, palvellaksenne heitä; niin te saatte olla maassa, jonka minä teille ja teidän isillenne antanut olen; mutta ette tahtoneet kallistaa korvianne siihen,, ettekä kuulleet minua.',
        ...
        17: 'Sentähden näin sanoo Herra Jumala Zebaot, Israelin Jumala: katso, minä annan tulla Juudan ja kaikkein Jerusalemin asuvaisten päälle kaiken sen onnettomuuden, jonka minä heitä vastaan olen puhunut, että minä olen heille puhunut, ja ei he tahdo kuulla: minä olen huutanut, mutta ei he tahdo minua vastata.',
    ...
    36: {
        ...
        3: 'Jos mitämaks Juudan huone, kuin he kuulevat kaiken sen onnettomuuden, joka minun mielessäni on heille tehdä, on itsensä kääntävä, jokainen pahasta menostansa, että minä antaisin anteeksi heidän pahat tekonsa ja rikoksensa.',
        ...
        6: 'Mutta mene sinä sinne ja lue kirja, johon sinä Herran sanat minun suustani kirjoittanut olet, kansan korvain edessä Herran huoneessa, paastopäivänä; ja sinun pitää myös ne lukeman koko Juudan korvain edessä, jotka heidän kaupungeistansa tulleet ovat.',
        ...
        13: 'Ja Mikaja sanoi heille kaikki ne sanat, jotka hän oli kuullut, kuin Baruk luki kirjasta kansan korvain edessä.',
    ...
    38: {
        ...
        23: 'Ja pitää vietämän kaikki sinun emäntäs ja lapses ulos Kaldealaisten tykö ja ei sinun itseskään pidä taitaman päästä heidän käsistänsä; vaan sinä pitää Babelin kuninkaalta käsitettämän, ja tämä kaupunki pitää tulella poltettaman.',
    ...
    39: {
        1: 'Yhdeksäntenä Zedekian, Juudan kuninkaan vuotena, kymmenentenä kuukautena, tuli Nebukadnetsar, Babelin kuningas, ja kaikki hänen sotajoukkonsa Jerusalemin eteen ja piirittivät sen.',
        2: 'Ja Zedekian ensimäisenä vuotena toistakymmentä, yhdeksäntenä päivänä neljäntenä kuukautena, kukistettiin kaupunki.',
        3: 'Ja kaikki Babelin kuninkaan ruhtinaat menivät sisälle, ja pysähtyivät keskimäiseen porttiin, Nergalsaretser, Samgarnebo, Sarsekim kamaripalveliain päämies, Nergalsaretser magilaisten päämies ja kaikki muut Babelin kuninkaan ruhtinaat.',
        ...
        5: 'Mutta Kaldealaisten sotajoukko ajoi heitä takaa, ja käsitti Zedekian Jerikon kedolla, otti hänen ja vei Nebukadnetsarin, Babelin kuninkaan, tykö Riblatiin, joka on Hamatin maalla; ja hän tuomitsi hänen.',
        6: 'Ja Babelin kuningas antoi tappaa Zedekian lapset hänen nähtensä Riblatissa; ja kaikki Juudan ruhtinaat antoi Babelin kuningas tappaa.',
        7: 'Ja antoi puhkaista ulos Zedekian silmät, ja sitoa hänen kaksilla vaskikahleilla, viedäksensä häntä Babeliin.',
        8: 'Ja Kaldealaiset polttivat sekä kuninkaan huoneen että asuvaisten huoneet, ja jaottivat Jerusalemin muurit.',
        9: 'Mutta mitä jäljellä oli kaupungissa kansasta, ja ne, jotka muutoin olivat hänen allensa itsensä antaneet, ja jääneen kansan, vei Nebusaradan, huovinhaltia, Babeliin.',
        10: 'Mutta muutamat köyhästä väestä, joilla ei mitään ollut, antoi Nebusaradan, huovinhaltia, jäädä Juudan maalle, ja antoi heille viinamäkiä ja peltoja sinä päivänä.',
        11: 'Mutta Nebukadnetsar, Babelin kuningas, oli käskenyt Nebusaradania, huovinhaltiaa, Jeremiasta ja sanonut:',
        12: 'Ota häntä ja katso hänen parastansa, ja älä hänelle tee mitään pahaa: vaan niinkuin hän anoo sinulta, niin tee hänelle.',
        13: 'Silloin lähetti Nebusaradan, huovinhaltia, ja Nebusasban kamaripalveliain päämies, Nergaisaretser magilaisten päämies, ja kaikki Babelin kuninkaan ruhtinaat,',
        14: 'He lähettivät ja antoivat noutaa Jeremian vankihuoneen pihasta, ja antoivat hänen Gedalian Ahikamin pojan, Saphanin pojan, haltuun, että hänen piti ottaman hänen huoneesensa, ja että hän asuis läsnä kansan tykönä.',
        15: 'Oli myös Herran sana tullut Jeremialle, kuin hän vielä oli vankina vankihuoneen pihassa, ja oli sanonut:',
        16: 'Mene ja sano Ebedmelekille Etiopialaiselle: näin sanoo Herra Zebaot, Israelin Jumala: katso, minä tahdon antaa minun sanani tulla tähän kaupunkiin onnettomuudeksi ja ei miksikään hyväksi, ja sinun pitää se siihen aikaan näkemän.',
        17: 'Mutta sinun minä silloin vapahdan, sanoo Herra, ja en anna sinua niiden miesten käsiin, joita sinä pelkäät;',
        18: 'Sillä minä tahdon sinua totisesti siitä auttaa, niin ettei sinun pidä miekalla lankeeman, vaan pitämän henkes niinkuin saaliin, ettäs luotit minuun, sanoo Herra.',
    },
    40: {
    ...
    46: {
        ...
        4: 'Valjastakaat hevoset, ja antakaat ratsastajat astua hevosten selkään; pankaat rautalakit päähänne, teroittakaat keihäät, pukekaat rautahame yllenne.',
        ...
        21: 'Ja hänen päivämiehensä, jotka siinä asuvat, ovat myös kuin syötetyt vasikat; mutta heidän pitää kumminkin palajaman, kaikki tuleman karkuriksi, ja ei taitaman pysyä; sillä heidän onnettomuutensa päivä pitää heidän päällensä tuleman, heidän rangaistuksensa aika.',
    ...
    49: {
        ...
        24: 'Damasku epäilee ja pakenee: hän vapisee ja on ahdistuksessa ja kivussa, niinkuin synnyttäväinen.',
    ...
    51: {
        ...
        5: 'Sillä Israel ja Juuda ei pidä Jumalaltansa, Herralta Zebaotilta leskeksi hyljättämän; vaikka heidän maansa on kovin rikkonut Israelin Pyhää vastaan.',
        6: 'Paetkaat Babelista, että jokainen pelastais sielunsa, ettette hukkuisi hänen pahuudessansa; sillä tämä on Herran koston aika ja hän tahtoo hänelle maksaa hänen ansionsa jälkeen.',
    ...
    52: {
        ...
        30: 'Ja Nebukadnetsarin kolmantena vuonna kolmattakymmentä vei Nebusaradan, huovinhaltia, pois seitsemänsataa ja viisiviidettäkymmentä sielua Juudasta; kaikki sielut ovat neljätuhatta ja kuusisataa.',
