...
CHAPTERS = {
    1: {
        ...
        6: 'И учини нас цареве и свештенике Богу и Оцу свом; томе слава и држава ва век века. Амин.',
        ...
        18: 'И Живи: и бејах мртав и ево сам жив ва век века, амин. И имам кључеве од пакла и од смрти.',
    ...
    4: {
        ...
        2: 'И одмах бих у духу; и гле, престо стајаше на небу, и на престолу сеђаше неко.',
        3: 'И Онај што сеђаше беше по виђењу као камен јаспис и сард; и око престола беше дуга по виђењу као смарагд.',
        4: 'И око престола беху двадесет и четири престола; и на престолима видех двадесет и четири старешине где седе, обучене у беле хаљине, и имаху круне златне на главама својим.',
        5: 'И од престола излажаху муње и громови и гласови; и седам жижака огњених гораху пред престолом, које су седам духова Божијих.',
        6: 'И пред престолом беше стаклено море, као кристал; и насред престола и око престола четири животиње, пуне очију спред и састраг.',
        7: 'И прва животиња беше као лав, и друга животиња као теле, и трећа животиња имаше лице као човек, и четврта животиња беше као орао кад лети.',
        8: 'И свака од четири животиње имаше по шест крила наоколо, и унутра пуна очију, и мира не имају дан и ноћ говорећи: Свет, свет, свет Господ Бог Сведржитељ, Који беше, и који јесте, и који ће доћи.',
        9: 'И кад даше животиње славу и част и хвалу Ономе што сеђаше на престолу, што живи ва век века,',
        10: 'Падоше двадесет и четири старешине пред Оним што сеђаше на престолу, и поклонише се Ономе што живи ва век века, и метнуше круне своје пред престолом говорећи:',
        11: 'Достојан си, Господе, да примиш славу и част и силу; јер си Ти саздао све, и по вољи Твојој јесте и створено је.',
    },
    5: {
        ...
        13: 'И свако створење, што је на небу, и на земљи, и под земљом, и што је на мору, и што је у њима, све чух где говоре: Ономе што седи на престолу, и Јагњету благослов и част и слава и држава ва век века.',
        14: 'И четири животиње говораху: Амин. И двадесет и четири старешине падоше и поклонише се Ономе што живи ва век века.',
    },
    6: {
        1: 'И видех кад отвори Јагње један од седам печата, и чух једну од четири животиње где говори као глас громовни: Дођи и види.',
        2: 'И видех, и гле, коњ бео, и онај што сеђаше на њему имаше стрелу; и њему се даде венац, и изиђе побеђујући, и да победи.',
        3: 'И кад отвори други печат, чух другу животињу где говори: Дођи и види.',
        4: 'И изиђе други коњ риђ, и ономе што сеђаше на њему даде се да узме мир са земље, и да убија један другог, и даде му се мач велики.',
        5: 'И кад отвори трећи печат, чух трећу животињу где говори: Дођи и види. И видех, и гле, коњ вран, и онај што сеђаше на њему имаше мерила у руци својој.',
        6: 'И чух глас између четири животиње где говори: Ока пшенице за грош, и три оке јечма за грош; а уља и вина неће бити.',
        7: 'И кад отвори четврти печат, чух глас четврте животиње где говори: Дођи и види.',
        8: 'И видех, и гле, коњ блед, и ономе што сеђаше на њему беше име смрт, и пакао иђаше за њим; и њему се даде област на четвртом делу земље да убије мачем и глађу и смрћу и зверињем земаљским.',
        ...
        12: 'И видех кад отвори шести печат, и гле, затресе се земља врло, и сунце поста црно као врећа од кострети, и месец поста као крв;',
        13: 'И звезде небеске падоше на земљу као што смоква одбацује пупке своје кад је велики ветар заљуља.',
        14: 'И небо се измаче као књига кад се савије, и свака гора и острво с места својих покренуше се.',
        15: 'И цареви земаљски, и бољари, и богати, и војводе, и силни, и сваки роб, и сваки слободњак, сакрише се по пећинама и по камењацима горским;',
        16: 'И говорише горама и камењу: Падните на нас, и сакријте нас од лица Оног што седи на престолу, и од гнева Јагњетовог.',
        17: 'Јер дође велики дан гнева Његовог, и ко може остати?',
    },
    7: {
        ...
        12: 'Говорећи: Амин; благослов и слава и премудрост и хвала и част и сила и јачина Богу нашем ва век века. Амин.',
    ...
    10: {
        ...
        6: 'И закле се Оним који живи ва век века, који сазда небо и шта је на њему, и земљу и шта је на њој, и море и шта је у њему, да времена већ неће бити;',
    ...
    11: {
        ...
        2: 'А порту што је изван цркве, избаци напоље, нити је мери, јер је дана незнабошцима; и град свети газиће четрдесет и два месеца.',
        3: 'И даћу двојици својих сведока, и прорицаће хиљаду и двеста и шездесет дана обучени у вреће.',
        4: 'Ови су две маслине и два жишка што стоје пред Господарем земаљским.',
        5: 'И ако им ко неправду учини, огањ излази из уста њихових, и појешће непријатеље њихове; и ко буде хтео да им учини нажао онај ваља да буде убијен.',
        6: 'И ови ће имати власт да затворе небо, да не падне дажд на земљу у дане њиховог прорицања; и имаће власт над водама да их претварају у крв, и да ударе земљу сваком муком, кадгод буду хтели.',
        7: 'И кад сврше сведочанство своје, онда ће звер што излази из бездана учинити с њима рат, и победиће их и убиће их.',
        8: 'И телеса њихова оставиће на улици града великог, који се духовно зове Содом и Мисир, где и Господ наш разапет би.',
        9: 'И гледаће неки од народа и племена и језика и колена телеса њихова три дана и по, и неће дати да се њихова телеса метну у гробове.',
        10: 'И који живе на земљи, обрадоваће се и развеселиће се за њих, и слаће даре један другом, јер ова два пророка мучише оне што живе на земљи.',
        11: 'И после три дана и по дух живота од Бога уђе у њих; и сташе оба на ноге своје, и страх велики нападе на оне који их гледаху.',
        12: 'И чуше глас велики с неба, који им говори: Изиђите амо. И изиђоше на небо на облацима, и видеше их непријатељи њихови.',
        13: 'И у тај час затресе се земља врло, и десети део града паде, и тресење земље поби седам хиљада имена човечијих; и остали се уплашише, и даше славу Богу небеском.',
        14: 'Зло друго прође, ево зло треће иде брзо.',
        15: 'И седми анђео затруби и посташе велики гласови на небесима говорећи: Поста царство света Господа нашег и Христа Његовог, и цароваће ва век века.',
        16: 'И двадесет и четири старешине које сеђаху пред Богом на престолима својим, падоше на лица своја и поклонише се Богу.',
        17: 'Говорећи: Хвалимо Те, Господе Боже Сведржитељу, који јеси, и беше, и бићеш, што си примио силу своју велику, и царујеш.',
        18: 'И незнабошци се прогневише, и дође гнев Твој и време мртвима да се суди, и да се да плата слугама Твојим, пророцима и светима, и онима који се боје имена Твог, малима и великима, и да се погубе они који земљу погубише.',
        19: 'И отвори се црква Божија на небу, и показа се ћивот завета Његовог у цркви Његовој; и бише севања муња, и гласови, и громови, и тресење земље, и град велики.',
    },
    12: {
    ...
    13: {
        1: 'И стадох на песку морском; и видех звер где излази из мора, која имаше седам глава, и рогова десет, и на роговима њеним десет круна, а на главама њеним имена хулна.',
        2: 'И звер коју видех беше као рис, и ноге јој као у медведа, и уста њена као уста лавова, и даде јој змија силу своју, и престо свој, и област велику.',
        3: 'И видех једну од глава њених као рањену на смрт, и рана смрти њене излечи се. И чуди се сва земља иза звери, и поклонише се змији, која даде област звери.',
        4: 'И поклонише се звери говорећи: Ко је као звер? И ко може ратовати с њом?',
        5: 'И дана јој бише уста која говоре велике ствари и хуљења, и дана јој би област да чини четрдесет и два месеца.',
        6: 'И отвори уста своја за хуљење на Бога, да хули на име Његово, и на кућу Његову, и на оне који живе на небу.',
        7: 'И дано јој би да се бије са светима, и да их победи; и дана јој би област над сваким коленом и народом и језиком и племеном.',
        8: 'И поклонише јој се сви који живе на земљи којима имена нису записана у животној књизи Јагњета, које је заклано од постања света.',
        9: 'Ако ко има ухо нека чује.',
        10: 'Ко у ропство води, биће у ропство одведен; ко ножем убије ваља да он ножем буде убијен. Овде је трпљење и вера светих.',
        11: 'И видех другу звер где излази из земље, и имаше два рога као у јагњета; и говораше као аждаха.',
        12: 'И сву власт прве звери чињаше пред њом; и учини да земља и који живе на њој поклони се првој звери којој се исцели рана смртна.',
    ...
    14: {
        ...
        6: 'И видех другог анђела где лети посред неба, који имаше вечно јеванђеље да објави онима који живе на земљи, и сваком племену, и језику и колену и народу.',
    ...
    15: {
        ...
        3: 'И певаху песму Мојсија, слуге Божијег, и песму Јагњетову, говорећи: Велика су и дивна дела Твоја, Господе Боже Сведржитељу, праведни су и истинити путеви Твоји, Царе светих.',
    ...
    16: {
        1: 'И чух глас велики из цркве где говори седморици анђела: Идите, и излијте седам чаша гнева Божијег на земљу.',
        2: 'И оде први анђео, и изли чашу своју на земљу; и посташе ране зле и љуте на људима који имају жиг зверин и који се клањају икони њеној.',
        3: 'И други анђео изли чашу своју у море; и поста крв као од мртваца, и свака душа жива умре у мору.',
        4: 'И трећи анђео изли чашу своју на реке и на изворе водене; и поста крв.',
        5: 'И чух анђела воденог где говори: Праведан си Господе, који јеси, и који беше, и свет, што си ово судио;',
        6: 'Јер пролише крв светих и пророка, и крв си им дао да пију јер су заслужили.',
        7: 'И чух другог из олтара где говори: Да, Господе Боже Сведржитељу, истинити су и прави судови Твоји.',
        ...
        10: 'И пети анђео изли чашу своју на престо зверин; и царство њено поста тамно, и жвакаху језике своје од бола.',
        11: 'И хулише на име Бога небеског од бола и од рана својих, и не покајаше се од дела својих.',
        12: 'И шести анђео изли чашу своју на велику реку Еуфрат; и пресахну вода њена, да се приправи пут царевима од истока сунчаног.',
        13: 'И видех из уста аждахиних, и из уста звериних, и из уста лажног пророка, где изиђоше три нечиста духа, као жабе.',
        14: 'Јер су ово духови ђаволски који чине чудеса и излазе к царевима свега васионог света да их скупе на бој за онај велики дан Бога Сведржитеља.',
        ...
        17: 'И седми анђео изли чашу своју по небу, и изиђе глас велики из цркве небеске од престола говорећи: Сврши се.',
        18: 'И бише севања муња и громови, и гласови, и би велико тресење земље, какво никад не би откако су људи на земљи, толико тресење, тако велико.',
        19: 'И град велики раздели се на три дела, и градови незнабожачки падоше; и Вавилон велики спомену се пред Богом да му да чашу вина љутог гнева свог.',
        20: 'И сва острва побегоше, и горе се не нађоше.',
        21: 'И град велики као глава паде с неба на људе; и људи хулише на Бога од зла градног, јер је велика мука његова врло.',
    },
    17: {
    ...
    19: {
        ...
        2: 'Јер су истинити и прави судови Његови, што је осудио курву велику, која поквари земљу курварством својим, и покајао крв слугу својих од руке њене.',
        3: 'И другом рекоше: Алилуја! И дим њен излажаше ва век века.',
        4: 'И падоше двадесет и четири старешине, и четири животиње, и поклонише се Богу који сеђаше на престолу, говорећи: Амин, алилуја!',
        5: 'И глас изиђе од престола који говори: Хвалите Бога нашег све слуге Његове, и који Га се бојите, и мали и велики.',
        6: 'И чух као глас народа многог, и као глас вода многих, и као глас громова јаких, који говоре: Алилуја! Јер царује Господ Бог Сведржитељ.',
        7: 'Да се радујемо и веселимо, и да дамо славу Њему; јер дође свадба Јагњетова, и жена Његова приправила се;',
        8: 'И дано јој би да се обуче у свилу чисту и белу: јер је свила правда светих.',
        9: 'И рече ми: Напиши: Благо онима који су позвани на вечеру свадбе Јагњетове. И рече ми: Ове су речи истините Божије.',
        10: 'И паднувши пред ногама његовим поклоних му се; и рече ми: Гле, немој, ја сам слуга као и ти и браћа твоја која имају сведочанство Исусово. Богу се поклони; јер је сведочанство Исусово Дух Пророштва.',
        11: 'И видех небо отворено, и гле, коњ бео, и који сеђаше на њему зове се Веран и Истинит, и суди по правди и војује.',
        12: 'А очи су Му као пламен огњени, и на глави Његовој круне многе, и имаше име написано, ког нико не зна до Он сам.',
        13: 'И беше обучен у хаљину црвену од крви, и име се Његово зове: Реч Божија.',
        14: 'И војске небеске иђаху за Њим на коњима белим, обучене у свилу белу и чисту.',
        15: 'И из уста Његових изиђе мач оштар, да њиме побије незнабошце; и Он ће их пасти с палицом гвозденом; и Он гази кацу вина и срдње и гнева Бога Сведржитеља.',
        16: 'И има на хаљини и на стегну свом име написано: Цар над царевима и Господар над господарима.',
        17: 'И видех једног анђела где стоји на сунцу и повика гласом великим говорећи свима птицама које лете испод неба: Дођите и скупите се на велику вечеру Божију,',
        18: 'Да једете меса од царева, и меса од војвода, и меса од јунака, и меса од коња и од оних који седе на њима, и меса од свих слободњака и робова, и од малих и од великих.',
        19: 'И видех звер и цареве земаљске и војнике њихове скупљене да се побију с Оним што седи на коњу и с војскама Његовим.',
        20: 'И би ухваћена звер, и с њом лажни пророк који учини пред њом знаке којима превари оне који примише жиг зверин и који се поклањају икони њеној: живи бише бачени обоје у језеро огњено, које гори сумпором.',
        21: 'А остали побијени бише мачем Оног што седи на коњу, који изиђе из уста Његових: и све се птице наситише од меса њиховог.',
    },
    20: {
        ...
        10: 'И ђаво који их вараше би бачен у језеро огњено и сумпорито, где је звер и лажни пророк; и биће мучени дан и ноћ ва век века.',
        ...
        13: 'И море даде своје мртваце, и смрт и пакао дадоше своје мртваце; и суд примише по делима својим.',
    ...
    21: {
        ...
        8: 'А страшљивима и невернима и поганима и крвницима, и курварима, и врачарима, и идолопоклоницима, и свима лажама, њима је део у језеру што гори огњем и сумпором; које је смрт друга.',
