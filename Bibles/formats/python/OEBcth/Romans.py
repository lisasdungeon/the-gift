...
CHAPTERS = {
    ...
    5: {
        ...
        7: 'Even for an upright person scarcely anyone will die. For a really good person perhaps some one might even dare to die.',
        ...
        15: 'But there is a contrast between Adam’s offence and God’s gracious gift. For, if by reason of the offence of the one man the whole race died, far more were the loving kindness of God, and the gift given in the loving kindness of the one man, Jesus Christ, lavished on the whole race.',
        ...
        21: 'in order than, just as sin had reigned in the realm of death, so, too, might Loving-kindness reign through righteousness, and result in eternal life, through Jesus Christ, our Lord.',
    },
    6: {
    ...
    13: {
        ...
        2: 'Therefore he who sets himself against the authorities is resisting God’s appointment, and those who resist will bring a judgment on themselves.',
    ...
    15: {
        ...
        9: 'and that the Gentiles also may praise God for his mercy. As scripture says — ‘Therefore will I make acknowledgment to you among the Gentiles and sing in honour of your name.’',
