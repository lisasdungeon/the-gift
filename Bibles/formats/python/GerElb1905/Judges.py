...
CHAPTERS = {
    ...
    7: {
        1: 'Und Jerub-Baal, das ist Gideon, und alles Volk, das mit ihm war, machten sich früh auf, und sie lagerten sich an der Quelle Harod; das Lager Midians aber war nordwärts von ihm, nach dem Hügel More hin, im Tale.',
    ...
    8: {
        ...
        26: 'Und das Gewicht der goldenen Ohrringe, die er erbeten hatte, war tausendsiebenhundert Sekel Gold, außer den Halbmonden und den Ohrgehängen und den Purpurkleidern, welche die Könige von Midian trugen, und außer den Halsketten, die an den Hälsen ihrer Kamele waren.',
    ...
    9: {
        ...
        15: 'Und der Dornstrauch sprach zu den Bäumen: Wenn ihr mich in Wahrheit zum König über euch salben wollt, so kommet, vertrauet euch meinem Schatten an; wenn aber nicht, so soll Feuer von dem Dornstrauch ausgehen und die Zedern des Libanon verzehren. -',
    ...
    16: {
        ...
        29: 'Und Simson umfaßte die beiden Mittelsäulen, auf welchen das Haus ruhte, (und er stützte sich darauf) die eine mit seiner Rechten und die andere mit seiner Linken;',
    ...
    20: {
        ...
        35: 'Und Jehova schlug Benjamin vor Israel, und die Kinder Israel streckten unter Benjamin an selbigem Tage fünfundzwanzigtausend einhundert Mann nieder; diese alle zogen das Schwert. -',
    ...
    21: {
        ...
        15: "Und das Volk ließ sich's gereuen wegen Benjamins, weil Jehova einen Riß gemacht hatte in den Stämmen Israels.",
