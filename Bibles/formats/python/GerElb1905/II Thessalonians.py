...
CHAPTERS = {
    1: {
        ...
        4: 'so daß wir selbst uns euer rühmen in den Versammlungen Gottes wegen eures Ausharrens und Glaubens in allen euren Verfolgungen und Drangsalen, die ihr erduldet;',
        5: 'ein offenbares Zeichen des gerechten Gerichts Gottes, daß ihr würdig geachtet werdet des Reiches Gottes, um dessentwillen ihr auch leidet:',
