...
CHAPTERS = {
    ...
    2: {
        ...
        14: 'Und in seiner Mitte werden Herden sich lagern, allerlei Tiere in Menge; auch Pelikane, auch Igel werden auf seinen Säulenknäufen übernachten. Eine Stimme singt im Fenster, Trümmer sind auf der Schwelle, denn er hat das Zederngetäfel bloßgelegt.',
        15: "Das ist die frohlockende Stadt, die in Sicherheit wohnte, die in ihrem Herzen sprach: Ich bin's und gar keine sonst! Wie ist sie zur Wüste geworden, zum Lagerplatz der wilden Tiere! Ein jeder, der an ihr vorüberzieht, wird zischen, wird seine Hand schwenken.",
    },
    3: {
