...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'Geh und rufe vor den Ohren Jerusalems und sprich: So spricht Jehova: Ich gedenke dir die Zuneigung deiner Jugend, die Liebe deines Brautstandes, dein Wandeln hinter mir her in der Wüste, im unbesäten Lande.',
        3: 'Israel war heilig dem Jehova, der Erstling seines Ertrages; alle, die es verzehren wollten, verschuldeten sich: Unglück kam über sie, spricht Jehova.',
    ...
    9: {
        ...
        2: 'O daß ich in der Wüste eine Wandererherberge hätte, so wollte ich mein Volk verlassen und von ihnen wegziehen! Denn sie sind allesamt Ehebrecher, eine Rotte Treuloser.',
        ...
        17: 'So spricht Jehova der Heerscharen: Gebet acht, und rufet Klageweiber, daß sie kommen, und schicket zu den weisen Frauen,',
        18: 'daß sie kommen und eilends eine Wehklage über uns erheben, damit unsere Augen von Tränen rinnen und unsere Wimpern von Wasser fließen.',
        ...
        20: 'Denn höret, ihr Weiber, das Wort Jehovas, und euer Ohr fasse das Wort seines Mundes; und lehret eure Töchter Wehklage und eine die andere Klagegesang.',
    ...
    15: {
        ...
        14: 'Und ich werde es deine Feinde in ein Land bringen lassen, das du nicht kennst; denn ein Feuer ist entbrannt in meinem Zorn, über euch wird es brennen. -',
    ...
    16: {
        ...
        5: 'Denn so spricht Jehova: Geh nicht in ein Haus der Klage, und geh nicht hin, um zu trauern, und bezeige ihnen kein Beileid; denn ich habe meinen Frieden von diesem Volke weggenommen, spricht Jehova, die Gnade und die Barmherzigkeit.',
        ...
        7: 'Und man wird ihnen nicht Brot brechen bei der Trauer, um jemand zu trösten über den Toten, noch ihnen zu trinken geben aus dem Becher des Trostes über jemandes Vater und über jemandes Mutter.',
        ...
        18: 'Und zuvor will ich zweifach vergelten ihre Ungerechtigkeit und ihre Sünde, weil sie mein Land mit den Leichen ihrer Scheusale entweiht und mein Erbteil mit ihren Greueln erfüllt haben.',
    ...
    22: {
        ...
        7: 'Und ich werde Verderber wider dich weihen, einen jeden mit seinen Waffen, und sie werden die Auswahl deiner Zedern umhauen und ins Feuer werfen.',
    ...
    28: {
        1: 'Und es geschah in demselben Jahre, im Anfang der Regierung Zedekias, des Königs von Juda, im vierten Jahre, im fünften Monat, da sprach zu mir Hananja, der Sohn Assurs, der Prophet, der von Gibeon war, im Hause Jehovas vor den Augen der Priester und alles Volkes,',
        2: 'und sagte: So spricht Jehova der Heerscharen, der Gott Israels, und sagt: Ich zerbreche das Joch des Königs von Babel.',
    ...
    29: {
        ...
        32: 'darum spricht Jehova also: Siehe, ich will Schemaja, den Nechelamiter, und seinen Samen heimsuchen: Er soll niemand haben, der inmitten dieses Volkes wohne, und er soll das Gute nicht sehen, welches ich meinem Volke tun werde, spricht Jehova; denn er hat Abfall geredet wider Jehova.',
    },
    30: {
        1: 'Das Wort, welches von seiten Jehovas zu Jeremia geschah, also:',
    ...
    42: {
        ...
        8: 'Und er berief Jochanan, den Sohn Kareachs, und alle Heerobersten, die mit ihm waren, und das ganze Volk, vom Kleinsten bis zum Größten, und sprach zu ihnen:',
        9: 'So spricht Jehova, der Gott Israels, an welchen ihr mich gesandt habt, um euer Flehen vor ihn kommen zu lassen:',
        ...
        13: 'Wenn ihr aber sprechet: Wir wollen nicht in diesem Lande bleiben, so daß ihr nicht höret auf die Stimme Jehovas, eures Gottes, und sprechet:',
        14: 'Nein, sondern wir wollen in das Land Ägypten ziehen, wo wir keinen Krieg sehen und den Schall der Posaune nicht hören und nicht nach Brot hungern werden, und daselbst wollen wir wohnen-',
    ...
    52: {
        ...
        16: 'Aber von den Geringen des Landes ließ Nebusaradan, der Oberste der Leibwache, zurück zu Weingärtnern und zu Ackersleuten.',
        ...
        29: 'im achtzehnten Jahre Nebukadrezars achthundertzweiunddreißig Seelen aus Jerusalem;',
        30: 'im dreiundzwanzigsten Jahre Nebukadrezars führte Nebusaradan, der Oberste der Leibwache, von den Juden siebenhundertfünfundvierzig Seelen weg; aller Seelen waren viertausendsechshundert.',
        31: 'Und es geschah im siebenunddreißigsten Jahre der Wegführung Jojakins, des Königs von Juda, im zwölften Monat, am Fünfundzwanzigsten des Monats, da erhob Ewil-Merodak, der König von Babel, im ersten Jahre seiner Regierung das Haupt Jojakins, des Königs von Juda, und führte ihn aus dem Gefängnis.',
