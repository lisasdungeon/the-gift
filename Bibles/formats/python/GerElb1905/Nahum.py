...
CHAPTERS = {
    1: {
        ...
        6: 'Wer kann vor seinem Grimm bestehen, und wer standhalten bei der Glut seines Zornes? Sein Grimm ergießt sich wie Feuer, und die Felsen werden von ihm zerrissen.',
        ...
        14: 'Und über dich hat Jehova geboten, daß von deinem Namen nicht mehr gesät werden soll; aus dem Hause deines Gottes werde ich das geschnitzte und das gegossene Bild ausrotten; ich werde dir ein Grab machen, denn verächtlich bist du.',
        15: 'Siehe, auf den Bergen die Füße dessen, der gute Botschaft bringt, der Frieden verkündigt! Feiere, Juda, deine Feste, bezahle deine Gelübde! Denn der Nichtswürdige wird fortan nicht mehr durch dich ziehen; er ist ganz ausgerottet.',
    },
    2: {
    ...
    3: {
        ...
        7: 'Und es wird geschehen, jeder, der dich sieht, wird von dir fliehen und sprechen: Ninive ist verwüstet! Wer wird ihr Beileid bezeigen? Woher soll ich dir Tröster suchen?',
        ...
        14: 'Schöpfe dir Wasser für die Belagerung; bessere deine Festungswerke aus! Tritt den Ton stampfe den Lehm, stelle den Ziegelofen wieder her!',
        15: 'Dort wird das Feuer dich verzehren, wird das Schwert dich ausrotten, dich verzehren wie der Jelek. Vermehre dich wie der Jelek, vermehre dich wie die Heuschrecken!',
        16: 'Du hast deiner Kaufleute mehr gemacht als die Sterne des Himmels: der Jelek fällt raubend ein und fliegt davon.',
        17: 'Deine Auserlesenen sind wie die Heuschrecken, und deine Kriegsobersten wie Heuschreckenschwärme, die sich an den Zäunen lagern am Tage des Frostes: geht die Sonne auf, so entfliehen sie, und man weiß ihre Stätte nicht; wo sind sie?',
        ...
        19: 'Keine Linderung für deine Wunde, dein Schlag ist tödlich! Alle, welche die Kunde von dir hören, klatschen über dich in die Hände; denn über wen ist nicht deine Bosheit beständig ergangen?',
    },
}
