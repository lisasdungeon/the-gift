...
CHAPTERS = {
    ...
    9: {
        ...
        10: 'Die Ziegelsteine sind eingefallen, aber mit behauenen Steinen bauen wir auf; die Sykomoren sind abgehauen, aber wir setzen Zedern an ihre Stelle.',
    ...
    13: {
        ...
        21: 'Aber Wüstentiere werden dort lagern, und ihre Häuser mit Uhus angefüllt sein; und Strauße werden dort wohnen und Böcke dort hüpfen;',
    ...
    21: {
        ...
        11: "Ausspruch über Duma. Aus Seir ruft man mir zu: Wächter, wie weit ist's in der Nacht? Wächter, wie weit in der Nacht?",
    ...
    30: {
        ...
        14: 'Und er wird sie zerbrechen, wie man einen Töpferkrug zerbricht, der ohne Schonung zertrümmert wird, und von welchem, wenn er zertrümmert ist, nicht ein Scherben gefunden wird, um damit Feuer vom Herd zu holen oder Wasser aus einer Zisterne zu schöpfen.',
    ...
    34: {
        ...
        15: 'Dort nistet die Pfeilschlange und legt Eier und brütet sie aus in ihrem Schatten; ja, daselbst versammeln sich die Geier, einer zum anderen. -',
    ...
    37: {
        ...
        36: 'Und ein Engel Jehovas zog aus und schlug in dem Lager der Assyrer hundertfünfundachtzigtausend Mann. Und als man des Morgens früh aufstand, siehe, da waren sie allesamt Leichname.',
