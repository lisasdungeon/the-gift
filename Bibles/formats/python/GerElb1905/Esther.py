...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'Da sprachen die Diener des Königs, die ihn bedienten: Man suche dem König Mädchen, die Jungfrauen sind und schön von Ansehen;',
        ...
        4: 'Und das Mädchen, welches dem König gefallen wird, werde Königin an Vastis Statt. Und das Wort gefiel dem König; und er tat also.',
        ...
        12: 'Und wenn die Reihe an ein jedes Mädchen kam, zum König Ahasveros zu kommen, nachdem ihr zwölf Monate lang nach der Vorschrift für die Weiber geschehen war (denn also wurden die Tage ihrer Reinigung erfüllt, nämlich sechs Monate mit Myrrhenöl, und sechs Monate mit Gewürzen und mit Reinigungssalben der Weiber),',
        13: 'und wenn alsdann das Mädchen zu dem König kam, so wurde ihr alles gegeben, was sie verlangte, um es aus dem Frauenhause in das Haus des Königs mitzunehmen.',
    ...
    3: {
        ...
        13: 'Und die Briefe wurden durch die Eilboten in alle Landschaften des Königs gesandt, um alle Juden zu vertilgen, zu ermorden und umzubringen, vom Knaben bis zum Greise, Kinder und Weiber, an einem Tage, am Dreizehnten des zwölften Monats, das ist der Monat Adar, und um ihre Habe zu plündern.',
    ...
    9: {
        ...
        16: 'Und die übrigen Juden, die in den Landschaften des Königs waren, versammelten sich und standen für ihr Leben ein und erhielten Ruhe vor ihren Feinden; und sie töteten unter ihren Hassern fünfundsiebzigtausend; aber an die Beute legten sie ihre Hand nicht.',
