...
CHAPTERS = {
    ...
    6: {
        1: '主よ、あなたの怒りをもって、わたしを責めず、あなたの激しい怒りをもって、わたしを懲しめないでください。',
    ...
    55: {
        ...
        19: '昔からみくらに座しておられる神は聞いて彼らを悩まされるでしょう。 [セラ 彼らはおきてを守らず、神を恐れないからです。',
    ...
    57: {
        ...
        3: '神は天から送ってわたしを救い、わたしを踏みつける者をはずかしめられます。 [セラ すなわち神はそのいつくしみとまこととを送られるのです。',
