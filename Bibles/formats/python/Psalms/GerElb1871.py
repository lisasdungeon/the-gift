...
CHAPTERS = {
    ...
    3: {
        ...
        2: 'Viele sagen von meiner Seele: Es ist keine Rettung für ihn bei Gott!',
        3: 'Du aber, Jehova, bist ein Schild um mich her, meine Herrlichkeit, und der mein Haupt emporhebt.',
        4: 'Mit meiner Stimme rufe ich zu Jehova, und er antwortet mir von seinem heiligen Berge.',
        ...
        8: 'Von Jehova ist die Rettung; dein Segen ist auf deinem Volke.',
    },
    4: {
        ...
        2: 'Ihr Männersöhne, bis wann soll meine Herrlichkeit zur Schande sein? Bis wann werdet ihr Eitles lieben, Lüge suchen?',
        3: 'Erkennet doch, daß Jehova den Frommen für sich abgesondert hat! Jehova wird hören, wenn ich zu ihm rufe.',
        4: 'Seid erregt, und sündiget nicht! Denket nach in eurem Herzen auf eurem Lager, und seid stille!',
    ...
    5: {
        1: 'Nimm zu Ohren, Jehova, meine Worte, merke auf mein Nachsinnen!',
    ...
    6: {
        1: 'Jehova, strafe mich nicht in deinem Zorn, und züchtige mich nicht in deinem Grimm!',
    ...
    7: {
        1: 'Jehova, mein Gott, auf dich traue ich; rette mich von allen meinen Verfolgern und befreie mich!',
        ...
        5: 'So verfolge der Feind meine Seele und erreiche sie, und trete mein Leben zu Boden und strecke meine Ehre hin in den Staub.',
    ...
    8: {
        1: 'Jehova, unser Herr, wie herrlich ist dein Name auf der ganzen Erde, der du deine Majestät gestellt hast über die Himmel!',
    ...
    9: {
        1: 'Ich will Jehova preisen mit meinem ganzen Herzen, will erzählen alle deine Wundertaten.',
        ...
        16: 'Jehova ist bekannt geworden: er hat Gericht ausgeübt, indem er den Gesetzlosen verstrickt hat in dem Werke seiner Hände.',
        ...
        20: 'Lege Furcht auf sie, Jehova; mögen die Nationen wissen, daß sie Menschen sind!',
    },
    10: {
        ...
        11: 'Er spricht in seinem Herzen: Gott vergißt; er verbirgt sein Angesicht, niemals sieht ers!',
    ...
    11: {
        1: 'Auf Jehova traue ich; wie saget ihr zu meiner Seele: Fliehet wie ein Vogel nach eurem Berge?',
    ...
    12: {
        1: 'Rette, Jehova! denn der Fromme ist dahin, denn die Treuen sind verschwunden unter den Menschenkindern.',
    ...
    13: {
        1: 'Bis wann, Jehova, willst du meiner vergessen immerdar? Bis wann willst du dein Angesicht vor mir verbergen?',
    ...
    15: {
        1: 'Jehova, wer wird in deinem Zelte weilen? Wer wird wohnen auf deinem heiligen Berge?',
    ...
    17: {
        1: 'Höre, Jehova, die Gerechtigkeit, horche auf mein Schreien; nimm zu Ohren mein Gebet von Lippen ohne Trug!',
    ...
    18: {
        1: 'Ich liebe dich, Jehova, meine Stärke!',
    ...
    19: {
        1: 'Die Himmel erzählen die Herrlichkeit Gottes, und die Ausdehnung verkündet seiner Hände Werk.',
    ...
    20: {
        1: 'Jehova erhöre dich am Tage der Drangsal, der Name des Gottes Jakobs setze dich in Sicherheit;',
        2: 'Er sende deine Hülfe aus dem Heiligtum, und von Zion aus unterstütze er dich;',
        3: 'Er gedenke aller deiner Speisopfer, und dein Brandopfer wolle er annehmen!',
    ...
    21: {
        1: 'In deiner Kraft, Jehova, freut sich der König, und wie sehr frohlockt er über deine Rettung!',
        2: 'Den Wunsch seines Herzens hast du ihm gegeben, und das Verlangen seiner Lippen nicht verweigert.',
    ...
    23: {
        1: 'Jehova ist mein Hirte, mir wird nichts mangeln.',
    ...
    24: {
        ...
        6: 'Dies ist das Geschlecht derer, die nach ihm trachten, die dein Angesicht suchen-Jakob.',
        ...
        10: 'Wer ist er, dieser König der Herrlichkeit? Jehova der Heerscharen, er ist der König der Herrlichkeit!',
    },
    25: {
    ...
    28: {
        1: 'Zu dir, Jehova rufe ich; mein Fels, wende dich nicht schweigend von mir ab, damit nicht, wenn du gegen mich verstummst, ich denen gleich sei, die in die Grube hinabfahren!',
    ...
    29: {
        1: 'Gebet Jehova, ihr Söhne der Starken, gebet Jehova Herrlichkeit und Stärke!',
    ...
    30: {
        1: 'Ich will dich erheben, Jehova, denn du hast mich emporgezogen und hast nicht über mich sich freuen lassen meine Feinde.',
    ...
    31: {
        1: 'Auf dich, Jehova, traue ich; laß mich nimmer beschämt werden; errette mich in deiner Gerechtigkeit!',
    ...
    32: {
        ...
        4: 'Denn Tag und Nacht lastete auf mir deine Hand; verwandelt ward mein Saft in Sommerdürre.',
        5: 'Ich tat dir kund meine Sünde und habe meine Ungerechtigkeit nicht zugedeckt. Ich sagte: Ich will Jehova meine Übertretungen bekennen; und du, du hast vergeben die Ungerechtigkeit meiner Sünde.',
    ...
    34: {
        1: 'N Jehova will ich preisen allezeit, beständig soll sein Lob in meinem Munde sein.',
    ...
    35: {
        1: 'Streite, Jehova, mit denen, die wider mich streiten, kämpfe mit denen, die mich bekämpfen!',
        ...
        25: 'Laß sie nicht in ihrem Herzen sagen: Haha, so wollten wirs! Laß sie nicht sagen: Wir haben ihn verschlungen!',
    ...
    36: {
        1: 'Die Übertretung des Gesetzlosen spricht im Innern meines Herzens: Es ist keine Furcht Gottes vor seinen Augen.',
    ...
    37: {
        1: 'N Erzürne dich nicht über die Übeltäter, beneide nicht die, welche Unrecht tun!',
    ...
    38: {
        1: 'Jehova, strafe mich nicht in deinem Zorn, noch züchtige mich in deinem Grimm!',
    ...
    39: {
        ...
        11: 'Strafst du einen Mann mit Züchtigungen für die Ungerechtigkeit, so machst du, gleich der Motte, seine Schönheit zergehen; ja, ein Hauch sind alle Menschen.',
    ...
    40: {
        1: 'Beharrlich habe ich auf Jehova geharrt, und er hat sich zu mir geneigt und mein Schreien gehört.',
        ...
        13: 'Laß dir gefallen, Jehova, mich zu erretten! Jehova, eile zu meiner Hülfe!',
        ...
        17: 'Ich aber bin elend und arm, der Herr denkt an mich. Meine Hülfe und mein Erretter bist du; mein Gott, zögere nicht!',
    },
    41: {
        1: 'Glückselig, wer achthat auf den Armen! am Tage des Übels wird Jehova ihn erretten.',
    ...
    42: {
        1: 'Wie ein Hirsch lechzt nach Wasserbächen, also lechzt meine Seele nach dir, o Gott!',
    ...
    44: {
        1: 'Gott, mit unseren Ohren haben wir gehört, unsere Väter haben uns erzählt die Großtat, die du gewirkt hast in ihren Tagen, in den Tagen vor alters.',
        ...
        8: 'In Gott rühmen wir uns den ganzen Tag, und deinen Namen werden wir preisen ewiglich.',
    ...
    45: {
        1: 'Es wallt mein Herz von gutem Worte. Ich sage: Meine Gedichte dem Könige! Meine Zunge sei der Griffel eines fertigen Schreibers!',
        ...
        6: 'Dein Thron, o Gott, ist immer und ewiglich, ein Scepter der Aufrichtigkeit ist das Scepter deines Reiches.',
    ...
    46: {
        1: 'Gott ist uns Zuflucht und Stärke, eine Hülfe, reichlich gefunden in Drangsalen.',
        ...
        3: 'Wenn seine Wasser tobten und schäumten, die Berge erbebten durch sein Ungestüm.',
        ...
        7: 'Jehova der Heerscharen ist mit uns, eine hohe Feste ist uns der Gott Jakobs.',
        ...
        11: 'Jehova der Heerscharen ist mit uns, eine hohe Feste ist uns der Gott Jakobs.',
    },
    47: {
        1: 'Ihr Völker alle, klatschet in die Hände! Jauchzet Gott mit Jubelschall!',
        ...
        4: 'Er erwählte für uns unser Erbteil, den Stolz Jakobs, den er geliebt hat.',
    ...
    48: {
        ...
        8: 'Wie wir gehört hatten, also haben wir es gesehen in der Stadt Jehovas der Heerscharen, in der Stadt unseres Gottes: Gott wird sie befestigen bis in Ewigkeit.',
        ...
        13: 'Betrachtet genau seine Wälle, mustert seine Paläste, damit ihrs erzählet dem künftigen Geschlecht!',
    ...
    49: {
        ...
        13: 'Dieser ihr Weg ist ihre Torheit; und die nach ihnen kommen, haben Wohlgefallen an ihren Worten.',
        ...
        15: 'Gott aber wird meine Seele erlösen von der Gewalt des Scheols; denn er wird mich aufnehmen.',
    ...
    50: {
        1: 'Der Mächtige, Gott, Jehova, hat geredet und die Erde gerufen vom Aufgang der Sonne bis zu ihrem Niedergang.',
    ...
    51: {
        1: 'Sei mir gnädig, o Gott, nach deiner Güte: nach der Größe deiner Erbarmungen tilge meine Übertretungen!',
    ...
    52: {
        1: 'Was rühmst du dich des Bösen, du Gewaltiger? Die Güte Gottes währt den ganzen Tag.',
        2: 'Verderben sinnt deine Zunge, wie ein geschliffenes Schermesser Trug übend.',
        3: 'Du hast das Böse mehr geliebt, als das Gute, die Lüge mehr, als Gerechtigkeit zu reden.',
        4: 'Du hast alle Vertilgungsworte geliebt, du Zunge des Trugs!',
        5: 'Gott wird dich auch zerstören für immerdar; er wird dich fassen und herausreißen aus dem Zelte und auswurzeln aus dem Lande der Lebendigen.',
    ...
    53: {
        1: 'N N Der Tor spricht in seinem Herzen: Es ist kein Gott! Sie haben verderbt gehandelt und haben abscheulich das Unrecht geübt; da ist keiner, der Gutes tue.',
    ...
    54: {
        ...
        3: 'Denn Fremde sind wider mich aufgestanden, und Gewalttätige trachten nach meinem Leben; sie haben Gott nicht vor sich gestellt.',
    ...
    55: {
        1: 'Nimm zu Ohren, o Gott, mein Gebet, und verbirg dich nicht vor meinem Flehen!',
        ...
        7: 'Siehe, weithin entflöhe ich, würde weilen in der Wüste.',
        ...
        19: 'Hören wird Gott und sie demütigen, -er thront ja von alters her; -weil es keine Änderung bei ihnen gibt und sie Gott nicht fürchten.',
    ...
    57: {
        ...
        3: 'Vom Himmel wird er senden und mich retten; er macht zum Hohn den, der nach mir schnaubt. Senden wird Gott seine Güte und seine Wahrheit.',
        ...
        6: 'Ein Netz haben sie meinen Schritten bereitet, es beugte sich nieder meine Seele; eine Grube haben sie vor mir gegraben, sie sind mitten hineingefallen.',
    ...
    59: {
        1: 'Befreie mich von meinen Feinden, o mein Gott! setze mich in Sicherheit vor denen, die sich wider mich erheben!',
        ...
        5: 'Ja, du, Jehova, Gott der Heerscharen, Gott Israels, erwache, um heimzusuchen alle Nationen! sei keinem gnädig von den treulos Frevelnden!',
        ...
        13: 'Mache ein Ende im Grimm, mache ein Ende, daß sie nicht mehr seien, und erkennen, daß Gott in Jakob herrscht bis an die Enden der Erde!',
    ...
    61: {
        ...
        4: 'Ich werde weilen in deinem Zelte in Ewigkeit, werde Zuflucht nehmen zu dem Schutze deiner Flügel.',
    ...
    62: {
        ...
        4: 'Sie ratschlagen nur, ihn von seiner Höhe zu stoßen; sie haben Wohlgefallen an der Lüge; mit ihrem Munde segnen sie, und in ihrem Innern fluchen sie.',
        ...
        8: 'Vertrauet auf ihn allezeit, o Volk! schüttet vor ihm aus euer Herz! Gott ist unsere Zuflucht.',
    ...
    63: {
        1: 'Gott, du bist mein Gott! frühe suche ich dich. Es dürstet nach dir meine Seele, nach dir schmachtet mein Fleisch in einem dürren und lechzenden Lande ohne Wasser,',
    ...
    65: {
        1: 'Deiner harrt schweigend der Lobgesang, o Gott, in Zion, und dir wird bezahlt werden das Gelübde.',
        ...
        4: 'Glückselig der, den du erwählest und herzunahen lässest, daß er wohne in deinen Vorhöfen! wir werden gesättigt werden mit dem Guten deines Hauses, dem Heiligen deines Tempels.',
    ...
    67: {
        1: 'Gott sei uns gnädig und segne uns, er lasse sein Angesicht leuchten über uns,',
        ...
        4: 'Es werden sich freuen und jubeln die Völkerschaften; denn du wirst die Völker richten in Geradheit, und die Völkerschaften auf der Erde, du wirst sie leiten.',
    ...
    68: {
        1: 'Möge Gott aufstehen! mögen sich zerstreuen seine Feinde, und vor ihm fliehen seine Hasser!',
        ...
        7: 'Gott, als du auszogest vor deinem Volke, als du einherschrittest durch die Wüste,',
        ...
        19: 'Gepriesen sei der Herr! Tag für Tag trägt er unsere Last; Gott ist unsere Rettung.',
        ...
        30: 'Schilt das Tier des Schülfes, die Schar der Stiere mit den Kälbern der Völker; jeder wird sich dir unterwerfen mit Silberbarren. Zerstreue die Völker, die Lust haben am Kriege!',
        31: 'Es werden kommen die Großen aus Ägypten; Äthiopien wird eilends seine Hände ausstrecken zu Gott.',
        32: 'Ihr Königreiche der Erde, singet Gott, besinget den Herrn,',
    ...
    70: {
        1: 'Eile, Gott, mich zu erretten, Jehova, zu meiner Hülfe!',
    ...
    72: {
        1: 'O Gott, gib dem Könige deine Gerichte, und deine Gerechtigkeit dem Sohne des Königs!',
        ...
        12: 'Denn erretten wird er den Armen, der um Hülfe ruft, und den Elenden, der keinen Helfer hat;',
    ...
    74: {
        1: 'Gott, warum hast du verworfen für immer, raucht dein Zorn wider die Herde deiner Weide?',
    ...
    75: {
        ...
        3: 'Zerschmolzen sind die Erde und alle ihre Bewohner: Ich habe ihre Säulen festgestellt."',
    ...
    76: {
        ...
        3: 'Dort zerbrach er des Bogens Blitze, Schild und Schwert und Krieg.',
        ...
        9: 'Als Gott aufstand zum Gericht, um zu retten alle Sanftmütigen des Landes.',
    ...
    77: {
        1: 'Meine Stimme ist zu Gott, und ich will schreien; meine Stimme ist zu Gott, und er wird mir Gehör schenken.',
        ...
        3: 'Ich gedachte Gottes, und ich stöhnte; ich sann nach, und mein Geist ermattete.',
        ...
        9: 'Hat Gott vergessen gnädig zu sein? Hat er im Zorn verschlossen seine Erbarmungen?',
        ...
        15: 'Du hast dein Volk erlöst mit erhobenem Arm, die Söhne Jakobs und Josephs.',
    ...
    80: {
        ...
        10: 'Die Berge wurden bedeckt von seinem Schatten, und seine Äste waren gleich Cedern Gottes;',
    ...
    81: {
        ...
        7: 'In der Bedrängnis riefest du, und ich befreite dich; ich antwortete dir in des Donners Hülle; ich prüfte dich an den Wassern von Meriba.',
    ...
    82: {
        ...
        2: 'Bis wann wollt ihr ungerecht richten und die Person der Gesetzlosen ansehen?',
    ...
    83: {
        ...
        8: 'Auch Assur hat sich ihnen angeschlossen; sie sind zu einem Arm geworden den Söhnen Lots.',
    ...
    84: {
        1: 'Wie lieblich sind deine Wohnungen, Jehova der Heerscharen!',
        ...
        4: 'Glückselig, die da wohnen in deinem Hause! stets werden sie dich loben.',
        ...
        8: 'Jehova, Gott der Heerscharen, höre mein Gebet; nimm zu Ohren, du Gott Jakobs!',
    ...
    85: {
        1: 'Jehova, du hast Gunst erzeigt deinem Lande, hast die Gefangenschaft Jakobs gewendet;',
        2: 'Du hast vergeben die Ungerechtigkeit deines Volkes, all ihre Sünde hast du zugedeckt.',
    ...
    87: {
        ...
        3: 'Herrliches ist von dir geredet, du Stadt Gottes.',
    ...
    88: {
        1: 'Jehova, Gott meiner Rettung! des Tages habe ich geschrieen und des Nachts vor dir.',
        ...
        7: 'Auf mir liegt schwer dein Grimm, und mit allen deinen Wellen hast du mich niedergedrückt.',
        ...
        10: 'Wirst du an den Toten Wunder tun? Oder werden die Schatten aufstehen, dich preisen?',
    ...
    89: {
        1: 'Die Gütigkeiten Jehovas will ich besingen ewiglich, von Geschlecht zu Geschlecht mit meinem Munde kundmachen deine Treue.',
        ...
        4: '"Bis in Ewigkeit will ich feststellen deinen Samen, und auf alle Geschlechter hin bauen deinen Thron."',
        ...
        19: 'Dazumal redetest du im Gesicht von deinem Frommen und sagtest: Hülfe habe ich auf einen Mächtigen gelegt, ich habe einen Auserwählten erhöht aus dem Volke.',
        ...
        37: 'Ewiglich wird er feststehen wie der Mond; und der Zeuge in den Wolken ist treu.',
        ...
        45: 'Du hast verkürzt die Tage seiner Jugend, mit Schmach hast du ihn bedeckt.',
        ...
        48: 'Welcher Mann lebt und wird den Tod nicht sehen, wird seine Seele befreien von der Gewalt des Scheols?',
    ...
    90: {
        1: 'Herr, du bist unsere Wohnung gewesen von Geschlecht zu Geschlecht.',
        ...
        13: 'Kehre wieder, Jehova! -Bis wann? -Und laß dichs gereuen über deine Knechte!',
    ...
    92: {
        1: 'Es ist gut, Jehova zu preisen, und Psalmen zu singen deinem Namen, o Höchster!',
    ...
    96: {
        1: 'N Singet Jehova ein neues Lied, singet Jehova, ganze Erde!',
    ...
    98: {
        1: 'Singet Jehova ein neues Lied! denn er hat Wunder getan; Rettung hat ihm verschafft seine Rechte und sein heiliger Arm.',
    ...
    101: {
        1: 'Von Güte und Recht will ich singen; dir, Jehova, will ich Psalmen singen.',
    ...
    105: {
        1: 'N Preiset Jehova, rufet an seinen Namen, machet kund unter den Völkern seine Taten!',
    ...
    106: {
        ...
        45: 'Und er gedachte ihnen seinen Bund, und es reute ihn nach der Größe seiner Güte.',
    ...
    108: {
        ...
        12: 'Schaffe uns Hülfe aus der Bedrängnis! Menschenrettung ist ja eitel.',
    ...
    111: {
        1: 'N Preisen will ich Jehova von ganzem Herzen im Kreise der Aufrichtigen und in der Gemeinde.',
    ...
    112: {
        1: 'N Glückselig der Mann, der Jehova fürchtet, der große Lust hat an seinen Geboten!',
    ...
    113: {
        1: 'Lobet, ihr Knechte Jehovas, lobet den Namen Jehovas!',
    ...
    117: {
        1: 'Lobet Jehova, alle Nationen! Rühmet ihn, alle Völker!',
        2: 'Denn mächtig über uns ist seine Güte; und die Wahrheit Jehovas währt ewiglich. Lobet Jehova!',
    },
    118: {
        1: 'Preiset Jehova! denn er ist gut, denn seine Güte währt ewiglich.',
    ...
    119: {
        1: 'N Glückselig, die im Wege untadelig sind, die da wandeln im Gesetze Jehovas!',
    ...
    120: {
        1: 'Zu Jehova rief ich in meiner Bedrängnis, und er erhörte mich.',
    ...
    121: {
        1: 'Ich hebe meine Augen auf zu den Bergen, woher meine Hülfe kommen wird.',
    ...
    122: {
        1: 'Ich freute mich, als sie zu mir sagten: Lasset uns zum Hause Jehovas gehen!',
    ...
    123: {
        1: 'Ich hebe meine Augen auf zu dir, der du thronst in den Himmeln!',
    ...
    124: {
        1: 'Wenn nicht Jehova für uns gewesen wäre, sage doch Israel,',
    ...
    125: {
        1: 'Die auf Jehova vertrauen, sind gleich dem Berge Zion, der nicht wankt, der ewiglich bleibt.',
    ...
    126: {
        1: 'Als Jehova die Gefangenen Zions zurückführte, waren wir wie Träumende.',
    ...
    127: {
        1: 'Von Salomo. Wenn Jehova das Haus nicht baut, vergebens arbeiten daran die Bauleute; wenn Jehova die Stadt nicht bewacht, vergebens wacht der Wächter.',
    ...
    128: {
        1: 'Glückselig ein jeder, der Jehova fürchtet, der da wandelt in seinen Wegen!',
    ...
    130: {
        1: 'Aus den Tiefen rufe ich zu dir, Jehova!',
    ...
    131: {
        1: 'Jehova! nicht hoch ist mein Herz, noch tragen sich hoch meine Augen; und ich wandle nicht in Dingen, die zu groß und zu wunderbar für mich sind.',
    ...
    132: {
        1: 'Gedenke, Jehova, dem David alle seine Mühsal!',
    ...
    133: {
        1: 'Siehe, wie gut und wie lieblich ist es, wenn Brüder einträchtig beieinander wohnen!',
    ...
    134: {
        1: 'Siehe, preiset Jehova, alle ihr Knechte Jehovas, die ihr stehet im Hause Jehovas in den Nächten!',
        2: 'Erhebet eure Hände im Heiligtum und preiset Jehova!',
        3: 'Jehova segne dich von Zion aus, der Himmel und Erde gemacht hat!',
    },
    135: {
        1: 'Lobet den Namen Jehovas! Lobet, ihr Knechte Jehovas,',
        ...
        14: 'Denn Jehova wird sein Volk richten, und er wird sichs gereuen lassen über seine Knechte.',
    ...
    138: {
        ...
        8: 'Jehova wirds für mich vollenden. Jehova, deine Güte währt ewiglich. Laß nicht die Werke deiner Hände!',
    },
    139: {
        1: 'Jehova! du hast mich erforscht und erkannt.',
    ...
    140: {
        1: 'Befreie mich, Jehova, von dem bösen Menschen; vor dem Manne der Gewalttaten behüte mich!',
        ...
        5: 'Die Hoffärtigen haben mir heimlich eine Schlinge und Fallstricke gelegt, ein Netz ausgespannt zur Seite des Weges, sie haben mir Fallen gestellt.',
        ...
        8: 'Gewähre nicht, Jehova, die Gelüste des Gesetzlosen, laß sein Vorhaben nicht gelingen: sie würden sich erheben.',
    ...
    141: {
        1: 'Jehova! zu dir habe ich gerufen, eile zu mir; nimm zu Ohren meine Stimme, wenn ich zu dir rufe!',
    ...
    142: {
        1: 'Mit meiner Stimme schreie ich zu Jehova, mit meiner Stimme flehe ich zu Jehova.',
    ...
    143: {
        1: 'Jehova! höre mein Gebet, nimm zu Ohren mein Flehen; erhöre mich in deiner Treue, in deiner Gerechtigkeit!',
        ...
        6: 'Zu dir breite ich meine Hände aus; gleich einem lechzenden Lande lechzt meine Seele nach dir.',
    ...
    144: {
        1: 'Gepriesen sei Jehova, mein Fels, der meine Hände unterweist zum Kampf, meine Finger zum Kriege:',
    ...
    145: {
        1: 'N Ich will dich erheben, mein Gott, du König, und deinen Namen preisen immer und ewiglich.',
    ...
    146: {
        ...
        5: 'Glückselig der, dessen Hülfe der Gott Jakobs, dessen Hoffnung auf Jehova, seinen Gott, ist!',
    ...
    148: {
        1: 'Lobet Jehova von den Himmeln her; lobet ihn in den Höhen!',
    ...
    149: {
        1: 'Singet Jehova ein neues Lied, sein Lob in der Versammlung der Frommen!',
    ...
    150: {
        1: 'Lobet Gott in seinem Heiligtum; lobet ihn in der Feste seiner Stärke!',
