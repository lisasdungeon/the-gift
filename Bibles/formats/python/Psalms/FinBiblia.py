...
CHAPTERS = {
    ...
    4: {
        1: 'Davidin Psalmi, edelläveisaajalle, kanteleilla. (H 4:2) Rukoillessani kuule minua, vanhurskauteni Jumala, joka minua lohdutat ahdistuksessani: ole minulle armollinen, ja kuule rukoukseni.',
    ...
    5: {
        1: 'Davidin Psalmi, edelläveisaajalle, perimisestä. (H 5:2) Herra, ota minun sanani korviis, havaitse minun puheeni.',
    ...
    6: {
        1: 'Davidin Psalmi, edelläveisaajalle, kahdeksalla kielellä. (H 6:2) Oi Herra, älä rankaise minua vihassas, ja älä minua julmuudessas kurita.',
    ...
    7: {
        1: 'Davidin viattomuus, josta hän Herralle veisasi, Kuusin Jeminin pojan sanan tähden: (H 7:2) Sinuun, Herra minun Jumalani, minä uskallan: auta minua kaikista minun vainollisistani, ja pelasta minua;',
    ...
    8: {
        1: 'Davidin Psalmi, edelläveisaajalle, Gittitin päällä. (H 8:2) Herra meidän Herramme! kuinka ihmeellinen on sinun nimes kaikessa maassa, joka panit kunnias taivasten ylitse.',
    ...
    9: {
        1: 'Davidin Psalmi, kauniista nuoruudesta, edelläveisaajalle. (H 9:2) Minä kiitän Herraa kaikesta sydämestäni, ja luettelen kaikki sinun ihmees.',
    ...
    12: {
        1: 'Davidin Psalmi, edelläveisaajalle, kahdeksalla kielellä. (H 12:2) Auta, Herra; sillä pyhät ovat vähentyneet, ja uskolliset ovat harvat ihmisten lasten seassa.',
    ...
    18: {
        1: 'Edelläveisaajalle, Davidin Herran palvelian Psalmi, joka Herralle nämät veisun sanat puhui sinä päivänä, jona Herra hänen vapahti kaikkein vihollistensa käsistä ja Saulin käsistä. (H18:2) Ja hän sanoi: minä rakastan sydämestäni sinua, Herra, minun voimani.',
    ...
    19: {
        1: 'Davidin Psalmi, edelläveisaajalle. (H19:2) Taivaat ilmoittavat Jumalan kunnian, ja vahvuus julistaa hänen kättensä teot.',
    ...
    21: {
        1: 'Davidin Psalmi, edelläveisaajalle. (H21:2) Herra, Kuningas riemuitsee sinun voimassas: ja kuinka suuresti hän iloitsee avustas!',
    ...
    22: {
        1: 'Davidin Psalmi, edelläveisaajalle, peurasta, jota varhain väijytään. (H22:2) Minun Jumalani, minun Jumalani! miksis minun hylkäsit? minä parun, vaan minun apuni on kaukana.',
    ...
    30: {
        1: 'Psalmi, veisattava Davidin huoneen vihkimisessä. (H30:2) Minä ylistän sinua, Herra, sillä sinä olet korottanut minua: et myös salli viholliseni iloita minusta.',
    ...
    31: {
        1: 'Davidin Psalmi edelläveisaajalle. (H31:2) Herra, sinuun minä uskallan, etten minä ikänä häpiään tulisi: vapahda minua sinun vanhurskautes kautta.',
    ...
    34: {
        1: 'Davidin Psalmi, koska hän muotonsa muutti Abimelekin edessä, joka hänen ajoi pois tyköänsä ja hän meni pois. (H34:2) Minä kiitän Herraa aina: hänen kiitoksensa on alati minun suussani.',
    ...
    36: {
        1: 'Davidin, Herran palvelian Psalmi, edelläveisaajalle. (H36:2) Se on sydämestäni sanottu jumalattomain menosta: ei he ensinkään Jumalaa pelkää.',
    ...
    38: {
        1: 'Davidin Psalmi muistoksi. (H38:2) Herra, älä rankaise minua vihassas, ja älä kurita minua hirmuisuudessas!',
    ...
    39: {
        1: 'Davidin Psalmi, Jedutunilta, edelläveisaajalle. (H39:2) Minä olen sanonut: minä tahdon pitää vaarin teistäni, etten minä tekisi syntiä kielelläni: minä hallitsen suuni niinkuin suitsilla, niin kauvan kuin minä näen jumalattoman edessäni.',
    ...
    40: {
        1: 'Davidin Psalmi, edelläveisaajalle. (H40:2) Minä hartaasti odotin Herraa: ja hän kallisti itsensä minun tyköni, ja hän kuuli minun huutoni.',
    ...
    41: {
        1: 'Davidin Psalmi, edelläveisaajalle. (H41:2) Autuas on, joka köyhää holhoo: häntä Herra auttaa pahana päivänä.',
