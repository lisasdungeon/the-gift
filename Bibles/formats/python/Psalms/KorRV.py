...
CHAPTERS = {
    ...
    54: {
        1: '다윗의 마스길, 영장으로 현악에 맞춘 노래, 십 인이 사울에게 이르러 말하기를 다윗이 우리 곳에 숨지 아니하였나이까 하던 때에 하나님이여 주의 이름으로 나를 구원하시고 주의 힘으로 나를 판단하소서',
    ...
    60: {
        1: '다윗이 교훈하기 위하여 지은 믹담, 영장으로 수산에둣에 맞춘 노래, 다윗이 아람 나하라임과 아람소바와 싸우는 중에 요압이 돌아와 에돔을 염곡에서 쳐서 일만 이천 인을 죽인 때에 하나님이여 주께서 우리를 버려 흩으셨고 분노하셨사오나 지금은 우리를 회복시키소서',
    ...
    70: {
        1: '다윗의 기념케 하는 시, 영장으로 한 노래 하나님이여 속히 나를 건지소서 여호와여 속히 나를 도우소서',
