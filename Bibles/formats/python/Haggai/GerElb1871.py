...
CHAPTERS = {
    ...
    2: {
        1: 'Im siebten Monat, am 21. des Monats, geschah das Wort Jehovas durch den Propheten Haggai also:',
        2: 'Rede doch zu Serubbabel, dem Sohne Schealtiels, dem Landpfleger von Juda, und zu Josua, dem Sohne Jozadaks, dem Hohenpriester, und zu dem Überrest des Volkes, und sprich:',
        ...
        4: 'Und nun sei stark, Serubbabel, spricht Jehova; und sei stark, Josua, Sohn Jozadaks, du Hoherpriester, und seid stark, alles Volk des Landes, spricht Jehova, und arbeitet! denn ich bin mit euch, spricht Jehova der Heerscharen.',
        ...
        10: 'Am 24. des neunten Monats, im zweiten Jahre des Darius, geschah das Wort Jehovas zu dem Propheten Haggai also:',
        ...
        18: 'Richtet doch euer Herz auf die Zeit von diesem Tage an und aufwärts; von dem 24. Tage des neunten Monats an, von dem Tage an, da der Tempel Jehovas gegründet wurde, richtet euer Herz darauf!',
        ...
        20: 'Und das Wort Jehovas geschah zum zweiten Male zu Haggai, am 24. des Monats, also:',
        21: 'Rede zu Serubbabel, dem Landpfleger von Juda, und sprich: Ich werde den Himmel und die Erde erschüttern.',
        22: 'Und ich werde den Thron der Königreiche umstürzen und die Macht der Königreiche der Nationen vernichten; und ich werde die Streitwagen umstürzen und die darauf fahren; und die Rosse und ihre Reiter sollen hinfallen, ein jeder durch das Schwert des anderen.',
