...
CHAPTERS = {
    ...
    2: {
        ...
        15: 'Et maintenant, considérez bien, je vous prie, [ce qui va arriver] dès ce jour et dorénavant: avant qu’on ait mis pierre sur pierre au temple de l’ Éternel, –',
        16: 'avant que ces [jours] soient, si l’on venait à un tas de 20 [boisseaux], il y en avait dix; si l’on venait à la cuve pour puiser 50 mesures, il y en avait 20;',
