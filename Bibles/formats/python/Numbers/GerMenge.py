...
CHAPTERS = {
    ...
    12: {
        1: 'Mirjam und Aaron aber redeten gegen Mose wegen des kuschitischen Weibes, das er zur Frau genommen hatte; er hatte nämlich eine Kuschitin geheiratet.',
    ...
    13: {
        ...
        23: 'Als sie dann ins Tal Eskol gekommen waren, schnitten sie dort eine Rebe mit einer einzigen Weintraube ab, die sie zu zweien an einer Stange trugen, auch einige Granatäpfel und Feigen.',
        24: 'Die betreffende Örtlichkeit nannte man Tal Eskol wegen der Traube, welche die Israeliten dort abgeschnitten hatten.',
        ...
        29: 'Die Amalekiter bewohnen das Südland, die Hethiter, Jebusiter und Amoriter wohnen im Berglande, und die Kanaanäer wohnen am Meer und an der Seite des Jordans.«',
    ...
    15: {
        ...
        15: 'Für die ganze Bevölkerung gilt eine und dieselbe Satzung, für euch wie für den Fremdling, der sich als Gast bei euch aufhält; eine ewiggültige Satzung soll es für euch von Geschlecht zu Geschlecht sein: vor dem HERRN soll der Fremdling ebenso dastehen wie ihr selbst.',
        ...
        19: 'so sollt ihr, wenn ihr von dem Brotkorn des Landes eßt, für den HERRN ein Hebeopfer abgeben.',
        20: 'Als Erstling eures Schrotmehls sollt ihr einen Kuchen als Hebeopfer abgeben; wie die Hebe von der Tenne, ebenso sollt ihr auch diese abgeben.',
        21: 'Von den Erstlingen eures Schrotmehls sollt ihr dem HERRN ein Hebeopfer abgeben in allen euren künftigen Geschlechtern.«',
        22: '»Und wenn ihr euch unabsichtlich vergeht und irgendeines von diesen Geboten, die der HERR dem Mose aufgetragen hat, unbefolgt laßt,',
        ...
        31: 'denn er hat das Wort des HERRN verachtet und sein Gebot übertreten; ein solcher Mensch soll ohne Gnade ausgerottet werden: seine Schuld komme über ihn!«',
    ...
    16: {
        ...
        2: 'Diese empörten sich gegen Mose und mit ihnen zweihundertundfünfzig Israeliten, welche Vorsteher der Gemeinde, aus der Gemeindeversammlung berufene und hochangesehene Männer waren.',
        3: 'Sie rotteten sich also gegen Mose und Aaron zusammen und sagten zu ihnen: »Ihr beansprucht für euch zu viel; denn die ganze Gemeinde, alle ohne Ausnahme sind heilig, weil der HERR in ihrer Mitte weilt: warum erhebt ihr euch da über die Gemeinde des HERRN?«',
        ...
        7: 'tut morgen Feuer hinein und legt vor dem HERRN Räucherwerk darauf; wen dann der HERR erwählt, der soll als geweiht gelten! Damit gebt euch zufrieden, ihr Söhne Levis!«',
        ...
        30: 'wenn aber der HERR etwas noch nie Vorgekommenes geschehen läßt und der Erdboden seinen Mund auftut und sie mit allem, was ihnen gehört, verschlingt, so daß sie lebendig in das Totenreich hinabfahren, so werdet ihr daran erkennen, daß diese Männer Verächter des HERRN gewesen sind!«',
    ...
    17: {
        ...
        6: 'Am folgenden Tage aber murrte die ganze Gemeinde der Israeliten gegen Mose und Aaron; sie riefen: »Ihr habt das Volk des HERRN umgebracht!«',
    ...
    20: {
        ...
        9: 'Da holte Mose den Stab vor dem HERRN weg, wie der HERR ihm geboten hatte.',
        ...
        13: 'Das ist das Haderwasser (von Kades), wo die Israeliten mit dem HERRN gehadert haben und er sich an ihnen als der Heilige erwies.',
        ...
        17: 'Gestatte uns doch den Durchzug durch dein Land! Wir wollen nicht durch die Äcker und durch die Weinberge ziehen, auch kein Wasser aus den Brunnen trinken; nein, auf der Königsstraße wollen wir ziehen, ohne nach rechts und nach links abzubiegen, bis wir dein Gebiet durchzogen haben.«',
    ...
    22: {
        ...
        8: 'Er aber antwortete ihnen: »Bleibt diese Nacht hier, dann will ich euch Bescheid geben, je nachdem der HERR mir Weisung erteilt.« So blieben denn die Fürsten der Moabiter bei Bileam.',
        ...
        15: 'Da sandte Balak noch einmal Fürsten ab, die zahlreicher und vornehmer waren als die ersten.',
        ...
        17: 'Denn ich will dich gar hoch ehren und alles tun, was du von mir verlangen wirst. So komm doch her und verfluche mir dieses Volk!‹«',
        ...
        32: 'Der Engel des HERRN aber sagte zu ihm: »Warum hast du deine Eselin nun schon dreimal geschlagen? Wisse wohl: ich habe mich aufgemacht, um dir feindlich entgegenzutreten; denn diese deine Reise ist unheilvoll und gegen meinen Willen.',
        ...
        37: 'Da sagte Balak zu Bileam: »Habe ich nicht in angemessener Weise zu dir gesandt, um dich rufen zu lassen? Warum bist du nicht sofort zu mir gekommen? Meinst du vielleicht, ich sei nicht imstande, dich zu ehren?«',
        ...
        40: 'Dort schlachtete Balak Rinder und Kleinvieh und schickte davon an Bileam und an die Fürsten, die bei ihm waren.',
    ...
    23: {
        ...
        10: 'Wer könnte den Staub Jakobs zählen oder nur den vierten Teil Israels berechnen? Möchte ich doch den Tod dieser Gerechten sterben und mein Ende dem ihren gleichen!«',
    ...
    27: {
        ...
        4: 'Warum soll nun der Name unseres Vaters aus seinem Geschlecht gestrichen werden, weil er keinen Sohn gehabt hat? Gib uns einen Erbbesitz unter den Geschlechtsgenossen unseres Vaters!«',
        ...
        12: 'Hierauf gebot der HERR dem Mose: »Steige auf das Gebirge Abarim hier und sieh dir das Land an, das ich für die Israeliten bestimmt habe.',
        ...
        14: 'weil ihr in der Wüste Zin, als die Gemeinde mit mir haderte, meinem Geheiß, mich durch Beschaffung von Wasser vor ihnen zu verherrlichen, nicht nachgekommen seid« – das bezieht sich auf das Haderwasser von Kades in der Wüste Zin.',
        ...
        20: 'und teile ihm etwas von deiner Hoheit mit, damit die ganze Gemeinde der Israeliten ihm gehorsam ist.',
        21: 'Er soll sich dann (bei jeder Gelegenheit) an den Priester Eleasar wenden, damit dieser für ihn das Urim-Orakel vor dem HERRN befragt: nach dessen Weisung sollen sie zum Kampf ausziehen und ebenso nach dessen Weisung wieder heimkehren, er und alle Israeliten mit ihm, überhaupt die ganze Gemeinde.«',
    ...
    30: {
        ...
        4: 'Wenn aber eine weibliche Person, die in ihrer Jugend im Hause ihres Vaters lebt, dem HERRN ein Gelübde ablegt oder sich zu einer Enthaltung verpflichtet',
        ...
        10: 'Aber das Gelübde einer Witwe oder einer verstoßenen Frau, alles, wozu sie sich verpflichtet hat, soll für sie verbindlich sein.',
        ...
        17: 'Das sind die Verordnungen, die der HERR dem Mose geboten hat, damit sie Geltung haben zwischen einem Manne und seiner Frau und zwischen einem Vater und seiner Tochter, solange diese in ihrer Jugend im Hause ihres Vaters lebt.',
    },
    31: {
