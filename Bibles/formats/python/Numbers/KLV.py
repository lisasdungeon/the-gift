...
CHAPTERS = {
    ...
    16: {
        ...
        4: "ghorgh Moses Qoyta' 'oH, ghaH pumta' Daq Daj qab:",
        ...
        8: "Moses ja'ta' Daq Korah, “Qoy DaH, SoH puqloDpu' vo' Levi!",
        ...
        26: "ghaH jatlhta' Daq the tay' ghotpu', ja'ta', “mej, please, vo' the tents vo' Dochvammey mIgh loDpu', je touch pagh vo' theirs, lest SoH taH Soppu' Daq Hoch chaj yemmey!”",
    ...
    18: {
        1: "joH'a' ja'ta' Daq Aaron, “SoH je lIj puqloDpu' je lIj fathers' tuq tlhej SoH DIchDaq SIQ the He'taHghach vo' the Daq QaD; je SoH je lIj puqloDpu' tlhej SoH DIchDaq SIQ the He'taHghach vo' lIj priesthood.",
        2: "lIj loDnI'pu' je, the tuq vo' Levi, the tuq vo' lIj vav, qem Sum tlhej SoH, vetlh chaH may taH joined Daq SoH, je minister Daq SoH: 'ach SoH je lIj puqloDpu' tlhej SoH DIchDaq taH qaSpa' the juHHom vo' the testimony.",
        3: "chaH DIchDaq pol lIj commands, je the duty vo' Hoch the juHHom: neH chaH DIchDaq ghobe' ghoS Sum Daq the Dujmey vo' the Daq QaD je Daq the lalDanta' Daq, vetlh chaH ghobe' Hegh, ghobe' chaH, ghobe' SoH.",
        4: "chaH DIchDaq taH joined Daq SoH, je pol the responsibility vo' the juHHom vo' qep, vaD Hoch the toy'taHghach vo' the juHHom: je a stranger DIchDaq ghobe' ghoS Sum Daq SoH.",
        5: "“SoH DIchDaq perform the duty vo' the Daq QaD, je the duty vo' the lalDanta' Daq; vetlh pa' taH QeHpu' ghobe' latlh Daq the puqpu' vo' Israel.",
        6: "jIH, yIlegh, jIH ghaj tlhappu' lIj loDnI'pu' the Levites vo' among the puqpu' vo' Israel: Daq SoH chaH 'oH a gift, nobpu' Daq joH'a', Daq ta' the toy'taHghach vo' the juHHom vo' qep.",
        7: "SoH je lIj puqloDpu' tlhej SoH DIchDaq pol lIj priesthood vaD everything vo' the lalDanta' Daq, je vaD vetlh within the veil; je SoH DIchDaq toy': jIH nob SoH the priesthood as a toy'taHghach vo' gift: je the stranger 'Iv choltaH Sum DIchDaq taH lan Daq Hegh.”",
        8: "joH'a' jatlhta' Daq Aaron, “jIH, yIlegh, jIH ghaj nobpu' SoH the ra'ta'ghach mu'mey vo' wIj wave nobmey, 'ach Hoch the le' Dochmey vo' the puqpu' vo' Israel; Daq SoH ghaj jIH nobpu' chaH Sum meq vo' the anointing, je Daq lIj puqloDpu', as a portion reH.",
        9: "vam DIchDaq taH yours vo' the HochHom le' Dochmey, reserved vo' the qul: Hoch cha'nob vo' theirs, 'ach Hoch 'uQ cha'nob vo' theirs, je Hoch yem cha'nob vo' theirs, je Hoch trespass cha'nob vo' theirs, nuq chaH DIchDaq render Daq jIH, DIchDaq taH HochHom le' vaD SoH je vaD lIj puqloDpu'.",
        10: "SoH DIchDaq Sop vo' 'oH rur the HochHom le' Dochmey. Hoch male DIchDaq Sop vo' 'oH. 'oH DIchDaq taH le' Daq SoH.",
        11: "“vam ghaH yours, too: the wave cha'nob vo' chaj gift, 'ach Hoch the wave nobmey vo' the puqpu' vo' Israel. jIH ghaj nobpu' chaH Daq SoH, je Daq lIj puqloDpu' je Daq lIj puqbe'pu' tlhej SoH, as a portion reH. Hoch 'Iv ghaH Say Daq lIj tuq DIchDaq Sop vo' 'oH.",
        12: "“Hoch the best vo' the Hergh, je Hoch the best vo' the vintage, je vo' the grain, the wa'Dich fruits vo' chaH nuq chaH nob Daq joH'a', Daq SoH ghaj jIH nobpu' chaH.",
        13: "The wa'Dich-ripe fruits vo' Hoch vetlh ghaH Daq chaj puH, nuq chaH qem Daq joH'a', DIchDaq taH yours; Hoch 'Iv ghaH Say Daq lIj tuq DIchDaq Sop vo' 'oH.",
        14: '“Everything devoted Daq Israel DIchDaq taH yours.',
        15: "Everything vetlh opens the womb, vo' Hoch ghab nuq chaH nob Daq joH'a', both vo' loD je animal DIchDaq taH yours: nevertheless SoH DIchDaq DIch redeem the firstborn vo' loD, je SoH DIchDaq redeem the firstborn vo' Say'Ha' Ha'DIbaH.",
        16: "SoH DIchDaq redeem chaH 'Iv 'oH Daq taH toDta' vo' chaH vo' a jar qan, according Daq lIj estimation, vaD vagh shekels vo' Huch, after the shekel vo' the Daq QaD (the rap ghaH cha'maH gerahs).",
        17: "“'ach SoH DIchDaq ghobe' redeem the firstborn vo' a cow, joq the firstborn vo' a Suy', joq the firstborn vo' a goat. chaH 'oH le'. SoH DIchDaq sprinkle chaj 'Iw Daq the lalDanta' Daq, je DIchDaq meQ chaj ror vaD an cha'nob chenmoHta' Sum qul, vaD a bel aroma Daq joH'a'.",
        18: "chaj ghab DIchDaq taH yours, as the wave cha'nob breast je as the nIH thigh, 'oH DIchDaq taH yours.",
        19: "Hoch the wave nobmey vo' the le' Dochmey, nuq the puqpu' vo' Israel nob Daq joH'a', ghaj jIH nobpu' SoH, je lIj puqloDpu' je lIj puqbe'pu' tlhej SoH, as a portion reH: 'oH ghaH a lay' vo' salt reH qaSpa' joH'a' Daq SoH je Daq lIj tIr tlhej SoH.”",
        20: "joH'a' ja'ta' Daq Aaron, “SoH DIchDaq ghaj ghobe' inheritance Daq chaj puH, ghobe' DIchDaq SoH ghaj vay' portion among chaH. jIH 'oH lIj portion je lIj inheritance among the puqpu' vo' Israel.",
        21: "“Daq the puqpu' vo' Levi, yIlegh, jIH ghaj nobpu' Hoch the tithe Daq Israel vaD an inheritance, Daq chegh vaD chaj toy'taHghach nuq chaH toy', 'ach the toy'taHghach vo' the juHHom vo' qep.",
        22: "Henceforth the puqpu' vo' Israel DIchDaq ghobe' ghoS Sum the juHHom vo' qep, lest chaH SIQ yem, je Hegh.",
        23: "'ach the Levites DIchDaq ta' the toy'taHghach vo' the juHHom vo' qep, je chaH DIchDaq SIQ chaj He'taHghach: 'oH DIchDaq taH a statute reH throughout lIj DISmey; je among the puqpu' vo' Israel chaH DIchDaq ghaj ghobe' inheritance.",
        24: "vaD the tithe vo' the puqpu' vo' Israel, nuq chaH nob as a wave cha'nob Daq joH'a', jIH ghaj nobpu' Daq the Levites vaD an inheritance: vaj jIH ghaj ja'ta' Daq chaH, ‘Among the puqpu' vo' Israel chaH DIchDaq ghaj ghobe' inheritance.'”",
        25: "joH'a' jatlhta' Daq Moses, ja'ta',",
        26: "“Moreover SoH DIchDaq jatlh Daq the Levites, je ja' chaH, ‘ghorgh SoH tlhap vo' the puqpu' vo' Israel the tithe nuq jIH ghaj nobpu' SoH vo' chaH vaD lIj inheritance, vaj SoH DIchDaq nob Dung a wave cha'nob vo' 'oH vaD joH'a', a tithe vo' the tithe.",
        27: "lIj wave cha'nob DIchDaq taH reckoned Daq SoH, as 'a' 'oH were the grain vo' the threshing floor, je as the fullness vo' the winepress.",
        28: "Thus SoH je DIchDaq nob a wave cha'nob Daq joH'a' vo' Hoch lIj tithes, nuq SoH Hev vo' the puqpu' vo' Israel; je vo' 'oH SoH DIchDaq nob joH'a' wave cha'nob Daq Aaron the lalDan vumwI'.",
        29: "pa' vo' Hoch lIj gifts SoH DIchDaq nob Hoch wave cha'nob vo' joH'a', vo' Hoch its best, 'ach the le' part vo' 'oH pa' vo' 'oH.'",
        30: "“vaj SoH DIchDaq ja' chaH, ‘ghorgh SoH heave its best vo' 'oH, vaj 'oH DIchDaq taH reckoned Daq the Levites as the increase vo' the threshing floor, je as the increase vo' the winepress.",
        31: "SoH DIchDaq Sop 'oH Daq Hoch Daq, SoH je lIj households: vaD 'oH ghaH lIj pop Daq chegh vaD lIj toy'taHghach Daq the juHHom vo' qep.",
        32: "SoH DIchDaq SIQ ghobe' yem Sum meq vo' 'oH, ghorgh SoH ghaj heaved vo' 'oH its best: je SoH DIchDaq ghobe' profane the le' Dochmey vo' the puqpu' vo' Israel, vetlh SoH ghobe' Hegh.'”",
    },
    19: {
        1: "joH'a' jatlhta' Daq Moses je Daq Aaron, ja'ta',",
    ...
    24: {
        1: "ghorgh Balaam leghta' vetlh 'oH pleased joH'a' Daq ghurmoH Israel, ghaH ta'be' jaH, as Daq the latlh poHmey, Daq ghom tlhej enchantments, 'ach ghaH cher Daj qab toward the ngem.",
        2: "Balaam qengta' Dung Daj mInDu', je ghaH leghta' Israel dwelling according Daq chaj tuqpu'; je the qa' vo' joH'a' ghoSta' Daq ghaH.",
        3: "ghaH tlhapta' Dung Daj parable, je ja'ta', “Balaam the puqloD vo' Beor jatlhtaH, the loD 'Iv mIn ghaHta' SoQ jatlhtaH;",
        4: "ghaH jatlhtaH, 'Iv hears the mu'mey vo' joH'a', 'Iv sees the leghtaHghach vo' the HoSghaj, falling bIng, je ghajtaH Daj mInDu' poSmoH:",
        5: "chay' goodly 'oH lIj tents, Jacob, je lIj tents, Israel!",
        6: "As valleys chaH 'oH ngeH vo', as wIjghachHommey Sum the riverside, as aloes nuq joH'a' ghajtaH planted, as cedar Sormey retlh the bIQmey.",
        7: "bIQ DIchDaq flow vo' Daj buckets. Daj tIr DIchDaq taH Daq law' bIQmey. Daj joH DIchDaq taH higher than Agag. Daj kingdom DIchDaq taH exalted.",
        ...
        22: 'Nevertheless Kain DIchDaq taH wasted, until Asshur carries SoH DoH captive.”',
        23: "ghaH tlhapta' Dung Daj parable, je ja'ta', “Alas, 'Iv DIchDaq yIn ghorgh joH'a' ta'taH vam?",
        ...
        25: "Balaam rose Dung, je mejta' je cheghta' Daq Daj Daq; je Balak je mejta' Daj way.",
    },
    25: {
    ...
    30: {
        1: "Moses jatlhta' Daq the nachDu' vo' the tuqpu' vo' the puqpu' vo' Israel, ja'ta', “vam ghaH the Doch nuq joH'a' ghajtaH ra'ta'.",
        2: "ghorgh a loD vows a vow Daq joH'a', joq swears an oath Daq bind Daj qa' tlhej a bond, ghaH DIchDaq ghobe' ghor Daj mu'; ghaH DIchDaq ta' according Daq Hoch vetlh proceeds pa' vo' Daj nujDu'.",
        3: "“je ghorgh a be' vows a vow Daq joH'a', je binds herself Sum a bond, taH Daq Daj vav tuq, Daq Daj youth,",
        4: "je Daj vav hears Daj vow, je Daj bond tlhej nuq ghaH ghajtaH bagh Daj qa', je Daj vav holds Daj roj Daq Daj; vaj Hoch Daj vows DIchDaq Qam, je Hoch bond tlhej nuq ghaH ghajtaH bagh Daj qa' DIchDaq Qam.",
        5: "'ach chugh Daj vav disallow Daj Daq the jaj vetlh ghaH hears, pagh vo' Daj vows, joq vo' Daj bonds tlhej nuq ghaH ghajtaH bagh Daj qa', DIchDaq Qam: je joH'a' DichDaq forgive Daj, because Daj vav disallowed Daj.",
        6: "“chugh ghaH ghaH married Daq a loDnal, qaStaHvIS Daj vows 'oH Daq Daj, joq the rash utterance vo' Daj wuSDu', tlhej nuq ghaH ghajtaH bagh Daj qa',",
        7: "je Daj loDnal Qoy 'oH, je 'uch Daj roj Daq Daj Daq the jaj vetlh ghaH hears 'oH; vaj Daj vows DIchDaq Qam, je Daj bonds tlhej nuq ghaH ghajtaH bagh Daj qa' DIchDaq Qam.",
        8: "'ach chugh Daj loDnal disallow Daj Daq the jaj vetlh ghaH hears 'oH, vaj ghaH DIchDaq chenmoH void Daj vow nuq ghaH Daq Daj, je the rash utterance vo' Daj wuSDu', tlhej nuq ghaH ghajtaH bagh Daj qa': je joH'a' DichDaq forgive Daj.",
        9: "“'ach the vow vo' a Heghbe'nal, joq vo' Daj 'Iv ghaH divorced, 'ach everything tlhej nuq ghaH ghajtaH bagh Daj qa', DIchDaq Qam Daq Daj.",
        10: "“chugh ghaH vowed Daq Daj husband's tuq, joq bagh Daj qa' Sum a bond tlhej an oath,",
        11: "je Daj loDnal Qoyta' 'oH, je held Daj roj Daq Daj, je ta'be' disallow Daj; vaj Hoch Daj vows DIchDaq Qam, je Hoch bond tlhej nuq ghaH bagh Daj qa' DIchDaq Qam.",
        12: "'ach chugh Daj loDnal chenmoHta' chaH null je void Daq the jaj vetlh ghaH Qoyta' chaH, vaj whatever proceeded pa' vo' Daj wuSDu' concerning Daj vows, joq concerning the bond vo' Daj qa', DIchDaq ghobe' Qam: Daj loDnal ghajtaH chenmoHta' chaH void; je joH'a' DichDaq forgive Daj.",
        13: "Hoch vow, je Hoch binding oath Daq afflict the qa', Daj loDnal may establish 'oH, joq Daj loDnal may chenmoH 'oH void.",
        14: "'ach chugh Daj loDnal altogether 'uch Daj roj Daq Daj vo' jaj Daq jaj, vaj ghaH establishes Hoch Daj vows, joq Hoch Daj bonds, nuq 'oH Daq Daj: ghaH ghajtaH established chaH, because ghaH held Daj roj Daq Daj Daq the jaj vetlh ghaH Qoyta' chaH.",
        15: "'ach chugh ghaH DIchDaq chenmoH chaH null je void after vetlh ghaH ghajtaH Qoyta' chaH, vaj ghaH DIchDaq SIQ Daj He'taHghach.”",
        16: "Dochvammey 'oH the chutmey, nuq joH'a' ra'ta' Moses, joj a loD je Daj be'nal, joj a vav je Daj puqbe', taH Daq Daj youth, Daq Daj vav tuq.",
    },
    31: {
        1: "joH'a' jatlhta' Daq Moses, ja'ta',",
