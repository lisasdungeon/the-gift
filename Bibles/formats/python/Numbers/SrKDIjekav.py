...
CHAPTERS = {
    1: {
        ...
        2: 'Избројте сав збор синова Израиљевих по породицама њиховијем и по домовима отаца њиховијех и по именима њиховијем, све мушкиње, главу по главу,',
        3: 'Од двадесет година и више, све који могу ићи на војску у Израиљу, избројте их по четама њиховијем ти и Арон;',
        4: 'А с вама нека буде по један човјек од свакога племена, који је поглавар у дому отаца својих.',
        5: 'А ово су имена људи који ће бити с вама: од племена Рувимова Елисур син Седијуров;',
        6: 'Од Симеунова Саламило син Сурисадејев;',
        ...
        18: 'И сабраше сав збор први дан другога мјесеца, и преписаше их по породицама њиховијем и по домовима отаца њиховијех и по именима њиховијем од двадесет година и више, главу по главу.',
        ...
        22: 'Синова Симеуновијех, рода њихова по породицама њиховијем и по домовима отаца њиховијех, кад се изброји по именима с главе на главу све мушкиње од двадесет година и више, што могаше ићи на војску,',
        23: 'Бјеше их избројенијех од племена Симеунова педесет и девет тисућа и три стотине.',
        ...
        39: 'Бјеше их избројенијех од племена Данова шездесет двије тисуће и седам стотина,',
        ...
        46: 'Бјеше их избројенијех шест стотина и три тисуће и пет стотина и педесет.',
        47: 'Али Левити по племену отаца својих не бише бројени међу њих.',
        48: 'Јер Господ рече Мојсију говорећи:',
        49: 'Племена Левијева немој бројати, нити броја њихова саставити са синовима Израиљевијем.',
        50: 'Него постави Левите над шатором од свједочанства и над свијем посуђем у њему и над свијем што припада њему; они нека носе шатор и све посуђе његово, нека служе у њему, и стају око шатора.',
    ...
    3: {
        ...
        2: 'И ово су имена синова Ароновијех: првенац Надав, па Авијуд и Елеазар и Итамар.',
        3: 'То су имена синова Ароновијех, свештеника, који бише помазани и посвећени да врше службу свештеничку.',
        4: 'Али погибе Надав и Авијуд пред Господом, кад принесоше огањ туђ пред Господом у пустињи Синајској; и не имаше дјеце; зато Елеазар и Итамар отправљаху службу свештеничку за живота Арона оца својега.',
        ...
        12: 'Ево узех Левите између синова Израиљевијех за све првенце што отворају материцу међу синовима Израиљевијем; зато ће моји бити Левити.',
        13: 'Јер је мој сваки првенац; од онога дана када побих све првенце у земљи Мисирској, посветих себи свакога првенца у Израиљу од човјека до живинчета; моји ће бити; ја сам Господ.',
        ...
        17: 'И бјеху синови Левијеви по имену ови: Гирсон и Кат и Мерарије.',
        ...
        25: 'А синови Гирсонови чуваху у шатору од састанка шатор и наслон, покривач његов и завјес на вратима шатора од састанка,',
        26: 'И завјесе од тријема и завјес на вратима од тријема што је око шатора и око олтара, и ужа његова за сваку потребу његову.',
        ...
        31: 'А они чуваху ковчег и сто и свијетњак и олтар и посуђе у светињи којим служе, и завјес, и све што припада к њему.',
        ...
        38: 'А пред шатором од састанка с истока стајаху у око Мојсије и Арон и синови његови чувајући светињу за синове Израиљеве; а да ко други приступи, погинуо би.',
        39: 'А свега Левита кад их изброји Мојсије и Арон по заповијести Господњој по породицама њиховијем, свега мушкиња од мјесец дана и више, бјеше двадесет и двије тисуће.',
        ...
        41: 'И узми Левите за мене (ја сам Господ) мјесто свијех првенаца међу синовима Израиљевим, и стоку Левитску мјесто свијех првенаца од стоке синова Израиљевих.',
        ...
        45: 'Узми Левите мјесто свијех првенаца међу синовима Израиљевим и стоку Левитску мјесто стоке њихове, да буду моји Левити; ја сам Господ.',
        46: 'А да се откупе они двјеста и седамдесет и три, што има првенаца међу синовима Израиљевијем више него Левита,',
    ...
    9: {
        ...
        2: 'Нека славе синови Израиљеви пасху у одређено вријеме.',
        ...
        5: 'И славише пасху првога мјесеца четрнаестога дана увече у пустињи Синајској; како бјеше Господ заповједио Мојсију, све онако учинише синови Израиљеви.',
        6: 'А бијаху неки који се оскврнише о мртваца те не могаху славити пасхе онај дан; и дођоше исти дан пред Мојсија и пред Арона;',
        ...
        15: 'А у који дан би подигнут шатор, покри облак шатор над наслоном од свједочанства; а увече бјеше над шатором као огањ до јутра.',
        ...
        20: 'И кад облак бијаше над шатором мало дана, по заповјести Господњој стајаху у околу и по заповијести Господњој полажаху.',
    ...
    11: {
        ...
        20: 'Него цио мјесец дана, докле вам на нос не удари и не огади вам се, зато што одбацисте Господа који је међу вама и плакасте пред њим говорећи: зашто изиђосмо из Мисира?',
    ...
    12: {
        ...
        7: 'Али није таки мој слуга Мојсије, који је вјеран у свем дому мојем.',
        8: 'Њему говорим из уста к устима, и он ме гледа доиста, а не у тами нити у каквој прилици Господњој. Како се дакле не побојасте викати на слугу мојега, на Мојсија?',
        9: 'И гњев се Господњи распали на њих, и он отиде.',
        10: 'И облак се подиже са шатора; и гле, Марија бјеше губава, бијела као снијег. И Арон погледа Марију, а она губава.',
        ...
        14: 'А Господ одговори Мојсију: да јој је отац њезин пљунуо у лице, не би ли се стидјела седам дана? Нека буде одлучена седам дана изван окола, а послије нека буде опет примљена.',
    ...
    14: {
        ...
        5: 'Тада Мојсије и Арон падоше ничице пред свијем збором синова Израиљевијех.',
        ...
        8: 'Ако смо мили Господу, он ће нас одвести у ту земљу, и даће нам је; а то је земља у којој тече млијеко и мед.',
        9: 'Само се не одмећите Господа, и не бојте се народа оне земље; јер их можемо појести; отступио је од њих заклон њихов, а с нама је Господ, не бојте их се.',
        10: 'Тада рече сав збор да их побију камењем; али се показа слава Господња свијем синовима Израиљевијем у шатору од састанка.',
        ...
        12: 'Ударићу га помором, и расућу га; а од тебе ћу учинити народ велик и јачи од овога.',
        ...
        16: 'Није могао Господ довести народа овога у земљу коју им је са заклетвом обећао, зато их поби у пустињи.',
        17: 'Нека се дакле прослави сила Господња, као што си рекао говорећи:',
        18: 'Господ дуго чека и обилан је милошћу, прашта безакоње и гријех, али не правда кривога, него походи безакоње отачко на синовима до трећега и четвртога кољена.',
        ...
        22: 'Ти људи који видјеше славу моју и знаке моје што сам учинио у Мисиру и у овој пустињи, и кушаше ме већ десет пута, и не послушаше ријечи моје,',
        23: 'Неће видјети земље коју са заклетвом обећах оцима њиховијем, неће видјети ни један од оних који ме увриједише.',
        24: 'А слугу својега Халева, у којем бјеше други дух и који се сасвијем мене држао, њега ћу одвести у земљу у коју је ишао, и сјеме ће је његово наслиједити.',
        ...
        37: 'Ти људи, који просуше зао глас о земљи, помријеше од помора пред Господом;',
    ...
    15: {
        ...
        3: 'И станете приносити жртву огњену Господу, жртву паљеницу или жртву завјета ради или од драге воље, или о празницима својим, готовећи мирис угодни Господу од крупне или од ситне стоке,',
        4: 'Тада ко принесе принос свој Господу, нека донесе уза њ дар, десетину ефе бијелога брашна помијешана с четвртином ина уља.',
        5: 'И вина четврт ина за наљев донеси уз жртву паљеницу или уз другу жртву, на свако јагње.',
        ...
        15: 'Зборе! Вама и дошљаку који је међу вама један да је закон, закон вјечан од кољена на кољено; дошљак ће бити као и ви пред Господом.',
        ...
        22: 'А кад бисте погријешили, те не бисте учинили свијех овијех заповијести, које каза Господ Мојсију,',
        ...
        27: 'Ако ли једна душа згријеши не знајући, нека принесе козу од године на жртву за гријех.',
        ...
        30: 'Али ко од силе згријеши између рођенијех у земљи или између дошљака, он ружи Господа; нека се истријеби душа она из народа својега.',
        ...
        34: 'И метнуше га под стражу, јер не бјеше казано шта ће се чинити с њим.',
        35: 'А Господ рече Мојсију: Нека се погуби тај човјек; нека га заспе камењем сав збор иза окола.',
        ...
        38: 'Реци синовима Израиљевијем и кажи им, нека ударају ресе по скутовима од хаљина својих од кољена до кољена, и над ресе нека мећу врвцу плаву.',
    ...
    25: {
        ...
        18: 'Јер они завојштише на вас пријеварама својим, и претворише вас Велфегором и Хазвијом кћерју кнеза Мадијанскога, сестром својом, која би убијена у дан погибије која дође с Фегора.',
    },
    26: {
    ...
    27: {
        ...
        19: 'И изведи га пред Елеазара свештеника и пред сав збор, и подај му заповјести пред њима.',
    ...
    30: {
        ...
        9: 'Ако ли муж њезин кад чује онај дан порече, укида с завјет који је био на њој или што је изрекла на уста своја те се везала; и Господ ће јој опростити.',
    ...
    34: {
        ...
        3: 'Јужни крај да вам је од пустиње Сина, уз међу Едомску, и да вам је јужна међа од бријега сланога мора на исток;',
        ...
        14: 'Јер племе синова Рувимовијех по породицама отаца својих, и племе синова Гадовијех по породицама отаца својих, и половина племена Манасијина примише своје нашљедство.',
        ...
        17: 'Ово су имена људи који ће вам раздијелити у нашљедство земљу: Елеазар свештеник и Исус син Навин.',
        ...
        20: 'Од племена синова Симеуновијех Самуило син Емијудов,',
    ...
    36: {
        ...
        2: 'И говорише: господару нашему заповједи Господ да подијели ждријебом земљу у нашљедство синовима Израиљевијем; и господар наш има заповијест од Господа да да нашљедство Салпада брата нашега кћерима његовијем.',
        ...
        4: 'И кад буде опросна година синовима Израиљевијем, опет ће остати нашљедство њихово с нашљедством онога племена у које се буду удале, и тако ће од нашљедства племена отаца наших остати откинуто нашљедство њихово.',
        ...
        9: 'Да се не би преносило нашљедство од једнога племена синова Израиљевијех да држи своје нашљедство.',
