...
CHAPTERS = {
    1: {
        ...
        23: 'ihr seid ja nicht aus vergänglichem, sondern aus unvergänglichem Samen wiedergeboren, nämlich durch das lebendige und ewigbleibende Wort Gottes.',
        ...
        25: 'das Wort des Herrn aber bleibt in Ewigkeit«. Dies ist aber das Wort, das euch als Heilsbotschaft verkündigt worden ist.',
    },
    2: {
    ...
    4: {
        ...
        11: 'Redet jemand, so seien seine Worte wie Aussprüche Gottes; hat jemand Dienste (als Diakon) zu leisten, so (tue er es) in der Kraft, die Gott verleiht, damit in allen Fällen Gott verherrlicht werde durch Jesus Christus: sein ist die Herrlichkeit und die Macht in alle Ewigkeit. Amen.',
