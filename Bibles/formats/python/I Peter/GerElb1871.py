...
CHAPTERS = {
    1: {
        1: 'Petrus, Apostel Jesu Christi, den Fremdlingen von der Zerstreuung von Pontus, Galatien, Kappadocien, Asien und Bithynien, auserwählt',
        2: 'nach Vorkenntnis Gottes, des Vaters, durch Heiligung des Geistes, zum Gehorsam und zur Blutbesprengung Jesu Christi: Gnade und Friede sei euch vermehrt!',
    ...
    2: {
        ...
        5: 'seid auch ihr selbst als lebendige Steine, aufgebaut, ein geistliches Haus, ein heiliges Priestertum, um darzubringen geistliche Schlachtopfer, Gott wohlannehmlich durch Jesum Christum.',
    ...
    3: {
        ...
        6: 'wie Sarah dem Abraham gehorchte und ihn Herr nannte, deren Kinder ihr geworden seid, wenn ihr Gutes tut und keinerlei Schrecken fürchtet.',
        ...
        16: 'indem ihr ein gutes Gewissen habt, auf daß, worin sie wider euch als Übeltäter reden, die zu Schanden werden, welche euren guten Wandel in Christo verleumden.',
        ...
        21: 'welches Gegenbild auch euch jetzt errettet, das ist die Taufe, durch die Auferstehung Jesu Christi,',
    ...
    5: {
        ...
        5: 'Gleicherweise ihr Jüngeren, seid den Ältesten untertan. Alle aber seid gegeneinander mit Demut fest umhüllt; denn "Gott widersteht den Hochmütigen, den Demütigen aber gibt er Gnade".',
        ...
        12: 'Durch Silvanus, den treuen Bruder, wie ich dafür halte, habe ich euch mit wenigem geschrieben, euch ermahnend und bezeugend, daß dies die wahre Gnade Gottes ist, in welcher ihr stehet.',
