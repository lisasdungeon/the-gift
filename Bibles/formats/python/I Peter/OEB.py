...
CHAPTERS = {
    ...
    2: {
        ...
        6: 'For there is a passage of scripture that runs — ‘See, I am placing in Zion a choice and precious corner-stone; And those who believe in him will have no cause for shame.’',
        ...
        12: 'Let your daily life among the Gentiles be so upright, that, whenever they malign you as evil-doers, they may learn, as they watch, from the uprightness of your conduct, to praise God ‘at the time when he will visit them.’',
        13: 'Submit to all human institutions for the Lord’s sake, alike to the emperor as the supreme authority,',
        14: 'and to governors as sent by him to punish evil-doers and to commend those who do right.',
    ...
    3: {
        ...
        3: 'Yours should be, not the external adornment of the arrangement of the hair, the wearing of jewelery, or the putting on of dresses,',
        ...
        10: '‘The person who wants to enjoy life And see happy days — Let them keep their tongue from evil And their lips from deceitful words,',
        11: 'let them turn from evil and do good, Let them seek for peace and follow after it;',
    ...
    4: {
        ...
        11: 'When anyone speaks, let them speak as one who is delivering the oracles of God. When anyone is endeavoring to serve others, let them do so in reliance on the strength which God supplies; so that in everything God may be honor ed through Jesus Christ — to whom be ascribed all honor and might for ever and ever. Amen.',
        ...
        16: 'But, if someone suffers as a Christian, do not let them be ashamed of it; let them bring honor to God even though they bear that name.',
    ...
    5: {
        1: 'As for the older ones among you, who bear office in the church, I, their fellow officer, and a witness to the sufferings of the Christ, who will also share in the glory that is to be revealed —',
        ...
        11: 'To him be ascribed dominion for ever. Amen.',
