...
CHAPTERS = {
    ...
    4: {
        ...
        11: 'もし語るならば、神の言をかたる者のごとく語り、事ふるならば、神の與へたまふ能力を受けたる者のごとく事へよ。是イエス・キリストによりて事々に神の崇められ給はん爲なり。榮光と權力とは世々 限りなく彼に歸するなり、アァメン。',
    ...
    5: {
        ...
        11: '願はくは權力 世々 限りなく神にあれ、アァメン。',
        12: 'われ忠實なる兄弟なりと思ふシルワノに由りて、簡單に書き贈りて汝らに勸め、かつ此は神の眞の恩惠なることを證す、汝 等この恩惠に立て。',
