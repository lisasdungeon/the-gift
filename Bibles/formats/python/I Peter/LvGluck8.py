...
CHAPTERS = {
    1: {
        ...
        23: 'Jūs, kas esat atdzimuši ne no iznīcīgas sēklas, bet no neiznīcīgas caur to dzīvo un mūžīgi paliekamo Dieva vārdu.',
        24: 'Jo visa miesa ir kā zāle un visa cilvēka godība kā zāles puķe; zāle ir savītusi un viņas puķe nokritusi;',
        25: 'Bet Tā Kunga vārds paliek mūžīgi. Bet šis ir tas vārds, kas jūsu starpā ir pasludināts.',
    },
    2: {
    ...
    4: {
        ...
        11: 'Ja kas runā, tas lai runā tā kā Dieva vārdus; ja kam kāds amats, lai tas to izdara itin pēc tā spēka, ko Dievs pasniedz, ka visās lietās Dievs top godināts caur Jēzu Kristu, kam pieder gods un vara mūžīgi mūžam. Āmen.',
    ...
    5: {
        ...
        10: 'Bet Tas visu žēlīgais Dievs, kas mūs aicinājis uz Savu mūžīgo godību iekš Kristus Jēzus, Tas jūs, kas mazu brīdi ciešat, Pats sataisīs, spēcinās, stiprinās, pastāvīgus darīs.',
        11: 'Tam lai ir gods un vara mūžīgi mūžam. Āmen.',
