...
CHAPTERS = {
    1: {
        ...
        4: "Et David lui dit: Qu'y a-t-il? Parle; et il répondit: Le peuple s'est enfui du champ de bataille; un grand nombre a péri, Saül et Jonathan sont morts,",
        5: 'Et David dit au jeune homme qui lui apportait ces nouvelles: Comment sais- tu que Saül et son fils Jonathan ont péri?',
        ...
        10: "Et je montai sur lui et je le tuai; car je voyais bien qu'il ne survivrait pas à sa chute. Ensuite, j'ai pris, sur sa tête, la couronne; autour de son bras, le bracelet, et je les ai apportés ici à mon maître.",
        11: 'Et David prit à deux mains ses vêtements et il les déchira, et tous les hommes de sa suite déchirèrent leurs vêtements.',
        12: "Puis, ils se lamentèrent, ils jeûnèrent jusqu'au soir, ils pleurèrent sur Saül, sur Jonathan, sur le peuple de Juda et sur la maison d'Israël, parce qu'ils avaient été frappés par l'épée.",
        ...
        17: 'Alors, David fit cette lamentation sur Saül et sur Jonathan, son fils.',
        18: "Et il commanda qu'on l'apprit aux fils de Juda, et elle est écrite au livre du Juste.",
        ...
        21: "Montagnes de Gelboé, que la rosée, que les pluies du ciel ne descendent plus sur vous, que vos champs ne donnent plus de prémices, car c'est là que le bouclier des vaillants a perdu sa gloire. Le bouclier de Saül n'était pas oint avec de l'huile;",
        22: "Le sang des blessés, la graisse des puissants, ne manquaient jamais à l'arc de Jonathan, ni à l'épée de Saül, quand ils revenaient du combat.",
        23: "Saül et Jonathan, bien-aimés et gracieux, vous n'êtes point séparés; nobles dans la vie, nobles dans la mort, ils ne sont point séparés; ils étaient plus agiles que l'aigle, plus forts que le lion.",
        24: "Filles d'Israël, pleurez sur Saül qui vous revêtait de robes d'écarlate, et ornait d'or votre parure.",
        25: 'Comment sont tombés les puissants au milieu de la bataille? Et Jonathan et ceux qui ont péri sur vos montagnes?',
        26: "Je pleure sur toi, Jonathan mon frère; qu'à mes yeux tu étais beau! ton amitié pour moi me ravissait plus que l'amour des femmes.",
    ...
    10: {
        ...
        2: "Et David dit: Je serai compatissant envers Annon, fils de Naas, de même que son père a été compatissant pour moi; en conséquence, il envoya, pour le consoler de la mort de son père, des serviteurs qui allèrent en la contrée des fias d'Ammon.",
        ...
        14: "Quand les fils d'Ammon virent que les Syriens fuyaient, ils s'enfuirent eux-mêmes devant Abessa, et ils s'enfermèrent dans leur ville; Joab les y laissa pour revenir à Jérusalem.",
    ...
    14: {
        ...
        14: "Nous mourrons tous de mort, nous serons comme l'eau qui s'écoule sur la terre et ne revient plus; Dieu prendra notre âme, et le roi a encore la pensée de repousser au loin celui qu'il a banni!",
        ...
        22: "Et Joab tomba la face contre terre; il adora et bénit le roi. Puis, il dit: Aujourd'hui ton serviteur reconnaît qu'il a trouvé grâce devant tes yeux, ô roi mon maître, puisque tu as fait comme ton serviteur avait dit.",
        ...
        26: "Lorsqu'il se coupait les cheveux, et il se les coupait au commencement de chaque année, parce qu'il était incommodé de leur poids, il en recueillait deux cents sicles pesant, au poids du sicle royal.",
        ...
        29: 'Ensuite, Absalon envoya chez Joab pour que celui-ci le menât chez le roi, mais il ne voulut point venir; Absalon envoya une seconde fois; Joab refusa encore.',
