...
CHAPTERS = {
    1: {
        ...
        2: "Qui fut emmené captif, du temps d'Enemessar, roi d'Assyrie; de Thisbès qui est à droite de Cydios en Nephthali, dans la Galilée, au-dessus d'Aser.",
        ...
        6: "Et moi seul j'allai bien des fois à Jérusalem les jours de fête, selon qu'il est écrit pour tout le peuple en la loi éternelle, portant avec moi les prémices et les dîmes des fruits de mes champs et la première tonte de mes agneaux;",
        7: "Et je les donnais aux prêtres, fils d'Aaron, devant l'autel. De tous mes produits, je donnais la dîme aux fils de Lévi, employés à Jérusalem; et je vendais la seconde dîme, et je m'en allais, et j'en dépensais le prix à Jérusalem tous les ans,",
        ...
        18: "Et si Sennachérib, après qu'il fut revenu de la Judée en fugitif, faisait périr l'un d'eux, je l'ensevelissais à la dérobée. Car, dans sa fureur, il en tua beaucoup; et lorsque le roi fit chercher leurs corps, on ne les trouva plus.",
    ...
    2: {
        ...
        14: "Et elle répondit: On me l'a donné outre mon salaire. Et je ne la crus pas, et je lui dis de le reporter aux maîtres, et je rougis d'elle. Et elle reprit: Où sont tes aumônes et tes œuvres de justice? Comme elles se révèlent toutes en toi!",
    },
    3: {
    ...
    4: {
        ...
        5: "Tous les jours, mon enfant, souviens-toi du Seigneur ton Dieu, ne consens pas à pécher ni à transgresser ses commandements. Fais la justice toute la vie, et ne marche jamais dans les voies de l'iniquité.",
        6: "Car, si tu fais la vérité, le succès s'en suivra en tous tes travaux, comme il advient à tous ceux qui font la justice.",
        7: "Donne en aumône une part de tes biens, et que ton œil ne te porte pas envie lorsque tu feras l'aumône. Ne détourne pas ton visage du mendiant, et le visage de Dieu ne se détournera pas de toi.",
        ...
        11: "L'aumône est un précieux présent devant le Très-Haut, pour tous ceux qui la font.",
        ...
        16: "Donne de tes mets aux affamés, et de tes vêtements aux nus; donne en aumône tout ton superflu, et que ton œil ne te porte pas envie quand tu feras l'aumône.",
        17: "Distribue ton pain sur la tombe des justes, n'en donne pas aux pécheurs.",
    ...
    5: {
        ...
        4: 'Et il sortit pour chercher un homme, et il trouva Raphaël, qui était un ange. Mais il ne le savait pas.',
        5: 'Et il lui dit: Puis-je aller avec toi à Ragès en Médie, et connais-tu le pays?',
        6: "Et l'ange lui répondit: Je partirai avec toi, et je sais le chemin; j'ai même séjourné chez mon frère Raguel.",
        7: 'Et Tobie reprit: Attends-moi, je vais le dire à mon père.',
        8: "Et l'ange lui dit: Va, et ne sois pas longtemps.",
        9: "Et, étant rentré, Tobie dit à son père: Voilà que j'ai trouvé quelqu'un pour venir avec moi. Et Tobit répondit: Appelle-le près de moi, que je sache de quelle tribu il est, et s'il y a sûreté à voyager avec lui.",
        10: "Et il l'appela, et l'ange entra, et ils se saluèrent mutuellement.",
        11: 'Et Tobit lui dit: Frère, de quelle tribu et de quelle famille paternelle es-tu? Fais-le-moi connaître.',
        12: "Et l'ange répondit: Est-ce ma tribu et ma famille que tu demandes, ou bien un serviteur qui aille avec ton fils? Et Tobit reprit: Je désire, frère, connaître ta famille et ton nom.",
        13: "Et l'ange dit: Je suis Azarias, fils du grand Ananias, l'un de tes frères.",
        14: "Et Tobit dit: Sois le bienvenu, frère, et ne te fâche pas de ce que j'ai demandé à connaître ta tribu et ta famille; il se rencontre que tu es mon frère, et que tu sors d'une belle et bonne maison. Car j'ai connu Ananias et Jonathas, fils de Sémeï le Grand, lorsque nous allions ensemble adorer à Jérusalem, et offrir la dîme de nos récoltes et les premiers-nés de nos troupeaux; ils ne tombaient point dans l'égarement de nos frères; frère, tu es d'une bien bonne souche.",
        15: "Mais dis-moi quel salaire j'aurai à te donner? Une drachme par jour, et ce qui sera nécessaire à toi comme à mon fils.",
        16: "Et j'ajouterai encore à ta récompense, si vous revenez sains et saufs.",
        17: "Et il leur plut ainsi; et Tobit dit à son fils: Dispose-toi à partir, et bon succès. Et Tobie prépara ce qu'il lui fallait pour la route, et son père lui dit: Va avec cet homme, et que Dieu, qui habite le ciel, vous guide en chemin, que son ange vous guide en chemin. Et ils sortirent tous les deux, et le chien du jeune homme le suivit.",
        18: "Or, Anne, sa mère, pleura, et elle dit à Tobit: Pourquoi as-tu envoyé là notre enfant? N'est-ce point le bâton sur lequel s'appuyaient nos mains, quand il allait et venait devant nous?",
        19: "Puisse cet argent ne plus avoir cours; puisse-t-il être changé en l'ordure de notre fils!",
        20: 'Ce que le Seigneur nous avait donné pour vivre nous suffisait bien.',
        21: "Et Tobit lui dit: N'aie pas d'inquiétude, ma sœur, il reviendra sain et sauf, et tes yeux le verront.",
        22: "Car un bon ange l'accompagne, et son voyage réussira, et il reviendra sain et sauf.",
    ...
    6: {
        ...
        5: "Et le jeune homme fit ce que lui avait dit l'ange; puis, ayant fait rôtir le poisson, ils en mangèrent.",
        6: "Ensuite, ils marchèrent, l'un et l'autre, jusqu'aux portes d'Ecbatane.",
        7: "Et, en marchant, le jeune homme dit à l'ange: Frère Azarias, à quoi servent le cœur, le foie et le fiel du poisson?",
        8: "Et l'ange répondit: Si quelqu'un, homme ou femme, est tourmenté par un démon ou un malin esprit, il faut brûler le cœur et le foie devant lui, et il ne sera plus tourmenté.",
        9: 'Et si avec le fiel on oint un homme qui a des taies aux yeux, il sera guéri.',
        10: 'Auprès de la ville.',
        11: "L'ange dit au jeune homme: Frère, nous passerons cette nuit chez Raguel, qui est de ta famille, et a une fille qu'on appelle Sara.",
        12: "Je lui parlerai d'elle, afin qu'il te la donne pour femme; l'héritage de Sara te revient, car tu es le seul de sa famille, et la jeune vierge est belle et prudente.",
        13: "Suis mon conseil, et je parlerai à son père, et quand nous reviendrons de Ragès nous ferons le mariage. Je sais que Raguel ne la donnera pas à un homme autre que celui que prescrit la loi de Moïse; sinon il exposerait cet homme à la mort, car il t'appartient de recueillir son héritage à l'exclusion de tout autre.",
        14: "Alors, le jeune homme dit à l'ange: Mon frère Azarias, j'ai ouï dire que la jeune fille a été donnée à sept maris, et que tous sont morts dans la chambre nuptiale.",
        15: "Or, je suis le seul enfant de mon père, et j'ai peur en l'épousant de mourir comme les premiers; car un démon l'aime, et il ne fait de mal à personne, sinon à ceux qui s'approchent d'elle. Et je crains de périr et de conduire au tombeau dans la tristesse la vie de mon père et de ma mère, et ils n'ont point d'autre fils pour les ensevelir.",
        16: "Et l'ange lui dit: Ne te souviens-tu pas que ton père t'a recommandé de prendre femme en ta famille? Écoute-moi donc, frère, car elle sera ta femme, et ne t'inquiète nullement du démon; cette nuit même elle te sera donnée pour femme.",
        17: "Et quand tu entreras dans la chambre nuptiale, prends le brasier aux parfums: jette, sur la cendre chaude, le cœur et le foie du poisson, et réduis-les en fumée. Et le démon en sentira l'odeur, et il s'enfuira, et il ne reviendra plus dans les siècles des siècles.",
        18: "Lorsque tu viendras ensuite auprès de la femme, restez levés tous les deux, et criez au Dieu de miséricorde, et il vous sauvera, et il aura compassion de vous. N'aie point crainte, elle t'est de tout temps destinée, et tu la sauveras, et elle te suivra, et j'espère que tu auras d'elle des enfants.",
        19: "Et, en entendant ces paroles, Tobie aima Sara, et son cœur s'attacha vivement à elle.",
    },
    7: {
        1: 'Et il entra dans Ecbatane, il arriva devant la maison de Raguel, et Sara vint à sa rencontre; elle souhaita le bonjour au jeune homme, et son père à tous les deux; puis, il les introduisit en sa maison.',
        ...
        6: "Et il s'élança, et il l'embrassa, et il se prit à pleurer. Et il le bénit, et il s'écria: Ô fils d'un homme honorable et bon. Puis, apprenant que Tobit avait perdu la vue, il fut contristé, et il pleura.",
        7: "Et Edna, sa femme, et Sara, sa fille, pleurèrent; ensuite, ils leur firent l'accueil le plus empressé.",
        8: 'Ils sacrifièrent un bélier, et ils servirent des mets en abondance.',
        9: "Et Tobie dit à Raphaël: Frère Azarias, parle à Raguel de ce que tu m'as dit en chemin, et que l'affaire s'accomplisse.",
        10: "Et Raphaël parla à Raguel, et celui-ci dit à Tobie: Mange et bois, et tiens-toi joyeux. Il t'appartient d'épouser mon enfant; mais je te déclarerai la vérité.",
    ...
    8: {
        ...
        3: "Et dès que le démon sentit l'odeur, il s'enfuit au fond de la haute Égypte, où l'ange l'enchaîna.",
        ...
        7: "Et maintenant, Seigneur, ce n'est point par concupiscence que j'épouse ma sœur que voici, mais en esprit de vérité; envoyez-moi votre miséricorde, faites que nous vieillissions ensemble.",
    ...
    10: {
        ...
        8: "Et Tobie dit à Raguel: Congédie-moi, car mon père et ma mère n'espèrent plus me revoir.",
        9: "Et le beau-père repartit: Demeure auprès de moi, et j'enverrai chez ton père, et je l'informerai de ce qui te concerne. Et Tobie reprit: Laisse-moi retourner chez mon père.",
        10: "Et Raguel, s'étant levé, lui donna Sara sa femme, et lui donna la moitié de ses biens, en esclaves, en argent et en bétail.",
        11: "Et, l'ayant béni, il le congédia, disant: Que le Dieu du ciel vous fasse prospérer, enfants, tant que je vivrai.",
        12: "Et il dit à sa fille: Honore ton beau-père et ta belle-mère; ils sont désormais tes parents; que j'entende de toi bonne renommée; et il l'embrassa.",
        13: "Et Edna dit à Tobie: Frère bien-aimé, que le Seigneur Dieu du ciel te conserve, qu'il m'accorde de te voir des enfants de Sara ma fille, afin que je me réjouisse devant le Seigneur. Voilà que je te confie ma fille, en disant: Garde-toi de la jamais affliger.",
        14: 'Après cela, Tobie partit bénissant Dieu qui lui avait fait faire un si heureux voyage; et il bénissait Raguel et Edna sa femme.',
    },
    11: {
        1: "Et il allait, jusqu'à ce qu'ils fussent près de Ninive. Et Raphaël dit à Tobie:",
        2: 'Ne sais-tu pas, frère, comment tu as laissé ton père?',
        ...
        19: "Et Achiachare et Nabbas ses cousins germains survinrent. Et l'on célébra avec de grandes réjouissances les noces de Tobie, pendant sept jours.",
    },
    12: {
        ...
        11: 'Je ne veux rien tous celer, et je viens de dire: Il est louable de garder le secret des rois; mais, pour les œuvres du Seigneur, il est glorieux de les révéler.',
        ...
        18: "Car ce n'est point par ma grâce à moi, maïs par la volonté de notre Dieu, que je suis venu; bénissez-le donc dans tous les siècles.",
        ...
        20: "Rendez gloire à Dieu; car, pour moi, je remonte vers celui qui m'a envoyé, et écrivez en un livre tout ce qui s'est accompli.",
    ...
    13: {
        1: 'Et dans le transport de sa joie, Tobit écrivit une prière, et il dit:',
        2: "Bénis soient dans tous les siècles le Dieu vivant et son règne! C'est lui qui châtie et fait miséricorde; il conduit aux enfers et il en ramène, et nul ne peut éviter sa main.",
        ...
        6: 'Si vous retournez à lui de tout votre cœur et de toute votre âme pour faire la vérité en sa présence, lui-même reviendra à vous, et il ne vous cachera plus sa face.',
        7: "Voyez ce qu'il a fait pour vous; rendez-lui gloire à pleine voix; bénissez le Seigneur de la justice, exaltez le Roi des siècles.",
        8: "Pour moi, en la terre où je suis captif, je lui rends gloire, et je fais voir au peuple des pécheurs sa force et sa magnificence. Convertissez-vous, pécheurs; et faites la justice en sa présence; qui sait s'il vous sera favorable, s'il vous fera miséricorde?",
        9: "J'exalte mon Dieu; mon âme est au Roi du ciel, elle se glorifiera de sa magnificence.",
        10: 'Proclamez-le tous; rendez-lui gloire dans Jérusalem. Jérusalem, ville du Saint, il te flagellera à cause des œuvres de tes enfants, et il fera miséricorde aux fils des justes.',
        11: "Rends au Seigneur une grande gloire; bénis le Roi des siècles; afin qu'en toi son tabernacle soit relevé avec allégresse.",
        12: "Qu'il y comble de joie les captifs, qu'il y aime les affligés dans toutes les générations du siècle.",
        13: "Nombre de nations lointaines viendront vers le nom du Seigneur Dieu, portant en leurs mains des présents, des présents pour le Roi du ciel; les générations des générations te causeront des transports d'allégresse.",
        14: "Maudits soient tous ceux qui te haïssent! Bénis soient à jamais ceux qui t'aiment!",
        15: "Réjouis-toi, tressaille d'allégresse, au sujet des fils des justes, car ils seront réunis, et ils béniront le Seigneur. Ô heureux ceux qui t'aiment! ils mettront leur joie dans ta paix;",
        16: 'Heureux tous ceux qui se sont affligés de tes fléaux nombreux, car ils se réjouiront en contemplant toute ta gloire, et leur allégresse sera éternelle! Que mon âme bénisse Dieu, le grand Roi,',
        17: "Parce qu'il rebâtira Jérusalem en émeraudes et en saphirs, parce qu'il l'entourera d'une muraille de pierres précieuses, et qu'il la couronnera de tours et de créneaux de l'or le plus pur; parce qu'il pavera d'anthrax et de béril les places de Jérusalem, et qu'il les ornera de mosaïques en pierres d'Ophir.",
        18: 'Et toutes ses rues diront: Alléluia, louange à Dieu, et elles répéteront: Béni soit le Dieu qui a exalté tous les siècles!',
    },
    14: {
        ...
        6: 'Et tous les Gentils se convertiront sincèrement à la crainte du Seigneur, et ils enfouiront leurs idoles. Et toutes les nations béniront le Seigneur,',
        7: "Et son peuple rendra gloire à Dieu, et le Seigneur glorifiera son peuple, et tous ceux qui aiment le Seigneur Dieu dans la vérité et la justice tressailliront d'allégresse, et ils seront miséricordieux pour nos frères.",
        8: "Maintenant donc, mon enfant, abandonne Ninive; car tout ce qu'a prédit le prophète Jonas arrivera.",
        9: "Et toi observe la loi et les commandements, et ne cesse pas d'être juste et miséricordieux, afin de trouver le bien. Et ensevelis-moi avec honneur, et auprès de moi ta mère, et ne restez pas à Ninive.",
        10: "Enfant, vois comme Aman a traité Achiachare qui l'avait élevé; comme de la lumière il l'a conduit aux ténèbres, et quelle reconnaissance il a eue pour lui. Toutefois Achiachare a été sauvé; il a obtenu ce qui lui a été rendu; et Aman lui-même est descendu dans les ténèbres. Manassès a fait la miséricorde: Achiachare a été tiré du piège de mort qu'on lui avait tendu; Aman est tombé dans le piège et y a péri.",
        ...
        15: 'Et, avant de mourir, il apprit la ruine de Ninive que prit Nabuchodonosor, avec Asuéros, et il eut cette joie, avant de mourir, au sujet de Ninive.',
    },
}
