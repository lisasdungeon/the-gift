...
CHAPTERS = {
    1: {
        1: 'Les Juifs qui sont dans Jérusalem et dans le pays de Judée, aux Juifs leurs frères qui sont en Egypte, salut et heureuse paix.',
        ...
        10: "L'an cent quatre-vingt-huit. Le peuple qui est à Jérusalem et dans la Judée, le sénat et Judas, à Aristobole, maître du roi Ptolémée, de la race des prêtres sacrés, et aux Juifs qui sont en Egypte, salut et santé.",
    ...
    2: {
        ...
        5: "Etant arrivé là, Jérémie trouva une caverne, et il y porta le tabernacle, l'arche et l'autel de l'encensement; puis il obstrua l'entrée.",
    ...
    3: {
        ...
        5: 'Mais, ne pouvant pas vaincre Onias, il alla trouver Apollonius, fils de Tharsée, qui commandait en ce temps-là dans la Cœlésyrie et dans la Phénicie;',
        ...
        8: "Aussitôt Héliodore se mit en route, en apparence pour visiter les villes de Cœlésyrie et de Phénicie, mais en réalité pour exécuter l'intention du roi.",
    ...
    4: {
        ...
        4: "Onias, considérant le danger de ces querelles, et l'emportement d'Apollonius, qui, en tant que gouverneur de la Cœlésyrie et de la Phénicie, excitait la malice de Simon, alla trouver le roi,",
        ...
        21: "Cependant Apollonius, fils de Mnesthée, ayant été envoyé en Egypte à cause des premiers ministres du roi Ptolémée Philométor, Antiochus apprit qu'on l'avait rendu étranger aux affaires du royaume; alors, songeant à ses propres intérêts, il partit de là, vint à Joppé, et ensuite à Jérusalem.",
    ...
    5: {
        1: "En ce même temps, Antiochus préparait une seconde expédition contre l'Egypte.",
        ...
        8: 'Enfin, pour sa perte, poursuivi par Arétas, roi des Arabes, fuyant de ville en ville, haï de tous comme un violateur des lois, comme un homme exécrable, comme un ennemi de sa patrie et de ses concitoyens, il fut chassé en Egypte;',
        ...
        11: "Ces choses s'étant passées ainsi, le roi soupçonna que les Juifs abandonneraient l'alliance; c'est pourquoi il partit d'Egypte plein de fureur, et il prit la ville par les armes.",
    ...
    6: {
        ...
        18: "Eléazar, l'un des premiers des scribes, homme avancé en âge et beau de visage, fut pressé de manger de la chair de pourceau, la bouche ouverte par force.",
        ...
        24: "Car il n'est pas digne de notre âge, dit-il, d'user d'une fiction qui serait cause que beaucoup de jeunes gens, s'imaginant qu'Eléazar, à l'âge de quatre-vingt-dix ans, aurait passé à la manière de vivre des païens,",
    ...
    7: {
        1: "Or il arriva que l'on prie aussi sept frères avec leur mère, et que le roi voulut les contraindre à manger, contre la défense de la loi, de la chair de pourceau, en les tourmentant avec des fouets et des lanières de taureau.",
    ...
    8: {
        ...
        8: "Alors Philippe voyant que cet homme grandissait peu à peu, et que ses entreprises réussissaient presque toujours, écrivit à Ptolémée, qui commandait dans la Cœlésyrie et dans la Phénicie, d'apporter du secours aux affaires du roi.",
    ...
    9: {
        1: 'En ce même temps, Anthiochus revenait honteusement de Perse.',
        ...
        29: "Philippe, son frère de lait, fit transporter son cadavre, et, craignant le fils d'Antiochus, il s'en alla en Egypte auprès de Ptolémée Philométor.",
    },
    10: {
    ...
    12: {
        ...
        27: "Après leur fuite et leur carnage, il fit marcher son armée vers Ephron, ville forte, où habitait une grande multitude de divers peuples; et de vaillants jeunes gens, debout devant les remparts, les défendaient vigoureusement; et il y avait à l'intérieur de nombreuses machines et une provision de dards.",
    ...
    13: {
        ...
        6: 'Il ordonna que ce sacrilège fût précipité de là dans la cendre, tous le poussant à la mort.',
        ...
        22: "Le roi parlementa de nouveau avec ceux qui étaient dans Bethsura, leur donna la main, la reçut d'eux et s'en alla. Il combattit contre Judas, et fut vaincu.",
        23: "Mais ayant appris que Philippe, qui avait été laissé à la tête des affaires, s'était révolté à Antioche, il en fut consterné; il supplia les Juifs, se soumit à eux, et jura tout ce qui parut juste; et après cette réconciliation il offrit un sacrifice, honora le temple et y offrit des dons.",
    ...
    15: {
        ...
        2: "Et comme les Juifs qui le suivaient par nécessité disaient: N'agis pas si fièrement ni d'un manière si barbare, mais rends honneur au jour de la sanctification, et révère Celui qui voit toutes choses;",
        ...
        22: "Dans son invocation, il parla ainsi: Vous, Seigneur, qui avez envoyé Votre Ange sous Ezéchias, roi de Juda, et qui avez tué cent quatre-vint-cinq mille hommes de l'armée de Sennachérib;",
