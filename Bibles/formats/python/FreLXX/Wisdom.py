...
CHAPTERS = {
    1: {
        ...
        3: "Les pensées tortueuses éloignent de Dieu, et Sa puissance confond les insensés, quand ils la mettent à l'épreuve.",
        ...
        12: "Ne cherchez point la mort par les égarements de votre vie; n'attirez point votre perdition par les œuvres de vos mains.",
        13: "Car Dieu n'a point fait la mort, et Il ne Se réjouit point de la perdition des vivants.",
    ...
    2: {
        ...
        3: "Quand elle sera éteinte, le corps sera cendre, et le souffle se répandra comme l'air insaisissable.",
        4: "Et notre nom sera oublié dans le temps, et nul ne se souviendra de nos œuvres; et notre vie passera comme l'ombre d'un nuage; elle se dissipera comme un brouillard chassé par les rayons du soleil, et tombant sous la chaleur.",
        5: "Car notre vie est le passage d'une ombre; notre fin est sans retour; elle est scellée, et nul ne revient.",
        ...
        9: "Que nul de nous ne soit privé de nos plaisirs; laissons partout des signes de nos joies: car c'est là notre partage, c'est notre sort.",
        ...
        12: 'Tendons des pièges au juste; car il nous est importun; il est contraire à nos œuvres; il nous reproche nos manquements à la loi; il nous diffame en décriant notre conduite.',
        ...
        17: "Voyons s'il y a quelque vérité en ses paroles; éprouvons les choses de sa fin.",
        18: 'Car si le juste est fils de Dieu, Dieu le protégera, et le tirera des mains de ses adversaires.',
        ...
        21: "Voilà comme ils ont raisonné, et ils sont tombés dans l'erreur; car leur malice les a aveuglés.",
        22: "Et ils n'ont point pénétré les mystères de Dieu; ils n'ont point cru qu'il y eût un salaire pour la sainteté, et ils n'ont fait nul cas de la récompense destinée aux innocents.",
    ...
    3: {
        ...
        5: "Leur affliction fut légère, grande sera leur récompense; car Dieu les a mis à l'épreuve, et les a trouvés dignes de Lui.",
        ...
        13: "Leur race est maudite. Heureuse la femme stérile, mais non souillée, qui n'a pas déshonoré sa couche par le péché; elle aura sa récompense le jour de la visite des âmes.",
        14: "Et l'eunuque qui, de ses mains, n'aura pas fait œuvre d'iniquité, et n'aura point pensé à mal contre le Seigneur, recevra une grâce particulière de foi, et, dans le temple du Seigneur, un partage digne d'envie.",
        ...
        17: "Et s'ils vivent longtemps, ils seront comblés pour rien; et les derniers jours de leur vieillesse seront sans honneurs.",
    ...
    4: {
        1: 'Mieux vaut la virginité avec la vertu; car sa mémoire est immortelle, elle est connue et de Dieu et des hommes.',
        ...
        7: "mais le juste, s'il est parvenu à la mort, sera en repos.",
        ...
        11: 'Il a été enlevé, de peur que leur malice ne pervertît son intelligence, ou que la ruse ne trompât son âme.',
        ...
        13: "L'homme parfait, en peu de temps, a rempli de longs jours.",
        ...
        18: "Ils la verront, et n'en tiendront aucun compte; mais le Seigneur Se rira d'eux.",
        ...
        20: 'Ils viendront tout tremblants au souvenir de leurs péchés, et leurs iniquités passeront devant eux pour les accuser.',
    },
    5: {
        ...
        2: 'À son aspect, ils seront troublés, pleins de crainte, stupéfaits de son salut inespéré.',
        3: "Ils se diront repentants, gémissants en l'angoisse de leur esprit: Voilà donc celui que nous tenions autrefois en dérision et en opprobre!",
        ...
        14: "L'espérance des impies est donc comme la poussière emportée par le vent; comme la gelée blanche fondue par la tempête; comme la fumée dispersée; au moindre souffle, elle s'est évanouie, comme le souvenir d'un hôte qui n'est resté qu'un jour, et a passé.",
        ...
        17: "Il S'armera de Son zèle, et Il en couvrira Sa créature pour la venger de Ses ennemis.",
        ...
        20: 'Il aiguisera Sa terrible colère pour en faire Sa lance, et le monde, de concert avec Lui, subjuguera les insensés.',
        21: "Les traits infaillibles de Son tonnerre partiront, et, comme ceux de l'arc des nuées, ils s'élanceront au but.",
        22: 'Et la grêle tombera avec violence comme une pluie de pierres. Les eaux de la mer tourneront contre eux leur fureur, et les fleuves déborderont en courroux.',
    ...
    6: {
        ...
        3: 'Votre puissance vous a été donnée par le Seigneur; votre autorité vient du Très-Haut, qui interrogera vos œuvres, et scrutera vos desseins.',
        ...
        7: "Le Maître de toutes choses n'aura point égard au rang; Il ne considérera pas la grandeur: c'est Lui qui a créé le petit et le grand, et Sa providence veille également sur tous.",
        8: 'Une enquête plus rigide est réservée aux plus puissants.',
        9: "Ô rois, c'est à vous que s'adressent mes paroles, afin que vous appreniez la sagesse, et que vous ne vous en écartiez point.",
        10: "Car ceux qui gardent saintement les choses saintes seront sanctifiés, et ceux qui les auront apprises y trouveront ce qu'ils ont à répondre.",
        ...
        15: "Penser à elle est une prudence consommée; celui qui veille pour elle sera bientôt exempt d'inquiétude.",
        16: "Elle s'en va à la ronde, cherchant ceux qui sont dignes d'elle, et se manifeste avec bienveillance en leurs sentiers, et va à la rencontre de tous leurs desseins.",
        ...
        21: 'Ainsi, rois des peuples, si vous mettez votre joie dans les trônes et les sceptres, honorez la sagesse, afin que vous soyez rois éternellement.',
        ...
        23: "Je ne cheminerai point avec celui que l'envie consume; car celui-là n'aura point de part à la sagesse.",
    ...
    7: {
        1: "Et moi aussi, je suis un homme mortel, semblable à tous, né de la race du premier créé; et j'ai été fait chair, dans les entrailles d'une femme,",
        2: "coagulé dans le sang en dix mois; fruit de la semence d'un homme, et du plaisir qui vient avec le sommeil.",
        3: "Et moi aussi, aussitôt né, j'ai respira l'air commun à tous; je suis tombé sur une terre également misérable, et, comme tous, j'ai jeté ma première voix en pleurant.",
        4: "J'ai été élevé dans les langes entouré de soins.",
        5: 'Car nul des rois ne commence autrement à naître;',
        6: 'même entrée dans la vire, et même sortie pour tous.',
        ...
        10: "Je l'ai aimée plus que la santé, plus que la beauté; et je l'aurais choisie de préférence à la lumière, parce que sa lumière ne s'éteint jamais.",
        11: "Tous les biens à la fois me sont venus avec elle, et dans ses mains elles a d'innombrables richesses.",
        12: "Et je me suis réjoui de toutes ces choses, parce que la sagesse elle-même me les amenait, et pourtant j'ignorais qu'elle en fût la mère.",
        ...
        16: 'Car nos sommes en Ses mains, nous et nos paroles, et toute notre sagesse, et la science de nos œuvres.',
        ...
        22: 'En elle réside un esprit intelligent, saint, unique et multiple, subtil, vif, pénétrant, pur, clair, incorruptible, ami du bien, rapide, libre et bienfaisant,',
        ...
        27: 'Unique, elle peut tout; immuable, elle renouvelle tout; et, de génération en génération, pénétrant dans les âmes saintes, elle forme les amis de Dieu et les prophètes.',
        ...
        30: 'Car la nuit succède au jour; mais le mal ne prévaut pas sur la Sagesse.',
    },
    8: {
        1: "La Sagesse, dans sa force, s'étend d'une extrémité de la terre à l'autre; elle règle toutes choses avec perfection.",
        2: "Je l'ai aimée et je l'ai choisie dès ma jeunesse; je l'ai cherchée afin de la prendre pour épouse, tant j'étais épris de sa beauté.",
        ...
        12: "Quand je me tairai, ils seront dans l'attente; quand je parlerai, ils auront les yeux sur moi; et si je parle plus longuement, ils ne mettront une main sur la bouche.",
        ...
        16: 'Rentré dans mon palais, je me reposerai avec la Sagesse; car son entretien est sans amertume; son commerce donne non de la douleur, mais du bonheur et de la joie.',
        ...
        21: "et que je sus qu'en aucune manière, je ne serais chaste, à moins que Dieu ne me fit ce don, et que cela même était de la sagesse, de savoir de qui en venait la grâce, j'allai au Seigneur, et je Le priai, et je Lui dis de toute mon âme",
    },
    9: {
        1: 'Dieu de mes pères, Seigneur miséricordieux, qui par Ta Parole as créé toutes choses;',
        2: "qui en Ta Sagesse as formé l'homme, pour qu'il régnât sur toutes les créatures;",
        3: "pour qu'il gouvernât le monde avec sainteté et justice, et qu'il jugeât dans la droiture de son âme;",
        4: "donne-moi la Sagesse, celle qui siège avec Toi sur Tes trônes, et ne me réprouves pas d'entre Tes enfants.",
        5: 'Je suis Ton serviteur et le fils de Ta servante, homme faible et de peu de durée, et des moindres en intelligence du jugement et de la loi.',
        6: "Car, si l'un des fils des hommes était parfait, Ta Sagesse lui manquant, il serait compté pour rien.",
        7: "Tu m'as élu roi de Ton peuple, juge de Tes fils et de Tes filles;",
        8: "Tu m'as dit de bâtir un temple sur Ta montagne sainte, et un autel dans la cité de Ton tabernacle, image du saint tabernacle que, dès le commencement, Tu as préparé.",
        9: 'Et avec Toi est la Sagesse qui connaît Tes œuvres; elle était présente, lorsque Tu as créé le monde; elle sait ce qui est agréable à Tes yeux, et quelle est la droiture de Tes commandements.',
        10: "Fais-la descendre des cieux, qui sont Ton sanctuaire; envoie-la du trône de Ta gloire, afin qu'elle soit avec moi, qu'elle travaille avec moi, et que je sache ce qui T'est agréable.",
        11: 'Car elle sait et comprend tout; elle me dirigera avec prudence dans toutes mes œuvres; elle me gardera par sa gloire.',
        12: 'Et mes œuvres seront bien accueillies; et je jugerai Ton peuple avec prudence, et je serai digne des trônes de mon père.',
        ...
        17: "Qui connaît Ton conseil, si Tu ne lui as donné la Sagesse, et si, d'en haut, Tu ne lui as envoyé Ton Esprit Saint?",
        18: "C'est Lui qui redresse les sentiers de ceux qui cheminent sur la terre; c'est de Lui que les hommes apprennent les choses qui Te sont agréables,",
    },
    10: {
        ...
        12: "C'est elle qui le protégea contre ses ennemis, l'affermit contre les séducteurs, et lui décerna le prix d'une lutte pénible, pour lui apprendre que la piété est plus forte que toute chose.",
        13: "Elle ne lui délaissa point le juste qu'on avait vendu; mais elle le préserva du péché. Elle descendit avec lui dans la citerne;",
        ...
        16: "Elle entra dans l'âme du serviteur de Dieu, et il tint tête à des rois redoutables, en faisant des signes et des prodiges.",
        ...
        20: "C'est pourquoi les justes s'emparèrent de la dépouilles des impies, et ils chantèrent, ô Seigneur, Ton saint Nom, et louèrent tout d'une voix Ta main tutélaire.",
        21: 'Car la Sagesse a ouvert la bouche des muets, et a fait éloquente la langue des enfants.',
    },
    11: {
        ...
        14: "Quand jadis Il était entré en explication avec eux, ils L'avaient méconnu et raillé; mais ils ont été bien surpris de l'issue des événements, n'ayant pas eu la même soif que les justes.",
        15: "En expiation des faux raisonnements de leurs iniquités, qui les avaient égarés et entraînés à adorer des reptiles engourdis et des bêtes méprisables, Tu leur as envoyé une multitude d'animaux sans raison,",
        16: "afin qu'ils sachent que l'on est puni par où l'on a péché.",
        17: "Ta main toute puissante, la main qui, d'une matière informe, a créé le monde, n'aurait pas eu de peine à leur envoyer une multitude d'ours, de lions audacieux,",
        18: "ou de bêtes inconnues d'une nouvelle espèce, et pleines de rage: les unes soufflant un air enflammé ou une fumée infecte; les autres lançant de leurs yeux de terribles étincelles;",
        19: "telles que non seulement leurs atteintes auraient pu les détruire, mais que leur aspect seul les eût frappés d'un effroi mortel.",
        20: 'Et sans cela même, un souffle eût suffi pour les abattre, poursuivis par Ta justice et vannés au vent de Ta puissance. Mais Tu as tout réglé avec poids et mesure.',
        21: "Car c'est à Toi qu'il appartient de prévaloir en tous lieux par la force; et qui donc résisterait à la puissance de Ton bras?",
        22: "L'univers est devant Toi comme le grain de sable qui fait pencher la balance, ou comme la goutte de rosée qui, le matin, descend sur la terre.",
        23: 'Mais Tu as pitié de tous, parce que Tu peux tout; et Tu feins de ne point voir les péchés des hommes, en vue du repentir.',
        24: "Tu as aimé tous les êtres; Tu n'as en abomination rien de ce que Tu as créé, et Tu n'as rien préparé de Tu dusses haïr.",
        25: "Quelle chose subsisterait, si Tu ne le voulais; ou durerait, si Tu ne l'avait appelée?",
        26: "Mais Tu pardonnes à tout, parce que tout T'appartient, ô Maître qui aime les âmes!",
    },
    12: {
        1: 'Ton Esprit en toute chose est infaillible.',
        2: 'Aussi, peu à peu Tu réprimandes ceux qui tombent; Tu avertis les pécheurs, en ranimant leurs souvenirs, afin que, se corrigeant de leur malice, ils aient foi en Toi, Seigneur.',
        3: 'Car Tu as pris en haine les anciens habitants de Ta terre sainte,',
        4: "parce qu'ils avaient fait les œuvres odieuses des enchanteurs, et qu'ils avaient des initiations impies;",
        5: "parce qu'ils égorgeaient sans pitié leurs enfants, qu'ils mangeaient des entrailles humaines, et buvaient le sang au milieu de Tes fêtes,",
        6: "et qu'ils étaient ainsi pères et homicides d'âmes abandonnées; Tu as donc voulu les exterminer, par les mains de nos pères,",
        7: 'afin que cette terre qui, entre toutes, était la plus aimée de Toi, devînt un lieu de passage pour les enfants de Dieu.',
        ...
        17: "Tu montres cette force à ceux qui doutent de la perfection de Ta vertu, et Tu punis l'audace de ceux qui la connaissent et la bravent.",
        18: "Maître de Ta force, Tu juges avec douceur et Tu nous gouvernes avec beaucoup de ménagements; car il T'appartient de pouvoir quand Tu veux.",
        19: "Et, par de telles œuvres, Tu as appris à Ton peuple qu'il doit être juste et humain, et Tu as rempli Tes fils d'espérance, en leur donnant le repentir après leurs fautes.",
        20: "Mais si en punissant les ennemis de Tes enfants, voués justement à la mort, Tu y a mis tant de prudence et d'égards; si Tu leur as accordé le temps et l'occasion de se corriger de leur malice,",
        21: "avec quelle attention n'as-Tu pas jugé Tes fils, en faisant avec leurs pères des alliances et des serments de bonnes promesses?",
        22: 'Lors donc que Tu nous corriges, Tu flagelles de mille manières Tes ennemis, afin que, jugeant, nous songions à Ton amour, et que, jugés, nous espérions en Ta miséricorde.',
        23: "De là vient aussi que Tu as fait souffrir, à cause de leurs abominations, les méchants qui avaient vécu dans la folie et l'iniquité.",
        24: "Ils s'étaient au loin égarés dans les voies de l'erreur, prenant pour dieux les plus vils des animaux malfaisants, égarés comme des enfants sans raison.",
        25: "Ainsi les as-Tu frappés d'un jugement dérisoire, comme des enfants insensés.",
        26: "Et ceux que n'ont point avertis les dérisions de la réprimande, feront l'épreuve d'un jugement digne de Dieu.",
        27: "Touchés de leurs souffrances, ils se sont indignés contre ce qu'ils croyaient des dieux; châtiés par eux, ils ont reconnu que ce Dieu qu'ils avaient d'abord rejeté est le vrai Dieu, et c'est ainsi que la fin de leur condamnation est venue.",
    },
    13: {
        ...
        10: 'Mais ceux-là sont malheureux (et leur espérance est parmi les morts), qui ont appelé qui ont appelé "dieu" des ouvrages de la main des hommes, or ou argent, productions de l\'art, images des animaux ou pierre inerte, travail d\'un artisan irréfléchi.',
        ...
        14: "Ou bien il en a fait la ressemblance de quelque vil animal; puis il l'a frotté de vermillon, il l'a fardé de rouge, et il en a masqué tous les défauts.",
    ...
    14: {
        ...
        21: 'Et ce fut le piège où tombèrent les humains; soit hasard, soit servilité envers la tyrannie, ils donnèrent à la pierre ou au bois un nom qui ne pouvait lui appartenir.',
        22: "Ensuite il ne leur suffit pas d'avoir erré dans la connaissance de Dieu; mais, vivant dans la rude bataille de l'ignorance, ils donnèrent le nom de paix à tant et de si grands maux,",
        23: 'soit en des initiations infanticides, soit en de secrets mystères, soit emportés, selon les lois, en des orgies furieuses.',
        ...
        26: 'oubli de la grâce, souillure des âmes, confusion des naissances, dérèglement dans le mariage, adultère et débauche.',
        ...
        29: 'En se confiant à des images sans âme, en prêtant de faux serments, ils ne croient pas se nuire à eux-mêmes.',
        30: "Un double et juste châtiment les atteindra, parce qu'ils ont de Dieu une idée mauvaise en s'attachant aux idoles, et parce que, au mépris de toute sainteté, ils ont juré dans un esprit de fraude.",
    ...
    15: {
        1: 'Mais Toi, ô mon Dieu, Tu es bon et vrai; Tu es patient, et Tu gouvernes toutes choses avec miséricorde.',
        2: "Lors même que nous péchons, nous ne cessons pas d'être à Toi, connaissant Ta puissance; et si nous ne péchons pas, nous savons que nous sommes comptés parmi ceux qui T'appartiennent.",
        3: "Te connaître, c'est la parfaite justice; connaître Ta puissance, c'est la racine de l'immortalité.",
    ...
    16: {
        ...
        4: "Ceux-là, en punition de leur tyrannie, devaient souffrir d'une indigence sans remède; à ceux-ci Tu Te bornais à leur faire voir comment leurs ennemis étaient tourmentés.",
        5: "Sur eux aussi, à la vérité, se tourna la rage furieuse d'animaux terribles; ils furent mordus par des serpents tortueux, mais Ta colère ne persista pas au point de les détruire.",
        6: 'Ils furent un moment troublés par cet avertissement, et ils élevèrent un signe de salut, comme mémorial de Ta loi et Tu leur avait intimée.',
        7: "Et celui qui se convertissait n'était point sauvé pour avoir regardé ce signe, mais à cause de Toi, Sauveur universel!",
        8: 'Et de cette manière Tu as convaincu nos ennemis que Tu es Celui qui délivre de tout mal.',
        9: "Car les morsures des sauterelles et des mouches avaient tué les Égyptiens, et il ne s'était point trouvé de guérison pour leurs âmes, parce qu'ils méritaient d'être punis comme ils l'avaient été.",
        10: 'Mais Tes enfants ne furent point vaincus par les dents venimeuses des dragons, parce que Ta miséricorde survint et les guérit.',
        11: "Pour qu'ils se souvinssent de Tes commandements, ils avaient été aiguillonnés; mais ils furent promptement guéris, de peur que, tombant dans un profond oubli, ils ne pussent jouir de Tes bienfaits.",
        12: "Or il n'y eut ni herbe ni émollient qui les guérit; mais, ô Seigneur, ce fut Ta Parole, cette Parole qui guérit tout.",
        13: "Car Tu as pouvoir de vie et de mort; Tu conduis aux portes de l'enfer, et Tu en ramènes.",
        14: "Un homme tue dans sa perversité, et l'âme, une fois sortie, ne revient pas; et cet homme ne peut la rappeler pour la prendre de nouveau.",
        15: "Mais il est impossible d'échapper à Ta main.",
        16: 'Les impies, refusant de Te connaître, ont été flagellés par la force de Ton bras; ils ont été persécutés par des plaies surnaturelles, par de la grêle, par des orages, et ils ont été dévorés par le feu.',
        17: "Et, merveille suprême! Le feu redoublait de fureur au milieu de l'eau qui éteint tout; car l'univers est l'auxiliaire des justes.",
        ...
        20: 'Au contraire, Tu as distribué à Ton peuple le pain des anges; Tu as envoyé pour lui le pain du ciel préparé sans labeur, plein de délices et en harmonie avec tous les goûts.',
        21: 'Cette substance, venue de Toi, manifesta Ta bonté pour Tes enfants; et, se conformant aux désirs de ceux qui la mangeaient, elle prit le goût que chacun voulait.',
        22: "Au contraire, c'était pour Tes ennemis une neige, une glace qui résistait au feu sans se fondre; et l'on n'ignorait pas que la flamme, en consumant les fruits des Égyptiens, brûlait au milieu de la grêle, et resplendissait au milieu des pluies.",
    ...
    17: {
        ...
        15: "Et si l'un deux venait à tomber, n'importe où, il restait là enfermé dans cette prison sans fers.",
        ...
        18: "le fracas étrange des rochers qui s'écroulaient, la course des animaux bondissant inaperçus, les voix des hôtes farouches, l'écho répété par le creux des montagnes, les glaçaient de terreur.",
    ...
    18: {
        1: 'Cependant la plus vive lumière brillait pour Tes saints; ils entendaient les cris des Égyptiens sans voir leur visage, et ils se glorifiaient de ne point souffrir comme eux.',
        2: "Et ils Te rendaient grâces de ce que ceux qui les avaient maltraités ne pouvaient plus leur nuire; et ils demandaient comme une faveur qu'il y eût cette différence entre eux et leurs ennemis.",
        3: "Et c'est pourquoi Tu leur as donné une colonne ardente pour les conduire dans une terre inconnue, soleil tempéré d'un voyage rempli de Tes bienfaits.",
        4: "Mais les Égyptiens méritaient d'être privés de lumière et d'être emprisonnés dans les ténèbres, pour avoir retenus enfermés Tes enfants, par qui la lumière inaltérable de Ta loi devait être répandue dans le siècle.",
        5: 'Et comme ils avaient résolu de faire périr les enfants des saints, un de ces enfants ayant été exposé et sauvé, pour leur opprobre, Tu as frappé la multitude de leurs fils; et eux, Tu les as tous submergés sous les flots impétueux.',
        6: "Cette nuit avait été annoncée à nos pères, afin qu'instruits avec certitude par des serments auxquels ils crurent, ils eussent bon courage.",
        7: 'Ton peuple fut témoin à la fois du salut des justes et de la ruine de ses ennemis.',
        8: 'Car, en même temps, Tu as puni ces derniers, et nous, Tu nous as appelés et bénis.',
        9: "Les saints enfants des bons offraient en secret leurs sacrifices; ils établissaient d'un sentiment unanime cette loi divine, que les saints participeraient également au bien et au mal; et déjà ils chantaient les louanges de leurs pères.",
        ...
        13: "À cause de leurs enchantements, ils n'avaient pas d'abord été convaincus; mais après l'extermination de leurs premiers-nés, ils reconnurent que ce peuple était fils de Dieu.",
        ...
        16: "Portant le glaive rapide de Ton commandement, sans détour elle s'arrêta, et soudain elle remplit tout de mort; et elle touchait au ciel, et elle marchait sur la terre.",
        17: 'Alors les terribles visions des songes les troubles soudain; alors les épouvantements imprévus les arrêtent;',
        18: 'ils tombent épars à demi morts, et reconnaissent la cause qui les a fait mourir.',
        19: "Car les songes qui les ont troublés la leur ont fait connaître, afin qu'en mourant ils sussent d'où leur venaient ces maux.",
        20: "L'épreuve de la mort atteignit aussi les justes, et un grand nombre fut frappé dans le désert; mais Ta colère ne dura qu'un moment.",
        21: "Car un homme irréprochable se hâta d'intercéder pour eux; revêtu de l'armure de son propre sacerdoce, de la prière et de l'encens de l'expiation, il s'opposa à ta colère, et mit fin à cette calamité en se montrant serviteur de Dieu.",
        22: "Il triompha de Ta colère, non par la force du corps ni par la force des armes, mais par la parole il subjugua l'ange exterminateur, en lui rappelant le souvenir de l'alliance de Dieu et de Ses promesses à nos pères.",
        ...
        24: 'Car le monde entier était dans sa robe sacerdotale, et la gloire des patriarches sur les quatre rangs de pierres gravées, et Ta magnificence, ô Seigneur, sur le diadème de sa tête.',
        25: "À ces signes, l'exterminateur s'arrêta, et le peuple en trembla de crainte; car cette seule épreuve de Ta colère suffisait.",
    },
    19: {
        ...
        3: "Plongés encore dans le deuil, arrosant de leurs larmes les sépulcres des morts, ils se laissaient entraîner par un autre calcul de démence; et ceux qu'ils avaient renvoyés en les suppliant, ils les poursuivent comme des fugitifs.",
        4: "Une juste nécessité les poussait à cette fin; et l'oubli de ce qui venant d'arriver les abusait, afin que le châtiment achevât ce qui manquait à leurs tortures,",
        5: "et que Ton peuple fit l'essai d'une voie miraculeuse, tandis qu'eux-mêmes allaient trouver un genre de mort inconnu.",
        6: "Car alors toute créature reçut d'en haut, sans changer de nature, une forme nouvelle, en obéissant à Tes ordres, afin que Tes fils échappassent sains et saufs.",
        ...
        8: 'par où, tous à la fois, ceux que Ta main abritait passèrent en contemplant ces merveilleux prodiges.',
        9: 'Ils étaient en un pâturage comme des chevaux; ils bondissaient comme des agneaux en te louant, Seigneur, Toi qui les sauvais.',
        ...
        12: 'Au gré de leurs désirs, Dieu fit lever pour eux de la mer des râles de cailles,',
        13: 'dans le même temps que le châtiment atteignait les pécheurs, non sans avoir été avertis par de grands coups de tonnerre; mais ils souffraient justement à cause de leurs péchés.',
