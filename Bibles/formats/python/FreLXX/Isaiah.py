...
CHAPTERS = {
    ...
    4: {
        ...
        4: "Car le Seigneur lavera la souillure des fils et des filles de Sion; et du sang versé parmi eux il la purifiera en un esprit de justice et un met d'ardeur.",
    ...
    8: {
        ...
        23: "Et celui qui sera dans l'angoisse y sera pour longtemps. Bois d'abord ceci, hâte-toi, terre de Zabulon, et toi, terre de Nephthali, et vous, restes des habitants de la côte, et toi, Galilée des Gentils au delà du Jourdain!",
    },
    9: {
        1: 'Peuples qui marchez dans les ténèbres, voyez une grande lumière; et vous qui habitez dans la région ténébreuse de la mort, une lumière luira sur vous;',
        2: "Sur vous qui êtes la plus grande part d'un peuple que vous avez amené, Seigneur, à vos joies; et ils se réjouiront de votre vue, comme ceux qui se réjouissent d'une moisson, ou qui se partagent des dépouilles;",
        3: "Parce que vous avez ôté le joug qui pesait sur eux, et la verge qui courbait leur cou. Car le Seigneur a brisé la verge de ceux qui les pressuraient, comme au jour où il s'est déclaré contre Madian.",
        4: "Ils rendront le prix des robes qu'ils ont accumulées par fraude, et des manteaux qu'ils ont eus par les vicissitudes de la guerre; et ils consentiront à les voir brûlés par le feu.",
        5: "Car un petit enfant nous est né, et un fils nous a été donné; la principauté repose sur son épaule, et il est appelé de ce nom, l'Ange du grand conseil. Par lui j'amènerai la paix sur les princes, par lui la santé et la paix.",
        6: "Sa principauté est grande, et à la paix qu'il donne il n'est point de limites; il s'assoira sur le trône de David, et il possédera son royaume, pour le conduire, et l'affermir dans l'équité et la justice, maintenant et dans tous les siècles; l'amour du Seigneur des armées fera ce prodige.",
        7: 'Le Seigneur a envoyé la mort contre Jacob, et elle est venue contre Israël.',
        8: "Et tout le peuple d'Ephraïm et ceux qui résident en Samarie le connaîtront, eux qui disent dans l'orgueil et l'arrogance de leur cœur:",
        9: 'Les briques sont tombées, mais venez; taillons des pierres, abattons des sycomores et des cèdres, et bâtissons-nous une tour.',
        10: "Et le Seigneur brisera ceux qui s'élèvent contre lui sur la montagne de Sion, et il dispersera les ennemis,",
        11: "La Syrie à l'Orient, les Hellènes à l'Occident, qui dévorent Israël à pleine bouche. Contre eux tous s'est tournée sa fureur, et sa main est encore levée.",
        12: "Et le peuple ne s'est point converti, et il n'a point cherché le Seigneur, avant d'avoir été frappé.",
        13: "Et en un seul jour le Seigneur a retranché d'Israël la tête et la queue, le grand et le petit,",
        14: "Le vieillard et tous ceux qui n'admirent que les apparences, c'est la tête; et le faux prophète qui enseigne l'iniquité, c'est la queue.",
        15: "Et ceux qui déclarent heureux ce peuple sont dans l'égarement, et ils l'égarent en de le dévorer.",
        16: "C'est pourquoi le Seigneur ne mettra pas sa joie en leurs jeunes gens, et il n'aura pitié ni de leurs orphelins ni de leurs veuves, parce qu'ils sont tous déréglés et pervers, et que leurs bouches profèrent toutes l'iniquité. Contre eux tous s'est tournée sa fureur, et sa main est encore levée.",
        17: "Et leur iniquité brûlera comme un feu; elle sera consumée par la flamme comme une herbe sèche; elle s'allumera comme une épaisse forêt de chênes, et tout ce qui environne la colline sera dévoré.",
        18: "A cause de la colère du Seigneur la terre entière sera livrée au feu, et le peuple sera la proie des flammes, et le frère n'aura point pitié de son frère.",
        19: "Il ira à droite, parce qu'il aura faim; il mangera à gauche, et ne sera point rassasié de la chair de son bras.",
        20: "Car Manassé mangera Ephraïm, et Éphraïm, Manassé, parce qu'ensemble ils auront assiégé Juda. Contre eux tous s'est tournée sa fureur, et sa main est encore levée.",
    },
    10: {
    ...
    36: {
        ...
        9: "Et comment pourrez-vous seulement résister en face à l'un de nos chefs? 11 n'y a que des esclaves qui ont mis leur confiance dans les Égyptiens, dans leurs chevaux et leurs cavaliers.",
    ...
    63: {
        1: "Quel est Celui qui vient d'Édom, avec un manteau rouge; qui vient de Bosra, si beau dans sa robe, si redoutable dans sa force? C'est moi qui viens parler sur la justice et le jugement de salut.",
        ...
        5: "J'ai promené mes regards, et nul n'est venu me secourir; j'ai cherché, et je n'ai trouvé nul secours. Et mon bras les a délivrés, et ma colère est survenue.",
        ...
        9: "En toutes leurs afflictions, ce n'est point un ambassadeur ni un ange, mais lui-même qui les a sauvés, parce qu'il les aime, et qu'il les a épargnés. Il les a lui-même rachetés, il les a relevés, il les a glorifiés dans tous les siècles écoulés.",
        10: 'Mais ils ont désobéi, ils ont irrité son Esprit-Saint. Et il les a pris en haine, et lui-même a combattu contre eux.',
        11: "Puis il s'est souvenu des jours antiques, disant: Où est celui qui a fait sortir de la mer le pasteur des brebis? Où est celui qui a placé en eux son Esprit-Saint?",
        12: 'Où est celui qui a conduit Moïse de sa main droite et de son bras glorieux? Il a dompté les flots devant lui pour se donner à lui-même un nom éternel.',
        13: "Il les a conduits à travers l'abîme comme un cheval à travers le désert, et ils n'ont point défailli.",
        14: "Ils étaient là, comme des troupeaux dans les champs. L'Esprit du Seigneur est descendu et les a guidés. C'est ainsi que vous avez conduit votre peuple, pour vous donner un nom glorieux.",
        ...
        18: "Afin que nous héritions d'une petite part de votre montagne sainte. Nos adversaires ont foulé vos demeures saintes.",
        19: "Nous sommes redevenus ce que nous étions au commencement, lorsque vous ne régniez pas sur nous, et que votre nom n'était pas encore invoqué pour nous. Lorsque vous ouvrirez le ciel, la crainte de vous, Seigneur, saisira les montagnes, et elles s'écrouleront.",
    },
    64: {
        1: 'Comme la cire devant le feu, et la flamme consumera vos ennemis, et votre nom sera signalé parmi eux. A votre aspect les nations seront troublées,',
        2: 'Lorsque vous ferez des prodiges; et la crainte de vous saisira les montagnes.',
        3: "Depuis le commencement des siècles nous n'avons point entendu, nos yeux n'ont point vu de Dieu, hormis vous; nous ne connaissons d'œuvres que les vôtres, et vous les accomplirez pour ceux qui attendent votre miséricorde.",
        4: 'Elle viendra au-devant de ceux qui pratiquent la justice, et ils se souviendront de votre voie. Vous vous êtes irrité, parce que nous avons péché, et que nous nous sommes égarés.',
        5: "Et nous sommes tous devenus impurs; et notre justice n'a pas mieux valu qu'un linge souillé de sang. Et à cause de nos péchés nous sommes tombés comme des feuilles, et, comme elles, le vent nous balayera.",
        6: "Et il n'est personne qui invoque votre nom et qui se souvienne de recourir à vous. Car vous avez détourné de nous votre visage, et vous nous avez livrés à cause de nos péchés.",
        7: "Et maintenant, Seigneur, vous êtes notre Père; pour nous, nous sommes de l'argile, nous sommes tous l'œuvre de vos mains.",
        8: "Ne vous irritez pas si fort contre nous, et ne gardez pas pour toujours le souvenir de nos péchés. Mais regardez-nous aujourd'hui; car nous sommes tous votre peuple.",
        9: 'Notre ville sainte était déserte, Sion comme un désert, Jérusalem maudite.',
        10: 'Le temple, notre sanctuaire, et la gloire que nos pères avaient édifiés, étaient des racines brûlées par le feu, et tout ce qui faisait notre orgueil était tombé.',
        11: 'Et pour toutes ces raisons, Seigneur, vous vous êtes contenu; vous avez gardé le silence; vous nous avez humiliés sévèrement.',
    },
    65: {
