...
CHAPTERS = {
    1: {
        ...
        19: 'Men åt Eber föddes två söner; den ene hette Peleg[1], ty i hans tid blev jorden fördelad; och hans broder hette Joktan.',
        ...
        54: 'fursten Magdiel, fursten Iram. Dessa voro Edoms stamfurstar. [1] D. ä. delning.',
    },
    2: {
    ...
    4: {
        ...
        9: 'Men Jaebes var mer ansedd än sina bröder; hans moder hade givit honom namnet Jaebes, i det hon sade: »Jag har fött honom med smärta[1].»',
        ...
        43: 'Och de slogo den sista kvarlevan av amalekiterna; sedan bosatte de sig där och bo där ännu i dag. [1] Hebr beóseb.',
    },
    5: {
    ...
    7: {
        ...
        23: 'Och han gick in till sin hustru, och hon blev havande och födde en son; och han gav honom namnet Beria, därför att det hade skett under en olyckstid[1] för hans hus.',
        ...
        40: 'Alla dessa voro Asers söner, huvudmän för sina familjer, utvalda tappra stridsmän, huvudmän bland hövdingarna; och de som voro upptecknade i deras släktregister såsom dugliga till krigstjänst utgjorde ett antal av tjugusex tusen man. [1] Hebr beraá.',
    },
    8: {
    ...
    13: {
        ...
        11: 'Men det gick David hårt till sinnes att HERREN så hade brutit ned Ussa[1]; och han kallade det stället Peres-Ussa, såsom det heter ännu i dag.',
        ...
        14: 'Sedan blev Guds ark kvar vid Obed-Edoms hus, där den stod i sitt eget hus, i tre månader; men HERREN välsignade Obed-Edoms hus och allt vad som hörde honom till. [1] Hebr parás péres be-Ussá.',
    },
    14: {
        ...
        11: 'Och de drogo upp till Baal-Perasim, och där slog David dem. Då sade David: »Gud har brutit ned[1] mina fiender genom min hand, likasom en vattenflod bryter ned.» Därav fick det stället namnet Baal-Perasim.',
        ...
        17: 'Och ryktet om David gick ut i alla länder, och HERREN lät fruktan för honom komma över alla folk. [1] Hebr parás.',
    },
    15: {
    ...
    21: {
        1: 'Men Satan trädde upp mot Israel och uppeggade David till att räkna Israel.',
        2: 'Då sade David till Joab och till folkets andra hövitsman: »Gån åstad och räknen Israel, från Beer-Seba ända till Dan, och given mig besked därom, så att jag får veta huru många de äro.»',
        3: 'Joab svarade: »Må HERREN än vidare föröka sitt folk hundrafalt. Äro de då icke, min herre konung, allasammans min herres tjänare? Varför begär då min herre sådant? Varför skulle man därmed draga skuld över Israel?',
        4: 'Likväl blev konungens befallning gällande, trots Joab. Alltså drog Joab ut och for omkring i hela Israel, och kom så hem igen till Jerusalem.',
        5: 'Och Joab uppgav för David vilken slutsumma folkräkningen utvisade: i Israel funnos tillsammans elva hundra tusen svärdbeväpnade män, och i Juda funnos fyra hundra sjuttio tusen svärdbeväpnade man.',
        6: 'Men Levi och Benjamin hade han icke räknat jämte de andra, ty konungens befallning var en styggelse för Joab.',
        7: 'Vad som hade skett misshagade Gud, och han hemsökte Israel.',
        8: 'Då sade David till Gud: »Jag har syndat storligen däri att jag har gjort detta; men tillgiv nu din tjänares missgärning, ty jag har handlat mycket dåraktigt.»',
        ...
        15: 'Och Gud sände en ängel mot Jerusalem till att fördärva det. Men när denne höll på att fördärva, såg HERREN därtill och ångrade det onda, så att han sade till ängeln, Fördärvaren[1]: »Det är nog; drag nu din hand tillbaka.» Och HERRENS ängel stod då vid jebuséen Ornans tröskplats.',
        ...
        30: 'Dock vågade David icke komma inför Guds ansikte för att söka honom; så förskräckt var han för HERRENS ängels svärd. [1] Se Fördärvaren i Ordförkl.',
    },
    22: {
        ...
        9: 'Men se, åt dig skall födas en son; han skall bliva en fridsäll man, och jag skall låta honom få fred med alla sina fiender runt omkring; ty Salomo[1] skall han heta, och frid[2] och ro skall jag låta vila över Israel i hans dagar.',
        ...
        19: 'Så vänden nu edert hjärta och eder själ till att söka HERREN, eder Gud; och stån upp och byggen HERREN Guds helgedom, så att man kan föra HERRENS förbundsark och vad annat som hör till Guds helgedom in i det hus som skall byggas åt HERRENS namn.» [1] Hebr Schelomó. [2] Hebr. schalóm.',
    },
    23: {
    ...
    27: {
        1: 'Och detta är förteckningen på Israels barn, efter deras antal med huvudmännen för deras familjer och med över- och underhövitsmännen och med deras tillsyningsmän vilka tjänade konungen i allt som rörde krigsfolkets avdelningar, vilka avdelningar kommo och avgingo skiftevis för var och en av årets alla månader, var avdelning tjugufyra tusen man stark.',
        2: 'Över den första avdelningen, den som tjänstgjorde under första månaden, hade Jasobeam, Sabdiels son, befälet. Och i hans avdelning voro tjugufyra tusen.',
        3: "Han hörde till Peres' barn och var huvudanförare för alla härhövitsmän som tjänstgjorde under första månaden.",
        4: 'Över den andra månadens avdelning hade ahoaiten Dodai befälet, det var hans avdelning; där var ock fursten Miklot. Och i hans avdelning voro tjugufyra tusen.',
        5: 'Den tredje härhövitsmannen, den som tjänstgjorde under tredje månaden, var Benaja, prästen Jojadas son, såsom huvudanförare. Och i hans avdelning voro tjugufyra tusen.',
        6: 'Denne Benaja var en hjälte bland de trettio och hade befälet över de trettio. Och vid hans avdelning var hans son Ammisabad.',
        7: 'Den fjärde, den som tjänstgjorde under fjärde månaden, var Asael, Joabs broder, och efter honom hans son Sebadja. Och i hans avdelning voro tjugufyra tusen',
        8: 'Den femte, den som tjänstgjorde under femte månaden, var hövitsmannen Samhut, jisraiten. Och i hans avdelning voro tjugufyra tusen.',
        9: "Den sjätte, den som tjänstgjorde under sjätte månaden, var tekoaiten Ira, Ickes' son. Och i hans avdelning voro tjugufyra tusen.",
        ...
        33: 'Ahitofel var konungens rådgivare, och arkiten Husai var konungens vän[1].',
        34: 'Efter Ahitofel kom Jojada, Benajas son, och Ebjatar. Och Joab var konungens härhövitsman. [1] Se Vän i Ordförkl.',
    },
    28: {
        ...
        11: 'Och David gav åt sin son Salomo en mönsterbild av förhuset och tempelbyggnaderna, och av förrådskamrarna, de övre salarna och de inre rummen, och av nådastolens[1] boning;',
