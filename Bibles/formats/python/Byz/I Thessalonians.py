...
CHAPTERS = {
    ...
    4: {
        1: 'λοιπον το λοιπον ουν αδελφοι ερωτωμεν υμας και παρακαλουμεν εν κυριω ιησου καθως παρελαβετε παρ ημων το πως δει υμας περιπατειν και αρεσκειν θεω ινα περισσευητε μαλλον',
        ...
        6: 'το μη υπερβαινειν και πλεονεκτειν εν τω πραγματι τον αδελφον αυτου διοτι εκδικος ο κυριος περι παντων τουτων καθως και προειπομεν προειπαμεν υμιν και διεμαρτυραμεθα',
    ...
    5: {
        ...
        10: 'του αποθανοντος υπερ ημων ινα ειτε γρηγορωμεν γρηγορουμεν ειτε καθευδωμεν αμα συν αυτω ζησωμεν',
        ...
        21: 'παντα δε δοκιμαζετε δοκιμαζοντες το καλον κατεχετε',
