...
CHAPTERS = {
    ...
    2: {
        ...
        37: 'ακουσαντες δε κατενυγησαν τη καρδια ειπον τε προς τον πετρον και τους λοιπους αποστολους τι ποιησομεν ποιησωμεν ανδρες αδελφοι',
    ...
    3: {
        ...
        6: 'ειπεν δε πετρος αργυριον και χρυσιον ουχ υπαρχει μοι ο δε εχω τουτο σοι διδωμι εν τω ονοματι ιησου χριστου του ναζωραιου εγειραι εγειρε και περιπατει',
        ...
        23: 'εσται δε πασα ψυχη ητις εαν αν μη ακουση του προφητου εκεινου εξολοθρευθησεται εκ του λαου',
        24: 'και παντες δε οι προφηται απο σαμουηλ και των καθεξης οσοι ελαλησαν και κατηγγειλαν προκατηγγειλαν τας ημερας ταυτας',
    ...
    4: {
        ...
        7: 'και στησαντες αυτους εν μεσω επυνθανοντο εν ποια δυναμει η εν ποιω ονοματι εποιησατε τουτο υμεις',
        ...
        12: 'και ουκ εστιν εν αλλω ουδενι η σωτηρια ουτε γαρ ονομα εστιν ετερον ετερον υπο τον ουρανον το δεδομενον εν ανθρωποις εν ω δει σωθηναι ημας',
        ...
        16: 'λεγοντες τι ποιησομεν ποιησωμεν τοις ανθρωποις τουτοις οτι μεν γαρ γνωστον σημειον γεγονεν δι αυτων πασιν τοις κατοικουσιν ιερουσαλημ φανερον και ου δυναμεθα αρνησασθαι',
        17: 'αλλ ινα μη επι πλειον διανεμηθη εις τον λαον απειλη απειλησομεθα απειλησωμεθα αυτοις μηκετι λαλειν επι τω ονοματι τουτω μηδενι ανθρωπων',
        ...
        21: 'οι δε προσαπειλησαμενοι απελυσαν αυτους μηδεν ευρισκοντες το πως κολασονται αυτους δια τον λαον οτι παντες εδοξαζον τον θεον επι τω γεγονοτι',
        ...
        32: 'του δε πληθους των πιστευσαντων ην η καρδια και η ψυχη μια και ουδε εις τι των υπαρχοντων αυτων αυτω ελεγεν ιδιον ειναι αλλ ην αυτοις απαντα κοινα',
    ...
    5: {
        ...
        12: 'δια δε των χειρων των αποστολων εγινετο εγενετο σημεια και τερατα εν τω λαω πολλα και ησαν ομοθυμαδον απαντες εν τη στοα σολομωντος',
        ...
        33: 'οι δε ακουοντες ακουσαντες διεπριοντο και εβουλευοντο ανελειν αυτους',
        ...
        41: 'οι μεν ουν επορευοντο χαιροντες απο προσωπου του συνεδριου οτι υπερ του ονοματος του ιησου αυτου κατηξιωθησαν ατιμασθηναι',
    ...
    6: {
        ...
        3: 'επισκεψασθε ουν αδελφοι ανδρας εξ υμων μαρτυρουμενους επτα πληρεις πνευματος αγιου και σοφιας ους καταστησωμεν καταστησομεν επι της χρειας ταυτης',
        4: 'ημεις δε τη προσευχη και τη διακονια του λογου προσκαρτερησομεν',
        5: 'και ηρεσεν ο λογος ενωπιον παντος του πληθους και εξελεξαντο στεφανον ανδρα πληρης πληρη πιστεως και πνευματος αγιου και φιλιππον και προχορον και νικανορα και τιμωνα και παρμεναν και νικολαον προσηλυτον αντιοχεα',
    ...
    7: {
        ...
        5: 'και ουκ εδωκεν αυτω κληρονομιαν εν αυτη ουδε βημα ποδος και επηγγειλατο δουναι αυτω αυτω δουναι εις κατασχεσιν αυτην και τω σπερματι αυτου μετ αυτον ουκ οντος αυτω τεκνου',
        ...
        14: 'αποστειλας δε ιωσηφ μετεκαλεσατο τον πατερα αυτου ιακωβ και πασαν την συγγενειαν συγγενειαν αυτου εν ψυχαις εβδομηκοντα πεντε',
        15: 'κατεβη δε ιακωβ εις αιγυπτον και ετελευτησεν αυτος και οι πατερες ημων',
        16: 'και μετετεθησαν εις συχεμ και ετεθησαν εν τω μνηματι ο ωνησατο αβρααμ τιμης αργυριου παρα των υιων εμμορ του συχεμ',
        17: 'καθως δε ηγγιζεν ο χρονος της επαγγελιας ης ωμοσεν ο θεος τω αβρααμ ηυξησεν ο λαος και επληθυνθη εν αιγυπτω',
        18: 'αχρι ου ανεστη βασιλευς ετερος ος ουκ ηδει τον ιωσηφ',
        ...
        20: 'εν ω καιρω εγεννηθη μωσης και ην αστειος τω θεω ος ανετραφη μηνας τρεις εν τω οικω του πατρος',
        21: 'εκτεθεντα δε αυτον ανειλετο η θυγατηρ φαραω και ανεθρεψατο αυτον εαυτη εις υιον',
        22: 'και επαιδευθη μωσης παση σοφια αιγυπτιων ην δε δυνατος εν λογοις και εργοις',
        ...
        26: 'τη τε επιουση ημερα ωφθη αυτοις μαχομενοις και συνηλασεν 4900 αυτους εις ειρηνην ειπων ανδρες αδελφοι εστε υμεις ινα τι αδικειτε αλληλους',
        27: 'ο δε αδικων τον πλησιον απωσατο αυτον ειπων τις σε κατεστησεν αρχοντα και δικαστην εφ ημας ημων',
        ...
        31: 'ο δε μωσης ιδων εθαυμαζεν εθαυμασεν το οραμα προσερχομενου δε αυτου κατανοησαι εγενετο φωνη κυριου προς αυτον',
        ...
        35: 'τουτον τον μωσην ον ηρνησαντο ειποντες τις σε κατεστησεν αρχοντα και δικαστην τουτον ο θεος αρχοντα και λυτρωτην απεστειλεν εν χειρι αγγελου του οφθεντος αυτω εν τη βατω',
        36: 'ουτος εξηγαγεν αυτους ποιησας τερατα και σημεια εν γη αιγυπτω και εν ερυθρα θαλασση και εν τη ερημω ετη τεσσαρακοντα',
        37: 'ουτος εστιν ο μωσης ο ειπων τοις υιοις ισραηλ προφητην υμιν αναστησει κυριος ο θεος ημων εκ των αδελφων υμων ως εμε',
        38: 'ουτος εστιν ο γενομενος εν τη εκκλησια εν τη ερημω μετα του αγγελου του λαλουντος αυτω εν τω ορει σινα και των πατερων ημων ος εδεξατο λογον ζωντα λογια ζωντα δουναι ημιν',
        39: 'ω ουκ ηθελησαν υπηκοοι γενεσθαι οι πατερες ημων αλλ απωσαντο και εστραφησαν τη καρδια αυτων εις αιγυπτον',
        ...
        43: 'και ανελαβετε την σκηνην του μολοχ και το αστρον του θεου υμων ρεμφαν ρεφαν τους τυπους ους εποιησατε προσκυνειν αυτοις και μετοικιω υμας επεκεινα βαβυλωνος',
        ...
        58: 'και εκβαλοντες εξω της πολεως ελιθοβολουν και οι μαρτυρες απεθεντο τα ιματια παρα τους ποδας νεανιου καλουμενου σαυλου',
    ...
    8: {
        ...
        12: 'οτε δε επιστευσαν τω φιλιππω ευαγγελιζομενω τα περι της βασιλειας του θεου και του ονοματος ιησου χριστου εβαπτιζοντο ανδρες τε και γυναικες',
    ...
    9: {
        ...
        5: 'ειπεν δε τις ει κυριε ο δε κυριος ειπεν εγω ειμι ιησους ον συ διωκεις',
        6: 'αλλα αναστηθι και εισελθε εις την πολιν και λαληθησεται σοι τι σε δει ποιειν',
        7: 'οι δε ανδρες οι συνοδευοντες αυτω ειστηκεισαν ενεοι εννεοι ακουοντες μεν της φωνης μηδενα δε θεωρουντες',
        8: 'ηγερθη δε ο σαυλος απο της γης ανεωγμενων τε των οφθαλμων αυτου ουδενα εβλεπεν χειραγωγουντες δε αυτον εισηγαγον εις δαμασκον',
        ...
        17: 'απηλθεν δε ανανιας και εισηλθεν εις την οικιαν και επιθεις επ αυτον τας χειρας ειπεν σαουλ αδελφε ο κυριος απεσταλκεν με ο οφθεις σοι εν τη οδω η ηρχου οπως αναβλεψης και πλησθης πνευματος αγιου',
        18: 'και ευθεως απεπεσον απο των οφθαλμων αυτου ωσει λεπιδες ανεβλεψεν τε τε παραχρημα και αναστας εβαπτισθη',
        ...
        21: 'εξισταντο δε παντες οι ακουοντες και ελεγον ουχ ουτος εστιν ο πορθησας εν ιερουσαλημ τους επικαλουμενους το ονομα τουτο και ωδε εις τουτο εληλυθεν ινα δεδεμενους αυτους αγαγη επι τους αρχιερεις',
        ...
        26: 'παραγενομενος δε ο σαυλος εν ιερουσαλημ επειρατο κολλασθαι τοις μαθηταις και παντες εφοβουντο αυτον μη πιστευοντες οτι εστιν μαθητης',
        ...
        28: 'και ην μετ αυτων εισπορευομενος εισπορευομενος και εκπορευομενος εις εν ιερουσαλημ και παρρησιαζομενος εν τω ονοματι του κυριου ιησου',
        ...
        33: 'ευρεν δε εκει ανθρωπον τινα αινεαν ονοματι εξ ετων οκτω κατακειμενον επι κραββατω κραββατου ος ην παραλελυμενος',
        34: 'και ειπεν αυτω ο πετρος αινεα ιαται σε ιησους ο χριστος αναστηθι και στρωσον σεαυτω και ευθεως ανεστη',
        35: 'και ειδον αυτον παντες οι κατοικουντες λυδδαν και τον ασσαρωνα οιτινες επεστρεψαν επι τον κυριον',
        36: 'εν ιοππη δε τις ην μαθητρια ονοματι ταβηθα η διερμηνευομενη λεγεται δορκας αυτη ην πληρης αγαθων εργων και ελεημοσυνων ων εποιει',
        37: 'εγενετο δε εν ταις ημεραις εκειναις ασθενησασαν αυτην αποθανειν λουσαντες δε αυτην εθηκαν εν υπερωω',
        38: 'εγγυς δε ουσης λυδδης τη ιοππη οι μαθηται ακουσαντες οτι πετρος εστιν εν αυτη απεστειλαν προς αυτον παρακαλουντες μη οκνησαι διελθειν εως αυτων',
    ...
    10: {
        ...
        3: 'ειδεν εν οραματι φανερως ωσει ωραν ενατην εννατην της ημερας αγγελον του θεου εισελθοντα προς αυτον και ειποντα αυτω κορνηλιε',
        ...
        5: 'και νυν πεμψον εις ιοππην ανδρας και μεταπεμψαι σιμωνα τον επικαλουμενον πετρον ος επικαλειται πετρος',
        ...
        19: 'του δε πετρου διενθυμουμενου 0 περι του οραματος ειπεν αυτω το πνευμα ιδου ανδρες ζητουσιν σε',
    ...
    11: {
        ...
        18: 'ακουσαντες δε ταυτα ησυχασαν και εδοξαζον τον θεον λεγοντες αρα γε και τοις εθνεσιν ο θεος την μετανοιαν εδωκεν εις ζωην',
        ...
        26: 'και ευρων ηγαγεν αυτον εις αντιοχειαν εγενετο δε αυτους ενιαυτον ολον συναχθηναι 4863 τη εκκλησια και διδαξαι οχλον ικανον χρηματισαι τε πρωτον εν αντιοχεια τους μαθητας χριστιανους',
    ...
    12: {
        ...
        15: 'οι δε προς αυτην ειπον μαινη η δε διισχυριζετο ουτως εχειν οι δε ελεγον ο αγγελος αυτου εστιν',
        ...
        22: 'ο δε δημος επεφωνει φωνη θεου θεου φωνη και ουκ ανθρωπου',
        ...
        25: 'βαρναβας δε και σαυλος υπεστρεψαν εις απο ιερουσαλημ πληρωσαντες την διακονιαν συμπαραλαβοντες και ιωαννην τον επικληθεντα μαρκον',
    },
    13: {
        ...
        4: 'ουτοι μεν ουν εκπεμφθεντες υπο του πνευματος του αγιου κατηλθον εις την σελευκειαν εκειθεν δε τε απεπλευσαν εις την κυπρον',
        5: 'και γενομενοι εν σαλαμινι κατηγγελλον τον λογον του θεου εν ταις συναγωγαις των ιουδαιων ειχον δε και ιωαννην υπηρετην',
        6: 'διελθοντες δε την νησον αχρι παφου ευρον 2147 τινα μαγον ψευδοπροφητην ιουδαιον ω ονομα βαριησους βαριησουν',
        ...
        25: 'ως δε επληρου ο OMIT ο ιωαννης τον δρομον ελεγεν τινα με υπονοειτε ειναι ουκ ειμι εγω αλλ ιδου ερχεται μετ εμε ου ουκ ειμι αξιος το υποδημα των ποδων λυσαι',
        26: 'ανδρες αδελφοι υιοι γενους αβρααμ και οι εν υμιν φοβουμενοι τον θεον υμιν ο λογος της σωτηριας ταυτης απεσταλη',
        27: 'οι γαρ κατοικουντες εν OMIT εν ιερουσαλημ και οι αρχοντες αυτων τουτον αγνοησαντες και τας φωνας των προφητων τας κατα παν σαββατον αναγινωσκομενας κριναντες επληρωσαν',
        ...
        39: 'και απο παντων ων ουκ ηδυνηθητε εν τω νομω μωυσεως μωσεως δικαιωθηναι εν τουτω πας ο πιστευων δικαιουται',
        ...
        42: 'εξιοντων δε δε αυτων εκ της συναγωγης των ιουδαιων παρεκαλουν τα εθνη εις το μεταξυ σαββατον λαληθηναι αυτοις τα ρηματα ρηματα ταυτα',
        ...
        48: 'ακουοντα δε τα εθνη εχαιρεν εχαιρον και εδοξαζον τον λογον του κυριου και επιστευσαν οσοι ησαν τεταγμενοι εις ζωην αιωνιον',
    ...
    14: {
        ...
        9: 'ουτος ηκουσεν ηκουεν του παυλου λαλουντος ος ατενισας αυτω και ιδων οτι πιστιν εχει του σωθηναι',
        10: 'ειπεν μεγαλη τη φωνη αναστηθι επι τους ποδας σου ορθως ορθος και ηλλετο και περιεπατει',
    ...
    15: {
        ...
        2: 'γενομενης ουν στασεως και ζητησεως ουκ ολιγης τω παυλω και τω βαρναβα προς αυτους εταξαν αναβαινειν παυλον και βαρναβαν και τινας αλλους εξ αυτων προς τους αποστολους και πρεσβυτερους εις ιερουσαλημ περι του ζητηματος τουτου',
        ...
        22: 'τοτε εδοξεν τοις αποστολοις και τοις πρεσβυτεροις συν ολη τη εκκλησια εκλεξαμενους ανδρας εξ αυτων πεμψαι εις αντιοχειαν συν παυλω και βαρναβα ιουδαν τον επικαλουμενον βαρσαββαν βαρσαβαν και σιλαν ανδρας ηγουμενους εν τοις αδελφοις',
    ...
    16: {
        ...
        6: 'διελθοντες δε την φρυγιαν και την γαλατικην χωραν κωλυθεντες υπο του αγιου πνευματος λαλησαι τον λογον εν τη ασια',
        ...
        9: 'και οραμα δια της νυκτος ωφθη τω παυλω ανηρ τις ην μακεδων εστως παρακαλων αυτον και λεγων διαβας εις μακεδονιαν βοηθησον ημιν',
        ...
        12: 'εκειθεν τε εις φιλιππους ητις εστιν πρωτη της μεριδος της μακεδονιας πολις κολωνεια ημεν δε εν αυτη τη πολει διατριβοντες ημερας τινας',
        ...
        16: 'εγενετο δε πορευομενων ημων εις προσευχην παιδισκην τινα εχουσαν πνευμα πυθωνος απαντησαι ημιν ητις εργασιαν πολλην παρειχεν τοις κυριοις αυτης μαντευομενη',
        17: 'αυτη κατακολουθησασα τω παυλω και ημιν τω σιλα εκραζεν λεγουσα ουτοι οι ανθρωποι δουλοι του θεου του υψιστου εισιν οιτινες καταγγελλουσιν ημιν οδον σωτηριας',
        18: 'τουτο δε εποιει επι πολλας ημερας διαπονηθεις δε ο παυλος και επιστρεψας τω πνευματι ειπεν παραγγελλω σοι εν τω ονοματι ιησου χριστου εξελθειν απ αυτης και εξηλθεν αυτη τη ωρα',
        ...
        20: 'και προσαγαγοντες αυτους τοις στρατηγοις ειπον ουτοι οι ανθρωποι εκταρασσουσιν ημων την πολιν ιουδαιοι υπαρχοντες',
        21: 'και καταγγελλουσιν εθη α ουκ εξεστιν ημιν παραδεχεσθαι ουδε ποιειν ρωμαιοις ουσιν',
        22: 'και συνεπεστη ο οχλος κατ αυτων και οι στρατηγοι περιρρηξαντες αυτων τα ιματια εκελευον ραβδιζειν',
        ...
        37: 'ο δε παυλος εφη προς αυτους δειραντες ημας δημοσια ακατακριτους ανθρωπους ρωμαιους υπαρχοντας εβαλον εις φυλακην και νυν λαθρα ημας εκβαλλουσιν ου γαρ αλλα ελθοντες αυτοι εξαγαγετωσαν',
        ...
        40: 'εξελθοντες δε εκ της φυλακης εισηλθον προς την λυδιαν και ιδοντες τους αδελφους παρεκαλεσαν αυτους και εξηλθον',
    },
    17: {
        ...
        5: 'προσλαβομενοι δε οι ιουδαιοι οι απειθουντες των αγοραιων τινας ανδρας πονηρους και οχλοποιησαντες εθορυβουν την πολιν επισταντες τε τη οικια ιασονος εζητουν αυτους αγαγειν εις τον δημον',
        ...
        7: 'ους υποδεδεκται ιασων και ουτοι παντες απεναντι των δογματων καισαρος πρασσουσιν βασιλεα λεγοντες ετερον ειναι ιησουν',
        ...
        10: 'οι δε αδελφοι ευθεως δια της νυκτος εξεπεμψαν τον τε παυλον και τον σιλαν εις βεροιαν οιτινες παραγενομενοι εις την συναγωγην απηεσαν των ιουδαιων',
        ...
        18: 'τινες δε και των επικουρειων και των στοικων στωικων φιλοσοφων συνεβαλλον αυτω και τινες ελεγον τι αν θελοι ο σπερμολογος ουτος λεγειν οι δε ξενων δαιμονιων δοκει καταγγελευς ειναι οτι τον ιησουν και την αναστασιν ευηγγελιζετο',
        ...
        26: 'εποιησεν τε εξ ενος αιματος παν εθνος ανθρωπων κατοικειν επι παν το προσωπον της γης ορισας προστεταγμενους καιρους και τας οροθεσιας της κατοικιας αυτων',
    ...
    18: {
        ...
        2: 'και ευρων τινα ιουδαιον ονοματι ακυλαν ποντικον τω γενει προσφατως εληλυθοτα απο της ιταλιας και πρισκιλλαν γυναικα αυτου δια το τεταχεναι διατεταχεναι κλαυδιον χωριζεσθαι παντας τους ιουδαιους εκ της ρωμης προσηλθεν αυτοις',
        3: 'και δια το ομοτεχνον ειναι εμενεν παρ αυτοις και ειργαζετο ησαν γαρ σκηνοποιοι την τεχνην τη τεχνη',
        ...
        17: 'επιλαβομενοι δε παντες οι ελληνες σωσθενην τον αρχισυναγωγον ετυπτον εμπροσθεν του βηματος και ουδεν τουτων τω γαλλιωνι εμελλεν',
        ...
        19: 'κατηντησεν δε εις εφεσον και εκεινους κακεινους κατελιπεν αυτου αυτος δε εισελθων εις την συναγωγην διελεχθη τοις ιουδαιοις',
        20: 'ερωτωντων δε αυτων επι πλειονα χρονον μειναι παρ αυτοις ουκ επενευσεν',
        21: 'αλλ απεταξατο αυτοις ειπων δει με παντως την εορτην την ερχομενην ποιησαι εις ιεροσολυμα παλιν δε ανακαμψω προς υμας του θεου θελοντος ανηχθη απο της εφεσου',
    ...
    19: {
        1: 'εγενετο δε εν τω τον απολλω ειναι εν κορινθω παυλον διελθοντα τα ανωτερικα μερη ελθειν εις εφεσον και ευρων τινας μαθητας',
        ...
        16: 'και εφαλλομενος επ αυτους ο ανθρωπος εν ω ην το πνευμα το πονηρον και κατακυριευσαν αυτων ισχυσεν κατ αυτων ωστε γυμνους και τετραυματισμενους εκφυγειν εκ του οικου εκεινου',
        ...
        27: 'ου μονον δε τουτο κινδυνευει ημιν το μερος εις απελεγμον ελθειν αλλα και το της μεγαλης θεας ιερον αρτεμιδος αρτεμιδος ιερον εις ουθεν λογισθηναι μελλειν δε και καθαιρεισθαι την μεγαλειοτητα αυτης ην ολη η ασια και η οικουμενη σεβεται',
        28: 'ακουσαντες δε και γενομενοι πληρεις θυμου εκραζον λεγοντες μεγαλη η αρτεμις εφεσιων',
        29: 'και επλησθη η πολις ολη της συγχυσεως ωρμησαν τε ομοθυμαδον εις το θεατρον συναρπασαντες γαιον και αρισταρχον μακεδονας συνεκδημους παυλου',
        ...
        37: 'ηγαγετε γαρ τους ανδρας τουτους ουτε ιεροσυλους ουτε βλασφημουντας την θεον υμων',
        ...
        40: 'και γαρ κινδυνευομεν εγκαλεισθαι στασεως περι της σημερον μηδενος αιτιου υπαρχοντος περι ου ου δυνησομεθα δουναι αποδουναι λογον της συστροφης ταυτης',
    ...
    20: {
        ...
        26: 'διοτι διο μαρτυρομαι υμιν εν τη σημερον ημερα οτι καθαρος εγω απο του αιματος παντων',
    ...
    21: {
        ...
        8: 'τη δε επαυριον εξελθοντες οι περι τον παυλον OMIT οι περι τον παυλον ηλθον ηλθομεν εις καισαρειαν και εισελθοντες εις τον οικον φιλιππου του ευαγγελιστου οντος εκ των επτα εμειναμεν παρ αυτω',
        ...
        11: 'και ελθων προς ημας και αρας την ζωνην του παυλου δησας τε αυτου τους ποδας και τας χειρας ειπεν ταδε λεγει το πνευμα το αγιον τον ανδρα ου εστιν η ζωνη αυτη ουτως δησουσιν εν ιερουσαλημ οι ιουδαιοι και παραδωσουσιν εις χειρας εθνων',
        ...
        15: 'μετα δε τας ημερας ταυτας επισκευασαμενοι 0 ανεβαινομεν εις ιερουσαλημ',
        ...
        20: 'οι δε ακουσαντες εδοξαζον τον κυριον ειποντες αυτω θεωρεις αδελφε ποσαι μυριαδες εισιν ιουδαιων των πεπιστευκοτων και παντες ζηλωται του νομου υπαρχουσιν',
        21: 'κατηχηθησαν δε περι σου οτι αποστασιαν διδασκεις απο μωυσεως μωυσεος τους κατα τα εθνη παντας ιουδαιους λεγων μη περιτεμνειν αυτους τα τεκνα μηδε τοις εθεσιν περιπατειν',
        ...
        37: 'μελλων τε εισαγεσθαι εις την παρεμβολην ο παυλος λεγει τω χιλιαρχω ει εξεστιν μοι ειπειν προς σε ο δε εφη ελληνιστι γινωσκεις',
        ...
        40: 'επιτρεψαντος δε αυτου ο παυλος εστως επι των αναβαθμων κατεσεισεν τη χειρι τω λαω πολλης δε σιγης γενομενης προσεφωνει τη εβραιδι διαλεκτω λεγων',
    },
    22: {
        ...
        7: 'επεσα επεσον τε εις το εδαφος και ηκουσα φωνης λεγουσης μοι σαουλ σαουλ τι με διωκεις',
        ...
        20: 'και οτε εξεχειτο το αιμα στεφανου του μαρτυρος σου και αυτος ημην εφεστως και συνευδοκων τη αναιρεσει αυτου φυλασσων και φυλασσων τα ιματια των αναιρουντων αυτον',
        ...
        23: 'κραζοντων κραυγαζοντων δε αυτων και ριπτουντων τα ιματια και κονιορτον βαλλοντων εις τον αερα',
        ...
        25: 'ως δε προετεινεν προετειναν αυτον τοις ιμασιν ειπεν προς τον εστωτα εκατονταρχον ο παυλος ει ανθρωπον ρωμαιον και ακατακριτον εξεστιν υμιν μαστιζειν',
    ...
    23: {
        ...
        7: 'τουτο δε αυτου λαλησαντος εγενετο στασις των φαρισαιων φαρισαιων και των σαδδουκαιων και εσχισθη το πληθος',
        ...
        15: 'νυν ουν υμεις εμφανισατε τω χιλιαρχω συν τω συνεδριω οπως αυριον αυτον καταγαγη καταγαγη αυτον προς υμας ως μελλοντας διαγινωσκειν ακριβεστερον τα περι αυτου ημεις δε προ του εγγισαι αυτον ετοιμοι εσμεν του ανελειν αυτον',
        ...
        20: 'ειπεν δε οτι οι ιουδαιοι συνεθεντο του ερωτησαι σε οπως αυριον εις το συνεδριον καταγαγης τον παυλον ως μελλοντα μελλοντες τι ακριβεστερον πυνθανεσθαι περι αυτου',
    ...
    24: {
        ...
        2: 'κληθεντος δε αυτου ηρξατο κατηγορειν ο τερτυλλος λεγων (24:3) πολλης ειρηνης τυγχανοντες δια σου και κατορθωματων γινομενων τω εθνει τουτω δια της σης προνοιας',
        ...
        6: 'ος και το ιερον επειρασεν βεβηλωσαι ον και εκρατησαμεν εκρατησαμεν 2902 και κατα τον ημετερον νομον ηθελησαμεν κριναι (24:7) παρελθων δε λυσιας ο χιλιαρχος μετα πολλης βιας εκ των χειρων ημων απηγαγεν 520 (24:8) κελευσας τους κατηγορους αυτου ερχεσθαι επι σου OR επι σε',
        8: 'παρ ου δυνηση αυτος ανακρινας περι παντων τουτων επιγνωναι ων ημεις κατηγορουμεν αυτου',
        9: 'συνεπεθεντο 0 δε και οι ιουδαιοι φασκοντες ταυτα ουτως εχειν',
    ...
    25: {
        ...
        7: 'παραγενομενου δε αυτου περιεστησαν οι απο ιεροσολυμων καταβεβηκοτες ιουδαιοι πολλα και βαρεα αιτιωματα αιτιαματα φεροντες κατα του παυλου α ουκ ισχυον αποδειξαι',
        ...
        13: 'ημερων δε διαγενομενων τινων αγριππας ο βασιλευς και βερνικη κατηντησαν εις καισαρειαν ασπασαμενοι ασπασομενοι τον φηστον',
        14: 'ως δε πλειους ημερας διετριβεν διετριβον εκει ο φηστος τω βασιλει ανεθετο τα κατα τον παυλον λεγων ανηρ τις εστιν καταλελειμμενος υπο φηλικος δεσμιος',
        ...
        20: 'απορουμενος δε εγω την περι τουτου ζητησιν ελεγον ει βουλοιτο πορευεσθαι εις ιερουσαλημ κακει κρινεσθαι περι τουτων',
    ...
    26: {
        ...
        3: 'μαλιστα γνωστην οντα σε παντων των κατα ιουδαιους ηθων εθων τε και ζητηματων διο δεομαι σου μακροθυμως ακουσαι μου',
        ...
        7: 'εις ην το δωδεκαφυλον ημων εν εκτενεια νυκτα και ημεραν λατρευον ελπιζει καταντησαι περι ης ελπιδος εγκαλουμαι βασιλευ αγριππα υπο ιουδαιων',
        ...
        17: 'εξαιρουμενος σε εκ του λαου και των εθνων εις ους εγω σε αποστελλω',
        18: 'ανοιξαι οφθαλμους αυτων του υποστρεψαι επιστρεψαι απο σκοτους εις φως και της εξουσιας του σατανα επι τον θεον του λαβειν αυτους αφεσιν αμαρτιων και κληρον εν τοις ηγιασμενοις πιστει τη εις εμε',
        ...
        21: 'ενεκα τουτων οι ιουδαιοι με με οι ιουδαιοι συλλαβομενοι εν τω ιερω επειρωντο διαχειρισασθαι',
        22: 'επικουριας ουν τυχων της παρα του θεου αχρι της ημερας ταυτης εστηκα μαρτυρομενος μικρω τε και μεγαλω ουδεν εκτος λεγων ων τε οι προφηται ελαλησαν μελλοντων γινεσθαι και μωυσης',
        ...
        26: 'επισταται γαρ περι τουτων ο βασιλευς προς ον και παρρησιαζομενος λαλω λανθανειν γαρ αυτον τι τουτων ου πειθομαι ουδεν ου γαρ εν γωνια πεπραγμενον τουτο',
    ...
    27: {
        ...
        11: 'ο δε εκατονταρχης εκατονταρχος τω κυβερνητη και τω ναυκληρω επειθετο μαλλον η τοις υπο του παυλου λεγομενοις',
        12: 'ανευθετου δε του λιμενος υπαρχοντος προς παραχειμασιαν οι πλειους εθεντο βουλην αναχθηναι κακειθεν ει πως δυναιντο καταντησαντες εις φοινικα παραχειμασαι λιμενα της κρητης βλεποντα κατα λιβα και κατα χωρον',
        ...
        17: 'ην αραντες βοηθειαις εχρωντο υποζωννυντες το πλοιον φοβουμενοι τε μη εις την συρτην εκπεσωσιν χαλασαντες το σκευος ουτως εφεροντο',
        ...
        33: 'αχρι δε ου ημελλεν εμελλεν ημερα γινεσθαι παρεκαλει ο παυλος απαντας μεταλαβειν τροφης λεγων τεσσαρεσκαιδεκατην σημερον ημεραν προσδοκωντες ασιτοι διατελειτε μηδεν προσλαβομενοι',
        ...
        38: 'κορεσθεντες δε της OMIT της τροφης εκουφιζον το πλοιον εκβαλλομενοι τον σιτον εις την θαλασσαν',
        39: 'οτε δε ημερα εγενετο την γην ουκ επεγινωσκον κολπον δε τινα κατενοουν εχοντα αιγιαλον εις ον εβουλευσαντο ει δυνατον εξωσαι το πλοιον',
    ...
    28: {
        ...
        3: 'συστρεψαντος δε του παυλου φρυγανων πληθος και επιθεντος επι την πυραν εχιδνα εκ της θερμης διεξελθουσα εξελθουσα καθηψεν της χειρος αυτου',
        ...
        11: 'μετα δε τρεις μηνας ηχθημεν ανηχθημεν εν πλοιω παρακεχειμακοτι εν τη νησω αλεξανδρινω παρασημω διοσκουροις',
        ...
        15: 'κακειθεν οι αδελφοι ακουσαντες τα περι ημων εξηλθον εις απαντησιν ημιν αχρι αππιου φορου και τριων ταβερνων ους ιδων ο παυλος ευχαριστησας τω θεω ελαβεν θαρσος',
        16: 'οτε δε ηλθομεν εις ρωμην ο εκατονταρχος παρεδωκεν τους δεσμιους τω στρατοπεδαρχη στρατοπεδαρχω τω δε παυλω επετραπη μενειν καθ εαυτον συν τω φυλασσοντι αυτον στρατιωτη',
        ...
        23: 'ταξαμενοι δε αυτω ημεραν ηκον προς αυτον εις την ξενιαν πλειονες οις εξετιθετο διαμαρτυρομενος την βασιλειαν του θεου πειθων τε αυτους τα περι του ιησου απο τε του νομου μωυσεως και των προφητων απο πρωι εως εσπερας',
        ...
        27: 'επαχυνθη γαρ η καρδια του λαου τουτου και τοις ωσιν βαρεως ηκουσαν και τους οφθαλμους αυτων εκαμμυσαν μηποτε ιδωσιν τοις οφθαλμοις και τοις ωσιν ακουσωσιν και τη καρδια συνωσιν και επιστρεψωσιν και ιασομαι ιασωμαι αυτους',
