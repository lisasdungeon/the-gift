...
CHAPTERS = {
    1: {
        ...
        6: 'πεποιθως αυτο τουτο οτι ο εναρξαμενος εν υμιν εργον αγαθον επιτελεσει αχρι ημερας χριστου ιησου',
    ...
    2: {
        ...
        27: 'και γαρ ησθενησεν παραπλησιον θανατω αλλα ο θεος αυτον ηλεησεν ουκ αυτον δε μονον αλλα και εμε ινα μη λυπην επι λυπην σχω',
    ...
    3: {
        ...
        8: 'αλλα μεν ουν και ηγουμαι παντα ζημιαν ειναι δια το υπερεχον της γνωσεως χριστου ιησου του κυριου μου δι ον τα παντα εζημιωθην και ηγουμαι σκυβαλα ειναι ινα χριστον κερδησω',
        ...
        13: 'αδελφοι εγω εμαυτον ου ουπω λογιζομαι κατειληφεναι εν δε τα μεν οπισω επιλανθανομενος τοις δε εμπροσθεν επεκτεινομενος',
