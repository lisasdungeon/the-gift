...
CHAPTERS = {
    ...
    2: {
        ...
        17: 'ου γαρ εσμεν ως οι λοιποι πολλοι καπηλευοντες τον λογον του θεου αλλ ως εξ ειλικρινειας αλλ ως εκ θεου κατενωπιον του θεου εν χριστω λαλουμεν',
    },
    3: {
        ...
        6: 'ος και ικανωσεν ημας διακονους καινης διαθηκης ου γραμματος αλλα πνευματος το γαρ γραμμα αποκτενει το δε πνευμα ζωοποιει',
        7: 'ει δε η διακονια του θανατου εν γραμμασιν εντετυπωμενη εν λιθοις εγενηθη εν δοξη ωστε μη δυνασθαι ατενισαι τους υιους ισραηλ εις το προσωπον μωυσεως δια την δοξαν του προσωπου αυτου την καταργουμενην',
        ...
        10: 'και γαρ ου δεδοξασται το δεδοξασμενον εν τουτω τω μερει ενεκεν της υπερβαλλουσης δοξης',
        11: 'ει γαρ το καταργουμενον δια δοξης πολλω μαλλον το μενον εν δοξη',
        12: 'εχοντες ουν τοιαυτην ελπιδα πολλη παρρησια χρωμεθα',
        13: 'και ου καθαπερ μωυσης ετιθει καλυμμα επι το προσωπον εαυτου προς το μη ατενισαι τους υιους ισραηλ εις το τελος του καταργουμενου',
        ...
        15: 'αλλ εως σημερον ηνικα αναγινωσκεται μωυσης καλυμμα επι την καρδιαν αυτων κειται',
    ...
    4: {
        ...
        2: 'αλλα απειπαμεθα τα κρυπτα της αισχυνης μη περιπατουντες εν πανουργια μηδε δολουντες 1389 τον λογον του θεου αλλα τη φανερωσει της αληθειας συνιστωντες εαυτους προς πασαν συνειδησιν ανθρωπων ενωπιον του θεου',
    ...
    5: {
        ...
        14: 'η γαρ αγαπη του χριστου συνεχει ημας κριναντας τουτο οτι ει OMIT ει εις υπερ παντων απεθανεν αρα οι παντες απεθανον',
        ...
        17: 'ωστε ει τις εν χριστω καινη κτισις τα αρχαια παρηλθεν ιδου γεγονεν καινα τα παντα τα παντα καινα',
    ...
    7: {
        ...
        12: 'αρα ει και εγραψα υμιν ουχ εινεκεν ενεκεν του αδικησαντος ουδε εινεκεν ενεκεν του αδικηθεντος αλλ εινεκεν ενεκεν του φανερωθηναι την σπουδην υμων την υπερ ημων προς υμας ενωπιον του θεου',
        13: 'δια τουτο παρακεκλημεθα επι δε OMIT δε τη παρακλησει υμων περισσοτερως περισσοτερως δε μαλλον εχαρημεν επι τη χαρα τιτου οτι αναπεπαυται το πνευμα αυτου απο παντων υμων',
    ...
    9: {
        ...
        5: 'αναγκαιον ουν ηγησαμην παρακαλεσαι τους αδελφους ινα προελθωσιν εις υμας και προκαταρτισωσιν την προκατηγγελμενην ευλογιαν υμων ταυτην ετοιμην ειναι ουτως ως ευλογιαν και μη ως πλεονεξιαν',
        ...
        10: 'ο δε επιχορηγων σπερμα τω σπειροντι και αρτον εις βρωσιν χορηγησαι και πληθυναι τον σπορον υμων και αυξησαι τα γενηματα της δικαιοσυνης υμων',
    ...
    11: {
        1: 'οφελον ανειχεσθε μου μικρον τη αφροσυνη αλλα και ανεχεσθε 430 μου',
        ...
        4: 'ει μεν γαρ ο ερχομενος αλλον ιησουν κηρυσσει ον ουκ εκηρυξαμεν η πνευμα ετερον λαμβανετε ο ουκ ελαβετε η ευαγγελιον ετερον ο ουκ εδεξασθε καλως ηνειχεσθε ανειχεσθε',
    ...
    12: {
        ...
        14: 'ιδου τριτον ετοιμως εχω ελθειν προς υμας και ου καταναρκησω υμων ου γαρ ζητω τα υμων αλλα υμας ου γαρ οφειλει τα τεκνα τοις γονευσιν θησαυριζειν αλλ οι γονεις τοις τεκνοις',
        ...
        21: 'μη παλιν ελθοντα με ταπεινωσει ταπεινωση ο θεος μου προς υμας και πενθησω πολλους των προημαρτηκοτων και μη μετανοησαντων επι τη ακαθαρσια και πορνεια και ασελγεια η επραξαν',
    },
    13: {
