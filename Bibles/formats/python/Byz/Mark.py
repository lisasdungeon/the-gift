...
CHAPTERS = {
    1: {
        ...
        10: 'και ευθεως αναβαινων απο του υδατος ειδεν σχιζομενους τους ουρανους και το πνευμα ωσει ως περιστεραν καταβαινον επ αυτον',
        ...
        34: 'και εθεραπευσεν πολλους κακως εχοντας ποικιλαις νοσοις και δαιμονια πολλα εξεβαλεν και ουκ ηφιεν λαλειν τα δαιμονια οτι ηδεισαν αυτον αυτον χριστον ειναι',
    ...
    2: {
        ...
        4: 'και μη δυναμενοι προσεγγισαι αυτω δια τον οχλον απεστεγασαν την στεγην οπου ην και εξορυξαντες χαλωσιν τον κραββατον κραβαττον εφ ω ο παραλυτικος κατεκειτο',
        ...
        9: 'τι εστιν ευκοπωτερον ειπειν τω παραλυτικω αφεωνται σου αι αμαρτιαι η ειπειν εγειραι εγειρε και αρον σου τον κραββατον κραβαττον και περιπατει',
        10: 'ινα δε ειδητε οτι εξουσιαν εχει ο υιος του ανθρωπου αφιεναι επι της γης επι της γης αφιεναι αμαρτιας λεγει τω παραλυτικω',
        11: 'σοι λεγω εγειραι εγειρε και αρον τον κραββατον κραβαττον σου και υπαγε εις τον οικον σου',
        12: 'και ηγερθη ευθεως και αρας τον κραββατον κραβαττον εξηλθεν εναντιον παντων ωστε εξιστασθαι παντας και δοξαζειν τον θεον λεγοντας οτι ουδεποτε ουτως ειδομεν',
        13: 'και εξηλθεν παλιν παρα την θαλασσαν και πας ο οχλος ηρχετο προς αυτον και εδιδασκεν αυτους',
        14: 'και παραγων ειδεν λευι λευιν τον του αλφαιου καθημενον επι το τελωνιον και λεγει αυτω ακολουθει μοι και αναστας ηκολουθησεν αυτω',
        ...
        25: 'και αυτος ελεγεν αυτοις ουδεποτε ανεγνωτε τι εποιησεν δαυιδ οτε χρειαν εσχεν και επεινασεν αυτος και οι μετ αυτου',
        26: 'πως εισηλθεν εις τον οικον του θεου επι αβιαθαρ αρχιερεως και τους αρτους της προθεσεως εφαγεν ους ουκ εξεστιν φαγειν ει μη τοις ιερευσιν και εδωκεν και τοις συν αυτω ουσιν',
    ...
    3: {
        ...
        5: 'και περιβλεψαμενος αυτους μετ οργης συλλυπουμενος επι τη πωρωσει της καρδιας αυτων λεγει τω ανθρωπω εκτεινον την χειρα σου και εξετεινεν και αποκατεσταθη απεκατεσταθη η χειρ αυτου υγιης ως η αλλη',
        6: 'και εξελθοντες οι φαρισαιοι ευθεως μετα των ηρωδιανων συμβουλιον εποιουν κατ αυτου οπως αυτον απολεσωσιν',
        7: 'και ο ιησους ανεχωρησεν μετα των μαθητων αυτου προς την θαλασσαν και πολυ πληθος απο της γαλιλαιας ηκολουθησαν ηκολουθησεν αυτω και απο της ιουδαιας',
        ...
        27: 'ουδεις δυναται τα σκευη του ισχυρου εισελθων εις την οικιαν αυτου διαρπασαι εαν μη πρωτον τον ισχυρον δηση και τοτε την οικιαν αυτου διαρπαση διαρπασει',
    ...
    4: {
        ...
        30: 'και ελεγεν τινι ομοιωσωμεν ομοιωσομεν την βασιλειαν του θεου η εν ποια παραβολη παραβαλωμεν αυτην',
        ...
        37: 'και γινεται λαιλαψ ανεμου μεγαλη τα δε κυματα επεβαλλεν επεβαλεν εις το πλοιον ωστε αυτο ηδη γεμιζεσθαι',
    ...
    5: {
        ...
        5: 'και δια παντος νυκτος και ημερας εν τοις ορεσιν και εν τοις μνημασιν ην κραζων και κατακοπτων 2629 εαυτον λιθοις',
    ...
    6: {
        ...
        16: 'ακουσας δε ηρωδης ο ηρωδης ειπεν οτι ον εγω απεκεφαλισα ιωαννην ουτος εστιν αυτος ηγερθη εκ νεκρων',
        ...
        51: 'και ανεβη προς αυτους εις το πλοιον και εκοπασεν ο ανεμος και λιαν εκπερισσου εν εαυτοις εξισταντο και εθαυμαζον',
    ...
    7: {
        ...
        32: 'και φερουσιν αυτω κωφον μογγιλαλον μογιλαλον και παρακαλουσιν αυτον ινα επιθη αυτω την χειρα',
    ...
    8: {
        ...
        2: 'σπλαγχνιζομαι επι τον οχλον οτι ηδη ημεραι ημερας τρεις προσμενουσιν μοι και ουκ εχουσιν τι φαγωσιν',
        ...
        7: 'και ειχον ιχθυδια ολιγα και ευλογησας 2127 ειπεν παραθειναι παραθηναι και αυτα',
        ...
        13: 'και αφεις αυτους εμβας παλιν εις εις το πλοιον απηλθεν εις το περαν',
        ...
        25: 'ειτα παλιν επεθηκεν 2007 τας χειρας επι τους οφθαλμους αυτου και εποιησεν αυτον αναβλεψαι και αποκατεσταθη και ενεβλεψεν ανεβλεψεν τηλαυγως απαντας',
        26: 'και απεστειλεν αυτον εις τον OMIT τον οικον αυτου λεγων μηδε εις την κωμην εισελθης μηδε ειπης τινι εν τη κωμη',
        ...
        38: 'ος γαρ εαν αν επαισχυνθη με και τους εμους λογους εν τη γενεα ταυτη τη μοιχαλιδι και αμαρτωλω και ο υιος του ανθρωπου επαισχυνθησεται αυτον οταν ελθη εν τη δοξη του πατρος αυτου μετα των αγγελων των αγιων',
    },
    9: {
        ...
        2: 'και μεθ ημερας εξ παραλαμβανει ο ιησους τον πετρον και τον ιακωβον και ιωαννην τον ιωαννην και αναφερει αυτους εις ορος υψηλον κατ ιδιαν μονους και μετεμορφωθη εμπροσθεν αυτων',
        3: 'και τα ιματια αυτου εγενοντο εγενετο στιλβοντα λευκα λιαν ως χιων οια γναφευς επι της γης ου δυναται λευκαναι',
        4: 'και ωφθη αυτοις ηλιας συν μωση μωσει και ησαν συλλαλουντες τω ιησου',
        5: 'και αποκριθεις ο πετρος λεγει τω ιησου ραββι καλον εστιν 1510 ημας ωδε ειναι και ποιησωμεν σκηνας τρεις σοι μιαν και μωση μωσει μιαν και ηλια μιαν',
        ...
        22: 'και πολλακις αυτον και εις το πυρ εβαλεν και εις υδατα ινα απολεση αυτον αλλ ει τι δυνασαι βοηθησον ημιν σπλαγχνισθεις εφ ημας',
        ...
        38: 'απεκριθη δε αυτω ιωαννης ο ιωαννης λεγων διδασκαλε ειδομεν τινα τω ονοματι σου εκβαλλοντα δαιμονια ος ουκ ακολουθει ημιν και εκωλυσαμεν αυτον οτι ουκ ακολουθει ημιν',
        ...
        45: 'και εαν ο πους σου σκανδαλιζη σε αποκοψον αυτον καλον εστιν σοι σε εισελθειν εις την ζωην χωλον η τους δυο ποδας εχοντα βληθηναι εις την γεενναν εις το πυρ το ασβεστον',
    ...
    10: {
        ...
        2: 'και προσελθοντες φαρισαιοι οι φαρισαιοι επηρωτησαν αυτον ει εξεστιν ανδρι γυναικα απολυσαι πειραζοντες αυτον',
        ...
        21: 'ο δε ιησους εμβλεψας αυτω ηγαπησεν αυτον και ειπεν αυτω εν σοι υστερει υπαγε οσα εχεις πωλησον και δος πτωχοις και εξεις θησαυρον εν ουρανω και δευρο ακολουθει μοι αρας τον σταυρον',
        ...
        27: 'εμβλεψας δε αυτοις ο ιησους λεγει παρα ανθρωποις αδυνατον αλλ ου παρα θεω παντα γαρ δυνατα εστιν παρα τω θεω',
        28: 'ηρξατο ο πετρος λεγειν αυτω ιδου ημεις αφηκαμεν παντα και ηκολουθησαμεν σοι',
        29: 'αποκριθεις αποκριθεις δε ο ιησους ειπεν αμην λεγω υμιν ουδεις εστιν ος αφηκεν οικιαν η αδελφους η αδελφας η πατερα η μητερα η γυναικα η τεκνα η αγρους ενεκεν εμου και ενεκεν OMIT ενεκεν του ευαγγελιου',
        ...
        31: 'πολλοι δε εσονται πρωτοι εσχατοι και εσχατοι οι εσχατοι πρωτοι',
        ...
        33: 'οτι ιδου αναβαινομεν εις ιεροσολυμα και ο υιος του ανθρωπου παραδοθησεται τοις αρχιερευσιν και γραμματευσιν και κατακρινουσιν αυτον θανατω και παραδωσουσιν αυτον τοις εθνεσιν',
        ...
        40: 'το δε καθισαι εκ δεξιων μου και εξ ευωνυμων ουκ εστιν εμον δουναι αλλ οις ητοιμασται',
        ...
        43: 'ουχ ουτως δε εσται εν υμιν αλλ ος εαν θελη γενεσθαι μεγας εν υμιν εσται υμων διακονος',
        44: 'και ος εαν θελη υμων γενεσθαι πρωτος εσται παντων δουλος',
        ...
        47: 'και ακουσας οτι ιησους ο ναζωραιος εστιν ηρξατο κραζειν και λεγειν ο υιος δαυιδ ιησου ελεησον με',
        ...
        51: 'και αποκριθεις λεγει αυτω ο ιησους τι θελεις ποιησω σοι ο δε τυφλος ειπεν αυτω ραββουνι ινα αναβλεψω',
        52: 'ο δε ιησους ειπεν αυτω υπαγε η πιστις σου σεσωκεν σε και ευθεως ανεβλεψεν και ηκολουθει τω ιησου εν τη οδω',
    },
    11: {
        1: 'και οτε εγγιζουσιν εις ιερουσαλημ εις βηθσφαγη βηθφαγη και βηθανιαν προς το ορος των ελαιων αποστελλει δυο των μαθητων αυτου',
        ...
        4: 'απηλθον δε και ευρον πωλον τον πωλον δεδεμενον προς την θυραν εξω επι του αμφοδου και λυουσιν αυτον',
        ...
        24: 'δια τουτο λεγω υμιν παντα οσα αν προσευχομενοι αιτησθε αιτεισθε πιστευετε οτι λαμβανετε και εσται υμιν',
    ...
    12: {
        ...
        26: 'περι δε των νεκρων οτι εγειρονται ουκ ανεγνωτε εν τη βιβλω μωσεως μωυσεως επι του βατου ως ειπεν αυτω ο θεος λεγων εγω ο θεος αβρααμ και ο θεος ισαακ και ο θεος ιακωβ',
        ...
        43: 'και προσκαλεσαμενος τους μαθητας αυτου λεγει αυτοις αμην λεγω υμιν οτι η χηρα αυτη η πτωχη πλειον παντων βεβληκεν των βαλλοντων βαλοντων εις το γαζοφυλακιον',
    ...
    13: {
        ...
        21: 'τοτε και τοτε εαν τις υμιν ειπη ιδου ωδε ο χριστος η ιδου εκει μη πιστευετε',
        ...
        31: 'ο ουρανος και η γη παρελευσεται παρελευσονται οι δε λογοι μου ου μη παρελθωσιν',
    ...
    14: {
        ...
        3: 'και οντος αυτου εν βηθανια εν τη οικια σιμωνος του λεπρου κατακειμενου αυτου ηλθεν γυνη εχουσα αλαβαστρον μυρου ναρδου πιστικης πολυτελους και συντριψασα το τον αλαβαστρον κατεχεεν αυτου κατα της κεφαλης',
        ...
        9: 'αμην αμην δε λεγω υμιν οπου εαν κηρυχθη το ευαγγελιον τουτο εις ολον τον κοσμον και ο εποιησεν αυτη λαληθησεται εις μνημοσυνον αυτης',
        ...
        12: 'και τη πρωτη ημερα των αζυμων οτε το πασχα εθυον λεγουσιν αυτω οι μαθηται αυτου που θελεις απελθοντες ετοιμασωμεν ετοιμασομεν ινα φαγης το πασχα',
        ...
        15: 'και αυτος υμιν δειξει ανωγεον αναγαιον μεγα εστρωμενον ετοιμον εκει ετοιμασατε ημιν',
        ...
        31: 'ο δε εκπερισσου ελεγεν μαλλον εαν με δεη συναποθανειν σοι ου μη σε απαρνησωμαι ωσαυτως δε και παντες ελεγον',
        ...
        35: 'και προσελθων μικρον επεσεν επι της γης και προσηυχετο ινα ει δυνατον εστιν παρελθη απ αυτου η ωρα',
        ...
        41: 'και ερχεται το τριτον και λεγει αυτοις καθευδετε λοιπον και αναπαυεσθε 373 απεχει ηλθεν η ωρα ιδου παραδιδοται ο υιος του ανθρωπου εις τας χειρας των αμαρτωλων',
        ...
        65: 'και ηρξαντο τινες εμπτυειν αυτω και περικαλυπτειν το προσωπον αυτου και κολαφιζειν αυτον και λεγειν αυτω προφητευσον και οι υπηρεται ραπισμασιν αυτον εβαλλον εβαλον',
        ...
        68: 'ο δε ηρνησατο λεγων ουκ οιδα ουδε ουτε επισταμαι τι συ λεγεις και εξηλθεν εξω εις το προαυλιον και αλεκτωρ εφωνησεν',
    ...
    15: {
        ...
        18: 'και ηρξαντο ασπαζεσθαι 782 αυτον χαιρε ο βασιλευς βασιλευ των ιουδαιων',
        ...
        32: 'ο χριστος ο βασιλευς του ισραηλ καταβατω νυν απο του σταυρου ινα ιδωμεν και πιστευσωμεν αυτω OMIT αυτω και οι συνεσταυρωμενοι αυτω ωνειδιζον αυτον',
        ...
        42: 'και ηδη οψιας γενομενης επει ην παρασκευη ο εστιν προσαββατον προς σαββατον',
    ...
    16: {
        1: 'και διαγενομενου του σαββατου μαρια η μαγδαληνη και μαρια ιακωβου η του ιακωβου και σαλωμη ηγορασαν αρωματα ινα ελθουσαι αλειψωσιν αυτον',
