...
CHAPTERS = {
    ...
    3: {
        ...
        4: 'μη γενοιτο γινεσθω 1096 δε ο θεος αληθης πας δε ανθρωπος ψευστης καθως γεγραπται οπως αν δικαιωθης εν τοις λογοις σου και νικησης νικησεις εν τω κρινεσθαι σε',
        ...
        10: 'καθως γεγραπται οτι OMIT οτι ουκ εστιν δικαιος ουδε εις',
    ...
    4: {
        ...
        12: 'και πατερα περιτομης τοις ουκ εκ περιτομης μονον αλλα και τοις στοιχουσιν τοις ιχνεσιν της πιστεως της εν τη ακροβυστια του πατρος ημων αβρααμ',
    ...
    5: {
        1: 'δικαιωθεντες ουν εκ πιστεως ειρηνην εχομεν εχωμεν προς τον θεον δια του κυριου ημων ιησου χριστου',
        ...
        14: 'αλλ εβασιλευσεν ο θανατος απο αδαμ μεχρι μωυσεως μωσεως και επι τους μη αμαρτησαντας επι τω ομοιωματι της παραβασεως αδαμ ος εστιν τυπος του μελλοντος',
    ...
    6: {
        1: 'τι ουν ερουμεν επιμενομεν επιμενωμεν OR επιμενουμεν τη αμαρτια ινα η χαρις πλεοναση',
    ...
    7: {
        ...
        23: 'βλεπω δε ετερον νομον εν τοις μελεσιν μου αντιστρατευομενον τω νομω του νοος μου και αιχμαλωτιζοντα με τω εν τω νομω της αμαρτιας τω οντι εν τοις μελεσιν μου',
    ...
    9: {
        ...
        15: 'τω γαρ μωυση μωση λεγει ελεησω ον αν ελεω και οικτειρησω ον αν οικτειρω',
    ...
    10: {
        ...
        19: 'αλλα λεγω μη ουκ εγνω ισραηλ πρωτος μωυσης λεγει εγω παραζηλωσω υμας επ ουκ εθνει επι εθνει ασυνετω παροργιω υμας',
    ...
    11: {
        ...
        21: 'ει γαρ ο θεος των κατα φυσιν κλαδων ουκ εφεισατο μηπως ουδε σου φεισεται',
        ...
        23: 'και εκεινοι δε εαν μη επιμεινωσιν τη απιστια εγκεντρισθησονται δυνατος γαρ ο θεος εστιν παλιν εγκεντρισαι αυτους',
        ...
        25: 'ου γαρ θελω υμας αγνοειν αδελφοι το μυστηριον τουτο ινα μη ητε παρ εαυτοις φρονιμοι οτι πωρωσις απο μερους τω ισραηλ γεγονεν αχρι ου το πληρωμα των εθνων εισελθη',
    ...
    12: {
        ...
        2: 'και μη συσχηματιζεσθαι 4964 συσχηματιζεσθε 4964 τω αιωνι τουτω αλλα μεταμορφουσθαι μεταμορφουσθε τη ανακαινωσει του νοος υμων εις το δοκιμαζειν υμας τι το θελημα του θεου το αγαθον και ευαρεστον και τελειον',
    ...
    13: {
        ...
        9: 'το γαρ ου μοιχευσεις ου φονευσεις ου κλεψεις κλεψεις ου ψευδομαρτυρησεις ουκ επιθυμησεις και ει τις ετερα εντολη εν τουτω τω λογω ανακεφαλαιουται εν τω αγαπησεις τον πλησιον σου ως σεαυτον',
    ...
    14: {
        ...
        23: 'ο δε διακρινομενος εαν φαγη κατακεκριται οτι ουκ εκ πιστεως παν δε ο ουκ εκ πιστεως αμαρτια εστιν (16:25) τω δε δυναμενω υμας στηριξαι κατα το ευαγγελιον μου και το κηρυγμα ιησου χριστου κατα αποκαλυψιν μυστηριου χρονοις αιωνιοις σεσιγημενου (16:26) φανερωθεντος δε νυν δια τε γραφων προφητικων κατ επιταγην του αιωνιου θεου εις υπακοην πιστεως εις παντα τα εθνη γνωρισθεντος (16:27) μονω σοφω θεω δια ιησου χριστου ω η δοξα εις τους αιωνας αμην',
    },
    15: {
        ...
        4: 'οσα γαρ προεγραφη εις την ημετεραν διδασκαλιαν προεγραφη ινα δια της υπομονης και δια της παρακλησεως των γραφων την ελπιδα εχωμεν',
        ...
        7: 'διο προσλαμβανεσθε αλληλους καθως και ο χριστος προσελαβετο υμας ημας εις δοξαν θεου',
        ...
        14: 'πεπεισμαι δε αδελφοι μου και αυτος εγω περι υμων οτι και αυτοι μεστοι εστε αγαθωσυνης πεπληρωμενοι πασης γνωσεως δυναμενοι και αλλους νουθετειν',
    ...
    16: {
        ...
        3: 'ασπασασθε πρισκαν πρισκιλλαν και ακυλαν τους συνεργους μου εν χριστω ιησου',
