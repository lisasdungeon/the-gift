...
CHAPTERS = {
    1: {
        ...
        9: 'ο δε μιχαηλ ο αρχαγγελος οτε τω διαβολω διακρινομενος διελεγετο περι του μωυσεως μωσεως σωματος ουκ ετολμησεν κρισιν επενεγκειν βλασφημιας αλλ ειπεν επιτιμησαι σοι κυριος',
        ...
        12: 'ουτοι εισιν εν ταις αγαπαις υμων σπιλαδες συνευωχουμενοι αφοβως εαυτους ποιμαινοντες νεφελαι ανυδροι υπο ανεμων παραφερομεναι δενδρα φθινοπωρινα ακαρπα δις αποθανοντα εκριζωθεντα',
        ...
        16: 'ουτοι εισιν γογγυσται μεμψιμοιροι κατα τας επιθυμιας αυτων εαυτων πορευομενοι και το στομα αυτων λαλει υπερογκα θαυμαζοντες προσωπα ωφελειας χαριν',
        ...
        23: 'ους δε εν φοβω σωζετε εκ πυρος αρπαζοντες μισουντες και τον απο της σαρκος εσπιλωμενον χιτωνα',
        24: 'τω δε δυναμενω φυλαξαι αυτους απταιστους και στησαι κατενωπιον της δοξης αυτου αμωμους εν αγαλλιασει',
