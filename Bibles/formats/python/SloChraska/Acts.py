...
CHAPTERS = {
    1: {
        ...
        4: 'In ko je bil ž njimi zbran, jim je zapovedal, naj ne odidejo iz Jeruzalema, temuč naj čakajo obljube Očetove, ‚ki ste jo slišali od mene;',
        5: 'kajti Janez je sicer krstil z vodo, ali vi boste krščeni s svetim Duhom ne dolgo po teh dneh‘.',
        6: 'Ti pa, ki so se bili sešli, so ga torej vpraševali, govoreč: Gospod, ali boš v tem času vnovič postavil kraljestvo v Izraelu?',
        7: 'On pa jim reče: Ni vaša stvar, da bi znali čase in ure, ki jih je določil Oče po svoji samooblasti;',
        8: 'temuč prejmete moč, ko pride sveti Duh na vas, in boste mi priče v Jeruzalemu in po vsej Judeji in Samariji in do kraja zemlje.',
        ...
        15: 'In v te dni vstane Peter sredi bratov in reče (bila pa je zbrana množica kakih sto in dvajset oseb):',
        ...
        22: 'začenši od krsta Janezovega prav do dne, ko je bil gori vzet od nas: eden teh mož mora biti z nami vred priča vstajenja njegovega.',
    ...
    2: {
        ...
        4: 'in vsi se napolnijo svetega Duha in začno govoriti v drugih jezikih, kakor jim je Duh dajal izgovarjati.',
        ...
        9: 'Parčani in Medi in Elamljani, in ki prebivamo v Mezopotamiji, Judeji in Kapadociji, Pontu in Aziji,',
        10: 'Frigiji in Pamfiliji, v Egiptu in v krajih Libije pri Cireni, in prišleci iz Rima, Judje in pojudenci,',
        11: 'Krečani in Arabci: slišimo, da nam govore v naših jezikih velika dela Božja.',
        ...
        16: 'temuč to je, kar je rečeno po proroku Joelu:',
        ...
        18: 'in tudi na hlapce svoje in na dekle svoje v tistih dneh izlijem od Duha svojega, in bodo prorokovali.',
        19: 'In pokažem čudeže gori na nebu in znamenja doli na zemlji, kri in ogenj in kajenje dima;',
        20: 'solnce se spremeni v temo in mesec v kri, preden pride dan Gospodov, veliki in preslavni.',
        ...
        30: 'Ker pa je bil prorok in je vedel, da se mu je s prisego zavezal Bog, da posadi enega iz plodu ledja njegovega na prestol njegov,',
        ...
        36: 'Za gotovo vedi torej vsa hiša Izraelova, da je Bog i za Gospoda i za Kristusa postavil tega Jezusa, ki ste ga vi križali.',
        ...
        46: 'In vsak dan so bili stanovitno ene misli v templju, in po hišah so lomili kruh in prejemali jed z veseljem in preprostim srcem,',
    ...
    3: {
        ...
        2: 'In nosili so nekega moža, ki je bil hrom od materinega telesa, in so ga pokladali vsak dan v templju pred vrata, ki se imenujejo Lepa, da je prosil miloščine teh, ki so hodili v tempelj.',
        ...
        8: 'In poskočivši, stoji in začne hoditi, in gre ž njima v tempelj, hodeč in poskakujoč in hvaleč Boga.',
        ...
        11: 'Ko se je pa ta ozdravljenec držal Petra in Janeza, priteče k njim vse ljudstvo zelo prestrašeno v lopo, ki se imenuje Salomonova.',
        ...
        13: 'Bog Abrahamov in Izakov in Jakobov, očetov naših Bog, je oslavil Služabnika svojega Jezusa, ki ste ga vi izdali in zatajili pred obličjem Pilatovim, ko je on sodil, naj se izpusti.',
        14: 'A vi ste Svetnika in Pravičnika zatajili in ste prosili, naj vam da ubijalca,',
        15: 'Začetnika življenja pa ste umorili! Tega je Bog obudil iz mrtvih, čemur smo mi priče.',
        ...
        17: 'Ali sedaj, bratje, vem, da ste to storili iz nevednosti, kakor tudi poglavarji vaši.',
        18: 'Bog pa je, kar je naprej oznanil z usti vseh prorokov, da bo njegov Maziljenec trpel, tako dopolnil.',
        19: 'Izpokorite se torej in izpreobrnite, da se izbrišejo grehi vaši, da tako pridejo časi poživljenja od obličja Gospodovega',
        20: 'in pošlje za vas določenega Maziljenca Jezusa,',
        21: 'ki ga sicer mora nebo sprejeti do časov preuredbe vsega, kar je Bog povedal z usti svetih prorokov svojih od nekdaj.',
        22: 'Mojzes je že rekel: „Proroka vam zbudi Gospod, Bog vaš, izmed bratov vaših kakor mene; njega poslušajte v vsem, karkoli vam bo govoril.',
        23: 'Zgodi se pa, da se vsaka duša, ki ne bo poslušala tega proroka, iztrebi izmed ljudstva“.',
        24: 'Pa tudi vsi proroki od Samuela in poznejši, kolikorkoli jih je govorilo, so tudi oznanili te dni.',
        25: 'Vi ste sinovi prorokov in zaveze, ki jo je Bog sklenil z očeti vašimi, govoreč Abrahamu: „In v semenu tvojem bodo blagoslovljene vse rodovine zemlje“.',
    ...
    4: {
        ...
        2: 'ki jih je zelo peklo, da učita ljudstvo in oznanjujeta v Jezusu vstajenje iz mrtvih.',
        ...
        5: 'Zgodi se pa drugi dan, da se zbero njih poglavarji in starejšine in pismarji v Jeruzalemu,',
        ...
        8: 'Tedaj jim Peter, napolnivši se svetega Duha, reče: Poglavarji naroda in starejšine!',
        ...
        14: 'Videč tudi človeka, ki je ozdravel, da stoji ž njima, niso imeli kaj ugovarjati.',
        ...
        23: 'Ko so ju pa izpustili, prideta k svojim in jim sporočita, kar so jima rekli višji duhovniki in starejšine.',
        ...
        32: 'Množica teh pa, ki so sprejeli vero, je bila enega srca in enega duha; tudi nihče ni govoril, da je kaj njegovega od tega, kar je imel, temuč vse jim je bilo skupno.',
        33: 'In z veliko močjo so dajali apostoli pričevanje za vstajenje Gospoda Jezusa, in milost velika je bila na vseh njih.',
        34: 'Ni ga bilo namreč ubožca med njimi: kajti koliko jih je bilo, ki so imeli njive ali hiše, ti so jih prodajali, in so prinašali izkupiček tega, kar so prodali,',
    ...
    5: {
        ...
        15: 'da so celo nosili bolnike na ulice in jih pokladali na postelje in odre, da bi vsaj senca mimoidočega Petra obsenčila koga od njih.',
        16: 'Shajala pa se je tudi množica iz sosednjih mest v Jeruzalem, in so prinašali bolnike in tiste, ki so jih mučili nečisti duhovi; in vsi so bili ozdravljeni.',
        ...
        21: 'Ko so pa to slišali, gredo zjutraj v tempelj ter učé. Pride pa veliki duhovnik in njegovi pristaši, ter skličejo veliki zbor in vse starejšine sinov Izraelovih in pošljejo v ječo, naj jih pripeljejo.',
        ...
        29: 'Peter in apostoli odgovore in reko: Boga je treba bolj poslušati nego ljudi.',
        ...
        40: 'In poslušali so ga: in pokličejo apostole in jih pretepo ter jim naroče, naj ne govore o imenu Jezusovem, in jih izpuste.',
    ...
    7: {
        ...
        6: 'Rekel je pa Bog tako: „Seme tvoje bo priseljeno v tuji zemlji, in sužnosti ga podvržejo in hudo bodo ravnali ž njim štiristo let.',
        ...
        9: 'In očaki so iz nevoščljivosti prodali Jožefa v Egipt; a Bog je bil ž njim',
        ...
        16: 'in prinesli so jih v Sihem in položili v grob, ki ga je kupil Abraham za ceno v srebru od sinov Hemorjevih v Sihemu.',
        ...
        37: 'Ta je tisti Mojzes, ki je rekel sinovom Izraelovim: „Proroka vam obudi Gospod Bog izmed bratov vaših kakor mene“.',
        ...
        42: 'Bog pa se je odvrnil in jih je izdal, naj služijo zvezdam neba, kakor je pisano v knjigi prorokov: „Ali ste mi darovali klalne in žgalne daritve štirideset let v puščavi, hiša Izraelova?',
        43: 'temuč nosili ste šator Molohov in boga Remfana zvezdo, podobe, ki ste jih naredili, da se jim poklanjate. Zato pa vas preselim onostran Babilona“.',
        44: 'Šator pričevanja so imeli očetje naši v puščavi, kakor je ukazal ta, ki je rekel Mojzesu, naj ga naredi po podobi, ki jo je videl.',
        45: 'Ta šator so tudi prejeli očetje naši in so ga sem prinesli z Jozuetom, ko so posedli deželo poganov, ki jih je izgnal Bog izpred obličja očetov naših, do dni Davidovih;',
        46: 'ki je našel milost pred Bogom in je prosil, da bi našel prebivališče Bogu Jakobovemu.',
        47: 'A Salomon mu je sezidal hišo.',
        48: 'Ali Najvišji ne prebiva v svetiščih, z rokami narejenih, kakor pravi prorok:',
        ...
        52: 'Katerega od prorokov niso preganjali očetje vaši? In pomorili so te, ki so naprej oznanjali prihod Pravičnika, čigar izdajalci in ubijalci ste sedaj postali vi,',
    ...
    8: {
        1: 'Savel pa se je ž njimi radoval njegove smrti. In nastalo je ta dan veliko preganjanje cerkve, ki je bila v Jeruzalemu; in vsi so se razkropili po judejskih in samarijskih krajih, razen apostolov.',
        ...
        21: 'Nimaš ga dela, ne deleža v tej reči, kajti srce tvoje ni odkrito proti Bogu.',
        ...
        28: 'se vrača domov, in sedeč na vozu svojem, prebira proroka Izaija.',
        29: 'Duh pa reče Filipu: Pristopi in pridruži se temu vozu.',
        30: 'Filip pa priteče in ga sliši, da bere proroka Izaija, ter reče: Ali pa umeš, kar bereš?',
        ...
        33: 'V ponižanju njegovem se je preklicala sodba njegova. A rod njegov kdo razloži? kajti življenje njegovo se vzame od zemlje“.',
        34: 'Izpregovori pa komornik in reče: Prosim te, o kom govori to prorok? o sebi ali o kom drugem?',
        35: 'Filip pa odpre usta in, začenši od tega pisma, mu oznani blagovestje o Jezusu.',
    ...
    9: {
        ...
        7: 'Možje pa, ki so ž njim šli, se ustavijo in strmé, ko glas sicer slišijo, pa nikogar ne vidijo.',
        ...
        28: 'In bival je ž njimi, hodeč v Jeruzalemu ven in noter in srčno govoreč v imenu Gospodovem.',
        ...
        34: 'In Peter mu veli: Eneja, Jezus Kristus te ozdravlja; vstani in postelji si sam! In precej vstane.',
        ...
        39: 'Peter pa vstane in gre ž njima. In ko pride, ga peljejo v gornjo izbo; in vse vdove ga obstopijo, jokajoč in kažoč suknje in oblačila, ki jim jih je delala Srna, dokler je bila ž njimi.',
    ...
    10: {
        ...
        27: 'In razgovarjaje se ž njim, stopi noter in jih najde veliko zbranih,',
        ...
        30: 'In Kornelij reče: Pred štirimi dnevi do te ure sem molil ob devetih v hiši svoji; in glej, mož se postavi pred menoj v svetlem oblačilu in veli:',
        ...
        35: 'temuč v vsakem narodu mu je prijeten, kdor se ga boji in dela pravično;',
        36: 'po besedi, ki jo je poslal sinovom Izraelovim, oznanjujoč blagovestje o miru po Jezusu Kristusu – ta je vsem Gospod!',
        37: 'Vi veste, kaj se je godilo po Judeji, počenši od Galileje, po krstu, ki ga je oznanjeval Janez,',
        38: 'veste o Jezusu Kristusu iz Nazareta, kako ga je pomazilil Bog s svetim Duhom in z močjo; ki je hodil okrog, deleč dobrote in ozdravljajoč vse, ki so bili obvladani od hudiča, ker je bil Bog ž njim.',
        39: 'In mi smo priče vsemu, kar je storil v deželi Judov in v Jeruzalemu; ki so ga tudi na les obesili in umorili.',
        40: 'Tega je Bog obudil tretji dan in dal, da so ga videli,',
        41: 'ne vse ljudstvo, nego priče, poprej izvoljene od Boga, mi, ki smo ž njim jedli in pili, potem ko je bil vstal iz mrtvih.',
        42: 'In on nam je ukazal, naj propovedujemo ljudstvu in pričamo, da je on od Boga postavljeni sodnik živih in mrtvih.',
        43: 'Temu pričajo vsi proroki, da prejme po imenu njegovem odpuščenje grehov vsak, kdor veruje vanj.',
    ...
    11: {
        1: 'Zaslišijo pa apostoli in bratje, ki so bivali po Judeji, da so tudi pogani sprejeli besedo Božjo.',
        2: 'Ko pa je prišel Peter v Jeruzalem, so se prepirali ž njim, ki so bili iz obreze,',
        3: 'in so dejali: K možem neobrezanim si šel in si jedel ž njimi!',
        4: 'Peter pa začne in jim razloži vse po vrsti, govoreč:',
        5: 'Molil sem v mestu Jopi, in zamaknjen vidim prikazen: nekaka posoda, kakor velik prt, gre navzdol in se za štiri vogle spušča z neba, in pride do mene.',
        ...
        12: 'In Duh mi veli, naj grem ž njimi brez pomišljevanja. Šlo je pa z menoj tudi tehle šest bratov, in vstopili smo v hišo moževo.',
        ...
        17: 'Ko jim je torej dal Bog prav ta dar kakor tudi nam, ko smo sprejeli vero v Gospoda Jezusa Kristusa: kdo pa sem bil jaz, da bi jaz mogel Bogu zabraniti?',
        18: 'Ko so pa to slišali, so se pomirili, in slavili so Boga, rekoč: Torej tudi poganom je Bog dal izpokorjenje za življenje!',
        ...
        21: 'In roka Gospodova je bila ž njimi; in veliko število se jih je, sprejemši vero, izpreobrnilo h Gospodu.',
        ...
        25: 'Barnaba pa odide v Tars iskat Savla; in ko ga je našel, ga pripelje v Antiohijo.',
        26: 'Zgodi se pa, da sta bila celo leto pri zborovanjih v cerkvi in sta učila precejšnjo množico, in da so učenci najprvo v Antiohiji bili imenovani Kristjani.',
        27: 'V tej dneh so pa prišli iz Jeruzalema proroki v Antiohijo.',
        28: 'In vstane eden izmed njih, po imenu Agab, ter oznani po Duhu, da nastane velika lakota po vsem svetu, ki je tudi prišla za Klavdija cesarja.',
        29: 'Tedaj sklenejo učenci, vsak po zmožnosti svoji, poslati v pomoč bratom, ki so prebivali v Judeji;',
        30: 'to so tudi storili, poslavši starejšinam po roki Barnabovi in Savlovi.',
    },
    12: {
        ...
        9: 'In izide in gre za njim; in ni vedel, da je resnično, kar se je godilo po angelu, temuč menil je, da vidi prikazen.',
        ...
        25: 'Barnaba in Pavel pa sta se vrnila iz Jeruzalema, ko sta bila izvršila službo ljubezni, in sta privedla s seboj Janeza s priimkom Marko.',
    },
    13: {
        1: 'Bili so pa v cerkvi, ki je bila v Antiohiji, proroki in učitelji: Barnaba in Simeon, ki se je imenoval Niger, in Lucij Cirenc, in Manahem, ki je bil odgojen s Herodom četrtnikom, in Savel.',
        ...
        6: 'In ko sta prešla ves otok do Pafa, najdeta nekega čarovnika, lažnivega proroka, ki je bil Jud in mu je bilo ime Barjezus;',
        7: 'in bil je pri namestniku Sergiju Pavlu, pametnem možu. Ta je poklical Barnaba in Pavla in želel slišati besedo Božjo.',
        8: 'Ali ustavljal se jima je Elima, čarovnik (tako namreč se tolmači ime njegovo), prizadevajoč si, da bi namestnika odvrnil od vere.',
        ...
        11: 'In sedaj, glej, roka Gospodova je zoper tebe in oslepiš in ne boš videl solnca do nekaj časa. In pri tej priči se zgrneta nanj mrak in tema, in tipajoč okoli, išče, kdo bi ga za roko vodil.',
        ...
        14: 'Ona pa gresta iz Perge naprej in prideta v Pisidijsko Antiohijo. In v sobotni dan gresta v shodnico in sedeta.',
        15: 'Po branju postave in prorokov pa pošljejo načelniki shodnice k njima s tem poročilom: Moža in brata, če imata besedo opomina in tolažbe za ljudstvo, govorita!',
        16: 'Vstane torej Pavel in pomigne z roko, naj umolknejo, ter reče: Možje Izraelci in kateri se bojite Boga, poslušajte!',
        17: 'Bog tega naroda, Izraela, je izvolil očete naše in povišal ljudstvo, ko je prebivalo na tujem v zemlji Egiptovski, in s povzdignjeno roko jih je izpeljal iz nje.',
        18: 'In okoli štirideset let je imel potrpljenje ž njih vedenjem v puščavi.',
        19: 'In pokončavši sedem narodov v zemlji Kanaanski, jim je razdelil v dediščino njih zemljo',
        20: 'za kakih štiristo in petdeset let. In potem jim je dajal sodnike do Samuela proroka.',
        21: 'In odtlej so zahtevali kralja, in dal jim je Bog Savla, sinu Kisovega, moža iz rodu Benjaminovega, štirideset let.',
        22: 'In ko je bil tega zavrgel, jim je za kralja obudil Davida, ki mu je tudi pričujoč rekel: Našel sem Davida, sina Jesejevega, moža po srcu svojem, ki bo delal vso voljo mojo.',
        ...
        25: 'Ko je pa Janez tek svoj dopolnjeval, je dejal: Nisem tisti, ki menite, da sem. Toda glejte, za menoj prihaja, ki mu nisem vreden odvezati obuvala z nog.',
        26: 'Možje in bratje, sinovi rodu Abrahamovega in kateri se med vami boje Boga: nam se je poslala beseda tega zveličanja.',
        27: 'Zakaj prebivalci v Jeruzalemu in njih poglavarji ga niso spoznali in so s svojo sodbo izpolnili govore prorokov, ki se vsako soboto bero;',
        ...
        31: 'In prikazoval se je več dni tem, ki so bili ž njim vred prišli iz Galileje v Jeruzalem, ki so zdaj njegove priče pred ljudstvom.',
        32: 'In mi vam oznanjujemo blagovestje o obljubi, ki je bila dana očetom, da jo je Bog izpolnil nam, njih otrokom, obudivši Jezusa,',
        33: 'kakor je tudi pisano v drugem psalmu: „Sin moj si ti; jaz sem te danes rodil“.',
        ...
        38: 'Znano vam torej bodi, možje in bratje, da se vam po njem oznanjuje odpuščenje grehov;',
        39: 'in vsega, česar se niste mogli opravičiti v Mojzesovi postavi, se v njem opraviči vsak, kdor veruje.',
        40: 'Glejte torej, da ne pride na vas, kar je rečeno v prorokih:',
        ...
        43: 'In ko se je zbor razšel, gre veliko Judov in pobožnih pojudencev za Pavlom in Barnabom, ki ž njimi govorita in jih izpodbujata naj vztrajajo v milosti Božji.',
        44: 'A drugo soboto se je skoro vse mesto zbralo, da bi slišali besedo Božjo.',
        45: 'Videč pa Judje množice, se napolnijo zavisti in ugovarjajo temu, kar je pravil Pavel, nasprotujoč in preklinjajoč.',
        46: 'In Pavel in Barnaba srčno rečeta: Vam se je morala najprej govoriti beseda Božja; toda ker jo zametujete in se sami za nevredne štejete večnega življenja, glej, obračava se do poganov.',
        ...
        50: 'Judje pa naščujejo pobožne in odlične žene in mestne prvake, in provzročijo preganjanje zoper Pavla in Barnaba ter ju izženo iz svojih krajev.',
        51: 'A ona sta otresla prah z nog svojih nanje, in prišla sta v Ikonijo.',
        52: 'Učenci pa so se napolnjevali veselja in svetega Duha.',
    },
    14: {
        1: 'Zgodi se pa v Ikoniji, da sta skupno šla v judovsko shodnico in sta tako govorila, da je vero sprejela velika množica Judov in Grkov.',
        ...
        4: 'Mestna množica se pa razdeli, in eni so bili za Jude, drugi pa za apostola.',
        ...
        7: 'in tu sta oznanjevala evangelij.',
        8: 'In v Listri je sedel neki mož, brez moči v nogah, hrom od materinega telesa, ki ni nikoli hodil.',
        9: 'Ta posluša Pavla, ko govori; on pa vpre oči vanj in videč, da ima vero, da ozdravi,',
        ...
        15: 'in govoreč: Možje! kaj to delate? Tudi midva sva človeka, z vami enake narave, in vam oznanjujeva blagovestje, da se od teh ničevih reči obrnete k živemu Bogu, ki je ustvaril nebo in zemljo in morje in vse, kar je v njih;',
        ...
        20: 'Ko pa ga učenci obstopijo, vstane in pride v mesto. In drugi dan odide z Barnabom v Derbo.',
        21: 'In ko sta oznanila evangelij temu mestu in sta pridobila dosti učencev, sta se vrnila v Listro in Ikonijo in Antiohijo,',
        22: 'potrjujoč duše učencev in jih opominjajoč, da naj vztrajajo v veri in da nam je treba po mnogih stiskah priti v kraljestvo Božje.',
        23: 'In postavita jim starejšine v vsaki cerkvi in jih v molitvi in s postom priporočita Gospodu, ki so bili vanj sprejeli vero.',
        24: 'In prehodita Pisidijo in prideta v Pamfilijo,',
        ...
        27: 'Ko pa dojdeta tja in zbereta cerkev, sporočita, koliko reči je Bog ž njima storil in da je odprl poganom vrata vere.',
    ...
    15: {
        ...
        2: 'Ko je torej nastal razpor in sta se Pavel in Barnaba nemalo prepirala ž njimi, sklenejo, da naj gredo Pavel in Barnaba in nekateri drugi izmed njih gori k apostolom in starejšinam v Jeruzalem zaradi tega vprašanja.',
        ...
        4: 'Ko so pa dospeli v Jeruzalem, so jih ljubeznivo sprejeli cerkev in apostoli in starejšine, in sporočili so, koliko reči je Bog ž njimi storil.',
        5: 'Ali vstane jih nekaj od ločine farizejev, ki so bili vero sprejeli, in reko: Obrezovati se morajo, in naročiti se mora, naj izpolnjujejo postavo Mojzesovo.',
        6: 'In apostoli in starejšine se zbero, da presodijo to reč.',
        ...
        11: 'Temuč verujemo, da se po milosti Gospoda Jezusa Kristusa zveličamo prav tako, kakor tudi oni.',
        ...
        13: 'Ko sta pa umolknila, izpregovori Jakob in reče: Možje in bratje, čujte me!',
        14: 'Simon je povedal, kako je Bog najprvo obiskal pogane, da bi izmed njih prejel ljudstvo imenu svojemu.',
        15: 'In s tem se ujemajo besede prorokov, kakor je pisano:',
        16: '„Potem se vrnem in zopet zgradim dom Davidov, ki je padel: in razvaline njegove zopet sezidam in ga postavim,',
        17: 'da ljudje, ki ostanejo, poiščejo Gospoda in vsi pogani, ki se je nad njimi klicalo ime moje:',
        18: 'pravi Gospod, ki to, od vekomaj znano, izvršuje“.',
        19: 'Zato sodim jaz, naj se ne nadlegujejo ti, ki se izmed poganov izpreobrnejo k Bogu;',
        20: 'ali naj se jim piše, da naj se zdržujejo ognušenja z maliki in nečistosti in zadavljenega in krvi.',
        21: 'Kajti Mojzes jih ima od starodavnih časov dosti po vseh mestih, ki ga oznanjujejo, ko se vsako soboto njegova postava čita po shodnicah.',
        22: 'Tedaj so apostoli in starejšine z vso cerkvijo sklenili izvoliti može izmed sebe in poslati v Antiohijo s Pavlom in Barnabom: Juda, s priimkom Barsaba, in Sila, ki sta bila voditelja med brati.',
        23: 'In poslali so po njih to pismo: apostoli in starejšine in bratje pozdravljajo brate izmed poganov, ki so po Antiohiji in Siriji in Ciliciji.',
        24: 'Slišali smo, da so nekateri izmed nas izšli in so vas zbegali s svojim govorjenjem in zmotili duše vaše, katerim nismo ničesar naročili;',
        ...
        32: 'A Juda in Sila, ki sta bila tudi proroka, sta tolažila in utrjevala brate z mnogimi besedami.',
        33: 'In ko sta nekaj časa tu prebila, so ju odpustili bratje v miru k tem, ki so ju bili poslali.',
        34: '§ [Sklenil je pa Sila tam ostati.]',
        35: 'A Pavel in Barnaba sta se pomudila v Antiohiji in sta učila in oznanjevala besedo Gospodovo še z mnogimi drugimi.',
        ...
        38: 'Pavlu pa se je bolje zdelo, da tega, ki se je ločil od njiju v Pamfiliji in ni šel ž njima na delo, ne bi jemala s seboj.',
        39: 'In nastane razpor, tako da se ločita drug od drugega, in Barnaba vzame Marka in se odpelje po morju na Ciper.',
        40: 'A Pavel si izbere Sila in odpotuje, priporočen milosti Božji od bratov.',
        41: 'In hodil je po Siriji in Ciliciji in je utrjeval cerkve.',
    },
    16: {
        1: 'Pride pa v Derbo in Listro. In glej, neki učenec je bil tu, po imenu Timotej, sin žene Judinje, ki je verovala, očeta pa Grka;',
        2: 'za njega so dobro pričali bratje, ki so bili v Listri in Ikoniji.',
        3: 'Tega je hotel Pavel, da bi šel ž njim; in ga vzame in obreže zavoljo Judov, ki so bili v tistih krajih, kajti vsi so vedeli za očeta njegovega, da je bil Grk.',
        4: 'Ko so pa hodili po mestih, so izročali bratom naredbe, ki so jih sklenili apostoli in starejšine v Jeruzalemu, naj se po njih ravnajo.',
        ...
        10: 'Ko je pa to prikazen videl, smo si prizadeli precej, da gremo naprej v Macedonijo, prepričani, da nas je Gospod poklical, da jim oznanimo evangelij.',
        11: 'Ko smo se torej odpeljali iz Troade, smo prišli naravnost v Samotracijo, in drugi dan v Neapol,',
        12: 'in odtod v Filipe, ki so prvo mesto te strani Macedonije in rimska naselbina. V tem mestu pa smo bivali nekoliko dni.',
        ...
        15: 'Ko pa je bila krščena in njena družina, nas je prosila, rekoč: Če ste sodili, da sem verna Gospodu, pridite v hišo mojo in tu ostanite; in nas je primorala.',
        16: 'Zgodi se pa, ko smo šli na molitveni kraj, nas sreča neka deklica, ki je imela vedeževalnega duha in je veliko dobička donašala gospodarjem svojim z vedeževanjem.',
        ...
        26: 'Kar nastane velik potres, tako da se zgane temelj jetnišnice; in pri tej priči se vsa vrata odpro in vsem jetnikom odpade železje.',
        27: 'Ko se pa ječar prebudi in vidi vrata ječe odprta, izdere meč in se hoče umoriti, misleč, da so jetniki pobegnili.',
        ...
        36: 'Ječar pa sporoči te besede Pavlu: Poslali so uradniki, naj vaju izpustim. Sedaj torej odidita in potujta v miru.',
        37: 'Ali Pavel jim reče: Šibali so naju, ki sva Rimljana, očitno brez pravde in sodbe ter vrgli v ječo, in sedaj naju hočejo skrivaj izgnati? Ne tako, marveč sami naj pridejo in naju izpeljejo!',
    ...
    17: {
        ...
        2: 'In Pavel gre po svoji navadi k njim in se razgovarja ž njimi tri sobote na podlagi pisem,',
        ...
        4: 'In nekateri izmed njih so se dali prepričati in so se pridružili Pavlu in Sili, tudi pobožnih Grkov velika množica in imenitnih žen ne malo.',
        5: 'Ali Jude je zavist prevzela, in ko so privzeli nekaj hudobnih mož izmed druhali in zbrali trumo, so napravili vstajo v mestu. In obstopijo hišo Jazonovo in ju iščejo, da bi ju pripeljali pred ljudstvo.',
        ...
        7: 'in Jazon jih je sprejel; in ti vsi delajo zoper cesarjeve postave, govoreč, da je drug kralj, namreč Jezus.',
        ...
        15: 'Ti pa, ki so Pavla spremljali, so ga pripeljali do Aten; in ko so prejeli sporočilo od Sila in Timoteja, naj bi kar najhitreje prišla k njemu, so se vrnili.',
        ...
        18: 'A tudi nekateri izmed epikurejskih in stoiških modrijanov so se prepirali ž njim; in nekateri so govorili: Kaj hoče ta kvasač povedati? A drugi: Zdi se, da je oznanjevalec tujih bogov - ker jim je oznanjeval evangelij o Jezusu in vstajenju.',
        ...
        34: 'A nekateri možje so se mu pridružili in sprejeli vero; med njimi je bil tudi Dionizij Areopagit in žena po imenu Damara, in drugi ž njima.',
    },
    18: {
        1: 'Potem se je Pavel ločil iz Aten in prišel v Korint.',
        2: 'In tu je našel nekega Juda, po imenu Akvila, iz Ponta po rodu, ki je bil nedavno prišel s Priscilo, ženo svojo, iz Italije zato, ker je bil zapovedal Klavdij vsem Judom, naj odidejo iz Rima. In šel je k njima,',
        3: 'in ker je bil istega rokodelstva, je ostal pri njiju, in delali so skupaj; bila sta namreč po rokodelstvu delavca šatorov.',
        ...
        9: 'Reče pa Gospod Pavlu po noči v prikazni: Ne boj se, temuč govori in ne molči;',
        10: 'zakaj jaz sem s teboj, in nihče te ne napade, da ti stori kaj hudega; kajti imam veliko ljudstvo v tem mestu.',
        ...
        14: 'Ko pa hoče Pavel odpreti usta, reče Galion Judom: Ko bi bila kaka krivica ali hudobno dejanje, o Judje, bi vas poslušal po dolžnosti;',
        15: 'ker so pa vprašanja za nauk in za imena in za vašo postavo, glejte sami; jaz nočem biti sodnik v teh rečeh.',
        ...
        18: 'Pavel pa, ko je še dosti dni ostal tu, se poslovi z brati in se odpelje po morju v Sirijo in ž njim Priscila in Akvila, ko si je ostrigel glavo v Kenhrejah: imel je namreč obljubo.',
        19: 'Pridejo pa v Efez, in onadva ostaneta tam. A on gre v shodnico in se razgovarja z Judi.',
        20: 'Ko ga pa prosijo, naj ostane dalje časa ž njimi, ne privoli,',
        21: 'ampak poslovi se ž njimi, rekoč: Vrnem se zopet k vam, če Bog hoče. In odpelje se iz Efeza,',
        ...
        24: 'Prišel pa je v Efez neki Jud, po imenu Apolo, Aleksandrijan po rodu, zgovoren mož; in bil je jako zveden v pismih.',
    ...
    19: {
        ...
        4: 'Pavel pa reče: Janez je krstil s krstom izpokorjenja, govoreč ljudstvu, da naj verujejo v tega, ki prihaja za njim, to je Jezusa.',
        5: 'Ko so pa to slišali, se dado krstiti v ime Gospoda Jezusa.',
        6: 'In ko poklada Pavel nanje roke, pride sveti Duh nanje, in govore jezike in prorokujejo.',
        7: 'Bilo jih je pa vseh skup kakih dvanajst mož.',
        8: 'In ko pride v shodnico, srčno oznanjuje in govori tri mesece in prepričava o kraljestvu Božjem,',
        9: 'Ko so se pa nekateri zakrknili in niso hoteli biti pokorni, hudo govoreč o potu Gospodovem pred množico, odstopi od njih in odloči učence, ter govori vsak dan v Tiranovi šoli.',
        10: 'To pa je trpelo dve leti, tako da so slišali besedo Gospodovo vsi, ki so prebivali v Aziji, Judje in Grki.',
        ...
        16: 'In skočivši nanje, premaga človek, v katerem je bil duh hudobni, dva izmed njih in ju zdela tako, da naga in ranjena ubežita iz tiste hiše.',
        ...
        18: 'Mnogi tudi teh, ki so bili sprejeli vero, so prihajali ter priznavali in razodevali dela svoja.',
        19: 'A mnogi tistih, ki so uganjali vraže, so znesli knjige in jih sežgali vpričo vseh; in ko so sešteli njih ceno, so našli, da so veljale petdeset tisoč srebrnikov.',
        20: 'Tako je beseda Gospodova rasla z močjo in se utrjevala.',
        21: 'A ko se je to dopolnilo, se nameni Pavel v duhu, da pojde, prehodivši Macedonijo in Ahajo, v Jeruzalem in reče: Potem, ko bom tam, moram videti tudi Rim.',
        ...
        25: 'In skliče te in druge take delavce in reče: Možje, veste, da imamo od tega dela blagostanje svoje,',
        26: 'in vidite in slišite, da ne samo v Efezu, temuč skoro po vsej Aziji je ta Pavel veliko ljudstva pregovoril in odvrnil, govoreč, da to niso bogovi, ki so z rokami narejeni.',
        27: 'Ni pa samo nevarnost, da pride to delo naše na nič, ampak tudi, da se bo za nič štel velike boginje Diane tempelj in se skrajša veličastvo te, ki jo časti vsa Azija in vesoljni svet.',
        28: 'Ko so pa to slišali, se napolnijo jeze in zakriče, rekoč: Velika je Diana Efežanov!',
        29: 'In po vsem mestu zavlada zmešnjava; in zaženo se enodušno na gledališče in zgrabijo s seboj Gaja in Aristarha, Macedonca, sopotovalca Pavlova.',
        30: 'Ko je pa Pavel hotel iti med ljudstvo, ga niso učenci pustili.',
        31: 'Pa tudi nekateri azijskih poglavarjev, ki so mu bili prijatelji, so k njemu poslali in ga prosili, naj ne gre v gledališče.',
        ...
        34: 'Ko pa spoznajo, da je Jud, vzdignejo vsi en glas in vpijejo kaki dve uri: Velika je Diana Efežanov!',
        35: 'Mestni pisar pa, ko je množico pomiril, reče: Možje Efežani! kateri človek je, ki bi ne vedel, da mesto Efežanov je varuh svetišču velike Diane in od Jupitra padle podobe?',
        ...
        38: 'Če imajo pa Demetrij in umetniki, ki so ž njim, tožbo zoper koga, sodišča so in namestniki so; naj tožijo drug drugega.',
        39: 'Če pa zahtevate kaj drugega, se to obravna v postavnem zboru.',
        40: 'Kajti v nevarnosti smo tudi, da bomo zatoženi zavoljo današnje vstaje, in nobenega nimamo vzroka, s katerim bi mogli dati odgovor za ta hrupni shod.',
        41: '§ In rekši to, je razpustil zbor.',
    },
    20: {
        1: 'Ko je pa ta hrup nehal, pokliče Pavel učence in jih potolaži, in poslovivši se odide, da potuje v Macedonijo.',
        ...
        5: 'Ti so bili šli naprej in nas čakali v Troadi.',
        ...
        11: 'Nato gre zopet gori, prelomi kruh in jé, govori ž njimi še mnogo, dokler se ne zdani, in tako odpotuje.',
        ...
        15: 'in odpeljavši se odtod, smo prišli drugi dan Hiju nasproti, in dan pozneje smo pripluli k Samu, in ko smo v Trogiliji prenočili, smo prišli drugi dan v Milet.',
        ...
        17: 'Iz Mileta pa pošlje v Efez in pokliče starejšine cerkve.',
        18: 'Ko pa pridejo k njemu, jim reče: Vi veste, kako sem od prvega dne, ko sem prišel v Azijo, ves čas bil z vami,',
        19: 'služeč gospodu z vso ponižnostjo in mnogimi solzami in med izkušnjami, ki so me zadele vsled zalezovanja Judov;',
        20: 'kako nisem nič koristnega izpustil, da ne bi bil vam oznanil in vas učil očitno in po hišah,',
        21: 'pričujoč Judom in Grkom izpreobrnjenje k Bogu in vero v Gospoda našega Jezusa Kristusa.',
        22: 'In sedaj, glejte, zvezan v duhu, grem v Jeruzalem, ne vedoč, kaj se mi tam prigodi,',
        23: 'razen da mi sveti Duh po vseh mestih priča in pravi, da me čakajo vezi in stiske.',
        24: 'Ali življenja svojega ne štejem vrednega zase niti besede, da le dokončam tek svoj in službo, ki sem jo prejel od Gospoda Jezusa, da popričam evangelij milosti Božje.',
        25: 'In sedaj, glejte, jaz vem, da ne boste več videli obličja mojega vi vsi, ki sem med vami hodil, propovedujoč kraljestvo Božje.',
        26: 'Zato vam pričujem današnji dan, da sem čist krvi vseh;',
        27: 'zakaj ničesar nisem zamolčal, da vam ne bi bil oznanil vse volje Božje.',
        28: 'Pazite torej nase in na vso čredo, v kateri vas je sveti Duh postavil za škofe [Škof, da pasete cerkev Božjo, ki si jo je pridobil z lastno krvjo.',
        29: 'Jaz vem, da pridejo po odhodu mojem med vas grabljivi volkovi, ki ne bodo prizanašali čredi;',
        30: 'in izmed vas samih vstanejo možje, ki bodo govorili popačene nauke, da bi potegnili učence za seboj.',
        31: 'Zato čuvajte, spominjajoč se, da tri leta noč in dan nisem nehal s solzami opominjati slehernega iz vas.',
        32: 'In sedaj vas, bratje, priporočam Bogu in besedi milosti njegove, ki more dovršiti vaš napredek in dati delež med vsemi posvečenimi.',
        ...
        35: 'V vsem sem vam dal zgled, da se je treba tako truditi in podpirati slabotne in spominjati se besed Gospoda Jezusa, da je on rekel: Veliko bolje je dati nego vzeti.',
        36: 'In ko je to povedal, poklekne na kolena in moli ž njimi vsemi.',
        37: 'In velik jok je nastal med vsemi, in oklenivši se vratu Pavlovega, so ga poljubovali,',
        38: 'žalostni največ zavoljo besede, ki jo je rekel, da ne bodo več videli obličja njegovega. In spremili so ga na ladjo.',
    },
    21: {
        ...
        4: 'In ko smo našli učence, smo ostali tu sedem dni; ti so pravili Pavlu po Duhu, naj ne hodi gori v Jeruzalem.',
        5: 'Ko smo pa te dni dopolnili, smo se odpravili, in spremljali so nas vsi z ženami in otroki ven za mesto; in pokleknivši na bregu, smo molili.',
        ...
        9: 'Ta pa je imel štiri hčere device, ki so prorokovale.',
        10: 'Ko smo se pa več dni mudili, pride iz Judeje neki prorok, po imenu Agab;',
        ...
        14: 'In ko ga nismo mogli pregovoriti, smo umolknili, rekši: Volja Gospodova se zgódi!',
        15: 'A po teh dneh smo se pripravili in šli gori v Jeruzalem.',
        ...
        18: 'A drugi dan je šel Pavel z nami k Jakobu, kjer so se sešli vsi starejšine.',
        19: 'In ko se je bil ž njimi pozdravil, je pripovedoval vse po vrsti, kaj je storil Bog med pogani po njegovi službi.',
        ...
        21: 'Slišali pa so zate, da učiš odstop od Mojzesa vse Jude, ki so med pogani, in praviš, naj ne obrezujejo sinov svojih in se tudi ne ravnajo po starih šegah.',
        22: 'Kaj je torej storiti? Gotovo [se zbere množica, kajti] zaslišijo, da si prišel.',
        23: 'To torej stóri, kar ti povemo: So pri nas štirje možje, ki imajo obljubo na sebi;',
        24: 'te vzemi k sebi in očisti se ž njimi in plačaj zanje, da si ostrižejo glave, in vsi bodo zvedeli, da ni res, kar so o tebi slišali, ampak da tudi sam redno živiš in izpolnjuješ postavo.',
        25: 'Glede tistih pa, ki so izmed poganov sprejeli vero, smo sklenili in pisali, da naj se varujejo malikom darovanega in krvi in zadavljenega in nečistosti.',
        26: 'Tedaj vzame k sebi Pavel može, in očistivši se ž njimi drugi dan, gre v tempelj in oznani, kdaj se dopolnijo dnevi očiščevanja, dokler se ni darovala daritev za vsakega od njih.',
        27: 'Ko so se pa sedmeri dnevi skoro dokončali, ga ugledajo v templju Judje iz Azije, razdražijo vse ljudstvo ter polože nanj roke,',
        28: 'kričeč: Možje Izraelci, pomagajte! Ta je tisti človek, ki povsod uči vse zoper naše ljudstvo in postavo in ta kraj, in vrhutega je tudi Grke pripeljal v tempelj in oskrunil ta sveti kraj.',
        29: 'Videli so bili namreč poprej Trofima Efežana ž njim v mestu, in o njem so mislili, da ga je Pavel pripeljal v tempelj.',
        30: 'In vse mesto se je vzdignilo in ljudstvo je drlo skupaj; in zgrabivši Pavla, so ga vlekli ven iz templja; in precej so zaprli vrata.',
        ...
        33: 'Tedaj se tisočnik približa in ga prime, in veli ga vkleniti v dve verigi, ter vpraša, kdo da je in kaj je storil.',
        ...
        35: 'In ko pride do stopnic, se prigodi, da ga morajo vojaki nesti zavoljo sile druhali;',
        36: 'kajti šla je za njim množica ljudstva, kričeč: Pogubi ga!',
        37: 'Ravno pa, ko hočejo Pavla peljati v grad, reče on tisočniku: Ali smem kaj govoriti s teboj? On pa reče: Znaš grški?',
        38: 'Nisi li torej tisti Egipčan, ki je pred temi dnevi napravil upor in izpeljal v puščavo štiri tisoč razbojnikov?',
        39: 'Pavel pa reče: Jaz sem Jud iz Tarsa, meščan ne neznatnega mesta v Ciliciji; prosim pa te, dovoli mi govoriti ljudstvu.',
        40: 'In ko mu je dovolil, namigne Pavel, stoječ na stopnicah, z roko ljudstvu, naj umolknejo; in ko nastane velika tihota, govori k njim v hebrejskem jeziku takole:',
    },
    22: {
        ...
        5: 'kakor mi to more izpričati tudi veliki duhovnik in vse starejšinstvo; od katerih sem prejel tudi pisem do bratov v Damasku in sem tja šel, da bi pripeljal tudi tiste, ki so tam bili, zvezane v Jeruzalem, da bi jih kaznovali.',
        ...
        12: 'Neki Ananija pa, mož pobožen po postavi, ki ima dobro pričevanje od vseh Judov, ki tam prebivajo,',
        ...
        20: 'in ko se je prelivala kri Štefana, pričevalca tvojega, sem tudi jaz stal zraven in sem se ž njimi veselil smrti njegove ter varoval oblačila tistih, ki so ga pobijali.',
        ...
        27: 'Pristopi pa tisočnik in mu reče: Povej mi, če si ti Rimljan? On pa reče: Sem.',
    ...
    23: {
        ...
        6: 'Vedoč pa, da jih je nekaj saducejev, nekaj pa farizejev, zavpije Pavel v velikem zboru: Bratje, jaz sem farizej, sin farizejev; zavoljo upanja in vstajenja od mrtvih sem na sodbi.',
        ...
        9: 'In nastane velik krik; in nekateri pismarji od strani farizejske vstanejo, se prepirajo in reko: Nič hudega ne vidimo na tem človeku; kako pa, če mu je duh govoril ali angel?',
        ...
        13: 'Bilo jih je pa več nego štirideset, ki so sklenili tako zaroto.',
        14: 'Ti pristopijo k višjim duhovnikom in starejšinam in reko: S prisego smo se zakleli, da ne okusimo ničesar, dokler ne ubijemo Pavla.',
        15: 'Sedaj torej vi z velikim zborom naznanite tisočniku, naj ga jutri pripelje doli k vam, kakor da bi hoteli natančneje preiskati njegovo zadevo; a mi smo pripravljeni, da ga ubijemo, preden se približa.',
        16: 'Slišal je pa o tem zalezovanju sin sestre Pavlove, ter pride in stopi v grad in sporoči Pavlu.',
        17: 'Pavel pa pokliče enega od stotnikov in reče: Tega mladeniča odpelji k tisočniku, ima mu namreč nekaj sporočiti.',
        18: 'On ga torej vzame in pripelje k tisočniku ter reče: Jetnik Pavel me je poklical in prosil, naj tega mladeniča popeljem k tebi, ki ima nekaj govoriti s teboj.',
        19: 'In tisočnik ga prime za roko in odstopi ž njim na stran in vpraša: Kaj je, kar imaš povedati?',
        20: 'In reče: Judje so se dogovorili, da te poprosijo, da bi jutri pripeljal Pavla v veliki zbor, kakor da bi hotel kaj natančnejšega izprašati zanj.',
        21: 'Ti jih pa ne poslušaj: zalezuje ga namreč izmed njih več nego štirideset mož, ki so se zarotili, da ne bodo ne jedli, ne pili, dokler ga ne umore; in sedaj so pripravljeni in čakajo obljube tvoje.',
        22: 'Tedaj tisočnik odpusti mladeniča, naročivši mu: Naj nikomur ne poveš, da si mi to naznanil.',
        ...
        25: 'In napiše pismo, ki se je takole glasilo:',
        26: 'Klavdij Lizija pozdravlja častitega namestnika Feliksa.',
        27: 'Tega moža so Judje zgrabili in ga hoteli umoriti; ali prišel sem z vojsko in ga otel, ko sem zvedel, da je Rimljan.',
        28: 'Hoteč pa zvedeti vzrok, zakaj ga tožijo, sem ga peljal v njih veliki zbor;',
        29: 'in našel sem, da ga tožijo za vprašanja svoje postave, da pa nima nobene krivice, za katero bi bil vreden smrti ali spon.',
        30: 'Ko se mi je pa naznanil naklep, ki so ga kovali zoper tega moža, sem ga poslal zdajci k tebi, sporočivši tudi tožnikom, naj pred teboj povedo, kar imajo zoper njega. Zdrav!',
        ...
        34: 'Ko pa prebere pismo, ga vpraša, iz katere pokrajine je, in zvedevši, da je iz Cilicije,',
        35: 'reče: Zaslišal te bom, kadar pridejo tudi tožniki tvoji. In ukaže, naj ga varujejo v dvorcu Herodovem.',
    },
    24: {
        1: 'Čez pet dni pa pride doli veliki duhovnik Ananija z nekaterimi starejšinami in z nekim govornikom Tertulom; ti pridejo pred namestnika s tožbo zoper Pavla.',
        ...
        14: 'To ti pa priznavam, da po poti, ki jo imenujejo krivoverstvo, tako služim Bogu naših očetov, da verujem vse, kar je pisano v postavi in v prorokih,',
        ...
        18: 'pri tem so me našli očiščenega v templju, ne z množico, ne s hrupom: bili so pa to neki Judje iz Azije,',
        19: 'ki bi morali tu pred teboj stati in tožiti, če imajo kaj zoper mene.',
        ...
        26: 'Zraven se je pa tudi nadejal, da mu Pavel da denarja, zato ga je tudi pogosteje klical k sebi in se ž njim razgovarjal.',
    ...
    25: {
        ...
        3: 'zahtevajoč to milost zoper njega, da bi ga poslal v Jeruzalem; in so zalezovali, da bi ga umorili na poti.',
        4: 'Toda Fest odgovori, da Pavla varujejo v Cezareji, in da pojde on sam kmalu zopet tja.',
        5: 'Kateri so torej med vami pooblaščenci, reče, naj gredo z menoj, in če je kaj nepristojnega na tem možu, naj ga tožijo.',
        6: 'In ko je prebil med njimi ne več kakor osem ali deset dni, odide v Cezarejo; in drugi dan sede na sodni stol in ukaže Pavla pripeljati.',
        7: 'Ko ga pa pripeljejo, ga obstopijo Judje, ki so prišli iz Jeruzalema, in izrekajo zoper njega mnoge in hude dolžitve, ki jih ne morejo dokazati,',
        8: 'ko se Pavel zagovarja: Nič se nisem pregrešil zoper postavo Judov, ne zoper tempelj, ne zoper cesarja.',
        ...
        10: 'Pavel pa reče: Pred cesarjevim sodnim stolom stojim, kjer moram biti sojen. Judom nisem storil ničesar krivega, kakor tudi sam prav dobro veš.',
        ...
        12: 'Tedaj se Fest pogovori s svetovalstvom in odgovori: Na cesarja si se sklical, k cesarju pojdeš.',
        13: 'Ko je pa minilo nekoliko dni, prideta Agripa kralj in Bernika v Cezarejo pozdravljat Festa.',
        14: 'Ko sta se pa več dni tam mudila, razloži Fest kralju Pavlovo zadevo, rekoč:',
        15: 'Nekega moža je pustil Feliks v ječi, ki so ga, ko sem bil v Jeruzalemu, prišli tožit višji duhovniki in starejšine Judov, zahtevajoč, naj ga obsodim.',
        16: 'Tem sem odgovoril, da ni navada pri Rimljanih, da bi se izdal kak človek na smrt, dokler obtoženec nima tožnikov pred licem in se mu ne da priložnost, zagovarjati se zoper obtožbo.',
        17: 'Ko so se torej tukaj sešli, sem sedel brez vsega odlašanja drugi dan na sodni stol in ukazal moža pripeljati.',
        18: 'Njegovi tožniki pa, ko so nastopili, mu niso očitali nobene take krivice, kakršne sem pričakoval jaz,',
        19: 'ampak neka sporna vprašanja o svojem bogočastju so imeli zoper njega in o nekem Jezusu, ki je umrl in je Pavel o njem trdil, da živi.',
        ...
        25: 'Jaz pa sem spoznal, da ni storil nič smrti vrednega; ker se je pa on sam sklical na cesarja, sem ga sklenil tja poslati.',
        26: 'A nimam nič gotovega, kar bi za njega pisal gospodarju. Zato sem ga pripeljal pred vas, in zlasti pred tebe, kralj Agripa, da imam, ko se izpraša, kaj pisati.',
    ...
    26: {
        ...
        2: 'Srečnega se štejem, kralj Agripa, da se smem danes pred teboj zagovarjati za vse, česar me Judje dolže,',
        ...
        5: 'ker me poznajo od začetka, če hočejo pričati, da sem živel po najostrejši ločini bogoslužja našega kot farizej.',
        ...
        9: 'Tudi jaz sem sicer menil, da moram zoper ime Jezusa Nazarečana storiti veliko nasprotnega.',
        ...
        14: 'In ko smo vsi popadali na zemljo, sem slišal glas, da mi pravi v hebrejskem jeziku: Savel, Savel, kaj me preganjaš? Težko ti je proti ostnu brcati.',
        ...
        18: 'da jim odpreš oči, da se izpreobrnejo od teme k luči in od oblasti satanove k Bogu: da prejmo odpuščenje grehov in delež med posvečenimi po veri, ki je v mene.',
        ...
        22: 'Ali dobivši pomoč, ki je od Boga, stojim do današnjega dne in pričujem malim in velikim, ne govoreč ničesar drugega, nego kar so govorili proroki in Mojzes, da se bo zgodilo,',
        23: 'namreč, da mora Kristus trpeti in kot prvi iz vstajenja mrtvih luč oznanjevati temu narodu in poganom.',
        24: 'Ko se pa tako zagovarja, reče Fest z močnim glasom: Meša se ti, Pavel! Velika učenost tvoja ti jemlje um.',
        25: 'Pavel pa reče: Ne meša se mi, vrli Fest, temuč besede resnice in razumnosti govorim.',
        ...
        27: 'Veruješ, kralj Agripa, prorokom? Vem, da veruješ.',
        28: 'Agripa pa reče Pavlu: Malo, pa me boš pregovoril, da postanem kristjan.',
        ...
        30: 'In vstanejo kralj in namestnik in Bernika in kateri so ž njim sedeli,',
    ...
    27: {
        ...
        5: 'In ko smo prepluli morje, ki je poleg Cilicije in Pamfilije, smo pripli v Miro v Liciji.',
        ...
        14: 'Toda nedolgo potem zaveje od otoka hud veter, ki se imenuje vzhodni sever.',
        ...
        20: 'Ko se pa ne solnce, ne zvezde niso pokazale več dni in je silna burja na nas pritiskala, je že izginilo vse upanje, da bi se oteli.',
        ...
        27: 'Ko je pa štirinajsta noč prišla in so nas valovi semterja gnali po Jadranskem morju, se je zdelo mornarjem okoli polnoči, da se bližajo neki zemlji.',
    ...
    28: {
        ...
        11: 'A po treh mesecih smo se odpeljali na aleksandrijski ladji, ki je bila prezimila na otoku in je imela znamenje Dvojčkov.',
        ...
        16: 'Ko smo pa prišli v Rim, [je izročil stotnik jetnike poveljniku cesarske straže, a] Pavlu se je dovolilo prebivati, kjer sam hoče, z vojakom, ki ga je varoval.',
        17: 'Zgodi se pa po treh dneh, da skliče Pavel prvake Judov. In ko so se sešli, jim je rekel: Možje bratje! dasi jaz ničesar nisem storil zoper naše ljudstvo ali šege očetovske, vendar so me zvezanega iz Jeruzalema izdali v roke Rimljanom.',
        18: 'Ti so me, ko so me bili zaslišali, hoteli izpustiti, zato ker ni bilo nobene smrtne krivice na meni.',
        19: 'Ko so pa Judje ugovarjali, sem bil prisiljen, sklicati se na cesarja, ne kakor da bi imel narod svoj za kaj tožiti.',
        20: 'Zavoljo tega razloga torej sem vas poklical, da bi vas videl in z vami govoril; zakaj zaradi upanja Izraelovega sem vkovan v to verigo.',
        21: 'Oni mu pa reko: Mi nismo ne pisem zastran tebe prejeli iz Judeje in tudi nobeden izmed bratov ni prišel, da bi sporočil ali govoril kaj hudega o tebi.',
        22: 'Želimo pa slišati od tebe, kaj misliš; kajti za to ločino nam je znano, da ji povsod ugovarjajo.',
        23: 'In ko so mu odločili dan, jih je mnogo prišlo k njemu v stanovanje; in jim je razlagal vse ter pričeval o kraljestvu Božjem in jim služil k veri v to, kar se tiče Jezusa, iz postave Mojzesove in prorokov, od zore do mraka.',
        24: 'In nekateri so verovali temu, kar jim je pravil, a nekateri niso verovali.',
        25: 'In ker niso bili složni med seboj, so odhajali, ko je rekel Pavel to eno besedo: Dobro je povedal sveti Duh po Izaiju proroku očetom vašim,',
        26: 'rekoč: „Pojdi k temu ljudstvu in reci: S sluhom boste slišali, a ne boste umeli, in z očmi boste gledali, a ne boste videli.',
        27: 'Kajti okamenelo je srce temu ljudstvu, in z ušesi težko slišijo, in oči so si zatisnili: da ne bi kako z očmi videli in z ušesi slišali in s srcem umeli in se spreobrnili, ter bi jih ozdravil“.',
        28: 'Bodi vam torej znano, da je poganom poslano to zveličanje Božje; oni bodo tudi poslušali. [',
        ...
        31: 'oznanjujoč kraljestvo Božje in učeč to, kar je Gospoda Jezusa Kristusa, z vso srčnostjo, in nihče mu ni branil.',
    },
}
