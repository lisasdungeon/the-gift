...
CHAPTERS = {
    1: {
        ...
        4: 'brez kakršnega koli madeža, lepe postave in dovzetnih za pouk v vsej modrosti, bistre pameti in obdarovanih z razumnostjo in sposobnih, da stoje v palači kraljevi ter da bi jih učili pismenstva in jezika Kaldejcev.',
        5: 'In kralj jim je določil vsakdanji obrok kraljevih jedil in vina, ki ga je sam pil, in da jih tako vzgajajo tri leta, in potem naj bi stali pred kraljem.',
        6: 'Bili so pa med njimi, iz sinov Judovih: Daniel, Hananija, Misael in Azarija.',
        ...
        13: 'Potem naj ogledajo obraze naše vpričo tebe in obraze mladeničev, ki jedo kraljevo jed, in kakor boš videl, tako stóri s hlapci svojimi.',
        14: 'Poslušal jih je torej v tej reči in naredil poskušnjo ž njimi deset dni.',
        ...
        19: 'In kralj je govoril ž njimi; a med njimi vsemi ni bilo nobenega kakor Daniel, Hananija, Misael in Azarija; zato so stali v službi pred kraljem.',
        20: 'In v vsaki stvari modrosti in razumnosti, za katero jih je vprašal kralj, jih je našel desekrat boljše nego vse pismouke in rotilce, ki so bili po vsej državi njegovi.',
    ...
    2: {
        ...
        10: 'Kaldejci odgovore pred kraljem in reko: Ni človeka na zemlji, ki bi mogel razodeti stvar kraljevo; kajti noben kralj, še tako velik in mogočen, ni nikdar zahteval take stvari od katerega koli pismouka ali rotilca ali Kaldejca.',
        ...
        17: 'Potem gre Daniel v hišo in razloži stvar tovarišem svojim Hananiju, Misaelu in Azariju:',
        ...
        19: 'Nato je bila Danielu v ponočni prikazni razodeta tista skrivnost. In Daniel je hvalil Boga nebes.',
        20: 'Daniel izpregovori in reče: Hvaljeno bodi ime Božje od vekomaj do vekomaj! Zakaj njegova je modrost in moč;',
        21: 'in on izpreminja čase in ure, on odstavlja kralje in postavlja kralje, modrost daje modrim in razumnim razumnost,',
        22: 'razodeva globoke in skrite stvari; on ve, kar je v temi, in pri njem je zgolj svetloba.',
        ...
        24: 'Zategadelj je šel Daniel noter k Ariohu, ki ga je bil kralj postavil, da pomori babilonske modrijane; vstopi in mu reče takole: Ne móri modrijanov babilonskih; pelji me pred kralja, in oznanim kralju razlago.',
        ...
        28: 'Ali Bog je v nebesih, ki razodeva skrivnosti, in on je oznanil kralju Nebukadnezarju, kar se zgodi v poslednjih dneh. Tvoje sanje in prikazni tvoje glave na ležišču tvojem so bile te:',
        ...
        30: 'Kar se pa tiče mene, ta skrivnost se mi ni razodela vsled modrosti, ki bi v meni bila mimo vseh živečih, temuč zategadelj, da se kralju oznani razlaga in ti zveš srca svojega misli.',
        ...
        38: 'in kjerkoli bivajo sinovi človeški, poljske zveri in ptice nebeške, tebi jih je dal v roko in tebe postavil za vladarja njim vsem – ti si tista glava iz zlata.',
        39: 'A za teboj nastopi drugo kraljestvo, slabše od tvojega, in potem tretje kraljestvo iz brona, ki bo gospodovalo vsej zemlji.',
        ...
        44: 'A v dneh teh kraljev ustanovi Bog nebes kraljestvo, ki vekomaj ne bo razdejano in njegovo gospostvo se ne prepusti nobenemu drugemu ljudstvu; vsa ona kraljestva pa zdrobi in uniči, a samo bo stalo na veke:',
        ...
        47: 'Kralj odgovori Danielu in reče: V resnici vaš Bog je Bog bogov in kraljem Gospod in razodevalec skrivnosti, ker si mogel razodeti to skrivnost.',
        48: 'Potem je poveličal kralj Daniela in mu dal mnogo velikih darov ter ga postavil za vladarja nad vso pokrajino Babilonsko in za prvega načelnika vsem modrijanom v Babilonu.',
        49: 'Daniel pa je prosil kralja, in ta je poveril poslovodstvo pokrajine Babilonske Sadrahu, Mesahu in Abednegu; a Daniel je bil na dvoru kraljevem.',
    },
    3: {
        ...
        10: 'Ti si, o kralj, izdal povelje, naj vsak, kdor zasliši glas roga, piščali, citer, sambuke, strun, soglasnic in katere koli godbe, pade in moli podobo zlato;',
        ...
        13: 'Tedaj zapove Nebukadnezar, srdit in togoten, naj privedejo k njemu Sadraha, Mesaha in Abednega. In pripeljejo te može pred kralja.',
        ...
        15: 'Sedaj pa, ako ste pripravljeni, kadar zaslišite glas roga, piščali, citer, sambuke, strun, soglasnic in vsaktere godbe, da padete in molite podobo, ki sem jo napravil, dobro; ako pa je ne boste molili, zdajci boste vrženi v gorečo, razbeljeno peč. In kdo je tisti bog, ki vas otme iz roke moje?',
        ...
        18: 'bodisi da ne, znano bodi tebi, kralj, da ne bomo služili bogovom tvojim in podobe zlate, ki si jo postavil, ne bomo molili!',
    ...
    4: {
        1: 'Nebukadnezar kralj vsem ljudstvom, narodom in jezikom, ki prebivajo po vsej zemlji: Mir naj se vam pomnoži!',
        2: 'Vzvidelo se mi je, da oznanjam znamenja in čudeže, ki jih je Bog najvišji storil pri meni.',
        3: 'Kako velika so znamenja njegova in čudeži njegovi kako mogočni! Kraljestvo njegovo je kraljestvo večno in gospostvo njegovo od roda do roda!',
        4: 'Jaz Nebukadnezar, ko sem pokojno živel v hiši svoji in srečo užival v palači svoji,',
        5: 'sem videl sanje, ki so me prestrašile; in premišljevanje na ležišču mojem in prikazni glave moje so me plašile.',
        6: 'Zato sem dal povelje, naj privedejo predme vse modrijane babilonske, da bi mi oznanili tistih sanj razlago.',
        7: 'Pridejo torej pismouki, rotilci, Kaldejci in vedeževalci, in jim povem sanje; ali niso mi oznanili njih razlage.',
        8: 'Nazadnje pa stopi predme Daniel, ki mu je bilo ime Beltsazar po imenu boga mojega in v katerem je duh svetih bogov; in njemu povem sanje, rekoč:',
        9: 'Beltsazar, višji pismoukov, ker vem, da je v tebi svetih bogov duh ter da ti nobena skrivnost ni pretežka, povej mi prikazni mojih sanj, ki sem jih videl, in njih razlago!',
        10: 'Prikazni glave moje na ležišču mojem pa so bile te: Videl sem, in glej: drevo stoji sredi zemlje, in višina njegova ogromna.',
        11: 'Drevo je postalo veliko in močno in visokost njegova je segala do neba, in bilo ga je videti do konca vse zemlje.',
        12: 'Listje njegovo je bilo lepo in sad njegov obilen in živeža je bilo na njem dosti za vse; poljske zveri so imele senco pod njim in ptice nebeške so gnezdile na njegovih vejah in ž njim se je živilo sleherno meso.',
        13: 'Videl sem v prikaznih glave svoje na ležišču svojem, in glej: varuh in svetnik stopi doli z neba,',
        14: 'glasno vpije in tako veli: Posekajte drevo in mu porežite veje, posmukajte mu listje ter raztresite sad njegov! Zveri naj zbežé izpod njega in ptiči z vej njegovih!',
        15: 'Toda panj njegov s koreninami pustite v zemlji, to pa v okovih železnih in bronastih, v travi na polju; in rosa nebeška naj ga moči in z zvermi mu bodi delež v travi zemeljski.',
        16: 'Človeško srce njegovo bodi izpremenjeno in dá naj se mu zverinsko srce; in sedem časov naj mine nad njim.',
        17: 'Po sklepu varuhov je to poročilo in povelje svetih je ta beseda, da bi spoznali živeči, da vlada Najvišji v kraljestvu človeškem ter ga dá, komur hoče, in more najnižjega izmed ljudi postaviti nad njim.',
        18: 'Te sanje sem videl jaz Nebukadnezar kralj; ti pa, Beltsazar, povej njih razlago, ker mi jih ne morejo razložiti vsi modrijani kraljestva mojega; ali ti moreš, ker v tebi je svetih bogov duh.',
        19: 'Tedaj postoji Daniel, ki mu je ime Beltsazar, strmeč skoraj eno uro, in misli njegove ga plašijo. Kralj izpregovori in reče: Beltsazar, ne plašijo naj te sanje in njih razlaga! Beltsazar odgovori in reče: Gospod moj, da bi veljale sanje tvojim sovražilcem in neprijateljem tvojim njih razlaga!',
        20: 'Drevo, ki si ga videl, da je postalo veliko in močno in visokost njegova je segala do neba in ga je bilo videti po vesoljni zemlji',
        21: 'in listje njegovo je bilo lepo in sad njegov obilen in živeža na njem dosti za vse, pod katerim so bivale poljske zveri in na njegovih vejah so gnezdile ptice nebeške:',
        22: 'to si ti, o kralj, ki si postal velik in mogočen; kajti tvoja velikost je vzrasla in sega do neba in gospostvo tvoje do konca zemlje.',
        23: 'A da je videl kralj varuha in svetnika, da je stopil z neba in velel: Posekajte drevo in ga izničite, toda panj njegov s koreninami pustite v zemlji, to pa v okovih železnih in bronastih, v travi na polju, in rosa nebeška naj ga moči in z zvermi poljskimi mu bodi delež, dokler ne mine sedem časov nad njim –',
        24: 'to je razlaga, o kralj, in to je sklep Najvišjega, ki pride nad gospoda mojega, kralja:',
        25: 'Pahnejo te ven izmed ljudi in pri zverini poljski bode bivališče tvoje, in travo ti bodo dajali jesti kakor volom in rosa nebeška te bo močila, in sedem časov mine nad teboj, dokler ne spoznaš, da vlada Najvišji v kraljestvu človeškem ter ga dá, komur hoče.',
        26: 'In da so veleli, naj ostane drevesu panj s koreninami, pomeni, da ti bode kraljestvo zopet utrjeno, brž ko spoznaš, da vladajo nebesa.',
        27: 'Zatorej ti bodi, o kralj, ugoden svet moj, da pretrgaj grehe svoje s pravičnostjo in krivice svoje z usmiljenostjo do ubogih, da se podaljša blagostanje tvoje.',
        28: 'Vse to je prišlo nad kralja Nebukadnezarja.',
        29: 'Ob koncu dvanajstih mesecev se je izprehajal po kraljevem dvoru v Babilonu.',
        30: 'In je izpregovoril ter rekel: Ni li to veliki Babilon, ki sem ga zgradil za kraljevsko prebivališče z močjo mogočnosti svoje in v čast slave svoje?',
        31: 'Še je bila tista beseda v ustih kraljevih, pa pride glas z neba: Tebi, o kralj Nebukadnezar, se pravi: Kraljestvo ti je odvzeto!',
        32: 'In spode te izmed ljudi in pri zverini poljski bode bivališče tvoje, travo ti bodo dajali jesti kakor volom in sedem časov mine nad teboj, dokler ne spoznaš, da vlada Najvišji v kraljestvu človeškem ter ga dá, komur hoče.',
        33: 'To uro se je izpolnila ta beseda pri Nebukadnezarju: bil je vržen izmed ljudi, in jedel je travo kakor voli in telo njegovo se je močilo z roso nebeško, da so mu lasje zrasli kakor orlom perje in nohti kakor ptičji kremplji.',
        34: 'Ob koncu tistih dni pa sem povzdignil jaz Nebukadnezar oči proti nebesom, in razum moj se mi je povrnil; in hvalil sem Najvišjega in slavil sem in poveličeval njega, ki večno živi, čigar gospostvo je večno gospostvo in kraljestvo njegovo od roda do roda.',
        35: 'In vse prebivalce zemlje je šteti za nič, in po volji svoji ravna z vojsko nebeško in s prebivalci zemlje, in nikogar ni, ki more njegovi roki braniti in mu reči: Kaj delaš?',
        36: 'V tistem času se mi je povrnil razum moj in v čast mojega kraljestva se mi je povrnila slava moja in svetlost; in moji svetovalci in mogočneži so me iskali, in bil sem zopet postavljen v kraljestvo svoje in posebna velikost mi je bila pridejana.',
        37: 'Sedaj jaz Nebukadnezar slavim, povišujem in poveličujem Kralja nebes, zakaj vsa dela njegova so resnica in pota njegova pravica; in tiste, ki žive prevzetno, zna on ponižati.',
    },
    5: {
        ...
        31: 'In Darij Medec je dobil kraljestvo, ko je bil blizu dvainšestdeset let star.',
    },
    6: {
        ...
        27: 'on rešuje in otimlje ter dela znamenja in čudeže na nebu in na zemlji: ta je otel Daniela iz oblasti levov.',
    ...
    8: {
        ...
        26: 'In prikazen o večerih in jutrih, o kateri se je govorilo, je resnica; ti pa hrani na skrivnem to prikazen, ker še je mnogo dni dotlej.',
    ...
    9: {
        ...
        2: 'v prvem letu kraljevanja njegovega sem jaz Daniel obrnil pozornost v pismih na število let, o katerih se je zgodila beseda Gospodova Jeremiju proroku, da se ima dopolniti razvalinam Jeruzalema sedemdeset let.',
        3: 'In obrnil sem obličje h Gospodu Bogu, da bi ga iskal z molitvijo in s prošnjami, ob postu, raševniku in pepelu.',
        ...
        6: 'In nismo poslušali služabnikov tvojih, prorokov, ki so v tvojem imenu govorili kraljem našim, knezom in očetom našim in vsemu ljudstvu dežele.',
        ...
        10: 'in nismo poslušali glasu Gospoda, Boga svojega, da bi hodili po postavah njegovih, ki nam jih je del pred oči po hlapcih svojih, prorokih.',
        11: 'Ampak ves Izrael je prestopil postavo tvojo in se odvrnil, da ni poslušal tvojega glasu. Zato se je razlilo na nas prokletstvo in prisega, ki je zapisana v zakonu Mojzesa, hlapca Božjega, ker smo grešili zoper njega.',
        ...
        21: 'ko sem še govoril v molitvi, prileti hitro mož Gabriel, ki sem ga bil videl v prikazni v začetku, in se me dotakne v času večerne daritve.',
        ...
        24: 'Sedemdeset tednov je odločenih nad ljudstvom tvojim in nad svetim mestom tvojim, da preneha odpad in se naredi konec grehom ter da se stori poravnava za krivico in se privede večna pravičnost in se zapečati prikazen in proroštvo in da se pomazili Najsvetejše.',
        ...
        27: 'In trdno zavezo sklene z mnogimi za en teden in sredi tedna stori, da neha klalna in jedilna daritev. In na perutih gnusob pride pustošnik; in do pokončanja, trdno določenega, se izlije jeza nad pustošnika.',
    },
    10: {
        ...
        17: 'Kajti kako more tega mojega gospoda hlapec govoriti s tem mojim gospodom? In odsedaj ni nič več moči v meni in sape mi ni ostalo.',
        18: 'Tedaj se me zopet dotakne nekdo, ki je bil videti kakor človek, in me pokrepča.',
        19: 'In veli: Ne boj se, mož dragi in ljubljeni! mir tebi, bodi močan, bodi, pravim, močan! In ko mi je govoril, sem bil pokrepčan in sem dejal: Govóri, gospod moj, kajti pokrepčal si me.',
    ...
    11: {
        ...
        4: 'In kakor vstane hitro, se razdrobi kraljestvo njegovo in se razdeli na štiri vetrove neba. A ne bode za potomce njegove in ne ostane v taki moči, s kakršno je on gospodoval; kajti kraljestvo njegovo bo raztrgano in da dobé drugi, mimo teh.',
        ...
        8: 'in odpelje tudi njih bogove z ulitimi njih podobami in ž njih dragimi posodami iz srebra in zlata v ujetništvo v Egipt; in bo vztrajal dosti let pred kraljem na severu.',
        ...
        11: 'In južni kralj se razkači in pride in se bo bojeval ž njim, kraljem na severu; in ta postavi v boj veliko množico, ali množica bo dana v roke južnemu kralju.',
        ...
        17: 'In obličje nameri v to, da pride z močjo vsega kraljestva svojega in stori ž njim poravnavo; in dá mu hčer žená, da jo pogubi; a ona se ne vzdrži in nič mu ne bo koristila.',
        ...
        23: 'Kajti odkar se je zavezal ž njim, bo ravnal prekanljivo, in pojde gori in si pridobi moč z neznatnim ljudstvom.',
        ...
        28: 'In vrne se severni kralj v deželo svojo z obilnim blagom, in srce njegovo bode zoper sveto zavezo, in delal bo po svoji volji in se vrnil v deželo svojo.',
        ...
        37: 'Tudi ne bo čislal boga očetov svojih, tudi se ne oziral po hrepenenju žen, ne po kateremsibodi bogu, temuč sam se bo poveličeval nad vse.',
        ...
        45: 'In postavi šatore svoje palače med morjem in goro svete dike. In dospe do svojega konca, in nihče mu ne pomore.',
    },
    12: {
        ...
        10: 'Mnogi se bodo čistili in belili in precejali, a brezbožni bodo brezbožno delali; nobeden brezbožni pa ne bo umel, ali razumni bodo umeli.',
        ...
        12: 'Blagor mu, kdor bo čakal in dosegel tisoč tristo petintrideset dni.',
