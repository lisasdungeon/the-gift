...
CHAPTERS = {
    ...
    3: {
        ...
        3: 'ali za sad tistega drevesa, ki je sredi vrta, je rekel Bog: Ne jejta od njega, tudi se ga ne doteknita, da ne umreta.',
        ...
        6: 'In žena je videla, da je dobro tisto drevo za jed in da je veselje očem in da je zaželeti to drevo, ker dodeli spoznanje; vzela je torej od sadu njegovega ter jedla; in dala je tudi možu svojemu, ki je bil ž njo, in jedel je.',
        ...
        14: 'In Gospod Bog reče kači: Ker si storila to, prokleta bodi pred vsemi živalmi in pred vsemi zvermi poljskimi; po trebuhu svojem hodi in prah jej vse dni svojega življenja.',
        15: 'In sovraštvo stavim med tebe in ženo, in med seme tvoje in njeno seme: to ti stare glavo, ti pa mu stareš peto.',
        16: 'Ženi reče: Jako pomnožim bolečino tvojo in nosečnosti tvoje težave, v bolečini bodeš rodila otroke, in po možu tvojem bodi poželenje tvoje, in on ti gospoduj.',
        17: 'Adamu pa reče: Ker si poslušal žene svoje glas in si jedel od drevesa, za katero sem ti zapovedal, rekoč: Ne jej od njega – prokleta bodi zemlja zaradi tebe: s trudom se živi od nje vse dni svojega življenja;',
        ...
        20: 'In Adam je dal ime ženi svoji Eva, zato ker je ona mati vseh živečih.',
        21: 'In Gospod Bog naredi Adamu in ženi njegovi suknji iz kož, in ju je oblekel.',
        22: 'In veli Gospod Bog: Glej, človek je postal kako eden izmed nas, v kolikor ve, kaj je dobro in hudo. Sedaj pa, da ne iztegne roke svoje ter ne vzame tudi od drevesa življenja, in bi jedel in živel vekomaj –',
    ...
    6: {
        ...
        2: 'da so videli sinovi Božji hčere človeške, da so lepe, in so si jemali od vsakršnih žene, katerekoli so si izbrali.',
        ...
        4: 'Velikani so bili na zemlji tiste dni in tudi pozneje, ko so se sinovi Božji shajali s hčerami človeškimi in so jim rodile. To so tisti junaki, ki so bili v starodavnem času, možje preslavni.',
        ...
        8: 'Ali Noe je našel milost v očeh Gospodovih.',
        ...
        11: 'In zemlja je bila popačena pred obličjem Božjim, in zemlja je bila napolnjena s silovitostjo.',
        12: 'In Bog je videl zemljo, in glej, popačena je bila, kajti vse meso je popačilo pot svojo na zemlji.',
        13: 'In reče Bog Noetu: Konec vsega mesa se je približal predme, zakaj zemlja je polna silovitosti od njih; zato, glej, pokončal jih bom z zemljo vred.',
        ...
        16: 'Napravi ladji odprtino za luč, ki naj seže do komolca od vrha, in vrata ladji umesti na strani njeni, s spodnjim, drugim in tretjim nadstropjem jo naredi.',
        17: 'In jaz, glej, pošljem potop, vode čez zemljo, pogubit vse meso, v katerem je dih življenja pod nebom; karkoli je na zemlji, pogine.',
        18: 'S teboj pa ustanovim zavezo svojo, in pojdeš v ladjo, ti in sinovi tvoji in žena tvoja in žene sinov tvojih s teboj.',
        19: 'In od vsega, kar živi, od vsakršnega mesa, od vsega po dvoje vzemi v ladjo, da jih pri življenju ohraniš s seboj: samec in samica naj bodo.',
        20: 'Izmed ptic po njih plemenih in izmed živine po plemenih njenih, izmed vse laznine zemeljske po vrstah njenih, izmed vseh po dvoje naj pride k tebi, da jih ohraniš pri življenju.',
    ...
    7: {
        ...
        5: 'In Noe stori vse, kakor mu je zapovedal Gospod.',
        6: 'Noe pa je imel šeststo let, ko je bil tisti potop in so vode stopile čez zemljo.',
        7: 'In Noe vstopi in sinovi njegovi in žena njegova in žene sinov njegovih ž njim v ladjo, pred vodami potopa.',
        ...
        13: 'Prav tisti dan je šel Noe in Sem in Ham in Jafet, sinovi Noetovi, in žena Noetova in tri žene sinov njegovih ž njimi v ladjo,',
        ...
        21: 'Poginilo je torej vse meso, ki se je gibalo na zemlji, kar je bilo ptic in živali in zveri in vse laznine, ki je lazila po zemlji, in vsak človek:',
        22: 'vse, kar je imelo v nosnicah dih duha življenja, vse, kar je bilo na suhem, je pomrlo.',
        23: 'In pokončal je sleherno živo bitje, ki je bilo na površju zemlje: ljudi in živali, laznino in ptice neba, in pokončani so bili z zemlje; in pri življenju je ostal samo Noe in kar je bilo ž njim v ladji.',
        24: 'Kipele pa so vode nad zemljo sto petdeset dni.',
    },
    8: {
    ...
    9: {
        1: 'Nato blagoslovi Bog Noeta in sinove njegove ter jim reče: Rodovitni bodite in množite se ter napolnite zemljo.',
        2: 'In strah do vas in trepet pred vami obhajaj vse živali na zemlji in vse ptice pod nebom; vse, karkoli se giblje na suhem, in vse ribe v morju so vam dane v pest.',
        ...
        8: 'In govori Bog Noetu in sinovom njegovim ž njim, rekoč:',
        ...
        15: 'da se spomnim zaveze svoje, ki je med menoj in vami in vsako živo stvarjo od vsakršnega mesa: in ne bode več vodá v potop, v pokončanje vsega mesa.',
        ...
        21: 'in ko pije od vina njegovega, se upijani ter se razodene sredi šatora svojega.',
        22: 'Ham pa, oče Kanaanov, zagleda nagoto očeta svojega ter pove dvema bratoma svojima odzunaj.',
        23: 'Sem pa vzame z Jafetom plašč njegov in ga zadeneta na rame svoje in nazaj obrnjena gresta ter pokrijeta ž njim očeta svojega nagoto; in obličje jima je bilo nazaj obrnjeno, da nista videla očeta svojega nagote.',
        24: 'Ko pa se je prebudil Noe iz vina svojega, zve, kaj mu je bil storil njegov najmlajši sin,',
        25: 'in reče: Proklet bodi Kanaan; hlapcev hlapec bodi bratom svojim!',
        26: 'Še reče: Hvaljen Gospod, Bog Semov, in Kanaan mu bodi hlapec!',
        27: 'Razširi naj Bog Jafeta, in naj prebiva v šatorih Semovih, in Kanaan mu bodi hlapec!',
        28: 'Živel pa je Noe po potopu tristo petdeset let.',
    ...
    12: {
        ...
        2: 'in storil te bom v narod velik in te blagoslovil, in poveličam ime tvoje, in v blagoslov bodi!',
        3: 'In blagoslovil bom nje, ki blagoslavljajo tebe, in kdor te proklinja, njega bom proklel, in blagoslovljene bodo v tebi vse rodovine zemlje.',
        4: 'In Abram se napoti, kakor mu je bil zapovedal Gospod, in Lot je šel ž njim; imel pa je Abram petinsedemdeset let, ko je potoval iz Harana.',
        ...
        6: 'In Abram preide deželo do kraja Sihema, do hrasta Morejevega. Bival je pa tedaj Kanaanec v deželi.',
        ...
        8: 'In napoti se odtod v gorovje proti jutranji strani Betela in postavi šator svoj: Betel mu je bil od zahoda in Aj od vzhoda; in postavi tam oltar Gospodu, in klical je ime Gospodovo.',
        9: 'Potem je potoval Abram dalje v južno stran.',
        10: 'Bila pa je lakota v deželi, zatorej gre Abram doli v Egipt, da bi tujčeval ondi, ker huda lakota je bila v deželi.',
        11: 'In ko je bil že blizu, da pride v Egipt, reče Saraji, ženi svoji: Glej, znam, da si žena lepe postave.',
        12: 'Lahko se zgodi, ko te zagledajo Egipčani in reko: Ta je žena njegova, da me ubijejo, tebe pa ohranijo živo.',
        13: 'Reci, prosim, da si sestra moja, da mi bo dobro zaradi tebe in da bom živel zavoljo tebe.',
        14: 'In zgodi se, ko je prišel Abram v Egipt, da so videli Egipčani ženo, da je silno lepa.',
        15: 'In videli so jo knezi Faraonovi in so jo hvalili pred Faraonom, in žena je bila vzeta v hišo Faraonovo.',
        ...
        18: 'In pokliče Faraon Abrama ter reče: Kaj si mi to storil? Zakaj mi nisi povedal, da je tá žena tvoja?',
    ...
    13: {
        1: 'Šel je torej Abram iz Egipta, on in žena njegova in vse, kar je imel, tudi Lot ž njim, v južno stran.',
        2: 'Bil je pa Abram silno bogat živine, srebra in zlata.',
        3: 'In šel je po svojih potih z južne strani do Betela, tja do kraja, kjer je bil prej šator njegov, med Betelom in Ajem,',
        4: 'do kraja onega oltarja, ki ga je prej ondi naredil; in tam je klical Abram ime Gospodovo.',
        5: 'A tudi Lot, ki je šel z Abramom, je imel črede ovac in goved in šatore.',
        ...
        12: 'Abram je bival v pokrajini Kanaanski, Lot pa je bival v mestih one ravnine in pomikal prav do Sodome šatore svoje.',
        ...
        18: 'Premakne torej Abram šatore ter pride in prebiva pri hrastih Mamrejevih, ki so pri Hebronu, in ondi postavi oltar Gospodu.',
    },
    14: {
        ...
        5: 'In v štirinajstem letu so prišli Kedorlaomer in kralji, ki so bili ž njim, ter so porazili Refaime v Asterot-karnaimu in Zuzime v Hamu in Emime v ravnini pri Kirjataimu',
        6: 'in Horejce na njih gorovju Seiru tja do El-parana, ki je poleg puščave.',
        7: 'In vrnili so se ter prišli v En-mišpat, ki je Kades, in ugonobili so vso poljano Amalekovcev in tudi Amorejce, ki so prebivali v Hazazontamaru.',
        ...
        17: 'In izide kralj sodomski Abramu naproti, ko se je vračal s poboja Kedorlaomerja in tistih kraljev, ki so bili ž njim, v dolino Šave, to je Kraljeva dolina.',
        18: 'Melhizedek pa, kralj v Salemu, prinese kruha in vina; bil je namreč duhovnik Boga mogočnega, Najvišjega.',
        19: 'In blagoslovi ga, govoreč: Blagoslovljen bodi Abram od Boga mogočnega, Najvišjega, Stvarnika nebes in zemlje;',
    ...
    15: {
        ...
        12: 'In ko se je solnce nagibalo, se loti Abrama trdno spanje, in glej, strah in tema velika ga obideta.',
        ...
        17: 'In ko je solnce zatonilo in je bila trda noč, glej: peč kadeča in plamenica goreča, ki gre skozi med onimi deli.',
    ...
    17: {
        ...
        3: 'Tedaj pade Abram na obličje svoje, in Bog je govoril ž njim, rekoč:',
        4: 'Jaz sem, glej, zaveza moja je s teboj, in oče bodeš množici narodov.',
        5: 'In ne bo se več imenovalo ime tvoje Abram, temuč ime tvoje bodi Abraham, zakaj za očeta množici narodov sem te postavil.',
        ...
        10: 'Ta je zaveza moja med menoj in vami in semenom tvojim za teboj, ki naj jo ohranite: Obrezan vam bodi vsak moški.',
        ...
        19: 'A Bog veli: Vendar ti pa Sara, žena tvoja, bo rodila sina, in ga imenuj Izaka; in zavezo svojo ustanovitim ž njim, da bodi večna zaveza semenu njegovemu za njim.',
        ...
        21: 'Zavezo svojo pa ustanovim z Izakom, ki ti ga bo Sara rodila o ravno tem času ob letu.',
        22: 'In nehal se je pogovarjati ž njim in šel je Bog gori od Abrahama.',
        23: 'Tedaj vzame Abraham Izmaela, sina svojega, in vse rojene v hiši svoji in kateregakoli je bil kupil z denarjem svojim: vsakega moškega iz domačih svojih, in še isti dan obreže meso njih kožic, kakor je ž njim Bog govoril.',
        24: 'Imel pa je Abraham devetindevetdeset let, ko je bilo obrezano meso neobreze njegove,',
        25: 'Izmael pa, sin njegov, trinajst let, ko je bilo obrezano meso neobreze njegove.',
        26: 'Ravno tisti dan sta bila obrezana Abraham in Izmael, sin njegov.',
        27: 'In vsi moški hiše njegove, i rojeni doma i kupljeni z denarjem od tujca, so bili obrezani ž njim vred.',
    },
    18: {
        1: 'In prikaže se mu Gospod pri hrastih Mamrejevih, ko je sedel pri vratih šatora svojega ob dnevni vročini.',
        2: 'In povzdigne oči in pogleda, in glej, trije možje se ustavijo pred njim; ko jih zazre, jim priteče naproti od vrat šatora svojega ter se prikloni do tal',
        ...
        5: 'In prinesem grižljaj kruha in okrepčajte srce svoje; potem pojdete dalje; saj zato ste se namerili mimo svojega hlapca. Oni pa reko: Tako stóri, kakor si govoril.',
        6: 'Hitel je torej Abraham v šator k Sari in rekel: Hitro zmesi tri merice bele moke in naredi podpepelnikov!',
        ...
        9: 'Ko so mu pa rekli: Kje je Sara, žena tvoja? reče: Glej, v šatoru.',
        10: 'In reče Gospod: Gotovo se vrnem k tebi, ko zopet pride ta čas, in glej, sina bo imela Sara, žena tvoja. Sara pa je slišala za durmi šatora, ki so bile za njim.',
        ...
        14: 'Je li Gospodu kaka stvar nedosežna? Osorej pridem zopet k tebi, ko se ponovi ta čas, in sina bo imela Sara.',
        15: 'Sara pa je tajila, govoreč: Nisem se smejala, ker se je bala. A ji reče: Nikakor, ampak smejala si se.',
        16: 'Nato so možje vstali odondod ter so gledali proti Sodomi; Abraham pa je šel ž njimi, da bi jih spremil.',
        17: 'Reče pa Gospod: Ali bi naj skrival pred Abrahamom, kar nameravam storiti?',
        18: 'Kajti Abraham bode gotovo naroda velikega in mogočnega oče, in vsi narodi zemlje bodo blagoslovljeni v njem.',
        19: 'Zakaj spoznal sem ga s tem namenom, da bo zapovedal otrokom svojim in rodbini svoji za seboj, naj se drže pota Gospodovega in strežejo pravičnosti in pravu, da bi izpolnil Gospod Abrahamu, kar mu je obljubil.',
        20: 'Reče torej Gospod: Vpitje iz Sodome in Gomore je res veliko in njih greh res silno težak;',
        21: 'zdaj pa pojdem doli in videl bom, ali so docela tako delali, kakor se glasi njih vpitje, ki je prišlo do mene; če pa ne, bom spoznal.',
        22: 'In tedaj sta se obrnila onadva in šla proti Sodomi; Abraham pa je stal še pred Gospodom.',
        23: 'In pristopi Abraham in reče: Boš li tudi pravičnega pokončal s krivičnim?',
        ...
        25: 'Ne bodi tega, da bi kaj takega storil ter v smrt dal pravičnega s krivičnim, da se godi enako pravičnemu kakor krivičnemu. Ne tako! Ali bi vse zemlje Sodnik ne delal po pravici?',
        26: 'In reče Gospod: Ako najdem v Sodomi, sredi mesta, petdeset pravičnih, prizanesem vsemu kraju zaradi njih.',
        27: 'Abraham pa odgovori ter reče: Glej, prosim, drznil sem se govoriti h Gospodu, jaz, ki sem prah in pepel:',
    ...
    19: {
        ...
        6: 'Lot pa izide k njim pred vrata in zapre duri za seboj',
        ...
        12: 'Tedaj rečeta ona moža Lotu: Koga imaš še tu? zeta ali sine svoje ali hčere svoje, ali kogarkoli imaš v tem mestu, glej, da gredo iz tega kraja.',
        13: 'Kajti pokončala bova ta kraj, zato ker je veliko njih vpitje pred obličjem Gospodovim, in poslal naju je Gospod ga pogubit.',
        ...
        15: 'Ko je pa vzhajala zarja, sta priganjala angela Lota, govoreč: Vstani, vzemi ženo svojo in dve hčeri svoji, ki sta pri tebi, da ne pogineš v kazni tega mesta.',
        ...
        17: 'In zgodi se, ko sta jih izpeljala ven, da mu veli: Reši se zaradi duše svoje, ne oziraj se za seboj in ne ustavi se na vseh tej ravnini; otmi se na ono goro, da ne pogineš.',
        18: 'Lot pa jima odgovori: Ah, ne tako, Gospod!',
        19: 'Glej, prosim, hlapec tvoj je našel milost v tvojih očeh in poveličal si milost svojo, ki si mi jo izkazal, ohranivši mi življenje; jaz pa se ne morem oteti na ono goro, da me ne dohiti zlo in ne umrem.',
        ...
        21: 'In mu veli: Glej, ozrl sem se milostno nate tudi v tej stvari, da ne razdenem mesta, za katero si govoril.',
        22: 'Hiti, otmi se tja, zakaj ničesar ne morem storiti, dokler ne dojdeš tja. Zato se imenuje mesto to Zoar.',
        23: 'Solnce je vzhajalo nad zemljo, ko je Lot prihajal v Zoar.',
        24: 'In Gospod je dežil nad Sodomo in Gomoro žveplo in ogenj od Gospoda z neba;',
        25: 'in pokončal je ta mesta in vso ravnino in vse prebivalce tistih mest in kar je raslo na zemlji.',
        26: 'In žena njegova, gredoča za njim, se je ozrla nazaj, in postala je solnat steber.',
        ...
        29: 'Zgodilo se je torej, ko je Bog pokončaval mesta one ravnine, da se je Bog spomnil Abrahama in odpeljal Lota iz propasti, ko je podiral mesta, v katerih je bival Lot.',
        30: 'Lot pa je šel gori iz Zoara in prebival je na gori in dve hčeri njegovi ž njim, kajti bal se je bivati v Zoaru; in bival je v neki jami, on in obe hčeri njegovi.',
        31: 'Reče pa prvenka mlajši: Oče najin je star, in v tej pokrajini ni moža, ki bi se združil z nama po navadi vse zemlje.',
        32: 'Dej, dajva piti svojemu očetu vina in leziva ž njim, da v življenju ohraniva iz svojega očeta seme.',
        ...
        34: 'In drugi dan reče prvenka mlajši: Glej, ležala sem preteklo noč z očetom svojim; dajva mu piti vina tudi nocoj, potem pridi, lezi ž njim, da ohraniva iz očeta svojega seme.',
        35: 'Dali sta torej tudi tisto noč piti vina očetu svojemu; mlajša pa vstane ter je ležala ž njim, in on ni zaznal, ne ko je legla, ne ko je vstala.',
        ...
        38: 'In tudi mlajša je rodila sina in mu je dala ime Ben-ami: on je oče sinov Amonovih do tega dne.',
    },
    20: {
        ...
        6: 'In mu reče Bog v sanjah: Saj jaz vem, da si storil to v nedolžnosti srca svojega, in tudi ubranil sem ti jaz, da nisi grešil zoper mene, zato ti nisem pustil dotekniti se je.',
        7: 'Zdaj torej vrni ženo onemu možu; prorok namreč je, in bo prosil zate, in živel boš; ako pa je ne vrneš, vedi, da vsekakor umreš, ti in vsi tvoji.',
        8: 'Zjutraj torej vstane Abimelek prav zgodaj, in ko je poklical vse hlapce svoje, jim pove vse te besede, da so slišali; in silno so se bali tisti možje.',
        ...
        10: 'Še reče Abimelek Abrahamu: Kaj se ti je zdelo, ko si storil to reč?',
        11: 'Abraham pa reče: Ker sem dejal, da gotovo ni strahu Božjega v tem kraju, zato me bodo umorili zaradi žene moje.',
        12: 'Ali tudi v resnici je sestra moja, očeta mojega hči, a ne hči matere moje; in vzel sem si jo za ženo.',
        ...
        17: 'In Abraham je molil k Bogu, in Bog ozdravi Abimeleka in ženo njegovo in dekle njegove, da so rodile.',
        18: 'Bil je namreč dočista zaprl Gospod vsako maternico v hiši Abimelekovi zaradi Sare, žene Abrahamove.',
    },
    21: {
        1: 'In Gospod je obiskal Saro, kakor je bil rekel, in storil je Gospod Sari, kakor je bil govoril.',
        ...
        6: 'In Sara reče: Smeh mi je napravil Bog; kdorkoli bo slišal, smejal se bo z menoj vred.',
        7: 'Še reče: Kdo bi bil rekel Abrahamu: Dojila bo otroke Sara! in vendar sem porodila sina v starosti njegovi!',
        ...
        10: 'in reče Abrahamu: Spódi to deklo in njenega sina; kajti sin te dekle ne bode dedič s sinom mojim, z Izakom.',
        ...
        17: 'Slišal pa je Bog dečkov jok, in zakliče angel Božji Agari z neba ter ji reče: Kaj ti je, Agara? Ne boj se; zakaj Bog je čul dečkov glas tam, kjer je.',
        ...
        23: 'Zdaj torej mi prisezi pri Bogu tukaj, da se mi ne bodeš lagal, ne sinu mojemu, ne vnuku mojemu, temuč da boš izkazoval enako prijaznost, kakršno sem izkazal jaz tebi, meni in deželi, v kateri gostuješ.',
        ...
        26: 'Abimelek pa reče: Ne vem, kdo je to storil, dá, tudi ti mi nisi povedal, niti jaz nisem slišal o tem, razen danes.',
        27: 'In Abraham vzame čred in goved ter jih da Abimeleku; in obadva skleneta zavezo.',
        28: 'Postavil pa je bil Abraham sedem mladih ovac od črede posebe.',
        29: 'Zato reče Abimelek Abrahamu: Čemu tistih sedem mladih ovac, ki si jih postavil posebe?',
        ...
        33: 'Abraham pa zasadi tamarisko pri Bersebi, in klical je tam ime Gospoda, večnega Boga mogočnega.',
    ...
    22: {
        ...
        4: 'Tretji dan povzdigne Abraham oči in ugleda tisti kraj oddaleč.',
        ...
        7: 'Ogovori pa Izak Abrahama, očeta svojega, in reče: Oče moj! On veli: Tu sem, sin moj! In reče: Glej, ogenj in drva, a kje je jagnje za žgalno daritev?',
        ...
        11: 'Ali angel Gospodov mu zakliče z neba ter reče: Abraham, Abraham! On pa reče: Tu sem!',
        12: 'In veli: Ne iztezaj roke svoje na dečka in nič mu ne stori: kajti sedaj sem spoznal, da se bojiš Boga, ker mi nisi odrekel sinú svojega, edinca svojega.',
        ...
        15: 'In zakliče angel Gospodov Abrahamu vdrugič z neba',
        16: 'in reče: Pri sebi samem prisegam, govori Gospod: Ker si to storil in mi nisi odrekel sinu svojega, edinca svojega,',
        17: 'te bom obiloma blagoslovil in silno pomnožil seme tvoje, kakor zvezde na nebu in kakor pesek ob morskem obrežju, in seme tvoje bo v last imelo vrata sovražnikov svojih;',
        18: 'in blagoslovljeni bodo vsi narodi zemlje v semenu tvojem, ker si poslušal moj glas.',
        ...
        22: 'in Keseda in Hazona in Pildasa in Jidlafa in Betuela.',
        23: 'Betuel pa je rodil Rebeko; teh osem je porodila Milka Nahorju, Abrahamovemu bratu.',
    ...
    23: {
        ...
        8: 'In govoril je ž njimi takole: Če vas je volja, da pokopljem mrliča svojega izpred obličja svojega, poslušajte me ter govorite zame Efronu, sinu Zoharjevemu,',
    ...
    24: {
        ...
        12: 'In reče: O Gospod, Bog Abrahama, gospoda mojega, stóri, prosim, da se mi posreči danes, in izkaži milost gospodu mojemu Abrahamu.',
        ...
        27: 'ter reče: Hvaljen bodi Gospod, Bog gospoda mojega Abrahama, ki ni opustil milosti in zvestobe svoje do gospodarja mojega; mene je spremil Gospod na potu v hišo sorodnikov gospodarja mojega.',
        ...
        30: 'To pa se je zgodilo, ko je videl obodec in zapestnici okoli rok sestre svoje in ko je slišal besede Rebeke, sestre svoje, govoreče: Tako mi je govoril tisti mož. Pride torej k možu, ki je, glej, stal pri velblodih poleg studenca.',
        31: 'In reče: Pridi noter, blagoslovljenec Gospodov, kaj bi stal zunaj? saj sem pripravil hišo, in prostora je velblodom.',
        32: 'In mož pride v hišo. In Laban razpravi velblode ter jim da slame in krme, in vode, da se umijejo noge njegove in noge mož, ki so bili ž njim.',
        33: 'Ali ko so mu postavili, da bi jedel, reče: Jedel ne bom nikakor, dokler ne povem svojih reči. In reče Laban: Govóri!',
        34: 'Tedaj reče: Hlapec sem Abrahamov.',
        35: 'Gospod pa je blagoslovil gospodarja mojega silno, da je postal velik; dal mu je namreč čred in goved, srebra in zlata, hlapcev in dekel, velblodov in oslov.',
        ...
        40: 'mi reče: Gospod, pred čigar obličjem sem vedno hodil, pošlje angela svojega s teboj, in srečno stori tvojo pot, da vzameš ženo sinu mojemu iz rodovine moje in iz hiše očeta mojega.',
        41: 'Tedaj bodeš prost zarotitve moje, ko prideš k rodovini moji; in če ti je ne dado, bodeš oproščen zarotitve moje.',
        42: 'Prišel sem torej danes k studencu in rekel: Gospod, Bog gospoda mojega Abrahama, o, da bi res srečno storil pot mojo, po kateri hodim!',
        ...
        45: 'Še nisem končal govoriti v srcu svojem, ko, glej, izide Rebeka z vrčem svojim na rami in gre doli k studencu in zajme. Rekel pa sem ji: Daj mi piti, prosim.',
        ...
        53: 'In hlapec seže po dragotine srebrne in dragotine zlate ter oblačila in jih izroči Rebeki; enako dá dragocenosti bratu njenemu in materi njeni.',
        54: 'Nato so jedli in pili on in možje, ki so bili ž njim, in so prenočili. Zjutraj pa, ko vstanejo, reče: Pustite me k mojemu gospodu.',
        ...
        61: 'Rebeka pa vstane in dekle njene ter sedejo na velblode, da bi šle z možem. In hlapec vzame Rebeko in odpotuje.',
        ...
        66: 'Tedaj pove hlapec Izaku vse, kar je bil opravil.',
        67: 'In Izak jo pelje v šator Sare, matere svoje, in vzame Rebeko, da mu bode žena, in ljubil jo je. Tako se je Izak potolažil po materi svoji.',
    },
    25: {
    ...
    27: {
        ...
        12: 'Lahko me potiplje oče moj, in zdel se mu bom, kakor da ga zasmehujem, in pripravim nadse prokletstvo, ne pa blagoslova.',
        13: 'Pa mu reče mati njegova: Nadme pridi prokletstvo tvoje, sin moj; le poslušaj glas moj ter pojdi in mi prinesi!',
        ...
        27: 'Pristopil je torej in ga poljubil, in ko on začuti duh oblačil njegovih, ga blagoslovi in reče: Glej, duh sina mojega je kakor duh polja, ki ga je blagoslovil Gospod.',
        28: 'Daj ti torej Bog od rose nebeške in od rodovitnih poljan zemlje ter obilost žita in vina.',
        29: 'Služijo naj ti ljudstva in klanjajo naj se ti narodi; gospodar bodi bratom svojim, in klanjajo naj se ti matere tvoje sinovi. Kdor te proklinja, vsak bodi proklet, in kdor te blagoslavlja, vsak bodi blagoslovljen!',
        ...
        36: 'In reče Ezav: Ni li se prav imenoval Jakob? kajti izpodrinil me je že vdrugič: ob prvenstvo me je pripravil, in glej, zdaj je odnesel blagoslov moj. Nato reče: Nisi li nič blagoslova mi prihranil?',
        ...
        44: 'Tam bivaj ž njim malo dni, dokler se ne uleže brata tvojega srd;',
    ...
    28: {
        ...
        3: 'In Bog silni, Vsegamogočni te blagoslovi, in rodovitnega te stóri ter pomnóži, da bodeš oče množici narodov.',
        ...
        11: 'In naleti na neki kraj, kjer je prenočil, ker je bilo solnce zašlo; in vzame od kamenja tistega kraja ter si napravi podglavje in leže počivat v tem kraju.',
        ...
        19: 'In imenuje ime tega kraja Betel; ali prej je bilo Luz ime tistemu mestu.',
    ...
    29: {
        ...
        9: 'Ko je še govoril ž njimi, pride Rahela z ovcami svojega očeta; kajti pasla jih je.',
        ...
        23: 'Zvečer pa vzame Lejo, hčer svojo, ter jo pripelje k njemu; in on se združi ž njo.',
        24: 'In da ji Laban Zilpo, deklo svojo, da bodi Leji, hčeri njegovi, dekla.',
        25: 'In zjutraj, glej, bila je Leja. In reče Labanu: Kaj si mi to storil? Nisem li služil za Rahelo pri tebi? Zakaj si me torej okanil?',
    ...
    30: {
        ...
        4: 'In dá mu Bilho, deklo svojo, za ženo; in združi se ž njo Jakob.',
        ...
        7: 'Nato spočne Bilha, Rahelina dekla, vdrugič in porodi sina drugega Jakobu.',
        ...
        16: 'In ko se je Jakob zvečer vračal s polja, mu pride Leja naproti ter reče: K meni prideš, zakaj prav za plačilo sem te najela za ljubezenska jabolčka svojega sina. In ležal je ž njo tisto noč.',
        ...
        30: 'Zakaj kar si malega imel pred prihodom mojim, to se je pomnožilo, in Gospod ter je blagoslovil, kamorkoli sem krenil. Sedaj pa, kdaj naj skrbim tudi jaz za hišo svojo?',
        ...
        36: 'in določi tri dni hoda razdalja med seboj in Jakobom; in Jakob je pasel ostalo drobnico Labanovo.',
        ...
        40: 'In ta jagnjeta je odločeval Jakob, in obličja ovac je obračal proti pisanim in proti vsem čadastim v Labanovi čredi; in sebi je napravljal črede posebe, in jih ni mešal med ovce Labanove.',
    ...
    31: {
        ...
        4: 'In pošlje Jakob in pokliče Rahelo in Lejo na polje k svoji čredi',
        5: 'in jima reče: Vidim, da obličje očeta vajinega ni do mene kakor poprej; toda Bog očeta mojega je bil pri meni.',
        6: 'In vedve vesta, da sem po vsej svoji moči služil vajinemu očetu.',
        ...
        10: 'Ob času namreč, ko se mrkajo ovce, sem povzdignil oči in videl v sanjah, in glej, ovni, ki zaskakujejo ovce, so pisani, marogasti in grahasti.',
        11: 'In angel Božji mi reče v sanjah: Jakob! In rečem: Glej, tu sem.',
        12: 'In veli: Povzdigni sedaj oči in poglej vse ovne, ki zaskakujejo ovce, da so progasti in pisani in grahasti; kajti videl sem vse, kar ti dela Laban.',
        ...
        16: 'Kajti vse to bogastvo, katero je Bog odvzel najinemu očetu, najino je in najinih otrok; sedaj pa, karkoli ti je velel Bog, stóri!',
        ...
        21: 'Tako pobegne on z vsem, kar je imel; in vstane ter prekorači reko in nameri obličje svoje proti gori Gileadski.',
        22: 'A tretji dan sporoče Labanu, da je Jakob zbežal.',
        23: 'In vzame brate svoje s seboj ter gre za njim sedem dni hodá, in dohiti ga na gori Gileadski.',
        24: 'Bog pa pride k Labanu Aramejcu v nočnih sanjah ter mu reče: Varuj se, da ne govoriš z Jakobom bodi dobro, bodi hudo.',
        25: 'In dojde Laban Jakoba. Jakob pa je bil zasadil šator svoj na gori, tudi Laban z brati svojimi ga zasadi na gori Gileadski.',
        26: 'Tedaj reče Laban Jakobu: Kaj si storil, da si prekanil dušo mojo in si odpeljal hčeri moji, kakor da si ju ujel v vojski?',
        27: 'Zakaj si pobegnil na skrivnem in si me prekanil? in mi nisi nič povedal, da bi te odpustil z radostjo in s petjem, z bobnom in s strunami?',
        28: 'In nisi mi dovolil, da poljubim sine svoje in hčere svoje? Zdaj si ravnal nespametno.',
        29: 'Bilo bi v moči roke moje, hudo vam storiti, ali Bog očeta vašega me je ogovoril snoči takole: Varuj se, da ne govoriš z Jakobom bodi dobro, bodi hudo.',
        ...
        32: 'Pri komer najdeš bogove svoje, naj ne bode živel; vpričo bratov naših preglej, kaj je tvojega pri meni, in vzemi si. Jakob namreč ni vedel, da jih je bila ukradla Rahela.',
        33: 'Laban torej gre v šator Jakobov in v šator Lejin in v šator obeh dekel, a jih ne najde. In pride iz šatora Lejinega in stopi v šator Rahelin.',
        34: 'Rahela pa je vzela tiste malike in jih dejala na velbodovo sedlo in je sedla nanje. In Laban pretakne ves šator njen, a jih ne najde.',
        35: 'Ona pa reče očetu svojemu: Ne bodi žaljivo v očeh gospoda mojega, da ne morem vstati pred teboj, ker mi je po ženski navadi. Ko preišče torej vse, ne najde svojih malikov.',
        36: 'Tedaj se razjezi Jakob in začne očitati Labanu; in odgovori Jakob ter reče Labanu: Kaj je moj prestopek, kaj je moj greh, da si hitel tako nagle jeze za mano?',
        37: 'In ker si obtipal vse pohištvo moje, kaj si našel od vsega blaga hiše svoje? Položi sem, vpričo bratov mojih in bratov tvojih, da razsodijo med nama obema!',
        38: 'Dvajset let je, odkar sem bil s teboj: ovce in koze tvoje niso bile jalove, in ovnov črede tvoje nisem jedel.',
        39: 'Raztrganih živali nisem prinesel k tebi: sam sem škodo trpel, iz moje roke si to zahteval, ukradeno mi po dnevi, ukradeno mi po noči.',
        ...
        48: 'Rekel je namreč Laban: Ta kup bodi priča med teboj in menoj danes; zato mu je dano ime Galed,',
        49: 'in tudi Micpa, ker je rekel Laban: Straži naj Gospod med menoj in teboj, ko ne bova drug drugega videla.',
        50: 'Ako boš grdo ravnal z mojima hčerama in če si vzameš še žene poleg hčer mojih, nobenega človeka ne bode med nama: glej, Bog bode priča med menoj in teboj.',
        ...
        53: 'Bog Abrahamov in Bog Nahorjev, Bog njiju očeta, naj sodi med nama! In Jakob priseže pri Strahu očeta svojega Izaka.',
        54: 'Nato zakolje Jakob žrtev na tisti gori in pokliče brate svoje, da použijejo jed. In použili so jed in prenočili na gori.',
        55: 'In zgodaj zjutraj vstane Laban in poljubi sine svoje in hčeri svoji in jih blagoslovi; in Laban odide ter se vrne v svoj kraj.',
    },
    32: {
        1: 'Jakob pa gre dalje svojim potem, in naproti mu pridejo angeli Božji.',
        2: 'In Jakob reče, ko jih je videl: Tabor vojske Božje je to; zato je imenoval tisti kraj Mahanaim.',
        3: 'In Jakob pošlje poročnike pred seboj do Ezava, brata svojega, v pokrajino Seirsko, poljano Edomsko,',
        4: 'in jim naroči, govoreč: Tako porečete gospodu mojemu Ezavu: Tako pravi hlapec tvoj Jakob: Pri Labanu sem živel kot tujec in bival do sedaj.',
        5: 'Imam pa volov in oslov, čred, hlapcev in dekel, zato sem poslal poročat to gospodu svojemu, da najdem milost v tvojih očeh.',
        6: 'In poročniki so se vrnili k Jakobu, govoreč: Prišli smo k bratu tvojemu, ki ti gre tudi naproti in štiristo mož ž njim.',
        7: 'In Jakob se silno zboji, in bil je zbegan; in razdeli ljudstvo, ki je bilo ž njim, in črede in goveda in velblode v dve krdeli.',
        8: 'Dejal je namreč: Če napade Ezav eno krdelo ter je pobije, bo vsaj krdelo, ki ostane, moglo pobegniti.',
        9: 'In reče Jakob: O Bog očeta mojega Abrahama in Bog očeta mojega Izaka, Gospod, ki si mi velel: Vrni se v deželo svojo in k sorodovini svoji, in obsujem te z dobrim.',
        10: 'Nevreden sem vseh milosti in vse zvestobe, ki si jo izkazal hlapcu svojemu; kajti samo s palico svojo sem prekoračil ta Jordan, sedaj pa sem gospodar dveh krdel.',
        11: 'Otmi me, prosim, iz brata mojega roke, iz Ezava roke, zakaj bojim se ga, da ne pride in me pobije, matere z otroki.',
        12: 'Saj si rekel: Obsujem te z dobrotami in seme tvoje naredim kakor morski pesek, ki ga od množine ni mogoče sešteti.',
        13: 'In prenoči ondi tisto noč; in vzame od imetka, ki mu je prišel v roko, da ponudi v dar Ezavu, bratu svojemu:',
        14: 'dvesto koz z dvajsetimi kozliči, dvesto ovac z dvajsetimi jagnjeti,',
        15: 'trideset molznih velblodov z njih mladiči, štirideset krav in deset juncev, oslic dvajset z desetimi osliči.',
        16: 'In da jih v roko hlapcem svojim, vsako čredo posebe, in ukaže hlapcem svojim: Idite pred menoj in pustite presledek med eno čredo in drugo.',
        17: 'In ukaže prvemu, rekoč: Ko te sreča Ezav, brat moj, in te vpraša, rekoč: Čigav si? in kam greš? in čigavo je tisto pred teboj?',
        18: 'tedaj porečeš: Hlapca tvojega, Jakoba. To je darilo, poslano gospodu mojemu Ezavu; in glej, tudi on sam gre za nami.',
        19: 'Isto ukaže tudi drugemu in tretjemu in vsem, ki so spremljali črede, govoreč: Tako ogovorite Ezava, ko ga srečate;',
        20: 'a porečete tudi: Glej, Jakob, hlapec tvoj, gre za nami. Rekel je namreč: Potolažim obličje njegovo s tem darilom, ki gre pred menoj, in potem zagledam obličje njegovo, morda me prijazno sprejme.',
        21: 'In šlo je tisto darilo pred njim; on pa je prenočil to noč v šatorišču.',
        22: 'In vstane še to noč ter vzame dve ženi svoji z dvema deklama svojima in enajst otrok svojih, in prebrede brod Jabok.',
        23: 'In ko jih je vzel in spravil čez reko, prevede tudi vse, kar je imel.',
        24: 'In Jakob je ostal sam; in mož se je boril ž njim, dokler je vstala zarja.',
        25: 'In ko je videl, da ga ne zmore, ga udari v kolkov sklep; in Jakobu se je izmaknil kolkov sklep, ko se je boril ž njim.',
        26: 'In veli: Pusti me, kajti zarja že vzhaja! Jakob pa reče: Ne pustim te, razen če me blagosloviš.',
        27: 'In mu reče: Katero je ime tvoje? On pa reče: Jakob.',
        28: 'Nato veli: Ne Jakob se bo imenovalo ime tvoje, ampak Izrael: zakaj boril si se z Bogom in z ljudmi in si zmagal.',
        29: 'Jakob pa vpraša in reče: Povej, prosim, ime svoje. On pa veli: Čemu pa poprašuješ po mojem imenu? In ondi ga je blagoslovil.',
        30: 'Zato je Jakob imenoval ime tistega kraja Penuel: zakaj Boga sem videl z obličjem v obličje, in oteta je bila duša moja.',
        31: 'Izšlo pa mu je solnce, ko je prešel Penuel, in hramal je od kolka svojega.',
        32: 'Zato sinovi Izraelovi ne jedo do tega dne živčne kite, ki je na kolkovem sklepu, ker je udaril Jakobov kolkov sklep, živčno kito na kolku.',
    },
    33: {
        1: 'In Jakob povzdigne oči in vidi, in glej, Ezav prihaja in štiristo mož ž njim. In razdeli otroke na Lejo in na Rahelo in na dve dekli;',
        ...
        4: 'A Ezav mu priteče naproti, ga objame, se mu oklene vratu in ga poljubi; in oba jočeta.',
        ...
        6: 'Nato pristopita dekli, oni in njuni otroci, ter se priklonijo.',
        ...
        9: 'A Ezav veli: Jaz imam dovolj, brat moj; ti imej, kar je tvoje.',
        10: 'In Jakob reče: Nikar; če sem res našel milost v tvojih očeh, prosim, sprejmi darilo moje iz roke moje; saj zategadelj sem zagledal obličje tvoje, kakor da bi bil zagledal obličje Božje, in blagovoljno si me sprejel.',
        11: 'Vzemi prosim, blagodar moj, ki so ga privedli k tebi, ker me je milostno obdaril Bog, da imam vsega dosti. In ker ga je silil, je sprejel.',
        12: 'Nato reče: Napotiva se in idiva dalje, in jaz te bom spremljal.',
        ...
        18: 'In pride Jakob v miru do mesta Sihema, ki je v deželi Kanaanski, ko je dospel iz Padan-arama, in postavi šatore pred mestom.',
        19: 'In kupi kos polja, na katerem je razpel šator svoj, od sinov Hamorja, očeta Sihemovega, za sto kesit.',
    ...
    34: {
        ...
        2: 'In videl jo je Sihem, sin Hamorja Hevejca, kneza v tistem kraju, in jo ugrabi ter leže ž njo in jo posili.',
        3: 'In srce njegovo se je prijelo Dine, Jakobove hčere, in je silno ljubil deklico in govoril, kar ji je segalo v srce.',
        4: 'In Sihem ogovori Hamorja, očeta svojega, rekoč: Vzemi mi to deklico za ženo.',
        ...
        6: 'Pride pa Hamor, Sihemov oče, k Jakobu, da ž njim govori.',
        7: 'In pridejo sinovi Jakobovi s polja, brž ko so slišali; in žalost je obšla te može in razsrdili so se silno, kajti nesramnost je storil v Izraelu, ker je legel s hčerjo Jakobovo, in tako se ne sme storiti.',
        ...
        9: 'In svaštvo sklenite z nami: hčere svoje dajajte nam in jemljite naše hčere.',
        10: 'In z nami ostanite: ta pokrajina vam bodi na voljo, prebivajte in tržite po njej in posestniki postanite v njej.',
        11: 'In Sihem reče očetu deklice in bratom njenim: Milost naj najdem v vaših očeh, in kar mi ukažete, dam.',
        12: 'Naložite mi kakorsibodi veliko doto in darilo, in dam, kolikor ukažete; samo dajti mi deklico za ženo!',
        13: 'Odgovoré pa sinovi Jakobovi zvijačno Sihemu in Hamorju, očetu njegovemu, ker je bil oskrunil Dino, njih sestro,',
        14: 'ter jima reko: Ne moremo storiti tega, da damo sestro svojo možu neobrezancu, zakaj to nam je sramotno.',
        15: 'Vendar s tem pogojem vam privolimo: ako hočete biti nam enaki, da se med vami obreže vse moško,',
        16: 'tedaj vam bomo dajali hčere svoje in si jemali hčere vaše, in prebivali bomo z vami in se združimo v eno ljudstvo.',
        17: 'Ako pa nas ne boste poslušali, da se obrežete, vzamemo hčer svojo ter odidemo.',
        18: 'In njih besede so ugajale Hamorju in Sihemu, Hamorjevemu sinu.',
        19: 'In mladenič ni odlašal in je storil to, ker je imel veselje do hčere Jakobove; in on je bil najimenitnejši v vsej hiši očeta svojeta.',
        20: 'Gresta torej Hamor in Sihem, sin njegov, k vratom svojega mesta in ogovorita someščane svoje, rekoč:',
        ...
        27: 'Sinovi Jakobovi planejo na pobite in oplenijo mesto, zato ker je odtod prišla oskrumba njih sestri.',
        ...
        30: 'Tedaj reče Jakob Simeonu in Leviju: V nesrečo sta me spravila, ker sta storila, da smrdim pri prebivalcih tega kraja, pri Kanaancu in Ferizejcu, ko imam le malo ljudi; če se zbero zoper mene, me pobijejo, in pokončan bom jaz in hiša moja.',
        31: 'Ona pa rečeta: Ali naj se kakor z nečistnico dela s sestro našo?',
    },
    35: {
        1: 'Bog pa ukaže Jakobu: Vstani, idi gori v Betel in nastani se tam; in napravi tam oltar Bogu mogočnemu, ki se ti je prikazal, ko si bežal pred Ezavom, bratom svojim.',
        2: 'In Jakob veli hiši svoji in vsem, ki so bili ž njim: Stran tuje bogove, ki so med vami, in očistite se ter preoblecite!',
        3: 'in vstanimo ter pojdimo gori v Betel, da napravim tam oltar Bogu mogočnemu, ki me je uslišal v dan stiske moje in mi je bil ob strani na potu, po katerem sem hodil.',
        4: 'Izročé torej Jakobu vse tuje bogove, ki so bili v njih rokah, in obodce, ki so bili v njih ušesih; in Jakob jih zakoplje pod hrastom, ki je blizu Sihema.',
        5: 'Nato se napotijo, in strah Božji je navdajal mesta, ki so bila okrog njih, da niso podili sinov Jakobovih.',
        6: 'In Jakob pride v Luz, ki je v deželi Kanaanski (to je Betel), on in vse ljudstvo, ki je bilo ž njim.',
        7: 'In napravi tam oltar, in imenoval je tisto mesto El-Betel, ker se mu je bil ondi razodel Bog, ko je bežal pred bratom svojim.',
        8: 'Umrla je pa Debora, Rebekina dojnica, in je bila pokopana pod hrastom doli za Betelom, zato ga je imenoval Alon bakut.',
        9: 'Nato se prikaže Bog zopet Jakobu, ko je prišel iz Padan-arama, in ga blagoslovi.',
        ...
        11: 'Še mu reče Bog: Jaz sem Bog silni, Vsemogočni: rodoviten bodi in množi se; narod, da, množica narodov bodi iz tebe, tudi kralji naj pridejo iz ledij tvojih.',
        12: 'Deželo pa, ki sem jo dal Abrahamu in Izaku, dam tebi, in semenu tvojemu za teboj dam deželo to.',
        13: 'In Bog je šel od njega na tistem mestu, kjer je govoril ž njim.',
        14: 'In Jakob postavi spomenik na mestu, kjer je govoril ž njim, spomenik kamenen, in izlije nanj pitno daritev in ga oblije z oljem.',
        15: 'In Jakob je dal mestu, kjer je Bog govoril ž njim, ime Betel.',
        ...
        18: 'In zgodi se, ko ji je uhajala duša in je umirala, da imenuje ime njegovo Benoni, ali oče njegov ga je imenoval Benjamina.',
        ...
        21: 'Nato se napoti Izrael in razpne šator svoj onkraj stolpa Ederja.',
        22: 'Zgodi se pa, ko je bival Izrael v tisti pokrajini, da je šel Ruben in ležal z Bilho, priležnico očeta svojega; in to je slišal Izrael. Bilo je pa sinov Izraelovih dvanajst.',
        23: 'Sinovi Leje: prvenec Jakobov Ruben, in Simeon in Levi in Juda, Isahar in Zebulon;',
        24: 'sinova Rahele: Jožef in Benjamin;',
        25: 'sinova pa Bilhe, ki je bila Rahelina dekla: Dan in Neftali;',
        26: 'in sinova Zilpe, ki je bila Lejina dekla: Gad in Aser. Ti so sinovi Jakobovi, ki so se mu rodli v Padan-aramu.',
        27: 'In pride Jakob k Izaku, očetu svojemu, v Mamro pri Kirjat-arbi, to je Hebron, kjer je nekdaj Abraham tujčeval in potem Izak.',
        28: 'Bilo je pa Izakovih dni sto osemdeset let.',
        29: 'In izdihnil je Izak in umrl ter je bil zbran k ljudstvu svojemu, star in dni svojih sit; in pokopala sta ga Ezav in Jakob, sina njegova.',
    },
    36: {
        ...
        3: 'in Basemato, hčer Izmaelovo, sestro Nebajotovo.',
        ...
        6: 'Ezav pa je vzel žene svoje in sinove in hčere svoje in vse domačine svoje, tudi drobnico in vso živino svojo in vso posest svojo, ki si jo je bil pridobil v deželi Kanaanski, in odšel je v drugo deželo, stran od Jakoba, brata svojega.',
        ...
        8: 'In prebival je Ezav na gori Seiru; Ezav, to je Edom.',
        9: 'To pa so rodovi Ezava, očeta Edomcev, na gori Seiru.',
        10: 'Ta so imena sinov Ezavovih: Elifaz, sin Ade, žene Ezavove; Reguel, sin Basemate, Ezavove žene.',
        ...
        13: 'Ti pa so sinovi Reguelovi: Nahat in Zerah, Šama in Miza. Ti so bili sinovi Basemate, Ezavove žene.',
        ...
        18: 'To pa so sinovi Oholibame, Ezavove žene: vojvoda Jeuš, vojvoda Jalam, vojvoda Korah. Ti so vojvode Oholibame, hčere Anove, Ezavove žene.',
        ...
        21: 'Dišon, Ezer in Dišan. Ti so vojvode Horejcev, sinov Seirovih, v deželi Edomovi.',
        22: 'In sinova Lotanova sta bila: Hori in Hemam, in sestra Lotanova Timna.',
        23: 'Ti pa so sinovi Šobalovi: Alvan, Manahat in Ebal, Šefo in Onam.',
        ...
        26: 'In ti so sinovi Dišonovi: Hemdan, Ešban, Jitran in Keran.',
        27: 'Ti pa sinovi Ezerjevi: Bilhan in Zaavan in Akan.',
        28: 'Ta pa sinova Dišanova: Uz in Aran.',
        29: 'Ti so vojvode Horejcev: vojvoda Lotan, vojvoda Šobal, vojvoda Zibeon, vojvoda Ana,',
        30: 'vojvoda Dišon, vojvoda Ezer, vojvoda Dišan. To so vojvode Horejcev po njih vojvodstvih v deželi Seirski.',
        31: 'Ti pa so kralji, ki so kraljevali v deželi Edomovi, preden je vladal kralj sinove Izraelove.',
        ...
        35: 'In Hušam je umrl, in zakraljeval je namesto njega Hadad, sin Bedada, ki je pobil Madiane na poljani Moabski; in mestu njegovemu je bilo ime Avit.',
        36: 'In Hadad je umrl, in na mestu njegovem je zakraljeval Samla iz Masreke.',
        ...
        41: 'vojvoda Oholibama, vojvoda Ela, vojvoda Pinon,',
        42: 'vojvoda Kenaz, vojvoda Teman, vojvoda Mibzar,',
        43: 'vojvoda Magdiel, vojvoda Iram. Ti so bili vojvode Edomovi po svojih bivališčih, v deželi svoje posesti. To je Ezav, oče Edomcev.',
    },
    37: {
        ...
        9: 'Nato je imel še druge sanje in jih je povedal bratom svojim ter rekel: Glejte, imel sem še sanje; glejte pa, solne in mesec in enajst zvezd se je klanjalo meni.',
        ...
        18: 'Oni pa ga zagledajo oddaleč, in ko ni bil še prišel do njih, so skovali zvijačo zoper njega, da ga usmrte.',
        ...
        33: 'On pa jo je spoznal in reče: Suknja je sina mojega; huda zver ga je požrla; raztrgan, dá, raztrgan je Jožef!',
        34: 'In Jakob raztrga oblačila svoja ter si ogrne ledja z žimovino, in žaloval je po sinu svojem mnogo dni.',
        35: 'In vstali so vsi sinovi njegovi in vse hčere njegove, da bi ga tolažili, a branil se je tolažbe, govoreč: Ne, kajti doli pojdem žalosten k sinu svojemu v grob. In jokal je oče njegov za njim.',
    ...
    38: {
        ...
        2: 'In ko je Juda videl tam hčer nekega Kanaanca, ki mu je bilo ime Šuva, jo vzame ter se združi ž njo.',
        3: 'In ona spočne ter rodi sina, ki ga je imenoval Gera.',
        ...
        16: 'Ustavi se torej pri njej ob potu ter reče: Dovoli mi, da se združim s teboj. Ni vedel namreč, da je snaha njegova. Ona pa reče: Kaj mi daš, da se združiš z menoj?',
        17: 'In on reče: Poslati ti hočem kozliča od črede. Ona pa reče: Daj mi zastavo, dokler mi ga ne pošlješ!',
        18: 'Tedaj vpraša: Kakšno naj ti dam zastavo? In ona veli: Pečatnik svoj s trakom svojim in palico svojo, ki je v roki tvoji. In da ji to ter se združi ž njo, in spočela je od njega.',
        ...
        24: 'Prigodi se pa blizu po treh mesecih, da so sporočili Judi, govoreč: Nečistovala je Tamara, snaha tvoja, in glej, tudi noseča je iz nečistovanja. In Juda reče: Peljite jo ven, da jo sežgo!',
        ...
        26: 'In Juda je to spoznal in reče: Pravičnejša je od mene, zato ker je nisem dal Šelu, sinu svojemu. In ni je nikoli več spoznal.',
        ...
        29: 'In ko ta nazaj potegne roko svojo, glej, brat njegov pride na svet, in ona reče: Kako si ti predrl! tvoj je predor. Zato so ga imenovali Pereza.',
    ...
    39: {
        ...
        2: 'A Gospod je bil ž Jožefom, in bil je mož, ki mu je šlo vse po sreči; in je bival v hiši gospodarja svojega, Egipčana.',
        3: 'In gospodar njegov je videl, da je Gospod ž njim in da vse, kar on počenja, pospešuje Gospod v roki njegovi.',
        ...
        6: 'Zato je prepustil vse, kar je imel, roki Jožefovi, in ni se brigal za nobeno stvar pri njem razen za hrano, ki jo je sam užival. Bil je pa Jožef lepe postave in zalega obličja.',
        ...
        9: 'Še sam ni večji od mene v tej hiši, in ničesar mi ni odtegnil razen tebe, ker si žena njegova. Kako bi torej jaz storil toliko zlo in grešil zoper Boga?',
        10: 'In ko je ona ogovarjala Jožefa vsak dan, ni ji privolil, da bi ležal poleg nje, niti da bi se mudil ž njo.',
        ...
        21: 'Ali Gospod je bil z Jožefom in naklonil mu je blagovoljnost in mu dal milost svojo pred očmi načelnika stolpu.',
        22: 'In načelnik stolpa je dal Jožefu v roko vse zvezane v stolpu; in vse, kar so tam delali, je vodil on.',
        23: 'Načelnik stolpa ni gledal na nobeno stvar, ki je bila v roki Jožefovi, zato ker je bil Gospod ž njim, in kar je počel, vse je pospeševal Gospod.',
    },
    40: {
    ...
    41: {
        ...
        9: 'Tedaj ogovori veliki točaj Faraona in reče: Svojih grehov se spominjam danes.',
        10: 'Faraon se je raztogotil zoper hlapce svoje in me je dejal v zapor v hiši načelnika telesne straže, mene in velikega peka.',
        11: 'Imela sva pa sanje v isti noči jaz in on; primerno razlagi najinih sanj se je sanjalo nama.',
        12: 'Bil je pa tam z nama mladenič Hebrejec, hlapec načelnika telesne straže, ki nama je sanje najine razložil, kakor sva mu povedala; vsakemu primerno sanjam njegovim je razložil.',
        ...
        17: 'Reče torej Faraon Jožefu: V sanjah svojih, glej, sem stal na bregu Nila.',
        ...
        22: 'Še sem videl v sanjah svojih, in glej, sedem klasov je zraslo na enem steblu, polnih in lepih.',
        23: 'Glej pa, sedem klasov drobnih in suhih, ki jih je vzhodni veter osmodil, je pognalo za njimi.',
        24: 'Tisti drobni klasi pa so pogoltnili sedem lepih klasov. In to sem povedal pismoukom, a nobenega ni bilo, ki bi mi razložil.',
        25: 'Tedaj reče Jožef Faraonu: Sanje Faraonove so ene: kar hoče storiti Bog, je razodel Faraonu.',
        ...
        31: 'in nič se ne bo vedelo v deželi za obilost zavoljo lakote, ki pride potem, zato ker huda bode silno.',
        32: 'Da so se pa ponovile sanje Faraonu dvakrat, pomeni, da je Bog to stvar trdno sklenil, in Bog jo v kratkem izpolni.',
        ...
        36: 'In ta živež bodi v zalogo deželi za tistih sedem let lakote, ki bode v deželi Egiptovski, da ne pogine dežela od lakote.',
        37: 'In ta beseda je bila dobra v očeh Faraonovih in v očeh vseh služabnikov njegovih.',
        38: 'In Faraon reče služabnikom svojim: Najdemo li mar temu enakega moža, ki je v njem duh Božji?',
        39: 'Nato veli Faraon Jožefu: Ker ti je Bog razodel vse to, nihče ni razumen in moder kakor ti.',
        40: 'Ti bodeš čez hišo mojo in po povelju tvojem se bo ravnalo ljudstvo moje, samo za ta prestol bodem višji od tebe.',
        41: 'Dalje reče Faraon Jožefu: Glej, stavim te čez vso deželo Egiptovsko.',
        42: 'In Faraon sname pečatni prstan z roke svoje ter ga natakne na roko Jožefovo in veli mu obleči oblačila iz tenčice in zlato verižico mu dene okoli vratu.',
        43: 'In ukaže, naj ga peljejo na drugem vozu njegovem, in klicali so pred njim: Priklonite se! In postavil ga je čez vso deželo Egiptovsko.',
        44: 'In reče Faraon Jožefu: Jaz sem Faraon, a brez tebe ne vzdigne nihče roke svoje ali noge svoje po vsej deželi Egiptovski.',
        45: 'Imenoval pa je Faraon ime Jožefovo Zafnat-paneah, in dal mu je za ženo Asnato, hčer Potiferja, svečenika v Onu. In Jožef je šel vladat deželo Egiptovsko.',
        46: 'Imel pa je Jožef trideset let, ko je stal pred Faraonom, kraljem egiptovskim. In Jožef je šel izpred obličja Faraonovega in je obhodil vso deželo Egiptovsko.',
        ...
        53: 'In ko je preteklo sedem let obilosti, ki je bila v deželi Egiptovski,',
        ...
        57: 'In iz vseh dežel so hodili v Egipt k Jožefu kupovat, zato ker je lakota hudo stiskala vso zemljo.',
    },
    42: {
        ...
        14: 'Veli jim Jožef: To je tisto, kar sem vam rekel: Ogleduhi ste.',
        ...
        18: 'Potem jim reče Jožef tretji dan: To storite in si ohranite življenje – Boga se bojim jaz:',
        ...
        24: 'In obrne se od njih, in je jokal. A zopet se vrne k njim in govori ž njimi. In vzame izmed njih Simeona in ga zveže pred njih očmi.',
        ...
        31: 'In rekli smo mu: Pošteni smo, nikdar nismo bili ogleduhi.',
        ...
        36: 'In Jakob, njih oče, jim reče: Pripravite me ob otroke! Jožefa ni več, in Simeona ni več, in Benjamina bi mi radi vzeli; zoper mene je vse to.',
        37: 'A Ruben ogovori očeta svojega in reče: Ta dva sinova moja daj v smrt, ako ga ne pripeljem zopet k tebi. Daj ga meni v roko, in jaz ga pripeljem zopet k tebi.',
    ...
    43: {
        ...
        3: 'A Juda mu odgovori in reče: Resno nam je zatrdil oni mož in rekel: Videli ne boste obličja mojega, ako ne bode brata vašega z vami.',
        ...
        13: 'Tudi brata svojega vzemite ter vstanite, vrnite se k onemu možu.',
        14: 'In Bog silni, Vsemogočni vam daj usmiljenje pred tistim možem, da vam izpusti onega brata vašega in Benjamina. Jaz pa, če bodem brez otrok, naj bom brez otrok!',
        ...
        16: 'Ko je videl Jožef Benjamina ž njimi, veli upravniku hiše svoje: Pelji noter te može in zakolji živali ter pripravi, z menoj namreč bodo jedli ti možje opoldne.',
        ...
        27: 'In on jih vpraša, kako se jim godi, ter reče: Ali se dobro godi vašemu očetu, starčku, o katerem ste govorili? Ali še živi?',
        28: 'Oni pa reko: Dobro se godi hlapcu tvojemu, našemu očetu, še živi. In pripognejo teme in se priklonijo.',
        29: 'In povzdigne oči in zagleda Benjamina, brata svojega, matere svoje sina, ter reče: Tale je tisti brat vaš najmlajši, o katerem ste mi govorili? In veli: Bog ti bodi milosten, sin moj!',
        ...
        32: 'In prineso njemu posebe in njim posebe in Egipčanom, ki so ž njim jedli, posebe, zakaj Egipčani ne smejo jesti s Hebrejci, ker to je nagnusno Egipčanom.',
        33: 'Sedeli so pa pred njim, prvenec po prvenstvu svojem in mlajši po mlajših letih svojih; in čudeč se so gledali ti možje drug drugega.',
        34: 'In jemaje jedi pred seboj, je pošiljal k njim, in večji je bil petkrat delež Benjaminov nego kateregakoli izmed njih. Tako so se gostili in dosti so pili ž njim.',
    },
    44: {
        ...
        3: 'Danilo se je že, ko so odpustili može ž njih osli.',
        ...
        5: 'Ali ni tisto, iz česar pije gospod moj in s česar pomočjo prorokuje? Hudo ste ravnali, ko ste storili to.',
        ...
        8: 'Glej, denar, ki smo ga našli zvrha v vrečah svojih, smo prinesli zopet k tebi iz dežele Kanaanske: kako bi bili torej ukradli iz hiše gospoda tvojega srebro ali zlato?',
        ...
        13: 'Tedaj raztrgajo oblačila svoja in nalože tovor vsak na svojega osla, in se vrnejo v mesto.',
        14: 'In Juda vstopi z brati svojimi v hišo Jožefovo, ko je bil on še tam, in popadajo pred obličje njegovo na tla.',
        15: 'Jožef pa jim reče: Kakšna je to pregreha, ki ste jo storili? Niste li vedeli, da mož, kakršen sem jaz, more prorokovati?',
        16: 'Tedaj reče Juda: Kaj bi rekli gospodu svojemu? kaj bi pravili? ali kako bi se opravičili? Bog sam je našel krivico hlapcev tvojih. Glej, mi smo hlapci svojemu gospodu, mi in on, v čigar roki se je našla tista kupa.',
        ...
        30: 'Zdaj torej, kadar pridem k hlapcu tvojemu, svojemu očetu, in tega dečka ne bode z nami, ko je očetova duša zvezana ž njegovo dušo,',
        31: 'se zgodi, da umre, ko bo videl, da ni tu dečka: tako bodo hlapci tvoji sivo glavo hlapca tvojega, našega očeta, z žalostjo spravili v grob.',
    ...
    45: {
        1: 'Tedaj se Jožef ni mogel več premagovati vpričo vseh, ki so stali okrog njega, in zavpije: Dejte, da gredó vsi ven od mene! In nihče ni ostal pri njem, ko se je Jožef dal spoznati bratom svojim.',
        2: 'Tedaj zažene glas svoj z jokom, tako da so slišali Egipčani, slišala je tudi hiša Faraonova.',
        ...
        8: 'Tako torej, nikakor me niste vi poslali sem, temuč Bog, ki me je postavil za očeta Faraonu in za gospodarja vsej hiši njegovi ter za oblastnika vsej deželi Egiptovski.',
        ...
        15: 'In poljubi vse brate svoje in joka ob njih vratu. Potem šele izpregovore bratje njegovi ž njim.',
        ...
        17: 'In Faraon veli Jožefu: Reci bratom svojim: To storite: obložite živino svojo in odpotujte, in ko pridete v deželo Kanaansko,',
        ...
        20: 'Oko vaše pa naj se ne žali za pohištvo vaše, kajti kar je najboljšega v vsej deželi Egiptovski, vaše je.',
        21: 'In sinovi Izraelovi so storili tako; in dal jim je Jožef voz po ukazu Faraonovem, dal jim tudi brašna na pot.',
        22: 'In dal jim je vsakemu posebe praznično obleko, Benjaminu pa je dal tristo srebrnikov in petero prazničnih oblek.',
        ...
        25: 'Tako so šli gori iz Egipta, in pridejo v deželo Kanaansko k Jakobu, očetu svojemu.',
        ...
        28: 'in Izrael reče: Dovolj mi je! še živi Jožef, sin moj; pojdem in videl ga bom, preden umrjem.',
    },
    46: {
    ...
    47: {
        ...
        11: 'Naseli torej Jožef očeta svojega in brate svoje ter jim da posest v deželi Egiptovski, v najboljšem kraju dežele, v pokrajini Ramesesu, kakor je ukazal Faraon.',
        ...
        15: 'Ko jim je torej pošel ves denar v deželi Egiptovski in v deželi Kanaanski, so prišli vsi Egipčani k Jožefu, govoreč: Daj nam kruha! zakaj bi neki umirali vpričo tebe? kajti denar je pošel.',
        ...
        21: 'Ljudstvo pa je preselil v mesta, od skrajne meje Egipta do druge meje njegove.',
        ...
        26: 'In tisto je Jožef ustanovil za postavo do tega dne o poljih v Egiptu, da se daje Faraonu petina; samo polja duhovnikov niso prišla v last Faraonu.',
        27: 'In Izrael je prebival v deželi Egiptovski, v pokrajini Gosenski, in pridobili so si posest v njej, in so bili rodovitni in se pomnožili silno.',
        ...
        30: 'Kadar bom ležal z očeti svojimi, nesi me nazaj iz Egipta in me pokoplji v njih grobišču. On pa reče: Storil bom po besedi tvoji.',
        31: 'Ko pa veli: Prisezi mi! mu je prisegel. In Izrael se prikloni Bogu proti zglavju postelje svoje.',
    },
    48: {
        ...
        15: 'In blagoslovi Jožefa, govoreč: Bog, pred čigar obličjem sta vedno hodila očeta moja, Abraham in Izak, Bog, ki mi je bil pastir, odkar živim do tega dne;',
        ...
        20: 'In blagoslovi ju tisti dan, rekoč: S teboj bodo blagoslavljali Izraelci, govoreč: Stóri ti Bog kakor Efraimu in kakor Manaseju! In postavil je Efraima pred Manaseja.',
        21: 'In reče Izrael Jožefu: Glej, skoraj umrem, a Bog bode z vami in vas pripelje nazaj v deželo očetov vaših.',
        22: 'In jaz ti darujem kos zemlje več nego bratom tvojim, ki sem ga dobil iz roke Amorejca s svojim mečem in z lokom svojim.',
    },
    49: {
        1: 'In Jakob skliče sinove svoje ter reče: Zberite se, da vam oznanim, kar se vam bo godilo v poznejših dnevih.',
        2: 'Zberite se in čujte, sinovi Jakobovi, poslušajte, pravim, Izraela, očeta svojega!',
        3: 'Ruben, ti si prvenec moj, moč moja in začetek mogočnosti moje, prednji v visokosti in prednji v krepkosti!',
        ...
        7: 'Prokleta njiju jeza, ker silna je bila, in njiju togota, ker neusmiljena je bila: razdelim ju v Jakobu in ju razkropim v Izraelu.',
        ...
        9: 'Levov mladič je Juda; od plena, sin moj, si prišel kvišku. Počivajoč leži kakor lev in kakor levinja, kdo se ga drzne zbuditi?',
        10: 'Ne vzame se žezlo od Jude, niti vladarska palica izmed nog njegovih, dokler ne pride Šilo, in njemu bode pokorščina narodov.',
        ...
        24: 'vendar nepremičen ostane lok njegov in gibčni lahti rok njegovih, po rokah Mogočnega Jakobovega. Odtod je pastir, kamen Izraelov:',
        25: 'od mogočnega Boga očeta tvojega, ki ti bo pomagal, in od Vsegamogočnega, ki te bo blagoslovil z blagoslovi nebes odzgoraj, z blagoslovi globine odspodaj, z blagoslovi prsi in maternice.',
        ...
        28: 'Vsi ti so dvanajsteri rodovi Izraelovi; in to jim je govoril njih oče, ko jih je blagoslavljal; vsakega izmed njih je blagoslovil, kakor mu je bil določen blagoslov.',
        29: 'In zapove jim in jim reče: Ko bom zbran k ljudstvu svojemu, pokopljite me pri mojih očetih, v jamo, ki je na njivi Efrona Hetejca,',
        30: 'v jamo, ki je na njivi Makpeli, nasproti Mamri v deželi Kanaanski, ki jo je kupil Abraham ž njivo vred od Efrona Hetejca v groba posest:',
        31: 'tam so pokopali Abrahama in Saro, ženo njegovo, tam so pokopali Izaka in Rebeko, ženo njegovo, in tam sem pokopal Lejo.',
        32: 'Kupljena je ona njiva in jama, ki je na njej, od Hetovih sinov.',
        33: 'In ko je Jakob nehal zapovedovati sinom svojim, potegne noge svoje v posteljo in umrje, in zbran je bil k svojim ljudstvom.',
    },
    50: {
        ...
        7: 'Šel je torej Jožef gori pokopat očeta svojega, in ž njim so šli vsi služabniki Faraonovi, starejšine hiše njegove in vsi starejšine dežele Egiptovske,',
        ...
        9: 'Šli so ž njim gori tudi vozovi in konjiki, tako da je bil izprevod silno velik.',
        ...
        11: 'Ko so torej videli tiste pokrajine prebivalci, Kanaanci, žalovanje na Gumnu divjih rož, so rekli: To je hudo žalovanje Egipčanov. Zato se je imenovalo ime tistega kraja Abel mizraim, ki je onkraj Jordana.',
        12: 'Storili so mu tedaj sinovi njegovi natanko, kakor jim je bil zapovedal,',
        13: 'in nesli so ga sinovi njegovi v deželo Kanaansko in so ga pokopali na njivi Makpeli v jami, ki jo je bil Abraham kupil ž njivo vred v groba posest od Efrona Hetejca, Mamri nasproti.',
        14: 'In ko je pokopal očeta svojega, se vrne Jožef v Egipt, on in bratje njegovi in vsi, kar jih je šlo ž njim pokopavat očeta njegovega.',
        ...
        17: 'Tako recite Jožefu: Ah, odpusti, prosim, prestopek bratov svojih in njih greh, da so ti hudo storili. Odpusti torej zdaj, prosimo, prestopek hlapcem Boga očeta svojega. Jožef pa se je jokal, ko so oni govoril ž njim.',
        ...
        21: 'Sedaj torej se ne bojte: jaz bom živil vas in otroke vaše. Tako jih je tolažil in govoril, da jim je seglo v srce.',
        ...
        24: 'In Jožef reče bratom svojim: Skoraj umrem, Bog pa vas gotovo obišče in dá, da pojdete gori iz te dežele v deželo, ki jo je s prisego obljubil Abrahamu, Izaku in Jakobu.',
        25: 'In Jožef zapriseže sinove Izraelove, rekoč: Gotovo vas obišče Bog, odnesite potem kosti moje odtod.',
