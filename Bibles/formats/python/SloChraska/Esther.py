...
CHAPTERS = {
    1: {
        1: 'In zgodi se v dneh Ahasvera (to je tisti Ahasver, ki je kraljeval od Indije do Etiopije nad sto in sedemindvajsetimi pokrajinami),',
        ...
        22: 'kajti poslal je liste v vse kraljeve pokrajine, v vsako pokrajino po njenem pismu in vsakemu ljudstvu po njegovem jeziku, da naj bode vsak mož v hiši svoji gospodar in govori po jeziku ljudstva svojega.',
    },
    2: {
        ...
        7: 'Ta je redil Hadaso (ta je Estera), svojega strica hčer; zakaj ni imela ne očeta, ne matere. In ta mladenka je bila lepe postave in zalega obraza. In ko sta bila umrla njen oče in mati, si jo je Mardohej vzel za hčer.',
        ...
        9: 'In deklica mu je ugajala in našla milost pred njim. In podvizal se je, da ji da njene potrebščine za očiščevanje in njene deleže in sedem deklet, ki so bile zanjo izbrane iz kraljeve hiše; in prestavil jo je ž njenimi deklicami v najboljši kraj ženske hiše.',
        10: 'Estera pa ni naznanila ljudstva svojega, ne rodovine svoje, zakaj Mardohej ji je bil zapovedal, naj tega ne pove.',
        11: 'In Mardohej se je vsak dan izprehajal pred dvoriščem ženske hiše, da bi zvedel, ali se dobro vede Esteri in kaj se ž njo godi.',
        ...
        14: 'Zvečer je šla in zjutraj se je vrnila v drugo žensko hišo pod roko Saasgaza, kraljevega komornika, ki je varoval priležnice; ni šla več h kralju, razen če si jo je kralj priljubil in je bila poklicana po imenu.',
        ...
        16: 'Estera je bila torej vzeta h kralju Ahasveru, v njegovo hišo kraljevo, v desetem mesecu, ki je mesec Tebet, v sedmem letu njegovega kraljevanja.',
        17: 'In kralj je ljubil Estero mimo vseh žen, in pridobila si je naklonjenost in milost v očeh njegovih bolj nego vse device, tako da ji je bil posadil kraljičino krono na glavo in jo storil za kraljico namesto Vaste.',
        ...
        23: 'In ko se je stvar preiskala in dokazala, so oba obesili na drevje, in zapisano je bilo v knjigo letopisov pred kraljem.',
    },
    3: {
    ...
    4: {
        ...
        16: 'Pojdi, zberi vse Jude, ki bivajo v Susanu, in postite se zame, da ne jeste in ne pijete tri dni, ne dan, ne noč; tudi jaz s svojimi deklami se bomo enako postile. In potem pojdem noter h kralju, dasi ni po postavi; in ako poginem, naj poginem!',
    ...
    5: {
        ...
        7: 'Nato odgovori Estera in reče: Moja prošnja in moja želja je:',
        ...
        11: 'In Haman jim razklada slavo svojega bogastva in koliko ima sinov in vse, s čimer ga je kralj poveličal in kako ga je povzdignil nad kneze in služabnike kraljeve.',
    ...
    8: {
        ...
        11: 'da je kralj dovolil Judom po vseh mestih, da se zbero in branijo življenje svoje, da pokončajo in pomore in pogube vso vojno moč ljudstva in pokrajin, ki bi napadla nje, njih otročiče in žene, in da zaplenijo njih imetje',
        ...
        14: 'Brzi sli, ki so jezdili na kraljevih konjih, so odšli, podvizaje se po kraljevi zapovedi. In ukaz se je izdal na gradu Susanu.',
    ...
    9: {
        ...
        3: 'In vsi knezi pokrajin in kraljevi namestniki in deželski oblastniki in oskrbniki kraljevih opravil so podpirali Jude, kajti navdal jih je strah pred Mardohejem.',
        ...
        8: 'Porata, Adalija, Aridata,',
        9: 'Parmasta, Arisaja, Aridaja in Vajzata,',
        10: 'desetero sinov Hamana, sinu Hamedata, sovražnika Judov, so pobili, ali po plenu niso segli s svojo roko.',
        ...
        17: 'trinajsti dan meseca Adarja; in štirinajsti dan meseca so počivali in ga naredili za dan gostovanja in veselja.',
        18: 'Judje pa, ki so bili v Susanu, so se zbrali trinajsti in štirinajsti dan meseca, in petnajsti dan so počivali ter ga naredili za dan gostovanja in veselja.',
        ...
        20: 'In Mardohej je spisal te zgodbe in poslal liste vsem Judom, ki so bili po vseh pokrajinah kralja Ahasvera, bližnjim in daljnim,',
