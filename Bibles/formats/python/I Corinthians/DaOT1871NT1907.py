...
CHAPTERS = {
    1: {
        ...
        20: 'Hvor er der en viis? hvor er der en skriftklog? hvor er der en Ordkæmper af denne Verden? har Gud ikke gjort Verdens Visdom til Daarskab?',
    ...
    2: {
        ...
        7: 'men vi tale Visdom fra Gud, den hemmelige, den, som var skjult, som Gud før Verdens Begyndelse forudbestemte til vor Herlighed,',
        8: 'hvilken ingen af denne Verdens Herskere har erkendt; thi havde de erkendt den, havde de ikke korsfæstet Herlighedens Herre;',
    ...
    3: {
        ...
        18: 'Ingen bedrage sig selv! Dersom nogen tykkes at være viis iblandt eder i denne Verden, han vorde en Daare, for at han kan vorde viis.',
