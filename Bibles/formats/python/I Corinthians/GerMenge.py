...
CHAPTERS = {
    ...
    2: {
        ...
        6: 'Was wir aber vortragen, ist dennoch Weisheit – bei den Vollkommenen, jedoch nicht die Weisheit dieser Weltzeit, auch nicht die der Machthaber dieser Weltzeit, die dem Untergang verfallen:',
        7: 'nein, wir tragen Gottes geheimnisvolle, verborgene Weisheit vor, die Gott vor allen Weltzeiten zu unserer Verherrlichung vorherbestimmt hat.',
    ...
    8: {
        ...
        13: 'Darum, wenn Speise meinem Bruder zum Anstoß wird, so will ich in Ewigkeit kein Fleisch genießen, um meinem Bruder kein Ärgernis zu bereiten.',
    },
    9: {
    ...
    10: {
        ...
        11: 'Dies alles ist jenen aber vorbildlicherweise widerfahren und ist niedergeschrieben worden zur Warnung für uns, denen das Ende der Weltzeiten nahe bevorsteht.',
