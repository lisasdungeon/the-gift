...
CHAPTERS = {
    ...
    7: {
        ...
        12: 'Maar den anderen zeg ik, niet de Heere: Indiën enig broeder een ongelovige vrouw heeft, en dezelve tevreden is bij hem te wonen, dat hij ze niet verlate;',
    ...
    9: {
        ...
        11: 'Indiën wij ulieden het geestelijke gezaaid hebben, is het een grote zaak, zo wij het uwe, dat lichamelijk is, maaien?',
        12: 'Indiën anderen deze macht over u deelachtig zijn, waarom niet veel meer wij? Doch wij hebben deze macht niet gebruikt, maar wij verdragen het al, opdat wij niet enige verhindering geven aan het Evangelie van Christus.',
    ...
    12: {
        ...
        15: 'Indiën de voet zeide: Dewijl ik de hand niet ben, zo ben ik van het lichaam niet; is hij daarom niet van het lichaam?',
    ...
    14: {
        ...
        11: 'Indiën ik dan de kracht der stem niet weet, zo zal ik hem, die spreekt, barbaars zijn; en hij, die spreekt, zal bij mij barbaars zijn.',
        ...
        23: 'Indiën dan de gehele Gemeente bijeenvergaderd ware, en zij allen in vreemde talen spraken, en enige ongeleerden of ongelovigen inkwamen, zouden zij niet zeggen, dat gij uitzinnig waart?',
        ...
        37: 'Indiën iemand meent een profeet te zijn, of geestelijke, die erkenne, dat, hetgeen ik u schrijf, des Heeren geboden zijn.',
    ...
    15: {
        ...
        12: 'Indiën nu Christus gepredikt wordt, dat Hij uit de doden opgewekt is, hoe zeggen sommigen onder u, dat er geen opstanding der doden is?',
        ...
        19: 'Indiën wij alleenlijk in dit leven op Christus zijn hopende, zo zijn wij de ellendigste van alle mensen.',
    ...
    16: {
        ...
        17: 'En ik verblijde mij over de aankomst van Stefanas, en Fortunatus, en Achaïkus, want dezen hebben vervuld hetgeen mij aan u ontbrak;',
        ...
        22: 'Indiën iemand den Heere Jezus Christus niet liefheeft, die zij een vervloeking; Maran-atha!',
        23: 'De genade van den Heere Jezus Christus zij met u.',
        24: 'Mijn liefde zij met u allen in Christus Jezus. Amen. De eerste brief aan de Korinthiërs werd geschreven vanuit Filippi door Stefanas en Fortunatus en Achaicus en Timotheüs.',
    },
}
