...
CHAPTERS = {
    1: {
        1: 'Phao-lô, theo ý Ðức Chúa Trời, được gọi làm sứ đồ của Ðức Chúa Jêsus Christ, cùng Sốt-then, anh em chúng tôi,',
        2: 'gởi cho Hội thánh Ðức Chúa Trời tại thành Cô-rinh-tô, tức là cho những người đã được nên thánh trong Ðức Chúa Jêsus Christ, được gọi làm thánh đồ, lại cho mọi người bất luận nơi nào, cầu khẩn danh Ðức Chúa Jêsus Christ chúng ta, là Chúa của những người ấy và của chúng ta:',
        3: 'nguyền xin anh em được ân điển và sự bình an ban cho bởi Ðức Chúa Trời, Cha chúng ta, và bởi Ðức Chúa Jêsus Christ!',
        4: 'Tôi hằng vì anh em tạ ơn Ðức Chúa Trời, bởi cớ anh em đã được Ðức Chúa Trời ban ơn trong Ðức Chúa Jêsus Christ;',
        5: 'vì chưng anh em đã được dư dật về mọi điều ban cho, cả lời nói và sự hiểu biết,',
        6: 'như lời chứng về Ðấng Christ đã được vững bền giữa anh em.',
        7: 'Anh em đang trông đợi kỳ Ðức Chúa Jêsus Christ chúng ta hiện đến, cũng chẳng thiếu một ơn nào.',
        8: 'Ngài sẽ khiến anh em được vững bền đến cuối cùng, để khỏi bị quở trách trong ngày của Ðức Chúa Jêsus Christ chúng ta.',
        9: 'Ðức Chúa Trời là thành tín, Ngài đã gọi anh em được thông công với Con Ngài là Ðức Chúa Jêsus Christ, Chúa chúng ta.',
        10: 'Hỡi Anh em, tôi nhơn danh Ðức Chúa Jêsus Christ chúng ta, khuyên anh em thảy đều phải đồng một tiếng nói với nhau, chớ phân rẽ nhau ra, nhưng phải hiệp một ý một lòng cùng nhau.',
        ...
        13: 'Ðấng Christ bị phân rẽ ra sao? Có phải Phao-lô đã chịu đóng đinh trên cây thập tự thế cho anh em, hay là anh em đã nhơn danh Phao-lô mà chịu phép báp tem sao?',
        14: 'Tôi tạ ơn Ðức Chúa Trời, vì ngoài Cơ-rít-bu và Gai-út, tôi chưa từng làm phép báp tem cho ai trong anh em,',
        ...
        21: 'Vì, tại thế gian cậy sự khôn ngoan mình, chẳng nhờ sự khôn ngoan Ðức Chúa Trời mà nhận biết Ðức Chúa Trời, nên Ngài đành lòng dùng sự giảng dồ dại của chúng ta mà cứu rỗi những người tin cậy.',
        22: 'Vả, đương khi người Giu-đa đòi phép lạ, người Gờ-réc tìm sự khôn ngoan,',
        23: 'thì chúng ta giảng Ðấng Christ bị đóng đinh trên cây thập tự, là sự người Giu-đa lấy làm gương xấu, dân ngoại cho là dồ dại;',
        24: 'song le, về những người được gọi, bất luận người Giu-đa hay người Gờ-réc, thì Ðấng Christ là quyền phép của Ðức Chúa Trời và sự khôn ngoan của Ðức Chúa Trời.',
    ...
    5: {
        ...
        3: 'Về phần tôi, thân dầu xa cách mà lòng ở tại đó, (vì anh em và lòng tôi được hội hiệp với quyền phép của Ðức Chúa Jêsus, là Chúa chúng ta),',
        4: 'nên tôi đã dường như có mặt ở đó, nhơn danh Ðức Chúa Jêsus là Chúa chúng ta, tuyên án kẻ phạm tội đó',
        5: 'rằng, một người như thế phải phó cho quỉ Sa tan, để hủy hoại phần xác thịt, hầu cho linh hồn được cứu trong ngày Ðức Chúa Jêsus.',
        6: 'Thật anh em chẳng có cớ mà khoe mình đâu! Anh em há chẳng biết rằng một chút men làm cho cả đống bột dậy lên sao?',
        7: 'Hãy làm cho mình sạch men cũ đi, hầu cho anh em trở nên bột nhồi mới không men, như anh em là bánh không men vậy. Vì Ðấng Christ là con sinh lễ Vượt Qua của chúng ta, đã bị giết rồi.',
        ...
        13: 'Còn như kẻ ở ngoài, thì Ðức Chúa Trời sẽ đoán xét họ. Hãy trừ bỏ kẻ gian ác khỏi anh em.',
    },
    6: {
        ...
        9: 'Anh em há chẳng biết những kẻ không công bình chẳng bao giờ hưởng được nước Ðức Chúa Trời sao?',
        ...
        11: 'Trước kia anh em ít nữa cũng có một đôi người như thế; nhưng nhơn danh Ðức Chúa Jêsus Christ, và nhờ Thánh Linh của Ðức Chúa Trời chúng ta, thì anh em được rửa sạch, được nên thánh, được xưng công bình rồi.',
        ...
        13: 'Ðồ ăn vì bụng, bụng vì đồ ăn, Ðức Chúa Trời sẽ hủy hoại cái nọ và cái kia. Nhưng thân thể chẳng phải vì sự dâm dục đâu, bèn là vì Chúa, và Chúa vì thân thể;',
        14: 'và Ðức Chúa Trời là Ðấng đã khiến Chúa sống lại, cũng sẽ lấy quyền phép mình khiến chúng ta sống lại nữa.',
        15: 'Anh em há chẳng biết thân thể mình là chi thể của Ðấng Christ sao? Vậy thì mình có nên lấy chi thể của Ðấng Christ mà làm thành chi thể của điếm đĩ chăng? Ðức Chúa Trời nào nỡ vậy!',
        ...
        19: 'Anh em há chẳng biết rằng thân thể mình là đền thờ của Ðức Thánh Linh đang ngự trong anh em, là Ðấng mà anh em đã nhận bởi Ðức Chúa Trời, và anh em chẳng phải thuộc về chính mình sao?',
        20: 'Vì chưng anh em đã được chuộc bằng giá cao rồi. Vậy, hãy lấy thân thể mình làm sáng danh Ðức Chúa Trời.',
    },
    7: {
    ...
    8: {
        1: 'Luận đến của cùng các thần tượng thì chúng ta biết mình đều có sự hay biết cả. Song sự hay biết sanh kiêu căng, còn sự yêu thương làm gương tốt.',
        2: 'Nếu có ai tưởng mình biết điều gì, thật người ấy chưa biết như mình nên biết.',
        3: 'Nhưng nếu có một người yêu mến Ðức Chúa Trời, thì Ðức Chúa Trời biết người đó.',
        4: 'Vậy, về sự ăn ở của cúng tế các thần tượng, chúng ta biết thần tượng trong thế gian thật là hư không, chỉ có một Ðức Chúa Trời, chớ không có thần nào khác.',
        5: 'Thật người ta xưng có các thần khác, hoặc ở trên trời, hoặc ở dưới đất, (bởi đó họ thờ nhiều thần nhiều Chúa),',
        6: 'về phần chúng ta, chỉ có một Ðức Chúa Trời mà thôi, là Ðức Chúa Cha, muôn vật bởi Ngài mà ra, và chúng ta hướng về Ngài; lại chỉ có một Chúa mà thôi, là Ðức Chúa Jêsus Christ, muôn vật đều nhờ Ngài mà có, và chúng ta cũng vậy.',
        ...
        8: 'Vả, ấy chẳng phải là đồ ăn làm cho chúng ta được đẹp lòng Ðức Chúa Trời; nếu chúng ta ăn, chẳng được ích gì, bằng không ăn, cũng chẳng tổn gì.',
    ...
    9: {
        1: 'Tôi chẳng được tự do sao? Tôi chẳng phải là sứ đồ sao? Tôi há chẳng từng thấy Ðức Chúa Jêsus là Chúa chúng ta sao? Anh em há chẳng phải là công việc tôi trong Chúa sao?',
        ...
        9: 'Vì chưng có chép trong luật pháp Môi-se rằng: Ngươi chớ khớp miệng con bò đang đạp lúa. Há phải Ðức Chúa Trời lo cho bò sao?',
        ...
        21: 'với những người không luật pháp, (dầu đối với Ðức Chúa Trời tôi không phải là không luật pháp, vì tôi ở dưới luật pháp của Ðấng Christ), song tôi cũng ở như người không luật pháp.',
    ...
    10: {
        ...
        4: 'và uống một thứ uống thiêng liêng; vì họ uống nơi một hòn đá thiêng liêng theo mình và đá ấy tức là Ðấng Christ.',
        5: 'Song phần nhiều trong vòng họ không đẹp lòng Ðức Chúa Trời, nên đã ngã chết nơi đồng vắng.',
        ...
        16: 'Cái chén phước lành mà chúng ta chúc phước, há chẳng phải là thông với huyết của Ðấng Christ sao? Cái bánh mà chúng ta bẻ, há chẳng phải là thông với thân thể của Ðấng Christ sao?',
        ...
        32: 'Ðừng làm gương xấu cho người Giu-đa, người Gờ-réc, hay là Hội thánh của Ðức Chúa Trời;',
    ...
    11: {
        1: 'Hãy bắt chước tôi, cũng như chính mình tôi bắt chước Ðấng Christ vậy.',
        2: 'Tôi khen anh em vì hay nhớ đến tôi trong mọi dịp, và lấy lòng trung tín mà giữ những điều tôi đã dạy dỗ anh em.',
        3: 'Dầu vậy, tôi muốn anh em biết Ðấng Christ là đầu mọi người; người đờn ông là đầu người đờn bà; và Ðức Chúa Trời là đầu của Ðấng Christ.',
        ...
        22: 'Anh em há chẳng có nhà để ăn uống sao? Hay là anh em khinh bỉ Hội thánh của Ðức Chúa Trời, muốn làm cho những kẻ không có gì phải hổ thẹn? Tôi nên nói chi với anh em? Có nên khen anh em không? Trong việc nầy tôi chẳng khen đâu.',
    ...
    12: {
        ...
        3: 'Bởi đó, tôi tỏ cùng anh em, chẳng ai cảm Thánh Linh của Ðức Chúa Trời, mà nói rằng: Ðức Chúa Jêsus đáng nguyền rủa! Nếu không cảm Ðức Thánh Linh, cũng chẳng ai xưng Ðức Chúa Jêsus là Chúa!',
        4: 'Vả, có các sự ban cho khác nhau, nhưng chỉ có một Ðức Thánh Linh.',
        5: 'Có các chức vụ khác nhau, nhưng chỉ có một Chúa.',
        6: 'Có các việc làm khác nhau, nhưng chỉ có một Ðức Chúa Trời, là Ðấng làm mọi việc trong mọi người.',
        7: 'Ðức Thánh Linh tỏ ra trong mỗi một người, cho ai nấy đều được sự ích chung.',
        8: 'Vả, người nầy nhờ Ðức Thánh Linh, được lời nói khôn ngoan; kẻ kia nhờ một Ðức Thánh Linh ấy, cũng được lời nói có tri thức.',
        9: 'Bởi một Ðức Thánh Linh, cho người nầy được đức tin; cũng bởi một Ðức Thánh Linh ấy, cho kẻ kia được ơn chữa tật bịnh;',
        ...
        18: 'Nhưng bây giờ, Ðức Chúa Trời đã sắp đặt các chi thể của thân chúng ta, ban cho mỗi một chi thể cái địa vị theo ý Ngài lấy làm tốt mà chỉ định.',
        ...
        24: 'còn như cái nào đã đẹp rồi, thì không cần trau giồi. Nhưng Ðức Chúa Trời đã sắp đặt thân người, để chi thể nào thiếu thốn thì được quí trọng hơn,',
        ...
        27: 'Vả, anh em là thân của Ðấng Christ, và là chi thể của thân, ai riêng phần nấy.',
        28: 'Ðức Chúa Trời đã lập trong Hội thánh, thứ nhứt là sứ đồ, thứ nhì là đấng tiên tri, thứ ba là thầy giáo, kế đến kẻ làm phép lạ, rồi kẻ được ơn chữa bịnh, cứu giúp, cai quản, nói các thứ tiếng.',
    ...
    14: {
        ...
        2: 'Vì người nào nói tiếng lạ, thì không phải nói với người ta, bèn là với Ðức Chúa Trời, bởi chẳng có ai hiểu (ấy là trong tâm thần mà người kia nói lời mầu nhiệm);',
        ...
        12: 'Ấy vậy, vì anh em nôn nả ước ao các sự ban cho thiêng liêng, hãy tìm cho được dư dật đặng gây dựng Hội thánh.',
        ...
        18: 'Tôi tạ ơn Ðức Chúa Trời, vì đã được ơn nói tiếng lạ nhiều hơn hết thảy anh em;',
        ...
        28: 'Nếu không có ai thông giải, thì người đó phải làm thinh ở trong Hội thánh, mình nói với mình và với Ðức Chúa Trời.',
        ...
        33: 'Vả, Ðức Chúa Trời chẳng phải là Chúa của sự loạn lạc, bèn là Chúa sự hòa bình. Hãy làm như trong cả Hội thánh của các thánh đồ,',
        ...
        36: 'Có phải là đạo Ðức Chúa Trời ra từ nơi anh em, hoặc chỉ đến cùng anh em mà thôi chăng?',
        37: 'Nếu ai tưởng mình là tiên tri, hay là được Ðức Thánh Linh soi sáng, thì người ấy hãy biết rằng đều tôi viết cho anh em đây là mạng lịnh của Chúa.',
        38: 'Mà nếu ai muốn bỏ qua thì mặc họ bỏ qua!',
        39: 'Ấy vậy, hỡi anh em, hãy trông mong ơn nói tiên tri, và đừng ngăn trở chi về điều nói tiếng lạ.',
