...
CHAPTERS = {
    1: {
        ...
        4: 'I always thank God about you for the blessing bestowed on you in Christ Jesus.',
        ...
        7: 'There is no gift in which you are deficient, while waiting for the appearing of our Lord Jesus Christ.',
        ...
        13: 'You have torn the Christ in pieces! Was it Paul who was crucified for you? Or were you baptized into the faith of Paul?',
        ...
        18: 'The message of the cross is indeed mere folly to those who are in the path to ruin, but to us who are in the path of salvation it is the power of God.',
        19: 'For scripture says — ‘I will bring the philosophy of the philosophers to nought, and the shrewdness of the shrewd I will bring to nothing.’',
    ...
    2: {
        ...
        2: 'for I had determined that, while with you, I would forget everything Jesus Christ — and him crucified!',
        ...
        8: 'This philosophy is not known to any of the leaders of today; for, had they known it, they would not have crucified our glorified Lord.',
        9: "It is what scripture speaks of as — ‘What eye never saw, nor ear ever heard, what never entered people's minds — even all that God has prepared for those who love him.’",
    ...
    3: {
        ...
        4: 'When one says ‘I follow Paul,’ and another ‘I follow Apollos,’ are not you like other people?',
        ...
        18: 'Let no one deceive himself. If any one among you imagines that, as regards this world, they are wise, let them become a ‘fool,’ that they may become wise.',
    ...
    4: {
        ...
        10: 'We, for Christ’s sake, are ‘fools,’ but you, by your union with Christ, are people of discernment. We are weak, but you are strong. You are honoured, but we are despised.',
    ...
    6: {
        ...
        9: 'Do not you know that wrong-doers will have no share in God’s kingdom? Do not be deceived. No one who is immoral, or an idolater, or an adulterer, or licentious, or a sexual pervert,',
    ...
    7: {
        ...
        15: 'However, if the unbeliever wishes to be separated, let him be so. Under such circumstances neither is bound; God has called you to live in peace.',
    ...
    8: {
        ...
        10: 'For if some one should see you who possess this knowledge, feasting in an idol’s temple, will not their conscience, if they are weak, become so hardened that they, too, will eat food offered to idols?',
    ...
    9: {
        ...
        5: 'Have not we a right to take a wife with us, if she is a Christian, as the other apostles and the Master’s brothers and Cephas all do?',
        ...
        9: 'For in the law of Moses it is said — ‘You should not muzzle a bullock while it is treading out the grain.’ Is it the bullocks that God is thinking of?',
        ...
        24: 'Do not you know that on a racecourse, though all run, yet only one wins the prize? Run in such a way that you may win.',
    ...
    11: {
        ...
        19: 'Indeed, there must be actual parties among you, for so only will the people of real worth become known.',
        ...
        34: 'If anyone is hungry, let them eat at home, so that your meetings may not bring a judgment on you. The other details I will settle when I come.',
    },
    12: {
    ...
    14: {
        ...
        37: 'If anyone thinks that he has the gift of preaching or any other spiritual gift, let him recognise that what I am now saying to you is a command from the Lord.',
