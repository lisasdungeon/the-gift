...
CHAPTERS = {
    ...
    5: {
        ...
        7: 'εκκαθαρατε εκκαθαρατε ουν την παλαιαν ζυμην ινα ητε νεον φυραμα καθως εστε αζυμοι και γαρ το πασχα ημων υπερ ημων ετυθη χριστος',
    ...
    6: {
        ...
        16: 'ουκ η ουκ οιδατε οτι ο κολλωμενος τη πορνη εν σωμα εστιν εσονται γαρ φησιν οι δυο εις σαρκα μιαν',
    ...
    7: {
        ...
        29: 'τουτο δε φημι αδελφοι ο καιρος συνεσταλμενος το λοιπον εστιν ινα και οι εχοντες γυναικας ως μη εχοντες ωσιν',
        ...
        34: 'μεμερισται και η γυνη και η παρθενος η αγαμος μεριμνα τα του κυριου ινα η αγια και σωματι και πνευματι η δε γαμησασα μεριμνα τα του κοσμου πως αρεσει τω ανδρι',
        ...
        39: 'γυνη δεδεται νομω εφ οσον χρονον ζη ο ανηρ αυτης εαν δε και κοιμηθη ο ανηρ ελευθερα εστιν ω θελει γαμηθηναι μονον εν κυριω',
    ...
    8: {
        ...
        5: 'και γαρ ειπερ εισιν λεγομενοι θεοι ειτε εν ουρανω ειτε επι γης της γης ωσπερ εισιν θεοι πολλοι και κυριοι πολλοι',
    ...
    9: {
        ...
        9: 'εν γαρ τω μωυσεως μωσεως νομω γεγραπται ου φιμωσεις βουν αλοωντα μη των βοων μελει τω θεω',
    ...
    10: {
        ...
        8: 'μηδε πορνευωμεν καθως τινες αυτων επορνευσαν και επεσον εν μια ημερα εικοσι τρεις χιλιαδες',
    ...
    11: {
        ...
        27: 'ωστε ος αν εσθιη τον αρτον τουτον η πινη το ποτηριον του κυριου αναξιως του κυριου ενοχος εσται του σωματος και του αιματος του κυριου',
    ...
    13: {
        ...
        3: 'και εαν ψωμισω παντα τα υπαρχοντα μου και εαν παραδω το σωμα μου ινα καυθησωμαι καυθησομαι αγαπην δε μη εχω ουδεν ωφελουμαι',
