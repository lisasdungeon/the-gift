...
CHAPTERS = {
    ...
    2: {
        1: 'Ihr wißt es selbst, Brüder, daß unser Aufenthalt bei euch nicht erfolglos gewesen ist.',
        2: 'Sondern trotz der Leiden und Mißhandlungen, die wir vorher, wie euch bekannt ist, in Philippi erfahren hatten, gewannen wir doch im Vertrauen auf Gott den Mut, bei euch die Frohe Botschaft unter schwerem Kampf zu verkündigen.',
        3: 'Denn unsere Predigt stammt nicht aus Irrwahn oder Unlauterkeit, noch geht sie mit Täuschung um.',
        4: 'Sondern da wir von Gott für würdig geachtet sind, mit der Heilsbotschaft betraut zu werden, so reden wir nun auch, nicht um Menschen zu gefallen, sondern Gott, der unsere Herzen prüft.',
        5: 'Denn wir sind nie mit Schmeichelworten umgegangen — das wißt ihr. Wir haben uns auch nie von Habsucht leiten lassen — des ist Gott Zeuge.',
        6: 'Auch haben wir niemals Ehre von Menschen gesucht, weder von euch noch von anderen.',
        7: 'Aber wir sind mit euch so zart und linde umgegangen wie eine Mutter, die ihre Kinder herzt und hegt.',
        8: 'In solcher inniger Liebe zu euch waren wir bereit, euch nicht nur Gottes Heilsbotschaft, sondern auch unser Leben zu schenken, — so lieb hatten wir euch gewonnen.',
        9: 'Ihr denkt gewiß noch, Brüder, an unsere Mühen und Beschwerden. Tag und Nacht haben wir gearbeitet, um bei der Verkündigung der Frohen Botschaft Gottes keinem von euch zur Last zu fallen.',
        10: 'Ihr seid Zeugen und Gott, wie heilig und gerecht und untadelig wir mit euch Gläubigen umgegangen sind.',
        11: 'Wie ein Vater seine Kinder, so haben auch wir — das wißt ihr — jeden einzelnen von euch ermahnt, ermuntert',
        12: 'und dringend gebeten, so zu wandeln, wie es Gott würdig ist, der euch fort und fort zu seinem Königreich und zu seiner Herrlichkeit beruft.',
        13: 'Deshalb danken wir auch Gott unablässig dafür, daß ihr das von uns verkündigte Wort Gottes nicht als Menschenwort aufgenommen habt, sondern — was es auch in Wahrheit ist — als Gotteswort, das sich auch in euch Gläubigen wirksam zeigt.',
        14: 'Denn in der Gemeinschaft mit Christus Jesus seid ihr, liebe Brüder, Nachfolger der Gemeinden Gottes in Judäa geworden, weil ihr von euern Volksgenossen dasselbe erduldet habt, was jenen von den Juden widerfahren ist.',
        15: 'Die haben den Herrn Jesus und die Propheten getötet und uns verfolgt; sie gefallen Gott nicht und sind aller Menschen Widersacher.',
        16: 'Denn sie suchen uns daran zu hindern, den Heiden zu ihrem Heil zu predigen. So sind sie fort und fort dabei, das Maß ihrer Sünden vollzumachen. Der Zorn (Gottes), der sie vernichten soll, ist schon über sie gekommen.',
        17: 'Wenn wir, liebe Brüder, auch für kurze Zeit dem Angesicht, aber nicht dem Herzen nach von euch geschieden sind, so haben wir doch lebhaft und mit großer Sehnsucht nach einem Wiedersehen mit euch getrachtet.',
        18: 'Deshalb wollten wir auch zu euch kommen — ich, Paulus habe diese Absicht wiederholt gehabt —, doch der Satan hat uns daran gehindert.',
        19: 'Denn wer sonst als ihr ist unsere Hoffnung, Freude oder Ruhmeskrone vor dem Angesicht unseres Herrn Jesus Christus, wenn er wiederkommt?',
        20: 'Ja, ihr seid unsere Ehre, unsere Freude!',
    },
    3: {
    ...
    4: {
        1: 'Ihr habt schon, liebe Brüder, von uns gehört, wie ihr wandeln müßt, um Gott zu gefallen. Und ihr seid auch auf dem rechten Weg. Doch nun bitten und ermahnen wir euch in dem Namen des Herrn Jesus: Schreitet ihr weiter vorwärts!',
        2: 'Ihr wißt ja, welche Gebote wir euch im Auftrag des Herrn Jesus gegeben haben.',
        3: 'Gott will, ihr sollt ein heiliges Leben führen und mit der Unzucht nichts zu schaffen haben.',
        4: 'Darum sehe jeder von euch zu, ein Eheweib heimzuführen, um mit ihr in Heiligkeit und Ehrbarkeit zusammenzuleben.',
        5: 'Niemand lasse sich nach Art der Heiden, die Gott nicht kennen, durch sinnliche Lust dazu verführen,',
        6: 'in die ehelichen Rechte seines Bruders überzugreifen und ihn durch Ehebruch zu betrügen. Alle solche Sünden straft der Herr, wie wir euch schon früher gesagt und bezeugt haben.',
        7: 'Denn Gott hat uns nicht dazu berufen, ein unreines, sondern ein heiliges Leben zu führen.',
        8: 'Wer also (diese Mahnungen) mißachtet, der mißachtet nicht einen Menschen, sondern Gott, der euch auch seinen Heiligen Geist gegeben hat.',
        9: 'Von der Bruderliebe braucht man euch nicht erst zu schreiben. Denn ihr habt selbst von Gott gelernt, einander zu lieben.',
        10: 'Und ihr beweist das auch an allen Brüdern in ganz Mazedonien. Doch ermahnen wir euch, Brüder: Betätigt diese Liebe immer mehr!',
        ...
        12: 'Ihr müßt denen, die draußen sind, durch euern Wandel ein gutes Vorbild geben und dürft nicht auf fremde Unterstützung angewiesen sein.',
        ...
        15: 'Denn dies tun wir euch kund, gestützt auf ein Wort des Herrn: Wir, die Lebenden, die bis zur Wiederkunft des Herrn übrigbleiben, werden den Entschlafenen nicht zuvorkommen.',
        16: 'Sobald der Befehlsruf ergeht, die Erzengelstimme erschallt und Gottes Posaune ertönt, wird der Herr selbst vom Himmel herabkommen, und dann ist das erste Ereignis, daß die im Glauben an Christus Gestorbenen auferstehen.',
        17: 'Darauf werden wir, die Lebenden, die übrigbleiben, zugleich mit ihnen auf Wolken in die Luft entrückt, um dort dem Herrn zu begegnen, und so werden wir allezeit mit dem Herrn vereinigt sein.',
