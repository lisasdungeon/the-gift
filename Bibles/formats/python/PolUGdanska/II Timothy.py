...
CHAPTERS = {
    1: {
        1: 'Paweł, apostoł Jezusa Chrystusa z woli Boga, zgodnie z obietnicą życia, które jest w Chrystusie Jezusie;',
        2: 'Do Tymoteusza, umiłowanego syna. Łaska, miłosierdzie i pokój od Boga Ojca i Chrystusa Jezusa, naszego Pana.',
        3: 'Dziękuję Bogu, któremu jak moi przodkowie służę z czystym sumieniem, że nieustannie ciebie wspominam w swoich modlitwach, w nocy i we dnie;',
        4: 'Wspominając twoje łzy, pragnę cię zobaczyć, aby napełnić się radością;',
        5: 'Pamiętając nieobłudną wiarę, która jest w tobie, a która najpierw mieszkała w twojej babce Lois i w twojej matce Eunice, jestem też pewien, że i w tobie mieszka.',
        6: 'Z tego powodu przypominam ci, abyś rozniecił dar Boży, który jest w tobie przez nałożenie moich rąk.',
        ...
        12: 'Z tego też powodu znoszę te cierpienia, ale się nie wstydzę, gdyż wiem, komu uwierzyłem, i jestem pewien, że on ma moc zachować to, co jemu powierzyłem, aż do owego dnia.',
        13: 'Trzymaj się wzoru zdrowych słów, które ode mnie usłyszałeś, w wierze i miłości, która jest w Chrystusie Jezusie.',
        14: 'Strzeż tego dobrego, które powierzył ci Duch Święty, który w nas mieszka.',
    ...
    2: {
        ...
        8: 'Pamiętaj, że Jezus Chrystus, potomek Dawida, powstał z martwych według mojej ewangelii;',
        9: 'Dla której znoszę cierpienia jak złoczyńca, aż do więzów, ale słowo Boże nie jest związane.',
        10: 'Dlatego wszystko znoszę przez wzgląd na wybranych, aby i oni dostąpili zbawienia, które jest w Chrystusie Jezusie wraz z wieczną chwałą.',
        11: 'Wiarygodne to słowa. Jeśli bowiem z nim umarliśmy, z nim też będziemy żyć.',
        12: 'Jeśli cierpimy, z nim też będziemy królować, jeśli się go wyprzemy, i on się nas wyprze.',
        13: 'Jeśli jesteśmy niewierni, on pozostaje wierny, bo samego siebie wyprzeć się nie może.',
        ...
        22: 'Uciekaj też od młodzieńczych pożądliwości, a zabiegaj o sprawiedliwość, wiarę, miłość, pokój wraz z tymi, którzy wzywają Pana z czystego serca.',
        ...
        25: 'Łagodnie nauczający tych, którzy się sprzeciwiają; może kiedyś Bóg da im pokutę, aby uznali prawdę;',
    ...
    4: {
        ...
        22: 'Pan Jezus Chrystus niech będzie z twoim duchem. Łaska niech będzie z wami. Amen. Drugi list został napisany z Rzymu do Tymoteusza (który był ustanowiony pierwszym biskupem w Efezie), gdy Paweł był postawiony przed cesarza Nerona.',
    },
}
