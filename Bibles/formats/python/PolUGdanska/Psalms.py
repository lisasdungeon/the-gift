...
CHAPTERS = {
    ...
    30: {
        ...
        3: 'Panie, wyprowadziłeś moją duszę z piekła, zachowałeś mnie przy życiu, abym nie zstąpił do dołu.',
    ...
    60: {
        1: 'Przewodnikowi chóru, na Sussanedut. Miktam Dawida dla pouczenia; gdy walczył przeciw Syryjczykom Nacharaim i przeciw Syryjczykom Soby, gdy Joab, wracając, pobił dwanaście tysięcy Edomitów w Dolinie Soli. Boże, odrzuciłeś nas, rozproszyłeś nas i rozgniewałeś się; powróć znowu do nas.',
    ...
    76: {
        1: 'Przewodnikowi chóru, na Neginot. Psalm i pieśń Asafa. Bóg znany jest w Judzie, jego imię jest wielkie w Izraelu.',
    ...
    86: {
        ...
        13: 'Bo wielkie jest twoje miłosierdzie dla mnie; ty ocaliłeś moją duszę z najgłębszego piekła.',
    ...
    127: {
        1: 'Pieśń stopni dla Salomona. Jeśli Pan nie zbuduje domu, na próżno trudzą się ci, którzy go wznoszą; jeśli Pan nie będzie strzegł miasta, na próżno czuwa strażnik.',
    ...
    141: {
        ...
        2: 'Niech moja modlitwa będzie przed tobą jak kadzidło, a podniesienie moich rąk jak wieczorna ofiara.',
        ...
        8: 'Ale podnoszę swoje oczy do ciebie, Boże, Panie; tobie ufam, nie porzucaj mojej duszy.',
    ...
    150: {
        ...
        2: 'Chwalcie go za jego potężne dzieła; chwalcie go za jego wielką dostojność.',
