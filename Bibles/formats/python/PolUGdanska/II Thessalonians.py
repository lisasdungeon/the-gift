...
CHAPTERS = {
    1: {
        1: 'Paweł, Sylwan i Tymoteusz do kościoła Tesaloniczan, który jest w Bogu, naszym Ojcu, i Panu Jezusie Chrystusie.',
        2: 'Łaska wam i pokój od Boga, naszego Ojca, i Pana Jezusa Chrystusa.',
        3: 'Bracia, powinniśmy zawsze dziękować Bogu za was, co jest rzeczą słuszną, bo bardzo wzrasta wasza wiara i u każdego z was pomnaża się wzajemna miłość;',
        4: 'Tak że i my sami chlubimy się wami w kościołach Bożych z powodu waszej cierpliwości i wiary we wszystkich waszych prześladowaniach i uciskach, które znosicie.',
        5: 'Są one dowodem sprawiedliwego sądu Boga, abyście byli uznani za godnych królestwa Bożego, za które też cierpicie.',
        ...
        9: 'Poniosą oni karę, wieczne zatracenie od oblicza Pana i od chwały jego mocy;',
        ...
        12: 'Aby imię naszego Pana Jezusa Chrystusa zostało uwielbione w was, a wy w nim, według łaski naszego Boga i Pana Jezusa Chrystusa.',
    },
    2: {
