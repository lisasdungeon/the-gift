...
CHAPTERS = {
    ...
    15: {
        1: 'A tak my, którzy jesteśmy mocni, powinniśmy znosić słabości słabych, a nie szukać tego, co nam się podoba.',
        2: 'Dlatego każdy z nas niech szuka tego, co podoba się bliźniemu, dla dobra, ku zbudowaniu.',
        3: 'Ponieważ i Chrystus nie szukał tego, co mu się podobało, ale jak jest napisane: Urągania urągających tobie spadły na mnie.',
        4: 'Wszystko bowiem, co przedtem napisano, ku naszej nauce napisano, abyśmy przez cierpliwość i pociechę z Pism mieli nadzieję.',
        ...
        8: 'Mówię bowiem, że Jezus Chrystus był sługą obrzezania ze względu na prawdę Bożą, aby potwierdzić obietnice dane ojcom;',
        ...
        12: 'I znowu Izajasz mówi: Przyjdzie korzeń Jessego, ten, który powstanie, aby panować nad poganami. W nim poganie będą pokładać nadzieję.',
        ...
        18: 'Nie śmiałbym bowiem mówić tego, czego Chrystus nie uczyniłby przeze mnie w przywodzeniu pogan do posłuszeństwa przez słowo i uczynek;',
        ...
        31: 'Abym został wybawiony od tych, którzy są niewierzący w Judei, i żeby moja posługa, którą wykonuję dla Jerozolimy, została dobrze przyjęta przez świętych;',
    ...
    16: {
        ...
        26: 'Lecz teraz objawionej i przez Pisma proroków według postanowienia wiecznego Boga oznajmionej wszystkim narodom, by przywieść je do posłuszeństwa wierze;',
        27: 'Temu, jedynemu mądremu Bogu, niech będzie chwała przez Jezusa Chrystusa na wieki. Amen. List do Rzymian został napisany z Koryntu i wysłany przez Febę, służebnicę kościoła w Kenchrach.',
    },
}
