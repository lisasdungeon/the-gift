...
CHAPTERS = {
    ...
    2: {
        ...
        4: 'Jeśli bowiem Bóg nie oszczędził aniołów, którzy zgrzeszyli, ale strąciwszy ich do piekła, wydał więzom ciemności, aby byli zachowani na sąd;',
        5: 'Także dawnego świata nie oszczędził, ale zbawił jako ósmego Noego, kaznodzieję sprawiedliwości, gdy zesłał potop na świat bezbożnych;',
        6: 'I miasta Sodomę i Gomorę, obracając w popiół, skazał na potępienie, stawiając je jako przykład dla tych, którzy żyją bezbożnie;',
        ...
        14: 'Mając oczy pełne cudzołóstwa i nieprzestające grzeszyć, zwabiają dusze niestałe. Serce mają wyćwiczone w chciwości, synowie przekleństwa.',
        15: 'Opuścili oni prostą drogę i zbłądzili, podążając drogą Balaama, syna Bosora, który umiłował zapłatę za niesprawiedliwość;',
        ...
        21: 'Lepiej bowiem byłoby dla nich nie poznać drogi sprawiedliwości, aniżeli poznawszy ją, odwrócić się od przekazanego im świętego przykazania.',
