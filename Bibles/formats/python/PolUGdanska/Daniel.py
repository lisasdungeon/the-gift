...
CHAPTERS = {
    ...
    2: {
        ...
        49: 'Ale Daniel wyprosił króla, aby ustanowił nad sprawami prowincji Babilonu Szadraka, Meszaka i Abed-Nego; Daniel zaś pozostał w bramie króla.',
    },
    3: {
    ...
    6: {
        ...
        8: 'I tak teraz, królu, zatwierdź to prawo i podaj go na piśmie, aby było nieodwołalne według prawa Medów i Persów, które nie może być cofnięte.',
