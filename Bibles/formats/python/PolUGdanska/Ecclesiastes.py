...
CHAPTERS = {
    ...
    4: {
        ...
        5: 'Głupi składa swoje ręce i zjada własne ciało.',
        6: 'Lepsza jest pełna garść z pokojem niż obie pełne garści z trudem i utrapieniem ducha.',
        7: 'Znowu obróciłem się i zobaczyłem kolejną marność pod słońcem.',
        8: 'Jest to człowiek samotny, bez towarzysza, nie ma ani syna, ani brata i nie ma końca wszelki jego trud, a jego oczy nie mogą nasycić się bogactwem. Nie myśli: Dla kogo ja pracuję i odmawiam dobra swojej duszy? Także i to jest marnością i ciężką udręką.',
        9: 'Lepiej jest dwom niż jednemu, gdyż mają dobry pożytek ze swojej pracy.',
        ...
        13: 'Lepszy jest chłopiec ubogi i mądry niż król stary i głupi, który nie potrafi już przyjmować napomnienia.',
