...
CHAPTERS = {
    ...
    16: {
        ...
        2: 'A on im odpowiedział: Gdy nastaje wieczór, mówicie: Będzie pogoda, bo niebo się czerwieni.',
        ...
        8: 'Gdy Jezus to zauważył, powiedział im: Ludzie małej wiary, czemu rozmawiacie między sobą o tym, że nie wzięliście chleba?',
        ...
        12: 'Wtedy zrozumieli, że nie mówił, aby się strzegli zakwasu chlebowego, ale nauki faryzeuszy i saduceuszy.',
        ...
        22: 'A Piotr, wziąwszy go na bok, zaczął go strofować, mówiąc: Zmiłuj się nad sobą, Panie! Nie przyjdzie to na ciebie.',
        23: 'Lecz on odwrócił się i powiedział do Piotra: Odejdź ode mnie, szatanie! Jesteś dla mnie zgorszeniem, bo nie pojmujesz tego, co Boże, ale to, co ludzkie.',
