...
CHAPTERS = {
    ...
    6: {
        ...
        2: 'Czy nie wiecie, że święci będą sądzić świat? A jeśli świat będzie sądzony przez was, to czy nie jesteście godni osądzać sprawy pomniejsze?',
        3: 'Czy nie wiecie, że będziemy sądzić aniołów? A cóż dopiero sprawy doczesne?',
        ...
        13: 'Pokarmy są dla brzucha, a brzuch dla pokarmów. Lecz Bóg zniszczy i jedno, i drugie. Ciało zaś nie jest dla nierządu, ale dla Pana, a Pan dla ciała.',
        14: 'A Bóg i Pana wskrzesił, i nas wskrzesi swoją mocą.',
        15: 'Czyż nie wiecie, że wasze ciała są członkami Chrystusa? Czy więc wezmę członki Chrystusa i uczynię je członkami nierządnicy? Nie daj Boże!',
        16: 'Czyż nie wiecie, że ten, kto się łączy z nierządnicą, jest z nią jednym ciałem? Dwoje bowiem, mówi on, będą jednym ciałem.',
    ...
    8: {
        1: 'Co do ofiar składanych bożkom, to oczywiście wszyscy posiadamy wiedzę. Wiedza wbija w pychę, lecz miłość buduje.',
    ...
    16: {
        ...
        24: 'Miłość moja niech będzie z wami wszystkimi w Chrystusie Jezusie. Amen. Pierwszy list do Koryntian został napisany z miasta Filippi przez Stefana, Fortunata, Achaika i Tymoteusza.',
    },
}
