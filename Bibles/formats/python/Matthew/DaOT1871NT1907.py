...
CHAPTERS = {
    ...
    5: {
        ...
        22: 'Men jeg siger eder, at hver den, som bliver vred paa sin Broder uden Aarsag, skal være skyldig for Dommen; og den, som siger til sin Broder: Raka! skal være skyldig for Raadet; og den, som siger: Du Daare! skal være skyldig til Helvedes Ild.',
        ...
        29: 'Men dersom dit højre Øje forarger dig, saa riv det ud, og kast det fra dig; thi det er bedre for dig, at eet af dine Lemmer fordærves, end at hele dit Legeme bliver kastet i Helvede.',
        30: 'Og om din højre Haand forarger dig, saa hug den af og kast den fra dig; thi det er bedre for dig, at eet af dine Lemmer fordærves, end at hele dit Legeme kommer i Helvede.',
    ...
    10: {
        ...
        28: 'Og frygter ikke for dem, som slaa Legemet ihjel, men ikke kunne slaa Sjælen ihjel; men frygter hellere for ham, som kan fordærve baade Sjæl og Legeme i Helvede.',
    ...
    11: {
        ...
        23: 'Og du, Kapernaum! som er bleven ophøjet indtil Himmelen, du skal nedstødes indtil Dødsriget; thi dersom de kraftige Gerninger, som ere skete i dig, vare skete i Sodoma, da var den bleven staaende indtil denne Dag.',
    ...
    12: {
        ...
        32: 'Og den, som taler et Ord imod Menneskesønnen, ham skal det forlades; men den, som taler imod den Helligaand, ham skal det ikke forlades, hverken i denne Verden eller i den kommende.',
    ...
    13: {
        ...
        22: 'Men det, som blev saaet iblandt Torne, er den, som hører Ordet, og Verdens Bekymring og Rigdommens Forførelse kvæler Ordet, og det bliver uden Frugt.',
        ...
        39: 'og Fjenden, som saaede det, er Djævelen; og Høsten er Verdens Ende; og Høstfolkene ere Engle.',
        40: 'Ligesom nu Ugræsset sankes sammen og opbrændes med Ild, saaledes skal det ske ved Verdens Ende.',
        ...
        49: 'Saaledes skal det gaa til ved Verdens Ende. Englene skulle gaa ud og skille de onde fra de retfærdige',
    ...
    16: {
        ...
        18: 'Saa siger jeg ogsaa dig, at du er Petrus, og paa denne Klippe vil jeg bygge min Menighed, og Dødsrigets Porte skulle ikke faa Overhaand over den.',
    ...
    18: {
        ...
        8: 'Men dersom din Haand eller din Fod forarger dig, da hug den af, og kast den fra dig! Det er bedre for dig at gaa lam eller som en Krøbling ind til Livet end at have to Hænder og to Fødder og blive kastet i den evige Ild.',
        9: 'Og dersom dit Øje forarger dig, da riv det ud, og kast det fra dig! Det er bedre for dig at gaa enøjet ind til Livet end at have to Øjne og blive kastet i Helvedes Ild.',
    ...
    19: {
        ...
        16: 'Og se, en kom til ham og sagde: „Mester! hvad godt skal jeg gøre, for at jeg kan faa et evigt Liv?‟',
        ...
        29: 'Og hver, som har forladt Hus eller Brødre eller Søstre eller Fader eller Moder eller Hustru eller Børn eller Marker for mit Navns Skyld, skal faa det mange Fold igen og arve et evigt Liv.',
    ...
    21: {
        ...
        19: 'Og han saa et Figentræ ved Vejen og gik hen til det, og han fandt intet derpaa uden Blade alene. Og han siger til det: „Aldrig i Evighed skal der vokse Frugt mere paa dig!‟ Og Figentræet visnede straks.',
    ...
    23: {
        ...
        15: 'Ve eder, I skriftkloge og Farisæere, I Hyklere! thi I drage om til Vands og til Lands for at vinde en eneste Tilhænger; og naar han er bleven det, gøre I ham til et Helvedes Barn, dobbelt saa slemt, som I selv ere.',
