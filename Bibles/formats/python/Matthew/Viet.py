...
CHAPTERS = {
    1: {
        ...
        22: 'Mọi việc đã xảy ra như vậy, để cho ứng nghiệm lṀ\x9di Chúa đã dùng đấng tiên tri mà phán rằng:',
    ...
    5: {
        1: 'Ðức Chúa Jêsus xem thấy đoàn dân đông, bèn lên núi kia; khi Ngài đã ngồi, thì các môn đồ đến gần.',
        ...
        32: 'Song ta phán cùng các ngươi: Nếu người nào để vợ mà không phải vì cớ ngoại tình, thì người ấy làm cho vợ mình ra người tà dâm; lại nếu người nào cưới đờn bà bị để, thì cũng phạm tội tà dâm.',
        33: 'Các ngươi còn có nghe lời phán cho người xưa rằng: Ngươi chớ thề dối, nhưng đối với Chúa, phải giữ vẹn lời thề mình.',
        34: 'Song ta phán cùng các ngươi rằng đừng thề chi hết: đừng chỉ trời mà thề, vì là ngôi của Ðức Chúa Trời;',
        35: 'đừng chỉ đất mà thề, vì là bệ chơn của Ðức Chúa Trời; đừng chỉ thành Giê-ru-sa-lem mà thề, vì là thành của Vua lớn.',
    ...
    6: {
        ...
        4: 'hầu cho sự bố thí được kín nhiệm; và Cha ngươi, là Ðấng thấy trong chỗ kín nhiệm, sẽ thưởng cho ngươi.',
        ...
        18: 'hầu cho người ta không xem thấy ngươi đang kiêng ăn, nhưng chỉ Cha ngươi là Ðấng ở nơi kín nhiệm xem thấy mà thôi; và Cha người thấy trong chỗ kín nhiệm sẽ thưởng cho ngươi.',
    ...
    11: {
        ...
        2: 'Khi Giăng ở trong ngục nghe nói về các công việc của Ðấng Christ, thì sai môn đồ mình đến thưa cùng Ngài rằng:',
        ...
        7: 'Khi họ ra về, Ðức Chúa Jêsus mới phán về việc Giăng cho đoàn dân nghe, rằng: Các ngươi đã đi xem chi trong đồng vắng? Có phải xem cây sậy bị gió rung chăng?',
        ...
        20: 'Vì dân các thành mà Ðức Chúa Jêsus đã làm rất nhiều phép lạ rồi, không ăn năn, nên Ngài quở trách rằng:',
        21: 'Khốn nạn cho mầy, thành Cô-ra-xin! Khốn nạn cho mầy thành Bết-sai-đa! Vì nếu các phép lạ đã làm giữa bay, đem làm trong thành Ty-rơ và Si-đôn, thì hai thành đó thật đã mặc áo gai, đội tro, ăn năn từ lâu rồi.',
        22: 'Vậy nên ta bảo bay, đến ngày phán xét, thành Ty-rơ và thành Si-đôn sẽ chịu đoán phạt nhẹ hơn bay.',
        23: 'Còn mầy, Ca-bê-na-um là thành đã được cao tới trời, sẽ hạ xuống tới âm phủ! Vì nếu các phép lạ đã làm giữa mầy, đem làm trong thành Sô-đôm, thì thành ấy còn lại đến ngày nay.',
        24: 'Vậy nên ta rao bảo rằng, đến ngày phán xét, xứ Sô-đôm sẽ chịu đoán phạt nhẹ hơn mầy.',
        25: 'Lúc đó, Ðức Chúa Jêsus nói rằng: Hỡi Cha! là Chúa của trời đất, tôi ngợi khen Cha, vì Cha đã giấu những điều này với kẻ khôn ngoan, người sáng dạ, mà tỏ ra cho những con trẻ hay.',
    ...
    15: {
        1: 'Bấy giờ, có mấy người Pha-ri-si và mấy thầy thông giáo từ thành Giê-ru-sa-lem đến gần Ðức Chúa Jêsus, mà thưa rằng:',
        2: 'Sao môn đồ thầy phạm lời truyền khẩu của người xưa? Vì họ không rửa tay trước khi ăn.',
        3: 'Ngài đáp rằng: Còn các ngươi sao cũng vì cớ lời truyền khẩu mình mà phạm điều răn của Ðức Chúa Trời?',
        4: 'Vì Ðức Chúa Trời đã truyền điều răn nầy: Phải hiếu kính cha mẹ ngươi; lại, điều nầy: Ai mắng nhiếc cha mẹ thì phải chết.',
        5: 'Nhưng các ngươi lại nói rằng: Ai nói cùng cha mẹ rằng: Những điều mà tôi có thể giúp cha mẹ, đã dâng cho Ðức Chúa Trời rồi, thì người ấy không cần phải hiếu kính cha mẹ.',
        6: 'Như vậy, các ngươi đã vì lời truyền khẩu mình mà bỏ lời Ðức Chúa Trời.',
        ...
        10: 'Ðoạn, Ngài gọi đoàn dân đến, mà phán rằng: Hãy nghe, và hiểu.',
        ...
        16: 'Ðức Chúa Jêsus hỏi rằng: Các ngươi cũng còn chưa hiểu biết sao?',
    ...
    18: {
        ...
        10: 'Hãy giữ mình đừng khinh dể một đứa nào trong những đứa trẻ nầy; vì ta bảo các ngươi, các thiên sứ của chúng nó trên trời thường thấy mặt Cha ta, là Ðấng ở trên trời.',
        ...
        21: 'Phi -e-rơ bèn đến gần Ðức Chúa Jêsus mà hỏi rằng: Thưa Chúa, nếu anh em tôi phạm tội cùng tôi, thì sẽ tha cho họ mấy lần? Có phải đến bảy lần chăng?',
    ...
    23: {
        1: 'Bấy giờ Ðức Chúa Jêsus phán cùng dân chúng và môn đồ Ngài rằng:',
        ...
        39: 'Vì, ta bảo, các ngươi sẽ không thấy ta nữa, cho đến lúc các ngươi sẽ nói rằng: Phước cho Ðấng nhơn danh Chúa mà đến!',
    },
    24: {
        ...
        5: 'Vì nhiều người sẽ mạo danh ta \x80\x91ến mà nói rằng: Ta là Ðấng Christ; và sẽ dỗ dành nhiều người.',
    ...
    25: {
        ...
        6: 'Ðến khuya, có tiếng kêu rằng: Kìa, chàng rể đến, hãy đi ra rước người!',
        7: 'Các nữ đồng trinh bèn thức dậy cả, sửa soạn đèn mình.',
        8: 'Các ngươi dại nói với các ngươi khôn rằng: Xin bớt dầu của các chị cho chúng tôi, vì đèn chúng tôi gần tắt.',
        9: 'Nhưng các ngươi khôn trả lời rằng: Không, e chẳng đủ cho chúng tôi và các chị; thà các chị hãy đi đến người bán dầu mà mua.',
        10: 'Song trong khi họ đang đi mua, thì chàng rể đến; kẻ nào chực sẵn, thì đi với người cùng vào tiệc cưới, và cửa đóng lại.',
        11: 'Chặp lâu, những người nữ đồng trinh khác cũng đến và xin rằng: Hỡi Chúa, hỡi Chúa, xin mở cho chúng tôi!',
        12: 'Nhưng người đáp rằng: Quả thật, ta nói cùng các ngươi, ta không biết các ngươi đâu.',
        ...
        44: 'Ðến phiên các ngươi nầy bèn thưa lại rằng: Lạy Chúa, khi nào chúng tôi đã thấy Chúa, hoặc đói, hoặc khát, hoặc làm khách lạ, hoặc trần truồng, hoặc đau ốm, hoặc bị tù mà không hầu việc Ngài ư?',
    ...
    26: {
        1: 'Vả, Ðức Chúa Jêsus đã phán những lời ấy xong rồi, thì phán cùng môn đồ rằng:',
        ...
        4: 'và bàn với nhau dùng mưu chước gì đặng bắt Ðức Chúa Jêsus mà giết.',
        ...
        17: 'Trong ngày thứ nhứt ăn bánh không men, môn đồ đến gần Ðức Chúa Jêsus mà thưa rằng: Thầy muốn chúng tôi dọn cho thầy ăn lễ Vượt qua tại đâu?',
        ...
        19: 'Môn đồ làm y như lời Ðức Chúa Jêsus đã dạy mà dọn lễ Vượt qua.',
        ...
        31: 'Ngài bèn phán rằng: Ðêm nay các ngươi sẽ đều vấp phạm vì cớ ta, như có chép rằng: Ta sẽ đánh kẻ chăn chiên, thì chiên trong bầy sẽ bị tan lạc.',
        ...
        34: 'Ðức Chúa Jêsus phán rằng: Quả thật, ta nói cùng ngươi, chính đêm nay, trước khi gà gáy, ngươi sẽ chối ta ba lần.',
    ...
    28: {
        ...
        5: 'Song thiên sứ nói cùng các ngươi đờn bà đó rằng: Các ngươi đừng sợ chi cả; vì ta biết các ngươi tìm Ðức Chúa Jêsus, là Ðấng bị đóng đinh trên thập tự giá.',
        6: 'Ngài không ở đây đâu; Ngài sống lại rồi, như lời Ngài đã phán. Hãy đến xem chỗ Ngài đã nằm;',
        7: 'và hãy đi mau nói cho môn đồ Ngài hay rằng Ngài đã từ kẻ chết sống lại. Ðây nầy, Ngài đi trước các ngươi qua xứ Ga-li-lê; ở đó, các ngươi sẽ thấy Ngài. Ấy, ta đã bảo các ngươi.',
        8: 'Hai người đờn bà đó bèn vội vàng ra khỏi mộ, vừa sợ vừa cả mừng, chạy báo tin cho các môn đồ.',
        9: 'Nầy, Ðức Chúa Jêsus gặp hai người đờn bà đó, thì phán rằng: Mừng các ngươi! Hai người cùng đến gần ôm chơn Ngài, và thờ lạy Ngài.',
        10: 'Ðức Chúa Jêsus bèn phán rằng: Ðừng sợ chi cả; hãy đi bảo cho anh em ta đi qua xứ Ga-li-lê, ở đó sẽ thấy ta.',
