...
CHAPTERS = {
    1: {
        ...
        20: '그가 이 일들을 생각할 때에, 보라, 주의 천사가 꿈에 그에게 나타나 이르되, 너 다윗의 자손 요셉아, 네 아내 마리아 취하는 것을 두려워하지 말라. 그녀 안에 수태된 그것은 성령님으로 말미암았느니라.',
    ...
    2: {
        ...
        2: '이르되, 유대인들의 왕으로 태어나신 분이 어디 계시냐? 우리가 동쪽에서 그분의 별을 보고 그분께 경배하러 왔노라, 하니',
        ...
        13: '그들이 떠난 뒤에, 보라, 주의 천사가 꿈에 요셉에게 나타나 이르되, 헤롯이 어린아이를 찾아 그를 죽이려 하니 일어나 어린아이와 그의 어머니를 데리고 이집트로 피하여 내가 네게 말을 전해 줄 때까지 너는 거기 있으라, 하매',
        14: '그가 일어나 밤에 어린아이와 그의 어머니를 데리고 이집트로 떠나',
        15: '헤롯이 죽을 때까지 거기 있었으니 이것은 주에 관하여 대언자를 통해 말씀하신 것을 성취하려 함이더라. 이르시되, 이집트에서 내가 내 아들을 불러내었노라, 하셨더라.',
        ...
        19: '¶그러나 헤롯이 죽으매, 보라, 이집트에서 주의 천사가 꿈에 요셉에게 나타나',
        20: '이르되, 일어나 어린아이와 그의 어머니를 데리고 이스라엘 땅으로 들어가라. 어린아이의 생명을 찾던 자들이 죽었느니라, 하니',
        21: '그가 일어나 어린아이와 그의 어머니를 데리고 이스라엘 땅으로 들어가니라.',
        22: '그러나 아켈라오가 그의 아버지 헤롯을 대신하여 유대에서 통치한다는 것을 그가 듣고는 거기로 가기를 두려워하더라. 그럼에도 불구하고 그가 꿈에 하나님으로부터 경고를 받아 옆으로 돌아서 갈릴리 지방으로 들어가',
    ...
    3: {
        ...
        3: '이 사람은 곧 주께서 대언자 이사야를 통해 말씀하신 자니라. 이르시되, 광야에서 외치는 자의 소리가 있어 이르기를, 너희는 주의 길을 예비하라. 그분의 행로들을 곧게 하라, 하였느니라.',
        ...
        9: '너희 속으로, 우리에게는 아브라함이 우리 아버지로 있다, 하고 말할 생각을 하지 말라. 내가 너희에게 이르노니, 하나님께서는 능히 이 돌들로도 아브라함에게 자손들을 일으키실 수 있느니라.',
        ...
        16: '예수님께서 침례를 받으시고 곧바로 물속에서 올라오실 때에, 보라, 하늘들이 그분께 열렸으며 또 하나님의 영께서 비둘기같이 내려와 자기 위에 내려앉는 것을 그분께서 보시더라.',
        17: '보라, 하늘로부터 한 음성이 있어 이르시되, 이 사람은 내 사랑하는 아들이라. 내가 그를 매우 기뻐하노라, 하시니라.',
    },
    4: {
    ...
    5: {
        ...
        13: '¶너희는 땅의 소금이로되 만일 소금이 제 맛을 잃으면 무엇으로 그것을 짜게 하리요? 그 뒤에는 그것이 아무 쓸모없으므로 버려져서 사람들의 발밑에 밟힐 뿐이니라.',
        ...
        19: '그러므로 누구든지 가장 작은 이 명령들 중의 하나를 어기고 또 그렇게 사람들을 가르치는 자는 하늘의 왕국에서 가장 작은 자라 불리되 누구든지 그것들을 행하고 가르치는 자 곧 그는 하늘의 왕국에서 큰 자라 불리리라.',
        ...
        33: '¶또 옛 사람들이 말한바, 너는 스스로 거짓 맹세하지 말고 네가 맹세한 것들을 주께 이행하라, 한 것을 너희가 들었으나',
        34: '나는 너희에게 이르노니, 결코 맹세하지 말라. 하늘을 두고도 하지 말 것은 그것이 하나님의 왕좌이기 때문이요,',
        35: '땅을 두고도 하지 말 것은 그것이 그분의 발받침이기 때문이요, 예루살렘을 두고도 하지 말 것은 그것이 위대한 왕의 도시이기 때문이라.',
        36: '네가 네 머리를 두고도 맹세하지 말 것은 네가 머리털 하나를 희거나 검게 할 수 없기 때문이라.',
        37: '오직 너희 대화는, 예, 할 것은, 예, 하고, 아니요, 할 것은, 아니요, 하라. 무엇이든지 이것들 이상의 것은 악에서 나느니라.',
        ...
        45: '그리하면 너희가 하늘에 계신 너희 아버지의 아이들이 되리니 그분께서는 자신의 해를 악한 자와 선한 자 위에 떠오르게 하시며 비를 의로운 자와 불의한 자 위에 내려 주시느니라.',
    ...
    6: {
        1: '너희는 사람들에게 보이려고 그들 앞에서 구제하지 아니하도록 주의하라. 그렇지 않으면 하늘에 계신 너희 아버지께 너희가 보상을 받지 못하느니라.',
        ...
        6: '오직 너는 기도할 때에 네 골방으로 들어가 네 문을 닫고 은밀한 가운데 계시는 네 아버지께 기도하라. 그리하면 은밀한 가운데 보시는 네 아버지께서 네게 드러나게 갚아 주시리라.',
        7: '오직 너희는 기도할 때에 이교도들과 같이 헛된 반복의 말을 사용하지 말라. 그들은 자기들이 말을 많이 하여야 아버지께서 들으실 줄로 생각하느니라.',
        8: '그러므로 너희는 그들과 같이 되지 말라. 너희가 너희 아버지께 구하기 전에 그분께서 너희에게 필요한 것들을 아시느니라.',
        9: '그러므로 너희는 이런 식으로 기도하라. 하늘에 계신 우리 아버지여, 아버지의 이름이 거룩히 여겨지게 하옵시며',
        ...
        14: '너희가 사람들에게 그들의 범법을 용서하면 너희 하늘 아버지께서도 너희를 용서하시려니와',
        15: '너희가 사람들에게 그들의 범법을 용서하지 아니하면 너희 아버지께서도 너희의 범법을 용서하지 아니하시리라.',
        ...
        18: '그리하여 네가 금식하는 것을 사람들에게 보이지 말고 은밀한 가운데 계시는 네 아버지께 보이라. 그리하면 은밀한 가운데 보시는 네 아버지께서 네게 드러나게 갚아 주시리라.',
        ...
        24: '¶아무도 두 주인을 섬길 수 없나니 이는 그가 한 주인을 미워하고 다른 주인을 사랑하거나 혹은 한 주인을 떠받들고 다른 주인을 업신여길 것이기 때문이라. 너희가 하나님과 맘몬을 겸하여 섬길 수 없느니라.',
    ...
    7: {
        ...
        11: '그런즉 너희가 악할지라도 너희 자녀들에게 좋은 선물들을 줄 줄 알거든 하물며 하늘에 계신 너희 아버지께서 자기에게 구하는 자들에게 좋은 것들을 얼마나 더 많이 주시겠느냐?',
    ...
    8: {
        ...
        6: '이르되, 주여, 내 종이 마비 병으로 집에 누워 몹시 고통을 받나이다, 하매',
        7: '예수님께서 그에게 이르시되, 내가 가서 그를 고쳐 주리라, 하시니',
        8: '백부장이 응답하여 이르되, 주여, 주께서 내 지붕 아래로 오심을 내가 감당할 자격이 없사온즉 오직 말씀만 하옵소서. 그러면 내 종이 낫겠나이다.',
        ...
        21: '또 그분의 제자들 중의 다른 사람이 그분께 이르되, 주여, 먼저 내가 가서 내 아버지를 장사지내게 허락하옵소서, 하거늘',
        ...
        25: '그분의 제자들이 그분께 나아와 그분을 깨우며 이르되, 주여, 우리를 구원하소서. 우리가 죽나이다, 하매',
        ...
        29: '보라, 그들이 소리를 지르며 이르되, 하나님의 아들 예수님이여, 우리가 당신과 무슨 상관이 있나이까? 때가 되기 전에 우리를 괴롭히려고 여기에 오셨나이까? 하더라.',
    ...
    9: {
        ...
        3: '보라, 서기관들 중의 어떤 자들이 속으로 이르되, 이 사람이 신성모독하는도다, 하니',
        ...
        8: '무리들이 그것을 보고 놀라며 이러한 권능을 사람들에게 주신 하나님께 영광을 돌리니라.',
        ...
        28: '그분께서 집에 들어가시매 그 눈먼 사람들이 그분께로 나아오더라. 예수님께서 그들에게 이르시되, 너희는 내가 능히 이 일을 할 수 있다고 믿느냐? 하시니 그들이 그분께 이르되, 주여, 그러하오이다, 하매',
        ...
        33: '그 마귀가 내쫓기고 말 못하는 자가 말을 하거늘 무리들이 놀라며 이르되, 이스라엘에서 결코 그 일을 이런 식으로 본 적이 없다, 하나',
    ...
    10: {
        ...
        20: '말하는 이는 너희가 아니요, 너희 안에서 말씀하시는 너희 아버지의 영이시니라.',
        21: '또 형제가 형제를 아버지가 자식을 죽음에 넘겨주며 자식들이 자기 부모를 대적하여 일어나 그들을 죽게 하리라.',
        22: '또 너희가 내 이름으로 인하여 모든 사람에게 미움을 받을 터이나 끝까지 견디는 자는 구원을 받으리라.',
        23: '그러나 그들이 이 도시에서 너희를 핍박하면 너희는 다른 도시로 도망하라. 진실로 내가 너희에게 이르노니, 너희가 이스라엘의 도시들을 다니기 전에 사람의 아들이 오리라.',
        ...
        41: '대언자의 이름으로 대언자를 받아들이는 자는 대언자의 보상을 받고 의로운 자의 이름으로 의로운 자를 받아들이는 자는 의로운 자의 보상을 받으며',
    ...
    11: {
        ...
        19: '사람의 아들이 와서 먹고 마시매 그들이 말하기를, 보라, 음식을 탐하는 자요, 포도즙을 많이 마시는 자요, 세리들과 죄인들의 친구로다, 하는도다. 그러나 지혜는 자기 자녀들로 말미암아 의롭게 되느니라, 하시니라.',
        20: '¶그때에 그분께서 능력 있는 일들을 가장 많이 행하신 도시들이 회개하지 아니하므로 그 도시들을 꾸짖기 시작하시니라.',
        21: '고라신아, 네게 화가 있을지어다! 벳새다야, 네게 화가 있을지어다! 너희 안에서 행한 능력 있는 일들을 두로와 시돈에서 행하였더라면 그들이 벌써 오래 전에 굵은 베옷을 입고 재 속에서 회개하였으리라.',
        22: '그러나 내가 너희에게 이르노니, 심판 날에 두로와 시돈이 너희보다 더 견디기 쉬우리라.',
        23: '가버나움아, 네가 하늘에까지 높여졌으나 지옥에까지 떨어지리라. 네 안에서 행한 능력 있는 일들을 소돔에서 행하였더라면 그것이 이 날까지 남아 있었으리라.',
        24: '그러나 내가 너희에게 이르노니, 심판 날에 소돔 땅이 너보다 더 견디기 쉬우리라.',
        25: '¶그때에 예수님께서 응답하여 이르시되, 오 하늘과 땅의 주이신 아버지여, 아버지께서 이것들을 지혜롭고 분별 있는 자들에게는 숨기시고 아기들에게는 드러내셨사오니 감사하나이다.',
        26: '과연 그러하옵나이다. 아버지여, 그것이 아버지 보시기에 매우 좋았나이다.',
        27: '내 아버지께서 모든 것을 내게 넘겨주셨사오니 아버지 외에는 아무도 아들을 알지 못하고 아들과 또 아들이 아버지를 드러낼 자 외에는 아무도 아버지를 알지 못하나이다.',
    ...
    12: {
        1: '그때에 예수님께서 안식일에 곡식 밭 사이로 지나가시는데 그분의 제자들이 시장하여 곡식 이삭을 따서 먹기 시작하니라.',
        ...
        4: '그가 하나님의 집에 들어가 보여 주는 빵 곧 오직 제사장들 외에 자기나 자기와 함께한 자들이 먹으면 율법에 어긋나는 빵을 먹었느니라.',
        5: '또는 안식일에 성전 안의 제사장들이 안식을 범하여도 죄가 없음을 너희가 율법에서 읽지 못하였느냐?',
        6: '그러나 내가 너희에게 이르노니, 성전보다 더 큰 이가 이곳에 있느니라.',
        7: '그러나, 내가 긍휼을 원하고 희생물을 원치 아니하노라, 하신 말씀이 무슨 뜻인지 너희가 알았더라면 무죄한 자를 정죄하지 아니하였으리니',
        8: '사람의 아들은 곧 안식일의 주니라, 하시니라.',
        ...
        31: '¶그러므로 내가 너희에게 이르노니, 온갖 종류의 죄와 신성모독은 사람들이 용서받되 성령님을 대적하여 신성모독하는 것은 사람들이 용서받지 못하고',
        32: '또 누구든지 말로 사람의 아들을 대적하면 그는 용서받되 누구든지 말로 성령님을 대적하면 이 세상에서나 오는 세상에서나 그는 용서받지 못하리라.',
        ...
        40: '요나가 밤낮으로 사흘 동안 고래 배 속에 있었던 것 같이 사람의 아들도 밤낮으로 사흘 동안 땅의 심장부에 있으리라.',
        ...
        50: '누구든지 하늘에 계신 내 아버지의 뜻을 행하는 자 곧 그가 내 형제요 자매요 어머니이니라, 하시니라.',
    },
    13: {
        ...
        35: '이것은 대언자를 통해 말씀하신 것을 성취하려 하심이라. 일렀으되, 내가 비유로 내 입을 열어 세상의 창건 이후로 은밀히 간직된 것들을 말하리라, 하였느니라.',
        ...
        44: '¶또 하늘의 왕국은 마치 밭에 숨겨진 보물과 같으니라. 사람이 그것을 발견하면 숨겨 두고 그것의 기쁨으로 인해 가서 자기의 모든 소유를 팔아 그 밭을 사느니라.',
        ...
        48: '그물이 가득 차매 그들이 그것을 물가로 끌어내고 앉아서 좋은 것은 모아 그릇에 담고 나쁜 것은 버렸느니라.',
    ...
    14: {
        ...
        13: '¶예수님께서 그것을 들으시고 배를 타고 거기를 떠나사 따로 외딴 곳으로 가시니 사람들이 그것을 듣고 도시들에서 나와 걸어서 그분을 따라가매',
        ...
        19: '무리에게 명령하사 잔디에 앉게 하시고 빵 다섯 개와 물고기 두 마리를 취하사 하늘을 우러러보시며 축복하시고 빵들을 떼어 자기 제자들에게 주시매 제자들이 무리에게 주니',
        ...
        26: '제자들이 그분께서 바다 위로 걸어오시는 것을 보고 불안해하여 이르기를, 영이다, 하고 두려워서 소리 지르거늘',
        27: '즉시 예수님께서 그들에게 말씀하여 이르시되, 안심하라. 나니 두려워하지 말라, 하시니라.',
        28: '베드로가 그분께 응답하여 이르되, 주여, 만일 주시거든 물 위로 주께 오라고 내게 명하소서, 하니',
        29: '그분께서, 오라, 하시매 베드로가 배에서 내려 예수님께 가려고 물 위로 걸어가되',
        30: '바람이 사나운 것을 보고 두려워하다가 가라앉기 시작하며 소리 질러 이르되, 주여, 나를 구원하소서, 하니',
        31: '예수님께서 즉시 손을 내미사 그를 붙잡으시며 그에게 이르시되, 오 믿음이 적은 자여, 어찌하여 의심하였느냐? 하시니라.',
        32: '그들이 배에 들어갈 때에 바람이 그치니',
        33: '이에 배에 있던 자들이 와서 그분께 경배하며 이르되, 진실로 주는 하나님의 아들이로소이다, 하더라.',
        34: '¶그들이 건너가서 게네사렛 땅에 들어가매',
        35: '그곳 사람들이 그분을 알아보고 그 주변 온 지역에 사람을 보내어 병든 모든 자들을 그분께로 데리고 와서',
        36: '그들이 다만 그분의 옷단에라도 손을 대게 하실 것을 그분께 간청하더니 손을 댄 자들은 다 완전히 온전하게 되니라.',
    },
    15: {
        ...
        4: '하나님께서 명령하여 이르시되, 네 아버지와 어머니를 공경하라, 하시고 또, 아버지나 어머니를 저주하는 자는 반드시 죽일지니라, 하셨거늘',
        5: '너희는 이르되, 누구든지 자기 아버지나 어머니에게 말하기를, 무엇이든 내가 드려 부모님을 유익하게 할 것이 예물이 되었나이다, 하기만 하면',
        6: '자기 아버지나 어머니를 공경하지 않아도 의무를 면제받으리라, 하여 너희 전통으로 이같이 하나님의 명령을 무효가 되게 하였느니라.',
        ...
        13: '그분께서 대답하여 이르시되, 내 하늘 아버지께서 심지 아니하신 초목마다 뿌리째 뽑힐 터이니',
    ...
    16: {
        ...
        2: '그분께서 그들에게 응답하여 이르시되, 저녁이 되면 너희가 말하기를, 하늘이 붉으니 날씨가 좋으리라, 하고',
        3: '또 아침에는, 하늘이 붉고 흐리니 오늘은 날씨가 궂으리라, 하는도다. 오 너희 위선자들아, 너희가 능히 하늘의 모습은 분별하거니와 시대의 표적들은 분별하지 못하느냐?',
        4: '악하고 음란한 세대가 표적을 구하나 대언자 요나의 표적 외에는 아무 표적도 그 세대에게 주지 아니하리라, 하시고 그들을 남겨 둔 채 떠나가시니라.',
        5: '그분의 제자들이 건너편으로 갈 때 빵 가져가는 것을 잊었더라.',
        6: '¶그때에 예수님께서 그들에게 이르시되, 바리새인들과 사두개인들의 누룩을 주의하고 조심하라, 하시니',
        7: '그들이 자기들끼리 의논하여 이르되, 이는 우리가 빵을 가져오지 아니하였기 때문이라, 하거늘',
        8: '예수님께서 그것을 아시고 그들에게 이르시되, 오 믿음이 적은 자들아, 너희가 어찌하여 빵을 가져오지 아니하였으므로 너희끼리 의논하느냐?',
        9: '너희가 아직도 깨닫지 못하느냐? 빵 다섯 개로 오천 명이 먹고 너희가 몇 바구니를 거두었으며',
        10: '빵 일곱 개로 사천 명이 먹고 너희가 몇 바구니를 거두었는지 기억하지 못하느냐?',
        11: '내가 빵에 관하여 너희에게 그것을 말하지 아니하고 너희가 바리새인들과 사두개인들의 누룩을 조심하라고 말한 줄을 어찌 너희가 깨닫지 못하느냐? 하시니',
        12: '그제야 그들이 그분께서 빵의 누룩이 아니라 바리새인들과 사두개인들의 교리의 누룩을 조심하라고 명하신 줄을 깨달으니라.',
        13: '¶예수님께서 가이사랴 빌립보 지방에 들어오사 자기 제자들에게 물어 이르시되, 사람들이 나 곧 사람의 아들을 누구라고 하느냐? 하시니',
        14: '그들이 이르되, 어떤 이들은 주께서 침례자 요한이라 하고 어떤 이들은 엘리야라고도 하며 다른 이들은 예레미야나 대언자들 중의 하나라고 하나이다, 하거늘',
        ...
        22: '그때에 베드로가 그분을 붙잡고 그분을 꾸짖기 시작하여 이르되, 주여, 그럴 수 없나이다. 이 일이 결코 주께 임하지 아니하리이다, 하거늘',
        23: '그분께서 돌이키사 베드로에게 이르시되, 사탄아, 너는 내 뒤로 물러가라. 너는 내게 실족거리니라. 네가 하나님에게서 난 일들을 좋아하지 아니하고 사람들에게서 난 일들을 좋아하는도다, 하시니라.',
        ...
        26: '사람이 만일 온 세상을 얻고도 자기 혼을 잃으면 그에게 무슨 유익이 있느냐? 혹은 사람이 무엇을 주어 자기 혼을 대신하게 하겠느냐?',
        27: '사람의 아들이 자기 아버지의 영광 중에 자기 천사들과 함께 올 것이요, 그때에 그가 각 사람에게 그의 행위대로 갚아 주리라.',
    ...
    17: {
        ...
        9: '그들이 산에서 내려올 때에 예수님께서 그들에게 명하여 이르시되, 사람의 아들이 죽은 자들로부터 다시 일어날 때까지는 그 본 것을 아무에게도 말하지 말라, 하시니',
        10: '그분의 제자들이 그분께 여쭈어 이르되, 그러면 어찌하여 서기관들은 반드시 엘리야가 먼저 와야 한다고 말하나이까? 하매',
        11: '예수님께서 대답하여 그들에게 이르시되, 참으로 엘리야가 먼저 와서 모든 것을 회복하리라.',
        12: '그러나 내가 너희에게 이르노니, 엘리야가 이미 왔으되 그들이 그를 알지 못하고 자기들이 하고자 하는 것을 다 그에게 행하였도다. 사람의 아들도 그와 같이 그들에게 고난을 당하리라, 하시매',
        13: '그제야 제자들이 그분께서 자기들에게 침례자 요한에 대하여 말씀하신 줄을 깨달으니라.',
        14: '¶그들이 무리에게 오니 어떤 사람이 그분께 와서 그분께 무릎을 꿇으며 이르되,',
        15: '주여, 내 아들에게 긍휼을 베푸소서. 그가 미친 증세로 심히 시달리고 자주 불 속에 쓰러지며 종종 물속에 빠지나이다.',
        ...
        22: '¶그들이 갈릴리에 거할 때에 예수님께서 그들에게 이르시되, 사람의 아들이 배반을 당해 사람들의 손에 넘어가',
        23: '죽임을 당하고 셋째 날 다시 일으켜지리라, 하시니 그들이 심히 근심하더라.',
        24: '¶그들이 가버나움에 이르렀을 때에 공세 돈 받는 자들이 베드로에게 나아와 이르되, 너희 선생님은 공세를 내지 아니하시느냐? 하니',
        25: '그가 이르되, 내신다, 하고 집에 들어가매 예수님께서 그보다 먼저 이르시되, 시몬아, 네 생각은 어떠하냐? 땅의 왕들이 누구에게서 관세나 공세를 걷느냐? 자기 자식들에게서냐, 타인들에게서냐? 하시니',
        26: '베드로가 그분께 이르되, 타인들에게서니이다, 하매 예수님께서 그에게 이르시되, 그렇다면 자식들은 면제되리라.',
        27: '그럼에도 불구하고 우리가 그들을 실족시킬까 염려하노니 너는 바다에 가서 낚시 바늘을 던져 처음 올라오는 물고기를 잡으라. 네가 그것의 입을 열면 돈 하나를 발견하리니 그것을 가져다가 나와 너를 위해 그들에게 주라, 하시니라.',
    },
    18: {
        ...
        6: '그러나 누구든지 나를 믿는 이 작은 자들 중의 하나를 실족하게 하면 차라리 연자 맷돌을 목에 매달고 바다 깊은 곳에 빠지는 것이 그에게 더 나으리라.',
        ...
        10: '너희가 이 작은 자들 중의 하나라도 업신여기지 않도록 조심하라. 내가 너희에게 이르노니, 하늘에서 그들의 천사들이 하늘에 계신 내 아버지의 얼굴을 항상 바라보느니라.',
        11: '사람의 아들은 잃어버린 것을 구원하려고 왔느니라.',
        ...
        16: '그러나 만일 그가 네 말을 들으려 하지 아니하거든 너와 함께 한두 사람을 데리고 가서 두세 증인의 입으로 모든 말을 확증하라.',
        17: '만일 그가 그들의 말 듣기를 무시하거든 교회에 그것을 말하되 그가 교회의 말 듣기를 무시하거든 너는 그를 이교도나 세리같이 여기라.',
        18: '진실로 내가 너희에게 이르노니, 무엇이든지 너희가 땅에서 묶으면 그것이 하늘에서 묶일 것이요, 무엇이든지 너희가 땅에서 풀면 그것이 하늘에서 풀리리라.',
        19: '내가 다시 너희에게 이르노니, 너희 중의 두 사람이 자기들이 구할 어떤 것에 대하여 땅에서 한마음이 되면 하늘에 계신 내 아버지께서 그들을 위해 그것을 행하시리라.',
        20: '두세 사람이 내 이름으로 함께 모인 곳에 나도 거기에 그들의 한가운데 있느니라, 하시니라.',
        21: '¶그때에 베드로가 그분께 나아와 이르되, 주여, 내 형제가 내게 죄를 지으면 내가 몇 번이나 그를 용서하리이까? 일곱 번까지 하리이까? 하매',
        ...
        35: '그러므로 너희가 각각 마음으로부터 자기 형제에게 그들의 범법을 용서하지 아니하면 내 하늘 아버지께서도 너희에게 이같이 하시리라, 하시니라.',
    },
    19: {
        1: '예수님께서 이 말씀들을 마치시고 갈릴리에서 떠나 요르단 건너편의 유대 지방으로 들어가시니',
        2: '큰 무리들이 그분을 따르므로 그분께서 거기서 그들을 고쳐 주시더라.',
        ...
        6: '그런즉 그들이 더 이상 둘이 아니요, 한 육체이니 그러므로 하나님께서 짝지어 주신 것을 사람이 나누지 못할지니라, 하시거늘',
        ...
        11: '그분께서 그들에게 이르시되, 모든 사람이 이 말을 받을 수는 없고 아버지께서 그것을 주신 자들만 받을 수 있느니라.',
        12: '자기 어머니 태에서부터 그렇게 태어난 고자들도 더러 있고 사람들이 고자로 만든 고자들도 더러 있으며 하늘의 왕국을 위해 스스로 고자가 된 자들도 있나니 그것을 받을 수 있는 자는 받을지어다, 하시니라.',
        ...
        16: '¶보라, 어떤 사람이 나아와 그분께 이르되, 선한 선생님이여, 내가 무슨 선한 일을 하여야 영원한 생명을 얻으리이까? 하매',
        17: '그분께서 그에게 이르시되, 네가 어찌하여 나를 선하다 하느냐? 한 분 곧 하나님 외에는 선한 이가 없느니라. 다만 네가 생명에 들어가려거든 명령들을 지키라, 하시니',
        18: '그가 그분께 이르기를, 어느 명령이니이까? 하매 예수님께서 이르시되, 너는 살인하지 말라, 너는 간음하지 말라, 너는 도둑질하지 말라, 너는 거짓 증언하지 말라,',
        19: '네 아버지와 어머니를 공경하라. 또 너는 네 이웃을 네 자신과 같이 사랑하라, 하는 명령이니라, 하시니',
        20: '그 청년이 그분께 이르기를, 이 모든 것은 내가 어려서부터 지켰거니와 아직도 내게 부족한 것이 무엇이니이까? 하거늘',
        21: '예수님께서 그에게 이르시되, 네가 완전하게 되려거든 가서 네 소유를 팔아 가난한 사람들에게 주라. 그리하면 하늘에서 네게 보화가 있으리라. 그리고 와서 나를 따르라, 하시매',
        22: '그 청년이 많은 소유를 가졌으므로 그 말씀을 듣고 근심하며 가니라.',
        23: '¶그때에 예수님께서 자기 제자들에게 이르시되, 진실로 내가 너희에게 이르노니, 부자는 하늘의 왕국에 들어가기가 어려우리라.',
        24: '내가 다시 너희에게 이르노니, 낙타가 바늘귀를 지나가는 것이 부자가 하나님의 왕국에 들어가는 것보다 쉬우니라, 하시매',
        25: '그분의 제자들이 그 말을 듣고 심히 놀라며 이르되, 그러면 누가 구원을 받을 수 있으리요? 하거늘',
        26: '예수님께서 그들을 보시며 그들에게 이르시되, 사람들에게는 이것이 불가능하나 하나님께는 모든 것이 가능하니라, 하시니라.',
        27: '¶그때에 베드로가 그분께 응답하여 이르되, 보소서, 우리가 모든 것을 버리고 주를 따랐사오니 그런즉 우리가 무엇을 얻으리이까? 하매',
        28: '예수님께서 그들에게 이르시되, 진실로 내가 너희에게 이르노니, 다시 나게 하는 때 곧 사람의 아들이 자기의 영광의 왕좌에 앉을 때에 나를 따른 너희도 열두 왕좌에 앉아 이스라엘의 열두 지파를 재판하리라.',
    ...
    20: {
        ...
        18: '보라, 우리가 예루살렘으로 올라가노니 사람의 아들이 배반을 당해 수제사장들과 서기관들에게 넘겨지매 그들이 그를 정죄하여 죽게 하고',
        ...
        23: '그분께서 그들에게 이르시되, 너희가 참으로 내 잔을 마시고 나를 잠기게 한 그 침례로 침례를 받으려니와 내 오른편과 내 왼편에 앉는 것은 내가 줄 것이 아니니라. 다만 내 아버지께서 누구를 위해 그것을 예비하셨든지 그들이 그것을 받을 것이니라, 하시니라.',
        ...
        28: '이와 같이 사람의 아들도 섬김을 받으러 오지 아니하고 도리어 섬기며 자기 생명을 많은 사람의 대속물로 주려고 왔느니라, 하시니라.',
        29: '그들이 여리고를 떠날 때에 큰 무리가 그분을 따르더라.',
        30: '¶보라, 눈먼 두 사람이 길가에 앉아 있다가 예수님께서 지나가신다는 말을 듣고 소리를 지르며 이르되, 오 주여, 다윗의 자손이여, 우리에게 긍휼을 베푸소서, 하니',
        31: '그들이 잠잠해야 하므로 무리가 그들을 꾸짖었으나 그들이 더욱 소리를 지르며 이르되, 오 주여, 다윗의 자손이여, 우리에게 긍휼을 베푸소서, 하더라.',
        32: '예수님께서 멈추어 서서 그들을 불러 이르시되, 내가 너희에게 무엇을 해 주기 원하느냐? 하시니',
        33: '그들이 그분께 이르되, 주여, 우리의 눈을 열어 주옵소서, 하매',
    ...
    21: {
        ...
        3: '만일 누가 너희에게 무슨 말을 하거든, 주께서 그것들을 필요로 하신다, 하라. 그리하면 그가 즉시 그것들을 보내리라, 하시니',
        4: '이 모든 일이 일어난 것은 대언자를 통해 말씀하신 것을 성취하려 하심이라. 일렀으되,',
        5: '너희는 시온의 딸에게 이르기를, 보라, 네 왕이 네게 임하시느니라. 그분은 온유하사 나귀 위에 앉으시되 나귀 새끼 곧 어린 수나귀 위에 앉으시느니라, 하라, 하였느니라.',
        ...
        9: '앞에서 가고 뒤에서 따르던 무리들이 외쳐 이르되, 호산나 다윗의 자손이여, 찬송하리로다. 주의 이름으로 오시는 이여, 가장 높은 곳에서 호산나, 하더라.',
        ...
        31: '그 둘 중에 누가 자기 아버지의 뜻을 행하였느냐? 하시매 그들이 그분께 이르되, 첫째 아들이라, 하거늘 예수님께서 그들에게 이르시되, 진실로 내가 너희에게 이르노니, 세리들과 창녀들이 너희보다 먼저 하나님의 왕국에 들어가느니라.',
        32: '요한이 의의 길로 너희에게 왔어도 너희는 그를 믿지 아니하였으나 세리들과 창녀들은 그를 믿었으며 너희는 그것을 보고도 그 뒤에 뜻을 돌이켜 그를 믿으려 하지 아니하였느니라.',
        33: '¶다른 비유를 들으라. 어떤 집주인이 포도원을 만들어 그 주위에 울타리를 두르고 그 안에 포도즙 틀을 파고 망대를 세운 뒤 농부들에게 그것을 세주고 먼 나라로 갔다가',
        ...
        42: '예수님께서 그들에게 이르시되, 너희가 성경 기록들에서, 건축자들이 버린 돌 바로 그 돌이 모퉁이의 머릿돌이 되었나니 이것은 주께서 행하신 것이요, 우리 눈에 놀랍도다, 한 말씀을 결코 읽어 본 적이 없느냐?',
        43: '그러므로 내가 너희에게 이르노니, 아버지께서 너희로부터 하나님의 왕국을 빼앗아 왕국의 열매를 맺는 민족에게 주시리라.',
    ...
    22: {
        1: '예수님께서 응답하며 다시 비유로 그들에게 말씀하여 이르시되,',
        ...
        16: '자기 제자들을 헤롯 당원들과 함께 그분께 보내어 이르되, 선생님이여, 우리가 알기에 선생님은 진실하시고 진리 안에서 하나님의 길을 가르치시며 또 아무도 신경 쓰지 아니하시나니 선생님은 사람들의 외모를 중히 여기지 아니하시나이다.',
        ...
        21: '그들이 그분께 이르되, 카이사르의 것이니이다, 하매 그때에 그분께서 그들에게 이르시되, 그런즉 카이사르의 것들은 카이사르에게, 하나님의 것들은 하나님께 바치라, 하시니',
        22: '그들이 이 말씀들을 듣고 놀라며 그분을 떠나 자기들의 길로 가니라.',
        23: '¶바로 그 날에 부활이 없다고 말하는 사두개인들이 그분께 와서 그분께 물어',
        ...
        29: '예수님께서 그들에게 대답하여 이르시되, 너희가 성경 기록들도 알지 못하고 하나님의 권능도 알지 못하므로 잘못하느니라.',
        30: '부활 때에는 그들이 장가가지도 시집가지도 아니하며 하늘에 있는 하나님의 천사들과 같으니라.',
        31: '그러나 죽은 자들의 부활에 관하여는 하나님께서 너희에게 말씀하신 것을 너희가 읽지 못하였느냐? 이르시되,',
        32: '나는 아브라함의 하나님이요, 이삭의 하나님이요, 야곱의 하나님이니라, 하셨으니 하나님은 죽은 자의 하나님이 아니요, 산 자의 하나님이시니라, 하시매',
        33: '무리가 이 말씀을 듣고 그분의 교리에 깜짝 놀라더라.',
        ...
        45: '그러면 다윗이 그를 주라 부를진대 어찌 그가 그의 자손이 되겠느냐? 하시니',
    ...
    23: {
        ...
        5: '도리어 그들은 사람들에게 보이기 위해 자기들의 모든 행위를 하나니 곧 그들은 성구함의 폭을 넓게 하며 자기들의 옷단을 큼직하게 하고',
        ...
        9: '땅에 있는 자를 너희 아버지라 부르지 말라. 너희 아버지는 한 분 곧 하늘에 계신 분이시니라.',
        ...
        29: '서기관들과 바리새인들, 위선자들아, 너희에게 화가 있을지어다! 너희가 대언자들의 묘를 만들고 의로운 자들의 돌무덤을 수리하며',
        30: '이르되, 우리가 만일 우리 조상들 시대에 있었더라면 그들이 대언자들의 피를 흘리는 데 참여하지 아니하였으리라, 하나니',
        ...
        39: '내가 너희에게 이르노니, 너희가 말하기를, 찬송하리로다. 주의 이름으로 오시는 이여, 할 때까지 이제부터 너희가 나를 보지 못하리라, 하시니라.',
    },
    24: {
    ...
    25: {
        ...
        31: '¶사람의 아들이 자기의 영광 중에 모든 거룩한 천사와 함께 올 때에 자기의 영광의 왕좌에 앉아서',
        ...
        44: '그때에 그들도 그분께 응답하여 이르되, 주여, 어느 때에 우리가 주께서 주리신 것이나 목마르신 것이나 나그네 되신 것이나 헐벗으신 것이나 병드신 것이나 감옥에 갇히신 것을 보고 주를 섬기지 아니하더이까? 하리라.',
    ...
    26: {
        ...
        2: '너희가 아는 대로 이틀이 지나면 유월절이라. 사람의 아들이 배반을 당해 십자가에 못 박히리라, 하시니라.',
        ...
        22: '그들이 심히 근심하며 저마다 그분께 말하기 시작하여 이르되, 주여, 그게 나니이까? 하매',
        ...
        39: '조금 멀리 가사 얼굴을 대고 엎드려 기도하여 이르시되, 오 내 아버지여, 가능하시거든 이 잔을 내게서 지나가게 하시옵소서. 그러나 내 뜻대로 하지 마옵시고 아버지의 뜻대로 하옵소서, 하시고는',
        40: '제자들에게 오사 그들이 자는 것을 보시고 베드로에게 이르시되, 도대체 너희가 나와 함께 한 시간도 깨어 있을 수 없었느냐?',
        41: '너희가 시험에 빠지지 않게 깨어 기도하라. 참으로 영은 원하되 육이 약하도다, 하시니라.',
        42: '그분께서 다시 두 번째 나가사 기도하여 이르시되, 오 내 아버지여, 만일 내가 마시지 않고서는 이 잔이 내게서 지나갈 수 없거든 아버지의 뜻이 이루어지기를 원하나이다, 하시고',
        43: '오셔서 보시니 그들이 다시 자더라. 이는 그들의 눈이 무거웠기 때문이더라.',
        44: '또 그분께서 그들을 떠나 다시 나가사 세 번째 같은 말씀들로 기도하시고',
        45: '그 뒤에 자기 제자들에게 오사 그들에게 이르시되, 이제는 자고 쉬라. 보라, 그 시각이 가까이 왔고 사람의 아들이 배반을 당해 죄인들의 손에 넘겨졌느니라.',
        ...
        53: '너는 내가 지금 내 아버지께 기도하여 당장이라도 그분께서 열두 군단이 넘는 천사들을 내게 주시도록 할 수 없는 줄로 생각하느냐?',
        ...
        61: '이르되, 이자가 말하기를, 내가 하나님의 성전을 헐고 사흘 만에 지을 수 있다, 하더라, 하니',
        62: '대제사장이 일어나 그분께 이르되, 네가 아무것도 대답하지 아니하느냐? 이들이 너를 대적하여 증언하는 것이 어떠하냐? 하되',
        63: '예수님께서 잠잠하시거늘 대제사장이 응답하여 그분께 이르되, 내가 너로 하여금 살아 계신 하나님을 두고 맹세하게 하노니 네가 하나님의 아들 그리스도인지 우리에게 말하라, 하매',
        64: '예수님께서 그에게 이르시되, 네가 말하였느니라. 그러할지라도 내가 너희에게 이르노니, 사람의 아들이 권능의 오른편에 앉아 있는 것과 하늘의 구름들 가운데서 오는 것을 이후에 너희가 보리라, 하시더라.',
    ...
    27: {
        ...
        10: '주께서 내게 정하신 바와 같이 그것들을 토기장이의 밭 값으로 주었도다, 하였느니라.',
        11: '예수님께서 총독 앞에 서시니 총독이 그분께 물어 이르되, 네가 유대인들의 왕이냐? 하매 예수님께서 그에게 이르시되, 네가 말하는도다, 하시고',
        ...
        29: '¶그들이 가시나무로 관을 엮어 그분의 머리에 씌우고 갈대를 그분의 오른손에 쥐어 주며 그분 앞에서 무릎을 꿇고 그분을 조롱하며 이르되, 만세, 유대인들의 왕이여! 하고',
        ...
        37: '그분의 머리 위에 이 사람은 유대인들의 왕 예수라고 쓴 죄명을 붙였더라.',
        ...
        43: '그가 하나님을 신뢰하였으니 그분께서 그를 원하시면 이제 그를 건져 내실 것이라. 그가 말하기를, 나는 하나님의 아들이라, 하였도다, 하며',
        ...
        54: '이제 백부장과 그와 함께 예수님을 지켜보던 자들이 지진과 일어난 그 일들을 보고 심히 두려워하여 이르되, 진실로 이분은 하나님의 아들이었도다, 하더라.',
    ...
    28: {
        ...
        2: '보라, 큰 지진이 났더라. 이는 주의 천사가 하늘로부터 내려와서는 가서 그 입구에서 돌을 뒤로 굴려 내고 그 위에 앉았기 때문이더라.',
