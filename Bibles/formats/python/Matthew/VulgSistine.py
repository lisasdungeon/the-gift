...
CHAPTERS = {
    ...
    5: {
        ...
        29: 'Quod si oculus tuus dexter scandalizat te, erue eum, et proiice abs te: expedit enim tibi ut pereat unum membrorum tuorum, quam totum corpus tuum mittatur in gehennam.',
        30: 'Et si dextra manus tua scandalizat te, abscinde eam, et proiice abs te: expedit enim tibi ut pereat unum membrorum tuorum, quam totum corpus tuum eat in gehennam.',
    ...
    13: {
        ...
        40: 'Sicut ergo colliguntur zizania, et igne comburuntur: sic erit in consummatione saeculi.',
    ...
    17: {
        ...
        19: 'Dixit illis Iesus: Propter incredulitatem vestram. Amen quippe dico vobis, si habueritis fidem, sicut granum sinapis, dicetis monti huic, Transi hinc, et transibit, et nihil impossibile erit vobis.',
    ...
    18: {
        ...
        8: 'Si autem manus tua, vel pes tuus scandalizat te: abscinde eum, et proiice abs te: bonum tibi est ad vitam ingredi debilem, vel claudum, quam duas manus, vel duos pedes habentem mitti in ignem aeternum.',
