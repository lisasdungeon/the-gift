...
CHAPTERS = {
    1: {
        ...
        16: 'Yet mercy was shown me for the express purpose that Christ Jesus might exhibit in my case, beyond all others, his exhaustless patience, as an example for those who were afterwards to believe on him and attain Immortal Life.',
    ...
    2: {
        1: 'First of all, then, I urge that petitions, prayers, intercessions, and thanksgivings should be offered for every one,',
        ...
        11: 'A woman should listen silently to her teachers, and show them all deference.',
