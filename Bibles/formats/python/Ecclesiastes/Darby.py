...
CHAPTERS = {
    ...
    2: {
        ...
        24: 'There is nothing good for man, but that he should eat and drink, and that he should make his soul enjoy good in his labour. This also I saw, that it was from the hand ofGod.',
        25: 'For who can eat, or who be eager, more than I?',
        26: "For he giveth to a man that is good in his sight wisdom, and knowledge, and joy; but to the sinner he giveth travail to gather and to heap up, that he may give to him that is good inGod's sight. This also is vanity and pursuit of the wind.",
    },
    3: {
    ...
    5: {
        ...
        18: 'Behold what I have seen good and comely: [it is] to eat and to drink, and to enjoy good in all his labour wherewith [man] laboureth under the sun, all the days of his life whichGod hath given him: for that is his portion.',
        19: 'Every man also to whomGod hath given riches and wealth, and power to eat thereof, and to take his portion and to rejoice in his labour: that is a gift ofGod.',
        20: 'For he will not much remember the days of his life, becauseGod answereth [him] with the joy of his heart.',
    },
    6: {
    ...
    7: {
        ...
        13: 'Consider the work ofGod; for who can make straight what he hath made crooked?',
        ...
        18: 'It is good that thou shouldest take hold of this; yea, also from that withdraw not thy hand: for he that fearethGod cometh forth from them all.',
        ...
        26: 'and I found more bitter than death the woman whose heart is nets and snares, [and] whose hands are bands: whoso pleasethGod shall escape from her; but the sinner shall be caught by her.',
        ...
        29: 'Only see this which I have found: thatGod made man upright, but they have sought out many devices.',
    },
    8: {
        ...
        12: 'Though a sinner do evil a hundred times, and prolong his [days], yet I know that it shall be well with them that fearGod, because they fear before him;',
        13: 'but it shall not be well with the wicked, neither shall he prolong [his] days as a shadow, because he feareth not beforeGod.',
        ...
        15: 'And I commended mirth, because there is nothing better for man under the sun than to eat, and to drink, and to be merry; for that shall abide with him of his labour the days of his life, whichGod hath given him under the sun.',
        ...
        17: 'then I saw that all [is] the work ofGod, [and] that man cannot find out the work that is done under the sun: because however man may labour to seek [it] out, yet doth he not find [it]; and even, if a wise [man] think to know [it], he shall not be able to find [it] out.',
    },
    9: {
        1: 'For all this I laid to my heart and [indeed] to investigate all this, that the righteous, and the wise, and their works, are in the hand ofGod; man knoweth neither love nor hatred: all is before them.',
        ...
        7: 'Go, eat thy bread with joy, and drink thy wine with a merry heart; forGod hath already accepted thy works.',
    ...
    12: {
        ...
        7: 'and the dust return to the earth as it was, and the spirit return untoGod who gave it.',
        ...
        13: 'Let us hear the end of the whole matter: FearGod, and keep his commandments; for this is the whole of man.',
        14: 'ForGod shall bring every work into judgment, with every secret thing, whether it be good or whether it be evil.',
    },
}
