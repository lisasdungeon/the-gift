...
CHAPTERS = {
    ...
    4: {
        1: 'Viszont látám én mind a nyomorgatásokat, a melyek a nap alatt történnek, és ímé, nyilván van azoknak, a kik nyomorgattatnak, könnyhullatások, és vígasztalójok nincs nékik; és az őket nyomorgatóknak kezekből erőszaktételt szenvednek, és vígasztalójuk nincs nékik.',
        2: 'És dicsérém én a megholtakat, a kik már meghaltak vala, az élők felett, a kik még élnek;',
        3: 'De mind a kettőnél boldogabbnak azt, a ki még nem lett, a ki nem látta azt a gonosz dolgot, a mely a nap alatt történik.',
        4: 'És látám én, hogy minden dolgát és minden ügyes cselekedetét az ember az ő felebarátja iránt való irígységből rendeli; annakokáért ez is hiábavalóság és lélek-fájdalom!',
        ...
        15: 'Láttam a nap alatt járó minden élőket a második gyermek mellett; a ki amannak helyére lépendő vala.',
        16: 'És hogy az egész sokaságnak nincs vége, mindazoknak, a kiknek ő élén volt; mindazáltal az utánok valók már semmit nem örvendeztek ő benne. Mert ez is hiábavalóság és lelki gyötrelem!',
    },
    5: {
