...
CHAPTERS = {
    ...
    4: {
        ...
        17: 'Gib acht auf deinen Fuß, wenn du zum Hause Gottes gehst; denn hintreten, um zu hören, ist besser, als wenn die Toren Opfer darbringen: sie wissen ja nichts weiter als Böses zu tun. –',
    },
    5: {
        ...
        5: 'Gestatte deinem Munde nicht, deine Person in Schuld zu bringen, und sage nicht vor dem Gottesdiener aus, daß eine Übereilung vorliege: warum soll Gott über etwas von dir Ausgesprochenes zürnen und das Werk deiner Hände mißlingen lassen?',
        6: 'Denn wo viele Träume sind, da ist auch viel eitler Wortschwall. Vielmehr fürchte Gott!',
        7: 'Wenn du siehst, wie der Arme bedrückt wird und wie es mit Recht und Gerechtigkeit in der Landschaft übel bestellt ist, so rege dich darüber nicht auf; denn über dem Hohen steht ein noch Höherer auf der Lauer, und ein Allerhöchster hält Wacht über sie alle.',
        8: 'Doch ein Vorteil für ein Land ist jedenfalls dies: ein König über bebautes Land.',
        9: 'Wer das Geld liebt, wird des Geldes nie satt, und wer am Reichtum seine Freude hat, ist unersättlich nach Einkünften; auch das ist nichtig.',
        ...
        14: 'Nackt, wie er aus dem Schoß seiner Mutter hervorgekommen ist, muß er wieder davon, wie er gekommen ist, und kann für seine Mühe nicht das Geringste mitnehmen, um es in seinem Besitz zu behalten.',
        ...
        17: '(Vernimm dagegen) was ich als gut, als schön befunden habe: daß der Mensch ißt und trinkt und es sich wohl sein läßt bei all seiner Mühe, mit der er sich unter der Sonne plagt während der geringen Zahl der Lebenstage, die Gott ihm beschieden hat; denn das ist sein Teil.',
