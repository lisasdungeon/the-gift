...
CHAPTERS = {
    1: {
        ...
        17: '그녀가 그에게 이르되, 내 주여, 왕께서 전에 주 왕의 하나님을 두고 왕의 여종에게 맹세하여 이르시기를, 네 아들 솔로몬이 반드시 나를 이어 통치하고 내 왕좌에 앉으리라, 하셨거늘',
        ...
        29: '왕이 맹세하여 이르되, 모든 고난에서 내 혼을 구속하신 주께서 살아 계심을 두고 맹세하거니와',
        ...
        36: '여호야다의 아들 브나야가 왕에게 응답하여 이르되, 아멘, 주 곧 내 주 왕의 하나님께서도 그와 같이 말씀하시기 원하오며',
        37: '또 주께서 내 주 왕과 함께 계셨던 것 같이 솔로몬과 함께 계셔서 그의 왕좌를 내 주 다윗 왕의 왕좌보다 더 크게 하시기를 원하나이다, 하니라.',
        ...
        47: '또 왕의 신하들이 와서 우리 주 다윗 왕을 축복하여 이르기를, 하나님께서 솔로몬의 이름을 왕의 이름보다 더 낫게 하시고 그의 왕좌를 왕의 왕좌보다 더 크게 하시기를 원하나이다, 하매 왕이 침상에서 몸을 구부리고',
        48: '또 이같이 말씀하시기를, 주 이스라엘의 하나님을 찬송하리로다. 그분께서 이 날 내 왕좌에 앉을 자를 주사 내 눈이 그것을 보게 하셨도다, 하셨나이다, 하니',
    ...
    2: {
        1: '이제 다윗의 날들이 가까이 이르러 그가 죽게 되매 그가 자기 아들 솔로몬에게 명하여 이르되,',
        2: '내가 온 땅이 가는 길을 가노니 그런즉 너는 강건하여 너 스스로 남자임을 보이고',
        3: '모세의 율법에 기록된 대로 주 네 하나님의 책무를 지켜 그분의 길들로 걸으며 그분의 법규와 명령과 판단의 법도와 증언을 지키라. 그리하면 네가 하는 모든 일에서 또 네가 어디로 향하든지 형통하리라.',
        4: '주께서 나에 관해 이르신 자신의 말씀을 계속해서 지키시리니 말씀하시기를, 만일 네 자손들이 자기들의 길에 주의를 기울이고 또 자기들의 마음을 다하고 혼을 다하여 진리 안에서 내 앞에서 걸으면 (그분께서 이르시되) 이스라엘 왕좌에 오를 사람이 네게 끊어지지 아니하리라, 하셨느니라.',
        5: '또한 스루야의 아들 요압이 내게 행한 일과 이스라엘 군대의 두 대장 곧 넬의 아들 아브넬과 예델의 아들 아마사에게 행한 일을 너도 알거니와 그가 그들을 죽여서 평화로운 때에 전쟁의 피를 흘리고 그 전쟁의 피를 자기 허리에 띤 띠와 자기 발에 신은 신에 묻혔으니',
        ...
        8: '또 보라, 바후림 출신의 베냐민 족속 게라의 아들 시므이가 너와 함께 있나니 그는 내가 마하나임으로 가던 날에 지독한 저주의 말로 나를 저주하였느니라. 그러나 그가 내려와 요르단에서 나를 맞이하기에 내가 주를 두고 그에게 맹세하여 이르기를, 내가 칼로 너를 죽이지 아니하리라, 하였노라.',
        9: '그러므로 이제 그를 무죄한 자로 여기지 말지어다. 너는 지혜로운 사람인즉 그에게 마땅히 행할 바를 아느니라. 오직 너는 그의 흰머리가 피를 흘리고 무덤에 내려가게 하라, 하니라.',
        10: '이처럼 다윗이 자기 조상들과 함께 잠들어 다윗의 도시에 묻히니라.',
        11: '다윗이 이스라엘을 통치한 날들이 사십 년이더라. 그가 헤브론에서 칠 년을 통치하고 예루살렘에서 삼십삼 년을 통치하였더라.',
        12: '¶그때에 솔로몬이 자기 아버지 다윗의 왕좌에 앉으니 그의 왕국이 크게 굳게 서니라.',
        13: '¶학깃의 아들 아도니야가 솔로몬의 어머니 밧세바에게 나아오므로 그녀가 이르되, 네가 평화롭게 오느냐? 하매 그가 이르되, 평화롭게 오나이다, 하고',
        14: '또 이르되, 내가 당신에게 아뢸 것이 조금 있나이다, 하니 그녀가 이르되, 말하라, 하매',
        15: '그가 이르되, 당신도 아시거니와 왕국은 내 것이었고 온 이스라엘은 나를 향해 얼굴을 들고 내가 통치하게 하려 하였으나 왕국이 돌려져서 내 동생의 것이 되었으니 이는 그것이 주로부터 나와 그의 것이 되었기 때문이니이다.',
        16: '이제 내가 당신에게 한 가지 청원을 하려 하오니 내 말을 거절하지 마옵소서, 하매 그녀가 그에게 이르되, 말하라, 하니',
        17: '그가 이르되, 원하건대 솔로몬 왕에게 아뢰어 왕이 수넴 여인 아비삭을 내게 아내로 주게 하소서. (왕이 당신에게, 아니라, 하지 아니하리이다), 하매',
        18: '밧세바가 이르되, 좋다, 내가 너를 위해 왕에게 말하리라, 하니라.',
        19: '¶그러므로 밧세바가 아도니야를 위해 말하려고 솔로몬 왕에게 이르매 왕이 일어나 그녀를 맞이하며 그녀에게 절한 뒤에 자기의 왕좌에 앉고 왕의 어머니를 위해 자리를 베풀게 하니 그녀가 그의 오른쪽에 앉았더라.',
        20: '그때에 그녀가 이르되, 내가 한 가지 작은 청원을 왕에게 구하오니 원하건대 내게, 아니라, 하지 마소서, 하매 왕이 그녀에게 이르되, 내 어머니여, 구하시옵소서. 내가 어머니에게, 아니라, 하지 아니하리이다, 하니',
        21: '그녀가 이르되, 수넴 여인 아비삭을 왕의 형 아도니야에게 아내로 주소서, 하매',
        22: '솔로몬 왕이 자기 어머니에게 응답하여 이르되, 어찌하여 어머니께서 아도니야를 위해 수넴 여인 아비삭을 구하시나이까? 그는 내 형이오니 그를 위해 왕국도 구하옵소서. 심지어 그를 위해 구할 뿐 아니라 제사장 아비아달과 스루야의 아들 요압을 위해서도 구하옵소서, 하고',
        23: '그때에 솔로몬 왕이 주를 두고 맹세하여 이르되, 만일 아도니야가 이 말을 하고도 자기 생명에 해를 입지 아니한다면 하나님께서 내게 벌을 내리시고 더 내리시기를 원하나이다.',
        24: '그러므로 이제 나를 굳게 세워 내 아버지 다윗의 왕좌에 오르게 하시고 또 친히 약속하신 대로 나를 위해 집을 세우신 주께서 살아 계심을 두고 맹세하노니 아도니야는 이 날 죽임을 당하리이다, 하고',
        25: '솔로몬 왕이 여호야다의 아들 브나야의 손으로 사람을 보내매 그가 그를 덮치므로 그가 죽으니라.',
        26: '¶왕이 제사장 아비아달에게 이르되, 너는 아나돗으로, 네 밭으로 가라. 너는 마땅히 죽어야 하느니라. 그러나 네가 내 아버지 다윗 앞에서 주 하나님의 궤를 메었고 또 내 아버지가 당한 모든 고난 중에서 너도 고난을 당하였은즉 내가 이번에 너를 죽이지 아니하노라, 하고',
        27: '이처럼 솔로몬이 아비아달을 쫓아내어 주의 제사장이 되지 못하게 하였으니 이것은 그가 주의 말씀 곧 그분께서 실로에 있던 엘리의 집에 관하여 이르신 말씀을 성취하려 함이었더라.',
        28: '¶그때에 소식이 요압에게 이르렀으니 이는 요압이 돌이켜서 압살롬을 따르지는 아니하였으나 아도니야를 따랐기 때문이더라. 요압이 주의 성막으로 도망하여 제단의 뿔들을 잡으니라.',
        29: '어떤 이가 솔로몬 왕에게 고하되 요압이 주의 성막으로 도망하였는데, 보소서, 그가 제단 옆에 있나이다 하므로 이에 솔로몬이 여호야다의 아들 브나야를 보내며 이르되, 가서 그를 덮치라, 하니라.',
        30: '브나야가 주의 성막에 이르러 그에게 이르되, 왕께서 이같이 말씀하시기를, 나오라, 하시느니라, 하매 그가 이르되, 아니라. 오직 내가 여기서 죽겠노라, 하니 브나야가 왕에게 다시 그 말을 전하여 이르되, 요압이 이같이 말하고 내게 이같이 대답하더이다, 하매',
        31: '왕이 그에게 이르되, 그가 말한 대로 하여 그를 덮치고 그를 묻을지니 이것은 네가 요압이 흘린 무죄한 피를 나와 내 아버지 집에서 제거하게 하려 함이라.',
        32: '주께서 그의 피를 그의 머리로 돌려보내시리니 그가 자기보다 더 의롭고 더 선한 사람 둘을 덮쳐서 그들 곧 이스라엘의 군대 대장 넬의 아들 아브넬과 유다의 군대 대장 예델의 아들 아마사를 칼로 죽였느니라. 그 일을 내 아버지 다윗은 알지 못하였나니',
        ...
        36: '¶또 왕이 사람을 보내어 시므이를 불러 그에게 이르되, 너는 예루살렘에서 너를 위해 집을 짓고 거기 거하며 거기에서 어디로든 나가지 말라.',
        ...
        39: '삼 년이 끝날 때에 시므이의 종들 중의 두 명이 가드 왕 마아가의 아들 아기스에게로 도망하였으므로 그들이 시므이에게 고하여 이르되, 보라, 네 종들이 가드에 있노라, 하매',
        40: '시므이가 자기 종들을 찾으려고 일어나 나귀에 안장을 얹고 가드로 가서 아기스에게 이르렀더라. 시므이가 가서 자기 종들을 가드에서 데려왔더니',
        ...
        44: '왕이 또 시므이에게 이르되, 네 마음에 은밀히 있는 모든 악 곧 네가 내 아버지 다윗에게 행한 바를 네가 아나니 그러므로 주께서 네 악을 네 머리로 돌려보내시리라.',
        45: '그러나 솔로몬 왕은 복을 받고 다윗의 왕좌는 영원히 주 앞에 굳게 서리라, 하고',
        46: '이에 왕이 여호야다의 아들 브나야에게 명령하니 그가 나가서 그를 덮쳐서 죽게 하매 왕국이 솔로몬의 손에서 굳게 서니라.',
    },
    3: {
        1: '솔로몬이 이집트 왕 파라오와 인척 관계를 맺고 파라오의 딸을 취한 뒤 자기 집과 주의 집과 예루살렘 주위의 성벽을 건축하는 일을 자기가 끝낼 때까지 그녀를 다윗의 도시에 데려다 두니라.',
        2: '그때까지 주의 이름을 위해 아직 집을 건축하지 아니하였으므로 다만 백성들은 산당들에서 희생물을 드렸더라.',
        3: '솔로몬이 주를 사랑하고 자기 아버지 다윗의 법규 안에서 걸었으나 다만 산당들에서 희생물을 드리고 분향하였더라.',
        ...
        7: '이제, 오 주 내 하나님이여, 주께서 주의 종으로 하여금 내 아버지 다윗을 대신하여 왕이 되게 하셨사오나 나는 작은 아이라 나가거나 들어올 줄을 알지 못하오며',
        ...
        10: '솔로몬이 이것을 구하매 주께서 그 말을 기쁘게 여기시니라.',
        11: '하나님께서 그에게 이르시되, 네가 이것을 구하였으며 너를 위해 장수하는 것도 구하지 아니하고 너를 위해 재물도 구하지 아니하며 네 원수들의 생명도 구하지 아니하고 오직 너를 위해 재판을 분별하기 위한 명철을 구하였은즉',
        12: '보라, 내가 네 말대로 행하였느니라. 보라, 내가 네게 지혜롭고 깨닫는 마음을 주었은즉 너 이전에도 너와 같은 자가 없었거니와 너 이후에도 너와 같은 자가 일어나지 아니하리라.',
        13: '또 네가 구하지 아니한 것 즉 재물과 명예도 내가 네게 주었은즉 네 평생토록 왕들 가운데서 너와 같은 자가 없으리라.',
        14: '또 네가 만일 네 아버지 다윗이 걸은 것 같이 내 길들로 걸으며 내 법규와 내 명령을 지키면 내가 네 날들을 길게 하리라, 하시니라.',
        15: '솔로몬이 깨니, 보라, 꿈이더라. 그가 예루살렘에 이르러 주의 언약 궤 앞에 서서 번제 헌물을 드리고 화평 헌물을 드리며 자기의 모든 신하를 위해 잔치를 베풀었더라.',
        16: '¶그때에 창녀인 두 여자가 왕에게 나아와 그 앞에 서고',
        17: '한 여자가 이르되, 오 내 주여, 나와 이 여자가 한 집에 사는데 내가 집에서 아이를 낳을 때에 그녀도 함께 있었나이다.',
        18: '내가 해산한 지 사흘 뒤에 이 여자도 해산하였는데 우리가 함께 있었고 집에 있던 우리 둘 외에는 집에 우리와 함께한 낯선 사람이 아무도 없었나이다.',
        19: '그런데 밤에 이 여자가 자기 아이 위에 누우므로 그 아이가 죽으니',
        20: '그녀가 한밤중에 일어나 주의 여종이 잠든 사이에 내 아들을 내 옆에서 가져다가 자기 품에 누이고 자기의 죽은 아이를 내 품에 누였나이다.',
        21: '아침에 내가 내 아이에게 젖을 주려고 일어났는데, 보소서, 그가 죽었나이다. 그런데 내가 아침에 자세히 살펴보니, 보소서, 그 아이는 내가 낳은 내 아들이 아니더이다, 하매',
        22: '다른 여자는 이르되, 아니라. 살아 있는 것은 내 아들이요, 죽은 것이 네 아들이라, 하고 이 여자는 이르되, 아니라. 죽은 것이 네 아들이요, 살아 있는 것은 내 아들이라, 하며 그들이 왕 앞에서 이렇게 말하니라.',
        23: '그때에 왕이 이르되, 한 여자는 말하기를, 살아 있는 이것은 내 아들이요 죽은 것이 네 아들이라, 하고 다른 여자는 말하기를, 아니라. 죽은 것이 네 아들이요 살아 있는 것은 내 아들이라, 하는도다, 하고',
        24: '또 이르되, 칼을 내게로 가져오라, 하니 그들이 칼을 왕 앞으로 가져오매',
        25: '왕이 이르되, 살아 있는 아이를 둘로 나누어 반은 이 여자에게 주고 반은 저 여자에게 주라, 하니',
        26: '그때에 그 살아 있는 아이의 어머니 되는 여자가 속 중심에서 자기 아들을 불쌍히 여겼으므로 왕에게 아뢰어 이르기를, 오 내 주여, 살아 있는 아이를 그녀에게 주시고 아무쪼록 죽이지 마옵소서, 하되 다른 여자는 말하기를, 그것이 내 것도 되게 하지 말고 네 것도 되게 하지 말며 그것을 나누게 하라, 하므로',
        27: '그때에 왕이 응답하여 이르되, 살아 있는 아이를 그녀에게 주고 결코 죽이지 말라. 그녀가 그 아이의 어머니니라, 하매',
        28: '왕이 판단한 재판을 온 이스라엘이 듣고 그들이 왕을 두려워하였으니 이는 판단의 공의를 행하기 위한 하나님의 지혜가 그에게 있음을 그들이 보았기 때문이더라.',
    },
    4: {
        ...
        5: '나단의 아들 아사랴는 직무 수행자들을 다스리는 자요, 나단의 아들 사붓은 으뜸가는 직무 수행자이며 또 왕의 친구요,',
        6: '아히살은 집안을 다스리는 자요, 압다의 아들 아도니람은 공세를 맡은 자더라.',
        7: '¶솔로몬이 또 온 이스라엘을 다스릴 열두 명의 직무 수행자를 두매 이들이 왕과 왕의 집안을 위해 음식물을 예비하되 각 사람이 일 년 중 자기가 맡은 달에 양식을 예비하였는데',
        8: '그들의 이름은 이러하니라. 에브라임 산에는 훌의 아들이요,',
        9: '마가스와 사알빔과 벧세메스와 엘론벧하난에는 데겔의 아들이요,',
        10: '아룹봇에는 헤셋의 아들인데 소고와 헤벨 온 땅이 그에게 속하였으며',
        11: '도르의 온 지역에는 아비나답의 아들인데 그는 솔로몬의 딸 다밧을 아내로 얻었으며',
        12: '아힐룻의 아들 바아나인데 다아낙과 므깃도와 예스르엘 아래 사르다나 옆의 온 벧스안 곧 벧스안에서부터 아벨므홀라까지와 심지어 욕느암 너머에 있는 곳까지 그에게 속하였으며',
        13: '라못길르앗에는 게벨의 아들인데 길르앗에 있는 므낫세의 아들 야일의 고을들이 그에게 속하였고 또 바산에 있는 아르곱 지역 곧 성벽과 놋 빗장이 있는 큰 도시 육십 개가 그에게 속하였으며',
        14: '잇도의 아들 아히나답이 마하나임을 소유하였고',
        15: '납달리에는 아히마아스인데 그는 또한 솔로몬의 딸 바스맛을 아내로 취하였으며',
        16: '아셀과 알롯에는 후새의 아들 바아나요,',
        17: '잇사갈에는 바루아의 아들 여호사밧이요,',
        18: '베냐민에는 엘라의 아들 시므이요,',
        19: '아모리 족속의 왕 시혼과 바산 왕 옥의 지방이던 길르앗 지방에는 우리의 아들 게벨인데 그 땅에서는 오직 그만 직무 수행자가 되었더라.',
        20: '¶유다와 이스라엘이 바닷가의 모래같이 수가 많게 되었으며 먹고 마시며 즐거워하였고',
        21: '솔로몬이 강에서부터 블레셋 사람들의 땅에 이르기까지와 이집트 경계에 이르기까지의 모든 왕국을 통치하였으므로 그들이 예물을 가져와서 솔로몬의 평생 동안 그를 섬겼더라.',
        22: '¶솔로몬의 하루 식량은 고운 밀가루 삼십 고르와 굵은 가루 육십 고르와',
        23: '살진 소 열 마리와 초장의 소 스무 마리와 양 백 마리며 그 외에 수사슴과 노루와 다마사슴과 살진 날짐승이 있었더라.',
        24: '그가 딥사에서부터 앗사에 이르기까지 강 이편 온 지역과 강 이편의 모든 왕을 지배하였으므로 그의 사방 모든 지역에 평화가 있었고',
        25: '솔로몬의 평생 동안 단에서부터 브엘세바에 이르기까지 유다와 이스라엘이 곧 각 사람이 자기 포도나무와 무화과나무 밑에서 안전히 거하였더라.',
        26: '¶솔로몬의 병거를 위한 말들의 외양간 사만 개가 그에게 있었으며 기병 만 이천 명이 있었고',
        27: '그 직무 수행자들은 각각 자기가 맡은 달에 솔로몬 왕과 솔로몬 왕의 상에 이른 모든 자를 위해 양식을 예비하여 부족함이 없게 하였으며',
        28: '또 그들이 각각 자기 책무에 따라 말과 단봉낙타에게 먹일 보리와 짚을 직무 수행자들이 있던 곳으로 가져왔더라.',
        29: '¶하나님께서 솔로몬에게 바닷가의 모래 같이 지혜와 명철을 심히 많이 주시고 또 넓은 마음을 주시매',
        30: '솔로몬의 지혜가 동쪽 지방 모든 자손의 지혜와 이집트의 모든 지혜보다 뛰어났더라.',
        31: '그가 모든 사람보다 지혜로워서 에스라 사람 에단과 마홀의 아들들인 헤만과 갈골과 다르다보다 지혜로웠으므로 그의 명성이 사방 모든 민족들 가운데 있었더라.',
    ...
    5: {
        1: '그들이 솔로몬에게 기름을 부어 그의 아버지 대신 왕으로 삼았다는 것을 두로 왕 히람이 들었으므로 그가 자기 신하들을 그에게 보내었으니 이는 히람이 늘 다윗을 사랑하였기 때문이라.',
        ...
        8: '히람이 솔로몬에게 사람을 보내어 이르되, 당신이 내게 사람을 보내어 구한 것들을 내가 깊이 생각하였고 백향목 재목과 전나무 재목에 관하여 당신의 모든 소원을 행하리이다.',
        ...
        10: '이처럼 히람이 솔로몬의 모든 소원대로 백향목과 전나무를 그에게 주매',
        11: '솔로몬이 히람에게 그의 집안의 양식으로 밀 이만 고르와 순수한 기름 이십 고르를 주되 해마다 히람에게 그와 같이 주었더라.',
        12: '주께서 솔로몬에게 약속하신 대로 그에게 지혜를 주시매 히람과 솔로몬 사이에 화평이 있었고 그들 둘이 함께 동맹을 맺었더라.',
        ...
        15: '또 솔로몬에게 짐 나르는 자 칠만 명이 있었고 산에서 돌 다듬는 자 팔만 명이 있었으며',
        16: '이 외에도 그 작업을 감독하는 솔로몬의 직무 수행자들 중에서 으뜸가는 자 삼천삼백 명이 있었는데 이들이 그 작업에서 일하는 사람들을 다스렸더라.',
        17: '왕이 명령하니 그들이 큰 돌과 값비싼 돌과 다듬은 돌을 가져다가 그 집의 기초를 놓았더라.',
        18: '솔로몬의 건축자들과 히람의 건축자들과 돌을 네모나게 만드는 자들이 그 돌들을 다듬었고 이처럼 그들이 그 집을 건축하기 위해 재목과 돌들을 예비하였더라.',
    },
    6: {
        1: '이스라엘 자손이 이집트 땅에서 나온 지 사백팔십 년이 되는 해 곧 솔로몬이 이스라엘을 통치한 지 사 년이 되는 해 시브 월 즉 둘째 달에 그가 주의 집을 건축하기 시작하였더라.',
        2: '솔로몬 왕이 주를 위하여 건축한 집은 길이가 육십 큐빗이요, 너비가 이십 큐빗이요, 높이가 삼십 큐빗이었으며',
        3: '그 집의 전 앞에 있던 주랑의 길이는 그 집의 너비와 같이 이십 큐빗이요, 그것의 너비는 집 앞에서 십 큐빗이었더라.',
        4: '그가 그 집을 위해 폭이 좁은 채광창들을 만들었더라.',
        5: '¶또 그가 그 집의 벽에 맞대어 돌아가며 방들을 만들되 돌아가며 그 집의 벽 곧 전과 하나님께서 말씀하시는 곳의 벽에 맞대어 돌아가며 방들을 만들었더라.',
        6: '맨 아래층 방의 너비는 오 큐빗이요, 가운데 층 방의 너비는 육 큐빗이며 셋째 층 방의 너비는 칠 큐빗이었으니 이것은 그가 그 집의 벽 바깥쪽에 폭이 좁아지는 받침대들을 돌아가며 만들어 그 집 벽에 들보들을 고정시키지 아니하려 함이더라.',
        7: '그 집은 건축할 때에 돌을 거기로 가져가기 전에 미리 예비하여 건축하였으므로 그것을 건축하는 동안에 집안에서는 쇠망치나 도끼나 어떤 쇠 연장 소리도 들리지 아니하였더라.',
        8: '가운데 층 방의 문은 그 집의 오른쪽에 있었으며 그들이 나선식 계단으로 가운데 층 방으로 올라갔고 가운데 층 방에서 셋째 층 방으로 올라갔더라.',
        9: '이와 같이 그가 그 집을 건축하고 마치니라. 그가 백향목 들보와 널빤지로 그 집을 덮었고',
        10: '그 뒤에 온 집을 향해 높이가 오 큐빗 되는 방들을 돌아가며 건축하되 백향목 재목을 가지고 그것들을 그 집 위에 얹어 놓았더라.',
        11: '¶주의 말씀이 솔로몬에게 임하니라. 이르시되,',
        12: '네가 건축하고 있는 이 집으로 말하건대 만일 네가 내 법규 안에서 걷고 내 판단의 법도를 집행하며 내 모든 명령을 지켜 그것들 안에서 걸으면 내가 네 아버지 다윗에게 한 내 말을 네게 행할 것이요,',
        13: '또 내가 이스라엘 자손 가운데 거하며 내 백성 이스라엘을 버리지 아니하리라, 하셨더라.',
        14: '이와 같이 솔로몬이 그 집을 건축하여 완성하고',
        15: '그 집 내부 벽 곧 그 집의 마루와 천장의 벽을 백향목 널빤지로 지으니라. 그가 그것들의 내부는 나무로 덮었고 그 집의 마루는 전나무 널빤지로 덮었으며',
        16: '또 그 집의 옆면에 마루와 벽들 이십 큐빗을 백향목 널빤지로 짓되 곧 내부에 있는 그것, 하나님께서 말씀하시는 곳 즉 지성소를 위해 그것들을 지으니라.',
        17: '그 집 곧 그것 앞의 전은 길이가 사십 큐빗이었으며',
        18: '그 집 내부의 백향목에는 둥근 꽃받침과 핀 꽃들을 새겼더라. 모든 것이 백향목이고 돌을 볼 수 없었더라.',
        19: '또 그가 주의 언약 궤를 두기 위해 그 집의 내부에 하나님께서 말씀하시는 곳을 예비하였는데',
        20: '하나님께서 말씀하시는 곳의 앞부분은 길이가 이십 큐빗이요, 너비가 이십 큐빗이요, 높이가 이십 큐빗이더라. 그가 순금으로 그것을 입혔고 마찬가지로 백향목으로 된 제단에도 입혔더라.',
        21: '이처럼 솔로몬이 그 집의 내부를 순금으로 입히고 하나님께서 말씀하시는 곳 앞에 금사슬로 칸막이를 만들어 그것을 금으로 입히며',
        22: '온 집을 금으로 입혀 마침내 온 집을 완성하니라. 그가 또 하나님께서 말씀하시는 곳 옆에 있던 제단을 온통 금으로 입혔더라.',
        23: '¶또 그가 하나님께서 말씀하시는 곳 안에 올리브나무로 두 그룹을 만들었는데 각각의 높이가 십 큐빗이더라.',
        24: '그룹의 한 날개는 오 큐빗이요, 그룹의 다른 날개도 오 큐빗이니 한 날개의 맨 끝에서부터 다른 날개의 맨 끝까지 십 큐빗이며',
        25: '다른 그룹도 십 큐빗이니 그 두 그룹은 한 치수, 한 크기더라.',
        26: '한 그룹의 높이가 십 큐빗이요, 다른 그룹의 높이도 마찬가지더라.',
        27: '그가 안쪽 집 안에 그룹들을 두매 그들이 그룹들의 날개들을 펼쳐 놓아 한 그룹의 날개는 한 쪽 벽에 닿게 하고 다른 그룹의 날개는 다른 쪽 벽에 닿게 하니 그것들의 날개들이 그 집 한가운데서 서로 닿았더라.',
        28: '또 그가 금으로 그룹들을 입혔으며',
        29: '집의 사면 모든 벽에는 안팎으로 그룹과 종려나무와 핀 꽃들의 새긴 형상을 새겼고',
        30: '그 집의 마루를 안팎으로 금으로 입혔더라.',
        31: '¶또 그가 올리브나무로 만든 문들을 하나님께서 말씀하시는 곳의 입구로 만들었는데 그 문들의 인방과 양옆 기둥이 벽의 오분의 일을 차지하였더라.',
        32: '그가 그 두 문도 올리브나무로 만들었으며 또 그것들에 그룹과 종려나무와 핀 꽃들을 새기고 그것들을 금으로 입히며 그룹과 종려나무들에 금을 깔았더라.',
        33: '또한 그가 이와 같이 전의 문을 위하여 올리브나무로 기둥들을 만들었는데 그것들이 벽의 사분의 일을 차지했으며',
        34: '또 그가 그 두 문을 전나무로 만들었더라. 또 그가 한 문의 두 문짝을 접히게 하였고 다른 문의 두 문짝도 접히게 하였으며',
        35: '그 위에 그룹과 종려나무와 핀 꽃들을 새기고 그 새긴 곳에 맞게 그것들을 금으로 덮었더라.',
        36: '¶또 그가 다듬은 돌 세 줄과 백향목 들보 한 줄로 안뜰을 건축하였더라.',
        37: '¶제사년 시브 월에 주의 집의 기초가 놓이고',
        38: '제십일년 불 월 곧 여덟째 달에 그 집의 모든 양식대로 그 집이 완성되되 그것의 모든 부분에서 완성되었으니 그가 이와 같이 칠 년 동안 그것을 건축하였더라.',
    },
    7: {
        1: '그러나 솔로몬이 십삼 년 동안 자기 집을 건축하여 자기의 온 집을 완성하니라.',
        2: '¶또한 그가 레바논 숲에서 나무를 취해 집을 건축하였는데 그것의 길이는 백 큐빗이요, 너비는 오십 큐빗이며 높이는 삼십 큐빗이더라. 그 집은 네 줄의 백향목 기둥들 위에 놓였으며 그 기둥들 위에는 백향목 들보들이 있었더라.',
        3: '또 그 집은 마흔다섯 개 기둥들 위에 놓인 들보들 위에서 백향목으로 덮였는데 그것들은 한 줄에 열다섯 개씩 있었더라.',
        4: '또 창문이 세 줄로 있었는데 빛과 빛이 세 층에서 마주 보더라.',
        5: '또 모든 문과 기둥을 창문들과 함께 네모나게 만들었는데 빛과 빛이 세 층에서 마주 보더라.',
        6: '¶또 그가 기둥들로 주랑을 만들었는데 그것의 길이는 오십 큐빗이요, 너비는 삼십 큐빗이더라. 그 주랑이 그것들 앞에 있었고 또 다른 기둥들과 두꺼운 들보가 그것들 앞에 있었더라.',
        7: '¶그 뒤에 그가 재판을 하기 위해 왕좌를 두는 주랑 곧 재판하는 주랑을 만들고 그것을 백향목으로 덮되 마루의 한쪽에서 다른 쪽까지 그리하니라.',
        8: '¶그가 거하던 그의 집에는 주랑 안에 다른 뜰이 있었는데 그 뜰 역시 같은 식으로 만드니라. 또한 솔로몬이 자기가 아내로 취한 파라오의 딸을 위해 집을 짓되 이 주랑과 같이 지으니라.',
        9: '이 모든 것들은 다듬은 돌의 치수에 따라 톱으로 켜서 만든 비싼 돌로 안과 밖을 짓되 그 기초에서부터 갓돌까지와 밖에서 큰 뜰에 이르기까지 다 그러하였으며',
        10: '그 기초는 값비싼 돌들 즉 큰 돌들 곧 십 큐빗 되는 돌들과 팔 큐빗 되는 돌들로 만들었더라.',
        11: '그 위에는 다듬은 돌들의 치수에 따라 값비싼 돌들과 백향목들이 있었으며',
        12: '또 큰 뜰 주위에는 다듬은 돌 세 줄과 백향목 들보 한 줄을 놓았는데 그것은 주의 집의 안뜰과 그 집의 주랑에 쓰기 위한 것이더라.',
        13: '¶솔로몬 왕이 사람을 보내어 두로에서 히람을 데려왔는데',
        14: '그는 납달리 지파에 속한 과부의 아들이요, 그의 아버지는 두로 사람으로 놋 대장장이더라. 그는 놋을 다루는 모든 일에서 일을 하도록 지혜와 명철이 충만하며 솜씨가 좋더라. 그가 솔로몬 왕에게 와서 그의 모든 작업을 수행하였더라.',
        ...
        20: '그 두 기둥들 위의 기둥머리들에는 그물 옆의 볼록한 부분 맞은편에 또한 위로 석류들이 있었으니 석류 이백 개가 다른 기둥머리 위에 돌아가며 줄을 지어 있었더라.',
        21: '또 그가 그 기둥들을 성전의 주랑 앞에 세우니라. 그가 오른쪽 기둥을 세우고 그것의 이름을 야긴이라 하며 왼쪽 기둥을 세우고 그것의 이름을 보아스라 하니라.',
        22: '그 기둥들 꼭대기 위에는 백합 모양이 있었더라. 이와 같이 기둥들을 만드는 일이 완성되니라.',
        23: '¶또 그가 바다를 부어 만들었는데 한 쪽 가장자리에서 다른 쪽 가장자리까지가 십 큐빗이더라. 그것은 사방으로 둥글며 그것의 높이는 오 큐빗이요, 삼십 큐빗 되는 줄이 그것을 돌아가며 둘렀더라.',
        24: '그것의 가장자리 밑에는 돌아가며 둥근 장식들이 일 큐빗마다 열 개씩 있어서 그것을 두르고 돌아가며 그 바다를 둘렀더라. 그 둥근 장식들은 바다를 부어 만들 때에 두 줄로 부어 만든 것이더라.',
        25: '그것은 열두 마리 소 위에 서 있었는데 세 마리는 북쪽을 바라보고 세 마리는 서쪽을 바라보며 세 마리는 남쪽을 바라보고 세 마리는 동쪽을 바라보았더라. 그 소들 위에 바다를 놓았고 그 소들의 뒷부분은 다 안으로 향하게 하였더라.',
        26: '그것의 두께는 한 손 너비만 하였고 그것의 가장자리는 잔의 가장자리같이 백합의 꽃들과 함께 만들었으며 그것은 이천 바스를 담았더라.',
        ...
        30: '또 각 받침대에는 놋 바퀴 네 개와 놋 판들이 있었고 받침대의 네 모서리에는 지지대들이 있었는데 이 지지대들은 물두멍 밑에 그 얇게 만들어 단 모든 것 옆에 부어 만들었더라.',
        31: '그것의 아가리는 머리 안에서 위로 일 큐빗 높이로 나와 있었으나 그 입구는 받침대를 만드는 일과 같이 일 큐빗 반 되게 둥글게 되어 있었으며 또 그것의 입구의 위에는 네모반듯하고 둥글지 아니한 조각한 것들이 그것들의 테두리들과 함께 있었더라.',
        ...
        36: '그가 그것의 가로대들의 판들과 그것의 테두리들 위에 그룹과 사자와 종려나무를 새기되 각각의 크기에 따라 새기고 또한 돌아가며 부가적인 것들을 새겼더라.',
        37: '이런 식으로 그가 받침대 열 개를 만들었으니 곧 그것들 모두를 한 금형과 한 치수와 한 크기로 부어 만들었더라.',
        38: '¶그 뒤에 그가 물두멍 열 개를 놋으로 만들어 한 물두멍에 사십 바스를 담았으며 각 물두멍을 사 큐빗으로 하고 열 개의 받침대 위에 각각 물두멍을 한 개씩 놓으니라.',
        ...
        42: '또 이 두 개의 그물을 위해 만든 사백 개의 석류 곧 기둥들 위에 있던 기둥머리들의 두 둥근 장식을 가리기 위해 한 그물에 두 줄씩 만든 석류들과',
        43: '또 받침대 열 개와 받침대들 위의 물두멍 열 개와',
        44: '바다 한 개와 또 바다 밑에 있던 소 열두 마리와',
        45: '솥들과 부삽들과 대야들이더라. 히람이 주의 집을 위해 솔로몬 왕에게 이 모든 기구를 빛나는 놋으로 만들었더라.',
        46: '요르단 평야에서 왕이 숙곳과 사르단 사이의 진흙땅에서 그것들을 부어 만들었더라.',
        47: '기구들이 심히 많으므로 솔로몬이 그것들을 다 달지 아니한 채 두었으며 그 놋의 무게를 알 수 없었더라.',
        ...
        51: '이와 같이 솔로몬 왕이 주의 집을 위해 수행한 모든 작업을 마치니라. 솔로몬이 자기 아버지 다윗이 봉헌한 물건들 곧 은과 금과 기구들을 가져다가 주의 집의 보고 가운데 두었더라.',
    },
    8: {
        1: '그때에 솔로몬이 이스라엘의 장로들과 지파들의 모든 우두머리들 곧 이스라엘 자손의 아버지들의 우두머리들을 예루살렘에 있던 솔로몬 왕에게로 모으니 이것은 그들이 주의 언약 궤를 다윗의 도시 곧 시온에서 가지고 올라오게 하려 함이더라.',
        2: '이스라엘의 모든 사람이 에다님 월 곧 일곱째 달의 명절에 솔로몬 왕에게로 모이고',
        3: '이스라엘의 모든 장로가 이르매 제사장들이 궤를 들어 올리니라.',
        4: '그들이 주의 궤와 회중의 성막과 성막 안의 모든 거룩한 기구를 가지고 올라가되 곧 제사장들과 레위 사람들이 그것들을 가지고 올라갔더라.',
        5: '솔로몬 왕과 그에게로 모인 이스라엘 온 회중이 그와 함께 궤 앞에서 양과 소로 희생물을 드렸는데 그 수가 많아 말할 수도 없었고 셀 수도 없었더라.',
        6: '제사장들이 주의 언약 궤를 궤의 처소로 들여오되 곧 그 집의 하나님께서 말씀하시는 곳으로, 지성소로 즉 그룹들의 날개들 밑으로 들여오니라.',
        7: '그룹들이 궤의 처소 위에서 자기들의 두 날개를 펴서 궤와 그것의 막대들을 위에서 덮었더라.',
        8: '또 그들이 막대들을 빼내었으므로 그 막대들의 끝이 하나님께서 말씀하시는 곳 앞의 성소에서는 보이나 밖에서는 보이지 아니하였더라. 그것들이 이 날까지 거기에 있느니라.',
        9: '궤 안에는 두 개의 돌 판 외에 아무것도 없었는데 그것들은 이스라엘 자손이 이집트 땅에서 나온 뒤에 주께서 그들과 언약을 맺으실 때에 모세가 호렙에서 거기에 넣은 것이더라.',
        10: '제사장들이 성소에서 나올 때에 구름이 주의 집에 가득하였으므로',
        11: '이에 제사장들이 그 구름으로 인하여 능히 서서 섬기지 못하였으니 이는 주의 영광이 주의 집에 가득하였기 때문이더라.',
        12: '¶그때에 솔로몬이 이르되, 주께서 친히 짙은 어둠 속에 거하시겠다고 말씀하셨사오나',
        13: '내가 참으로 주를 위해 거하실 집을 건축하였사오니 곧 주께서 영원히 거하실 안정된 처소로소이다, 하고',
        14: '왕이 얼굴을 돌이켜 이스라엘 온 회중을 축복하니라. (이때에 이스라엘 온 회중은 서 있었더라.)',
        15: '그가 이르되, 주 이스라엘의 하나님을 찬송할지로다. 그분께서 자신의 입으로 내 아버지 다윗에게 말씀하시고 자신의 손으로 그것을 이루셨도다. 이르시기를,',
        16: '내가 내 백성 이스라엘을 이집트에서 데리고 나온 날부터 내 이름을 두기 위해 집을 건축하려고 이스라엘의 모든 지파 중에서 어떤 도시도 택하지 아니하고 다만 다윗을 택하여 내 백성 이스라엘을 다스리게 하였노라, 하셨으므로',
        17: '내 아버지 다윗이 주 이스라엘의 하나님의 이름을 위해 집을 건축할 마음을 품었더니',
        18: '주께서 내 아버지 다윗에게 이르시되, 네가 내 이름을 위해 집을 건축할 것을 마음에 품었은즉 네가 그 일을 마음에 품어 잘하였도다.',
        19: '그럼에도 불구하고 너는 그 집을 건축하지 못할 것이요, 오직 네 허리에서 나올 네 아들 그가 내 이름을 위해 집을 건축하리라, 하셨느니라.',
        20: '주께서 친히 하신 자신의 말씀을 이행하셨고 내가 주께서 약속하신 대로 내 아버지 다윗을 대신하여 일어나 이스라엘 왕좌에 앉고 또 주 이스라엘의 하나님의 이름을 위해 집을 건축하였으며',
        21: '또 내가 거기에 그분께서 우리 조상들을 이집트 땅에서 데리고 나오실 때에 그분께서 그들과 맺으신 주의 언약을 넣은 궤를 두기 위해 한 처소를 마련하였노라, 하니라.',
        22: '¶솔로몬이 이스라엘의 온 회중 앞에서 주의 제단 앞에 서서 하늘을 향해 자기의 두 손을 앞으로 펼치고',
        23: '이르되, 주 이스라엘의 하나님이여, 위로 하늘에나 아래로 땅에 주와 같은 하나님이 없나이다. 주께서는 마음을 다해 주 앞에서 걷는 주의 종들에게 언약을 지키시고 긍휼을 베푸시나이다.',
        24: '주께서 주의 종 내 아버지 다윗에게 약속하신 것을 그에게 지키시고 또한 주의 입으로 말씀하시고 주의 손으로 그것을 이루신 것이 이 날과 같으니이다.',
        25: '그러므로 주 이스라엘의 하나님이여, 주께서 주의 종 내 아버지 다윗에게 약속하여 이르시되, 네 자손들이 자기들의 길에 주의를 기울이고 네가 내 앞에서 걸은 것 같이 내 앞에서 걸으면 이스라엘 왕좌에 앉을 사람이 내 눈앞에서 네게 끊어지지 아니하리라, 하셨사오니 이제 그 약속을 그에게 지키시옵소서.',
        26: '오 이스라엘의 하나님이여, 이제 원하건대 주께서 주의 종 내 아버지 다윗에게 하신 주의 말씀을 확증하옵소서.',
        27: '그러나 하나님께서 참으로 땅에 거하시리이까? 보소서, 하늘과 하늘들의 하늘이라도 주를 품지 못하겠거늘 하물며 내가 건축한 이 집이오리이까?',
        28: '그럼에도, 오 주 내 하나님이여, 주의 종의 기도와 간구에 관심을 기울이시고 또 주의 종이 오늘 주 앞에서 기도하는 기도와 부르짖음에 귀를 기울이시옵소서.',
        ...
        31: '¶만일 어떤 사람이 자기 이웃에게 범법하였으므로 그가 맹세하게 하는 서약을 맺고 그 서약이 이 집에 있는 주의 제단 앞에 이르거든',
        32: '그때에 주께서는 하늘에서 들으시고 행하시며 사악한 자를 정죄하여 그의 길을 그의 머리에 돌리시고 의로운 자를 의롭다 하여 그의 의대로 그에게 갚으사 주의 종들을 심판하시옵소서.',
        33: '¶주의 백성 이스라엘이 주께 죄를 지어 원수 앞에서 패한 뒤 주께로 다시 돌아와 주의 이름을 시인하고 이 집에서 주께 기도하며 간구를 드리거든',
        34: '그때에 주께서는 하늘에서 들으시고 주의 백성 이스라엘의 죄를 용서하시며 주께서 그들의 조상들에게 주신 땅으로 그들이 다시 돌아오게 하옵소서.',
        35: '¶그들이 주께 죄를 지어 하늘이 닫히고 비가 없어 주께서 그들을 괴롭게 하실 때에 그들이 이곳을 향하여 기도하며 주의 이름을 시인하고 자기들의 죄에서 돌이키거든',
        36: '그때에 주께서는 하늘에서 들으시고 주의 종들과 주의 백성 이스라엘의 죄를 용서하시며 그들이 마땅히 걸어야 할 선한 길을 그들에게 가르쳐 주시고 또 주께서 주의 백성에게 상속 재산으로 주신 주의 땅에 비를 내리시옵소서.',
        37: '¶만일 그 땅에 기근이 있거나 역병이나 마름병이나 곰팡이나 메뚜기가 있거나 혹은 쐐기벌레가 나거나 그들의 원수가 그들의 도시들의 땅에서 그들을 에워싸거나 무슨 재앙이나 무슨 질병이 있든지',
        38: '어떤 사람이나 혹은 주의 온 백성 이스라엘이 각각 자기 마음의 재앙을 알고 이 집을 향해 자기의 두 손을 앞으로 펼치고 무슨 기도나 무슨 간구를 드리거든',
        39: '그때에 주께서는 하늘 곧 주의 거처에서 들으시고 용서하시며 또 주께서 각 사람의 마음을 아시오니 각 사람에게 그의 길들대로 행하사 갚으시옵소서. (주 곧 주만 홀로 사람들의 모든 자녀들의 마음을 아시나이다.)',
        40: '그리하시면 그들이 주께서 우리 조상들에게 주신 땅에 사는 모든 날 동안 주를 두려워하리이다.',
        41: '또 주의 백성 이스라엘에 속하지 아니한 자 곧 주의 이름으로 인하여 먼 지방에서 오는 타국인에 관하여는',
        42: '(그들이 주의 크신 이름과 주의 강한 손과 주의 뻗은 팔에 대해 들을 터이므로) 그가 와서 이 집을 향하여 기도하거든',
        43: '주께서는 하늘 곧 주의 거처에서 들으시고 그 타국인이 주를 부르며 구하는 모든 것에 따라 행하사 땅의 모든 백성들이 주의 백성 이스라엘처럼 주의 이름을 알고 주를 두려워하게 하시오며 또 내가 건축한 이 집이 주의 이름으로 불리는 줄을 알게 하옵소서.',
        44: '¶만일 주의 백성이 자기들의 원수와 싸우려고 주께서 보내실 곳으로 나갈 때에 그들이 주께서 택하신 도시와 내가 주의 이름을 위해 건축한 집을 향하여 주께 기도하거든',
        45: '그때에 주께서는 하늘에서 그들의 기도와 간구를 들으시고 그들의 사정을 돌아보옵소서.',
        46: '(죄를 짓지 않는 사람이 없사오니) 만일 그들이 주께 죄를 지으므로 주께서 그들에게 분노하사 그들을 그 원수에게 넘겨주시매 그들이 그들을 포로로 사로잡아 멀든지 가깝든지 원수의 땅으로 끌고 갔을 경우',
        47: '그럼에도 그들이 자기들이 포로로 사로잡혀 간 땅에서 스스로 깨닫고 자기들을 포로로 사로잡아 간 자들의 땅에서 회개하며 주께 간구하여 말하기를, 우리가 죄를 짓고 그릇되게 행하였으며 악한 일을 행하였나이다, 하고',
        48: '또 그와 같이 자기들을 포로로 사로잡아 간 자기 원수들의 땅에서 마음을 다하고 혼을 다해 주께로 돌아와 주께서 자기 조상들에게 주신 자기들의 땅을 향하여 곧 주께서 택하신 도시와 내가 주의 이름을 위해 건축한 집을 향하여 주께 기도하거든',
        49: '그때에 주께서는 하늘 곧 주의 거처에서 그들의 기도와 간구를 들으시고 그들의 사정을 돌아보사',
        50: '주께 죄를 지은 주의 백성을 용서하시며 그들이 주께 범법하며 행한 그들의 모든 범법을 용서하시고 또 그들을 포로로 사로잡아 간 자들 앞에서 그들을 불쌍히 여기사 그들이 그들을 불쌍히 여기게 하옵소서.',
        51: '그들은 주께서 쇠 용광로 한가운데서 곧 이집트에서 데리고 나오신 주의 백성이며 주의 상속 재산이니이다.',
        52: '원하건대 주의 눈을 주의 종의 간구와 주의 백성 이스라엘의 간구를 향해 여사 그들이 주를 부르며 구하는 모든 일에서 그들에게 귀를 기울이소서.',
        53: '오 주 하나님이여, 주께서 우리 조상들을 이집트에서 데리고 나오실 때에 주의 종 모세의 손으로 말씀하신 바와 같이 주께서 땅의 모든 백성들 가운데서 그들을 구별하사 주의 상속 백성으로 삼으셨나이다, 하더라.',
        54: '솔로몬이 이 모든 기도와 간구로 주께 기도하기를 마친 뒤 하늘을 향해 두 손을 펼친 채 무릎을 꿇는 자세를 고치고 주의 제단 앞에서 일어나',
        55: '서서 큰 목소리로 이스라엘 온 회중을 축복하며 이르되,',
        56: '주를 찬송할지로다. 그분께서 친히 약속하신 모든 것에 따라 자신의 백성 이스라엘에게 안식을 주셨으니 그분께서 자신의 종 모세의 손으로 약속하신바 자신의 모든 선한 약속 중 한 말씀도 이루지 아니하신 것이 없도다.',
        57: '주 우리 하나님께서 우리 조상들과 함께 계시던 것 같이 우리와 함께 계시사 우리를 떠나지 마시며 버리지 마시기를 원하고',
        58: '또 우리의 마음을 자신에게로 향하게 하사 자신의 모든 길로 걷게 하시며 친히 우리 조상들에게 명령하신 자신의 명령과 법규와 판단의 법도를 지키게 하시기를 원하고',
        59: '내가 주 앞에서 간구하면서 말한 나의 이 말들이 밤낮으로 주 우리 하나님에게 가까이 있게 하사 친히 자신의 종의 사정과 자신의 백성 이스라엘의 사정을 언제나 일이 필요로 하는 대로 돌아보시고',
        60: '이로써 땅의 모든 백성들이 주는 하나님이시며 그분 외에 다른 이가 없는 줄을 알게 하시기를 원하노라.',
        61: '그런즉 너희 마음을 주 우리 하나님께 대해 완전하게 하고 이 날과 같이 그분의 법규 안에서 걸으며 그분의 명령들을 지킬지어다.',
        62: '¶왕과 및 왕과 함께한 온 이스라엘이 주 앞에 희생물을 드리니라.',
        63: '솔로몬이 화평 헌물의 희생물을 드렸는데 그가 주께 드린 것은 소가 이만 이천 마리요, 양이 십이만 마리더라. 이와 같이 왕과 이스라엘의 모든 자손이 주의 집을 봉헌하니라.',
        64: '바로 그 날에 왕이 주의 집 앞에 있던 뜰의 한가운데를 거룩히 구별하고 거기서 번제 헌물과 음식 헌물과 화평 헌물의 기름을 드렸으니 이는 주 앞에 있던 놋 제단이 너무 작아서 번제 헌물과 음식 헌물과 화평 헌물의 기름을 수용할 수 없었기 때문이더라.',
        65: '그때에 솔로몬과 그와 함께한 온 이스라엘 곧 하맛의 입구에서부터 이집트의 강까지의 큰 회중이 이레와 이레 동안 곧 열나흘 동안 주 우리 하나님 앞에서 명절을 지키니라.',
        66: '여덟째 날에 그가 백성을 돌려보내매 그들이 왕을 축복하고 자기 장막으로 돌아가면서 주께서 자신의 종 다윗과 자신의 백성 이스라엘에게 행하신 모든 선하심으로 인해 마음속으로 기뻐하며 즐거워하였더라.',
    },
    9: {
        1: '솔로몬이 주의 집과 왕의 집 건축하기를 마치고 자기가 기쁘게 행하고자 하던 것 즉 솔로몬의 모든 소원을 끝마친 때에',
        2: '주께서 전에 기브온에서 그에게 나타나신 것 같이 두 번째 솔로몬에게 나타나',
        3: '주께서 그에게 이르시되, 네가 내 앞에서 드린 네 기도와 간구를 내가 들었고 네가 건축한 이 집에 거기에 내 이름을 영원히 두려고 그것을 거룩하게 구분하였은즉 내 눈과 내 마음을 영구히 거기에 두리라.',
        ...
        8: '또 이 집이 높을지라도 그 옆으로 지나가는 자마다 이 집으로 인해 놀라고 비웃으며 그들이 이르되, 주께서 무슨 까닭으로 이 땅과 이 집에 이같이 행하셨는가? 하면',
        9: '그들이 대답하기를, 그 까닭은 그들이 자기 조상들을 이집트 땅에서 데리고 나오신 주 자기들의 하나님을 버리고 다른 신들을 붙들며 그들에게 경배하고 그들을 섬겼기 때문이라. 그러므로 주께서 이 모든 재앙을 그들에게 가져오셨도다, 하리라, 하셨더라.',
        10: '¶이십 년이 끝난 뒤에 솔로몬이 두 집 곧 주의 집과 왕의 집을 건축하고',
        ...
        15: '¶솔로몬 왕이 일꾼들을 모집한 까닭은 이러하니 곧 그가 주의 집과 자기 집과 밀로와 예루살렘 성벽과 하솔과 므깃도와 게셀을 건축하고자 하였기 때문이라.',
        ...
        25: '¶솔로몬이 자기가 주를 위하여 쌓은 제단 위에 한 해에 세 번 번제 헌물과 화평 헌물을 드리고 또 주 앞에 있던 제단에서 분향하니라. 이와 같이 그가 그 집을 완성하니라.',
    ...
    10: {
        1: '세바의 여왕이 주의 이름에 관해 솔로몬의 명성을 듣고 와서 어려운 문제들로 그를 시험하려고',
        ...
        5: '그의 상의 음식물과 그의 신하들의 앉는 것과 그의 일꾼들의 섬기는 것과 그들의 의복과 그의 잔 나르는 자들과 그가 주의 집에 올라갈 때 쓰는 그의 오르막 통로를 보고는 더 이상 정신이 없어서',
        ...
        9: '주 당신의 하나님을 찬송할지로다. 그분께서 당신을 기뻐하사 이스라엘 왕좌에 당신을 앉히시고 주께서 영원히 이스라엘을 사랑하셨으므로 당신을 왕으로 삼아 판단의 공의와 정의를 행하게 하셨도다, 하고',
        ...
        12: '왕이 백단목으로 주의 집과 왕의 집의 기둥들을 만들고 또 노래하는 자들을 위하여 하프와 비파를 만들었는데 이 같은 백단목은 전에 오지도 아니하였고 이 날까지 보지도 못한 것이더라.',
    ...
    11: {
        ...
        2: '그 민족들에 관하여는 주께서 이스라엘 자손에게 이르시되, 너희는 그들에게로 들어가지 말며 그들도 너희에게로 들어오지 못하게 하라. 그들이 반드시 너희 마음을 돌려 자기들의 신들을 따르게 하리라, 하셨으나 솔로몬이 사랑에 빠져 이들에게 굳게 붙었더라.',
        ...
        6: '솔로몬이 주의 눈앞에서 악을 행하고 자기 아버지 다윗이 전적으로 주를 따른 것같이 따르지 아니하며',
        ...
        11: '주께서 솔로몬에게 이르시되, 네가 이러한 일을 행하였고 또 내가 네게 명령한 내 언약과 내 법규를 네가 지키지 아니하였은즉 내가 반드시 왕국을 네게서 빼앗아 찢어서 네 신하에게 주리라.',
        ...
        14: '¶주께서 에돔 족속 하닷을 일으켜 솔로몬의 대적이 되게 하셨는데 그는 에돔에서 왕의 씨에 속한 자였더라.',
    ...
    12: {
        ...
        5: '그가 그들에게 이르되, 사흘 동안 떠나갔다가 다시 내게로 오라, 하매 백성이 떠나가니라.',
        ...
        13: '왕이 백성에게 거칠게 대답하며 노인들이 자기에게 준 권고를 버리고',
        14: '청년들의 권고를 따라 그들에게 말하여 이르되, 내 아버지는 너희 멍에를 무겁게 하였으나 나는 너희 멍에에 더하리라. 또한 내 아버지는 채찍으로 너희를 벌하였으나 나는 전갈로 너희를 벌하리라, 하니라.',
        15: '그런 까닭에 왕이 백성의 말에 귀를 기울이지 아니하였으니 이는 그 원인이 주로부터 났기 때문이라. 이것은 주께서 전에 실로 사람 아히야를 통해 느밧의 아들 여로보암에게 하신 말씀 곧 자신의 말씀을 친히 이행하려 하심이더라.',
        ...
        20: '여로보암이 돌아왔다는 것을 온 이스라엘이 듣고 사람을 보내어 그를 회중에게로 불러 온 이스라엘을 다스릴 왕으로 삼으니 오직 유다 지파 외에는 다윗의 집을 따른 자가 아무도 없더라.',
        21: '¶르호보암이 예루살렘에 이르러 유다의 온 집과 베냐민 지파를 모았는데 선정된 자들 곧 용사들이 십팔만 명이더라. 이들이 이스라엘의 집과 싸워 왕국을 다시 솔로몬의 아들 르호보암에게 가져오려 하였으나',
        22: '하나님의 말씀이 하나님의 사람 스마야에게 임하니라. 이르시되,',
        23: '솔로몬의 아들 유다 왕 르호보암과 유다와 베냐민의 온 집과 또 백성의 남은 자들에게 말하여 이르기를,',
        24: '주가 이같이 말하노라. 너희는 올라가지 말며 또 너희 형제 이스라엘 자손과 싸우지 말고 각각 자기 집으로 돌아가라. 이 일은 내게서 났느니라, 하라, 하시니라. 그러므로 그들이 주의 말씀에 귀를 기울이고 주의 말씀에 따라 떠나서 돌아갔더라.',
        25: '¶그때에 여로보암이 에브라임 산에 세겜을 건축하고 그 안에 거하며 또 거기서 나가 브느엘을 건축하고',
        ...
        33: '이와 같이 그가 자기 마음속으로 생각하여 정한 달 곧 팔월 십오일에 자기가 벧엘에 만든 제단 위에 헌물을 드렸으며 이스라엘 자손을 위하여 명절을 정하고 제단 위에 헌물을 드리고 분향하니라.',
    },
    13: {
        1: '보라, 하나님의 사람 하나가 주의 말씀으로 말미암아 유다에서 나와 벧엘에 이르렀는데 여로보암이 제단 옆에 서서 분향하므로',
        2: '그가 제단을 향하여 주의 말씀으로 외쳐 이르되, 오 제단아, 제단아, 주가 이같이 말하노라. 보라, 다윗의 집에 요시야라는 이름의 아이가 태어나리니 그가 네 위에 분향하는 산당들의 제사장들을 네 위에 헌물로 드릴 것이요, 또 사람들의 뼈를 네 위에서 태우리라, 하고',
        3: '바로 그 날에 그가 표적을 주며 이르되, 이것은 주께서 말씀하신 표적이라. 보라, 제단이 갈라지며 그 위에 있는 재가 쏟아지리라, 하니라.',
        4: '하나님의 사람이 벧엘에 있는 제단을 향하여 외쳐 말하는 것을 여로보암 왕이 들을 때에 그가 제단에서 손을 내밀며 이르기를, 그를 잡으라, 하였는데 이때에 그가 그를 향하여 내민 손이 말라서 그가 다시 그것을 거두어들이지 못하였더라.',
        5: '또 하나님의 사람이 주의 말씀으로 준 표적대로 제단도 갈라지며 재가 제단에서 쏟아지므로',
        6: '왕이 하나님의 사람에게 응답하여 이르되, 이제 주 곧 네 하나님의 얼굴에게 은혜를 간구하고 나를 위해 기도하여 내 손이 다시 회복되게 하라, 하매 하나님의 사람이 주께 간청하니 왕의 손이 다시 회복되어 전과 같이 되니라.',
        7: '왕이 하나님의 사람에게 이르되, 나와 함께 집에 가서 원기를 회복하라. 내가 네게 보상을 주리라, 하매',
        8: '하나님의 사람이 왕에게 이르되, 왕께서 왕의 집 절반을 내게 줄지라도 나는 왕과 함께 들어가지 아니하고 이곳에서 빵도 먹지 아니하며 물도 마시지 아니하리이다.',
        9: '주께서 말씀으로 내게 이같이 명하여 이르시기를, 빵도 먹지 말며 물도 마시지 말고 네가 왔던 같은 길로 되돌아가지도 말라, 하셨나이다, 하고',
        10: '이에 그가 다른 길로 가고 자기가 벧엘로 올 때 택한 길로 되돌아가지 아니하니라.',
        11: '¶이제 벧엘에 한 늙은 대언자가 거하더라. 그의 아들들이 와서 그 날에 하나님의 사람이 벧엘에서 행한 모든 일을 그에게 고하고 또 그가 왕에게 전한 말씀들도 자기들의 아버지에게 고하였으므로',
        12: '그들의 아버지가 그들에게 이르되, 그가 어느 길로 갔느냐? 하였으니 이는 그의 아들들이 유다에서 온 하나님의 사람이 어느 길로 갔는지 보았기 때문이더라.',
        13: '그가 자기 아들들에게 이르되, 나를 위해 나귀에 안장을 얹으라, 하니 이에 그들이 그를 위해 나귀에 안장을 얹으매 그가 그 위에 타고는',
        14: '하나님의 사람의 뒤를 따라가서 그가 상수리나무 밑에 앉은 것을 보고 그에게 이르되, 그대가 유다에서 온 하나님의 사람이냐? 하니 그가 이르되, 그러하다, 하매',
        ...
        17: '주께서 말씀으로 내게 이르시기를, 너는 거기서 빵도 먹지 말며 물도 마시지 말고 네가 올 때 택한 길로 가려고 되돌아서지도 말라, 하셨느니라, 하매',
        18: '그가 그 사람에게 이르되, 나도 그대와 같은 대언자라. 천사가 주의 말씀으로 내게 말하여 이르기를, 그를 네 집으로 데리고 돌아가서 그가 빵을 먹게 하고 물을 마시게 하라, 하였느니라, 하니라. 그러나 그가 그 사람에게 거짓말을 하였더라.',
        19: '이에 그 사람이 그와 함께 돌아가서 그의 집에서 빵을 먹으며 물을 마시니라.',
        20: '¶그들이 상에 앉았을 때에 주의 말씀이 그 사람을 데려온 대언자에게 임하였으므로',
        21: '그가 유다에서 온 하나님의 사람을 향하여 외쳐 이르되, 주가 이같이 말하노라. 네가 주의 입의 말씀에 순종하지 아니하고 주 네 하나님이 네게 명령한 명령을 지키지 아니하며',
        22: '돌아와서 주가 네게 빵도 먹지 말며 물도 마시지 말라 한 곳에서 빵을 먹고 물을 마셨으니 네 사체가 네 조상들의 돌무덤에 들어가지 못하리라, 하니라.',
        23: '¶그 사람이 빵을 먹고 물을 마신 뒤에 그가 자기가 데리고 돌아온 대언자를 위해 즉 그를 위해 나귀에 안장을 얹어 주니라.',
        ...
        26: '그 사람을 길에서 데리고 돌아간 대언자가 그것을 듣고 이르되, 그것은 주의 말씀에 순종하지 아니한 하나님의 사람이로다. 그런즉 주께서 친히 그에게 하신 말씀대로 주께서 그를 사자에게 넘겨주시매 사자가 그를 찢어 죽였도다, 하고',
        ...
        29: '그 대언자가 하나님의 사람의 사체를 들어 나귀에 싣고 그 사체를 가지고 돌아오니라. 그 늙은 대언자가 도시로 들어가 애곡하며 그를 묻고',
        30: '그의 사체를 자기 무덤에 두니 그들이 그를 위해 애곡하며 이르되, 아 슬프다, 내 형제여! 하니라.',
        31: '그가 그 사람을 묻은 뒤에 자기 아들들에게 말하여 이르되, 내가 죽거든 하나님의 사람을 묻은 돌무덤에 나를 묻되 내 뼈를 그의 뼈 옆에 두라.',
        32: '그가 주의 말씀으로 벧엘에 있는 제단을 향하여 외친 말과 또 사마리아의 도시들에 있는 산당들의 모든 집을 향하여 외친 말이 반드시 이루어지리라, 하니라.',
        33: '¶여로보암이 이 일이 있은 뒤에도 자기의 악한 길에서 돌이키지 아니하고 다시금 백성 중에서 가장 천한 자들을 산당들의 제사장들로 삼되 누구든지 원하기만 하면 그를 구분하여 산당들의 제사장들 중의 하나가 되게 하였으므로',
    ...
    14: {
        ...
        5: '¶주께서 아히야에게 이르시되, 보라, 여로보암의 아내가 자기 아들이 병들었으므로 그를 위해 네게 한 가지 일을 물으러 오나니 너는 그녀에게 이렇게 이렇게 대답하라. 그녀가 들어올 때에 다른 여인으로 가장하리라, 하시니라.',
        6: '그녀가 문에서 들어올 때에 아히야가 그녀의 발소리를 듣고 이르되, 여로보암의 아내여, 들어오라. 네가 어찌하여 다른 사람으로 가장하느냐? 내가 엄중한 소식을 전하라고 네게 보내어졌느니라.',
        7: '가서 여로보암에게 고하되, 주 이스라엘의 하나님께서 이같이 말씀하시기를, 내가 너를 백성 가운데서 높여 내 백성 이스라엘을 다스릴 통치자가 되게 하고',
        ...
        14: '또한 주께서 친히 이스라엘을 다스릴 한 왕을 일으키실 터인즉 그가 그 날에 여로보암의 집을 끊어 버리리라. 그런데 무슨 말이냐? 곧 지금이니라.',
        15: '주께서 이스라엘을 쳐서 물에서 흔들리는 갈대같이 되게 하시고 친히 그들의 조상들에게 주신 이 좋은 땅에서 이스라엘을 뿌리째 뽑아 강 너머로 그들을 흩으시리니 이는 그들이 작은 숲들을 만들어 주의 분노를 일으켰기 때문이니라.',
        ...
        18: '그들이 그를 묻고 온 이스라엘이 그를 위하여 애곡하니 주께서 친히 자신의 종 대언자 아히야의 손으로 하신 말씀과 같았더라.',
        ...
        26: '주의 집의 보물과 왕의 집의 보물을 빼앗되 다 빼앗고 또 전에 솔로몬이 만든 모든 금 방패들을 빼앗았으므로',
        27: '르호보암 왕이 그것들 대신 놋 방패들을 만들어 왕의 집 문을 지키는 호위대 우두머리의 손에 맡기매',
        28: '왕이 주의 집에 들어갈 때에 호위병들이 그 방패들을 들고 갔다가 다시 호위대 방으로 그것들을 가져갔더라.',
    ...
    15: {
        ...
        15: '또 그가 자기 아버지가 봉헌한 물건들과 자기가 봉헌한 물건들 곧 은과 금과 그릇들을 가져다가 주의 집에 들여놓았더라.',
        16: '¶아사와 이스라엘 왕 바아사 사이에 그들의 평생 동안 전쟁이 있었더라.',
        17: '이스라엘 왕 바아사가 유다를 치러 올라와서 라마를 건축하여 아무도 유다 왕 아사에게로 들어가거나 나오지 못하게 하려 하니라.',
        18: '이에 아사가 주의 집의 보고와 왕의 집의 보고에 남아 있던 모든 은과 금을 취하여 자기 신하들의 손에 넘겨주고 아사 왕이 다마스쿠스에 거하던 시리아 왕 곧 헤시온의 손자요, 다브림몬의 아들인 벤하닷에게 그것들을 보내며 이르되,',
        ...
        26: '그가 주의 눈앞에서 악을 행하고 자기 아버지의 길로 걸었으며 또 자기 아버지가 이스라엘로 하여금 죄를 짓게 할 때 이용한 그의 죄 가운데서 걸었더라.',
        ...
        29: '그가 통치할 때에 여로보암의 온 집을 쳐서 마침내 그를 멸하고 숨 쉬는 자를 여로보암에게 하나도 남기지 아니하되 주께서 자신의 종 실로 사람 아히야를 통하여 친히 하신 말씀대로 하였으니',
        30: '이는 여로보암이 지은 죄들과 또 그가 주 이스라엘의 하나님의 분노를 일으킴으로써 이스라엘로 하여금 죄를 짓게 한 죄들로 인함이더라.',
        ...
        34: '그가 주의 눈앞에서 악을 행하고 여로보암의 길로 걸었으며 또 여로보암이 이스라엘로 하여금 죄를 짓게 할 때 이용한 그의 죄 가운데서 걸었더라.',
    },
    16: {
        1: '그때에 주의 말씀이 하나니의 아들 예후에게 임하여 바아사를 대적하며 이르시되,',
        ...
        7: '또한 주의 말씀이 하나니의 아들 대언자 예후의 손으로 바아사와 그의 집을 대적하여 임하였으니 이는 그가 여로보암의 집을 본받아 주의 눈앞에서 모든 악을 행하고 자기 손의 일로 그분의 분노를 일으켰기 때문이며 또 그를 죽였기 때문이더라.',
        ...
        12: '시므리가 이같이 바아사의 온 집을 멸하되 주께서 대언자 예후를 통해 바아사를 대적하여 하신 말씀대로 하였으니',
        13: '이는 바아사의 모든 죄와 그의 아들 엘라의 죄들로 인함이라. 그들이 이 죄들을 짓고 또 그것들을 써서 이스라엘로 하여금 죄를 짓게 하여 그들의 헛된 것으로 주 이스라엘의 하나님의 분노를 일으켰더라.',
        ...
        19: '이는 그가 주의 눈앞에서 악을 행하는 가운데 지은 죄들로 인함이라. 그가 여로보암의 길로 걸었으며 또 여로보암이 이스라엘로 하여금 죄를 짓게 하려고 행한 그의 죄 가운데서 걸었더라.',
        ...
        25: '¶그러나 오므리가 주의 눈에 악을 행하되 자기 이전에 있던 모든 사람보다 더욱 악하게 행하였으니',
        26: '그가 느밧의 아들 여로보암의 모든 길로 걸었으며 또 여로보암이 이스라엘로 하여금 죄를 짓게 할 때 이용한 그의 죄 가운데서 걸어 그들의 헛된 것으로 주 이스라엘의 하나님의 분노를 일으켰더라.',
        ...
        34: '¶그의 시대에 벧엘 사람 히엘이 여리고를 건축하였는데 주께서 눈의 아들 여호수아를 통하여 하신 말씀에 따라 그가 그것의 기초를 놓을 때에 자기의 맏아들 아비람을 잃고 그것의 문들을 세울 때에 자기의 막내아들 스굽을 잃었더라.',
    },
    17: {
        1: '길르앗 거주민 디셉 사람 엘리야가 아합에게 이르되, 내가 서서 섬기는 주 이스라엘의 하나님께서 살아 계심을 두고 맹세하노니 내 말이 있지 아니하면 이 몇 년 동안 이슬이나 비가 있지 아니하리라, 하니라.',
        2: '주의 말씀이 그에게 임하니라, 이르시되,',
        3: '너는 여기를 떠나 동쪽으로 가서 요르단 앞 그릿 시냇가에 숨고',
        4: '그 시내에서 물을 마시라. 내가 까마귀들에게 명령하여 거기서 너를 먹이게 하였느니라, 하시니라.',
        5: '이에 그가 가서 주의 말씀대로 행하였으니 곧 그가 가서 요르단 앞 그릿 시냇가에 거하였더라.',
        ...
        14: '주 이스라엘의 하나님께서 이같이 말씀하시기를, 주가 비를 땅 위에 내리는 날까지 가루 통이 고갈되지 아니하고 기름병이 마르지 아니하리라, 하시느니라, 하니라.',
        15: '그녀가 가서 엘리야의 말대로 하였더니 그녀와 엘리야와 그녀의 집이 여러 날 먹었으나',
        16: '주께서 엘리야를 통하여 친히 하신 말씀대로 가루 통이 고갈되지 아니하고 기름병이 마르지 아니하니라.',
        ...
        20: '주께 부르짖어 이르되, 오 주 내 하나님이여, 주께서 내가 머무는 집의 과부의 아들을 죽이심으로써 그녀에게 또 재앙을 내리셨나이까? 하고',
    ...
    18: {
        1: '여러 날이 지난 뒤 셋째 해에 주의 말씀이 엘리야에게 임하니라. 이르시되, 가서 너를 아합에게 보이라. 내가 비를 땅 위에 내리리라, 하시니라.',
        2: '엘리야가 자기를 아합에게 보이려고 갔는데 사마리아에 심한 기근이 있더라.',
        3: '아합이 자기 집을 다스리는 자 오바댜를 부르니라. (이제 오바댜는 크게 주를 두려워하였더라.',
        4: '이세벨이 주의 대언자들을 끊어 버릴 때에 오바댜가 대언자 백 명을 데려다가 그들을 오십 명씩 굴에 숨기고 그들에게 빵과 물을 먹였더라.)',
        5: '아합이 오바댜에게 이르기를, 땅으로 가되 모든 물 근원과 모든 시내로 가라. 혹시 우리가 풀을 찾으면 말과 노새들을 살리리니 그리하면 우리가 모든 짐승을 잃지는 아니하리라, 하고는',
        6: '이에 그들이 두루 다닐 땅을 서로 나누어 아합은 홀로 이 길로 가고 오바댜는 홀로 저 길로 가니라.',
        7: '¶보라, 오바댜가 길에 있을 때에 엘리야가 그를 만나매 그가 그를 알아보고는 얼굴을 대고 엎드려 이르되, 당신이 내 주 그 엘리야이시니이까? 하니',
        8: '그가 대답하되, 그러하다. 가서 네 주에게 고하기를, 보소서, 엘리야가 여기 있나이다, 하라, 하매',
        9: '그가 이르되, 내가 무슨 죄를 지었기에 당신이 당신의 종을 아합의 손에 넘겨주어 죽게 하려 하시나이까?',
        10: '주 당신의 하나님께서 살아 계심을 두고 맹세하옵나니 내 주께서 당신을 찾으려고 사람을 보내지 아니한 민족이나 왕국이 없는데 그들이 말하기를, 그가 거기 없다, 하면 그가 그 왕국과 그 민족에게 맹세하게 하되 그들이 당신을 보지 못하였다고 맹세하게 하였나이다.',
        11: '이제 당신이 이르시되, 가서 네 주에게 고하기를, 보소서, 엘리야가 여기 있나이다, 하라, 하시나',
        12: '내가 당신을 떠나간 뒤에 곧바로 주의 영께서 내가 알지 못하는 곳으로 당신을 데려가시리니 그런즉 내가 가서 아합에게 고하였다가 그가 당신을 찾지 못하면 나를 죽이리이다. 오직 당신의 종 나는 어려서부터 주를 두려워하나이다.',
        ...
        15: '엘리야가 이르되, 내가 서서 섬기는 만군의 주께서 살아 계심을 두고 맹세하노니 내가 오늘 반드시 나를 그에게 보이리라, 하니라.',
        16: '이에 오바댜가 가서 아합을 만나 그에게 고하매 아합이 엘리야를 만나려고 가니라.',
        17: '¶아합이 엘리야를 볼 때에 그에게 이르되, 네가 이스라엘을 괴롭게 하는 자냐? 하매',
        18: '그가 대답하되, 내가 이스라엘을 괴롭게 하지 아니하고 당신과 당신의 아버지 집이 괴롭게 하였나니 곧 당신들이 주의 명령들을 버렸고 당신이 바알들을 따랐나이다.',
        19: '그런즉 이제 사람을 보내어 온 이스라엘과 또 이세벨의 상에서 먹는 바알의 대언자 사백오십 명과 작은 숲의 대언자 사백 명을 갈멜 산으로 모아 내게로 나오게 하소서, 하매',
        20: '이에 아합이 이스라엘의 모든 자손에게로 사람을 보내어 그 대언자들을 갈멜 산으로 함께 모으니라.',
        21: '엘리야가 온 백성에게 가서 이르되, 너희가 어느 때까지 두 의견 사이에서 머뭇거리려느냐? 만일 주께서 하나님이면 그분을 따르려니와 만일 바알이 하나님이면 그를 따를지니라, 하니 백성이 그에게 한 마디도 응답하지 아니하매',
        22: '그때에 엘리야가 백성에게 이르되, 주의 대언자로는 나 곧 나만 홀로 남았으나 바알의 대언자는 사백오십 명이로다.',
        23: '그런즉 그들이 수소 두 마리를 우리에게 주게 하고 또 자기들을 위해 수소 하나를 택하여 그것을 여러 조각으로 자르고 나무 위에 놓되 그 밑에 불은 붙이지 말게 하라. 나는 다른 수소를 예비하여 나무 위에 놓고 그 밑에 불은 붙이지 아니하리라.',
        24: '또 너희는 너희 신들의 이름을 부르라. 나는 주의 이름을 부르리니 불로 응답하는 신 곧 그분이 하나님이시니라, 하매 온 백성이 응답하여 이르기를, 잘 말씀하셨나이다, 하니라.',
        25: '엘리야가 바알의 대언자들에게 이르되, 너희는 많으니 그런즉 너희를 위해 먼저 수소 하나를 택하여 예비하고 너희 신들의 이름을 부르라. 그러나 그 밑에 불을 붙이지는 말라, 하매',
        26: '그들이 자기들에게 넘겨진 수소를 취하여 예비하고 아침부터 정오까지 바알의 이름을 불러 이르되, 오 바알이여, 우리 말을 들으소서, 하였으나 아무 소리도 없고 응답하는 자도 없으므로 그들이 그 만들어 놓은 제단 위에서 껑충 껑충 뛰더라.',
        27: '정오에 엘리야가 그들을 조롱하여 이르되, 큰 소리로 부르라. 그는 신이므로 지금 이야기하고 있거나 쫓아가고 있거나 여행 중이거나 혹은 자고 있으니 반드시 깨워야 하리라, 하매',
        28: '그들이 큰 소리로 부르고 자기들의 관례에 따라 몸에서 피가 철철 흐를 때까지 칼과 창으로 자기 몸을 찢었더라.',
        29: '한낮이 지나고 저녁 희생물을 드릴 때까지 그들이 대언하였으나 아무 음성도 없고 응답하는 자나 주목한 자가 아무도 없더라.',
        30: '엘리야가 온 백성에게 이르되, 내게로 가까이 오라, 하니 온 백성이 그에게로 가까이 오매 그가 무너진 주의 제단을 보수하고',
        31: '야곱의 아들들의 지파들 수에 따라 열두 돌을 취하였는데 이 야곱은 전에 주의 말씀이 임하여 이르시기를, 이스라엘이 네 이름이 되리라, 하신 자더라.',
        32: '그가 주의 이름으로 그 돌들로 제단을 쌓고 또 제단 주위에 이 세아 분량의 씨를 담을 만한 크기의 도랑을 만들며',
        33: '또 나무를 정돈하고 수소를 여러 조각으로 잘라 나무 위에 놓고 이르되, 통 넷에 물을 채워다가 태우는 희생물과 나무 위에 부으라, 하니라.',
        34: '또 그가 이르되, 두 번째 그리하라, 하니 그들이 두 번째 그리하고 또 그가 이르되, 세 번째 그리하라, 하니 그들이 세 번째 그리하매',
        35: '물이 제단 주위에 돌아가며 흐르더라. 그가 도랑에도 물을 가득 채웠더라.',
        36: '저녁 희생물을 드릴 때에 대언자 엘리야가 가까이 가서 이르되, 주 곧 아브라함과 이삭과 이스라엘의 하나님이여, 주께서 이스라엘 안에서 하나님이신 것과 내가 주의 종인 것과 내가 주의 말씀대로 이 모든 일을 행한 것을 저들이 이 날 알게 하소서.',
        ...
        41: '¶엘리야가 아합에게 이르되, 왕은 올라가서 먹고 마시소서. 많은 빗소리가 있나이다, 하니',
        42: '이에 아합이 먹고 마시러 올라가니라. 엘리야가 갈멜 산의 꼭대기로 올라가서 땅에 꿇어 엎드려 자기 얼굴을 무릎 사이에 넣고',
        43: '자기 종에게 이르되, 이제 올라가서 바다 쪽을 바라보라, 하니 그가 올라가서 바라보고 이르되, 아무것도 없나이다, 하매 그가 이르되, 일곱 번 다시 가라, 하니',
        44: '일곱 번째 이르러서는 그가 이르되, 보소서, 바다에서 사람의 손만 한 작은 구름이 일어나나이다, 하매 그가 이르되, 올라가서 아합에게 말하기를, 비에 막히지 아니하도록 왕의 병거를 준비하고 내려가소서, 하라, 하니라.',
        45: '그 동안에 구름과 바람으로 인해 하늘이 캄캄해지고 큰 비가 내리므로 아합이 병거를 타고 예스르엘로 갔는데',
        46: '주의 손이 엘리야에게 임하매 그가 허리를 동이고 예스르엘로 들어가는 곳까지 아합 앞에서 달려갔더라.',
    },
    19: {
        ...
        4: '¶그러나 그가 스스로 하룻길을 가서 광야로 들어가 로뎀나무에 이르러 그 밑에 앉아 스스로 죽기를 구하여 이르되, 오 주여, 족하오니 이제 내 생명을 취하시옵소서. 나는 내 조상들보다 낫지 아니하나이다, 하고',
        5: '로뎀나무 밑에 누워 자는데, 보라, 그때에 한 천사가 그를 어루만지며 그에게 이르되, 일어나 먹으라, 하니라.',
        6: '그가 바라보니, 보라, 머리맡에 숯에 구운 빵과 물 한 병이 있더라. 그가 먹고 마시고 다시 누웠더니',
        7: '주의 천사가 다시 두 번째 와서 그를 어루만지며 이르되, 일어나 먹으라. 갈 길이 네게 너무 머니라, 하므로',
        8: '그가 일어나 먹고 마시고 그 음식의 힘을 의지하여 밤낮으로 사십 일을 가서 하나님의 산 호렙에 이르니라.',
        9: '¶그가 거기로 가서 굴에 이르러 거기 거하였더라. 보라, 주의 말씀이 그에게 임하고 그분께서 그에게 이르시되, 엘리야야, 네가 여기서 무엇을 하느냐? 하매',
        ...
        11: '그분께서 이르시되, 앞으로 나아가 주 앞에서 산에 서라, 하시니라. 보라, 주께서 지나가시는데 주 앞에서 크고 강한 바람이 산들을 가르고 바위들을 산산조각으로 부수었으나 주께서 바람 가운데에 계시지 아니하였으며 바람이 지나간 뒤에 지진이 있었으나 주께서 지진 가운데에도 계시지 아니하였고',
        12: '또 지진이 있은 뒤에 불이 있었으나 주께서 불 가운데에도 계시지 아니하였으며 불이 있은 뒤에 고요한 작은 음성이 있더라.',
        13: '이에 엘리야가 그것을 듣고는 자기의 겉옷으로 얼굴을 싸고 나가서 굴의 어귀에 서니, 보라, 한 음성이 그에게 임하여 이르시되, 엘리야야, 네가 여기서 무엇을 하느냐? 하매',
        ...
        15: '주께서 그에게 이르시되, 네 길을 돌이켜 다마스쿠스의 광야로 가고 거기에 이르거든 하사엘에게 기름을 부어 시리아를 다스릴 왕이 되게 하며',
        ...
        19: '¶이에 그가 거기서 떠나 사밧의 아들 엘리사를 만났는데 그는 열두 겨리 소들을 자기 앞에 두고 밭을 갈았으며 그 자신은 열두째 겨리와 함께 있더라. 엘리야가 그의 곁을 지나가며 자기의 겉옷을 그 위에 던졌더니',
        20: '그가 소들을 남겨 두고 엘리야를 따라 달려가서 이르되, 원하건대 내가 내 아버지와 어머니에게 입 맞추게 하소서. 그리한 뒤에 내가 당신을 따르리이다, 하매 엘리야가 그에게 이르되, 돌아가라. 내가 네게 무슨 일을 하였느냐? 하니라.',
        21: '엘리사가 그를 떠나 돌아가서 한 겨리의 소들을 취하여 잡고 소의 기구로 그것들의 고기를 삶아 백성에게 주니 그들이 먹으매 이에 그가 일어나 엘리야를 따라가며 그를 섬겼더라.',
    },
    20: {
        ...
        14: '아합이 이르되, 누구를 통해 그리하시리이까? 하니 그가 이르되, 주가 이같이 말하노라. 여러 지방의 통치자들의 청년들을 통해 그리하리라, 하매 이에 그가 이르되, 누가 싸움을 지시하리이까? 하니 그가 대답하되, 왕이니이다, 하거늘',
        ...
        28: '¶하나님의 사람이 나아와 이스라엘 왕에게 말하여 이르되, 주가 이같이 말하노라. 시리아 사람들이 말하기를, 주는 산의 신이요, 골짜기의 신은 아니라, 하였도다. 그러므로 내가 이 온 큰 무리를 네 손에 넘겨주리니 내가 주인 줄을 너희가 알리라, 하니라.',
        ...
        35: '¶대언자들의 아들들 중의 어떤 사람이 주의 말씀으로 자기 이웃에게 이르되, 원하건대 나를 치라, 하였는데 그 사람이 치기를 거부하므로',
        36: '이에 그가 그 사람에게 이르되, 네가 주의 음성에 순종하지 아니하였은즉, 보라, 네가 나를 떠나갈 때에 곧바로 사자가 너를 죽이리라, 하니 그 사람이 그를 떠나가매 곧바로 사자가 그를 만나 그를 죽였더라.',
    ...
    21: {
        ...
        20: '아합이 엘리야에게 이르되, 오 내 원수여, 네가 나를 찾았느냐? 하니 그가 대답하되, 내가 너를 찾았노라. 네가 네 자신을 팔아 주의 눈앞에서 악을 행하였으므로',
    ...
    22: {
        ...
        8: '이스라엘 왕이 여호사밧에게 이르되, 아직 한 사람 곧 이믈라의 아들 미가야가 있으니 우리가 그를 통해 주께 여쭐 수 있으나 그는 나에 관하여 좋게 대언하지 아니하고 나쁘게 대언하므로 내가 그를 미워하나이다, 하매 여호사밧이 이르되, 왕은 그런 말씀을 하지 마소서, 하니',
        9: '이에 이스라엘 왕이 직무 수행자 하나를 불러 이르되, 이믈라의 아들 미가야를 속히 여기로 데려오라, 하니라.',
        ...
        13: '미가야를 부르러 간 사자가 그에게 말하여 이르되, 이제 보소서, 대언자들의 말이 한 입으로 왕에게 좋게 고하니 원하건대 당신의 말도 그들 중의 한 사람의 말처럼 되게 하여 좋은 것을 말하소서, 하매',
        14: '미가야가 이르되, 주께서 살아 계심을 두고 맹세하노니 주께서 내게 말씀하시는 것 즉 그것을 내가 말하리라, 하니라.',
        15: '¶이에 그가 왕에게 나오니 왕이 그에게 이르되, 미가야야, 우리가 라못길르앗을 치려고 싸우러 가랴, 아니면 삼가랴? 하매 그가 왕에게 대답하되, 가서 형통하소서. 주께서 그곳을 왕의 손에 넘겨주시리이다, 하니',
        16: '왕이 그에게 이르되, 내가 몇 번이나 너로 하여금 맹세하게 하여야 네가 주의 이름으로 오직 진실한 것만을 내게 고하겠느냐? 하매',
        17: '그가 이르되, 내가 보니 온 이스라엘이 목자 없는 양같이 산들에 흩어졌는데 주께서 말씀하시기를, 이들에게 주인이 없은즉 그들이 각각 평안히 자기 집으로 돌아가게 하라, 하셨나이다.',
        18: '이스라엘 왕이 여호사밧에게 이르되, 그가 나에 관하여 좋게 대언하지 아니하고 나쁘게 대언하려 한다고 내가 당신에게 말하지 아니하였나이까? 하매',
        19: '그가 이르되, 그런즉 왕은 주의 말씀을 들으소서. 내가 보니 주께서 자신의 왕좌에 앉으셨고 하늘의 온 군대가 그분 옆으로 오른쪽과 왼쪽에 서 있었나이다.',
        20: '주께서 이르시되, 누가 아합을 설득하여 그가 올라가 라못길르앗에서 쓰러지게 할까? 하시니 하나는 이런 식으로 말하고 다른 하나는 저런 식으로 말하였는데',
        21: '한 영이 나아와 주 앞에 서서 이르되, 내가 그를 설득하겠나이다, 하거늘',
        22: '주께서 그에게 이르시되, 무엇으로 하겠느냐? 하시니 그가 이르되, 내가 나가서 그의 모든 대언자들의 입에서 거짓말하는 영이 되겠나이다, 하매 그분께서 이르시되, 너는 그를 설득하겠고 또 이기리라. 나아가서 그와 같이 하라, 하셨나이다.',
        23: '그러므로 이제 보소서, 주께서 거짓말하는 영을 왕의 이 모든 대언자들의 입에 넣으셨고 또 주께서 왕에 관하여 화를 말씀하셨나이다, 하니라.',
        24: '그러나 그나아나의 아들 시드기야가 가까이 나아와 미가야의 뺨을 치며 이르되, 주의 영께서 나를 떠나 어느 길로 가서 네게 말씀하시더냐? 하니',
        25: '미가야가 이르되, 보라, 네가 안에 있는 방에 들어가서 숨는 그 날에 보리라, 하니라.',
        26: '이스라엘 왕이 이르되, 미가야를 붙잡아 도시의 감독자 아몬과 왕의 아들 요아스에게로 다시 끌고 가서',
        27: '이르되, 왕이 이같이 말하기를, 이놈을 감옥에 가두고 내가 평안히 올 때까지 고난의 빵과 고난의 물로 먹이라, 하신다, 하라, 하니',
        28: '미가야가 이르되, 왕이 참으로 평안히 돌아오실진대 주께서 나를 통해 말씀하지 아니하셨나이다, 하고 또 그가 이르되, 오 백성들아, 너희는 다 귀를 기울일지어다, 하니라.',
        ...
        38: '한 사람이 그 병거를 사마리아의 연못에서 씻으매 개들이 그의 피를 핥았고 그들이 그의 갑옷을 씻었으니 주께서 그에게 하신 말씀대로 되었더라.',
        39: '이제 아합의 나머지 행적과 그가 행한 모든 일과 그가 만든 상아 집과 그가 건축한 모든 도시들은 이스라엘 왕들의 연대기 책에 기록되어 있지 아니하냐?',
        ...
        43: '그가 자기 아버지 아사의 모든 길로 걸으며 거기서 돌이키지 아니하고 주의 눈에 올바른 것을 행하였으나 그럼에도 불구하고 산당들은 제거하지 아니하였으니 이는 백성이 여전히 산당들에서 헌물을 드리며 분향하였기 때문이더라.',
        44: '여호사밧이 이스라엘 왕과 화친하니라.',
        45: '이제 여호사밧의 나머지 행적과 그가 보여 준 그의 권력과 또 그가 어떻게 전쟁하였는지는 유다 왕들의 연대기 책에 기록되어 있지 아니하냐?',
