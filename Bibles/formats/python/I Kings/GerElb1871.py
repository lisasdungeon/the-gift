...
CHAPTERS = {
    ...
    2: {
        1: 'Als nun die Tage Davids herannahten, daß er sterben sollte, gebot er seinem Sohne Salomo und sprach:',
        2: 'Ich gehe den Weg der ganzen Erde; so sei stark und sei ein Mann;',
        3: 'und warte der Hut Jehovas, deines Gottes, daß du auf seinen Wegen wandelst, indem du seine Satzungen, seine Gebote und seine Rechte und seine Zeugnisse beobachtest, wie geschrieben ist in dem Gesetz Moses; auf daß es dir gelinge in allem, was du tust, und überall, wohin du dich wendest;',
        4: 'auf daß Jehova sein Wort aufrecht halte, das er über mich geredet hat, indem er sprach: Wenn deine Söhne auf ihren Weg achthaben, so daß sie vor mir wandeln in Wahrheit, mit ihrem ganzen Herzen und mit ihrer ganzen Seele, so soll es, sprach er, dir nicht an einem Manne fehlen auf dem Throne Israels.',
        ...
        6: 'So handle nun nach deiner Weisheit, und laß sein graues Haar nicht in Frieden in den Scheol hinabfahren.',
        7: 'Aber an den Söhnen Barsillais, des Gileaditers, sollst du Güte erweisen, und sie sollen unter denen sein, die an deinem Tische essen; denn also sind sie mir entgegengekommen, als ich vor deinem Bruder Absalom floh.',
        8: 'Und siehe, bei dir ist Simei, der Sohn Geras, der Benjaminiter, von Bachurim; und selbiger fluchte mir mit heftigem Fluche an dem Tage, da ich nach Machanaim ging. Aber er kam herab, mir entgegen, an den Jordan, und ich schwur ihm bei Jehova und sprach: Wenn ich dich mit dem Schwerte töte!',
        9: 'Nun aber halte ihn nicht für schuldlos, denn du bist ein weiser Mann und wirst wissen, was du ihm tun sollst; und laß sein graues Haar mit Blut in den Scheol hinabfahren.',
        10: 'Und David legte sich zu seinen Vätern; und er wurde begraben in der Stadt Davids.',
        11: 'Und die Tage, die David über Israel regierte, waren vierzig Jahre; zu Hebron regierte er sieben Jahre, und zu Jerusalem regierte er 33 Jahre.',
        12: 'Und Salomo saß auf dem Throne seines Vaters David, und sein Königtum wurde sehr befestigt.',
        ...
        15: 'Und er sprach: Du weißt ja, daß das Königtum mein war, und daß ganz Israel sein Angesicht auf mich gerichtet hatte, daß ich König sein sollte; aber das Königtum hat sich gewandt und ist meinem Bruder geworden, denn von Jehova aus gehörte es ihm.',
        16: 'Und nun bitte ich eine Bitte von dir; weise mich nicht ab! Und sie sprach zu ihm: Rede.',
        ...
        19: 'Und Bathseba ging zu dem König Salomo hinein, um wegen Adonijas mit ihm zu reden. Und der König stand auf, ihr entgegen, und beugte sich vor ihr nieder und setzte sich auf seinen Thron; und er ließ einen Thron für die Mutter des Königs hinstellen, und sie setzte sich zu seiner Rechten.',
        ...
        28: 'Und das Gerücht kam zu Joab; da floh Joab zum Zelte Jehovas und erfaßte die Hörner des Altars.',
        ...
        33: 'Und ihr Blut wird zurückkehren auf den Kopf Joabs und auf den Kopf seines Samens ewiglich; aber David und seinem Samen und seinem Hause und seinem Throne wird Friede sein auf ewig von seiten Jehovas.',
        ...
        35: 'Und der König setzte Benaja, den Sohn Jojadas, an seiner Statt über das Heer; und Zadok, den Priester, setzte der König an die Stelle Abjathars.',
        36: 'Und der König sandte hin und ließ Simei rufen, und er sprach zu ihm: Baue dir ein Haus zu Jerusalem, und wohne daselbst; und du sollst nicht von dannen herausgehen, dahin oder dorthin.',
        37: 'Und es soll geschehen an dem Tage, da du hinausgehst und den Bach Kidron überschreitest, so wisse bestimmt, daß du sterben mußt; dein Blut wird auf deinem Kopfe sein.',
        38: 'Und Simei sprach zu dem König: Das Wort ist gut; so wie mein Herr, der König, geredet hat, also wird dein Knecht tun. Und Simei wohnte zu Jerusalem eine lange Zeit.',
        39: 'Es geschah aber am Ende von drei Jahren, da entflohen zwei Knechte Simeis zu Achis, dem Sohne Maakas, dem König von Gath; und man berichtete es Simei und sprach: Siehe, deine Knechte sind in Gath!',
        40: 'Da machte sich Simei auf und sattelte seinen Esel und ging nach Gath, zu Achis, um seine Knechte zu suchen; und Simei ging hin und brachte seine Knechte von Gath zurück.',
        41: 'Und es wurde Salomo berichtet, daß Simei von Jerusalem nach Gath gegangen und zurückgekommen sei.',
        42: 'Da sandte der König hin und ließ Simei rufen, und er sprach zu ihm: Habe ich dich nicht bei Jehova beschworen und dir beteuert und gesagt: An dem Tage, da du hinausgehst und gehst dahin oder dorthin, so wisse bestimmt, daß du sterben mußt? Und du sprachst zu mir: Das Wort ist gut, das ich gehört habe.',
        43: 'Und warum hast du den Schwur Jehovas nicht beachtet und das Gebot, das ich dir geboten hatte?',
        44: 'Und der König sprach zu Simei: Du selbst weißt all das Böse, dessen dein Herz sich bewußt ist, das du meinem Vater David getan hast; und so bringt Jehova deine Bosheit auf deinen Kopf zurück.',
        45: 'Aber der König Salomo wird gesegnet sein, und der Thron Davids wird feststehen vor Jehova ewiglich.',
    ...
    3: {
        ...
        4: 'Und der König ging nach Gibeon, um daselbst zu opfern, denn das war die große Höhe; tausend Brandopfer opferte Salomo auf selbigem Altar.',
    ...
    4: {
        ...
        32: 'Und er redete dreitausend Sprüche, und seiner Lieder waren 1005.',
        33: 'Und er redete über die Bäume, von der Ceder, die auf dem Libanon ist, bis zum Ysop, der an der Mauer herauswächst; und er redete über das Vieh und über die Vögel und über das Gewürm und über die Fische.',
    ...
    5: {
        ...
        6: 'Und nun gebiete, daß man mir Cedern vom Libanon haue; und meine Knechte sollen mit deinen Knechten sein; und den Lohn deiner Knechte will ich dir geben nach allem, was du sagen wirst; denn du weißt ja, daß niemand unter uns ist, der Holz zu hauen versteht wie die Zidonier.',
        7: 'Und es geschah, als Hiram die Worte Salomos hörte, da freute er sich sehr; und er sprach: Gepriesen sei heute Jehova, der David einen weisen Sohn gegeben hat über dieses große Volk!',
        8: 'Und Hiram sandte zu Salomo und ließ ihm sagen: Ich habe gehört, was du mir entboten hast; ich will all dein Begehr tun betreffs des Cedernholzes und betreffs des Cypressenholzes.',
        ...
        10: 'Und so gab Hiram dem Salomo Cedernholz und Cypressenholz nach all seinem Begehr.',
        11: 'Salomo aber gab Hiram 20000 Kor Weizen zur Nahrung für sein Haus, und zwanzig Kor zerstoßenes Öl: so gab Salomo dem Hiram Jahr für Jahr.',
        ...
        14: 'Und er schickte sie auf den Libanon, 10000 im Monat, wechselweise: einen Monat waren sie auf dem Libanon, zwei Monate in ihrem Hause; und Adoniram war über die Fronarbeiter.',
        15: 'Und Salomo hatte 70000 Lastträger und 80000 Steinhauer im Gebirge,',
        16: 'ohne die Oberaufseher Salomos, welche über die Arbeit waren, 3300, die über das Volk walteten, das an der Arbeit beschäftigt war.',
    ...
    6: {
        1: 'Und es geschah im 480. Jahre nach dem Auszuge der Kinder Israel aus dem Lande Ägypten, im vierten Jahre der Regierung Salomos über Israel, im Monat Siw, das ist der zweite Monat, da baute er Jehova das Haus.',
        ...
        10: 'Und er baute die Stockwerke an das ganze Haus, fünf Ellen ihre Höhe; und sie waren mit dem Hause durch Cedernhölzer verbunden.',
        ...
        16: 'Und er baute die zwanzig Ellen an der Hinterseite des Hauses mit Cedernbrettern, vom Fußboden bis an die Wände; und er baute sie ihm inwendig zum Sprachorte, zum Allerheiligsten.',
        17: 'Und das Haus, das ist der Tempel, vorn vor dem Sprachorte, war vierzig Ellen lang.',
        18: 'Und das Cedernholz am Hause, inwendig, war Schnitzwerk von Koloquinthen und aufbrechenden Blumen; alles war Cedernholz, kein Stein wurde gesehen.',
        19: 'Und den Sprachort im Innersten des Hauses richtete er zu, um die Lade des Bundes Jehovas dahin zu setzen;',
        20: 'und das Innere des Sprachortes: zwanzig Ellen die Länge, und zwanzig Ellen die Breite, und zwanzig Ellen seine Höhe; und er überzog ihn mit geläutertem Golde; auch den Cedernholzaltar überzog er damit.',
    ...
    7: {
        ...
        14: 'Er war der Sohn einer Witwe aus dem Stamme Naphtali, ein Arbeiter in Erz; und er war voll Weisheit und Einsicht und Kenntnis, um allerlei Werk in Erz zu machen; und er kam zu dem König Salomo und machte sein ganzes Werk.',
        ...
        18: 'Und er machte Granatäpfel, und zwar zwei Reihen ringsum, über das eine Netzwerk, zur Bedeckung der Kapitäle, die auf der Spitze der Säulen waren; und ebenso machte er es an dem anderen Kapitäl.',
        19: 'Und die Kapitäle die auf der Spitze der Säulen waren, waren wie die Lilienarbeit in der Halle, vier Ellen.',
        20: 'Und auch waren Kapitäle auf den beiden Säulen oben, dicht an dem Wulste, der jenseit des Flechtwerks war. Und der Granatäpfel waren zweihundert, in Reihen ringsum, an dem anderen Kapitäl.',
        21: 'Und er richtete die Säulen auf bei der Halle des Tempels: er richtete die rechte Säule auf und gab ihr den Namen Jakin, und er richtete die linke Säule auf und gab ihr den Namen Boas.',
        ...
        30: 'Und jedes Gestell hatte vier eherne Räder und eherne Achsen, und seine vier Füße hatten Schulterstücke; unter dem Becken waren die Schulterstücke angegossen; jenseit eines jeden waren die Kränze.',
        31: 'Und seine Öffnung, innerhalb der Krone und aufwärts, war bei einer Elle, und ihre Öffnung war gerundet, Gestellarbeit, eine Elle und eine halbe Elle; und auch an ihrer Öffnung war Schnitzwerk. Und ihre Felder waren viereckig, nicht rund.',
        ...
        34: 'Und vier Schulterstücke waren an den vier Ecken eines Gestelles: aus dem Gestell waren seine Schulterstücke.',
        ...
        39: 'Und er setzte die Gestelle, fünf auf die rechte Seite des Hauses, und fünf auf die linke Seite des Hauses. Und das Meer setzte er auf die rechte Seite des Hauses ostwärts, gegen Süden.',
        ...
        41: 'zwei Säulen und die krugförmigen Kapitäle, die auf der Spitze der beiden Säulen waren; und die zwei Netzwerke zur Bedeckung der beiden krugförmigen Kapitäle, die auf der Spitze der Säulen waren;',
    ...
    8: {
        ...
        42: ', kommt er und betet gegen dieses Haus hin:',
        ...
        54: 'Und es geschah, als Salomo geendigt hatte, dieses ganze Gebet und Flehen an Jehova zu richten, stand er auf vor dem Altar Jehovas von dem Beugen seiner Knie, indem seine Hände gen Himmel ausgebreitet waren;',
        ...
        63: 'Und Salomo schlachtete als Friedensopfer, das er Jehova opferte, 22000 Rinder und 120000 Schafe. Und der König und alle Kinder Israel weihten das Haus Jehovas ein.',
    ...
    9: {
        ...
        10: 'Und es geschah am Ende von zwanzig Jahren, während welcher Salomo die beiden Häuser, das Haus Jehovas und das Haus des Königs, gebaut hatte, -',
        ...
        22: 'Aber aus den Kindern Israel machte Salomo keine Sklaven, sondern sie waren Kriegsleute und seine Knechte und seine Obersten und seine Anführer, und Oberste seiner Wagen und seiner Reiter.',
    ...
    10: {
        ...
        5: 'und die Speise seines Tisches, und das Sitzen seiner Knechte, und das Aufwarten seiner Diener, und ihre Kleidung und seine Mundschenken, und seinen Aufgang, auf welchem er in das Haus Jehovas hinaufging, da geriet sie außer sich',
        ...
        26: 'Und Salomo brachte zusammen Wagen und Reiter, und er hatte 1400 Wagen und 12000 Reiter; und er verlegte sie in die Wagenstädte und zu dem König nach Jerusalem.',
        ...
        29: 'Und ein Wagen kam herauf und wurde ausgeführt aus Ägypten um 600 Sekel Silber, und ein Roß um150. Und also führte man für alle Könige der Hethiter und für die Könige von Syrien durch ihre Hand aus.',
    },
    11: {
        ...
        15: 'Es geschah nämlich, als David in Edom war, als Joab, der Heeroberste, hinaufzog, um die Erschlagenen zu begraben, und er alles Männliche in Edom erschlug',
        16: ':',
        ...
        26: 'Und Jerobeam, der Sohn Nebats, ein Ephratiter, von Zereda, ein Knecht Salomos, auch er erhob die Hand wider den König.',
        ...
        40: 'Und Salomo suchte Jerobeam zu töten; da machte Jerobeam sich auf und entfloh nach Ägypten zu Sisak, dem König von Ägypten; und er war in Ägypten bis zum Tode Salomos.',
        41: 'Und das Übrige der Geschichte Salomos und alles, was er getan hat, und seine Weisheit, ist das nicht geschrieben in dem Buche der Geschichte Salomos?',
    ...
    12: {
        ...
        21: 'Und Rehabeam kam nach Jerusalem; und er versammelte das ganze Haus Juda und den Stamm Benjamin, 180000 auserlesene Krieger, um mit dem Hause Israel zu streiten, damit er das Königreich an Rehabeam, den Sohn Salomos, zurückbrächte.',
        ...
        32: 'Und Jerobeam machte ein Fest im achten Monat, am fünfzehnten Tage des Monats, wie das Fest, das in Juda stattfand, und er opferte auf dem Altar. Ebenso tat er zu Bethel, indem er den Kälbern opferte, die er gemacht hatte; und er bestellte in Bethel die Priester der Höhen, die er gemacht hatte.',
        33: 'Und er opferte auf dem Altar, den er zu Bethel gemacht hatte, am fünfzehnten Tage im achten Monat, in dem Monat, den er aus seinem Herzen erdacht hatte; und er machte den Kindern Israel ein Fest, und opferte auf dem Altar und räucherte.',
    },
    13: {
        1: 'Und siehe, ein Mann Gottes kam aus Juda, durch das Wort Jehovas, nach Bethel, und Jerobeam stand bei dem Altar, um zu räuchern.',
        2: 'Und er rief aus wider den Altar durch das Wort Jehovas und sprach: Altar, Altar! so spricht Jehova: Siehe, ein Sohn wird dem Hause Davids geboren werden, Josia sein Name; und er wird auf dir die Priester der Höhen schlachten, die auf dir räuchern, und man wird Menschengebeine auf dir verbrennen!',
        3: 'Und er gab an selbigem Tage ein Zeichen und sprach: Dies ist das Zeichen, von dem Jehova geredet hat: Siehe, der Altar wird reißen und die Fettasche, die darauf ist, verschüttet werden.',
        4: 'Und es geschah, als der König das Wort des Mannes Gottes hörte, das er wider den Altar zu Bethel ausgerufen hatte, da streckte Jerobeam seine Hand aus von dem Altar herab und sprach: Greifet ihn! Da verdorrte seine Hand, die er wider ihn ausgestreckt hatte, und er konnte sie nicht wieder an sich ziehen.',
        5: 'Und der Altar riß, und die Fettasche wurde vom Altar verschüttet, nach dem Zeichen, welches der Mann Gottes durch das Wort Jehovas gegeben hatte.',
        6: 'Da antwortete der König und sprach zu dem Manne Gottes: Flehe doch Jehova, deinen Gott, an und bete für mich, daß meine Hand mir wiedergegeben werde. Und der Mann Gottes flehte Jehova an, und die Hand des Königs wurde ihm wiedergegeben und war wie zuvor.',
        7: 'Und der König redete zu dem Manne Gottes: Komm mit mir ins Haus und stärke dich, und ich will dir ein Geschenk geben.',
        8: 'Aber der Mann Gottes sprach zu dem König: Wenn du mir die Hälfte deines Hauses gäbest, so würde ich nicht mit dir hingehen; und ich werde kein Brot essen und kein Wasser trinken an diesem Orte.',
        ...
        10: 'Und er ging auf einem anderen Wege und kehrte nicht auf dem Wege zurück, auf welchem er nach Bethel gekommen war.',
        11: 'Ein alter Prophet aber wohnte zu Bethel; und einer seiner Söhne kam und erzählte ihm alles, was der Mann Gottes an dem Tage zu Bethel getan hatte; die Worte, die er zum König geredet hatte, die erzählten sie auch ihrem Vater.',
        12: 'Und ihr Vater sprach zu ihnen: Welchen Weg ist er gegangen? Und seine Söhne hatten den Weg gesehen, den der Mann Gottes gegangen, der aus Juda gekommen war.',
        13: 'Da sprach er zu seinen Söhnen: Sattelt mir den Esel! Und sie sattelten ihm den Esel, und er ritt darauf.',
        14: 'Und er ritt dem Manne Gottes nach und fand ihn unter einer Terebinthe sitzen; und er sprach zu ihm: Bist du der Mann Gottes, der von Juda gekommen ist? Und er sprach: Ich bins.',
        ...
        23: 'Und es geschah, nachdem er Brot gegessen und nachdem er getrunken hatte, da sattelte er ihm, dem Propheten, den er zurückgebracht hatte, den Esel.',
        24: 'Und er zog fort; und es fand ihn ein Löwe auf dem Wege und tötete ihn. Und sein Leichnam lag hingestreckt auf dem Wege, und der Esel stand daneben, und der Löwe stand neben dem Leichnam.',
        25: 'Und siehe, da gingen Leute vorüber und sahen den Leichnam hingestreckt auf dem Wege, und den Löwen neben dem Leichnam stehen; und sie kamen und sagten es in der Stadt, in welcher der alte Prophet wohnte.',
        26: 'Als nun der Prophet, der ihn von dem Wege zurückgeführt hatte, es hörte, sprach er: Das ist der Mann Gottes, der gegen den Befehl Jehovas widerspenstig gewesen ist; und so hat Jehova ihn dem Löwen preisgegeben: der hat ihn zerrissen und getötet, nach dem Worte Jehovas, das er zu ihm geredet hat.',
        27: 'Und er redete zu seinen Söhnen und sprach: Sattelt mir den Esel! Und sie sattelten ihn.',
        28: 'Und er ritt hin und fand seinen Leichnam hingestreckt auf dem Wege, und den Esel und den Löwen neben dem Leichnam stehen; der Löwe hatte den Leichnam nicht gefressen und den Esel nicht zerrissen.',
        29: 'Und der Prophet hob den Leichnam des Mannes Gottes auf und legte ihn auf den Esel und brachte ihn zurück. Und er kam in die Stadt des alten Propheten, um ihn zu beklagen und zu begraben.',
    ...
    14: {
        ...
        20: 'Und die Tage, die Jerobeam regierte, waren 22 Jahre; und er legte sich zu seinen Vätern. Und Nadab, sein Sohn, ward König an seiner Statt.',
    ...
    15: {
        ...
        26: 'Und er tat, was böse war in den Augen Jehovas, und wandelte auf dem Wege seines Vaters und in seiner Sünde, wodurch er Israel sündigen gemacht hatte.',
        ...
        29: 'Und es geschah, sobald er König geworden war, erschlug er das ganze Haus Jerobeams; er ließ von Jerobeam nichts übrig, was Odem hatte, bis er ihn vertilgt hatte, nach dem Worte Jehovas, das er durch seinen Knecht Achija, den Siloniter, geredet hatte:',
        30: 'wegen der Sünden Jerobeams, die er begangen und wodurch er Israel sündigen gemacht, durch seine Reizung, wodurch er Jehova, den Gott Israels, gereizt hatte.',
        ...
        33: 'Im dritten Jahre Asas, des Königs von Juda, wurde Baesa, der Sohn Achijas, König über ganz Israel zu Tirza, 24 Jahre.',
    ...
    16: {
        ...
        2: 'Weil ich dich aus dem Staube erhoben und dich als Fürst über mein Volk Israel gesetzt habe, du aber auf dem Wege Jerobeams gewandelt und mein Volk Israel sündigen gemacht hast, so daß sie mich reizen durch ihre Sünden:',
        ...
        8: 'Im 26. Jahre Asas, des Königs von Juda, wurde Ela, der Sohn Baesas, König über Israel zu Tirza, zwei Jahre.',
        9: 'Und sein Knecht Simri, der Oberste über die Hälfte der Wagen, machte eine Verschwörung wider ihn. Er aber trank und berauschte sich zu Tirza, im Hause Arzas, der über das Haus zu Tirza war.',
        10: 'Und Simri kam herein und erschlug ihn und tötete ihn im 27. Jahre Asas, des Königs von Juda; und er ward König an seiner Statt.',
        11: 'Und es geschah, als er König war, sobald er auf seinem Throne saß, erschlug er das ganze Haus Baesas; er ließ nichts von ihm übrig, was männlich war, weder seine Blutsverwandten noch seine Freunde.',
        ...
        13: 'wegen all der Sünden Baesas und der Sünden Elas, seines Sohnes, die sie begangen und wodurch sie Israel sündigen gemacht hatten, so daß sie Jehova, den Gott Israels, reizten durch ihre nichtigen Götzen.',
        ...
        15: 'Im 27. Jahre Asas, des Königs von Juda, regierte Simri sieben Tage zu Tirza. Das Volk belagerte nämlich Gibbethon, welches den Philistern gehörte.',
        ...
        23: 'Im 31. Jahre Asas, des Königs von Juda, wurde Omri König über Israel, zwölf Jahre; zu Tirza regierte er sechs Jahre.',
        ...
        29: 'Und Ahab, der Sohn Omris, wurde König über Israel im 38. Jahre Asas, des Königs von Juda; und Ahab, der Sohn Omris, regierte über Israel zu Samaria 22 Jahre.',
    ...
    17: {
        ...
        9: 'Mache dich auf, gehe nach Zarpath, das zu Zidon gehört, und bleibe daselbst; siehe ich habe daselbst einer Witwe geboten, dich zu versorgen.',
    ...
    18: {
        ...
        8: 'Und er sprach zu ihm: Ich bins; gehe hin, sage deinem Herrn: Siehe, Elia ist da!',
        ...
        19: 'Und nun sende hin, versammle ganz Israel zu mir nach dem Berge Karmel, und die 450 Propheten des Baal und die 400 Propheten der Aschera, die am Tische Isebels essen.',
        ...
        22: 'Und Elia sprach zu dem Volke: Ich allein bin übriggeblieben, ein Prophet Jehovas, und der Propheten des Baal sind 450 Mann.',
    ...
    19: {
        ...
        13: 'Und es geschah, als Elia es hörte, da verhüllte er sein Angesicht mit seinem Mantel, und ging hinaus und stellte sich an den Eingang der Höhle. Und siehe, eine Stimme geschah zu ihm also: Was tust du hier, Elia?',
        14: 'Und er sprach: Ich habe sehr geeifert für Jehova, den Gott der Heerscharen; denn die Kinder Israel haben deinen Bund verlassen, deine Altäre niedergerissen und deine Propheten mit dem Schwerte getötet; und ich allein bin übriggeblieben, und sie trachten danach, mir das Leben zu nehmen!',
        15: 'Und Jehova sprach zu ihm: Gehe, kehre zurück deines Weges, nach der Wüste von Damaskus; und wenn du angekommen bist, so salbe Hasael zum König über Syrien.',
        ...
        17: 'Und es soll geschehen: wer dem Schwerte Hasaels entrinnt, den wird Jehu töten; und wer dem Schwerte Jehus entrinnt, den wird Elisa töten.',
        18: 'Aber ich habe 7000 in Israel übriggelassen, alle die Knie, die sich nicht vor dem Baal gebeugt haben, und jeden Mund, der ihn nicht geküßt hat.',
        19: 'Und er ging von dannen und fand Elisa, den Sohn Saphats, welcher gerade pflügte mit zwölf Joch Rindern vor sich her, und er war bei dem zwölften; und Elia ging zu ihm hin und warf seinen Mantel auf ihn.',
    ...
    20: {
        1: 'Und Ben-Hadad, der König von Syrien, versammelte seine ganze Heeresmacht: 32 Könige waren mit ihm und Rosse und Wagen; und er zog herauf und belagerte Samaria und stritt wider dasselbe.',
        2: 'Und er sandte Boten zu Ahab, dem König von Israel, in die Stadt,',
        3: 'und ließ ihm sagen: So spricht Ben-Hadad: Dein Silber und dein Gold ist mein, und deine Weiber und deine Söhne, die schönsten, sind mein.',
        4: 'Und der König von Israel antwortete und sprach: Nach deinem Worte, mein Herr König: dein bin ich mit allem, was mein ist.',
        5: 'Und die Boten kamen wieder und sprachen: So spricht Ben-Hadad und sagt: Wohl habe ich zu dir gesandt und gesprochen: Dein Silber und dein Gold, und deine Weiber und deine Söhne sollst du mir geben;',
        6: 'doch morgen um diese Zeit werde ich meine Knechte zu dir senden, und sie werden dein Haus und die Häuser deiner Knechte durchsuchen; und es wird geschehen, alle Lust deiner Augen werden sie in ihre Hand tun und mitnehmen.',
        ...
        9: 'Und er sprach zu den Boten Ben-Hadads: Saget meinem Herrn, dem König: Alles, was du deinem Knechte zuerst entboten hast, will ich tun; aber diese Sache kann ich nicht tun. Und die Boten gingen hin und brachten ihm Antwort.',
        ...
        15: 'Da musterte er die Knaben der Obersten der Landschaften, und ihrer waren 232; und nach ihnen musterte er das ganze Volk, alle Kinder Israel, 7000 Mann.',
        16: 'Und sie zogen aus am Mittag. Ben-Hadad aber trank und berauschte sich in den Zelten, er und die Könige, die 32 Könige, die ihm halfen.',
        ...
        20: 'Und sie schlugen ein jeder seinen Mann, und die Syrer flohen, und Israel jagte ihnen nach; und Ben-Hadad, der König von Syrien, entkam auf einem Rosse mit einigen Reitern.',
        21: 'Da zog der König von Israel aus und schlug die Rosse und die Wagen, und er richtete unter den Syrern eine große Niederlage an.',
        ...
        23: 'Und die Knechte des Königs von Syrien sprachen zu ihm: Ihre Götter sind Berggötter, darum waren sie uns überlegen; jedoch laßt uns in der Ebene wider sie streiten, ob wir ihnen nicht überlegen sein werden!',
        24: 'Tue aber dieses: Entferne die Könige, einen jeden von seinem Orte, und setze Befehlshaber an ihre Stelle;',
        25: 'und du, zähle dir ein Heer wie das Heer, das dir gefallen ist, und Rosse wie die Rosse, und Wagen wie die Wagen; und wir wollen in der Ebene wider sie streiten, ob wir ihnen nicht überlegen sein werden. Und er hörte auf ihre Stimme und tat also.',
        26: 'Und es geschah bei der Rückkehr des Jahres, da musterte Ben-Hadad die Syrer, und er zog hinauf nach Aphek zum Streit mit Israel.',
        27: 'Und die Kinder Israel wurden gemustert und mit Vorrat versorgt, und sie zogen ihnen entgegen; und die Kinder Israel lagerten sich ihnen gegenüber wie zwei kleine Herden Ziegen; die Syrer aber füllten das Land.',
        28: 'Da trat der Mann Gottes herzu und sprach zu dem König von Israel und sagte: So spricht Jehova: Weil die Syrer gesagt haben: Jehova ist ein Gott der Berge und nicht ein Gott der Täler, so will ich diesen ganzen großen Haufen in deine Hand geben; und ihr werdet erkennen, daß ich Jehova bin.',
        29: 'Und sie lagerten, diese jenen gegenüber, sieben Tage lang. Und es geschah am siebten Tage, da begann der Streit; und die Kinder Israel schlugen die Syrer, 100000 Mann zu Fuß, an einem Tage.',
        30: 'Und die übrigen flohen nach Aphek in die Stadt. Da fiel die Mauer auf die 27000 Mann, die übriggeblieben waren. Und Ben-Hadad floh und kam in die Stadt, in das innerste Gemach.',
        31: 'Da sprachen seine Knechte zu ihm: Siehe doch, wir haben gehört, daß die Könige des Hauses Israel gnädige Könige sind; laß uns doch Sacktuch um unsere Lenden legen und Stricke um unsere Häupter, und zum König von Israel hinausgehen; vielleicht läßt er deine Seele am Leben.',
        32: 'Und sie gürteten Sacktuch um ihre Lenden und legten Stricke um ihre Häupter, und kamen zu dem König von Israel und sprachen: Dein Knecht Ben-Hadad spricht: Laß doch meine Seele am Leben! Und er sprach: Lebt er noch? Er ist mein Bruder.',
        33: 'Und die Männer nahmen es als eine gute Vorbedeutung, und eilten sich zu vergewissern, ob er es wirklich so meinte, und sprachen: Dein Bruder Ben-Hadad. Und er sprach: Gehet, holet ihn. Da ging Ben-Hadad zu ihm hinaus, und er ließ ihn zu sich auf den Wagen steigen.',
        34: 'Und Ben-Hadad sprach: Die Städte, die mein Vater deinem Vater genommen hat, will ich dir zurückgeben, und du magst dir Straßen in Damaskus anlegen, so wie mein Vater sich solche in Samaria angelegt hat. Und ich, sprach Ahab, will dich mit diesem Bunde ziehen lassen. Und er machte einen Bund mit ihm und ließ ihn ziehen.',
        35: 'Und ein Mann von den Söhnen der Propheten sprach zu seinem Genossen durch das Wort Jehovas: Schlage mich doch! Aber der Mann weigerte sich, ihn zu schlagen.',
        36: 'Da sprach er zu ihm: Darum daß du nicht auf die Stimme Jehovas gehört hast, siehe, sobald du von mir weggehst, wird dich ein Löwe töten. Und als er von ihm wegging, da fand ihn ein Löwe und tötete ihn.',
        37: 'Und er traf einen anderen Mann und sprach: Schlage mich doch! Und der Mann schlug ihn, schlug und verwundete ihn.',
        38: 'Da ging der Prophet hin und stellte sich auf den Weg des Königs, und machte sich unkenntlich, indem er den Kopfbund über seine Augen zog.',
        ...
        40: 'Und es geschah, während dein Knecht hier und dort zu tun hatte, da war er fort. Und der König von Israel sprach zu ihm: Also ist dein Urteil, du selbst hast entschieden.',
        41: 'Da tat er eilends den Kopfbund von seinen Augen, und der König von Israel erkannte ihn, daß er von den Propheten war.',
        ...
        43: 'Und der König von Israel ging nach seinem Hause, mißmutig und zornig, und kam nach Samaria.',
    },
    21: {
        ...
        13: 'und die zwei Männer, Söhne Belials, kamen und setzten sich ihm gegenüber; und die Männer Belials zeugten wider ihn, wider Naboth, vor dem Volke und sprachen: Naboth hat Gott und den König gelästert! Und sie führten ihn zur Stadt hinaus und steinigten ihn, und er starb.',
        ...
        22: 'und ich werde dein Haus machen wie das Haus Jerobeams, des Sohnes Nebats, und wie das Haus Baesas, des Sohnes Achijas, wegen der Reizung, womit du mich gereizt und Israel sündigen gemacht hast.',
    ...
    22: {
        ...
        38: 'Und als man den Wagen am Teiche von Samaria abspülte, da leckten die Hunde sein Blut, nach dem Worte Jehovas, das er geredet hatte.',
        ...
        41: 'Und Josaphat, der Sohn Asas, wurde König über Juda im vierten Jahre Ahabs, des Königs von Israel.',
        ...
        43: 'Und er wandelte auf allen Wegen seines Vaters Asa; er wich nicht davon, indem er tat, was recht war in den Augen Jehovas.',
        ...
        49: 'Josaphat baute Tarsisschiffe, um nach Ophir zu fahren und Gold zu holen; aber man fuhr nicht, denn die Schiffe wurden bei Ezjon-Geber zertrümmert.',
        ...
        51: 'Und Josaphat legte sich zu seinen Vätern, und er wurde bei seinen Vätern begraben in der Stadt seines Vaters David. Und Joram, sein Sohn, ward König an seiner Statt.',
