...
CHAPTERS = {
    ...
    3: {
        ...
        3: 'Jesus svarade och sade till honom: »Sannerligen, sannerligen säger jag dig: Om en människa icke bliver född på nytt[1], så kan hon icke få se Guds rike.»',
        ...
        8: 'Vinden blåser vart den vill, och du hör dess sus, men du vet icke varifrån den kommer, eller vart den far; så är det med var och en som är född av Anden[2].»',
        ...
        36: 'Den som tror på Sonen, han har evigt liv; men den som icke hörsammar Sonen, han skall icke få se livet, utan Guds vrede förbliver över honom.» [1] Grundtextens uttryck har den dubbla betydelsen på nytt och ovanifrån; jfr v. 31. [2] Grundtexten har här samma uttryck för vind som för ande.',
    },
    4: {
        ...
        10: "Jesus svarade och sade till henne: »Förstode du Guds gåva, och vem den är som säger till dig: 'Giv mig att dricka', så skulle i stället du hava bett honom, och han skulle då hava givit dig levande vatten[1].»",
        ...
        38: 'Jag har sänt eder att skörda, där I icke haven arbetat. Andra hava arbetat, och I haven fått gå in i deras arbete[2].»',
    ...
    5: {
        ...
        16: 'Därför förföljde nu judarna Jesus[2], eftersom han gjorde sådant på sabbaten.',
        ...
        47: 'Men tron I icke hans skrifter, huru skolen I då kunna tro mina ord?» [2] och sökte att döda honom.',
    },
    6: {
        ...
        7: 'Filippus svarade honom: »Bröd för två hundra silverpenningar[1] vore icke nog för att var och en skulle få ett litet stycke.»',
    ...
    7: {
        ...
        50: 'Då sade Nikodemus till dem, han som förut hade besökt honom[2], och som själv var en av dem:',
        ...
        53: '[Och de gingo hem, var och en till sitt. [1] Jämför noten till Joh 4,10. [2] om natten.',
    },
    8: {
        ...
        9: 'När de hörde detta[3], gingo de ut, den ene efter den andre, först de äldsta, och Jesus blev lämnad allena med kvinnan, som stod där kvar.',
        10: 'Då såg Jesus upp och sade till kvinnan: »Var äro de andra? Har ingen dömt dig?»',
        11: 'Hon svarade: »Herre, ingen.» Då sade han till henne: »Icke heller jag dömer dig. Gå, och synda icke härefter.»][1]',
        ...
        59: 'Då togo de upp stenar för att kasta på honom. Men Jesus gömde sig undan och gick sedan ut ur helgedomen. [1] 7,53--8,11; Se Nya testamentets text i Ordförkl. [2] och allt folket kom till honom, och han satte sig och lärde dem. [3] och kände sig överbevisade av samvetet.',
    },
    9: {
    ...
    12: {
        ...
        5: '»Varför sålde man icke hellre denna smörjelse för tre hundra silverpenningar[1] och gav dessa åt de fattiga?»',
        ...
        13: 'togo de palmkvistar och gingo ut för att möta honom och ropade: »Hosianna! Välsignad vare han som kommer[2], i Herrens namn, han som är Israels konung.»',
        ...
        50: 'Och jag vet att hans bud är evigt liv; därför, vad jag talar, det talar jag såsom Fadern har sagt mig.» [1] Se Silverpenning i Ordförkl. [2] Se Messias i Ordförkl.',
    },
    13: {
    ...
    16: {
        ...
        16: 'En liten tid, och I sen mig icke mer; och åter en liten tid, och I fån se mig[1].»',
        ...
        33: 'Detta har jag talat till eder, för att I skolen hava frid i mig. I världen liden i betryck; men varen vid gott mod, jag har övervunnit världen.» [1] ty jag går till Fadern.',
    },
    17: {
