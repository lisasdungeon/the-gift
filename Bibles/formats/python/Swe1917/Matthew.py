...
CHAPTERS = {
    1: {
        ...
        21: 'Och hon skall föda en son, och honom skall du giva namnet Jesus[1], ty han skall frälsa sitt folk ifrån deras synder.»',
        ...
        25: 'Och han kände henne icke, förrän hon hade fött en son; och honom gav han namnet Jesus. [1] Jämför hebr. jeschuá, som betyder frälsning.',
    },
    2: {
    ...
    5: {
        ...
        21: "I haven hört att det är sagt till de gamle: 'Du skall icke dräpa; och den som dräper, han är hemfallen åt Domstolens[1] dom.'",
        ...
        48: 'Varen alltså I fullkomliga, såsom eder himmelske Fader är fullkomlig.» [1] Se Domstol i Ordförkl.',
    },
    6: {
        ...
        24: 'Ingen kan tjäna två herrar; ty antingen kommer han då att hata den ene och älska den andre, eller kommer han att hålla sig till den förre och förakta den senare. I kunnen icke tjäna både Gud och Mamon[2].',
        ...
        34: 'Gören eder alltså icke bekymmer för morgondagen, ty morgondagen skall själv bära sitt bekymmer. Var dag har nog av sin egen plåga.» [1] Se Fader vår i Ordförklaringarna. [2] Se Mamon i Ordförklaringarna.',
    },
    7: {
        ...
        29: 'ty han förkunnade sin lära för dem med makt och myndighet, och icke såsom deras skriftlärde. [1] Se Dagen i Ordförklaringarna',
    },
    8: {
    ...
    10: {
        ...
        29: 'Säljas icke två sparvar för en skärv[1]? Och icke en av dem faller till jorden utan eder Faders vilja.',
        ...
        42: 'Och den som giver en av dessa små allenast en bägare friskt vatten att dricka, därför att det är en lärjunge -- sannerligen säger jag eder: Han skall ingalunda gå miste om sin lön.» [1] Se Skärv i Ordförklaringarna.',
    },
    11: {
    ...
    13: {
        ...
        33: 'En annan liknelse framställde han för dem: »Himmelriket är likt en surdeg som en kvinna tager och blandar in i tre skäppor[1] mjöl, till dess alltsammans bliver syrat.»',
        ...
        58: 'Och för deras otros skull gjorde han där icke många kraftgärningar. [1] Se Skäppa i Ordförklaringarna',
    },
    14: {
        ...
        24: 'Båten var då redan många stadier[1] från land och hårt ansatt av vågorna, ty vinden låg emot.',
        ...
        36: 'Och de bådo honom att allenast få röra vid hörntofsen på hans mantel; och alla som rörde vid den blevo hulpna. [1] Se Stadie i Ordförklaringarna.',
    },
    15: {
    ...
    16: {
        ...
        18: 'Så säger ock jag dig att du är Petrus; och på denna klippa[1] skall jag bygga min församling, och dödsrikets portar skola icke bliva henne övermäktiga.',
        ...
        28: 'Sannerligen säger jag eder: Bland dem som här stå finnas några som icke skola smaka döden, förrän de få se Människosonen komma i sitt rike.» [1] Klippa heter på grekiska petra.',
    },
    17: {
        ...
        4: 'Då tog Petrus till orda och sade till Jesus: »Herre, här är oss gott att vara[1]; vill du, så skall jag här göra tre hyddor, åt dig en och åt Moses en och åt Elias en.»',
    ...
    18: {
        ...
        28: "Men när samme tjänare kom ut, träffade han på en av sina medtjänare, som var skyldig honom hundra silverpenningar[3]; och han tog fast denne och grep honom vid strupen och sade: 'Betala vad du är skyldig.'",
        ...
        35: 'Så skall ock min himmelske Fader göra med eder, om I icke av hjärtat förlåten var och en sin broder.» [1] Se Nya testamentets text i Ordförklaringarna. [2] Se Pund i Ordförklaringarna. [3] Se Silverpenningar i Ordförklaringarna.',
    },
    19: {
    ...
    20: {
        ...
        2: 'Och när han hade kommit överens med arbetarna om en viss dagspenning[1], sände han dem till sin vingård.',
        ...
        34: 'Då förbarmade sig Jesus över dem och rörde vid deras ögon, och strax fingo de sin syn och följde honom. [1] Se Dagspenning i Ordförklaringarna.',
    },
    21: {
        ...
        9: 'Och folket, både de som gingo före honom och de som följde efter, ropade och sade: »Hosianna Davids son! Välsignad vare han som kommer[1], i Herrens namn. Hosianna i höjden!»',
        ...
        46: 'Och de hade gärna velat gripa honom, men de fruktade för folket, eftersom man höll honom för en profet. [1] Se Messias i Ordförklaringarna. [2] Se Nya testamentets text i Ordförklaringarna.',
    },
    22: {
        ...
        19: 'Låten mig se skattepenningen.» Då lämnade de fram till honom en penning[1].',
        ...
        46: 'Och ingen förmådde svara honom ett ord. Ej heller dristade sig någon från den dagen att vidare ställa någon fråga till honom. [1] Se Penning i Ordförklaringarna.',
    },
    23: {
        ...
        9: "Ej heller skolen I kalla någon på jorden eder 'fader'[1], ty en är eder Fader, han som är i himmelen.",
        ...
        39: "Ty jag säger eder: Härefter skolen I icke få se mig, intill den tid då I sägen: 'Välsignad vare han som kommer[3], i Herrens namn.'» [1] Se Fader i Ordförklaringarna. [2] Se Nya testamentets text i Ordförklaringarna. [3] Se Messias i Ordförklaringarna.",
    },
    24: {
        ...
        15: "När I nu fån se 'förödelsens styggelse'[2], om vilken är talat genom profeten Daniel, stå på helig plats -- den som läser detta, han give akt därpå --",
        ...
        29: 'Men strax efter den tidens vedermöda skall solen förmörkas och månen upphöra att giva sitt sken, och stjärnorna skola falla ifrån himmelen, och himmelens makter[3] skola bäva.',
        ...
        51: 'och han skall låta hugga honom i stycken och låta honom få sin del med skrymtare. Där skall vara gråt och tandagnisslan.» [1] Se Födslovåndor i Ordförklaringarna. [2] Se Förödelsens styggelse i Ordförklaringarna. [3] Se Makter i Ordförklaringarna.',
    },
    25: {
        ...
        15: 'åt en gav han fem pund[1], åt en annan två och åt en tredje ett pund, åt var och en efter hans förmåga, och for utrikes.',
        ...
        41: "Därefter skall han ock säga till dem som stå på hans vänstra sida: 'Gån bort ifrån mig, I förbannade[2], till den eviga elden, som är tillredd åt djävulen och hans änglar.",
        ...
        46: "Och dessa skola då då bort till evigt straff, men de rättfärdiga till evigt liv.» [1] Se Pund i Ordförklaringarna. [2] Eller: Därefter skall han ock säga till dem som stå på hans vänstra sida: 'Gån bort ifrån mig i förbannelse' osv.",
    },
    26: {
        ...
        15: 'och sade: »Vad viljen I giva mig för att jag skall överlämna honom åt eder?» Då vägde de upp åt honom trettio silverpenningar[1].',
        ...
        75: 'Då kom Petrus ihåg Jesu ord, huru han hade sagt: »Förrän hanen gal, skall du tre gånger förneka mig.» Och han gick ut och grät bitterligen. [1] Se Silverpenning i Ordförklaringarna.',
    },
    27: {
        ...
        3: 'När då Judas, som hade förrått honom, såg att han var dömd, ångrade han sig och bar de trettio silverpenningarna[1] tillbaka till översteprästerna och de äldste',
        ...
        46: 'Och vid nionde timmen ropade Jesus med hög röst och sade: »Eli, Eli, lema sabaktani[2]?»; det betyder: »Min Gud, min Gud, varför har du övergivit mig?»',
        ...
        66: 'Och de gingo åstad och skyddade graven, i det att de icke allenast satte ut vakten, utan ock förseglade stenen. [1] Se Silverpenning i Ordförklaringarna. [2] Se Betoning i Ordförklaringarna.',
    },
    28: {
