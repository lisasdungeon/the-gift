...
CHAPTERS = {
    1: {
        ...
        5: 'då jag erinras om din oskrymtade tro, samma tro som först bodde i din mormoder Lois och din moder Eunice, och som nu -- därom är jag förvissad -- jämväl bor i dig.',
        6: 'Fördenskull påminner jag dig att du må uppliva den nådegåva från Gud, som i följd av min handpåläggning finnes i dig.',
        7: 'Ty Gud har icke givit oss en försagdhetens ande, utan en kraftens och kärlekens och tuktighetens ande.',
        ...
        12: 'Fördenskull lider jag också detta, men jag blyges dock icke därför. Ty jag vet på vem jag tror, och jag är viss om att han är mäktig att för »den dagen»[1] bevara vad som har blivit mig betrott.',
        ...
        18: 'Ja, Herren give att han må finna barmhärtighet hos Herren på »den dagen». Till huru stor tjänst han var i Efesus, det vet du själv bäst. [1] Se Dagen i Ordförkl.',
    },
    2: {
    ...
    4: {
        ...
        8: 'Nu ligger rättfärdighetens segerkrans tillreds åt mig, och Herren, den rättfärdige domaren, skall giva den åt mig på »den dagen»[1], och icke åt mig allenast, utan åt alla som hava älskat hans tillkommelse.',
        ...
        22: 'Herren vare med din ande. Nåd vare med eder. [1] Se Dagen i Ordförkl.',
    },
}
