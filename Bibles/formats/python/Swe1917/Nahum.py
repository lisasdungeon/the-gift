...
CHAPTERS = {
    1: {
        ...
        15: 'Se, över bergen nalkas glädjebudbärarens fötter hans som förkunnar frid: »Fira dina högtider, Juda, infria dina löften. Ty ej mer skall fördärvaren draga fram mot dig; han varder förgjord i grund.» [1] Delvis alfabetisk sång; se Poesi i a Ordförkl.',
    },
    2: {
    ...
    3: {
        ...
        19: 'Det finnes ingen bot för din skada oläkligt är ditt sår. Alla som höra vad som har hänt dig klappa i händerna över dig. Ty över vem gick ej din ondska beständigt? [1] Delvis alfabetisk sång; se Poesi i Ordförkl.',
    },
}
