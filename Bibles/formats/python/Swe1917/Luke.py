...
CHAPTERS = {
    ...
    2: {
        ...
        52: 'Och Jesus växte till i ålder och vishet och nåd inför Gud och människor[1]. [1] Eller: Och Jesus växte upp och växte till i vishet och nåd osv.',
    },
    3: {
    ...
    16: {
        ...
        6: "Han svarade: 'Hundra fat[1] olja.' Då sade han till honom: 'Tag här ditt skuldebrev, och sätt dig nu strax ned och skriv femtio.'",
        7: "Sedan frågade han en annan: 'och du, huru mycket är du skyldig?' Denne svarade: 'hundra tunnor[2] vete.' Då sade han till honom: 'Tag här ditt skuldebrev och skriv åttio.'",
        8: 'Och husbonden prisade den orättrådige förvaltaren för det att han hade handlat klokt. Ty denna tidsålders barn skicka sig klokare mot sitt släkte än ljusets barn.',
        9: 'Och jag säger eder: Skaffen eder vänner medelst den orättrådige Mamons goda, för att de, när detta har tagit slut, må taga emot eder i de eviga hyddorna.',
        ...
        31: "Då sade han till honom: 'Lyssna de icke till Moses och profeterna, så skola de icke heller låta övertyga sig, om någon uppstår från de döda.'» [1] Se Fat i Ordförkl. [2] Se Tunna i Ordförkl.",
    },
    17: {
