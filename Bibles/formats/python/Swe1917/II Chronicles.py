...
CHAPTERS = {
    1: {
        1: 'Hans Salomo, Davids son, befäste sig nu i sin konungamakt, i det att HERREN, hans Gud, var med honom och gjorde honom övermåttan stor.',
    ...
    13: {
        ...
        5: 'Skullen I icke veta att det är HERREN, Israels Gud, som har givit åt David konungadömet över Israel för evig tid, åt honom själv och hans söner, genom ett saltförbund?[1]',
        ...
        22: 'Vad nu mer är att säga om Abia, om hans företag och om annat som rör honom, det finnes upptecknat i profeten Iddos »Utläggning». [1] Se Saltförbund i Ordförkl.',
    },
    14: {
    ...
    16: {
        ...
        14: 'Och man begrov honom i den grav som han hade låtit hugga ut åt sig i Davids stad; och man lade honom på en bädd som man hade fyllt med vällukter och kryddor av olika slag, konstmässigt beredda, och anställde till hans ära en mycket stor förbränning[1]. [1] Sorgebruk i Ordförkl.',
    },
    17: {
    ...
    20: {
        ...
        26: 'Men på fjärde dagen församlade de sig i Berakadalen; där lovade de[1] HERREN, och därav fick det stället namnet Berakadalen, såsom det heter ännu i dag.',
        ...
        37: 'Då profeterade Elieser, Dodavahus son, från Maresa, mot Josafat; han sade: »Därför att du har förbundit dig med Ahasja, skall HERREN låta ditt företag bliva om intet.» Och somliga av skeppen ledo skeppsbrott, så att de icke kunde gå till Tarsis. [1] Hebr berekú.',
    },
    21: {
        ...
        19: 'Och efter år och dagar, när två år voro förlidna, föllo hans inälvor ut i följd av sjukdomen, och han dog i svåra plågor; men hans folk anställde ingen förbränning[1] till hans ära, såsom de hade gjort efter hans fäder.',
        20: 'Han var trettiotvå år gammal, när han blev konung, och han regerade åtta år i Jerusalem. Och han gick bort utan att bliva saknad, och man begrov honom i Davids stad, men icke i konungagravarna. [1] Se Sorgebruk i Ordförkl.',
    },
    22: {
    ...
    23: {
        ...
        11: 'Därefter förde de ut konungasonen och satte på honom kronan och gåvo honom vittnesbördet[1] och gjorde honom till konung; och Jojada och hans söner smorde honom och ropade: »Leve konungen!»',
        ...
        21: 'Och hela folkmängden gladde sig, och staden förblev lugn. Men Atalja hade de dödat med svärd. [1] Se Vittnesbördet i Ordförkl.',
    },
    24: {
    ...
    27: {
        1: 'Jotam var tjugufem år gammal när han blev konung, och han regerade sexton år i Jerusalem. Hans moder hette Jerusa, Sadoks dotter.',
        2: 'Han gjorde vad rätt var i HERRENS ögon, alldeles såsom hans fader Ussia hade gjort, vartill kom att han icke trängde in i HERRENS tempel; men folket gjorde ännu vad fördärvligt var.',
        3: 'Han byggde Övre porten till HERRENS hus, och på Ofelmuren utförde han stora byggnadsarbeten.',
        4: 'Därtill byggde han städer i Juda bergsbygd, och i skogarna byggde han borgar och torn.',
        5: 'Och när han så kom i strid med Ammons barns konung, blev han dem övermäktig, så att Ammons barn det året måste giva honom ett hundra talenter silver, tio tusen korer vete och tio tusen korer korn. Lika mycket måste Ammons barn erlägga åt honom också nästa år och året därpå.',
        6: 'Så mäktig blev Jotam, därför att han vandrade ståndaktigt inför HERREN, sin Gud.',
        7: 'Vad nu mer är att säga om Jotam och om alla hans krig och andra företag, det finnes upptecknat i boken om Israels och Juda konungar.',
        8: 'Han var tjugufem år gammal, när han blev konung, och han regerade sexton år i Jerusalem.',
        9: 'Och Jotam gick till vila hos sina fäder, och man begrov honom i Davids stad. Och hans son Ahas blev konung efter honom.',
    },
    28: {
