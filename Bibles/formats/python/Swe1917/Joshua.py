...
CHAPTERS = {
    ...
    5: {
        ...
        9: 'Och HERREN sade till Josua: »I dag har jag avvältrat[1] från eder Egyptens smälek.» Och detta ställe fick namnet Gilgal[1], såsom det heter ännu i dag.',
        ...
        15: 'Hövitsmannen över HERRENS här sade då till Josua: »Drag dina skor av dina fötter, ty platsen där du står är helig.» Och Josua gjorde så. [1] De båda orden hava i hebreiskan likhet med varandra.',
    },
    6: {
    ...
    7: {
        ...
        11: 'Israel har syndat, de hava överträtt det förbund[1] som jag stadgade för dem; de hava tagit av det tillspillogivna, de hava stulit, de hava ljugit, de hava gömt det bland sitt eget gods.',
        ...
        25: 'Och Josua sade: »Varför drog du olycka över oss? Nu skall ock HERREN i dag låta olycka komma över[1] dig.» Och Israels menighet stenade honom; de brände upp dem i eld och kastade stenar på dem.',
        26: 'Och de uppkastade över honom ett stort stenröse, som finnes kvar ännu i dag; och så vände sig HERREN ifrån sin vredes glöd. Därav fick det stället namnet Akors dal, såsom det heter ännu i dag. [1] Se Förbund i Ordförkl. [2] Hebr akár.',
    },
    8: {
    ...
    18: {
        1: 'Och Israels barns hela menighet församlade sig i Silo och uppsatte där uppenbarelsetältet, då nu landet var dem underdånigt.',
    ...
    21: {
        ...
        45: 'Intet uteblev av allt det goda som HERREN hade lovat Israels hus; det gick allt i fullbordan. [1] V. 36--37 se Gamla testamentets text i Ordförkl.',
    },
    22: {
