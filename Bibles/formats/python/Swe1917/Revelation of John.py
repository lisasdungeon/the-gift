...
CHAPTERS = {
    1: {
        ...
        20: 'Vad angår hemligheten med de sju stjärnorna, som du har sett i min högra hand, och de sju gyllene ljusstakarna, så må du veta att de sju stjärnorna äro de sju församlingarnas änglar, och att de sju ljusstakarna äro de sju församlingarna.» [1] Se A och O i Ordförkl.',
    },
    2: {
    ...
    3: {
        ...
        14: 'Och skriv till Laodiceas församlings ängel: »Så säger han som är Amen[1], den trovärdiga och sannfärdiga vittnet, begynnelsen till Guds skapelse:',
        ...
        22: 'Den som har öra, han höre vad Anden säger till församlingarna. [1] Detta uttryck är hämtat från Jes 65,16, där det ord, som i den svenska översättningen återgives med den sannfärdige, i den hebreiska grundtexten är amen.',
    },
    4: {
    ...
    6: {
        ...
        6: 'Och jag hörde likasom en röst mitt ibland de fyra väsendena säga: »Ett mått[1] vete för en silverpenning[1] och tre mått korn för en silverpenning! Och oljan och vinet må du icke skada.»',
        ...
        17: 'Ty deras vredes stora dag är kommen, och vem kan bestå?» [1] Se Mått och Silverpenning i Ordförkl.',
    },
    7: {
        ...
        12: 'och sade: »Amen. Lovet och priset och visheten och tacksägelsen och äran och makten och starkheten tillhöra vår Gud i evigheternas evigheter. Amen.»',
    ...
    8: {
        1: 'Och när Lammet bröt det sjunde inseglet, uppstod i himmelen en tystnad, som varade vid pass en halv timme.',
        ...
        7: 'Och den förste stötte i sin basun. Då kom hagel och eld, blandat med blod, och det kastades ned på jorden; och tredjedelen av jorden brändes upp, och tredjedelen av träden brändes upp, och allt grönt gräs brändes upp.',
    ...
    9: {
        ...
        11: 'Till konung över sig hade de avgrundens ängel, vilkens namn på hebreiska är Abaddon och som på grekiska har namnet Apollyon[1].',
        ...
        21: 'De gjorde icke bättring och upphörde icke med sina mordgärningar och trolldomskonster, sin otukt och sitt tjuveri. [1] D. ä. fördärvaren.',
    },
    10: {
    ...
    13: {
        1: 'Då såg jag ett vilddjur stiga upp ur havet; det hade tio horn och sju huvuden, och på sina horn hade det tio kronor och på sina huvuden hädiska namn.',
    ...
    14: {
        ...
        6: 'Och jag såg en annan ängel flyga fram uppe i himlarymden; han hade ett evigt evangelium, som han skulle förkunna för dem som bo på jorden, för alla folkslag och stammar och tungomål och folk.',
        ...
        11: 'Och när de så plågas, uppstiger röken därav i evigheters evigheter, och de hava ingen ro, vaken dag eller natt, de som tillbedja vilddjuret och dess bild, eller som låta märka sig med dess namn.',
    ...
    21: {
        ...
        27: 'Men intet orent skall någonsin komma ditin, och ingen som gör vad styggeligt är och lögn, utan allenast de som äro skrivna i livets bok, Lammets bok. [1] Se A och O i Ordförkl.',
    },
    22: {
        ...
        21: 'Herren Jesu nåd vare med alla. [1] Se A och O i Ordförkl.',
    },
}
