...
CHAPTERS = {
    ...
    4: {
        ...
        13: 'Bättre än en gammal konung som är dåraktig och ej har förstånd nog att låta varna sig är en fattig yngling med vishet.',
