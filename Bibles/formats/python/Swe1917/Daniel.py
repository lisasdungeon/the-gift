...
CHAPTERS = {
    ...
    2: {
        ...
        2: 'Då lät konungen tillkalla sina spåmän, besvärjare, trollkarlar och kaldéer[1], för att de skulle giva konungen till känna vad han hade drömt, och de kommo och trädde fram för konungen.',
        ...
        49: 'Och på Daniels bön förordnade konungen Sadrak, Mesak och Abed-Nego att förvalta Babels hövdingdöme; men Daniel själv stannade vid konungens hov. [1] Se Kaldéer i Ordförkl.',
    },
    3: {
        1: 'Konung Nebukadnessar lät göra en gyllene bildstod, sextio alnar hög och sex alnar bred; den lät han ställa upp på Duraslätten i Babels hövdingdöme.',
        2: 'Och konung Nebukadnessar sände åstad och lät församla satraper, landshövdingar och ståthållare, fogdar, skattmästare, domare, lagtolkare och alla andra makthavande i hövdingdömena, för att de skulle komma till invigningen av den bildstod som konung Nebukadnessar hade låtit ställa upp.',
        ...
        4: 'utropade en härold med hög röst: »Detta vare eder befallt, I folk och stammar och tungomål:',
        5: 'När I hören ljudet av horn, pipor, cittror, sambukor, psaltare, säckpipor och allahanda andra instrumenter, skolen I falla ned och tillbedja den gyllene bildstod som konung Nebukadnessar har låtit ställa upp.',
        6: 'Men den som icke faller ned och tillbeder, han skall i samma stund kastas i den brinnande ugnen.»',
        7: 'Så snart nu allt folket hörde ljudet av horn, pipor, cittror, sambukor, psaltare och allahanda andra instrumenter, föllo de alltså ned, alla folk och stammar och tungomål, och tillbådo den gyllene bildstod som konung Nebukadnessar hade låtit ställa upp.',
        8: 'Men strax därefter kommo några kaldeiska män fram och anklagade judarna.',
        9: 'De togo till orda och sade till konung Nebukadnessar: Må du leva evinnerligen, o konung!',
    ...
    5: {
        ...
        26: 'Och detta är uttydningen därpå: Mene, det betyder: Gud har räknat[1] ditt rikes dagar och gjort ände på det',
        27: 'Tekel, det betyder: du är vägd[2] på en våg och befunnen för lätt.',
        28: 'Peres, det betyder: ditt rike har blivit styckat[3] och givet åt meder och perser[4].»',
        ...
        31: 'Och Darejaves av Medien mottog riket, när han var sextiotvå år gammal. [1] På arameiska mená. [2] På arameiska tekiltá. [3] På arameiska perisát. [4] På arameiska u-farás.',
    },
    6: {
    ...
    11: {
        ...
        31: 'Och härar, utsända av honom, skola komma och oskära helgedomens fäste och avskaffa det dagliga offret och ställa upp förödelsens styggelse[1].',
        ...
        45: 'Och sina palatstält skall han slå upp mellan havet och helgedomens härliga berg. Men han går till sin undergång, och ingen skall finnas, som hjälper honom.» [1] Se Förödelsens styggelse i Ordförkl.',
    },
    12: {
        ...
        11: 'Och från den tid då det dagliga offret bliver avskaffat och förödelsens styggelse[1] uppställd skola ett tusen två hundra nittio dagar förgå.',
        12: 'Säll är den som förbidar och hinner fram till ett tusen tre hundra trettiofem dagar.',
        13: 'Men gå du åstad mot ändens tid; sedan du har vilat, skall du uppstå till din del, vid dagarnas ände.» [1] Se Förödelsens styggelse i Ordförkl.',
    },
}
