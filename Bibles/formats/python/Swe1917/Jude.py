...
CHAPTERS = {
    1: {
        ...
        19: 'Det är dessa människor som vålla söndringar, dessa som äro »själiska»[1] och icke hava ande.',
        ...
        25: 'honom som allena är Gud, och som är vår Frälsare genom Jesus Kristus, vår Herre, honom tillhör ära, majestät, välde och makt, såsom före all tid, så ock nu och i alla evigheter. Amen. [1] Se Själisk i Ordförkl',
    },
}
