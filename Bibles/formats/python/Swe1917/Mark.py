...
CHAPTERS = {
    1: {
        1: 'Jesus Detta är begynnelsen av evangelium om Jesus Kristus, Guds Son.',
    ...
    6: {
        ...
        37: 'Men han svarade och sade till dem: »Given I dem att äta.» De svarade honom: »Skola vi då gå bort och köpa bröd för två hundra silverpenningar[1] och giva dem att äta?»',
        ...
        56: 'Och varhelst han gick in i någon by eller någon stad eller någon gård, där lade man de sjuka på de öppna platserna. Och de bådo honom att åtminstone få röra vid hörntofsen på hans mantel; och alla som rörde vid den blevo hulpna. [1] Se Silverpenning i Ordförklaringarna.',
    },
    7: {
        ...
        37: 'Och folket häpnade övermåttan och sade: »Allt har han väl beställt: de döva låter han höra och de stumma tala.» [1] Se Nya testamentets text i Ordförklaringarna.',
    },
    8: {
    ...
    9: {
        ...
        5: 'Då tog Petrus till orda och sade till Jesus: »Rabbi, här är oss gott att vara[1]; låt oss göra tre hyddor, åt dig en och åt Moses en och åt Elias en.»',
        ...
        50: 'Saltet är en god sak; men om saltet mister sin sälta, varmed skolen I då återställa dess kraft? -- Haven salt i eder och hållen frid inbördes.» [1] Eller: Då tog Petrus till orda och sade till Jesus: »Rabbi, det är gott att vi äro här tillstädes» osv. [2] Se Nya testamentets text i Ordförklaringarna.',
    },
    10: {
    ...
    11: {
        ...
        9: 'Och de som gingo före och de som följde efter ropade: »Hosianna! Välsignad vare han som kommer[1], i Herrens namn.',
        ...
        33: 'De svarade alltså Jesus och sade: »Vi veta det icke.» Då sade Jesus till dem: »Så säger icke heller jag eder med vad myndighet jag gör detta.» [1] Se Messias i Ordförklaringarna. [2] Se Nya testamentets text i Ordförklaringarna.',
    },
    12: {
        ...
        15: 'Men han förstod deras skrymteri och sade till dem: »Varför söken I att snärja mig? Tagen hit en penning[1], så att jag får se den.»',
        ...
        42: 'Men en fattig änka kom och lade ned två skärvar[2], det är ett öre.',
        ...
        44: 'Ty dessa lade alla dit av sitt överflöd, men hon lade dit av sitt armod allt vad hon hade, så mycket som fanns i hennes ägo.» [1] Se Penning i Ordförklaringarna. [2] Se Skärv i Ordförklaringarna.',
    },
    13: {
        ...
        8: "Ja, folk skall resa sig upp mot folk och rike mot rike, och det skall bliva jordbävningar på den ena orten efter den andra, och hungersnöd skall uppstå; detta är begynnelsen till 'födslovåndorna'[1].",
        ...
        14: "Men när I fån se 'förödelsens styggelse'[2] stå där han icke borde stå -- den som läser detta, han give akt därpå -- då må de som äro i Judeen fly bort till bergen,",
        ...
        25: 'och stjärnorna skola falla ifrån himmelen, och makterna[3] i himmelen skola bäva.',
        ...
        37: 'Men vad jag säger till eder, det säger jag till alla: Vaken!» [1] Se Födslovåndor i Ordförklaringarna. [2] Se Förödelsens styggelse i Ordförklaringarna. [3] Se Makter i Ordförklaringarna.',
    },
    14: {
        ...
        5: 'Man hade ju kunnat sälja den för mer än tre hundra silverpenningar[1] och giva dessa åt de fattiga.» Och de talade hårda ord till henne.',
        ...
        72: 'Och i detsamma gol hanen för andra gången. Då kom Petrus ihåg Jesu ord, huru han hade sagt till honom: »Förrän hanen har galit två gånger, skall du tre gånger förneka mig.» Och han brast ut i gråt. [1] Se Silverpenning i Ordförklaringarna.',
    },
    15: {
        ...
        34: 'Och vid nionde timmen ropade Jesus med hög röst: »Eloi, Eloi, lema sabaktani[2]?»; det betyder: »Min Gud, min Gud, varför har du övergivit mig?»',
        ...
        47: "Men Maria från Magdala och den Maria som var Joses' moder sågo var han lades. [1] Se Nya testamentets text i Ordförklaringarna. [2] Se Betoning i Ordförklaringarna.",
    },
    16: {
        ...
        20: 'Men de gingo ut och predikade allestädes. Och Herren verkade med dem och stadfäste ordet genom de tecken som åtföljde det.][1] [1] V. 9--20 se Nya testamentets text i Ordförklaringarna.',
    },
}
