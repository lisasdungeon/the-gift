...
CHAPTERS = {
    1: {
        1: 'I Ramataim-Sofim, i Efraims bergsbygd, levde en man som hette Elkana, son till Jeroham, son till Elihu, son till Tohu, son till Suf, en efraimit.',
        ...
        20: 'Och Hanna blev havande och födde en son, när tiden hade gått om; denne gav hon namnet Samuel, »ty», sade hon, »av HERREN har jag utbett mig honom.»[1]',
        ...
        24: 'Men sedan hon hade avvant[2] honom, tog hon honom med sig ditupp, jämte tre tjurar, en efa mjöl och en vinlägel; så förde hon honom in i HERRENS hus i Silo. Men gossen var ännu helt ung.',
        ...
        28: 'Därför vill ock jag nu giva honom tillbaka åt HERREN; så länge han lever, skall han vara given åt HERREN.» Och de tillbådo där HERREN. [1] Namnet Samuel är sammansatt av två hebreiska ord som betyda höra och Gud. [2] Se Avvänja i Ordförkl.',
    },
    2: {
        1: 'Och Hanna bad och sade: »Mitt hjärta fröjdar sig i HERREN; mitt horn är upphöjt genom HERREN. Min mun är vitt upplåten mot mina fiender; ty jag gläder mig över din frälsning.',
        ...
        23: 'sade han till dem: »Varför gören I sådant, allt detta onda som jag hör allt folket här tala om eder?',
        ...
        33: 'Dock vill jag icke från mitt altare utrota var man av din släkt, så att jag kommer dina ögon att förtvina och din själ att försmäkta; men alla som växa upp i ditt hus skola dö, när de hava hunnit till manlig ålder.',
        34: 'Och tecknet härtill skall för dig vara det som skall övergå dina båda söner Hofni och Pinehas: på en och samma dag skola de båda dö.',
        35: 'Men jag skall låta en präst uppstå åt mig, som bliver beståndande, en som gör efter vad i mitt hjärta och min själ är; åt honom skall jag bygga ett hus som bliver beståndande, och han skall göra tjänst inför min smorde beständigt.',
        36: "Och var och en som bliver kvar av ditt hus skall komma och falla ned för honom, för att få en silverpenning eller en kaka bröd; han skall säga: 'Anställ mig vid någon prästsyssla, så att jag får en bit bröd att äta.'»",
    },
    3: {
    ...
    4: {
        ...
        21: 'Och hon kallade gossen I-Kabod[1], och sade: »Härligheten är borta från Israel.» Därmed syftade hon på att Guds ark var tagen, så ock på sin svärfader och sin man.',
        22: 'Hon sade: »Härligheten är borta från Israel», eftersom Guds ark var tagen. [1] Namnet kan översättas med utan härlighet',
    },
    5: {
        ...
        4: 'Men när de dagen därefter åter kommo dit bittida om morgonen, fingo de ånyo se Dagon ligga framstupa på jorden framför HERRENS ark; och Dagons huvud och hans båda händer lågo avslagna på tröskeln, allenast fiskdelen[1] satt kvar på honom.',
        ...
        12: 'De av invånarna som icke dogo blevo slagna med bölder; och ropet från staden steg upp mot himmelen. [1] Se Dagon i Ordförkl.',
    },
    6: {
    ...
    7: {
        ...
        6: 'Då församlade de sig i Mispa och öste upp vatten och göto ut det inför HERREN och fastade den dagen; och de sade där: »Vi hava syndat mot HERREN.» Och Samuel dömde Israels barn i Mispa.',
        ...
        12: 'Då tog Samuel en sten och reste den mellan Mispa och Sen och gav den namnet Eben-Haeser[1], i det han sade: »Allt härintill har HERREN hjälpt oss.»',
        ...
        17: 'Sedan plägade han vända tillbaka till Rama, ty där var hans hem, och där dömde han eljest Israel där byggde han ock ett altare åt HERREN. [1] D. ä. hjälpstenen.',
    },
    8: {
    ...
    10: {
        ...
        3: 'Och när du har gått därifrån ett stycke fram och kommit till Tabors terebint skall du där möta tre män som äro på väg upp till Gud i Betel. En bär tre killingar, en bär tre brödkakor, och en bär en vinlägel.',
        4: 'Dessa skola hälsa dig och giva dig två bröd, och du skall taga emot vad de giva.',
        ...
        21: "När han sedan lät Benjamins stam gå fram efter dess släkter, träffades Matris släkt av lotten; därpå träffades Saul, Kis' son, av lotten, men när de då sökte efter honom, stod han icke att finna.",
    ...
    12: {
        ...
        10: "Men de ropade till HERREN och sade: 'Vi hava syndat, ty vi hava övergivit HERREN och tjänat Baalerna och Astarterna; men rädda oss nu från våra fienders hand, så vilja vi tjäna dig.'",
        ...
        14: 'Allenast mån I nu frukta HERREN och tjäna honom och höra hans röst och icke vara gensträviga mot HERRENS befallning. Ja, både I och den konung som regerar över eder mån följa HERREN, eder Gud.',
    ...
    19: {
        ...
        5: 'Han tog ju sin själ[1] i sin hand och slog ned filistéen, och HERREN gav så hela Israel en stor seger; du har själv sett det och glatt dig däråt. Varför skulle du då försynda dig på oskyldigt blod genom att döda David utan sak?»',
        ...
        24: 'Då kastade också han av sig sina kläder, i det att också han blev fattad av hänryckning inför Samuel; och han föll ned och låg där naken hela den dagen och hela natten. Därför plägar man säga: »Är ock Saul bland profeterna?» [1] Se själ i Ordförkl.',
    },
    20: {
    ...
    23: {
        ...
        28: 'Då upphörde Saul att förfölja David och drog mot filistéerna. Därav fick det stället namnet Sela-Hammalekot[1]. [1] Betydelsen oviss; möjligen skiljeklippan.',
    },
    24: {
    ...
    25: {
        ...
        25: 'Icke må min herre fästa något avseende vid Nabal, den onde mannen, ty vad hans namn betyder, det är han; Nabal heter han, och dårskap[1] bor i honom. Men jag, din tjänarinna, har icke sett de män som du, min herre, sände.',
        ...
        44: "Men Saul hade givit sin dotter Mikal, Davids hustru, åt Palti, Lais' son, från Gallim. [1] Hebr nebalá.",
    },
    26: {
        1: 'Och sifiterna kommo till Saul i Gibea och sade: »David håller sig nu gömd på Hakilahöjden, gent emot ödemarken.»',
        2: 'Då bröt Saul upp och drog ned till öknen Sif med tre tusen män utvalda ur Israel, för att söka efter David i öknen Sif.',
        3: 'Och Saul lägrade sig på Hakilahöjden, som ligger gent emot ödemarken, vid vägen. Men David uppehöll sig då i öknen. Och när David förnam att Saul hade kommit efter honom in i öknen,',
        4: 'sände han ut spejare och fick så full visshet om att Saul hade kommit.',
        ...
        6: 'Och David tog till orda och sade till hetiten Ahimelek och till Abisai, Serujas son, Joabs broder: »Vem vill gå med mig ned till Saul i lägret?» Då svarade Abisai: »Jag vill gå med dig ditned.»',
        ...
        8: 'Då sade Abisai till David: »Gud har i dag överlämnat din fiende i din hand; så låt mig nu få spetsa honom fast i jorden med spjutet; det skall ske genom en enda stöt, jag skall icke behöva giva honom mer än den.»',
        9: 'Men David svarade Abisai: »Du får icke förgöra honom; ty vem har uträckt sin hand mot HERRENS smorde och förblivit ostraffad?»',
        ...
        21: 'Då sade Saul: »Jag har syndat. Kom tillbaka, min son David; ty jag vill icke mer göra dig något ont, eftersom mitt liv i dag har varit dyrt aktat i dina ögon. Se, jag har handlat i mycket stor dårskap och förvillelse.»',
        22: 'David svarade och sade: »Se här är spjutet, o konung; låt nu en av dina män komma hitöver och hämta det.',
        23: 'Och HERREN skall vedergälla var och en för hans rättfärdighet och trofasthet. HERREN gav dig ju i dag i min hand, men jag ville icke uträcka min hand mot HERRENS smorde.',
        24: 'Och likasom ditt liv i dag har varit högt aktat i mina ögon, så må ock mitt liv vara högt aktat i HERRENS ögon, så att han räddar mig ur all nöd.»',
    ...
    28: {
        ...
        21: 'Men kvinnan gick fram till Saul, och när hon såg huru högeligen förskräckt han var, sade hon till honom: »Se, din tjänarinna lyssnade till din begäran; Jag tog min själ[1] i min hand och hörsammade den önskan du uttalade till mig.',
        ...
        25: 'Sedan satte hon fram det för Saul: och hans tjänare, och de åto. Därefter stodo de upp och gingo samma natt sina färde. [1] Se själ i Ordförkl.',
    },
    29: {
        ...
        10: 'Så stå nu upp bittida i morgon, jämte din herres tjänare som hava kommit hit med dig; och när I i morgon haven stått bittida upp, mån I draga edra färde, så snart det har blivit dager.»',
        11: 'Då stod David bittida upp med sina män för att om morgonen draga tillbaka till filistéernas land. Men filistéerna drogo upp till Jisreel.',
    },
    30: {
