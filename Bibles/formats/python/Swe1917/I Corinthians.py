...
CHAPTERS = {
    ...
    2: {
        ...
        14: 'Men en »själisk»[1] människa tager icke emot vad som hör Guds Ande till. Det är henne en dårskap, och hon kan icke förstå det, ty det måste utgrundas på ett andligt sätt.',
        15: 'Den andliga människan åter kan utgrunda allt, men själv kan hon icke utgrundas av någon.',
        16: 'Ty »vem har lärt känna Herrens sinne, så att han skulle kunna undervisa honom?» Men vi hava Kristi sinne. [1] Se Själisk i Ordförkl.',
    },
    3: {
        ...
        13: 'så skall det en gång visa sig huru det är med vars och ens verk. »Den dagen»[1] skall göra det kunnigt; ty den skall uppenbaras i eld, och hurudant vars och ens verk är, det skall elden pröva.',
        ...
        23: 'Men I hören Kristus till, och Kristus hör Gud till. [1] Se Dagen i Ordförkl.',
    },
    4: {
    ...
    7: {
        ...
        21: 'Har du blivit kallad såsom träl, så låt detta icke gå dig till sinnes; dock, om du kan bliva fri, så begagna dig hellre därav[1].',
        ...
        40: 'Men lyckligare är hon, om hon förbliver såsom hon är. Så är min mening, och jag tror att också jag har Guds Ande. [1] Eller: Har du blivit kallad såsom träl, så låt detta icke gå dig till sinnes; om du än kunde bliva fri, så behåll hellre din ställning.',
    },
    8: {
        1: "Vad åter angår kött från avgudaoffer, så känna vi nog det talet: »Alla hava vi 'kunskap'[1].» »Kunskapen» uppblåser, men kärleken uppbygger.",
        ...
        13: 'Därför, om maten kan bliva min broder till fall, så vill jag sannerligen hellre för alltid avstå från att äta kött, på det att jag icke må bliva min broder till fall. [1] Se Kunskap i Ordförkl.',
    },
    9: {
        ...
        17: 'Gör jag det av egen drift, så har jag rätt till lön; men då jag nu icke gör det av egen drift, så är den syssla som jag är betrodd med allenast en livegen förvaltares[1]. --',
        ...
        27: 'Fastmer tuktar jag min kropp och kuvar den, för att jag icke, när jag predikar för andra, själv skall komma till korta vid provet. [1] Se Förvaltare i Ordförkl.',
    },
    10: {
    ...
    15: {
        ...
        44: 'här sås en »själisk»[1] kropp, där uppstår en andlig kropp. Så visst som det finnes en »själisk» kropp, så visst finnes det ock en andlig.',
        ...
        58: 'Alltså, mina älskade bröder, varen fasta, orubbliga, alltid överflödande i Herrens verk, eftersom I veten att edert arbete icke är fåfängt i Herren. [1] Se Själisk i Ordförkl.',
    },
    16: {
        ...
        24: 'Min kärlek är med eder alla, i Kristus Jesus. [1] Arameiska ord, som betyda: »Du vår Herre, kom!» -- Jämför Upp 22,20.',
    },
}
