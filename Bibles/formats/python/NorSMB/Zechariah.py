...
CHAPTERS = {
    ...
    2: {
        1: 'So lyfte eg upp augo mine og fekk sjå fire horn.',
        2: 'Då spurde eg engelen som tala med meg: «Kva er dette?» Og han sagde til meg: «Dette er dei horni som hev spreidt Juda, Israel og Jerusalem.»',
        3: 'So let Herren meg sjå fire smedar,',
        4: 'og eg spurde: «Kva skal desse gjera?» Han svara: «Det var horni som spreidde Juda so at ingen lyfte hovudet sitt. Desse er no komne og skal skræma deim og slå av horni på dei heidningfolki som lyfte horn mot Judalandet til å spreida det.»',
        5: 'Og eg lyfte upp augo mine og fekk sjå ein mann med ei mælesnor i handi.',
        6: 'Då spurde eg: «Kvar gjeng du?» Han svara: «Eg skal mæla Jerusalem og sjå kor breidt og kor langt det skal verta.»',
        7: 'Då kom han fram den engelen som tala med meg, og ein annan engel kom imot honom.',
        8: 'Og han sagde til honom: «Spring og seg til denne unge mannen: «Fritt og ope skal Jerusalem liggja; slik ei mengd med folk og fe skal finnast der.',
        ...
        13: 'Sjå, eg lyfter handi mi mot deim, og dei skal verta til herfang for trælarne sine, og de skal få kjenna at Herren, allhers drott, hev sendt meg. Ropa høgt av frygd og gleda, du dotter Sion! For sjå, eg kjem og vil bu hjå deg, segjer Herren. Og mange heidningfolk skal venda seg til Herren på den dagen og verta mitt folk; ja, eg vil bu hjå deg, og du skal få kjenna at Herren, allhers drott, hev sendt meg til deg. Og til sin eigedom og arvlut skal Herren taka Juda i det heilage landet og endå ein gong velja ut Jerusalem. Ver stilt, alt kjøt, for Herren! For han hev rise upp og gjenge ut or sin heilage bustad.',
    },
    3: {
