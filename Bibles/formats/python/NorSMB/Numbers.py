...
CHAPTERS = {
    ...
    30: {
        ...
        16: 'Og gjer han det fyrst um inkje ei tid etter han fekk høyra um det, so ber han ansvaret for brotet hennar.» Dette er dei fyresegnerne Herren gav Moses um den retten ein mann hev yver kona si, og ein far yver dotter si, so lenge ho er ung og er heime hjå faren.',
    },
    31: {
