...
CHAPTERS = {
    ...
    5: {
        1: 'Da nu alt det arbeid var ferdig som Salomo lot gjøre for Herrens hus, lot han bære inn der de ting som hans far David hadde helliget til Herren; både sølvet og gullet og alle karene la han ned i skattkammerne i Guds hus.',
        ...
        3: 'Og alle Israels menn samlet sig hos kongen på festen i den syvende måned.',
        ...
        8: 'For kjerubene bredte sine vinger ut over det sted hvor arken stod, så at kjerubene ovenfra dekket både over arken og dens stenger.',
    ...
    8: {
        1: 'Da nu de tyve år var til ende som Salomo hadde bygget på Herrens hus og sitt eget hus,',
        2: 'bygget han op de byer som Hiram hadde gitt Salomo, og lot Israels barn bosette sig i dem.',
        3: 'Derefter drog Salomo til Hamat-Soba og la det under sig.',
        ...
        8: 'deres efterkommere, så mange som var blitt tilbake efter dem i landet fordi Israels barn ikke hadde utryddet dem - dem uttok Salomo til pliktarbeid, og så har det vært til denne dag.',
    ...
    10: {
        ...
        15: 'Kongen hørte ikke på folket; for Gud styrte det så forat Herrens ord skulde bli opfylt, det som han hadde talt til Jeroboam, Nebats sønn, ved Akia fra Silo.',
        16: 'Da nu hele Israel så at kongen ikke hørte på dem, svarte folket kongen og sa: Hvad del har vi i David? Vi har ingen lodd i Isais sønn. Til dine telt, Israel, hver og en! Se nu selv til ditt hus, David! Så drog hele Israel hjem igjen.',
    ...
    22: {
        1: 'Derefter gjorde Jerusalems innbyggere hans yngste sønn Akasja til konge i hans sted; for alle de eldre var blitt drept av den røverflokk som var kommet til leiren sammen med araberne. Således blev Jorams sønn Akasja konge i Juda.',
        ...
        12: 'Siden var han hos dem i Guds hus og blev holdt skjult i seks år, mens Atalja regjerte i landet.',
    },
    23: {
    ...
    27: {
        1: 'Jotam var fem og tyve år da han blev konge, og regjerte seksten år i Jerusalem; hans mor hette Jerusa og var datter av Sadok.',
        ...
        7: 'Hvad som ellers er å fortelle om Jotam, om alle hans kriger og alt det han tok sig fore, det er opskrevet i boken om Israels og Judas konger.',
        8: 'Han var fem og tyve år gammel da han blev konge, og regjerte seksten år i Jerusalem.',
        9: 'Og Jotam la sig til hvile hos sine fedre, og de begravde ham i Davids stad; og hans sønn Akas blev konge i hans sted.',
    },
    28: {
