...
CHAPTERS = {
    1: {
        ...
        18: "Et Salomon ordonna que l'on bâtit un temple au nom du Seigneur; puis, pour lui-même, une demeure royale.",
    },
    2: {
        1: "Il réunit soixante-dix mille manœuvres, quatre-vingt mille tailleurs de pierres qu'il envoya dans la montagne, et trois mille six cents conducteurs de leurs travaux.",
        2: "Il dépêcha des messagers à Hiram, roi de Tyr, disant: Tu en as bien usé avec David, mon père, tu lui as envoyé des cèdres pour bâtir le palais qu'il devait habiter.",
        3: "Or, voici que moi son fils, je bâtis un temple au nom du Seigneur mon Dieu, pour le lui consacrer, pour y brûler devant lui de l'encens, pour y exposer toujours les pains de proposition, pour y offrir les holocaustes du matin et du soir, ceux des sabbats, des nouvelles lunes, et des fêtes du Seigneur notre Dieu à perpétuité en Israël.",
        4: 'Le temple que je bâtis sera grand, parce que le Seigneur notre Dieu est grand plus que tous les dieux.',
        5: "Mais, qui donc peut lui élever un temple? Car le ciel et le ciel des cieux ne contiennent pas sa gloire. Et moi, qui suis-je pour lui bâtir un temple, si ce n'est seulement pour sacrifier devant lui?",
        6: "Envoie-moi donc un homme adroit et instruit à façonner l'or, l'argent, l'airain, le fer, le porphyre, l'hyacinthe et l'écarlate; et quelqu'un sachant sculpter et ciseler, avec les gens habiles que j'ai auprès de moi à Jérusalem, et qu'a formés David mon père.",
        7: "Envoie-moi aussi des bois de cèdre, de genièvre et de pin du Liban, car je n'ignore pas comment tes serviteurs savent équarrir les arbres du Liban. Et tes serviteurs, avec les miens,",
        8: 'Iront me préparer de la charpente en quantité, parce que la maison que je bâtis sera grande et magnifique.',
        9: "A tes serviteurs les charpentiers, je donne gratuitement pour leur nourriture: vingt mille mesures de froment, vingt mille mesures d'orge, vingt mille mesures de vin, et vingt mille mesures d'huile.",
        10: "Hiram, roi de Tyr, répondit par écrit, et il fit passer sa lettre à Salomon, disant: Le Seigneur aime ton peuple, c'est pourquoi il t'a fait régner sur eux.",
        11: "Et Hiram ajouta: Béni soit le Seigneur Dieu d'Israël, qui a créé le ciel et la terre, qui a donné à David un fils sage, plein de savoir et d'intelligence; c'est ce fils qui bâtira le temple du Seigneur et son propre palais.",
        12: "Et moi je t'envoie un homme intelligent et habile, Hiram, mon serviteur.",
        13: "Sa mère est des filles de Dan, et son père un Tyrien; il sait façonner l'or, l'argent, l'airain, le fer, les pierres et le bois; il sait tisser avec le porphyre, l'hyacinthe, le lin et l'écarlate; il sait sculpter et ciseler; il n'est rien qu'il ne sache inventer; il exécutera tout ce que tu lui commanderas, aidé de tes hommes habiles, et des hommes habiles de mon seigneur David, ton père.",
        14: "Quant aux vivres, à l'orge, à l'huile, au vin dont a parlé mon seigneur, qu'il les envoie à ses serviteurs.",
        15: "Et nous, nous équarrirons des arbres du Liban, autant qu'il en faudra; nous en ferons des radeaux que nous conduirons par mer à Joppé, et tu les transporteras à Jérusalem.",
        16: "Alors, Salomon réunit tous les étrangers qui habitaient la terre d'Israël, après le dénombrement qu'avait fait son père David; or, il s'en trouvait cent cinquante-trois mille six cents.",
        17: 'Parmi eux, il prit soixante-dix mille manœuvres, quatre-vingt mille tailleurs de pierres, et trois mille six cents conducteurs des travaux, pour diriger cette multitude.',
    },
    3: {
    ...
    6: {
        ...
        36: "Ils pècheront contre vous, car il n'est point d'homme qui ne pèche; vous les frapperez, vous les livrerez à des ennemis qui les emmèneront captifs en leur terre voisine ou lointaine.",
    ...
    13: {
        ...
        23: "Et Abias mourut, et il alla rejoindre ses pères, et on l'ensevelit en la ville de David; et Asa, son fils, régna à sa place. Sous Asa, Juda fut en paix dix années.",
    },
    14: {
        ...
        11: "Et le Seigneur frappa les Ethiopiens devant Juda, et les Ethiopiens s'enfuirent.",
        12: "Asa et son peuple les poursuivirent jusqu'à Gedsor. Les Ethiopiens tombèrent jusqu'au dernier; car ils furent broyés devant le Seigneur et devant son armée, et les fils de Juda recueillirent d'innombrables dépouilles.",
        13: 'Et ils détruisirent les bourgs autour de Gedsor; car un grand trouble, venant du Seigneur, était sur eux. Les fils de Juda pillèrent leurs villes, et ils firent un riche butin.',
        14: 'Ils détruisirent les tentes des troupeaux, ils dépouillèrent les habitants de la côte, ils emmenèrent quantité de moutons et de chameaux, et ils revinrent à Jérusalem.',
    },
    15: {
    ...
    23: {
        1: "Dans la huitième année, Joad se fortifia, il prit avec lui dans le temple du Seigneur les centeniers Azarias, fils de Joram; Ismaël, fils de Johanan; Azarias, fils d'Obed; Maaseas, fils d'Adia, et Elisaphan, fils de Zacharie.",
        ...
        4: "Écoutez donc ce que vous avez à faire: Que le tiers des prêtres et des lévites commence son service de semaine et garde les portes d'entrée,",
    ...
    26: {
        ...
        15: "Et il fit exécuter à Jérusalem des machines, œuvres d'un habile calculateur, pour être sur les tours et sur les angles, ou pour lancer des traits ou de grosses pierres; partout, même au loin, on parla beaucoup de ses engins; car il en était merveilleusement secouru, et en tirait une grande force.",
