...
CHAPTERS = {
    1: {
        ...
        2: 'Und Salomo redete zu ganz Israel, zu den Obersten über tausend und über hundert, und zu den Richtern und zu allen Fürsten von ganz Israel, den Häuptern der Väter;',
        3: 'und sie gingen, Salomo und die ganze Versammlung mit ihm, nach der Höhe, die zu Gibeon war; denn dort war das Zelt der Zusammenkunft Gottes, welches Mose, der Knecht Jehovas, in der Wüste gemacht hatte.',
        ...
        7: 'In selbiger Nacht erschien Gott dem Salomo und sprach zu ihm: Bitte, was ich dir geben soll.',
        ...
        9: 'nun möge sich, Jehova Gott, dein Wort bewähren, das du zu meinem Vater David geredet hast! Denn du hast mich zum König gemacht über ein Volk, das zahlreich ist wie der Staub der Erde.',
        ...
        13: 'Und Salomo kam von der Höhe, die zu Gibeon war, von dem Zelte der Zusammenkunft nach Jerusalem. Und er regierte über Israel.',
        14: 'Und Salomo brachte Wagen und Reiter zusammen, und er hatte 1400 Wagen und 12000 Reiter; und er verlegte sie in die Wagenstädte und zu dem König nach Jerusalem.',
        15: 'Und der König machte das Silber und das Gold in Jerusalem den Steinen gleich, und die Cedern machte er den Sykomoren gleich, die in der Niederung sind, an Menge.',
        16: 'Und die Ausfuhr der Rosse für Salomo geschah aus Ägypten; und ein Zug Handelsleute des Königs holte einen Zug um Geld.',
        17: 'Und sie brachten herauf und führten aus Ägypten einen Wagen aus um 600 Sekel Silber, und ein Roß um 150. Und also führte man für alle Könige der Hethiter und für die Könige von Syrien durch ihre Hand aus.',
    },
    2: {
        1: 'Und Salomo gedachte, dem Namen Jehovas ein Haus zu bauen und ein Haus für sein Königtum.',
        2: 'Und Salomo zählte 70000 Lastträger ab, und 80000 Steinhauer im Gebirge, und 3600 Aufseher über dieselben.',
        3: 'Und Salomo sandte zu Huram, dem König von Tyrus, und ließ ihm sagen: So wie du meinem Vater David getan und ihm Cedern gesandt hast, daß er sich ein Haus baue, um darin zu wohnen, so tue auch mir.',
        4: 'Siehe, ich will dem Namen Jehovas, meines Gottes, ein Haus bauen, um es ihm zu heiligen, wohlriechendes Räucherwerk vor ihm zu räuchern, und um das beständige Schichtbrot zuzurichten und Brandopfer morgens und abends zu opfern, an den Sabbathen und an den Neumonden und an den Festen Jehovas, unseres Gottes; ewiglich liegt dies Israel ob.',
        5: 'Und das Haus, das ich bauen will, soll groß sein; denn unser Gott ist größer als alle Götter.',
        6: 'Aber wer vermöchte ihm ein Haus zu bauen? denn die Himmel und der Himmel Himmel können ihn nicht fassen. Und wer bin ich, daß ich ihm ein Haus bauen sollte, es sei denn, um vor ihm zu räuchern?',
        7: 'Und nun sende mir einen Mann, der zu arbeiten versteht in Gold und in Silber, und in Erz und in Eisen, und in rotem Purpur und Karmesin und blauem Purpur, und kundig ist, Schnitzarbeit zu machen, nebst den Kunstverständigen, die bei mir in Juda und in Jerusalem sind, die mein Vater David bestellt hat.',
        8: 'Und sende mir Cedern-, Cypressen- und Sandelholz vom Libanon; denn ich weiß, daß deine Knechte das Holz des Libanon zu hauen verstehen; und siehe, meine Knechte sollen mit deinen Knechten sein.',
        9: 'Und man möge mir Holz bereiten in Menge; denn das Haus, das ich bauen will, soll groß und außerordentlich sein.',
        10: 'Und siehe, ich werde deinen Knechten, den Holzhauern, die das Holz fällen, ausgeschlagenen Weizen geben, 20000 Kor, und 20000 Kor Gerste, und 20000 Bath Wein, und 20000 Bath Öl.',
        ...
        16: 'Wir aber werden Holz hauen vom Libanon nach all deinem Bedarf, und werden es dir als Flöße auf dem Meere nach Japho bringen; und du magst es nach Jerusalem hinaufschaffen.',
        17: 'Und Salomo zählte alle Fremdlinge, die im Lande Israel waren, nach der Zählung, welche sein Vater David von ihnen gemacht hatte; und es fanden sich 153600.',
        18: 'Und er machte aus ihnen 70000 zu Lastträgern, und 80000 zu Steinhauern im Gebirge, und 3600 zu Aufsehern, um das Volk zur Arbeit anzuhalten.',
    },
    3: {
        ...
        4: 'Und die Halle, welche der Länge nach vor der Breite des Hauses war, zwanzig Ellen, und die Höhe120; und er überzog sie inwendig mit reinem Golde.',
        ...
        15: 'Und er machte vor dem Hause zwei Säulen, 35 Ellen die Länge; und das Kapitäl, das auf ihrer Spitze war, maß fünf Ellen.',
    ...
    4: {
        ...
        2: 'Und er machte das Meer, gegossen, zehn Ellen von seinem einen Rande bis zu seinem anderen Rande, gerundet ringsum, und fünf Ellen seine Höhe; und eine Schnur von dreißig Ellen umfaßte es ringsum.',
        3: 'Und unter demselben waren Gleichnisse von Rindern, die es ringsherum umgaben, zehn auf die Elle, das Meer ringsum einschließend; der Rinder waren zwei Reihen, gegossen aus einem Gusse mit demselben.',
        ...
        7: 'Und er machte die zehn goldenen Leuchter, nach ihrer Vorschrift, und er setzte sie in den Tempel, fünf zur Rechten und fünf zur Linken.',
        ...
        9: 'Und er machte den Hof der Priester und den großen Vorhof, und die Türen zu dem Vorhof; und ihre Flügel überzog er mit Erz.',
        10: 'Und das Meer setzte er auf die rechte Seite ostwärts gegen Süden.',
        11: 'Und Huram machte die Töpfe und die Schaufeln und die Sprengschalen. -Und so vollendete Huram das Werk, welches er für den König Salomo im Hause Gottes machte:',
        12: 'zwei Säulen und die krugförmigen Kapitäle auf der Spitze der beiden Säulen; und die zwei Netzwerke zur Bedeckung der beiden krugförmigen Kapitäle, die auf der Spitze der Säulen waren;',
        ...
        16: 'und die Töpfe und die Schaufeln und die Gabeln. Und alle ihre Geräte machte Huram-Abiw dem König Salomo für das Haus Jehovas von geglättetem Erz.',
        ...
        21: 'und die Blumen und die Lampen und die Lichtschneuzen von Gold;',
    ...
    5: {
        1: 'Und so war das ganze Werk vollendet, welches Salomo für das Haus Jehovas machte. Und Salomo brachte die geheiligten Dinge seines Vaters David hinein, nämlich das Silber und das Gold und alle Geräte; er legte sie in die Schatzkammern des Hauses Gottes.',
        2: 'Damals versammelte Salomo die Ältesten von Israel und alle Häupter der Stämme, die Fürsten der Väter der Kinder Israel, nach Jerusalem, um die Lade des Bundes Jehovas heraufzubringen aus der Stadt Davids, das ist Zion.',
        ...
        5: 'Und sie brachten die Lade hinauf, sowie das Zelt der Zusammenkunft und alle heiligen Geräte, die im Zelte waren: die Priester, die Leviten, brachten sie hinauf.',
        ...
        7: 'Und die Priester brachten die Lade des Bundes Jehovas an ihren Ort, in den Sprachort des Hauses, in das Allerheiligste, unter die Flügel der Cherubim;',
        ...
        9: 'Und die Stangen waren so lang, daß die Spitzen der Stangen von der Lade her an der Vorderseite des Sprachortes gesehen wurden; aber auswärts wurden sie nicht gesehen. Und sie sind daselbst bis auf diesen Tag.',
        ...
        11: 'Und es geschah, als die Priester aus dem Heiligen herausgingen',
    ...
    6: {
        ...
        36: 'Wenn sie wider dich sündigen, -denn da ist kein Mensch, der nicht sündigte und du über sie erzürnst und sie vor dem Feinde dahingibst und ihre Besieger sie gefangen wegführen in ein fernes oder in ein nahes Land;',
        ...
        41: 'Und nun, stehe auf, Jehova Gott, zu deiner Ruhe, du und die Lade deiner Stärke! Laß deine Priester, Jehova Gott, bekleidet sein mit Rettung, und deine Frommen sich freuen des Guten!',
    ...
    7: {
        ...
        5: 'Und der König Salomo opferte als Schlachtopfer 22000 Rinder und 120000 Schafe. Und der König und das ganze Volk weihten das Haus Gottes ein.',
    ...
    8: {
        1: 'Und es geschah am Ende von zwanzig Jahren, während welcher Salomo das Haus Jehovas und sein Haus gebaut hatte,',
        ...
        8: 'ihre Söhne, die nach ihnen im Lande übriggeblieben waren, welche die Kinder Israel nicht vertilgt hatten, die hob Salomo zu Fronarbeitern aus bis auf diesen Tag.',
        ...
        11: 'Und Salomo führte die Tochter des Pharao aus der Stadt Davids herauf in das Haus, das er ihr gebaut hatte; denn er sprach: Mein Weib soll nicht in dem Hause Davids, des Königs von Israel, wohnen; denn die Orte sind heilig, in welche die Lade Jehovas gekommen ist.',
        ...
        15: 'Und man wich nicht von dem Gebot des Königs an die Priester und die Leviten ab betreffs jeder Sache und betreffs der Schätze. -',
        16: 'Und so wurde das ganze Werk Salomos zustande gebracht, bis zum Tage der Gründung des Hauses Jehovas und bis zur Vollendung desselben. Das Haus Jehovas war fertig.',
    ...
    9: {
        1: 'Und die Königin von Scheba hörte den Ruf Salomos; und sie kam nach Jerusalem, um Salomo mit Rätseln zu versuchen, mit einem sehr großen Zuge und mit Kamelen, die Gewürze und Gold trugen in Menge und Edelsteine. Und sie kam zu Salomo und redete mit ihm alles, was in ihrem Herzen war.',
        2: 'Und Salomo erklärte ihr alles, um was sie fragte; und keine Sache war vor Salomo verborgen, die er ihr nicht erklärt hätte.',
        3: 'Und als die Königin von Scheba die Weisheit Salomos sah, und das Haus, das er gebaut hatte,',
        4: 'und die Speise seines Tisches, und das Sitzen seiner Knechte, und das Aufwarten seiner Diener, und ihre Kleidung, und seine Mundschenken und ihre Kleidung, und seinen Aufgang, auf welchem er in das Haus Jehovas hinaufging, da geriet sie außer sich',
        ...
        9: 'Und sie gab dem König 120 Talente Gold, und Gewürze in großer Menge und Edelsteine; und nie ist dergleichen Gewürz gewesen wie dieses, welches die Königin von Scheba dem König Salomo gab.',
        10: 'Und auch die Knechte Hurams und die Knechte Salomos, welche Gold aus Ophir holten, brachten Sandelholz und Edelsteine.',
        11: 'Und der König machte von dem Sandelholz Stiegen für das Haus Jehovas und für das Haus des Königs, und Lauten und Harfen für die Sänger; und desgleichen ist vordem nicht gesehen worden im Lande Juda.',
        ...
        15: 'Und der König Salomo machte zweihundert Schilde von getriebenem Golde: sechshundert Sekel getriebenes Gold zog er über jeden Schild;',
        ...
        21: 'Denn die Schiffe des Königs fuhren nach Tarsis mit den Knechten Hurams; einmal in drei Jahren kamen Tarsisschiffe, beladen mit Gold und Silber, Elfenbein und Affen und Pfauen.',
        ...
        25: 'Und Salomo hatte viertausend Stände für Rosse und Wagen und 12000 Reiter; und er verlegte sie in die Wagenstädte und zu dem König nach Jerusalem.',
        26: 'Und er war Herrscher über alle Könige, von dem Strome an bis zu dem Lande der Philister und bis zu der Grenze Ägyptens.',
        27: 'Und der König machte das Silber in Jerusalem den Steinen gleich, und die Cedern machte er den Sykomoren gleich, die in der Niederung sind, an Menge.',
    ...
    10: {
        ...
        2: 'Und es geschah, als Jerobeam, der Sohn Nebats, es hörte, da kehrte Jerobeam aus Ägypten zurück.',
        3: 'Und sie sandten hin und riefen ihn. Und Jerobeam und ganz Israel kamen und redeten zu Rehabeam und sprachen:',
        4: 'Dein Vater hat unser Joch hart gemacht; und nun erleichtere den harten Dienst deines Vaters und sein schweres Joch, das er auf uns gelegt hat, so wollen wir dir dienen.',
        5: 'Und er sprach zu ihnen: Noch drei Tage, dann kommet wieder zu mir. Und das Volk ging hin.',
        ...
        8: 'Aber er verließ den Rat der Alten, den sie ihm gegeben hatten; und er beriet sich mit den Jungen, die mit ihm aufgewachsen waren, die vor ihm standen.',
        ...
        11: 'Nun denn, mein Vater hat euch ein schweres Joch aufgeladen, ich aber will zu eurem Joche hinzutun; mein Vater hat euch mit Geißeln gezüchtigt, ich aber will euch mit Skorpionen züchtigen.',
        12: 'Und Jerobeam und alles Volk kamen zu Rehabeam am dritten Tage, so wie der König geredet und gesagt hatte: Kommet am dritten Tage wieder zu mir.',
        13: 'Und der König antwortete ihnen hart; und der König Rehabeam verließ den Rat der Alten,',
        14: 'und redete zu ihnen nach dem Rate der Jungen und sprach: Mein Vater hat euer Joch schwer gemacht, ich aber will zu demselben hinzutun; mein Vater hat euch mit Geißeln gezüchtigt, ich aber will euch mit Skorpionen züchtigen.',
        15: 'So hörte der König nicht auf das Volk; denn es war eine Wendung von seiten Gottes, auf daß Jehova sein Wort aufrecht hielte, welches er durch Achija, den Siloniter, zu Jerobeam, dem Sohne Nebats, geredet hatte.',
        16: 'Und als ganz Israel sah, daß der König nicht auf sie hörte, da antwortete das Volk dem König und sprach: Was haben wir für Teil an David? und wir haben kein Erbteil am Sohne Isais! Ein jeder zu seinen Zelten, Israel! Nun sieh nach deinem Hause, David! Und ganz Israel ging nach seinen Zelten.',
        17: 'Die Kinder Israel aber, die in den Städten Judas wohnten, über sie wurde Rehabeam König.',
        18: 'Und der König Rehabeam sandte Hadoram, der über die Fron war; aber die Kinder Israel steinigten ihn, und er starb. Da eilte der König Rehabeam, den Wagen zu besteigen, um nach Jerusalem zu fliehen.',
        19: 'So fiel Israel vom Hause Davids ab bis auf diesen Tag.',
    },
    11: {
        1: 'Und Rehabeam kam nach Jerusalem; und er versammelte das Haus Juda und Benjamin, 180000 auserlesene Krieger, um mit Israel zu streiten, damit er das Königreich an Rehabeam zurückbrächte.',
    ...
    12: {
        ...
        7: 'Und als Jehova sah, daß sie sich gedemütigt hatten, geschah das Wort Jehovas zu Schemaja also: Sie haben sich gedemütigt: ich will sie nicht verderben, und will ihnen ein wenig Errettung geben, und mein Grimm soll sich nicht durch Sisak über Jerusalem ergießen.',
        ...
        12: 'Und als er sich demütigte, wandte sich der Zorn Jehovas von ihm ab, so daß er ihn nicht völlig verderbte; und auch war in Juda noch etwas Gutes.',
    ...
    14: {
        1: 'Und Abija legte sich zu seinen Vätern, und man begrub ihn in der Stadt Davids. Und Asa, sein Sohn, ward König an seiner Statt. In seinen Tagen hatte das Land Ruhe zehn Jahre.',
        ...
        8: 'Und Asa hatte ein Heer, das Schild und Lanze trug: aus Juda 300000 und aus Benjamin 280000 Mann, die Tartschen trugen und den Bogen spannten: sämtlich tapfere Helden.',
    ...
    15: {
        ...
        6: 'Und es stieß sich Nation an Nation und Stadt an Stadt; denn Gott beunruhigte sie durch allerlei Bedrängnis.',
        7: 'Ihr aber, seid stark und lasset eure Hände nicht erschlaffen, denn es gibt Lohn für euer Tun!',
        8: 'Und als Asa diese Worte und die Weissagung Odeds, des Propheten, hörte, faßte er Mut; und er schaffte die Greuel weg aus dem ganzen Lande Juda und Benjamin und aus den Städten, die er vom Gebirge Ephraim eingenommen hatte, und er erneuerte den Altar Jehovas, der vor der Halle Jehovas stand.',
        ...
        11: 'und sie opferten Jehova an selbigem Tage von der Beute, die sie eingebracht hatten, 700 Rinder und 7000 Schafe.',
        ...
        15: 'Und ganz Juda freute sich des Eides; denn sie schwuren mit ihrem ganzen Herzen und suchten Jehova mit ihrem ganzen Willen; und er ließ sich von ihnen finden. Und Jehova schaffte ihnen Ruhe ringsumher.',
        16: 'Und auch Maaka, die Mutter des Königs Asa, setzte er ab, daß sie nicht mehr Königin wäre, weil sie der Aschera ein Götzenbild gemacht hatte; und Asa rottete ihr Götzenbild aus und zermalmte und verbrannte es im Tale Kidron.',
    ...
    16: {
        1: 'Im 36. Jahre der Regierung Asas zog Baesa, der König von Israel, wider Juda herauf; und er baute Rama, um Asa, dem König von Juda, niemand aus- und eingehen zu lassen.',
        2: 'Da brachte Asa Silber und Gold heraus aus den Schätzen des Hauses Jehovas und des Hauses des Königs; und er sandte zu Ben-Hadad, dem König von Syrien, der zu Damaskus wohnte, und ließ ihm sagen:',
        3: 'Ein Bund ist zwischen mir und dir und zwischen meinem Vater und deinem Vater. Siehe, ich sende dir Silber und Gold; wohlan! brich deinen Bund mit Baesa, dem König von Israel, daß er von mir abziehe.',
        4: 'Und Ben-Hadad hörte auf den König Asa, und er sandte seine Heerobersten wider die Städte Israels; und sie schlugen Ijon und Dan und Abel-Majim und alle Vorratsplätze der Städte Naphtalis.',
        5: 'Und es geschah, als Baesa es hörte, da ließ er von dem Bau Ramas ab und stellte seine Arbeit ein.',
        6: 'Der König Asa aber nahm ganz Juda, und sie schafften die Steine Ramas und dessen Holz weg, womit Baesa gebaut hatte; und er baute damit Geba und Mizpa.',
        7: 'Und zu selbiger Zeit kam Hanani, der Seher, zu Asa, dem König von Juda, und sprach zu ihm: Weil du dich auf den König von Syrien gestützt hast, und hast dich nicht auf Jehova, deinen Gott, gestützt, darum ist das Heer des Königs von Syrien deiner Hand entronnen.',
        8: 'Waren nicht die Kuschiter und die Libyer eine zahlreiche Heeresmacht, mit Wagen und Reitern in großer Menge? Aber weil du dich auf Jehova stütztest, gab er sie in deine Hand.',
        9: 'Denn Jehovas Augen durchlaufen die ganze Erde, um sich mächtig zu erweisen an denen, deren Herz ungeteilt auf ihn gerichtet ist. Hierin hast du töricht gehandelt; denn von nun an wirst du Kriege haben.',
        10: 'Und Asa wurde ärgerlich über den Seher und legte ihn in das Stockhaus; denn er war dieserhalb gegen ihn erzürnt. Auch tat Asa zu selbiger Zeit etlichen von dem Volke Gewalt an.',
        11: 'Und siehe, die Geschichte Asas, die erste und die letzte, siehe, sie ist geschrieben in dem Buche der Könige von Juda und Israel.',
        12: 'Und im 39. Jahre seiner Regierung erkrankte Asa an seinen Füßen, so daß er überaus krank war; aber auch in seiner Krankheit suchte er nicht Jehova, sondern die Ärzte.',
        13: 'Und Asa legte sich zu seinen Vätern; und er starb im 41. Jahre seiner Regierung.',
        14: 'Und man begrub ihn in seinem Begräbnis, das er sich in der Stadt Davids gegraben hatte. Und man legte ihn auf ein Lager, das man gefüllt hatte mit Gewürz und Spezereien, gemischt nach der Kunst der Salbenmischung; und man veranstaltete für ihn einen sehr großen Brand.',
    },
    17: {
        1: 'Und Josaphat, sein Sohn, ward König an seiner Statt. Und er stärkte sich wider Israel;',
        2: 'und er legte Kriegsvolk in alle festen Städte Judas und legte Besatzungen in das Land Juda und in die Städte Ephraims, die sein Vater Asa eingenommen hatte.',
        ...
        11: 'Und die Philister brachten Josaphat Geschenke und Silber als Tribut; auch die Araber brachten ihm Kleinvieh, 7700 Widder, und 7700 Böcke.',
    ...
    18: {
        1: 'So hatte Josaphat Reichtum und Ehre in Fülle. Und er verschwägerte sich mit Ahab.',
        ...
        4: 'Und Josaphat sprach zu dem König von Israel: Befrage doch heute das Wort Jehovas.',
        ...
        7: 'Und der König von Israel sprach zu Josaphat: Es ist noch ein Mann da, um durch ihn Jehova zu befragen; aber ich hasse ihn, denn er weissagt nichts Gutes über mich, sondern immer nur Böses; es ist Micha, der Sohn Jimlas. Und Josaphat sprach: Der König spreche nicht also!',
        ...
        24: 'Und Micha sprach: Siehe, du wirst es sehen an jenem Tage, wenn du ins innerste Gemach gehen wirst, um dich zu verstecken.',
        ...
        31: 'Und es geschah, als die Obersten der Wagen Josaphat sahen, denn sie sprachen: Das ist der König von Israel! da umringten sie ihn, um zu streiten; und Josaphat schrie; und Jehova half ihm, und Gott lenkte sie von ihm ab.',
        32: 'Und es geschah, als die Obersten der Wagen sahen, daß er nicht der König von Israel war, da wandten sie sich von ihm ab.',
        33: 'Und ein Mann spannte den Bogen aufs Geratewohl und traf den König von Israel zwischen den Panzeranhang und den Panzer. Da sprach er zu seinem Wagenlenker: Wende um und führe mich aus dem Lager hinaus, denn ich bin verwundet.',
    ...
    20: {
        ...
        2: 'Und man kam und berichtete Josaphat und sprach: Eine große Menge ist wider dich gekommen von jenseit des Meeres, von Syrien; und siehe, sie sind zu Hazezon-Tamar, das ist Engedi.',
        3: 'Da fürchtete sich Josaphat, und er richtete sein Angesicht darauf, Jehova zu suchen; und er rief ein Fasten aus über ganz Juda.',
        4: 'Und Juda versammelte sich, um von Jehova Hülfe zu suchen; sogar aus allen Städten Judas kamen sie, um Jehova zu suchen.',
        5: 'Und Josaphat stand in der Versammlung Judas und Jerusalems im Hause Jehovas, vor dem neuen Vorhof;',
        6: 'und er sprach: Jehova, Gott unserer Väter, bist du es nicht, der da Gott im Himmel ist, und bist du nicht der Herrscher über alle Königreiche der Nationen? Und in deiner Hand ist Kraft und Macht; und niemand vermag gegen dich zu bestehen.',
        ...
        13: 'Und ganz Juda stand vor Jehova, samt ihren Kindlein, ihren Weibern und ihren Söhnen.',
        14: 'Und Jachasiel, der Sohn Sekarjas, des Sohnes Benajas, des Sohnes Jechiels, des Sohnes Mattanjas, der Levit, von den Söhnen Asaphs-auf ihn kam der Geist Jehovas mitten in der Versammlung.',
        15: 'Und er sprach: Merket auf, ganz Juda, und ihr Bewohner von Jerusalem, und du, König Josaphat! So spricht Jehova zu euch: Fürchtet euch nicht und erschrecket nicht vor dieser großen Menge; denn nicht euer ist der Streit, sondern Gottes!',
        ...
        17: 'Ihr werdet hierbei nicht zu streiten haben; tretet hin, stehet und sehet die Rettung Jehovas an euch, Juda und Jerusalem! Fürchtet euch nicht und erschrecket nicht; morgen ziehet ihnen entgegen, und Jehova wird mit euch sein!',
        ...
        28: 'Und sie kamen nach Jerusalem, zum Hause Jehovas, mit Harfen und mit Lauten und mit Trompeten.',
        29: 'Und der Schrecken Gottes fiel auf alle Königreiche der Länder, als sie hörten, daß Jehova mit den Feinden Israels gestritten hatte.',
        30: 'Und das Königreich Josaphats hatte Ruhe; und sein Gott schaffte ihm Ruhe ringsumher.',
        31: 'Und so regierte Josaphat über Juda. Er war 35 Jahre alt, als er König wurde, und er regierte 25 Jahre zu Jerusalem; und der Name seiner Mutter war Asuba, die Tochter Schilchis.',
        ...
        37: 'Und Elieser, der Sohn Dodawas, von Marescha, weissagte wider Josaphat und sprach: Weil du dich mit Ahasja verbunden hast, hat Jehova dein Werk zerstört. Und die Schiffe wurden zertrümmert und vermochten nicht nach Tarsis zu fahren.',
    },
    21: {
        ...
        20: 'Jahre war er alt, als er König wurde, und er regierte acht Jahre zu Jerusalem. Und er ging hin, ohne vermißt zu werden; und man begrub ihn in der Stadt Davids, aber nicht in den Gräbern der Könige.',
    },
    22: {
        1: 'Und die Bewohner von Jerusalem machten Ahasja, seinen jüngsten Sohn, zum König an seiner Statt; denn alle die älteren hatte die Schar ermordet, welche mit den Arabern ins Lager gekommen war. Und Ahasja, der Sohn Jorams, des Königs von Juda, ward König.',
        2: 'Jahre war Ahasja alt, als er König wurde, und er regierte ein Jahr zu Jerusalem; und der Name seiner Mutter war Athalja, die Tochter Omris.',
        ...
        11: 'Aber Josabath, die Tochter des Königs, nahm Joas, den Sohn Ahasjas, und stahl ihn weg aus der Mitte der Königssöhne, die getötet wurden, und sie tat ihn und seine Amme in das Schlafgemach. Und so verbarg ihn Josabath, die Tochter des Königs Joram, das Weib Jojadas, des Priesters vor Athalja, so daß sie ihn nicht tötete.',
        12: 'Und er war sechs Jahre bei ihnen im Hause Gottes versteckt. Athalja aber regierte über das Land.',
    },
    23: {
        1: 'Und im siebten Jahre stärkte sich Jojada und verband die Obersten über hundert, Asarja, den Sohn Jerochams, und Ismael, den Sohn Jochanans, und Asarja, den Sohn Obeds, und Maaseja, den Sohn Adajas, und Elisaphat, den Sohn Sikris, mit sich in einem Bunde.',
    ...
    24: {
        ...
        20: 'Und der Geist Gottes kam über Sekarja, den Sohn Jojadas, des Priesters; und er stand auf über dem Volke und sprach zu ihnen: So spricht Gott: Warum übertretet ihr die Gebote Jehovas? Es wird euch ja nicht gelingen. Weil ihr Jehova verlassen habt, so hat er euch verlassen.',
    ...
    26: {
        ...
        3: 'Sechzehn Jahre war Ussija alt, als er König wurde, und er regierte 52 Jahre zu Jerusalem; und der Name seiner Mutter war Jekolja, von Jerusalem.',
        ...
        10: 'Und er baute Türme in der Wüste und grub viele Cisternen; denn er hatte viel Vieh, sowohl in der Niederung als auch in der Ebene, und Ackerleute und Weingärtner im Gebirge und im Fruchtgefilde; denn er liebte den Ackerbau.',
        ...
        12: 'Die ganze Zahl der Häupter der Väter der tapferen Helden war 2600.',
        13: 'Und unter ihrer Leitung stand eine Heeresmacht von 307500 Mann, welche den Krieg führte mit gewaltiger Kraft, um dem König wider den Feind beizustehen.',
        ...
        20: 'Und Asarja, der Hauptpriester, und alle die Priester wandten sich zu ihm, und siehe, er war aussätzig an seiner Stirn, und sie trieben ihn eilends von dannen fort; und auch er selbst beeilte sich hinauszukommen, weil Jehova ihn geschlagen hatte.',
    ...
    27: {
        ...
        5: 'Und er stritt mit dem König der Kinder Ammon und überwand sie; und die Kinder Ammon gaben ihm in selbigem Jahre 1000 Talente Silber und 10000 Kor Weizen und 10000 Kor Gerste. Das entrichteten ihm die Kinder Ammon auch im zweiten und im dritten Jahre.',
        ...
        8: 'Jahre war er alt, als er König wurde, und er regierte sechzehn Jahre zu Jerusalem.',
    ...
    28: {
        ...
        6: 'Und Pekach, der Sohn Remaljas, erschlug in Juda an einem Tage 120000 Mann, alles tapfere Leute, weil sie Jehova, den Gott ihrer Väter, verlassen hatten.',
        ...
        8: 'Und die Kinder Israel führten von ihren Brüdern 200000 Weiber, Söhne und Töchter gefangen hinweg; und auch raubten sie große Beute von ihnen und brachten die Beute nach Samaria.',
        ...
        21: 'Denn Ahas beraubte das Haus Jehovas und das Haus des Königs und der Obersten, und gab das Geraubte dem König von Assyrien; aber er war ihm nicht zur Hülfe.',
    ...
    29: {
        1: 'Jehiskia wurde König, als er 25 Jahre alt war, und er regierte 29 Jahre zu Jerusalem; und der Name seiner Mutter war Abija, die Tochter Sekarjas.',
        ...
        19: 'Und alle Geräte, die der König Ahas während seiner Regierung in seiner Treulosigkeit entweiht hat, haben wir hergerichtet und geheiligt; und siehe, sie sind vor dem Altar Jehovas.',
        ...
        31: 'Und Jehiskia hob an und sprach: Nun habt ihr euch Jehova geweiht; tretet herzu und bringet Schlachtopfer und Dankopfer zum Hause Jehovas. Und die Versammlung brachte Schlachtopfer und Dankopfer, und jeder, der willigen Herzens war, brachte Brandopfer.',
    ...
    30: {
        1: 'Und Jehiskia sandte hin zu ganz Israel und Juda und schrieb auch Briefe an Ephraim und Manasse, daß sie zum Hause Jehovas in Jerusalem kommen möchten, um Jehova, dem Gott Israels, Passah zu feiern.',
        2: 'Und der König und seine Obersten und die ganze Versammlung in Jerusalem wurden Rats, das Passah im zweiten Monat zu feiern.',
        ...
        5: 'Und sie setzten fest, einen Ruf ergehen zu lassen durch ganz Israel, von Beerseba bis Dan, daß sie kämen, um Jehova, dem Gott Israels, Passah zu feiern in Jerusalem; denn sie hatten es lange Zeit nicht gefeiert, wie es vorgeschrieben ist.',
        ...
        7: 'Und seid nicht wie eure Väter und wie eure Brüder, die treulos gehandelt haben gegen Jehova, den Gott ihrer Väter, so daß er sie der Verwüstung hingegeben hat, wie ihr es sehet.',
        8: 'Nun verhärtet euren Nacken nicht, wie eure Väter; gebet Jehova die Hand und kommet zu seinem Heiligtum, das er geheiligt hat auf ewig, und dienet Jehova, eurem Gott, damit die Glut seines Zornes sich von euch wende.',
        ...
        12: 'Auch über Juda kam die Hand Gottes, daß er ihnen ein einmütiges Herz gab, um das Gebot des Königs und der Obersten zu tun, nach dem Worte Jehovas.',
        ...
        18: 'Denn ein großer Teil des Volkes, viele von Ephraim und Manasse, Issaschar und Sebulon, hatten sich nicht gereinigt, sondern aßen das Passah nicht, wie es vorgeschrieben ist. Doch Jehiskia bat für sie und sprach: Jehova, der Gütige, möge einem jeden vergeben,',
        ...
        24: 'Denn Jehiskia, der König von Juda, schenkte der Versammlung 1000 Farren und 7000 Stück Kleinvieh; und die Obersten schenkten der Versammlung 1000 Farren und 10000 Stück Kleinvieh. Und die Priester hatten sich in Menge geheiligt.',
    ...
    32: {
        ...
        9: 'Nach diesem sandte Sanherib, der König von Assyrien, seine Knechte nach Jerusalem an Jehiskia, den König von Juda, und an ganz Juda, das in Jerusalem war, und ließ ihnen sagen:',
        ...
        16: 'Und noch mehr redeten seine Knechte wider Jehova Gott und wider Jehiskia, seinen Knecht.',
        ...
        28: 'und Vorratshäuser für den Ertrag an Getreide und Most und Öl, und Ställe für allerlei Vieh, und er verschaffte sich Herden für die Ställe.',
        ...
        31: 'Und so verließ ihn Gott bei den Gesandten der Fürsten von Babel, um ihn zu versuchen, damit er alles erkennte, was in seinem Herzen war.',
    ...
    33: {
        1: 'Zwölf Jahre war Manasse alt, als er König wurde, und er regierte 55 Jahre zu Jerusalem.',
        ...
        3: 'Und er baute die Höhen wieder auf, die sein Vater Jehiskia niedergerissen hatte, und errichtete den Baalim Altäre, und machte Ascheroth, und beugte sich nieder vor dem ganzen Heere des Himmels und diente ihnen.',
        4: 'Und er baute Altäre in dem Hause Jehovas, von welchem Jehova gesagt hatte: In Jerusalem soll mein Name sein ewiglich!',
        ...
        8: 'Und ich will den Fuß Israels nicht mehr aus dem Lande weichen lassen, welches ich euren Vätern bestimmt habe, wenn sie nur darauf achten, alles zu tun, was ich ihnen geboten habe, nach dem ganzen Gesetz und den Satzungen und den Rechten durch Mose.',
        9: 'Aber Manasse verleitete Juda und die Bewohner von Jerusalem, mehr Böses zu tun, als die Nationen, welche Jehova vor den Kindern Israel vertilgt hatte.',
        10: 'Und Jehova redete zu Manasse und zu seinem Volke; aber sie merkten nicht darauf.',
        11: 'Da ließ Jehova die Heerobersten des Königs von Assyrien über sie kommen; und sie nahmen Manasse gefangen und banden ihn mit ehernen Fesseln und führten ihn nach Babel.',
        12: 'Und als er bedrängt war, flehte er Jehova, seinen Gott, an und demütigte sich sehr vor dem Gott seiner Väter und betete zu ihm;',
        13: 'und er ließ sich von ihm erbitten und erhörte sein Flehen, und brachte ihn nach Jerusalem in sein Königreich zurück. Da erkannte Manasse, daß Jehova Gott ist.',
        14: 'Und hernach baute er die äußere Mauer der Stadt Davids, westlich gegen den Gihon hin, im Tale, und bis zum Eingang des Fischtores, und umgab den Ophel mit einer Mauer und machte sie sehr hoch. Und er legte Kriegsoberste in alle festen Städte in Juda.',
        15: 'Und er tat die Götter der Fremde hinweg und das Gleichnis aus dem Hause Jehovas, und alle Altäre, die er auf dem Berge des Hauses Jehovas und in Jerusalem gebaut hatte; und er warf sie hinaus außerhalb der Stadt.',
        ...
        23: 'Und er demütigte sich nicht vor Jehova, wie sein Vater Manasse sich gedemütigt hatte; sondern er, Amon, häufte die Schuld.',
        24: 'Und seine Knechte machten eine Verschwörung wider ihn und töteten ihn in seinem Hause.',
        25: 'Da erschlug das Volk des Landes alle, die sich wider den König Amon verschworen hatten; und das Volk des Landes machte Josia, seinen Sohn, zum König an seiner Statt.',
    },
    34: {
        1: 'Acht Jahre war Josia alt, als er König wurde, und er regierte 31 Jahre zu Jerusalem.',
        ...
        7: 'riß er die Altäre nieder; und die Ascherim und die geschnitzten Bilder zertrümmerte er, indem er sie zermalmte; und alle Sonnensäulen hieb er um im ganzen Lande Israel. Und er kehrte nach Jerusalem zurück.',
    ...
    35: {
        1: 'Und Josia feierte dem Jehova Passah zu Jerusalem; und man schlachtete das Passah am Vierzehnten des ersten Monats.',
        2: 'Und er stellte die Priester in ihre Ämter und ermutigte sie zum Dienst des Hauses Jehovas.',
        3: 'Und er sprach zu den Leviten, welche ganz Israel unterwiesen, die Jehova geheiligt waren: Setzet die heilige Lade in das Haus, welches Salomo, der Sohn Davids, der König von Israel, gebaut hat; ihr habt sie nicht mehr auf der Schulter zu tragen. Dienet nunmehr Jehova, eurem Gott, und seinem Volke Israel;',
        4: 'und bereitet euch nach euren Vaterhäusern, in euren Abteilungen, nach der Schrift Davids, des Königs von Israel, und nach der Schrift seines Sohnes Salomo;',
        5: 'und stellet euch im Heiligtum auf nach den Klassen der Vaterhäuser eurer Brüder, der Kinder des Volkes, und zwar je eine Abteilung eines Vaterhauses der Leviten;',
        6: 'und schlachtet das Passah, und heiliget euch und bereitet es für eure Brüder, daß ihr tuet nach dem Worte Jehovas durch Mose.',
        7: 'Und Josia schenkte den Kindern des Volkes an Kleinvieh: Lämmer und Ziegenböcklein, -alles zu den Passahopfern für alle, die sich vorfanden-30000 an der Zahl, und 3000 Rinder; das war von der Habe des Königs.',
        8: 'Und seine Obersten schenkten freiwillig für das Volk, für die Priester und für die Leviten. Hilkija und Sekarja und Jechiel, die Fürsten des Hauses Gottes, gaben den Priestern zu den Passahopfern 2600 Stück Kleinvieh und 300 Rinder.',
        9: 'Und Konanja, und Schemanja und Nethaneel, seine Brüder, und Haschabja und Jeghiel und Josabad, die Obersten der Leviten, schenkten den Leviten zu den Passahopfern 5000 Stück Kleinvieh und 500 Rinder.',
        10: 'Und der Dienst wurde eingerichtet; und die Priester standen an ihrer Stelle und die Leviten in ihren Abteilungen, nach dem Gebote des Königs.',
        11: 'Und sie schlachteten das Passah; und die Priester sprengten das Blut aus ihrer Hand, und die Leviten zogen die Haut ab.',
        12: 'Und sie taten die Brandopfer beiseite, um sie den Klassen der Vaterhäuser der Kinder des Volkes zu geben, um sie Jehova darzubringen, wie im Buche Moses geschrieben steht; und ebenso taten sie mit den Rindern.',
        ...
        18: 'Und es war kein solches Passah in Israel gefeiert worden wie dieses, seit den Tagen Samuels, des Propheten; und alle Könige von Israel hatten kein Passah gefeiert wie dasjenige, welches Josia feierte und die Priester und die Leviten und ganz Juda und Israel, das sich vorfand, und die Bewohner von Jerusalem.',
        19: 'Im achtzehnten Jahre der Regierung Josias ist dieses Passah gefeiert worden.',
        20: 'Nach allem diesem, als Josia das Haus eingerichtet hatte, zog Neko, der König von Ägypten, hinauf, um wider Karchemis am Phrat zu streiten; und Josia zog aus, ihm entgegen.',
        21: 'Da sandte er Boten zu ihm und ließ ihm sagen: Was haben wir miteinander zu schaffen, König von Juda? Nicht wider dich komme ich heute, sondern wider das Haus, mit dem ich Krieg führe; und Gott hat gesagt, daß ich eilen sollte. Stehe ab von Gott, der mit mir ist, daß er dich nicht verderbe!',
        22: 'Aber Josia wandte sein Angesicht nicht von ihm ab, sondern verkleidete sich, um wider ihn zu streiten; und er hörte nicht auf die Worte Nekos, die aus dem Munde Gottes kamen. Und er kam in das Tal Megiddo, um zu streiten.',
    ...
    36: {
        ...
        2: 'Jahre war Joahas alt, als er König wurde, und er regierte drei Monate zu Jerusalem.',
