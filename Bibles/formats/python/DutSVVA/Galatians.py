...
CHAPTERS = {
    1: {
        ...
        9: 'Gelijk wij te voren gezegd hebben, zo zeg ik ook nu wederom: Indiën u iemand een Evangelie verkondigt, buiten hetgeen gij ontvangen hebt, die zij vervloekt.',
    ...
    2: {
        ...
        14: 'Maar als ik zag, dat zij niet recht wandelden naar de waarheid van het Evangelie, zeide ik tot Petrus in aller tegenwoordigheid: Indiën gij, die een Jood zijt, naar heidense wijze leeft, en niet naar Joodse wijze, waarom noodzaakt gij de heidenen naar de Joodse wijze te leven?',
    ...
    3: {
        ...
        4: 'Hebt gij zoveel tevergeefs geleden? Indiën maar ook tevergeefs!',
    ...
    4: {
        ...
        25: 'Want dit, namelijk Agar, is Sina, een berg in Arabië, en komt overeen met Jeruzalem, dat nu is, en dienstbaar is is met haar kinderen.',
    ...
    5: {
        ...
        11: 'Maar ik, broeders! Indiën ik nog de besnijdenis predik, waarom word ik nog vervolgd? Zo is dan de ergernis des kruises vernietigd.',
        ...
        25: 'Indiën wij door den Geest leven, zo laat ons ook door den Geest wandelen.',
    ...
    6: {
        ...
        18: 'De genade van onzen Heere Jezus Christus zij met uw geest, broeders! Amen. Geschreven aan de Galaten vanuit Rome.',
    },
}
