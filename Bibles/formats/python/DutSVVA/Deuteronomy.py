...
CHAPTERS = {
    1: {
        ...
        3: 'En het is geschied in het veertigste jaar, in de elfde maand, op den eersten der maand, dat Mozes sprak tot de kinderen Israëls, naar alles wat hem de Heere aan hen bevolen had;',
        ...
        7: 'Keert u, en vertrekt, en gaat in het gebergte der Amorieten, en tot al hun geburen, in het vlakke veld, op het gebergte, en in de laagte, en in het zuiden, en aan de havens der zee; het land der Kanaänieten, en den Libanon, tot aan die grote rivier, de rivier Frath.',
    ...
    3: {
        ...
        14: 'Jaïr, de zoon van Manasse, kreeg de ganse landstreek van Argob, tot aan de landpale der Gezurieten en Maachathieten; en hij noemde ze naar zijn naam, Bazan Havvoth-jair, tot op dezen dag.',
    ...
    4: {
        ...
        3: 'Uw ogen hebben gezien, wat God om Baäl-peor gedaan heeft; want alle man, die Baäl-peor navolgde, dien heeft de Heere, uw God, uit het midden van u verdaan.',
    ...
    9: {
        ...
        20: 'Ook vertoornde Zich de Heere zeer tegen Aäron, om hem te verdelgen; doch ik bad ook ter zelver tijd voor Aäron.',
        ...
        23: 'Voorts als de Heere ulieden zond uit Kades-barnea, zeggende: Gaat op en erft dat land, dat Ik u gegeven heb; zo waart gij den mond des Heeren, uws Gods, wederspannig, en geloofdet Hem niet, en waart Zijn stem niet gehoorzaam.',
    ...
    11: {
        ...
        30: 'Zijn zij niet aan gene zijde van de Jordaan, achter den weg van den ondergang der zon, in het land der Kanaänieten, die in het vlakke veld wonen, tegenover Gilgal, bij de eikenbossen van More?',
    ...
    15: {
        ...
        5: 'Indiën gij slechts de stem des Heeren, uws Gods, vlijtiglijk zult gehoorzamen, dat gij waarneemt te doen al deze geboden, die ik u heden gebiede.',
        ...
        9: 'Wacht u, dat in uw hart geen Belialswoord zij, om te zeggen: Het zevende jaar, het jaar der vrijlating, naakt; dat uw oog boos zij tegen uw broeder, die arm is, en dat gij hem niet gevet; en hij over u roepe tot den Heere, en zonde in u zij.',
        ...
        12: 'Wanneer uw broeder, een Hebreër of een Hebreïnne, aan u verkocht zal zijn, zo zal hij u zes jaren dienen; maar in het zevende jaar zult gij hem vrij van u laten gaan.',
        ...
        19: 'Al het eerstgeborene, dat onder uw runderen en onder uw schapen zal geboren worden, zijnde een manneken, zult gij den Heere, uw God, heiligen; gij zult niet arbeiden met den eerstgeborene van uw os, noch de eerstgeborene uwer schapen scheren.',
    ...
    16: {
        ...
        3: 'Gij zult niets gedesemds op hetzelve eten; zeven dagen zult gij ongezuurde broden op hetzelve eten, een brood der ellende, (want in der haast zijt gij uit Egypteland uitgetogen); opdat gij gedenkt aan den dag van uw uittrekken uit Egypteland, al de dagen uws levens.',
    ...
    25: {
        ...
        5: 'Wanneer broeders samenwonen, en een van hen sterft, en geen zoon heeft, zo zal de vrouw des verstorvenen aan geen vreemden man daarbuiten geworden; haar mans broeder zal tot haar ingaan, en nemen haar zich ter vrouwe, en doen haar den plicht van eens mans broeder.',
        ...
        7: 'Maar indien dezen man zijns broeders vrouw niet bevallen zal te nemen, zo zal zijn broeders vrouw opgaan naar de poort tot de oudsten, en zeggen: Mijns mans broeder weigert zijn broeder een naam te verwekken in Israël; hij wil mij den plicht van eens mans broeders niet doen.',
    ...
    26: {
        ...
        12: 'Wanneer gij zult geëindigd hebben alle tienden van uw inkomen te vertienen, in het derde jaar, zijnde een jaar der tienden; dan zult gij aan den Leviet, aan den vreemdeling, aan den wees en aan de weduwe geven, dat zij in uw poorten eten en verzadigd worden.',
        ...
        15: 'Zie nederwaarts van Uw heilige woning, van den hemel, en zegen Uw volk Israël, en het land, dat Gij ons gegeven hebt, gelijk als Gij onzen vaderen gezworen hebt, een land van melk en honig vloeiende.',
    ...
    28: {
        ...
        58: 'Indiën gij niet zult waarnemen te doen al de woorden dezer wet, die in dit boek geschreven zijn, om te vrezen dezen heerlijken en vreselijken Naam, den Heere, uw God;',
    ...
    31: {
        ...
        19: 'En nu, schrijft ulieden dit lied, en leert het den kinderen Israëls; legt het in hun mond; opdat dit lied Mij ten getuige zij tegen de kinderen Israëls.',
        ...
        23: 'En Hij gebood Jozua, den zoon van Nun, en zeide: Zijt sterk en heb goeden moed, want gij zult de kinderen Israëls inbrengen in het land, dat Ik hun gezworen heb; en Ik zal met u zijn.',
    ...
    32: {
        ...
        41: 'Indiën Ik Mijn glinsterend zwaard wette, en Mijn hand ten gerichte grijpt, zo zal Ik wraak op Mijn tegenpartijen doen wederkeren, en Mijn hateren vergelden.',
        ...
        50: 'En sterf op dien berg, waarheen gij opklimmen zult, en word vergaderd tot uw volken; gelijk als uw broeder Aäron stierf op den berg Hor, en werd tot zijn volken vergaderd.',
