...
CHAPTERS = {
    1: {
        ...
        13: 'En als zij ingekomen waren, gingen zij op in de opperzaal, waar zij bleven, namelijk Petrus en Jakobus, en Johannes en Andreas, Filippus en Thomas, Bartholomeüs en Mattheus, Jakobus, de zoon van Alfeüs, en Simon Zelotes, en Judas, de broeder van Jakobus.',
    ...
    2: {
        ...
        11: 'Kretenzen en Arabiëren, wij horen hen in onze talen de grote werken Gods spreken.',
    ...
    6: {
        ...
        5: 'En dit woord behaagde aan al de menigte; en zij verkoren Stefanus, een man vol des geloofs en des Heiligen Geestes, en Filippus, en Prochorus, en Nicanor, en Timon, en Parmenas, Nicolaus, een Jodengenoot van Antiochië;',
    ...
    8: {
        ...
        14: 'Als nu de apostelen, die te Jeruzalem waren, hoorden, dat Samaria het Woord Gods aangenomen had, zonden zij, hen Petrus en Johannes;',
        ...
        18: 'En als Simon zag, dat, door oplegging van de handen der apostelen de Heilige Geest gegeven werd, zo bood hij hun geld aan,',
        ...
        37: 'En Filippus zeide: Indiën gij van ganser harte gelooft, zo is het geoorloofd. En hij, antwoordende, zeide: Ik geloof, dat Jezus Christus de Zoon van God is.',
    ...
    11: {
        ...
        17: 'Indiën dan God hun evengelijke gave gegeven heeft, als ook ons, die in de Heere Jezus Christus geloofd hebben, wie was ik toch, die God konde weren?',
        ...
        20: 'En er waren enige Cyprische en Cyreneïsche mannen uit hen, welken te Antiochië gekomen zijnde, spraken tot de Grieksen, verkondigende den Heere Jezus.',
        ...
        25: 'En Barnabas ging uit naar Tarsen, om Saulus te zoeken; en als hij hem gevonden had, bracht hij hem te Antiochië.',
        26: 'En het is geschied, dat zij een geheel jaar samen vergaderden in de Gemeente, en een grote schare leerden; en dat de discipelen eerst te Antiochië Christenen genaamd werden.',
    ...
    12: {
        ...
        11: 'En Petrus, tot zichzelven gekomen zijnde, zeide: Nu weet ik waarachtiglijk dat de Heere Zijn engel uitgezonden heeft, en mij verlost heeft uit de hand van Herodes, en uit de verwachting van het volk der Joden.',
    ...
    13: {
        ...
        15: 'En na het lezen der wet en der profeten, zonden de oversten der synagogen tot hen, zeggende: Mannen broeders, indien er enig woord van vertroosting, het volk in u is, zo spreekt.',
    ...
    14: {
        ...
        6: 'Zijn zij, alles overlegd hebbende, gevlucht naar de steden van Lykaonië, namelijk Lystre en Derbe, en het omliggende land;',
        ...
        19: 'Maar daarover kwamen Joden van Antiochië en Ikonium, en overreedden de scharen, en stenigden Paulus, en sleepten hem buiten de stad, menende, dat hij dood was.',
        ...
        26: 'En van daar scheepten zij af naar Antiochië, van waar zij der genade Gods bevolen waren geweest tot het werk, dat zij volbracht hadden.',
    ...
    15: {
        1: 'En sommigen, die afgekomen waren van Judea, leerden de broederen, zeggende: Indiën gij niet besneden wordt naar de wijze van Mozes, zo kunt gij niet zalig worden.',
    ...
    16: {
        1: 'En hij kwam te Derbe en Lystre. En ziet, aldaar was een zeker discipel, met name Timotheüs, zoon van een gelovige Joodse vrouw, maar van een Grieksen vader;',
        ...
        10: 'Als hij nu dit gezicht gezien had, zo zochten wij terstond naar Macedonië te reizen, besluitende daaruit, dat ons de Heere geroepen had, om denzelven het Evangelie te verkondigen.',
        ...
        15: 'En als zij gedoopt was, en haar huis, bad zij ons, zeggende: Indiën gij hebt geoordeeld, dat ik den Heere getrouw ben, zo komt in mijn huis, en blijft er. En zij dwong ons.',
        ...
        37: 'Maar Paulus zeide tot hen: Zij hebben ons, die Romeinen zijn, onveroordeeld in het openbaar gegeseld, en in de gevangenis geworpen, en werpen zij zij ons nu heimelijk daaruit? Niet alzo; maar dat zij zelven komen, en ons uitleiden.',
    ...
    17: {
        ...
        7: 'Welke Jason in zijn huis genomen heeft; en alle dezen doen tegen de geboden des keizers, zeggende, dat er een andere Koning is, namelijk een Jezus.',
        ...
        15: 'En die Paulus geleidden, brachten hem tot Athene toe; en als zij bevel gekregen hadden aan Silas en Timotheüs, dat zij op het spoedigste tot hem zouden komen, vertrokken zij.',
    ...
    18: {
        ...
        18: 'En als Paulus er nog vele dagen gebleven was, nam hij afscheid van de broederen, en scheepte van daar naar Syrië; en Priscilla en Aquila met hem, zijn hoofd te Kenchreen geschoren hebbende; want hij had een gelofte gedaan.',
        ...
        22: 'En als hij te Cesarea was gekomen, ging hij op naar Jeruzalem, en de Gemeente gegroet hebbende, ging hij af naar Antiochië.',
        ...
        24: 'En een zeker Jood, met name Apollos, van geboorte een Alexandriër, een welsprekend man, kwam te Efeze, machtig zijnde in de Schriften.',
    ...
    19: {
        ...
        27: 'En wij zijn niet alleen in gevaar, dat dit deel in verachting kome, maar dat ook de tempel van de grote godin Diana als niets geacht zal worden, en dat ook haar majesteit zal ten ondergaan, aan welke gans Azië en de gehele wereld godsdienst bewijst.',
        28: 'Als zij nu dit hoorden, werden zij vol van toornigheid, en riepen, zeggende: Groot is de Diana de Efezeren!',
        29: 'En de gehele stad werd vol verwarring; en zij liepen met een gedruis eendrachtelijk naar de schouwplaats, met zich trekkende Gajus en Aristarchus, Macedoniërs, metgezellen van Paulus op de reis.',
        ...
        38: 'Indiën dan nu Demetrius, en die met hem van de kunst zijn, tegen iemand enige zaak hebben, de rechtsdagen worden gehouden, en er zijn stadhouders; laat hen elkander verklagen.',
    ...
    20: {
        ...
        3: 'En als hij aldaar drie maanden overgebracht had, en hem van de Joden lagen gelegd werden, als hij naar Syrië zoude varen, zo werd hij van zin weder te keren door Macedonië.',
        4: 'En hem vergezelschapte tot in Azië Sopater van Berea; en van de Thessalonicensen Aristarchus en Sekundus; en Gajus van Derbe, en Timotheüs en van die van Azië Tychikus en Trofimus.',
        ...
        16: 'Want Paulus had voorgenomen Efeze voorbij te varen, opdat hij niet den tijd in Azië zou verslijten; want hij spoedde zich, om (zo het hem mogelijk ware) op den pinksterdag te Jeruzalem te zijn.',
    ...
    21: {
        ...
        26: 'Toen nam Paulus de mannen met zich, en den dag daaraan met hen geheiligd zijnde, ging hij in den tempel, en verkondigde, dat de dagen der heiliging vervuld waren, blijvende daar, totdat een iegelijk van hen de offerande opgeofferd was.',
        ...
        39: 'Maar Paulus zeide: Ik ben een Joods man van Tarsen, een burger van geen onvermaarde stad in Cilicië, ik bid u, laat mij toe tot het volk te spreken.',
    ...
    23: {
        ...
        7: 'En als hij dit gesproken had, ontstond er tweedracht tussen de Farizeën en de Sadduceën, en de menigte werd verdeeld.',
        8: 'Want de Sadduceën zeggen, dat er geen opstanding is, noch engel, noch geest, maar de Farizeën belijden het beide.',
        9: 'En er geschiedde een groot geroep; en de Schriftgeleerden van de zijde der Farizeën stonden op, en streden, zeggende: Wij vinden geen kwaad in dezen mens; en indien een geest tot hem gesproken heeft, of een engel, laat ons tegen God niet strijden.',
    ...
    25: {
        ...
        23: 'Des anderen daags dan, als Agrippa gekomen was en Bernice, met grote pracht, en als zij ingegaan waren in het rechthuis, met de oversten over duizend, en de mannen, die de voornaamsten der stad waren, werd Paulus op bevel van Festus voor gebracht.',
        24: 'En Festus zeide: Koning Agrippa, en gij mannen allen, die met ons tegenwoordig zijt, gij ziet dezen, van welken mij de ganse menigte der Joden heeft aangesproken, beide te Jeruzalem en hier, roepende, dat hij niet meer behoort te leven.',
    ...
    27: {
        ...
        5: 'En de zee, die langs Cilicië en Pamfylië is, doorgevaren zijnde, kwamen wij aan te Myra in Lycie.',
        ...
        27: 'Als nu de veertiende nacht gekomen was, alzo wij in de Adriatische zee zee herwaarts en derwaarts gedreven werden, omtrent het midden des nachts, vermoedden de scheepslieden, dat hun enig land naderde.',
        ...
        31: 'Zeide Paulus tot den hoofdman en tot de krijgsknechten: Indiën dezen in het schip niet blijven, gij kunt niet behouden worden.',
    ...
    28: {
        ...
        11: 'En na drie maanden voeren wij af in een schip van Alexandrië, dat in het eiland overwinterd had, hebbende tot een teken, Kastor en Pollux.',
        ...
        23: 'En als zij hem een dag gesteld hadden, kwamen er velen tot hem in zijn woonplaats; denwelken hij het Koninkrijk Gods uitlegde, en betuigde, en poogde hen te bewegen tot het geloof in Jezus, beide uit de wet van Mozes en de profeten, van des morgens vroeg tot den avond toe.',
