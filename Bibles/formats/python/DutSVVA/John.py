...
CHAPTERS = {
    1: {
        ...
        45: '[1:46] Filippus vond Nathanaël en zeide tot hem: Wij hebben Dien gevonden, van Welken Mozes in de wet geschreven heeft, en de profeten, namelijk Jezus, den zoon van Jozef, van Nazareth.',
        46: '[1:47] En Nathanaël zeide tot hem: Kan uit Nazareth iets goeds zijn? Filippus zeide tot hem: Kom en zie.',
        47: '[1:48] Jezus zag Nathanaël tot Zich komen, en zeide van hem: Zie, waarlijk een Israëliet, in welken geen bedrog is.',
        48: '[1:49] Nathanaël zeide tot Hem: Van waar kent Gij mij? Jezus antwoordde en zeide tot hem: Eer u Filippus riep, daar gij onder den vijgeboom waart, zag Ik u.',
        49: '[1:50] Nathanaël antwoordde en zeide tot Hem: Rabbi! Gij zijt de Zone Gods, Gij zijt de Koning Israëls.',
    ...
    3: {
        ...
        12: 'Indiën Ik ulieden de aardse dingen gezegd heb, en gij niet gelooft, hoe zult gij geloven, indien Ik ulieden de hemelse zou zeggen?',
    ...
    4: {
        ...
        10: 'Jezus antwoordde en zeide tot haar: Indiën gij de gave Gods kendet, en Wie Hij is, Die tot u zegt: Geef Mij te drinken, zo zoudt gij van Hem hebben begeerd, en Hij zoude u levend water gegeven hebben.',
        ...
        45: 'Als Hij dan in Galilea kwam, ontvingen Hem de Galileërs, gezien hebbende al de dingen, die Hij te Jeruzalem op het feest gedaan had; want ook zij waren tot het feest gegaan.',
    ...
    5: {
        ...
        31: 'Indiën Ik van Mijzelven getuig, Mijn getuigenis is niet waarachtig.',
    ...
    7: {
        ...
        4: 'Want niemand doet iets in het verborgen, en zoekt zelf, dat men openlijk van hem spreke. Indiën Gij deze dingen doet, zo openbaar Uzelven aan de wereld.',
        ...
        23: 'Indiën een mens de besnijdenis ontvangt op den sabbat, opdat de wet van Mozes niet gebroken worde; zijt gij toornig op Mij, dat Ik een gehelen mens gezond gemaakt heb op den sabbat?',
    ...
    8: {
        ...
        31: 'Jezus dan zeide tot de Joden, die in Hem geloofden: Indiën gijlieden in Mijn woord blijft, zo zijt gij waarlijk Mijn discipelen;',
        ...
        36: 'Indiën dan de Zoon u zal vrijgemaakt hebben, zo zult gij waarlijk vrij zijn.',
        ...
        39: 'Zij antwoordden en zeiden tot Hem: Abraham is onze vader. Jezus zeide tot hen: Indiën gij Abrahams kinderen waart, zo zoudt gij de werken van Abraham doen.',
        ...
        42: 'Jezus dan zeide tot hen: Indiën God uw Vader ware, zo zoudt gij Mij liefhebben; want Ik ben van God uitgegaan; en kom van Hem. Want Ik ben ook van Mijzelven niet gekomen, maar Hij heeft Mij gezonden.',
        ...
        54: 'Jezus antwoordde: Indiën Ik Mijzelven eer, zo is Mijn eer niets; Mijn Vader is het, Die Mij eert, Welken gij zegt, dat uw God is.',
    ...
    9: {
        ...
        33: 'Indiën Deze van God niet ware, Hij zou niets kunnen doen.',
        ...
        41: 'Jezus zeide tot hen: Indiën gij blind waart, zo zoudt gij geen zonde hebben; maar nu zegt gij: Wij zien; zo blijft dan uw zonde.',
    },
    10: {
        ...
        24: 'De Joden dan omringden Hem, en zeiden tot Hem: Hoe lang houdt Gij onze ziel op? Indiën Gij de Christus zijt, zeg het ons vrijuit.',
        ...
        35: 'Indiën de wet die goden genaamd heeft, tot welke het woord Gods geschied is, en de Schrift niet kan gebroken worden;',
        ...
        37: 'Indiën Ik niet doe de werken Mijns Vaders, zo gelooft Mij niet;',
    ...
    11: {
        1: 'En er was een zeker man krank, genaamd Lazarus, van Bethanië, uit het vlek van Maria en haar zuster Martha.',
        ...
        9: 'Jezus antwoordde: Zijn er niet twaalf uren in den dag? Indiën iemand in den dag wandelt, zo stoot hij zich niet, overmits hij het licht dezer wereld ziet;',
        ...
        48: 'Indiën wij Hem alzo laten geworden, zij zullen allen in Hem geloven, en de Romeinen zullen komen, en wegnemen beide onze plaats en volk.',
    ...
    12: {
        ...
        24: 'Voorwaar, voorwaar zeg Ik u: Indiën het tarwegraan in de aarde niet valt, en sterft, zo blijft hetzelve alleen; maar indien het sterft, zo brengt het veel vrucht voort.',
    ...
    13: {
        ...
        8: 'Petrus zeide tot Hem: Gij zult mijn voeten niet wassen in der eeuwigheid! Jezus antwoordde hem: Indiën Ik u niet wasse, gij hebt geen deel met Mij.',
        ...
        14: 'Indiën dan Ik, de Heere en de Meester, uw voeten gewassen heb, zo zijt gij ook schuldig, elkanders voeten te wassen.',
        ...
        17: 'Indiën gij deze dingen weet, zalig zijt gij, zo gij dezelve doet.',
        ...
        32: 'Indiën God in Hem verheerlijkt is, zo zal ook God Hem verheerlijken in Zichzelven, en Hij zal Hem terstond verheerlijken.',
    ...
    14: {
        ...
        7: 'Indiën gijlieden Mij gekend hadt, zo zoudt gij ook Mijn Vader gekend hebben; en van nu kent gij Hem, en hebt Hem gezien.',
        ...
        15: 'Indiën gij Mij liefhebt, zo bewaart Mijn geboden.',
        ...
        28: 'Gij hebt gehoord, dat Ik tot u gezegd heb: Ik ga heen, en kom weder tot u. Indiën gij Mij liefhadt, zo zoudt gij u verblijden, omdat Ik gezegd heb: Ik ga heen tot den Vader; want Mijn Vader is meerder dan Ik.',
    ...
    15: {
        ...
        7: 'Indiën gij in Mij blijft, en Mijn woorden in u blijven, zo wat gij wilt, zult gij begeren, en het zal u geschieden.',
        ...
        10: 'Indiën gij Mijn geboden bewaart, zo zult gij in Mijn liefde blijven; gelijkerwijs Ik de geboden Mijns Vaders bewaard heb, en blijf in Zijn liefde.',
        ...
        18: 'Indiën u de wereld haat, zo weet, dat zij Mij eer dan u gehaat heeft.',
        19: 'Indiën gij van de wereld waart, zo zou de wereld het hare liefhebben; doch omdat gij van de wereld niet zijt, maar Ik u uit de wereld heb uitverkoren, daarom haat u de wereld.',
        20: 'Gedenk des woords, dat Ik u gezegd heb: Een dienstknecht is niet meerder dan zijn heer. Indiën zij Mij vervolgd hebben, zij zullen ook u vervolgen; indien zij Mijn woord bewaard hebben, zij zullen ook het uwe bewaren.',
        21: 'Maar al deze dingen zullen zij doen om Mijns Naams wil, omdat zij Hem niet kennen, Die Mij gezonden heeft.',
        22: 'Indiën Ik niet gekomen ware, en tot hen gesproken had, zij hadden geen zonde; maar nu hebben zij geen voorwendsel voor hun zonde.',
        23: 'Die Mij haat, die haat ook Mijn Vader.',
        24: 'Indiën Ik de werken onder hen niet had gedaan, die niemand anders gedaan heeft, zij hadden geen zonde; maar nu hebben zij ze gezien, en beiden Mij en Mijn Vader gehaat.',
    ...
    18: {
        ...
        3: 'Judas dan, genomen hebbende de bende krijgsknechten en enige dienaars van de overpriesters en Farizeën, kwam aldaar met lantaarnen, en fakkelen, en wapenen.',
        ...
        8: 'Jezus antwoordde: Ik heb u gezegd, dat Ik het ben. Indiën gij dan Mij zoekt, zo laat dezen heengaan.',
        ...
        23: 'Jezus antwoordde hem: Indiën Ik kwalijk gesproken heb, betuig van het kwade; en indien wel, waarom slaat gij Mij?',
        ...
        30: 'Zij antwoordden en zeiden tot hem: Indiën Deze geen kwaaddoener ware, zo zouden wij Hem u niet overgeleverd hebben.',
        ...
        36: 'Jezus antwoordde: Mijn Koninkrijk is niet van deze wereld. Indiën Mijn Koninkrijk van deze wereld ware, zo zouden Mijn dienaren gestreden hebben, opdat Ik den Joden niet ware overgeleverd; maar nu is Mijn Koninkrijk niet van hier.',
    ...
    19: {
        ...
        12: 'Van toen af zocht Pilatus Hem los te laten; maar de Joden riepen, zeggende: Indiën gij Dezen loslaat, zo zijt gij des keizers vriend niet; een iegelijk, die zichzelven koning maakt, wederspreekt den keizer.',
        ...
        39: 'En Nicodemus kwam ook (die des nachts tot Jezus eerst gekomen was), brengende een mengsel van mirre en aloë; omtrent honderd ponden gewichts.',
    ...
    20: {
        ...
        25: 'De andere discipelen dan zeiden tot hem: Wij hebben den Heere gezien. Doch hij zeide tot hen: Indiën ik in Zijn handen niet zie het teken der nagelen, en mijn vinger steke in het teken der nagelen, en steke mijn hand in Zijn zijde, ik zal geenszins geloven.',
    ...
    21: {
        ...
        22: 'Jezus zeide tot hem: Indiën Ik wil, dat hij blijve, totdat Ik kome, wat gaat het u aan? Volg gij Mij.',
        23: 'Dit woord dan ging uit onder de broederen, dat deze discipel niet zou sterven. En Jezus had tot hem niet gezegd, dat hij niet sterven zou, maar: Indiën Ik wil, dat hij blijve, totdat Ik kome, wat gaat het u aan?',
