...
CHAPTERS = {
    ...
    3: {
        ...
        2: 'En hebben gezonden Timotheüs, onzen broeder, en Gods dienaar, en onzen medearbeider in het Evangelie van Christus, om u te versterken, en u te vermanen van uw geloof;',
        ...
        6: 'Maar als Timotheüs nu van ulieden tot ons gekomen was, en ons de goede boodschap gebracht had van uw geloof en liefde, en dat gij altijd goede gedachtenis van ons hebt, zeer begerig zijnde om ons te zien, gelijk wij ook om ulieden;',
    ...
    5: {
        ...
        28: 'De genade van onzen Heere Jezus Christus zij met ulieden. Amen. De eerste brief aan de Thessalonicenzen werd geschreven vanuit Athene.',
    },
}
