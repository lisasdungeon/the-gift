...
CHAPTERS = {
    ...
    2: {
        ...
        3: 'Indiën gij anders gesmaakt hebt, dat de Heere goedertieren is.',
    ...
    4: {
        ...
        11: 'Indiën iemand spreekt, die spreke als de woorden Gods; indien iemand dient, die diene als uit kracht, die God verleent; opdat God in allen geprezen worde door Jezus Christus, Welken toekomt de heerlijkheid en de kracht, in alle eeuwigheid. Amen.',
        ...
        14: 'Indiën gij gesmaad wordt om den Naam van Christus, zo zijt gij zalig; want de Geest der heerlijkheid, en de Geest van God rust op u. Wat hen aangaat, Hij wordt wel gelasterd, maar wat u aangaat, Hij wordt verheerlijkt.',
