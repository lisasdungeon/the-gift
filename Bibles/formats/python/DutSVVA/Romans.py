...
CHAPTERS = {
    ...
    2: {
        ...
        26: 'Indiën dan de voorhuid de rechten der wet bewaart, zal niet zijn voorhuid tot een besnijdenis gerekend worden?',
    ...
    3: {
        ...
        5: 'Indiën nu onze ongerechtigheid Gods gerechtigheid bevestigt, wat zullen wij zeggen? Is God onrechtvaardig, als Hij toorn over ons brengt? (Ik spreek naar den mens.)',
    ...
    6: {
        ...
        8: 'Indiën wij nu met Christus gestorven zijn, zo geloven wij, dat wij ook met Hem zullen leven;',
    ...
    7: {
        ...
        20: 'Indiën ik hetgene doe, dat ik niet wil, zo doe ik nu hetzelve niet meer, maar de zonde, die in mij woont.',
    ...
    9: {
        ...
        29: 'En gelijk Jesaja te voren gezegd heeft: Indiën de Heere Sebaoth ons geen zaad had overgelaten, zo waren wij als Sodom geworden, en Gomorra gelijk gemaakt geweest.',
    ...
    10: {
        ...
        19: 'Maar ik zeg: Heeft Israël het niet verstaan? Mozes zegt eerst: Ik zal ulieden tot jaloërsheid verwekken door degenen, die geen volk zijn; door een onverstandig volk zal ik u tot toorn verwekken.',
    ...
    11: {
        ...
        11: 'Zo zeg ik dan: Hebben zij gestruikeld, opdat zij vallen zouden? Dat zij verre; maar door hun val is de zaligheid den heidenen geworden, om hen tot jaloërsheid te verwekken.',
        ...
        14: 'Of ik enigszins mijn vlees tot jaloërsheid verwekken, en enigen uit hen behouden mocht.',
    ...
    12: {
        ...
        18: 'Indiën het mogelijk is, zoveel in u is, houdt vrede met alle mensen.',
        ...
        20: 'Indiën dan uw vijand hongert, zo spijzigt hem; indien hem dorst, zo geeft hem te drinken; want dat doende, zult gij kolen vuurs op zijn hoofd hopen.',
    ...
    16: {
        ...
        21: 'U groeten, Timotheüs, mijn medearbeider, en Lucius, en Jason, en Socipater, mijn bloedverwanten.',
        ...
        27: 'Den zelven alleen wijzen God zij door Jezus Christus de heerlijkheid in der eeuwigheid. Amen. De brief aan de Romeinen is geschreven van Korinthe, en gezonden door Febe, de dienares der gemeente die te Kenchreen is.',
    },
}
