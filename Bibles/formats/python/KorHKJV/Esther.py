...
CHAPTERS = {
    ...
    4: {
        ...
        11: '왕의 모든 신하들과 왕의 지방들의 백성들이 알거니와 남자와 여자를 막론하고 누구든지 부름을 받지 아니하고 안뜰에 들어가 왕에게 나아가면 왕의 법은 그를 죽이는 것 하나뿐이며 다만 왕이 그 사람에게 황금 홀(笏)을 내밀어야 그가 살리이다. 그러나 이제 내가 부름을 받지 못해 왕에게 나아가지 못한 지 이미 삼십 일이나 되었나이다, 하라.',
