...
CHAPTERS = {
    1: {
        ...
        3: '이 사람이 해마다 자기 도시에서 나와 실로에 계신 만군의 주께 올라가 경배하며 희생물을 드렸는데 엘리의 두 아들 홉니와 비느하스가 거기서 주의 제사장으로 있더라.',
        ...
        7: '그녀가 주의 집에 올라갈 때에 해마다 그가 그와 같이 하므로 브닌나가 그녀를 자극하니라. 그러므로 그녀가 울고 먹지 아니하니',
        ...
        10: '그녀가 혼이 쓰라린 가운데 주께 기도하고 심히 통곡하며',
        ...
        22: '한나는 올라가지 아니하였으니 이는 그녀가 자기 남편에게 이르되, 아이의 젖을 뗄 때까지 내가 올라가지 아니하고 그 뒤에 그를 데리고 가서 주 앞에 보이고 그가 영원토록 거기 있게 하리이다, 하였기 때문이더라.',
        23: '그녀의 남편 엘가나가 그녀에게 이르되, 당신이 보기에 좋은 대로 하여 당신이 그의 젖을 뗄 때까지 머무르라. 오직 주께서 자신의 말씀을 확증하시기 원하노라, 하매 이에 그 여인이 머무르며 자기 아들의 젖을 뗄 때까지 그에게 젖을 주니라.',
        ...
        26: '그녀가 이르되, 오 내 주여, 당신의 혼이 살아 계심을 두고 맹세하노니, 내 주여, 나는 여기에서 당신 옆에 서서 주께 기도하던 여자이니이다.',
        27: '이 아이를 위하여 내가 기도하였더니 주께서 내가 그분께 구하여 청원한 것을 내게 주셨나이다.',
        28: '그러므로 나도 그를 주께 빌려 드렸으며 그가 살아 있는 동안 그를 주께 빌려 드리리이다, 하니라. 그가 거기서 주께 경배하니라.',
    },
    2: {
        1: '한나가 기도하여 이르되, 내 마음이 주를 기뻐하며 내 뿔이 주 안에서 높여졌도다. 내가 주의 구원을 기뻐하므로 내 입이 내 원수들을 향해 크게 열렸나이다.',
        2: '주와 같이 거룩한 분이 없으니 주 외에는 다른 분이 없고 우리 하나님 같은 반석도 없나이다.',
        3: '다시는 그토록 심히 교만하게 말하지 말며 오만한 말을 너희 입에서 내지 말지어다. 주께서는 지식의 하나님이시므로 친히 사람의 행동을 달아 보시는도다.',
        ...
        8: '그분께서 가난한 자를 먼지에서 일으키시며 거지를 거름더미에서 들어 올리사 통치자들 가운데 앉게 하시고 또 그들이 영광의 왕좌를 상속받게 하시나니 이는 땅의 기둥들이 주의 것이요, 또 그분께서 그것들 위에 세상을 세우셨기 때문이라.',
        ...
        14: '납작한 냄비나 솥이나 가마솥이나 깊은 냄비에 그것을 찔렀으며 그 갈고리로 끄집어내는 모든 것은 제사장이 자기를 위해 취하였더라. 그들이 실로에서 거기에 온 모든 이스라엘 사람에게 이와 같이 행하였더라.',
        15: '또한 그들이 기름을 태우기 전에 제사장의 종이 와서 희생물을 드린 사람에게 말하기를, 제사장을 위해 구울 고기를 내라. 그가 네게서 삶은 고기가 아니라 날고기를 받으려 하노라, 하다가',
        ...
        19: '또한 그의 어머니가 해마다 드리는 희생물을 드리러 자기 남편과 함께 올라갈 때에 그를 위해 작은 겉옷을 만들어 매년 그에게 가져다주었더라.',
        20: '¶엘리가 엘가나와 그의 아내를 축복하여 이르되, 주께서 이 여인으로부터 네게 씨를 주사 주께 빌려 드린 것을 대신하게 하시기를 원하노라, 하였더라. 그들이 자기들의 집으로 돌아가매',
        21: '주께서 한나를 돌아보셨으므로 그녀가 수태하여 세 아들과 두 딸을 낳았더라. 아이 사무엘은 주 앞에서 자랐더라.',
        22: '¶이제 엘리는 매우 늙었더라. 그가 자기 아들들이 온 이스라엘에게 행한 모든 일과 그들이 회중의 성막 문에 모인 여인들과 함께 누운 것을 듣고',
        23: '그들에게 이르되, 너희가 어찌하여 이런 일들을 행하느냐? 내가 너희의 악한 행동을 이 온 백성으로부터 듣느니라.',
        24: '아니라. 내 아들들아, 내가 듣는 소문이 좋지 아니하니 너희가 주의 백성으로 하여금 범법하게 하는도다.',
        ...
        26: '아이 사무엘은 점점 자라면서 주와 사람들에게 호의를 입었더라.',
        27: '¶하나님의 사람이 엘리에게 나아와 그에게 이르되, 주가 이같이 말하노라. 네 조상의 집이 이집트에서 파라오의 집에 있었을 때에 내가 그들에게 분명하게 나타났느냐?',
        ...
        29: '너희가 어찌하여 내가 내 처소에서 명령한 내 희생물과 내 헌물을 발로 차며 네 아들들을 나보다 더 존중히 여겨 내 백성 이스라엘이 드리는 모든 헌물 중에서 가장 좋은 것으로 너희 자신을 살지게 하느냐?',
        ...
        32: '하나님이 이스라엘에게 모든 복을 베푸는 가운데 너는 내 처소에서 원수를 볼 것이요, 네 집에 영원토록 노인이 하나도 없으리라.',
        33: '또 내 제단으로부터 내가 끊어 버리지 아니할 네 사람이 네 눈을 쇠약하게 하고 네 마음을 슬프게 할 것이요, 네 집에서 출산하는 모든 자가 꽃다운 나이에 죽으리라.',
        34: '네 두 아들 홉니와 비느하스에게 닥칠 이 일이 네게 표적이 되리니 그들이 둘 다 한 날에 죽으리라.',
        35: '내가 나를 위하여 신실한 제사장을 일으키리니 그는 내 마음과 내 생각에 있는 그대로 행하리라. 내가 그를 위하여 든든한 집을 세우리니 그가 나의 기름 부음 받은 자 앞에서 영원히 걸으리라.',
        36: '네 집에 남은 모든 사람이 와서 은 한 조각과 빵 한 조각을 위하여 그에게 엎드려 이르되, 원하노니 내게 제사장의 직무 중 하나를 맡기사 내가 빵 한 조각을 먹게 하소서, 하리라, 하니라.',
    },
    3: {
        1: '아이 사무엘이 엘리 앞에서 주를 섬겼는데 그때에는 주의 말씀이 희귀하여 열린 환상이 전혀 없었더라.',
        ...
        5: '엘리에게 달려가서 이르되, 당신이 나를 부르셨으므로 내가 여기 있나이다, 하매 그가 이르되, 나는 부르지 아니하였으니 다시 누우라, 하매 그가 가서 누우니라.',
        6: '주께서 여전히 다시, 사무엘아, 하고 부르시니 사무엘이 일어나 엘리에게 가서 이르되, 당신이 나를 부르셨으므로 내가 여기 있나이다, 하거늘 그가 응답하되, 내 아들아, 나는 부르지 아니하였으니 다시 누우라, 하니라.',
        7: '이제 사무엘은 아직 주를 알지 못하였고 주의 말씀도 아직 그에게 계시되지 아니하였더라.',
        8: '주께서 다시 세 번째 사무엘을 부르시니 그가 일어나 엘리에게 가서 이르되, 당신이 나를 부르셨으므로 내가 여기 있나이다, 하매 엘리가 주께서 그 아이를 부르신 줄을 깨닫고',
        9: '그러므로 사무엘에게 이르되, 가서 누웠다가 그분께서 너를 부르시거든 너는 말하기를, 주여, 말씀하옵소서. 주의 종이 듣나이다, 하라, 하니 이에 사무엘이 가서 자기 처소에 누우니라.',
        10: '주께서 오셔서 서시고 다른 때와 같이, 사무엘아, 사무엘아, 하고 부르시니 그때에 사무엘이 응답하되, 말씀하옵소서. 주의 종이 듣나이다, 하더라.',
        11: '¶주께서 사무엘에게 이르시되, 보라, 내가 이스라엘에서 한 일을 행하리니 그것을 듣는 모든 자의 두 귀가 그것으로 인해 울리리라.',
        12: '그 날에 내가 엘리의 집에 관하여 말한 모든 것을 그에게 행하리라. 내가 시작하면 또한 끝을 내리라.',
        ...
        17: '그가 이르되, 주께서 네게 말씀하신 것이 무엇이냐? 원하건대 그것을 내게 숨기지 말라. 네가 만일 그분께서 네게 말씀하신 모든 것 중에서 하나라도 내게 숨기면 하나님께서 네게 벌을 내리시고 더 내리시기를 원하노라, 하니',
        18: '사무엘이 모든 것을 그에게 말하고 아무것도 그에게 숨기지 아니하매 그가 이르되, 그분은 주시니 그분께서 선하게 여기는 것을 행하실 것이니라, 하니라.',
    ...
    4: {
        ...
        2: '블레셋 사람들이 이스라엘을 치려고 전열을 갖추니라. 그들이 함께 싸우다가 이스라엘이 블레셋 사람들 앞에서 패하니 그들이 들에 있던 군대 중에서 사천 명가량을 죽이니라.',
        ...
        7: '블레셋 사람들이 두려워하여 이르기를, 하나님이 진영에 이르렀도다, 하고 또 그들이 이르기를, 우리에게 화가 있으리로다! 지금까지 그런 일이 없었도다.',
        ...
        10: '¶블레셋 사람들이 싸우매 이스라엘이 패하여 그들이 각각 자기 장막으로 도망하였고 거기에 심히 큰 살육이 있었으니 거기서 이스라엘의 보병 삼만 명이 쓰러졌더라.',
        11: '또 하나님의 궤는 빼앗겼고 엘리의 두 아들 홉니와 비느하스는 죽임을 당하였더라.',
        12: '¶바로 그 날에 어떤 베냐민 사람이 군대에서 달려 나와 자기 옷을 찢고 자기 머리에 흙을 뿌린 채 실로에 이르니라.',
        13: '그가 이를 때에, 보라, 엘리가 길옆에 있던 자기 의자에 앉아 기다렸으니 이는 그의 마음이 하나님의 궤로 인하여 떨렸기 때문이라. 그 사람이 도시에 들어와 그 일을 고하매 온 도시가 부르짖으므로',
        14: '엘리가 그 부르짖는 소리를 듣고 이르되, 이 소동하는 소리는 무엇을 뜻하느냐? 하니 그 사람이 속히 와서 엘리에게 고하니라.',
        ...
        21: '말하기를, 영광이 이스라엘에서 떠났다, 하며 그 아이의 이름을 이가봇이라 하였으니 이는 하나님의 궤를 빼앗겼고 또 자기 시아버지와 남편이 죽었기 때문이더라.',
    ...
    5: {
        ...
        3: '¶아스돗 사람들이 다음 날 일찍 일어났는데, 보라, 다곤이 주의 궤 앞에서 얼굴을 땅에 댄 채 쓰러졌으므로 그들이 다곤을 취해 다시 그것의 자리에 두었더라.',
        ...
        6: '그러나 주의 손이 아스돗 사람들에게 엄중하게 임하고 그분께서 그들을 멸하시며 종기로 그들 곧 아스돗과 그것의 지경을 치시매',
        7: '아스돗 사람들이 그리된 것을 보고 이르되, 이스라엘의 하나님의 궤가 우리와 함께 거하지 못할지니 그의 손이 우리와 우리의 신 다곤 위에 심하게 임하는도다, 하니라.',
        8: '그러므로 그들이 사람을 보내어 블레셋 사람들의 모든 귀족을 모으고 이르되, 우리가 이스라엘의 하나님의 궤를 어떻게 처리하랴? 한즉 그들이 대답하되, 이스라엘의 하나님의 궤를 가드로 옮겨가라, 하므로 그들이 이스라엘의 하나님의 궤를 거기로 옮겨갔더니',
        9: '그들이 그 궤를 옮겨간 뒤에 주의 손이 매우 큰 파멸과 함께 그 도시를 치니라. 그분께서 작은 자든 큰 자든 그 도시 사람들을 치시므로 그들의 은밀한 부위에 종기가 나니라.',
        10: '¶그러므로 그들이 하나님의 궤를 에그론으로 보내니라. 하나님의 궤가 에그론에 이른즉 에그론 사람들이 부르짖어 이르되, 그들이 이스라엘의 하나님의 궤를 우리에게로 가져다가 우리와 우리 백성을 죽이려 한다, 하고',
        11: '이에 사람을 보내어 블레셋 사람들의 모든 귀족을 함께 모으고 이르되, 이스라엘의 하나님의 궤를 보내어 그것이 그것의 본래 처소로 다시 가게 하고 그리하여 우리와 우리 백성을 죽이지 못하게 하자, 하니 이는 온 도시에 두루 치명적인 파멸이 있었으며 거기서 하나님의 손이 심히 엄중하였기 때문이더라.',
        12: '그분께서 죽지 아니한 사람들을 종기로 치시매 그 도시의 부르짖음이 하늘에까지 이르렀더라.',
    },
    6: {
        1: '주의 궤가 블레셋 사람들의 지방에 일곱 달 동안 머무니라.',
        2: '블레셋 사람들이 제사장들과 점쟁이들을 불러서 이르되, 우리가 주의 궤를 어떻게 처리하랴? 우리가 무엇으로 그것을 그것의 처소로 보낼지 우리에게 고하라, 하매',
        3: '그들이 이르되, 너희가 이스라엘의 하나님의 궤를 보내려거든 빈 채로 보내지 말고 반드시 그분께 범법 헌물을 돌려드리라. 그리하면 너희가 병도 낫고 그분의 손이 너희에게서 떠나지 아니한 이유를 알게 되리라, 하매',
        4: '그때에 그들이 이르되, 우리가 무엇을 범법 헌물로 그분께 돌려드리랴? 하니 그들이 대답하되, 블레셋 사람들의 귀족들의 수대로 금 종기 다섯 개와 금 쥐 다섯 마리라야 하리라. 너희 모두와 너희 귀족들 위에 한 재앙이 내렸느니라.',
        5: '그러므로 너희는 너희 종기의 형상들과 땅을 망치는 너희 쥐들의 형상들을 만들고 이스라엘의 하나님께 영광을 돌리라. 혹시 그분께서 너희와 너희 신들과 너희 땅에서 떠나 자신의 손을 가볍게 하실까 하노라.',
        6: '그런즉 이집트 사람들과 파라오가 자기들의 마음을 강퍅하게 한 것 같이 어찌하여 너희가 너희 마음을 강퍅하게 하느냐? 그분께서 그들 가운데서 놀랍게 행하셨을 때에 그들이 백성을 가게 하므로 그들이 떠나지 아니하였느냐?',
        7: '그러므로 이제 새 수레를 만들고 멍에를 멘 적이 없는 젖내는 암소 두 마리를 끌어다가 수레에 묶고 그것들의 송아지들은 암소들로부터 떼 내어 집으로 보내라.',
        8: '또 주의 궤를 가져다가 수레에 싣고 너희가 범법 헌물로 그분께 돌려드리는 금 보물은 상자에 담아 궤 옆에 두고 그 궤를 보내어 가게 하고',
        9: '볼지니 만일 그 궤가 자기의 본래 지경의 길로 올라가서 벧세메스로 가면 그분께서 이 큰 재앙을 우리에게 내리셨느니라. 그러나 만일 그렇지 아니하면 우리를 친 것이 그분의 손이 아니며 그것이 우리에게 우연히 일어난 일임을 우리가 알리라, 하니라.',
        10: '¶그 사람들이 그와 같이 하여 젖내는 암소 두 마리를 끌어다가 수레에 묶고 그것들의 송아지들은 집에 가두고',
        11: '주의 궤와 금 쥐들과 자기들의 종기들의 형상들을 담은 상자를 수레 위에 실으매',
        12: '암소들이 벧세메스 길로 향하는 곧은길을 택하여 큰길을 따라 가더라. 그것들이 갈 때에 울면서 가고 오른쪽으로나 왼쪽으로나 치우치지 아니하였으며 블레셋 사람들의 귀족들은 그것들을 따라 벧세메스의 경계까지 가니라.',
        13: '벧세메스 사람들이 골짜기에서 밀을 수확하다가 눈을 들어 궤를 보고 그것을 보므로 기뻐하더라.',
        14: '수레가 벧세메스 사람 여호수아의 밭에 이르러 거기 섰는데 거기에 큰 돌이 있더라. 그들이 수레의 나무를 쪼개고 그 암소들을 번제 헌물로 주께 드리며',
        15: '레위 사람들은 주의 궤와 그 궤와 함께 있던 금 보물이 담긴 상자를 내려다가 그 큰 돌 위에 두매 바로 그 날에 벧세메스 사람들이 주께 번제 헌물을 드리고 희생물들을 희생시켜 드리니라.',
        16: '블레셋 사람들의 다섯 귀족이 그것을 보고 바로 그 날에 에그론으로 돌아갔더라.',
        17: '블레셋 사람들이 주께 범법 헌물로 돌려드린 금 종기들은 이러하니 곧 아스돗을 위하여 하나요, 가자를 위하여 하나요, 아스글론을 위하여 하나요, 가드를 위하여 하나요, 에그론을 위하여 하나이며',
        18: '금 쥐들은 성벽을 두른 도시들과 시골 마을들 곧 그 다섯 귀족에게 속한 블레셋 사람들의 모든 도시 즉 그들이 주의 궤를 올려놓은 아벨의 큰 돌에 이르기까지의 도시들 수와 같았더라. 그 돌이 벧세메스 사람 여호수아의 밭에 이 날까지 남아 있느니라.',
        19: '¶벧세메스 사람들이 주의 궤를 들여다보았으므로 그분께서 그들을 치시되 곧 그분께서 백성 중에서 오만 칠십 명을 치시니라. 주께서 백성 중에서 많은 사람을 쳐서 크게 살육하셨으므로 백성이 애곡하였더라.',
        20: '벧세메스 사람들이 이르되, 이 거룩하신 주 하나님 앞에 누가 능히 서리요? 그분께서 우리를 떠나 누구에게로 가실까? 하더라.',
        21: '¶그들이 사자들을 기럇여아림 거주민들에게로 보내어 이르되, 블레셋 사람들이 주의 궤를 도로 가져왔으니 너희는 내려와서 그것을 너희에게로 가져가라, 하니라.',
    },
    7: {
        1: '기럇여아림 사람들이 와서 주의 궤를 가져다가 산에 있던 아비나답의 집에 들여 놓고 그의 아들 엘르아살을 거룩히 구별하여 주의 궤를 지키게 하였더라.',
        2: '그 궤가 기럇여아림에 거하되 그 기간이 길어 이십 년이 되었으므로 이스라엘의 온 집이 주를 구하며 애곡하니라.',
        3: '¶사무엘이 이스라엘의 온 집에게 말하여 이르되, 너희가 마음을 다해 주께 돌아오려거든 이방 신들과 아스다롯을 너희 가운데서 제거하고 너희 마음을 예비하여 주께로 향하게 하며 그분만 섬기라. 그분께서 너희를 블레셋 사람들의 손에서 건져 내시리라, 하니',
        ...
        7: '이스라엘 자손이 미스바에 함께 모였다는 것을 블레셋 사람들이 듣고 블레셋 사람들의 귀족들이 이스라엘을 치러 올라오므로 이스라엘 자손이 그것을 듣고 블레셋 사람들을 두려워하여',
        ...
        17: '라마로 돌아왔더라. 그의 집은 거기 있더라. 그가 거기서 이스라엘을 재판하였고 또 거기서 주께 제단을 쌓았더라.',
    },
    8: {
        1: '사무엘이 늙어서 자기 아들들을 이스라엘의 재판관으로 삼았는데',
        2: '이제 그의 맏아들의 이름은 요엘이요, 둘째 아들의 이름은 아비야더라. 그들이 브엘세바에서 재판관이 되니라.',
        3: '그의 아들들이 그의 길들로 걷지 아니하고 옆으로 돌이켜 이익을 추구하며 뇌물을 취하고 재판을 굽게 하니라.',
        4: '이에 이스라엘의 모든 장로들이 함께 모여 라마에 있던 사무엘에게 가서',
        5: '그에게 이르되, 보소서, 당신은 늙었고 당신의 아들들은 당신의 길들로 걷지 아니하니 모든 민족들과 같이 이제 우리에게 왕을 세워 우리를 재판하게 하소서, 하니라.',
        6: '¶그러나 그들이 이르기를, 우리에게 왕을 주어 우리를 재판하게 하소서, 하였을 때에 그 일을 사무엘이 기뻐하지 아니하여 주께 기도하매',
        7: '주께서 사무엘에게 이르시되, 백성이 네게 말하는 모든 것에서 그들의 음성에 귀를 기울이라. 그들이 너를 버리지 아니하고 나를 버려서 내가 자기들을 통치하지 못하게 하려 하였느니라.',
        8: '내가 그들을 이집트에서 데리고 올라온 날부터 이 날까지 그들이 행한 모든 행위에 따라 그들이 그런 일들로 나를 저버리고 다른 신들을 섬긴 것 같이 네게도 그리하는도다.',
        9: '그러므로 이제 그들의 음성에 귀를 기울이되 그들에게 엄숙하게 단언하고 그들을 통치할 왕에 관한 규범을 그들에게 보이라, 하시니라.',
        ...
        14: '또 그가 너희 밭과 포도원과 올리브 밭을 취하되 그중에 가장 좋은 것을 취하여 자기 신하들에게 주며',
        15: '또 너희 씨와 포도원의 십분의 일을 취하여 자기의 직무 수행자들과 신하들에게 주고',
        16: '또 너희 남종과 여종과 가장 아름다운 청년과 나귀들을 취하여 자기 일을 하게 하며',
        17: '너희 양의 십분의 일을 취하리니 너희가 그의 종이 되리라.',
        18: '그 날에 너희가 너희를 위해 택할 너희 왕으로 인하여 너희가 부르짖을 터이나 주께서 그 날에 너희 말을 듣지 아니하시리라, 하니라.',
    ...
    9: {
        1: '이제 기스라는 이름의 베냐민 사람이 있었는데 그는 아비엘의 아들이요, 스롤의 손자요, 베고랏의 증손이요, 아비아의 사대 손으로 베냐민 족속이며 능력 있고 강력한 자더라.',
        2: '그에게 사울이라는 이름의 아들이 있었는데 그는 준수한 젊은이로 잘생겼더라. 이스라엘 자손 가운데 그보다 더 잘생긴 자가 없었고 또 그는 백성 중의 어떤 사람보다 자기 어깨로부터 위만큼 키가 더 크더라.',
        ...
        6: '그가 그에게 이르되, 이제 보소서, 이 도시에 하나님의 사람이 있는데 그는 존귀한 사람이니이다. 그가 말하는 모든 것은 반드시 이루어지니 이제 우리가 거기로 가사이다. 혹시 그가 우리가 가야 할 우리의 길을 보여 줄까 하나이다, 하므로',
        7: '그때에 사울이 자기 종에게 이르되, 그러나, 보라, 우리가 가면 그 사람에게 무엇을 가져가겠느냐? 우리 그릇에 있는 빵을 다 썼으니 하나님의 사람에게 가져갈 예물이 없도다. 우리에게 무엇이 있느냐? 하매',
        8: '그 종이 사울에게 다시 대답하여 이르되, 보소서, 내게 여기 은 일 세겔의 사분의 일이 손에 있으니 내가 그것을 하나님의 사람에게 드리고 우리의 길을 우리에게 알려 달라 하겠나이다, 하니라.',
        ...
        12: '그들이 그들에게 대답하여 이르되, 있나이다. 보소서, 그가 당신들보다 앞섰으니 이제 서두르소서. 오늘 산당에서 백성이 희생물을 드리므로 그가 오늘 도시에 왔나이다.',
        13: '당신들이 도시로 들어가면 그가 먹으러 산당에 올라가기 전에 즉시 그를 만나리이다. 그가 오기 전에는 백성이 먹지 아니하리니 그가 희생물을 축복하므로 그 뒤에야 초청 받은 자들이 먹나이다. 그러므로 당신들은 지금 올라가소서. 이때쯤 당신들이 그를 만나리이다, 하니라.',
        ...
        17: '사무엘이 사울을 볼 때에 주께서 그에게 이르시되, 내가 네게 말한 사람을 보라! 바로 이 사람이 내 백성을 통치하리라, 하시니라.',
        18: '그때에 사울이 성문에서 사무엘에게 가까이 가서 이르되, 원하건대 선견자의 집이 어디인지 내게 말해 주소서, 하니',
        19: '사무엘이 사울에게 응답하여 이르되, 내가 선견자니라. 나보다 앞서 산당으로 올라가라. 너희가 오늘 나와 함께 먹을 것이요, 내일 내가 너를 가게 하고 또 네 마음속에 있는 모든 것을 네게 말하리라.',
        20: '사흘 전에 잃은 네 나귀들에 관하여는 네 생각을 그것들에 두지 말라. 그것들을 찾았느니라. 이스라엘의 모든 열망이 누구에게 있느냐? 너와 네 아버지의 온 집에게 있지 아니하냐? 하니',
        21: '사울이 대답하여 이르되, 나는 이스라엘 지파 중에서 가장 작은 지파 출신으로 베냐민 족속이 아니니이까? 또한 내 가족은 베냐민 지파의 모든 가족들 중에서 가장 작지 아니하니이까? 그런데 당신이 어찌하여 내게 이같이 말씀하시나이까? 하니라.',
        ...
        27: '그들이 도시 끝으로 내려갈 때에 사무엘이 사울에게 이르기를, 종에게 명령하여 우리보다 앞서 가게 하되 (그가 앞서 가더라.) 너는 잠깐 서 있으라. 내가 하나님의 말씀을 네게 알려 주리라, 하니라.',
    },
    10: {
        1: '그때에 사무엘이 기름 한 병을 취하여 그의 머리에 붓고 그에게 입을 맞추며 이르되, 그것은 주께서 네게 기름을 부으사 자신의 상속 백성을 다스릴 대장으로 삼으셨기 때문이 아니냐?',
        ...
        4: '그들이 네게 문안하고 빵 두 개를 네게 주겠고 너는 그들의 손에서 그것을 받으리라.',
        ...
        12: '같은 장소의 한 사람은 대답하여 이르되, 그런데 그들의 아버지가 누구냐? 하니라. 그러므로 그것이 속담이 되어, 사울도 대언자들 가운데 있느냐? 하였더라.',
        ...
        23: '그들이 달려가 거기서 그를 데려오매 그가 백성 가운데 서니 그는 백성 중의 어떤 사람보다 자기 어깨로부터 위만큼 키가 더 크더라.',
        24: '사무엘이 온 백성에게 이르되, 너희가 주께서 택하신 자를 보느냐? 온 백성 가운데 그와 같은 자가 없느니라, 하니 온 백성이 외치며 이르되, 국왕 폐하 만세, 하니라.',
        25: '이에 사무엘이 왕국의 규범을 백성에게 말하고 책에 그것을 기록하여 주 앞에 두고 온 백성을 각각 자기 집으로 보내니라.',
    ...
    11: {
        ...
        3: '야베스의 장로들이 그에게 이르되, 우리에게 이레 동안의 유예 기간을 주어 우리가 이스라엘 온 지역에 사자들을 보내게 하라. 우리를 구원할 사람이 없으면 우리가 네게로 나가리라, 하니라.',
        4: '¶이에 사자들이 사울의 기브아에 이르러 그 소식을 백성의 귀에 고하매 온 백성이 소리 높여 울더라.',
        5: '보라, 마침 사울이 밭에서 소 떼를 따라 오다가 말하되, 무엇이 백성을 괴롭게 하기에 그들이 우느냐? 하매 그들이 야베스 사람들의 소식을 그에게 고하니라.',
        ...
        10: '그러므로 야베스 사람들이 이르되, 우리가 내일 너희에게로 나가리니 너희는 너희에게 좋게 보이는 모든 것을 우리에게 행하라, 하니라.',
        11: '이처럼 다음 날 사울이 백성을 세 무리로 나누었더니 그들이 새벽 경점에 그 군대의 한가운데로 들어가 날이 뜨거울 때까지 암몬 족속을 죽이매 남은 자들이 흩어져서 그들 중 두 사람이 함께 남지 아니하였더라.',
        ...
        14: '그때에 사무엘이 백성에게 이르되, 오라, 우리가 길갈로 가서 거기서 왕국을 새롭게 하자, 하니',
    ...
    12: {
        ...
        10: '그들이 주께 부르짖어 이르되, 우리가 주를 버리고 바알들과 아스다롯을 섬겼으므로 죄를 지었나이다. 하오나 이제 우리를 우리 원수들의 손에서 건져 내소서. 그리하시면 우리가 주를 섬기겠나이다, 하매',
        11: '주께서 여룹바알과 베단과 입다와 사무엘을 보내사 너희를 사방에 있던 너희 원수들의 손에서 건져 내셨으므로 너희가 안전히 거하였느니라.',
        12: '암몬 자손의 왕 나하스가 너희를 치러 온 것을 너희가 보고는 주 너희 하나님께서 너희 왕이심에도 불구하고 너희가 내게 말하기를, 아니니이다. 오직 왕이 우리를 통치하여야 하리이다, 하였도다.',
        13: '그러므로 이제 너희가 택하고 너희가 바라던 왕을 보라! 보라, 주께서 너희를 다스릴 왕을 세우셨느니라.',
        14: '너희가 만일 주를 두려워하여 그분을 섬기며 그분의 음성에 순종하고 주의 명령을 거역하지 아니하려면 너희와 또 너희를 통치하는 왕이 다 주 너희 하나님을 계속해서 따라야 하리라.',
        15: '그러나 너희가 만일 주의 음성에 순종하지 아니하고 주의 명령을 거역하면 주의 손이 너희 조상들을 대적한 것 같이 너희를 대적하리라.',
        16: '¶그러므로 이제 서서 주께서 너희 눈앞에서 행하실 이 큰일을 보라.',
        ...
        20: '¶사무엘이 백성에게 이르되, 두려워하지 말라. 너희가 이 모든 사악한 일을 행하였으나 주를 따르는 데서 돌이키지 말고 오직 너희 마음을 다하여 주를 섬기라.',
        ...
        23: '또한 나로 말하건대 너희를 위하여 기도하기를 쉼으로 내가 결단코 주께 죄를 짓지 아니하고 선하고 바른 길을 너희에게 가르칠 터인즉',
    ...
    13: {
        1: '사울이 일 년을 통치하니라. 그가 이 년 동안 이스라엘을 통치한 뒤에',
        2: '이스라엘 사람 삼천 명을 택하였는데 그중의 이천 명은 사울과 함께 믹마스와 벧엘 산에 있었고 천 명은 요나단과 함께 베냐민의 기브아에 있었더라. 그가 백성의 남은 자들은 각각 각 사람의 장막으로 보내니라.',
        ...
        5: '¶블레셋 사람들이 이스라엘과 싸우려고 함께 모였는데 병거가 삼만 대요, 기병이 육천 명이요, 백성이 해변의 모래같이 많았더라. 그들이 올라와 벧아웬에서 동쪽으로 믹마스에 진을 치매',
        6: '이스라엘 사람들이 자기들이 위험에 빠진 것을 보고 백성이 굴과 덤불과 바위와 높은 곳과 구덩이에 숨으니라. (백성이 곤란을 당하였더라.)',
        7: '어떤 히브리 사람들은 요르단을 건너서 갓과 길르앗 땅으로 갔으나 사울로 말하건대 그는 아직 길갈에 있었고 온 백성은 떨면서 그를 따르더라.',
        8: '¶그가 사무엘이 정해 준 정한 시기에 따라 이레 동안을 기다렸으나 사무엘이 길갈로 오지 아니하매 백성이 자기를 떠나 흩어지므로',
        9: '사울이 이르되, 번제 헌물과 화평 헌물을 이리로 내게로 가져오라, 하고 그가 번제 헌물을 드렸더라.',
        10: '그가 번제 헌물 드리기를 마치매, 보라, 즉시 사무엘이 오므로 사울이 나가서 그를 맞으며 그에게 문안하니라.',
        11: '¶사무엘이 이르되, 왕이 도대체 무엇을 행하였나이까? 하니 사울이 이르되, 백성이 나를 떠나 흩어지고 당신은 정한 날 안에 오지 아니하며 블레셋 사람들은 믹마스에 함께 모였음을 내가 보았으므로',
        12: '내가 말하기를, 이제 블레셋 사람들이 나를 덮치러 길갈로 내려오겠거늘 내가 주께 간구하지 못하였다, 하고 그런 까닭에 내가 스스로 어쩔 수 없이 번제 헌물을 드렸나이다, 하니',
        ...
        15: '사무엘이 일어나 길갈에서 떠나 베냐민의 기브아로 올라가니라. 사울이 자기와 함께 있던 백성의 수를 세니 육백 명가량이더라.',
        16: '사울과 그의 아들 요나단과 그들과 함께 있던 백성은 베냐민의 기브아에 머물렀으나 블레셋 사람들은 믹마스에 진을 쳤더라.',
        17: '¶노략하는 자들이 블레셋 사람들의 진영에서 세 무리로 나와 한 무리는 오브라로 가는 길 쪽으로 돌아서서 수알 땅에 이르렀고',
        18: '다른 무리는 길을 돌아서 벧호론으로 향하였으며 다른 무리는 광야 쪽의 스보임 골짜기를 바라보는 경계의 길로 돌아섰더라.',
        19: '¶이제 이스라엘 온 땅에는 대장장이가 없었으니 이는 블레셋 사람들이 말하기를, 히브리 사람들이 자기들을 위해 칼이나 창을 만들까 두렵다, 하였기 때문이라.',
        20: '다만 모든 이스라엘 사람은 각각 자기의 보습이나 날이나 도끼나 곡괭이를 벼리려면 블레셋 사람들에게로 내려갔더라.',
        ...
        23: '블레셋 사람들의 수비대가 나와서 믹마스 통로에 이르렀더라.',
    },
    14: {
        1: '이제 하루는 사울의 아들 요나단이 자기의 병기를 든 청년에게 이르되, 오라, 우리가 저편에 있는 블레셋 사람들의 수비대에게로 건너가자, 하였으나 자기 아버지에게는 고하지 아니하였더라.',
        2: '사울은 기브아의 맨 끝 지역에서 미그론에 있는 석류나무 밑에 머물렀고 그와 함께한 백성은 육백 명가량이더라.',
        3: '아히야는 에봇을 입고 있었는데 그는 이가봇의 형제인 아히둡의 아들이요, 비느하스의 손자요, 실로에 있던 주의 제사장 엘리의 증손이더라. 백성은 요나단이 간 줄을 알지 못하였더라.',
        4: '¶요나단이 통로들을 통해 블레셋 사람들의 수비대에게로 건너가려 하였더라. 그 통로들 사이에는 이쪽에도 날카로운 바위가 있었고 저쪽에도 날카로운 바위가 있었는데 하나의 이름은 보세스요, 다른 것의 이름은 세네더라.',
        5: '한 바위의 맨 앞은 믹마스를 마주보며 북쪽으로 놓이고 다른 하나는 기브아를 마주보며 남쪽으로 놓였으므로',
        6: '요나단이 자기의 병기를 든 청년에게 이르되, 오라, 우리가 이 할례 받지 않은 자들의 수비대에게로 건너가자. 혹시 주께서 우리를 위하여 일하시리로다. 많은 사람으로 구원하시든지 혹은 적은 사람으로 하시든지 주께는 제약이 없느니라, 하니',
        7: '그의 병기 드는 자가 그에게 이르되, 당신의 마음속에 있는 모든 것을 행하시오며 몸을 돌이키소서. 보소서, 당신의 마음에 따라 내가 당신과 함께하나이다, 하니라.',
        ...
        12: '그 수비대 사람들이 요나단과 그의 병기 드는 자에게 응답하여 이르되, 우리에게로 올라오라. 우리가 너희에게 한 가지 일을 보이리라, 하니라. 요나단이 자기의 병기를 드는 자에게 이르되, 나를 따라 올라오라. 주께서 그들을 이스라엘의 손에 넘겨주셨느니라, 하고는',
        13: '요나단이 손과 발로 기어 올라갔고 그의 병기 드는 자도 그를 따랐더라. 그들이 요나단 앞에서 쓰러지매 그의 병기를 드는 자가 그를 따라가며 죽이니라.',
        14: '요나단과 그의 병기 드는 자가 한 겨리의 소들이 쟁기질 할 수 있는 반 에이커 땅에서 처음으로 살육한 자가 이십 명가량이더라.',
        15: '군대와 들과 온 백성 가운데서 떨림이 있었고 수비대와 노략하는 자들도 떨며 땅도 흔들렸으니 이처럼 그것은 참으로 큰 떨림이었더라.',
        16: '베냐민의 기브아에 있던 사울의 파수꾼이 바라보니, 보라, 많은 사람이 사라지고 그들이 서로를 내리치더라.',
        17: '그때에 사울이 자기와 함께 있던 백성에게 이르되, 이제 수를 세어 우리에게서 누가 나갔는지 보라, 하므로 그들이 수를 세니, 보라, 거기에 요나단과 그의 병기 드는 자가 없더라.',
        18: '사울이 아히야에게 이르되, 하나님의 궤를 이리로 가져오라, 하였으니 하나님의 궤가 그때에 이스라엘 자손과 함께 있었더라.',
        19: '¶사울이 제사장에게 말할 때에 블레셋 사람들의 군대 내의 소리가 계속 나면서 커지므로 사울이 제사장에게 이르되, 네 손을 거두라, 하니라.',
        20: '사울과 그와 함께 있던 온 백성이 모인 뒤 그들이 싸우러 갔는데, 보라, 각 사람의 칼이 자기 동료를 치매 거기에 크게 쳐부수는 일이 있더라.',
        21: '또한 그 때 전에 블레셋 사람들과 함께하던 히브리 사람들 즉 사방의 지역에서 저들과 함께 올라와서 진영에 들어온 자들 곧 그들도 돌이켜서 사울과 요나단과 함께한 이스라엘 사람들과 함께하고',
        ...
        26: '백성이 숲으로 들어갈 때에, 보라, 꿀이 떨어지더라. 그러나 백성이 맹세를 두려워하여 아무도 자기 손을 입에 대지 아니하니라.',
        ...
        29: '이에 요나단이 이르되, 내 아버지가 그 땅을 괴롭게 하였도다. 청하건대 내가 이 꿀을 조금 맛보았으므로 내 눈이 얼마나 밝아졌는지 보라.',
        ...
        32: '백성이 노략한 물건으로 날아가서 양과 소와 송아지들을 취하고 땅에서 잡아 그것들을 피째 먹었더라.',
        33: '¶그때에 그들이 사울에게 고하여 이르되, 보소서, 백성이 피째 먹어 주께 죄를 짓나이다, 하니 그가 이르되, 너희가 죄를 지었도다. 이 날 큰 돌을 내게로 굴려 오라, 하고',
        ...
        35: '사울이 주께 제단을 쌓았는데 바로 그것은 그가 주를 위하여 처음 쌓은 제단이었더라.',
        36: '¶사울이 이르되, 우리가 밤에 블레셋 사람들을 쫓아 내려가서 동틀 때까지 그들을 노략하고 그들 중의 한 사람도 남기지 말자, 하니 그들이 이르되, 무엇이든지 왕이 보시기에 좋은 대로 행하소서, 하니라. 그때에 제사장이 이르되, 우리가 여기로 하나님께로 가까이 가사이다, 하매',
        37: '사울이 하나님의 조언을 구하되, 내가 블레셋 사람들을 쫓아 내려가리이까? 주께서 그들을 이스라엘의 손에 넘겨주시겠나이까? 하였으나 그분께서 그 날에 그에게 대답하지 아니하시므로',
        38: '사울이 이르되, 백성의 모든 우두머리들아, 너희는 여기로 가까이 오라. 이 날 이 죄가 어디에 있는지 알고 살펴보라.',
        39: '이스라엘을 구원하시는 주께서 살아 계심을 두고 맹세하노니 그 죄가 내 아들 요나단에게 있다 할지라도 그가 반드시 죽으리라, 하되 온 백성 가운데서 그에게 대답하는 자가 하나도 없더라.',
        40: '이에 그가 온 이스라엘에게 이르되, 너희는 한 쪽에 있으라. 나와 내 아들 요나단은 다른 쪽에 있으리라, 하니 백성이 사울에게 이르되, 왕이 보시기에 좋은 대로 행하소서, 하니라.',
        41: '그러므로 사울이 주 이스라엘의 하나님께 아뢰되, 완전한 제비를 주소서, 하매 요나단과 사울이 뽑히고 백성은 벗어났으므로',
        ...
        45: '백성이 사울에게 이르되, 이스라엘 안에서 이 큰 구원을 이룬 요나단이 죽어야 하리이까? 결단코 그렇지 아니하니이다. 주께서 살아 계심을 두고 맹세하옵나니 그의 머리털 하나도 땅에 떨어지지 아니하리이다. 그가 이 날 하나님과 함께 일하였나이다, 하여 백성이 이렇게 요나단을 구출하였으므로 그가 죽지 아니하니라.',
        ...
        48: '군대를 모아 아말렉 족속을 치고 이스라엘을 노략하는 자들의 손에서 그들을 건졌더라.',
        49: '이제 사울의 아들들은 요나단과 이수이와 멜기수아요, 그의 두 딸의 이름은 이러하니 맏딸의 이름은 메랍이요, 작은 딸의 이름은 미갈이더라.',
        50: '사울의 아내의 이름은 아히마아스의 딸 아히노암이요, 그의 군대 대장의 이름은 아브넬인데 그는 사울의 삼촌 넬의 아들이더라.',
        51: '사울의 아버지는 기스요, 아브넬의 아버지는 넬인데 그는 아비엘의 아들이더라.',
        52: '사울의 평생 동안 블레셋 사람들과 심한 싸움이 있었으며 사울이 강한 자나 용맹 있는 자를 보면 그를 자기에게로 데려왔더라.',
    },
    15: {
        ...
        6: '¶사울이 겐 족속에게 이르되, 가라. 떠나라. 너희는 아말렉 족속 가운데서 떠나 내려가라. 내가 그들과 함께 너희를 멸할까 염려하노라. 이스라엘의 모든 자손이 이집트에서 나와 올라올 때에 너희가 그들에게 친절을 베풀었느니라, 하니 이에 겐 족속이 아말렉 족속 가운데서 떠나니라.',
        7: '사울이 하윌라에서부터 네가 이집트 맞은편에 있는 수르에 이르기까지 아말렉 족속을 치고',
        8: '아말렉 족속의 왕 아각을 산 채로 사로잡으며 칼날로 그 온 백성을 진멸하니라.',
        9: '그러나 사울과 백성이 아각과 또 양과 소와 살진 것 중에서 가장 좋은 것과 어린양과 모든 좋은 것을 남기고 그것들을 진멸하려 하지 아니하며 다만 나쁘고 가치 없는 것만 다 진멸하니라.',
        10: '¶그때에 주의 말씀이 사무엘에게 임하니라. 이르시되,',
        11: '내가 사울을 왕으로 삼은 것으로 인해 슬퍼하노니 그가 나를 따르는 것에서 돌이켜 내 명령을 수행하지 아니하였느니라, 하시니라. 그것으로 인해 사무엘이 근심하여 온밤을 주께 부르짖으니라.',
        ...
        18: '또 주께서 왕을 보내 이동하게 하시며 말씀하시기를, 가서 죄인인 아말렉 족속을 진멸하되 그들이 소멸될 때까지 그들과 싸우라, 하셨나이다.',
        ...
        25: '그러므로 이제 원하오니 내 죄를 용서하시고 나와 함께 되돌아가서 내가 주께 경배하게 하소서, 하매',
        26: '사무엘이 사울에게 이르되, 나는 왕과 함께 돌아가지 아니하리니 왕이 주의 말씀을 버렸으므로 주께서 왕을 버려 이스라엘을 다스릴 왕이 되지 못하게 하셨나이다, 하니라.',
        27: '사무엘이 가려고 돌아설 때에 그가 그의 겉옷 자락을 붙잡으매 그것이 찢어지므로',
        ...
        30: '그때에 그가 이르되, 내가 죄를 지었을지라도 원하건대 이제 내 백성의 장로들 앞과 이스라엘 앞에서 나를 존중히 여기사 나와 함께 되돌아가서 내가 주 당신의 하나님께 경배하게 하소서, 하니',
        31: '이에 사무엘이 되돌아서서 사울을 따라가매 사울이 주께 경배하니라.',
        32: '¶그때에 사무엘이 이르되, 너희는 아말렉 족속의 왕 아각을 여기로 내게로 데려오라, 하니 아각이 기분 좋게 그에게 오며 이르되, 분명히 사망의 쓰라림이 지나갔도다, 하니라.',
        33: '사무엘이 이르되, 네 칼이 여인들로 하여금 자식이 없게 한 것 같이 여인들 가운데서 네 어미가 자식이 없으리라, 하고 사무엘이 길갈에서 주 앞에서 아각을 찍어 토막을 내니라.',
        34: '¶그때에 사무엘은 라마로 가고 사울은 사울의 기브아에 있던 자기 집으로 올라가니라.',
        35: '사무엘이 자기가 죽는 날까지 사울을 보려고 다시는 가지 아니하였으나 그럼에도 불구하고 사울을 위하여 애곡하였더라. 주께서는 자신이 사울을 이스라엘을 다스릴 왕으로 삼으신 것으로 인해 슬퍼하셨더라.',
    },
    16: {
        1: '주께서 사무엘에게 이르시되, 내가 이미 사울을 버려 이스라엘을 통치하지 못하게 하였거늘 네가 어느 때까지 그를 위하여 애곡하려느냐? 기름을 네 뿔에 채우고 가라. 내가 너를 베들레헴 사람 이새에게로 보내리니 내가 나를 위해 그의 아들들 가운데서 한 왕을 예비하였느니라, 하시니',
        2: '사무엘이 이르되, 내가 어찌 갈 수 있으리이까? 사울이 그것을 들으면 나를 죽이리이다, 하매 주께서 이르시되, 암송아지를 끌고 가서 말하기를, 내가 주께 희생물을 드리러 왔다, 하고',
        3: '이새를 희생물 드리는 일에 부르라. 네가 행할 일을 내가 네게 보여 주리니 너는 내가 네게 지명하는 자에게 나를 위해 기름을 부을지니라, 하시니라.',
        ...
        14: '¶그러나 주의 영께서 사울을 떠나고 주로부터 온 악한 영이 그를 괴롭게 하므로',
        15: '사울의 신하들이 그에게 이르되, 이제 보소서, 하나님으로부터 온 악한 영이 왕을 괴롭게 하온즉',
        16: '이제 우리 주는 왕 앞에 있는 왕의 신하들에게 명령하사 솜씨 있게 하프를 탈 줄 아는 사람을 구하게 하소서. 하나님으로부터 온 그 악한 영이 왕에게 임할 때에 그가 손으로 타면 왕이 나으시리이다, 하니',
        ...
        19: '¶그러므로 사울이 사자들을 이새에게 보내어 이르되, 양들과 함께하는 네 아들 다윗을 내게로 보내라, 하매',
        20: '이새가 나귀를 취해 빵과 포도즙 한 부대와 염소 새끼를 싣고 자기 아들 다윗의 손으로 그것들을 사울에게 보내니',
        21: '다윗이 사울에게 이르러 그 앞에 서매 그가 그를 크게 사랑하여 자기의 병기 드는 자로 삼고',
        22: '이새에게 사람을 보내어 이르되, 원하건대 다윗이 내 앞에 서게 하라. 그가 내 눈앞에서 호의를 얻었느니라, 하니라.',
        23: '하나님으로부터 온 그 악한 영이 사울에게 임할 때에 다윗이 하프를 취하여 손으로 타니 이에 사울이 상쾌하게 되고 나았으며 그 악한 영이 그에게서 떠나니라.',
    },
    17: {
        1: '이제 블레셋 사람들이 싸우기 위해 자기들의 군대를 함께 모으고 유다에 속한 소고에 함께 모여 소고와 아세가 사이에 있는 에베스담밈에 진을 치매',
        ...
        5: '그는 머리에 놋 투구를 썼고 쇠 그물 옷으로 무장하였는데 그 옷의 무게는 놋 오천 세겔이더라.',
        6: '또 그가 다리에 놋으로 된 정강이가리개를 입었고 그의 어깨 사이에는 놋 방패가 있더라.',
        7: '그의 창 자루는 베틀 채 같았고 그의 창 촉의 무게는 쇠 육백 세겔이더라. 방패를 든 자가 그 앞에서 가더라.',
        8: '그가 서서 이스라엘 군대를 향해 외치며 그들에게 이르되, 너희가 어찌하여 나와서 전투대형을 갖추었느냐? 나는 블레셋 사람이 아니며 너희는 사울의 종들이 아니냐? 너희는 너희를 위해 한 사람을 택하고 그를 내게로 내려오게 하라.',
        9: '그가 능히 나와 싸워서 나를 죽이면 우리가 너희 종이 될 터이나 만일 내가 그를 이기어 그를 죽이면 너희가 우리 종이 되어 우리를 섬길 것이니라, 하고',
        10: '그 블레셋 사람이 또 이르되, 내가 이 날 이스라엘 군대에 도전하노니 내게로 사람을 보내어 우리가 서로 싸우게 하라, 하므로',
        11: '사울과 온 이스라엘이 그 블레셋 사람의 그 말들을 듣고는 놀라고 크게 두려워하니라.',
        12: '¶이제 다윗은 베들레헴유다의 그 에브랏 사람 곧 이새라 하는 자의 아들이더라. 그에게 여덟 아들이 있었으며 그 사람은 사울 시대에 사람들 가운데 늙은 사람으로 통하였더라.',
        13: '이새의 가장 나이 많은 세 아들이 가서 사울을 따라 싸우러 갔는데 싸우러 간 그의 세 아들의 이름은 맏아들이 엘리압이요, 그 다음은 아비나답이요, 셋째는 삼마이며',
        ...
        19: '이제 사울과 그들과 이스라엘의 모든 사람들은 엘라 골짜기에서 블레셋 사람들과 싸우는 중이었더라.',
        20: '¶다윗이 아침에 일찍 일어나서 양 지키는 자에게 양들을 맡기고 이새가 자기에게 명령한 대로 가지고 가서 참호에 이른즉 군대가 싸우러 나아가려 하면서 싸우려고 소리를 지르더라.',
        21: '이스라엘과 블레셋 사람들이 전투대형을 갖추고 군대와 군대가 대항하였더라.',
        ...
        24: '이스라엘의 모든 사람들이 그 사람을 보고 그로부터 도망하며 심히 두려워하고',
        25: '또 이스라엘 사람들이 이르되, 너희가 올라온 이 사람을 보았느냐? 참으로 그가 이스라엘에게 도전하려고 올라왔도다. 그를 죽이는 사람은 왕이 큰 재물로 부유하게 하고 또 자기 딸을 그에게 주며 그의 아버지 집을 이스라엘 안에서 자유롭게 하시리라, 하니라.',
        26: '다윗이 자기 옆에 서 있던 사람들에게 말하여 이르되, 이 블레셋 사람을 죽여 이스라엘에게서 수치를 제거하는 그 사람에게는 어떤 대우를 하겠느냐? 이 할례 받지 않은 블레셋 사람이 누구이기에 그가 살아 계시는 하나님의 군대에 도전하느냐? 하니',
        27: '백성이 이 같은 식으로 그에게 대답하여 이르되, 그를 죽이는 사람에게는 그렇게 대우하리라, 하니라.',
        28: '¶그가 그 사람들에게 말할 때에 그의 맏형 엘리압이 들었으므로 엘리압의 분노가 다윗을 향해 타오르매 그가 이르되, 네가 어찌하여 이리로 내려왔느냐? 광야에 있는 몇 안 되는 그 양들을 네가 누구에게 맡겼느냐? 나는 네 교만과 네 마음의 무례함을 아나니 네가 전쟁을 구경하려고 내려왔도다, 하매',
        29: '그가 이르되, 내가 지금 무엇을 하였나이까? 이유가 없나이까? 하더라.',
        30: '¶다윗이 그에게서 돌이켜 다른 사람을 향하여 같은 식으로 말하매 백성이 전과 같은 식으로 다시 그에게 대답하니라.',
        31: '그들이 다윗이 말한 말들을 듣고 그것들을 사울 앞에 고하였으므로 그가 그를 부르니라.',
        32: '¶다윗이 사울에게 고하되, 그로 인하여 아무도 낙담하지 말게 하소서. 당신의 종이 가서 이 블레셋 사람과 싸우리이다, 하매',
        33: '사울이 다윗에게 이르되, 네가 가서 이 블레셋 사람을 치며 그와 싸울 수 없나니 너는 단지 소년이나 그는 어려서부터 전사이니라, 하거늘',
        ...
        36: '당신의 종이 사자와 곰을 죽였은즉 살아 계시는 하나님의 군대에 도전한 이 할례 받지 않은 블레셋 사람도 그 짐승들 중의 하나와 같이 되리이다, 하고',
        37: '다윗이 또 이르되, 나를 사자의 발톱과 곰의 발톱에서 건져 내신 주 그분께서 나를 이 블레셋 사람의 손에서도 건져 내시리이다, 하니 사울이 다윗에게 이르되, 가라. 주께서 너와 함께 계시기를 원하노라, 하니라.',
        ...
        54: '다윗은 그 블레셋 사람의 머리를 취해 예루살렘으로 가져갔으나 그의 병기는 자기 장막에 두니라.',
        55: '¶다윗이 그 블레셋 사람을 향하여 나아감을 사울이 보고 군대 대장 아브넬에게 이르되, 아브넬아, 이 소년이 누구의 아들이냐? 하매 아브넬이 이르되, 오 왕이여, 왕의 혼이 살아 계심을 두고 맹세하옵나니 내가 알지 못하나이다, 하매',
        56: '왕이 이르되, 너는 이 젊은이가 누구의 아들인가 물어보라, 하였더라.',
        57: '다윗이 그 블레셋 사람을 살육하고 돌아올 때에 아브넬이 그를 안내하여 사울 앞으로 데려갔는데 그의 손에 그 블레셋 사람의 머리가 있더라.',
    ...
    18: {
        ...
        18: '다윗이 사울에게 이르되, 내가 누구니이까? 이스라엘 안에서 내 삶이나 내 아버지 집이 무엇이기에 내가 왕의 사위가 되리이까? 하였더라.',
        ...
        27: '다윗이 일어나 자기 사람들과 함께 가서 블레셋 사람들 중에서 이백 명을 죽이고 그들의 포피를 가져다가 수를 채워 왕에게 드림으로 왕의 사위가 되려 하매 사울이 자기 딸 미갈을 그에게 아내로 주었더라.',
        28: '¶주께서 다윗과 함께 계시며 사울의 딸 미갈도 그를 사랑하는 것을 사울이 보고 알았으므로',
        29: '사울이 다윗을 더욱 두려워하여 계속해서 다윗의 원수가 되니라.',
        30: '그때에 블레셋 사람들의 통치자들이 나아왔는데 그들이 나아온 뒤에 다윗이 사울의 모든 신하보다 더 지혜롭게 행동하므로 그의 이름이 매우 중히 여겨지니라.',
    },
    19: {
        ...
        3: '내가 나가 네가 있는 들에서 내 아버지 옆에 서서 너에 관하여 내 아버지와 대화하다가 무엇을 보거든 그것을 네게 고하리라, 하더라.',
        ...
        9: '사울이 손에 창을 가지고 자기 집에 앉았는데 주로부터 온 악한 영이 그에게 임하므로 다윗이 손으로 하프를 탈 때에',
        ...
        18: '¶이와 같이 다윗이 도망하여 피하고 라마로 가서 사무엘에게 이르러 사울이 자기에게 행한 모든 일을 그에게 고하였고 그와 사무엘이 가서 나욧에 거하였더라.',
        19: '어떤 이가 사울에게 고하여 이르되, 보소서, 다윗이 라마의 나욧에 있나이다, 하매',
        20: '사울이 다윗을 잡으려고 사자들을 보내었는데 그들이 대언자들의 무리가 대언하는 것과 사무엘이 임명을 받아 그들을 다스리는 자로 선 것을 볼 때에 하나님의 영께서 사울의 사자들에게 임하시매 그들도 대언을 하니라.',
        ...
        24: '그가 또한 자기 옷을 벗고 사무엘 앞에서 같은 방식으로 대언을 하며 그 날 온 낮과 온밤에 벌거벗은 채 누웠더라. 그러므로 그들이 말하기를, 사울도 대언자들 가운데 있느냐? 하니라.',
    },
    20: {
        1: '다윗이 라마의 나욧에서 도망하여 가서 요나단 앞에서 이르되, 내가 무엇을 하였느냐? 내 불법이 무엇이냐? 네 아버지 앞에서 내 죄가 무엇이기에 그가 내 생명을 찾느냐? 하니',
        2: '그가 그에게 이르되, 결단코 아니라. 네가 죽지 아니하리라. 보라, 내 아버지가 큰일이든 작은 일이든 내게 알려 주지 않고서는 아무 일도 하려 하지 아니하시나니 내 아버지가 어찌하여 이 일은 내게 숨기시리요? 그렇지 아니하니라, 하매',
        ...
        15: '주께서 다윗의 원수들을 지면에서 모두 끊어 버리신 때에도 또한 내 집으로부터 결코 네 친절을 영원히 끊어 버리지 말라, 하고',
        ...
        20: '내가 마치 과녁을 쏘려 하는 것 같이 화살 셋을 그 곁에 쏠 것이요,',
        21: '또, 보라, 내가 아이를 보내며 이르기를, 가서 화살들을 찾으라, 하며 내가 일부러 그 아이에게 이르기를, 보라, 화살들이 네 이편에 있으니 그것들을 가져오라, 하거든 너는 올지니라. 주께서 살아 계심을 두고 맹세하거니와 네게 평강이 있으며 해가 없으리라.',
        ...
        29: '이르되, 원하건대 나를 가게 하라. 우리 가족이 그 도시에서 희생물을 드리려 하므로 내 형이 내게 거기에 올 것을 명령하였나니 이제 내가 네 눈에 호의를 입었거든 내가 떠나가서 원하건대 내 형들을 보게 하라, 하였으므로 그가 왕의 식탁에 오지 아니하나이다, 하니라.',
        30: '이에 사울의 분노가 요나단을 향해 타오르매 그가 그에게 이르되, 너 사악하고 반역하는 여인의 아들아, 네가 이새의 아들을 택하여 네게 혼란을 가져오고 또 네 어머니를 벌거벗기는 혼란을 가져온 줄을 내가 알지 못하랴?',
        ...
        33: '사울이 그에게 창을 던져 그를 치려 하니 이로써 요나단이 자기 아버지가 다윗을 죽이기로 결심한 줄 알고',
        ...
        36: '자기의 아이에게 이르되, 달려가서 이제 내가 쏘는 화살들을 찾으라, 하고 아이가 달려갈 때에 그가 화살을 그 아이 너머로 쏘니라.',
        ...
        40: '요나단이 자기의 병기를 자기의 아이에게 주며 그에게 이르되, 그것들을 가지고 도시로 가라, 하니라.',
        41: '¶아이가 가매 곧 다윗이 남쪽을 향한 곳에서 일어나 얼굴을 땅에 대고 엎드려 세 번 절한 뒤에 그들이 서로 입을 맞추고 같이 울더니 마침내 다윗이 더 심히 울었더라.',
    ...
    21: {
        ...
        7: '이제 그 날 사울의 신하들 중 어떤 사람이 거기서 주 앞에 머물러 있었는데 그의 이름은 도엑이요, 그는 에돔 족속으로 사울에게 속한 목자들 중에서 가장 으뜸가는 자였더라.',
        ...
        14: '그때에 아기스가 자기 신하들에게 이르되, 보라, 너희도 보거니와 그 사람은 미쳤도다. 그런즉 어찌하여 너희가 그를 내게로 데려왔느냐?',
        15: '내게 미치광이가 필요하여 너희가 이자를 데려다가 내 앞에서 미친 짓을 하게 하느냐? 이자가 내 집에 들어오겠느냐? 하니라.',
    },
    22: {
        ...
        3: '¶다윗이 거기서 모압의 미스바로 가서 모압 왕에게 이르되, 원하건대 하나님께서 나를 위하여 무엇을 하시려는지 내가 알 때까지 내 아버지와 어머니가 와서 당신들과 함께 있게 하소서, 하고',
        4: '그들을 모압 왕 앞으로 데려갔더니 다윗이 요새에 있을 동안에 줄곧 그들이 그와 함께 있었더라.',
        5: '¶대언자 갓이 다윗에게 이르되, 너는 요새에 머무르지 말고 떠나서 유다 땅으로 들어가라, 하니 이에 다윗이 떠나서 하렛 숲에 이르니라.',
        6: '¶다윗과 그와 함께 있던 사람들이 나타났다는 것을 사울이 들으니라. (이제 사울은 기브아에서 라마에 있던 나무 밑에 머무르며 손에 창을 들고 있고 그의 모든 신하들은 그 주위에 섰더라.)',
        7: '그때에 사울이 자기 주위에 선 자기 신하들에게 이르되, 너희 베냐민 족속들아, 이제 들으라. 이새의 아들이 너희 모든 사람에게 밭과 포도원을 주며 너희 모두를 천인 대장과 백인 대장으로 삼겠느냐?',
        8: '너희 모두가 나를 대적하려고 음모를 꾸몄고 내 아들이 이새의 아들과 동맹을 맺은 것을 내게 알리는 자가 하나도 없으며 또 너희 중에서 나를 위해 슬퍼하거나 내 아들이 내 신하를 선동하여 이 날에라도 매복하였다가 나를 치려 하는 것을 내게 알리는 자가 하나도 없도다, 하니라.',
        9: '¶그때에 사울의 신하들을 다스리도록 세워진 에돔 족속 도엑이 응답하여 이르되, 이새의 아들이 놉에 와서 아히둡의 아들 아히멜렉에게 이른 것을 내가 보았는데',
        10: '그가 그를 위하여 주께 묻고 그에게 양식을 주며 블레셋 사람 골리앗의 칼을 그에게 주었나이다, 하니라.',
        ...
        13: '사울이 그에게 이르되, 어찌하여 너희 곧 너와 이새의 아들이 나를 대적하려고 음모를 꾸미며 네가 그에게 빵과 칼을 주고 그를 위하여 하나님께 물어서 그가 이 날에라도 매복하였다가 나를 치려고 일어나게 하려 하였느냐? 하니',
        14: '그때에 아히멜렉이 왕에게 대답하여 이르되, 왕의 모든 신하 가운데 다윗같이 신실한 자가 누구니이까? 그는 왕의 사위도 되며 왕의 분부대로 가기도 하고 또한 왕의 집에서 존귀한 자이니이다.',
        15: '내가 그때에야 비로소 그를 위하여 하나님께 여쭙기 시작했나이까? 결단코 아니니이다. 왕께서는 왕의 종과 내 아버지의 온 집에게 아무 책임도 돌리지 마옵소서. 왕의 종은 이 모든 일에서 적든 많든 아무것도 알지 못하나이다, 하매',
        16: '왕이 이르되, 아히멜렉아, 네가 반드시 죽을 것이요, 너와 네 아버지의 온 집이 그러하리라, 하니라.',
        17: '¶왕이 자기 주위에 선 보병들에게 이르되, 돌아서서 주의 제사장들을 죽이라. 그들의 손이 다윗과 함께하고 또 그가 도망한 것을 알고도 그들이 그것을 내게 알리지 아니하였느니라, 하였으나 왕의 신하들이 자기 손을 내밀어 주의 제사장들을 덮치려 하지 아니하므로',
        18: '왕이 도엑에게 이르되, 너는 돌아서서 제사장들을 덮치라, 하매 에돔 족속 도엑이 돌아서서 제사장들을 덮쳐 그 날에 아마 에봇을 입은 자 팔십오 명을 죽였고',
    ...
    23: {
        ...
        4: '그때에 다윗이 주께 여전히 다시 여쭈니 주께서 그에게 응답하여 이르시되, 일어나 그일라로 내려가라. 내가 블레셋 사람들을 네 손에 넘겨주리라, 하시므로',
        5: '이에 다윗과 그의 사람들이 그일라로 가서 블레셋 사람들과 싸워 그들의 가축을 끌어오고 그들을 쳐서 크게 살육하니라. 이와 같이 다윗이 그일라 거주민들을 구원하니라.',
        6: '아히멜렉의 아들 아비아달이 그일라로 다윗에게로 도망할 때에 자기 손에 에봇을 가지고 내려왔더라.',
        ...
        9: '¶사울이 은밀히 자기를 해치려는 것을 다윗이 알고는 제사장 아비아달에게 이르되, 에봇을 여기로 가져오라, 하고',
        ...
        14: '다윗이 광야에서 강한 요새에 머물렀고 또 십 광야에 있는 산에 거하였더라. 사울이 날마다 그를 찾았으나 하나님께서 그를 그의 손에 넘겨주지 아니하시니라.',
        15: '사울이 자기 생명을 찾으려고 나온 것을 다윗이 보았으므로 다윗이 십 광야에 있는 숲에 있었더라.',
        ...
        18: '그들 둘이 주 앞에서 언약을 맺고 다윗은 숲에 머물며 요나단은 자기 집으로 돌아가니라.',
        19: '¶그때에 십 사람들이 기브아에 이르러 사울에게 나아와 이르되, 다윗이 우리와 함께 여시몬 남쪽에 있는 하길라 산 숲의 강한 요새에 숨지 아니하나이까?',
        20: '그러하온즉, 오 왕이여, 이제 왕의 혼이 내려오기를 전적으로 원하시는 대로 내려오소서. 그를 왕의 손에 넘겨주는 것이 우리의 몫이 되리이다, 하매',
        21: '사울이 이르되, 너희가 나를 불쌍히 여겼으니 주께 복 받기를 원하노라.',
        22: '어떤 이가 내게 고하기를 그가 매우 교묘히 행한다고 하니 청하건대 너희는 가서 여전히 예비하고 그가 드나드는 곳이 어디이며 누가 거기서 그를 보았는지 알아보라.',
        23: '그러므로 너희는 그가 숨어 있는 모든 은신처를 보고 안 뒤에 확신을 가지고 다시 내게 오라. 그러면 내가 너희와 함께 가리니 그가 그 땅에 있으면 내가 유다의 수천 곳을 모두 두루 다녀서라도 그를 찾아내리라, 하니라.',
        24: '그들이 일어나서 사울보다 먼저 십으로 갔으나 다윗과 그의 사람들은 여시몬 남쪽에 있는 평야 곧 마온 광야에 있었더라.',
        25: '사울과 그의 사람들이 그를 찾으러 가므로 그들이 다윗에게 고하매 그런 까닭에 그가 바위로 내려가 마온 광야에 머물렀더니 사울이 그것을 듣고는 마온 광야에서 다윗을 추격하니라.',
        ...
        29: '¶다윗이 거기서 올라가 엔게디의 강한 요새에 거하니라.',
    },
    24: {
        1: '사울이 블레셋 사람들을 따르다가 돌아오매 어떤 이가 그에게 고하여 이르되, 보소서, 다윗이 엔게디 광야에 있나이다, 하니',
        2: '그때에 사울이 온 이스라엘에서 택한 사람 삼천 명을 거느리고 다윗과 그의 사람들을 찾으려고 들염소 바위로 가니라.',
        3: '그가 길가에 있던 양 우리에 이른즉 거기에 굴이 있으므로 사울이 자기 발을 덮으려고 들어갔는데 다윗과 그의 사람들은 그 굴의 옆면에 남아 있더라.',
        4: '다윗의 사람들이 그에게 이르되, 주께서 당신에게 말씀하시기를, 보라, 내가 네 원수를 네 손에 넘겨주리니 네가 보기에 선한 대로 그에게 행하라, 하시며 언급한 그 날을 주목하소서, 하니라. 이에 다윗이 일어나서 몰래 사울의 겉옷자락을 베니라.',
        ...
        8: '그 뒤에 다윗도 일어나 굴에서 나가 사울의 뒤에서 외쳐 이르되, 내 주 왕이여, 하매 사울이 자기 뒤를 바라보므로 다윗이 자기 얼굴을 땅으로 숙여 절하니라.',
        9: '¶다윗이 사울에게 이르되, 어찌하여 왕께서는, 보소서, 다윗이 왕을 해치려 하나이다, 하는 사람들의 말을 들으시나이까?',
        10: '보소서, 오늘 주께서 왕을 굴에서 내 손에 넘겨주신 것을 이 날 왕의 눈이 보셨나이다. 몇 사람이 내게 권하여 왕을 죽이게 하였으나 내 눈이 왕을 아끼어 내가 말하기를, 나는 내 손을 내밀어 내 주(主)를 치지 아니하리니 그는 주의 기름 부음 받은 자니라, 하였나이다.',
        11: '또한 내 아버지여, 보소서, 참으로 내 손에 있는 왕의 겉옷자락을 보소서. 내가 왕의 겉옷자락만 베고 왕을 죽이지 아니하였은즉 내 손에 악함이나 범법이 없는 줄을 왕께서 보고 아시옵소서. 나는 왕에게 죄를 짓지 아니하였으나 왕은 내 혼을 사냥하여 취하려 하시나이다.',
        12: '주께서 나와 왕 사이에서 판단하시고 주께서 나를 위하여 왕에게 복수하시려니와 나는 내 손을 왕 위에 두지 아니하리이다.',
        13: '옛 사람들의 속담이 말하기를, 사악함은 사악한 자에게서 난다, 하나이다. 그러나 나는 내 손을 왕 위에 두지 아니하리이다.',
        14: '이스라엘의 왕이 누구의 뒤를 쫓으려고 나왔나이까? 왕께서 누구를 뒤쫓나이까? 죽은 개와 벼룩을 뒤쫓나이다.',
        15: '그런즉 주께서 재판관이 되사 나와 왕 사이에 판단하시고 내 사정을 살펴 변호하시며 나를 왕의 손에서 건져 내시기 원하나이다, 하니라.',
        16: '¶다윗이 사울에게 이 말들 말하기를 마치매, 사울이 이르되, 내 아들 다윗아, 이것이 네 목소리냐? 하고 소리를 높여 울며',
    ...
    25: {
        1: '사무엘이 죽으매 모든 이스라엘 사람이 함께 모여 그를 위해 애곡하며 라마에 있던 그의 집에 그를 묻으니 다윗이 일어나서 바란 광야로 내려가니라.',
        2: '마온에 한 사람이 있었는데 그의 소유는 갈멜에 있었으며 그 사람이 심히 창대하여 양 삼천 마리와 염소 천 마리를 소유하였더라. 그가 갈멜에서 자기 양들의 털을 깎고 있었는데',
        3: '이제 그 사람의 이름은 나발이요, 그의 아내의 이름은 아비가일이더라. 이 여인은 이해심이 좋고 용모가 아름다우나 그 사람은 야비하고 행위들이 악하더라. 그는 갈렙의 집에 속하였더라.',
        4: '¶나발이 자기 양들의 털을 깎는다는 것을 다윗이 광야에서 들으니라.',
        ...
        7: '네게 양털 깎는 자들이 있다는 것을 이제 내가 들었노라. 이제 네 목자들이 우리와 함께 있었으나 우리가 그들을 해치지 아니하였고 그들이 갈멜에 있는 동안 내내 잃어버린 것이 그들에게 하나도 없었으니',
        8: '네 청년들에게 물으면 그들이 네게 알려 주리라. 그런즉 이 청년들이 네 눈에 호의를 입게 하라. 우리가 좋은 날에 오나니 네 손에 닿는 것이 무엇이든지 네 종들과 네 아들 다윗에게 주기를 원하노라, 하라.',
        9: '다윗의 청년들이 가서 다윗의 이름으로 나발에게 그 모든 말대로 말하고 멈추니라.',
        10: '¶나발이 다윗의 종들에게 응답하여 이르되, 다윗이 누구냐? 이새의 아들이 누구냐? 요즘 각각 자기 주인에게서 도망치는 종들이 많도다.',
        11: '이러할진대 내가 내 빵과 물과 내 양털 깎는 자를 위하여 잡은 내 고기를 가져다가 어디로부터 왔는지 내가 알지도 못하는 사람들에게 주겠느냐? 하니라.',
        ...
        14: '¶그러나 청년들 중의 하나가 나발의 아내 아비가일에게 고하여 이르되, 보소서, 다윗이 광야에서 우리 주인에게 문안하려고 사자들을 보내었거늘 주인이 그들을 욕하였나이다.',
        ...
        18: '¶이에 아비가일이 급히 빵 이백 개와 포도즙 두 부대와 이미 요리한 양 다섯 마리와 볶은 곡식 오 세아와 건포도 백 송이와 무화과 이백 덩이를 취하여 나귀들 위에 싣고',
        ...
        21: '그런데 다윗이 이미 말하기를, 내가 광야에서 이자가 가진 모든 소유를 지켜 그에게 속한 모든 것 중에서 하나도 잃어버리지 아니하게 한 것이 참으로 헛되었도다. 그가 내게 선을 악으로 갚았도다.',
        22: '내가 동틀 때까지 그에게 속한 모든 자 중에서 담에다 소변보는 자를 하나라도 남겨 두면 하나님께서 다윗의 원수들에게 벌을 내리시고 더 내리시기를 원하노라, 하였더라.',
        23: '아비가일이 다윗을 보고는 급히 나귀에서 내려 다윗 앞에 얼굴을 대고 엎드리며 몸을 구부려 땅에 대고',
        24: '그의 발에 엎드려 이르되, 내 주여, 이 불법을 내게로 곧 내게로 돌리시고 원하오니 주의 여종이 주께서 듣는 데서 말하게 하시며 주의 여종의 말을 들으소서.',
        ...
        26: '그러므로 이제 내 주여, 주께서 살아 계심과 또 내 주의 혼이 살아 계심을 두고 맹세하거니와 내 주께서 피를 흘리러 가는 것과 내 주의 손으로 친히 원수 갚으시는 것을 주께서 막으셨사오니 이제 내 주의 원수들과 또 내 주께 악을 꾀하는 자들은 나발과 같이 되기를 원하나이다.',
        ...
        29: '그럼에도 사람이 일어나 내 주를 쫓아가서 내 주의 혼을 찾으려 하나 내 주의 혼은 주 곧 내 주의 하나님께 있는 생명 묶음으로 묶여 있을 것이요, 내 주의 원수들의 혼은 그분께서 무릿매의 중간에서 던지듯 던지시리이다.',
        ...
        36: '¶아비가일이 나발에게 돌아왔는데, 보라, 그가 왕의 잔치 같은 잔치를 집에서 열고 크게 취하였으므로 나발의 마음이 그의 속에서 즐거워하였더라. 그러므로 그녀가 동틀 때까지는 적든 많든 그에게 아무것도 말하지 아니하니라.',
        ...
        44: '¶그러나 사울이 자기 딸 곧 다윗의 아내 미갈을 갈림 출신의 라이스의 아들 발디에게 주었더라.',
    },
    26: {
        1: '십 사람들이 기브아에 와서 사울에게 나아와 이르되, 다윗이 여시몬 앞 하길라 산에 숨지 아니하나이까? 하니',
        ...
        5: '¶다윗이 일어나 사울이 진을 친 곳에 이르러 사울과 넬의 아들 곧 그의 군대 대장 아브넬이 누운 곳을 바라보았는데 사울은 참호 안에 누웠고 백성은 그를 둘러싸고 진을 쳤더라.',
        6: '그때에 다윗이 헷 족속 아히멜렉과 스루야의 아들이요, 요압의 동생인 아비새에게 응답하며 말하여 이르되, 누가 나와 함께 진영에 내려가 사울에게 이르겠느냐? 하니 아비새가 이르되, 내가 당신과 함께 가겠나이다, 하니라.',
        7: '이처럼 다윗과 아비새가 밤에 그 백성에게 갔는데, 보라, 사울은 참호 안에서 누워 자며 그의 창은 그의 베개 옆 땅에 꽂혀 있더라. 그러나 아브넬과 백성이 그를 둘러싸고 누웠으므로',
        ...
        11: '내가 내 손을 내밀어 주의 기름 부음 받은 자를 치는 것을 주께서 금하시나니 원하건대 다만 이제 너는 그의 베개 옆에 있는 창과 물병만 취하라. 그리고 우리가 가리라, 하고',
        ...
        19: '그러므로 이제 원하건대 내 주 왕은 주의 종의 말을 들으소서. 만일 주께서 나를 치려고 왕을 움직이셨으면 그분께서 헌물을 받으시리이다. 하오나 만일 그들이 사람들의 자녀들이면 주 앞에서 그들이 저주를 받으리니 그들이 말하기를, 너는 가서 다른 신들을 섬기라, 하고 이 날 나를 쫓아내어 주의 상속 재산 안에 머물지 못하게 하였나이다.',
        20: '그런즉 이제 주의 얼굴 앞에서 내 피가 땅에 떨어지지 아니하게 하소서. 사람이 산에서 자고새 한 마리를 사냥하는 것 같이 이스라엘 왕이 벼룩 한 마리를 찾으러 나오셨나이다, 하니라.',
        21: '¶이에 사울이 이르되, 내가 죄를 지었도다. 내 아들 다윗아, 돌아오라. 이 날 네 눈이 내 혼을 귀중히 여겼은즉 내가 다시는 너를 해하지 아니하리라. 보라, 내가 어리석게 행하고 크게 잘못하였도다, 하매',
        22: '다윗이 응답하여 이르되, 왕의 창을 보소서! 청년들 중의 한 명을 오게 하여 그것을 가져가게 하소서.',
    ...
    27: {
        1: '다윗이 자기 마음속으로 이르되, 이제 내가 언젠가는 사울의 손에 멸망하리니 내가 블레셋 사람들의 땅으로 빨리 도피하는 것보다 더 좋은 것이 내게 없도다. 사울이 이스라엘 온 지경에서 나를 더 찾다가 나로 인해 절망하리니 내가 이와 같이 그의 손에서 도피하리라, 하고',
        ...
        4: '다윗이 가드로 도망한 것을 어떤 이가 사울에게 고하매 그가 다시는 그를 또 찾지 아니하니라.',
        5: '¶다윗이 아기스에게 이르되, 이제 내가 당신의 눈에 은혜를 입었거든 그들이 지방에 있는 어떤 고을에서 한 처소를 내게 주게 하여 내가 거기 거하게 하소서. 당신의 종이 어찌하여 당신과 함께 왕의 도시에 거하리이까? 하니',
        6: '이에 아기스가 그 날에 시글락을 그에게 주었으므로 시글락이 이 날까지 유다 왕들에게 속하느니라.',
        7: '다윗이 블레셋 사람들의 지방에 거한 기간이 만 일 년 사 개월이었더라.',
        8: '¶다윗과 그의 사람들이 올라가서 그술 족속과 게셀 족속과 아말렉 족속을 침략하였는데 그 민족들은 옛적부터 그 땅 곧 네가 수르로 즉 이집트 땅으로 갈 때에 만나는 땅의 거주민이었더라.',
        9: '다윗이 그 땅을 쳐서 남자나 여자나 살려 두지 아니하고 양과 소와 나귀와 낙타와 의복을 취하고 돌아와서 아기스에게 이르매',
        10: '아기스가 이르되, 너희가 오늘은 어디로 길을 내었느냐? 하니 다윗이 이르되, 유다의 남쪽과 여라므엘 족속의 남쪽과 겐 족속의 남쪽을 쳤나이다, 하니라.',
        11: '다윗이 남자나 여자를 살려 두지 아니하여 가드에 소식을 전하지 못하게 하며 이르되, 그들이 우리에 관해 고하여 말하기를, 다윗이 이와 같이 행하였으니 그가 블레셋 사람들의 지방에 거하는 동안에도 항상 이런 식으로 행하리라, 할까 염려하노라, 하니라.',
        12: '아기스가 다윗을 믿고 이르기를, 그가 자기 백성 이스라엘로 하여금 자기를 철저히 싫어하게 하였은즉 그가 영원토록 내 종이 되리라, 하니라.',
    },
    28: {
        1: '그때에 블레셋 사람들이 이스라엘과 싸우려고 전쟁을 위해 자기들의 군대를 함께 모으므로 아기스가 다윗에게 이르되, 너는 확실히 알라. 너와 네 사람들이 나와 함께 싸우러 나갈 것이니라, 하매',
        2: '다윗이 아기스에게 이르되, 당신의 종이 행할 수 있는 일을 당신이 확실히 아시리이다, 하니 아기스가 다윗에게 이르되, 그런 까닭에 내가 너를 영원토록 내 머리 지키는 자로 삼으리라, 하니라.',
        ...
        7: '¶이에 사울이 자기 신하들에게 이르되, 부리는 영을 지닌 여인을 나를 위해 찾으라. 내가 그녀에게로 가서 그녀에게 물으리라, 하니 그의 신하들이 그에게 이르되, 보소서, 엔돌에 부리는 영을 지닌 여인이 있나이다, 하니라.',
        8: '사울이 변장하고 다른 옷을 입은 채 두 사람과 함께 가서 그들이 밤에 그 여인에게 이르니라. 그가 이르되, 원하노니 나를 위해 부리는 영으로 점을 쳐서 내가 네게 지명할 사람을 나를 위해 위로 데려오라, 하매',
        ...
        11: '그때에 여인이 이르되, 내가 누구를 네게로 위로 데려오랴? 하거늘 그가 이르되, 사무엘을 나를 위해 위로 데려오라, 하니라.',
        12: '여인이 사무엘을 보고는 큰 소리로 외치며 사울에게 말하여 이르되, 당신이 어찌하여 나를 속이셨나이까? 당신은 사울이시니이다, 하매',
        ...
        15: '¶사무엘이 사울에게 이르되, 네가 어찌하여 나를 위로 데려가려고 나를 요동시켰느냐? 하니 사울이 대답하되, 내가 심히 곤궁하나이다. 블레셋 사람들은 나를 치려고 싸움을 일으켰고 하나님은 내게서 떠나사 다시는 대언자로도 꿈으로도 내게 대답하지 아니하시나이다. 그러므로 내가 행할 일을 당신이 내게 알려 주도록 하기 위해 내가 당신을 불렀나이다, 하니라.',
        ...
        20: '이에 사울이 사무엘의 말들로 인해 즉시 땅에 완전히 쓰러지고 심히 두려워하더라. 또 그가 온 낮과 온밤에 전혀 빵을 먹지 아니하였으므로 그에게 전혀 기력이 없더라.',
        21: '¶그 여인이 사울에게 다가가서 그가 심히 고통 받는 것을 보고 그에게 이르되, 보소서, 왕의 여종이 왕의 음성에 순종하여 내 생명을 내 손에 두고 왕이 내게 이르신 말씀들에 귀를 기울였사오니',
        22: '그러므로 이제 원하건대 왕께서도 왕의 여종의 목소리에 귀를 기울이사 내가 왕 앞에 빵 한 조각을 놓게 하소서. 왕은 잡수시고 길을 가실 때에 기력을 얻으소서, 하거늘',
        23: '그가 거절하여 이르되, 내가 먹지 아니하리라, 하였으나 그의 신하들과 여인이 함께 강권하매 그가 그들의 목소리에 귀를 기울이고 이에 땅에서 일어나 침상에 앉으니라.',
        24: '여인에게는 집에 살진 송아지가 있었으므로 그녀가 급히 그것을 잡고 밀가루를 취해 반죽하여 그것으로 누룩 없는 빵을 구워',
        25: '사울과 그의 신하들 앞에 가져오니 그들이 먹고 그 뒤에 일어나서 그 밤에 가니라.',
    },
    29: {
        1: '이제 블레셋 사람들은 자기들의 모든 군대를 아벡에 함께 모았고 이스라엘 사람들은 예스르엘에 있는 샘 옆에 진을 쳤더라.',
        2: '블레셋 사람들의 귀족들은 수백 명씩 수천 명씩 나아가되 다윗과 그의 사람들은 아기스와 함께 후위대에서 나아갔더니',
        ...
        4: '블레셋 사람들의 통치자들이 그에게 노하니라. 블레셋 사람들의 통치자들이 그에게 이르되, 이자를 돌려보내어 그가 왕이 그를 위해 정해 준 그의 처소로 다시 가게 하소서. 그가 우리와 함께 싸우러 내려가게 하지 말지니 그가 싸움터에서 우리의 대적이 될까 염려하나이다. 그가 무엇으로 자기 주인과 화해하리이까? 이 사람들의 머리가 아니니이까?',
        5: '그들이 춤추며 서로 노래하여 이르되, 사울이 죽인 자는 수천이요, 다윗은 수만이로다, 하던 자가 이 다윗이 아니니이까? 하니라.',
        6: '¶이에 아기스가 다윗을 불러 그에게 이르되, 주께서 살아 계심을 두고 맹세하거니와 분명히 네가 올바르며 네가 내게 온 날부터 이 날까지 내가 네게서 악을 보지 못하였으므로 네가 나와 함께 군대 안에서 나가고 들어오는 것이 내 눈앞에서는 좋게 보이나 그럼에도 불구하고 귀족들이 네게 호감을 갖지 아니하니',
        7: '그런즉 이제 너는 돌이켜 평안히 가서 블레셋 사람들의 귀족들을 노엽게 하지 말라, 하니라.',
        8: '¶다윗이 아기스에게 이르되, 그러나 내가 무엇을 하였나이까? 내가 이 날까지 당신과 함께 있는 동안 당신이 당신의 종에게서 무엇을 보셨기에 내가 가서 내 주 왕의 원수들과 싸우지 못하게 하시나이까? 하매',
        9: '아기스가 다윗에게 대답하여 이르되, 네가 내 눈앞에서 하나님의 천사같이 선한 줄을 내가 아나 그럼에도 불구하고 블레셋 사람들의 통치자들은 말하기를, 그가 우리와 함께 싸우러 올라가지 못하리라, 하였나니',
    ...
    30: {
        1: '다윗과 그의 사람들이 셋째 날에 시글락에 이르렀는데 그때는 이미 아말렉 족속이 남쪽과 시글락을 침략한 뒤더라. 그들이 시글락을 쳐서 불로 태우고',
        2: '그 안에 있던 여인들을 포로로 취하며 큰 자든 작은 자든 하나도 죽이지 아니하고 다 사로잡아 데리고 자기들의 길로 가니라.',
        3: '¶이처럼 다윗과 그의 사람들이 도시에 이르렀는데, 보라, 도시는 불탔고 자기들의 아내와 아들딸들은 포로가 되었으므로',
        4: '그때에 다윗과 그와 함께 있던 백성이 더 이상 울 힘이 없을 때까지 소리를 높여 울었더라.',
        5: '다윗의 두 아내 곧 예스르엘 여인 아히노암과 갈멜 사람 나발의 아내 아비가일도 포로가 되었더라.',
        6: '온 백성이 각각 자기 아들딸들로 인해 혼이 괴롭게 되어 다윗을 돌로 치자고 말하였으므로 그가 크게 고통을 당하였으나 다윗이 주 자기 하나님 안에서 스스로 용기를 내었더라.',
        7: '다윗이 아히멜렉의 아들 제사장 아비아달에게 이르되, 원하건대 에봇을 여기로 내게로 가져오라, 하니 아비아달이 에봇을 거기로 다윗에게로 가져오매',
        8: '다윗이 주께 여쭈어 이르되, 내가 이 군대를 추격하리이까? 내가 그들을 따라잡으리이까? 하니 그분께서 그에게 대답하시되, 쫓아가라. 네가 반드시 그들을 따라잡고 틀림없이 모든 것을 도로 찾으리라, 하시니라.',
        9: '이에 다윗과 그와 함께 있던 육백 명이 가서 브솔 시내에 이르러 뒤에 남은 자들을 거기 머물게 하였으나',
        10: '다윗과 사백 명은 쫓아갔으니 이는 이백 명이 너무 기진하여 브솔 시내를 건너지 못하고 뒤에 머물렀기 때문이더라.',
        11: '¶그들이 들에서 이집트 사람 하나를 찾아내어 다윗에게로 데려와 그에게 빵을 주니 그가 먹으매 그들이 그에게 물을 마시게 하고',
        12: '또 무화과 덩이에서 뗀 덩이 하나와 건포도 두 송이를 주었더라. 그가 밤낮으로 사흘 동안 빵도 먹지 못하고 물도 마시지 못하였으므로 먹은 뒤에 그의 정신이 다시 그에게 돌아왔더라.',
        13: '다윗이 그에게 이르되, 너는 누구에게 속하였느냐? 어디 사람이냐? 하매 그가 이르되, 나는 이집트 청년이요, 아말렉 족속의 종인데 사흘 전에 내가 병들매 내 주인이 나를 버렸나이다.',
        14: '우리가 그렛 족속의 남쪽과 유다에 속한 지경과 갈렙의 남쪽을 침략하고 시글락을 불로 태웠나이다, 하매',
        15: '다윗이 그에게 이르되, 네가 나를 이 무리에게로 데리고 내려갈 수 있겠느냐? 하니 그가 이르되, 당신이 나를 죽이지도 아니하고 내 주인의 손에 넘겨주지도 아니하겠다고 하나님을 두고 내게 맹세하소서. 그리하면 내가 당신을 이 무리에게로 데리고 내려가리이다, 하더라.',
        16: '¶그가 다윗을 데리고 내려가니, 보라, 그들이 온 땅에 넓게 퍼져 블레셋 사람들의 땅과 유다 땅에서 빼앗은 온갖 큰 노략물로 인하여 먹고 마시며 춤추므로',
        17: '다윗이 황혼부터 다음 날 저녁때까지 그들을 치매 낙타를 타고 도망한 청년들 사백 명 외에는 그들 중의 아무도 피하지 못하였더라.',
        18: '다윗이 아말렉 족속이 끌고 간 모든 것을 되찾고 자기의 두 아내를 구출하였으며',
        19: '작은 자든 큰 자든, 아들이든 딸이든, 노략물이든 혹은 그들이 탈취했던 것이든 아무것도 잃은 것이 없이 다윗이 모두 되찾았고',
        20: '또 모든 양 떼와 소 떼를 탈취하였더니 그들이 그것들을 다른 가축들보다 앞에 몰고 가며 이르되, 이것은 다윗의 노략물이라, 하였더라.',
        21: '¶다윗이 이백 명에게로 갔는데 이들은 너무 기진하여 다윗을 따르지 못하므로 저들이 또한 브솔 시내에 머물게 한 자들이더라. 그들이 다윗과 및 그와 함께한 백성을 맞이하러 나오므로 다윗이 그 백성에게 가까이 가서 그들에게 문안하니',
        22: '그때에 다윗과 함께 갔던 자들 중에서 사악한 모든 사람들과 벨리알의 사람들이 응답하여 이르되, 그들이 우리와 함께 가지 아니하였은즉 우리가 되찾은 노략물 중에서 아무것도 그들에게 주지 아니하고 다만 각 사람에게 그의 아내와 아이들만 주어 그들이 그들을 데리고 떠나가게 하리라, 하니라.',
        23: '이에 다윗이 이르되, 내 형제들아, 주께서 우리를 보존하시고 우리를 치러 온 그 무리를 우리 손에 넘겨주셨은즉 그분께서 우리에게 주신 것에 대하여 너희가 그와 같이 하지 못하리라.',
        24: '이 일에서 누가 너희 말에 귀를 기울이겠느냐? 오직 싸우러 내려가는 자의 몫이 물건 옆에 머무르는 자의 몫과 같을 것이요, 그들이 똑같이 나눌 것이니라, 하고',
        25: '그 날부터 그가 그것을 이스라엘을 위해 법규와 규례로 삼았더니 그것이 이 날까지 그리 되니라.',
        26: '¶다윗이 시글락에 이르러 유다 장로들 곧 자기 친구들에게 노략물을 보내며 이르되, 주의 원수들에게서 취한 노략물 중에서 너희를 위해 마련한 예물을 보라, 하고',
        ...
        31: '헤브론에 있던 자들과 또 다윗 자신과 그의 사람들이 자주 가던 모든 곳에 보내었더라.',
    },
    31: {
        ...
        3: '싸움이 사울에게 심히 불리하게 되어 활 쏘는 자들이 그를 맞히매 그가 그 활 쏘는 자들로 인하여 크게 다치니라.',
        4: '이에 사울이 자기의 병기 드는 자에게 이르되, 네 칼을 빼어 그것으로 나를 찌르라. 이 할례 받지 않은 자들이 와서 나를 찌르고 능욕할까 염려하노라, 하였으나 그의 병기 드는 자가 심히 두려워하여 하려 하지 아니하므로 사울이 칼을 취해 그 위에 쓰러지매',
        5: '그의 병기 드는 자가 사울이 죽은 것을 보고 자기도 마찬가지로 자기 칼 위에 쓰러져 그와 함께 죽으니라.',
        6: '이와 같이 사울과 그의 세 아들과 그의 병기 드는 자와 그의 모든 사람이 그 날에 함께 죽었더라.',
