...
CHAPTERS = {
    1: {
        1: '오바댜의 환상 계시라. 주 하나님께서 에돔에 관하여 이같이 말씀하시느니라. 우리가 주로부터 한 소문을 들었도다. 한 대사가 이교도들 가운데로 보내어졌는데 그가 말하기를, 너희는 일어날지어다. 우리가 일어나서 에돔을 대적하여 싸우자, 하는도다.',
        ...
        8: '주가 말하노라. 그 날에 내가 에돔에서 심지어 지혜로운 사람들을 멸하며 에서의 산에서 지각을 멸하지 아니하겠느냐?',
        ...
        15: '주의 날이 모든 이교도들 위에 가까이 이르렀도다. 네가 행한 대로 네게 이루어지리니 너에 대한 보응이 네 머리로 돌아가리라.',
        ...
        18: '야곱의 집은 불이 되고 요셉의 집은 불꽃이 되며 에서의 집은 지푸라기가 되리라. 그들이 저들을 불사르고 삼킬 터인즉 에서의 집에 남은 자가 하나도 없으리라. 주가 그것을 말하였느니라.',
        ...
        21: '구원자들이 시온 산 위로 올라와서 에서의 산을 심판하리니 그 왕국이 주의 것이 되리로다.',
    },
}
