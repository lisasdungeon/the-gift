...
CHAPTERS = {
    ...
    2: {
        ...
        17: '나의 사랑하는 이여, 날이 새고 그림자들이 달아나기 전까지는 돌이키시며 또 당신은 베데르 산들 위의 노루나 젊은 사슴같이 되시옵소서.',
    },
    3: {
        ...
        11: '오 시온의 딸들아, 너희는 나아가서 관을 쓰신 솔로몬 왕을 보라. 이 관은 그가 정혼하던 날 곧 그의 마음이 즐거워하던 날에 그의 어머니가 그에게 씌워 준 것이로다.',
    },
    4: {
        ...
        16: '¶오 북풍아, 깨어라. 너 남풍아, 오라. 내 동산에 불어서 그곳의 향료를 흘려보내라. 나의 사랑하는 이가 자신의 동산에 들어오사 자신의 아름다운 열매들을 드시게 할지니라.',
    },
    5: {
        ...
        16: '그분의 입은 지극히 달콤하니 참으로 그분은 모든 것이 사랑스럽도다. 오 예루살렘의 딸들아, 이분이 나의 사랑하는 이시요, 이분이 나의 친구시로다.',
    },
    6: {
    ...
    7: {
        ...
        13: '합환채가 향기를 뿜어내고 우리의 성문들에는 온갖 종류의 아름다운 열매가 있나니 새 것과 오래된 것이라. 오 나의 사랑하는 이여, 내가 당신을 위하여 그것들을 쌓아 두었나이다.',
    },
    8: {
        ...
        14: '¶나의 사랑하는 이여, 서두르소서. 당신은 향료들의 산들 위에 있는 노루나 젊은 사슴같이 되시옵소서.',
    },
}
