...
CHAPTERS = {
    1: {
        1: '하나님의 뜻으로 말미암아 예수 그리스도의 사도가 된 바울은 에베소에 있는 성도들과 그리스도 예수님 안에 있는 신실한 자들에게 편지하노니',
        2: '하나님 우리 아버지와 주 예수 그리스도로부터 은혜와 평강이 너희에게 있기를 원하노라.',
        3: '하나님 곧 우리 주 예수 그리스도의 아버지를 찬송하리로다. 그분께서 그리스도 안에서 하늘의 처소들에 있는 모든 영적인 복으로 우리에게 복을 주셨으니',
        ...
        13: '너희도 진리의 말씀 곧 너희의 구원의 복음을 들은 뒤에 그분을 신뢰하였고 너희가 믿은 뒤에 또한 그분 안에서 약속의 저 거룩하신 영으로 봉인되었느니라.',
    ...
    2: {
        ...
        11: '그러므로 기억하라. 너희는 지나간 때에 육체로는 이방인이요, 손으로 육체에 행하는 할례를 받아 할례자라 불리는 자에 의해 무할례자들이라 불리던 자들이라.',
        ...
        19: '그러므로 이제 너희는 더 이상 낯선 자와 외국인이 아니요 오직 성도들과 더불어 동료 시민이요 하나님의 집안에 속한 자들이며',
    ...
    3: {
        ...
        2: '너희를 위해 내게 주신 하나님의 은혜의 경륜을 너희가 들었으리라.',
        ...
        7: '내게 주신 하나님의 은혜의 선물에 따라 그분의 권능이 효력 있게 활동함을 힘입어 내가 이 복음의 사역자가 되었노라.',
        8: '그분께서 모든 성도들 중에서 가장 작은 자보다 더 작은 나에게 이 은혜를 주신 것은 헤아릴 수 없는 그리스도의 부요함을 내가 이방인들 가운데 선포하게 하고',
        ...
        12: '그리스도 안에서 우리가 그분의 믿음을 통해 담대함을 가지며 또 확신 있게 나아감을 얻느니라.',
    ...
    4: {
        1: '그러므로 주의 갇힌 자 된 내가 너희에게 간청하노니 너희는 너희를 부르실 때에 허락하신 그 부르심에 합당하게 걷고',
        ...
        18: '그들은 지각이 어두워졌으며 그들 속에 있는 무지함과 그들 마음의 눈먼 것으로 인해 하나님의 생명에서 떨어져 있도다.',
        19: '그들이 감각을 지나쳐 자기를 색욕에 내주고 탐욕을 내어 모든 부정한 것을 행하였으되',
        20: '너희는 그리스도를 그렇게 배우지 아니하였느니라.',
        21: '진리가 예수님 안에 있는 것 같이 너희가 그분의 말씀을 듣고 그분에게서 가르침을 받았을진대',
        22: '이전 행실에 관하여는 너희가 속이는 것으로 가득한 욕심들에 따라 부패한 옛 사람을 벗어 버릴 것을 가르침을 받았으니',
        23: '너희의 생각의 영 속에서 새롭게 되라.',
        24: '또 너희가 하나님을 따라 의와 참된 거룩함으로 창조된 새 사람을 입을 것을 가르침을 받았으니',
        ...
        30: '하나님의 거룩한 영을 슬프게 하지 말라. 그분으로 말미암아 너희가 구속의 날까지 봉인되었느니라.',
        31: '너희는 모든 쓴 것과 진노와 분노와 소리 지르는 것과 비방하는 것을 모든 악의와 함께 버리고',
        32: '서로 친절히 대하며 상냥한 마음을 품고 서로 용서하기를 하나님께서 그리스도로 인하여 너희를 용서하신 것 같이 하라.',
    },
    5: {
        1: '그러므로 너희는 사랑스러운 자녀로서 하나님을 따르는 자가 되고',
        2: '그리스도께서 우리를 사랑하사 우리를 위해 자신을 향기로운 냄새의 헌물과 희생물로 하나님께 드리신 것 같이 사랑 안에서 걸으라.',
        3: '오직 음행과 모든 부정한 것과 혹은 탐욕은 너희 가운데서 한 번이라도 그 이름조차 부르지 말라. 그것이 성도에게 합당하니라.',
        ...
        19: '시와 찬송가와 영적 노래로 너희 자신에게 말하며 너희 마음속에서 주께 노래하고 선율을 만들며',
        20: '모든 일로 인해 우리 주 예수 그리스도의 이름으로 항상 하나님 곧 아버지께 감사하고',
    ...
    6: {
        ...
        4: '또 너희 아버지들아, 너희 자녀들을 노엽게 하지 말고 오직 주의 교육과 훈계로 양육하라.',
        5: '종들아, 육체에 따라 너희의 주인 된 자들에게 두려워하고 떨며 단일한 마음으로 순종하기를 그리스도께 하듯 하라.',
        6: '사람들을 기쁘게 하는 자들같이 눈으로 섬기지 말고 그리스도의 종들로서 마음으로부터 하나님의 뜻을 행하여',
        7: '선한 뜻으로 섬기기를 주께 하듯 하고 사람들에게 하듯 하지 말라.',
        8: '어떤 사람이 무슨 선한 일을 행하든지 그가 매인 자든지 자유로운 자든지 주에게서 바로 그것을 받을 줄을 너희가 아느니라.',
        9: '너희 주인들아, 그들에게 같은 일들을 행하고 협박하는 일을 삼가라. 너희 주인도 하늘에 계시나니 그분께서 사람들의 외모를 중시하지 아니하시는 줄 너희가 아느니라.',
        ...
        23: '하나님 아버지와 주 예수 그리스도로부터 평강과 아울러 믿음을 겸한 사랑이 형제들에게 있기를 원하노라.',
