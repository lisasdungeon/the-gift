...
CHAPTERS = {
    1: {
        1: 'Paulus, Jesu Christi Apostel, genom Guds vilja, och brödren Timotheus, den Guds församling som är i Corintho, samt med all helgon, som äro uti hela Achajen:',
        2: 'Nåd vare med eder, och frid af Gudi, varom Fader, och Herranom Jesu Christo.',
        ...
        7: 'Efter vi vete, att såsom I ären delaktige i lidandet, så värden I ock delaktige i hugsvalelsen.',
        ...
        12: 'Ty vår berömmelse är detta, nämliga värt sam vets vittnesbörd, att vi uti enfaldighet och Guds renhet, icke uti köttslig vishet, utan i Guds nåd, hafve vandrat på verldene; men aldramest när eder.',
        ...
        15: 'Och på den förtröstning ville jag kommit till eder tillförene, att jag matte eder dubbelt vara till vilja;',
    ...
    2: {
        ...
        3: 'Och detsamma hafver jag skrifvit eder, att, när jag komme till eder, jag icke skulle få sorg af dem, der jag heldre skulle fä glädje af; efter jag hafver den tröst till eder alla, att min fröjd är allas edra fröjd.',
        ...
        7: 'Så att I nu dess mer tvärtemot skolen öfver se med honom, och hugsvala honom, på det han icke skall uppsluken varda uti för mycken bedröfvelse.',
        ...
        10: 'Den I förläten något, den förlåter ock jag; ty hvem ock jag förlåter något, det förlåter jag för edra skull, i Christi stad;',
    ...
    3: {
        ...
        3: 'Efter I bevisen, att I ären Christi bref, beredt genom vår tjenst, och skrifvet icke med bläck, utan med lefvandes Guds Anda; icke i taflor af sten, utan i hjertans t anor af kött.',
        ...
        6: 'Hvilken ock oss beqvämliga gjort hafver till att föra dess Nya Testamentsena ämbete; icke bokstafsens, utan Andans; ty bokstafven dödar, men Anden gör lefvande.',
    ...
    4: {
        ...
        3: 'Är nu värt Evangelium förtäckt, så är det förtäckt för dem, som förtappade varda;',
    ...
    5: {
        ...
        10: 'Ty vi måste alle uppenbarade varda för Christi domstol; på det hvar och en skall fä, efter som han handlat hafver, medan han lefde, ehvad det är godt eller ondt.',
        ...
        12: 'Vi prise oss icke äter för eder; men vi gifve eder tillfälle till att berömma eder af oss; på det I något hafva skolen emot dem, som sig efter anseendet, och icke efter hjertat berömma.',
        13: 'Ty äre vi för stränge, så äre vi det Gudi; eller äre vi mättelige, så äre vi eder måttelige.',
    ...
    6: {
        ...
        16: 'Eller huru kommer Guds tempel öfverens med afgudar? Ty I ären lefvandes Guds tempel, såsom Gud säger: Jag vill bo uti dem, och vandra uti dem; och jag vill vara deras Gud, och de skola vara mittfolk.',
    ...
    7: {
        1: 'Efter vi nu hafve sådana löfte, mine käreste, så görom oss rena af all köttsens och andans obsmittelse, fullbordande helgelsen i Guds räddhåga.',
        ...
        7: 'Dock icke allenast genom hans tillkommelse, utan jemväl genom den hugsvalelse han fatt hade af eder; och förkunnade oss edra åstundan, edar gråt, edart nit om mig, så att jag blef ända yttermera glad.',
    ...
    8: {
        ...
        8: 'Icke så, att jag bjuder eder något; utan efter andre så vinnlägga sig, försöker jag ock edar kärlek, om hän sannskyldig är.',
        ...
        24: 'Låter nu skina någon bevisning till edar kärlek, och vår berömmelse af eder, nå dem; ja ock uppenbarliga för församlingarna.',
    },
    9: {
        ...
        4: 'På det, om de af Macedonien med mig komma, och finna eder icke redo, att vi (jag vill icke säga I) icke då skolen fä en blygd af sådana berömmelse.',
        ...
        6: 'Men det säger jag: Den som sparliga sär, han skallock sparliga uppskära; och den som sår i välsignelse, han skall ock uppskära i välsignelse.',
    ...
    10: {
        ...
        5: 'Med hvilko vi kullsläde anslag, och all höghet som sig upphäfver emot Guds kunskap; och tillfångatage allt förnuft under Christi lydno;',
        6: 'Och äro redebogne att hämnas alla olydno, när edor lydnad fullbordad är.',
        7: 'Domen I efter ansigtet? Om någor förlåter sig derpå, att han hörer Christo till, han tanke det ock med sig sjelf, att, såsom han hörer Christo till, så höre ock vi Christo till.',
        ...
        11: 'Den sådana är, han tanke, att sådana som vi äre med orden i brefven frånvarande, så äre vi ock väl medgerningen närvarande.',
    ...
    11: {
        ...
        2: 'Ty jag nitälskar eder i Guds nit; ty jag hafver fast eder enom man, på det jag skulle fly Christo en ren jungfru.',
        ...
        5: 'Ty jag häller mig icke ringare, än de höga Apostlar äro.',
        ...
        16: 'Åter säger jag, att ingen skall tänka att jag är fåvitsk; annars tager mig ock an såsom en fåvitsk man, att jag ock något litet må berömma mig.',
        ...
        23: 'Förutan det som eljest påkommer, nämliga att jag dagliga öfverlupen varder, och bär omsorg för alla församlingar. Förutan det som eljest påkommer, nämliga att jag dagliga öfverlupen varder, och bär omsorg för alla församlingar.',
        ...
        33: 'Oeh jag vardt i en korg genom ett fenster, öfver muren, nedersläppt, och undslapp hans händer.',
    },
    12: {
        ...
        9: 'Och han sade till mig: Lät dig nöja åt mine nåd; ty min kraft är mägtig i de svaga. Derföre vill jag aldrahelst berömma mig af mine svaghet, på det Christi kraft skall bo i mig.',
        ...
        14: 'Si, jag är redebogen tredje reson komma till eder, och vill intet heller betunga eder; ty jag söker icke edart, utan eder; derföre ätt barnen skola icke draga tillhopa föräldromen, utan föräldrarna barnomen.',
    ...
    13: {
        ...
        2: 'Jag hafver det sagt eder tillförene, och säger eder det tillförene, såsom närvarandes, i den andra reson; och skrifver det nu frånvarandes, dem som tillförene syndat hafva, och allom dem androm. Om jag äter kommer, skall jag intet skona;',
        ...
        11: 'På sistone, käre bröder, fröjder eder; varer full komne, tröster eder, varer ens sinnade, varer fridsamme; så blifver kärlekens och fridsens Gud när eder.',
