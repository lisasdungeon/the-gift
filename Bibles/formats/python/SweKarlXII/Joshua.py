...
CHAPTERS = {
    ...
    2: {
        ...
        13: 'Att I låten lefva min fader, mina moder, mina breder, och mina systrar, och allt det de hafva; och frälser våra själar ifrå döden.',
        14: 'Männerna sade till henne: Om vi icke göre barmhertighet och trohet med dig, då Herren gifver oss landet, så skall var själ vara döden skyldig för eder, såframt du icke förråder vårt ärende.',
        ...
        18: 'När vi komme i landet, och du icke binder detta rosenröda tåget i fenstret, med hvilko du oss nedersläppt hafver: och hafver församlat till dig i huset din fader, dina moder, dina bröder, och hela dins fadershus;',
        ...
        21: 'Hon sade: Vare som I sägen: och låt gå dem; och de gingo sin väg, och hon band det rosenröda tåget i fenstret.',
        22: 'Och de gingo sin väg, och kommo upp på berget, och blefvo den tre dagar, tilldess de kommo igen, som efter dem foro: ty de hade sökt dem på alla vägar, och dock intet funnit dem.',
    ...
    5: {
        ...
        2: 'På den tiden sade Herren till Josua: Gör dig stenknifvar, och omskär Israels bara annan gång.',
    ...
    9: {
        1: 'Då nu detta hördes intill alla de Konungar, som voro på den sidon Jordan, på bergom och i dalom, och i alla stora hafsens nämner, och när dem som voro invid Libanons berg, nämliga de Hetheer, Amoreer, Cananeer, Phereseer, Heveer och Jebuseer;',
    ...
    12: {
        ...
        2: 'Sihon, de Amoreers Konung, som bodde i Hesbon, och var rådandes ifrån Aroer, som på strandene ligger vid den bäcken vid Arnon, och midt i bäcken, och öfver hälft Gilead, intill den bäcken Jabbok, der Ammons barnas landamäre är;',
    ...
    13: {
        ...
        3: 'Ifrå Sichor, som löper framom Egypten, allt intill Ekrons landsändar norrut, hvilka de Cananeer tillräknas; fem de Philisteers herrar, nämliga de Gasiter, de Asdod i ter, de Askaloniter, de Gittiter, de Ekroniter, och de Aviter.',
        ...
        25: 'Så att deras landsändar voro Jaeser, och alla de städer i Gilead, och hälft Ammons barnas land, allt intill Aroer, som ligger för Rabbah;',
    ...
    14: {
        1: 'Detta är nu det som Israels barn intogo i Canaans lande, hvilket dem emellan utskifte Presten Eleazar, och Josua, Nuns son, och de öfverste fader i Israels barnas slägter.',
        ...
        6: 'Då gingo Juda barn fram till Josua i Gilgal; och Caleb, Jephunne son, den Kenisiten, sade till honom: Du vetst hvad Herren sade till den Guds männen Mose, på mina och dina vägnar, i KadesBarnea.',
    ...
    15: {
        ...
        2: 'Så att deras södergränsor voro ifrån andanom af salthafvet, det är, ifrå den tungone som drager söderåt;',
    ...
    16: {
        ...
        3: 'Och drager sig nederåt vesterut, till den gränson Japhleti, allt intill den nedra Bethorons gränso, och allt intill Gaser; och dess ände är vid hafvet.',
    ...
    17: {
        ...
        4: 'Och de gingo fram för Presten Eleazar, och för Josua, Nuns son, och för de örversta, och sade: Herren böd Mose, att han skulle gifva oss arfvedel ibland våra bröder; så gaf han dem ock arfvedel ibland deras faders bröder, efter Herrans befallning.',
    ...
    19: {
        ...
        45: 'Jehud, Benebarak, GrathRimmon,',
        ...
        51: 'Desse äro nu de arfvedelar, som Eleazar Presten, och Josua, Nuns son, och de öfverste af fäderna ibland släkterna, genom lott utskifte Israels barnom i Silo för Herranom, inför dörrene af vittnesbördsens tabernakel; och lyktade så landsens utskiftning.',
    },
    20: {
    ...
    21: {
        ...
        18: 'Anathoth, och dess förstäder; Aimon, och dess förstäder;',
    ...
    24: {
        ...
        29: 'Och det begaf sig, när detta skedt var, att Josua, Nuns son, Herrans tjenare, blef död, då han hundrade och tio är gammal var.',
