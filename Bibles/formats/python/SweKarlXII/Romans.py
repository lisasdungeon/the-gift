...
CHAPTERS = {
    1: {
        1: 'Paulus, Jesu Christi tjenare, kallad till Apostel, afskild tio att predika Guds Evangelium;',
        ...
        5: 'Ibland hvilka I ock ären kallade af Jesu Christo; Ibland hvilka I ock ären kallade af Jesu Christo;',
        7: 'Allom dem som i Rom äro, Guds kärestom, kalladom heligom. Nåd vare med eder, och frid af Gudi varom Fader, och Herranom Jesu Christo.',
        ...
        13: 'Jag vill icke dölja for eder, bröder, att jag hafver ofta haft i sinnet komma till eder, ändock jag hafver varit förhindrad allt härtill; på det jag måtte ock någon frukt skaffa ibland eder, såsom ibland andra Hedningar.',
        14: 'Jag är pligtig både Greker och Barbarer, både visa och ovisa.',
        15: 'Ty jag skämmes icke vid Christi Evangelium; ty det är Guds kraft allom dem till salighet som tro; Judomen först, så ock Grekomen; Ty jag skämmes icke vid Christi Evangelium; ty det är Guds kraft allom dem till salighet som tro; Judomen först, så ock Grekomen;',
        ...
        24: 'Derföre hafver ock Gud öfvergifvit dem i deras hjertans lust ar, uti orenlighet, till att skämma sin lekamen inbördes;',
        25: 'Derföre hafver ock Gud öfvergifvit dem i skamliga lustar; ty deras qvinnor hafva förvandlat den naturliga brukningena uti den, som är emot naturen. Derföre hafver ock Gud öfvergifvit dem i skamliga lustar; ty deras qvinnor hafva förvandlat den naturliga brukningena uti den, som är emot naturen.',
        ...
        28: 'Och såsom de intet aktade hafva Gud i känslo, hafver Gud öfvergifvit dem i ett vrängt sinne, till att bedrifva obeqvämlig ting;',
    ...
    2: {
        ...
        5: 'Hvilken gifva skall hvarjom och enom efter hans gerningar; Hvilken gifva skall hvarjom och enom efter hans gerningar;',
        ...
        15: 'På den dagen, när Gud menniskornas lönligheter döma skall, genom Jesum Christum, efter mitt Evangelium. På den dagen, när Gud menniskornas lönligheter döma skall, genom Jesum Christum, efter mitt Evangelium.',
        ...
        25: 'Om nu förhuden håller lagsens rättfärdighet, månn icke hans förhud blifva räknad för omskärelse? Om nu förhuden håller lagsens rättfärdighet, månn icke hans förhud blifva räknad för omskärelse?',
    ...
    3: {
        ...
        5: 'Bort det; ty huru kunde Gud då döma verldena? Bort det; ty huru kunde Gud då döma verldena?',
        ...
        15: 'Förtryckelse och vedermöda i deras vägar Förtryckelse och vedermöda i deras vägar',
        ...
        20: 'Derföre, att intet kött kan af lagsens gerningar varda rättfärdigt för honom; ty af lagen känner man synden a.',
        ...
        25: 'Till att låta se i denna tiden sina rättfärdighet; på det han allena skall vara rättfärdig, och göra den rättfärdigan, som är af Jesu tro. Till att låta se i denna tiden sina rättfärdighet; på det han allena skall vara rättfärdig, och göra den rättfärdigan, som är af Jesu tro.',
    ...
    4: {
        ...
        2: 'Det säge vi: Är Abraham rättfärdig vorden af gemingarna, så hafver han det han må berömma sig af; men icke för Gudi.',
        3: 'Men hvad säger Skriften? Abraham trodde Gudi, och det vardt honom räknadt till rättfärdighet.',
        4: 'Men honom, som håller sig vid gemingarna, varder lönen icke räknad af nåd, utan af pligt.',
        5: 'Såsom ock David säger, att saligheten är dens menniskos, hvilko Gud tillräknar rättfärdighetena, utan gerningar. Såsom ock David säger, att saligheten är dens menniskos, hvilko Gud tillräknar rättfärdighetena, utan gerningar.',
        ...
        20: 'Ty han tvinade intet på Guds löfte med otro; utan vardt stark i trone, gifvandes Gudi ärona;',
    ...
    5: {
        1: 'Medan vi nu rättfärdige vordne äro af trone, hafvo vi frid med Gud, genom vår Herra Jesum Christum;',
        2: 'Genom hvilken vi hafve ock en tillgång i trone till denna nåd, som vi uti stam, och berömmom oss af hoppet, som vi hafve, till den härlighet som Gud gifva skall.',
        ...
        5: 'Ty ock Christus, den stund vi ännu svage vorom efter tiden, hafver lidit döden för oss syndare. Ty ock Christus, den stund vi ännu svage vorom efter tiden, hafver lidit döden för oss syndare.',
        ...
        11: 'Icke allenast det; utan vi berömmom oss ock af Gudi, genom vår Herra Jesum €hristum, genom hvilken vi nu förlikningen fått hafve.',
        ...
        19: 'Tv såsom, för ene menniskos olydno, äro månge vordne syndare; så varda ock, för ens lydnos skull, månge rättfärdige.',
    ...
    6: {
        ...
        5: 'Vetande att vår gamla menniska är korsfäst med honom, på det att syndakroppen skall varda om intet, att vi icke härefter skola tjena syndene. Vetande att vår gamla menniska är korsfäst med honom, på det att syndakroppen skall varda om intet, att vi icke härefter skola tjena syndene.',
        7: 'Ty den som döder är, han är rättfärdigad ifrå syndene.',
        8: 'Äre vi nu döde med Christo, så tro vi, att vi ock skole lefva med honom j',
        ...
        15: 'Veten I icke, att hvem I gifven eder för tjenare till att lyda, hans tjenare ären I, som I lydige ären, ehvad det är mer syndene, till döden, eller lydnone, till rättfärdighetena? Veten I icke, att hvem I gifven eder för tjenare till att lyda, hans tjenare ären I, som I lydige ären, ehvad det är mer syndene, till döden, eller lydnone, till rättfärdighetena?',
        ...
        22: 'Men nu, medan I ären frie vordne ifrå syndene, och vordne Guds tjenare, hafven I edor frukt, att I helige värden; och till ändalykt, evinnerligit lif.',
        23: 'Ty syndenes lön är döden; men Guds gåfva är det eviga lifvet, genom Christum Jesum, vår Herra.',
    },
    7: {
        1: 'Veten I icke, käre bröder (ty jag talar med dem som lagen veta), att lagen regnerar öfver menniskona, så länge non lefver?',
        ...
        10: 'Och jag vardt död; så fans då, att budordet, som mig var gifvet till lifs, det var mig till döds.',
        11: 'Ty synden tog tillfälle af budordet, och bes vek mig, och drap mig dermed.',
        ...
        15: 'Om jag nu gör det jag icke vill, så samtycker jag, att lagen är god. Om jag nu gör det jag icke vill, så samtycker jag, att lagen är god.',
    ...
    8: {
        ...
        3: 'Ty det som lagen icke kunde åstadkomma, i det hon vardt försvagad af köttet, det gjorde Gud, sandandes sin Son i syndelig kötts liknelse, och fördömde syndena i köttet genom synd;',
        4: 'På det den rättfärdighet, som lagen äskar, skulle varda fullbordad i oss, som icke vandrom efter köttet, utan efter Andan.',
        5: 'Ty köttsens sinne är döden; men Andans sinne är lif och frid. Ty köttsens sinne är döden; men Andans sinne är lif och frid.',
        ...
        15: 'Den samme Anden vittnar med vår Anda, att vi äre Guds barn. Den samme Anden vittnar med vår Anda, att vi äre Guds barn.',
        ...
        18: 'Ty jag håller det så före, ätt denna tidsens vedermöda är icke lika emot den härlighet, som på oss uppenbaras skall.',
        ...
        21: 'Ty kreaturen skola ock varda fri af förgängelighetenes träldom, tall Guds barnas härliga frihet.',
        ...
        35: 'Såsom skrifvet är: För dina skull vardom vi dödade hela dagen; vi vardom hållne såsom slagtofår. Såsom skrifvet är: För dina skull vardom vi dödade hela dagen; vi vardom hållne såsom slagtofår.',
    ...
    9: {
        ...
        5: 'Detta säger jag icke fördenskull, att Guds ord äro omintet vorden; ty de äro icke alle Israeliter, som äro af Israel; Detta säger jag icke fördenskull, att Guds ord äro omintet vorden; ty de äro icke alle Israeliter, som äro af Israel;',
        ...
        10: 'Och icke allenast det; utan ock Rebecka vardt en gång hafvandes af Isaac, varom fader.',
        ...
        15: 'Så står det nu icke till någors mans vilja eller lopp, utan till Guds barmhertighet. Så står det nu icke till någors mans vilja eller lopp, utan till Guds barmhertighet.',
        ...
        24: 'Hvilka han ock kallat hafver, nämliga oss, icke allenast af Judo men, utan ock af Hedningomen;',
        25: 'Och det skall ske, att der som hafver varit sagdt till dem: I ären icke mitt folk; der skola de varda kallade lefvandes Guds barn. Och det skall ske, att der som hafver varit sagdt till dem: I ären icke mitt folk; der skola de varda kallade lefvandes Guds barn.',
        ...
        30: 'Hvad vilje vi då säga? Det säge vi: Hedningarna, som icke farit hafva efter rättfärdighetene, de hafva fått rättfärdigneten; den rättfärdighet menar jag, som af trone kommer.',
        31: 'Men Israel, som for efter rättfärdignetenes lag, kom icke tillrättfärdighetenes lag..',
    ...
    10: {
        ...
        5: 'Men den rättfärdighet, som är af trone, säger så: Säg icke i ditt hjerta: Ho vill fara upp i himmelen? Det är, att hemta Christum härned. Men den rättfärdighet, som är af trone, säger så: Säg icke i ditt hjerta: Ho vill fara upp i himmelen? Det är, att hemta Christum härned.',
        ...
        15: 'Men de äro icke alle Evangelio lydige; ty Esaias säger: Herre, ho tror vår predikan? Men de äro icke alle Evangelio lydige; ty Esaias säger: Herre, ho tror vår predikan?',
        ...
        20: 'Dristar ock Esaias sig till, och säger: Jagar funnen af dem, som intet sökte mig, och är vorden uppenbar dem, som intet sporde efter mig.',
    ...
    11: {
        ...
        5: 'Är det nu af nåd, så är det icke af gerningom; annars vore nåd icke nåd; är det ock af gerningom, så är det nu icke nåd; annars är gerning icke gerning. Är det nu af nåd, så är det icke af gerningom; annars vore nåd icke nåd; är det ock af gerningom, så är det nu icke nåd; annars är gerning icke gerning.',
        ...
        15: 'Är förstlingen helig, så är ock väl hele degen helig och om roten är helig, så äro ock qvistarna helige. Är förstlingen helig, så är ock väl hele degen helig och om roten är helig, så äro ock qvistarna helige.',
        ...
        18: 'Så beröm dig icke emot qvistarna. Om du berömmer dig, så bär ju icke du roten a, utan roten bär dig.',
        19: 'Så säger du då: Qvistarna äro afbrutne, på det jag skulle inympas.',
        20: 'Sant säger du; de äro af brutne för otrones skull; men du äst ståndandes genom trona; var icke för stolt i ditt sinne, utan var i räddhåga.',
        ...
        23: 'Och de inympas igen, om de icke blifva i otrone; ty Gud är mägtig äter inympa dem.',
        ...
        25: 'Och så varder hele Israel salig; såsom skrifvet är: Af Zion skall den komma som fria skall, och afvända ogudaktigheten af Jacob. Och så varder hele Israel salig; såsom skrifvet är: Af Zion skall den komma som fria skall, och afvända ogudaktigheten af Jacob.',
        ...
        29: 'Ty Guds gåfvor och kallelse äro sädana, att han kan dem icke ångra.',
        ...
        35: 'Ty af honom, och igenom honom, och i honom äro all ting; honom vare ära i evighet. Amen. Ty af honom, och igenom honom, och i honom äro all ting; honom vare ära i evighet. Amen.',
    },
    12: {
        ...
        5: 'Och hafve åtskilliga gåfvor, efter den nåd som oss gifven är. Hafver någor Prophetiam, så vare hon ens med trone. Och hafve åtskilliga gåfvor, efter den nåd som oss gifven är. Hafver någor Prophetiam, så vare hon ens med trone.',
        7: 'Hafver någor ett ämbete, så akte han derpä; lärer någor, så akte han på lärona.',
        ...
        14: 'Tåler väl om dem som gå efter edart argasta; tåler väl, och önsker dem icke ondt.',
        15: 'Ens till sinnes med hvarannan; håller icke mycket af eder sjelfva; utan håller eder lika vid dem som ringa äro; håller eder icke sjelfva för kloka, Ens till sinnes med hvarannan; håller icke mycket af eder sjelfva; utan håller eder lika vid dem som ringa äro; håller eder icke sjelfva för kloka,',
        17: 'Görer ingom ondt för ondt; vinnlägger eder om det som ärligit är, inför hvar man.',
        18: 'Om möjeligit är, så mycket som till eder står, sa hafver frid med alla menniskor.',
        ...
        21: 'Lät dig icke öfvervunnen varda af det onda; utan öfvervinn det onda med det goda.',
    },
    13: {
        ...
        5: 'Derföre måsten I ock gifva skatt; ty de äro Guds tjenare, som sådant skola sköta. Derföre måsten I ock gifva skatt; ty de äro Guds tjenare, som sådant skola sköta.',
        ...
        9: 'Ty det som sagd t är: Du skall icke göra hor; du skall icke dräpa; du skall icke stjäla; du skall icke bära falskt vittne; du skall icke begära; och annat sådant bud, det beslutes i detta ordet: Du skall älska din nästa som dig sjelf.',
    ...
    14: {
        ...
        8: 'Lefve vi, sa lefve vi Herranom; dö vi, så dö vi Herranom; ehvad vi nu lefve eller dö, så höre vi Herranom till.',
        ...
        15: 'Derföre flyr det så, att edart goda icke varder undergifvet menniskors förtal. Derföre flyr det så, att edart goda icke varder undergifvet menniskors förtal.',
    ...
    15: {
        ...
        5: 'Att I med enom håg, och med enom mun, mågen prisa Gud, och vårs Herras Jesu Christi Fader. Att I med enom håg, och med enom mun, mågen prisa Gud, och vårs Herras Jesu Christi Fader.',
        ...
        12: 'Och äter säger Esaias: Det skall vara Jesse rot, och den som uppstå skall att råda öfver Hedningarna; på honom skola Hedningarna hoppas.',
        ...
        20: 'Och beflitat inig att predika Evangelium, der Christus icke ens hade varit nämnd, på det jag icke skulle bygga på ens annars grund;',
        ...
        25: 'Ty de som bo uti Macedonien, och Achajen, hafva belefvat göra någon undsättning dem fattigom heligom, som äro i Jerusalem. Ty de som bo uti Macedonien, och Achajen, hafva belefvat göra någon undsättning dem fattigom heligom, som äro i Jerusalem.',
    ...
    16: {
        ...
        5: 'Helser Maria, den der mycket arbete för oss haft hafver. Helser Maria, den der mycket arbete för oss haft hafver.',
        ...
        15: 'Helser eder inbördes med en helig kyss; helsa eder Christi församlingar. Helser eder inbördes med en helig kyss; helsa eder Christi församlingar.',
        ...
        23: 'Helsar eder Gajus, min och hela församlingenes värd; helsar eder Erastus, stadsens räntomästare, och Qvartus, brödren.',
        24: 'Vårs Herras Jesu Christi nåd vare med eder allom. Amen.',
        25: 'Men nu uppenbarad och kungjord, igenom Prophetemas skrifter, af eviga Guds befallning; på det tron skall få lydaktighet ibland alla Hedningar; Men nu uppenbarad och kungjord, igenom Prophetemas skrifter, af eviga Guds befallning; på det tron skall få lydaktighet ibland alla Hedningar;',
