...
CHAPTERS = {
    ...
    3: {
        1: 'Joram, Achabs son, vardt Konung öfver Israel i Samarien, uti adertonde årena Josaphats, Juda Konungs; och regerade i tolf ar;',
    ...
    7: {
        ...
        10: 'Och då de kommo, ropade de vid stadsporten, och underviste dem och sade: Vi kommo uti de Syrers lägre, och si, der är ingen, ej heller någor menniskos röst; utan hästar och åsnar bundne, och hyddorna såsom de stå. Och riddaren svarade Guds mannenom, och sade: Si, om Herren än gjorde fenster på himmelen, huru kunde detta ske? Men han sade: Si, med din ögon skall du se det, och intet äta deraf.',
    ...
    8: {
        1: 'Elisa talade med den qvinnone, hvilkens son han hade lefvande gjort, och sade: Statt upp och gack dina färde med ditt hus, och var främmande hvar du kan; ty Herren varder kallandes en hunger, och han skall komma öfver landet i sju är.',
        2: 'Qvinnan stod upp, och gjorde såsom Guds mannen sade: och drog åstad med sitt hus, och var främmande uti de Philisteers land i sju är.',
        ...
        18: 'Och vandrade på Israels Konungars väg, såsom Achabs hus gjorde; ty Achabs dotter var hans hustru; och han gjorde det ondt var för Herran om.',
    ...
    11: {
        ...
        21: 'Och Joas var sju är gammal, då han vardt Konung.',
    },
    12: {
    ...
    14: {
        ...
        23: 'Uti femtonde årena Amazia, Joas sons, Juda Konungs, vardt Jerobeam, Joas son, Konung öfver Israel i Samarien, ett och fyratio ar,',
    ...
    15: {
        ...
        27: 'Uti andra och femtionde årena Asaria, Juda Konungs, vardt Pekah, Remalia son, Konung öfver Israel i Samarien i tjugu är;',
    ...
    16: {
        ...
        2: 'Tjugu åra gammal var Ahas, då han vardt Konung, och regerade sexton är i Jerusalem, och gjorde intet det Herranom hans Gud behagade, såsom hans fader David.',
    ...
    17: {
        ...
        5: 'Och Konungen i Assyrien drog in i hela landet, och till Samarien, och belade det i tre är.',
        ...
        11: 'Och rökte der på alla höjder, lika såsom Hedningarna, hvilka Herren för dem fördrifvit hade; och bedrefvo slem stycke, der med de förtörnade Herran;',
    ...
    18: {
        ...
        2: 'Och var fem och tjugu åra gammal, då han vardt Konung, och regerade nio och tjugu är i Jerusalem; hans moder het Abi, Zacharia dotter.',
    ...
    22: {
        ...
        16: 'Så säger Herren: Si, jag skall låta komma olycko öfver detta rum, och dess inbyggare, efter all lansens ord, som Juda konung hafver läsa låtit.',
    ...
    24: {
        1: 'Uti hans tid drog NebucadNezar upp, Konungen i Babel, och Jojakim vardt honom underdånig i tre är. Och han vände sig om, och föll ifrå honom.',
