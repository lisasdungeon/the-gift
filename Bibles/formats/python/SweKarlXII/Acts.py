...
CHAPTERS = {
    1: {
        ...
        3: 'Hvilkom han ock efter sin pino betedde sig lefvandes, med mångahanda bevisning, da han lät sig se af dem i fyratio dagar, och talade med dem om Guds rike.',
        4: 'Och då han hade församlat dem, böd han dem, att de icke skulle gå utaf Jerusalem, utan förbida Fadrens löfte, der I af hört harven (sade han) af mig.',
        ...
        11: 'De der ock sade: I Galileiske män, hvi stan I och sen upp i himmelen? Denne Jesus, som upptagen är ifrån eder i himmelen, han skall så komma, som I honom sett hafven uppfara i himmelen.',
        ...
        16: 'I män och bröder, den Skriften måste fullbordas, som den Helge Ande längo sagt hade genom Davids mun, om Judas, som deras ledsagare var som grepo Jesum.',
        17: 'Ty han var räknad i vårt tal, och hade fatt med oss detta ämbetet.',
        18: 'Och han forvärfde en åker för orättfärdig lön; och upphängde sig, och remnade midt itu, och alla hans inelfver gåfvo sig ut.',
    ...
    2: {
        ...
        6: 'Då nu denna rösten skett hade, kom tillsammans mycket folk, och vordo forhäpne; ty de hörde dem tala kvar och en med sitt eget mål;',
        7: 'Och vordo alle förskräckte, och förundrade sig, sägande emellan sig: Si, äro icke alle desse, som tala, Galileiske?',
        8: 'Huru höre vi då hvar och en sitt tungomål, der vi uti födde are?',
        ...
        40: 'Betygade han ock med mång annor ord, och förmanade dem, sågandes: Låter hjelpa eder ifrå detta onda slägtet.',
        ...
        46: 'Och hvar dag voro de stadigt och endrägteliga i templet; och bröto bröd här och der i husen, ätandes med h varannan i fröjd; och lofvade Gud i deras hjertans enfaldighet.',
    ...
    3: {
        ...
        13: 'Abrahams, och Isaacs och Jacobs Gud, våra faders Gud, hafver förklarat sin Son Jesum, hvilken I öfverantvardat hafven, och förnekat inför Pilatus, då han dömde, att han skulle gifvas lös.',
        14: 'Men I förnekaden den Helga och Rättfärdiga; och baden, att mandråparen skulle gifvas eder.',
        15: 'Och lifsens Första dråpen I. Den hafver Gud nu uppväckt ifrå de döda; till hvilket vi vittne are;',
        ...
        20: 'Att vederqvickelsens tid då kommer för Herrans ansigte, när han sandandes varder den eder nu tillförene predikad är, Jesum Christum;',
        ...
        22: 'Ty Moses hafver sagt till fäderna: Herren, edar Gud, skall eder uppväcka en Prophet utaf edra bröder, såsom mig; honom skolen I höra i allt det han eder sågandes varder.',
        23: 'Och det skall ske, att hvar och en själ, som icke hörer den Propheten, hon skall utkastas ifrå folket.',
        24: 'Och alle Propheterna, ifrå Samuel, och sedan så månge som talat hafva, hafva badat dessa dagarna.',
        25: 'I ären Propheternas och förbundsens barn, det Gud hafver gjort med våra fäder, sågandes till Abraham: I dine säd skola all folk på jordene välsignad varda.',
    ...
    4: {
        ...
        7: 'Och hade dem fram för si£, och frågade dem: Af hvad magt, eller i hvad namn, hafven I detta gjort?',
        ...
        19: 'Då svarade Petrus och Johannes, och sade till dem: Om det är rättfärdigt for Gudi, att vi höre eder mer än Gud, derom män I sjelfve döma.',
        ...
        35: 'Och lade fram för Apostlarnas fötter; och delades h värj om och enom, efter som honom behof var.',
    ...
    5: {
        ...
        7: 'Då stod den öfverste Presten upp, och alle de med honom voro, hvilke äro det parti, som kallas de Sadduceers; och vordo fulle med nit; Då stod den öfverste Presten upp, och alle de med honom voro, hvilke äro det parti, som kallas de Sadduceers; och vordo fulle med nit;',
        ...
        22: 'Då tjenarena kommo, och funno dem icke i fängahuset, kommo de igen, och bådade dem;',
        ...
        27: 'Och då de hade ledt dem dit, hade de dem fram för Badet; och den öfverste Presten frågade dem,',
        ...
        32: 'Och vi äro honom för vittne till det vi sägom; så ock den Helge Ande, den Gud gifvit hafver dem som honom lydaktige äro.',
        33: 'Då de detta hörde, skar det dem i hjertat, och de begynte rädsla, att de mätte dräpa dem.',
        ...
        36: 'För dessa dagar hof Theudas sig upp, sågandes sig någon vara, honom föll en hop folk till, vid fyrahundrad; han vardt ihjälslagen, och alle de, som trodde honom, vordo förskingrade, och kommo till intet.',
    ...
    6: {
        ...
        11: 'Då under satte de några män, som skulle säga: Vi hafve hört honom säga hädisk ord emot Moses, och emot Gud.',
    ...
    7: {
        ...
        2: 'Då sade han: I män, bröder och fader, hörer härtill. Härlighetenes Gud syntes varom fader Abraham, medan han var i Mesopotamien, förr än han bodde i Haran;',
        ...
        26: 'Och dagen derefter syntes han ibland dem, der de trätte tillhopa; och ville förlika dem, sågandes: I män, I ären bröder hvi gören I hvarannan orätt?',
        27: 'Men den som orätt gjorde sinom nästa, han stötte honom bort, sågandes: Ho hafver satt dig till höfvitsman och domare öfver oss?',
        28: 'Månn du vilja slå mig ihjäl, såsom du slog den Egyptien i går?',
        29: 'Då flydde Moses, för detta talets skull, och vardt en främling uti det. landet Madian; dier han två söner födde.',
        ...
        41: 'Och gjorde de en kalf, i de dagar, och offrade offer till af gudar, och fröjdade sig öfver sina händers verk.',
        ...
        44: 'Vare fader hade vittnesbördsens tabernakel uti öknene; såsom han dem forskickat hade, sågandes till Mosen, att han skulle göra det efter den eftersyn, som han sett hade;',
        45: 'Hvilket ock våre fader anammade, och förde det med Josua uti det land, som Hedningarna innehade, hvilka Gud utdref för våra faders ansigte, intill Davids tid;',
        46: 'Hvilken fann nåd for Gudi, och bad, att han mätte finna ett tabernakel till Jacobs Gud.',
        ...
        58: 'Och drefvo honom utu staden, och stenade honom. Och vittnen lade sin kläder af vid en ung mans lotter, som het Saulus.',
    ...
    8: {
        ...
        5: 'Och Philippus kom ned uti en stad i Samarien, och predikade for dem om Christa',
        ...
        24: 'Då svarade Simon, och sade: Beder I Herran för mig, att mig intet öfvergår af det I säden.',
        ...
        27: 'Så stod han upp, och gick. Och si, en Ethiopisk man, en kamererare, och väldig när Drottning Candaces uti Ethiopien, h vilken hon hade satt öfver alla sina håfvor; han var kommen till Jerusalem, der att tillbedja;',
    ...
    9: {
        ...
        4: 'Och han föll ned på jordena, och hörde ena röst, sågandes till sig: Saul, Saul, hvi förföljer du mig?',
        ...
        23: 'Efter många dagar gingo Judarna till räds emellan sig, att de skulle dräpa honom.',
    ...
    10: {
        ...
        4: 'Då säg han uppå honom, och vardt förfärad, och sade: Hvad äret. Herre? Då sade han till honom: Dina böner och dina almosor äro uppkomne i åminnelse för Gud.',
        ...
        11: 'Och han såg himmelen öppen, och nederkomma till sig ett fat, såsom ett stort linnet kläde, tillhopabundet i alla fyra hörnen, nederlätet på jorden;',
        ...
        26: 'Men Petrus reste honom upp, sågandes: Statt upp; jag är ock en menniska.',
        ...
        48: 'Och så lät han döpa dem i Herrans Namn. Och de bådo honom, att han skulle blifva när dem i några dagar. Utan i allahanda folk den som fruktar honom, och gör rättfärdigheten, han är honom täck.',
    },
    11: {
        ...
        4: 'Då begynte Petrus förtälja dem af begynnelsen, det ena med det andra, sågandes:',
        5: 'Jag var i Joppe stad bedjandes; då kom jag uti en ovala, och såg ena syn; nämliga ett fat nederkomma, såsom ett stort linnet kläde, fyrahörnadt, nederlåtet af himmelen; och det kom intill mig.',
        ...
        9: 'Svarade mig äter rösten af himmelen: Det Gud hafver rent gjort, det måste du icke räkna menligit.',
        10: 'Och det skedde tre resor; och vardt allt åter upptaget i himmelen.',
        11: 'Och si, i det samma voro tre män for huset, der jag uti var, de der sände voro. till mig af Cesareen.',
        ...
        15: 'När jag hade begynt mitt tal, föll den Helge Ande ned på dem, såsom han ock i förstone nederföll nå oss.',
        ...
        23: 'När han der kom, och fick se Guds nåd, vardt han glad; och förmanade dem alla, att de af hjertat skulle fäste blifva, och hålla sig intill Herran;',
    ...
    13: {
        ...
        13: 'Då Paulus, och de med honom voro, foro ifrå Papho, kommo de till Pergen i Pamphylien; och Johannes skilj des ifrå dem, och for igen till Jerusalem.',
        ...
        15: 'Och sedan lagen var läsen och Propheterna, sände de öfverste af Synagogon. till dem, sägande: I män och bröder, hafven I något att tala till folkets förmanelse, så tåler.',
        ...
        18: 'Och vid fyratio är långt led han deras seder uti öknen;',
        19: 'Och nederlade sjuhanda folk uti Canaans land; och skifte deras land emellan dem med lott.',
        20: 'Och sedan, vid femtio och fyrahundrade är, gaf han dem domare, intill Propheten Samuel.',
        ...
        46: 'Då togo Paulus och Barnabas tröst till sig, och sade: Eder borde man först säga Guds ord; men efter det I drifven det ifrån eder, och hällen eder ovärdiga till evinnerligit lif, si, så vilje vi vända oss till Hedningarna.',
        ...
        51: 'Men de skuddade stoftet af sina fötter på dem, och kommo till Iconien. Och Lärlingarna vordo uppfyllde med f röj d och den Helga Anda.',
    },
    14: {
        ...
        5: 'Och vardt ett upplopp gjord t af Hedningarna och Judarna, och deras öfverstar, så att de ville öfverfalla dem med våld, och stena dem;',
        ...
        10: 'Ty sade han till honom med höga röst: Upprätt dig på dina fötter. Och han sprang upp, och begynte till att gä.',
        ...
        23: 'Och när de hade utvalt Prester for hvar och en församling, och hade bedit och fastat, befallde de dem Herranom, den de uppå trodde.',
    ...
    15: {
        ...
        20: 'Utan att man skrifver dem till, att de hafva återhåll af afgudars besmittelse, och M boleri och af det som förqvafdt är, och af blod.',
        ...
        24: 'Efter vi hört hafve, att någre äro utgängne af oss, och hafva förvillt eder med läro, och förvändt edra själar, bjudandes att I skolen lata eder omskära, och hälla Jagen, dem vi det icke befallt hafve;',
    ...
    16: {
        ...
        35: 'Då dager vardt, sände Rådherrarna stadsjenarena, sägande: Släpp de männerna ut.',
    ...
    17: {
        ...
        16: 'Och då Paulus förbidde dem i Athen, vardt hans ande upptänd i honom, då han säg staden afgudadyrkan undergifven vara.',
        ...
        19: 'Och de togo fatt på honom, och ledde honom på domplatsen, sägande: Mage vi icke veta, hvad denne nye lärdomen är, som du lärer?',
        20: 'Ty du gifver vår öron ny styck er före; sa vilje vi nu veta, hvad det vara skall.',
        21: 'Och de af Athen, och alle de främmande som der vistades, aktade på intet annat än att säga eller höra något nytt.',
        22: 'Då stod Paulus midt på domplatsen, och sade: I män af Athen, jag ser, att I uti all stycveke omgån med vantro;',
        ...
        26: 'Och hafver gjort allt menniskoslägtet af ett blod, till att bo på hela jordene, och satt dem före beskärda tider, och skickat huru vid t och långt de bo skola;',
        27: 'På det att de skola söka Herran, om de måtte kunna kannan och finnan, ändock han är icke långt ifrå hvarjom och enom af oss.',
        ...
        31: 'Ty han hafver satt en dag före, på hvilken han skall döma jordenes krets med rättfärdighet, genom den man i hvilkom han det beslutit hafver, gifvandes allom trona före, i det han honom uppväckt hado ifrå de döda.',
    ...
    18: {
        ...
        18: 'Sedan Paulus hade då varit der i lång tid, helsade han bröderna, och seglade sina färde till Syrien, och följde honom Priscilla och Aquila; och han rakade sitt hufvud i Kenchrea, ty han hade ett löfte;',
        ...
        26: 'Och han begynte dristeliga tala uti Synagogon. Då Priscilla och Aquila hörde honom, togo de honom till sig, och uttydde för honom ännu grundeligare Guds väg.',
    ...
    19: {
        ...
        13: 'Så voro någre Judar besvärj are, som foro omkring; de togo sig före åkalla Herrans Jesu Namn, öfver dem som hade de onda andar, sägande: Vi besvärje eder vid Jesum, den Paulus predikar.',
        ...
        19: 'Men månge af dem, som förvetna konster brukat hade, bäro fram böckerna, och brände upp i hvars mans åsyn; och då deras värde räknadt vardt, vardt det funnet till femtiotusend penningar.',
        ...
        24: 'Ty det var en guldsmed, benämnd Demetrius, som gjorde silftermpel till Diana, der de en stor vinning af hade, som det handtverk brukade;',
        ...
        36: 'Så, efter der säger ingen emot, masten I stilla eder, och intet orådeligit företaga.',
        ...
        40: 'Ty det är fara att vi komme i skuld, för det upplopp som i dag skedt är, efter ingen sak på färde är, der vi kunne någon skäl af taga till detta upplopp. Och då han det sagt hade, lat han folket gå.',
    },
    20: {
        ...
        9: 'Så satt der en yngling uti ett fenster, benämnd Eutychus, och var förtyngd af svär sömn; och vid Paulus länge talade, tog sömnen honom så svärliga, att han föll ned af tredje bottnen, och vardt upptagen döder.',
        ...
        24: 'Dock aktar jag d; t intet, ej heller är mig sjelfvom mitt lif kärt; på det jag skall fullkomna mitt lopp med glädje, och det ämbete som jag anammat hafver af Herranom Jesu, till att betyga Evangelium om Guds nåd.',
        ...
        29: 'Ty jag vet det att, sedan jag skiljs ifrån eder, skola komma ibland eder svära ulfvar, de der hjorden icke spara skola.',
    ...
    21: {
        ...
        13: 'Då svarade Paulus, och sade: Hvad (rören I, gråtandes, och bedröfvandes mitt hjerta? Jag är redebogen icke allenast bindas, utan jemväl dö i Jerusalem, för Herrans Jesu Namns skull.',
        ...
        21: 'Och de hafva hört af dig, att du lärer alla de Judar, som bo ibland Hedningarna, att de skola träda ifrå Mose lag; sägandes, att de icke skola om skära sin barn, och icke vandra efter som vant är.',
        ...
        24: 'Dem tag till dig, och rena dig med dem, och bekosta der något uppå att de raka sitt hufvud; och deraf kunna alle veta, att det är intet som de hört hafva om dig; utan att du ock så vandrar, att du OCK häller lagen.',
        ...
        35: 'Och när han kom till trapporna, hände sig att krigsknektarna måste bära honom, för öfvervalds skull, som gick af folkena.',
    ...
    22: {
        ...
        11: 'Och efter jag såg intet, för den klarhetens skull som gick af det skenet, vardt jag ledd vid handena af mina följ are, som med mig voro, och kom in i Damascum.',
        ...
        16: 'Och nu, hvad töfvar du? Statt upp, och lät dig döpa, och två af dina synder, åkallandes Herrans Namn.',
        ...
        25: 'Och då han honom bundit hade med tåg, sade Paulus till underhöfvitsmannen, som när stod: Magen I ock hudflänga någon Romersk man, och odömdan?',
    ...
    23: {
        ...
        9: 'Och så vardt ett stort rop. Och de Skriftlärde af det Phariseiska parti stodo upp, och begynte kämpas, och sade: Vi finnom intet ondt med den mannen; om så kan hända, att Anden hafver talat med honom, eller en Ängel, så lät oss icke strida emot Gud.',
        ...
        16: 'Då Pauli systerson hörde sådana forsat, kom han, och gick in i lägret, och bådade det Paulo.',
        ...
        28: 'Och när jag ville veta sak ena, som de hade emot honom, lät jag honom komma inför deras Räd.',
        ...
        30: 'Och vardt mig undervist om försåt, som Judarna hade beställt för honom; och straxt sände jag honom till dig, och bod hans åklagare att, hvad de hafva emot honom, det skola de säga dig. Farväl.',
    ...
    24: {
        ...
        8: 'Bjudandes, att hans åklagare skulle komma till dig, af hvilkom du kan sjelfver utfråga och lata dig undervisa om all ärende, der vi klage honom före.',
        ...
        16: 'Ja, för samma saks skull lägger jag mig vinn om hafva ett obesmittadt sam vet, inför Gud, och inför menniskor alltid.',
        ...
        27: 'Då nu tu är voro förlupna, kom Porcius Festus i Felix stad; men Felix ville göra Judomen till vilja, och lät Paulum blifva efter sig fången.',
    },
    25: {
        ...
        7: 'Då han framkommen var. stodo de Judar kringom honom, som af Jerusalem nederkomne voro; och båro mäng och svår klagomål före emot Paulum, som de icke bevisa kunde.',
        ...
        10: 'Sade Paulus: Jag står för Kejsarerätt, och der bör mig dömas; Judomen hafver }ag ingen orätt gjort, såsom du ock sjelfver bäst vetst.',
        ...
        12: 'Då hade Pestus samtal med Rådet, och svarade: Till Kejsaren hafver du skjutit dig; till Kejsaren skall du ock fara.',
        13: 'Och då någre dagar voro framlidne, foro Konung Agrippa och Bemice ned till Cesareen, och skulle helsa Eestum.',
        14: 'Och medan de dvaldes der i många dagar, förtäljde Pestus Konungenom Pauli sak, sägandes: Felix hafver låtit här efter sig en man fången;',
        15: 'Om hvilken, då jag kom till Jerusalem, under viste mig de öfverste Presterna, och Judarnas äldste, begärandes dom emot honom.',
        ...
        22: 'Då sade Agrippa till Pestum: Jag ville ock gerna höra mannen. I morgon, sade han, skall du få horan.',
    ...
    26: {
        ...
        3: 'Aldramest medan ja£ vet, att du äst förståndig på de sedvänjor och spörsmål, som ibland Judarna äro; hvarföre beder jag dig, att du ville höra mig tåleliga.',
        ...
        10: 'Som jag ock gjorde i Jerusalem; och mänga heliga kastade jag i fängelse, dertill jag magt tagit hade af de öfversta Presterna; och då de dräpne vordo, förde jag domen.',
        ...
        32: 'Och sade Agrippa till Festum: Denne mannen mätte väl vordit lösgifven, hade han icke skjutit sig till Kejsaren.',
    },
    27: {
        ...
        4: 'Och nar vi lade dädan, seglade vi utmed Cypren; ty vädret var oss emot.',
        ...
        7: 'Och då vi långsamliga seglat hade i mänga dagar, och som nogast komma kunde in mot Gnidum för motväders skull, seglade vi in under Creta, vid Salmone;',
        ...
        12: 'Och efter der var icke hamn till att ligga i vinterläge, föllo de mesta parten på det rådet att lägga dädan, att de, om någorlunda ske kunde, mätte komma till Phenicien, och ligga der i vinterläge; den hamnen är på Creta, för sydvest och nordvest.',
        13: 'Och som nu sunnanväder begynte blåsa, men te de hafva efter sin vilja; och då de lade ifrån Asson, seglade de utmed Creta.',
        14: 'Men icke långt efter stack sig upp emot dem ett iligt väder, som kallas nordost.',
        15: 'Och då skeppet vardt begripet, och kunde icke begå sig för vädret, läte vi drifva för vädret;',
        ...
        20: 'Och då hvarken sol eller stjernor syntes i många dagar, och stormen låg oss svärliga uppå, var oss allt hopp borto om vår välfärd.',
        ...
        22: 'Och nu förmanar jag, att I våren vid ett godt mod; ty ingom af eder skall något skada till lifvet, utan allena skeppet.',
        ...
        28: 'Och kastade ut lodet, och funno tjugu famnar djup; och kommo litet länger fram, och kastade äter lodet, och funno femton famnar djup.',
        ...
        31: 'Då sade Paulus till höfvitsmannen och till krigsknektarna: Utan desse blifva i skeppet, så värden icke I behållne.',
        32: 'Då höggo krigsknektarna af fåstona till båten, och läto honom fara.',
        ...
        34: 'Hvarföre rader jag eder, att I fån eder mat; ty det hörer edra välfärd till; ty ingens edars ett här skall falla af hans hufvud.',
        ...
        40: 'Och när de hade upptagit ankaren, gåfvo de sig till sjös, och upplöste roderbanden, och hade upp seglet till väders, och läto gå ät strandene.',
        41: 'Dock kommo de på en refvel, och skeppet stötte; och framskeppet blef ståndandes fast orörligit; men bakskeppet lossades af vägene.',
    ...
    28: {
        ...
        15: 'Och då bröderna fingo hörn om oss, gingo de emot oss intill Appii forum, och till Tretabern. När Paulus dem såg, tackade han Gudi, och tog tröst till sig.',
        16: 'Och när vi kommom in i Rom, öfverantvardade underhöfvitsmannen fångarna öfverhöfvitsmannenom; men Paulo vardt tillstadt vara för sig sielf, med en krigsknekt som tog vara på honom.',
        ...
        20: 'För denna sakens skull hafver jag kallat eder, att jag mätte se eder, och tala med eder; ty för Israels hopps skull är jag ombunden med denna kedjon.',
