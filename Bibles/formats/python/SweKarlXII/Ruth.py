...
CHAPTERS = {
    ...
    2: {
        ...
        6: 'Drängen, som öfver skördemännerna sätter var, svarade och sade: Det är den Moabitiska qvinnan, som med Naemi igenkommen är ifrå de Moabiters land.',
    ...
    3: {
        ...
        12: 'Det är sant, att jag är arfvingen, men en annar är när mer än jag.',
        ...
        15: 'Och sade: Räck hit din mantel, som du hafver uppå, och håll honom fram; och hon höll honom fram, och han mälte sex mätt korn, och lade på henne. Och han kom i staden.',
    ...
    4: {
        ...
        19: 'Hezron födde Ram; Barn födde Amminadab;',
