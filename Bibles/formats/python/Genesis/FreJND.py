...
CHAPTERS = {
    ...
    8: {
        ...
        13: 'Et il arriva, l’an 601, au premier [mois], le premier [jour] du mois, que les eaux furent séchées de dessus la terre; et Noé ôta la couverture de l’arche et regarda, et voici, la face du sol avait séché.',
    ...
    12: {
        ...
        6: 'Et Abram passa au travers du pays, jusqu’au lieu de Sichem, jusqu’au chêne de Moré. Et le Cananéen était alors dans le pays.',
    ...
    14: {
        ...
        14: 'Et Abram apprit que son frère avait été emmené captif, et il mit en campagne ses hommes exercés, 318 [hommes], nés dans sa maison, et poursuivit [les rois] jusqu’à Dan;',
    ...
    16: {
        ...
        16: 'Et Abram était âgé de 86 ans lorsque Agar enfanta Ismaël à Abram.',
    },
    17: {
    ...
    18: {
        ...
        24: 'Peut-être y a-t-il 50 justes dans la ville; [la] détruiras-tu, et ne pardonneras-tu pas à la ville à cause des 50 justes qui seront en elle?',
        ...
        26: 'Et l’ Éternel dit: Si je trouve dans Sodome 50 justes, au-dedans de la ville, je pardonnerai à tout le lieu à cause d’eux.',
        27: 'Et Abraham répondit et dit: Voici, je te prie, j’ai osé parler au Seigneur, moi qui suis poussière et cendre.',
        28: 'Peut-être en manquera-t-il cinq, des 50 justes; détruiras-tu pour cinq toute la ville? Et il dit: Je ne la détruirai pas, si j’y en trouve 45.',
        29: 'Et il continua encore de lui parler, et dit: Peut-être s’y en trouvera-t-il 40? Et il dit: Je ne le ferai pas, à cause des 40.',
        ...
        31: 'Et il dit: Voici, j’ai osé parler au Seigneur: Peut-être s’y en trouvera-t-il 20? Et il dit: Je ne la détruirai pas, à cause des 20.',
    ...
    20: {
        ...
        6: 'Et Dieu lui dit en songe: Moi aussi je sais que tu as fait cela dans l’intégrité de ton cœur, et aussi je t’ai retenu de pécher contre moi; c’est pourquoi je n’ai pas permis que tu la touches.',
        ...
        9: 'Et Abimélec appela Abraham, et lui dit: Que nous as-tu fait? et en quoi ai-je péché contre toi, que tu aies fait venir sur moi et sur mon royaume un grand péché? Tu as fait à mon égard des choses qui ne doivent pas se faire.',
        ...
        16: 'Et à Sara il dit: Voici, j’ai donné 1 000 [pièces] d’argent à ton frère; voici, cela te sera une couverture des yeux pour tous ceux qui sont avec toi, et pour tous. Ainsi elle fut reprise.',
    ...
    21: {
        ...
        7: 'Et elle dit: Qui aurait dit à Abraham: Sara allaitera des fils? Car je lui ai enfanté un fils dans sa vieillesse.',
        ...
        33: 'Et [Abraham] planta un tamaris à Beër-Shéba; et là il invoqua le nom de l’ Éternel, le ✶Dieu d’éternité.',
    ...
    25: {
        ...
        7: 'Et ce sont ici les jours des années de la vie d’Abraham, qu’il vécut: 175 ans.',
        ...
        17: 'Et ce sont ici les années de la vie d’Ismaël: 137 ans; et il expira et mourut, et fut recueilli vers ses peuples.',
        ...
        20: 'Et Isaac était âgé de 40 ans lorsqu’il prit pour femme Rebecca, fille de Bethuel l’Araméen de Paddan-Aram, sœur de Laban l’Araméen.',
        ...
        22: 'Et les enfants s’entre-poussaient dans son sein; et elle dit: S’il en est ainsi, pourquoi suis-je là? Et elle alla consulter l’ Éternel.',
        ...
        26: 'Et ensuite sortit son frère, et sa main tenait le talon d’Ésaü; et on appela son nom Jacob. Et Isaac était âgé de 60 ans quand ils naquirent.',
    ...
    30: {
        ...
        41: 'Et il arrivait que toutes les fois que les bêtes vigoureuses entraient en chaleur, Jacob mettait les branches dans les auges, devant les yeux du bétail, afin qu’elles entrent en chaleur en face des branches.',
    ...
    31: {
        ...
        27: 'Pourquoi t’es-tu enfui en cachette, et t’es-tu dérobé d’avec moi, et ne m’as-tu pas averti? Et je t’aurais renvoyé avec joie, et avec des chants, avec le tambourin et avec la harpe.',
        ...
        41: 'Ces 20 années j’ai été dans ta maison; je t’ai servi 14 ans pour tes deux filles, et six ans pour ton menu bétail, et tu as changé dix fois mon salaire.',
        42: 'Si le Dieu de mon père, le Dieu d’Abraham et la frayeur d’Isaac, n’avait été pour moi, certes, tu m’aurais maintenant renvoyé à vide. Dieu a vu mon affliction et le labeur de mes mains, et il t’a repris la nuit passée.',
    ...
    32: {
        ...
        2: '*Et Jacob alla son chemin. Et les anges de Dieu le rencontrèrent;',
        3: 'et Jacob dit, quand il les vit: C’est l’armée de Dieu. Et il appela le nom de ce lieu-là Mahanaïm.',
        4: 'Et Jacob envoya devant lui des messagers à Ésaü, son frère, au pays de Séhir, dans la campagne d’Édom;',
        5: 'et il leur commanda, disant: Vous parlerez ainsi à mon seigneur Ésaü: Ainsi a dit ton serviteur Jacob: J’ai séjourné chez Laban, et m’y suis arrêté jusqu’à présent;',
        6: 'et j’ai des bœufs, et des ânes, du menu bétail, et des serviteurs et des servantes; et je l’ai envoyé annoncer à mon seigneur, afin de trouver grâce à tes yeux.',
        7: 'Et les messagers revinrent vers Jacob, disant: Nous sommes allés vers ton frère, vers Ésaü, et même il vient à ta rencontre, et 400 hommes avec lui.',
        ...
        9: 'et il dit: Si Ésaü vient à l’une des bandes et la frappe, la bande qui restera pourra échapper.',
        10: 'Et Jacob dit: Dieu de mon père Abraham, et Dieu de mon père Isaac! Éternel, qui m’as dit: Retourne en ton pays et vers ta parenté, et je te ferai du bien!',
        11: 'Je suis trop petit pour toutes les grâces et pour toute la vérité dont tu as usé envers ton serviteur; car j’ai passé ce Jourdain avec mon bâton; et maintenant je suis devenu deux bandes.',
        ...
        13: 'Et toi, tu as dit: Certes, je te ferai du bien, et je ferai devenir ta semence comme le sable de la mer, qui ne peut se nombrer à cause de son abondance.',
        14: 'Et il passa là cette nuit; et il prit, de ce qui lui vint sous la main, un présent pour Ésaü, son frère:',
        15: '200 chèvres, et 20 boucs; 200 brebis, et 20 béliers;',
        16: '30 chamelles allaitantes, et leurs petits; 40 vaches, et dix taureaux; 20 ânesses, et dix ânons.',
        17: 'Et il les mit entre les mains de ses serviteurs, chaque troupeau à part, et il dit à ses serviteurs: Passez devant moi, et mettez de l’espace entre troupeau et troupeau.',
        ...
        19: 'tu diras: À ton serviteur Jacob; c’est un présent envoyé à mon seigneur Ésaü; et voici, lui-même aussi [vient] après nous.',
        20: 'Et il commanda de même au second, de même au troisième, de même à tous ceux qui suivaient les troupeaux, disant: Selon cette parole vous parlerez à Ésaü, quand vous le trouverez;',
        21: 'et vous direz aussi: Voici, ton serviteur Jacob [vient] après nous. Car il disait: Je l’apaiserai par le présent qui va devant moi, et après cela je verrai sa face; peut-être qu’il m’accueillera favorablement.',
        22: 'Et le présent passa devant lui; mais, pour lui, il passa cette nuit-là dans le camp.',
        ...
        24: 'Il les prit, et leur fit passer le torrent; et il fit passer ce qui était à lui.',
        ...
        27: 'Et il dit: Laisse-moi aller, car l’aurore se lève. Et il dit: Je ne te laisserai point aller sans que tu m’aies béni.',
        28: 'Et il lui dit: Quel est ton nom? Et il dit: Jacob.',
        29: 'Et il dit: Ton nom ne sera plus appelé Jacob, mais Israël; car tu as lutté avec Dieu et avec les hommes, et tu as prévalu.',
        30: 'Et Jacob demanda, et dit: Je te prie, déclare-moi ton nom. Et il dit: Pourquoi demandes-tu mon nom? Et il le bénit là.',
        31: 'Et Jacob appela le nom du lieu Peniel: Car j’ai vu Dieu face à face, et mon âme a été délivrée.',
        32: 'Et le soleil se levait sur lui comme il passait Peniel; et il boitait sur sa cuisse.',
        33: 'C’est pourquoi, jusqu’à ce jour, les fils d’Israël ne mangent point du tendon qui est sur l’emboîture de la hanche; car il toucha l’emboîture de la hanche de Jacob sur le tendon.',
    },
    33: {
        1: 'Et Jacob leva ses yeux, et regarda; et voici, Ésaü venait, et 400 hommes avec lui. Et il partagea les enfants entre Léa et Rachel et les deux servantes.',
        ...
        4: 'Et Ésaü courut à sa rencontre, et l’embrassa, et se jeta à son cou, et lui donna un baiser; et ils pleurèrent.',
        ...
        19: 'Et il acheta de la main des fils de Hamor, père de Sichem, pour 100 kesitas, la portion du champ où il avait dressé sa tente;',
    ...
    35: {
        ...
        22: 'Et il arriva, pendant qu’Israël demeurait dans ce pays-là, que Ruben alla et coucha avec Bilha, concubine de son père; et Israël l’apprit. Et les fils de Jacob étaient douze.',
    ...
    44: {
        ...
        26: 'mais nous avons dit: Nous ne pouvons descendre. Si notre plus jeune frère est avec nous, alors nous descendrons; car nous ne pouvons voir la face de cet homme, si notre plus jeune frère n’est pas avec nous.',
    ...
    47: {
        ...
        9: 'Et Jacob dit au Pharaon: Les jours des années de mon séjournement sont 130 ans; les jours des années de ma vie ont été courts et mauvais, et ils n’ont pas atteint les jours des années de la vie de mes pères, dans les jours de leur séjournement.',
    ...
    48: {
        ...
        10: 'Or les yeux d’Israël étaient appesantis de vieillesse; il ne pouvait voir. Et [Joseph] les fit approcher de lui, et il leur donna un baiser et les embrassa.',
