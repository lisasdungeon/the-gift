...
CHAPTERS = {
    ...
    2: {
        ...
        25: 'Och mannen och hans hustru voro båda nakna och blygdes icke för varandra. [1] Hebr adám [2] Hebr. adamá',
    },
    3: {
        ...
        20: 'Och mannen gav sin hustru namnet Eva[1], ty hon blev en moder åt allt levande.',
        ...
        24: 'Och han drev ut mannen, och satte öster om Edens lustgård keruberna jämte det ljungande svärdets lågor, för att bevaka vägen till livets träd. [1] Namnet härledes från ett hebreiskt ord som betyder leva.',
    },
    4: {
        1: 'Och mannen kände sin hustru Eva, och hon blev havande och födde Kain; då sade hon: »Jag har fött[1] en man genom HERRENS hjälp.»',
        ...
        25: 'Och Adam kände åter sin hustru, och hon födde en son och gav honom namnet Set, i det hon sade: »Gud har beskärt[2] mig en annan livsfrukt, till ersättning för Abel, eftersom Kain dräpte honom.»',
        26: 'Men åt Set föddes ock en son, och han gav honom namnet Enos. Vid denna tid begynte man åkalla HERRENS namn. [1] Egentligen »fått», hebr. kaníti. [2] Det hebreiska uttrycket liknar namnet Set.',
    },
    5: {
    ...
    6: {
        ...
        2: 'sågo Guds söner[1] att människornas döttrar voro fagra, och de togo till hustrur dem som de funno mest behag i.',
        ...
        22: 'Och Noa gjorde så; han gjorde i alla stycken såsom Gud hade bjudit honom. [1] Se Änglar i Ordförkl.',
    },
    7: {
    ...
    8: {
        ...
        21: 'När då HERREN kände den välbehagliga lukten, sade han vid sig själv: »Jag skall härefter icke mer förbanna marken för människans skull, eftersom ju människans hjärtas uppsåt är ont allt ifrån ungdomen. Och jag skall härefter icke mer dräpa allt levande, såsom jag nu har gjort.',
    ...
    11: {
        ...
        9: 'Därav fick den namnet Babel, eftersom HERREN där förbistrade[1] hela jordens tungomål; därifrån spridde ock HERREN ut dem över hela jorden.',
        ...
        32: 'Och Teras ålder blev två hundra fem år; därefter dog Tera i Haran. [1] Hebr balál.',
    },
    12: {
    ...
    15: {
        ...
        11: 'Och rovfåglar slogo ned på de döda kropparna, men Abram drev bort dem.',
    ...
    16: {
        ...
        11: 'Ytterligare sade HERRENS ängel till henne: »Se, du är havande och skall föda en son; honom skall du giva namnet Ismael[1], därför att HERREN har hört ditt lidande.',
        ...
        13: 'Och hon gav HERREN, som hade talat med henne, ett namn, i det hon sade: »Du är Seendets Gud.» Hon tänkte nämligen: »Har jag då verkligen här fått se en skymt av honom som ser mig[2]?»',
        ...
        16: 'Och Abram var åttiosex år gammal, när Hagar födde Ismael åt Abram. [1] D. ä. Gud hör. [2] Hebr roí.',
    },
    17: {
        ...
        5: 'Därför skall du icke mer heta Abram, utan Abraham[1] skall vara ditt namn, ty jag skall låta dig bliva en fader till många folk.',
        ...
        15: 'Och Gud sade åter till Abraham: »Din hustru Sarai skall du icke mer kalla Sarai, utan Sara[2] skall vara hennes namn.',
        ...
        27: 'och alla män i hans hus, de hemfödda tjänarna och de som voro köpta för penningar ifrån främmande folk, blevo omskurna tillika med honom. [1] D. ä. fader till många. [2] D. ä. furstinna.',
    },
    18: {
    ...
    19: {
        ...
        22: 'Men skynda att fly undan dit; ty jag kan intet göra, förrän du har kommit dit.» Därav fick staden namnet Soar[1].',
        ...
        38: 'Den yngre födde ock en son, och hon gav honom namnet Ben-Ammi; från honom härstamma Ammons barn ända till denna dag. [1] D. ä. litenhet.',
    },
    20: {
    ...
    21: {
        ...
        31: 'Därav kallades det stället Beer-Seba[1], eftersom de båda där gingo eden.',
        ...
        34: 'Och Abraham bodde i filistéernas land en lång tid. [1] D. ä. sjubrunnen; i hebreiskan hava orden för »sju» och »ed» likhet med varandra.',
    },
    22: {
        ...
        18: 'Och i din säd skola alla folk på jorden välsigna sig[1], därför att du lyssnade till mina ord.»',
        ...
        24: 'Och hans bihustru, som hette Reuma, födde ock barn, nämligen Teba, Gaham, Tahas och Maaka. [1] Se Välsigna i Ordförkl.',
    },
    23: {
    ...
    25: {
        ...
        34: 'Men Jakob gav Esau bröd och linssoppa; och han åt och drack och stod sedan upp och gick sin väg. Så ringa aktade Esau sin förstfödslorätt. [1] D. ä. den som håller i hälen; kan ock betyda: den som bedrager. [2] D. ä. röd.',
    },
    26: {
        ...
        4: 'Jag skall göra din säd talrik såsom stjärnorna på himmelen, och jag skall giva åt din säd alla dessa länder; och i din säd skola alla folk på jorden välsigna sig[1],',
        ...
        20: 'Men herdarna i Gerar begynte tvista med Isaks herdar och sade: »Vattnet är vårt.» Då gav han den brunnen namnet Esek[2], eftersom de hade kivat med honom.',
        21: 'Därefter grävde de en annan brunn, men om den kommo de ock i tvist; då gav han den namnet Sitna[3].',
        22: 'Sedan begav han sig därifrån till en annan plats och grävde åter en brunn; om den tvistade de icke. Därför gav han denna namnet Rehobot[4], i det han sade: »Nu har ju HERREN givit oss utrymme, så att vi kunna föröka oss i landet.»',
        ...
        26: 'Och Abimelek begav sig till honom från Gerar med Ahussat, sin vän[5], och Pikol, sin härhövitsman.',
        ...
        35: 'Men dessa blevo en hjärtesorg för Isak och Rebecka. [1] Se Välsigna sig i Ordförkl. [2] D. ä. kiv. [3] D. ä. fientlighet. [4] D. ä. utrymme. [5] Se Vän i Ordförkl.',
    },
    27: {
        ...
        36: 'Då sade han: »Han heter ju Jakob[1], och han har nu också två gånger bedragit mig. Min förstfödslorätt har han tagit, och se, nu har han ock tagit min välsignelse.» Och han frågade: »Har du då ingen välsignelse kvar för mig?»',
        ...
        46: 'Och Rebecka sade till Isak: »Jag är led vid livet för Hets döttrars skull. Om Jakob tager hustru bland Hets döttrar, en sådan som dessa, någon bland landets döttrar, varför skulle jag då leva?» [1] Se noten till 25,26.',
    },
    28: {
        ...
        19: 'Och han gav den platsen namnet Betel[1]; förut hade staden hetat Lus.',
        ...
        22: 'och denna sten som jag har rest till en stod skall bliva ett Guds hus, och av allt vad du giver mig skall jag giva dig tionde.» [1] D. ä. Guds hus.',
    },
    29: {
        ...
        32: 'Och Lea blev havande och födde en son, och hon gav honom namnet Ruben, ty hon tänkte: »HERREN har sett till mitt lidande[1]; ja, nu skall min man hava mig kär.»',
        33: 'Och hon blev åter havande och födde en son. Då sade hon: »HERREN har hört[2] att jag har varit försmådd, därför har han givit mig också denne.» Och hon gav honom namnet Simeon.',
        34: 'Och åter blev hon havande och födde en son. Då sade hon: »Nu skall väl ändå min man hålla sig till[3] mig; jag har ju fött honom tre söner.» Därav fick denne namnet Levi.',
        35: 'Åter blev hon havande och födde en son. Då sade hon: »Nu vill jag tacka[4] HERREN.» Därför gav hon honom namnet Juda. Sedan upphörde hon att föda. [1] Hebr raá beonjí. [2] Hebr. schamá, varav namnet Simeon (egentligen Schimeón) härledes. [3] Hebr. jillavé av stammen lavá. [4] Hebr. hodá »tacka», varav namnet Juda (egentligen Jehudá) härledes.',
    },
    30: {
        ...
        6: 'Då sade Rakel: »Gud har skaffat rätt[1] åt mig; han har hört min röst och givit mig en son.» Därför gav hon honom namnet Dan',
        7: 'Åter blev Bilha, Rakels tjänstekvinna, havande, och hon födde åt Jakob en andre son.',
        8: 'Då sade Rakel: »Strider[2] om Gud har jag stritt med min syster och har vunnit seger.» Och hon gav honom namnet Naftali.',
        ...
        13: 'Då sade Lea: »Till sällhet[4] för mig! Ja, jungfrur skola prisa mig säll.» Och hon gav honom namnet Aser.',
        ...
        18: 'Då sade Lea: »Gud har givit mig min lön[5], för det att jag gav min tjänstekvinna åt min man.» Och hon gav honom namnet Isaskar.',
        19: 'Åter blev Lea havande, och hon födde åt Jakob en sjätte son.',
        20: 'Då sade Lea: »Gud har givit mig en god gåva[6]. Nu skall min man förbliva boende[7] hos mig, ty jag har fött honom sex söner.» Och hon gav honom namnet Sebulon.',
        ...
        23: 'Hon blev havande och födde en son. Då sade hon: »Gud har tagit bort[8] min smälek.»',
        24: 'Och hon gav honom namnet Josef, i det hon sade: »HERREN give mig ännu[9] en son.»',
    ...
    31: {
        ...
        47: 'Och Laban kallade det Jegar-Sahaduta, men Jakob kallade det Galed[1].',
        48: 'Och Laban sade: »Detta röse vare i dag vittne mellan mig och dig.» Därav fick det namnet Galed;',
        49: 'men det kallades ock Mispa[2], ty han sade: »HERREN vare väktare mellan mig och dig, när vi icke mer se varandra.',
        ...
        55: 'Men om morgonen stod Laban bittida upp, och sedan han hade kysst sina barnbarn och sina döttrar och välsignat dem, for han sin väg hem igen. [1] Båda namnen betyda vittnesröse; det förra namnet är arameiska, det senare hebreiska. [2] D. ä. vaktställe.',
    },
    32: {
        1: 'Men när Jakob drog sin väg fram, mötte honom Guds änglar;',
        2: 'och då Jakob såg dem, sade han: »Detta är Guds skara.» Och han gav den platsen namnet Mahanaim[1].',
        ...
        28: 'Han sade: »Du skall icke mer heta Jakob, utan Israel, ty du har kämpat med Gud[2] och med människor och vunnit seger.»',
        ...
        30: 'Men Jakob gav platsen namnet Peniel[3], »ty», sade han, »jag har sett Gud ansikte mot ansikte, och dock har mitt liv blivit räddat».',
        31: 'Och när han hade kommit förbi Penuel, såg han solen gå upp; men han haltade på höften.',
        32: 'Fördenskull äta Israels barn ännu i dag icke höftsenan som ligger på höftleden, därför nämligen, att han gav Jakob ett slag på höftleden, på höftsenan. [1] D. ä. två skaror. [2] Hebr sará »kämpa», el »Gud». [3] Peniel, även Penuel, betyder Guds ansikte.',
    },
    33: {
        ...
        17: 'Men Jakob bröt upp och drog till Suckot och byggde sig där ett hus. Och åt sin boskap gjorde han lövhyddor[1]; därav fick platsen namnet Suckot.',
        ...
        20: 'Och han reste där ett altare och kallade det El-Elohe-Israel[2]. [1] Hebr suckót. [2] D. ä. Gud, Israels Gud.',
    },
    34: {
    ...
    35: {
        ...
        7: 'Och han byggde där ett altare och kallade platsen El-Betel[1], därför att Gud där hade uppenbarat sig för honom, när han flydde för sin broder.',
        ...
        18: 'Men när hon höll på att giva upp andan, ty hon skulle nu dö, gav hon honom namnet Ben-Oni[2]; men hans fader kallade honom Benjamin[3].',
        ...
        29: 'därefter gav Isak upp andan och dog och blev samlad till sina fäder, gammal och mätt på att leva. Och hans söner Esau och Jakob begrovo honom. [1] D. ä. Betels Gud. [2] D. ä. min smärtas son. [3] D. ä. lyckoson.',
    },
    36: {
    ...
    38: {
        ...
        29: 'Men när han därefter åter drog sin hand tillbaka, se, då kom hans broder fram; och hon sade: »Varför har du trängt dig fram?» Och han fick namnet Peres[1].',
        30: 'Därefter kom hans broder fram, han som hade den röda tråden om sin hand, och han fick namnet Sera. [1] D. ä. framträngande.',
    },
    39: {
    ...
    41: {
        ...
        32: 'Men att Farao har haft drömmen två gånger, det betyder att detta är av Gud fast bestämt, och att Gud skall låta det ske snart.',
        ...
        43: 'Och han lät honom åka i vagnen närmast efter sin egen, och man utropade framför honom »abrek»[1]. Och han satte honom över hela Egyptens land.',
        ...
        51: 'Och Josef gav åt den förstfödde namnet Manasse[2], »ty», sade han, »Gud har låtit mig förgäta all min olycka och hela min faders hus.»',
        52: 'Och åt den andre gav han namnet Efraim[3], »ty», sade han, »Gud har gjort mig fruktsam i mitt lidandes land».',
        ...
        57: 'och från alla länder kom man till Josef i Egypten för att köpa säd, ty hungersnöden blev allt större i alla länder. [1] Se Abrek i Ordförkl. [2] Efter ett hebreiskt ord som betyder förgäta. [3] Efter ett hebreiskt ord som betyder vara fruktsam.',
    },
    42: {
    ...
    48: {
        ...
        22: 'Och utöver vad jag giver dina bröder giver jag dig en särskild höjdsträcka[1] som jag med mitt svärd och min båge har tagit från amoréerna.» [1] Hebr schekém, vilket ord såsom ort- och personnamn återgives med »Sikem».',
    },
    49: {
        ...
        6: 'Min själ inlåte sig ej i deras råd, min ära[1] tage ingen del i deras samkväm; ty i sin vrede dräpte de män, och i sitt överdåd stympade de oxar.',
        ...
        8: 'Dig, Juda, dig skola dina bröder prisa[2]; din hand skall vara på dina fienders nacke, för dig skola din faders söner buga sig.',
        ...
        10: 'Spiran skall icke vika ifrån Juda, icke härskarstaven ifrån hans fötter, till dess han kommer till Silo[3] och folken bliva honom hörsamma.',
        ...
        16: 'Dan skall skaffa rätt[4] åt sitt folk, han såväl som någon av Israels stammar.',
        ...
        19: 'Gad skall trängas av skaror[5], men själv skall han tränga dem på hälarna.',
    ...
    50: {
        ...
        11: 'Och när landets inbyggare, kananéerna, sågo sorgefesten i Goren-Haatad, sade de: »Det är en högtidlig sorgefest[1] som egyptierna[2] här hålla.» Därav fick stället namnet Abel-Misraim; det ligger på andra sidan Jordan.',
        ...
        26: 'Och Josef dog, när han var ett hundra tio år gammal. Och man balsamerade honom, och han lades i en kista, i Egypten. [1] Hebr ébel. [2] Hebr. misrájim.',
    },
}
