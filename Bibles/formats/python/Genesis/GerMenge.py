...
CHAPTERS = {
    1: {
        ...
        2: 'die Erde war aber eine Wüstenei und Öde, und Finsternis lag über der weiten Flut, und der Geist Gottes schwebte (brütend) über der Wasserfläche.',
        ...
        9: 'Dann sprach Gott: »Es sammle sich das Wasser unterhalb des Himmels an einen besonderen Ort, damit das Trockene sichtbar wird!« Und es geschah so.',
        ...
        14: 'Dann sprach Gott: »Es sollen Lichter am Himmelsgewölbe entstehen, um Tag und Nacht voneinander zu scheiden; die sollen Merkzeichen sein und zur (Bestimmung von) Festzeiten sowie zur (Zählung von) Tagen und Jahren dienen;',
        15: 'und sie sollen Lichter am Himmelsgewölbe sein, um Licht über die Erde zu verbreiten!« Und es geschah so.',
        ...
        24: 'Dann sprach Gott: »Die Erde bringe alle Arten lebender Wesen hervor, Vieh, Kriechgetier und wilde Landtiere, jedes nach seiner Art!« Und es geschah so.',
    ...
    2: {
        ...
        4: 'a Dies ist die Entstehungsgeschichte des Himmels und der Erde, als sie geschaffen wurden. b Zur Zeit, als Gott der HERR Erde und Himmel schuf,',
        ...
        9: 'Dann ließ Gott der HERR allerlei Bäume aus dem Erdboden hervorwachsen, die lieblich anzusehen waren und wohlschmeckende Früchte trugen, dazu auch den Baum des Lebens mitten im Garten und den Baum der Erkenntnis des Guten und des Bösen.',
        ...
        12: 'und das Gold dieses Landes ist kostbar; dort kommt auch das Bedolachharz vor und der Edelstein Soham.',
        13: 'Der zweite Strom heißt Gihon: dieser ist es, der das ganze Land Kusch umfließt.',
        14: 'Der dritte Strom heißt Hiddekel: dieser ist es, der östlich von Assyrien fließt; und der vierte Strom ist der Euphrat.',
        ...
        18: 'Hierauf sagte Gott der HERR: »Es ist nicht gut für den Menschen, daß er allein ist: ich will ihm eine Hilfe schaffen, die zu ihm paßt.«',
        19: 'Da bildete Gott der HERR aus Erde alle Tiere des Feldes und alle Vögel des Himmels und brachte sie zu dem Menschen, um zu sehen, wie er sie benennen würde; und wie der Mensch sie alle benennen würde, so sollten sie heißen.',
        20: 'So legte denn der Mensch allem Vieh und den Vögeln des Himmels und allen wilden Tieren Namen bei; aber für einen Menschen fand er keine Hilfe darunter, die zu ihm gepaßt hätte.',
        ...
        25: 'Und sie waren beide nackt, der Mensch und sein Weib, und doch schämten sie sich nicht (voreinander).',
    },
    3: {
        1: 'Nun war die Schlange listiger als alle Tiere des Feldes, die Gott der HERR geschaffen hatte; die sagte zum Weibe: »Sollte Gott wirklich gesagt haben: ›Ihr dürft von allen Bäumen des Gartens nicht essen!‹«',
        ...
        8: 'Als sie dann aber die Stimme Gottes des HERRN hörten, der in der Abendkühle im Garten sich erging, versteckten sie sich, der Mann (Adam) und sein Weib, vor Gott dem HERRN unter den Bäumen des Gartens.',
        ...
        14: 'Da sagte Gott der HERR zu der Schlange: »Weil du das getan hast, sollst du verflucht sein vor allen Tieren, zahmen und wilden! Auf dem Bauche sollst du kriechen und Staub fressen dein Leben lang!',
        15: 'Und ich will Feindschaft setzen zwischen dir und dem Weibe und zwischen deinem Samen und ihrem Samen: er wird dir nach dem Kopfe treten, und du wirst ihm nach der Ferse schnappen.«',
        ...
        17: 'Zu dem Manne aber sagte er: »Weil du der Aufforderung deines Weibes nachgekommen bist und von dem Baume gegessen hast, von dem zu essen ich dir ausdrücklich verboten hatte, so soll der Ackerboden verflucht sein um deinetwillen: mit Mühsal sollst du dich von ihm nähren dein Leben lang!',
        18: 'Dornen und Gestrüpp soll er dir wachsen lassen, und du sollst dich vom Gewächs des Feldes nähren!',
        19: 'Im Schweiße deines Angesichts sollst du dein Brot essen, bis du zum Erdboden zurückkehrst, von dem du genommen bist; denn Staub bist du, und zu Staub mußt du wieder werden!«',
        20: 'Adam gab dann seinem Weibe den Namen Eva; denn sie ist die Stammutter aller Lebenden geworden.',
        21: 'Darauf machte Gott der HERR dem Manne und seinem Weibe Röcke von Fellen und bekleidete sie (damit).',
        ...
        24: 'und als er den Menschen hinausgetrieben hatte, ließ er östlich vom Garten Eden die Cherube sich lagern und die Flamme des kreisenden Schwertes, damit sie den Zugang zum Baume des Lebens bewachten.',
    },
    4: {
    ...
    7: {
        ...
        11: 'Es war im sechshundertsten Lebensjahre Noahs, am siebzehnten Tage des zweiten Monats: an diesem Tage brachen alle Quellen der großen Tiefe auf, und die Fenster des Himmels öffneten sich,',
        ...
        14: 'sie und alle Arten der wilden Tiere und alle Arten des Viehs und alle Arten des Gewürms, das auf der Erde kriecht, auch alle Arten der Vögel, alles, was Flügel hatte und beschwingt war;',
        15: 'die kamen zu Noah in die Arche hinein, je ein Paar von allen Geschöpfen, die Lebensodem in sich hatten;',
        16: 'und die da hineinkamen, waren immer ein Männchen und ein Weibchen von allem Fleische, wie Gott ihm geboten hatte. Hierauf schloß der HERR hinter ihm zu.',
    ...
    8: {
        ...
        2: 'die Quellen der Tiefe und die Fenster des Himmels schlossen sich, und dem Regen vom Himmel her wurde Einhalt getan.',
        3: 'Da verlief sich das Wasser allmählich von der Erde und begann nach Ablauf der hundertundfünfzig Tage zu fallen;',
        4: 'und am siebzehnten Tage des siebten Monats saß die Arche auf einem der Berge von Ararat fest.',
        ...
        9: 'Da die Taube aber keinen Ort fand, wo ihre Füße hätten ruhen können, kehrte sie zu ihm zu der Arche zurück; denn das Wasser bedeckte noch die Oberfläche der ganzen Erde. Da streckte er seine Hand hinaus, ergriff sie und nahm sie wieder zu sich in die Arche.',
    ...
    12: {
        ...
        2: 'denn ich will ich zu einem großen Volke machen und will dich segnen und deinen Namen groß machen, und du sollst ein Segen werden.',
        ...
        17: 'Aber der HERR suchte den Pharao und sein Haus mit schweren Plagen heim wegen Sarais, der Frau Abrams.',
    ...
    13: {
        ...
        8: 'Da sagte Abram zu Lot: »Laß doch keine Streitigkeiten zwischen mir und dir und zwischen meinen und deinen Hirten herrschen: wir sind ja Brüder.',
        ...
        10: 'Da hob Lot seine Augen auf und sah, daß die ganze Gegend am Jordan überall wohlbewässertes Land war – bevor nämlich der HERR Sodom und Gomorrha zerstört hatte –, wie der Garten Gottes, wie das Land Ägypten, bis nach Zoar hin.',
        11: 'Da wählte Lot für sich die ganze Gegend am Jordan und zog ostwärts. So trennten sich beide voneinander:',
        ...
        18: 'Da zog Abram mit seinen Zelten weiter und nahm (endlich) seinen Wohnsitz unter den Terebinthen Mamres, die bei Hebron stehen; dort baute er dem HERRN einen Altar.',
    },
    14: {
    ...
    19: {
        1: 'Als nun die beiden Engel am Abend nach Sodom kamen, saß Lot gerade am Tor von Sodom. Sobald Lot sie erblickte, erhob er sich vor ihnen, verneigte sich mit dem Angesicht bis zur Erde',
        2: 'und sagte: »Bitte, meine Herren! Kehrt doch im Hause eures Knechtes ein, um dort zu übernachten, und wascht euch die Füße; morgen früh mögt ihr euch dann wieder aufmachen und eures Weges ziehen.« Sie aber antworteten: »Nein, wir wollen hier im Freien übernachten.«',
        ...
        14: 'Da ging Lot aus dem Hause hinaus und sagte zu seinen Schwiegersöhnen, die seine Töchter geheiratet hatten: »Macht euch auf und verlaßt diesen Ort! Denn der HERR will die Stadt zerstören.« Aber er kam seinen Schwiegersöhnen vor wie einer, der Scherz (mit ihnen) trieb.',
        ...
        22: 'Flüchte dich eilends dorthin! denn ich kann nichts tun, bis du dorthin gekommen bist.« Daher hat der Ort den Namen Zoar erhalten.',
        ...
        37: 'Und die ältere gebar einen Sohn und nannte ihn »Moab«; der ist der Stammvater der heutigen Moabiter.',
        38: 'Die jüngere gebar auch einen Sohn und gab ihm den Namen »Ben-Ammi«; der ist der Stammvater der heutigen Ammoniter.',
    },
    20: {
    ...
    21: {
        ...
        3: 'Abraham gab dann seinem Sohne, der ihm geboren worden war, den Sara ihm geboren hatte, den Namen Isaak',
        ...
        31: 'Darum nennt man jenen Ort »Beerseba«, weil sie beide dort einander geschworen haben.',
        32: 'Nachdem sie so einen Vertrag zu Beerseba geschlossen hatten, brach Abimelech mit seinem Heerführer Pichol auf, und sie kehrten ins Philisterland zurück.',
    ...
    22: {
        1: 'Nach diesen Begebenheiten wollte Gott den Abraham auf die Probe stellen und sagte zu ihm: »Abraham!« Dieser antwortete: »Hier bin ich!«',
        ...
        3: 'Da sattelte Abraham am andern Morgen früh seinen Esel und nahm zwei von seinen Knechten und seinen Sohn Isaak mit sich; er spaltete Holzscheite für das Brandopfer und machte sich dann auf den Weg nach dem Orte, den Gott ihm angegeben hatte.',
        ...
        14: 'Abraham nannte dann jenen Ort: »Der HERR sieht«; deshalb sagt man noch heutigentags: »Auf dem Berge, wo der HERR gesehen wird«.',
        ...
        18: 'und in deiner Nachkommenschaft sollen alle Völker der Erde gesegnet werden zum Lohn dafür, daß du meiner Aufforderung nachgekommen bist!«',
    ...
    25: {
        ...
        7: 'Dies aber ist die Zeit der Lebensjahre, die Abraham gelebt hat: 175 Jahre;',
        ...
        11: 'Nach Abrahams Tode aber segnete Gott dessen Sohn Isaak; dieser wohnte bei dem ›Brunnen des Lebendigen, der mich sieht‹.',
        12: 'Dies ist der Stammbaum Ismaels, des Sohnes Abrahams, den die Ägypterin Hagar, die Leibmagd Saras, dem Abraham geboren hat;',
        ...
        19: 'Dies ist der Stammbaum Isaaks, des Sohnes Abrahams: Abraham war der Vater Isaaks;',
        20: 'und Isaak war vierzig Jahre alt, als er Rebekka, die Tochter des Aramäers Bethuel aus Nord-Mesopotamien, die Schwester des Aramäers Laban, zur Frau nahm.',
        21: 'Und Isaak betete zum HERRN für seine Frau, denn sie hatte keine Kinder; da ließ der HERR sich von ihm erbitten, so daß seine Frau Rebekka guter Hoffnung wurde.',
    ...
    32: {
        ...
        18: 'Dann gab er dem ersten folgende Weisung: »Wenn mein Bruder Esau dir begegnet und dich fragt: ›Wem gehörst du, und wohin willst du, und wem gehören die Tiere, die du da treibst?‹,',
        ...
        32: 'Als er dann an Pniel vorübergezogen war, ging ihm die Sonne auf; er hinkte aber an seiner Hüfte.',
    ...
    39: {
        ...
        11: 'Nun begab es sich eines Tages, daß Joseph, wie gewöhnlich, ins Haus kam, um seine Geschäfte zu besorgen, während gerade keiner von den Hausangehörigen drinnen im Hause anwesend war.',
    ...
    49: {
        ...
        29: 'Dann erteilte er ihnen folgenden Auftrag: »Wenn ich jetzt zu meinen Stammesgenossen versammelt bin, so begrabt mich bei meinen Vätern in der Höhle auf dem Felde des Hethiters Ephron,',
    ...
    50: {
        ...
        4: 'Als dann die Zeit der Trauer um ihn vorüber war, sagte Joseph zu den Hofbeamten des Pharaos: »Wenn ich Gnade bei euch gefunden habe, so bringt doch folgendes zur Kenntnis des Pharaos:',
        ...
        10: 'Als sie nun nach Goren-Haatad, das jenseits des Jordans liegt, gekommen waren, veranstalteten sie dort eine große und sehr feierliche Totenklage, und (Joseph) stellte um seinen Vater eine siebentägige Leichenfeier an.',
        ...
        17: '›So sollt ihr zu Joseph sagen: Ach bitte, vergib doch deinen Brüdern ihr Vergehen und ihre Verschuldung, daß sie so übel an dir gehandelt haben!‹ So vergib uns nun doch unser Vergehen; wir sind ja doch auch Knechte des Gottes deines Vaters!« Da weinte Joseph, als sie ihm das sagen ließen.',
        ...
        20: 'Ihr freilich hattet Böses gegen mich im Sinn, aber Gott gedachte es zum Guten zu wenden, um das auszuführen, was jetzt klar zutage liegt, nämlich um ein zahlreiches Volk am Leben zu erhalten.',
        ...
        26: 'Dann starb Joseph im Alter von 110 Jahren; man balsamierte ihn ein und legte ihn in Ägypten in einen Sarg.',
    },
}
