...
CHAPTERS = {
    1: {
        ...
        50: 'From age to age his mercy rests On those who honour him.',
    ...
    3: {
        ...
        3: 'And John went through the whole district of the Jordan, proclaiming baptism on repentance, for the forgiveness of sins.',
    ...
    6: {
        ...
        40: 'A scholar is not above their teacher; yet every finished scholar will be like their teacher.',
    ...
    8: {
        ...
        37: 'Then all the people in the neighbourhood of the Gerasenes asked Jesus to leave them, for they were terrified. Jesus got into a boat and returned.',
    ...
    14: {
        ...
        12: 'Then Jesus went on to say to the man who had invited him: “When you give a breakfast or a dinner, do not ask your friends, or your brothers or sisters, or your relations, or rich neighbours, because they might invite you in return, and so you should be repaid.',
    ...
    17: {
        ...
        2: 'It would be good for them if they had been flung into the sea with a millstone round their neck, rather than that they should prove a trap even one of these little ones.',
