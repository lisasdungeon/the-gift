...
CHAPTERS = {
    1: {
        ...
        15: 'εσται γαρ μεγας ενωπιον του OMIT του κυριου και οινον και σικερα ου μη πιη και πνευματος αγιου πλησθησεται ετι εκ κοιλιας μητρος αυτου',
    ...
    2: {
        ...
        21: 'και οτε επλησθησαν ημεραι οκτω του περιτεμειν αυτον και εκληθη το ονομα αυτου ιησους το κληθεν υπο του αγγελου προ του συλληφθηναι αυτον εν τη κοιλια',
    ...
    3: {
        ...
        26: 'του μααθ του ματταθιου του σεμει σεμεει του ιωσηφ του ιουδα',
        27: 'του ιωαναν ιωαννα του ρησα του ζοροβαβελ του σαλαθιηλ του νηρι',
        ...
        33: 'του αμιναδαβ του αραμ αραμ του ιωραμ του εσρωμ του φαρες του ιουδα',
        34: 'του ιακωβ του ισαακ του αβρααμ του θαρα θαρρα του ναχωρ',
        35: 'του σερουχ του ραγαυ του φαλεγ φαλεκ του εβερ του σαλα',
    ...
    4: {
        ...
        4: 'και απεκριθη ιησους προς αυτον λεγων γεγραπται οτι ουκ επ αρτω μονω ζησεται ανθρωπος ο ανθρωπος αλλ επι παντι ρηματι θεου',
        ...
        41: 'εξηρχετο δε και δαιμονια απο πολλων κραζοντα κραυγαζοντα και λεγοντα οτι συ ει 1510 ο χριστος ο υιος του θεου και επιτιμων ουκ εια αυτα λαλειν οτι ηδεισαν τον χριστον αυτον ειναι',
    ...
    5: {
        ...
        6: 'και τουτο ποιησαντες συνεκλεισαν πληθος ιχθυων πολυ διερρηγνυτο δε το δικτυον αυτων',
        ...
        25: 'και παραχρημα αναστας ενωπιον αυτων αρας εφ ο κατεκειτο 2621 απηλθεν εις τον οικον αυτου δοξαζων τον θεον',
        ...
        30: 'και εγογγυζον οι γραμματεις αυτων και οι φαρισαιοι προς τους μαθητας αυτου λεγοντες δια τι μετα των OMIT των τελωνων και αμαρτωλων εσθιετε και πινετε',
        ...
        36: 'ελεγεν δε και παραβολην προς αυτους οτι ουδεις επιβλημα ιματιου καινου επιβαλλει επι ιματιον παλαιον ει δε μηγε και το καινον σχιζει και τω παλαιω ου συμφωνει το απο του καινου',
    ...
    6: {
        ...
        10: 'και περιβλεψαμενος παντας αυτους ειπεν αυτω εκτεινον την χειρα σου ο δε εποιησεν και αποκατεσταθη η χειρ αυτου υγιης ως η αλλη',
        ...
        18: 'και οι οχλουμενοι υπο απο πνευματων ακαθαρτων και εθεραπευοντο',
        ...
        23: 'χαρητε εν εκεινη τη ημερα και σκιρτησατε ιδου γαρ ο μισθος υμων πολυς εν τω ουρανω κατα ταυτα γαρ εποιουν τοις προφηταις οι πατερες αυτων',
        ...
        26: 'ουαι οταν καλως υμας ειπωσιν οι παντες οι ανθρωποι κατα ταυτα γαρ εποιουν τοις ψευδοπροφηταις οι πατερες αυτων',
        27: 'αλλ αλλα υμιν λεγω τοις ακουουσιν αγαπατε τους εχθρους υμων καλως ποιειτε τοις μισουσιν υμας',
        ...
        34: 'και εαν δανειζητε 1155 παρ ων ελπιζετε 1679 απολαβειν ποια υμιν χαρις εστιν και γαρ αμαρτωλοι αμαρτωλοις δανειζουσιν ινα απολαβωσιν τα ισα',
    ...
    7: {
        ...
        2: 'εκατονταρχου δε τινος δουλος κακως εχων εμελλεν τελευταν ος ην αυτω εντιμος',
        ...
        6: 'ο δε ιησους επορευετο συν αυτοις ηδη δε αυτου ου μακραν απεχοντος απο της οικιας επεμψεν προς αυτον ο εκατονταρχος φιλους λεγων αυτω κυριε μη σκυλλου ου γαρ ειμι ικανος ινα υπο την στεγην μου μου υπο την στεγην εισελθης',
        ...
        9: 'ακουσας δε ταυτα ο ιησους εθαυμασεν αυτον και στραφεις τω ακολουθουντι αυτω οχλω ειπεν λεγω υμιν ουτε ουδε εν τω ισραηλ τοσαυτην πιστιν ευρον',
        10: 'και υποστρεψαντες οι πεμφθεντες εις τον οικον ευρον τον ασθενουντα δουλον υγιαινοντα',
        11: 'και εγενετο εν τω τη εξης επορευετο εις πολιν καλουμενην ναιν και συνεπορευοντο αυτω οι μαθηται αυτου ικανοι και οχλος πολυς',
        12: 'ως δε ηγγισεν τη πυλη της πολεως και ιδου εξεκομιζετο τεθνηκως υιος μονογενης τη μητρι αυτου και αυτη χηρα ην χηρα και οχλος της πολεως ικανος συν αυτη',
        ...
        19: 'και προσκαλεσαμενος δυο τινας των μαθητων αυτου ο ιωαννης επεμψεν προς τον ιησουν λεγων συ ει ο ερχομενος η αλλον προσδοκωμεν 4328',
        ...
        24: 'απελθοντων δε των αγγελων ιωαννου ηρξατο λεγειν τοις οχλοις περι ιωαννου τι εξεληλυθατε εις την ερημον θεασασθαι καλαμον υπο ανεμου σαλευομενον',
        ...
        32: 'ομοιοι εισιν παιδιοις τοις εν αγορα καθημενοις και προσφωνουσιν 4377 αλληλοις και λεγουσιν 3004 ηυλησαμεν υμιν και ουκ ωρχησασθε εθρηνησαμεν υμιν και ουκ εκλαυσατε',
        ...
        37: 'και ιδου γυνη εν τη πολει ητις ην αμαρτωλος επιγνουσα και επιγνουσα οτι ανακειται εν τη οικια του φαρισαιου κομισασα αλαβαστρον μυρου',
        ...
        46: 'ελαιω την κεφαλην μου ουκ ηλειψας αυτη δε μυρω ηλειψεν μου τους ποδας τους ποδας μου',
    ...
    8: {
        ...
        3: 'και ιωαννα γυνη χουζα επιτροπου ηρωδου και σουσαννα σωσαννα και ετεραι πολλαι αιτινες διηκονουν αυτοις απο των υπαρχοντων αυταις',
        ...
        18: 'βλεπετε ουν πως ακουετε ος γαρ εαν εχη δοθησεται 1325 αυτω και ος εαν μη εχη και ο δοκει εχειν αρθησεται απ αυτου',
        ...
        31: 'και παρεκαλει αυτον ινα μη επιταξη αυτοις εις την αβυσσον απελθειν',
        ...
        42: 'οτι θυγατηρ μονογενης ην αυτω ως ετων δωδεκα και αυτη αυτη απεθνησκεν εν δε τω υπαγειν αυτον οι οχλοι συνεπνιγον αυτον',
    ...
    9: {
        ...
        5: 'και οσοι εαν μη δεξωνται υμας εξερχομενοι απο της πολεως εκεινης και τον κονιορτον απο των ποδων υμων αποτιναξατε εις μαρτυριον επ αυτους',
        ...
        9: 'και ειπεν ηρωδης ιωαννην εγω απεκεφαλισα τις δε εστιν ουτος περι ου εγω ακουω τοιαυτα και εζητει ιδειν αυτον',
        10: 'και υποστρεψαντες οι αποστολοι διηγησαντο αυτω οσα εποιησαν και παραλαβων αυτους υπεχωρησεν κατ ιδιαν εις τοπον ερημον πολεως καλουμενης βηθσαιδαν',
        ...
        13: 'ειπεν δε προς αυτους δοτε αυτοις υμεις φαγειν οι δε ειπον ουκ εισιν ημιν πλειον η πεντε αρτοι και ιχθυες δυο ει μητι πορευθεντες ημεις αγορασωμεν εις παντα τον λαον τουτον βρωματα',
        ...
        22: 'ειπων οτι δει τον υιον του ανθρωπου πολλα παθειν και αποδοκιμασθηναι απο των πρεσβυτερων και αρχιερεων και γραμματεων και αποκτανθηναι και τη τριτη ημερα αναστηναι εγερθηναι',
        23: 'ελεγεν δε προς παντας ει τις θελει οπισω μου ελθειν απαρνησασθω εαυτον και αρατω τον σταυρον αυτου και ακολουθειτω μοι',
        ...
        33: 'και εγενετο εν τω διαχωριζεσθαι αυτους απ αυτου ειπεν πετρος προς τον ιησουν επιστατα καλον εστιν ημας ωδε ειναι και ποιησωμεν σκηνας τρεις μιαν σοι και μιαν μωση μωσει και μιαν ηλια μη ειδως ο λεγει',
        ...
        38: 'και ιδου ανηρ απο του οχλου ανεβοησεν λεγων διδασκαλε δεομαι σου επιβλεψαι επιβλεψον επι τον υιον μου οτι μονογενης εστιν μοι',
        ...
        41: 'αποκριθεις δε ο ιησους ειπεν ω γενεα απιστος και διεστραμμενη εως ποτε εσομαι προς υμας και ανεξομαι υμων προσαγαγε τον υιον σου ωδε',
        ...
        55: 'στραφεις δε επετιμησεν αυτοις και ειπεν ουκ οιδατε οιου πνευματος εστε υμεις OMIT και ειπεν ουκ οιδατε οιου πνευματος εστε υμεις',
        56: 'ο γαρ υιος του ανθρωπου ουκ ηλθεν ψυχας ανθρωπων απολεσαι αλλα σωσαι OMIT ο γαρ υιος του ανθρωπου ουκ ηλθεν ψυχας ανθρωπων απολεσαι αλλα σωσαι και επορευθησαν εις ετεραν κωμην',
        57: 'εγενετο δε πορευομενων αυτων εν τη οδω ειπεν τις προς αυτον ακολουθησω σοι οπου αν εαν απερχη κυριε',
        ...
        62: 'ειπεν δε ο ιησους προς αυτον ουδεις επιβαλων την χειρα αυτου επ αροτρον και βλεπων εις τα οπισω ευθετος εστιν εις την βασιλειαν του θεου',
    },
    10: {
    ...
    11: {
        ...
        6: 'επειδη φιλος παρεγενετο εξ οδου προς με και ουκ εχω ο παραθησω αυτω',
        ...
        8: 'λεγω υμιν ει και ου δωσει αυτω αναστας δια το ειναι αυτου φιλον δια γε την αναιδειαν αυτου εγερθεις δωσει αυτω οσον χρηζει',
        ...
        32: 'ανδρες νινευι νινευιται αναστησονται εν τη κρισει μετα της γενεας ταυτης και κατακρινουσιν αυτην οτι μετενοησαν εις το κηρυγμα ιωνα και ιδου πλειον ιωνα ωδε',
        33: 'ουδεις δε λυχνον αψας εις κρυπτην τιθησιν ουδε υπο τον μοδιον αλλ επι την λυχνιαν ινα οι εισπορευομενοι το φεγγος βλεπωσιν',
        ...
        44: 'ουαι υμιν γραμματεις και φαρισαιοι υποκριται οτι εστε ως τα μνημεια τα αδηλα και οι ανθρωποι περιπατουντες επανω ουκ οιδασιν',
        ...
        54: 'ενεδρευοντες αυτον ζητουντες θηρευσαι τι εκ του στοματος αυτου ινα κατηγορησωσιν αυτου',
    },
    12: {
        ...
        15: 'ειπεν δε προς αυτους ορατε και φυλασσεσθε απο της πλεονεξιας οτι ουκ εν τω περισσευειν τινι η ζωη αυτω εστιν εκ των υπαρχοντων αυτου',
        ...
        25: 'τις δε εξ υμων μεριμνων δυναται προσθειναι προσθηναι επι την ηλικιαν αυτου πηχυν ενα',
        ...
        58: 'ως γαρ υπαγεις μετα του αντιδικου σου επ αρχοντα εν τη οδω δος εργασιαν απηλλαχθαι απ αυτου μηποτε κατασυρη σε προς τον κριτην και ο κριτης σε παραδω τω πρακτορι και ο πρακτωρ σε βαλη εις φυλακην',
        59: 'λεγω σοι ου μη εξελθης εκειθεν εως ου και τον εσχατον λεπτον αποδως',
    },
    13: {
        ...
        15: 'απεκριθη ουν αυτω ο κυριος και ειπεν υποκριται εκαστος υμων τω σαββατω ου λυει τον βουν αυτου η τον ονον απο της φατνης και απαγαγων ποτιζει',
        ...
        29: 'και ηξουσιν απο ανατολων και δυσμων και βορρα και νοτου και ανακλιθησονται εν τη βασιλεια του θεου',
        ...
        34: 'ιερουσαλημ ιερουσαλημ η αποκτενουσα αποκτεινουσα τους προφητας και λιθοβολουσα τους απεσταλμενους προς αυτην ποσακις ηθελησα επισυναξαι τα τεκνα σου ον τροπον ορνις την εαυτης νοσσιαν υπο τας πτερυγας και ουκ ηθελησατε',
    ...
    14: {
        ...
        24: 'λεγω γαρ υμιν οτι ουδεις των ανδρων εκεινων των κεκλημενων γευσεται μου του δειπνου πολλοι γαρ εισιν κλητοι ολιγοι δε εκλεκτοι OMIT πολλοι γαρ εισιν κλητοι ολιγοι δε εκλεκτοι',
        ...
        28: 'τις γαρ εξ υμων ο θελων πυργον οικοδομησαι ουχι πρωτον καθισας ψηφιζει την δαπανην ει εχει τα εις προς απαρτισμον',
    ...
    15: {
        ...
        20: 'και αναστας ηλθεν προς τον πατερα αυτου εαυτου ετι δε αυτου μακραν απεχοντος ειδεν αυτον ο πατηρ αυτου και εσπλαγχνισθη και δραμων επεπεσεν επι τον τραχηλον αυτου και κατεφιλησεν αυτον',
    ...
    17: {
        ...
        10: 'ουτως και υμεις οταν ποιησητε παντα τα διαταχθεντα υμιν λεγετε οτι δουλοι αχρειοι εσμεν οτι ο οφειλομεν ωφειλομεν ποιησαι πεποιηκαμεν',
    ...
    18: {
        ...
        5: 'δια γε το παρεχειν μοι κοπον την χηραν ταυτην εκδικησω αυτην ινα μη εις τελος ερχομενη υποπιαζη με',
        6: 'ειπεν δε ο κυριος ακουσατε τι ο κριτης της αδικιας λεγει',
        7: 'ο δε θεος ου μη ποιηση ποιησει την εκδικησιν των εκλεκτων αυτου των βοωντων προς αυτον ημερας και νυκτος και μακροθυμων επ αυτοις',
    ...
    19: {
        ...
        4: 'και προδραμων εμπροσθεν ανεβη επι συκομωραιαν ινα ιδη αυτον οτι εκεινης δι εκεινης εμελλεν διερχεσθαι',
        ...
        15: 'και εγενετο εν τω επανελθειν αυτον λαβοντα την βασιλειαν και OMIT και ειπεν φωνηθηναι αυτω τους δουλους τουτους οις εδωκεν το αργυριον ινα γνω τις τι διεπραγματευσατο',
        ...
        29: 'και εγενετο ως ηγγισεν εις βηθσφαγη βηθφαγη και βηθανιαν προς το ορος το καλουμενον ελαιων απεστειλεν δυο των μαθητων αυτου',
    ...
    20: {
        1: 'και εγενετο εν μια των ημερων εκεινων διδασκοντος αυτου τον λαον εν τω ιερω και ευαγγελιζομενου επεστησαν οι ιερεις και οι γραμματεις συν τοις πρεσβυτεροις',
        ...
        9: 'ηρξατο δε προς τον λαον λεγειν την παραβολην ταυτην ανθρωπος εφυτευσεν αμπελωνα και εξεδοτο αυτον γεωργοις και απεδημησεν χρονους ικανους',
        ...
        19: 'και εζητησαν οι αρχιερεις και οι γραμματεις επιβαλειν επ αυτον τας χειρας εν αυτη τη ωρα και εφοβηθησαν εγνωσαν γαρ οτι προς αυτους την παραβολην ταυτην ειπεν',
        ...
        31: 'και ο τριτος ελαβεν αυτην ωσαυτως ωσαυτως δε και οι επτα ου κατελιπον τεκνα και απεθανον',
        32: 'υστερον δε OMIT δε παντων απεθανεν και η γυνη',
        ...
        37: 'οτι δε εγειρονται οι νεκροι και μωσης μωυσης εμηνυσεν επι της βατου ως λεγει κυριον τον θεον αβρααμ και τον θεον ισαακ και τον θεον ιακωβ',
    ...
    21: {
        ...
        22: 'οτι ημεραι εκδικησεως αυται εισιν του πλησθηναι πληρωθηναι παντα τα γεγραμμενα',
    ...
    22: {
        ...
        9: 'οι δε ειπον αυτω που θελεις ετοιμασομεν ετοιμασωμεν',
        ...
        30: 'ινα εσθιητε και πινητε επι της τραπεζης μου μου εν τη βασιλεια μου και καθισεσθε επι θρονων κρινοντες τας δωδεκα φυλας του ισραηλ',
        31: 'ειπεν δε ο κυριος σιμων σιμων ιδου ο σατανας εξητησατο υμας του σινιασαι ως τον σιτον',
        32: 'εγω δε εδεηθην περι σου ινα μη εκλιπη εκλειπη η πιστις σου και συ ποτε επιστρεψας στηριξον τους αδελφους σου',
        ...
        42: 'λεγων πατερ ει βουλει παρενεγκειν το ποτηριον τουτο απ εμου πλην μη το θελημα μου αλλα το σον γενεσθω γινεσθω',
    ...
    24: {
        1: 'τη δε μια των σαββατων ορθρου βαθεος βαθεως ηλθον επι το μνημα φερουσαι α ητοιμασαν αρωματα και τινες συν αυταις',
        ...
        10: 'ησαν δε η μαγδαληνη μαρια και ιωαννα και μαρια ιακωβου η ιακωβου και αι λοιπαι συν αυταις αι ελεγον προς τους αποστολους ταυτα',
