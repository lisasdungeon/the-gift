...
CHAPTERS = {
    1: {
        ...
        26: 'εν δε τω μηνι τω εκτω απεσταλη ο αγγελος γαβριηλ υπο του θεου εις πολιν της γαλιλαιας η ονομα ναζαρετ ναζαρεθ',
        ...
        74: 'του δουναι ημιν (1:74) αφοβως εκ χειρος των εχθρων ημων ρυσθεντας λατρευειν αυτω',
    ...
    2: {
        ...
        4: 'ανεβη δε και ιωσηφ απο της γαλιλαιας εκ πολεως ναζαρετ ναζαρεθ εις την ιουδαιαν εις πολιν δαβιδ ητις καλειται 2564 βηθλεεμ δια το ειναι αυτον εξ οικου και πατριας δαβιδ',
        ...
        22: 'και οτε επλησθησαν αι ημεραι του καθαρισμου αυτων αυτης κατα τον νομον μωσεως ανηγαγον αυτον εις ιεροσολυμα παραστησαι τω κυριω',
        ...
        34: 'και ευλογησεν αυτους συμεων σιμεων και ειπεν προς μαριαμ την μητερα αυτου ιδου ουτος κειται εις πτωσιν και αναστασιν πολλων εν τω ισραηλ και εις σημειον αντιλεγομενον',
        ...
        39: 'και ως ετελεσαν απαντα τα κατα τον νομον κυριου υπεστρεψαν εις την γαλιλαιαν εις την πολιν αυτων ναζαρετ ναζαρεθ',
        ...
        51: 'και κατεβη μετ αυτων και ηλθεν εις ναζαρετ ναζαρεθ και ην υποτασσομενος αυτοις και η μητηρ αυτου διετηρει παντα τα ρηματα ταυτα εν τη καρδια αυτης',
    ...
    3: {
        ...
        30: 'του συμεων σιμεων του ιουδα του ιωσηφ του ιωναν του ελιακειμ',
        31: 'του μελεα του μαιναν μεναμ 0 του ματταθα του ναθαν του δαβιδ',
    ...
    4: {
        ...
        16: 'και ηλθεν εις την ναζαρετ ναζαρεθ ου ην τεθραμμενος και εισηλθεν κατα το ειωθος αυτω εν τη ημερα των σαββατων εις την συναγωγην και ανεστη αναγνωναι',
    ...
    6: {
        ...
        9: 'ειπεν ουν ο ιησους προς αυτους επερωτησω υμας τι τι εξεστιν τοις σαββασιν αγαθοποιησαι η κακοποιησαι ψυχην σωσαι η απολεσαι',
        ...
        34: 'και εαν δανειζητε παρ ων ελπιζετε ελπιζητε απολαβειν ποια υμιν χαρις εστιν και γαρ οι αμαρτωλοι αμαρτωλοις δανειζουσιν ινα απολαβωσιν τα ισα',
    ...
    8: {
        ...
        29: 'παρηγγελλεν παρηγγειλεν γαρ τω πνευματι τω ακαθαρτω εξελθειν απο του ανθρωπου πολλοις γαρ χρονοις συνηρπακει αυτον και εδεσμειτο αλυσεσιν και πεδαις φυλασσομενος και διαρρησσων τα δεσμα ηλαυνετο υπο του δαιμονος εις τας ερημους',
        30: 'επηρωτησεν δε αυτον ο ιησους λεγων τι σοι εστιν ονομα ο δε ειπεν λεγεων οτι δαιμονια πολλα εισηλθεν εις αυτον',
        31: 'και παρεκαλει παρεκαλουν αυτον ινα μη επιταξη αυτοις εις την αβυσσον απελθειν',
    ...
    9: {
        ...
        36: 'και εν τω γενεσθαι την φωνην ευρεθη ο ιησους μονος και αυτοι εσιγησαν και ουδενι απηγγειλαν εν εκειναις ταις ημεραις ουδεν ων εωρακασιν 3708',
    ...
    10: {
        ...
        19: 'ιδου διδωμι υμιν την εξουσιαν του πατειν επανω οφεων και σκορπιων και επι πασαν την δυναμιν του εχθρου και ουδεν υμας ου μη αδικηση αδικησει',
    ...
    12: {
        ...
        20: 'ειπεν δε αυτω ο θεος αφρων αφρον ταυτη τη νυκτι την ψυχην σου απαιτουσιν απο σου α δε ητοιμασας τινι εσται',
        ...
        56: 'υποκριται το προσωπον της γης και του ουρανου του ουρανου και της γης οιδατε δοκιμαζειν τον δε καιρον τουτον πως ου δοκιμαζετε',
    ...
    15: {
        ...
        26: 'και προσκαλεσαμενος ενα των παιδων αυτου επυνθανετο τι ειη ταυτα',
    ...
    22: {
        ...
        42: 'λεγων πατερ ει βουλει παρενεγκειν παρενεγκε το ποτηριον τουτο απ εμου πλην μη το θελημα μου αλλα το σον γενεσθω',
        ...
        45: 'και αναστας απο της προσευχης ελθων προς τους μαθητας αυτου ευρεν αυτους κοιμωμενους απο της λυπης',
    ...
    24: {
        ...
        53: 'και ησαν διαπαντος δια παντος εν τω ιερω αινουντες και ευλογουντες τον θεον αμην',
    },
}
