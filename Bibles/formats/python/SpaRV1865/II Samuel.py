...
CHAPTERS = {
    1: {
        1: 'Y aconteció después de la muerte de Saul, que vuelto David de la derrota de los Amalecitas, estuvo dos días en Siceleg:',
        2: 'Y al tercero día aconteció, que llegó uno del campo de Saul, rotos sus vestidos, y esparcida tierra sobre su cabeza. Y llegando a David, postróse en tierra, y le hizo reverencia.',
        3: 'Y preguntóle David: ¿De dónde vienes? Y él respondió: Heme escapado del campo de Israel.',
        4: 'Y David le dijo: ¿Qué ha acontecido? Ruégote que me lo digas. Y él respondió: El pueblo huyó de la batalla, y también muchos del pueblo cayeron y son muertos: también Saul, y Jonatán su hijo murieron.',
        5: 'Y dijo David a aquel mancebo que le daba las nuevas: ¿Cómo sabes que Saul es muerto, y Jonatán su hijo?',
        6: 'Y el mancebo que le daba las nuevas respondió: Por casualidad vine al monte de Gelboé, y, he aquí Saul que estaba recostado sobre su lanza, y venían tras él carros y gente de a caballo:',
        7: 'Y como él miró atrás, me vio, y me llamó: y yo dije: Heme aquí:',
        8: 'Y él me dijo: ¿Quién eres tú? Y yo le respondí: Soy Amalecita.',
        9: 'Y él me volvió a decir: Yo te ruego que te pongas sobre mí, y me mates, porque me toman angustias, y aun toda mi alma está en mí.',
        10: 'Yo entonces púseme sobre él, y le maté: porque sabía que no podía vivir después de su caída. Y tomé la corona que tenía en su cabeza, y la ajorca que traía en su brazo, y las he traído acá a mi señor.',
        11: 'Entonces David trabando de sus vestidos rompiólos, y lo mismo hicieron los varones que estaban con él.',
        12: 'Y lloraron, y lamentaron; y ayunaron hasta la tarde por Saul y por Jonatán su hijo, y por el pueblo de Jehová, y por la casa de Israel, que habían caído a cuchillo.',
        13: '¶ Y David dijo a aquel mancebo, que le había traído las nuevas: ¿De dónde eres tú? Y él respondió: Yo soy hijo de un extranjero, Amalecita.',
        14: 'Y díjole David: ¿Cómo no hubiste temor de extender tu mano para matar al ungido de Jehová?',
        15: 'Entonces David llamó a uno de los mancebos, y díjole: Llega, y mátale. Y él le hirió, y murió.',
        ...
        17: 'Y endechó David a Saul y a Jonatán su hijo, con esta endecha.',
        18: 'Y dijo, que enseñasen al arco a los hijos de Judá. He aquí que así está escrito en el libro del derecho.',
        19: '¶ La gloria de Israel, muertos sobre tus collados: ¡cómo han caído los valientes!',
        20: 'No lo denunciéis en Get, no deis las nuevas en las plazas de Ascalón; porque no se alegren las hijas de los Filisteos: porque no salten de gozo las hijas de los incircuncisos.',
        21: 'Montes de Gelboé, ni rocío ni lluvia caiga sobre vosotros; ni seáis tierras de ofrendas: porque allí fue desechado el escudo de los valientes, el escudo de Saul, como si no hubiera sido ungido de aceite.',
        22: 'Sin sangre de muertos, sin sebo de valientes, el arco de Jonatán nunca volvió atrás, ni la espada de Saul se tornó vacía.',
        23: 'Saul y Jonatán amados y queridos en su vida, en su muerte tampoco fueron apartados. Más ligeros que águilas, más fuertes que leones.',
        24: 'Hijas de Israel llorád sobre Saul, que os vestía de escarlata en placeres: que adornaba vuestras ropas con ornamentos de oro.',
    ...
    2: {
        1: 'Después de esto aconteció que David consultó a Jehová, diciendo: ¿Subiré a alguna de las ciudades de Judá? Y Jehová le respondió: Sube. Y David tornó a decir. ¿Adónde subiré? Y él le dijo: a Hebrón.',
        2: 'Y David subió allá, y con él sus dos mujeres Aquinoam Jezraelita, y Abigail, la mujer de Nabal del Carmelo.',
        3: 'Y trajo también David consigo los varones que habían estado con él, cada uno con su familia: los cuales moraron en las ciudades de Hebrón.',
        4: 'Y vinieron los varones de Judá, y ungieron allí a David por rey sobre la casa de Judá. Y dieron aviso a David, diciendo: Los de Jabes de Galaad son los que sepultaron a Saul.',
        5: '¶ Y David envió mensajeros a los de Jabes de Galaad, diciéndoles: Benditos seáis vosotros de Jehová, que habéis hecho esta misericordia con vuestro señor Saul, que le habéis sepultado.',
        6: 'Ahora pues Jehová hará con vosotros misericordia y verdad: y yo también os haré bien, por esto que habéis hecho.',
        7: 'Esfuércense pues ahora vuestras manos, y sed valientes, pues que muerto Saul vuestro señor, los de la casa de Judá me han ungido por rey sobre sí.',
        8: '¶ Y Abner, hijo de Ner, general del ejército de Saul, tomó a Is-boset, hijo de Saul, e hízole pasar al real.',
        9: 'Y alzóle por rey sobre Galaad, y sobre Gessuri, y sobre Jezrael, y sobre Efraím, y sobre Ben-jamín, y sobre todo Israel.',
        10: 'De cuarenta años era Is-boset, hijo de Saul, cuando comenzó a reinar sobre Israel, y reinó dos años: sola la casa de Judá seguía a David.',
        11: 'Y fue el número de los días que David reinó en Hebrón sobre la casa de Judá, siete años y seis meses.',
        12: 'Y Abner, hijo de Ner, salió del real a Gabaón con los siervos de Is-boset, hijo de Saul.',
        13: 'Y Joab, hijo de Sarvia, y los criados de David salieron, y encontráronlos junto al estanque de Gabaón; y como se juntaron, los unos se pararon de la una parte del estanque, y los otros de la otra.',
        14: 'Y dijo Abner a Joab: Levántense ahora los mancebos, y jueguen delante de nosotros. Y Joab respondió: Levanten.',
        15: 'Entonces levantáronse, y pasaron doce por cuenta de Ben-jamín de la parte de Is-boset, hijo de Saul: y otros doce de los siervos de David.',
        16: 'Y cada uno echó mano de la cabeza de su compañero, y metió su espada por el lado de su compañero, y cayeron a una: y fue llamado aquel lugar Helcat-assurim, el cual es en Gabaón.',
        17: 'Y hubo aquel día una batalla muy recia, donde Abner y los varones de Israel fueron vencidos de los siervos de David.',
        18: 'Y estaban allí los tres hijos de Sarvia, Joab, y Abisaí, y Asael. Este Asael era suelto de pies como un corzo del campo.',
        19: 'El cual Asael siguió a Abner, yendo sin apartarse a diestra ni a siniestra en pos de Abner.',
        20: 'Y Abner miró atrás, y dijo: ¿No eres tú Asael? Y él respondió: Sí.',
        21: 'Entonces Abner le dijo: Apártate, o a la derecha, o a la izquierda, y préndete alguno de los mancebos, y tómate sus despojos. Y Asael no quiso apartarse de en pos de él.',
        22: 'Y Abner tornó a decir a Asael: Apártate de en pos de mí, porque te heriré en tierra, y después ¿cómo levantaré mi rostro a tu hermano Joab?',
        23: 'Y no queriendo él irse, hirióle Abner con la parte opuesta de la lanza, junto a la quinta costilla, y la lanza le salió por las espaldas, y cayó allí, y murió en aquel mismo lugar. Y todos los que venían por aquel lugar donde Asael había caído, y estaba muerto, se paraban.',
        24: 'Y Joab y Abisaí siguieron a Abner, y púsoseles el sol, cuando llegaron al collado de Amma, que está delante de Gia, junto al camino del desierto de Gabaón.',
        25: 'Y juntáronse los hijos de Ben-jamín en un escuadrón con Abner; y paráronse en la cumbre del collado.',
        ...
        27: 'Y Joab respondió: Vive Dios que si no hubieras hablado, ya desde esta mañana el pueblo hubiera cesado de seguir a sus hermanos.',
        28: 'Entonces Joab tocó el cuerno, y todo el pueblo se detuvo, y no siguió más a los de Israel, ni peleó más.',
        29: 'Y Abner y los suyos se fueron por la campaña toda aquella noche, y pasando el Jordán caminaron por todo Bet-orón, y vinieron al real.',
        30: 'Joab también vuelto de seguir a Abner, juntando todo el pueblo, faltaron de los siervos de David diez y nueve hombres, y Asael.',
        31: 'Y los siervos de David hirieron de los de Ben-jamín, y de los de Abner: trescientos y sesenta hombres murieron. Y tomaron a Asael, y sepultáronle en el sepulcro de su padre en Belén.',
        32: 'Y caminaron toda aquella noche, Joab y los suyos: y amanecióles en Hebrón.',
    },
    3: {
        1: 'Y hubo luenga guerra entre la casa de Saul, y la casa de David: mas David se iba fortificando, y la casa de Saul iba en diminución.',
        2: 'Y nacieron hijos a David en Hebrón. Su primogénito fue Amnón de Aquinoam Jezraelita.',
        3: 'Su segundo fue Queleab de Abigail, la mujer de Nabal, el del Carmelo; el tercero, Absalom, hijo de Maaca, hija de Tolmai rey de Gessur;',
        4: 'El cuarto, Adonías, hijo de Haggit; el quinto, Safatias, hijo de Abital;',
        5: 'El sexto, Jetraam de Egla mujer de David: estos nacieron a David en Hebrón.',
        6: 'Y como había guerra entre la casa de Saul, y la de David, aconteció que Abner se esforzaba por la casa de Saul.',
        7: 'Y Saul había tenido una concubina que se llamaba Resfa, hija de Aja: e Is-boset dijo a Abner: ¿Por qué has entrado a la concubina de mi padre?',
        8: 'Y Abner se enojó en gran manera por las palabras de Is-boset, y dijo: ¿Soy yo cabeza de los perros de Judá? Yo he hecho hoy misericordia con la casa de Saul tu padre, con sus hermanos, y con sus amigos, y no te he entregado en las manos de David, y tú me has hecho hoy cargo del pecado de una mujer.',
        9: 'Así haga Dios a Abner, y así le añada, que como ha jurado Jehová a David, así haga yo con él:',
        10: 'Y que yo traspase el reino de la casa de Saul, y confirme la silla de David sobre Israel, y sobre Judá, desde Dan hasta Beer-seba.',
        11: 'Y él no pudo responder palabra a Abner porque tenía temor de él.',
        12: 'Y envió Abner mensajeros a David de su parte, diciendo: ¿Cúya es la tierra? Y que le dijesen: Haz alianza conmigo, y, he aquí que mi mano será contigo para volver a ti a todo Israel.',
        13: 'Y él dijo: Bien. Yo haré contigo alianza: mas una cosa te pido; y es, que no me vengas a ver sin que primero traigas a Micol la hija de Saul, cuando vinieres a verme.',
        14: 'Después de esto David envió mensajeros a Is-boset, hijo de Saul, diciendo: Restitúyeme a mi mujer Micol, la cual yo desposé conmigo por cien prepucios de Filisteos.',
        15: 'Entonces Is-boset envió, y quitóla a su marido Faltiel, hijo de Lais.',
        16: 'Y su marido fue con ella llorando por el camino en pos de ella hasta Bajurim: y Abner le dijo: Anda, vuélvete. Entonces él se volvió.',
        17: 'Y habló Abner con los ancianos de Israel, diciendo: Ayer y anteayer procurabais que David fuese rey sobre vosotros;',
        18: 'Ahora pues, hacédlo; porque Jehová ha hablado a David, diciendo: Por la mano de mi siervo David libraré a mi pueblo Israel de mano de los Filisteos, y de mano de todos sus enemigos.',
        19: 'Y habló también Abner en oídos de Ben-jamín: y también fue Abner a decir a David a Hebrón todo el parecer de los de Israel, y de toda la casa de Ben-jamín.',
        ...
        21: 'Y dijo Abner a David: Yo me levantaré, e iré, y juntaré a mi señor el rey todo Israel, para que hagan contigo alianza, y tú reines sobre todo lo que desea tu alma. Y David envió a Abner, y él se fue en paz.',
        22: '¶ Y he aquí los siervos de David y Joab, que venían del campo, y traían consigo gran presa. Y Abner ya no estaba con David en Hebrón, que ya él le había despedido, y él se había ido en paz.',
        23: 'Y como Joab y todo el ejército que con él estaba vinieron, fue dado aviso a Joab, diciendo: Abner, hijo de Ner, ha venido al rey: y él le ha enviado, y se fue en paz.',
        24: 'Entonces Joab vino al rey, y le dijo: ¿Qué has hecho? He aquí, habíase venido Abner a ti: ¿por qué pues le dejaste que se fuese?',
        25: '¿Sabes tú que Abner, hijo de Ner, es venido para engañarte, y saber tu salida y tu entrada, y por entender todo lo que tú haces?',
        ...
        27: 'Y como Abner volvió a Hebrón, Joab le apartó al medio de la puerta hablando con él blandamente como de secreto, y allí le hirió junto a la quinta costilla por la muerte de Asael su hermano, y murió.',
        28: 'Cuando David supo esto después, dijo: Yo soy limpio, y mi reino, delante de Jehová, para siempre, de la sangre de Abner, hijo de Ner:',
        29: 'Caiga sobre la cabeza de Joab, y sobre toda la casa de su padre; que nunca falte de la casa de Joab hombre que padezca flujo, ni leproso, ni quien ande con bordón, ni quien muera a cuchillo, ni quien tenga falta de pan.',
        30: 'Así que Joab y Abisaí su hermano mataron a Abner, porque él había muerto a Asael hermano de ellos en la batalla en Gabaón.',
        31: 'Entonces David dijo a Joab, y a todo el pueblo que con él estaba: Rompéd vuestros vestidos, y ceñíos de sacos, y hacéd llanto delante de Abner: y el rey iba detrás de las andas.',
        32: 'Y sepultaron a Abner en Hebrón: y alzando el rey su voz, lloró al sepulcro de Abner: y todo el pueblo también lloró.',
        33: 'Y endechando el rey al mismo Abner, decía: ¿Murió Abner como muere el insensato?',
        34: 'Tus manos no eran atadas, ni tus pies ligados con grillos. Como los que caen delante de los hijos de iniquidad, así caíste. Y añadieron todo el pueblo a llorar sobre él.',
        35: 'Y como todo el pueblo viniese a dar de comer pan a David, siendo aun de día, David juró, diciendo: Así me haga Dios, y así me añada, si antes que se ponga el sol yo gustare pan, o otra cualquiera cosa.',
        36: 'Así entendió todo el pueblo, y les plugo en sus ojos; porque todo lo que el rey hacía parecía bien en ojos de todo el pueblo.',
        ...
        39: 'Que yo ahora aun soy tierno rey ungido: y estos hombres, los hijos de Sarvia, muy duros me son: Jehová dé el pago al que mal hace, conforme a su malicia.',
    },
    4: {
    ...
    7: {
        1: 'Y aconteció, que estando ya el rey asentado en su casa, y que Jehová le había dado reposo de todos sus enemigos al derredor;',
        2: 'Dijo el rey al profeta Natán: Mira ahora, yo moro en casas de cedros, y el arca de Dios está entre cortinas.',
        3: 'Y Natán dijo al rey: Vé, y haz todo lo que está en tu corazón, que Jehová es contigo.',
        4: 'Y aconteció aquella noche, que fue palabra de Jehová a Natán, diciendo:',
        5: 'Vé, y di a mi siervo David: Así dijo Jehová: ¿Tú me has de edificar casa en que yo more?',
        6: 'Ciertamente no he habitado en casas desde el día que saqué a los hijos de Israel de Egipto hasta hoy, mas anduve en tienda y en tabernáculo.',
        7: 'Y en todo cuanto he andado con todos los hijos de Israel, ¿he hablado palabra en alguna de las tribus de Israel, a quien haya mandado que apaciente mi pueblo de Israel, para decir: Por qué no me habéis edificado a mí casa de cedros?',
        8: 'Ahora pues, dirás así a mi siervo David: Así dijo Jehová de los ejércitos: Yo te tomé de la majada, de detrás de las ovejas, para que fueses príncipe sobre mi pueblo, sobre Israel;',
        ...
        10: 'Y yo pondré lugar a mí pueblo Israel, y yo le plantaré, que habite en su lugar y nunca más sea removido; y que los malos nunca más le aflijan, como antes,',
        11: 'Desde el día que puse jueces sobre mi pueblo Israel; y yo te daré descanso de todos tus enemigos. Asimismo Jehová te hace saber, que Jehová te quiere a ti hacer casa.',
        12: 'Y cuando tus días fueren cumplidos, y durmieres con tus padres, yo afirmaré tu simiente tras ti, la cual saldrá de tu vientre; y yo afirmaré su reino.',
        13: 'Este edificará casa a mi nombre: y yo afirmaré para siempre la silla de su reino.',
        14: 'Yo le seré a él padre, y él me será a mi hijo. Y si él hiciere mal, yo le castigaré con vara de hombres, y con azotes de hijos de hombres:',
        15: 'Mas mi misericordia no se apartará de él, como la aparté de Saul, al cual quité de delante de ti.',
    ...
    10: {
        ...
        3: 'Los príncipes de los hijos de Ammón dijeron a Hanón su señor: ¿Honra David a tu padre a tu parecer, que te ha enviado consoladores? ¿No ha enviado David sus siervos a ti por reconocer y considerar la ciudad, para destruirla?',
        4: 'Entonces Hanón tomó los siervos de David, y rapóles la media barba, y cortóles los vestidos por la mitad hasta las nalgas, y los envió.',
        5: 'Lo cual como fue hecho saber a David, envió delante de ellos, porque ellos estaban grandemente avergonzados, y dijo el rey: Estáos en Jericó, hasta que os torne a nacer la barba, y entonces volveréis.',
        6: '¶ Y viendo los hijos de Ammón que se habían hecho odiosos con David, enviaron los hijos de Ammón, y dieron sueldo a los Siros de la casa de Roob, y a los Siros de Soba, veinte mil hombres de a pie, y del rey de Maaca mil hombres, y de Is-tob doce mil hombres.',
        ...
        9: 'Viendo pues Joab que había escuadrones delante y detrás de él, escogió de todos los escogidos de Israel, y púsose en orden contra los Siros.',
        10: 'Y lo que quedó del pueblo, entregó en mano de Abisaí su hermano, y púsolo en orden para encontrar a los Ammonitas.',
        ...
        14: 'Entonces los hijos de Ammón viendo que los Siros habían huido, huyeron también ellos delante de Abisaí, y entráronse en la ciudad. Y volvió Joab de los hijos de Ammón, y vínose a Jerusalem.',
        15: 'Y viendo los Siros que habían caído delante de Israel, tornáronse a juntar:',
        ...
        17: 'Y fue dado aviso a David, y juntó a todo Israel, y pasando el Jordán vino a Helán: y los Siros se pusieron en orden contra David, y pelearon con él.',
        ...
        19: 'Y viendo todos los reyes, siervos de Adarezer, que habían caído delante de Israel, hicieron paz con Israel, y sirviéronles: y de allí adelante temieron los Siros de socorrer a los hijos de Ammón.',
    },
    11: {
    ...
    13: {
        1: 'Después de esto aconteció, que Absalom, hijo de David, tenía una hermana hermosa que se llamaba Tamar, de la cual se enamoró Amnón hijo de David.',
        2: 'Y Amnón fue angustiado, hasta enfermar por Tamar su hermana: porque por ser ella virgen, parecía a Amnón que sería cosa dificultosa hacerle algo.',
        3: 'Y Amnón tenía un amigo, que se llamaba Jonadab, hijo de Samma, hermano de David, y Jonadab era hombre muy astuto.',
        4: 'Y este le dijo: Hijo del rey, ¿qué es la causa que a las mañanas estás así flaco? ¿No me lo descubrirás a mí? Y Amnón le respondió: Yo amo a Tamar la hermana de mi hermano Absalom.',
        ...
        6: 'Y Amnón se acostó, y fingió que estaba enfermo, y vino el rey a visitarle: y Amnón dijo al rey: Yo te ruego que venga mi hermana Tamar, y haga delante de mí dos hojuelas que coma yo de su mano.',
        7: 'Y David envió a Tamar a su casa, diciendo: Vé ahora a casa de Amnón tu hermano, y házle de comer.',
        8: 'Entonces Tamar fue a casa de su hermano Amnón, el cual estaba acostado: y tomó harina, y amasó, e hizo hojuelas delante de él, y aderezó las hojuelas.',
        9: 'Y tomando la sartén sacólas delante de él: mas él no quiso comer. Y dijo Amnón: Echád fuera de aquí a todos. Y todos se salieron de allí.',
        10: 'Entonces Amnón dijo a Tamar: Trae la comida a la recámara, para que yo coma de tu mano. Y tomando Tamar las hojuelas que había cocido, llevólas a su hermano Amnón a la recámara.',
        11: 'Y como ella se las puso delante para que comiese, él trabó de ella, diciéndole: Ven, hermana mía, duerme conmigo.',
        12: 'Ella entonces le respondió: No, hermano mío, no me hagas fuerza: porque no se hace así en Israel: no hagas tal locura.',
        13: 'Porque ¿dónde iría yo con mi deshonra? Y aun tú serías estimado como uno de los insensatos de Israel. Yo te ruego ahora que hables al rey, que no me negará a ti.',
        14: 'Mas él no la quiso oír, antes pudiendo más que ella la forzó, y durmió con ella.',
        15: 'Y aborrecióla Amnón de tan grande aborrecimiento, que el odio con que la aborreció después, fue mayor que el amor con que la había amado. Y díjole Amnón: Levántate, y vete.',
        16: 'Y ella le respondió: No es razón. Mayor mal es este de echarme, que el que me has hecho. Mas él no la quiso oír.',
        17: 'Antes llamando a su criado, que le servía, le dijo: Échame ésta allá fuera, y cierra la puerta tras ella.',
        18: 'Y ella tenía una ropa de colores sobre sí, (que las hijas vírgenes de los reyes vestían de aquellas ropas:) y su criado la echó fuera, y cerró la puerta tras ella.',
        19: 'Y Tamar tomó ceniza, y esparcióla sobre su cabeza, y rompió la ropa de colores de que estaba vestida: y puestas sus manos sobre su cabeza, se fue gritando.',
        20: 'Y le dijo su hermano Absalom: ¿Ha estado contigo tu hermano Amnón? Calla, pues, ahora hermana mía, tu hermano es, no pongas tu corazón en este negocio. Y Tamar se quedó desconsolada en casa de su hermano Absalom.',
        21: 'Y el rey David, oyendo todo esto, fue muy enojado.',
        22: '¶ Mas Absalom no habló, ni malo ni bueno con Amnón, porque Absalom aborrecía a Amnón, porque había forzado a su hermana Tamar.',
        23: 'Y aconteció, pasados dos años de tiempo, que Absalom tenía trasquiladores en Baal-hasor, que es junto a Efraím. Y convidó Absalom a todos los hijos del rey,',
        24: 'Y vino Absalom al rey, y díjole: He aquí, tu siervo tiene ahora trasquiladores: yo ruego que venga el rey y sus siervos con tu siervo.',
        25: 'Y respondió el rey a Absalom: No, hijo mío, no vamos todos, porque no seamos gravosos sobre ti. Y porfió con él, y no quiso venir, mas le bendijo.',
        ...
        27: 'Y como Absalom le importunase, dejó ir con él a Amnón, y a todos los hijos del rey.',
        28: 'Y había mandado Absalom a sus criados, diciendo: Yo os ruego que miréis, cuando el corazón de Amnón estará alegre del vino, y cuando yo os dijere: Heríd a Amnón; entonces matádle: y no tengáis temor, que yo os lo he mandado. Esforzáos, pues, y sed hombres valientes.',
        29: 'Y los criados de Absalom lo hicieron con Amnón como Absalom se lo había mandado, y levantándose todos los hijos del rey subieron todos en sus mulos, y huyeron.',
        30: 'Y estando aun ellos en el camino, la fama llegó a David, diciendo: Absalom ha asesinado a todos los hijos del rey, que ninguno ha quedado de ellos.',
        31: 'Entonces David levantándose rompió sus vestidos, y echóse en tierra: y todos sus siervos estaban desgarrados sus vestidos.',
        32: 'Y respondió Jonadab el hijo de Samma hermano de David, y dijo: No diga mi señor, que han asesinado a todos los mozos, hijos del rey, que solo Amnón es muerto, que en la boca de Absalom estaba puesto desde el día que Amnón forzó a Tamar su hermana,',
        33: 'Por tanto ahora no ponga mi señor el rey en su corazón tal palabra, diciendo: Todos los hijos del rey han sido asesinados, que solo Amnón es muerto.',
        34: 'Y Absalom huyó. Y alzando sus ojos el mozo, que estaba en atalaya, miró, y, he aquí mucho pueblo que venía a sus espaldas por el camino de hacia el monte.',
        35: 'Y dijo Jonadab al rey: He allí los hijos del rey que vienen; porque así es como tu siervo ha dicho.',
        36: 'Y como él acabó de hablar, he aquí los hijos del rey que vinieron, y alzando su voz lloraron. Y también el mismo rey, y todos sus siervos lloraron de muy gran llanto.',
        37: 'Mas Absalom huyó, y se fue a Tolmai, hijo de Ammiud rey de Gessur. Y David lloró por su hijo todos los días.',
        38: 'Y como Absalom huyó, y vino a Gessur, estuvo allá tres años.',
        39: 'Y el rey David deseó salir por Absalom: porque ya estaba consolado a cerca de Amnón, que era muerto.',
    },
    14: {
        1: 'Y conociendo Joab, hijo de Sarvia, que el corazón del rey estaba con Absalom,',
        2: 'Envió Joab a Tecua, y tomó de allá una mujer astuta, y le dijo: Yo te ruego que te enlutes, y te vistas de ropas de luto, y no te unjas con óleo, antes sé como una mujer que ha mucho tiempo que trae luto por algún muerto.',
        3: 'Y entrando al rey, habla con él de esta manera. Entonces puso Joab las palabras en su boca.',
        ...
        10: 'Y el rey dijo: Al que hablare contra ti, tráele a mí, que no te tocará más.',
        ...
        13: 'Entonces la mujer dijo: ¿Por qué pues piensas tú otro tanto contra el pueblo de Dios? que hablando el rey esta palabra es como culpado: por cuanto el rey no hace volver su fugitivo.',
        ...
        18: 'Entonces el rey respondió, y dijo a la mujer: Yo te ruego que no me encubras nada de lo que yo te preguntare. Y la mujer dijo: Diga mi señor el rey.',
        ...
        21: 'Entonces el rey dijo a Joab: He aquí, yo hago esto. Vé, y haz volver al mozo Absalom.',
        ...
        23: 'Y levantóse Joab, y fue a Gessur, y volvió a Absalom a Jerusalem.',
        24: 'Y el rey dijo: Váyase a su casa, y no vea mi rostro. Y Absalom se volvió a su casa, y no vio el rostro del rey.',
        25: 'No había varón tan hermoso en todo Israel como Absalom, para alabar en gran manera: desde la planta de su pie hasta la mollera no había en él mácula.',
        ...
        27: 'Y naciéronle a Absalom tres hijos, y una hija que se llamaba Tamar: la cual fue hermosa de ver.',
        28: '¶ Y estuvo Absalom dos años de tiempo en Jerusalem, que nunca vio el rostro del rey.',
        ...
        30: 'Entonces dijo a sus siervos: Bien sabéis las tierras de Joab junto a mi lugar, donde tiene sus cebadas: id, y pegádle fuego. Y los siervos de Absalom pegaron fuego a las tierras.',
        31: 'Y levantóse Joab, y vino a Absalom a su casa, y díjole: ¿Por qué han puesto fuego tus siervos a mis tierras?',
        32: 'Y Absalom respondió a Joab: He aquí, yo he enviado por ti, diciendo, que vinieses acá, para que yo te enviase al rey, a que le dijeses: ¿Para qué vine de Gessur? Mejor me fuera estarme aun allá. Vea yo ahora la cara del rey: y si hay en mi pecado, máteme.',
        33: 'Vino pues Joab al rey: e hízoselo saber: y llamó a Absalom, el cual vino al rey, e inclinó su rostro a tierra delante del rey: y el rey besó a Absalom.',
    },
    15: {
    ...
    18: {
        1: 'David, pues, contó el pueblo que tenía consigo, y puso sobre ellos tribunos y centuriones.',
        2: 'Y puso la tercera parte del pueblo debajo de la mano de Joab, y otra tercera debajo de la mano de Abisaí, hijo de Sarvia, hermano de Joab, y la otra tercera parte debajo de la mano de Etai Geteo. Y dijo el rey al pueblo: Yo también saldré con vosotros.',
        3: 'Mas el pueblo dijo: No saldrás, porque si nosotros huyéremos, no harán caso de nosotros: y aunque la mitad de nosotros muera, no harán caso de nosotros: mas tú ahora vales tanto como diez mil de nosotros, por tanto mejor será que tú nos des ayuda desde la ciudad.',
        4: 'Entonces el rey les dijo: Yo haré lo que a vosotros pareciere bien. Y el rey se puso a la entrada de la puerta, mientras salía todo el pueblo de ciento en ciento, y de mil en mil.',
        5: 'Y el rey mandó a Joab, y a Abisaí, y a Etai, diciendo: Tratád benignamente por amor de mí al mozo Absalom. Y todo el pueblo oyó cuando el rey mandó acerca de Absalom a todos los capitanes.',
        6: 'Y el pueblo salió al campo contra Israel, y la batalla se dio en el bosque de Efraím.',
        7: 'Y el pueblo de Israel cayó allí delante de los siervos de David, y fue hecha allí gran matanza en aquel día de veinte mil hombres.',
        8: 'Y derramándose allí el ejército por la haz de toda la tierra, fueron más los que consumió el bosque de los del pueblo, que los que consumió la espada aquel día.',
        9: 'Y Absalom se encontró con los siervos de David, y Absalom iba sobre un mulo, y el mulo se entró debajo de un espeso y grande alcornoque, y asiósele la cabeza al alcornoque, y quedó entre el cielo y la tierra, y el mulo que estaba debajo de él, pasó adelante.',
        10: 'Y viéndole uno, avisó a Joab, diciendo: He aquí que yo ví a Absalom colgado de un alcornoque.',
        11: 'Y Joab respondió al hombre que le daba la nueva: ¿Y viéndole tú? ¿por qué no le heriste luego allí a tierra? y sobre mí, que yo te diera diez siclos de plata, y un talabarte.',
        12: 'Y el hombre dijo a Joab: Aunque yo me pesara en mis manos mil siclos de plata, no extendiera mi mano en el hijo del rey: porque nosotros lo oímos cuando el rey te mandó a ti, y a Abisaí, y a Etai, diciendo: Mirád que ninguno toque en el mozo Absalom:',
        13: 'O yo hubiera hecho traición contra mi alma; pues que al rey nada se le esconde, y tú mismo estarías contra mí.',
        14: 'Y Joab respondió: No es razón, que yo te ruegue. Y tomando tres dardos en su mano, hincólos en el corazón de Absalom, que aun estaba vivo en medio del alcornoque.',
        15: 'Y cercándole diez mancebos escuderos de Joab, hirieron a Absalom, y matáronle.',
        16: 'Entonces Joab tocó la corneta, y el pueblo se volvió de seguir a Israel, porque Joab detuvo al pueblo.',
        17: 'Y tomando a Absalom, echáronle en un gran foso en el bosque, y levantaron sobre él un muy gran majano de piedras, y todo Israel huyó cada uno a sus estancias.',
        18: 'Y Absalom había tomado, y se había levantado una columna en su vida, la cual está en el valle del rey, porque había dicho entre sí: Yo no tengo hijo que conserve la memoria de mi nombre: y llamó a aquella columna por su nombre, y así se llamó, lugar de Absalom, hasta hoy.',
        19: '¶ Entonces Aquimaas, hijo de Sadoc, dijo: Yo correré ahora y daré las nuevas al rey, como Jehová ha defendido su causa de la mano de sus enemigos.',
        20: 'Y respondióle Joab: Hoy no llevarás las nuevas, otro día las llevarás: no darás hoy la nueva, porque el hijo del rey es muerto.',
        21: 'Y Joab dijo a Cusi: Vé tú, y di al rey lo que has visto. Y Cusi hizo reverencia a Joab, y corrió.',
        22: 'Y Aquimaas, hijo de Sadoc, tornó a decir a Joab: Sea lo que fuere, yo correré ahora tras Cusi. Y Joab dijo: Hijo mío, ¿para qué has tú de correr, que no hallarás premio por las nuevas?',
        23: 'Y él respondió: Sea lo que fuere, yo correré; y Joab le dijo: Corre. Y Aquimaas corrió por el camino de la campaña, y pasó delante de Cusi.',
        24: 'Y David estaba asentado entre las dos puertas, y el atalaya había ido sobre la techumbre de la puerta en el muro, y alzando sus ojos, miró y vio a uno que corría solo.',
        25: 'Y el atalaya dio voces, e hízolo saber al rey. Y el rey dijo: Si es solo, buenas nuevas trae. Y él venía acercándose.',
        26: 'El atalaya vio otro que corría: y dio voces el atalaya al portero, diciendo: Hé un hombre que corre solo. Y el rey dijo: Este también es mensajero.',
        27: 'Y el atalaya volvió a decir: Paréceme el correr del primero, como el correr de Aquimaas, hijo de Sadoc. Y el rey respondió: Ese hombre es de bien, y viene con buena nueva.',
        28: 'Entonces Aquimaas dijo a alta voz al rey: Paz. E inclinóse a tierra delante del rey, y dijo: Bendito sea Jehová Dios tuyo, que ha entregado los hombres, que habían levantado sus manos contra mi señor el rey.',
        29: 'Y el rey dijo: ¿El mozo Absalom, tiene paz? Y Aquimaas respondió: Yo ví un grande alboroto, cuando Joab envió al siervo del rey, y a mí tu siervo, mas no sé que era.',
        30: 'Y el rey dijo: Pasa, y pónte allí. Y él pasó, y paróse.',
        ...
        32: 'El rey entonces dijo a Cusi: ¿El mozo Absalom tiene paz? Y Cusi respondió: Como aquel mozo sean los enemigos de mi señor el rey, y todos los que se levantan contra ti para mal.',
        33: 'Entonces el rey se turbó, y subióse a la sala de la puerta, y lloró, y yendo decía así: ¡Hijo mío, Absalom! ¡hijo mío, hijo mío, Absalom! ¡quién me diera, que yo muriera en lugar de ti, Absalom, hijo mío, hijo mío!',
    },
    19: {
    ...
    22: {
        ...
        6: 'Cuando las cuerdas del sepulcro me ciñeron, y los lazos de muerte me tomaron descuidado;',
