...
CHAPTERS = {
    ...
    2: {
        1: 'Determinó pues Salomón de edificar casa al nombre de Jehová, y otra casa para su reino.',
        2: 'Y contó Salomón setenta mil hombres que llevasen cargas, y ochenta mil hombres que cortasen en el monte, y tres mil y seiscientos que les gobernasen.',
        3: 'Y envió Salomón a Hiram rey de Tiro, diciendo: Como hiciste con David mi padre enviándole cedros, para que edificase para sí casa en que morase:',
        4: 'He aquí, yo tengo de edificar casa al nombre de Jehová mi Dios, para consagrársela, para quemar perfumes aromáticos delante de él, y para la disposición continua, y holocaustos a la mañana y a la tarde, para sábados, y nuevas lunas, y festividades de Jehová nuestro Dios, lo cual ha de ser perpetuo en Israel.',
        5: 'Y la casa que tengo de edificar, ha de ser grande: porque el Dios nuestro es grande sobre todos los dioses.',
        6: 'Mas ¿quién será tan poderoso, que le edifique casa? Los cielos, y los cielos de los cielos no le comprenden, ¿quién pues soy yo, para que le edifique casa más de para quemar perfumes delante de él?',
        7: 'Envíame pues ahora un hombre sabio, que sepa obrar en oro, y en plata, y en metal, y en hierro, en púrpura, y en grana, y en cárdeno: y que sepa esculpir figuras con los maestros, que están conmigo en Judá y en Jerusalem, que mi padre apercibió.',
        8: 'Envíame también madera de cedro, de haya, y almugim del Líbano: porque yo sé que tus siervos son maestros de cortar la madera en el Líbano; y he aquí, mis siervos irán con los tuyos,',
        9: 'Para que me aparejen mucha madera: porque la casa que tengo de edificar, ha de ser grande e insigne.',
        ...
        11: 'E Hiram el rey de Tiro respondió por cartas, las cuales envió a Salomón: Porque Jehová amó a su pueblo, te ha puesto por rey sobre ellos.',
        12: 'Y añadió Hiram, diciendo: Bendito sea Jehová el Dios de Israel, que hizo los cielos y la tierra, y que dio al rey David hijo sabio, entendido, cuerdo, y prudente, que edifique casa a Jehová, y casa para su reino.',
        13: 'Yo pues te he enviado un hombre sabio y entendido, que fue de Hiram mi padre,',
        14: 'Hijo de una mujer de las hijas de Dan, y su padre fue de Tiro, el cual sabe obrar en oro, y plata, y metal, e hierro, en piedra, y en madera, en púrpura, y cárdeno, en lino, y en carmesí: y para esculpir todas figuras, e inventar todas las invenciones que se le propusieren, con tus sabios, y con los sabios de mi señor David tu padre.',
        15: 'Enviará pues ahora mi señor a sus siervos el trigo, y cebada, y aceite, y vino que ha dicho,',
        16: 'Y nosotros cortaremos en el Líbano la madera que hubieres menester, y traértela hemos en balsas por la mar hasta Joppe, y tú la harás llevar a Jerusalem.',
        17: 'Y contó Salomón todos los varones extranjeros, que estaban en la tierra de Israel, después de haberlos ya contado David su padre, y fueron hallados ciento y cincuenta y tres mil y seiscientos.',
        18: 'E hizo de ellos setenta mil para llevar cargas, y ochenta mil que cortasen piedra en el monte, y tres mil y seiscientos que eran prefectos para hacer trabajar al pueblo.',
    },
    3: {
        1: 'Y comenzó Salomón a edificar la casa de Jehová en Jerusalem en el monte Moria, que había sido mostrado a David su padre, en el lugar que David había aparejado en la era de Ornán Jebuseo.',
        ...
        13: 'Así las alas de estos querubines estaban extendidas por veinte codos: y ellos estaban en pie, los rostros hacia la casa.',
    ...
    4: {
        1: 'E hizo un altar de metal de longitud de veinte codos, y de anchura de otros veinte codos, y de altura de diez codos.',
        ...
        3: 'Y debajo de él había unas imágenes de bueyes que le cercaban al derredor, diez en cada codo: y había dos ordenes de bueyes fundidos en su fundición.',
        ...
        5: 'Y tenía de grueso un palmo, y el borde era de la hechura de un borde de un cáliz, o de una flor de lis. Y hacía tres mil batos.',
        ...
        13: 'Cuatrocientas granadas en las dos redecillas, dos ordenes de granadas en cada redecilla, para que cubriesen las dos bolas de los capiteles que estaban sobre las cabezas de las columnas.',
    ...
    6: {
        1: 'Entonces dijo Salomón: Jehová ha dicho, que él habitará en la oscuridad.',
        2: 'Yo pues he edificado una casa de morada para ti, y una habitación en que mores para siempre.',
        3: 'Y volviendo el rey su rostro bendijo a toda la congregación de Israel, y toda la congregación de Israel estaba en pie, y él dijo:',
        4: 'Bendito sea Jehová Dios de Israel, el cual dijo por su boca a David mi padre, y con su mano ha cumplido, diciendo:',
        ...
        6: 'Mas a Jerusalem he elegido para que en ella esté mi nombre, y a David he elegido para que fuese sobre mi pueblo Israel.',
        7: 'Y David mi padre tuvo en corazón de edificar casa al nombre de Jehová Dios de Israel.',
        8: 'Mas Jehová dijo a David mi padre: De haber tenido en tu corazón de edificar casa a mi nombre, bien has hecho de haber tenido esto en tu corazón:',
        9: 'Empero tú no edificarás la casa; sino tu hijo que saldrá de tus lomos, él edificará casa a mi nombre.',
        10: 'Y Jehová ha cumplido su palabra, que dijo: y levantéme yo por David mi padre, y asentéme en el trono de Israel, como Jehová había dicho; y he edificado casa al nombre de Jehová Dios de Israel.',
        11: 'Y he puesto en ella el arca en la cual está el concierto de Jehová que concertó con los hijos de Israel.',
        12: 'Y púsose delante del altar de Jehová delante de toda la congregación de Israel, y extendió sus manos:',
        13: 'Porque Salomón había hecho un púlpito de metal, y le había puesto en medio del patio, de longitud de cinco codos, y de anchura de otros cinco, y de altura de tres codos, y púsose sobre él, e hincóse de rodillas delante de toda la congregación de Israel, y extendiendo sus manos al cielo, dijo:',
        14: 'Jehová Dios de Israel, no hay Dios semejante a ti en el cielo, ni en la tierra, que guardas el concierto, y la misericordia a tus siervos, que caminan delante de ti con todo su corazón:',
        ...
        16: 'Ahora pues Jehová Dios de Israel, guarda a tu siervo David mi padre lo que le has prometido, diciendo: No faltará de ti varón delante de mí que se asiente en el trono de Israel, a condición que tus hijos guarden su camino, andando en mi ley, como tú has andado delante de mí.',
        17: 'Ahora pues, oh Jehová Dios de Israel, sea firme tu palabra que dijiste a tu siervo David.',
        18: '¿Es verdad que Dios ha de habitar con el hombre en la tierra? He aquí, los cielos, y los cielos de los cielos no te comprenden, ¿cuánto menos esta casa que he edificado?',
        ...
        20: 'Que tus ojos estén abiertos sobre esta casa de día y de noche, sobre el lugar del cual dijiste: Mi nombre será allí: que oigas la oración con que tu siervo ora en este lugar.',
        21: 'Asimismo, que oigas el ruego de su siervo, y de tu pueblo Israel, cuando oraren en este lugar; que tú oirás desde los cielos, desde el lugar de tu habitación; que oigas, y perdones.',
        22: 'Si alguno pecare contra su prójimo, y él le pidiere juramento haciéndolo jurar, y el juramento viniere delante de tu altar en esta casa;',
        23: 'Tú oirás desde los cielos, y harás, y juzgarás a tus siervos, pagando al impío, dándole su camino en su cabeza, y justificando al justo, dándole conforme a su justicia.',
        24: 'Si tu pueblo Israel cayere delante de los enemigos por haber pecado contra ti, y si se convirtieren, y confesaren tu nombre, y rogaren delante de ti en esta casa;',
        25: 'Tú oirás desde los cielos, y perdonarás el pecado de tu pueblo Israel, y volverlos has a la tierra que diste a ellos y a sus padres.',
        ...
        27: 'Tú los oirás en los cielos, y perdonarás el pecado de tus siervos, y de tu pueblo Israel, y les enseñarás el buen camino para que anden en él, y darás lluvia sobre tu tierra, la cual diste por heredad a tu pueblo.',
        28: 'Y si hubiere hambre en la tierra, o si hubiere pestilencia, o si hubiere tizoncillo, o niebla, lagarta, langosta, o pulgón; o si los cercaren sus enemigos en la tierra de sus ciudades; o cualquiera llaga, o enfermedad:',
        29: 'Toda oración, y todo ruego que cualquier hombre hiciere, o todo tu pueblo Israel, o cualquiera que conociere su llaga, y su dolor en su corazón, si extendiere sus manos a esta casa;',
        30: 'Tú oirás desde los cielos, desde el lugar de tu habitación, y perdonarás, y darás a cada uno conforme a sus caminos, habiendo conocido su corazón; porque tú solo conoces el corazón de los hijos de los hombres:',
        31: 'Para que te teman, y anden en tus caminos todos los días que vivieren sobre la haz de la tierra que tú diste a nuestros padres.',
        32: 'Y también al extranjero, que no fuere de tu pueblo Israel, que hubiere venido de lejas tierras, por causa de tu grande nombre, y de tu mano fuerte, y de tu brazo extendido, si vinieren, y oraren en esta casa;',
        ...
        35: 'Tú oirás desde los cielos su oración y su ruego, y defenderás su causa.',
        36: 'Si pecaren contra ti, pues que no hay hombre que no peque, y te airares contra ellos, y los entregares delante de sus enemigos, para que los que los tomaren, los lleven cautivos a tierra de enemigos lejos o cerca;',
        37: 'Y ellos volvieren en sí en la tierra donde fueren llevados cautivos, y si se convirtieren, y oraren a ti en la tierra de su cautividad, y dijeren: Pecamos, hemos hecho inicuamente, hemos hecho impíamente;',
        38: 'Y se convirtieren a ti de todo su corazón, y de toda su alma, en la tierra de su cautividad, donde los hubieren llevado cautivos, y oraren hacia su tierra, que tú diste a sus padres, hacia la ciudad que tú elegiste, y hacia la casa que he edificado a tu nombre;',
        39: 'Tú oirás desde los cielos, desde la morada de tu habitación, su oración y su ruego, y defenderás su causa, y perdonarás a tu pueblo que pecó contra ti.',
        40: 'Ahora pues, oh Dios mío, estén, yo te ruego, abiertos tus ojos, y atentas tus orejas a la oración en este lugar.',
        41: 'Oh Jehová Dios, levántate ahora para tu reposo, tú y el arca de tu fortaleza: oh Jehová Dios, tus sacerdotes sean vestidos de salud, y tus misericordiosos gocen de bien.',
    ...
    7: {
        ...
        8: 'Entonces hizo Salomón fiesta siete días, y con él todo Israel, una grande congregación, desde la entrada de Emat hasta el arroyo de Egipto.',
        9: 'Al octavo día hicieron convocación, porque la dedicación del altar habían hecho en siete días, y habían celebrado la solemnidad por siete días.',
        ...
        11: 'Y Salomón acabó la casa de Jehová, y la casa del rey: y todo lo que Salomón tuvo en voluntad de hacer en la casa de Jehová, y en su casa, fue prosperado.',
        12: 'Y Jehová apareció a Salomón de noche, y díjole: Yo he oído tu oración, y yo he elegido para mí este lugar, por una casa de sacrificio.',
        ...
        14: 'Y si se humillare mi pueblo sobre los cuales mi nombre es invocado, y oraren, y buscaren mi faz, y se convirtieren de sus caminos malos, entonces yo oiré desde los cielos, y perdonaré sus pecados, y sanaré su tierra.',
        ...
        21: 'Y esta casa que fue tan ilustre, será espanto a todo pasante; y dirá: ¿Por qué ha hecho así Jehová a esta tierra, y a esta casa?',
        22: 'Y serle ha respondido: Por cuanto dejaron a Jehová Dios de sus padres, el cual los sacó de la tierra de Egipto, y echaron mano de dioses ajenos, y los adoraron y sirvieron: por eso él ha traído sobre ellos todo este mal.',
    },
    8: {
        ...
        6: 'Ítem, a Balaat, y a todas las villas de munición, que tenía Salomón: también todas las ciudades de los carros, y las de la gente de a caballo: y todo lo que Salomón quiso edificar en Jerusalem, y en el Líbano, y en toda la tierra de su señorío,',
        ...
        12: 'Entonces ofreció Salomón holocaustos a Jehová sobre el altar de Jehová, que había edificado delante del portal;',
        ...
        16: 'Porque toda la obra de Salomón estaba aparejada, desde el día que la casa de Jehová fue fundada hasta que se acabó, que la casa de Jehová fue acabada del todo.',
        17: '¶ Entonces Salomón fue a Asión-gaber, y a Elat a la costa de la mar en la tierra de Edom.',
        18: 'Porque Hiram le había enviado navíos por mano de sus siervos, y marineros diestros por la mar, los cuales habían ido con los siervos de Salomón a Ofir, y habían tomado de allá cuatrocientos y cincuenta talentos de oro, y los habían traído al rey Salomón.',
    },
    9: {
    ...
    10: {
        ...
        2: 'Y como Jeroboam, hijo de Nabat, el cual estaba en Egipto, donde había huido a causa del rey Salomón, lo oyó, volvió de Egipto.',
        3: 'Y enviaron y llamáronle. Y vino Jeroboam, y todo Israel, y hablaron a Roboam, diciendo:',
        4: 'Tu padre agravó nuestro yugo, afloja tú pues ahora algo de la dura servidumbre, y del grave yugo con que tu padre nos apremió, y servirte hemos.',
        5: 'Y él les dijo: Volvéd a mí de aquí a tres días. Y el pueblo se fue.',
        6: 'Entonces el rey Roboam tomó consejo con los viejos que habían estado delante de Salomón su padre, cuando vivía, y díjoles: ¿Cómo aconsejáis vosotros que responda a este pueblo?',
        7: 'Y ellos le hablaron, diciendo: Si te hubieres humanamente con este pueblo, y los agradares, y les hablares buenas palabras, ellos te servirán perpetuamente.',
        8: 'Mas él dejando el consejo de los viejos, que le dieron, tomó consejo con los jóvenes, que se habían criado con él, y que asistían delante de él.',
        9: 'Y díjoles: ¿Qué aconsejáis vosotros que respondamos a este pueblo que me ha hablado, diciendo: Alivia algo del yugo que tu padre puso sobre nosotros?',
        10: 'Entonces los jóvenes, que se habían criado con él, le hablaron, diciendo: Así dirás al pueblo que te ha hablado, diciendo: Tu padre agravó nuestro yugo, tú pues descárganos. Así les dirás: El menor dedo mío es más grueso que los lomos de mi padre.',
        ...
        12: 'Vino pues Jeroboam y todo el pueblo a Roboam al tercero día, como el rey les había mandado, diciendo: Volvéd a mí de aquí a tres días.',
        13: 'Y respondióles el rey ásperamente; y dejó el rey Roboam el consejo de los viejos,',
        14: 'Y hablóles conforme al consejo de los mancebos, diciendo: Mi padre agravó vuestro yugo, y yo añadiré a vuestro yugo: mi padre os castigó con azotes, y yo con escorpiones.',
        15: 'Y no escuchó el rey al pueblo: porque era la voluntad de Dios para cumplir Jehová su palabra que había hablado por Ahías Silonita a Jeroboam, hijo de Nabat.',
        16: 'Y viendo todo Israel que el rey no le había oído, respondió el pueblo al rey, diciendo: ¿Qué parte tenemos nosotros con David, ni herencia en el hijo de Isaí? Israel cada uno a sus estancias: David mira ahora por tu casa. Así se fue todo Israel a sus estancias.',
        17: 'Y reinó Roboam sobre los hijos de Israel, que habitaban en las ciudades de Judá.',
        18: 'Y envió el rey Roboam a Aduram, que tenía cargo de los tributos, y apedreáronle los hijos de Israel con piedras, y murió. Entonces el rey Roboam se hizo fuerte, y subiendo en un carro huyó a Jerusalem.',
    ...
    12: {
        ...
        5: '¶ Entonces vino Semeías profeta a Roboam, y a los príncipes de Judá que estaban congregados en Jerusalem por causa de Sesac, y díjoles: Así ha dicho Jehová: Vosotros me habéis dejado, y yo también os he dejado en mano de Sesac.',
        6: 'Y los príncipes de Israel, y el rey, se humillaron, y dijeron: Justo es Jehová.',
        7: 'Y como vio Jehová, que se habían humillado, fue palabra de Jehová a Semeías, diciendo: Hánse humillado: no los destruiré, antes en breve los salvaré; y no se derramará mi ira contra Jerusalem por mano de Sesac.',
        ...
        13: 'Y fortificado Roboam, reinó en Jerusalem: y era Roboam de cuarenta y un años, cuando comenzó a reinar, y diez y siete años reinó en Jerusalem, ciudad que escogió Jehová, para poner en ella su nombre, de todas las tribus de Israel: y el nombre de su madre fue Naama, Ammonita.',
    ...
    13: {
        1: 'A los diez y ocho años del rey Jeroboam reinó Abías sobre Judá,',
        2: 'Y reinó tres años en Jerusalem. El nombre de su madre fue Micaia, hija de Uriel de Gabaa. Y hubo guerra entre Abías y Jeroboam.',
        3: 'Y Abías ordenó batalla con el ejército de los valerosos en la guerra, cuatrocientos mil hombres escogidos: y Jeroboam ordenó batalla contra él con ochocientos mil hombres escogidos, fuertes y valerosos.',
        4: 'Y levantóse Abías sobre el monte de Semerón, que es en los montes de Efraím, y dijo: Oídme Jeroboam, y todo Israel:',
        5: '¿No sabéis vosotros, que Jehová Dios de Israel dio el reino a David sobre Israel perpetuamente, a él y a sus hijos en alianza de sal?',
        6: '¿Y que Jeroboam, hijo de Nabat, siervo de Salomón, hijo de David, se levantó y se rebeló contra su señor:',
        7: 'Y que se allegaron a él hombres vanos, e hijos de Belial: y pudieron más que Roboam, hijo de Salomón; porque Roboam era mozo, y tierno de corazón, y no se esforzó delante de ellos?',
        8: 'Y ahora vosotros consultáis para fortificaros contra el reino de Jehová, que está en mano de los hijos de David; y sois muchos, y tenéis con vosotros los becerros de oro, que Jeroboam os hizo por dioses.',
        9: '¿No echasteis vosotros los sacerdotes de Jehová, los hijos de Aarón, y los Levitas, y os habéis hecho sacerdotes a la manera de los pueblos de las tierras, que cualquiera venga a consagrarse con un becerro, hijo de vaca, y siete carneros, y sea sacerdote de los que no son dioses?',
        10: 'Mas a nosotros, Jehová es nuestro Dios y no le dejamos: y los sacerdotes que ministran a Jehová son los hijos de Aarón, y los Levitas en la obra:',
        11: 'Los cuales queman a Jehová los holocaustos cada mañana y cada tarde, y los perfumes aromáticos, y ponen los panes sobre la mesa limpia, y el candelero de oro con sus candilejas para que ardan cada tarde; porque nosotros guardamos la observancia de Jehová nuestro Dios: mas vosotros le habéis dejado.',
        12: 'Y, he aquí, Dios está con nosotros por cabeza, y sus sacerdotes, y las trompetas del júbilo, para que suenen contra vosotros. Oh hijos de Israel, no peleéis contra Jehová el Dios de vuestros padres, porque no os sucederá bien.',
        13: 'Y Jeroboam hizo una emboscada al derredor, para venir a ellos por las espaldas: y la emboscada estaba a las espaldas de Judá, y ellos delante.',
        14: 'Entonces como miró Judá, he aquí que tenían batalla delante y a las espaldas. Y clamaron a Jehová, y los sacerdotes tocaron las trompetas.',
        15: 'Y los de Judá alzaron grita. Y como ellos alzaron grita, Dios venció a Jeroboam y a todo Israel delante de Abías y de Judá.',
        ...
        18: 'Así fueron humillados los hijos de Israel en aquel tiempo: y los hijos de Judá se fortificaron; porque estribaban en Jehová el Dios de sus padres.',
        19: 'Y siguió Abías a Jeroboam, y tomó sus ciudades, a Bet-el con sus aldeas, a Jesana con sus aldeas, a Efrón con sus aldeas.',
        20: '¶ Y nunca más Jeroboam tuvo fuerza en los días de Abías: y Jehová le hirió, y murió.',
        21: 'Mas Abías se fortificó: y tomóse catorce mujeres, y engendró veinte y dos hijos, y diez y seis hijas.',
        22: 'Lo demás de los hechos de Abías, sus caminos, y sus negocios, está escrito en la historia de Addo profeta.',
    },
    14: {
        1: 'Y durmió Abías con sus padres, y fue sepultado en la ciudad de David: y reinó en su lugar Asa su hijo. En sus días reposó la tierra diez años.',
        ...
        8: 'Tuvo también Asa ejército que traía escudos y lanzas, trescientos mil de Judá; y doscientos y ochenta mil de Ben-jamín, que traían escudos, y flechaban arcos: todos hombres diestros.',
        ...
        11: 'Y clamó Asa a Jehová su Dios, y dijo: Jehová, no tienes tú más con el grande, que con el que ninguna fuerza tiene, para dar ayuda. Ayúdanos, oh Jehová Dios nuestro, porque en ti estribamos, y en tu nombre venimos contra este ejército. Oh Jehová, tú eres nuestro Dios: no prevalezca contra ti el hombre.',
    ...
    15: {
        1: 'Y fue el Espíritu de Dios sobre Azarías, hijo de Obed;',
        2: 'Y salió al encuentro a Asa, y díjole: Oídme Asa, y todo Judá y Ben-jamín. Jehová es con vosotros, si vosotros fuereis con él: y si le buscareis, será hallado de vosotros: mas si le dejareis, él también os dejará.',
        3: 'Muchos días ha estado Israel sin verdadero Dios, y sin sacerdote, y sin enseñador, y sin ley.',
        4: 'Mas cuando con su tribulación se convirtieron a Jehová Dios de Israel, y le buscaron, él fue hallado de ellos.',
        ...
        8: 'Y como Asa oyó las palabras y profecía de Obed profeta, fue confortado, y quitó las abominaciones de toda la tierra de Judá y de Ben-jamín, y de las ciudades que él había tomado en el monte de Efraím: y reparó el altar de Jehová, que estaba delante del portal de Jehová.',
        9: 'E hizo juntar a todo Judá y Ben-jamín, y con ellos los extranjeros de Efraím, y de Manasés, y de Simeón: porque muchos de Israel se habían pasado a él, viendo que Jehová su Dios era con él.',
        10: 'Y fueron juntos en Jerusalem en el mes tercero, a los quince años del reino de Asa.',
        11: 'Y sacrificaron a Jehová aquel mismo día, de los despojos que habían traído, siete cientos bueyes, y siete mil ovejas.',
        ...
        15: 'Del cual juramento todos los de Judá se alegraron; porque de todo su corazón le juraban, y de toda su voluntad le buscaban, y fue hallado de ellos: y Jehová les dio reposo de todas partes.',
    ...
    16: {
        1: 'En el año treinta y seis del reino de Asa subió Baasa rey de Israel contra Judá: y edificó a Rama, para no dejar salir ni entrar a alguno al rey Asa rey de Judá.',
        ...
        3: 'Alianza hay entre mí y ti, y entre mi padre y tu padre: he aquí, yo te he enviado plata y oro, para que vengas, y deshagas tu alianza, que tienes con Baasa rey de Israel, para que se retire de mí.',
        4: 'Y consintió Ben-adad con el rey Asa, y envió los capitanes de los ejércitos que tenía, a las ciudades de Israel; e hirieron a Ahión, Dan, y Abel-maim, y las ciudades fuertes de Neftalí.',
        5: 'Y oyéndo lo Baasa, cesó de edificar a Rama, y dejó su obra.',
        6: 'Entonces el rey Asa tomó a todo Judá, y llevaron de Rama la piedra y madera con que Baasa edificaba; y con ello edificó a Gabaa, y Maspa.',
        7: 'En aquel tiempo vino Janani vidente a Asa rey de Judá, y díjole: Por cuanto has estribado sobre el rey de Siria, y no estribaste en Jehová tu Dios, por eso el ejército del rey de Siria ha escapado de tus manos.',
        8: '¿Los Etiopes, y los Libios, no traían ejército en multitud con carros, y muy mucha gente de a caballo? mas, porque tú estribaste en Jehová, él los entregó en tus manos.',
        9: 'Porque los ojos de Jehová contemplan toda la tierra, para corroborar a los que tienen corazón perfecto para con él. Locamente has hecho en esto, porque de aquí adelante habrá guerra contra ti.',
        10: 'Y Asa enojado contra el vidente, echóle en la casa de la cárcel, porque fue grandemente conmovido de esto. Y mató Asa en aquel tiempo algunos del pueblo.',
        11: 'He aquí pues, los hechos de Asa, primeros y postreros, están escritos en el libro de los reyes de Judá y de Israel.',
        12: '¶ Y el año treinta y nueve de su reino enfermó Asa de los pies para arriba, y en su enfermedad no buscó a Jehová, sino a los médicos.',
        13: 'Y durmió Asa con sus padres, y murió el año cuarenta y uno de su reino,',
        14: 'Y sepultáronle en sus sepulcros que él había hecho para sí, en la ciudad de David. Y pusiéronle en una litera, la cual hinchieron de aromas, y olores hechos de obra de perfumadores: e hiciéronle una quema muy grande.',
    },
    17: {
    ...
    19: {
        1: 'Y Josafat rey de Judá se volvió a su casa a Jerusalem en paz.',
        2: 'Y salióle al encuentro Jehú, hijo de Janani vidente, y dijo al rey Josafat: ¿A un impío das ayuda, y amas a los que aborrecen a Jehová? Mas la ira de la presencia de Jehová será sobre ti por ello.',
        3: 'Empero hánse hallado en ti buenas cosas, porque cortaste de la tierra los bosques, y has aparejado tu corazón a buscar a Dios.',
        4: '¶ Y habitaba Josafat en Jerusalem: y volvía, y salía al pueblo desde Beer-seba hasta el monte de Efraím, y reducíalos a Jehová el Dios de sus padres.',
        ...
        11: 'He aquí también Amarías sacerdote, él será el jefe sobre vosotros en todo negocio de Jehová; y Zabadías, hijo de Ismael, príncipe de la casa de Judá, en todos los negocios del rey; y los Levitas que serán los maestros delante de vosotros. Esforzáos pues, y hacéd: que Jehová será con el bueno.',
    },
    20: {
        1: 'Pasadas estas cosas aconteció que los hijos de Moab y de Ammón, y con ellos de los Ammonitas, vinieron contra Josafat a la guerra.',
        2: 'Y vinieron, y dieron aviso a Josafat, diciendo: Contra ti viene una grande multitud de la otra parte de la mar, y de Siria; y, he aquí, ellos están en Asason-tamar, que es Engadí.',
        3: 'Entonces él hubo temor: y puso Josafat su rostro, para consultar a Jehová, e hizo pregonar ayuno a todo Judá.',
        4: 'Y juntáronse los de Judá para buscar socorro de Jehová: y también de todas las ciudades de Judá vinieron para buscar socorro de Jehová.',
        5: 'Y púsose Josafat en pie en la congregación de Judá y de Jerusalem, en la casa de Jehová, delante del patio nuevo,',
        6: 'Y dijo: Jehová Dios de nuestros padres ¿no eres tú Dios en los cielos? ¿Y no te enseñoreas en todos los reinos de las gentes? ¿No está en tu mano la fuerza y el poder, que no hay quien te resista?',
        ...
        9: 'Si mal viniere sobre nosotros, o espada de juicio, o pestilencia, o hambre, presentarnos hemos delante de esta casa, y delante de ti; porque tu nombre está en esta casa; y de nuestras tribulaciones clamarémos a ti, y tú nos oirás y salvarás.',
        10: 'Ahora pues, he aquí los hijos de Ammón y de Moab, y el monte de Seir, por los cuales no quisiste que pasase Israel, cuando venían de la tierra de Egipto, sino que se apartasen de ellos, y no los destruyesen;',
        11: 'He aquí, ellos nos dan el pago, que vienen a echarnos de tu posesión, que tú nos diste que poseyésemos.',
        12: 'Dios nuestro, ¿no los juzgarás tú? Porque en nosotros no hay fuerza contra tan grande multitud que viene contra nosotros: no sabemos lo que hemos de hacer; mas a ti son nuestros ojos.',
        13: 'Y todo Judá estaba en pie delante de Jehová, también sus niños, y sus mujeres, y sus hijos.',
        14: 'Y estaba allí Jahaziel, hijo de Zacarías, hijo de Banaías, hijo de Jehiel, hijo de Matanías, Levita de los hijos de Asaf, sobre el cual vino el Espíritu de Jehová, en medio de la congregación;',
        15: 'Y dijo: Oíd todo Judá, y moradores de Jerusalem, y tú rey Josafat: Jehová os dice así: No temáis, ni hayáis miedo delante de esta tan grande multitud; porque no es vuestra la guerra, sino de Dios.',
        16: 'Mañana descenderéis contra ellos: he aquí que ellos subirán por la cuesta de Sis; y hallarlos heis junto al arroyo, antes del desierto de Jeruel.',
        17: 'Y no habrá para que vosotros peleéis ahora: paráos, estád quedos, y ved la salud de Jehová con vosotros, Oh Judá y Jerusalem: no temáis ni desmayéis; salíd mañana contra ellos: que Jehová será con vosotros.',
        18: 'Entonces Josafat inclinó su rostro a tierra, y asimismo todo Judá y los moradores de Jerusalem se postraron delante de Jehová, y adoraron a Jehová.',
        19: 'Y levantáronse los Levitas de los hijos de Caat, y de los hijos de Coré, para alabar a Jehová el Dios de Israel a grande y alta voz.',
        20: 'Y como se levantaron por la mañana, salieron por el desierto de Tecua: y mientras ellos salían, Josafat estando en pie, dijo: Oídme Judá, y moradores de Jerusalem: Creéd a Jehová vuestro Dios, y seréis seguros: y creéd a sus profetas, y seréis prosperados.',
        21: 'Y habido consejo con el pueblo, puso a algunos que cantasen a Jehová; y alabasen en la hermosura de la santidad, mientras que salía la gente armada, y dijesen: Glorificád a Jehová, porque su misericordia es para siempre.',
        22: 'Y como comenzaron con clamor y con alabanza, puso Jehová asechanzas contra los hijos de Ammón, de Moab, y del monte de Seir, que venían contra Judá: y matáronse los unos a los otros.',
        23: 'Y los hijos de Ammón y Moab se levantaron contra los del monte de Seir, para matarlos y destruirlos: y como hubieron acabado a los del monte de Seir, cada cual ayudó a su compañero a matarse.',
        24: 'Y como vino Judá a la atalaya del desierto, miraron por la multitud, y, hélos aquí que estaban tendidos en tierra muertos, que ninguno había escapado.',
        25: 'Y viniendo Josafat y su pueblo a despojarlos, hallaron en ellos muchas riquezas, y cuerpos muertos, y vestidos, y vasos preciados; los cuales tomaron para sí, que no los podían llevar: tres días duró el despojo, porque era mucho.',
        26: 'Y al cuarto día juntáronse en el valle de la bendición, porque allí bendijeron a Jehová: y por esto llamaron al nombre de aquel lugar el valle de Beraca, hasta hoy.',
        27: 'Y todo Judá, y los de Jerusalem, y Josafat por su cabeza, volvieron para tornarse a Jerusalem con gozo, porque Jehová les había dado gozo de sus enemigos.',
        28: 'Y vinieron a Jerusalem con salterios, arpas, y bocinas a la casa de Jehová.',
        29: 'Y vino el pavor de Dios sobre todos los reinos de la tierra, cuando oyeron que Jehová había peleado contra los enemigos de Israel.',
        30: 'Y el reino de Josafat tuvo reposo, porque su Dios le dio reposo de todas partes.',
        31: 'Así reinó Josafat sobre Judá: de treinta y cinco años era cuando comenzó a reinar: y reinó veinte y cinco años en Jerusalem. El nombre de su madre fue Azuba, hija de Selaquí.',
        32: 'Y anduvo en el camino de Asa su padre, sin apartarse de él, haciendo lo que era recto en los ojos de Jehová.',
        33: 'Con todo eso los altos no eran quitados; que el pueblo aun no había aparejado su corazón al Dios de sus padres.',
        34: 'Lo demás de los hechos de Josafat, primeros y postreros, he aquí, están escritos en las palabras de Jehú, hijo de Janani, del cual es hecha mención en el libro de los reyes de Israel.',
        35: '¶ Pasadas estas cosas, Josafat rey de Judá hizo amistad con Ocozías rey de Israel, el cual fue dado a impiedad.',
        36: 'E hizo con él compañía para aparejar navíos, que fuesen a Társis. E hicieron navíos en Asión-gaber.',
        37: 'Entonces Eliezer, hijo de Dodava de Maresa, profetizó contra Josafat, diciendo: Por cuanto has hecho compañía con Ocozías, Jehová destruirá tus obras. Y los navíos se quebraron, y no pudieron ir a Társis.',
    },
    21: {
        ...
        8: 'En los días de este se rebeló Edom para no estar debajo de la mano de Judá, y pusieron rey sobre sí.',
        ...
        13: 'Antes, has andado en el camino de los reyes de Israel, y has hecho que fornicase Judá y los moradores de Jerusalem, como fornicó la casa de Acab: además de esto has muerto a tus hermanos, la casa de tu padre, los cuales eran mejores que tú:',
        ...
        16: '¶ Y despertó Jehová contra Joram el espíritu de los Filisteos, y de los Árabes, que estaban junto a los Etiopes:',
        17: 'Y subieron contra Judá, y corrieron la tierra, y saquearon toda la hacienda que hallaron en la casa del rey, y a sus hijos, y a sus mujeres; que no le quedó hijo, sino fue Joacas el menor de sus hijos.',
    ...
    22: {
        1: 'Y los moradores de Jerusalem hicieron rey a Ocozías su hijo menor en su lugar: porque el ejército que había venido con los Árabes en el campo había muerto todos los mayores: por lo cual reinó Ocozías, hijo de Joram rey de Judá.',
        2: 'Cuando Ocozías comenzó a reinar era de cuarenta y dos años, y reinó un año en Jerusalem. El nombre de su madre fue Atalía, hija de Amrí.',
        3: 'Este también anduvo en los caminos de la casa de Acab; porque su madre le aconsejaba a hacer impíamente.',
        4: 'E hizo lo malo en ojos de Jehová, como la casa de Acab; porque después de la muerte de su padre ellos le aconsejaron para su perdición.',
        ...
        6: 'Y volvió para curarse a Jezrael de las heridas que tenía, que le habían dado en Rama peleando con Hazael rey de Siria. Y descendió Azarías, hijo de Joram, rey de Judá, a visitar a Joram, hijo de Acab, en Jezrael, porque allí estaba enfermo.',
        7: 'Y esto empero venía de Dios, para que Ocozías fuese hollado viniendo a Joram: porque siendo venido, salió con Joram a encontrarse con Jehú, hijo de Namsí, al cual Jehová había ungido para que talase la casa de Acab.',
        8: 'Y fue, qué, haciendo juicio Jehú con la casa de Acab, halló a los príncipes de Judá, y a los hijos de los hermanos de Ocozías, que servían a Ocozías, y los mató.',
        9: 'Y buscando a Ocozías, el cual se había escondido en Samaria, le tomaron, y le trajeron a Jehú; y le mataron, y le sepultaron; porque dijeron: Es hijo de Josafat, el cual buscó a Jehová de todo su corazón. Y la casa de Ocozías no tenía fuerzas para poder retener el reino.',
        10: '¶ Entonces Atalía, madre de Ocozías, viendo que su hijo era muerto, levantóse, y destruyó toda la simiente real de la casa de Judá:',
        11: 'Y Josabet, hija del rey, tomó a Joas, hijo de Ocozías, y hurtóle de entre los hijos del rey que mataban, y guardóle a él y a su ama en la cámara de los lechos: y así le escondió Josabet, hija del rey Joram, (mujer de Joiada el sacerdote, porque ella era hermana de Ocozías,) de delante de Atalía, y no le mataron.',
        12: 'Y estuvo con ellos escondido en la casa de Dios seis años. Y Atalía reinaba en la tierra.',
    },
    23: {
    ...
    24: {
        1: 'De siete años era Joas, cuando comenzó a reinar, y cuarenta años reinó en Jerusalem. El nombre de su madre fue Sebia de Beer-seba.',
    ...
    30: {
        1: 'Envió también Ezequías por todo Israel y Judá, y escribió cartas a Efraím y Manasés, que viniesen a Jerusalem a la casa de Jehová, para celebrar la pascua a Jehová Dios de Israel.',
        2: 'Y el rey tomó consejo con sus príncipes, y con toda la congregación en Jerusalem, para hacer la pascua en el mes segundo.',
        3: 'Porque entonces no la podían hacer, por cuanto no había hartos sacerdotes santificados, ni el pueblo estaba congregado en Jerusalem.',
        4: 'Esto agradó al rey, y a toda la multitud.',
        5: 'Y determinaron de hacer pasar pregón por todo Israel desde Beer-seba hasta Dan, para que viniesen a hacer la pascua a Jehová Dios de Israel en Jerusalem: porque en mucho tiempo no la habían hecho como estaba escrito.',
        6: 'Y fueron correos con cartas de la mano del rey y de sus príncipes por todo Israel y Judá, como el rey lo había mandado, y decían: Hijos de Israel, volvéos a Jehová el Dios de Abraham, de Isaac, y de Israel, y él se volverá a los restos que os han quedado de la mano de los reyes de Asiria.',
        7: 'No seáis como vuestros padres, y como vuestros hermanos, que se rebelaron contra Jehová el Dios de sus padres, y él los entregó en asolamiento, como vosotros veis.',
        8: 'Por tanto ahora no endurezcáis vuestra cerviz, como vuestros padres: dad la mano a Jehová; y veníd a su santuario, el cual él ha santificado para siempre: y servíd a Jehová vuestro Dios, y la ira de su furor se apartará de vosotros:',
        9: 'Porque si os volviereis a Jehová, vuestros hermanos y vuestros hijos hallarán misericordia delante de los que los tienen cautivos, y volverán a esta tierra: porque Jehová vuestro Dios es clemente, y misericordioso, y no volverá de vosotros su rostro, si vosotros os volviereis a él.',
        10: 'Y así pasaban los correos de ciudad en ciudad por la tierra de Efraím y Manasés hasta Zabulón: mas ellos se reían y burlaban de ellos.',
        11: 'Con todo eso algunos varones de Aser, de Manasés, y de Zabulón se humillaron, y vinieron a Jerusalem.',
        12: 'En Judá también fue la mano de Dios para darles un corazón para hacer el mandado del rey y de los príncipes, conforme a la palabra de Jehová.',
        13: 'Y juntáronse en Jerusalem un grande pueblo, para hacer la solemnidad de los panes sin levadura en el mes segundo, una grande congregación.',
        14: 'Y levantándose quitaron los altares, que estaban en Jerusalem: y todos los altares de perfumes quitaron, y echáronlos en el arroyo de Cedrón.',
        15: 'Y sacrificaron la pascua a los catorce del mes segundo, y los sacerdotes y los Levitas se avergonzaron, y se santificaron, y trajeron los holocaustos a la casa de Jehová.',
        16: 'Y pusiéronse en su orden conforme a su costumbre; conforme a la ley de Moisés varón de Dios, los sacerdotes esparcían la sangre de la mano de los Levitas.',
        17: 'Porque aun había muchos en la congregación que no estaban santificados, y los Levitas sacrificaban la pascua por todos los que no se habían limpiado para santificarse a Jehová.',
        18: 'Porque grande multitud del pueblo, de Efraím, y Manasés, e Isacar, y Zabulón, no se habían purificado, y comieron la pascua no conforme a lo que era escrito: mas Ezequías oró por ellos, diciendo: Jehová, que es bueno, sea propicio',
        19: 'A todo aquel que ha apercebido su corazón para buscar a Dios, a Jehová el Dios de sus padres, aunque no esté purificado según la purificación del santuario.',
        20: 'Y oyó Jehová a Ezequías, y sanó el pueblo.',
        21: 'Así hicieron los hijos de Israel, que fueron presentes en Jerusalem, la solemnidad de los panes sin levadura siete días con gran gozo: y alababan a Jehová todos los días los Levitas y los sacerdotes, con instrumentos de fortaleza a Jehová.',
        22: 'Y Ezequías habló al corazón de todos los Levitas que tenían buena inteligencia para Jehová: y comieron la solemnidad por siete días sacrificando sacrificios pacíficos, y haciendo gracias a Jehová el Dios de sus padres.',
        23: 'Y toda la multitud determinó que celebrasen otros siete días, y celebraron otros siete días con alegría.',
        24: 'Porque Ezequías rey de Judá había dado a la multitud mil novillos, y siete mil ovejas: y también los príncipes dieron al pueblo mil novillos y diez mil ovejas: y muchos sacerdotes se santificaron.',
        ...
        26: 'E hiciéronse grandes alegrías en Jerusalem: porque desde los días de Salomón, hijo de David, rey de Israel, no hubo tal cosa en Jerusalem.',
        27: 'Y levantándose los sacerdotes y Levitas bendijeron al pueblo: y la voz de ellos fue oída, y su oración llegó a la habitación de su santuario, al cielo.',
    },
    31: {
        1: 'Hechas todas estas cosas, salió todo Israel, los que se habían hallado por las ciudades de Judá, y quebraron las estatuas, y destruyeron los bosques, y derribaron los altos y los altares por todo Judá y Ben-jamín: y también en Efraím y Manasés hasta acabarlo todo: y volviéronse todos los hijos de Israel cada uno a su posesión, y a sus ciudades.',
        ...
        5: 'Y como este edicto fue divulgado, los hijos de Israel dieron muchas primicias de grano, vino, aceite, miel, y de todos los frutos de la tierra: y trajeron asimismo los diezmos de todas las cosas en abundancia.',
        ...
        11: 'Entonces mandó Ezequías que aparejasen cámaras en la casa de Jehová: y las aparejaron.',
        ...
        15: 'Y a su mano estaban Edén, Ben-jamín, Jesué, Semeías, Amarías, y Sequenías, en las ciudades de los sacerdotes, para dar con fidelidad a sus hermanos sus partes conforme a sus ordenes, así al mayor como al menor;',
        16: 'Sin lo que se contaba para los varones de edad de tres años y arriba, a todos los que entraban en la casa de Jehová, cada cosa en su día por su ministerio, por sus estancias, y por sus ordenes:',
        17: 'Y a los que eran contados entre los sacerdotes por las familias de sus padres, y a los Levitas de edad de veinte años y arriba por sus estancias y ordenes.',
        18: 'Asimismo a los de su generación con todos sus niños, y sus mujeres, y sus hijos, e hijas, para toda la congregación: porque por la fe de estos se repartían las ofrendas.',
        ...
        21: 'En todo cuanto comenzó en el servicio de la casa de Dios, y en la ley y mandamientos, buscó a su Dios: e hizo de todo corazón, y fue prosperado.',
    },
    32: {
        1: 'Después de estas cosas, y de esta fidelidad, vino Sennaquerib rey de los Asirios, y entró en Judá, y asentó campo contra las ciudades fuertes, y determinó de entrarlas.',
        2: 'Viendo pues Ezequías la venida de Sennaquerib, y que tenía el rostro puesto para hacer la guerra a Jerusalem,',
        3: 'Tuvo su consejo con sus príncipes, y con sus valerosos, que tapasen las fuentes de las aguas, que estaban fuera de la ciudad: y ellos le ayudaron.',
        4: 'Y juntóse mucho pueblo, y taparon todas las fuentes: y también el arroyo que va por medio de la tierra, diciendo: ¿Por qué han de hallar los reyes de Asiria muchas aguas cuando vinieren?',
        5: 'Confortóse pues Ezequías, y edificó todos los muros caídos, e hizo alzar las torres, y otro muro por de fuera: y fortificó a Mello en la ciudad de David, e hizo muchas espadas y paveses.',
        6: 'Y puso capitanes de guerra sobre el pueblo, e hízolos congregar a sí en la plaza de la puerta de la ciudad, y hablóles al corazón de ellos, diciendo:',
        7: 'Esforzáos y confortáos; no temáis, ni hayáis miedo del rey de Asiria, ni de toda su multitud que con él viene: porque más son con nosotros que con él.',
        8: 'Con él es el brazo de carne, mas con nosotros Jehová nuestro Dios para ayudarnos, y pelear nuestras peleas. Entonces el pueblo reposó sobre las palabras de Ezequías rey de Judá.',
        9: '¶ Después de esto envió Sennaquerib rey de los Asirios sus siervos a Jerusalem, estando él sobre Laquis, y con él toda su potencia, a Ezequías rey de Judá, y a todo Judá, que estaba en Jerusalem, diciendo:',
        10: 'Sennaquerib rey de los Asirios ha dicho así: ¿En qué confiáis vosotros para estar cercados en Jerusalem?',
        11: '¿No os engaña Ezequías para entregaros a muerte, a hambre, y a sed, diciendo: Jehová nuestro Dios nos librará de la mano del rey de Asiria?',
        12: '¿No es Ezequías el que ha quitado sus altos y sus altares, y dijo a Judá, y a Jerusalem: Delante de este solo altar adoraréis, y sobre él quemaréis perfume?',
        13: '¿No habéis sabido lo que yo y mis padres habemos hecho a todos los pueblos de las tierras? ¿Pudieron los dioses de las gentes de las tierras librar su tierra de mi mano?',
        14: '¿Qué dios hubo de todos los dioses de aquellas gentes que destruyeron mis padres, que puediese librar su pueblo de mis manos? ¿Por qué podrá vuestro Dios escaparos de mi mano?',
        15: 'Ahora pues no os engañe Ezequías, ni os persuada tal cosa, ni le creáis; que si ningún dios de todas aquellas naciones y reinos pudo librar su pueblo de mis manos, y de las manos de mis padres, ¿cuánto menos vuestros dioses os podrán librar de mi mano?',
        16: 'Y otras cosas hablaron sus siervos contra el Dios Jehová, y contra Ezequías su siervo.',
        17: 'Y además de esto escribió cartas en las cuales blasfemaba a Jehová el Dios de Israel, y hablaba contra él, diciendo: Como los dioses de las gentes de las provincias no pudieron librar su pueblo de mis manos, tampoco el Dios de Ezequías librará al suyo de mis manos.',
        18: 'Y clamaron a gran voz en Judaico contra el pueblo de Jerusalem que estaba en los muros, para espantarlos y ponerles temor, para tomar la ciudad.',
        ...
        21: 'Y Jehová envió un ángel, el cual hirió todo valiente en fuerzas, y los capitanes, y los príncipes, en el campo del rey de Asiria: y volvióse con vergüenza de rostro a su tierra: y entrando en el templo de su dios, allí le pasaron a cuchillo los que habían salido de sus entrañas.',
        22: 'Así salvó Jehová a Ezequías y a los moradores de Jerusalem de las manos de Sennaquerib rey de Asiria, y de las manos de todos: y les dio reposo de todas partes.',
        23: 'Y muchos trajeron presente a Jehová a Jerusalem, y a Ezequías rey de Judá ricos dones: y fue muy grande delante de todas las gentes después de esto.',
        24: '¶ En aquel tiempo Ezequías enfermó de muerte: y oró a Jehová: el cual le respondió, y le dio señal.',
        25: 'Mas Ezequías no pagó conforme al bien, que le había sido hecho: antes su corazón se enalteció, y fue la ira contra él, y contra Judá, y Jerusalem.',
        26: 'Empero Ezequías, después de haberse enaltecido su corazón, se humilló, él y los moradores de Jerusalem: y no vino sobre ellos la ira de Jehová en los días de Ezequías.',
        27: 'Y tuvo Ezequías riquezas y gloria mucha en gran manera: e hízose tesoros de plata y oro, de piedras preciosas, de especierías, de escudos, y de todos vasos de desear;',
        ...
        29: 'Hízose también ciudades, y hatos de ovejas y de vacas en gran copia: porque Dios le había dado muy mucha hacienda.',
        30: 'Este Ezequías cerró los manaderos de las aguas de Gijón, la de arriba, y encaminólas abajo al occidente de la ciudad de David: y fue prosperado Ezequías en todo lo que hizo.',
        31: 'Empero a causa de los embajadores de los príncipes de Babilonia, que enviaron a él para saber del prodigio que había sido en aquella tierra, Dios le dejó, para tentarle, para saber todo lo que estaba en su corazón.',
        32: 'Lo demás de los hechos de Ezequías, y de sus misericordias, he aquí, todo está escrito en la profecía de Isaías, hijo de Amós profeta, y en el libro de los reyes de Judá y de Israel.',
        33: 'Y durmió Ezequías con sus padres, y sepultáronle en los más insignes sepulcros de los hijos de David, honrándole en su muerte todo Judá y los de Jerusalem: y reinó en su lugar Manasés su hijo.',
    },
    33: {
        1: 'De doce años era Manasés, cuando comenzó a reinar, y cincuenta y cinco años reinó en Jerusalem.',
        2: 'E hizo lo malo en los ojos de Jehová, conforme a las abominaciones de las gentes que había echado Jehová delante de los hijos de Israel.',
        ...
        4: 'Edificó también altares en la casa de Jehová, de la cual Jehová había dicho: En Jerusalem será mi nombre perpetuamente.',
        5: 'Edificó asimismo altares a todo el ejército de los cielos en los dos patios de la casa de Jehová.',
        6: 'Y pasó sus hijos por fuego en el valle de los hijos de Ennon: miraba en los tiempos, miraba en agüeros, y era dado a adivinaciones, consultaba pitones y encantadores: multiplicó en hacer lo malo en ojos de Jehová para irritarle.',
        7: 'Además de esto puso una imagen de fundición que hizo, en la casa de Dios, de la cual Dios había dicho a David, y a Salomón su hijo: En esta casa, y en Jerusalem, la cual yo elegí sobre todas las tribus de Israel, pondré mi nombre para siempre:',
        ...
        9: 'Así que Manasés hizo descaminar a Judá y a los moradores de Jerusalem, para hacer más mal que las gentes que Jehová destruyó delante de los hijos de Israel.',
        10: 'Y Jehová hablo a Manasés y a su pueblo; mas ellos no escucharon: por lo cual Jehová trajo contra ellos los príncipes del ejército del rey de los Asirios, los cuales echaron en grillos a Manasés: y atado con dos cadenas le llevaron a Babilonia.',
        11: '¶ Mas después que fue puesto en angustias oró a la faz de Jehová su Dios, humillado grandemente en la presencia del Dios de sus padres.',
        12: 'Y como oró a él, fue oído: porque él oyó su oración, y le volvió a Jerusalem a su reino. Entonces conoció Manasés que Jehová era Dios.',
        13: 'Después de esto edificó el muro de a fuera de la ciudad de David, al occidente de Gijón en el valle, y a la entrada de la puerta del pescado, y cercó a Ofel, y alzólo muy alto: y puso capitanes de ejército en todas las ciudades fuertes por Judá.',
        14: 'Asimismo quitó los dioses ajenos, y el ídolo de la casa de Jehová, y todos los altares que había edificado en el monte de la casa de Jehová, y en Jerusalem, y echólo todo fuera de la ciudad.',
        15: 'Y reparó el altar de Jehová, y sacrificó sobre él sacrificios pacíficos, y de alabanza: y mandó a Judá que sirviesen a Jehová Dios de Israel.',
        16: 'Empero el pueblo aun sacrificaba en los altos, aunque a Jehová su Dios.',
        17: 'Lo demás de los hechos de Manasés, y su oración a su Dios, y las palabras de los videntes que le hablaron en nombre de Jehová el Dios de Israel, he aquí, todo está escrito en los hechos de los reyes de Israel.',
        18: 'Su oración también, y como fue oído, todos sus pecados, y su prevaricación, los lugares donde edificó altos y había puesto bosques e ídolos antes que se humillase, he aquí, estas cosas están escritas en las palabras de los videntes.',
        19: 'Y durmió Manasés con sus padres, y sepultáronle en su casa: y reinó en su lugar Amón su hijo.',
        20: 'De veinte y dos años era Amón, cuando comenzó a reinar, y dos años reinó en Jerusalem.',
        21: 'E hizo lo malo en ojos de Jehová, como había hecho Manasés su padre: porque a todos los ídolos que su padre Manasés había hecho, sacrificó y sirvió Amón.',
        22: 'Mas nunca se humilló delante de Jehová, como Manasés su padre se humilló, antes aumentó el pecado.',
        23: 'Y conspiraron contra él sus siervos, y matáronle en su casa.',
        24: 'Mas el pueblo de la tierra hirió a todos los que habían conspirado contra el rey Amón: y el pueblo de la tierra puso por rey en su lugar a Josías su hijo.',
    },
    34: {
    ...
    35: {
        1: 'Y Josías hizo pascua a Jehová en Jerusalem, y sacrificaron la pascua a los catorce del mes primero.',
        ...
        4: 'Apercebíos según las familias de vuestros padres por vuestros ordenes, conforme a la prescripción de David rey de Israel, y de Salomón su hijo.',
        ...
        6: 'Y sacrificád la pascua, y santificáos, y apercebíd vuestros hermanos, que hagan conforme a la palabra de Jehová dada por mano de Moisés.',
        7: 'Y ofreció el rey Josías a los del pueblo, ovejas, corderos, y cabritos de las cabras, todo para la pascua, para todos los que se hallaron presentes, en cantidad de treinta mil, y bueyes tres mil. Esto de la hacienda del rey.',
        8: 'También sus príncipes ofrecieron con liberalidad al pueblo, y a los sacerdotes y Levitas: Helcías, Zacarías, y Jehiel, príncipes de la casa de Dios, dieron a los sacerdotes para hacer la pascua dos mil y seiscientas ovejas, y trescientos bueyes.',
        9: 'Asimismo Conenías, Semeías, y Natanael sus hermanos, y Hasabías, Jehiel y Josabad, príncipes de los Levitas, dieron a los Levitas para los sacrificios de la pascua cinco mil ovejas, y quinientos bueyes.',
        10: 'Aparejado así el servicio, los sacerdotes se pusieron en sus estancias, y asimismo los Levitas en sus ordenes, conforme al mandamiento del rey,',
        11: 'Y sacrificaron la pascua, y esparcieron los sacerdotes la sangre tomada de la mano de los Levitas, y los Levitas desollaban.',
        ...
        13: 'Y asaron la pascua en fuego, según la costumbre: mas lo que había sido santificado, cocieron en ollas, en calderos, y calderas, y repartiéronlo prestamente a todo el pueblo.',
        ...
        16: 'Así fue aparejado todo el servicio de Jehová en aquel día, para hacer la pascua y sacrificar los holocaustos sobre el altar de Jehová, conforme al mandamiento del rey Josías.',
        17: 'E hicieron los hijos de Israel, que se hallaron presentes, la pascua en aquel tiempo, y la solemnidad de los panes sin levadura, por siete días.',
        18: 'Nunca tal pascua fue hecha en Israel desde los días de Samuel el profeta: ni ningún rey de Israel hizo tal pascua, como la que hizo el rey Josías y los sacerdotes y Levitas, y todo Judá e Israel, los que se hallaron presentes, juntamente con los moradores de Jerusalem.',
        19: 'Esta pascua fue celebrada en el año diez y ocho del rey Josías.',
        ...
        21: 'Y él le envió embajadores, diciendo: ¿Qué tenemos yo y tu, rey de Judá? Yo no vengo contra ti hoy, sino contra la casa que me hace guerra: y Dios dijo que me apresurase. Déjate de tomarte con Dios, que es conmigo, no te destruya.',
        22: 'Mas Josías no volvió su rostro atrás de él, antes se disfrazó para darle batalla, y no oyó a las palabras de Necao, que eran de boca de Dios. Y vino a darle la batalla en el campo de Mageddo.',
        ...
        24: 'Entonces sus siervos le quitaron de aquel carro, y pusiéronle en otro segundo carro que tenía: y trajéronle a Jerusalem y murió: y sepultáronle en los sepulcros de sus padres. Y todo Judá y Jerusalem puso luto por Josías.',
