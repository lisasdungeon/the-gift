...
CHAPTERS = {
    1: {
        1: 'Estas son las palabras que habló Moisés a todo Israel de esta parte del Jordán en el desierto, en el llano, delante del mar Bermejo, entre Farán, y Tofel, y Labán, y Jaserot, y Dizahab.',
        2: 'Once jornadas hay desde Horeb camino del monte de Seir hasta Cádes-barne.',
        3: 'Y fue, que a los cuarenta años, en el mes undécimo, al primero del mes, Moisés habló a los hijos de Israel conforme a todas las cosas que Jehová le había mandado acerca de ellos:',
        ...
        15: 'Y tomé los principales de vuestras tribus, varones sabios y expertos, y púselos por príncipes sobre vosotros, príncipes de millares, y príncipes de cientos, y príncipes de cincuenta, y príncipes de diez, y gobernadores a vuestras tribus.',
        16: 'Y entonces mandé a vuestros jueces, diciendo: Oíd entre vuestros hermanos: juzgád justamente entre el hombre y su hermano, y entre su extranjero.',
        17: 'No tengáis respeto de personas en el juicio: así al pequeño como al grande oiréis: no habréis temor de ninguno, porque el juicio es de Dios: y la causa que os fuere difícil, llegaréis a mí, y yo la oiré.',
        18: 'Y entonces os mandé todo lo que hubieseis de hacer.',
        19: '¶ Y partidos de Horeb, anduvimos todo este desierto grande y temeroso, que habéis visto, por el camino del monte del Amorreo, como Jehová nuestro Dios nos lo mandó: y llegamos hasta Cádes-barne.',
        ...
        22: '¶ Y llegasteis a mí todos vosotros, y dijisteis: Enviemos varones delante de nosotros, que nos reconozcan la tierra, y nos tornen la respuesta; el camino por donde hemos de subir, y las ciudades a donde hemos de venir.',
        ...
        27: 'Y murmurasteis en vuestras tiendas, diciendo: Porque Jehová nos aborrecía, nos sacó de tierra de Egipto, para entregarnos en mano del Amorreo para destruirnos.',
        ...
        29: 'Entonces yo os dije: No temáis, ni hayáis miedo de ellos:',
        ...
        32: 'Y aun con esto no habéis creído en Jehová vuestro Dios.',
        ...
        38: 'Josué hijo de Nun, que está delante de ti, él entrará allá; esfuérzale, porque él la hará heredar a Israel.',
        ...
        42: 'Y Jehová me dijo: Díles: No subáis, ni peleéis, porque yo no estoy entre vosotros, y no seáis heridos delante de vuestros enemigos.',
        43: 'Y os hablé y no oísteis; antes os rebelasteis al dicho de Jehová, y porfiasteis con soberbia, y subisteis al monte.',
        44: 'Y salió el Amorreo, que habitaba en aquel monte, a vuestro encuentro, y os persiguieron, como hacen las avispas, y os quebrantaron en Seir hasta Jorma.',
        45: 'Y volvisteis, y llorasteis delante de Jehová, y Jehová no oyó vuestra voz, ni os escuchó.',
        46: 'Y estuvisteis en Cádes por muchos días, como parece en los días que habéis estado.',
    },
    2: {
    ...
    3: {
        ...
        8: 'Y tomamos entonces la tierra de mano de dos reyes Amorreos que estaba de esta parte del Jordán, desde el arroyo de Arnón hasta el monte de Hermón.',
        ...
        12: '¶ Y esta tierra heredamos entonces desde Aroer, que está al arroyo de Arnón; y la mitad del monte de Galaad con sus ciudades di a los Rubenitas y a los Gaditas:',
        13: 'Y la resta de Galaad y toda la Basán del reino de Og di a la media tribu de Manasés, toda la tierra de Argob toda Basán, que se llamaba la tierra de los gigantes.',
        ...
        16: 'Y a los Rubenitas y Gaditas di a Galaad hasta el arroyo de Arnón, el medio del arroyo por término hasta el arroyo de Jeboc, el término de los hijos de Ammón:',
        ...
        18: 'Y mandéos entonces, diciendo: Jehová vuestro Dios os ha dado esta tierra, que la poseáis: pasaréis armados delante de vuestros hermanos los hijos de Israel todos los valientes.',
        ...
        21: 'Mandé también a Josué entonces, diciendo: Tus ojos ven todo lo que Jehová vuestro Dios ha hecho a aquellos dos reyes; así hará Jehová a todos los reinos a los cuales tú pasarás.',
        22: 'No los temáis, que Jehová vuestro Dios, él es el que pelea por vosotros.',
        23: '¶ Y oré a Jehová entonces, diciendo:',
        ...
        27: 'Sube a la cumbre del Fasga, y alza tus ojos al occidente, y al aquilón, y al mediodía, y al oriente, y ve por tus ojos: porque no pasarás este Jordán.',
    ...
    4: {
        1: 'Ahora pues, oh Israel, oye los estatutos, y derechos que yo os enseño para que hagáis, y viváis, y entréis, y heredéis la tierra que Jehová el Dios de vuestros padres te da.',
        ...
        3: 'Vuestros ojos vieron lo que hizo Jehová por Baal-pehor: que a todo hombre que fue en pos de Baal-pehor destruyó Jehová tu Dios de en medio de ti:',
        ...
        10: 'El día que estuviste delante de Jehová tu Dios en Horeb, cuando Jehová me dijo: Júntame el pueblo, para que yo les haga oír mis palabras, las cuales aprenderán para temerme todos los días que vivieren sobre la tierra, y enseñarán a sus hijos.',
        11: 'Y os llegasteis, y os pusisteis al pie del monte, y el monte ardía en fuego hasta en medio de los cielos, tinieblas, nube, y oscuridad.',
        12: 'Y habló Jehová con vosotros de en medio del fuego; la voz de sus palabras oísteis, mas figura ninguna visteis más de la voz.',
        13: 'Y él os denunció su concierto, el cual os mandó que hicieseis, las diez palabras, y escribiólas en dos tablas de piedra.',
        14: 'A mí también me mandó Jehová entonces, que os enseñase los estatutos y derechos, para que los hicieseis en la tierra, a la cual pasáis, para poseerla.',
        ...
        16: 'Que no corrompáis, y hagáis para vosotros escultura, imagen de alguna semejanza, figura de macho o de hembra:',
        ...
        20: 'Empero a vosotros Jehová os tomó, y os sacó del horno de hierro, de Egipto, para que seáis a él por pueblo de heredad, como parece en este día.',
        ...
        23: 'Guardáos no os olvidéis del concierto de Jehová vuestro Dios, que él concertó con vosotros, y os hagáis escultura, imagen de cualquier cosa, como Jehová tu Dios te ha mandado.',
        24: 'Porque Jehová tu Dios es fuego que consume, Dios zeloso.',
        25: '¶ Cuando hubiereis engendrado hijos y nietos, y hubiereis envejecido en aquella tierra, y corrompiereis, e hiciereis escultura, imagen de cualquier cosa, e hiciereis mal en ojos de Jehová vuestro Dios para enojarle,',
        26: 'Yo pongo hoy por testigos al cielo y a la tierra, que pereciendo pereceréis presto de la tierra a la cual pasáis el Jordán para heredarla: no estaréis en ella largos días, que no seáis destruidos.',
        ...
        32: '¶ Porque pregunta ahora de los tiempos antiguos, que han sido antes de ti, desde el día que creó Dios al hombre sobre la tierra, y desde el un cabo del cielo al otro, ¿si se ha hecho cosa semejante a esta gran cosa, o se haya oído otra como ella?',
        33: '¿Ha oído pueblo alguno la voz de Dios, que hablase de en medio del fuego, y ha vivido, como tú la oíste?',
        ...
        35: 'A ti te fue mostrado, para que supieses, que Jehová él es Dios, no hay más fuera de él.',
        36: 'De los cielos te hizo oír su voz, para enseñarte, y sobre la tierra te mostró su gran fuego, y sus palabras has oído de en medio del fuego.',
        ...
        38: 'Para echar de delante de ti gentes grandes, y más fuertes que tú, y para meterte a ti, y darte su tierra por heredad, como parece hoy.',
        ...
        40: 'Y guarda sus estatutos y sus mandamientos, que yo te mando hoy, para que hayas bien tú y tus hijos después de ti, y prolongues tus días sobre la tierra, que Jehová tu Dios te da todo el tiempo.',
        ...
        46: 'De esta parte del Jordán en el valle, delante de Bet-pehor en la tierra de Sejón rey de los Amorreos, que habitaba en Jesebón, al cual hirió Moisés y los hijos de Israel, cuando hubieron salido de Egipto.',
    ...
    6: {
        1: 'Estos pues son los mandamientos, estatutos, y derechos, que Jehová vuestro Dios mandó que os enseñase que hagáis en la tierra a la cual vosotros pasáis para heredarla;',
        ...
        3: 'Oye pues, oh Israel, y guarda que hagas, para que hayas bien, y seáis muy multiplicados, como te ha dicho Jehová el Dios de tus padres, en la tierra que corre leche y miel.',
        ...
        15: 'Porque el Dios zeloso Jehová tu Dios en medio de ti está, porque no se aire el furor de Jehová tu Dios contra ti, y te destruya de sobre la haz de la tierra.',
        ...
        22: 'Y dio Jehová señales y milagros grandes y malos en Egipto sobre Faraón, y sobre toda su casa delante de nuestros ojos:',
        23: 'Y nos sacó de allá para traernos, y darnos la tierra, que juró a nuestros padres.',
        24: 'Y nos mandó Jehová que hiciésemos todos estos estatutos, para que temamos a Jehová nuestro Dios, para que hayamos bien todos los días, para que nos dé vida, como parece hoy.',
    ...
    7: {
        1: 'Cuando Jehová tu Dios te hubiere metido en la tierra en la cual tú has de entrar para heredarla, y hubiere echado las muchas gentes de delante de tu presencia, al Jetteo, y al Gergeseo, y al Amorreo, y al Cananeo, y al Ferezeo, y al Heveo, y al Jebuseo, siete naciones muchas y fuertes más que tú;',
        2: 'Y Jehová tu Dios las hubiere entregado delante de ti, y las hirieres, destruyendo las destruirás: no harás con ellos alianza, ni los tomarás a merced:',
        3: 'Y no consuegrarás con ellos: no darás tu hija a su hijo, ni tomarás su hija para tu hijo;',
        4: 'Porque tirará a tu hijo de en pos de mí, y servirán a dioses ajenos; y el furor de Jehová se encenderá sobre vosotros, y destruirte ha presto.',
        5: 'Sino así haréis con ellos: Sus altares destruiréis, y sus estatuas quebraréis, y cortaréis sus bosques, y sus esculturas quemaréis en el fuego.',
        6: '¶ Porque tú eres pueblo santo a Jehová tu Dios: Jehová tu Dios te ha escogido para ser a él un pueblo singular más que todos los pueblos, que están sobre la haz de la tierra.',
        7: 'No por ser vosotros más que todos los pueblos, os ha codiciado Jehová, y os ha escogido: porque vosotros eráis los más pocos de todos los pueblos:',
        8: 'Mas porque Jehová os amó, y quiso guardar el juramento que juró a vuestros padres, os sacó Jehová con mano fuerte, y os rescató de casa de siervos, de la mano de Faraón rey de Egipto.',
        9: 'Y para que sepas que Jehová tu Dios es Dios, Dios fiel, que guarda el concierto y la misericordia a los que le aman, y guardan sus mandamientos hasta las mil generaciones:',
        ...
        12: '¶ Y será, que por haber oído estos derechos, y guardado, y hécholos, Jehová tu Dios guardará contigo el concierto y la misericordia, que juró a tus padres:',
        13: 'Y amarte ha, y bendecirte ha, y multiplicarte ha: y bendecirá el fruto de tu vientre, y el fruto de tu tierra, y tu grano, y tu mosto, y tu aceite, la cria de tus vacas, y los rebaños de tus ovejas en la tierra, que juró a tus padres que te daría.',
        14: 'Bendito serás más que todos los pueblos: no habrá en ti estéril macho ni hembra, ni en tus bestias.',
        15: 'Y quitará de ti Jehová toda enfermedad, y todas las malas plagas de Egipto, que tú sabes: no las pondrá sobre ti, antes las pondrá sobre todos los que te aborrecieren.',
        16: 'Y consumirás a todos los pueblos, que Jehová tu Dios te da: no los perdonará tu ojo: no servirás a sus dioses, que te será tropezón.',
        17: '¶ Cuando dijeres en tu corazón: Aquellas gentes son muchas más que yo, ¿cómo las podré yo desarraigar?',
        ...
        21: 'No desmayes delante de ellos, que Jehová tu Dios está en medio de ti, Dios grande y temeroso.',
        22: 'Y Jehová tu Dios echará estas gentes de delante de ti poco a poco: no las podrás acabar luego: porque las bestias del campo no se aumenten contra ti.',
        23: 'Mas Jehová tu Dios las entregará delante de ti, y él las quebrantará de un gran quebrantamiento, hasta que sean destruidos.',
        ...
        25: '¶ Las esculturas de sus dioses quemarás en el fuego, no codiciarás plata ni oro de sobre ellas para tomártelo, porque no tropieces en ello, porque es abominación a Jehová tu Dios.',
    ...
    8: {
        1: 'Todo mandamiento, que yo os mando hoy, guardaréis para hacer lo, porque viváis, y seáis multiplicados; y entréis y heredéis la tierra de la cual juró Jehová a vuestros padres.',
        2: 'Y acordarte has de todo el camino, por donde te ha traído Jehová tu Dios estos cuarenta años en el desierto para afligirte, por probarte para saber lo que estaba en tu corazón, si habías de guardar sus mandamientos, o no.',
        3: 'Y afligióte, e hízote haber hambre, y sustentóte con man, comida que no conociste tú, ni tus padres la conocieron; para hacerte saber, que el hombre no vivirá de solo pan, mas de todo lo que sale de la boca de Jehová vivirá el hombre.',
        ...
        17: 'Y digas en tu corazón: Mi potencia, y la fortaleza de mi mano me ha hecho esta riqueza.',
        18: 'Antes te acuerdes de Jehová tu Dios; porque él te da la potencia para hacer las riquezas, para confirmar su concierto, que juró a tus padres: como parece en este día.',
        ...
        20: 'Como las gentes que Jehová destruirá delante de vosotros así pereceréis, por cuanto no habréis oído la voz de Jehová vuestro Dios.',
    },
    9: {
    ...
    13: {
        1: 'Cuando se levantare en medio de ti profeta o soñador de sueño, y te diere señal, o milagro,',
        2: 'Y la señal, o milagro, que él te dijo, viniere, diciendo: Vamos en pos de dioses ajenos, que no conociste, y sirvámosles:',
        3: 'No oirás las palabras del tal profeta, ni al tal soñador de sueño: porque Jehová vuestro Dios os tienta por saber si amáis a Jehová vuestro Dios con todo vuestro corazón, y con toda vuestra alma.',
        4: 'En pos de Jehová vuestro Dios andaréis, y a él temeréis, y sus mandamientos guardaréis, y su voz oiréis, y a él serviréis, y a él os llegaréis.',
        5: 'Y el tal profeta, o soñador de sueño, morirá porque habló rebelión contra Jehová vuestro Dios, que te sacó de tierra de Egipto, y te rescató de casa de siervos para echarte del camino, que Jehová tu Dios te mandó que anduvieses por él, y escombrarás el mal de en medio de ti.',
        6: 'Cuando te incitare tu hermano, hijo de tu madre, o tu hijo, o tu hija, o la mujer de tu seno, o tu amigo que sea como tu alma, diciendo en secreto: Vamos, y sirvamos a dioses ajenos, que ni tú, ni tus padres conocistes,',
        7: 'De los dioses de los pueblos que están en vuestros al derredores, cercanos a ti, o lejos de ti desde el un cabo de la tierra hasta el otro cabo de ella,',
        8: 'No consentirás con él, ni lo oirás, ni tu ojo le perdonará, ni habrás compasión, ni lo encubrirás.',
        9: 'Mas matando le matarás: tu mano será primero sobre él para matarle, y después la mano de todo el pueblo.',
        10: 'Y apedrearle has con piedras, y morirá: por cuanto procuró echarte de Jehová tu Dios, que te sacó de tierra de Egipto, de casa de siervos;',
        ...
        13: 'Hombres, hijos de impiedad, han salido de en medio de ti, que impelieron a los moradores de su ciudad, diciendo: Vamos y sirvamos a dioses ajenos, que vosotros no conocisteis;',
        ...
        15: 'Hiriendo herirás a filo de espada los moradores de aquella ciudad, destruyéndola a filo de espada con todo lo que en ella hubiere y sus bestias:',
        16: 'Y todo el despojo de ella juntarás en medio de su plaza, y quemarás a fuego la ciudad y todo su despojo, todo ello, a Jehová tu Dios: y será montón perpetuo: nunca más se edificará.',
        17: 'Y no se pegará algo a tu mano del anatema; porque Jehová se aparte de la ira de su furor, y te dé mercedes, y haya misericordia de ti, y te multiplique, como lo juró a tus padres,',
        18: 'Cuando obedecieres a la voz de Jehová tu Dios guardando todos sus mandamientos que yo te mando hoy, para hacer lo que es recto en ojos de Jehová tu Dios.',
    },
    14: {
    ...
    16: {
        1: 'Guardarás el mes de los nuevos frutos y harás pascua a Jehová tu Dios, porque en el mes de los nuevos frutos te sacó Jehová tu Dios de Egipto de noche.',
        2: 'Y sacrificarás pascua a Jehová tu Dios de ovejas y de vacas, en el lugar que Jehová escogiere para hacer habitar su nombre en él.',
        3: 'No comerás con ella leudo; siete días comerás con ella panes por leudar, pan de aflicción, porque apriesa saliste de tierra de Egipto: para que te acuerdes del día en que saliste de la tierra de Egipto, todos los días de tu vida.',
        4: 'Y no parecerá levadura en ti, en todo tu término por siete días: y no quedará de la carne que matares a la tarde del primer día hasta la mañana.',
        5: 'No podrás sacrificar la pascua en ninguna de tus ciudades, que Jehová tu Dios te da,',
        6: 'Sino en el lugar que Jehová tu Dios escogiere, para hacer habitar su nombre en él, sacrificarás la pascua a la tarde a puesta del sol, al tiempo que saliste de Egipto.',
        7: 'Y asarás, y comerás en el lugar que Jehová tu Dios escogiere, y volverás por la mañana y tornarte has a tu morada.',
        8: 'Seis días comerás panes cenceños, y el séptimo día será solemnidad a Jehová tu Dios, no harás obra.',
        ...
        11: 'Y alegrarte has delante de Jehová tu Dios, tú, y tu hijo, y tu hija, y tu siervo y tu sierva, y el Levita que estuviere dentro de tus puertas, y el extranjero, y el huérfano, y la viuda, que estuvieren en medio de ti, en el lugar que Jehová tu Dios escogiere para hacer habitar su nombre en él.',
        12: 'Y acordarte has que fuiste siervo en Egipto; por tanto guardarás, y harás estos estatutos.',
        13: '¶ La solemnidad de las cabañas harás siete días, cuando hubieres hecho la cosecha de tu era y de tu lagar.',
        ...
        15: 'Siete días celebrarás solemnidad a Jehová tu Dios en el lugar que Jehová escogiere, porque te habrá bendecido Jehová tu Dios en todos tus frutos, y en toda obra de tus manos, y serás ciertamente alegre.',
    ...
    17: {
        1: 'No sacrificarás a Jehová tu Dios buey, o cordero en el cual haya falta, o alguna cosa mala, que es abominación a Jehová tu Dios.',
        2: '¶ Cuando se hallare entre ti, en alguna de tus ciudades, que Jehová tu Dios te da, hombre, o mujer, que haya hecho mal en ojos de Jehová tu Dios traspasando su concierto;',
        3: 'Que hubiere ido, y servido a dioses ajenos, y se hubiere inclinado a ellos, o al sol, o a la luna, o a todo el ejército del cielo, lo cual yo no mandé;',
        4: 'Y te fuere dado aviso, y oyeres, y hubieres buscado bien, y la cosa ha parecido de verdad cierta, que tal abominación ha sido hecha en Israel;',
        5: 'Entonces sacarás al hombre o mujer, que hubiere hecho esta mala cosa, a tus puertas, hombre o mujer, y apedrearlos has con piedras, y morirán.',
        6: 'Por dicho de dos testigos, o de tres testigos, morirá el que hubiere de morir: no morirá por el dicho de un solo testigo.',
        7: 'La mano de los testigos será primero sobre él, para matarle, y la mano de todo el pueblo después: y quitarás el mal de en medio de ti.',
        8: '¶ Cuando alguna cosa te fuere oculta en juicio entre sangre y sangre, entre causa y causa, y entre llaga y llaga en negocios de rencillas en tus ciudades, entonces levantarte has, y subirás al lugar que Jehová tu Dios escogiere:',
        9: 'Y vendrás a los sacerdotes Levitas, y al juez que fuere en aquellos días; y preguntarás, y enseñarte han la palabra del juicio.',
        10: 'Y harás según la palabra que ellos te enseñaren del lugar que Jehová escogiere, y guardarás que hagas según todo lo que te enseñaren.',
        11: 'Según la ley, que ellos te enseñaren, y según el juicio que te dijeren, harás: de la palabra que te enseñaren, no te apartarás ni a diestra ni a siniestra.',
        12: 'Y el hombre que hiciere con soberbia no obedeciendo al sacerdote que está para ministrar allí, delante de Jehová tu Dios, o al juez, el tal varón morirá: y quitarás el mal de Israel.',
        13: 'Y todo el pueblo oirá, y temerá, y no se ensoberbecerán más.',
        14: '¶ Cuando hubieres entrado en la tierra, que Jehová tu Dios te da y la heredares, y habitares en ella, y dijeres: Pondré rey sobre mí, como todas las gentes que están en mis al derredores;',
        15: 'Poniendo pondrás por rey sobre ti al que Jehová tu Dios escogiere: de entre tus hermanos pondrás rey sobre ti: no podrás poner sobre ti hombre extranjero, que no sea tu hermano.',
        16: '¶ Solamente que no se aumente caballos, ni haga volver el pueblo a Egipto para aumentar caballos: porque Jehová os ha dicho: No procuraréis de volver más por este camino.',
        17: 'Ni aumentará para sí mujeres, porque su corazón no se aparte: ni plata ni oro se multiplicará mucho.',
        18: '¶ Y será que cuando se asentare sobre la silla de su reino, escribirá para sí un traslado de esta ley en un libro, tomándolo de delante de los sacerdotes Levitas;',
        19: 'El cual tendrá consigo, y leerá en él todos los días de su vida, para que aprenda a temer a Jehová su Dios, para guardar todas las palabras de aquesta ley, y estos estatutos para hacerlos;',
        20: 'Para que no se eleve su corazón sobre sus hermanos, ni se aparte del mandamiento a diestra ni a siniestra, porque alargue días en su reino él, y sus hijos en medio de Israel.',
    },
    18: {
        ...
        2: 'Y no tendrá heredad entre sus hermanos: Jehová es su heredad, como él le ha dicho.',
        3: 'Y este será el derecho de los sacerdotes que recibirán del pueblo, de los que sacrificaren sacrificio, buey, o cordero; dará al sacerdote la espalda, y las quijadas, y el cuajar.',
        4: 'Las primicias de tu grano, de tu vino, y de tu aceite, y las primicias de la lana de tus ovejas le darás.',
        5: 'Porque le ha escogido Jehová tu Dios de todas tus tribus, para que esté para ministrar al nombre de Jehová, él y sus hijos, todos los días.',
        6: 'Y cuando el Levita viniere de alguna de tus ciudades de todo Israel, donde el hubiere peregrinado, y viniere con todo deseo de su alma al lugar que Jehová escogiere,',
        7: 'Ministrará al nombre de Jehová su Dios, como todos sus hermanos los Levitas que estuvieren allí delante de Jehová.',
        8: 'Porción, como la porción de los otros comerán, allende de sus patrimonios.',
        ...
        11: 'Ni encantador de encantamentos, ni quien pregunte a pitón, ni mágico, ni quien pregunte a los muertos:',
        12: 'Porque es abominación a Jehová cualquiera que hace estas cosas: y por estas abominaciones Jehová tu Dios las echó de delante de ti.',
        13: 'Perfecto serás con Jehová tu Dios.',
        14: 'Porque estas gentes que has de heredar, a agoreros y a hechiceros oían: mas tú, no así te ha dado Jehová tu Dios.',
        15: '¶ Profeta de en medio de ti, de tus hermanos, como yo, te levantará Jehová tu Dios, a él oiréis;',
        16: 'Según todas las cosas que pediste a Jehová tu Dios en Horeb, el día de la congregación, diciendo: No vuelva yo a oír la voz de Jehová mi Dios, ni vea yo más este gran fuego, porque no muera.',
        17: 'Y Jehová me dijo: Bien han dicho.',
        18: 'Profeta les despertaré de en medio de sus hermanos, como tú: y yo pondré mis palabras en su boca, y él les hablará todo lo que yo le mandare.',
        19: 'Mas será, que cualquiera que no oyere mis palabras, que él hablare en mi nombre, yo requeriré de él.',
        20: 'Empero el profeta que presumiere de hablar palabra en mi nombre, que yo no le haya mandado hablar, o que hablare en nombre de dioses ajenos, el tal profeta morirá.',
        21: '¶ Y si dijeres en tu corazón: ¿Cómo conoceremos la palabra que Jehová no hubiere hablado?',
        22: 'Cuando el profeta hablare en nombre de Jehová, y no fuere la tal cosa, ni viniere, es palabra que Jehová no ha hablado: con soberbia la habló el tal profeta: no hayas temor de él.',
    },
    19: {
        1: 'Cuando Jehová tu Dios talare las gentes, cuya tierra Jehová tu Dios te da a ti, y tú las heredares, y habitares en sus ciudades, y en sus casas;',
        2: 'Apartarte has tres ciudades en medio de tu tierra que Jehová tu Dios te da para que la heredes.',
        3: 'Aderezarte has el camino, y partirás en tres partes el término de tu tierra, que Jehová tu Dios te dará en heredad, y será para que todo homicida se huya allí.',
        4: 'Y este es el negocio del homicida que huirá allí, y vivirá: El que hiriere a su prójimo por yerro, que no le tenía enemistad desde ayer ni desde anteayer:',
        5: 'Y el que fue con su prójimo al monte a cortar leña, y poniendo fuerza con su mano en la hacha para cortar algún leño, saltó el hierro del cabo, y halló a su prójimo, y murió; este huirá a una de estas ciudades, y vivirá.',
        6: 'Porque el redimidor de la sangre no vaya tras el homicida cuando se escalentare su corazón, y lo alcance, por ser largo el camino, y lo hiera de muerte, el cual no será condenado a muerte; porque no tenía enemistad con él desde ayer y anteayer.',
        7: 'Por tanto yo te mando, diciendo: Tres ciudades te apartarás.',
        8: 'Y si Jehová tu Dios ensanchare tu término, como lo juró a tus padres, y te diere toda la tierra, que dijo a tus padres, que había de dar,',
        9: 'Cuando guardases todos estos mandamientos, que yo te mando hoy, para hacerlos, que ames a Jehová tu Dios y andes en sus caminos todos los días entonces añadirás otras tres ciudades allende de estas tres:',
        10: 'Porque no sea derramada sangre inocente en medio de tu tierra, que Jehová tu Dios te da por heredad, y sean sobre ti sangres.',
        11: 'Mas cuando hubiere alguno que aborreciere a su prójimo, y le espiare, y se levantare sobre él, y le hiriere de muerte, y muriere, y huyere a alguna de estas ciudades;',
        12: 'Entonces los ancianos de su ciudad enviarán, y sacarle han de allí, y entregarle han en mano del pariente del muerto, y morirá.',
        13: 'No le perdonará tu ojo: y quitarás la sangre inocente de Israel, y habrás bien.',
        14: '¶ No estrecharás el término de tu prójimo, que señalaron los antiguos en tu heredad que poseyeres en la tierra que Jehová tu Dios te da, para que la heredes.',
        15: '¶ No valdrá un testigo contra ninguno en cualquier delito, y en cualquier pecado, en cualquier pecado que se cometiere. En dicho de dos testigos, o en dicho de tres testigos consistirá el negocio.',
        16: '¶ Cuando se levantare testigo falso contra alguno para testificar contra él rebelión;',
        17: 'Entonces los dos hombres, que pleitean se presentarán delante de Jehová, delante de los sacerdotes y jueces que fueren en aquellos días;',
        18: 'Y los jueces inquirirán bien, y si pareciere ser aquel testigo falso, que testificó falso contra su hermano;',
        19: 'Haréis a él como él pensó hacer a su hermano, y quitarás el mal de en medio de ti.',
        20: 'Y los que quedaren, oirán, y temerán, y no volverán más a hacer una mala cosa como esta en medio de ti.',
    ...
    22: {
        1: 'No verás el buey de tu hermano, o su cordero, perdidos, y te esconderás de ellos: volviendo los volverás a tu hermano.',
        ...
        4: 'No verás el asno de tu hermano, o su buey caídos en el camino, y te esconderás de ellos, levantando los levantarás con él.',
        ...
        7: 'Enviando enviarás la madre, y los pollos te tomarás; porque hayas bien, y largos días.',
        ...
        14: 'Y la pusiere achaques de cosas, y sacare sobre ella mala fama, y dijere: Esta tomé por mujer, y llegué a ella, y no la hallé virgen:',
        15: 'Entonces el padre de la moza y su madre tomarán, y sacarán las virginidades de la moza a los ancianos de la ciudad a la puerta;',
        16: 'Y dirá el padre de la moza a los ancianos: Yo di mi hija a este hombre por mujer, y él la aborrece,',
        17: 'Y, he aquí, él le pone achaques de cosas, diciendo: No he hallado a tu hija virgen: y, he aquí las virginidades de mi hija: y extenderán la sábana delante de los ancianos de la ciudad:',
        18: 'Entonces los ancianos de la ciudad tomarán al hombre, y castigarle han;',
        19: 'Y penarle han en cien pesos de plata, los cuales darán al padre de la moza, por cuanto sacó mala fama sobre virgen de Israel: y tenerla ha por mujer, y no la podrá enviar en todos sus días.',
        20: 'Mas si este negocio fue verdad, y no se hallaren virginidades en la moza;',
        21: 'Entonces sacarán a la moza a la puerta de la casa de su padre, y apedrearla han con piedras los hombres de su ciudad, y morirá; por cuanto hizo vileza en Israel fornicando en casa de su padre, y quitarás el mal de en medio de ti.',
        22: '¶ Cuando alguno fuere tomado echado con mujer casada con marido, ambos ellos morirán, el varón que durmió con la mujer, y la mujer: y quitarás el mal de Israel.',
        23: 'Cuando fuere moza virgen desposada con alguno, y alguno la hallare en la ciudad, y se echare con ella;',
        24: 'Entonces sacarles heis a ambos a la puerta de aquella villa, y apedrearles heis con piedras, y morirán: la moza porque no dio voces en la ciudad, y el hombre porque afligió a la mujer de su prójimo: y quitarás el mal de en medio de ti.',
        ...
        27: 'Porque él la halló en el campo, la moza desposada dio voces, y no hubo quien la valiese.',
        28: '¶ Cuando alguno hallare moza virgen, que no fuere desposada, y la tomare, y se echare con ella, y fueren tomados;',
        29: 'Entonces el hombre que se echó con ella dará al padre de la moza cincuenta pesos de plata, y será su mujer, por cuanto la afligió: no la podrá enviar en todos sus días.',
    ...
    24: {
        1: 'Cuando alguno tomare mujer y se casare con ella, si después no le agradare por haber hallado en ella alguna cosa torpe, escribirle ha carta de repudio, y dársela ha en su mano, y enviarla ha de su casa.',
        ...
        4: 'No podrá su marido el primero, que la envió, volverla a tomar, para que sea su mujer, después que fue inmunda, porque es abominación delante de Jehová, y no contaminarás la tierra, que Jehová tu Dios te da por heredad.',
        ...
        13: 'Volviendo le volverás la prenda cuando el sol se ponga, porque duerma en su ropa; y bendecirte ha, y a ti será justicia delante de Jehová tu Dios.',
        ...
        15: 'En su día le darás su jornal, y el sol no se pondrá sobre él, porque pobre es, y con el sustenta su vida: porque no clame contra ti a Jehová, y sea en ti pecado.',
    ...
    25: {
        1: 'Cuando hubiere pleito entre algunos, y vinieren a juicio, y los juzgaren, y absolvieren al justo, y condenaren al impío:',
        2: 'Será que si el impío mereciere ser azotado, entonces el juez le hará echar, y le hará azotar delante de sí, según su impiedad por cuenta.',
        3: 'Cuarenta veces le hará herir, no más: porque si le hiriere de muchos azotes allende de estos, no se envilezca tu hermano delante de tus ojos.',
        4: '¶ No embozalarás al buey cuando trillare.',
        5: '¶ Cuando algunos hermanos estuvieren juntos, y muriere alguno de ellos, y no tuviere hijo, la mujer del muerto no se casará fuera con hombre extraño: su cuñado entrará a ella, y la tomará por su mujer, y hará con ella parentesco.',
        6: 'Y será, que el primogénito que pariere, se levantará en nombre de su hermano el muerto, porque su nombre no sea raído de Israel.',
        7: 'Y si el hombre no quisiere tomar a su cuñada, entonces su cuñada vendrá a la puerta a los ancianos, y dirá: Mi cuñado no quiere despertar nombre en Israel a su hermano: no quiere hacer parentesco conmigo.',
        8: 'Entonces los ancianos de aquella ciudad le harán venir, y hablarán con él: y él se levantará, y dirá: Yo no quiero tomarla.',
        9: 'Y su cuñada se llegará a él delante de los ancianos, y descalzarle ha su zapato de su pie, y escupirle ha en el rostro, y hablará, y dirá: Así sea hecho al varón, que no edificare la casa de su hermano.',
        ...
        12: 'Entonces cortarle has la mano, no perdonará tu ojo.',
        13: '¶ No tendrás en tu bolsa pesa grande y pesa chica.',
        14: 'No tendrás en tu casa efa grande y efa chica.',
        15: 'Pesas cumplidas y justas tendrás: efa cumplida y justa tendrás: para que tus días sean prolongados sobre la tierra, que Jehová tu Dios te da.',
        16: 'Porque abominación es a Jehová tu Dios cualquiera que hace esto, cualquiera que hace injusticia.',
        17: '¶ Acuérdate de lo que te hizo Amalec en el camino cuando salistes de Egipto:',
        18: 'Que te salió al camino, y te desguarneció la retaguardia de todos los flacos que iban detrás de ti, cuando tú estabas cansado y trabajado, y no temió a Dios.',
        19: 'Y será que cuando Jehová tu Dios te hubiere dado reposo de todos tus enemigos al derredor en la tierra que Jehová tu Dios te da por heredad para que la poseas, raerás la memoria de Amalec de debajo del cielo, no te olvides.',
    },
    26: {
        ...
        2: 'Entonces tomarás de las primicias de todos los frutos de la tierra, que trajeres de tu tierra, que Jehová tu Dios te da, y pondrás en un canastillo, e irás al lugar que Jehová tu Dios escogiere, para hacer habitar allí su nombre:',
        3: 'Y vendrás al sacerdote que fuere en aquellos días, y decirle has: Confieso hoy a Jehová tu Dios, que yo he entrado en la tierra que juró Jehová a nuestros padres que nos había de dar.',
        4: 'Y el sacerdote tomará el canastillo de tu mano, y ponerlo ha delante del altar de Jehová tu Dios.',
        5: 'Y responderás, y dirás delante de Jehová tu Dios: El Siro mi padre pereciendo de hambre descendió a Egipto, y peregrinó allá con pocos hombres, y allí creció en gente grande, fuerte, y mucha.',
        6: 'Y los Egipcios nos maltrataron, y nos afligieron, y pusieron sobre nosotros dura servidumbre.',
        7: 'Y clamamos a Jehová Dios de nuestros padres, y oyó Jehová nuestra voz, y vio nuestra aflicción, y nuestro trabajo, y nuestra opresión:',
        8: 'Y sacónos Jehová de Egipto con mano fuerte y con brazo extendido, y con espanto grande, y con señales y con milagros.',
        9: 'Y trájonos a este lugar, y diónos esta tierra, tierra que corre leche y miel.',
        10: 'Y ahora, he aquí, he traído las primicias del fruto de la tierra que me diste, oh Jehová. Y dejarlo has delante de Jehová tu Dios, e inclinarte has delante de Jehová tu Dios.',
        11: 'Y alegrarte has con todo el bien que Jehová tu Dios te hubiere dado a ti y a tu casa, tú y el Levita y el extranjero que está en medio de ti.',
        ...
        17: 'A Jehová has ensalzado hoy para ser a ti por Dios, y para andar en sus caminos, y para guardar sus estatutos y sus mandamientos, y sus derechos, y para oír su voz.',
    ...
    29: {
        1: 'Estas son las palabras del concierto que mandó Jehová a Moisés, para que concertase con los hijos de Israel en la tierra de Moab, allende del concierto que concertó con ellos en Horeb.',
        2: 'Moisés pues llamó a todo Israel, y díjoles: Vosotros habéis visto todo lo que Jehová ha hecho delante de vuestros ojos en la tierra de Egipto a Faraón y a todos sus siervos, y a toda su tierra:',
        3: 'Las pruebas grandes que vieron tus ojos, las señales, y las grandes maravillas.',
        4: 'Y Jehová no os dio corazón para entender, ni ojos para ver, ni oídos para oír, hasta hoy.',
        5: 'Y yo os he traído cuarenta años por el desierto, que vuestros vestidos no se han envejecido sobre vosotros, ni tu zapato se ha envejecido sobre tu pie.',
        6: 'Nunca comisteis pan, ni bebisteis vino ni sidra, porque supieseis que yo soy Jehová vuestro Dios.',
        7: 'Y llegasteis a este lugar, y salió Sejón rey de Jesebón, y Og rey de Basán delante de nosotros para pelear, y herímoslos:',
        8: 'Y tomamos su tierra, y dímosla por heredad a Rubén y a Gad, y a la media tribu de Manasés.',
        9: 'Guardaréis pues las palabras de este concierto, y hacerlas heis, para que seáis prosperados en todo lo que hiciereis.',
        10: 'Vosotros todos estáis hoy delante de Jehová vuestro Dios, vuestros príncipes de vuestras tribus, vuestros ancianos, y vuestros alcaldes, todos los varones de Israel:',
        ...
        12: 'Para que entres en el concierto de Jehová tu Dios y en su juramento, que Jehová tu Dios concierta hoy contigo:',
        ...
        14: 'Y no con vosotros solos concierto yo este concierto, y este juramento,',
        15: 'Mas con los que están aquí estantes hoy con nosotros delante de Jehová nuestro Dios, y con los que no están aquí hoy con nosotros.',
        16: 'Porque vosotros sabéis como habitamos en la tierra de Egipto, y como hemos pasado por medio de las gentes que habéis pasado;',
        17: 'Y habéis visto sus abominaciones, y sus ídolos, madera y piedra, plata y oro, que tienen consigo.',
        18: 'Quizá habrá entre vosotros varón o mujer, o familia o tribu, cuyo corazón se vuelva hoy de con Jehová nuestro Dios por andar a servir a los dioses de aquellas gentes: quizá habrá en vosotros raíz que eche veneno y ajenjo:',
        19: 'Y sea, que cuando el tal oyere las palabras de esta maldición, él se bendiga en su corazón, diciendo: Paz habré, aunque ande según el pensamiento de mi corazón, para añadir la embriaguez a la sed.',
        20: 'Jehová no querrá perdonar al tal, que luego humeará el furor de Jehová y su zelo sobre el tal hombre, y acostarse ha sobre él toda maldición escrita en este libro, y Jehová raerá su nombre de debajo del cielo.',
        21: 'Y apartarle ha Jehová de todas las tribus de Israel para mal, conforme a todas las maldiciones del concierto escrito en este libro de la ley.',
        ...
        23: '(Azufre y sal, quemada toda su tierra: no será sembrada, ni producirá, ni crecerá en ella yerba ninguna, como en la subversión de Sodoma y de Gomorra, de Adma y de Seboim, que Jehová subvertió en su furor en su ira.)',
        24: 'Y dirán todas las gentes: ¿Por qué hizo Jehová esto a esta tierra? ¿Qué ira es esta de tan gran furor?',
        25: 'Y respondérseles ha: Por cuanto dejaron el concierto de Jehová el Dios de sus padres que el concertó con ellos, cuando les sacó de tierra de Egipto,',
        26: 'Y fueron, y sirvieron a dioses ajenos, e inclináronse a ellos; dioses que no conocieron, y que ninguna cosa les habían dado.',
        27: 'Y el furor de Jehová se encendió contra esta tierra, para traer sobre ella todas las maldiciones escritas en este libro.',
        28: 'Y Jehová los desarraigó de su tierra con enojo y con saña, y con furor grande, y los echó a otra tierra, como parece hoy.',
        29: 'Las cosas secretas pertenecen a Jehová nuestro Dios: mas las reveladas son para nosotros y para nuestros hijos para siempre, para que hagamos todas las palabras de esta ley.',
    },
    30: {
        1: 'Y será, que cuando te vinieren todas estas cosas, la bendición, y la maldición que yo he puesto delante de ti, y volvieres a tu corazón en todas las gentes a las cuales Jehová tu Dios te echare,',
        ...
        3: 'Jehová también volverá tus cautivos, y habrá misericordia de ti: y tornará, y juntarte ha de todos los pueblos, a los cuales te hubiere esparcido Jehová tu Dios.',
        ...
        9: 'Y hacerte ha Jehová tu Dios abundar en toda obra de tus manos, en el fruto de tu vientre, en el fruto de tu bestia, y en el fruto de tu tierra para bien: porque Jehová se convertirá para gozarse sobre ti en bien, de la manera que se gozó sobre tus padres,',
        ...
        18: 'Yo os protesto hoy que pereciendo pereceréis: no tendréis luengos días sobre la tierra, para ir a la cual pasas el Jordán, para que la heredes.',
        ...
        20: 'Que ames a Jehová tu Dios: Que oigas su voz y te allegues a él: porque él es tu vida, y la longura de tus días: porque habites sobre la tierra que juró Jehová a tus padres Abraham, Isaac, y Jacob, que les había de dar.',
    },
    31: {
        ...
        3: 'Jehová tu Dios él pasa delante de ti, él destruirá estas gentes delante de tu faz, y heredarlas has: Josué, él pasa delante de ti, como Jehová ha dicho.',
        ...
        8: 'Y Jehová es el que va delante de ti, él será contigo, no te dejará, ni te desamparará: no temas, ni te espantes.',
        ...
        12: 'Harás congregar el pueblo, varones y mujeres y niños, y tus extranjeros que estuvieren en tus ciudades, para que oigan y aprendan, y teman a Jehová vuestro Dios, y guarden para hacer todas las palabras de esta ley;',
        13: 'Y sus hijos, que no supieron, oigan, y aprendan a temer a Jehová vuestro Dios todos los días que viviereis sobre la tierra, para ir a la cual pasáis el Jordán para heredarla.',
        14: '¶ Y Jehová dijo a Moisés: He aquí, tus días son ya llegados para que mueras: llama a Josué, y esperád en el tabernáculo del testimonio, y mandarle he. Y fue Moisés y Josué, y esperaron en el tabernáculo del testimonio.',
        ...
        26: 'Tomád este libro de la ley, y ponédlo al lado del arca del concierto de Jehová vuestro Dios, y esté allí por testigo contra ti.',
        ...
        29: 'Porque yo sé, que después de yo muerto, corrompiendo os corromperéis, y os apartaréis del camino que os he mandado: y que os ha de venir mal en los prostreros días por haber hecho mal en ojos de Jehová, enojándole con la obra de vuestras manos.',
        30: 'Entonces habló Moisés en oídos de toda la congregación de Israel las palabras de esta canción, hasta acabarla.',
    },
    32: {
        1: 'Escuchád cielos, y hablaré: y oiga la tierra los dichos de mi boca.',
        ...
        20: 'Y dijo: Esconderé de ellos mi rostro, veré cual será su prostrimería: que son generación de perversidades, hijos sin fe.',
        ...
        44: 'Y vino Moisés, y recitó todas las palabras de esta canción a oídos del pueblo, él y Josué hijo de Nun.',
        ...
        50: 'Y muere en el monte al cual subes, y sé agregado a tus pueblos, de la manera que murió Aarón tu hermano en el monte de Hor, y fue agregado a sus pueblos:',
    ...
    33: {
        1: 'Y esta es la bendición con la cual Moisés, varón de Dios, bendijo a los hijos de Israel antes que muriese;',
        2: 'Y dijo: Jehová vino de Sinaí, y de Seir les esclareció: resplandeció desde el monte de Farán, y vino con diez mil santos: a su diestra la ley de fuego para ellos.',
        3: 'Aun amó los pueblos, todos sus santos están en tu mano: ellos también se llegaron a tus pies: recibieron de tus dichos.',
        4: 'Ley nos mandó Moisés por heredad a la congregación de Jacob.',
        5: 'Y fue en el Recto rey, cuando se congregaron las cabezas del pueblo, las tribus de Israel en uno.',
        6: 'Viva Rubén, y no muera: y sean sus varones en número.',
        7: 'Y esta para Judá; y dijo: Oye oh Jehová, la voz de Judá, y llévale a su pueblo: sus manos le basten, y tú le seas ayuda contra sus enemigos.',
        8: 'Y a Leví dijo: Tu Tumim y tu Urim diste a tu buen varón, al cual tentaste en Massa: y lo hiciste reñir a las aguas de la rencilla;',
        9: 'El que dijo a su padre y a su madre: Nunca los ví: ni conoció a sus hermanos, ni conoció a sus hijos: por lo cual ellos guardarán tus dichos, y observarán tu concierto.',
        10: 'Ellos enseñarán tus juicios a Jacob, y tu ley a Israel: pondrán el perfume a tus narices, y el holocausto sobre tu altar.',
        11: 'Bendice oh Jehová lo que hicieren, y en la obra de sus manos toma contentamiento: hiere los lomos de sus enemigos, y de los que le aborrecieren, que nunca se levanten.',
        12: 'Y a Ben-jamín dijo: El amado de Jehová habitará confiado cerca de él: cubrirle ha siempre, y entre sus hombros morará.',
        13: 'Y a José dijo: Bendita sea de Jehová su tierra por los regalos de los cielos, por el rocío, y por el abismo que está abajo,',
        ...
        17: 'El es hermoso como el primogénito de su buey: y sus cuernos, cuernos de unicornio: con ellos acorneará los pueblos a una, hasta los fines de la tierra: y estos son los diez millares de Efraím: y estos los millares de Manasés.',
        18: 'Y a Zabulón dijo: Alégrate Zabulón cuando salieres; e Isacar en tus tiendas.',
        19: 'Al monte llamarán pueblos, allí sacrificarán sacrificios de justicia: por lo cual chuparán la abundancia de las mares, y los tesoros escondidos del arena.',
        20: 'Y a Gad dijo: Bendito el que hizo ensanchar a Gad: como león habitará, y arrebatará brazo y mollera.',
        21: 'El vio para sí lo primero, que allí estaba escondida la parte del legislador, y vino en la delantera del pueblo: la justicia de Jehová hará, y sus juicios con Israel.',
        22: 'Y a Dan dijo: Dan, cachorro de león: saltará desde Basán.',
        23: 'Y a Neftalí dijo: Neftalí harto de voluntad, y lleno de bendición de Jehová; el occidente y el mediodía hereda.',
        24: 'Y a Aser dijo: Bendito más que los hijos, Aser; será agradable a sus hermanos: y mojará en aceite su pie.',
        25: 'Hierro y metal serán tus cerraduras; y como tus días será tu fortaleza.',
        26: 'No hay otro como el Dios del Recto: caballero en el cielo para tu ayuda, y en los cielos con su grandeza.',
        27: 'La habitación de Dios es eterna, y debajo de brazos de perpetuidad: él echará de delante de ti al enemigo; y dirá: Destruye.',
        28: 'E Israel, la fuente de Jacob, habitará confiado solo en tierra de grano y de vino: también sus cielos destilarán rocío.',
        29: 'Bienaventurado tú Israel: ¿Quién como tú, pueblo salvo por Jehová, escudo de tu socorro, y espada de tu excelencia? Y tus enemigos serán humillados, y tú hollarás sobre sus alturas.',
    },
    34: {
