...
CHAPTERS = {
    ...
    3: {
        1: 'Przetoż mówię: Słuchajcie przedniejsi w Jakóbie, i wodzowie domu Izraelskiego! izali wy nie macie być powiadomi sądu?',
        2: 'Ale oni nienawidzą dobrego, a miłują złe; odzierają lud z skóry ich, i mięso ich z kości ich;',
        3: 'A jedzą mięso ludu mojego, a skórę ich z nich zdzierają,i kości ich łamią, i rąbią je jako do garnca, a jako mięso do kotła.',
        4: 'Tedy do Pana wołać będą, a nie wysłucha ich, owszem, zakryje oblicze swoje przed nimi czasu onego, tak jako oni wykonywali złe przedsięwzięcia swoje.',
        ...
        8: 'Alem ja napełniony siłą ducha Pańskiego i sądem i mocą, abym oznajmił Jakóbowi przestępstwa jego, a Izraelowi grzech jego.',
        9: 'Słuchajcież już tego przedniejsi w domu Jakóbowym, i wodzowie domu Izraelskiego, którzy macie sąd w obrzydliwości, a co jest sprawiedliwego, podwracacie.',
        10: 'Każdy buduje Syon krwią, a Jeruzalem nieprawością.',
