...
CHAPTERS = {
    ...
    5: {
        1: '(H4:14) Nun dränge dich zusammen, Tochter des Gedränges: man hat eine Belagerung gegen uns gerichtet; mit dem Stabe schlagen sie den Richter Israels auf den Backen.',
        2: '(H5:1) Und du, Bethlehem, Ephrata, zu klein, um unter den Tausenden von Juda zu sein, aus dir wird mir hervorkommen, der Herrscher über Israel sein soll; und seine Ausgänge sind von der Urzeit, von den Tagen der Ewigkeit her.',
        3: '(H5:2) Darum wird er sie dahingeben bis zur Zeit, da eine Gebärende geboren hat; und der Rest seiner Brüder wird zurückkehren samt den Kindern Israel.',
        ...
        5: '(H5:4) Und dieser wird Friede sein. Wenn Assyrien in unser Land kommen und wenn es in unsere Paläste treten wird, so werden wir sieben Hirten und acht Menschenfürsten gegen dasselbe aufstellen.',
        6: '(H5:5) Und sie werden das Land Assyrien mit dem Schwerte weiden, und das Land Nimrods in seinen Toren; und er wird uns von Assyrien erretten, wenn es in unser Land kommen und wenn es in unsere Grenzen treten wird.',
        7: '(H5:6) Und der Überrest Jakobs wird inmitten vieler Völker sein wie ein Tau von Jehova, wie Regenschauer auf das Kraut, der nicht auf Menschen wartet und nicht auf Menschenkinder harrt.',
        8: '(H5:7) Und der Überrest Jakobs wird unter den Nationen, inmitten vieler Völker, sein wie ein Löwe unter den Tieren des Waldes, wie ein junger Löwe unter den Schafherden, der, wenn er hindurchgeht, zertritt und zerreißt, und niemand errettet. -',
    ...
    6: {
        ...
        16: 'Und man beobachtet eifrig die Satzungen Omris und alles Tun des Hauses Ahabs, und ihr wandelt in ihren Ratschlägen: auf daß ich dich zum Entsetzen mache und ihre Bewohner zum Gezisch; und ihr werdet die Schmach meines Volkes tragen.',
    },
    7: {
