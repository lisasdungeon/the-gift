...
CHAPTERS = {
    1: {
        ...
        5: 'und ich werde den Riegel von Damaskus zerbrechen, und den Bewohner ausrotten aus dem Tale Awen, und den, der das Scepter hält, aus Beth-Eden; und das Volk von Syrien wird nach Kir weggeführt werden, spricht Jehova.',
    ...
    7: {
        ...
        4: 'Also ließ mich der Herr, Jehova, sehen: Siehe, der Herr, Jehova rief, um mit Feuer zu richten und es fraß die große Flut und fraß das Erbteil.',
        ...
        14: 'Und Amos antwortete und sprach zu Amazja: Ich war kein Prophet und war kein Prophetensohn sondern ich war ein Viehhirt und las wilde Feigen.',
    ...
    8: {
        ...
        4: 'Höret dieses, die ihr nach dem Dürftigen schnaubet und nach der Vernichtung der Sanftmütigen im Lande,',
