...
CHAPTERS = {
    1: {
        ...
        5: 'I will break also the bar of Damascus, and cut off the inhabitant from the plain of Aven, and him that holds the scepter from the house of Eden: and the people of Syria shall go into captivity to Kir, says the LORD. ¶',
    ...
    2: {
        ...
        3: 'And I will cut off the judge from the middle thereof, and will slay all the princes thereof with him, says the LORD. ¶',
        4: 'Thus says the LORD; For three transgressions of Judah, and for four, I will not turn away the punishment thereof; because they have despised the law of the LORD, and have not kept his commandments, and their lies caused them to err, after the which their fathers have walked:',
    ...
    4: {
        ...
        5: 'And offer a sacrifice of thanksgiving with leaven, and proclaim and publish the free offerings: for this likes you, O you children of Israel, says the Lord GOD. ¶',
    ...
    5: {
        ...
        4: 'For thus says the LORD to the house of Israel, Seek you me, and you shall live:',
        ...
        16: 'Therefore the LORD, the God of hosts, the LORD, says thus; Wailing shall be in all streets; and they shall say in all the highways, Alas! alas! and they shall call the farmer to mourning, and such as are skillful of lamentation to wailing.',
    ...
    9: {
        ...
        8: 'Behold, the eyes of the Lord GOD are on the sinful kingdom, and I will destroy it from off the face of the earth; saving that I will not utterly destroy the house of Jacob, says the LORD.',
