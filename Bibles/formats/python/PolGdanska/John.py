...
CHAPTERS = {
    ...
    6: {
        ...
        27: 'Sprawujcież nie pokarm, który ginie, ale pokarm, który trwa ku żywotowi wiecznemu, który wam da Syn człowieczy; albowiem tego zapieczętował Bóg Ojciec.',
    ...
    8: {
        ...
        52: 'Tedy mu rzekli Żydowie: Terażeśmy poznali, że dyjabelstwo masz, Abraham umarł i prorocy, a ty powiadasz: Jeźli kto słowa moje zachowywać będzie, śmierci nie skosztuje na wieki;',
