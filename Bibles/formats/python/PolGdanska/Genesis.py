...
CHAPTERS = {
    ...
    4: {
        ...
        26: 'Setowi też urodził się syn, i nazwał imię jego Enos. Na ten czas poczęto wzywać imienia Pańskiego.',
    },
    5: {
    ...
    28: {
        ...
        4: 'I niech ci da błogosławieństwo Abrahamowe, tobie i nasieniu twemu z tobą, abyś odziedziczył ziemię pielgrzymstwa twojego, którą dał Bóg Abrahamowi.',
        ...
        11: 'I przyszedł na jedno miejsce, i nocował tam (albowiem już było zaszło słońce) a wziąwszy jeden z kamieni miejsca onego, podłożył pod głowę swoję, i spał na temże miejscu.',
        ...
        18: 'I wstał Jakób bardzo rano, a wziąwszy kamień, który był podłożył pod głowę swoję, postawił go na znak, i nalał oliwy na wierzch jego.',
        ...
        22: 'A kamień ten, którym wystawił na znak, będzie domem Bożym, a ze wszystkiego, co mi dasz, dziesięcinę pewną oddawać ci będę.',
    },
    29: {
    ...
    37: {
        ...
        35: 'I zeszli się wszyscy synowie jego, i wszystkie córki jego, aby go cieszyli, lecz nie dał się cieszyć, ale mówił: Zaprawdę zstąpię za synem moim do grobu; i płakał go ojciec jego.',
