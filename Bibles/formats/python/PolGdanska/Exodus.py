...
CHAPTERS = {
    ...
    3: {
        ...
        2: 'I ukazał mu się Anioł Pański w płomieniu ognistym, z pośrodku krza; i widział, a oto, kierz gorzał ogniem, a on kierz nie zgorzał.',
        3: 'Tedy rzekł Mojżesz: Pójdę teraz, a oglądam to widzenie wielkie, czemu nie zgore ten kierz.',
        ...
        11: 'I rzekł Mojżesz do Boga: Któżem ja, abym szedł do Faraona, a wywiódł syny Izraelskie z Egiptu?',
        12: 'I rzekł Bóg: Oto, będę z tobą, a to miej na znak, żem cię ja posłał: Gdy wywiedziesz ten lud z Egiptu, będziecie służyć Bogu na tej górze.',
        ...
        18: 'Tedy usłuchają głosu twego, a pójdziesz ty i starsi Izraelscy do króla Egipskiego, i rzeczecie do niego: Pan, Bóg Hebrajczyków, zabieżał nam; przetoż teraz niech pójdziemy proszę w drogę trzech dni na puszczą, abyśmy ofiarowali Panu, Bogu naszemu.',
    ...
    10: {
        ...
        12: 'Potem Pan rzekł do Mojżesza: Wyciągnij rękę twą na ziemię Egipską dla szarańczy, aby przyszła na ziemię Egipską, a pożarła wszystko ziele na ziemi, wszystko, co zostało po gradzie.',
        ...
        19: 'A obróciwszy Pan wiatr zachodni mocny bardzo, porwał szarańczę, i wrzucił ją do morza czerwonego, i nie została ani jedna szarańcza we wszystkich granicach Egipskich.',
    ...
    22: {
        1: 'Jeźliby kto ukradł wołu albo owcę, i zabiłby je, albo je sprzedał, pięć wołów wróci za jednego wołu, a cztery owce za jedną owcę,',
    ...
    24: {
        ...
        6: 'Zatem wziął Mojżesz połowę krwi i wlał w czaszę, a połowę drugą wylał na ołtarz.',
    ...
    27: {
        1: 'Uczynisz też ołtarz z drzewa sytym na pięć łokci wzdłuż, a na pięć łokci wszerz; czworograniasty będzie ołtarz, a na trzy łokcie wzwyż.',
    ...
    29: {
        1: 'To też uczynisz im na poświęcenie ich, aby mi odprawowali urząd kapłański: Weźmij cielca jednego młodego, i dwu baranów zupełnych;',
        ...
        41: 'Także baranka drugiego ofiarować będziesz między dwoma wieczorami; według obrzędu ofiary porannej i według ofiary mokrej jej, tak przy niej uczynisz nad wonią przyjemną, i ofiarę zapaloną Panu.',
