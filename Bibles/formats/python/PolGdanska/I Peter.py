...
CHAPTERS = {
    ...
    4: {
        ...
        11: 'Jeźli kto mówi, niech mówi jako wyroki Boże, jeźli kto posługuje, niech to czyni jako z siły, której Bóg dodaje, aby we wszystkiem chwalony był Bóg przez Jezusa Chrystusa, któremu należy chwała i panowanie na wieki wieków. Amen.',
    ...
    5: {
        ...
        10: 'A Bóg wszelkiej łaski, który nas powołał do wiecznej chwały swojej w Chrystusie Jezusie, gdy maluczko ucierpicie, ten niech was doskonałymi uczyni, utwierdzi, umocni i ugruntuje;',
