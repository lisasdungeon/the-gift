...
CHAPTERS = {
    ...
    5: {
        ...
        12: 'Jest ciężka bieda, którąm widział pod słońcem; bogactwa zachowane na złe pana swego.',
        ...
        17: 'Toć jest, com ja obaczył, że dobra i osobliwa rzecz jest, jeść i pić, i używać dobrego ze wszystkiej pracy swej, którą człowiek podejmuje pod słońcem po wszystkie dni żywota swego, które mu dał Bóg; albowiem to jest dział jego.',
