...
CHAPTERS = {
    1: {
        ...
        3: 'Wer irgend unter euch aus seinem Volke ist, mit dem sei sein Gott, und er ziehe hinauf nach Jerusalem, das in Juda ist, und baue das Haus Jehovas, des Gottes Israels, in Jerusalem.',
    ...
    2: {
        ...
        6: 'die Söhne Pachath-Moabs, von den Söhnen Jeschuas und Joabs, 2812;',
    ...
    3: {
        ...
        10: 'Und als die Bauleute den Grund zum Tempel Jehovas legten, ließ man die Priester in ihrer Kleidung hintreten, mit Trompeten, und die Leviten, die Söhne Asaphs, mit Cymbeln, um Jehova zu loben nach der Anweisung Davids, des Königs von Israel.',
    ...
    5: {
        ...
        17: 'Und nun, wenn es den König gut dünkt, so werde nachgesucht in dem Schatzhause des Königs, welches dort zu Babel ist, ob es so sei, daß vom König Kores Befehl gegeben worden ist, dieses Haus Gottes in Jerusalem zu bauen; und der König sende uns seinen Willen hierüber zu.',
    },
    6: {
    ...
    10: {
        ...
        23: 'Und von den Leviten: Josabad und Simei und Kelaja, Pethachja, Juda und Elieser. -',
