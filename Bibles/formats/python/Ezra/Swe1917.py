...
CHAPTERS = {
    1: {
        1: "Judarnas tillredelser för Men i den persiske konungen Kores' första regeringsår uppväckte HERREN -- för att HERRENS ord från Jeremias mun skulle fullbordas -- den persiske konungen Kores' ande, så att denne lät utropa över hela sitt rike och tillika skriftligen kungöra följande:",
    ...
    4: {
        ...
        14: 'Alldenstund vi nu äta palatsets salt[1], och det icke är tillbörligt att vi åse huru skada tillskyndas konungen, därför sända vi nu och låta konungen veta detta,',
        ...
        24: "Så förhindrades nu arbetet på Guds hus i Jerusalem. Och det blev förhindrat ända till den persiske konungen Darejaves' andra regeringsår. [1] Se Salt i Ordförkl.",
    },
    5: {
