...
CHAPTERS = {
    ...
    2: {
        ...
        27: 'De man af Michmas hundrade två och tjugu.',
    ...
    4: {
        ...
        12: 'Kunnigt vare Konungenom, att de Judar, som ifrå dig hitupp till oss komne äro till Jerusalem, i den upproriska ock onda staden, bygga honom upp, och göra hans murar, och låta uppgå dem af grunden.',
        ...
        15: 'Att man låte söka i dina faders Chrönicor; så skall du finna i samma Chrönicor, och förfara, att denne staden är upprorisk, och Konungom och landom skadelig, och kommer desslikes andra till affall af ålder; derföre staden ock förstörd är.',
        ...
        17: 'Då sände Konungen ett svar till Rehum canceleren, och Simsai skrifvaren, och de andra i deras Råd, som i Samarien bodde, och de andra på hinsidon älfvena: Frid och helso.',
        ...
        22: 'Så ser nu till, att I härutinnan icke försummelige ären, att Konungenom ingen skada härar sker.',
    ...
    6: {
        ...
        22: 'Och höllo osyrade bröds högtid i sju dagar med glädje; förty Herren hade gjort dem glada, och vändt Konungens hjerta af Assur till dem, så att deras händer styrkta vordo i verket på Guds hus, den Israels Gudar.',
    },
    7: {
    ...
    8: {
        ...
        12: 'Af Asgads barn: Johanan, Kåtans son, och med honom hundrade och tio män.',
        ...
        17: 'Och sände dem ut till Iddo öfverstan, till Casiphja, att de skulle hemta oss tjenare uti var Guds hus. Och jag gaf dem in hvad de tala skulle med Iddo och hans bröder, de Nethinim i Casiphja.',
        ...
        22: 'Ty jag skämdes bedas ledsagare och resenärar af Konungenom, att de skulle hjelpa oss för fienderna på vägenom; förty vi hade sagt Konungenom: Var Guds hand är till det bästa öfver alla de honom söka; och hans starkhet och vrede öfver alla dem, som honom öfvergifva.',
        ...
        31: 'Alltså fore vi ifrån älfvene Ahava, på tolfte dagen i första månadenom, att vi skulle draga till Jerusalem; och var Guds hand var öfver oss, och bevarade oss ifrå fiendernas hand och försåt på vägenom.',
    ...
    9: {
        ...
        6: 'Och sade: Min Gud, jag skämmes och blyges att upphäfva min ögon till dig, min Gud: ty vår missgerning är vuxen öfver vårt hufvud, och var skuld är stor upp till himmelen.',
        7: 'Allt ifrå vara fäders tid hafve vi varit i stora skuld, allt intill denna dag; och för våra missgerningars skull äre vi, och våre Konungar och Prester, gifne i Konungarnas hand i landen, uti svärd, i fängelse, i rof, och i ansigtes blygd, såsom det går i denna dag.',
        8: 'Så är oss dock nu någon liten tid nåde af Herranom vårom Gud vederfaren, att ännu något af oss är qvart blifvet, att han skulle gifva oss en nagla i sitt helga rum; och att vår Gud skulle upplysa var ögon, och gifva oss ännu ett litet lif i vår träldom;',
    ...
    10: {
        ...
        24: 'Ibland sångarena: Eljasib. Ibland dörravaktarena: Sal lura, Telem och Uri.',
