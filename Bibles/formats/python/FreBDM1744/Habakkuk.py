...
CHAPTERS = {
    1: {
        ...
        5: 'Regardez entre les nations, et voyez, et soyez étonnés et tout interdits, car je m’en vais faire en votre temps une oeuvre que vous ne croirez point quand on vous la racontera.',
        ...
        16: 'A cause de cela il sacrifiera à son filet, et fera des encensements à son rets, parce qu’il aura eu par leur moyen une grasse portion, et que sa viande est une chose moelleuse.',
        17: 'Videra-t-il à cause de cela son filet? et ne cessera-t-il jamais de faire le carnage des nations? Retournez au Début',
    },
    2: {
        ...
        11: 'Car la pierre criera de la paroi, et les noeuds qui sont dans les poutres lui répondront.',
        ...
        20: 'Mais l’Eternel est au Temple de sa sainteté; toute la terre, tais-toi, redoutant sa présence. Retournez au Début',
    },
    3: {
        ...
        19: 'L’Eternel, le Seigneur est ma force, et il rendra mes pieds semblables à ceux des biches, et me fera marcher sur mes lieux élevés. Au maître chantre sur Néguinoth. Retournez au Début ===============================================================================',
    },
}
