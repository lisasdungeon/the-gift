...
CHAPTERS = {
    ...
    2: {
        ...
        4: 'car je vous ai écrit dans une grande affliction et angoisse de coeur, avec beaucoup de larmes; non afin que vous fussiez attristés, mais afin que vous connussiez la charité toute particulière que j’ai pour vous.',
    ...
    3: {
        ...
        2: 'Vous êtes vous-mêmes notre Epître, écrite dans nos coeurs, connue et lue de tous les hommes.',
        3: 'Car il paraît en vous que vous êtes l’Epître de Christ, dressée par notre ministère, et écrite non avec de l’encre, mais par l’Esprit du Dieu vivant; non sur des tables de pierre, mais sur les tables charnelles du coeur.',
    ...
    9: {
        ...
        8: 'Et Dieu est puissant pour faire abonder toute grâce en vous, afin qu’ayant toujours tout ce qui suffit en toute chose, vous soyez abondants en toute bonne oeuvre:',
