...
CHAPTERS = {
    1: {
        ...
        7: 'Comme il est juste que je pense ainsi de vous tous, parce que je retiens dans mon coeur que vous avez tous été participants de la grâce avec moi dans mes liens, et dans la défense et la confirmation de l’Evangile.',
    ...
    4: {
        ...
        3: 'Je te prie aussi, toi mon vrai compagnon, aide-leur, comme à celles qui ont combattu avec moi dans l’Evangile, avec Clément, et mes autres compagnons d’oeuvre, dont les noms sont écrits au Livre de vie.',
        ...
        7: 'Et la paix de Dieu, laquelle surpasse toute intelligence, gardera vos coeurs et vos sentiments en Jésus-Christ.',
