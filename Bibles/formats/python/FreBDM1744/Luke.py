...
CHAPTERS = {
    ...
    8: {
        ...
        12: 'Et ceux qui ont reçu la semence le long du chemin, ce sont ceux qui écoutent la parole; mais ensuite vient le démon, qui ôte de leur coeur la parole, de peur qu’en croyant ils ne soient sauvés.',
    ...
    9: {
        ...
        47: 'Mais Jésus voyant la pensée de leur coeur, prit un petit enfant, et le mit auprès de lui;',
    ...
    16: {
        ...
        8: 'Et le maître loua l’économe infidèle de ce qu’il avait agi prudemment. Ainsi les enfants de ce siècle sont plus prudents en leur génération, que les enfants de lumière.',
