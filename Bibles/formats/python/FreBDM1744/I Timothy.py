...
CHAPTERS = {
    1: {
        ...
        5: 'Or la fin du Commandement, c’est la charité qui procède d’un coeur pur, et d’une bonne conscience, et d’une foi sincère:',
    ...
    2: {
        ...
        10: 'Mais qu’elles soient ornées de bonnes oeuvres, comme il est séant à des femmes qui font profession de servir Dieu.',
    ...
    5: {
        ...
        10: 'Ayant le témoignage d’avoir fait de bonnes oeuvres, comme d’avoir nourri ses propres enfants, d’avoir logé les étrangers, d’avoir lavé les pieds des Saints, d’avoir secouru les affligés, et de s’être ainsi constamment appliquée à toutes sortes de bonnes oeuvres.',
        ...
        18: 'Car l’Ecriture dit: tu n’emmuselleras point le boeuf qui foule le grain; et l’ouvrier est digne de son salaire.',
        ...
        25: 'Les bonnes oeuvres aussi se manifestent auparavant, et celles qui sont autrement ne peuvent point être cachées.',
    },
    6: {
        ...
        17: 'Dénonce à ceux qui sont riches en ce monde, qu’ils ne soient point hautains, et qu’ils ne mettent point leur confiance dans l’incertitude des richesses, mais au Dieu vivant, qui nous donne toutes choses abondamment pour en jouir.',
        18: 'Qu’ils fassent du bien; qu’ils soient riches en bonnes oeuvres; qu’ils soient prompts à donner, libéraux.',
