...
CHAPTERS = {
    ...
    4: {
        ...
        22: 'Le Seigneur Jésus-Christ soit avec ton esprit. Que la grâce soit avec vous, Amen! La seconde Epître à Timothée qui a été établi le premier Evêque de l’Eglise des Ephésiens, a été écrite de Rome, quand Paul fut présenté la seconde fois à César Néron. ===============================================================================',
    },
}
