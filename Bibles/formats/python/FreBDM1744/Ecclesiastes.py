...
CHAPTERS = {
    ...
    9: {
        1: 'Certainement j’ai appliqué mon cœur à tout ceci; et pour éclaircir tout ceci, savoir que les justes et les sages, et leurs faits sont en la main de Dieu; mais les hommes ne connaissent ni l’amour ni la haine de tout ce qui est devant eux.',
        2: 'Tout arrive également à tous; un même accident arrive au juste et au méchant; au bon, au net, et au souillé; à celui qui sacrifie, et à celui qui ne sacrifie point; le pécheur est comme l’homme de bien; celui qui jure, comme celui qui craint de jurer.',
        3: 'C’est ici une chose fâcheuse entre toutes celles qui se font sous le soleil, qu’un même accident arrive à tous, et qu’aussi le cœur des hommes est plein de maux, et que des folies occupent leurs cœurs durant leur vie, et après cela ils vont vers les morts.',
        4: 'Et qui est celui qui leur voudrait être associé? Il y a de l’espérance pour tous ceux qui sont encore vivants: et même un chien vivant vaut mieux qu’un lion mort.',
        ...
        7: 'Va, mange ton pain avec joie, et bois gaiement ton vin; car Dieu a déjà tes oeuvres pour agréables.',
        ...
        11: 'Je me suis tourné ailleurs, et j’ai vu sous le soleil que la course n’est point aux légers, ni aux forts la bataille, ni aux sages le pain, ni aux prudents les richesses, ni la grâce aux savants; mais que le temps et l’occasion décident de ce qui arrive à tous.',
        12: 'Car aussi l’homme même ne connaît point son temps, non plus que les poissons qui sont pris au filet, lequel est mauvais pour eux, et les oiseaux qui sont pris au lacet; car les hommes sont ainsi enlacés par le temps mauvais, lorsqu’il tombe subitement sur eux.',
    ...
    10: {
        ...
        2: 'Le sage a le cœur à sa droite, mais le fou a le coeur à sa gauche.',
    ...
    12: {
        ...
        15: 'Le but de tout le discours qui a été ouï, c’est: Crains Dieu, et garde ses commandements; car c’est là le tout de l’homme.',
        16: 'Parce que Dieu amènera toute oeuvre en jugement, touchant tout ce qui est caché, soit bien, soit mal. ===============================================================================',
    },
}
