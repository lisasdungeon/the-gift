...
CHAPTERS = {
    ...
    7: {
        1: 'Or il arriva qu’après que le Roi fut assis en sa maison, et que l’Eternel lui eut donné la paix avec tous ses ennemis d’alentour;',
        ...
        7: 'Dans tous les lieux où j’ai marché avec tous les enfants d’Israël, en ai-je dit un seul mot à quelqu’une des Tribus d’Israël, à laquelle j’ai commandé de paître mon peuple d’Israël, en disant: Pourquoi ne m’avez-vous point bâti une maison de cèdres?',
        ...
        9: 'Et j’ai été avec toi partout où tu as marché, et j’ai exterminé tous tes ennemis de devant toi, et je t’ai tait un grand nom, comme le nom des grands qui sont sur la terre.',
        10: 'Et j’établirai un lieu à mon peuple d’Israël, je le planterai, il habitera chez soi, il ne sera plus agité, et les injustes ne les affligeront plus, comme ils ont fait auparavant,',
        11: 'Savoir, depuis le jour que j’ai ordonné des juges sur mon peuple d’Israël, et que je t’ai donné du repos de tous tes ennemis, et que l’Eternel t’a fait entendre qu’il te bâtirait une maison.',
        ...
        15: 'Mais ma gratuité ne se retirera point de lui, comme je l’ai retirée de Saül, que j’ai ôté de devant toi.',
        ...
        18: 'Alors le Roi David entra, et se tint devant l’Eternel, et dit: Qui suis-je, ô Seigneur Eternel! et quelle est ma maison, que tu m’aies fait venir au point où je suis?',
        19: 'Et encore cela t’a semblé être peu de chose, ô Seigneur Eternel! car tu as même parlé de la maison de ton serviteur pour un long temps. Est-ce là la manière d’agir des hommes, ô Seigneur Eternel!',
        ...
        22: 'C’est pourquoi tu t’es montré grand, ô Eternel Dieu! car il n’y en a point de tel que toi, et il n’y a point d’autre Dieu que toi, selon tout ce que nous avons entendu de nos oreilles.',
        ...
        24: 'Car tu t’es assuré ton peuple d’Israël, pour être ton peuple à jamais; et toi, ô Eternel! tu leur as été Dieu.',
        25: 'Maintenant donc, ô Eternel Dieu! confirme pour jamais la parole que tu as prononcée touchant ton serviteur, et touchant sa maison, et fais comme tu en as parlé.',
        ...
        27: 'Car toi, ô Eternel des armées! Dieu d’Israël! tu as fait entendre à ton serviteur, et tu lui as dit: Je te bâtirai une maison, c’est pourquoi ton serviteur a pris la hardiesse de te faire cette prière.',
    ...
    12: {
        ...
        17: 'Et les Anciens de sa maison se levèrent et vinrent vers lui, pour le faire lever de terre, mais il ne voulut point se lever, et il ne mangea d’aucune chose avec eux.',
        ...
        19: 'Et David aperçut que ses serviteurs parlaient bas, et il comprit que l’enfant était mort; et David dit à ses serviteurs: L’enfant n’est-il pas mort? Ils répondirent: Il est mort.',
        20: 'Alors David se leva de terre, se lava, s’oignit, et changea d’habits; et il entra dans la maison de l’Eternel, et se prosterna; puis il revint en sa maison, et ayant demandé à manger, on mit de la viande devant lui, et il mangea.',
        ...
        22: 'Et il dit: Quand l’enfant était encore en vie, j’ai jeûné, et pleuré; car je disais: Qui sait si l’Eternel aura pitié de moi, et si l’enfant ne vivra point?',
        ...
        30: 'Et il prit la couronne de dessus la tête de leur Roi, laquelle pesait un talent d’or, et il y avait des pierres précieuses; et on la mit sur la tête de David, qui emmena un fort grand butin de la ville.',
    ...
    14: {
        ...
        4: 'La femme Tékohite donc parla au Roi, et s’inclina sur son visage en terre, et se prosterna, et dit: Ô Roi! aide-moi.',
        ...
        17: 'Ta servante disait: Que maintenant la parole du Roi mon Seigneur nous apporte du repos; car le Roi mon Seigneur est comme un Ange de Dieu, pour connaître le bien et le mal; que donc l’Eternel ton Dieu soit avec toi.',
    ...
    17: {
        ...
        10: 'Alors le plus vaillant, celui-là même qui avait le coeur comme un lion, se fondra; car tout Israël sait que ton père est un homme de coeur, et que ceux qui sont avec lui sont vaillants.',
    ...
    18: {
        1: 'Or David fit le dénombrement du peuple qui était avec lui, et il établit sur eux des capitaines sur les milliers et sur les centaines.',
        2: 'Et David envoya le peuple, savoir un tiers sous la conduite de Joab; un autre tiers sous la conduite d’Abisaï fils de Tséruja, frère de Joab; et l’autre tiers sous la conduite d’Ittaï Guittien: puis le Roi dit au peuple: Certainement je sortirai aussi avec vous.',
        ...
        8: 'Et la bataille s’étendit là par tout le pays, et la forêt consuma en ce jour-là beaucoup plus de peuple, que l’épée.',
        ...
        21: 'Et Joab dit à Cusi: Va, et rapporte au Roi ce que tu as vu. Cusi se prosterna devant Joab, puis il se mit à courir.',
        ...
        23: 'Mais il dit: Quoi qu’il en soit, je courrai; et Joab lui répondit: Cours. Ahimahats donc courut par le chemin de la plaine, et passa Cusi.',
        ...
        25: 'Et la sentinelle cria, et le fit savoir au Roi; et le Roi dit: S’il est seul, il apporte de bonnes nouvelles; et cet homme marchait incessamment, et approchait.',
        ...
        27: 'Et la sentinelle dit: Il me semble à voir courir le premier, que c’est ainsi que court Ahimahats fils de Tsadok; et le Roi dit: C’est un homme de bien; il vient quand il y a de bonnes nouvelles.',
        28: 'Alors Ahimahats cria, et dit au Roi: Tout va bien, et il se prosterna devant le Roi, le visage contre terre, et dit: Béni soit l’Eternel ton Dieu qui a livré les hommes qui avaient levé leurs mains contre le Roi mon Seigneur.',
    ...
    19: {
        ...
        14: 'Ainsi il fléchit le coeur de tous les hommes de Juda, comme si ce n’eût été qu’un seul homme, et ils envoyèrent dire au Roi: Retourne- t’en avec tous tes serviteurs.',
