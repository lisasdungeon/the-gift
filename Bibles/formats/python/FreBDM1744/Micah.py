...
CHAPTERS = {
    1: {
        ...
        16: 'Arrache tes cheveux, et te fais tondre à cause de tes fils qui font tes délices; arrache tout le poil de ton corps comme un aigle qui mue, car ils sont emmenés prisonniers loin de toi. Retournez au Début',
    },
    2: {
        ...
        13: 'Le briseur montera devant eux, on brisera, et on passera outre, et eux sortiront par la porte; et leur Roi passera devant eux, et l’Eternel sera à leur tête. Retournez au Début',
    },
    3: {
        ...
        12: 'C’est pourquoi à cause de vous, Sion sera labourée comme un champ, et Jérusalem sera réduite en monceaux de pierres, et la montagne du Temple en hauts lieux de forêt. Retournez au Début',
    },
    4: {
        ...
        13: 'Lève-toi, et foule, fille de Sion, car je ferai que ta corne sera de fer, et je ferai que tes ongles seront d’airain; et tu menuiseras plusieurs peuples, et je dédierai comme un interdit leur gain à l’Eternel, et leurs biens au Seigneur de toute la terre. Retournez au Début',
    },
    5: {
        ...
        15: 'Et je ferai vengeance avec colère et avec fureur de toutes les nations qui ne m’auront point écouté. Retournez au Début',
    },
    6: {
        ...
        16: 'Car on a gardé les ordonnances de Homri, et toute l’oeuvre de la maison d’Achab, et vous avez marché dans leurs conseils, afin que je mette en désolation et en opprobre ceux qui habitent en elle, et que vous portiez l’opprobre de mon peuple. Retournez au Début',
    },
    7: {
        ...
        11: 'Au temps qu’il rebâtira tes cloisons, en ce tempslà les édits seront étendus au loin.',
        ...
        20: 'Tu maintiendras ta vérité à Jacob, et ta gratuité à Abraham, laquelle tu as jurée à nos pères dès les siècles passés. Retournez au Début This Website is Hosted by../../lilacsandbutterflies/images/EClilacsbanner.gif ===============================================================================',
    },
}
