...
CHAPTERS = {
    ...
    12: {
        ...
        16: 'Lequel fit du bien à Abram, à cause d’elle; de sorte qu’il en eut des brebis, des boeufs, des ânes, des serviteurs, des servantes, des ânesses, et des chameaux.',
        ...
        19: 'Pourquoi as-tu dit, c’est ma soeur? car je l’avais prise pour ma femme; mais maintenant, voici ta femme, prends-la, et t’en va.',
    ...
    13: {
        ...
        5: 'Lot aussi qui marchait avec Abram, avait des brebis, des boeufs, et des tentes.',
        ...
        11: 'Et Lot choisit pour lui toute la plaine du Jourdain, et alla du coté d’Orient; ainsi ils se séparèrent l’un de l’autre.',
        12: 'Abram demeura au pays de Canaan, et Lot demeura dans les villes de la plaine, et dressa ses tentes jusqu’à Sodome.',
        13: 'Or les habitants de Sodome étaient méchants, et grands pécheurs contre l’Eternel.',
        14: 'Et l’Eternel dit à Abram, après que Lot se fut séparé de lui: Lève maintenant tes yeux, et regarde du lieu où tu es, vers le Septentrion, le Midi, l’Orient, et l’Occident.',
    ...
    20: {
        ...
        5: 'Ne m’a-t-il pas dit: C’est ma soeur? Et elle-même aussi n’a-t-elle pas dit: C’est mon frère? J’ai fait ceci dans l’intégrité de mon coeur, et dans la pureté de mes mains.',
        6: 'Et Dieu lui dit en songe: Je sais que tu l’as fait dans l’intégrité de ton coeur, et aussi ai-je empêché que tu ne péchasses contre moi; c’est pourquoi je n’ai pas permis que tu la touchasses.',
        ...
        12: 'Et aussi, à la vérité, elle est ma soeur, fille de mon père; mais elle n’est pas fille de ma mère; et elle m’a été donnée pour femme.',
        ...
        14: 'Alors Abimélec prit des brebis, des boeufs, des serviteurs, et des servantes, et les donna à Abraham, et lui rendit Sara, sa femme.',
    ...
    26: {
        ...
        9: 'Alors Abimélec appela Isaac, et lui dit: Voici, c’est véritablement ta femme; et comment as-tu dit: C’est ma soeur? Et Isaac lui répondit: C’est parce que j’ai dit: Afin que peut-être je ne meure à cause d’elle.',
    ...
    39: {
        ...
        20: 'Et le maître de Joseph le prit, et le mit dans une étroite prison; dans l’endroit où les prisonniers du Roi étaient renfermés, et il fut là en prison.',
    ...
    42: {
        ...
        28: 'Et il dit à ses frères: Mon argent m’a été rendu; et en effet, le voici dans mon sac. Et le coeur leur tressaillit, et ils furent saisis de peur, et se dirent l’un à l’autre: Qu’est-ce que Dieu nous a fait?',
    ...
    45: {
        ...
        10: 'Et tu habiteras dans la contrée de Goscen, et tu seras près de moi, toi et tes enfants, et les enfants de tes enfants, et tes troupeaux, et tes boeufs, et tout ce qui est à toi.',
    ...
    47: {
        1: 'Joseph donc vint et fit entendre à Pharaon, en disant: Mon père, et mes frères, avec leurs troupeaux et leurs boeufs, et tout ce qui est à eux, sont venus du pays de Canaan, et voici, ils sont en la contrée de Goscen.',
        ...
        17: 'Alors ils amenèrent à Joseph leur bétail, et Joseph leur donna du pain pour des chevaux, pour des troupeaux de brebis, pour des troupeaux de boeufs, et pour des ânes; ainsi il les sustenta de pain cette année-là, pour tous leurs troupeaux.',
    ...
    50: {
        ...
        8: 'Et toute la maison de Joseph, et ses frères, et la maison de son père y montèrent aussi, laissant seulement leurs familles, et leurs troupeaux, et leurs boeufs dans la contrée de Goscen.',
        ...
        21: 'Ne craignez donc point maintenant; moi-même je vous entretiendrai, vous et vos familles; et il les consola, et leur parla selon leur coeur.',
