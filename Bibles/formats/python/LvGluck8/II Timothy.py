...
CHAPTERS = {
    1: {
        ...
        9: 'Kas mūs izglābis un aicinājis ar svētu aicināšanu ne pēc mūsu darbiem, bet pēc Savas īpašas apņemšanās un žēlastības, kas mums dota iekš Kristus Jēzus no mūžīgiem laikiem,',
    ...
    2: {
        ...
        10: 'Tāpēc es visu panesu to izredzēto dēļ, lai arī tie debess prieku dabū iekš Kristus Jēzus ar mūžīgu godību.',
    ...
    4: {
        ...
        10: 'Jo Demas mani atstājis, mīlēdams šo pasauli, un ir nogājis uz Tesaloniku, Krescents uz Galatiju, Titus uz Dalmatiju.',
        ...
        18: 'Un Tas Kungs mani izraus no ikviena ļauna darba un izglābs uz Savu Debesu valstību; Tam ir gods mūžīgi mūžam! Āmen.',
