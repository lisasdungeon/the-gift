...
CHAPTERS = {
    ...
    2: {
        1: 'Pēc tam, kad ķēniņa Ahasverus bardzība bija nostājusies, tad viņš pieminēja Vasti, un ko tā bija darījusi, un kas par viņu bija nospriests.',
        2: 'Tad ķēniņa jaunekļi, kas viņam kalpoja, sacīja: lai ķēniņam meklē jaunas jumpravas skaistu vaigu.',
        3: 'Un lai ķēniņš ieceļ uzraugus visās savās valsts tiesās, ka tie sapulcē visas jaunās jumpravas skaistu vaigu uz Sūsanas pili, uz to sievu namu, apakš Egajus, ķēniņa kambarjunkura, tā sievu sarga, un lai pie tām notiek mazgāšana un svaidīšana.',
        4: 'Un kura jauna meita ķēniņam labi patiks, tā lai top par ķēniņieni Vastis vietā. Un tas vārds patika ķēniņam un viņš tā darīja.',
        5: 'Un viens Jūdu vīrs bija Sūsanas pilī, vārdā Mardakajs, tas bija Jaīra, tas Šimejus, tas Ķisa dēls, Benjaminietis;',
        6: 'Tas bija aizvests no Jeruzālemes līdz ar tiem, kas tapa aizvesti ar Jekaniju, Jūda ķēniņu, ko NebukadNecars, Bābeles ķēniņš, bija aizvedis.',
        7: 'Un viņš bija Adasas audžu tēvs, tā ir Estere, viņa brālēna meita, jo viņai nebija ne tēva ne mātes. Un viņa bija jauna meita daiļu augumu un skaistu vaigu. Un kad viņas tēvs un viņas māte nomira, tad Mardakajs viņu bija pieņēmis par meitu.',
        8: 'Kad nu ķēniņa vārds un viņa pavēle izpaudās un daudz jaunas meitas tika savestas Sūsanas pilī apakš Egajus rokas, tad Estere arī tapa ņemta ķēniņa namā, apakš Egajus, tā sievu sarga, rokas.',
        9: 'Un tā meita viņam patika un atrada žēlastību viņa priekšā, un viņš steidzās tai dot tās svaidāmās zāles priekš mazgāšanās un viņas daļu, un viņš tai deva septiņas daiļas jaunas meitas no ķēniņa nama, un viņš to noveda ar viņas meitām tai vislabākā vietā sievu namā.',
        10: 'Bet Estere nebija teikusi nedz savus ļaudis nedz savus radus, jo Mardakajs viņai bija piekodinājis, lai tā to neteicot.',
        11: 'Un Mardakajs staigāja ikdienas gar sievu nama pagalmu, lai dabūtu zināt, kā Esterei klājās un kas ar to būšot.',
        12: 'Kad nu ikvienas jaunietes reize atnāca iet pie ķēniņa Ahasverus, kad pēc sievu likuma ar to bija darīts divpadsmit mēnešus, (jo tik daudz laika pagāja viņu mazgāšanai un svaidīšanai, proti sešus mēnešus ar mirru eļļu un sešus mēnešus ar balzamu un citām sievu zālēm), -',
        13: 'Tad tā jauniete nāca pie ķēniņa, un ko viņa prasīja, to viņai deva, ka viņa ar to ietu no sievu nama uz ķēniņa namu.',
        14: 'Vakarā viņa iegāja un rītā viņa gāja atpakaļ uz otru sievu namu, apakš Zaāzgas, ķēniņa kambarjunkura, lieko sievu sarga; viņa negāja atkal pie ķēniņa, kā vien, kad ķēniņš viņu gribēja un viņu pie vārda sauca.',
        15: 'Kad nu Esteres, Abikaīla, Mardakaja brālēna, meitas, Mardakaja audzēknes, reize atnāca, iet pie ķēniņa, tad viņa neprasīja ne ko, ka tik vien ko Egajus, ķēniņa kambarjunkurs, tas sievu sargs, sacīja. Un Estere atrada žēlastību pie visiem, kas viņu redzēja.',
        16: 'Tā Estere tapa ņemta pie ķēniņa Ahasverus ķēniņa namā desmitā mēnesī, tas ir Tebetmēnesis, viņa valdīšanas septītā gadā.',
        17: 'Un ķēniņš iemīlēja Esteri pār visām sievām, un viņa atrada vairāk žēlastības un laipnības viņa priekšā nekā visas jaunietes, un viņš lika ķēniņa kroni uz viņas galvu un to cēla pār ķēniņieni Vastis vietā.',
        18: 'Un ķēniņš taisīja lielas dzīres visiem saviem lielkungiem un kalpiem, - tās bija Esteres dzīres, - un deva valstīm atvieglināšanu un izdalīja dāvanas pēc ķēniņa bagātības.',
        19: 'Kad nu otrā reizē tās jaunietes tapa sapulcētas, tad Mardakajs sēdēja ķēniņa vārtos.',
        20: 'Bet Estere nebija teikusi ne savus radus, ne savus ļaudis, tā kā Mardakajs tai bija pavēlējis; jo Estere darīja pēc Mardakaja vārda, kā to laiku, kad viņa pie tā uzauga.',
        21: 'Tanīs dienās, kad Mardakajs sēdēja ķēniņa vārtos, Bigtans un Teres, divi ķēniņa kambarjunkuri no tiem sliekšņa sargiem, apskaitās un meklēja rokas pielikt pie ķēniņa Ahasverus.',
        22: 'Un šī lieta Mardakajum tapa zināma, un viņš to izteica ķēniņienei Esterei, un Estere to sacīja ķēniņam Mardakaja vārdā.',
        23: 'Un tā lieta tapa izmeklēta un tā atrasta, un tie divi tapa pakārti pie koka, un tas tapa ierakstīts laiku grāmatā priekš ķēniņa.',
    },
    3: {
    ...
    8: {
        1: 'Tanī dienā ķēniņš Ahasverus deva ķēniņienei Esterei Amana, tā Jūdu ienaidnieka, namu, un Mardakajs nāca ķēniņa priekšā, jo Estere bija stāstījusi, kas viņš tai esot.',
        2: 'Un ķēniņš novilka savu gredzenu, ko no Amana bija ņēmis, un to deva Mardakajam, un Estere iecēla Mardakaju pār Amana namu.',
        3: 'Un Estere runāja vēl ķēniņa priekšā un krita viņam pie kājām un raudāja un viņu lūdza, ka viņš atņemtu Amana, tā Agaģieša, ļaunumu un viņa nodomu, ko viņš izdomājis pret Jūdiem.',
        4: 'Tad ķēniņš Esterei piesniedza zelta scepteri, un Estere cēlās un stāvēja ķēniņa priekšā.',
        5: 'Un viņa sacīja: ja ķēniņam patīk, un ja es žēlastību esmu atradusi viņa priekšā, un ja tas pareizi ir ķēniņa priekšā, un es patīkama esmu viņa acīs, tad lai top rakstīts, ka Amana, Medatus, tā Agaģieša dēla, grāmatas un domas top iznīcinātas, ko viņš rakstījis, gribēdams Jūdus nomaitāt, kas ir visās ķēniņa valstīs.',
        6: 'Jo kā es varētu redzēt to nelaimi, kas maniem ļaudīm uzies, un kā es varētu uzlūkot savu radu nomaitāšanu?',
        7: 'Tad ķēniņš Ahasverus sacīja uz ķēniņieni Esteri un uz Jūdu Mardakaju: redzi, Amana namu es esmu devis Esterei, un viņš ir pakārts pie koka, tādēļ ka savu roku pielicis pie Jūdiem.',
        8: 'Tad nu jūs rakstiet par tiem Jūdiem, kā jums patīk ķēniņa vārdā un aizspiežat to ar ķēniņa gredzenu, jo to rakstu, kas ķēniņa vārdā rakstīts un ar ķēniņa zieģeli aizspiests, to nedrīkst pārgrozīt.',
        9: 'Tad ķēniņa rakstītāji tanī laikā tapa aicināti trešā mēnesī, tas ir Zivana mēnesis, divdesmit trešā dienā, un tapa rakstīts, tā kā Mardakajs pavēlēja, Jūdiem un valdniekiem un zemes valdītājiem un valsts lieliem kungiem, no Indijas līdz Moru zemei, simts divdesmit septiņās valstīs un uz ikvienu valsti viņas rakstā un uz ikvienu tautu viņas valodā, un Jūdiem pēc viņu rakstiem un pēc viņu valodas.',
        10: 'Un tas tapa rakstīts ķēniņa Ahasverus vārdā un aizspiests ar ķēniņa gredzenu. Un tās grāmatas tapa sūtītas caur skrējējiem, kas jāja uz čakliem zirgiem no ķēniņa staļļiem.',
        11: 'Ķēniņš atļaujot Jūdiem visās pilsētās sapulcēties un savu dzīvību aizstāvēt, izdeldēt, nokaut un nomaitāt visu to ļaužu un valsts spēku, kas nāktu virsū, laupīt bērnus un sievas, un viņu mantu, -',
        12: 'Vienā dienā, pa visām ķēniņa Ahasverus valstīm, trīspadsmitā dienā divpadsmitā mēnesī, tas ir Adara mēnesis.',
        13: 'Tais grāmatās bija rakstīts: ka pavēle dota pa visām valstīm, ka visiem ļaudīm nāk zināms, lai Jūdi ir gatavi uz to dienu atriebties pie saviem ienaidniekiem.',
        14: 'Tad tie skrējēji izgāja jāšus ar ķēniņa čakliem zirgiem ātri steigdamies, pēc ķēniņa vārda, un tā pavēle tapa dota Sūsanas pilī.',
        15: 'Un Mardakajs izgāja no ķēniņa ar pazilām un baltām ķēniņa drēbēm un ar lielu zelta kroni un ar uzvalku no dārga audekla un purpura, un Sūsanas pilsēta gavilēja un līksmojās.',
        16: 'Pie Jūdiem bija spožums un līksmība un prieks un gods.',
        17: 'Un visās valstīs un visās pilsētās, kur ķēniņa vārds un pavēle nāca zināmi, bija prieks un līksmība pie Jūdiem, dzīres un labas dienas, un daudz no pagāniem palika par Jūdiem, jo bailes no Jūdiem tiem bija uzkritušas.',
    },
    9: {
    ...
    10: {
        1: 'Un ķēniņš Ahasverus uzlika klausību zemei un jūras salām.',
        2: 'Bet visi viņa varas un viņa stipruma darbi un Mardakaja lielā paaugstināšana, ar ko ķēniņš viņu paaugstinājis, tas viss rakstīts Mēdiešu un Persiešu ķēniņu laiku grāmatā.',
        3: 'Jo Jūds Mardakajs bija otrais pie ķēniņa Ahasverus un augsts pie Jūdiem un pieņēmīgs(patīkams) pie visiem saviem brāļiem; jo viņš meklēja labumu priekš savas tautas, un runāja par visa sava dzimuma labklāšanos.',
    },
}
