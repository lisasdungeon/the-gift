...
CHAPTERS = {
    1: {
        1: 'Pāvils, Jēzus Kristus kalps, aicināts par apustuli, izvēlēts, sludināt Dieva evaņģēliju,',
        ...
        20: 'Jo Viņa neredzamā būšana no pasaules radīšanas pie tiem darbiem top nomanīta un ieraudzīta, gan Viņa mūžīgais spēks, gan Viņa dievība, tā ka tie nevar aizbildināties.',
        ...
        25: 'Dieva patiesību tie ir pārvērtuši melos un radītas lietas lielākā godā turējuši un tām vairāk kalpojuši nekā tam Radītājam, kas ir augsti teicams mūžīgi! Āmen.',
    ...
    5: {
        ...
        2: 'Caur ko mēs ticībā esam dabūjuši arī pieiešanu pie tās pašas žēlastības, kurā mēs stāvam, un lielāmies ar to cerību uz Dieva godību.',
        3: 'Bet ne vien ar to, bet mēs lielāmies arī ar bēdām, zinādami, ka bēdas dara pacietību,',
        ...
        11: 'Un ne vien tā, bet mēs arī lielāmies ar Dievu caur mūsu Kungu Jēzu Kristu, caur ko mēs tagad salīdzināšanu esam dabūjuši.',
        12: 'Tādēļ itin kā caur vienu cilvēku grēks ir ienācis pasaulē un caur grēku nāve, un tā nāve pie visiem cilvēkiem ir caurspiedusies, tāpēc ka visi ir grēkojuši;',
        13: 'Jo līdz bauslībai grēks gan bija pasaulē; bet grēks netop pielīdzināts, kad bauslības nav.',
        14: 'Tomēr nāve ir valdījusi no Ādama līdz Mozum arī pār tiem, kas nebija grēkojuši tādā pārkāpšanā kā Ādams, kas ir tā nākamā (Ādama) priekšzīme.',
        ...
        17: 'Jo ja caur tā viena apgrēkošanos nāve ir valdījusi caur to vienu, tad daudz vairāk tie, kas to žēlastības pilnību un to taisnības dāvanu dabū, valdīs iekš dzīvības caur To vienu Jēzu Kristu.',
        ...
        21: 'Lai, kā grēks ir valdījis ar nāvi, tāpat arī žēlastība valda caur taisnību uz mūžīgu dzīvošanu caur Jēzu Kristu, mūsu Kungu.',
    },
    6: {
    ...
    9: {
        ...
        5: 'Tiem tie tēvi, no kuriem arī Kristus pēc miesas; tas ir Dievs pār visiem, augsti teicams mūžīgi. Āmen.',
    ...
    11: {
        ...
        36: 'Jo no Viņa un caur Viņu un uz Viņu ir visas lietas. Viņam lai ir gods mūžīgi! Āmen.',
    },
    12: {
    ...
    16: {
        ...
        25: 'Bet Tam, kas jūs spēj stiprināt pēc mana evaņģēlija un Jēzus Kristus sludināšanas, pēc tā noslēpuma parādīšanas, kas no mūžīgiem laikiem nav bijis dzirdēts,',
        26: 'Bet tagad zināms darīts un caur praviešu rakstiem pēc tā mūžīgā Dieva pavēlēšanas ir sludināts visiem pagāniem, lai šie ticībai paklausa,',
