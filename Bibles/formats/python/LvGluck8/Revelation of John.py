...
CHAPTERS = {
    1: {
        ...
        6: 'Un mūs darījis par ķēniņiem un priesteriem Savam Dievam un Tēvam: Viņam lai ir gods un vara mūžīgi mūžam! Āmen.',
        ...
        18: 'Un Tas Dzīvais. Es biju nomiris un redzi, Es esmu dzīvs mūžīgi mūžam. Un Man ir elles un nāves atslēgas.',
    ...
    4: {
        ...
        9: 'Un kad tie dzīvie godu un slavu un pateikšanu dod Tam, kas sēž uz tā goda krēsla, kas dzīvo mūžīgi mūžam,',
        10: 'Tad tie divdesmit četri vecaji nometās zemē priekš Tā, kas sēž uz tā goda krēsla, un pielūdz To, kas dzīvo mūžīgi mūžam, un met savus kroņus tā goda krēsla priekšā sacīdami:',
    ...
    5: {
        ...
        13: 'Un visus radījumus, kas ir debesīs un virs zemes un zemes apakšā, un kas ir jūrā, un visus, kas tur ir iekšā, es dzirdēju sakām: Tam, kas sēž uz tā goda krēsla, un Tam Jēram lai ir pateicība un slava un gods un vara mūžīgi mūžam!',
    ...
    6: {
        ...
        8: 'Un es redzēju un raugi, pelēks zirgs, un kas uz tā sēdēja, tam bija vārds: nāve; un elle tai gāja pakaļ; un tiem vara tapa dota, ceturto pasaules tiesu nokaut ar zobenu un ar badu un ar mēri un caur zemes zvēriem.',
    ...
    7: {
        ...
        12: 'Sacīdami: Āmen! Teikšana un gods un gudrība un pateicība un slava un vara un spēks pieder mūsu Dievam mūžīgi mūžam! Āmen.',
    ...
    9: {
        1: 'Un tas piektais eņģelis bazūnēja. Un es redzēju zvaigzni, kritušu no debess uz zemi, un tam tapa dota bezdibeņa akas atslēga.',
        2: 'Un tas atvēra bezdibeņa aku. Un dūmi uzkāpa no tās akas, kā liela cepļa dūmi. Un saule tapa aptumšota un gaiss no tās akas dūmiem.',
        ...
        11: 'Un pār tiem bija ķēniņš, tas bezdibeņa eņģelis, viņa vārds bija ebrejiski: Abadon, un Grieķu valodā: Apolion.',
    ...
    10: {
        ...
        6: 'Un zvērēja pie Tā, kas dzīvo mūžīgi mūžam, kas ir radījis debesis un, kas tur iekšā, un zemi un, kas tur iekšā, un jūru un, kas tur iekšā, ka laiks vairs nebūs.',
    ...
    11: {
        ...
        7: 'Un kad tie savu liecību būs pabeiguši, tad tas zvērs, kas izkāpj no bezdibeņa, ar tiem karos un tos uzvarēs un tos nokaus.',
        ...
        15: 'Un tas septītais eņģelis bazūnēja, un stipras balsis cēlās debesīs sacīdamas: pasaules valstis ir kļuvušas mūsu Kungam un Viņa Kristum, un Tas valdīs mūžīgi mūžam.',
    ...
    14: {
        ...
        11: 'Un tie dūmi no viņu mocības uzkāpj mūžīgi mūžam, un dusēšanas nav nedz dienu nedz nakti tiem, kas to zvēru un viņa bildi pielūdz, un ja kas viņa vārda zīmi pieņem.',
    ...
    15: {
        1: 'Un es redzēju citu lielu un brīnišķu zīmi debesīs: septiņus eņģeļus, kas turēja tās septiņas pēdīgās mocības, jo iekš tām Dieva dusmība piepildījās.',
        2: 'Un es redzēju kā glāzes jūru ar uguni jauktu; un tos, kas uzvarēja to zvēru un viņa bildi un viņa zīmi un viņa vārda skaitli, ka tie stāvēja pie tās glāzes jūras, turēdami Dieva kokles.',
        3: 'Un tie dziedāja Mozus, Tā Dieva kalpa, dziesmu un Tā Jēra dziesmu sacīdami: lieli un brīnišķi ir Tavi darbi, Kungs Dievs, visu Valdītājs; taisni un patiesīgi ir Tavi ceļi, Tu Ķēniņ pār tām tautām!',
        4: 'Kas Tevi nebītos, Kungs, un nedotu Tavam vārdam godu? Jo Tu vien esi svēts; jo visas tautas nāks un pielūgs Tavā priekšā, jo Tavas tiesas ir atspīdējušas.',
        5: 'Un pēc tam es redzēju, un raugi, Dieva nams, tas liecības dzīvoklis, tapa atvērts debesīs.',
        6: 'Un tie septiņi eņģeļi, kam tās septiņas mocības bija, nāca ārā no Dieva nama, apģērbti ar šķīstu un spožu audekli un apjozti ap krūtīm ar zelta jostām.',
        7: 'Un viens no tiem četriem dzīviem deva tiem septiņiem eņģeļiem septiņus zelta kausus, pildītus ar Tā Dieva dusmību, kas mūžīgi mūžam dzīvo.',
        8: 'Un Dieva nams tapa pilns dūmu no Dieva godības un no Viņa spēka, un neviens nevarēja Dieva namā ieiet, kamēr to septiņu eņģeļu septiņas mocības nebija pabeigtas.',
    },
    16: {
    ...
    17: {
        ...
        8: 'Tas zvērs, ko tu esi redzējis, bija un nav un izkāps no bezdibeņa un ies bojā; un tie, kas virs zemes dzīvo, (kam vārdi nav rakstīti tai dzīvības grāmatā no pasaules radīšanas,) tie brīnīsies, redzēdami to zvēru, ka tas bija un nav un būs.',
    ...
    19: {
        ...
        3: 'Un tie sacīja otrā kārtā: Alleluja! Un viņas dūmi uzkāpj mūžīgi mūžam.',
        ...
        20: 'Un tas zvērs tapa sagrābts, un līdz ar to tas viltīgais pravietis, kas viņa priekšā tās zīmes bija darījis, caur ko viņš bija pievīlis tos, kas bija pieņēmuši tā zvēra zīmi, un tos, kas pielūdza viņa bildi: tie divi tapa dzīvi iemesti uguns zaņķī, kas deg ar sēru.',
    ...
    20: {
        1: 'Un es redzēju eņģeli nokāpjam no debesīm, tam bija bezdibeņa atslēgas un lielas ķēdes savā rokā.',
        2: 'Un viņš sagrāba to pūķi, to veco čūsku, tas ir velns un sātans, un to saistīja tūkstoš gadus.',
        3: 'Un viņš to iemeta bezdibenī un aizslēdza un uzlika zieģeli virsū, ka tas tos ļaudis vairs nepieviltu, tiekams tūkstoš gadi būtu pabeigti, un pēc tiem viņam būs vaļā tapt mazu brīdi.',
        ...
        10: 'Un velns, kas tos pievīla, tapa iemests tai uguns un sēra zaņķī, kur tas zvērs ir un tas viltīgais pravietis, un tie taps mocīti dienām naktīm mūžīgi mūžam.',
        ...
        13: 'Un jūra deva tos mirušos, kas iekš tās bija, un nāve un elle deva tos mirušos, kas iekš tām bija, un ikviens tapa tiesāts pēc saviem darbiem.',
        14: 'Un nāve un elle tapa iemestas uguns zaņķī: šī ir tā otrā nāve.',
        15: 'Un ja kas netapa atrasts tai dzīvības grāmatā rakstīts, tas tapa iemests uguns zaņķī.',
    },
    21: {
        ...
        8: 'Bet tiem bailīgiem un neticīgiem un negantiem un slepkavām un mauciniekiem un burvjiem un elku kalpiem un visiem melkuļiem būs sava daļa tai zaņķī, kas deg ar uguni un sēru; tā ir tā otrā nāve.',
    ...
    22: {
        ...
        5: 'Un tur nakts nebūs, un tiem nevajadzēs nedz uguns nedz saules gaišuma; jo Tas Kungs Dievs tos apgaismo. Un tie valdīs mūžīgi mūžam.',
