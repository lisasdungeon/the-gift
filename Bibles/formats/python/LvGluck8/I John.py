...
CHAPTERS = {
    1: {
        ...
        2: '(Ja dzīvība ir parādīta, un mēs to esam redzējuši, un apliecinām un pasludinām jums to mūžīgo dzīvību, kas bija pie Tā Tēva un mums ir parādīta,) -',
    ...
    2: {
        ...
        17: 'Un pasaule paiet un viņas kārība; bet kas Dieva prātu dara, tas paliek mūžīgi.',
        ...
        25: 'Un šī ir tā apsolīšana, ko Viņš mums ir apsolījis, (proti) to mūžīgo dzīvošanu.',
    ...
    3: {
        ...
        15: 'Ikviens, kas savu brāli ienīst, tas ir slepkava, un jūs zināt, ka nevienam slepkavam mūžīga dzīvība nav paliekama iekš viņa.',
    ...
    5: {
        ...
        11: 'Un šī ir tā liecība, ka Dievs mums mūžīgu dzīvību ir devis, un šī dzīvība ir iekš Viņa Dēla.',
        12: 'Kam Tas Dēls ir, tam ir tā dzīvība. Kam Tas Dieva Dēls nav, tam nav tā dzīvība.',
        13: 'To es esmu rakstījis jums, kas ticiet uz Dieva Dēla vārdu, lai jūs zināt, ka jums ir mūžīga dzīvība, un ka jūs ticat uz Dieva Dēla vārdu.',
        ...
        20: 'Bet mēs zinām, ka Dieva Dēls ir nācis un mums tādu prātu devis, ka atzīstam To patiesīgo un esam iekš Tā Patiesīgā, iekš Viņa Dēla Jēzus Kristus; šis ir Tas patiesīgais Dievs un tā mūžīgā dzīvība.',
