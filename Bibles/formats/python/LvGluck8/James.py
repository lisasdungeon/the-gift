...
CHAPTERS = {
    ...
    3: {
        ...
        6: 'Mēle arīdzan ir uguns, pasaule pilna netaisnības; tāpat mēle starp mūsu locekļiem ir tas, kas visu miesu apgāna un iededzina visapkārt mūsu dzīvības ceļu, pati iededzināta no elles.',
