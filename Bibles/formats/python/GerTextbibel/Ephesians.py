...
CHAPTERS = {
    1: {
        ...
        21: 'hoch über alle Herrschaft und Macht und Gewalt und Hoheit und alle Namen, die genannt werden, nicht nur in dieser sondern auch in der zukünftigen Welt,',
    ...
    2: {
        ...
        3: '(unter welchen auch wir einst alle wandelten mit den Begierden unseres Fleisches, den Willen des Fleisches und der Gedanken vollbringend, und waren von Natur Kinder des Zornes wie die anderen auch)',
        4: 'hat doch der Gott, der da reich ist an Erbarmen, um seiner großen Liebe willen, mit der er uns geliebt hat,',
    ...
    3: {
        ...
        6: 'daß die Heiden Miterben sein sollten und Leibesgenossen und Teilnehmer der Verheißung in Christus Jesus durch das Evangelium,',
