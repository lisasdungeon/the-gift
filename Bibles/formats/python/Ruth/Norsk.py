...
CHAPTERS = {
    1: {
        ...
        2: "Mannen hette Elimelek, hans hustru No'omi og hans to sønner Mahlon og Kiljon; de var efratitter - fra Betlehem i Juda. De kom nu til Moabs land og blev der.",
    ...
    3: {
        ...
        7: 'Da Boas hadde ett og drukket og var blitt vel til mote, gikk han og la sig ved kanten av kornhaugen; da kom hun stille og slo op dekket ved hans føtter og la sig der.',
