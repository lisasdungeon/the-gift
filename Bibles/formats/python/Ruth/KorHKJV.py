...
CHAPTERS = {
    1: {
        1: '이제 재판관들이 다스리던 때에 땅에 기근이 드니라. 베들레헴유다의 어떤 사람이 자기 아내와 두 아들을 데리고 모압 지방에 가서 머물렀는데',
        ...
        6: '¶그때에 그녀가 주께서 자신의 백성을 돌아보사 그들에게 빵을 주셨다는 것을 모압 지방에서 들었으므로 모압 지방에서 돌아오려고 자기의 며느리들과 함께 일어나니라.',
        7: '그러므로 그녀가 자기가 있던 곳에서 나와 떠나매 그녀의 두 며느리도 그녀와 함께하더라. 그들이 유다 땅으로 돌아오려고 길을 갈 때에',
        ...
        10: '그녀에게 이르되, 우리가 반드시 어머니와 함께 어머니의 백성에게로 돌아가겠나이다, 하니라.',
        11: '나오미가 이르되, 되돌아가라. 내 딸들아, 너희가 어찌하여 나와 함께 가려 하느냐? 아직도 내 태에 아들들이 있어서 그들이 너희 남편이 되겠느냐?',
        12: '되돌아가라. 내 딸들아, 너희 길로 갈지어다. 나는 너무 늙어서 남편을 두지 못하노라. 가령 내가 소망이 있다고 말하거나 혹은 오늘 밤에 남편을 두어 아들들을 낳는다 하자.',
        13: '그들이 자랄 때까지 너희가 그들을 기다리려느냐? 그들로 인하여 너희가 남편 두기를 멈추겠느냐? 내 딸들아, 아니라. 주의 손이 나와서 나를 치셨으므로 내가 너희로 인해 심히 괴롭도다, 하매',
        14: '그들이 소리 높여 다시 울더라. 오르바는 자기 시어머니에게 입을 맞추되 룻은 그녀에게 굳게 붙으므로',
        15: '그녀가 또 이르되, 보라, 네 동서는 자기 백성과 자기 신들에게로 돌아갔나니 너도 네 동서를 따라 돌아가라, 하매',
        ...
        18: '그녀가 자기와 함께 가기로 굳게 결심한 것을 보고 나오미가 그녀에게 말하기를 그치니라.',
        19: '¶이에 그들 둘이 가서 마침내 베들레헴에 이르렀더니 그들이 베들레헴에 이를 때에 온 도시가 그들로 인해 흥분하여 말하기를, 이 사람이 나오미냐? 하므로',
        20: '그녀가 그들에게 이르되, 나를 나오미라 부르지 말고 마라라 부르라. 전능자께서 나를 심히 괴롭게 하셨느니라.',
        21: '내가 풍족하게 나갔으나 주께서 나를 빈손으로 집에 다시 오게 하셨느니라. 주께서 나를 대적하는 증거를 보이셨고 전능자께서 나를 괴롭게 하셨거늘 너희가 어찌하여 나를 나오미라 부르느냐? 하니라.',
        22: '이같이 나오미가 모압 지방에서 돌아온 자기 며느리 모압 여인 룻과 함께 돌아왔더라. 그들이 보리 수확을 시작할 때에 베들레헴에 이르렀더라.',
    },
    2: {
        1: '나오미에게는 그녀의 남편 엘리멜렉의 가족에 속한 친족으로 부유하고 강력한 자가 있었는데 그의 이름은 보아스더라.',
        2: '모압 여인 룻이 나오미에게 이르되, 이제 내가 밭에 가도록 허락하소서. 내가 누구의 눈앞에서 은혜를 입으면 그를 따라가며 곡식 이삭을 줍겠나이다, 하니 나오미가 그녀에게 이르되, 내 딸아, 갈지어다, 하매',
        3: '그녀가 가서 밭에 이르러 곡식 베는 자들을 따라가며 이삭을 줍다가 우연히 엘리멜렉의 친족인 보아스에게 속한 밭의 일부를 만나니라.',
        ...
        7: '그녀가 말하기를, 청하건대 내가 곡식 베는 자들을 따라가며 곡식 단 사이에서 이삭을 주워 모으게 하소서, 하였고 이처럼 와서 아침부터 지금까지 잠시 집에서 쉰 것 외에는 계속 줍고 있나이다, 하니라.',
        ...
        10: '이에 그녀가 땅에 얼굴을 대고 엎드려 절하며 그에게 이르되, 나는 타국인이온데 어찌하여 당신의 눈에 은혜를 입게 하시며 나를 알아주시나이까? 하매',
        ...
        14: '보아스가 그녀에게 이르되, 식사할 때에 너는 이리로 와서 빵을 먹으며 네 빵 조각을 식초에 찍으라, 하니 그녀가 곡식 베는 자들 옆에 앉으매 그가 그녀에게 볶은 곡식을 건네주니 그녀가 배불리 먹고 남겼더라.',
        15: '그녀가 이삭을 주우러 일어날 때에 보아스가 자기 청년들에게 명령하여 이르되, 그녀가 곡식 단 사이에서 줍게 하고 그녀를 책망하지 말라.',
        16: '또 그녀를 위해 손에 쥔 것에서 의도적으로 얼마를 떨어뜨리고 그것들을 남겨 두어 그녀가 줍게 하며 그녀를 꾸짖지 말라, 하니라.',
        17: '이처럼 그녀가 밭에서 저녁까지 줍고 자기가 주운 것을 떠니 보리가 일 에바쯤 되었더라.',
        18: '¶룻이 그것을 가지고 도시로 들어가 자기 시어머니에게 자기가 주운 것을 보이고 자기가 배불리 먹고 남긴 것을 가져다가 시어머니에게 드리매',
        19: '그녀의 시어머니가 그녀에게 이르되, 네가 오늘 어디에서 주웠느냐? 어디에서 일을 하였느냐? 너를 알아준 자에게 복이 있기를 원하노라, 하니 그녀가 자기가 누구와 함께 일했는지 자기 시어머니에게 알리고 이르되, 오늘 나와 함께 일한 사람의 이름은 보아스이니이다, 하매',
        ...
        21: '모압 여인 룻이 이르되, 그가 또 내게 말하기를, 내 청년들이 내 모든 수확물을 거둘 때까지 너는 그들 옆에 바싹 붙어 있으라, 하더이다, 하매',
        22: '나오미가 자기 며느리 룻에게 이르되, 내 딸아, 네가 그의 소녀들과 함께 나감으로써 그들이 다른 밭에서 너를 만나지 아니하게 하는 것이 좋으니라, 하니',
        23: '이에 그녀가 보아스의 소녀들 옆에 바싹 붙어 있으며 보리 수확과 밀 수확을 끝마칠 때까지 이삭을 줍고 자기 시어머니와 함께 거하니라.',
    },
    3: {
        1: '그때에 룻의 시어머니 나오미가 그녀에게 이르되, 내 딸아, 내가 너를 위해 안식할 곳을 구하여 네가 잘되게 하여야 하지 아니하겠느냐?',
        2: '너와 함께하던 소녀들을 둔 보아스는 이제 우리의 친족이 아니냐? 보라, 그가 오늘 밤에 타작마당에서 보리를 까부르리라.',
        3: '그런즉 너는 몸을 씻고 기름을 바르고 의복을 입고 타작마당으로 내려가되 그 사람이 먹고 마시기를 다할 때까지 그에게 네 자신을 알리지 말며',
        4: '그가 누울 때에 눕는 곳을 알아두었다가 들어가서 그의 발을 드러내고 누우라. 네가 해야 할 일을 그가 네게 고하리라, 하니',
        5: '그녀가 시어머니에게 이르되, 어머니께서 말씀하시는 모든 것을 내가 행하리이다, 하니라.',
        6: '¶그녀가 타작마당으로 내려가서 자기 시어머니가 자기에게 명한 모든 것에 따라 행하니라.',
        7: '보아스가 먹고 마시고 마음이 즐거울 때에 가서 곡식더미 끝에 누우매 그녀가 가만히 가서 그의 발을 드러내고 누웠더라.',
        ...
        10: '그가 이르되, 내 딸아, 주께서 네게 복주시기를 원하노라. 네가 가난하든지 부하든지 젊은 남자를 따르지 아니함으로 네가 처음보다 마지막 끝에 친절을 더 많이 베풀었도다.',
        11: '내 딸아, 이제 두려워하지 말라. 네가 요구하는 모든 것을 내가 네게 행하리니 네가 현숙한 여자인 줄 내 백성의 온 도시가 아느니라.',
        12: '참으로 이제 나는 너의 가까운 친족이나 나보다 더 가까운 친족이 있으니',
        13: '이 밤은 여기서 머무르라. 아침에 그가 친족의 역할을 네게 행하려 하면 좋은 일이니 그가 친족의 역할을 행하려니와 만일 그가 네게 친족의 역할을 행하려 하지 아니하면 주께서 살아 계심을 두고 맹세하노니 내가 네게 친족의 역할을 행하리라. 아침까지 누울지니라, 하니라.',
        14: '¶룻이 아침까지 그의 발치에 누웠다가 사람이 서로 알아보기 전에 일어나매 보아스가 이르되, 여인이 타작마당에 들어온 것을 사람이 알지 못하여야 하리라, 하고',
        15: '또 그가 이르되, 너를 덮는 너울을 가져다가 그것을 잡으라, 하매 그녀가 그것을 잡으니 그가 보리를 여섯 번 되어 룻에게 이워 주매 그녀가 도시로 들어가니라.',
        16: '룻이 자기 시어머니에게 가니 그녀가 이르되, 내 딸아, 너는 누구냐? 하매 그녀가 그 사람이 자기에게 행한 모든 것을 그녀에게 고하고',
        17: '이르되, 그가 내게 이 보리를 여섯 번 되어 주었나이다. 그가 말하기를, 빈손으로 네 시어머니에게 가지 말라, 하였나이다, 하매',
        18: '이에 그녀가 이르되, 내 딸아, 이 일이 어떻게 될지 네가 알 때까지 가만히 앉아 있으라. 그 사람이 이 날 그 일을 끝마치기 전에는 안식하지 아니하리라, 하니라.',
    },
    4: {
        1: '그때에 보아스가 성문에 올라가서 거기 앉았는데, 보라, 보아스가 말하던 친족이 지나가므로 그가 그에게 이르되, 어이, 아무개여! 돌이켜서 이리로 와서 앉으라, 하니 그가 돌이켜서 앉더라.',
        ...
        9: '¶보아스가 장로들과 온 백성에게 이르되, 내가 엘리멜렉에게 있던 모든 것과 기룐과 말론에게 있던 모든 것을 나오미의 손에서 산 일에 관하여 너희가 이 날 증인이 되었고',
        ...
        14: '여인들이 나오미에게 이르되, 주를 찬송할지로다. 그분께서 이 날 너를 친족이 없게 내버려 두지 아니하셨도다. 그의 이름이 이스라엘에서 유명하게 되기를 원하노라.',
