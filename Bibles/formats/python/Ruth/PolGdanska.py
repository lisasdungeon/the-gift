...
CHAPTERS = {
    1: {
        ...
        5: 'Umarli potem i oni oba, Mahalon i Chelijon; i tak ona niewiasta osierociała po obu synach swoich i po mężu swoim.',
        6: 'A wezbrawszy się z synowemi swemi wróciła się z ziemi Moabskiej; bo słyszała w krainie Moabskiej, że był nawiedził Pan lud swój, i dał im chleb.',
        7: 'Tedy wyszła z miejsca, na którem była z onemi dwiema synowemi swemi, a udały się w drogę, aby się wróciły do ziemi Juda.',
        8: 'Zatem rzekła Noemi do dwóch synowych swych: Idźcież, wróćcie się każda do domu matki twojej; niechaj uczyni Pan z wami miłosierdzie, jakoście uczyniły z umarłymi synami moimi i ze mną.',
        ...
        15: 'Do której Noemi rzekła: Oto się wróciła powinna twoja do ludu swego, i do bogów swoich, wróćże się i ty za powinną swoją.',
        16: 'Na co jej odpowiedziała Ruta: Nie wiedź mię do tego, abym cię opuścić i od ciebie odejść miała; owszem gdziekolwiek pójdziesz, z tobą pójdę, a gdziekolwiek mieszkać będziesz, z tobą mieszkać będę; lud twój lud mój, a Bóg twój Bóg mój.',
        ...
        19: 'I szły obie pospołu, aż przyszły do Betlehem. I stało się, gdy przyszły do Betlehem, wzruszyło się wszystko miasto dla nich, mówiąc: Izaż nie ta jest Noemi?',
        ...
        22: 'A tak wróciła się Noemi i Rut Moabitka, synowa jej, z nią; wróciła się z krainy Moabskiej, i przyszły do Betlehem na początku żniwa jęczmiennego.',
    },
    2: {
